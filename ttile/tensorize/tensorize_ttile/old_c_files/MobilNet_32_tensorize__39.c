...
c129_p_0 = 0;
						for (w = w82, wp_0 = 0;w < w82 + 3;w += 1, wp_0 += 1){
							...
							for (x = x144, xp_2 = x144_p_1, xp_1 = x144_p_0, xp_0 = 0;x < x144 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_994 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_995 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_994);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_995);
							}
						}
}
