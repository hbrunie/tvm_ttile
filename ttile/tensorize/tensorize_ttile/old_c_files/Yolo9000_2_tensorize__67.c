...
[V f; U (2, f); U (8, y); T (4, c); Hoist_vars [c]; T (34, x); T (3, w);
  T (3, h); T (1, x); T (34, y); T (2, f); T (8, c); T (1, x); T (8, x)]
*/
IND_TYPE c, cp_0, c282_p_0, cp_1, c282, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x470_p_0, x471_p_0, x472_p_0, xp_1, x470_p_1, x471_p_1, xp_2, x470_p_2, xp_3, x470, x471, x472, y, yp_0;
IND_TYPE y188 = 0;
IND_TYPE x473 = 0;
IND_TYPE h188 = 0;
IND_TYPE w188 = 0;
...
x470_p_2 = 0;
						for (h = h188, hp_0 = 0;h < h188 + 3;h += 1, hp_0 += 1){
							...
							for (w = w188, wp_0 = 0;w < w188 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 34) (34 / 1)
								for (x = x470, xp_3 = x470_p_2, xp_2 = x470_p_1, xp_1 = x470_p_0, xp_0 = 0;x < x470 + 34;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
