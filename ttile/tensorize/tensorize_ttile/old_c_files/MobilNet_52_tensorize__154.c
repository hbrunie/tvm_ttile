						...
						for (h = h398, hp_0 = 0;h < h398 + 3;h += 1, hp_0 += 1){
							...
							for (w = w472, wp_0 = 0;w < w472 + 3;w += 1, wp_0 += 1){
								...
								for (x = x750, xp_1 = x750_p_0, xp_0 = 0;x < x750 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6888 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
											mem_vec_6889 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
											mem_vec_6890 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
											mem_vec_6891 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 4, f = 32
											// T (c, 4) (4 / 1)
											for (c = c978, cp_2 = c978_p_1, cp_1 = c978_p_0, cp_0 = 0;c < c978 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_6888);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_6889);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_6890);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_6891);
								}
							}
						}
}
