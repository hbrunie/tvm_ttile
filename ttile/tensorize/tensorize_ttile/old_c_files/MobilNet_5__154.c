...
*/
IND_TYPE c, cp_0, c978_p_0, c979_p_0, cp_1, c978_p_1, cp_2, c978, c979, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x750_p_0, xp_1, x750, y, yp_0;
							...
							for (w = w472, wp_0 = 0;
								...
								for (x = x750, xp_1 = x750_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6888 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_6889 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
											mem_vec_6890 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_6891 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 4, f = 32
											// T (c, 4) (4 / 1)
											for (c = c978, cp_2 = c978_p_1, cp_1 = c978_p_0, cp_0 = 0;
												c < c978 + 4;
												...
												vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_6888);
												mem_vec_6888 = vec_32;



												vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_6889);
												mem_vec_6889 = vec_34;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
												vec_36 = _mm512_set1_ps(scal_11);


												vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_6890);
												mem_vec_6890 = vec_35;



												vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_6891);
												mem_vec_6891 = vec_37;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_6888);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_6889);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_6890);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_6891);
								}
							}
						}
					}
