...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (4, y); T (4, f); T (4, c); T (1, f); T (64, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c288_p_0, c289_p_0, cp_1, c288_p_1, cp_2, c288, c289, f, fp_0, f276_p_0, f277_p_0, fp_1, f276_p_1, fp_2, f276, f277, h, hp_0, w, wp_0, x, xp_0, x216_p_0, xp_1, x216, y, yp_0;
	...
	for (x216 = x217, x216_p_0 = 0;
		...
		for (c289 = c290, c289_p_0 = 0;
			...
			for (f276 = f277, f276_p_1 = f277_p_0, f276_p_0 = 0;
				f276 < f277 + 256;
				f276 += 256, f276_p_1 += 256, f276_p_0 += 256){
				// y = 28, x = 2, h = 3, w = 3, c = 4, f = 256
				// T (c, 4) (4 / 1)
