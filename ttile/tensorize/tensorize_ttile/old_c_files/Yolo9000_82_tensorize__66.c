							...
							for (h = h348, hp_0 = 0;h < h348 + 3;h += 1, hp_0 += 1){
								...
								for (w = w296, wp_0 = 0;w < w296 + 3;w += 1, wp_0 += 1){
									...
									for (x = x574, xp_1 = x574_p_0, xp_0 = 0;x < x574 + 17;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_5928 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
												mem_vec_5929 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_5928);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_5929);
									}
								}
							}
}
