...
[V f; U (4, f); U (4, y); U (3, w); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (2, x); T (68, y); T (2, c); T (4, x); T (34, x)]
*/
IND_TYPE c, cp_0, c846_p_0, cp_1, c846, h, hp_0, x, xp_0, x1410_p_0, x1411_p_0, x1412_p_0, xp_1, x1410_p_1, x1411_p_1, xp_2, x1410_p_2, xp_3, x1410, x1411, x1412, y, yp_0;
...
for (x1412 = x1413, x1412_p_0 = 0;
	...
	// T (x, 4) (8 / 2)
	for (x1411 = x1412, x1411_p_1 = x1412_p_0, x1411_p_0 = 0;
		x1411 < x1412 + 8;
		x1411 += 2, x1411_p_1 += 2, x1411_p_0 += 2){
		...
		for (c846 = c847, c846_p_0 = 0;
			...
			for (y = y564, yp_0 = 0;
				...
				// T (x, 2) (2 / 1)
				for (x1410 = x1411, x1410_p_2 = x1411_p_1, x1410_p_1 = x1411_p_0, x1410_p_0 = 0;
					x1410 < x1411 + 2;
					x1410 += 1, x1410_p_2 += 1, x1410_p_1 += 1, x1410_p_0 += 1){
					...
					for (h = h564, hp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x = x1410, xp_3 = x1410_p_2, xp_2 = x1410_p_1, xp_1 = x1410_p_0, xp_0 = 0;
							x < x1410 + 1;
