...
*/
IND_TYPE c, cp_0, c336_p_0, c337_p_0, cp_1, c336_p_1, cp_2, c336, c337, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x252_p_0, xp_1, x252, y, yp_0;
IND_TYPE y168 = 0;
IND_TYPE x253 = 0;
IND_TYPE h168 = 0;
IND_TYPE w168 = 0;
					...
					for (h = h168, hp_0 = 0;h < h168 + 3;h += 1, hp_0 += 1){
						...
						for (w = w168, wp_0 = 0;w < w168 + 3;w += 1, wp_0 += 1){
							...
							for (x = x252, xp_1 = x252_p_0, xp_0 = 0;x < x252 + 2;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 2) (2 / 1)
										for (c = c336, cp_2 = c336_p_1, cp_1 = c336_p_0, cp_0 = 0;c < c336 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
