...
/*
[V f; U (4, f); ULambda y; U (3, h); T (256, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (1, h); T (1, c); T (4, f); T (7, x);
...
c0_p_1 = 0;
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 3, hp_0 += 3){
							// y = u_y, x = 4, h = 3, w = 3, c = 256, f = 64
							// T (w, 3) (3 / 1)
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
								// y = u_y, x = 4, h = 3, w = 1, c = 256, f = 64
								// T (x, 4) (4 / 1)
