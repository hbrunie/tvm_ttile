...
[V f; U (2, f); U (14, y); T (4, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (64, c); T (16, f); T (2, x); T (1, y); T (2, c)]
*/
IND_TYPE c, cp_0, c72_p_0, c73_p_0, cp_1, c72_p_1, cp_2, c72, c73, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x54_p_0, xp_1, x54, y, yp_0;
