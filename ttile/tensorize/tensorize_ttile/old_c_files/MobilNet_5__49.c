...
[V f; U (4, f); U (7, y); T (64, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, y); T (4, f); T (4, c); T (1, f); T (1, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c88_p_0, c89_p_0, cp_1, c88_p_1, cp_2, c88, c89, f, fp_0, f76_p_0, f77_p_0, fp_1, f76_p_1, fp_2, f76, f77, h, hp_0, w, wp_0, x, xp_0, x66_p_0, xp_1, x66, y, yp_0;
