...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (64, c); T (2, f); T (2, x); T (1, f)]
*/
IND_TYPE c, cp_0, c162_p_0, cp_1, c162, f, fp_0, f170_p_0, f171_p_0, fp_1, f170_p_1, fp_2, f170, f171, h, hp_0, w, wp_0, x, xp_0, x162_p_0, xp_1, x162, y, yp_0;
...
for (f171 = f172, f171_p_0 = 0;
	...
	for (x162 = x163, x162_p_0 = 0;
		...
		for (f170 = f171, f170_p_1 = f171_p_0, f170_p_0 = 0;
			f170 < f171 + 256;
			f170 += 128, f170_p_1 += 128, f170_p_0 += 128){
