						...
						for (h = h338, hp_0 = 0;h < h338 + 3;h += 1, hp_0 += 1){
							...
							for (w = w412, wp_0 = 0;w < w412 + 3;w += 1, wp_0 += 1){
								...
								for (x = x660, xp_1 = x660_p_0, xp_0 = 0;x < x660 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_5740 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_5741 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
											mem_vec_5742 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_5743 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_5740);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_5741);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_5742);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_5743);
								}
							}
						}
}
