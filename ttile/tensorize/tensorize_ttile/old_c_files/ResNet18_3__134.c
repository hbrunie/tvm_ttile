...
for (y540 = y541, y540_p_0 = 0;
	...
	for (x678 = x679, x678_p_0 = 0;
		...
		// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 1) (28 / 28)
		for (y539 = y540, y539_p_1 = y540_p_0, y539_p_0 = 0;
			y539 < y540 + 28;
			y539 += 28, y539_p_1 += 28, y539_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 28) (56 / 2)
			for (x677 = x678, x677_p_1 = x678_p_0, x677_p_0 = 0;
				x677 < x678 + 56;
				x677 += 2, x677_p_1 += 2, x677_p_0 += 2){
				...
				for (f = f265, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y539, yp_2 = y539_p_1, yp_1 = y539_p_0, yp_0 = 0;
						y < y539 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 2) (2 / 1)
						for (x676 = x677, x676_p_2 = x677_p_1, x676_p_1 = x677_p_0, x676_p_0 = 0;
							x676 < x677 + 2;
							x676 += 1, x676_p_2 += 1, x676_p_1 += 1, x676_p_0 += 1){
							...
							for (c411 = c412, c411_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x676, xp_3 = x676_p_2, xp_2 = x676_p_1, xp_1 = x676_p_0, xp_0 = 0;
									x < x676 + 1;
