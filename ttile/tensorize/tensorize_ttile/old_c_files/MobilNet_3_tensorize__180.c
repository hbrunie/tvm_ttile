...
[V f; U (2, f); ULambda y; T (64, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); Lambda_apply y [((Iter 3), (Arg 10)); ((Iter 2), (Arg 13))];
  T (4, f); T (2, c); T (14, x); T (1, y)]
*/
...
c0_p_0 = 0;
			for (f = f0, fp_0 = 0;f < f0 + 128;f += 32, fp_0 += 32){
					for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 30;y += 10, yp_1 += 10, yp_0 += 10){
						// y = u_y, x = 4, h = 3, w = 3, c = 64, f = 32
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 4, h = 1, w = 3, c = 64, f = 32
							// T (w, 3) (3 / 1)
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
								// y = u_y, x = 4, h = 1, w = 1, c = 64, f = 32
								// T (x, 4) (4 / 1)
					...
					for (y = y0 + 30, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 30 + 26;y += 13, yp_1 += 13, yp_0 += 13){
						// y = u_y, x = 4, h = 3, w = 3, c = 64, f = 32
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 4, h = 1, w = 3, c = 64, f = 32
