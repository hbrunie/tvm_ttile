...
[V f; U (4, f); U (7, y); U (3, w); T (2, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, c); T (8, f); T (1, x); T (2, y); T (128, c)]
*/
IND_TYPE c, cp_0, c916_p_0, c917_p_0, cp_1, c916_p_1, cp_2, c916, c917, f, fp_0, h, hp_0, x, xp_0, x732_p_0, xp_1, x732, y, yp_0;
