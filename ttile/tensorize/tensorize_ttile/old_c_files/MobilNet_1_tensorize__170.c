...
/*
[V f; U (2, f); U (8, y); T (32, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (2, x); T (14, y); T (1, c); T (4, x)]
*/
IND_TYPE c, cp_0, c42_p_0, cp_1, c42, h, hp_0, w, wp_0, x, xp_0, x56_p_0, x57_p_0, xp_1, x56_p_1, xp_2, x56, x57, y, yp_0;
IND_TYPE y28 = 0;
IND_TYPE x58 = 0;
IND_TYPE h28 = 0;
IND_TYPE w28 = 0;
...
x56_p_1 = 0;
				for (h = h28, hp_0 = 0;h < h28 + 3;h += 1, hp_0 += 1){
					// y = 8, x = 14, h = 1, w = 3, c = 32, f = 32
					// T (w, 3) (3 / 1)
					for (w = w28, wp_0 = 0;w < w28 + 3;w += 1, wp_0 += 1){
						// y = 8, x = 14, h = 1, w = 1, c = 32, f = 32
						// T (x, 14) (14 / 1)
