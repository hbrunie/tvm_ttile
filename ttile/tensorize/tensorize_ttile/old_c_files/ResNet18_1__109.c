...
/*
[V f; U (2, f); U (8, y); T (1, c); Hoist_vars [c]; T (28, x); T (7, w);
  T (7, h); T (4, x); T (14, y); T (2, f); T (3, c); T (1, x)]
*/
...
for (x1 = x2, x1_p_0 = 0;
	...
	for (c0 = c1, c0_p_0 = 0;
		...
		for (f = f0, fp_0 = 0;
			f < f0 + 64;
			f += 32, fp_0 += 32){
			// y = 112, x = 112, h = 7, w = 7, c = 1, f = 32
			// T (y, 14) (112 / 8)
			for (y = y0, yp_0 = 0;
				y < y0 + 112;
				y += 8, yp_0 += 8){
				// y = 8, x = 112, h = 7, w = 7, c = 1, f = 32
				// T (x, 4) (112 / 28)
				for (x0 = x1, x0_p_1 = x1_p_0, x0_p_0 = 0;
					x0 < x1 + 112;
					x0 += 28, x0_p_1 += 28, x0_p_0 += 28){
					// y = 8, x = 28, h = 7, w = 7, c = 1, f = 32
					// T (h, 7) (7 / 1)
					for (h = h0, hp_0 = 0;
						h < h0 + 7;
						h += 1, hp_0 += 1){
						// y = 8, x = 28, h = 1, w = 7, c = 1, f = 32
						// T (w, 7) (7 / 1)
						for (w = w0, wp_0 = 0;
							w < w0 + 7;
							w += 1, wp_0 += 1){
							// y = 8, x = 28, h = 1, w = 1, c = 1, f = 32
							// T (x, 28) (28 / 1)
