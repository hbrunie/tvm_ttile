...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (256, c); T (4, f); T (1, y); T (4, c); T (4, f)]
*/
IND_TYPE c, cp_0, c264_p_0, c265_p_0, cp_1, c264_p_1, cp_2, c264, c265, f, fp_0, f198_p_0, fp_1, f198, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y132 = 0;
IND_TYPE x132 = 0;
IND_TYPE h132 = 0;
IND_TYPE w132 = 0;
					...
					for (h = h132, hp_0 = 0;h < h132 + 3;h += 1, hp_0 += 1){
						...
						for (w = w132, wp_0 = 0;w < w132 + 3;w += 1, wp_0 += 1){
							...
							for (x = x132, xp_0 = 0;x < x132 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 1) (1 / 1)
										for (c = c264, cp_2 = c264_p_1, cp_1 = c264_p_0, cp_0 = 0;c < c264 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
