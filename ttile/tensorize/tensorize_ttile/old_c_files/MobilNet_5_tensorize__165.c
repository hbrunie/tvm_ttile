...
[V f; U (4, f); U (7, y); T (16, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (8, c); T (1, f); T (2, c); T (4, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c160_p_0, c161_p_0, cp_1, c160_p_1, cp_2, c160, c161, f, fp_0, f148_p_0, f149_p_0, fp_1, f148_p_1, fp_2, f148, f149, h, hp_0, w, wp_0, x, xp_0, x120_p_0, xp_1, x120, y, yp_0;
IND_TYPE y80 = 0;
IND_TYPE x121 = 0;
IND_TYPE h80 = 0;
IND_TYPE w80 = 0;
...
yp_0 = 0;
							for (h = h80, hp_0 = 0;h < h80 + 3;h += 1, hp_0 += 1){
								...
								for (w = w80, wp_0 = 0;w < w80 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 7) (7 / 1)
									for (x = x120, xp_1 = x120_p_0, xp_0 = 0;x < x120 + 7;x += 1, xp_1 += 1, xp_0 += 1){
