...
[V f; U (2, f); U (14, y); T (128, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (2, c); T (16, f); T (7, x); T (1, y); T (2, c)]
*/
IND_TYPE c, cp_0, c128_p_0, c129_p_0, cp_1, c128_p_1, cp_2, c128, c129, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x96_p_0, xp_1, x96, y, yp_0;
		...
		for (x96 = x97, x96_p_0 = 0;
			...
			for (f = f64, fp_0 = 0;
				...
				for (c128 = c129, c128_p_1 = c129_p_0, c128_p_0 = 0;
					c128 < c129 + 256;
					c128 += 128, c128_p_1 += 128, c128_p_0 += 128){
