...
[V f; U (4, f); U (7, y); T (4, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (4, y); T (4, f); T (1, c); T (1, f); T (64, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c248_p_0, c249_p_0, cp_1, c248_p_1, cp_2, c248, c249, f, fp_0, f236_p_0, f237_p_0, fp_1, f236_p_1, fp_2, f236, f237, h, hp_0, w, wp_0, x, xp_0, x186_p_0, xp_1, x186, y, yp_0;
	...
	for (x186 = x187, x186_p_0 = 0;
		...
		for (c249 = c250, c249_p_0 = 0;
			...
			for (f236 = f237, f236_p_1 = f237_p_0, f236_p_0 = 0;
				f236 < f237 + 256;
				f236 += 256, f236_p_1 += 256, f236_p_0 += 256){
				// y = 28, x = 4, h = 3, w = 3, c = 4, f = 256
				// T (c, 1) (4 / 4)
				for (c248 = c249, c248_p_1 = c249_p_0, c248_p_0 = 0;
					c248 < c249 + 4;
					c248 += 4, c248_p_1 += 4, c248_p_0 += 4){
					// y = 28, x = 4, h = 3, w = 3, c = 4, f = 256
					// T (f, 4) (256 / 64)
