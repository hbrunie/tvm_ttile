					...
					for (h = h316, hp_0 = 0;h < h316 + 3;h += 1, hp_0 += 1){
						...
						for (w = w336, wp_0 = 0;w < w336 + 3;w += 1, wp_0 += 1){
							...
							for (x = x672, xp_2 = x672_p_1, xp_1 = x672_p_0, xp_0 = 0;x < x672 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5566 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_5567 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										...
										for (c = c504, cp_1 = c504_p_0, cp_0 = 0;c < c504 + 2;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_5566);
											mem_vec_5566 = vec_29;
											vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_5567);
											mem_vec_5567 = vec_31;
										}
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_5566);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_5567);
							}
						}
					}
}
