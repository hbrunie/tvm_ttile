...
/*
[V f; U (1, f); U (14, y); U (3, h); T (128, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (4, y); T (2, f); T (1, c); T (4, f); T (7, x); T (1, f)]
*/
IND_TYPE c, cp_0, c138_p_0, cp_1, c138, f, fp_0, f116_p_0, f117_p_0, fp_1, f116_p_1, fp_2, f116, f117, w, wp_0, x, xp_0, x172_p_0, xp_1, x172, y, yp_0;
...
__m512 mem_vec_952 ,mem_vec_953 ,mem_vec_954 ,mem_vec_955 ,mem_vec_956 ,mem_vec_957 ,mem_vec_958 ,mem_vec_959 ,mem_vec_960 ,mem_vec_961 ,mem_vec_962 ,mem_vec_963 ,mem_vec_964 ,mem_vec_965 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_81 ,vec_82 ,vec_83 ,vec_84 ,vec_85 ,vec_86 ,vec_9;
			...
			for (c138 = c139, c138_p_0 = 0;
				...
				for (f = f116, fp_2 = f116_p_1, fp_1 = f116_p_0, fp_0 = 0;
					...
					for (y = y92, yp_0 = 0;
						y < y92 + 56;
						y += 14, yp_0 += 14){
						// y = 14, x = 8, h = 3, w = 3, c = 128, f = 16
						// T (w, 3) (3 / 1)
						for (w = w92, wp_0 = 0;
							w < w92 + 3;
							w += 1, wp_0 += 1){
							// y = 14, x = 8, h = 3, w = 1, c = 128, f = 16
							// T (x, 8) (8 / 1)
							for (x = x172, xp_1 = x172_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_959 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
										mem_vec_960 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
										mem_vec_961 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
										mem_vec_962 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
										mem_vec_963 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_964 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
										mem_vec_965 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										...
										for (c = c138, cp_1 = c138_p_0, cp_0 = 0;
											...
											vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_959);
											mem_vec_959 = vec_15;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h) + c];
											vec_18 = _mm512_set1_ps(scal_8);


											vec_17 = _mm512_fmadd_ps(vec_18, vec_2, mem_vec_960);
											mem_vec_960 = vec_17;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h) + c];
											vec_20 = _mm512_set1_ps(scal_9);


											vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_961);
											mem_vec_961 = vec_19;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
											vec_22 = _mm512_set1_ps(scal_10);


											vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_962);
											mem_vec_962 = vec_21;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_959);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_960);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_961);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_962);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_963);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_964);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_965);
							}
						}
					}
				}
