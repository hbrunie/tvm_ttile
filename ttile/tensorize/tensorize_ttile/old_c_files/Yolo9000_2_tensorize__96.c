...
[V f; U (2, f); U (8, y); T (2, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (4, x); T (34, y); T (2, f); T (16, c); T (68, x); T (1, x)]
*/
IND_TYPE c, cp_0, c126_p_0, cp_1, c126, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x210_p_0, x211_p_0, x212_p_0, xp_1, x210_p_1, x211_p_1, xp_2, x210_p_2, xp_3, x210, x211, x212, y, yp_0;
IND_TYPE y84 = 0;
IND_TYPE x213 = 0;
IND_TYPE h84 = 0;
IND_TYPE w84 = 0;
