...
for (y652 = y653, y652_p_0 = 0;
	...
	for (x818 = x819, x818_p_0 = 0;
		...
		// T (y, 1) (28 / 28)
		for (y651 = y652, y651_p_1 = y652_p_0, y651_p_0 = 0;
			y651 < y652 + 28;
			y651 += 28, y651_p_1 += 28, y651_p_0 += 28){
			// y = 28, x = 7, h = 1, w = 1, c = 64, f = 64
			// T (x, 7) (7 / 1)
			for (x817 = x818, x817_p_1 = x818_p_0, x817_p_0 = 0;
				x817 < x818 + 7;
				x817 += 1, x817_p_1 += 1, x817_p_0 += 1){
				...
				for (f = f321, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y651, yp_2 = y651_p_1, yp_1 = y651_p_0, yp_0 = 0;
						y < y651 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 1, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (1 / 1)
						for (x816 = x817, x816_p_2 = x817_p_1, x816_p_1 = x817_p_0, x816_p_0 = 0;
							x816 < x817 + 1;
							x816 += 1, x816_p_2 += 1, x816_p_1 += 1, x816_p_0 += 1){
							// y = 14, x = 1, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c495 = c496, c495_p_0 = 0;
								...
								// y = 14, x = 1, h = 1, w = 1, c = 64, f = 32
								// T (x, 1) (1 / 1)
								for (x = x816, xp_3 = x816_p_2, xp_2 = x816_p_1, xp_1 = x816_p_0, xp_0 = 0;
									x < x816 + 1;
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4142 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_4143 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
											// y = 14, x = 1, h = 1, w = 1, c = 64, f = 32
											// T (c, 64) (64 / 1)
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_4142);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_4143);
								}
							}
						}
					}
