...
// T (x, 1) (272 / 272)
for (x1522 = x1523, x1522_p_0 = 0;
	x1522 < x1523 + 272;
	x1522 += 272, x1522_p_0 += 272){
	// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (x, 4) (272 / 68)
	for (x1521 = x1522, x1521_p_1 = x1522_p_0, x1521_p_0 = 0;
		x1521 < x1522 + 272;
		x1521 += 68, x1521_p_1 += 68, x1521_p_0 += 68){
			...
			for (f = f468, fp_0 = 0;
				...
				f += 32, fp_0 += 32){
					for (y = y608, yp_0 = 0;
						...
						// T (x, 1) (68 / 68)
						for (x1520 = x1521, x1520_p_2 = x1521_p_1, x1520_p_1 = x1521_p_0, x1520_p_0 = 0;
							x1520 < x1521 + 68;
							x1520 += 68, x1520_p_2 += 68, x1520_p_1 += 68, x1520_p_0 += 68){
							// y = ph_y, x = 68, h = 3, w = 3, c = 16, f = 32
							// T (h, 3) (3 / 1)
							for (h = h608, hp_0 = 0;
								h < h608 + 3;
								...
								for (w = w468, wp_0 = 0;
									...
									// T (x, 68) (68 / 1)
									for (x = x1520, xp_3 = x1520_p_2, xp_2 = x1520_p_1, xp_1 = x1520_p_0, xp_0 = 0;
										x < x1520 + 68;
										x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_5392 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
												mem_vec_5393 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
												mem_vec_5394 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
												mem_vec_5395 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_5392);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_5393);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_5394);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_5395);
									}
								}
							}
						}
								...
								for (w = w468, wp_0 = 0;
									...
									for (x = x1520, xp_3 = x1520_p_2, xp_2 = x1520_p_1, xp_1 = x1520_p_0, xp_0 = 0;
										...
										x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_5416 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
												mem_vec_5417 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
												mem_vec_5418 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
												mem_vec_5419 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
												mem_vec_5420 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
												mem_vec_5421 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
												mem_vec_5422 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
												mem_vec_5423 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
												mem_vec_5424 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
												mem_vec_5425 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 32
												// T (c, 16) (16 / 1)
												for (c = c912, cp_1 = c912_p_0, cp_0 = 0;
													c < c912 + 16;
													...
													vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_5416);
													mem_vec_5416 = vec_32;



													vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_5417);
													mem_vec_5417 = vec_34;
													scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
													vec_36 = _mm512_set1_ps(scal_11);


													vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_5418);
													mem_vec_5418 = vec_35;



													vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_5419);
													mem_vec_5419 = vec_37;
													scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
													vec_39 = _mm512_set1_ps(scal_12);


													vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_5420);
													mem_vec_5420 = vec_38;



													vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_5421);
													mem_vec_5421 = vec_40;
													scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
													vec_42 = _mm512_set1_ps(scal_13);


													vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_5422);
													mem_vec_5422 = vec_41;



													vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_5423);
													mem_vec_5423 = vec_43;
													scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 14 + h) + c];
													vec_45 = _mm512_set1_ps(scal_14);


													vec_44 = _mm512_fmadd_ps(vec_45, vec_2, mem_vec_5424);
													mem_vec_5424 = vec_44;



													vec_46 = _mm512_fmadd_ps(vec_45, vec_4, mem_vec_5425);
													mem_vec_5425 = vec_46;
												}
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_5416);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_5417);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_5418);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_5419);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_5420);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_5421);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_5422);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_5423);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_5424);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_5425);
									}
								}
							}
						}
