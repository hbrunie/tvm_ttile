...
*/
IND_TYPE c, cp_0, c72_p_0, cp_1, c72, f, fp_0, f72_p_0, fp_1, f72, h, hp_0, w, wp_0, x, xp_0, x72_p_0, xp_1, x72, y, yp_0;
IND_TYPE y48 = 0;
IND_TYPE x73 = 0;
IND_TYPE h48 = 0;
IND_TYPE w48 = 0;
...
fp_1 = 0;
					for (h = h48, hp_0 = 0;h < h48 + 3;h += 1, hp_0 += 1){
						...
						for (w = w48, wp_0 = 0;w < w48 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 2) (2 / 1)
							for (x = x72, xp_1 = x72_p_0, xp_0 = 0;x < x72 + 2;x += 1, xp_1 += 1, xp_0 += 1){
