...
[V f; U (2, f); U (8, y); T (32, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (2, x); T (34, y); T (2, f); T (1, c); T (34, x); T (1, x)]
*/
IND_TYPE c, cp_0, c108_p_0, cp_1, c108, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x180_p_0, x181_p_0, x182_p_0, xp_1, x180_p_1, x181_p_1, xp_2, x180_p_2, xp_3, x180, x181, x182, y, yp_0;
IND_TYPE y72 = 0;
IND_TYPE x183 = 0;
IND_TYPE h72 = 0;
IND_TYPE w72 = 0;
...
x180_p_2 = 0;
						for (h = h72, hp_0 = 0;h < h72 + 3;h += 1, hp_0 += 1){
							...
							for (w = w72, wp_0 = 0;w < w72 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 4) (4 / 1)
								for (x = x180, xp_3 = x180_p_2, xp_2 = x180_p_1, xp_1 = x180_p_0, xp_0 = 0;x < x180 + 4;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
