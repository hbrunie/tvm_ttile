							...
							for (w = w22, wp_0 = 0;w < w22 + 3;w += 1, wp_0 += 1){
								...
								for (x = x33, xp_1 = x33_p_0, xp_0 = 0;x < x33 + 34;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (h = h22, hp_0 = 0;h < h22 + 3;h += 1, hp_0 += 1){
												mem_vec_430 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
												mem_vec_431 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
												...
												mem_vec_435 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16]);
												...
												mem_vec_438 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_439 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												...
												mem_vec_442 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
												mem_vec_443 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
												mem_vec_444 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
												mem_vec_445 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_430);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_431);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16], mem_vec_435);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_438);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_439);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_442);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_443);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_444);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_445);
									}
								}
							}
}
