...
/*
[V f; U (4, f); U (7, y); U (3, h); T (4, c); Hoist_vars [c]; T (56, x);
  T (3, w); T (1, h); T (4, y); T (2, f); T (32, c); T (1, x); T (2, y)]
*/
...
for (y0 = y1, y0_p_0 = 0;
	...
	for (x0 = x1, x0_p_0 = 0;
		...
		for (c0 = c1, c0_p_0 = 0;
			c0 < c1 + 128;
			c0 += 4, c0_p_0 += 4){
			// y = 28, x = 56, h = 3, w = 3, c = 4, f = 128
			// T (f, 2) (128 / 64)
			for (f = f0, fp_0 = 0;
				f < f0 + 128;
				f += 64, fp_0 += 64){
				// y = 28, x = 56, h = 3, w = 3, c = 4, f = 64
				// T (y, 4) (28 / 7)
