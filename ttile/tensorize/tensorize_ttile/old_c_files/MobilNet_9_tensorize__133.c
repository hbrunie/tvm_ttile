...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (128, c); T (2, f); T (1, y); T (8, c); T (8, f)]
*/
IND_TYPE c, cp_0, c360_p_0, c361_p_0, cp_1, c360_p_1, cp_2, c360, c361, f, fp_0, f270_p_0, fp_1, f270, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y180 = 0;
IND_TYPE x180 = 0;
IND_TYPE h180 = 0;
IND_TYPE w180 = 0;
					...
					for (h = h180, hp_0 = 0;h < h180 + 3;h += 1, hp_0 += 1){
						...
						for (w = w180, wp_0 = 0;w < w180 + 3;w += 1, wp_0 += 1){
							...
							for (x = x180, xp_0 = 0;x < x180 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 1) (1 / 1)
										for (c = c360, cp_2 = c360_p_1, cp_1 = c360_p_0, cp_0 = 0;c < c360 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
