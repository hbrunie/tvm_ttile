...
for (y748 = y749, y748_p_0 = 0;
	...
	for (x938 = x939, x938_p_0 = 0;
		...
		// T (y, 1) (28 / 28)
		for (y747 = y748, y747_p_1 = y748_p_0, y747_p_0 = 0;
			y747 < y748 + 28;
			y747 += 28, y747_p_1 += 28, y747_p_0 += 28){
			// y = 28, x = 4, h = 1, w = 1, c = 64, f = 64
			// T (x, 2) (4 / 2)
			for (x937 = x938, x937_p_1 = x938_p_0, x937_p_0 = 0;
				x937 < x938 + 4;
				x937 += 2, x937_p_1 += 2, x937_p_0 += 2){
				...
				for (f = f369, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y747, yp_2 = y747_p_1, yp_1 = y747_p_0, yp_0 = 0;
						y < y747 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (2 / 2)
						for (x936 = x937, x936_p_2 = x937_p_1, x936_p_1 = x937_p_0, x936_p_0 = 0;
							x936 < x937 + 2;
							x936 += 2, x936_p_2 += 2, x936_p_1 += 2, x936_p_0 += 2){
							// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c567 = c568, c567_p_0 = 0;
								...
								// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
								// T (x, 2) (2 / 1)
								for (x = x936, xp_3 = x936_p_2, xp_2 = x936_p_1, xp_1 = x936_p_0, xp_0 = 0;
									x < x936 + 2;
