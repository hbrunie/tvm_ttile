...
fp_1 = 0;
					for (h = h378, hp_0 = 0;h < h378 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 14) (14 / 1)
						for (x = x804, xp_1 = x804_p_0, xp_0 = 0;x < x804 + 14;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_6158 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_6159 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_6158);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_6159);
						}
					}
}
