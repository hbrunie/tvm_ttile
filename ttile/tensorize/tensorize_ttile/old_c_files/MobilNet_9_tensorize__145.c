...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (512, c); T (8, f); T (1, y); T (2, c); T (2, f)]
*/
IND_TYPE c, cp_0, c176_p_0, c177_p_0, cp_1, c176_p_1, cp_2, c176, c177, f, fp_0, f132_p_0, fp_1, f132, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x88 = 0;
IND_TYPE h88 = 0;
IND_TYPE w88 = 0;
					...
					for (h = h88, hp_0 = 0;h < h88 + 3;h += 1, hp_0 += 1){
						...
						for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
							...
							for (x = x88, xp_0 = 0;x < x88 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 1) (1 / 1)
										for (c = c176, cp_2 = c176_p_1, cp_1 = c176_p_0, cp_0 = 0;c < c176 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
