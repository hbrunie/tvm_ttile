...
[V f; U (2, f); U (8, y); T (4, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (68, x); T (34, y); T (2, f); T (8, c); T (4, x); T (1, x)]
*/
IND_TYPE c, cp_0, c54_p_0, cp_1, c54, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x90_p_0, x91_p_0, x92_p_0, xp_1, x90_p_1, x91_p_1, xp_2, x90_p_2, xp_3, x90, x91, x92, y, yp_0;
IND_TYPE y36 = 0;
IND_TYPE x93 = 0;
IND_TYPE h36 = 0;
IND_TYPE w36 = 0;
