...
[V f; U (1, f); U (14, y); U (3, h); T (16, c); Hoist_vars [c]; T (56, x);
  T (3, w); T (1, x); T (4, y); T (4, f); T (4, c); T (1, x)]
*/
IND_TYPE c, cp_0, c178_p_0, cp_1, c178, f, fp_0, w, wp_0, x, xp_0, x186_p_0, x187_p_0, xp_1, x186_p_1, xp_2, x186, x187, y, yp_0;
		...
		for (f = f82, fp_0 = 0;
			...
			for (y = y104, yp_0 = 0;
				...
				for (x186 = x187, x186_p_1 = x187_p_0, x186_p_0 = 0;
					x186 < x187 + 56;
					x186 += 56, x186_p_1 += 56, x186_p_0 += 56){
					// y = 14, x = 56, h = 3, w = 3, c = 16, f = 16
					// T (w, 3) (3 / 1)
					for (w = w104, wp_0 = 0;
						w < w104 + 3;
