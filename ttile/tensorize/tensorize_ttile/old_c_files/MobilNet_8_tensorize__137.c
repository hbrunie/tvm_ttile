...
*/
IND_TYPE c, cp_0, c328_p_0, c329_p_0, cp_1, c328_p_1, cp_2, c328, c329, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y164 = 0;
IND_TYPE x164 = 0;
IND_TYPE h164 = 0;
IND_TYPE w164 = 0;
				...
				for (h = h164, hp_0 = 0;h < h164 + 3;h += 1, hp_0 += 1){
					...
					for (w = w164, wp_0 = 0;w < w164 + 3;w += 1, wp_0 += 1){
						...
						for (x = x164, xp_0 = 0;x < x164 + 7;x += 1, xp_0 += 1){
									...
									// T (c, 8) (8 / 1)
									for (c = c328, cp_2 = c328_p_1, cp_1 = c328_p_0, cp_0 = 0;c < c328 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
