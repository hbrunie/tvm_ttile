							...
							for (h = h76, hp_0 = 0;h < h76 + 3;h += 1, hp_0 += 1){
								...
								for (w = w76, wp_0 = 0;w < w76 + 3;w += 1, wp_0 += 1){
									...
									for (x = x114, xp_1 = x114_p_0, xp_0 = 0;x < x114 + 17;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_1442 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
												mem_vec_1443 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_1442);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_1443);
									}
								}
							}
}
