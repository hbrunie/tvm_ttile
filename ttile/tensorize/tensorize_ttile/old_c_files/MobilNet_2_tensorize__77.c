...
[V f; U (4, f); U (7, y); T (16, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (1, c); T (28, x); T (8, y); T (4, c)]
*/
IND_TYPE c, cp_0, c162_p_0, c163_p_0, cp_1, c162_p_1, cp_2, c162, c163, h, hp_0, w, wp_0, x, xp_0, x174_p_0, xp_1, x174, y, yp_0;
IND_TYPE y96 = 0;
IND_TYPE x175 = 0;
IND_TYPE h96 = 0;
IND_TYPE w96 = 0;
				...
				for (h = h96, hp_0 = 0;h < h96 + 3;h += 1, hp_0 += 1){
					...
					for (w = w96, wp_0 = 0;w < w96 + 3;w += 1, wp_0 += 1){
						...
						for (x = x174, xp_1 = x174_p_0, xp_0 = 0;x < x174 + 2;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 16) (16 / 1)
									for (c = c162, cp_2 = c162_p_1, cp_1 = c162_p_0, cp_0 = 0;c < c162 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
