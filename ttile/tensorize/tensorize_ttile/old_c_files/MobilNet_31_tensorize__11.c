...
x1188_p_1 = 0;
						for (w = w650, wp_0 = 0;w < w650 + 3;w += 1, wp_0 += 1){
							...
							for (x = x1188, xp_2 = x1188_p_1, xp_1 = x1188_p_0, xp_0 = 0;x < x1188 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_9494 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_9495 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										mem_vec_9496 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_9497 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_9494);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_9495);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_9496);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_9497);
							}
						}
}
