...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (1, c); T (2, f); T (256, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c208_p_0, c209_p_0, cp_1, c208_p_1, cp_2, c208, c209, f, fp_0, f196_p_0, f197_p_0, fp_1, f196_p_1, fp_2, f196, f197, h, hp_0, w, wp_0, x, xp_0, x156_p_0, xp_1, x156, y, yp_0;
IND_TYPE y104 = 0;
IND_TYPE x157 = 0;
IND_TYPE h104 = 0;
IND_TYPE w104 = 0;
