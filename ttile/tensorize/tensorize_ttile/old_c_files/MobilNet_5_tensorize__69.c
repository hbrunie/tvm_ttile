...
/*
[V f; U (4, f); U (7, y); T (4, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (16, c); T (4, f); T (4, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c32_p_0, c33_p_0, cp_1, c32_p_1, cp_2, c32, c33, f, fp_0, f20_p_0, f21_p_0, fp_1, f20_p_1, fp_2, f20, f21, h, hp_0, w, wp_0, x, xp_0, x24_p_0, xp_1, x24, y, yp_0;
IND_TYPE y16 = 0;
IND_TYPE x25 = 0;
IND_TYPE h16 = 0;
IND_TYPE w16 = 0;
							...
							for (h = h16, hp_0 = 0;h < h16 + 3;h += 1, hp_0 += 1){
								...
								for (w = w16, wp_0 = 0;w < w16 + 3;w += 1, wp_0 += 1){
									...
									for (x = x24, xp_1 = x24_p_0, xp_0 = 0;x < x24 + 28;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 4) (4 / 1)
												for (c = c32, cp_2 = c32_p_1, cp_1 = c32_p_0, cp_0 = 0;c < c32 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
