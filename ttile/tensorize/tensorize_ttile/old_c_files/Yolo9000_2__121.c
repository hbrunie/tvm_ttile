...
for (x1102 = x1103, x1102_p_0 = 0;
	x1102 < x1103 + 272;
	x1102 += 136, x1102_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 68) (136 / 2)
	for (x1101 = x1102, x1101_p_1 = x1102_p_0, x1101_p_0 = 0;
		x1101 < x1102 + 136;
		x1101 += 2, x1101_p_1 += 2, x1101_p_0 += 2){
		...
		for (c660 = c661, c660_p_0 = 0;
			...
			for (y = y440, yp_0 = 0;
				...
				// T (x, 2) (2 / 1)
				for (x1100 = x1101, x1100_p_2 = x1101_p_1, x1100_p_1 = x1101_p_0, x1100_p_0 = 0;
					x1100 < x1101 + 2;
					x1100 += 1, x1100_p_2 += 1, x1100_p_1 += 1, x1100_p_0 += 1){
					...
					for (h = h440, hp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x = x1100, xp_3 = x1100_p_2, xp_2 = x1100_p_1, xp_1 = x1100_p_0, xp_0 = 0;
							x < x1100 + 1;
