...
[V f; U (1, f); U (14, y); U (3, h); T (2, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (1, f); T (64, c); T (1, x); T (2, y); T (8, f)]
*/
IND_TYPE c, cp_0, c186_p_0, cp_1, c186, f, fp_0, f186_p_0, fp_1, f186, w, wp_0, x, xp_0, x186_p_0, xp_1, x186, y, yp_0;
					...
					for (w = w124, wp_0 = 0;
						...
						for (x = x186, xp_1 = x186_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1575 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_1576 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_1577 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_1578 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_1579 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_1580 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_1581 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									...
									for (c = c186, cp_1 = c186_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1569);
										mem_vec_1569 = vec_3;
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_1571);
										mem_vec_1571 = vec_7;
										...
										vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_1574);
										mem_vec_1574 = vec_13;
										scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
										vec_16 = _mm512_set1_ps(scal_7);


										vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_1575);
										mem_vec_1575 = vec_15;
										...
										vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_1577);
										mem_vec_1577 = vec_19;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
										vec_22 = _mm512_set1_ps(scal_10);


										vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_1578);
										mem_vec_1578 = vec_21;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_1575);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_1576);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_1577);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_1578);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1579);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1580);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1581);
						}
					}
				}
			}
