...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (32, c); T (2, f); T (4, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c168_p_0, c169_p_0, cp_1, c168_p_1, cp_2, c168, c169, f, fp_0, f156_p_0, f157_p_0, fp_1, f156_p_1, fp_2, f156, f157, h, hp_0, w, wp_0, x, xp_0, x126_p_0, xp_1, x126, y, yp_0;
IND_TYPE y84 = 0;
IND_TYPE x127 = 0;
IND_TYPE h84 = 0;
IND_TYPE w84 = 0;
							...
							for (h = h84, hp_0 = 0;h < h84 + 3;h += 1, hp_0 += 1){
								...
								for (w = w84, wp_0 = 0;w < w84 + 3;w += 1, wp_0 += 1){
									...
									for (x = x126, xp_1 = x126_p_0, xp_0 = 0;x < x126 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 2) (2 / 1)
												for (c = c168, cp_2 = c168_p_1, cp_1 = c168_p_0, cp_0 = 0;c < c168 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
