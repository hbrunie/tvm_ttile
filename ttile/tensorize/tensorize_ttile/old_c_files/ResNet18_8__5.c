...
[V f; U (4, f); U (7, y); T (64, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (2, c); T (2, f); T (28, x); T (1, f)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, f, fp_0, f250_p_0, f251_p_0, fp_1, f250_p_1, fp_2, f250, f251, h, hp_0, w, wp_0, x, xp_0, x222_p_0, xp_1, x222, y, yp_0;
