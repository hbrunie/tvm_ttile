...
c1128_p_1 = 0;
				for (h = h454, hp_0 = 0;h < h454 + 3;h += 1, hp_0 += 1){
					...
					for (x = x564, xp_0 = 0;x < x564 + 7;x += 1, xp_0 += 1){
								...
								mem_vec_7920 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
								mem_vec_7921 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
								mem_vec_7922 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
								mem_vec_7923 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								// y = 7, x = 1, h = 1, w = 3, c = 4, f = 64
								// T (c, 4) (4 / 1)
								for (c = c1128, cp_2 = c1128_p_1, cp_1 = c1128_p_0, cp_0 = 0;c < c1128 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_7920);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_7921);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_7922);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_7923);
					}
				}
}
