						...
						for (h = h366, hp_0 = 0;h < h366 + 3;h += 1, hp_0 += 1){
							...
							for (w = w440, wp_0 = 0;w < w440 + 3;w += 1, wp_0 += 1){
								...
								for (x = x702, xp_1 = x702_p_0, xp_0 = 0;x < x702 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6248 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
											mem_vec_6249 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
											mem_vec_6250 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
											mem_vec_6251 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_6248);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_6249);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_6250);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_6251);
								}
							}
						}
}
