...
for (y624 = y625, y624_p_0 = 0;
	...
	for (x783 = x784, x783_p_0 = 0;
		...
		// T (y, 2) (28 / 14)
		for (y623 = y624, y623_p_1 = y624_p_0, y623_p_0 = 0;
			y623 < y624 + 28;
			y623 += 14, y623_p_1 += 14, y623_p_0 += 14){
			// y = 14, x = 7, h = 1, w = 1, c = 64, f = 64
			// T (x, 1) (7 / 7)
			for (x782 = x783, x782_p_1 = x783_p_0, x782_p_0 = 0;
				x782 < x783 + 7;
				x782 += 7, x782_p_1 += 7, x782_p_0 += 7){
				// y = 14, x = 7, h = 1, w = 1, c = 64, f = 64
				// T (f, 2) (64 / 32)
				for (f = f307, fp_0 = 0;
					f < f307 + 64;
					...
					// T (y, 1) (14 / 14)
					for (y = y623, yp_2 = y623_p_1, yp_1 = y623_p_0, yp_0 = 0;
						y < y623 + 14;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (7 / 7)
						for (x781 = x782, x781_p_2 = x782_p_1, x781_p_1 = x782_p_0, x781_p_0 = 0;
							x781 < x782 + 7;
							x781 += 7, x781_p_2 += 7, x781_p_1 += 7, x781_p_0 += 7){
							// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 4) (64 / 16)
							for (c474 = c475, c474_p_0 = 0;
								...
								// T (x, 7) (7 / 1)
								for (x = x781, xp_3 = x781_p_2, xp_2 = x781_p_1, xp_1 = x781_p_0, xp_0 = 0;
									x < x781 + 7;
