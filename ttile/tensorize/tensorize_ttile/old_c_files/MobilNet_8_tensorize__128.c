...
*/
IND_TYPE c, cp_0, c224_p_0, c225_p_0, cp_1, c224_p_1, cp_2, c224, c225, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y112 = 0;
IND_TYPE x112 = 0;
IND_TYPE h112 = 0;
IND_TYPE w112 = 0;
				...
				for (h = h112, hp_0 = 0;h < h112 + 3;h += 1, hp_0 += 1){
					...
					for (w = w112, wp_0 = 0;w < w112 + 3;w += 1, wp_0 += 1){
						...
						for (x = x112, xp_0 = 0;x < x112 + 7;x += 1, xp_0 += 1){
									...
									// T (c, 32) (32 / 1)
									for (c = c224, cp_2 = c224_p_1, cp_1 = c224_p_0, cp_0 = 0;c < c224 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
