...
[V f; U (4, f); U (7, y); T (32, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (2, c); T (1, f); T (4, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c104_p_0, c105_p_0, cp_1, c104_p_1, cp_2, c104, c105, f, fp_0, f92_p_0, f93_p_0, fp_1, f92_p_1, fp_2, f92, f93, h, hp_0, w, wp_0, x, xp_0, x78_p_0, xp_1, x78, y, yp_0;
IND_TYPE y52 = 0;
IND_TYPE x79 = 0;
IND_TYPE h52 = 0;
IND_TYPE w52 = 0;
...
yp_0 = 0;
							for (h = h52, hp_0 = 0;h < h52 + 3;h += 1, hp_0 += 1){
								...
								for (w = w52, wp_0 = 0;w < w52 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 14) (14 / 1)
									for (x = x78, xp_1 = x78_p_0, xp_0 = 0;x < x78 + 14;x += 1, xp_1 += 1, xp_0 += 1){
