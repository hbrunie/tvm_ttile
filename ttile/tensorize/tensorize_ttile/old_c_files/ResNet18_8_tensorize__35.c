...
[V f; U (4, f); U (7, y); T (64, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (2, c); T (1, f); T (2, x); T (2, f)]
*/
IND_TYPE c, cp_0, c150_p_0, cp_1, c150, f, fp_0, f154_p_0, f155_p_0, fp_1, f154_p_1, fp_2, f154, f155, h, hp_0, w, wp_0, x, xp_0, x150_p_0, xp_1, x150, y, yp_0;
IND_TYPE y100 = 0;
IND_TYPE x151 = 0;
IND_TYPE h100 = 0;
IND_TYPE w100 = 0;
...
yp_0 = 0;
						for (h = h100, hp_0 = 0;h < h100 + 3;h += 1, hp_0 += 1){
							...
							for (w = w100, wp_0 = 0;w < w100 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x150, xp_1 = x150_p_0, xp_0 = 0;x < x150 + 14;x += 1, xp_1 += 1, xp_0 += 1){
