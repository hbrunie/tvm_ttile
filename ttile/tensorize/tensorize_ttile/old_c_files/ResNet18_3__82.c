...
*/
IND_TYPE c, cp_0, c462_p_0, cp_1, c462, f, fp_0, x, xp_0, x761_p_0, x762_p_0, x763_p_0, xp_1, x761_p_1, x762_p_1, xp_2, x761_p_2, xp_3, x761, x762, x763, y, yp_0, y607_p_0, y608_p_0, yp_1, y607_p_1, yp_2, y607, y608;
...
for (y608 = y609, y608_p_0 = 0;
	...
	for (x763 = x764, x763_p_0 = 0;
		...
		// T (y, 1) (28 / 28)
		for (y607 = y608, y607_p_1 = y608_p_0, y607_p_0 = 0;
			y607 < y608 + 28;
			y607 += 28, y607_p_1 += 28, y607_p_0 += 28){
			// y = 28, x = 7, h = 1, w = 1, c = 64, f = 64
			// T (x, 1) (7 / 7)
			for (x762 = x763, x762_p_1 = x763_p_0, x762_p_0 = 0;
				x762 < x763 + 7;
				x762 += 7, x762_p_1 += 7, x762_p_0 += 7){
				// y = 28, x = 7, h = 1, w = 1, c = 64, f = 64
				// T (f, 2) (64 / 32)
				for (f = f299, fp_0 = 0;
					f < f299 + 64;
					...
					// T (y, 2) (28 / 14)
					for (y = y607, yp_2 = y607_p_1, yp_1 = y607_p_0, yp_0 = 0;
						y < y607 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (7 / 7)
						for (x761 = x762, x761_p_2 = x762_p_1, x761_p_1 = x762_p_0, x761_p_0 = 0;
							x761 < x762 + 7;
							x761 += 7, x761_p_2 += 7, x761_p_1 += 7, x761_p_0 += 7){
							// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c462 = c463, c462_p_0 = 0;
								...
								// T (x, 7) (7 / 1)
								for (x = x761, xp_3 = x761_p_2, xp_2 = x761_p_1, xp_1 = x761_p_0, xp_0 = 0;
									x < x761 + 7;
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3830 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_3831 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
											mem_vec_3832 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_3833 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
											mem_vec_3834 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_3835 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
											...
											for (c = c462, cp_1 = c462_p_0, cp_0 = 0;
												...
												vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_3830);
												mem_vec_3830 = vec_35;



												vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_3831);
												mem_vec_3831 = vec_37;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
												vec_39 = _mm512_set1_ps(scal_12);


												vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_3832);
												mem_vec_3832 = vec_38;



												vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_3833);
												mem_vec_3833 = vec_40;
												scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
												vec_42 = _mm512_set1_ps(scal_13);


												vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_3834);
												mem_vec_3834 = vec_41;



												vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_3835);
												mem_vec_3835 = vec_43;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3830);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_3831);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_3832);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_3833);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3834);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_3835);
								}
							}
						}
					}
