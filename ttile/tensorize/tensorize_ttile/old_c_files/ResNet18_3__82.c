...
for (y524 = y525, y524_p_0 = 0;
	...
	for (x658 = x659, x658_p_0 = 0;
		...
		// y = 56, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 2) (56 / 28)
		for (y523 = y524, y523_p_1 = y524_p_0, y523_p_0 = 0;
			y523 < y524 + 56;
			y523 += 28, y523_p_1 += 28, y523_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 28) (56 / 2)
			for (x657 = x658, x657_p_1 = x658_p_0, x657_p_0 = 0;
				x657 < x658 + 56;
				x657 += 2, x657_p_1 += 2, x657_p_0 += 2){
				...
				for (f = f257, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y523, yp_2 = y523_p_1, yp_1 = y523_p_0, yp_0 = 0;
						y < y523 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 2) (2 / 1)
						for (x656 = x657, x656_p_2 = x657_p_1, x656_p_1 = x657_p_0, x656_p_0 = 0;
							x656 < x657 + 2;
							x656 += 1, x656_p_2 += 1, x656_p_1 += 1, x656_p_0 += 1){
							...
							for (c399 = c400, c399_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x656, xp_3 = x656_p_2, xp_2 = x656_p_1, xp_1 = x656_p_0, xp_0 = 0;
									x < x656 + 1;
