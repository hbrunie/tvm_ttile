...
*/
IND_TYPE c, cp_0, c472_p_0, cp_1, c472, f, fp_0, f272_p_0, fp_1, f272, w, wp_0, x, xp_0, x372_p_0, xp_1, x372, y, yp_0;
					...
					for (w = w248, wp_0 = 0;
						...
						for (x = x372, xp_1 = x372_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_3149 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3149);
						}
					}
				}
			}
