...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (16, c); T (28, x); T (8, y); T (4, c)]
*/
IND_TYPE c, cp_0, c170_p_0, c171_p_0, cp_1, c170_p_1, cp_2, c170, c171, h, hp_0, w, wp_0, x, xp_0, x180_p_0, xp_1, x180, y, yp_0;
IND_TYPE y100 = 0;
IND_TYPE x181 = 0;
IND_TYPE h100 = 0;
IND_TYPE w100 = 0;
				...
				for (h = h100, hp_0 = 0;h < h100 + 3;h += 1, hp_0 += 1){
					...
					for (w = w100, wp_0 = 0;w < w100 + 3;w += 1, wp_0 += 1){
						...
						for (x = x180, xp_1 = x180_p_0, xp_0 = 0;x < x180 + 2;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 1) (1 / 1)
									for (c = c170, cp_2 = c170_p_1, cp_1 = c170_p_0, cp_0 = 0;c < c170 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
