				...
				for (x = x67, xp_0 = 0;
					...
					for (w = w46, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								mem_vec_596 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
								mem_vec_597 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_598 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_599 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_600 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_601 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								for (c = c75, cp_1 = c75_p_0, cp_0 = 0;
									...
									vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_595);
									mem_vec_595 = vec_15;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_596);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_597);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_598);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_599);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_600);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_601);
					}
				}
			}
		}
