...
for (x1212 = x1213, x1212_p_0 = 0;
	x1212 < x1213 + 272;
	x1212 += 68, x1212_p_0 += 68){
	// y = 272, x = 68, h = 3, w = 3, c = 32, f = 64
	// T (x, 34) (68 / 2)
	for (x1211 = x1212, x1211_p_1 = x1212_p_0, x1211_p_0 = 0;
		x1211 < x1212 + 68;
		x1211 += 2, x1211_p_1 += 2, x1211_p_0 += 2){
		...
		for (c726 = c727, c726_p_0 = 0;
			...
			for (y = y484, yp_0 = 0;
				...
				// T (x, 1) (2 / 2)
				for (x1210 = x1211, x1210_p_2 = x1211_p_1, x1210_p_1 = x1211_p_0, x1210_p_0 = 0;
					x1210 < x1211 + 2;
					x1210 += 2, x1210_p_2 += 2, x1210_p_1 += 2, x1210_p_0 += 2){
					// y = 4, x = 2, h = 3, w = 3, c = 1, f = 64
					// T (h, 3) (3 / 1)
					for (h = h484, hp_0 = 0;
						h < h484 + 3;
						...
						// T (x, 2) (2 / 1)
						for (x = x1210, xp_3 = x1210_p_2, xp_2 = x1210_p_1, xp_1 = x1210_p_0, xp_0 = 0;
							x < x1210 + 2;
