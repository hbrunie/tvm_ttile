...
for (x1232 = x1233, x1232_p_0 = 0;
	x1232 < x1233 + 272;
	x1232 += 68, x1232_p_0 += 68){
	// y = 272, x = 68, h = 3, w = 3, c = 32, f = 64
	// T (x, 68) (68 / 1)
	for (x1231 = x1232, x1231_p_1 = x1232_p_0, x1231_p_0 = 0;
		x1231 < x1232 + 68;
		x1231 += 1, x1231_p_1 += 1, x1231_p_0 += 1){
		...
		for (c738 = c739, c738_p_0 = 0;
			...
			for (y = y492, yp_0 = 0;
				...
				// T (x, 1) (1 / 1)
				for (x1230 = x1231, x1230_p_2 = x1231_p_1, x1230_p_1 = x1231_p_0, x1230_p_0 = 0;
					x1230 < x1231 + 1;
					x1230 += 1, x1230_p_2 += 1, x1230_p_1 += 1, x1230_p_0 += 1){
					// y = 4, x = 1, h = 3, w = 3, c = 2, f = 64
					// T (h, 3) (3 / 1)
					for (h = h492, hp_0 = 0;
						h < h492 + 3;
						...
						// T (x, 1) (1 / 1)
						for (x = x1230, xp_3 = x1230_p_2, xp_2 = x1230_p_1, xp_1 = x1230_p_0, xp_0 = 0;
							x < x1230 + 1;
