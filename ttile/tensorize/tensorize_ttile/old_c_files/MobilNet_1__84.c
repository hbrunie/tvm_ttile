	...
	for (c66 = c67, c66_p_0 = 0;
		...
		for (y = y44, yp_0 = 0;
			...
			for (x88 = x89, x88_p_1 = x89_p_0, x88_p_0 = 0;
				x88 < x89 + 112;
				x88 += 16, x88_p_1 += 16, x88_p_0 += 16){
				// y = 14, x = 16, h = 3, w = 3, c = 32, f = 32
				// T (h, 3) (3 / 1)
				for (h = h44, hp_0 = 0;
					h < h44 + 3;
					h += 1, hp_0 += 1){
					...
					for (w = w44, wp_0 = 0;
						...
						for (x = x88, xp_2 = x88_p_1, xp_1 = x88_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_372 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_373 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									mem_vec_374 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_375 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_376 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_377 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_378 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_379 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_372);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_373);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_374);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_375);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_376);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_377);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_378);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_379);
						}
					}
				}
			}
