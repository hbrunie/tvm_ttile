					...
					for (h = h360, hp_0 = 0;h < h360 + 3;h += 1, hp_0 += 1){
						...
						for (w = w380, wp_0 = 0;w < w380 + 3;w += 1, wp_0 += 1){
							...
							for (x = x760, xp_2 = x760_p_1, xp_1 = x760_p_0, xp_0 = 0;x < x760 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6624 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_6625 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
										mem_vec_6626 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_6627 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
										...
										for (c = c570, cp_1 = c570_p_0, cp_0 = 0;c < c570 + 4;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_6624);
											mem_vec_6624 = vec_38;
											vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_6625);
											mem_vec_6625 = vec_40;
											scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 13 + h) + c];
											vec_42 = _mm512_set1_ps(scal_13);
											vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_6626);
											mem_vec_6626 = vec_41;
											vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_6627);
											mem_vec_6627 = vec_43;
										}
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_6624);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_6625);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_6626);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_6627);
							}
						}
					}
}
