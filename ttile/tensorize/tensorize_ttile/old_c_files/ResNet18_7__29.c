...
[V f; U (1, f); U (14, y); U (3, h); T (4, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (16, f); T (32, c); T (1, x); T (1, y); T (1, f)]
*/
					...
					for (w = w220, wp_0 = 0;
						...
						for (x = x330, xp_1 = x330_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_2867 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_2868 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_2867);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2868);
