...
[V f; U (2, f); U (14, y); T (4, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (1, x); T (4, y); T (2, f); T (16, c); T (8, x)]
*/
					...
					for (h = h52, hp_0 = 0;h < h52 + 3;h += 1, hp_0 += 1){
						...
						for (w = w52, wp_0 = 0;w < w52 + 3;w += 1, wp_0 += 1){
							...
							for (x = x104, xp_2 = x104_p_1, xp_1 = x104_p_0, xp_0 = 0;x < x104 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_530 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_531 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										mem_vec_532 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_533 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
										mem_vec_534 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										mem_vec_535 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
										mem_vec_536 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_537 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
										mem_vec_538 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_539 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
										...
										for (c = c78, cp_1 = c78_p_0, cp_0 = 0;c < c78 + 4;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_530);
											mem_vec_530 = vec_29;
											vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_531);
											mem_vec_531 = vec_31;
											scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 10 + h) + c];
											vec_33 = _mm512_set1_ps(scal_10);
											vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_532);
											mem_vec_532 = vec_32;
											vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_533);
											mem_vec_533 = vec_34;
											scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 11 + h) + c];
											vec_36 = _mm512_set1_ps(scal_11);
											vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_534);
											mem_vec_534 = vec_35;
											vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_535);
											mem_vec_535 = vec_37;
											scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 12 + h) + c];
											vec_39 = _mm512_set1_ps(scal_12);
											vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_536);
											mem_vec_536 = vec_38;
											vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_537);
											mem_vec_537 = vec_40;
											scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 13 + h) + c];
											vec_42 = _mm512_set1_ps(scal_13);
											vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_538);
											mem_vec_538 = vec_41;
											vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_539);
											mem_vec_539 = vec_43;
										}
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_530);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_531);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_532);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_533);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_534);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_535);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_536);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_537);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_538);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_539);
							}
						}
					}
}
