...
[V f; U (4, f); U (7, y); T (64, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (2, c); T (8, f); T (1, x); T (2, y); T (4, c)]
*/
IND_TYPE c, cp_0, c216_p_0, c217_p_0, cp_1, c216_p_1, cp_2, c216, c217, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x162_p_0, xp_1, x162, y, yp_0;
IND_TYPE y108 = 0;
IND_TYPE x163 = 0;
IND_TYPE h108 = 0;
IND_TYPE w108 = 0;
