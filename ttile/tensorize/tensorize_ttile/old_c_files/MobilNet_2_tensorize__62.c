...
[V f; U (4, f); U (7, y); T (4, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, c); T (4, x); T (8, y); T (4, c)]
*/
IND_TYPE c, cp_0, c122_p_0, c123_p_0, cp_1, c122_p_1, cp_2, c122, c123, h, hp_0, w, wp_0, x, xp_0, x144_p_0, xp_1, x144, y, yp_0;
IND_TYPE y76 = 0;
IND_TYPE x145 = 0;
IND_TYPE h76 = 0;
IND_TYPE w76 = 0;
				...
				for (h = h76, hp_0 = 0;h < h76 + 3;h += 1, hp_0 += 1){
					...
					for (w = w76, wp_0 = 0;w < w76 + 3;w += 1, wp_0 += 1){
						...
						for (x = x144, xp_1 = x144_p_0, xp_0 = 0;x < x144 + 14;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 4) (4 / 1)
									for (c = c122, cp_2 = c122_p_1, cp_1 = c122_p_0, cp_0 = 0;c < c122 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
