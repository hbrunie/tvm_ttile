...
[V f; U (4, f); U (7, y); T (16, c); Hoist_vars [c]; T (3, w); T (3, h);
  T (7, x); T (4, c); T (1, y); T (16, f); T (1, c); T (16, c)]
*/
IND_TYPE c, cp_0, c290_p_0, c291_p_0, c292_p_0, cp_1, c290_p_1, c291_p_1, cp_2, c290_p_2, cp_3, c290, c291, c292, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
		...
		for (f = f116, fp_0 = 0;
			...
			for (y = y116, yp_0 = 0;
				...
				for (c290 = c291, c290_p_2 = c291_p_1, c290_p_1 = c291_p_0, c290_p_0 = 0;
					c290 < c291 + 64;
					c290 += 16, c290_p_2 += 16, c290_p_1 += 16, c290_p_0 += 16){
