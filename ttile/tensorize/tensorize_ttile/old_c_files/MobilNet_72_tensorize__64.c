...
c1124_p_1 = 0;
						for (h = h462, hp_0 = 0;h < h462 + 3;h += 1, hp_0 += 1){
							...
							for (x = x888, xp_1 = x888_p_0, xp_0 = 0;x < x888 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7562 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
										mem_vec_7563 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_7562);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_7563);
							}
						}
}
