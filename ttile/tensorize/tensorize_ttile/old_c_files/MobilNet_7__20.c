...
[V f; U (4, f); U (7, y); U (3, h); T (4, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (16, c); T (8, f); T (1, x); T (2, y); T (8, c)]
*/
IND_TYPE c, cp_0, c620_p_0, c621_p_0, cp_1, c620_p_1, cp_2, c620, c621, f, fp_0, w, wp_0, x, xp_0, x510_p_0, xp_1, x510, y, yp_0;
