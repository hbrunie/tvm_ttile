...
c585_p_0 = 0;
							for (w = w367, wp_0 = 0;w < w367 + 3;w += 1, wp_0 += 1){
								...
								for (x = x641, xp_1 = x641_p_0, xp_0 = 0;x < x641 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4755 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											...
											mem_vec_4761 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_4755);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_4761);
