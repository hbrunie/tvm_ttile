...
for (x1122 = x1123, x1122_p_0 = 0;
	x1122 < x1123 + 272;
	x1122 += 136, x1122_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 136) (136 / 1)
	for (x1121 = x1122, x1121_p_1 = x1122_p_0, x1121_p_0 = 0;
		x1121 < x1122 + 136;
		x1121 += 1, x1121_p_1 += 1, x1121_p_0 += 1){
		...
		for (c672 = c673, c672_p_0 = 0;
			...
			for (y = y448, yp_0 = 0;
				...
				// T (x, 1) (1 / 1)
				for (x1120 = x1121, x1120_p_2 = x1121_p_1, x1120_p_1 = x1121_p_0, x1120_p_0 = 0;
					x1120 < x1121 + 1;
					x1120 += 1, x1120_p_2 += 1, x1120_p_1 += 1, x1120_p_0 += 1){
					// y = 4, x = 1, h = 3, w = 3, c = 8, f = 64
					// T (h, 3) (3 / 1)
					for (h = h448, hp_0 = 0;
						h < h448 + 3;
						...
						// T (x, 1) (1 / 1)
						for (x = x1120, xp_3 = x1120_p_2, xp_2 = x1120_p_1, xp_1 = x1120_p_0, xp_0 = 0;
							x < x1120 + 1;
