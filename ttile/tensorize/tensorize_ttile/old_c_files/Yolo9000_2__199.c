...
for (x1402 = x1403, x1402_p_0 = 0;
	...
	// T (x, 2) (8 / 4)
	for (x1401 = x1402, x1401_p_1 = x1402_p_0, x1401_p_0 = 0;
		x1401 < x1402 + 8;
		x1401 += 4, x1401_p_1 += 4, x1401_p_0 += 4){
		...
		for (c840 = c841, c840_p_0 = 0;
			...
			for (y = y560, yp_0 = 0;
				...
				// T (x, 4) (4 / 1)
				for (x1400 = x1401, x1400_p_2 = x1401_p_1, x1400_p_1 = x1401_p_0, x1400_p_0 = 0;
					x1400 < x1401 + 4;
					x1400 += 1, x1400_p_2 += 1, x1400_p_1 += 1, x1400_p_0 += 1){
					...
					for (h = h560, hp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x = x1400, xp_3 = x1400_p_2, xp_2 = x1400_p_1, xp_1 = x1400_p_0, xp_0 = 0;
							x < x1400 + 1;
