...
[V f; U (1, f); U (14, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, h); T (2, c); T (16, f); T (14, x); T (1, y); T (8, c)]
*/
					...
					for (h = h0, hp_0 = 0;h < h0 + 3;h += 3, hp_0 += 3){
						...
						for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
							...
							for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_10 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_11 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										mem_vec_12 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_13 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										// y = 14, x = 1, h = 3, w = 1, c = 16, f = 16
										// T (c, 16) (16 / 1)
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_10);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_11);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_12);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_13);
							}
						}
					}
}
