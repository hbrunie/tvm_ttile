...
[V f; U (4, f); U (7, y); T (4, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (128, c); T (1, f); T (1, y); T (2, c); T (16, f)]
*/
IND_TYPE c, cp_0, c144_p_0, c145_p_0, cp_1, c144_p_1, cp_2, c144, c145, f, fp_0, f108_p_0, fp_1, f108, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y72 = 0;
IND_TYPE x72 = 0;
IND_TYPE h72 = 0;
IND_TYPE w72 = 0;
