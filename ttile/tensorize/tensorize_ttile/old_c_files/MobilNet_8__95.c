...
[V f; U (4, f); U (7, y); U (3, h); T (256, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, c); T (8, f); T (1, y); T (2, c)]
*/
IND_TYPE c, cp_0, c520_p_0, c521_p_0, cp_1, c520_p_1, cp_2, c520, c521, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
	...
	for (y = y260, yp_0 = 0;
		...
		for (f = f260, fp_0 = 0;
			...
			for (c520 = c521, c520_p_1 = c521_p_0, c520_p_0 = 0;
				c520 < c521 + 256;
				c520 += 256, c520_p_1 += 256, c520_p_0 += 256){
				// y = 7, x = 7, h = 3, w = 3, c = 256, f = 64
				// T (w, 3) (3 / 1)
				for (w = w260, wp_0 = 0;
					w < w260 + 3;
