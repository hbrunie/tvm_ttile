...
[V f; U (4, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (16, c); T (16, f); T (1, y); T (2, c); T (1, f)]
*/
IND_TYPE c, cp_0, c720_p_0, c721_p_0, cp_1, c720_p_1, cp_2, c720, c721, f, fp_0, f540_p_0, fp_1, f540, w, wp_0, x, xp_0, y, yp_0;
...
for (f540 = f541, f540_p_0 = 0;
	f540 < f541 + 1024;
	f540 += 1024, f540_p_0 += 1024){
	// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
	// T (c, 2) (1024 / 512)
	for (c721 = c722, c721_p_0 = 0;
		c721 < c722 + 1024;
		c721 += 512, c721_p_0 += 512){
		...
		for (y = y360, yp_0 = 0;
			...
			for (f = f540, fp_1 = f540_p_0, fp_0 = 0;
				...
				for (c720 = c721, c720_p_1 = c721_p_0, c720_p_0 = 0;
					c720 < c721 + 512;
					c720 += 32, c720_p_1 += 32, c720_p_0 += 32){
