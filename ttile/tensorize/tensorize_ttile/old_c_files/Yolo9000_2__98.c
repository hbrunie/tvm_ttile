...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, x); T (68, y); T (1, c); T (17, x); T (8, x)]
*/
IND_TYPE c, cp_0, c756_p_0, cp_1, c756, h, hp_0, x, xp_0, x1260_p_0, x1261_p_0, x1262_p_0, xp_1, x1260_p_1, x1261_p_1, xp_2, x1260_p_2, xp_3, x1260, x1261, x1262, y, yp_0;
...
for (x1262 = x1263, x1262_p_0 = 0;
	x1262 < x1263 + 272;
	x1262 += 34, x1262_p_0 += 34){
	// y = 272, x = 34, h = 3, w = 3, c = 32, f = 64
	// T (x, 17) (34 / 2)
	for (x1261 = x1262, x1261_p_1 = x1262_p_0, x1261_p_0 = 0;
		x1261 < x1262 + 34;
		x1261 += 2, x1261_p_1 += 2, x1261_p_0 += 2){
		...
		for (c756 = c757, c756_p_0 = 0;
			...
			for (y = y504, yp_0 = 0;
				...
				// T (x, 1) (2 / 2)
				for (x1260 = x1261, x1260_p_2 = x1261_p_1, x1260_p_1 = x1261_p_0, x1260_p_0 = 0;
					x1260 < x1261 + 2;
					x1260 += 2, x1260_p_2 += 2, x1260_p_1 += 2, x1260_p_0 += 2){
					// y = 4, x = 2, h = 3, w = 3, c = 32, f = 64
					// T (h, 3) (3 / 1)
					for (h = h504, hp_0 = 0;
						h < h504 + 3;
						...
						// T (x, 2) (2 / 1)
						for (x = x1260, xp_3 = x1260_p_2, xp_2 = x1260_p_1, xp_1 = x1260_p_0, xp_0 = 0;
							x < x1260 + 2;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c756, cp_1 = c756_p_0, cp_0 = 0;
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_4032);
										mem_vec_4032 = vec_24;

										vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_4033);
										mem_vec_4033 = vec_27;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_4034);
										mem_vec_4034 = vec_29;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_4035);
										mem_vec_4035 = vec_31;
										scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_34 = _mm512_set1_ps(scal_5);


										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_4036);
										mem_vec_4036 = vec_33;



										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_4037);
										mem_vec_4037 = vec_35;



										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_4038);
										mem_vec_4038 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_4039);
										mem_vec_4039 = vec_37;
										scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_4040);
										mem_vec_4040 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_4041);
										mem_vec_4041 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_4042);
										mem_vec_4042 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_4043);
										mem_vec_4043 = vec_42;
										scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_44 = _mm512_set1_ps(scal_7);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_4044);
										mem_vec_4044 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_4045);
										mem_vec_4045 = vec_45;



										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_4046);
										mem_vec_4046 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_4047);
										mem_vec_4047 = vec_47;
										scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_4032);
										mem_vec_4032 = vec_48;

										vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_4033);
										mem_vec_4033 = vec_51;

										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_4034);
										mem_vec_4034 = vec_53;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_4035);
										mem_vec_4035 = vec_55;
										scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_58 = _mm512_set1_ps(scal_9);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_4036);
										mem_vec_4036 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_4037);
										mem_vec_4037 = vec_59;



										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_4038);
										mem_vec_4038 = vec_60;



										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_4039);
										mem_vec_4039 = vec_61;
										scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_63 = _mm512_set1_ps(scal_10);


										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_4040);
										mem_vec_4040 = vec_62;



										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_4041);
										mem_vec_4041 = vec_64;



										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_4042);
										mem_vec_4042 = vec_65;



										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_4043);
										mem_vec_4043 = vec_66;
										scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_4044);
										mem_vec_4044 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_4045);
										mem_vec_4045 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_4046);
										mem_vec_4046 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_4047);
										mem_vec_4047 = vec_71;
									}
