...
[V f; U (2, f); ULambda y; T (128, c); Hoist_vars [c]; T (2, x);
  ...
  T (68, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x51_p_0, xp_1, x51, y, yp_0, y51_p_0, yp_1, y51;
IND_TYPE y52 = 0;
IND_TYPE x52 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x51_p_0 = 0;
		for (f = f34, fp_0 = 0;f < f34 + 64;f += 32, fp_0 += 32){
				for (y = y51, yp_1 = y51_p_0, yp_0 = 0;y < y51 + 40;y += 8, yp_1 += 8, yp_0 += 8){
					// y = ph_y, x = 2, h = 1, w = 1, c = 128, f = 32
					// T (x, 2) (2 / 1)
					for (x = x51, xp_1 = x51_p_0, xp_0 = 0;x < x51 + 2;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 128) (128 / 1)
								for (c = c34, cp_0 = 0;c < c34 + 128;c += 1, cp_0 += 1){
				...
				for (y = y51 + 40, yp_1 = y51_p_0, yp_0 = 0;y < y51 + 40 + 28;y += 14, yp_1 += 14, yp_0 += 14){
					// y = ph_y, x = 2, h = 1, w = 1, c = 128, f = 32
					// T (x, 2) (2 / 1)
					for (x = x51, xp_1 = x51_p_0, xp_0 = 0;x < x51 + 2;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_724 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
								mem_vec_725 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
								mem_vec_726 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
								mem_vec_727 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
								mem_vec_728 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
								mem_vec_729 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
								mem_vec_730 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
								mem_vec_731 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c34, cp_0 = 0;c < c34 + 128;c += 1, cp_0 += 1){
									scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
									...
									vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_726);
									mem_vec_726 = vec_35;
									vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_727);
									mem_vec_727 = vec_37;
									scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 12 + h) + c];
									vec_39 = _mm512_set1_ps(scal_12);
									vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_728);
									mem_vec_728 = vec_38;
									vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_729);
									mem_vec_729 = vec_40;
									scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 13 + h) + c];
									vec_42 = _mm512_set1_ps(scal_13);
									vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_730);
									mem_vec_730 = vec_41;
									vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_731);
									mem_vec_731 = vec_43;
								}
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_724);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_725);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_726);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_727);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_728);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_729);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_730);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_731);
					}
				}
		}
}
