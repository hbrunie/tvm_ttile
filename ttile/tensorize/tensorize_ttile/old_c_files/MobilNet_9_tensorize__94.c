...
*/
IND_TYPE c, cp_0, c152_p_0, c153_p_0, cp_1, c152_p_1, cp_2, c152, c153, f, fp_0, f114_p_0, fp_1, f114, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y76 = 0;
IND_TYPE x76 = 0;
IND_TYPE h76 = 0;
IND_TYPE w76 = 0;
					...
					for (h = h76, hp_0 = 0;h < h76 + 3;h += 1, hp_0 += 1){
						...
						for (w = w76, wp_0 = 0;w < w76 + 3;w += 1, wp_0 += 1){
							...
							for (x = x76, xp_0 = 0;x < x76 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 2) (2 / 1)
										for (c = c152, cp_2 = c152_p_1, cp_1 = c152_p_0, cp_0 = 0;c < c152 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
