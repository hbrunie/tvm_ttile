...
[V f; U (4, f); U (7, y); U (3, h); T (2, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, c); T (8, f); T (14, x); T (2, y); T (256, c)]
*/
IND_TYPE c, cp_0, c852_p_0, c853_p_0, cp_1, c852_p_1, cp_2, c852, c853, f, fp_0, w, wp_0, x, xp_0, x684_p_0, xp_1, x684, y, yp_0;
