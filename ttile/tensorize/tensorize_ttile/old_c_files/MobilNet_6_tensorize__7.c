...
fp_1 = 0;
					for (h = h348, hp_0 = 0;h < h348 + 3;h += 1, hp_0 += 1){
						...
						for (x = x744, xp_1 = x744_p_0, xp_0 = 0;x < x744 + 14;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_5514 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_5515 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_5514);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_5515);
						}
					}
}
