...
[V f; U (4, f); U (7, y); U (3, h); T (2, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (64, c); T (8, f); T (1, x); T (2, y); T (4, c)]
*/
IND_TYPE c, cp_0, c596_p_0, c597_p_0, cp_1, c596_p_1, cp_2, c596, c597, f, fp_0, w, wp_0, x, xp_0, x492_p_0, xp_1, x492, y, yp_0;
