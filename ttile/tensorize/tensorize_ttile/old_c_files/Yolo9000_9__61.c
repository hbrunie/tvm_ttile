...
for (y168 = y169, y168_p_0 = 0;
	...
	for (x225 = x226, x225_p_0 = 0;
		...
		x225 += 68, x225_p_0 += 68){
			...
			for (y = y168 + 26, yp_1 = y168_p_0, yp_0 = 0;
				y < y168 + 26 + 42;
						...
						for (c168 = c169, c168_p_0 = 0;
							...
							for (x = x224, xp_2 = x224_p_1, xp_1 = x224_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2872 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_2873 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 64, f = 32
										// T (c, 64) (64 / 1)
										for (c = c168, cp_1 = c168_p_0, cp_0 = 0;
											c < c168 + 64;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_2872);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_2873);
							}
						}
					}
				}
