...
for (y468 = y469, y468_p_0 = 0;
	...
	for (x588 = x589, x588_p_0 = 0;
		...
		// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 1) (28 / 28)
		for (y467 = y468, y467_p_1 = y468_p_0, y467_p_0 = 0;
			y467 < y468 + 28;
			y467 += 28, y467_p_1 += 28, y467_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (56 / 4)
			for (x587 = x588, x587_p_1 = x588_p_0, x587_p_0 = 0;
				x587 < x588 + 56;
				x587 += 4, x587_p_1 += 4, x587_p_0 += 4){
				...
				for (f = f229, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y467, yp_2 = y467_p_1, yp_1 = y467_p_0, yp_0 = 0;
						y < y467 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 4, h = 1, w = 1, c = 64, f = 32
						// T (x, 2) (4 / 2)
						for (x586 = x587, x586_p_2 = x587_p_1, x586_p_1 = x587_p_0, x586_p_0 = 0;
							x586 < x587 + 4;
							x586 += 2, x586_p_2 += 2, x586_p_1 += 2, x586_p_0 += 2){
							...
							for (c357 = c358, c357_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x586, xp_3 = x586_p_2, xp_2 = x586_p_1, xp_1 = x586_p_0, xp_0 = 0;
									x < x586 + 2;
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2852 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_2853 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
											mem_vec_2854 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_2855 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2852);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_2853);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_2854);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_2855);
								}
							}
						}
					}
