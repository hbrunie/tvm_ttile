...
[V f; U (4, f); U (7, y); U (3, h); T (1, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (512, c); T (8, f); T (2, x); T (2, y); T (1, c)]
*/
IND_TYPE c, cp_0, c668_p_0, c669_p_0, cp_1, c668_p_1, cp_2, c668, c669, f, fp_0, w, wp_0, x, xp_0, x546_p_0, xp_1, x546, y, yp_0;
