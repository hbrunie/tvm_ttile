...
[V f; U (4, f); U (4, y); U (3, w); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, x); T (68, y); T (8, c); T (68, x); T (2, x)]
*/
IND_TYPE c, cp_0, c654_p_0, cp_1, c654, h, hp_0, x, xp_0, x1090_p_0, x1091_p_0, x1092_p_0, xp_1, x1090_p_1, x1091_p_1, xp_2, x1090_p_2, xp_3, x1090, x1091, x1092, y, yp_0;
...
for (x1092 = x1093, x1092_p_0 = 0;
	x1092 < x1093 + 272;
	x1092 += 136, x1092_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 68) (136 / 2)
	for (x1091 = x1092, x1091_p_1 = x1092_p_0, x1091_p_0 = 0;
		x1091 < x1092 + 136;
		x1091 += 2, x1091_p_1 += 2, x1091_p_0 += 2){
		...
		for (c654 = c655, c654_p_0 = 0;
			...
			for (y = y436, yp_0 = 0;
				...
				// T (x, 1) (2 / 2)
				for (x1090 = x1091, x1090_p_2 = x1091_p_1, x1090_p_1 = x1091_p_0, x1090_p_0 = 0;
					x1090 < x1091 + 2;
					x1090 += 2, x1090_p_2 += 2, x1090_p_1 += 2, x1090_p_0 += 2){
					// y = 4, x = 2, h = 3, w = 3, c = 4, f = 64
					// T (h, 3) (3 / 1)
					for (h = h436, hp_0 = 0;
						h < h436 + 3;
						...
						// T (x, 2) (2 / 1)
						for (x = x1090, xp_3 = x1090_p_2, xp_2 = x1090_p_1, xp_1 = x1090_p_0, xp_0 = 0;
							x < x1090 + 2;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c654, cp_1 = c654_p_0, cp_0 = 0;
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_3488);
										mem_vec_3488 = vec_24;

										vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_3489);
										mem_vec_3489 = vec_27;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_3490);
										mem_vec_3490 = vec_29;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_3491);
										mem_vec_3491 = vec_31;
										scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_34 = _mm512_set1_ps(scal_5);


										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_3492);
										mem_vec_3492 = vec_33;



										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_3493);
										mem_vec_3493 = vec_35;



										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_3494);
										mem_vec_3494 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_3495);
										mem_vec_3495 = vec_37;
										scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_3496);
										mem_vec_3496 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_3497);
										mem_vec_3497 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_3498);
										mem_vec_3498 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_3499);
										mem_vec_3499 = vec_42;
										scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_44 = _mm512_set1_ps(scal_7);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_3500);
										mem_vec_3500 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_3501);
										mem_vec_3501 = vec_45;



										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_3502);
										mem_vec_3502 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_3503);
										mem_vec_3503 = vec_47;
										scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_3488);
										mem_vec_3488 = vec_48;

										vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_3489);
										mem_vec_3489 = vec_51;

										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_3490);
										mem_vec_3490 = vec_53;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_3491);
										mem_vec_3491 = vec_55;
										scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_58 = _mm512_set1_ps(scal_9);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_3492);
										mem_vec_3492 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_3493);
										mem_vec_3493 = vec_59;



										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_3494);
										mem_vec_3494 = vec_60;



										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_3495);
										mem_vec_3495 = vec_61;
										scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_63 = _mm512_set1_ps(scal_10);


										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_3496);
										mem_vec_3496 = vec_62;



										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_3497);
										mem_vec_3497 = vec_64;



										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_3498);
										mem_vec_3498 = vec_65;



										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_3499);
										mem_vec_3499 = vec_66;
										scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_3500);
										mem_vec_3500 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_3501);
										mem_vec_3501 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_3502);
										mem_vec_3502 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_3503);
										mem_vec_3503 = vec_71;
									}
