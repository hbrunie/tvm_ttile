...
fp_2 = 0;
							for (w = w616, wp_0 = 0;w < w616 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 34) (34 / 1)
								for (x = x1016, xp_1 = x1016_p_0, xp_0 = 0;x < x1016 + 34;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_11750 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
											mem_vec_11751 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
											mem_vec_11752 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
											mem_vec_11753 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 32, f = 64
											// T (c, 32) (32 / 1)
											for (c = c1016, cp_1 = c1016_p_0, cp_0 = 0;c < c1016 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_11750);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_11751);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_11752);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_11753);
								}
							}
}
