...
/*
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (4, y); T (4, f); T (64, c); T (1, f); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c138_p_0, cp_1, c138, f, fp_0, f138_p_0, f139_p_0, fp_1, f138_p_1, fp_2, f138, f139, h, hp_0, w, wp_0, x, xp_0, x138_p_0, xp_1, x138, y, yp_0;
