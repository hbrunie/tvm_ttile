			...
			for (f = f124, fp_0 = 0;
				...
				for (y = y124, yp_0 = 0;
					...
					for (x310 = x311, x310_p_2 = x311_p_1, x310_p_1 = x311_p_0, x310_p_0 = 0;
						x310 < x311 + 34;
						x310 += 34, x310_p_2 += 34, x310_p_1 += 34, x310_p_0 += 34){
						// y = 8, x = 34, h = 3, w = 3, c = 32, f = 32
						// T (h, 3) (3 / 1)
						for (h = h124, hp_0 = 0;
							h < h124 + 3;
							...
							for (w = w124, wp_0 = 0;
								...
								for (x = x310, xp_3 = x310_p_2, xp_2 = x310_p_1, xp_1 = x310_p_0, xp_0 = 0;
									...
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_1006 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
											mem_vec_1007 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_1006);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_1007);
								}
							}
						}
					}
