...
[V f; U (1, f); U (14, y); U (3, h); T (2, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (16, f); T (64, c); T (7, x); T (1, y); T (1, f)]
*/
IND_TYPE c, cp_0, c462_p_0, cp_1, c462, f, fp_0, f462_p_0, fp_1, f462, w, wp_0, x, xp_0, x462_p_0, xp_1, x462, y, yp_0;
					...
					for (w = w308, wp_0 = 0;
						...
						for (x = x462, xp_1 = x462_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_3483 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_3484 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_3485 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3483);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_3484);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3485);
						}
					}
				}
			}
