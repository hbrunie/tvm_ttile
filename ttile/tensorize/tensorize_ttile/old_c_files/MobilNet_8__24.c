...
[V f; U (4, f); U (7, y); U (3, h); T (512, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, c); T (8, f); T (1, y); T (1, c)]
*/
IND_TYPE c, cp_0, c440_p_0, c441_p_0, cp_1, c440_p_1, cp_2, c440, c441, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
	...
	for (y = y220, yp_0 = 0;
		...
		for (f = f220, fp_0 = 0;
			...
			for (c440 = c441, c440_p_1 = c441_p_0, c440_p_0 = 0;
				c440 < c441 + 512;
				c440 += 512, c440_p_1 += 512, c440_p_0 += 512){
				// y = 7, x = 7, h = 3, w = 3, c = 512, f = 64
				// T (w, 3) (3 / 1)
				for (w = w220, wp_0 = 0;
					w < w220 + 3;
