				...
				for (w = w200, wp_0 = 0;w < w200 + 3;w += 1, wp_0 += 1){
					...
					for (x = x414, xp_2 = x414_p_1, xp_1 = x414_p_0, xp_0 = 0;x < x414 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
						...
						for (h = h195, hp_0 = 0;h < h195 + 3;h += 1, hp_0 += 1){
									...
									mem_vec_3402 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
									mem_vec_3403 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
									...
									mem_vec_3406 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_3407 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_3402);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_3403);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_3406);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_3407);
						}
					}
				}
}
