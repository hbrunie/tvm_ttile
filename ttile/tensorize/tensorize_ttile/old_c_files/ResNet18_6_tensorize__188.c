...
/*
[V f; U (2, f); U (14, y); T (128, c); Hoist_vars [c]; T (4, x); T (3, w);
...
fp_1 = 0;
					for (h = h28, hp_0 = 0;h < h28 + 3;h += 1, hp_0 += 1){
						// y = 14, x = 4, h = 1, w = 3, c = 128, f = 32
						// T (w, 3) (3 / 1)
						for (w = w28, wp_0 = 0;w < w28 + 3;w += 1, wp_0 += 1){
							// y = 14, x = 4, h = 1, w = 1, c = 128, f = 32
							// T (x, 4) (4 / 1)
							for (x = x42, xp_1 = x42_p_0, xp_0 = 0;x < x42 + 4;x += 1, xp_1 += 1, xp_0 += 1){
