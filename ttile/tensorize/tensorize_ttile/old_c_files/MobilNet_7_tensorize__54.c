...
[V f; U (2, f); U (14, y); T (1, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (16, c); T (16, f); T (1, x); T (1, y); T (32, c)]
*/
IND_TYPE c, cp_0, c56_p_0, c57_p_0, cp_1, c56_p_1, cp_2, c56, c57, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x42_p_0, xp_1, x42, y, yp_0;
IND_TYPE y28 = 0;
IND_TYPE x43 = 0;
IND_TYPE h28 = 0;
IND_TYPE w28 = 0;
					...
					for (h = h28, hp_0 = 0;h < h28 + 3;h += 1, hp_0 += 1){
						...
						for (w = w28, wp_0 = 0;w < w28 + 3;w += 1, wp_0 += 1){
							...
							for (x = x42, xp_1 = x42_p_0, xp_0 = 0;x < x42 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_418 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_419 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
										// y = 14, x = 1, h = 1, w = 1, c = 1, f = 32
										// T (c, 1) (1 / 1)
										for (c = c56, cp_2 = c56_p_1, cp_1 = c56_p_0, cp_0 = 0;c < c56 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_418);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_419);
							}
						}
					}
}
