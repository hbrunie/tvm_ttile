...
c1004_p_1 = 0;
					for (h = h402, hp_0 = 0;h < h402 + 3;h += 1, hp_0 += 1){
						...
						for (x = x798, xp_1 = x798_p_0, xp_0 = 0;x < x798 + 2;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_6634 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_6635 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_6634);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_6635);
						}
					}
}
