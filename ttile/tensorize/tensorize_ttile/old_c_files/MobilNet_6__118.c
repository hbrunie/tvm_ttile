...
[V f; U (1, f); U (14, y); U (3, h); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (256, c); T (7, x); T (1, y); T (16, f)]
*/
					...
					for (w = w328, wp_0 = 0;
						...
						for (x = x492, xp_1 = x492_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_3613 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									...
									mem_vec_3619 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_3620 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_3621 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_3622 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_3623 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									...
									for (c = c492, cp_1 = c492_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_3613);
										mem_vec_3613 = vec_3;
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_3615);
										mem_vec_3615 = vec_7;
										...
										vec_11 = _mm512_fmadd_ps(vec_12, vec_2, mem_vec_3617);
										mem_vec_3617 = vec_11;
										scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h) + c];
										vec_14 = _mm512_set1_ps(scal_6);


										vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_3618);
										mem_vec_3618 = vec_13;
										scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 7) + h) + c];
										vec_16 = _mm512_set1_ps(scal_7);


										vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_3619);
										mem_vec_3619 = vec_15;
										...
										vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_3621);
										mem_vec_3621 = vec_19;
										scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 10) + h) + c];
										vec_22 = _mm512_set1_ps(scal_10);


										vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_3622);
										mem_vec_3622 = vec_21;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_3619);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_3620);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_3621);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_3622);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3623);
