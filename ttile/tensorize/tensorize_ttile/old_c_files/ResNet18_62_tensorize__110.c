						...
						for (h = h380, hp_0 = 0;h < h380 + 3;h += 1, hp_0 += 1){
							...
							for (w = w412, wp_0 = 0;w < w412 + 3;w += 1, wp_0 += 1){
								...
								for (x = x678, xp_1 = x678_p_0, xp_0 = 0;x < x678 + 14;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_5982 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_5983 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
											mem_vec_5984 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_5985 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_5982);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_5983);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_5984);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_5985);
								}
							}
						}
}
