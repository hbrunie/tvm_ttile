							...
							for (w = w79, wp_0 = 0;w < w79 + 3;w += 1, wp_0 += 1){
								...
								for (x = x126, xp_1 = x126_p_0, xp_0 = 0;x < x126 + 17;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (h = h84, hp_0 = 0;h < h84 + 3;h += 1, hp_0 += 1){
												...
												mem_vec_1768 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
												mem_vec_1769 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
												mem_vec_1770 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
												mem_vec_1771 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_1768);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_1769);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_1770);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_1771);
									}
								}
							}
}
