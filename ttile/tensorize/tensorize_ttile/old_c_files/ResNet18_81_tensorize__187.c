						...
						for (h = h450, hp_0 = 0;h < h450 + 3;h += 1, hp_0 += 1){
							...
							for (w = w474, wp_0 = 0;w < w474 + 3;w += 1, wp_0 += 1){
								...
								for (x = x786, xp_1 = x786_p_0, xp_0 = 0;x < x786 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_7236 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
											mem_vec_7237 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_7236);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_7237);
								}
							}
						}
}
