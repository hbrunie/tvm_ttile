...
/*
[V f; U (2, f); U (8, y); T (8, c); Hoist_vars [c]; T (17, x); T (3, w);
  T (3, h); T (2, x); T (17, y); T (4, f); T (8, c); T (4, x)]
*/
			...
			for (y = y20, yp_0 = 0;
				...
				for (x40 = x41, x40_p_1 = x41_p_0, x40_p_0 = 0;
					...
					for (h = h20, hp_0 = 0;
						h < h20 + 3;
						h += 1, hp_0 += 1){
						// y = 8, x = 17, h = 1, w = 3, c = 8, f = 32
						// T (w, 3) (3 / 1)
						for (w = w20, wp_0 = 0;
							w < w20 + 3;
							w += 1, wp_0 += 1){
							// y = 8, x = 17, h = 1, w = 1, c = 8, f = 32
							// T (x, 17) (17 / 1)
