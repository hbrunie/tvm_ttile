...
[V f; U (4, f); U (7, y); U (3, h); T (16, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (4, y); T (1, f); T (4, c); T (1, f); T (4, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c450_p_0, c451_p_0, cp_1, c450_p_1, cp_2, c450, c451, f, fp_0, f460_p_0, f461_p_0, fp_1, f460_p_1, fp_2, f460, f461, w, wp_0, x, xp_0, x354_p_0, xp_1, x354, y, yp_0;
		...
		for (c451 = c452, c451_p_0 = 0;
			...
			for (f460 = f461, f460_p_1 = f461_p_0, f460_p_0 = 0;
				...
				for (c450 = c451, c450_p_1 = c451_p_0, c450_p_0 = 0;
					c450 < c451 + 64;
					c450 += 16, c450_p_1 += 16, c450_p_0 += 16){
