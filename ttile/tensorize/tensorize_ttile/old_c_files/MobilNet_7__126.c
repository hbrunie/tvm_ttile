...
[V f; U (1, f); U (14, y); U (3, h); T (128, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (8, f); T (4, c); T (7, x); T (1, y); T (4, f)]
*/
IND_TYPE c, cp_0, c502_p_0, cp_1, c502, f, fp_0, f302_p_0, fp_1, f302, w, wp_0, x, xp_0, x402_p_0, xp_1, x402, y, yp_0;
					...
					for (w = w268, wp_0 = 0;
						...
						for (x = x402, xp_1 = x402_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_3282 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_3283 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_3284 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_3285 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_3286 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_3287 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_3288 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_3289 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									...
									for (c = c502, cp_1 = c502_p_0, cp_0 = 0;
										...
										vec_11 = _mm512_fmadd_ps(vec_12, vec_2, mem_vec_3281);
										mem_vec_3281 = vec_11;
										scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
										vec_14 = _mm512_set1_ps(scal_6);


										vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_3282);
										mem_vec_3282 = vec_13;
										scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
										vec_16 = _mm512_set1_ps(scal_7);


										vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_3283);
										mem_vec_3283 = vec_15;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h) + c];
										vec_18 = _mm512_set1_ps(scal_8);


										vec_17 = _mm512_fmadd_ps(vec_18, vec_2, mem_vec_3284);
										mem_vec_3284 = vec_17;
										...
										vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_3286);
										mem_vec_3286 = vec_21;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_3282);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_3283);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_3284);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_3285);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_3286);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3287);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_3288);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3289);
						}
					}
				}
			}
