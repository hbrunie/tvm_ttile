...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (16, c); T (2, f); T (16, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c272_p_0, c273_p_0, cp_1, c272_p_1, cp_2, c272, c273, f, fp_0, f260_p_0, f261_p_0, fp_1, f260_p_1, fp_2, f260, f261, h, hp_0, w, wp_0, x, xp_0, x204_p_0, xp_1, x204, y, yp_0;
IND_TYPE y136 = 0;
IND_TYPE x205 = 0;
IND_TYPE h136 = 0;
IND_TYPE w136 = 0;
