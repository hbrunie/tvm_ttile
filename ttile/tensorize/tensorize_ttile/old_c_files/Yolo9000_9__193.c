...
for (y84 = y85, y84_p_0 = 0;
	...
	for (x113 = x114, x113_p_0 = 0;
		...
		x113 += 68, x113_p_0 += 68){
			...
			for (y = y84 + 8, yp_1 = y84_p_0, yp_0 = 0;
				y < y84 + 8 + 60;
						...
						for (c84 = c85, c84_p_0 = 0;
							...
							for (x = x112, xp_2 = x112_p_1, xp_1 = x112_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1488 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
										mem_vec_1489 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 64, f = 32
										// T (c, 64) (64 / 1)
										for (c = c84, cp_1 = c84_p_0, cp_0 = 0;
											c < c84 + 64;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_1488);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_1489);
							}
						}
					}
				}
