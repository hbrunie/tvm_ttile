						...
						for (h = h354, hp_0 = 0;h < h354 + 3;h += 1, hp_0 += 1){
							...
							for (w = w428, wp_0 = 0;w < w428 + 3;w += 1, wp_0 += 1){
								...
								for (x = x684, xp_1 = x684_p_0, xp_0 = 0;x < x684 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6008 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
											mem_vec_6009 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
											mem_vec_6010 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
											mem_vec_6011 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_6008);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_6009);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_6010);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_6011);
								}
							}
						}
}
