...
*/
IND_TYPE c, cp_0, c1124_p_0, c1125_p_0, cp_1, c1124_p_1, cp_2, c1124, c1125, f, fp_0, h, hp_0, x, xp_0, x888_p_0, xp_1, x888, y, yp_0;
IND_TYPE y592 = 0;
IND_TYPE x889 = 0;
IND_TYPE h462 = 0;
IND_TYPE w = 0;
...
c1124_p_1 = 0;
						for (h = h462, hp_0 = 0;h < h462 + 3;h += 1, hp_0 += 1){
							...
							for (x = x888, xp_1 = x888_p_0, xp_0 = 0;x < x888 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7538 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
										mem_vec_7539 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
										mem_vec_7540 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_7541 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
										mem_vec_7542 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
										mem_vec_7543 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
										// y = ph_y, x = 1, h = 1, w = 3, c = 16, f = 64
										// T (c, 16) (16 / 1)
										for (c = c1124, cp_2 = c1124_p_1, cp_1 = c1124_p_0, cp_0 = 0;c < c1124 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_7538);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_7539);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_7540);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_7541);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_7542);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_7543);
							}
						}
}
