...
[V f; U (4, f); U (7, y); T (16, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, y); T (4, f); T (1, c); T (1, f); T (16, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c176_p_0, c177_p_0, cp_1, c176_p_1, cp_2, c176, c177, f, fp_0, f164_p_0, f165_p_0, fp_1, f164_p_1, fp_2, f164, f165, h, hp_0, w, wp_0, x, xp_0, x132_p_0, xp_1, x132, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x133 = 0;
IND_TYPE h88 = 0;
IND_TYPE w88 = 0;
