...
*/
IND_TYPE c, cp_0, c1172_p_0, c1173_p_0, cp_1, c1172_p_1, cp_2, c1172, c1173, f, fp_0, h, hp_0, x, xp_0, x924_p_0, xp_1, x924, y, yp_0;
IND_TYPE y616 = 0;
IND_TYPE x925 = 0;
IND_TYPE h486 = 0;
IND_TYPE w = 0;
...
c1172_p_1 = 0;
						for (h = h486, hp_0 = 0;h < h486 + 3;h += 1, hp_0 += 1){
							...
							for (x = x924, xp_1 = x924_p_0, xp_0 = 0;x < x924 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 4) (4 / 1)
										for (c = c1172, cp_2 = c1172_p_1, cp_1 = c1172_p_0, cp_0 = 0;c < c1172 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
