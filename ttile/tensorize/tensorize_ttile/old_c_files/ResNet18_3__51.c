...
for (y504 = y505, y504_p_0 = 0;
	...
	for (x633 = x634, x633_p_0 = 0;
		...
		// y = 56, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 2) (56 / 28)
		for (y503 = y504, y503_p_1 = y504_p_0, y503_p_0 = 0;
			y503 < y504 + 56;
			y503 += 28, y503_p_1 += 28, y503_p_0 += 28){
			...
			for (x632 = x633, x632_p_1 = x633_p_0, x632_p_0 = 0;
				...
				for (f = f247, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y503, yp_2 = y503_p_1, yp_1 = y503_p_0, yp_0 = 0;
						y < y503 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (2 / 2)
						for (x631 = x632, x631_p_2 = x632_p_1, x631_p_1 = x632_p_0, x631_p_0 = 0;
							x631 < x632 + 2;
							x631 += 2, x631_p_2 += 2, x631_p_1 += 2, x631_p_0 += 2){
							// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 4) (64 / 16)
							for (c384 = c385, c384_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x631, xp_3 = x631_p_2, xp_2 = x631_p_1, xp_1 = x631_p_0, xp_0 = 0;
									x < x631 + 2;
