...
[V f; U (2, f); U (14, y); T (4, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (4, c); T (16, f); T (7, x); T (1, y); T (32, c)]
*/
IND_TYPE c, cp_0, c176_p_0, c177_p_0, cp_1, c176_p_1, cp_2, c176, c177, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x132_p_0, xp_1, x132, y, yp_0;
