...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, c); T (8, f); T (2, x); T (2, y); T (16, c)]
*/
IND_TYPE c, cp_0, c288_p_0, c289_p_0, cp_1, c288_p_1, cp_2, c288, c289, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x216_p_0, xp_1, x216, y, yp_0;
IND_TYPE y144 = 0;
IND_TYPE x217 = 0;
IND_TYPE h144 = 0;
IND_TYPE w144 = 0;
					...
					for (h = h144, hp_0 = 0;h < h144 + 3;h += 1, hp_0 += 1){
						...
						for (w = w144, wp_0 = 0;w < w144 + 3;w += 1, wp_0 += 1){
							...
							for (x = x216, xp_1 = x216_p_0, xp_0 = 0;x < x216 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 8) (8 / 1)
										for (c = c288, cp_2 = c288_p_1, cp_1 = c288_p_0, cp_0 = 0;c < c288 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
