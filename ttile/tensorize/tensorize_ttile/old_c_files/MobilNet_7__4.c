...
[V f; U (1, f); U (14, y); U (3, h); T (128, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, f); T (4, c); T (14, x); T (1, y); T (16, f)]
*/
IND_TYPE c, cp_0, c544_p_0, cp_1, c544, f, fp_0, f344_p_0, fp_1, f344, w, wp_0, x, xp_0, x444_p_0, xp_1, x444, y, yp_0;
