...
[V f; U (4, f); U (7, y); U (3, h); T (1, c); Hoist_vars [c]; T (56, x);
  T (3, w); T (4, c); T (1, x); T (8, y); T (16, c)]
*/
IND_TYPE c, cp_0, c246_p_0, c247_p_0, cp_1, c246_p_1, cp_2, c246, c247, w, wp_0, x, xp_0, x272_p_0, xp_1, x272, y, yp_0;
