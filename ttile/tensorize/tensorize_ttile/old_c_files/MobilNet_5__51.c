...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (4, c); T (1, f); T (32, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c64_p_0, c65_p_0, cp_1, c64_p_1, cp_2, c64, c65, f, fp_0, f52_p_0, f53_p_0, fp_1, f52_p_1, fp_2, f52, f53, h, hp_0, w, wp_0, x, xp_0, x48_p_0, xp_1, x48, y, yp_0;
