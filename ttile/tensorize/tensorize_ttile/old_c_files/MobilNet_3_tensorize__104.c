...
[V f; U (2, f); ULambda y; T (128, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); Lambda_apply y [((Iter 2), (Arg 9)); ((Iter 1), (Arg 10))];
  T (4, f); T (1, c); T (14, x); T (2, y)]
*/
...
c0_p_0 = 0;
			for (f = f0, fp_0 = 0;f < f0 + 128;f += 32, fp_0 += 32){
					for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 18;y += 9, yp_1 += 9, yp_0 += 9){
						// y = u_y, x = 4, h = 3, w = 3, c = 128, f = 32
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 4, h = 1, w = 3, c = 128, f = 32
							// T (w, 3) (3 / 1)
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
								// y = u_y, x = 4, h = 1, w = 1, c = 128, f = 32
								// T (x, 4) (4 / 1)
					...
					for (y = y0 + 18, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 18 + 10;y += 10, yp_1 += 10, yp_0 += 10){
						// y = u_y, x = 4, h = 3, w = 3, c = 128, f = 32
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 4, h = 1, w = 3, c = 128, f = 32
