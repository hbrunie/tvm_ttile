...
[V f; U (2, f); U (14, y); T (8, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (2, c); T (16, f); T (2, x); T (1, y); T (32, c)]
*/
IND_TYPE c, cp_0, c104_p_0, c105_p_0, cp_1, c104_p_1, cp_2, c104, c105, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x78_p_0, xp_1, x78, y, yp_0;
IND_TYPE y52 = 0;
IND_TYPE x79 = 0;
IND_TYPE h52 = 0;
IND_TYPE w52 = 0;
