...
*/
IND_TYPE c, cp_0, c252_p_0, cp_1, c252, f, fp_0, f252_p_0, fp_1, f252, h, hp_0, w, wp_0, x, xp_0, x252_p_0, xp_1, x252, y, yp_0;
IND_TYPE y168 = 0;
IND_TYPE x253 = 0;
IND_TYPE h168 = 0;
IND_TYPE w168 = 0;
...
fp_1 = 0;
					for (h = h168, hp_0 = 0;h < h168 + 3;h += 1, hp_0 += 1){
						...
						for (w = w168, wp_0 = 0;w < w168 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 14) (14 / 1)
							for (x = x252, xp_1 = x252_p_0, xp_0 = 0;x < x252 + 14;x += 1, xp_1 += 1, xp_0 += 1){
