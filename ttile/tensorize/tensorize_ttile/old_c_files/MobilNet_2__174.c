...
/*
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (8, x); T (3, w);
  T (3, h); T (1, c); T (7, x); T (8, y); T (8, c)]
*/
IND_TYPE c, cp_0, c138_p_0, c139_p_0, cp_1, c138_p_1, cp_2, c138, c139, h, hp_0, w, wp_0, x, xp_0, x156_p_0, xp_1, x156, y, yp_0;
