...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, c); T (2, f); T (1, y); T (32, c); T (8, f)]
*/
IND_TYPE c, cp_0, c432_p_0, c433_p_0, cp_1, c432_p_1, cp_2, c432, c433, f, fp_0, f324_p_0, fp_1, f324, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y216 = 0;
IND_TYPE x216 = 0;
IND_TYPE h216 = 0;
IND_TYPE w216 = 0;
					...
					for (h = h216, hp_0 = 0;h < h216 + 3;h += 1, hp_0 += 1){
						...
						for (w = w216, wp_0 = 0;w < w216 + 3;w += 1, wp_0 += 1){
							...
							for (x = x216, xp_0 = 0;x < x216 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 8) (8 / 1)
										for (c = c432, cp_2 = c432_p_1, cp_1 = c432_p_0, cp_0 = 0;c < c432 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
