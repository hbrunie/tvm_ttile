...
for (y404 = y405, y404_p_0 = 0;
	...
	for (x508 = x509, x508_p_0 = 0;
		...
		// y = 56, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 2) (56 / 28)
		for (y403 = y404, y403_p_1 = y404_p_0, y403_p_0 = 0;
			y403 < y404 + 56;
			y403 += 28, y403_p_1 += 28, y403_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 8) (56 / 7)
			for (x507 = x508, x507_p_1 = x508_p_0, x507_p_0 = 0;
				x507 < x508 + 56;
				x507 += 7, x507_p_1 += 7, x507_p_0 += 7){
				...
				for (f = f197, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y403, yp_2 = y403_p_1, yp_1 = y403_p_0, yp_0 = 0;
						y < y403 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
						// T (x, 7) (7 / 1)
						for (x506 = x507, x506_p_2 = x507_p_1, x506_p_1 = x507_p_0, x506_p_0 = 0;
							x506 < x507 + 7;
							x506 += 1, x506_p_2 += 1, x506_p_1 += 1, x506_p_0 += 1){
							...
							for (c309 = c310, c309_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x506, xp_3 = x506_p_2, xp_2 = x506_p_1, xp_1 = x506_p_0, xp_0 = 0;
									x < x506 + 1;
