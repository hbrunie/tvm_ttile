...
for (y776 = y777, y776_p_0 = 0;
	...
	for (x973 = x974, x973_p_0 = 0;
		...
		// T (y, 1) (28 / 28)
		for (y775 = y776, y775_p_1 = y776_p_0, y775_p_0 = 0;
			y775 < y776 + 28;
			y775 += 28, y775_p_1 += 28, y775_p_0 += 28){
			// y = 28, x = 4, h = 1, w = 1, c = 64, f = 64
			// T (x, 2) (4 / 2)
			for (x972 = x973, x972_p_1 = x973_p_0, x972_p_0 = 0;
				...
				for (f = f383, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y775, yp_2 = y775_p_1, yp_1 = y775_p_0, yp_0 = 0;
						y < y775 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 2) (2 / 1)
						for (x971 = x972, x971_p_2 = x972_p_1, x971_p_1 = x972_p_0, x971_p_0 = 0;
							x971 < x972 + 2;
							x971 += 1, x971_p_2 += 1, x971_p_1 += 1, x971_p_0 += 1){
							...
							for (c588 = c589, c588_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x971, xp_3 = x971_p_2, xp_2 = x971_p_1, xp_1 = x971_p_0, xp_0 = 0;
									x < x971 + 1;
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_5010 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_5011 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
											// y = 14, x = 1, h = 1, w = 1, c = 32, f = 32
											// T (c, 32) (32 / 1)
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_5010);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_5011);
								}
							}
						}
					}
