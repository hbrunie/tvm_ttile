...
[V f; U (4, f); ULambda y; U (3, w); T (16, c); Hoist_vars [c]; T (28, x);
  T (1, w); T (3, h); T (1, y); T (2, f); T (8, c); T (2, x);
...
__m512 mem_vec_0 ,mem_vec_1 ,mem_vec_10 ,mem_vec_11 ,mem_vec_12 ,mem_vec_13 ,mem_vec_14 ,mem_vec_15 ,mem_vec_16 ,mem_vec_17 ,mem_vec_18 ,mem_vec_19 ,mem_vec_2 ,mem_vec_20 ,mem_vec_21 ,mem_vec_22 ,mem_vec_23 ,mem_vec_24 ,mem_vec_25 ,mem_vec_26 ,mem_vec_27 ,mem_vec_28 ,mem_vec_29 ,mem_vec_3 ,mem_vec_30 ,mem_vec_31 ,mem_vec_32 ,mem_vec_33 ,mem_vec_34 ,mem_vec_35 ,mem_vec_36 ,mem_vec_37 ,mem_vec_38 ,mem_vec_39 ,mem_vec_4 ,mem_vec_40 ,mem_vec_41 ,mem_vec_42 ,mem_vec_43 ,mem_vec_44 ,mem_vec_45 ,mem_vec_46 ,mem_vec_47 ,mem_vec_48 ,mem_vec_49 ,mem_vec_5 ,mem_vec_50 ,mem_vec_51 ,mem_vec_6 ,mem_vec_7 ,mem_vec_8 ,mem_vec_9 ,vec_0 ,vec_1 ,vec_10 ,vec_100 ,vec_101 ,vec_102 ,vec_103 ,vec_104 ,vec_105 ,vec_106 ,vec_107 ,vec_108 ,vec_109 ,vec_11 ,vec_110 ,vec_111 ,vec_112 ,vec_113 ,vec_114 ,vec_115 ,vec_116 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_81 ,vec_82 ,vec_83 ,vec_84 ,vec_85 ,vec_86 ,vec_87 ,vec_88 ,vec_89 ,vec_9 ,vec_90 ,vec_91 ,vec_92 ,vec_93 ,vec_94 ,vec_95 ,vec_96 ,vec_97 ,vec_98 ,vec_99;
	for (y0 = y1, y0_p_0 = 0;
		y0 < y1 + 42;
		y0 += 6, y0_p_0 += 6){
		// y = u_y, x = 56, h = 3, w = 3, c = 128, f = 128
		// T (x, 2) (56 / 28)
		for (x0 = x1, x0_p_0 = 0;
			x0 < x1 + 56;
			x0 += 28, x0_p_0 += 28){
			...
			for (c0 = c1, c0_p_0 = 0;
				c0 < c1 + 128;
				c0 += 16, c0_p_0 += 16){
				// y = u_y, x = 28, h = 3, w = 3, c = 16, f = 128
				// T (f, 2) (128 / 64)
				for (f = f0, fp_0 = 0;
					f < f0 + 128;
					f += 64, fp_0 += 64){
					// y = u_y, x = 28, h = 3, w = 3, c = 16, f = 64
					// T (y, 1) (u_y / u_y)
								...
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c0, cp_1 = c0_p_0, cp_0 = 0;
												...
												vec_34 = _mm512_fmadd_ps(vec_35, vec_36, mem_vec_0);
												mem_vec_0 = vec_34;

												vec_38 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_37 = _mm512_fmadd_ps(vec_35, vec_38, mem_vec_1);
												mem_vec_1 = vec_37;

												vec_40 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

												vec_39 = _mm512_fmadd_ps(vec_35, vec_40, mem_vec_2);
												mem_vec_2 = vec_39;

												vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

												vec_41 = _mm512_fmadd_ps(vec_35, vec_42, mem_vec_3);
												mem_vec_3 = vec_41;
												scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_44 = _mm512_set1_ps(scal_7);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_4);
												mem_vec_4 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_38, mem_vec_5);
												mem_vec_5 = vec_45;



												vec_46 = _mm512_fmadd_ps(vec_44, vec_40, mem_vec_6);
												mem_vec_6 = vec_46;



												vec_47 = _mm512_fmadd_ps(vec_44, vec_42, mem_vec_7);
												mem_vec_7 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_49 = _mm512_set1_ps(scal_8);


												vec_48 = _mm512_fmadd_ps(vec_49, vec_36, mem_vec_8);
												mem_vec_8 = vec_48;



												vec_50 = _mm512_fmadd_ps(vec_49, vec_38, mem_vec_9);
												mem_vec_9 = vec_50;



												vec_51 = _mm512_fmadd_ps(vec_49, vec_40, mem_vec_10);
												mem_vec_10 = vec_51;



												vec_52 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_11);
												mem_vec_11 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_54 = _mm512_set1_ps(scal_9);


												vec_53 = _mm512_fmadd_ps(vec_54, vec_36, mem_vec_12);
												mem_vec_12 = vec_53;



												vec_55 = _mm512_fmadd_ps(vec_54, vec_38, mem_vec_13);
												mem_vec_13 = vec_55;



												vec_56 = _mm512_fmadd_ps(vec_54, vec_40, mem_vec_14);
												mem_vec_14 = vec_56;



												vec_57 = _mm512_fmadd_ps(vec_54, vec_42, mem_vec_15);
												mem_vec_15 = vec_57;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_59 = _mm512_set1_ps(scal_10);


												vec_58 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_16);
												mem_vec_16 = vec_58;



												vec_60 = _mm512_fmadd_ps(vec_59, vec_38, mem_vec_17);
												mem_vec_17 = vec_60;



												vec_61 = _mm512_fmadd_ps(vec_59, vec_40, mem_vec_18);
												mem_vec_18 = vec_61;



												vec_62 = _mm512_fmadd_ps(vec_59, vec_42, mem_vec_19);
												mem_vec_19 = vec_62;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
												vec_64 = _mm512_set1_ps(scal_11);


												vec_63 = _mm512_fmadd_ps(vec_64, vec_36, mem_vec_20);
												mem_vec_20 = vec_63;



												vec_65 = _mm512_fmadd_ps(vec_64, vec_38, mem_vec_21);
												mem_vec_21 = vec_65;



												vec_66 = _mm512_fmadd_ps(vec_64, vec_40, mem_vec_22);
												mem_vec_22 = vec_66;



												vec_67 = _mm512_fmadd_ps(vec_64, vec_42, mem_vec_23);
												mem_vec_23 = vec_67;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_69 = _mm512_set1_ps(scal_12);
												vec_70 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_68 = _mm512_fmadd_ps(vec_69, vec_70, mem_vec_0);
												mem_vec_0 = vec_68;

												vec_72 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_71 = _mm512_fmadd_ps(vec_69, vec_72, mem_vec_1);
												mem_vec_1 = vec_71;

												vec_74 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

												vec_73 = _mm512_fmadd_ps(vec_69, vec_74, mem_vec_2);
												mem_vec_2 = vec_73;

												vec_76 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

												vec_75 = _mm512_fmadd_ps(vec_69, vec_76, mem_vec_3);
												mem_vec_3 = vec_75;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_78 = _mm512_set1_ps(scal_13);


												vec_77 = _mm512_fmadd_ps(vec_78, vec_70, mem_vec_4);
												mem_vec_4 = vec_77;



												vec_79 = _mm512_fmadd_ps(vec_78, vec_72, mem_vec_5);
												mem_vec_5 = vec_79;



												vec_80 = _mm512_fmadd_ps(vec_78, vec_74, mem_vec_6);
												mem_vec_6 = vec_80;



												vec_81 = _mm512_fmadd_ps(vec_78, vec_76, mem_vec_7);
												mem_vec_7 = vec_81;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_83 = _mm512_set1_ps(scal_14);


												vec_82 = _mm512_fmadd_ps(vec_83, vec_70, mem_vec_8);
												mem_vec_8 = vec_82;



												vec_84 = _mm512_fmadd_ps(vec_83, vec_72, mem_vec_9);
												mem_vec_9 = vec_84;



												vec_85 = _mm512_fmadd_ps(vec_83, vec_74, mem_vec_10);
												mem_vec_10 = vec_85;



												vec_86 = _mm512_fmadd_ps(vec_83, vec_76, mem_vec_11);
												mem_vec_11 = vec_86;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_88 = _mm512_set1_ps(scal_15);


												vec_87 = _mm512_fmadd_ps(vec_88, vec_70, mem_vec_12);
												mem_vec_12 = vec_87;



												vec_89 = _mm512_fmadd_ps(vec_88, vec_72, mem_vec_13);
												mem_vec_13 = vec_89;



												vec_90 = _mm512_fmadd_ps(vec_88, vec_74, mem_vec_14);
												mem_vec_14 = vec_90;



												vec_91 = _mm512_fmadd_ps(vec_88, vec_76, mem_vec_15);
												mem_vec_15 = vec_91;
												scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_93 = _mm512_set1_ps(scal_16);


												vec_92 = _mm512_fmadd_ps(vec_93, vec_70, mem_vec_16);
												mem_vec_16 = vec_92;



												vec_94 = _mm512_fmadd_ps(vec_93, vec_72, mem_vec_17);
												mem_vec_17 = vec_94;



												vec_95 = _mm512_fmadd_ps(vec_93, vec_74, mem_vec_18);
												mem_vec_18 = vec_95;



												vec_96 = _mm512_fmadd_ps(vec_93, vec_76, mem_vec_19);
												mem_vec_19 = vec_96;
												scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_98 = _mm512_set1_ps(scal_17);


												vec_97 = _mm512_fmadd_ps(vec_98, vec_70, mem_vec_20);
												mem_vec_20 = vec_97;



												vec_99 = _mm512_fmadd_ps(vec_98, vec_72, mem_vec_21);
												mem_vec_21 = vec_99;



												vec_100 = _mm512_fmadd_ps(vec_98, vec_74, mem_vec_22);
												mem_vec_22 = vec_100;



												vec_101 = _mm512_fmadd_ps(vec_98, vec_76, mem_vec_23);
												mem_vec_23 = vec_101;
											}
								...
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c0, cp_1 = c0_p_0, cp_0 = 0;
												...
												vec_39 = _mm512_fmadd_ps(vec_40, vec_41, mem_vec_24);
												mem_vec_24 = vec_39;

												vec_43 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_42 = _mm512_fmadd_ps(vec_40, vec_43, mem_vec_25);
												mem_vec_25 = vec_42;

												vec_45 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

												vec_44 = _mm512_fmadd_ps(vec_40, vec_45, mem_vec_26);
												mem_vec_26 = vec_44;

												vec_47 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

												vec_46 = _mm512_fmadd_ps(vec_40, vec_47, mem_vec_27);
												mem_vec_27 = vec_46;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_49 = _mm512_set1_ps(scal_8);


												vec_48 = _mm512_fmadd_ps(vec_49, vec_41, mem_vec_28);
												mem_vec_28 = vec_48;



												vec_50 = _mm512_fmadd_ps(vec_49, vec_43, mem_vec_29);
												mem_vec_29 = vec_50;



												vec_51 = _mm512_fmadd_ps(vec_49, vec_45, mem_vec_30);
												mem_vec_30 = vec_51;



												vec_52 = _mm512_fmadd_ps(vec_49, vec_47, mem_vec_31);
												mem_vec_31 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_54 = _mm512_set1_ps(scal_9);


												vec_53 = _mm512_fmadd_ps(vec_54, vec_41, mem_vec_32);
												mem_vec_32 = vec_53;



												vec_55 = _mm512_fmadd_ps(vec_54, vec_43, mem_vec_33);
												mem_vec_33 = vec_55;



												vec_56 = _mm512_fmadd_ps(vec_54, vec_45, mem_vec_34);
												mem_vec_34 = vec_56;



												vec_57 = _mm512_fmadd_ps(vec_54, vec_47, mem_vec_35);
												mem_vec_35 = vec_57;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_59 = _mm512_set1_ps(scal_10);


												vec_58 = _mm512_fmadd_ps(vec_59, vec_41, mem_vec_36);
												mem_vec_36 = vec_58;



												vec_60 = _mm512_fmadd_ps(vec_59, vec_43, mem_vec_37);
												mem_vec_37 = vec_60;



												vec_61 = _mm512_fmadd_ps(vec_59, vec_45, mem_vec_38);
												mem_vec_38 = vec_61;



												vec_62 = _mm512_fmadd_ps(vec_59, vec_47, mem_vec_39);
												mem_vec_39 = vec_62;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_64 = _mm512_set1_ps(scal_11);


												vec_63 = _mm512_fmadd_ps(vec_64, vec_41, mem_vec_40);
												mem_vec_40 = vec_63;



												vec_65 = _mm512_fmadd_ps(vec_64, vec_43, mem_vec_41);
												mem_vec_41 = vec_65;



												vec_66 = _mm512_fmadd_ps(vec_64, vec_45, mem_vec_42);
												mem_vec_42 = vec_66;



												vec_67 = _mm512_fmadd_ps(vec_64, vec_47, mem_vec_43);
												mem_vec_43 = vec_67;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
												vec_69 = _mm512_set1_ps(scal_12);


												vec_68 = _mm512_fmadd_ps(vec_69, vec_41, mem_vec_44);
												mem_vec_44 = vec_68;



												vec_70 = _mm512_fmadd_ps(vec_69, vec_43, mem_vec_45);
												mem_vec_45 = vec_70;



												vec_71 = _mm512_fmadd_ps(vec_69, vec_45, mem_vec_46);
												mem_vec_46 = vec_71;



												vec_72 = _mm512_fmadd_ps(vec_69, vec_47, mem_vec_47);
												mem_vec_47 = vec_72;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
												vec_74 = _mm512_set1_ps(scal_13);


												vec_73 = _mm512_fmadd_ps(vec_74, vec_41, mem_vec_48);
												mem_vec_48 = vec_73;



												vec_75 = _mm512_fmadd_ps(vec_74, vec_43, mem_vec_49);
												mem_vec_49 = vec_75;



												vec_76 = _mm512_fmadd_ps(vec_74, vec_45, mem_vec_50);
												mem_vec_50 = vec_76;



												vec_77 = _mm512_fmadd_ps(vec_74, vec_47, mem_vec_51);
												mem_vec_51 = vec_77;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_79 = _mm512_set1_ps(scal_14);
												vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_78 = _mm512_fmadd_ps(vec_79, vec_80, mem_vec_24);
												mem_vec_24 = vec_78;

												vec_82 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_81 = _mm512_fmadd_ps(vec_79, vec_82, mem_vec_25);
												mem_vec_25 = vec_81;

												vec_84 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

												vec_83 = _mm512_fmadd_ps(vec_79, vec_84, mem_vec_26);
												mem_vec_26 = vec_83;

												vec_86 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

												vec_85 = _mm512_fmadd_ps(vec_79, vec_86, mem_vec_27);
												mem_vec_27 = vec_85;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_88 = _mm512_set1_ps(scal_15);


												vec_87 = _mm512_fmadd_ps(vec_88, vec_80, mem_vec_28);
												mem_vec_28 = vec_87;



												vec_89 = _mm512_fmadd_ps(vec_88, vec_82, mem_vec_29);
												mem_vec_29 = vec_89;



												vec_90 = _mm512_fmadd_ps(vec_88, vec_84, mem_vec_30);
												mem_vec_30 = vec_90;



												vec_91 = _mm512_fmadd_ps(vec_88, vec_86, mem_vec_31);
												mem_vec_31 = vec_91;
												scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_93 = _mm512_set1_ps(scal_16);


												vec_92 = _mm512_fmadd_ps(vec_93, vec_80, mem_vec_32);
												mem_vec_32 = vec_92;



												vec_94 = _mm512_fmadd_ps(vec_93, vec_82, mem_vec_33);
												mem_vec_33 = vec_94;



												vec_95 = _mm512_fmadd_ps(vec_93, vec_84, mem_vec_34);
												mem_vec_34 = vec_95;



												vec_96 = _mm512_fmadd_ps(vec_93, vec_86, mem_vec_35);
												mem_vec_35 = vec_96;
												scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_98 = _mm512_set1_ps(scal_17);


												vec_97 = _mm512_fmadd_ps(vec_98, vec_80, mem_vec_36);
												mem_vec_36 = vec_97;



												vec_99 = _mm512_fmadd_ps(vec_98, vec_82, mem_vec_37);
												mem_vec_37 = vec_99;



												vec_100 = _mm512_fmadd_ps(vec_98, vec_84, mem_vec_38);
												mem_vec_38 = vec_100;



												vec_101 = _mm512_fmadd_ps(vec_98, vec_86, mem_vec_39);
												mem_vec_39 = vec_101;
												scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_103 = _mm512_set1_ps(scal_18);


												vec_102 = _mm512_fmadd_ps(vec_103, vec_80, mem_vec_40);
												mem_vec_40 = vec_102;



												vec_104 = _mm512_fmadd_ps(vec_103, vec_82, mem_vec_41);
												mem_vec_41 = vec_104;



												vec_105 = _mm512_fmadd_ps(vec_103, vec_84, mem_vec_42);
												mem_vec_42 = vec_105;



												vec_106 = _mm512_fmadd_ps(vec_103, vec_86, mem_vec_43);
												mem_vec_43 = vec_106;
												scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_108 = _mm512_set1_ps(scal_19);


												vec_107 = _mm512_fmadd_ps(vec_108, vec_80, mem_vec_44);
												mem_vec_44 = vec_107;



												vec_109 = _mm512_fmadd_ps(vec_108, vec_82, mem_vec_45);
												mem_vec_45 = vec_109;



												vec_110 = _mm512_fmadd_ps(vec_108, vec_84, mem_vec_46);
												mem_vec_46 = vec_110;



												vec_111 = _mm512_fmadd_ps(vec_108, vec_86, mem_vec_47);
												mem_vec_47 = vec_111;
												scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
												vec_113 = _mm512_set1_ps(scal_20);


												vec_112 = _mm512_fmadd_ps(vec_113, vec_80, mem_vec_48);
												mem_vec_48 = vec_112;



												vec_114 = _mm512_fmadd_ps(vec_113, vec_82, mem_vec_49);
												mem_vec_49 = vec_114;



												vec_115 = _mm512_fmadd_ps(vec_113, vec_84, mem_vec_50);
												mem_vec_50 = vec_115;



												vec_116 = _mm512_fmadd_ps(vec_113, vec_86, mem_vec_51);
												mem_vec_51 = vec_116;
											}
