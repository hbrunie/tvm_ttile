...
[V f; U (4, f); U (7, y); T (16, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (8, c); T (1, f); T (1, y); T (8, c); T (16, f)]
*/
IND_TYPE c, cp_0, c296_p_0, c297_p_0, cp_1, c296_p_1, cp_2, c296, c297, f, fp_0, f222_p_0, fp_1, f222, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y148 = 0;
IND_TYPE x148 = 0;
IND_TYPE h148 = 0;
IND_TYPE w148 = 0;
					...
					for (h = h148, hp_0 = 0;h < h148 + 3;h += 1, hp_0 += 1){
						...
						for (w = w148, wp_0 = 0;w < w148 + 3;w += 1, wp_0 += 1){
							...
							for (x = x148, xp_0 = 0;x < x148 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c296, cp_2 = c296_p_1, cp_1 = c296_p_0, cp_0 = 0;c < c296 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
