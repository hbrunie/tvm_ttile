...
fp_1 = 0;
						for (h = h284, hp_0 = 0;h < h284 + 3;h += 1, hp_0 += 1){
							...
							for (w = w308, wp_0 = 0;w < w308 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 4) (4 / 1)
								for (x = x516, xp_1 = x516_p_0, xp_0 = 0;x < x516 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4098 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_4099 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_4098);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_4099);
								}
							}
						}
}
