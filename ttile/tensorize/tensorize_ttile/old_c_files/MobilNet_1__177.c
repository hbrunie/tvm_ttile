...
/*
[V f; U (2, f); U (14, y); T (2, c); Hoist_vars [c]; T (16, x); T (3, w);
  T (3, h); T (7, x); T (8, y); T (16, c); T (1, x)]
*/
...
for (x1 = x2, x1_p_0 = 0;
	...
	for (c0 = c1, c0_p_0 = 0;
		...
		for (y = y0, yp_0 = 0;
			y < y0 + 112;
			y += 14, yp_0 += 14){
			// y = 14, x = 112, h = 3, w = 3, c = 2, f = 32
			// T (x, 7) (112 / 16)
			for (x0 = x1, x0_p_1 = x1_p_0, x0_p_0 = 0;
				x0 < x1 + 112;
				x0 += 16, x0_p_1 += 16, x0_p_0 += 16){
				// y = 14, x = 16, h = 3, w = 3, c = 2, f = 32
				// T (h, 3) (3 / 1)
				for (h = h0, hp_0 = 0;
					h < h0 + 3;
					h += 1, hp_0 += 1){
					// y = 14, x = 16, h = 1, w = 3, c = 2, f = 32
					// T (w, 3) (3 / 1)
					for (w = w0, wp_0 = 0;
						w < w0 + 3;
						w += 1, wp_0 += 1){
						// y = 14, x = 16, h = 1, w = 1, c = 2, f = 32
						// T (x, 16) (16 / 1)
