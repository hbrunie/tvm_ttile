							...
							for (w = w87, wp_0 = 0;w < w87 + 3;w += 1, wp_0 += 1){
								...
								for (x = x138, xp_1 = x138_p_0, xp_0 = 0;x < x138 + 17;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (h = h92, hp_0 = 0;h < h92 + 3;h += 1, hp_0 += 1){
												...
												mem_vec_1986 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
												mem_vec_1987 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_1986);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_1987);
									}
								}
							}
}
