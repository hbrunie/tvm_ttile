...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (64, c); T (8, f); T (2, x); T (2, y); T (1, c)]
*/
IND_TYPE c, cp_0, c240_p_0, c241_p_0, cp_1, c240_p_1, cp_2, c240, c241, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x180_p_0, xp_1, x180, y, yp_0;
IND_TYPE y120 = 0;
IND_TYPE x181 = 0;
IND_TYPE h120 = 0;
IND_TYPE w120 = 0;
					...
					for (h = h120, hp_0 = 0;h < h120 + 3;h += 1, hp_0 += 1){
						...
						for (w = w120, wp_0 = 0;w < w120 + 3;w += 1, wp_0 += 1){
							...
							for (x = x180, xp_1 = x180_p_0, xp_0 = 0;x < x180 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 8) (8 / 1)
										for (c = c240, cp_2 = c240_p_1, cp_1 = c240_p_0, cp_0 = 0;c < c240 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
