...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (2, c); T (8, f); T (7, x); T (2, y); T (128, c)]
*/
IND_TYPE c, cp_0, c352_p_0, c353_p_0, cp_1, c352_p_1, cp_2, c352, c353, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x264_p_0, xp_1, x264, y, yp_0;
IND_TYPE y176 = 0;
IND_TYPE x265 = 0;
IND_TYPE h176 = 0;
IND_TYPE w176 = 0;
