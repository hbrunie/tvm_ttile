...
[V f; U (4, f); U (7, y); U (3, h); T (128, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (2, c); T (8, f); T (1, y); T (2, c)]
*/
IND_TYPE c, cp_0, c528_p_0, c529_p_0, cp_1, c528_p_1, cp_2, c528, c529, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
	...
	for (y = y264, yp_0 = 0;
		...
		for (f = f264, fp_0 = 0;
			...
			for (c528 = c529, c528_p_1 = c529_p_0, c528_p_0 = 0;
				c528 < c529 + 256;
				c528 += 128, c528_p_1 += 128, c528_p_0 += 128){
