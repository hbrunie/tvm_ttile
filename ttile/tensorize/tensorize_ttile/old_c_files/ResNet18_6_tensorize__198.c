...
/*
[V f; U (2, f); U (14, y); T (4, c); Hoist_vars [c]; T (28, x); T (3, w);
...
fp_1 = 0;
					for (h = h12, hp_0 = 0;h < h12 + 3;h += 1, hp_0 += 1){
						// y = 14, x = 28, h = 1, w = 3, c = 4, f = 32
						// T (w, 3) (3 / 1)
						for (w = w12, wp_0 = 0;w < w12 + 3;w += 1, wp_0 += 1){
							// y = 14, x = 28, h = 1, w = 1, c = 4, f = 32
							// T (x, 28) (28 / 1)
							for (x = x18, xp_1 = x18_p_0, xp_0 = 0;x < x18 + 28;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 4) (4 / 1)
										for (c = c18, cp_1 = c18_p_0, cp_0 = 0;c < c18 + 4;c += 1, cp_1 += 1, cp_0 += 1){
