...
/*
[V f; U (2, f); U (8, y); T (2, c); Hoist_vars [c]; T (68, x); T (3, w);
  T (3, h); T (1, x); T (34, y); T (2, f); T (16, c); T (4, x); T (1, x)]
*/
IND_TYPE c, cp_0, c36_p_0, cp_1, c36, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x60_p_0, x61_p_0, x62_p_0, xp_1, x60_p_1, x61_p_1, xp_2, x60_p_2, xp_3, x60, x61, x62, y, yp_0;
IND_TYPE y24 = 0;
IND_TYPE x63 = 0;
IND_TYPE h24 = 0;
IND_TYPE w24 = 0;
...
x60_p_2 = 0;
						for (h = h24, hp_0 = 0;h < h24 + 3;h += 1, hp_0 += 1){
							// y = 8, x = 68, h = 1, w = 3, c = 2, f = 32
							// T (w, 3) (3 / 1)
							for (w = w24, wp_0 = 0;w < w24 + 3;w += 1, wp_0 += 1){
								// y = 8, x = 68, h = 1, w = 1, c = 2, f = 32
								// T (x, 68) (68 / 1)
								for (x = x60, xp_3 = x60_p_2, xp_2 = x60_p_1, xp_1 = x60_p_0, xp_0 = 0;x < x60 + 68;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
