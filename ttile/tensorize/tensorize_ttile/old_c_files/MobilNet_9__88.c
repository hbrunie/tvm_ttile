...
[V f; U (4, f); U (7, y); U (3, w); T (1, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (1024, c); T (1, f); T (1, y); T (1, c); T (16, f)]
*/
IND_TYPE c, cp_0, c1120_p_0, c1121_p_0, cp_1, c1120_p_1, cp_2, c1120, c1121, f, fp_0, f840_p_0, fp_1, f840, h, hp_0, x, xp_0, y, yp_0;
