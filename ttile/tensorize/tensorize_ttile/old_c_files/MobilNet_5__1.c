...
[V f; U (4, f); U (7, y); U (3, h); T (8, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (4, y); T (2, f); T (32, c); T (1, f); T (1, c); T (4, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c538_p_0, c539_p_0, cp_1, c538_p_1, cp_2, c538, c539, f, fp_0, f548_p_0, f549_p_0, fp_1, f548_p_1, fp_2, f548, f549, w, wp_0, x, xp_0, x420_p_0, xp_1, x420, y, yp_0;
