...
for (x1072 = x1073, x1072_p_0 = 0;
	x1072 < x1073 + 272;
	x1072 += 136, x1072_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 8) (136 / 17)
	for (x1071 = x1072, x1071_p_1 = x1072_p_0, x1071_p_0 = 0;
		x1071 < x1072 + 136;
		x1071 += 17, x1071_p_1 += 17, x1071_p_0 += 17){
		...
		for (c642 = c643, c642_p_0 = 0;
			...
			for (y = y428, yp_0 = 0;
				...
				// T (x, 17) (17 / 1)
				for (x1070 = x1071, x1070_p_2 = x1071_p_1, x1070_p_1 = x1071_p_0, x1070_p_0 = 0;
					x1070 < x1071 + 17;
					x1070 += 1, x1070_p_2 += 1, x1070_p_1 += 1, x1070_p_0 += 1){
					...
					for (h = h428, hp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x = x1070, xp_3 = x1070_p_2, xp_2 = x1070_p_1, xp_1 = x1070_p_0, xp_0 = 0;
							x < x1070 + 1;
