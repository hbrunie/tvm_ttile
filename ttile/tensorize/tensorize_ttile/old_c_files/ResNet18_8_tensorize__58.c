...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (128, c); T (2, f); T (7, x); T (2, f)]
*/
IND_TYPE c, cp_0, c210_p_0, cp_1, c210, f, fp_0, f234_p_0, f235_p_0, fp_1, f234_p_1, fp_2, f234, f235, h, hp_0, w, wp_0, x, xp_0, x210_p_0, xp_1, x210, y, yp_0;
IND_TYPE y140 = 0;
IND_TYPE x211 = 0;
IND_TYPE h140 = 0;
IND_TYPE w140 = 0;
