...
fp_1 = 0;
						for (w = w600, wp_0 = 0;w < w600 + 3;w += 1, wp_0 += 1){
							...
							for (x = x954, xp_1 = x954_p_0, xp_0 = 0;x < x954 + 28;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_9174 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
										mem_vec_9175 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_9174);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_9175);
							}
						}
}
