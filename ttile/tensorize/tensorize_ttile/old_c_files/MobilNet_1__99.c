...
/*
[V f; U (2, f); U (8, y); T (4, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (1, x); T (14, y); T (8, c); T (4, x)]
*/
		...
		for (y = y0, yp_0 = 0;
			...
			for (x0 = x1, x0_p_1 = x1_p_0, x0_p_0 = 0;
				...
				for (h = h0, hp_0 = 0;
					h < h0 + 3;
					h += 1, hp_0 += 1){
					// y = 8, x = 28, h = 1, w = 3, c = 4, f = 32
					// T (w, 3) (3 / 1)
					for (w = w0, wp_0 = 0;
						w < w0 + 3;
						w += 1, wp_0 += 1){
						// y = 8, x = 28, h = 1, w = 1, c = 4, f = 32
						// T (x, 28) (28 / 1)
