...
[V f; U (1, f); U (14, y); U (3, h); T (4, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (8, f); T (128, c); T (1, x); T (1, y); T (4, f)]
*/
IND_TYPE c, cp_0, c424_p_0, cp_1, c424, f, fp_0, f224_p_0, fp_1, f224, w, wp_0, x, xp_0, x324_p_0, xp_1, x324, y, yp_0;
