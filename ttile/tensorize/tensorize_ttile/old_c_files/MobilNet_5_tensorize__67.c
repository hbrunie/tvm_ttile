...
[V f; U (4, f); U (7, y); T (16, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (16, c); T (1, f); T (1, c); T (4, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c144_p_0, c145_p_0, cp_1, c144_p_1, cp_2, c144, c145, f, fp_0, f132_p_0, f133_p_0, fp_1, f132_p_1, fp_2, f132, f133, h, hp_0, w, wp_0, x, xp_0, x108_p_0, xp_1, x108, y, yp_0;
IND_TYPE y72 = 0;
IND_TYPE x109 = 0;
IND_TYPE h72 = 0;
IND_TYPE w72 = 0;
