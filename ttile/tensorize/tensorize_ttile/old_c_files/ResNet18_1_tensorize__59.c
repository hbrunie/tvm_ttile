...
[V f; U (2, f); U (14, y); T (3, c); Hoist_vars [c]; T (28, x); T (1, c);
  T (7, w); T (7, h); T (4, x); T (4, y); T (2, f); T (2, y)]
*/
IND_TYPE c, cp_0, c18_p_0, cp_1, c18, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x13_p_0, xp_1, x13, y, yp_0, y18_p_0, yp_1, y18;
IND_TYPE y19 = 0;
IND_TYPE x14 = 0;
IND_TYPE h12 = 0;
IND_TYPE w12 = 0;
				...
				for (h = h12, hp_0 = 0;h < h12 + 7;h += 1, hp_0 += 1){
					...
					for (w = w12, wp_0 = 0;w < w12 + 7;w += 1, wp_0 += 1){
						...
						for (c18 = c19, c18_p_0 = 0;c18 < c19 + 3;c18 += 3, c18_p_0 += 3){
							// y = 14, x = 28, h = 1, w = 1, c = 3, f = 32
							// T (x, 28) (28 / 1)
							for (x = x13, xp_1 = x13_p_0, xp_0 = 0;x < x13 + 28;x += 1, xp_1 += 1, xp_0 += 1){
