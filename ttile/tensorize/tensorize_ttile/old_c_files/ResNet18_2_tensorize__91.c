...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (4, c); T (8, x); T (14, y); T (2, c)]
*/
IND_TYPE c, cp_0, c274_p_0, c275_p_0, cp_1, c274_p_1, cp_2, c274, c275, h, hp_0, x, xp_0, x286_p_0, xp_1, x286, y, yp_0;
IND_TYPE y160 = 0;
IND_TYPE x287 = 0;
IND_TYPE h134 = 0;
IND_TYPE w = 0;
...
c274_p_1 = 0;
				for (h = h134, hp_0 = 0;h < h134 + 3;h += 1, hp_0 += 1){
					...
					for (x = x286, xp_1 = x286_p_0, xp_0 = 0;x < x286 + 7;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 8) (8 / 1)
								for (c = c274, cp_2 = c274_p_1, cp_1 = c274_p_0, cp_0 = 0;c < c274 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
									...
									vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_1780);
									mem_vec_1780 = vec_24;
									vec_28 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
									vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_1781);
									mem_vec_1781 = vec_27;
									vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
									vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_1782);
									mem_vec_1782 = vec_29;
									vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
									vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_1783);
									mem_vec_1783 = vec_31;
									scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
									vec_34 = _mm512_set1_ps(scal_5);
									vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_1784);
									mem_vec_1784 = vec_33;
									vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_1785);
									mem_vec_1785 = vec_35;
									vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1786);
									mem_vec_1786 = vec_36;
									vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1787);
									mem_vec_1787 = vec_37;
									scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
									vec_39 = _mm512_set1_ps(scal_6);
									vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_1788);
									mem_vec_1788 = vec_38;
									vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_1789);
									mem_vec_1789 = vec_40;
									vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_1790);
									mem_vec_1790 = vec_41;
									vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_1791);
									mem_vec_1791 = vec_42;
									scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
									vec_44 = _mm512_set1_ps(scal_7);
									vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_1792);
									mem_vec_1792 = vec_43;
									vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_1793);
									mem_vec_1793 = vec_45;
									vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_1794);
									mem_vec_1794 = vec_46;
									vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_1795);
									mem_vec_1795 = vec_47;
									scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
									vec_49 = _mm512_set1_ps(scal_8);
									vec_50 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
									vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_1780);
									mem_vec_1780 = vec_48;
									vec_52 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
									vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_1781);
									mem_vec_1781 = vec_51;
									vec_54 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
									vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_1782);
									mem_vec_1782 = vec_53;
									vec_56 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
									vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_1783);
									mem_vec_1783 = vec_55;
									scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
									vec_58 = _mm512_set1_ps(scal_9);
									vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1784);
									mem_vec_1784 = vec_57;
									vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_1785);
									mem_vec_1785 = vec_59;
									vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_1786);
									mem_vec_1786 = vec_60;
									vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_1787);
									mem_vec_1787 = vec_61;
									scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
									vec_63 = _mm512_set1_ps(scal_10);
									vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_1788);
									mem_vec_1788 = vec_62;
									vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_1789);
									mem_vec_1789 = vec_64;
									vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_1790);
									mem_vec_1790 = vec_65;
									vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_1791);
									mem_vec_1791 = vec_66;
									scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
									vec_68 = _mm512_set1_ps(scal_11);
									vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_1792);
									mem_vec_1792 = vec_67;
									vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_1793);
									mem_vec_1793 = vec_69;
									vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_1794);
									mem_vec_1794 = vec_70;
									vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_1795);
									mem_vec_1795 = vec_71;
								}
