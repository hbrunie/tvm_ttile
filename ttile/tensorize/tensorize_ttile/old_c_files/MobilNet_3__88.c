...
[V f; U (1, f); U (14, y); U (3, h); T (64, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (2, c); T (2, f); T (4, y); T (4, x); T (1, f); T (4, f)]
*/
IND_TYPE c, cp_0, c465_p_0, cp_1, c465, f, fp_0, f468_p_0, f469_p_0, fp_1, f468_p_1, fp_2, f468, f469, w, wp_0, x, xp_0, x515_p_0, xp_1, x515, y, yp_0;
				...
				for (f = f468, fp_2 = f468_p_1, fp_1 = f468_p_0, fp_0 = 0;
					...
					for (c465 = c466, c465_p_0 = 0;
						...
						for (w = w290, wp_0 = 0;
							...
							// T (x, 14) (14 / 1)
							for (x = x515, xp_1 = x515_p_0, xp_0 = 0;
								x < x515 + 14;
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3945 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3945);
							}
						}
					}
				}
