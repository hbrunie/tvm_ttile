...
[V f; U (2, f); ULambda y; U (3, h); T (8, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (1, h); T (1, y); T (4, f); T (16, c); T (7, x);
							...
							for (w = w0, wp_0 = 0;
								...
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_38 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_39 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
											// y = u_y, x = 1, h = 3, w = 1, c = 8, f = 32
											// T (c, 8) (8 / 1)
											for (c = c0, cp_1 = c0_p_0, cp_0 = 0;
												c < c0 + 8;
												...
												vec_35 = _mm512_fmadd_ps(vec_36, vec_37, mem_vec_18);
												mem_vec_18 = vec_35;

												vec_39 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_38 = _mm512_fmadd_ps(vec_36, vec_39, mem_vec_19);
												mem_vec_19 = vec_38;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_41 = _mm512_set1_ps(scal_12);


												vec_40 = _mm512_fmadd_ps(vec_41, vec_37, mem_vec_20);
												mem_vec_20 = vec_40;



												vec_42 = _mm512_fmadd_ps(vec_41, vec_39, mem_vec_21);
												mem_vec_21 = vec_42;
												scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_44 = _mm512_set1_ps(scal_13);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_37, mem_vec_22);
												mem_vec_22 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_39, mem_vec_23);
												mem_vec_23 = vec_45;
												scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_47 = _mm512_set1_ps(scal_14);


												vec_46 = _mm512_fmadd_ps(vec_47, vec_37, mem_vec_24);
												mem_vec_24 = vec_46;



												vec_48 = _mm512_fmadd_ps(vec_47, vec_39, mem_vec_25);
												mem_vec_25 = vec_48;
												scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
												vec_50 = _mm512_set1_ps(scal_15);


												vec_49 = _mm512_fmadd_ps(vec_50, vec_37, mem_vec_26);
												mem_vec_26 = vec_49;



												vec_51 = _mm512_fmadd_ps(vec_50, vec_39, mem_vec_27);
												mem_vec_27 = vec_51;
												scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
												vec_53 = _mm512_set1_ps(scal_16);


												vec_52 = _mm512_fmadd_ps(vec_53, vec_37, mem_vec_28);
												mem_vec_28 = vec_52;



												vec_54 = _mm512_fmadd_ps(vec_53, vec_39, mem_vec_29);
												mem_vec_29 = vec_54;
												scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
												vec_56 = _mm512_set1_ps(scal_17);


												vec_55 = _mm512_fmadd_ps(vec_56, vec_37, mem_vec_30);
												mem_vec_30 = vec_55;



												vec_57 = _mm512_fmadd_ps(vec_56, vec_39, mem_vec_31);
												mem_vec_31 = vec_57;
												scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
												vec_59 = _mm512_set1_ps(scal_18);


												vec_58 = _mm512_fmadd_ps(vec_59, vec_37, mem_vec_32);
												mem_vec_32 = vec_58;



												vec_60 = _mm512_fmadd_ps(vec_59, vec_39, mem_vec_33);
												mem_vec_33 = vec_60;
												scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
												vec_62 = _mm512_set1_ps(scal_19);


												vec_61 = _mm512_fmadd_ps(vec_62, vec_37, mem_vec_34);
												mem_vec_34 = vec_61;



												vec_63 = _mm512_fmadd_ps(vec_62, vec_39, mem_vec_35);
												mem_vec_35 = vec_63;
												scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
												vec_65 = _mm512_set1_ps(scal_20);


												vec_64 = _mm512_fmadd_ps(vec_65, vec_37, mem_vec_36);
												mem_vec_36 = vec_64;



												vec_66 = _mm512_fmadd_ps(vec_65, vec_39, mem_vec_37);
												mem_vec_37 = vec_66;
												scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
												vec_68 = _mm512_set1_ps(scal_21);


												vec_67 = _mm512_fmadd_ps(vec_68, vec_37, mem_vec_38);
												mem_vec_38 = vec_67;



												vec_69 = _mm512_fmadd_ps(vec_68, vec_39, mem_vec_39);
												mem_vec_39 = vec_69;
												scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_71 = _mm512_set1_ps(scal_22);
												vec_72 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_70 = _mm512_fmadd_ps(vec_71, vec_72, mem_vec_18);
												mem_vec_18 = vec_70;

												vec_74 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_73 = _mm512_fmadd_ps(vec_71, vec_74, mem_vec_19);
												mem_vec_19 = vec_73;
												scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_76 = _mm512_set1_ps(scal_23);


												vec_75 = _mm512_fmadd_ps(vec_76, vec_72, mem_vec_20);
												mem_vec_20 = vec_75;



												vec_77 = _mm512_fmadd_ps(vec_76, vec_74, mem_vec_21);
												mem_vec_21 = vec_77;
												scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_79 = _mm512_set1_ps(scal_24);


												vec_78 = _mm512_fmadd_ps(vec_79, vec_72, mem_vec_22);
												mem_vec_22 = vec_78;



												vec_80 = _mm512_fmadd_ps(vec_79, vec_74, mem_vec_23);
												mem_vec_23 = vec_80;
												scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_82 = _mm512_set1_ps(scal_25);


												vec_81 = _mm512_fmadd_ps(vec_82, vec_72, mem_vec_24);
												mem_vec_24 = vec_81;



												vec_83 = _mm512_fmadd_ps(vec_82, vec_74, mem_vec_25);
												mem_vec_25 = vec_83;
												scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
												vec_85 = _mm512_set1_ps(scal_26);


												vec_84 = _mm512_fmadd_ps(vec_85, vec_72, mem_vec_26);
												mem_vec_26 = vec_84;



												vec_86 = _mm512_fmadd_ps(vec_85, vec_74, mem_vec_27);
												mem_vec_27 = vec_86;
												scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
												vec_88 = _mm512_set1_ps(scal_27);


												vec_87 = _mm512_fmadd_ps(vec_88, vec_72, mem_vec_28);
												mem_vec_28 = vec_87;



												vec_89 = _mm512_fmadd_ps(vec_88, vec_74, mem_vec_29);
												mem_vec_29 = vec_89;
												scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
												vec_91 = _mm512_set1_ps(scal_28);


												vec_90 = _mm512_fmadd_ps(vec_91, vec_72, mem_vec_30);
												mem_vec_30 = vec_90;



												vec_92 = _mm512_fmadd_ps(vec_91, vec_74, mem_vec_31);
												mem_vec_31 = vec_92;
												scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
												vec_94 = _mm512_set1_ps(scal_29);


												vec_93 = _mm512_fmadd_ps(vec_94, vec_72, mem_vec_32);
												mem_vec_32 = vec_93;



												vec_95 = _mm512_fmadd_ps(vec_94, vec_74, mem_vec_33);
												mem_vec_33 = vec_95;
												scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
												vec_97 = _mm512_set1_ps(scal_30);


												vec_96 = _mm512_fmadd_ps(vec_97, vec_72, mem_vec_34);
												mem_vec_34 = vec_96;



												vec_98 = _mm512_fmadd_ps(vec_97, vec_74, mem_vec_35);
												mem_vec_35 = vec_98;
												scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
												vec_100 = _mm512_set1_ps(scal_31);


												vec_99 = _mm512_fmadd_ps(vec_100, vec_72, mem_vec_36);
												mem_vec_36 = vec_99;



												vec_101 = _mm512_fmadd_ps(vec_100, vec_74, mem_vec_37);
												mem_vec_37 = vec_101;
												scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
												vec_103 = _mm512_set1_ps(scal_32);


												vec_102 = _mm512_fmadd_ps(vec_103, vec_72, mem_vec_38);
												mem_vec_38 = vec_102;



												vec_104 = _mm512_fmadd_ps(vec_103, vec_74, mem_vec_39);
												mem_vec_39 = vec_104;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_38);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_39);
								}
							}
						}
					}
