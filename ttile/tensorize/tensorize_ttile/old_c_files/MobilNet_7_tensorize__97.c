...
[V f; U (2, f); U (14, y); T (32, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, c); T (16, f); T (2, x); T (1, y); T (4, c)]
*/
IND_TYPE c, cp_0, c80_p_0, c81_p_0, cp_1, c80_p_1, cp_2, c80, c81, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x60_p_0, xp_1, x60, y, yp_0;
IND_TYPE y40 = 0;
IND_TYPE x61 = 0;
IND_TYPE h40 = 0;
IND_TYPE w40 = 0;
...
c80_p_1 = 0;
					for (h = h40, hp_0 = 0;h < h40 + 3;h += 1, hp_0 += 1){
						...
						for (w = w40, wp_0 = 0;w < w40 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 7) (7 / 1)
							for (x = x60, xp_1 = x60_p_0, xp_0 = 0;x < x60 + 7;x += 1, xp_1 += 1, xp_0 += 1){
