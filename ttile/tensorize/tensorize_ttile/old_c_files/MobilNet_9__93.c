...
[V f; U (4, f); U (7, y); U (3, h); T (2, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (4, c); T (8, f); T (1, y); T (128, c); T (2, f)]
*/
IND_TYPE c, cp_0, c1000_p_0, c1001_p_0, cp_1, c1000_p_1, cp_2, c1000, c1001, f, fp_0, f750_p_0, fp_1, f750, w, wp_0, x, xp_0, y, yp_0;
