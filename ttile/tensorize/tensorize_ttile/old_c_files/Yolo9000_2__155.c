...
for (x1192 = x1193, x1192_p_0 = 0;
	x1192 < x1193 + 272;
	x1192 += 68, x1192_p_0 += 68){
	// y = 272, x = 68, h = 3, w = 3, c = 32, f = 64
	// T (x, 4) (68 / 17)
	for (x1191 = x1192, x1191_p_1 = x1192_p_0, x1191_p_0 = 0;
		x1191 < x1192 + 68;
		x1191 += 17, x1191_p_1 += 17, x1191_p_0 += 17){
		...
		for (c714 = c715, c714_p_0 = 0;
			...
			for (y = y476, yp_0 = 0;
				...
				// T (x, 1) (17 / 17)
				for (x1190 = x1191, x1190_p_2 = x1191_p_1, x1190_p_1 = x1191_p_0, x1190_p_0 = 0;
					x1190 < x1191 + 17;
					x1190 += 17, x1190_p_2 += 17, x1190_p_1 += 17, x1190_p_0 += 17){
					// y = 4, x = 17, h = 3, w = 3, c = 16, f = 64
					// T (h, 3) (3 / 1)
					for (h = h476, hp_0 = 0;
						h < h476 + 3;
						...
						// T (x, 17) (17 / 1)
						for (x = x1190, xp_3 = x1190_p_2, xp_2 = x1190_p_1, xp_1 = x1190_p_0, xp_0 = 0;
							x < x1190 + 17;
