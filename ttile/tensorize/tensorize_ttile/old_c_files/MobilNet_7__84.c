...
[V f; U (4, f); U (7, y); U (3, h); T (64, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (2, c); T (8, f); T (2, x); T (2, y); T (4, c)]
*/
IND_TYPE c, cp_0, c684_p_0, c685_p_0, cp_1, c684_p_1, cp_2, c684, c685, f, fp_0, w, wp_0, x, xp_0, x558_p_0, xp_1, x558, y, yp_0;
