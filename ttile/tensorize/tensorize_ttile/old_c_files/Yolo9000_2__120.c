...
for (x1292 = x1293, x1292_p_0 = 0;
	x1292 < x1293 + 272;
	x1292 += 17, x1292_p_0 += 17){
	// y = 272, x = 17, h = 3, w = 3, c = 32, f = 64
	// T (x, 1) (17 / 17)
	for (x1291 = x1292, x1291_p_1 = x1292_p_0, x1291_p_0 = 0;
		x1291 < x1292 + 17;
		x1291 += 17, x1291_p_1 += 17, x1291_p_0 += 17){
		// y = 272, x = 17, h = 3, w = 3, c = 32, f = 64
		// T (c, 16) (32 / 2)
		for (c774 = c775, c774_p_0 = 0;
			...
			for (y = y516, yp_0 = 0;
				y < y516 + 272;
				y += 4, yp_0 += 4){
				// y = 4, x = 17, h = 3, w = 3, c = 2, f = 64
				// T (x, 17) (17 / 1)
				for (x1290 = x1291, x1290_p_2 = x1291_p_1, x1290_p_1 = x1291_p_0, x1290_p_0 = 0;
					x1290 < x1291 + 17;
					x1290 += 1, x1290_p_2 += 1, x1290_p_1 += 1, x1290_p_0 += 1){
					...
					for (h = h516, hp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x = x1290, xp_3 = x1290_p_2, xp_2 = x1290_p_1, xp_1 = x1290_p_0, xp_0 = 0;
							x < x1290 + 1;
