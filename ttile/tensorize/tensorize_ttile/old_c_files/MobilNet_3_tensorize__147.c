...
c0_p_0 = 0;
			for (f = f0, fp_0 = 0;f < f0 + 128;f += 64, fp_0 += 64){
					for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 28;y += 4, yp_1 += 4, yp_0 += 4){
						// y = u_y, x = 56, h = 3, w = 3, c = 2, f = 64
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 56, h = 1, w = 3, c = 2, f = 64
							// T (w, 1) (3 / 3)
					...
					for (y = y0 + 28, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 28 + 28;y += 7, yp_1 += 7, yp_0 += 7){
						// y = u_y, x = 56, h = 3, w = 3, c = 2, f = 64
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 56, h = 1, w = 3, c = 2, f = 64
							...
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 3, wp_0 += 3){
								...
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 56;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_42 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
											mem_vec_43 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
											// y = u_y, x = 1, h = 1, w = 3, c = 2, f = 64
											// T (c, 2) (2 / 1)
											for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 2;c += 1, cp_1 += 1, cp_0 += 1){
												scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_42);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_43);
								}
							}
						}
					}
