...
/*
[V f; U (4, f); U (7, y); T (512, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (8, f); T (1, c); T (7, x); T (2, y); T (1, f); T (1, c)]
*/
				...
				for (c0 = c1, c0_p_1 = c1_p_0, c0_p_0 = 0;
					...
					for (f = f0, fp_1 = f0_p_0, fp_0 = 0;
						...
						for (h = h0, hp_0 = 0;
							h < h0 + 3;
							h += 1, hp_0 += 1){
							// y = 7, x = 2, h = 1, w = 3, c = 512, f = 64
							// T (w, 3) (3 / 1)
							for (w = w0, wp_0 = 0;
								w < w0 + 3;
								w += 1, wp_0 += 1){
								// y = 7, x = 2, h = 1, w = 1, c = 512, f = 64
								// T (x, 2) (2 / 1)
