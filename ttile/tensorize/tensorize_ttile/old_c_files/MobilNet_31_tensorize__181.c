...
c363_p_0 = 0;
							for (w = w222, wp_0 = 0;w < w222 + 3;w += 1, wp_0 += 1){
								...
								for (x = x413, xp_1 = x413_p_0, xp_0 = 0;x < x413 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3225 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
											mem_vec_3226 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
											mem_vec_3227 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
											mem_vec_3228 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_3229 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3225);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_3226);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_3227);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3228);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3229);
								}
							}
}
