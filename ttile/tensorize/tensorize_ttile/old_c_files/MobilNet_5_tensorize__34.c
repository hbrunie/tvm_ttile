...
/*
[V f; U (4, f); U (7, y); T (32, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (8, c); T (2, f); T (1, c); T (7, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c216_p_0, c217_p_0, cp_1, c216_p_1, cp_2, c216, c217, f, fp_0, f204_p_0, f205_p_0, fp_1, f204_p_1, fp_2, f204, f205, h, hp_0, w, wp_0, x, xp_0, x162_p_0, xp_1, x162, y, yp_0;
IND_TYPE y108 = 0;
IND_TYPE x163 = 0;
IND_TYPE h108 = 0;
IND_TYPE w108 = 0;
...
yp_0 = 0;
							for (h = h108, hp_0 = 0;h < h108 + 3;h += 1, hp_0 += 1){
								...
								for (w = w108, wp_0 = 0;w < w108 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 4) (4 / 1)
									for (x = x162, xp_1 = x162_p_0, xp_0 = 0;x < x162 + 4;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 32) (32 / 1)
												for (c = c216, cp_2 = c216_p_1, cp_1 = c216_p_0, cp_0 = 0;c < c216 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
