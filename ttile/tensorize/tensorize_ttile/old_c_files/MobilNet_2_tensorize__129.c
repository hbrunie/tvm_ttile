...
/*
[V f; U (4, f); U (7, y); T (4, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (8, c); T (14, x); T (8, y); T (2, c)]
*/
IND_TYPE c, cp_0, c154_p_0, c155_p_0, cp_1, c154_p_1, cp_2, c154, c155, h, hp_0, w, wp_0, x, xp_0, x168_p_0, xp_1, x168, y, yp_0;
IND_TYPE y92 = 0;
IND_TYPE x169 = 0;
IND_TYPE h92 = 0;
IND_TYPE w92 = 0;
...
c154_p_1 = 0;
				for (h = h92, hp_0 = 0;h < h92 + 3;h += 1, hp_0 += 1){
					...
					for (w = w92, wp_0 = 0;w < w92 + 3;w += 1, wp_0 += 1){
						// y = 7, x = 4, h = 1, w = 1, c = 4, f = 64
						// T (x, 4) (4 / 1)
						for (x = x168, xp_1 = x168_p_0, xp_0 = 0;x < x168 + 4;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1134 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
									mem_vec_1135 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
									...
									mem_vec_1138 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
									mem_vec_1139 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
									...
									mem_vec_1142 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
									mem_vec_1143 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
									...
									mem_vec_1146 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_1147 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									// y = 7, x = 1, h = 1, w = 1, c = 4, f = 64
									// T (c, 4) (4 / 1)
									for (c = c154, cp_2 = c154_p_1, cp_1 = c154_p_0, cp_0 = 0;c < c154 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_1134);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_1135);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_1138);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_1139);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_1142);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_1143);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_1146);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_1147);
						}
					}
				}
}
