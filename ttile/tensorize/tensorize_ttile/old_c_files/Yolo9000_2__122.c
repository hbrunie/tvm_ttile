...
[V f; U (2, f); U (8, y); T (2, c); Hoist_vars [c]; T (17, x); T (3, w);
  T (3, h); T (1, x); T (34, y); T (2, f); T (16, c); T (1, x); T (16, x)]
*/
IND_TYPE c, cp_0, c312_p_0, cp_1, c312, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x520_p_0, x521_p_0, x522_p_0, xp_1, x520_p_1, x521_p_1, xp_2, x520_p_2, xp_3, x520, x521, x522, y, yp_0;
...
for (x522 = x523, x522_p_0 = 0;
	...
	for (x521 = x522, x521_p_1 = x522_p_0, x521_p_0 = 0;
		x521 < x522 + 17;
		x521 += 17, x521_p_1 += 17, x521_p_0 += 17){
		// y = 272, x = 17, h = 3, w = 3, c = 32, f = 64
		// T (c, 16) (32 / 2)
