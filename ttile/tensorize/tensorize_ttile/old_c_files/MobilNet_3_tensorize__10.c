...
[V f; U (2, f); ULambda y; T (16, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); Lambda_apply y [((Iter 2), (Arg 10)); ((Iter 3), (Arg 12))];
  T (4, f); T (8, c); T (2, x); T (1, y)]
*/
...
c0_p_0 = 0;
			for (f = f0, fp_0 = 0;f < f0 + 128;f += 32, fp_0 += 32){
					for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 20;y += 10, yp_1 += 10, yp_0 += 10){
					...
					for (y = y0 + 20, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 20 + 36;y += 12, yp_1 += 12, yp_0 += 12){
						// y = u_y, x = 28, h = 3, w = 3, c = 16, f = 32
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 28, h = 1, w = 3, c = 16, f = 32
