...
x760_p_2 = 0;
					for (h = h304, hp_0 = 0;h < h304 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 272) (272 / 1)
						for (x = x760, xp_3 = x760_p_2, xp_2 = x760_p_1, xp_1 = x760_p_0, xp_0 = 0;x < x760 + 272;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 8) (8 / 1)
									for (c = c456, cp_1 = c456_p_0, cp_0 = 0;c < c456 + 8;c += 1, cp_1 += 1, cp_0 += 1){
