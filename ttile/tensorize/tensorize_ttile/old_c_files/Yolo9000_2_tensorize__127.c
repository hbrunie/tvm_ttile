...
/*
[V f; U (2, f); U (8, y); T (16, c); Hoist_vars [c]; T (8, x); T (3, w);
  T (3, h); T (1, x); T (34, y); T (2, f); T (2, c); T (34, x); T (1, x)]
*/
IND_TYPE c, cp_0, c102_p_0, cp_1, c102, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x170_p_0, x171_p_0, x172_p_0, xp_1, x170_p_1, x171_p_1, xp_2, x170_p_2, xp_3, x170, x171, x172, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x173 = 0;
IND_TYPE h68 = 0;
IND_TYPE w68 = 0;
...
x170_p_2 = 0;
						for (h = h68, hp_0 = 0;h < h68 + 3;h += 1, hp_0 += 1){
							// y = 8, x = 8, h = 1, w = 3, c = 16, f = 32
							// T (w, 3) (3 / 1)
							for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
								// y = 8, x = 8, h = 1, w = 1, c = 16, f = 32
								// T (x, 8) (8 / 1)
								for (x = x170, xp_3 = x170_p_2, xp_2 = x170_p_1, xp_1 = x170_p_0, xp_0 = 0;x < x170 + 8;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
