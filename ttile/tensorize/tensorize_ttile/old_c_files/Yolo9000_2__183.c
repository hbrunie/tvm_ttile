...
/*
[V f; U (2, f); U (8, y); T (1, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (34, x); T (34, y); T (2, f); T (32, c); T (2, x); T (1, x)]
*/
...
for (x42 = x43, x42_p_0 = 0;
	...
	for (x41 = x42, x41_p_1 = x42_p_0, x41_p_0 = 0;
		x41 < x42 + 272;
		x41 += 136, x41_p_1 += 136, x41_p_0 += 136){
		...
		for (c24 = c25, c24_p_0 = 0;
			...
			for (f = f16, fp_0 = 0;
				f < f16 + 64;
				f += 32, fp_0 += 32){
				// y = 272, x = 136, h = 3, w = 3, c = 1, f = 32
				// T (y, 34) (272 / 8)
				for (y = y16, yp_0 = 0;
					y < y16 + 272;
					y += 8, yp_0 += 8){
					// y = 8, x = 136, h = 3, w = 3, c = 1, f = 32
					// T (x, 34) (136 / 4)
					for (x40 = x41, x40_p_2 = x41_p_1, x40_p_1 = x41_p_0, x40_p_0 = 0;
						x40 < x41 + 136;
						x40 += 4, x40_p_2 += 4, x40_p_1 += 4, x40_p_0 += 4){
						// y = 8, x = 4, h = 3, w = 3, c = 1, f = 32
						// T (h, 3) (3 / 1)
						for (h = h16, hp_0 = 0;
							h < h16 + 3;
							h += 1, hp_0 += 1){
							// y = 8, x = 4, h = 1, w = 3, c = 1, f = 32
							// T (w, 3) (3 / 1)
							for (w = w16, wp_0 = 0;
								w < w16 + 3;
								w += 1, wp_0 += 1){
								// y = 8, x = 4, h = 1, w = 1, c = 1, f = 32
								// T (x, 4) (4 / 1)
