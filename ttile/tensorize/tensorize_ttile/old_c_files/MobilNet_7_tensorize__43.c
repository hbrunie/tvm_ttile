...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (2, c); T (8, f); T (14, x); T (2, y); T (128, c)]
*/
IND_TYPE c, cp_0, c392_p_0, c393_p_0, cp_1, c392_p_1, cp_2, c392, c393, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x294_p_0, xp_1, x294, y, yp_0;
IND_TYPE y196 = 0;
IND_TYPE x295 = 0;
IND_TYPE h196 = 0;
IND_TYPE w196 = 0;
