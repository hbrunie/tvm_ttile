...
[V f; U (4, f); U (7, y); U (3, h); T (1, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (2, c); T (8, f); T (1, x); T (2, y); T (256, c)]
*/
IND_TYPE c, cp_0, c644_p_0, c645_p_0, cp_1, c644_p_1, cp_2, c644, c645, f, fp_0, w, wp_0, x, xp_0, x528_p_0, xp_1, x528, y, yp_0;
