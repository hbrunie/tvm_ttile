...
for (y616 = y617, y616_p_0 = 0;
	...
	for (x773 = x774, x773_p_0 = 0;
		...
		// T (y, 2) (28 / 14)
		for (y615 = y616, y615_p_1 = y616_p_0, y615_p_0 = 0;
			y615 < y616 + 28;
			y615 += 14, y615_p_1 += 14, y615_p_0 += 14){
			// y = 14, x = 7, h = 1, w = 1, c = 64, f = 64
			// T (x, 1) (7 / 7)
			for (x772 = x773, x772_p_1 = x773_p_0, x772_p_0 = 0;
				x772 < x773 + 7;
				x772 += 7, x772_p_1 += 7, x772_p_0 += 7){
				// y = 14, x = 7, h = 1, w = 1, c = 64, f = 64
				// T (f, 2) (64 / 32)
				for (f = f303, fp_0 = 0;
					f < f303 + 64;
					...
					// T (y, 1) (14 / 14)
					for (y = y615, yp_2 = y615_p_1, yp_1 = y615_p_0, yp_0 = 0;
						y < y615 + 14;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (7 / 7)
						for (x771 = x772, x771_p_2 = x772_p_1, x771_p_1 = x772_p_0, x771_p_0 = 0;
							x771 < x772 + 7;
							x771 += 7, x771_p_2 += 7, x771_p_1 += 7, x771_p_0 += 7){
							// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c468 = c469, c468_p_0 = 0;
								...
								// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
								// T (x, 7) (7 / 1)
								for (x = x771, xp_3 = x771_p_2, xp_2 = x771_p_1, xp_1 = x771_p_0, xp_0 = 0;
									x < x771 + 7;
