...
[V f; U (4, f); U (7, y); U (3, h); T (8, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (1, c); T (8, f); T (1, x); T (2, y); T (64, c)]
*/
IND_TYPE c, cp_0, c636_p_0, c637_p_0, cp_1, c636_p_1, cp_2, c636, c637, f, fp_0, w, wp_0, x, xp_0, x522_p_0, xp_1, x522, y, yp_0;
