...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (16, c); T (1, f); T (8, c); T (28, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c328_p_0, c329_p_0, cp_1, c328_p_1, cp_2, c328, c329, f, fp_0, f316_p_0, f317_p_0, fp_1, f316_p_1, fp_2, f316, f317, h, hp_0, w, wp_0, x, xp_0, x246_p_0, xp_1, x246, y, yp_0;
IND_TYPE y164 = 0;
IND_TYPE x247 = 0;
IND_TYPE h164 = 0;
IND_TYPE w164 = 0;
							...
							for (h = h164, hp_0 = 0;h < h164 + 3;h += 1, hp_0 += 1){
								...
								for (w = w164, wp_0 = 0;w < w164 + 3;w += 1, wp_0 += 1){
									...
									for (x = x246, xp_1 = x246_p_0, xp_0 = 0;x < x246 + 1;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// y = 7, x = 1, h = 1, w = 1, c = 2, f = 64
												// T (c, 2) (2 / 1)
												for (c = c328, cp_2 = c328_p_1, cp_1 = c328_p_0, cp_0 = 0;c < c328 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
