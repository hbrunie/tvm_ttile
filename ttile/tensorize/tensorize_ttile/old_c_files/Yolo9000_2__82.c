...
/*
[V f; U (2, f); U (8, y); T (4, c); Hoist_vars [c]; T (8, x); T (3, w);
  T (3, h); T (17, x); T (34, y); T (2, f); T (8, c); T (1, x); T (2, x)]
*/
IND_TYPE c, cp_0, c156_p_0, cp_1, c156, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x260_p_0, x261_p_0, x262_p_0, xp_1, x260_p_1, x261_p_1, xp_2, x260_p_2, xp_3, x260, x261, x262, y, yp_0;
			...
			for (f = f104, fp_0 = 0;
				...
				for (y = y104, yp_0 = 0;
					...
					for (x260 = x261, x260_p_2 = x261_p_1, x260_p_1 = x261_p_0, x260_p_0 = 0;
						x260 < x261 + 136;
						x260 += 8, x260_p_2 += 8, x260_p_1 += 8, x260_p_0 += 8){
						// y = 8, x = 8, h = 3, w = 3, c = 4, f = 32
						// T (h, 3) (3 / 1)
						for (h = h104, hp_0 = 0;
							h < h104 + 3;
							h += 1, hp_0 += 1){
							// y = 8, x = 8, h = 1, w = 3, c = 4, f = 32
							// T (w, 3) (3 / 1)
							for (w = w104, wp_0 = 0;
								w < w104 + 3;
								w += 1, wp_0 += 1){
								// y = 8, x = 8, h = 1, w = 1, c = 4, f = 32
								// T (x, 8) (8 / 1)
