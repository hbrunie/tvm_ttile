...
for (x1182 = x1183, x1182_p_0 = 0;
	x1182 < x1183 + 272;
	x1182 += 68, x1182_p_0 += 68){
	// y = 272, x = 68, h = 3, w = 3, c = 32, f = 64
	// T (x, 2) (68 / 34)
	for (x1181 = x1182, x1181_p_1 = x1182_p_0, x1181_p_0 = 0;
		x1181 < x1182 + 68;
		x1181 += 34, x1181_p_1 += 34, x1181_p_0 += 34){
		...
		for (c708 = c709, c708_p_0 = 0;
			...
			for (y = y472, yp_0 = 0;
				...
				// T (x, 34) (34 / 1)
				for (x1180 = x1181, x1180_p_2 = x1181_p_1, x1180_p_1 = x1181_p_0, x1180_p_0 = 0;
					x1180 < x1181 + 34;
					x1180 += 1, x1180_p_2 += 1, x1180_p_1 += 1, x1180_p_0 += 1){
					...
					for (h = h472, hp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x = x1180, xp_3 = x1180_p_2, xp_2 = x1180_p_1, xp_1 = x1180_p_0, xp_0 = 0;
							x < x1180 + 1;
