...
for (x1332 = x1333, x1332_p_0 = 0;
	x1332 < x1333 + 272;
	x1332 += 16, x1332_p_0 += 16){
	// y = 272, x = 16, h = 3, w = 3, c = 32, f = 64
	// T (x, 8) (16 / 2)
	for (x1331 = x1332, x1331_p_1 = x1332_p_0, x1331_p_0 = 0;
		x1331 < x1332 + 16;
		x1331 += 2, x1331_p_1 += 2, x1331_p_0 += 2){
		...
		for (c798 = c799, c798_p_0 = 0;
			...
			for (y = y532, yp_0 = 0;
				...
				// T (x, 2) (2 / 1)
				for (x1330 = x1331, x1330_p_2 = x1331_p_1, x1330_p_1 = x1331_p_0, x1330_p_0 = 0;
					x1330 < x1331 + 2;
					x1330 += 1, x1330_p_2 += 1, x1330_p_1 += 1, x1330_p_0 += 1){
					...
					for (h = h532, hp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x = x1330, xp_3 = x1330_p_2, xp_2 = x1330_p_1, xp_1 = x1330_p_0, xp_0 = 0;
							x < x1330 + 1;
