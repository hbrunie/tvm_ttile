...
fp_1 = 0;
					for (h = h458, hp_0 = 0;h < h458 + 3;h += 1, hp_0 += 1){
						...
						for (x = x924, xp_1 = x924_p_0, xp_0 = 0;x < x924 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_7278 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_7279 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									// y = 7, x = 1, h = 1, w = 3, c = 2, f = 64
									// T (c, 2) (2 / 1)
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_7278);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_7279);
						}
					}
}
