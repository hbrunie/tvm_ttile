...
c0 = 0;
c0_p_0 = 0;
			for (f = f0, fp_0 = 0;f < f0 + 128;f += 16, fp_0 += 16){
						...
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 3, hp_0 += 3){
							...
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
								...
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_7 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
											mem_vec_8 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_9 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											// y = u_y, x = 1, h = 3, w = 1, c = 128, f = 16
											// T (c, 128) (128 / 1)
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_7);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_8);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_9);
								}
							}
						}
					}
						...
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 3, hp_0 += 3){
							...
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
								...
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_22 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
											// y = u_y, x = 1, h = 3, w = 1, c = 128, f = 16
											// T (c, 128) (128 / 1)
											for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 128;c += 1, cp_1 += 1, cp_0 += 1){
												scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_22);
								}
							}
						}
					}
