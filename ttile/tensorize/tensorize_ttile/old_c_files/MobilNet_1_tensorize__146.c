...
x96_p_1 = 0;
				for (h = h48, hp_0 = 0;h < h48 + 3;h += 1, hp_0 += 1){
					...
					for (w = w48, wp_0 = 0;w < w48 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 56) (56 / 1)
						for (x = x96, xp_2 = x96_p_1, xp_1 = x96_p_0, xp_0 = 0;x < x96 + 56;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_434 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
									mem_vec_435 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_434);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_435);
						}
					}
				}
}
