							...
							for (h = h276, hp_0 = 0;h < h276 + 3;h += 1, hp_0 += 1){
								...
								for (w = w276, wp_0 = 0;w < w276 + 3;w += 1, wp_0 += 1){
									...
									for (x = x414, xp_1 = x414_p_0, xp_0 = 0;x < x414 + 34;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_5984 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
												mem_vec_5985 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_5984);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_5985);
									}
								}
							}
}
