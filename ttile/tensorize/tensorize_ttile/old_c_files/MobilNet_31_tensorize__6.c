...
c375_p_0 = 0;
							for (w = w230, wp_0 = 0;w < w230 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 28) (28 / 1)
								for (x = x425, xp_1 = x425_p_0, xp_0 = 0;x < x425 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3311 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
											mem_vec_3312 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
											mem_vec_3313 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
											mem_vec_3314 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
											...
											mem_vec_3317 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_3311);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3312);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3313);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_3314);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3317);
								}
							}
}
