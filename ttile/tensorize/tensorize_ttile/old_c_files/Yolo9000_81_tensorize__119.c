							...
							for (w = w275, wp_0 = 0;w < w275 + 3;w += 1, wp_0 += 1){
								...
								for (x = x447, xp_1 = x447_p_0, xp_0 = 0;x < x447 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c447, cp_1 = c447_p_0, cp_0 = 0;c < c447 + 32;c += 1, cp_1 += 1, cp_0 += 1){
												...
												vec_29 = _mm512_fmadd_ps(vec_30, vec_31, mem_vec_5770);
												mem_vec_5770 = vec_29;
												vec_33 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
												vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_5771);
												mem_vec_5771 = vec_32;
												scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
												vec_35 = _mm512_set1_ps(scal_10);
												vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_5772);
												mem_vec_5772 = vec_34;
												vec_36 = _mm512_fmadd_ps(vec_35, vec_33, mem_vec_5773);
												mem_vec_5773 = vec_36;
												scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
												vec_38 = _mm512_set1_ps(scal_11);
												vec_37 = _mm512_fmadd_ps(vec_38, vec_31, mem_vec_5774);
												mem_vec_5774 = vec_37;
												vec_39 = _mm512_fmadd_ps(vec_38, vec_33, mem_vec_5775);
												mem_vec_5775 = vec_39;
												scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
												vec_41 = _mm512_set1_ps(scal_12);
												vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_5776);
												mem_vec_5776 = vec_40;
												vec_42 = _mm512_fmadd_ps(vec_41, vec_33, mem_vec_5777);
												mem_vec_5777 = vec_42;
												scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 1) + c];
												vec_44 = _mm512_set1_ps(scal_13);
												vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_5778);
												mem_vec_5778 = vec_43;
												vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_5779);
												mem_vec_5779 = vec_45;
												scal_14 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 1) + c];
												vec_47 = _mm512_set1_ps(scal_14);
												vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_5780);
												mem_vec_5780 = vec_46;
												vec_48 = _mm512_fmadd_ps(vec_47, vec_33, mem_vec_5781);
												mem_vec_5781 = vec_48;
												scal_15 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 1) + c];
												vec_50 = _mm512_set1_ps(scal_15);
												vec_49 = _mm512_fmadd_ps(vec_50, vec_31, mem_vec_5782);
												mem_vec_5782 = vec_49;
												vec_51 = _mm512_fmadd_ps(vec_50, vec_33, mem_vec_5783);
												mem_vec_5783 = vec_51;
												scal_16 = input[strideA1 * (x + w) + strideA2 * (y + 7 + h + 1) + c];
												vec_53 = _mm512_set1_ps(scal_16);
												vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_5784);
												mem_vec_5784 = vec_52;
												vec_54 = _mm512_fmadd_ps(vec_53, vec_33, mem_vec_5785);
												mem_vec_5785 = vec_54;
												scal_17 = input[strideA1 * (x + w) + strideA2 * (y + 8 + h + 1) + c];
												vec_56 = _mm512_set1_ps(scal_17);
												vec_55 = _mm512_fmadd_ps(vec_56, vec_31, mem_vec_5786);
												mem_vec_5786 = vec_55;
												vec_57 = _mm512_fmadd_ps(vec_56, vec_33, mem_vec_5787);
												mem_vec_5787 = vec_57;
												scal_18 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
												vec_59 = _mm512_set1_ps(scal_18);
												vec_60 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
												vec_58 = _mm512_fmadd_ps(vec_59, vec_60, mem_vec_5770);
												mem_vec_5770 = vec_58;
												vec_62 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
												vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_5771);
												mem_vec_5771 = vec_61;
												scal_19 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
												vec_64 = _mm512_set1_ps(scal_19);
												vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_5772);
												mem_vec_5772 = vec_63;
												vec_65 = _mm512_fmadd_ps(vec_64, vec_62, mem_vec_5773);
												mem_vec_5773 = vec_65;
												scal_20 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
												vec_67 = _mm512_set1_ps(scal_20);
												vec_66 = _mm512_fmadd_ps(vec_67, vec_60, mem_vec_5774);
												mem_vec_5774 = vec_66;
												vec_68 = _mm512_fmadd_ps(vec_67, vec_62, mem_vec_5775);
												mem_vec_5775 = vec_68;
												scal_21 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
												vec_70 = _mm512_set1_ps(scal_21);
												vec_69 = _mm512_fmadd_ps(vec_70, vec_60, mem_vec_5776);
												mem_vec_5776 = vec_69;
												vec_71 = _mm512_fmadd_ps(vec_70, vec_62, mem_vec_5777);
												mem_vec_5777 = vec_71;
												scal_22 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 2) + c];
												vec_73 = _mm512_set1_ps(scal_22);
												vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_5778);
												mem_vec_5778 = vec_72;
												vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_5779);
												mem_vec_5779 = vec_74;
												scal_23 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 2) + c];
												vec_76 = _mm512_set1_ps(scal_23);
												vec_75 = _mm512_fmadd_ps(vec_76, vec_60, mem_vec_5780);
												mem_vec_5780 = vec_75;
												vec_77 = _mm512_fmadd_ps(vec_76, vec_62, mem_vec_5781);
												mem_vec_5781 = vec_77;
												scal_24 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 2) + c];
												vec_79 = _mm512_set1_ps(scal_24);
												vec_78 = _mm512_fmadd_ps(vec_79, vec_60, mem_vec_5782);
												mem_vec_5782 = vec_78;
												vec_80 = _mm512_fmadd_ps(vec_79, vec_62, mem_vec_5783);
												mem_vec_5783 = vec_80;
												scal_25 = input[strideA1 * (x + w) + strideA2 * (y + 7 + h + 2) + c];
												vec_82 = _mm512_set1_ps(scal_25);
												vec_81 = _mm512_fmadd_ps(vec_82, vec_60, mem_vec_5784);
												mem_vec_5784 = vec_81;
												vec_83 = _mm512_fmadd_ps(vec_82, vec_62, mem_vec_5785);
												mem_vec_5785 = vec_83;
												scal_26 = input[strideA1 * (x + w) + strideA2 * (y + 8 + h + 2) + c];
												vec_85 = _mm512_set1_ps(scal_26);
												vec_84 = _mm512_fmadd_ps(vec_85, vec_60, mem_vec_5786);
												mem_vec_5786 = vec_84;
												vec_86 = _mm512_fmadd_ps(vec_85, vec_62, mem_vec_5787);
												mem_vec_5787 = vec_86;
											}
