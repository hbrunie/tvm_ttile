...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (256, c); T (2, f); T (1, y); T (2, c); T (8, f)]
*/
IND_TYPE c, cp_0, c160_p_0, c161_p_0, cp_1, c160_p_1, cp_2, c160, c161, f, fp_0, f120_p_0, fp_1, f120, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y80 = 0;
IND_TYPE x80 = 0;
IND_TYPE h80 = 0;
IND_TYPE w80 = 0;
					...
					for (h = h80, hp_0 = 0;h < h80 + 3;h += 1, hp_0 += 1){
						...
						for (w = w80, wp_0 = 0;w < w80 + 3;w += 1, wp_0 += 1){
							...
							for (x = x80, xp_0 = 0;x < x80 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 2) (2 / 1)
										for (c = c160, cp_2 = c160_p_1, cp_1 = c160_p_0, cp_0 = 0;c < c160 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
