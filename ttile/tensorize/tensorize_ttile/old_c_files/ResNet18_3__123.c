...
for (y752 = y753, y752_p_0 = 0;
	...
	for (x943 = x944, x943_p_0 = 0;
		...
		// T (y, 1) (28 / 28)
		for (y751 = y752, y751_p_1 = y752_p_0, y751_p_0 = 0;
			y751 < y752 + 28;
			y751 += 28, y751_p_1 += 28, y751_p_0 += 28){
			// y = 28, x = 4, h = 1, w = 1, c = 64, f = 64
			// T (x, 2) (4 / 2)
			for (x942 = x943, x942_p_1 = x943_p_0, x942_p_0 = 0;
				...
				for (f = f371, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y751, yp_2 = y751_p_1, yp_1 = y751_p_0, yp_0 = 0;
						y < y751 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (2 / 2)
						for (x941 = x942, x941_p_2 = x942_p_1, x941_p_1 = x942_p_0, x941_p_0 = 0;
							x941 < x942 + 2;
							x941 += 2, x941_p_2 += 2, x941_p_1 += 2, x941_p_0 += 2){
							// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c570 = c571, c570_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x941, xp_3 = x941_p_2, xp_2 = x941_p_1, xp_1 = x941_p_0, xp_0 = 0;
									x < x941 + 2;
