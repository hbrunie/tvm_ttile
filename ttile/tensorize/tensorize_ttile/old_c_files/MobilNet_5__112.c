...
/*
[V f; U (4, f); U (7, y); U (3, h); T (64, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (4, y); T (1, f); T (1, c); T (4, f); T (4, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c434_p_0, c435_p_0, cp_1, c434_p_1, cp_2, c434, c435, f, fp_0, f444_p_0, f445_p_0, fp_1, f444_p_1, fp_2, f444, f445, w, wp_0, x, xp_0, x342_p_0, xp_1, x342, y, yp_0;
							...
							for (w = w228, wp_0 = 0;
								...
								for (x = x342, xp_1 = x342_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2910 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
											mem_vec_2911 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_2910);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_2911);
								}
							}
						}
					}
