...
y42 = 0;
y42_p_0 = 0;
	for (c42 = c43, c42_p_0 = 0;c42 < c43 + 32;c42 += 32, c42_p_0 += 32){
			for (y = y42, yp_1 = y42_p_0, yp_0 = 0;y < y42 + 60;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x28, xp_0 = 0;x < x28 + 112;x += 1, xp_0 += 1){
			...
			for (y = y42 + 60, yp_1 = y42_p_0, yp_0 = 0;y < y42 + 60 + 52;y += 13, yp_1 += 13, yp_0 += 13){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x28, xp_0 = 0;x < x28 + 112;x += 1, xp_0 += 1){
					// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 32
