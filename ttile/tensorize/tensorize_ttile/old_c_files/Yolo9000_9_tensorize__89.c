...
y240 = 0;
y240_p_0 = 0;
	for (x321 = x322, x321_p_0 = 0;x321 < x322 + 68;x321 += 4, x321_p_0 += 4){
			for (y = y240, yp_1 = y240_p_0, yp_0 = 0;y < y240 + 8;y += 8, yp_1 += 8, yp_0 += 8){
				// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (4 / 4)
				for (x320 = x321, x320_p_1 = x321_p_0, x320_p_0 = 0;x320 < x321 + 4;x320 += 4, x320_p_1 += 4, x320_p_0 += 4){
					// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
					// T (f, 4) (128 / 32)
					for (f = f160, fp_0 = 0;f < f160 + 128;f += 32, fp_0 += 32){
						// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 32
						// T (c, 4) (256 / 64)
						for (c240 = c241, c240_p_0 = 0;c240 < c241 + 256;c240 += 64, c240_p_0 += 64){
							// y = ph_y, x = 4, h = 1, w = 1, c = 64, f = 32
							// T (x, 4) (4 / 1)
							for (x = x320, xp_2 = x320_p_1, xp_1 = x320_p_0, xp_0 = 0;x < x320 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y240 + 8, yp_1 = y240_p_0, yp_0 = 0;y < y240 + 8 + 60;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (4 / 4)
				for (x320 = x321, x320_p_1 = x321_p_0, x320_p_0 = 0;x320 < x321 + 4;x320 += 4, x320_p_1 += 4, x320_p_0 += 4){
					// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
