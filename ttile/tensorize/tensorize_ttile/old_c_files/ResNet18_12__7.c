...
[V f; U (4, f); U (7, y); U (3, h); T (4, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (32, c); T (8, f); T (1, y); T (8, c); T (2, f)]
*/
IND_TYPE c, cp_0, c824_p_0, c825_p_0, cp_1, c824_p_1, cp_2, c824, c825, f, fp_0, f618_p_0, fp_1, f618, w, wp_0, x, xp_0, y, yp_0;
