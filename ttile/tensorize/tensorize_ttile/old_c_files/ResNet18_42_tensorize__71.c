...
fp_1 = 0;
						for (w = w604, wp_0 = 0;w < w604 + 3;w += 1, wp_0 += 1){
							...
							for (x = x960, xp_1 = x960_p_0, xp_0 = 0;x < x960 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_9270 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_9271 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_9270);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_9271);
							}
						}
}
