...
[V f; U (1, f); U (14, y); U (3, h); T (128, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (2, f); T (4, c); T (2, x); T (1, y); T (16, f)]
*/
IND_TYPE c, cp_0, c436_p_0, cp_1, c436, f, fp_0, f236_p_0, fp_1, f236, w, wp_0, x, xp_0, x336_p_0, xp_1, x336, y, yp_0;
					...
					for (w = w224, wp_0 = 0;
						...
						for (x = x336, xp_1 = x336_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_2979 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_2980 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_2981 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									...
									for (c = c436, cp_1 = c436_p_0, cp_0 = 0;
										...
										vec_25 = _mm512_fmadd_ps(vec_26, vec_2, mem_vec_2980);
										mem_vec_2980 = vec_25;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
										vec_28 = _mm512_set1_ps(scal_13);


										vec_27 = _mm512_fmadd_ps(vec_28, vec_2, mem_vec_2981);
										mem_vec_2981 = vec_27;
										...
										vec_32 = _mm512_fmadd_ps(vec_33, vec_31, mem_vec_2969);
										mem_vec_2969 = vec_32;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_16);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_2970);
										mem_vec_2970 = vec_34;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_37 = _mm512_set1_ps(scal_17);


										vec_36 = _mm512_fmadd_ps(vec_37, vec_31, mem_vec_2971);
										mem_vec_2971 = vec_36;
										...
										vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_2973);
										mem_vec_2973 = vec_40;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_43 = _mm512_set1_ps(scal_20);


										vec_42 = _mm512_fmadd_ps(vec_43, vec_31, mem_vec_2974);
										mem_vec_2974 = vec_42;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_45 = _mm512_set1_ps(scal_21);


										vec_44 = _mm512_fmadd_ps(vec_45, vec_31, mem_vec_2975);
										mem_vec_2975 = vec_44;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_22);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_2976);
										mem_vec_2976 = vec_46;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
										vec_49 = _mm512_set1_ps(scal_23);


										vec_48 = _mm512_fmadd_ps(vec_49, vec_31, mem_vec_2977);
										mem_vec_2977 = vec_48;
										scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
										vec_51 = _mm512_set1_ps(scal_24);


										vec_50 = _mm512_fmadd_ps(vec_51, vec_31, mem_vec_2978);
										mem_vec_2978 = vec_50;
										scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
										vec_53 = _mm512_set1_ps(scal_25);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_2979);
										mem_vec_2979 = vec_52;
										scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
										vec_55 = _mm512_set1_ps(scal_26);


										vec_54 = _mm512_fmadd_ps(vec_55, vec_31, mem_vec_2980);
										mem_vec_2980 = vec_54;
										scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 1) + c];
										vec_57 = _mm512_set1_ps(scal_27);


										vec_56 = _mm512_fmadd_ps(vec_57, vec_31, mem_vec_2981);
										mem_vec_2981 = vec_56;
										...
										vec_61 = _mm512_fmadd_ps(vec_62, vec_60, mem_vec_2969);
										mem_vec_2969 = vec_61;
										scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_30);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_2970);
										mem_vec_2970 = vec_63;
										scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_66 = _mm512_set1_ps(scal_31);


										vec_65 = _mm512_fmadd_ps(vec_66, vec_60, mem_vec_2971);
										mem_vec_2971 = vec_65;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_2979);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2980);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_2981);
						}
					}
				}
			}
