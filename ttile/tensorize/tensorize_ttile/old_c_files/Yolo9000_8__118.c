...
/*
[V f; U (4, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (17, x);
  T (3, h); T (2, f); T (1, x); T (17, y); T (1, f); T (64, c); T (4, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c66_p_0, cp_1, c66, f, fp_0, f88_p_0, f89_p_0, fp_1, f88_p_1, fp_2, f88, f89, h, hp_0, x, xp_0, x88_p_0, x89_p_0, xp_1, x88_p_1, xp_2, x88, x89, y, yp_0;
								...
								for (x = x88, xp_2 = x88_p_1, xp_1 = x88_p_0, xp_0 = 0;
									...
									x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c66, cp_1 = c66_p_0, cp_0 = 0;
												...
												vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_352);
												mem_vec_352 = vec_24;

												vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_353);
												mem_vec_353 = vec_27;

												vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

												vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_354);
												mem_vec_354 = vec_29;

												vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

												vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_355);
												mem_vec_355 = vec_31;
												scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_34 = _mm512_set1_ps(scal_5);


												vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_356);
												mem_vec_356 = vec_33;



												vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_357);
												mem_vec_357 = vec_35;



												vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_358);
												mem_vec_358 = vec_36;



												vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_359);
												mem_vec_359 = vec_37;
												scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_39 = _mm512_set1_ps(scal_6);


												vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_360);
												mem_vec_360 = vec_38;



												vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_361);
												mem_vec_361 = vec_40;



												vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_362);
												mem_vec_362 = vec_41;



												vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_363);
												mem_vec_363 = vec_42;
												scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_44 = _mm512_set1_ps(scal_7);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_364);
												mem_vec_364 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_365);
												mem_vec_365 = vec_45;



												vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_366);
												mem_vec_366 = vec_46;



												vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_367);
												mem_vec_367 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_49 = _mm512_set1_ps(scal_8);
												vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_352);
												mem_vec_352 = vec_48;

												vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_353);
												mem_vec_353 = vec_51;

												vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

												vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_354);
												mem_vec_354 = vec_53;

												vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

												vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_355);
												mem_vec_355 = vec_55;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_58 = _mm512_set1_ps(scal_9);


												vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_356);
												mem_vec_356 = vec_57;



												vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_357);
												mem_vec_357 = vec_59;



												vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_358);
												mem_vec_358 = vec_60;



												vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_359);
												mem_vec_359 = vec_61;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_63 = _mm512_set1_ps(scal_10);


												vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_360);
												mem_vec_360 = vec_62;



												vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_361);
												mem_vec_361 = vec_64;



												vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_362);
												mem_vec_362 = vec_65;



												vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_363);
												mem_vec_363 = vec_66;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_68 = _mm512_set1_ps(scal_11);


												vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_364);
												mem_vec_364 = vec_67;



												vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_365);
												mem_vec_365 = vec_69;



												vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_366);
												mem_vec_366 = vec_70;



												vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_367);
												mem_vec_367 = vec_71;
											}
