...
c0_p_0 = 0;
			for (f = f0, fp_0 = 0;f < f0 + 128;f += 64, fp_0 += 64){
					for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 8;y += 4, yp_1 += 4, yp_0 += 4){
						// y = u_y, x = 4, h = 3, w = 3, c = 64, f = 64
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 4, h = 1, w = 3, c = 64, f = 64
							// T (w, 1) (3 / 3)
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 3, wp_0 += 3){
								// y = u_y, x = 4, h = 1, w = 3, c = 64, f = 64
								// T (x, 4) (4 / 1)
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = u_y, x = 1, h = 1, w = 3, c = 64, f = 64
											// T (c, 64) (64 / 1)
											for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 64;c += 1, cp_1 += 1, cp_0 += 1){
					...
					for (y = y0 + 8, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 8 + 6;y += 6, yp_1 += 6, yp_0 += 6){
						// y = u_y, x = 4, h = 3, w = 3, c = 64, f = 64
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 4, h = 1, w = 3, c = 64, f = 64
							...
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 3, wp_0 += 3){
								...
								// T (x, 4) (4 / 1)
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_16 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
											mem_vec_17 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
											mem_vec_18 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
											mem_vec_19 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
											mem_vec_20 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											mem_vec_21 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16]);
											mem_vec_22 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
											mem_vec_23 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
											mem_vec_24 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
											mem_vec_25 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16]);
											mem_vec_26 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
											mem_vec_27 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
											mem_vec_28 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
											mem_vec_29 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
											mem_vec_30 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
											mem_vec_31 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
											mem_vec_32 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
											mem_vec_33 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											mem_vec_34 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
											mem_vec_35 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
											mem_vec_36 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
											mem_vec_37 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
											mem_vec_38 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
											mem_vec_39 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
											// y = u_y, x = 1, h = 1, w = 3, c = 64, f = 64
											// T (c, 64) (64 / 1)
											for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 64;c += 1, cp_1 += 1, cp_0 += 1){
												scal_0 = input[strideA1 * (2 * x + w) + strideA2 * (2 * y + h) + c];
												...
												vec_34 = _mm512_fmadd_ps(vec_35, vec_36, mem_vec_16);
												mem_vec_16 = vec_34;
												vec_38 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
												vec_37 = _mm512_fmadd_ps(vec_35, vec_38, mem_vec_17);
												mem_vec_17 = vec_37;
												vec_40 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
												vec_39 = _mm512_fmadd_ps(vec_35, vec_40, mem_vec_18);
												mem_vec_18 = vec_39;
												vec_42 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
												vec_41 = _mm512_fmadd_ps(vec_35, vec_42, mem_vec_19);
												mem_vec_19 = vec_41;
												scal_7 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 1) + h) + c];
												vec_44 = _mm512_set1_ps(scal_7);
												vec_43 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_20);
												mem_vec_20 = vec_43;
												vec_45 = _mm512_fmadd_ps(vec_44, vec_38, mem_vec_21);
												mem_vec_21 = vec_45;
												vec_46 = _mm512_fmadd_ps(vec_44, vec_40, mem_vec_22);
												mem_vec_22 = vec_46;
												vec_47 = _mm512_fmadd_ps(vec_44, vec_42, mem_vec_23);
												mem_vec_23 = vec_47;
												scal_8 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 2) + h) + c];
												vec_49 = _mm512_set1_ps(scal_8);
												vec_48 = _mm512_fmadd_ps(vec_49, vec_36, mem_vec_24);
												mem_vec_24 = vec_48;
												vec_50 = _mm512_fmadd_ps(vec_49, vec_38, mem_vec_25);
												mem_vec_25 = vec_50;
												vec_51 = _mm512_fmadd_ps(vec_49, vec_40, mem_vec_26);
												mem_vec_26 = vec_51;
												vec_52 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_27);
												mem_vec_27 = vec_52;
												scal_9 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 3) + h) + c];
												vec_54 = _mm512_set1_ps(scal_9);
												vec_53 = _mm512_fmadd_ps(vec_54, vec_36, mem_vec_28);
												mem_vec_28 = vec_53;
												vec_55 = _mm512_fmadd_ps(vec_54, vec_38, mem_vec_29);
												mem_vec_29 = vec_55;
												vec_56 = _mm512_fmadd_ps(vec_54, vec_40, mem_vec_30);
												mem_vec_30 = vec_56;
												vec_57 = _mm512_fmadd_ps(vec_54, vec_42, mem_vec_31);
												mem_vec_31 = vec_57;
												scal_10 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 4) + h) + c];
												vec_59 = _mm512_set1_ps(scal_10);
												vec_58 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_32);
												mem_vec_32 = vec_58;
												vec_60 = _mm512_fmadd_ps(vec_59, vec_38, mem_vec_33);
												mem_vec_33 = vec_60;
												vec_61 = _mm512_fmadd_ps(vec_59, vec_40, mem_vec_34);
												mem_vec_34 = vec_61;
												vec_62 = _mm512_fmadd_ps(vec_59, vec_42, mem_vec_35);
												mem_vec_35 = vec_62;
												scal_11 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 5) + h) + c];
												vec_64 = _mm512_set1_ps(scal_11);
												vec_63 = _mm512_fmadd_ps(vec_64, vec_36, mem_vec_36);
												mem_vec_36 = vec_63;
												vec_65 = _mm512_fmadd_ps(vec_64, vec_38, mem_vec_37);
												mem_vec_37 = vec_65;
												vec_66 = _mm512_fmadd_ps(vec_64, vec_40, mem_vec_38);
												mem_vec_38 = vec_66;
												vec_67 = _mm512_fmadd_ps(vec_64, vec_42, mem_vec_39);
												mem_vec_39 = vec_67;
												scal_12 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * y + h) + c];
												vec_69 = _mm512_set1_ps(scal_12);
												vec_70 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
												vec_68 = _mm512_fmadd_ps(vec_69, vec_70, mem_vec_16);
												mem_vec_16 = vec_68;
												vec_72 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
												vec_71 = _mm512_fmadd_ps(vec_69, vec_72, mem_vec_17);
												mem_vec_17 = vec_71;
												vec_74 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
												vec_73 = _mm512_fmadd_ps(vec_69, vec_74, mem_vec_18);
												mem_vec_18 = vec_73;
												vec_76 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
												vec_75 = _mm512_fmadd_ps(vec_69, vec_76, mem_vec_19);
												mem_vec_19 = vec_75;
												scal_13 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 1) + h) + c];
												vec_78 = _mm512_set1_ps(scal_13);
												vec_77 = _mm512_fmadd_ps(vec_78, vec_70, mem_vec_20);
												mem_vec_20 = vec_77;
												vec_79 = _mm512_fmadd_ps(vec_78, vec_72, mem_vec_21);
												mem_vec_21 = vec_79;
												vec_80 = _mm512_fmadd_ps(vec_78, vec_74, mem_vec_22);
												mem_vec_22 = vec_80;
												vec_81 = _mm512_fmadd_ps(vec_78, vec_76, mem_vec_23);
												mem_vec_23 = vec_81;
												scal_14 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 2) + h) + c];
												vec_83 = _mm512_set1_ps(scal_14);
												vec_82 = _mm512_fmadd_ps(vec_83, vec_70, mem_vec_24);
												mem_vec_24 = vec_82;
												vec_84 = _mm512_fmadd_ps(vec_83, vec_72, mem_vec_25);
												mem_vec_25 = vec_84;
												vec_85 = _mm512_fmadd_ps(vec_83, vec_74, mem_vec_26);
												mem_vec_26 = vec_85;
												vec_86 = _mm512_fmadd_ps(vec_83, vec_76, mem_vec_27);
												mem_vec_27 = vec_86;
												scal_15 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 3) + h) + c];
												vec_88 = _mm512_set1_ps(scal_15);
												vec_87 = _mm512_fmadd_ps(vec_88, vec_70, mem_vec_28);
												mem_vec_28 = vec_87;
												vec_89 = _mm512_fmadd_ps(vec_88, vec_72, mem_vec_29);
												mem_vec_29 = vec_89;
												vec_90 = _mm512_fmadd_ps(vec_88, vec_74, mem_vec_30);
												mem_vec_30 = vec_90;
												vec_91 = _mm512_fmadd_ps(vec_88, vec_76, mem_vec_31);
												mem_vec_31 = vec_91;
												scal_16 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 4) + h) + c];
												vec_93 = _mm512_set1_ps(scal_16);
												vec_92 = _mm512_fmadd_ps(vec_93, vec_70, mem_vec_32);
												mem_vec_32 = vec_92;
												vec_94 = _mm512_fmadd_ps(vec_93, vec_72, mem_vec_33);
												mem_vec_33 = vec_94;
												vec_95 = _mm512_fmadd_ps(vec_93, vec_74, mem_vec_34);
												mem_vec_34 = vec_95;
												vec_96 = _mm512_fmadd_ps(vec_93, vec_76, mem_vec_35);
												mem_vec_35 = vec_96;
												scal_17 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 5) + h) + c];
												vec_98 = _mm512_set1_ps(scal_17);
												vec_97 = _mm512_fmadd_ps(vec_98, vec_70, mem_vec_36);
												mem_vec_36 = vec_97;
												vec_99 = _mm512_fmadd_ps(vec_98, vec_72, mem_vec_37);
												mem_vec_37 = vec_99;
												vec_100 = _mm512_fmadd_ps(vec_98, vec_74, mem_vec_38);
												mem_vec_38 = vec_100;
												vec_101 = _mm512_fmadd_ps(vec_98, vec_76, mem_vec_39);
												mem_vec_39 = vec_101;
											}
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_16);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_17);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_18);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_19);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_20);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16], mem_vec_21);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_22);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_23);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_24);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16], mem_vec_25);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_26);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_27);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_28);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_29);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_30);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_31);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_32);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_33);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_34);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_35);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_36);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_37);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_38);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_39);
								}
							}
						}
					}
