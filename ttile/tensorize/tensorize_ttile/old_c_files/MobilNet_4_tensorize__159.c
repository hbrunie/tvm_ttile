...
[V f; U (2, f); ULambda y; T (64, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); Lambda_apply y [((Iter 1), (Arg 8)); ((Iter 2), (Arg 10))];
...
c0_p_0 = 0;
			for (f = f0, fp_0 = 0;f < f0 + 128;f += 32, fp_0 += 32){
					for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 8;y += 8, yp_1 += 8, yp_0 += 8){
					...
					for (y = y0 + 8, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 8 + 20;y += 10, yp_1 += 10, yp_0 += 10){
						// y = u_y, x = 2, h = 3, w = 3, c = 64, f = 32
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 2, h = 1, w = 3, c = 64, f = 32
