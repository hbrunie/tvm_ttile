...
[V f; U (1, f); U (14, y); U (3, h); T (8, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (4, f); T (8, c); T (7, x); T (2, y); T (2, f)]
*/
					...
					for (w = w168, wp_0 = 0;
						...
						for (x = x252, xp_1 = x252_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_2027 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_2028 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_2029 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									...
									for (c = c252, cp_1 = c252_p_0, cp_0 = 0;
										...
										vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_2026);
										mem_vec_2026 = vec_21;
										...
										vec_25 = _mm512_fmadd_ps(vec_26, vec_2, mem_vec_2028);
										mem_vec_2028 = vec_25;
										scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 13) + h) + c];
										vec_28 = _mm512_set1_ps(scal_13);


										vec_27 = _mm512_fmadd_ps(vec_28, vec_2, mem_vec_2029);
										mem_vec_2029 = vec_27;
										...
										vec_32 = _mm512_fmadd_ps(vec_33, vec_31, mem_vec_2017);
										mem_vec_2017 = vec_32;
										scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_16);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_2018);
										mem_vec_2018 = vec_34;
										scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
										vec_37 = _mm512_set1_ps(scal_17);


										vec_36 = _mm512_fmadd_ps(vec_37, vec_31, mem_vec_2019);
										mem_vec_2019 = vec_36;
										...
										vec_61 = _mm512_fmadd_ps(vec_62, vec_60, mem_vec_2017);
										mem_vec_2017 = vec_61;
										scal_30 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_30);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_2018);
										mem_vec_2018 = vec_63;
										scal_31 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
										vec_66 = _mm512_set1_ps(scal_31);


										vec_65 = _mm512_fmadd_ps(vec_66, vec_60, mem_vec_2019);
										mem_vec_2019 = vec_65;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_2027);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2028);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_2029);
						}
					}
				}
			}
