...
[V f; U (4, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, y); T (2, f); T (2, c); T (2, f); T (4, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c674_p_0, c675_p_0, cp_1, c674_p_1, cp_2, c674, c675, f, fp_0, f684_p_0, f685_p_0, fp_1, f684_p_1, fp_2, f684, f685, w, wp_0, x, xp_0, x522_p_0, xp_1, x522, y, yp_0;
		...
		for (c675 = c676, c675_p_0 = 0;
			...
			for (f684 = f685, f684_p_1 = f685_p_0, f684_p_0 = 0;
				...
				for (c674 = c675, c674_p_1 = c675_p_0, c674_p_0 = 0;
					c674 < c675 + 64;
					c674 += 32, c674_p_1 += 32, c674_p_0 += 32){
