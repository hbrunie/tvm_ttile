		...
		for (f = f116, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				for (y = y66, yp_1 = y66_p_0, yp_0 = 0;
					...
					// T (x, 2) (34 / 17)
					for (x97 = x98, x97_p_1 = x98_p_0, x97_p_0 = 0;
						x97 < x98 + 34;
						x97 += 17, x97_p_1 += 17, x97_p_0 += 17){
						...
						for (c93 = c94, c93_p_0 = 0;
							...
							for (w = w35, wp_0 = 0;
								...
								// T (x, 17) (17 / 1)
								for (x = x97, xp_2 = x97_p_1, xp_1 = x97_p_0, xp_0 = 0;
									x < x97 + 17;
									...
									for (h = h62, hp_0 = 0;
										...
										h += 1, hp_0 += 1){
												...
												mem_vec_1412 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
												mem_vec_1413 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_1412);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_1413);
									}
								}
							}
						}
				...
				for (y = y66 + 22, yp_1 = y66_p_0, yp_0 = 0;
					y < y66 + 22 + 12;
