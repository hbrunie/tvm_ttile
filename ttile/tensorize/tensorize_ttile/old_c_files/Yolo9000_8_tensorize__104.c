...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, f); T (1, x); T (17, y); T (4, f); T (4, c); T (34, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c126_p_0, cp_1, c126, f, fp_0, f168_p_0, f169_p_0, fp_1, f168_p_1, fp_2, f168, f169, h, hp_0, x, xp_0, x168_p_0, x169_p_0, xp_1, x168_p_1, xp_2, x168, x169, y, yp_0;
IND_TYPE y84 = 0;
IND_TYPE x170 = 0;
IND_TYPE h84 = 0;
IND_TYPE w = 0;
