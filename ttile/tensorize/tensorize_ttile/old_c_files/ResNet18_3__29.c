...
for (y572 = y573, y572_p_0 = 0;
	...
	for (x718 = x719, x718_p_0 = 0;
		...
		// T (y, 1) (56 / 56)
		for (y571 = y572, y571_p_1 = y572_p_0, y571_p_0 = 0;
			y571 < y572 + 56;
			y571 += 56, y571_p_1 += 56, y571_p_0 += 56){
			// y = 56, x = 28, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (28 / 2)
			for (x717 = x718, x717_p_1 = x718_p_0, x717_p_0 = 0;
				x717 < x718 + 28;
				x717 += 2, x717_p_1 += 2, x717_p_0 += 2){
				...
				for (f = f281, fp_0 = 0;
					...
					// T (y, 4) (56 / 14)
					for (y = y571, yp_2 = y571_p_1, yp_1 = y571_p_0, yp_0 = 0;
						y < y571 + 56;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (2 / 2)
						for (x716 = x717, x716_p_2 = x717_p_1, x716_p_1 = x717_p_0, x716_p_0 = 0;
							x716 < x717 + 2;
							x716 += 2, x716_p_2 += 2, x716_p_1 += 2, x716_p_0 += 2){
							// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c435 = c436, c435_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x716, xp_3 = x716_p_2, xp_2 = x716_p_1, xp_1 = x716_p_0, xp_0 = 0;
									x < x716 + 2;
