...
[V f; U (2, f); U (8, y); T (16, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (4, x); T (34, y); T (2, f); T (2, c); T (1, x); T (68, x)]
*/
IND_TYPE c, cp_0, c414_p_0, cp_1, c414, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x690_p_0, x691_p_0, x692_p_0, xp_1, x690_p_1, x691_p_1, xp_2, x690_p_2, xp_3, x690, x691, x692, y, yp_0;
			...
			for (f = f276, fp_0 = 0;
				...
				for (y = y276, yp_0 = 0;
					...
					for (x690 = x691, x690_p_2 = x691_p_1, x690_p_1 = x691_p_0, x690_p_0 = 0;
						x690 < x691 + 4;
						x690 += 1, x690_p_2 += 1, x690_p_1 += 1, x690_p_0 += 1){
