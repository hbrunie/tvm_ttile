...
[V f; U (4, f); ULambda y; U (3, w); T (32, c); Hoist_vars [c]; T (4, x);
  T (1, w); T (3, h); T (4, y); T (2, f); T (4, c); T (14, x);
  Lambda_apply y [((Iter 2), (Arg 4)); ((Iter 1), (Arg 6))]]
*/
...
__m512 mem_vec_0 ,mem_vec_1 ,mem_vec_10 ,mem_vec_11 ,mem_vec_12 ,mem_vec_13 ,mem_vec_14 ,mem_vec_15 ,mem_vec_16 ,mem_vec_17 ,mem_vec_18 ,mem_vec_19 ,mem_vec_2 ,mem_vec_20 ,mem_vec_21 ,mem_vec_22 ,mem_vec_23 ,mem_vec_24 ,mem_vec_25 ,mem_vec_26 ,mem_vec_27 ,mem_vec_28 ,mem_vec_29 ,mem_vec_3 ,mem_vec_30 ,mem_vec_31 ,mem_vec_32 ,mem_vec_33 ,mem_vec_34 ,mem_vec_35 ,mem_vec_36 ,mem_vec_37 ,mem_vec_38 ,mem_vec_39 ,mem_vec_4 ,mem_vec_5 ,mem_vec_6 ,mem_vec_7 ,mem_vec_8 ,mem_vec_9 ,vec_0 ,vec_1 ,vec_10 ,vec_100 ,vec_101 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_81 ,vec_82 ,vec_83 ,vec_84 ,vec_85 ,vec_86 ,vec_87 ,vec_88 ,vec_89 ,vec_9 ,vec_90 ,vec_91 ,vec_92 ,vec_93 ,vec_94 ,vec_95 ,vec_96 ,vec_97 ,vec_98 ,vec_99;
	for (y0 = y1, y0_p_0 = 0;
		y0 < y1 + 32;
		y0 += 16, y0_p_0 += 16){
		// y = 4 * u_y, x = 56, h = 3, w = 3, c = 128, f = 128
		// T (x, 14) (56 / 4)
		for (x0 = x1, x0_p_0 = 0;
			x0 < x1 + 56;
			x0 += 4, x0_p_0 += 4){
			// y = 4 * u_y, x = 4, h = 3, w = 3, c = 128, f = 128
			// T (c, 4) (128 / 32)
			for (c0 = c1, c0_p_0 = 0;
				c0 < c1 + 128;
				c0 += 32, c0_p_0 += 32){
				// y = 4 * u_y, x = 4, h = 3, w = 3, c = 32, f = 128
				// T (f, 2) (128 / 64)
				for (f = f0, fp_0 = 0;
					f < f0 + 128;
					f += 64, fp_0 += 64){
					// y = 4 * u_y, x = 4, h = 3, w = 3, c = 32, f = 64
					// T (y, 4) (4 * u_y / u_y)
