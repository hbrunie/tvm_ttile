...
c350_p_1 = 0;
				for (h = h164, hp_0 = 0;h < h164 + 3;h += 1, hp_0 += 1){
					...
					for (x = x350, xp_1 = x350_p_0, xp_0 = 0;x < x350 + 7;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_2278 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
								mem_vec_2279 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
								...
								mem_vec_2282 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
								mem_vec_2283 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								// y = 7, x = 1, h = 1, w = 3, c = 1, f = 64
								// T (c, 1) (1 / 1)
								for (c = c350, cp_2 = c350_p_1, cp_1 = c350_p_0, cp_0 = 0;c < c350 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_2278);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_2279);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_2282);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_2283);
					}
				}
}
