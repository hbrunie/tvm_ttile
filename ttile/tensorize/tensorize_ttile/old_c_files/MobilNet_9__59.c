...
[V f; U (4, f); U (7, y); U (3, h); T (4, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (2, c); T (4, f); T (1, y); T (128, c); T (4, f)]
*/
IND_TYPE c, cp_0, c992_p_0, c993_p_0, cp_1, c992_p_1, cp_2, c992, c993, f, fp_0, f744_p_0, fp_1, f744, w, wp_0, x, xp_0, y, yp_0;
