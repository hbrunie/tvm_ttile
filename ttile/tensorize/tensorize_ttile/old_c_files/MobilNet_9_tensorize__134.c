...
[V f; U (4, f); U (7, y); T (16, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (2, c); T (1, f); T (1, y); T (32, c); T (16, f)]
*/
IND_TYPE c, cp_0, c424_p_0, c425_p_0, cp_1, c424_p_1, cp_2, c424, c425, f, fp_0, f318_p_0, fp_1, f318, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y212 = 0;
IND_TYPE x212 = 0;
IND_TYPE h212 = 0;
IND_TYPE w212 = 0;
