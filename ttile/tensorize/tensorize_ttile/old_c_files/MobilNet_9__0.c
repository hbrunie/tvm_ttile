...
[V f; U (4, f); U (7, y); U (3, h); T (1, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (256, c); T (1, f); T (1, y); T (4, c); T (16, f)]
*/
IND_TYPE c, cp_0, c800_p_0, c801_p_0, cp_1, c800_p_1, cp_2, c800, c801, f, fp_0, f600_p_0, fp_1, f600, w, wp_0, x, xp_0, y, yp_0;
