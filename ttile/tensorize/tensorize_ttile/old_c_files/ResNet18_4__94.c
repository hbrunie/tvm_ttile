...
[V f; U (1, f); U (14, y); U (3, h); T (32, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (4, f); T (2, c); T (7, x); T (2, y); T (2, f)]
*/
IND_TYPE c, cp_0, c246_p_0, cp_1, c246, f, fp_0, f246_p_0, fp_1, f246, w, wp_0, x, xp_0, x246_p_0, xp_1, x246, y, yp_0;
					...
					for (w = w164, wp_0 = 0;
						...
						for (x = x246, xp_1 = x246_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1995 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_1996 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_1997 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_1998 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_1999 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_2000 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_2001 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									...
									for (c = c246, cp_1 = c246_p_0, cp_0 = 0;
										...
										vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_1995);
										mem_vec_1995 = vec_15;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_1995);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_1996);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_1997);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_1998);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1999);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2000);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_2001);
						}
					}
				}
			}
