...
c1120_p_1 = 0;
					for (w = w660, wp_0 = 0;w < w660 + 3;w += 1, wp_0 += 1){
						...
						for (x = x1274, xp_1 = x1274_p_0, xp_0 = 0;x < x1274 + 56;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_11566 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_11567 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_11566);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_11567);
						}
					}
}
