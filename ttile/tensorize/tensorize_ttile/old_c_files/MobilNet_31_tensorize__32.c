...
c432_p_0 = 0;
							for (w = w268, wp_0 = 0;w < w268 + 3;w += 1, wp_0 += 1){
								...
								for (x = x482, xp_1 = x482_p_0, xp_0 = 0;x < x482 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3749 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
											mem_vec_3750 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_3751 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_3752 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_3749);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3750);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3751);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_3752);
								}
							}
}
