...
[V f; U (2, f); U (8, y); T (16, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (2, x); T (34, y); T (2, f); T (2, c); T (17, x); T (2, x)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x340_p_0, x341_p_0, x342_p_0, xp_1, x340_p_1, x341_p_1, xp_2, x340_p_2, xp_3, x340, x341, x342, y, yp_0;
			...
			for (f = f136, fp_0 = 0;
				...
				for (y = y136, yp_0 = 0;
					...
					for (x340 = x341, x340_p_2 = x341_p_1, x340_p_1 = x341_p_0, x340_p_0 = 0;
						x340 < x341 + 8;
						x340 += 4, x340_p_2 += 4, x340_p_1 += 4, x340_p_0 += 4){
