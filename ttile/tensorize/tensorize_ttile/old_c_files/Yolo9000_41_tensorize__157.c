						...
						for (h = h348, hp_0 = 0;h < h348 + 3;h += 1, hp_0 += 1){
							...
							for (w = w318, wp_0 = 0;w < w318 + 3;w += 1, wp_0 += 1){
								...
								for (x = x696, xp_2 = x696_p_1, xp_1 = x696_p_0, xp_0 = 0;x < x696 + 136;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6072 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
											mem_vec_6073 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_6072);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_6073);
								}
							}
						}
}
