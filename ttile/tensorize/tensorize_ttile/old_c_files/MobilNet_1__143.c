						...
						for (w = w336, wp_0 = 0;
							...
							for (x = x672, xp_2 = x672_p_1, xp_1 = x672_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5566 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
										mem_vec_5567 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_5566);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_5567);
							}
						}
					}
				}
			}
			for (y = y336 + 90, yp_0 = 0;
				y < y336 + 90 + 22;
				y += 11, yp_0 += 11){
				// y = ph_y, x = 14, h = 3, w = 3, c = 2, f = 32
				// T (x, 2) (14 / 7)
