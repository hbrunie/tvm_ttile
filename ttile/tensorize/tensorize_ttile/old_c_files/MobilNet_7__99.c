...
[V f; U (4, f); U (7, y); U (3, w); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (4, c); T (8, f); T (7, x); T (2, y); T (32, c)]
*/
IND_TYPE c, cp_0, c1036_p_0, c1037_p_0, cp_1, c1036_p_1, cp_2, c1036, c1037, f, fp_0, h, hp_0, x, xp_0, x822_p_0, xp_1, x822, y, yp_0;
