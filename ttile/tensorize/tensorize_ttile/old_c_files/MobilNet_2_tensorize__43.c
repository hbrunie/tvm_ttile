...
c382_p_1 = 0;
				for (h = h180, hp_0 = 0;h < h180 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x374, xp_1 = x374_p_0, xp_0 = 0;x < x374 + 1;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_2502 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
								mem_vec_2503 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
								...
								mem_vec_2506 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
								mem_vec_2507 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								// y = 7, x = 1, h = 1, w = 3, c = 1, f = 64
								// T (c, 1) (1 / 1)
								for (c = c382, cp_2 = c382_p_1, cp_1 = c382_p_0, cp_0 = 0;c < c382 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_2502);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_2503);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_2506);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_2507);
					}
				}
}
