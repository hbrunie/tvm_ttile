...
/*
[V f; U (4, f); ULambda y; U (3, w); T (512, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (1, c); T (8, f); T (1, x);
  Lambda_apply y [((Iter 1), (Arg 4)); ((Iter 2), (Arg 5))]; T (1, c)]
*/
IND_TYPE c, cp_0, c1084_p_0, c1085_p_0, cp_1, c1084_p_1, cp_2, c1084, c1085, f, fp_0, h, hp_0, x, xp_0, x858_p_0, xp_1, x858, y, yp_0;
IND_TYPE y572 = 0;
IND_TYPE x859 = 0;
IND_TYPE h442 = 0;
IND_TYPE w = 0;
...
c1084_p_1 = 0;
						for (h = h442, hp_0 = 0;h < h442 + 3;h += 1, hp_0 += 1){
							// y = ph_y, x = 14, h = 1, w = 3, c = 512, f = 64
							// T (x, 14) (14 / 1)
							for (x = x858, xp_1 = x858_p_0, xp_0 = 0;x < x858 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 512) (512 / 1)
										for (c = c1084, cp_2 = c1084_p_1, cp_1 = c1084_p_0, cp_0 = 0;c < c1084 + 512;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
