...
for (y632 = y633, y632_p_0 = 0;
	...
	for (x793 = x794, x793_p_0 = 0;
		...
		// T (y, 1) (28 / 28)
		for (y631 = y632, y631_p_1 = y632_p_0, y631_p_0 = 0;
			y631 < y632 + 28;
			y631 += 28, y631_p_1 += 28, y631_p_0 += 28){
			// y = 28, x = 7, h = 1, w = 1, c = 64, f = 64
			// T (x, 1) (7 / 7)
			for (x792 = x793, x792_p_1 = x793_p_0, x792_p_0 = 0;
				...
				for (f = f311, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y631, yp_2 = y631_p_1, yp_1 = y631_p_0, yp_0 = 0;
						y < y631 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
						// T (x, 7) (7 / 1)
						for (x791 = x792, x791_p_2 = x792_p_1, x791_p_1 = x792_p_0, x791_p_0 = 0;
							x791 < x792 + 7;
							x791 += 1, x791_p_2 += 1, x791_p_1 += 1, x791_p_0 += 1){
							...
							for (c480 = c481, c480_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x791, xp_3 = x791_p_2, xp_2 = x791_p_1, xp_1 = x791_p_0, xp_0 = 0;
									x < x791 + 1;
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4002 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_4003 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
											// y = 14, x = 1, h = 1, w = 1, c = 32, f = 32
											// T (c, 32) (32 / 1)
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_4002);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_4003);
								}
							}
						}
					}
