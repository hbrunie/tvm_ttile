...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (4, y); T (4, f); T (1, c); T (1, f); T (128, c); T (28, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c344_p_0, c345_p_0, cp_1, c344_p_1, cp_2, c344, c345, f, fp_0, f332_p_0, f333_p_0, fp_1, f332_p_1, fp_2, f332, f333, h, hp_0, w, wp_0, x, xp_0, x258_p_0, xp_1, x258, y, yp_0;
IND_TYPE y172 = 0;
IND_TYPE x259 = 0;
IND_TYPE h172 = 0;
IND_TYPE w172 = 0;
							...
							for (h = h172, hp_0 = 0;h < h172 + 3;h += 1, hp_0 += 1){
								...
								for (w = w172, wp_0 = 0;w < w172 + 3;w += 1, wp_0 += 1){
									...
									for (x = x258, xp_1 = x258_p_0, xp_0 = 0;x < x258 + 1;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// y = 7, x = 1, h = 1, w = 1, c = 2, f = 64
												// T (c, 2) (2 / 1)
												for (c = c344, cp_2 = c344_p_1, cp_1 = c344_p_0, cp_0 = 0;c < c344 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
