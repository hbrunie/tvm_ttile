...
/*
[V f; U (4, f); U (7, y); U (3, h); T (128, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (1, h); T (1, y); T (2, f); T (1, c); T (7, x); T (8, y)]
*/
