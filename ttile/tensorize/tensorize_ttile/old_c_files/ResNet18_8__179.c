...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, y); T (4, f); T (128, c); T (1, f); T (2, x); T (1, f)]
*/
IND_TYPE c, cp_0, c168_p_0, cp_1, c168, f, fp_0, f178_p_0, f179_p_0, fp_1, f178_p_1, fp_2, f178, f179, h, hp_0, w, wp_0, x, xp_0, x168_p_0, xp_1, x168, y, yp_0;
...
for (f179 = f180, f179_p_0 = 0;
	...
	for (x168 = x169, x168_p_0 = 0;
		...
		for (f178 = f179, f178_p_1 = f179_p_0, f178_p_0 = 0;
			f178 < f179 + 256;
			f178 += 256, f178_p_1 += 256, f178_p_0 += 256){
			// y = 28, x = 14, h = 3, w = 3, c = 128, f = 256
			// T (c, 128) (128 / 1)
