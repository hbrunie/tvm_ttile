...
[V f; U (4, f); U (7, y); U (3, h); T (256, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (2, c); T (8, f); T (1, y); T (1, c)]
*/
IND_TYPE c, cp_0, c448_p_0, c449_p_0, cp_1, c448_p_1, cp_2, c448, c449, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
	...
	for (y = y224, yp_0 = 0;
		...
		for (f = f224, fp_0 = 0;
			...
			for (c448 = c449, c448_p_1 = c449_p_0, c448_p_0 = 0;
				c448 < c449 + 512;
				c448 += 256, c448_p_1 += 256, c448_p_0 += 256){
