...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (1, c); T (8, f); T (7, x); T (2, y); T (64, c)]
*/
IND_TYPE c, cp_0, c344_p_0, c345_p_0, cp_1, c344_p_1, cp_2, c344, c345, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x258_p_0, xp_1, x258, y, yp_0;
IND_TYPE y172 = 0;
IND_TYPE x259 = 0;
IND_TYPE h172 = 0;
IND_TYPE w172 = 0;
