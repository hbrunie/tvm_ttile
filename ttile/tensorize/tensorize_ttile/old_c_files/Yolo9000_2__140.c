...
// T (x, 272) (272 / 1)
for (x1452 = x1453, x1452_p_0 = 0;
	x1452 < x1453 + 272;
	x1452 += 1, x1452_p_0 += 1){
	// y = 272, x = 1, h = 3, w = 3, c = 32, f = 64
	// T (x, 1) (1 / 1)
	for (x1451 = x1452, x1451_p_1 = x1452_p_0, x1451_p_0 = 0;
		x1451 < x1452 + 1;
		x1451 += 1, x1451_p_1 += 1, x1451_p_0 += 1){
		// y = 272, x = 1, h = 3, w = 3, c = 32, f = 64
		// T (c, 8) (32 / 4)
		for (c870 = c871, c870_p_0 = 0;
			...
			for (y = y580, yp_0 = 0;
				...
				// T (x, 1) (1 / 1)
				for (x1450 = x1451, x1450_p_2 = x1451_p_1, x1450_p_1 = x1451_p_0, x1450_p_0 = 0;
					x1450 < x1451 + 1;
					x1450 += 1, x1450_p_2 += 1, x1450_p_1 += 1, x1450_p_0 += 1){
					// y = 4, x = 1, h = 3, w = 3, c = 4, f = 64
					// T (h, 3) (3 / 1)
					for (h = h580, hp_0 = 0;
						h < h580 + 3;
						...
						// T (x, 1) (1 / 1)
						for (x = x1450, xp_3 = x1450_p_2, xp_2 = x1450_p_1, xp_1 = x1450_p_0, xp_0 = 0;
							x < x1450 + 1;
