							...
							for (h = h8, hp_0 = 0;h < h8 + 3;h += 1, hp_0 += 1){
								...
								for (w = w8, wp_0 = 0;w < w8 + 3;w += 1, wp_0 += 1){
									...
									for (x = x12, xp_1 = x12_p_0, xp_0 = 0;x < x12 + 34;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_178 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
												mem_vec_179 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_178);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_179);
									}
								}
							}
}
