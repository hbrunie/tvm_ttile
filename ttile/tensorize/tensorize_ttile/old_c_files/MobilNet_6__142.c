...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (4, f); T (8, c); T (2, x); T (2, y); T (1, f)]
*/
IND_TYPE c, cp_0, c756_p_0, cp_1, c756, f, fp_0, f756_p_0, fp_1, f756, h, hp_0, x, xp_0, x756_p_0, xp_1, x756, y, yp_0;
