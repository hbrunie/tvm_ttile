...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (16, c); T (2, f); T (2, c); T (7, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c224_p_0, c225_p_0, cp_1, c224_p_1, cp_2, c224, c225, f, fp_0, f212_p_0, f213_p_0, fp_1, f212_p_1, fp_2, f212, f213, h, hp_0, w, wp_0, x, xp_0, x168_p_0, xp_1, x168, y, yp_0;
IND_TYPE y112 = 0;
IND_TYPE x169 = 0;
IND_TYPE h112 = 0;
IND_TYPE w112 = 0;
							...
							for (h = h112, hp_0 = 0;h < h112 + 3;h += 1, hp_0 += 1){
								...
								for (w = w112, wp_0 = 0;w < w112 + 3;w += 1, wp_0 += 1){
									...
									for (x = x168, xp_1 = x168_p_0, xp_0 = 0;x < x168 + 4;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 8) (8 / 1)
												for (c = c224, cp_2 = c224_p_1, cp_1 = c224_p_0, cp_0 = 0;c < c224 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
