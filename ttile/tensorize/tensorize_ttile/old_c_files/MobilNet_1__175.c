		...
		c564 += 2, c564_p_0 += 2){
			for (y = y376, yp_0 = 0;
				...
				for (x752 = x753, x752_p_1 = x753_p_0, x752_p_0 = 0;
					x752 < x753 + 16;
					x752 += 16, x752_p_1 += 16, x752_p_0 += 16){
					// y = ph_y, x = 16, h = 3, w = 3, c = 2, f = 32
					// T (h, 3) (3 / 1)
					for (h = h356, hp_0 = 0;
						h < h356 + 3;
						...
						for (w = w376, wp_0 = 0;
							...
							for (x = x752, xp_2 = x752_p_1, xp_1 = x752_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6500 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
										mem_vec_6501 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
										mem_vec_6502 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
										mem_vec_6503 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_6500);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_6501);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_6502);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_6503);
							}
						}
					}
				}
			}
			for (y = y376 + 70, yp_0 = 0;
				y < y376 + 70 + 42;
				y += 14, yp_0 += 14){
				// y = ph_y, x = 16, h = 3, w = 3, c = 2, f = 32
				// T (x, 1) (16 / 16)
						...
						for (w = w376, wp_0 = 0;
							...
							for (x = x752, xp_2 = x752_p_1, xp_1 = x752_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6528 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
										mem_vec_6529 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
										mem_vec_6530 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_6531 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 2, f = 32
										// T (c, 2) (2 / 1)
										for (c = c564, cp_1 = c564_p_0, cp_0 = 0;
											c < c564 + 2;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_6528);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_6529);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_6530);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_6531);
							}
						}
					}
				}
