...
for (y204 = y205, y204_p_0 = 0;
	...
	for (x273 = x274, x273_p_0 = 0;
		...
		x273 += 34, x273_p_0 += 34){
			...
			for (y = y204 + 6, yp_1 = y204_p_0, yp_0 = 0;
				y < y204 + 6 + 28;
				y += 7, yp_1 += 7, yp_0 += 7){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
						...
						for (c204 = c205, c204_p_0 = 0;
							...
							for (x = x272, xp_2 = x272_p_1, xp_1 = x272_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3514 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
										mem_vec_3515 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 64
										// T (c, 128) (128 / 1)
										for (c = c204, cp_1 = c204_p_0, cp_0 = 0;
											c < c204 + 128;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_3514);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_3515);
							}
						}
					}
				}
