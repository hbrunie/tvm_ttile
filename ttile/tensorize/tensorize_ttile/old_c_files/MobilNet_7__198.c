...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (16, c); T (8, f); T (14, x); T (2, y); T (4, c)]
*/
IND_TYPE c, cp_0, c376_p_0, c377_p_0, cp_1, c376_p_1, cp_2, c376, c377, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x282_p_0, xp_1, x282, y, yp_0;
