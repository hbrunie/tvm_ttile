...
c676_p_1 = 0;
					for (w = w368, wp_0 = 0;w < w368 + 3;w += 1, wp_0 += 1){
						...
						for (x = x552, xp_1 = x552_p_0, xp_0 = 0;x < x552 + 7;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_4338 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_4339 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_4338);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_4339);
						}
					}
}
