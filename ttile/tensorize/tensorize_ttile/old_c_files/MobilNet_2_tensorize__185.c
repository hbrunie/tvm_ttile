...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (4, c); T (2, x); T (8, y); T (8, c)]
*/
IND_TYPE c, cp_0, c106_p_0, c107_p_0, cp_1, c106_p_1, cp_2, c106, c107, h, hp_0, w, wp_0, x, xp_0, x132_p_0, xp_1, x132, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x133 = 0;
IND_TYPE h68 = 0;
IND_TYPE w68 = 0;
				...
				for (h = h68, hp_0 = 0;h < h68 + 3;h += 1, hp_0 += 1){
					...
					for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
						...
						for (x = x132, xp_1 = x132_p_0, xp_0 = 0;x < x132 + 28;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 2) (2 / 1)
									for (c = c106, cp_2 = c106_p_1, cp_1 = c106_p_0, cp_0 = 0;c < c106 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
