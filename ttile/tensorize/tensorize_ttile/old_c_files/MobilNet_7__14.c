...
[V f; U (4, f); U (7, y); U (3, h); T (64, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (8, c); T (8, f); T (14, x); T (2, y); T (1, c)]
*/
IND_TYPE c, cp_0, c780_p_0, c781_p_0, cp_1, c780_p_1, cp_2, c780, c781, f, fp_0, w, wp_0, x, xp_0, x630_p_0, xp_1, x630, y, yp_0;
		...
		for (x630 = x631, x630_p_0 = 0;
			...
			for (f = f480, fp_0 = 0;
				...
				for (c780 = c781, c780_p_1 = c781_p_0, c780_p_0 = 0;
					c780 < c781 + 512;
					c780 += 64, c780_p_1 += 64, c780_p_0 += 64){
