...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (32, c); T (1, f); T (4, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c40_p_0, c41_p_0, cp_1, c40_p_1, cp_2, c40, c41, f, fp_0, f28_p_0, f29_p_0, fp_1, f28_p_1, fp_2, f28, f29, h, hp_0, w, wp_0, x, xp_0, x30_p_0, xp_1, x30, y, yp_0;
IND_TYPE y20 = 0;
IND_TYPE x31 = 0;
IND_TYPE h20 = 0;
IND_TYPE w20 = 0;
