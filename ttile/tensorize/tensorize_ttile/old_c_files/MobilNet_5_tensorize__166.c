...
[V f; U (4, f); U (7, y); T (4, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (1, c); T (2, f); T (64, c); T (14, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c280_p_0, c281_p_0, cp_1, c280_p_1, cp_2, c280, c281, f, fp_0, f268_p_0, f269_p_0, fp_1, f268_p_1, fp_2, f268, f269, h, hp_0, w, wp_0, x, xp_0, x210_p_0, xp_1, x210, y, yp_0;
IND_TYPE y140 = 0;
IND_TYPE x211 = 0;
IND_TYPE h140 = 0;
IND_TYPE w140 = 0;
							...
							for (h = h140, hp_0 = 0;h < h140 + 3;h += 1, hp_0 += 1){
								...
								for (w = w140, wp_0 = 0;w < w140 + 3;w += 1, wp_0 += 1){
									...
									for (x = x210, xp_1 = x210_p_0, xp_0 = 0;x < x210 + 2;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 4) (4 / 1)
												for (c = c280, cp_2 = c280_p_1, cp_1 = c280_p_0, cp_0 = 0;c < c280 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
