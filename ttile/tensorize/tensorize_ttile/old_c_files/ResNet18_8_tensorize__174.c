...
fp_1 = 0;
					for (h = h290, hp_0 = 0;h < h290 + 3;h += 1, hp_0 += 1){
						...
						for (x = x546, xp_1 = x546_p_0, xp_0 = 0;x < x546 + 14;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_4382 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_4383 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_4382);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_4383);
						}
					}
}
