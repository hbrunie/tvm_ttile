...
[V f; U (4, f); U (7, y); U (3, w); T (1, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, c); T (4, f); T (2, x); T (4, y); T (128, c)]
*/
IND_TYPE c, cp_0, c826_p_0, c827_p_0, cp_1, c826_p_1, cp_2, c826, c827, f, fp_0, h, hp_0, x, xp_0, x636_p_0, xp_1, x636, y, yp_0;
