...
[V f; U (4, f); ULambda y; U (3, w); T (16, c); Hoist_vars [c]; T (28, x);
  T (1, w); T (3, h); T (2, y); T (2, f); T (8, c); T (1, x);
  Lambda_apply y [((Iter 1), (Arg 4)); ((Iter 2), (Arg 5))]]
*/
	...
	for (y0 = y1, y0_p_0 = 0;
		...
		for (x0 = x1, x0_p_0 = 0;
			...
			for (c0 = c1, c0_p_0 = 0;
				c0 < c1 + 128;
				c0 += 16, c0_p_0 += 16){
				// y = 2 * u_y, x = 28, h = 3, w = 3, c = 16, f = 128
				// T (f, 2) (128 / 64)
				for (f = f0, fp_0 = 0;
					f < f0 + 128;
					f += 64, fp_0 += 64){
					// y = 2 * u_y, x = 28, h = 3, w = 3, c = 16, f = 64
					// T (y, 2) (2 * u_y / u_y)
