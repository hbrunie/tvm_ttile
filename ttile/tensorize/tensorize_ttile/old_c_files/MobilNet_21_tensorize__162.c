...
c1128_p_1 = 0;
					for (w = w664, wp_0 = 0;w < w664 + 3;w += 1, wp_0 += 1){
						...
						for (x = x1280, xp_1 = x1280_p_0, xp_0 = 0;x < x1280 + 56;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_11642 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
									mem_vec_11643 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_11642);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_11643);
						}
					}
}
