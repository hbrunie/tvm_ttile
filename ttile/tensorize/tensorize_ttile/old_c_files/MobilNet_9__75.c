...
[V f; U (4, f); U (7, y); U (3, h); T (128, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (4, c); T (16, f); T (1, y); T (2, c); T (1, f)]
*/
IND_TYPE c, cp_0, c704_p_0, c705_p_0, cp_1, c704_p_1, cp_2, c704, c705, f, fp_0, f528_p_0, fp_1, f528, w, wp_0, x, xp_0, y, yp_0;
		...
		for (y = y352, yp_0 = 0;
			...
			for (f = f528, fp_1 = f528_p_0, fp_0 = 0;
				...
				for (c704 = c705, c704_p_1 = c705_p_0, c704_p_0 = 0;
					c704 < c705 + 512;
					c704 += 128, c704_p_1 += 128, c704_p_0 += 128){
