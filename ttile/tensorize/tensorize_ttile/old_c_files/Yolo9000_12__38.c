...
for (f417 = f418, f417_p_0 = 0;
	...
	for (c312 = c313, c312_p_0 = 0;
		...
		for (f416 = f417, f416_p_1 = f417_p_0, f416_p_0 = 0;
			f416 < f417 + 512;
			f416 += 512, f416_p_1 += 512, f416_p_0 += 512){
				for (y = y208, yp_0 = 0;
					y < y208 + 20;
					y += 10, yp_0 += 10){
								...
								for (w = w208, wp_0 = 0;
									...
									for (x = x312, xp_1 = x312_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4368 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
												mem_vec_4369 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
												mem_vec_4370 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
												mem_vec_4371 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_4368);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_4369);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_4370);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_4371);
									}
								}
							}
						}
								...
								for (w = w208, wp_0 = 0;
									...
									for (x = x312, xp_1 = x312_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4396 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
												mem_vec_4397 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
												mem_vec_4398 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
												mem_vec_4399 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 64, f = 32
												// T (c, 64) (64 / 1)
												for (c = c312, cp_1 = c312_p_0, cp_0 = 0;
													c < c312 + 64;
													...
													vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_4396);
													mem_vec_4396 = vec_38;



													vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_4397);
													mem_vec_4397 = vec_40;
													scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
													vec_42 = _mm512_set1_ps(scal_13);


													vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_4398);
													mem_vec_4398 = vec_41;



													vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_4399);
													mem_vec_4399 = vec_43;
												}
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_4396);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_4397);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_4398);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_4399);
									}
								}
							}
						}
