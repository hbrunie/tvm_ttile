...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (16, c); T (1, f); T (7, x); T (4, f)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, f, fp_0, f226_p_0, f227_p_0, fp_1, f226_p_1, fp_2, f226, f227, h, hp_0, w, wp_0, x, xp_0, x204_p_0, xp_1, x204, y, yp_0;
