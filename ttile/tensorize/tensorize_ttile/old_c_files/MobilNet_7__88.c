...
[V f; U (4, f); U (7, y); T (16, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (32, c); T (8, f); T (14, x); T (2, y); T (1, c)]
*/
IND_TYPE c, cp_0, c360_p_0, c361_p_0, cp_1, c360_p_1, cp_2, c360, c361, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x270_p_0, xp_1, x270, y, yp_0;
