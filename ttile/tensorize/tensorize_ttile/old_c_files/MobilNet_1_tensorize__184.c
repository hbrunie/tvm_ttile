...
/*
[V f; U (2, f); U (8, y); T (1, c); Hoist_vars [c]; T (56, x); T (3, w);
  T (3, h); T (1, x); T (14, y); T (32, c); T (2, x)]
*/
...
x24_p_1 = 0;
				for (h = h12, hp_0 = 0;h < h12 + 3;h += 1, hp_0 += 1){
					...
					for (w = w12, wp_0 = 0;w < w12 + 3;w += 1, wp_0 += 1){
						// y = 8, x = 56, h = 1, w = 1, c = 1, f = 32
						// T (x, 56) (56 / 1)
						for (x = x24, xp_2 = x24_p_1, xp_1 = x24_p_0, xp_0 = 0;x < x24 + 56;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
