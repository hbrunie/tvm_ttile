...
c1348_p_1 = 0;
						for (h = h574, hp_0 = 0;h < h574 + 3;h += 1, hp_0 += 1){
							...
							for (x = x1056, xp_1 = x1056_p_0, xp_0 = 0;x < x1056 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_9638 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
										mem_vec_9639 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_9638);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_9639);
							}
						}
}
