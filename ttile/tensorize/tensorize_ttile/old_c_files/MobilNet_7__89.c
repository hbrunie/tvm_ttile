...
[V f; U (4, f); U (7, y); U (3, w); T (1, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (64, c); T (8, f); T (1, x); T (2, y); T (8, c)]
*/
IND_TYPE c, cp_0, c884_p_0, c885_p_0, cp_1, c884_p_1, cp_2, c884, c885, f, fp_0, h, hp_0, x, xp_0, x708_p_0, xp_1, x708, y, yp_0;
