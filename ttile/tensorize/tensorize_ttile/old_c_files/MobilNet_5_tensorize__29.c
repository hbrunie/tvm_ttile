...
yp_0 = 0;
							for (w = w376, wp_0 = 0;w < w376 + 3;w += 1, wp_0 += 1){
								...
								for (x = x564, xp_1 = x564_p_0, xp_0 = 0;x < x564 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4982 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
											mem_vec_4983 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
											// y = 7, x = 1, h = 3, w = 1, c = 8, f = 64
											// T (c, 8) (8 / 1)
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_4982);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_4983);
								}
							}
}
