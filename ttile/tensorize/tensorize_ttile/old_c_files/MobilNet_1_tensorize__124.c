...
/*
[V f; U (2, f); U (14, y); T (32, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (14, x); T (8, y); T (1, c); T (2, x)]
*/
IND_TYPE c, cp_0, c78_p_0, cp_1, c78, h, hp_0, w, wp_0, x, xp_0, x104_p_0, x105_p_0, xp_1, x104_p_1, xp_2, x104, x105, y, yp_0;
IND_TYPE y52 = 0;
IND_TYPE x106 = 0;
IND_TYPE h52 = 0;
IND_TYPE w52 = 0;
				...
				for (h = h52, hp_0 = 0;h < h52 + 3;h += 1, hp_0 += 1){
					...
					for (w = w52, wp_0 = 0;w < w52 + 3;w += 1, wp_0 += 1){
						...
						for (x = x104, xp_2 = x104_p_1, xp_1 = x104_p_0, xp_0 = 0;x < x104 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_480 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_481 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
									mem_vec_482 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									mem_vec_483 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
									mem_vec_484 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									mem_vec_485 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									mem_vec_486 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
									mem_vec_487 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
									mem_vec_488 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									mem_vec_489 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
									mem_vec_490 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
									mem_vec_491 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
									...
									for (c = c78, cp_1 = c78_p_0, cp_0 = 0;c < c78 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_480);
										mem_vec_480 = vec_26;
										vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_481);
										mem_vec_481 = vec_28;
										...
										vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_484);
										mem_vec_484 = vec_32;
										vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_485);
										mem_vec_485 = vec_34;
										scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 11 + h) + c];
										vec_36 = _mm512_set1_ps(scal_11);
										vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_486);
										mem_vec_486 = vec_35;
										vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_487);
										mem_vec_487 = vec_37;
										scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 12 + h) + c];
										vec_39 = _mm512_set1_ps(scal_12);
										vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_488);
										mem_vec_488 = vec_38;
										vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_489);
										mem_vec_489 = vec_40;
										scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 13 + h) + c];
										vec_42 = _mm512_set1_ps(scal_13);
										vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_490);
										mem_vec_490 = vec_41;
										vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_491);
										mem_vec_491 = vec_43;
									}
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_480);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_481);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_482);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_483);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_484);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_485);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_486);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_487);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_488);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_489);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_490);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_491);
						}
					}
				}
}
