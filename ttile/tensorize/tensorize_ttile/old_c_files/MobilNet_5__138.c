...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (8, c); T (4, f); T (4, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c112_p_0, c113_p_0, cp_1, c112_p_1, cp_2, c112, c113, f, fp_0, f100_p_0, f101_p_0, fp_1, f100_p_1, fp_2, f100, f101, h, hp_0, w, wp_0, x, xp_0, x84_p_0, xp_1, x84, y, yp_0;
