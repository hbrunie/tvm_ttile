...
[V f; U (1, f); U (14, y); U (3, h); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, f); T (32, c); T (14, x); T (1, y); T (4, f)]
*/
					...
					for (w = w352, wp_0 = 0;
						...
						for (x = x528, xp_1 = x528_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_3793 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									// y = 14, x = 1, h = 3, w = 1, c = 4, f = 16
									// T (c, 4) (4 / 1)
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3793);
						}
					}
				}
			}
