...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (128, c); T (2, f); T (4, x); T (2, f)]
*/
IND_TYPE c, cp_0, c186_p_0, cp_1, c186, f, fp_0, f202_p_0, f203_p_0, fp_1, f202_p_1, fp_2, f202, f203, h, hp_0, w, wp_0, x, xp_0, x186_p_0, xp_1, x186, y, yp_0;
...
for (f203 = f204, f203_p_0 = 0;
	...
	for (x186 = x187, x186_p_0 = 0;
		...
		for (f202 = f203, f202_p_1 = f203_p_0, f202_p_0 = 0;
			f202 < f203 + 128;
			f202 += 64, f202_p_1 += 64, f202_p_0 += 64){
