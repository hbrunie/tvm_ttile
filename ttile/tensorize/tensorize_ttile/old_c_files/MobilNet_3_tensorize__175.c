...
[V f; U (4, f); U (4, y); U (3, w); T (128, c); Hoist_vars [c]; T (56, x);
  T (3, h); T (1, c); T (2, f); T (1, x); T (14, y)]
*/
IND_TYPE c, cp_0, c81_p_0, cp_1, c81, f, fp_0, h, hp_0, x, xp_0, x94_p_0, xp_1, x94, y, yp_0;
IND_TYPE y54 = 0;
IND_TYPE x95 = 0;
IND_TYPE h43 = 0;
IND_TYPE w = 0;
				...
				for (h = h43, hp_0 = 0;h < h43 + 3;h += 1, hp_0 += 1){
					...
					for (x = x94, xp_1 = x94_p_0, xp_0 = 0;x < x94 + 56;x += 1, xp_1 += 1, xp_0 += 1){
								...
								for (c = c81, cp_1 = c81_p_0, cp_0 = 0;c < c81 + 128;c += 1, cp_1 += 1, cp_0 += 1){
									...
									vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_556);
									mem_vec_556 = vec_24;
									vec_28 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
									vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_557);
									mem_vec_557 = vec_27;
									vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
									vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_558);
									mem_vec_558 = vec_29;
									vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
									vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_559);
									mem_vec_559 = vec_31;
									scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
									vec_34 = _mm512_set1_ps(scal_5);
									vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_560);
									mem_vec_560 = vec_33;
									vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_561);
									mem_vec_561 = vec_35;
									vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_562);
									mem_vec_562 = vec_36;
									vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_563);
									mem_vec_563 = vec_37;
									scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
									vec_39 = _mm512_set1_ps(scal_6);
									vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_564);
									mem_vec_564 = vec_38;
									vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_565);
									mem_vec_565 = vec_40;
									vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_566);
									mem_vec_566 = vec_41;
									vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_567);
									mem_vec_567 = vec_42;
									scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
									vec_44 = _mm512_set1_ps(scal_7);
									vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_568);
									mem_vec_568 = vec_43;
									vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_569);
									mem_vec_569 = vec_45;
									vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_570);
									mem_vec_570 = vec_46;
									vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_571);
									mem_vec_571 = vec_47;
									scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
									vec_49 = _mm512_set1_ps(scal_8);
									vec_50 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
									vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_556);
									mem_vec_556 = vec_48;
									vec_52 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
									vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_557);
									mem_vec_557 = vec_51;
									vec_54 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
									vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_558);
									mem_vec_558 = vec_53;
									vec_56 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
									vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_559);
									mem_vec_559 = vec_55;
									scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
									vec_58 = _mm512_set1_ps(scal_9);
									vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_560);
									mem_vec_560 = vec_57;
									vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_561);
									mem_vec_561 = vec_59;
									vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_562);
									mem_vec_562 = vec_60;
									vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_563);
									mem_vec_563 = vec_61;
									scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
									vec_63 = _mm512_set1_ps(scal_10);
									vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_564);
									mem_vec_564 = vec_62;
									vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_565);
									mem_vec_565 = vec_64;
									vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_566);
									mem_vec_566 = vec_65;
									vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_567);
									mem_vec_567 = vec_66;
									scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
									vec_68 = _mm512_set1_ps(scal_11);
									vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_568);
									mem_vec_568 = vec_67;
									vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_569);
									mem_vec_569 = vec_69;
									vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_570);
									mem_vec_570 = vec_70;
									vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_571);
									mem_vec_571 = vec_71;
								}
