...
*/
IND_TYPE c, cp_0, c354_p_0, cp_1, c354, f, fp_0, f354_p_0, fp_1, f354, h, hp_0, x, xp_0, x354_p_0, xp_1, x354, y, yp_0;
IND_TYPE y236 = 0;
IND_TYPE x355 = 0;
IND_TYPE h168 = 0;
IND_TYPE w = 0;
...
__m512 mem_vec_2744 ,mem_vec_2745 ,mem_vec_2746 ,mem_vec_2747 ,mem_vec_2748 ,mem_vec_2749 ,mem_vec_2750 ,mem_vec_2751 ,mem_vec_2752 ,mem_vec_2753 ,mem_vec_2754 ,mem_vec_2755 ,mem_vec_2756 ,mem_vec_2757 ,mem_vec_2758 ,mem_vec_2759 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_8 ,vec_9;
					...
					for (h = h168, hp_0 = 0;h < h168 + 3;h += 1, hp_0 += 1){
						...
						for (x = x354, xp_1 = x354_p_0, xp_0 = 0;x < x354 + 14;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c354, cp_1 = c354_p_0, cp_0 = 0;c < c354 + 128;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_2744);
										mem_vec_2744 = vec_24;
										vec_28 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_2745);
										mem_vec_2745 = vec_27;
										vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_2746);
										mem_vec_2746 = vec_29;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_2747);
										mem_vec_2747 = vec_31;
										scal_5 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 1) + h) + c];
										vec_34 = _mm512_set1_ps(scal_5);
										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_2748);
										mem_vec_2748 = vec_33;
										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_2749);
										mem_vec_2749 = vec_35;
										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_2750);
										mem_vec_2750 = vec_36;
										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_2751);
										mem_vec_2751 = vec_37;
										scal_6 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 2) + h) + c];
										vec_39 = _mm512_set1_ps(scal_6);
										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_2752);
										mem_vec_2752 = vec_38;
										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_2753);
										mem_vec_2753 = vec_40;
										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_2754);
										mem_vec_2754 = vec_41;
										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_2755);
										mem_vec_2755 = vec_42;
										scal_7 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 3) + h) + c];
										vec_44 = _mm512_set1_ps(scal_7);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_2756);
										mem_vec_2756 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_2757);
										mem_vec_2757 = vec_45;
										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_2758);
										mem_vec_2758 = vec_46;
										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_2759);
										mem_vec_2759 = vec_47;
										scal_8 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * y + h) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_2744);
										mem_vec_2744 = vec_48;
										vec_52 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_2745);
										mem_vec_2745 = vec_51;
										vec_54 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_2746);
										mem_vec_2746 = vec_53;
										vec_56 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_2747);
										mem_vec_2747 = vec_55;
										scal_9 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 1) + h) + c];
										vec_58 = _mm512_set1_ps(scal_9);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_2748);
										mem_vec_2748 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_2749);
										mem_vec_2749 = vec_59;
										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_2750);
										mem_vec_2750 = vec_60;
										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_2751);
										mem_vec_2751 = vec_61;
										scal_10 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 2) + h) + c];
										vec_63 = _mm512_set1_ps(scal_10);
										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_2752);
										mem_vec_2752 = vec_62;
										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_2753);
										mem_vec_2753 = vec_64;
										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_2754);
										mem_vec_2754 = vec_65;
										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_2755);
										mem_vec_2755 = vec_66;
										scal_11 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 3) + h) + c];
										vec_68 = _mm512_set1_ps(scal_11);
										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_2756);
										mem_vec_2756 = vec_67;
										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_2757);
										mem_vec_2757 = vec_69;
										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_2758);
										mem_vec_2758 = vec_70;
										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_2759);
										mem_vec_2759 = vec_71;
									}
