...
// T (x, 8) (272 / 34)
for (x1782 = x1783, x1782_p_0 = 0;
	x1782 < x1783 + 272;
	x1782 += 34, x1782_p_0 += 34){
	// y = 272, x = 34, h = 3, w = 3, c = 32, f = 64
	// T (x, 1) (34 / 34)
	for (x1781 = x1782, x1781_p_1 = x1782_p_0, x1781_p_0 = 0;
		x1781 < x1782 + 34;
		x1781 += 34, x1781_p_1 += 34, x1781_p_0 += 34){
		// y = 272, x = 34, h = 3, w = 3, c = 32, f = 64
		// T (c, 16) (32 / 2)
			...
			for (f = f572, fp_0 = 0;
				...
				f += 32, fp_0 += 32){
					for (y = y712, yp_0 = 0;
						...
						// T (x, 1) (34 / 34)
						for (x1780 = x1781, x1780_p_2 = x1781_p_1, x1780_p_1 = x1781_p_0, x1780_p_0 = 0;
							x1780 < x1781 + 34;
							x1780 += 34, x1780_p_2 += 34, x1780_p_1 += 34, x1780_p_0 += 34){
							// y = ph_y, x = 34, h = 3, w = 3, c = 2, f = 32
							// T (h, 3) (3 / 1)
							for (h = h712, hp_0 = 0;
								h < h712 + 3;
								...
								for (w = w572, wp_0 = 0;
									...
									// T (x, 34) (34 / 1)
									for (x = x1780, xp_3 = x1780_p_2, xp_2 = x1780_p_1, xp_1 = x1780_p_0, xp_0 = 0;
										x < x1780 + 34;
										x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_8410 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
												mem_vec_8411 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_8410);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_8411);
									}
								}
							}
						}
					}
					for (y = y712 + 182, yp_0 = 0;
						y < y712 + 182 + 90;
						y += 15, yp_0 += 15){
						// y = ph_y, x = 34, h = 3, w = 3, c = 2, f = 32
						// T (x, 1) (34 / 34)
								...
								for (w = w572, wp_0 = 0;
									...
									for (x = x1780, xp_3 = x1780_p_2, xp_2 = x1780_p_1, xp_1 = x1780_p_0, xp_0 = 0;
										...
										x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_8437 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
												mem_vec_8438 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
												mem_vec_8439 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
												mem_vec_8440 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
												mem_vec_8441 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 2, f = 32
												// T (c, 2) (2 / 1)
												for (c = c1068, cp_1 = c1068_p_0, cp_0 = 0;
													c < c1068 + 2;
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_8437);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_8438);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_8439);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_8440);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_8441);
									}
								}
							}
						}
