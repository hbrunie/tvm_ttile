...
fp_1 = 0;
						for (h = h460, hp_0 = 0;h < h460 + 3;h += 1, hp_0 += 1){
							...
							for (x = x912, xp_1 = x912_p_0, xp_0 = 0;x < x912 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7134 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
										mem_vec_7135 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
										// y = ph_y, x = 1, h = 1, w = 3, c = 8, f = 64
										// T (c, 8) (8 / 1)
										for (c = c912, cp_1 = c912_p_0, cp_0 = 0;c < c912 + 8;c += 1, cp_1 += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_7134);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_7135);
							}
						}
}
