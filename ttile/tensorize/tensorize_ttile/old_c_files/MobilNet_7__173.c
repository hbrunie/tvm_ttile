...
[V f; U (4, f); U (7, y); U (3, h); T (2, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (256, c); T (8, f); T (2, x); T (2, y); T (1, c)]
*/
IND_TYPE c, cp_0, c660_p_0, c661_p_0, cp_1, c660_p_1, cp_2, c660, c661, f, fp_0, w, wp_0, x, xp_0, x540_p_0, xp_1, x540, y, yp_0;
