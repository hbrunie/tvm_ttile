...
*/
IND_TYPE c, cp_0, c258_p_0, cp_1, c258, f, fp_0, f258_p_0, fp_1, f258, h, hp_0, w, wp_0, x, xp_0, x258_p_0, xp_1, x258, y, yp_0;
IND_TYPE y172 = 0;
IND_TYPE x259 = 0;
IND_TYPE h172 = 0;
IND_TYPE w172 = 0;
...
fp_1 = 0;
					for (h = h172, hp_0 = 0;h < h172 + 3;h += 1, hp_0 += 1){
						...
						for (w = w172, wp_0 = 0;w < w172 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 14) (14 / 1)
							for (x = x258, xp_1 = x258_p_0, xp_0 = 0;x < x258 + 14;x += 1, xp_1 += 1, xp_0 += 1){
