...
/*
[V f; U (2, f); U (14, y); T (128, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (1, f); T (1, c); T (1, x); T (2, y); T (4, f)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, f, f0, fp_0, f0_p_0, fp_1, h, hp_0, w, wp_0, x, x0, xp_0, x0_p_0, xp_1, y, yp_0;
IND_TYPE y0 = 0;
IND_TYPE x1 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
...
fp_1 = 0;
					for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
						// y = 14, x = 28, h = 1, w = 3, c = 128, f = 32
						// T (w, 3) (3 / 1)
						for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
							// y = 14, x = 28, h = 1, w = 1, c = 128, f = 32
							// T (x, 28) (28 / 1)
