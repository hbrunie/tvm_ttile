...
[V f; U (2, f); U (8, y); T (1, c); Hoist_vars [c]; T (8, x); T (3, w);
  T (3, h); T (7, x); T (14, y); T (32, c); T (2, x)]
*/
IND_TYPE c, cp_0, c36_p_0, cp_1, c36, h, hp_0, w, wp_0, x, xp_0, x48_p_0, x49_p_0, xp_1, x48_p_1, xp_2, x48, x49, y, yp_0;
IND_TYPE y24 = 0;
IND_TYPE x50 = 0;
IND_TYPE h24 = 0;
IND_TYPE w24 = 0;
...
x48_p_1 = 0;
				for (h = h24, hp_0 = 0;h < h24 + 3;h += 1, hp_0 += 1){
					...
					for (w = w24, wp_0 = 0;w < w24 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 8) (8 / 1)
						for (x = x48, xp_2 = x48_p_1, xp_1 = x48_p_0, xp_0 = 0;x < x48 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
