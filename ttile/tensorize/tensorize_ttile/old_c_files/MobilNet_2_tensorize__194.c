...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (8, x); T (3, w);
  T (3, h); T (16, c); T (7, x); T (8, y); T (4, c)]
*/
IND_TYPE c, cp_0, c130_p_0, c131_p_0, cp_1, c130_p_1, cp_2, c130, c131, h, hp_0, w, wp_0, x, xp_0, x150_p_0, xp_1, x150, y, yp_0;
IND_TYPE y80 = 0;
IND_TYPE x151 = 0;
IND_TYPE h80 = 0;
IND_TYPE w80 = 0;
...
c130_p_1 = 0;
				for (h = h80, hp_0 = 0;h < h80 + 3;h += 1, hp_0 += 1){
					...
					for (w = w80, wp_0 = 0;w < w80 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 8) (8 / 1)
						for (x = x150, xp_1 = x150_p_0, xp_0 = 0;x < x150 + 8;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 1) (1 / 1)
									for (c = c130, cp_2 = c130_p_1, cp_1 = c130_p_0, cp_0 = 0;c < c130 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
