...
[V f; U (4, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (7, x); T (8, y); T (2, f); T (4, c); T (1, x)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, f, fp_0, w, wp_0, x, xp_0, x240_p_0, x241_p_0, xp_1, x240_p_1, xp_2, x240, x241, y, yp_0;
