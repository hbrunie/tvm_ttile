...
for (x1022 = x1023, x1022_p_0 = 0;
	x1022 < x1023 + 272;
	x1022 += 136, x1022_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 2) (136 / 68)
	for (x1021 = x1022, x1021_p_1 = x1022_p_0, x1021_p_0 = 0;
		x1021 < x1022 + 136;
		x1021 += 68, x1021_p_1 += 68, x1021_p_0 += 68){
		...
		for (c612 = c613, c612_p_0 = 0;
			...
			for (y = y408, yp_0 = 0;
				...
				// T (x, 17) (68 / 4)
				for (x1020 = x1021, x1020_p_2 = x1021_p_1, x1020_p_1 = x1021_p_0, x1020_p_0 = 0;
					x1020 < x1021 + 68;
					x1020 += 4, x1020_p_2 += 4, x1020_p_1 += 4, x1020_p_0 += 4){
					...
					for (h = h408, hp_0 = 0;
						...
						// T (x, 4) (4 / 1)
						for (x = x1020, xp_3 = x1020_p_2, xp_2 = x1020_p_1, xp_1 = x1020_p_0, xp_0 = 0;
							x < x1020 + 4;
