...
*/
IND_TYPE c, cp_0, c264_p_0, cp_1, c264, f, fp_0, x, xp_0, x352_p_0, x353_p_0, xp_1, x352_p_1, xp_2, x352, x353, y, yp_0, y256_p_0, yp_1, y256;
IND_TYPE y257 = 0;
IND_TYPE x354 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c264_p_0 = 0;
							for (x = x352, xp_2 = x352_p_1, xp_1 = x352_p_0, xp_0 = 0;x < x352 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 512) (512 / 1)
										for (c = c264, cp_1 = c264_p_0, cp_0 = 0;c < c264 + 512;c += 1, cp_1 += 1, cp_0 += 1){
