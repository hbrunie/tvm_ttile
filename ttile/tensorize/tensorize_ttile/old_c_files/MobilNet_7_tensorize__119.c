...
c804_p_1 = 0;
					for (w = w432, wp_0 = 0;w < w432 + 3;w += 1, wp_0 += 1){
						...
						for (x = x648, xp_1 = x648_p_0, xp_0 = 0;x < x648 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_5234 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_5235 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									// y = 7, x = 1, h = 3, w = 1, c = 32, f = 64
									// T (c, 32) (32 / 1)
									for (c = c804, cp_2 = c804_p_1, cp_1 = c804_p_0, cp_0 = 0;c < c804 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_5234);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_5235);
						}
					}
}
