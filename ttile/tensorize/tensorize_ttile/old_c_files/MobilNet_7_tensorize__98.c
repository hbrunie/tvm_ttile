...
[V f; U (2, f); U (14, y); T (4, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, c); T (16, f); T (1, x); T (1, y); T (32, c)]
*/
IND_TYPE c, cp_0, c48_p_0, c49_p_0, cp_1, c48_p_1, cp_2, c48, c49, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x36_p_0, xp_1, x36, y, yp_0;
IND_TYPE y24 = 0;
IND_TYPE x37 = 0;
IND_TYPE h24 = 0;
IND_TYPE w24 = 0;
					...
					for (h = h24, hp_0 = 0;h < h24 + 3;h += 1, hp_0 += 1){
						...
						for (w = w24, wp_0 = 0;w < w24 + 3;w += 1, wp_0 += 1){
							...
							for (x = x36, xp_1 = x36_p_0, xp_0 = 0;x < x36 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 4) (4 / 1)
										for (c = c48, cp_2 = c48_p_1, cp_1 = c48_p_0, cp_0 = 0;c < c48 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
