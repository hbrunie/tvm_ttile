...
[V f; U (4, f); U (7, y); U (3, w); T (64, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (8, c); T (8, f); T (1, x); T (2, y); T (1, c)]
*/
IND_TYPE c, cp_0, c860_p_0, c861_p_0, cp_1, c860_p_1, cp_2, c860, c861, f, fp_0, h, hp_0, x, xp_0, x690_p_0, xp_1, x690, y, yp_0;
		...
		for (x690 = x691, x690_p_0 = 0;
			...
			for (f = f520, fp_0 = 0;
				...
				for (c860 = c861, c860_p_1 = c861_p_0, c860_p_0 = 0;
					c860 < c861 + 512;
					c860 += 64, c860_p_1 += 64, c860_p_0 += 64){
