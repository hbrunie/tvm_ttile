...
c195_p_0 = 0;
				for (h = h85, hp_0 = 0;h < h85 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 28) (28 / 1)
					for (x = x212, xp_1 = x212_p_0, xp_0 = 0;x < x212 + 28;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_1326 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
								mem_vec_1327 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
								...
								mem_vec_1330 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
								mem_vec_1331 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
								// y = 4, x = 1, h = 1, w = 3, c = 128, f = 64
								// T (c, 128) (128 / 1)
								for (c = c195, cp_1 = c195_p_0, cp_0 = 0;c < c195 + 128;c += 1, cp_1 += 1, cp_0 += 1){
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_1326);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_1327);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_1330);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_1331);
					}
				}
}
