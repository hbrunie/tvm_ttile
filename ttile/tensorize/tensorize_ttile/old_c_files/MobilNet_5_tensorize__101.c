...
[V f; U (4, f); U (7, y); T (32, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (1, c); T (2, f); T (8, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c56_p_0, c57_p_0, cp_1, c56_p_1, cp_2, c56, c57, f, fp_0, f44_p_0, f45_p_0, fp_1, f44_p_1, fp_2, f44, f45, h, hp_0, w, wp_0, x, xp_0, x42_p_0, xp_1, x42, y, yp_0;
IND_TYPE y28 = 0;
IND_TYPE x43 = 0;
IND_TYPE h28 = 0;
IND_TYPE w28 = 0;
