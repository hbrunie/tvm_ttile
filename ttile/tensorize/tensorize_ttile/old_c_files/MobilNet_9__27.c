...
[V f; U (4, f); U (7, y); U (3, h); T (4, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (32, c); T (1, f); T (1, y); T (8, c); T (16, f)]
*/
IND_TYPE c, cp_0, c832_p_0, c833_p_0, cp_1, c832_p_1, cp_2, c832, c833, f, fp_0, f624_p_0, fp_1, f624, w, wp_0, x, xp_0, y, yp_0;
