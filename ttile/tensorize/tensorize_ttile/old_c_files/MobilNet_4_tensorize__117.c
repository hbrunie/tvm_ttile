...
c0_p_0 = 0;
			for (f = f0, fp_0 = 0;f < f0 + 128;f += 64, fp_0 += 64){
					for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 4;y += 4, yp_1 += 4, yp_0 += 4){
						// y = u_y, x = 4, h = 3, w = 3, c = 128, f = 64
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 4, h = 1, w = 3, c = 128, f = 64
							// T (w, 1) (3 / 3)
					...
					for (y = y0 + 4, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 4 + 10;y += 5, yp_1 += 5, yp_0 += 5){
						// y = u_y, x = 4, h = 3, w = 3, c = 128, f = 64
						// T (h, 3) (3 / 1)
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							// y = u_y, x = 4, h = 1, w = 3, c = 128, f = 64
