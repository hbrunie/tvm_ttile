...
[V f; U (4, f); ULambda y; U (3, h); T (32, c); Hoist_vars [c]; T (3, w);
  ...
  T (2, c); T (2, f)]
*/
IND_TYPE c, cp_0, c46_p_0, c47_p_0, cp_1, c46_p_1, cp_2, c46, c47, f, fp_0, f52_p_0, fp_1, f52, w, wp_0, x, xp_0, y, yp_0;
							...
							for (w = w26, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c46, cp_2 = c46_p_1, cp_1 = c46_p_0, cp_0 = 0;
											...
											vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_568);
											mem_vec_568 = vec_34;

											vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

											vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_569);
											mem_vec_569 = vec_37;

											vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_570);
											mem_vec_570 = vec_39;

											vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

											vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_571);
											mem_vec_571 = vec_41;
											scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_572);
											mem_vec_572 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_573);
											mem_vec_573 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_574);
											mem_vec_574 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_575);
											mem_vec_575 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_576);
											mem_vec_576 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_577);
											mem_vec_577 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_578);
											mem_vec_578 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_579);
											mem_vec_579 = vec_52;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_580);
											mem_vec_580 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_581);
											mem_vec_581 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_582);
											mem_vec_582 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_583);
											mem_vec_583 = vec_57;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_59 = _mm256_set1_ps(scal_10);


											vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_584);
											mem_vec_584 = vec_58;



											vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_585);
											mem_vec_585 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_586);
											mem_vec_586 = vec_61;



											vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_587);
											mem_vec_587 = vec_62;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_64 = _mm256_set1_ps(scal_11);


											vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_588);
											mem_vec_588 = vec_63;



											vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_589);
											mem_vec_589 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_590);
											mem_vec_590 = vec_66;



											vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_591);
											mem_vec_591 = vec_67;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_69 = _mm256_set1_ps(scal_12);
											vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_568);
											mem_vec_568 = vec_68;

											vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

											vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_569);
											mem_vec_569 = vec_71;

											vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_570);
											mem_vec_570 = vec_73;

											vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

											vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_571);
											mem_vec_571 = vec_75;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_572);
											mem_vec_572 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_573);
											mem_vec_573 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_574);
											mem_vec_574 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_575);
											mem_vec_575 = vec_81;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_576);
											mem_vec_576 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_577);
											mem_vec_577 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_578);
											mem_vec_578 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_579);
											mem_vec_579 = vec_86;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_88 = _mm256_set1_ps(scal_15);


											vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_580);
											mem_vec_580 = vec_87;



											vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_581);
											mem_vec_581 = vec_89;



											vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_582);
											mem_vec_582 = vec_90;



											vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_583);
											mem_vec_583 = vec_91;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_93 = _mm256_set1_ps(scal_16);


											vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_584);
											mem_vec_584 = vec_92;



											vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_585);
											mem_vec_585 = vec_94;



											vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_586);
											mem_vec_586 = vec_95;



											vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_587);
											mem_vec_587 = vec_96;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_98 = _mm256_set1_ps(scal_17);


											vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_588);
											mem_vec_588 = vec_97;



											vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_589);
											mem_vec_589 = vec_99;



											vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_590);
											mem_vec_590 = vec_100;



											vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_591);
											mem_vec_591 = vec_101;
										}
						...
						for (x = x28, xp_0 = 0;
							...
							for (w = w26, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										mem_vec_612 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
										mem_vec_613 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
										mem_vec_614 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
										mem_vec_615 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
										mem_vec_616 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
										mem_vec_617 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
										mem_vec_618 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
										mem_vec_619 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
										// y = ph_y, x = 1, h = 3, w = 1, c = 32, f = 32
										// T (c, 32) (32 / 1)
										for (c = c46, cp_2 = c46_p_1, cp_1 = c46_p_0, cp_0 = 0;
											c < c46 + 32;
											...
											vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_612);
											mem_vec_612 = vec_29;



											vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_613);
											mem_vec_613 = vec_31;



											vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_614);
											mem_vec_614 = vec_32;



											vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_615);
											mem_vec_615 = vec_33;
											scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
											vec_35 = _mm256_set1_ps(scal_6);


											vec_34 = _mm256_fmadd_ps(vec_35, vec_2, mem_vec_616);
											mem_vec_616 = vec_34;



											vec_36 = _mm256_fmadd_ps(vec_35, vec_4, mem_vec_617);
											mem_vec_617 = vec_36;



											vec_37 = _mm256_fmadd_ps(vec_35, vec_6, mem_vec_618);
											mem_vec_618 = vec_37;



											vec_38 = _mm256_fmadd_ps(vec_35, vec_8, mem_vec_619);
											mem_vec_619 = vec_38;
											scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
											vec_40 = _mm256_set1_ps(scal_7);
											vec_41 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

											vec_39 = _mm256_fmadd_ps(vec_40, vec_41, mem_vec_592);
											mem_vec_592 = vec_39;

											vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

											vec_42 = _mm256_fmadd_ps(vec_40, vec_43, mem_vec_593);
											mem_vec_593 = vec_42;

											vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_44 = _mm256_fmadd_ps(vec_40, vec_45, mem_vec_594);
											mem_vec_594 = vec_44;

											vec_47 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

											vec_46 = _mm256_fmadd_ps(vec_40, vec_47, mem_vec_595);
											mem_vec_595 = vec_46;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_41, mem_vec_596);
											mem_vec_596 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_43, mem_vec_597);
											mem_vec_597 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_45, mem_vec_598);
											mem_vec_598 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_47, mem_vec_599);
											mem_vec_599 = vec_52;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_41, mem_vec_600);
											mem_vec_600 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_43, mem_vec_601);
											mem_vec_601 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_45, mem_vec_602);
											mem_vec_602 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_47, mem_vec_603);
											mem_vec_603 = vec_57;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_59 = _mm256_set1_ps(scal_10);


											vec_58 = _mm256_fmadd_ps(vec_59, vec_41, mem_vec_604);
											mem_vec_604 = vec_58;



											vec_60 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_605);
											mem_vec_605 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_606);
											mem_vec_606 = vec_61;



											vec_62 = _mm256_fmadd_ps(vec_59, vec_47, mem_vec_607);
											mem_vec_607 = vec_62;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_64 = _mm256_set1_ps(scal_11);


											vec_63 = _mm256_fmadd_ps(vec_64, vec_41, mem_vec_608);
											mem_vec_608 = vec_63;



											vec_65 = _mm256_fmadd_ps(vec_64, vec_43, mem_vec_609);
											mem_vec_609 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_64, vec_45, mem_vec_610);
											mem_vec_610 = vec_66;



											vec_67 = _mm256_fmadd_ps(vec_64, vec_47, mem_vec_611);
											mem_vec_611 = vec_67;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_69 = _mm256_set1_ps(scal_12);


											vec_68 = _mm256_fmadd_ps(vec_69, vec_41, mem_vec_612);
											mem_vec_612 = vec_68;



											vec_70 = _mm256_fmadd_ps(vec_69, vec_43, mem_vec_613);
											mem_vec_613 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_69, vec_45, mem_vec_614);
											mem_vec_614 = vec_71;



											vec_72 = _mm256_fmadd_ps(vec_69, vec_47, mem_vec_615);
											mem_vec_615 = vec_72;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_74 = _mm256_set1_ps(scal_13);


											vec_73 = _mm256_fmadd_ps(vec_74, vec_41, mem_vec_616);
											mem_vec_616 = vec_73;



											vec_75 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_617);
											mem_vec_617 = vec_75;



											vec_76 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_618);
											mem_vec_618 = vec_76;



											vec_77 = _mm256_fmadd_ps(vec_74, vec_47, mem_vec_619);
											mem_vec_619 = vec_77;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_79 = _mm256_set1_ps(scal_14);
											vec_80 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_78 = _mm256_fmadd_ps(vec_79, vec_80, mem_vec_592);
											mem_vec_592 = vec_78;

											vec_82 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

											vec_81 = _mm256_fmadd_ps(vec_79, vec_82, mem_vec_593);
											mem_vec_593 = vec_81;

											vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_83 = _mm256_fmadd_ps(vec_79, vec_84, mem_vec_594);
											mem_vec_594 = vec_83;

											vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

											vec_85 = _mm256_fmadd_ps(vec_79, vec_86, mem_vec_595);
											mem_vec_595 = vec_85;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_88 = _mm256_set1_ps(scal_15);


											vec_87 = _mm256_fmadd_ps(vec_88, vec_80, mem_vec_596);
											mem_vec_596 = vec_87;



											vec_89 = _mm256_fmadd_ps(vec_88, vec_82, mem_vec_597);
											mem_vec_597 = vec_89;



											vec_90 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_598);
											mem_vec_598 = vec_90;



											vec_91 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_599);
											mem_vec_599 = vec_91;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_93 = _mm256_set1_ps(scal_16);


											vec_92 = _mm256_fmadd_ps(vec_93, vec_80, mem_vec_600);
											mem_vec_600 = vec_92;



											vec_94 = _mm256_fmadd_ps(vec_93, vec_82, mem_vec_601);
											mem_vec_601 = vec_94;



											vec_95 = _mm256_fmadd_ps(vec_93, vec_84, mem_vec_602);
											mem_vec_602 = vec_95;



											vec_96 = _mm256_fmadd_ps(vec_93, vec_86, mem_vec_603);
											mem_vec_603 = vec_96;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_98 = _mm256_set1_ps(scal_17);


											vec_97 = _mm256_fmadd_ps(vec_98, vec_80, mem_vec_604);
											mem_vec_604 = vec_97;



											vec_99 = _mm256_fmadd_ps(vec_98, vec_82, mem_vec_605);
											mem_vec_605 = vec_99;



											vec_100 = _mm256_fmadd_ps(vec_98, vec_84, mem_vec_606);
											mem_vec_606 = vec_100;



											vec_101 = _mm256_fmadd_ps(vec_98, vec_86, mem_vec_607);
											mem_vec_607 = vec_101;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_103 = _mm256_set1_ps(scal_18);


											vec_102 = _mm256_fmadd_ps(vec_103, vec_80, mem_vec_608);
											mem_vec_608 = vec_102;



											vec_104 = _mm256_fmadd_ps(vec_103, vec_82, mem_vec_609);
											mem_vec_609 = vec_104;



											vec_105 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_610);
											mem_vec_610 = vec_105;



											vec_106 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_611);
											mem_vec_611 = vec_106;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_108 = _mm256_set1_ps(scal_19);


											vec_107 = _mm256_fmadd_ps(vec_108, vec_80, mem_vec_612);
											mem_vec_612 = vec_107;



											vec_109 = _mm256_fmadd_ps(vec_108, vec_82, mem_vec_613);
											mem_vec_613 = vec_109;



											vec_110 = _mm256_fmadd_ps(vec_108, vec_84, mem_vec_614);
											mem_vec_614 = vec_110;



											vec_111 = _mm256_fmadd_ps(vec_108, vec_86, mem_vec_615);
											mem_vec_615 = vec_111;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_113 = _mm256_set1_ps(scal_20);


											vec_112 = _mm256_fmadd_ps(vec_113, vec_80, mem_vec_616);
											mem_vec_616 = vec_112;



											vec_114 = _mm256_fmadd_ps(vec_113, vec_82, mem_vec_617);
											mem_vec_617 = vec_114;



											vec_115 = _mm256_fmadd_ps(vec_113, vec_84, mem_vec_618);
											mem_vec_618 = vec_115;



											vec_116 = _mm256_fmadd_ps(vec_113, vec_86, mem_vec_619);
											mem_vec_619 = vec_116;
										}
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_612);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_613);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_614);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_615);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_616);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_617);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_618);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_619);
							}
						}
					}
				}
