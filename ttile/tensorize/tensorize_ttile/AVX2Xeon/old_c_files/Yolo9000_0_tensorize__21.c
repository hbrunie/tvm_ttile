...
yp_2 = 0;
				for (h = h190, hp_0 = 0;h < h190 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c352 = c353, c352_p_0 = 0;c352 < c353 + 3;c352 += 3, c352_p_0 += 3){
						// y = 4, x = 4, h = 1, w = 3, c = 3, f = 32
						// T (x, 4) (4 / 1)
						for (x = x416, xp_1 = x416_p_0, xp_0 = 0;x < x416 + 4;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c352, cp_1 = c352_p_0, cp_0 = 0;c < c352 + 3;c += 1, cp_1 += 1, cp_0 += 1){
