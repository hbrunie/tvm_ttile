...
[V f; U (4, f); ULambda y; U (3, w); T (16, c); Hoist_vars [c]; T (3, h);
  ...
  T (2, c); T (2, f)]
*/
IND_TYPE c, cp_0, c58_p_0, c59_p_0, cp_1, c58_p_1, cp_2, c58, c59, f, fp_0, f61_p_0, fp_1, f61, h, hp_0, x, xp_0, y, yp_0;
		...
		for (f = f61, fp_1 = f61_p_0, fp_0 = 0;
			...
			f += 32, fp_1 += 32, fp_0 += 32){
				for (y = y44, yp_0 = 0;
					...
					// T (c, 8) (128 / 16)
					for (c58 = c59, c58_p_1 = c59_p_0, c58_p_0 = 0;
						c58 < c59 + 128;
						c58 += 16, c58_p_1 += 16, c58_p_0 += 16){
						...
						for (x = x34, xp_0 = 0;
							...
							for (h = h30, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c58, cp_2 = c58_p_1, cp_1 = c58_p_0, cp_0 = 0;
											c < c58 + 16;
