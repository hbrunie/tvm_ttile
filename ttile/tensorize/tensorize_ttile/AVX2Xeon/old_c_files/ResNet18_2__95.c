...
for (f736 = f737, f736_p_0 = 0;
	...
	// T (f, 1) (32 / 32)
	for (f735 = f736, f735_p_1 = f736_p_0, f735_p_0 = 0;
		f735 < f736 + 32;
		f735 += 32, f735_p_1 += 32, f735_p_0 += 32){
		// y = 56, x = 56, h = 3, w = 3, c = 64, f = 32
		// T (x, 7) (56 / 8)
		for (x574 = x575, x574_p_0 = 0;
			...
			for (y = y399, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f735, fp_2 = f735_p_1, fp_1 = f735_p_0, fp_0 = 0;
					f < f735 + 32;
					...
					for (c576 = c577, c576_p_0 = 0;
						...
						for (w = w308, wp_0 = 0;
							...
							for (x = x574, xp_1 = x574_p_0, xp_0 = 0;
								x < x574 + 8;
								x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_7282 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
										mem_vec_7283 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
										mem_vec_7284 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
										mem_vec_7285 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
										mem_vec_7286 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_7287 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
										mem_vec_7288 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_7289 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
										mem_vec_7290 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_7291 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
										mem_vec_7292 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_7293 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
										mem_vec_7294 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_7295 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
										mem_vec_7296 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
										mem_vec_7297 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_7282);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_7283);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_7284);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_7285);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_7286);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_7287);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_7288);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_7289);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_7290);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_7291);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_7292);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_7293);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_7294);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_7295);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_7296);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_7297);
							}
						}
					}
				}
