			...
			for (c185 = c186, c185_p_0 = 0;
				...
				for (f = f144, fp_2 = f144_p_1, fp_1 = f144_p_0, fp_0 = 0;
					...
					f += 32, fp_2 += 32, fp_1 += 32, fp_0 += 32){
						...
						for (y = y106 + 12, yp_1 = y106_p_0, yp_0 = 0;
							y < y106 + 12 + 5;
							y += 5, yp_1 += 5, yp_0 += 5){
							// y = ph_y, x = 34, h = 3, w = 3, c = 8, f = 32
							// T (x, 34) (34 / 1)
								...
								for (h = h71, hp_0 = 0;
									...
									for (w = w82, wp_0 = 0;
										...
										w += 1, wp_0 += 1){
												...
												mem_vec_2092 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
												mem_vec_2093 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8]);
												mem_vec_2094 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
												mem_vec_2095 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 8, f = 32
												// T (c, 8) (8 / 1)
												for (c = c185, cp_1 = c185_p_0, cp_0 = 0;
													c < c185 + 8;
											...
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_2092);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8], mem_vec_2093);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_2094);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24], mem_vec_2095);
									}
								}
							}
						}
