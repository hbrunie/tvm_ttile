...
for (f248 = f249, f248_p_0 = 0;
	...
	for (c337 = c338, c337_p_0 = 0;
		...
		// T (f, 2) (64 / 32)
		for (f = f248, fp_1 = f248_p_0, fp_0 = 0;
			f < f248 + 64;
							...
							for (w = w128, wp_0 = 0;
								...
								for (x = x252, xp_1 = x252_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3784 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_3785 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
											mem_vec_3786 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_3787 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 64, f = 32
											// T (c, 64) (64 / 1)
											for (c = c336, cp_2 = c336_p_1, cp_1 = c336_p_0, cp_0 = 0;
												c < c336 + 64;
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_3784);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_3785);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_3786);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_3787);
								}
							}
						}
					}
