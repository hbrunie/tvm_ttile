...
[V f; U (4, f); U (4, y); U (3, h); T (3, c); Hoist_vars [c]; T (8, x);
  T (1, c); T (3, w); T (17, y); T (68, x); T (4, y); T (2, y)]
*/
IND_TYPE c, cp_0, c286_p_0, cp_1, c286, w, wp_0, x, xp_0, x350_p_0, xp_1, x350, y, yp_0, y392_p_0, y393_p_0, yp_1, y392_p_1, yp_2, y392, y393;
IND_TYPE y394 = 0;
IND_TYPE x351 = 0;
IND_TYPE h = 0;
IND_TYPE w195 = 0;
...
yp_2 = 0;
				for (w = w195, wp_0 = 0;w < w195 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c286 = c287, c286_p_0 = 0;c286 < c287 + 3;c286 += 3, c286_p_0 += 3){
						// y = 4, x = 8, h = 3, w = 1, c = 3, f = 32
						// T (x, 8) (8 / 1)
						for (x = x350, xp_1 = x350_p_0, xp_0 = 0;x < x350 + 8;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c286, cp_1 = c286_p_0, cp_0 = 0;c < c286 + 3;c += 1, cp_1 += 1, cp_0 += 1){
