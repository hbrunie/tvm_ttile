...
[V f; U (4, f); ULambda y; U (3, h); T (32, c); Hoist_vars [c]; T (2, x);
  ...
  T (1, f); T (2, f)]
*/
IND_TYPE c, cp_0, c18_p_0, cp_1, c18, f, fp_0, f18_p_0, f19_p_0, fp_1, f18_p_1, fp_2, f18, f19, w, wp_0, x, xp_0, x18_p_0, xp_1, x18, y, yp_0;
								...
								for (x = x18, xp_1 = x18_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c18, cp_1 = c18_p_0, cp_0 = 0;
												...
												vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_180);
												mem_vec_180 = vec_24;

												vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_181);
												mem_vec_181 = vec_27;

												vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_182);
												mem_vec_182 = vec_29;

												vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

												vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_183);
												mem_vec_183 = vec_31;
												scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_34 = _mm256_set1_ps(scal_5);


												vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_184);
												mem_vec_184 = vec_33;



												vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_185);
												mem_vec_185 = vec_35;



												vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_186);
												mem_vec_186 = vec_36;



												vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_187);
												mem_vec_187 = vec_37;
												scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_39 = _mm256_set1_ps(scal_6);


												vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_188);
												mem_vec_188 = vec_38;



												vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_189);
												mem_vec_189 = vec_40;



												vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_190);
												mem_vec_190 = vec_41;



												vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_191);
												mem_vec_191 = vec_42;
												scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_44 = _mm256_set1_ps(scal_7);


												vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_192);
												mem_vec_192 = vec_43;



												vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_193);
												mem_vec_193 = vec_45;



												vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_194);
												mem_vec_194 = vec_46;



												vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_195);
												mem_vec_195 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_49 = _mm256_set1_ps(scal_8);
												vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_180);
												mem_vec_180 = vec_48;

												vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_181);
												mem_vec_181 = vec_51;

												vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_182);
												mem_vec_182 = vec_53;

												vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

												vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_183);
												mem_vec_183 = vec_55;
												scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_58 = _mm256_set1_ps(scal_9);


												vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_184);
												mem_vec_184 = vec_57;



												vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_185);
												mem_vec_185 = vec_59;



												vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_186);
												mem_vec_186 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_187);
												mem_vec_187 = vec_61;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_63 = _mm256_set1_ps(scal_10);


												vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_188);
												mem_vec_188 = vec_62;



												vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_189);
												mem_vec_189 = vec_64;



												vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_190);
												mem_vec_190 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_191);
												mem_vec_191 = vec_66;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_68 = _mm256_set1_ps(scal_11);


												vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_192);
												mem_vec_192 = vec_67;



												vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_193);
												mem_vec_193 = vec_69;



												vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_194);
												mem_vec_194 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_195);
												mem_vec_195 = vec_71;
											}
							...
							for (w = w12, wp_0 = 0;
								...
								for (x = x18, xp_1 = x18_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_216 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_217 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
											mem_vec_218 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_219 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
											mem_vec_220 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_221 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
											mem_vec_222 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_223 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 32, f = 32
											// T (c, 32) (32 / 1)
											for (c = c18, cp_1 = c18_p_0, cp_0 = 0;
												c < c18 + 32;
												...
												vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_216);
												mem_vec_216 = vec_29;



												vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_217);
												mem_vec_217 = vec_31;



												vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_218);
												mem_vec_218 = vec_32;



												vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_219);
												mem_vec_219 = vec_33;
												scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
												vec_35 = _mm256_set1_ps(scal_6);


												vec_34 = _mm256_fmadd_ps(vec_35, vec_2, mem_vec_220);
												mem_vec_220 = vec_34;



												vec_36 = _mm256_fmadd_ps(vec_35, vec_4, mem_vec_221);
												mem_vec_221 = vec_36;



												vec_37 = _mm256_fmadd_ps(vec_35, vec_6, mem_vec_222);
												mem_vec_222 = vec_37;



												vec_38 = _mm256_fmadd_ps(vec_35, vec_8, mem_vec_223);
												mem_vec_223 = vec_38;
												scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
												vec_40 = _mm256_set1_ps(scal_7);
												vec_41 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

												vec_39 = _mm256_fmadd_ps(vec_40, vec_41, mem_vec_196);
												mem_vec_196 = vec_39;

												vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_42 = _mm256_fmadd_ps(vec_40, vec_43, mem_vec_197);
												mem_vec_197 = vec_42;

												vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_44 = _mm256_fmadd_ps(vec_40, vec_45, mem_vec_198);
												mem_vec_198 = vec_44;

												vec_47 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

												vec_46 = _mm256_fmadd_ps(vec_40, vec_47, mem_vec_199);
												mem_vec_199 = vec_46;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_49 = _mm256_set1_ps(scal_8);


												vec_48 = _mm256_fmadd_ps(vec_49, vec_41, mem_vec_200);
												mem_vec_200 = vec_48;



												vec_50 = _mm256_fmadd_ps(vec_49, vec_43, mem_vec_201);
												mem_vec_201 = vec_50;



												vec_51 = _mm256_fmadd_ps(vec_49, vec_45, mem_vec_202);
												mem_vec_202 = vec_51;



												vec_52 = _mm256_fmadd_ps(vec_49, vec_47, mem_vec_203);
												mem_vec_203 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_54 = _mm256_set1_ps(scal_9);


												vec_53 = _mm256_fmadd_ps(vec_54, vec_41, mem_vec_204);
												mem_vec_204 = vec_53;



												vec_55 = _mm256_fmadd_ps(vec_54, vec_43, mem_vec_205);
												mem_vec_205 = vec_55;



												vec_56 = _mm256_fmadd_ps(vec_54, vec_45, mem_vec_206);
												mem_vec_206 = vec_56;



												vec_57 = _mm256_fmadd_ps(vec_54, vec_47, mem_vec_207);
												mem_vec_207 = vec_57;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_59 = _mm256_set1_ps(scal_10);


												vec_58 = _mm256_fmadd_ps(vec_59, vec_41, mem_vec_208);
												mem_vec_208 = vec_58;



												vec_60 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_209);
												mem_vec_209 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_210);
												mem_vec_210 = vec_61;



												vec_62 = _mm256_fmadd_ps(vec_59, vec_47, mem_vec_211);
												mem_vec_211 = vec_62;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
												vec_64 = _mm256_set1_ps(scal_11);


												vec_63 = _mm256_fmadd_ps(vec_64, vec_41, mem_vec_212);
												mem_vec_212 = vec_63;



												vec_65 = _mm256_fmadd_ps(vec_64, vec_43, mem_vec_213);
												mem_vec_213 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_64, vec_45, mem_vec_214);
												mem_vec_214 = vec_66;



												vec_67 = _mm256_fmadd_ps(vec_64, vec_47, mem_vec_215);
												mem_vec_215 = vec_67;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
												vec_69 = _mm256_set1_ps(scal_12);


												vec_68 = _mm256_fmadd_ps(vec_69, vec_41, mem_vec_216);
												mem_vec_216 = vec_68;



												vec_70 = _mm256_fmadd_ps(vec_69, vec_43, mem_vec_217);
												mem_vec_217 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_69, vec_45, mem_vec_218);
												mem_vec_218 = vec_71;



												vec_72 = _mm256_fmadd_ps(vec_69, vec_47, mem_vec_219);
												mem_vec_219 = vec_72;
												scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
												vec_74 = _mm256_set1_ps(scal_13);


												vec_73 = _mm256_fmadd_ps(vec_74, vec_41, mem_vec_220);
												mem_vec_220 = vec_73;



												vec_75 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_221);
												mem_vec_221 = vec_75;



												vec_76 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_222);
												mem_vec_222 = vec_76;



												vec_77 = _mm256_fmadd_ps(vec_74, vec_47, mem_vec_223);
												mem_vec_223 = vec_77;
												scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_79 = _mm256_set1_ps(scal_14);
												vec_80 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_78 = _mm256_fmadd_ps(vec_79, vec_80, mem_vec_196);
												mem_vec_196 = vec_78;

												vec_82 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_81 = _mm256_fmadd_ps(vec_79, vec_82, mem_vec_197);
												mem_vec_197 = vec_81;

												vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_83 = _mm256_fmadd_ps(vec_79, vec_84, mem_vec_198);
												mem_vec_198 = vec_83;

												vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

												vec_85 = _mm256_fmadd_ps(vec_79, vec_86, mem_vec_199);
												mem_vec_199 = vec_85;
												scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_88 = _mm256_set1_ps(scal_15);


												vec_87 = _mm256_fmadd_ps(vec_88, vec_80, mem_vec_200);
												mem_vec_200 = vec_87;



												vec_89 = _mm256_fmadd_ps(vec_88, vec_82, mem_vec_201);
												mem_vec_201 = vec_89;



												vec_90 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_202);
												mem_vec_202 = vec_90;



												vec_91 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_203);
												mem_vec_203 = vec_91;
												scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_93 = _mm256_set1_ps(scal_16);


												vec_92 = _mm256_fmadd_ps(vec_93, vec_80, mem_vec_204);
												mem_vec_204 = vec_92;



												vec_94 = _mm256_fmadd_ps(vec_93, vec_82, mem_vec_205);
												mem_vec_205 = vec_94;



												vec_95 = _mm256_fmadd_ps(vec_93, vec_84, mem_vec_206);
												mem_vec_206 = vec_95;



												vec_96 = _mm256_fmadd_ps(vec_93, vec_86, mem_vec_207);
												mem_vec_207 = vec_96;
												scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_98 = _mm256_set1_ps(scal_17);


												vec_97 = _mm256_fmadd_ps(vec_98, vec_80, mem_vec_208);
												mem_vec_208 = vec_97;



												vec_99 = _mm256_fmadd_ps(vec_98, vec_82, mem_vec_209);
												mem_vec_209 = vec_99;



												vec_100 = _mm256_fmadd_ps(vec_98, vec_84, mem_vec_210);
												mem_vec_210 = vec_100;



												vec_101 = _mm256_fmadd_ps(vec_98, vec_86, mem_vec_211);
												mem_vec_211 = vec_101;
												scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
												vec_103 = _mm256_set1_ps(scal_18);


												vec_102 = _mm256_fmadd_ps(vec_103, vec_80, mem_vec_212);
												mem_vec_212 = vec_102;



												vec_104 = _mm256_fmadd_ps(vec_103, vec_82, mem_vec_213);
												mem_vec_213 = vec_104;



												vec_105 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_214);
												mem_vec_214 = vec_105;



												vec_106 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_215);
												mem_vec_215 = vec_106;
												scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
												vec_108 = _mm256_set1_ps(scal_19);


												vec_107 = _mm256_fmadd_ps(vec_108, vec_80, mem_vec_216);
												mem_vec_216 = vec_107;



												vec_109 = _mm256_fmadd_ps(vec_108, vec_82, mem_vec_217);
												mem_vec_217 = vec_109;



												vec_110 = _mm256_fmadd_ps(vec_108, vec_84, mem_vec_218);
												mem_vec_218 = vec_110;



												vec_111 = _mm256_fmadd_ps(vec_108, vec_86, mem_vec_219);
												mem_vec_219 = vec_111;
												scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
												vec_113 = _mm256_set1_ps(scal_20);


												vec_112 = _mm256_fmadd_ps(vec_113, vec_80, mem_vec_220);
												mem_vec_220 = vec_112;



												vec_114 = _mm256_fmadd_ps(vec_113, vec_82, mem_vec_221);
												mem_vec_221 = vec_114;



												vec_115 = _mm256_fmadd_ps(vec_113, vec_84, mem_vec_222);
												mem_vec_222 = vec_115;



												vec_116 = _mm256_fmadd_ps(vec_113, vec_86, mem_vec_223);
												mem_vec_223 = vec_116;
											}
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_216);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_217);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_218);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_219);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_220);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_221);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_222);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_223);
								}
							}
						}
					}
