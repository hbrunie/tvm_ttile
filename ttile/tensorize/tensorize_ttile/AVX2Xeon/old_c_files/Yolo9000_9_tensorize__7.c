...
/*
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (68, x); T (16, c);
  T (4, f); T (1, x); T (17, y)]
*/
IND_TYPE c, cp_0, c33_p_0, cp_1, c33, f, fp_0, x, xp_0, x33_p_0, xp_1, x33, y, yp_0;
IND_TYPE y22 = 0;
IND_TYPE x34 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c33 = 0;
c33_p_0 = 0;
				for (x = x33, xp_1 = x33_p_0, xp_0 = 0;x < x33 + 68;x += 1, xp_1 += 1, xp_0 += 1){
