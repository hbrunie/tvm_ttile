...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (4, c); T (1, f); T (34, y); T (1, x); T (4, f); T (8, x)]
*/
IND_TYPE c, cp_0, c15_p_0, cp_1, c15, f, fp_0, f15_p_0, fp_1, f15, w, wp_0, x, xp_0, x20_p_0, x21_p_0, xp_1, x20_p_1, xp_2, x20, x21, y, yp_0;
IND_TYPE y10 = 0;
IND_TYPE x22 = 0;
IND_TYPE h = 0;
IND_TYPE w10 = 0;
