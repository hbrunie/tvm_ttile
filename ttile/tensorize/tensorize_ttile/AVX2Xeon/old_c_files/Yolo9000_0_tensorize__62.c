...
yp_2 = 0;
				for (w = w136, wp_0 = 0;w < w136 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c199 = c200, c199_p_0 = 0;c199 < c200 + 3;c199 += 3, c199_p_0 += 3){
						// y = 4, x = 136, h = 3, w = 1, c = 3, f = 32
						// T (x, 136) (136 / 1)
						for (x = x251, xp_1 = x251_p_0, xp_0 = 0;x < x251 + 136;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c199, cp_1 = c199_p_0, cp_0 = 0;c < c199 + 3;c += 1, cp_1 += 1, cp_0 += 1){
