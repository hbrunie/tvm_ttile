...
// T (y, 4) (544 / 136)
for (y691 = y692, y691_p_0 = 0;
	y691 < y692 + 544;
	y691 += 136, y691_p_0 += 136){
	...
	for (x640 = x641, x640_p_0 = 0;
		...
		// T (y, 17) (136 / 8)
		for (y = y691, yp_1 = y691_p_0, yp_0 = 0;
			y < y691 + 136;
			y += 8, yp_1 += 8, yp_0 += 8){
			...
			for (x639 = x640, x639_p_1 = x640_p_0, x639_p_0 = 0;
				x639 < x640 + 34;
				x639 += 17, x639_p_1 += 17, x639_p_0 += 17){
				...
				for (f = f259, fp_0 = 0;
					...
					for (w = w344, wp_0 = 0;
						...
						// T (x, 17) (17 / 1)
						for (x = x639, xp_2 = x639_p_1, xp_1 = x639_p_0, xp_0 = 0;
							x < x639 + 17;
