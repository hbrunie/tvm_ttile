...
*/
IND_TYPE c, cp_0, c160_p_0, c161_p_0, cp_1, c160_p_1, cp_2, c160, c161, f, fp_0, f154_p_0, f155_p_0, fp_1, f154_p_1, fp_2, f154, f155, h, hp_0, x, xp_0, y, yp_0;
...
for (f155 = f156, f155_p_0 = 0;
	...
	for (c161 = c162, c161_p_0 = 0;
		...
		for (f154 = f155, f154_p_1 = f155_p_0, f154_p_0 = 0;
			f154 < f155 + 64;
			f154 += 64, f154_p_1 += 64, f154_p_0 += 64){
			// y = 28, x = 28, h = 3, w = 3, c = 128, f = 64
			// T (y, 4) (28 / 7)
			for (y = y80, yp_0 = 0;
				y < y80 + 28;
