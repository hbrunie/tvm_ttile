...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (3, w); T (3, h);
  T (28, x); T (7, y); T (1, f); T (1, c); T (4, f); T (1, y); T (1, f)]
*/
IND_TYPE c, cp_0, c174_p_0, cp_1, c174, f, fp_0, f232_p_0, f233_p_0, fp_1, f232_p_1, fp_2, f232, f233, h, hp_0, w, wp_0, x, xp_0, y, yp_0, y132_p_0, yp_1, y132;
IND_TYPE y133 = 0;
IND_TYPE x116 = 0;
IND_TYPE h98 = 0;
IND_TYPE w92 = 0;
