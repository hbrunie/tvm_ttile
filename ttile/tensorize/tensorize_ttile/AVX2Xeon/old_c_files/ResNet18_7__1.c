...
[V f; U (4, f); ULambda y; U (3, w); T (16, c); Hoist_vars [c]; T (3, h);
  ...
  T (8, c); T (8, f); T (1, c)]
*/
IND_TYPE c, cp_0, c184_p_0, c185_p_0, cp_1, c184_p_1, cp_2, c184, c185, f, fp_0, h, hp_0, x, xp_0, y, yp_0;
						...
						for (h = h67, hp_0 = 0;
							...
							h += 1, hp_0 += 1){
									...
									for (c = c184, cp_2 = c184_p_1, cp_1 = c184_p_0, cp_0 = 0;
										...
										vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_1476);
										mem_vec_1476 = vec_24;

										vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

										vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_1477);
										mem_vec_1477 = vec_27;

										vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_1478);
										mem_vec_1478 = vec_29;

										vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

										vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_1479);
										mem_vec_1479 = vec_31;
										scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
										vec_34 = _mm256_set1_ps(scal_5);


										vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_1480);
										mem_vec_1480 = vec_33;



										vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_1481);
										mem_vec_1481 = vec_35;



										vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_1482);
										mem_vec_1482 = vec_36;



										vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_1483);
										mem_vec_1483 = vec_37;
										scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
										vec_39 = _mm256_set1_ps(scal_6);


										vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_1484);
										mem_vec_1484 = vec_38;



										vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_1485);
										mem_vec_1485 = vec_40;



										vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_1486);
										mem_vec_1486 = vec_41;



										vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_1487);
										mem_vec_1487 = vec_42;
										scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
										vec_44 = _mm256_set1_ps(scal_7);


										vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_1488);
										mem_vec_1488 = vec_43;



										vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_1489);
										mem_vec_1489 = vec_45;



										vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_1490);
										mem_vec_1490 = vec_46;



										vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_1491);
										mem_vec_1491 = vec_47;
										scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
										vec_49 = _mm256_set1_ps(scal_8);
										vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_1476);
										mem_vec_1476 = vec_48;

										vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

										vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_1477);
										mem_vec_1477 = vec_51;

										vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_1478);
										mem_vec_1478 = vec_53;

										vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

										vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_1479);
										mem_vec_1479 = vec_55;
										scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
										vec_58 = _mm256_set1_ps(scal_9);


										vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_1480);
										mem_vec_1480 = vec_57;



										vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_1481);
										mem_vec_1481 = vec_59;



										vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_1482);
										mem_vec_1482 = vec_60;



										vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_1483);
										mem_vec_1483 = vec_61;
										scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
										vec_63 = _mm256_set1_ps(scal_10);


										vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_1484);
										mem_vec_1484 = vec_62;



										vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_1485);
										mem_vec_1485 = vec_64;



										vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_1486);
										mem_vec_1486 = vec_65;



										vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_1487);
										mem_vec_1487 = vec_66;
										scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
										vec_68 = _mm256_set1_ps(scal_11);


										vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_1488);
										mem_vec_1488 = vec_67;



										vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_1489);
										mem_vec_1489 = vec_69;



										vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_1490);
										mem_vec_1490 = vec_70;



										vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_1491);
										mem_vec_1491 = vec_71;
									}
						...
						for (h = h67, hp_0 = 0;
							...
							h += 1, hp_0 += 1){
									...
									for (c = c184, cp_2 = c184_p_1, cp_1 = c184_p_0, cp_0 = 0;
										...
										vec_29 = _mm256_fmadd_ps(vec_30, vec_31, mem_vec_1492);
										mem_vec_1492 = vec_29;

										vec_33 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

										vec_32 = _mm256_fmadd_ps(vec_30, vec_33, mem_vec_1493);
										mem_vec_1493 = vec_32;

										vec_35 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_34 = _mm256_fmadd_ps(vec_30, vec_35, mem_vec_1494);
										mem_vec_1494 = vec_34;

										vec_37 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

										vec_36 = _mm256_fmadd_ps(vec_30, vec_37, mem_vec_1495);
										mem_vec_1495 = vec_36;
										scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
										vec_39 = _mm256_set1_ps(scal_6);


										vec_38 = _mm256_fmadd_ps(vec_39, vec_31, mem_vec_1496);
										mem_vec_1496 = vec_38;



										vec_40 = _mm256_fmadd_ps(vec_39, vec_33, mem_vec_1497);
										mem_vec_1497 = vec_40;



										vec_41 = _mm256_fmadd_ps(vec_39, vec_35, mem_vec_1498);
										mem_vec_1498 = vec_41;



										vec_42 = _mm256_fmadd_ps(vec_39, vec_37, mem_vec_1499);
										mem_vec_1499 = vec_42;
										scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
										vec_44 = _mm256_set1_ps(scal_7);


										vec_43 = _mm256_fmadd_ps(vec_44, vec_31, mem_vec_1500);
										mem_vec_1500 = vec_43;



										vec_45 = _mm256_fmadd_ps(vec_44, vec_33, mem_vec_1501);
										mem_vec_1501 = vec_45;



										vec_46 = _mm256_fmadd_ps(vec_44, vec_35, mem_vec_1502);
										mem_vec_1502 = vec_46;



										vec_47 = _mm256_fmadd_ps(vec_44, vec_37, mem_vec_1503);
										mem_vec_1503 = vec_47;
										scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
										vec_49 = _mm256_set1_ps(scal_8);


										vec_48 = _mm256_fmadd_ps(vec_49, vec_31, mem_vec_1504);
										mem_vec_1504 = vec_48;



										vec_50 = _mm256_fmadd_ps(vec_49, vec_33, mem_vec_1505);
										mem_vec_1505 = vec_50;



										vec_51 = _mm256_fmadd_ps(vec_49, vec_35, mem_vec_1506);
										mem_vec_1506 = vec_51;



										vec_52 = _mm256_fmadd_ps(vec_49, vec_37, mem_vec_1507);
										mem_vec_1507 = vec_52;
										scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
										vec_54 = _mm256_set1_ps(scal_9);


										vec_53 = _mm256_fmadd_ps(vec_54, vec_31, mem_vec_1508);
										mem_vec_1508 = vec_53;



										vec_55 = _mm256_fmadd_ps(vec_54, vec_33, mem_vec_1509);
										mem_vec_1509 = vec_55;



										vec_56 = _mm256_fmadd_ps(vec_54, vec_35, mem_vec_1510);
										mem_vec_1510 = vec_56;



										vec_57 = _mm256_fmadd_ps(vec_54, vec_37, mem_vec_1511);
										mem_vec_1511 = vec_57;
										scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
										vec_59 = _mm256_set1_ps(scal_10);
										vec_60 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_58 = _mm256_fmadd_ps(vec_59, vec_60, mem_vec_1492);
										mem_vec_1492 = vec_58;

										vec_62 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

										vec_61 = _mm256_fmadd_ps(vec_59, vec_62, mem_vec_1493);
										mem_vec_1493 = vec_61;

										vec_64 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_63 = _mm256_fmadd_ps(vec_59, vec_64, mem_vec_1494);
										mem_vec_1494 = vec_63;

										vec_66 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

										vec_65 = _mm256_fmadd_ps(vec_59, vec_66, mem_vec_1495);
										mem_vec_1495 = vec_65;
										scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
										vec_68 = _mm256_set1_ps(scal_11);


										vec_67 = _mm256_fmadd_ps(vec_68, vec_60, mem_vec_1496);
										mem_vec_1496 = vec_67;



										vec_69 = _mm256_fmadd_ps(vec_68, vec_62, mem_vec_1497);
										mem_vec_1497 = vec_69;



										vec_70 = _mm256_fmadd_ps(vec_68, vec_64, mem_vec_1498);
										mem_vec_1498 = vec_70;



										vec_71 = _mm256_fmadd_ps(vec_68, vec_66, mem_vec_1499);
										mem_vec_1499 = vec_71;
										scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
										vec_73 = _mm256_set1_ps(scal_12);


										vec_72 = _mm256_fmadd_ps(vec_73, vec_60, mem_vec_1500);
										mem_vec_1500 = vec_72;



										vec_74 = _mm256_fmadd_ps(vec_73, vec_62, mem_vec_1501);
										mem_vec_1501 = vec_74;



										vec_75 = _mm256_fmadd_ps(vec_73, vec_64, mem_vec_1502);
										mem_vec_1502 = vec_75;



										vec_76 = _mm256_fmadd_ps(vec_73, vec_66, mem_vec_1503);
										mem_vec_1503 = vec_76;
										scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
										vec_78 = _mm256_set1_ps(scal_13);


										vec_77 = _mm256_fmadd_ps(vec_78, vec_60, mem_vec_1504);
										mem_vec_1504 = vec_77;



										vec_79 = _mm256_fmadd_ps(vec_78, vec_62, mem_vec_1505);
										mem_vec_1505 = vec_79;



										vec_80 = _mm256_fmadd_ps(vec_78, vec_64, mem_vec_1506);
										mem_vec_1506 = vec_80;



										vec_81 = _mm256_fmadd_ps(vec_78, vec_66, mem_vec_1507);
										mem_vec_1507 = vec_81;
										scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
										vec_83 = _mm256_set1_ps(scal_14);


										vec_82 = _mm256_fmadd_ps(vec_83, vec_60, mem_vec_1508);
										mem_vec_1508 = vec_82;



										vec_84 = _mm256_fmadd_ps(vec_83, vec_62, mem_vec_1509);
										mem_vec_1509 = vec_84;



										vec_85 = _mm256_fmadd_ps(vec_83, vec_64, mem_vec_1510);
										mem_vec_1510 = vec_85;



										vec_86 = _mm256_fmadd_ps(vec_83, vec_66, mem_vec_1511);
										mem_vec_1511 = vec_86;
									}
