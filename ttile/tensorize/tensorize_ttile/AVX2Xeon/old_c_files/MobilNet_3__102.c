...
[V f; U (4, f); ULambda y; U (3, w); T (64, c); Hoist_vars [c]; T (2, x);
  ...
  T (2, f); T (2, c); T (2, f)]
*/
IND_TYPE c, cp_0, c48_p_0, c49_p_0, cp_1, c48_p_1, cp_2, c48, c49, f, fp_0, f36_p_0, fp_1, f36, h, hp_0, x, xp_0, x36_p_0, xp_1, x36, y, yp_0;
								...
								for (x = x36, xp_1 = x36_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c48, cp_2 = c48_p_1, cp_1 = c48_p_0, cp_0 = 0;
												...
												vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_480);
												mem_vec_480 = vec_24;

												vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

												vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_481);
												mem_vec_481 = vec_27;

												vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_482);
												mem_vec_482 = vec_29;

												vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

												vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_483);
												mem_vec_483 = vec_31;
												scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_34 = _mm256_set1_ps(scal_5);


												vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_484);
												mem_vec_484 = vec_33;



												vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_485);
												mem_vec_485 = vec_35;



												vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_486);
												mem_vec_486 = vec_36;



												vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_487);
												mem_vec_487 = vec_37;
												scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_39 = _mm256_set1_ps(scal_6);


												vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_488);
												mem_vec_488 = vec_38;



												vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_489);
												mem_vec_489 = vec_40;



												vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_490);
												mem_vec_490 = vec_41;



												vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_491);
												mem_vec_491 = vec_42;
												scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_44 = _mm256_set1_ps(scal_7);


												vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_492);
												mem_vec_492 = vec_43;



												vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_493);
												mem_vec_493 = vec_45;



												vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_494);
												mem_vec_494 = vec_46;



												vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_495);
												mem_vec_495 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_49 = _mm256_set1_ps(scal_8);
												vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_480);
												mem_vec_480 = vec_48;

												vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

												vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_481);
												mem_vec_481 = vec_51;

												vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_482);
												mem_vec_482 = vec_53;

												vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

												vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_483);
												mem_vec_483 = vec_55;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_58 = _mm256_set1_ps(scal_9);


												vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_484);
												mem_vec_484 = vec_57;



												vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_485);
												mem_vec_485 = vec_59;



												vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_486);
												mem_vec_486 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_487);
												mem_vec_487 = vec_61;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_63 = _mm256_set1_ps(scal_10);


												vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_488);
												mem_vec_488 = vec_62;



												vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_489);
												mem_vec_489 = vec_64;



												vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_490);
												mem_vec_490 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_491);
												mem_vec_491 = vec_66;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_68 = _mm256_set1_ps(scal_11);


												vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_492);
												mem_vec_492 = vec_67;



												vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_493);
												mem_vec_493 = vec_69;



												vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_494);
												mem_vec_494 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_495);
												mem_vec_495 = vec_71;
											}
							...
							for (h = h16, hp_0 = 0;
								...
								for (x = x36, xp_1 = x36_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_514 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
											mem_vec_515 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24]);
											mem_vec_516 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_517 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
											mem_vec_518 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_519 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
											mem_vec_520 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_521 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
											mem_vec_522 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_523 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
											// y = ph_y, x = 1, h = 1, w = 3, c = 64, f = 32
											// T (c, 64) (64 / 1)
											for (c = c48, cp_2 = c48_p_1, cp_1 = c48_p_0, cp_0 = 0;
												c < c48 + 64;
												...
												vec_24 = _mm256_fmadd_ps(vec_25, vec_2, mem_vec_512);
												mem_vec_512 = vec_24;



												vec_26 = _mm256_fmadd_ps(vec_25, vec_4, mem_vec_513);
												mem_vec_513 = vec_26;



												vec_27 = _mm256_fmadd_ps(vec_25, vec_6, mem_vec_514);
												mem_vec_514 = vec_27;



												vec_28 = _mm256_fmadd_ps(vec_25, vec_8, mem_vec_515);
												mem_vec_515 = vec_28;
												...
												vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_518);
												mem_vec_518 = vec_32;



												vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_519);
												mem_vec_519 = vec_33;
												scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
												vec_35 = _mm256_set1_ps(scal_6);


												vec_34 = _mm256_fmadd_ps(vec_35, vec_2, mem_vec_520);
												mem_vec_520 = vec_34;



												vec_36 = _mm256_fmadd_ps(vec_35, vec_4, mem_vec_521);
												mem_vec_521 = vec_36;



												vec_37 = _mm256_fmadd_ps(vec_35, vec_6, mem_vec_522);
												mem_vec_522 = vec_37;



												vec_38 = _mm256_fmadd_ps(vec_35, vec_8, mem_vec_523);
												mem_vec_523 = vec_38;
												scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
												vec_40 = _mm256_set1_ps(scal_7);
												vec_41 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

												vec_39 = _mm256_fmadd_ps(vec_40, vec_41, mem_vec_496);
												mem_vec_496 = vec_39;

												vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

												vec_42 = _mm256_fmadd_ps(vec_40, vec_43, mem_vec_497);
												mem_vec_497 = vec_42;

												vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_44 = _mm256_fmadd_ps(vec_40, vec_45, mem_vec_498);
												mem_vec_498 = vec_44;

												vec_47 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

												vec_46 = _mm256_fmadd_ps(vec_40, vec_47, mem_vec_499);
												mem_vec_499 = vec_46;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_49 = _mm256_set1_ps(scal_8);


												vec_48 = _mm256_fmadd_ps(vec_49, vec_41, mem_vec_500);
												mem_vec_500 = vec_48;



												vec_50 = _mm256_fmadd_ps(vec_49, vec_43, mem_vec_501);
												mem_vec_501 = vec_50;



												vec_51 = _mm256_fmadd_ps(vec_49, vec_45, mem_vec_502);
												mem_vec_502 = vec_51;



												vec_52 = _mm256_fmadd_ps(vec_49, vec_47, mem_vec_503);
												mem_vec_503 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_54 = _mm256_set1_ps(scal_9);


												vec_53 = _mm256_fmadd_ps(vec_54, vec_41, mem_vec_504);
												mem_vec_504 = vec_53;



												vec_55 = _mm256_fmadd_ps(vec_54, vec_43, mem_vec_505);
												mem_vec_505 = vec_55;



												vec_56 = _mm256_fmadd_ps(vec_54, vec_45, mem_vec_506);
												mem_vec_506 = vec_56;



												vec_57 = _mm256_fmadd_ps(vec_54, vec_47, mem_vec_507);
												mem_vec_507 = vec_57;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_59 = _mm256_set1_ps(scal_10);


												vec_58 = _mm256_fmadd_ps(vec_59, vec_41, mem_vec_508);
												mem_vec_508 = vec_58;



												vec_60 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_509);
												mem_vec_509 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_510);
												mem_vec_510 = vec_61;



												vec_62 = _mm256_fmadd_ps(vec_59, vec_47, mem_vec_511);
												mem_vec_511 = vec_62;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_64 = _mm256_set1_ps(scal_11);


												vec_63 = _mm256_fmadd_ps(vec_64, vec_41, mem_vec_512);
												mem_vec_512 = vec_63;



												vec_65 = _mm256_fmadd_ps(vec_64, vec_43, mem_vec_513);
												mem_vec_513 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_64, vec_45, mem_vec_514);
												mem_vec_514 = vec_66;



												vec_67 = _mm256_fmadd_ps(vec_64, vec_47, mem_vec_515);
												mem_vec_515 = vec_67;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
												vec_69 = _mm256_set1_ps(scal_12);


												vec_68 = _mm256_fmadd_ps(vec_69, vec_41, mem_vec_516);
												mem_vec_516 = vec_68;



												vec_70 = _mm256_fmadd_ps(vec_69, vec_43, mem_vec_517);
												mem_vec_517 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_69, vec_45, mem_vec_518);
												mem_vec_518 = vec_71;



												vec_72 = _mm256_fmadd_ps(vec_69, vec_47, mem_vec_519);
												mem_vec_519 = vec_72;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
												vec_74 = _mm256_set1_ps(scal_13);


												vec_73 = _mm256_fmadd_ps(vec_74, vec_41, mem_vec_520);
												mem_vec_520 = vec_73;



												vec_75 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_521);
												mem_vec_521 = vec_75;



												vec_76 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_522);
												mem_vec_522 = vec_76;



												vec_77 = _mm256_fmadd_ps(vec_74, vec_47, mem_vec_523);
												mem_vec_523 = vec_77;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_79 = _mm256_set1_ps(scal_14);
												vec_80 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_78 = _mm256_fmadd_ps(vec_79, vec_80, mem_vec_496);
												mem_vec_496 = vec_78;

												vec_82 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

												vec_81 = _mm256_fmadd_ps(vec_79, vec_82, mem_vec_497);
												mem_vec_497 = vec_81;

												vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_83 = _mm256_fmadd_ps(vec_79, vec_84, mem_vec_498);
												mem_vec_498 = vec_83;

												vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

												vec_85 = _mm256_fmadd_ps(vec_79, vec_86, mem_vec_499);
												mem_vec_499 = vec_85;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_88 = _mm256_set1_ps(scal_15);


												vec_87 = _mm256_fmadd_ps(vec_88, vec_80, mem_vec_500);
												mem_vec_500 = vec_87;



												vec_89 = _mm256_fmadd_ps(vec_88, vec_82, mem_vec_501);
												mem_vec_501 = vec_89;



												vec_90 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_502);
												mem_vec_502 = vec_90;



												vec_91 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_503);
												mem_vec_503 = vec_91;
												scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_93 = _mm256_set1_ps(scal_16);


												vec_92 = _mm256_fmadd_ps(vec_93, vec_80, mem_vec_504);
												mem_vec_504 = vec_92;



												vec_94 = _mm256_fmadd_ps(vec_93, vec_82, mem_vec_505);
												mem_vec_505 = vec_94;



												vec_95 = _mm256_fmadd_ps(vec_93, vec_84, mem_vec_506);
												mem_vec_506 = vec_95;



												vec_96 = _mm256_fmadd_ps(vec_93, vec_86, mem_vec_507);
												mem_vec_507 = vec_96;
												scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_98 = _mm256_set1_ps(scal_17);


												vec_97 = _mm256_fmadd_ps(vec_98, vec_80, mem_vec_508);
												mem_vec_508 = vec_97;



												vec_99 = _mm256_fmadd_ps(vec_98, vec_82, mem_vec_509);
												mem_vec_509 = vec_99;



												vec_100 = _mm256_fmadd_ps(vec_98, vec_84, mem_vec_510);
												mem_vec_510 = vec_100;



												vec_101 = _mm256_fmadd_ps(vec_98, vec_86, mem_vec_511);
												mem_vec_511 = vec_101;
												scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_103 = _mm256_set1_ps(scal_18);


												vec_102 = _mm256_fmadd_ps(vec_103, vec_80, mem_vec_512);
												mem_vec_512 = vec_102;



												vec_104 = _mm256_fmadd_ps(vec_103, vec_82, mem_vec_513);
												mem_vec_513 = vec_104;



												vec_105 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_514);
												mem_vec_514 = vec_105;



												vec_106 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_515);
												mem_vec_515 = vec_106;
												scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_108 = _mm256_set1_ps(scal_19);


												vec_107 = _mm256_fmadd_ps(vec_108, vec_80, mem_vec_516);
												mem_vec_516 = vec_107;



												vec_109 = _mm256_fmadd_ps(vec_108, vec_82, mem_vec_517);
												mem_vec_517 = vec_109;



												vec_110 = _mm256_fmadd_ps(vec_108, vec_84, mem_vec_518);
												mem_vec_518 = vec_110;



												vec_111 = _mm256_fmadd_ps(vec_108, vec_86, mem_vec_519);
												mem_vec_519 = vec_111;
												scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
												vec_113 = _mm256_set1_ps(scal_20);


												vec_112 = _mm256_fmadd_ps(vec_113, vec_80, mem_vec_520);
												mem_vec_520 = vec_112;



												vec_114 = _mm256_fmadd_ps(vec_113, vec_82, mem_vec_521);
												mem_vec_521 = vec_114;



												vec_115 = _mm256_fmadd_ps(vec_113, vec_84, mem_vec_522);
												mem_vec_522 = vec_115;



												vec_116 = _mm256_fmadd_ps(vec_113, vec_86, mem_vec_523);
												mem_vec_523 = vec_116;
											}
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_514);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24], mem_vec_515);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_516);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_517);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_518);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_519);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_520);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_521);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_522);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_523);
								}
							}
						}
					}
