...
// T (y, 1) (136 / 136)
for (y569 = y570, y569_p_0 = 0;
	y569 < y570 + 136;
	y569 += 136, y569_p_0 += 136){
	// y = 136, x = 136, h = 1, w = 1, c = 128, f = 64
	// T (x, 1) (136 / 136)
	for (x712 = x713, x712_p_0 = 0;
		x712 < x713 + 136;
		x712 += 136, x712_p_0 += 136){
		// y = 136, x = 136, h = 1, w = 1, c = 128, f = 64
		// T (y, 17) (136 / 8)
		for (y568 = y569, y568_p_1 = y569_p_0, y568_p_0 = 0;
			y568 < y569 + 136;
			y568 += 8, y568_p_1 += 8, y568_p_0 += 8){
			// y = 8, x = 136, h = 1, w = 1, c = 128, f = 64
			// T (x, 17) (136 / 8)
			for (x711 = x712, x711_p_1 = x712_p_0, x711_p_0 = 0;
				x711 < x712 + 136;
				x711 += 8, x711_p_1 += 8, x711_p_0 += 8){
				...
				for (f = f284, fp_0 = 0;
					...
					// T (y, 2) (8 / 4)
					for (y = y568, yp_2 = y568_p_1, yp_1 = y568_p_0, yp_0 = 0;
						y < y568 + 8;
						...
						for (x710 = x711, x710_p_2 = x711_p_1, x710_p_1 = x711_p_0, x710_p_0 = 0;
							x710 < x711 + 8;
							x710 += 1, x710_p_2 += 1, x710_p_1 += 1, x710_p_0 += 1){
