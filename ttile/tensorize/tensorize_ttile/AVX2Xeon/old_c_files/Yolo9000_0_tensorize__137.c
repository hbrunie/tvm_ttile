...
[V f; U (4, f); U (4, y); U (3, h); T (3, c); Hoist_vars [c]; T (1, x);
  T (1, c); T (3, w); T (17, y); T (544, x); T (4, y); T (2, y)]
*/
IND_TYPE c, cp_0, c322_p_0, cp_1, c322, w, wp_0, x, xp_0, x386_p_0, xp_1, x386, y, yp_0, y440_p_0, y441_p_0, yp_1, y440_p_1, yp_2, y440, y441;
IND_TYPE y442 = 0;
IND_TYPE x387 = 0;
IND_TYPE h = 0;
IND_TYPE w219 = 0;
...
yp_2 = 0;
				for (w = w219, wp_0 = 0;w < w219 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c322 = c323, c322_p_0 = 0;c322 < c323 + 3;c322 += 3, c322_p_0 += 3){
						// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
						// T (x, 1) (1 / 1)
						for (x = x386, xp_1 = x386_p_0, xp_0 = 0;x < x386 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c322, cp_1 = c322_p_0, cp_0 = 0;c < c322 + 3;c += 1, cp_1 += 1, cp_0 += 1){
