...
for (f684 = f685, f684_p_0 = 0;
	...
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 1) (64 / 64)
	for (f683 = f684, f683_p_1 = f684_p_0, f683_p_0 = 0;
		f683 < f684 + 64;
		f683 += 64, f683_p_1 += 64, f683_p_0 += 64){
		// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
		// T (x, 1) (56 / 56)
		for (x535 = x536, x535_p_0 = 0;
			...
			for (y = y373, yp_0 = 0;
				...
				// T (f, 2) (64 / 32)
				for (f = f683, fp_2 = f683_p_1, fp_1 = f683_p_0, fp_0 = 0;
					f < f683 + 64;
					...
					for (c537 = c538, c537_p_0 = 0;
						...
						for (h = h254, hp_0 = 0;
							...
							for (x = x535, xp_1 = x535_p_0, xp_0 = 0;
								x < x535 + 56;
								x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_6810 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
										mem_vec_6811 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
										mem_vec_6812 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
										mem_vec_6813 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
										mem_vec_6814 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_6815 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
										mem_vec_6816 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_6817 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
										mem_vec_6818 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_6819 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
										mem_vec_6820 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_6821 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
										mem_vec_6822 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_6823 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
										mem_vec_6824 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
										mem_vec_6825 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_6810);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_6811);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_6812);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_6813);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_6814);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_6815);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_6816);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_6817);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_6818);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_6819);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_6820);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_6821);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_6822);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_6823);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_6824);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_6825);
							}
						}
					}
				}
