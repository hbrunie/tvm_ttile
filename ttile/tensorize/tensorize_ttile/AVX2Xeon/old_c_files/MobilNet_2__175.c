...
[V f; U (4, f); U (7, y); U (3, w); T (64, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, c); T (1, f); T (8, y); T (56, x); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c240_p_0, cp_1, c240, f, fp_0, f311_p_0, f312_p_0, fp_1, f311_p_1, fp_2, f311, f312, h, hp_0, x, xp_0, x241_p_0, xp_1, x241, y, yp_0;
...
for (f312 = f313, f312_p_0 = 0;
	...
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 2) (64 / 32)
	for (f311 = f312, f311_p_1 = f312_p_0, f311_p_0 = 0;
		f311 < f312 + 64;
		f311 += 32, f311_p_1 += 32, f311_p_0 += 32){
		...
		for (x241 = x242, x241_p_0 = 0;
			...
			for (y = y163, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f311, fp_2 = f311_p_1, fp_1 = f311_p_0, fp_0 = 0;
					f < f311 + 32;
