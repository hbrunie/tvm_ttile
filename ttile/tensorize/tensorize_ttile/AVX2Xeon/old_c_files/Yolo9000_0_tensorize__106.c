...
yp_2 = 0;
				for (h = h264, hp_0 = 0;h < h264 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c484 = c485, c484_p_0 = 0;c484 < c485 + 3;c484 += 3, c484_p_0 += 3){
						// y = 4, x = 68, h = 1, w = 3, c = 3, f = 32
						// T (x, 68) (68 / 1)
						for (x = x620, xp_1 = x620_p_0, xp_0 = 0;x < x620 + 68;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c484, cp_1 = c484_p_0, cp_0 = 0;c < c484 + 3;c += 1, cp_1 += 1, cp_0 += 1){
