...
yp_2 = 0;
				for (w = w199, wp_0 = 0;w < w199 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c292 = c293, c292_p_0 = 0;c292 < c293 + 3;c292 += 3, c292_p_0 += 3){
						// y = 4, x = 8, h = 3, w = 1, c = 3, f = 32
						// T (x, 8) (8 / 1)
						for (x = x356, xp_1 = x356_p_0, xp_0 = 0;x < x356 + 8;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c292, cp_1 = c292_p_0, cp_0 = 0;c < c292 + 3;c += 1, cp_1 += 1, cp_0 += 1){
