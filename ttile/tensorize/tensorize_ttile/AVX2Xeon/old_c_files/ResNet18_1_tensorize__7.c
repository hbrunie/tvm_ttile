...
[V f; U (4, f); U (4, y); T (3, c); Hoist_vars [c]; T (16, x); T (1, c);
  T (7, w); T (7, h); T (28, y); T (7, x); T (1, y); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c114_p_0, cp_1, c114, f, fp_0, f114_p_0, fp_1, f114, h, hp_0, w, wp_0, x, xp_0, x114_p_0, xp_1, x114, y, yp_0, y114_p_0, yp_1, y114;
IND_TYPE y115 = 0;
IND_TYPE x115 = 0;
IND_TYPE h76 = 0;
IND_TYPE w76 = 0;
...
__m256 mem_vec_648 ,mem_vec_649 ,mem_vec_650 ,mem_vec_651 ,mem_vec_652 ,mem_vec_653 ,mem_vec_654 ,mem_vec_655 ,mem_vec_656 ,mem_vec_657 ,mem_vec_658 ,mem_vec_659 ,mem_vec_660 ,mem_vec_661 ,mem_vec_662 ,mem_vec_663 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_3 ,vec_4 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
...
yp_1 = 0;
					for (h = h76, hp_0 = 0;h < h76 + 7;h += 1, hp_0 += 1){
						...
						for (w = w76, wp_0 = 0;w < w76 + 7;w += 1, wp_0 += 1){
							...
							// T (c, 1) (3 / 3)
							for (c114 = c115, c114_p_0 = 0;c114 < c115 + 3;c114 += 3, c114_p_0 += 3){
								// y = 4, x = 16, h = 1, w = 1, c = 3, f = 32
								// T (x, 16) (16 / 1)
								for (x = x114, xp_1 = x114_p_0, xp_0 = 0;x < x114 + 16;x += 1, xp_1 += 1, xp_0 += 1){
