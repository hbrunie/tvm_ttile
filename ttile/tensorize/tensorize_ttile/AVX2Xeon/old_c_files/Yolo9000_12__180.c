							...
							for (x = x20, xp_0 = 0;
								...
								for (h = h18, hp_0 = 0;
									...
									for (w = w18, wp_0 = 0;
										w < w18 + 3;
										w += 1, wp_0 += 1){
												mem_vec_424 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
												mem_vec_425 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
												mem_vec_426 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
												mem_vec_427 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
												mem_vec_428 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
												mem_vec_429 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
												mem_vec_430 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
												mem_vec_431 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
												mem_vec_432 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
												mem_vec_433 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
												mem_vec_434 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
												mem_vec_435 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
												mem_vec_436 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
												mem_vec_437 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
												mem_vec_438 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
												mem_vec_439 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
											...
											_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_424);
											_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_425);
											_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_426);
											_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_427);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_428);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_429);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_430);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_431);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_432);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_433);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_434);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_435);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_436);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_437);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_438);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_439);
									}
								}
							}
						}
						for (y = y26 + 12, yp_1 = y26_p_0, yp_0 = 0;
							y < y26 + 12 + 5;
							y += 5, yp_1 += 5, yp_0 += 5){
							// y = ph_y, x = 34, h = 3, w = 3, c = 16, f = 32
							// T (x, 34) (34 / 1)
