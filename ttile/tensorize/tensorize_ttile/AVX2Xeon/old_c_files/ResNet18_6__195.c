...
[V f; U (4, f); U (7, y); U (3, w); T (64, c); Hoist_vars [c]; T (3, h);
  T (28, x); T (1, c); T (1, f); T (4, y); T (1, f); T (2, c); T (4, f)]
*/
IND_TYPE c, cp_0, c569_p_0, c570_p_0, cp_1, c569_p_1, cp_2, c569, c570, f, fp_0, f570_p_0, f571_p_0, fp_1, f570_p_1, fp_2, f570, f571, h, hp_0, x, xp_0, y, yp_0;
			...
			for (y = y295, yp_0 = 0;
				...
				for (f = f570, fp_2 = f570_p_1, fp_1 = f570_p_0, fp_0 = 0;
					...
					for (c569 = c570, c569_p_1 = c570_p_0, c569_p_0 = 0;
						c569 < c570 + 64;
						c569 += 64, c569_p_1 += 64, c569_p_0 += 64){
						// y = 7, x = 28, h = 3, w = 3, c = 64, f = 32
						// T (x, 28) (28 / 1)
						for (x = x288, xp_0 = 0;
							x < x288 + 28;
							...
							for (h = h213, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 64) (64 / 1)
										for (c = c569, cp_2 = c569_p_1, cp_1 = c569_p_0, cp_0 = 0;
											c < c569 + 64;
