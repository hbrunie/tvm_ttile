...
[V f; U (4, f); U (4, y); U (3, w); T (3, c); Hoist_vars [c]; T (1, x);
  T (1, c); T (3, h); T (17, y); T (544, x); T (1, y); T (8, y)]
*/
IND_TYPE c, cp_0, c379_p_0, cp_1, c379, h, hp_0, x, xp_0, x443_p_0, xp_1, x443, y, yp_0, y516_p_0, y517_p_0, yp_1, y516_p_1, yp_2, y516, y517;
IND_TYPE y518 = 0;
IND_TYPE x444 = 0;
IND_TYPE h208 = 0;
IND_TYPE w = 0;
...
yp_2 = 0;
				for (h = h208, hp_0 = 0;h < h208 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c379 = c380, c379_p_0 = 0;c379 < c380 + 3;c379 += 3, c379_p_0 += 3){
						// y = 4, x = 1, h = 1, w = 3, c = 3, f = 32
						// T (x, 1) (1 / 1)
						for (x = x443, xp_1 = x443_p_0, xp_0 = 0;x < x443 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// y = 4, x = 1, h = 1, w = 3, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c379, cp_1 = c379_p_0, cp_0 = 0;c < c379 + 3;c += 1, cp_1 += 1, cp_0 += 1){
