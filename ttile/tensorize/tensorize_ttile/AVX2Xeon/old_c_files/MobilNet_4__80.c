...
*/
IND_TYPE c, cp_0, c237_p_0, c238_p_0, cp_1, c237_p_1, cp_2, c237, c238, f, fp_0, f238_p_0, f239_p_0, fp_1, f238_p_1, fp_2, f238, f239, w, wp_0, x, xp_0, y, yp_0;
		...
		for (f238 = f239, f238_p_1 = f239_p_0, f238_p_0 = 0;
			...
			for (y = y129, yp_0 = 0;
				...
				for (f = f238, fp_2 = f238_p_1, fp_1 = f238_p_0, fp_0 = 0;
					...
					// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
					// T (c, 1) (32 / 32)
					for (c237 = c238, c237_p_1 = c238_p_0, c237_p_0 = 0;
						c237 < c238 + 32;
						c237 += 32, c237_p_1 += 32, c237_p_0 += 32){
						// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
						// T (x, 28) (28 / 1)
						for (x = x122, xp_0 = 0;
							x < x122 + 28;
							...
							for (w = w92, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										// T (c, 32) (32 / 1)
										for (c = c237, cp_2 = c237_p_1, cp_1 = c237_p_0, cp_0 = 0;
											c < c237 + 32;
