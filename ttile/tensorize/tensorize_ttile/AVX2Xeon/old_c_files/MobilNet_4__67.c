...
[V f; U (4, f); U (7, y); U (3, w); T (64, c); Hoist_vars [c]; T (3, h);
  T (28, x); T (1, c); T (4, f); T (4, y); T (1, f); T (2, c); T (1, f)]
*/
IND_TYPE c, cp_0, c549_p_0, c550_p_0, cp_1, c549_p_1, cp_2, c549, c550, f, fp_0, f550_p_0, f551_p_0, fp_1, f550_p_1, fp_2, f550, f551, h, hp_0, x, xp_0, y, yp_0;
...
for (f551 = f552, f551_p_0 = 0;
	...
	for (c550 = c551, c550_p_0 = 0;
		...
		for (f550 = f551, f550_p_1 = f551_p_0, f550_p_0 = 0;
			f550 < f551 + 128;
			f550 += 128, f550_p_1 += 128, f550_p_0 += 128){
			// y = 28, x = 28, h = 3, w = 3, c = 64, f = 128
			// T (y, 4) (28 / 7)
			for (y = y285, yp_0 = 0;
				y < y285 + 28;
