...
[V f; U (4, f); U (4, y); U (3, h); T (3, c); Hoist_vars [c]; T (4, x);
  T (1, c); T (3, w); T (17, y); T (136, x); T (2, y); T (4, y)]
*/
IND_TYPE c, cp_0, c301_p_0, cp_1, c301, w, wp_0, x, xp_0, x365_p_0, xp_1, x365, y, yp_0, y412_p_0, y413_p_0, yp_1, y412_p_1, yp_2, y412, y413;
IND_TYPE y414 = 0;
IND_TYPE x366 = 0;
IND_TYPE h = 0;
IND_TYPE w205 = 0;
...
yp_2 = 0;
				for (w = w205, wp_0 = 0;w < w205 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c301 = c302, c301_p_0 = 0;c301 < c302 + 3;c301 += 3, c301_p_0 += 3){
						// y = 4, x = 4, h = 3, w = 1, c = 3, f = 32
						// T (x, 4) (4 / 1)
						for (x = x365, xp_1 = x365_p_0, xp_0 = 0;x < x365 + 4;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c301, cp_1 = c301_p_0, cp_0 = 0;c < c301 + 3;c += 1, cp_1 += 1, cp_0 += 1){
