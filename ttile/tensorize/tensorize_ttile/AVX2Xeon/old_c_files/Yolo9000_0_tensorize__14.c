...
yp_2 = 0;
				for (w = w209, wp_0 = 0;w < w209 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c307 = c308, c307_p_0 = 0;c307 < c308 + 3;c307 += 3, c307_p_0 += 3){
						// y = 4, x = 2, h = 3, w = 1, c = 3, f = 32
						// T (x, 2) (2 / 1)
						for (x = x371, xp_1 = x371_p_0, xp_0 = 0;x < x371 + 2;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c307, cp_1 = c307_p_0, cp_0 = 0;c < c307 + 3;c += 1, cp_1 += 1, cp_0 += 1){
