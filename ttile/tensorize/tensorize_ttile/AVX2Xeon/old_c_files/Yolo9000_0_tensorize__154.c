...
yp_2 = 0;
				for (h = h108, hp_0 = 0;h < h108 + 3;h += 1, hp_0 += 1){
					...
					for (w = w134, wp_0 = 0;w < w134 + 3;w += 1, wp_0 += 1){
						...
						// T (c, 1) (3 / 3)
						for (c196 = c197, c196_p_0 = 0;c196 < c197 + 3;c196 += 3, c196_p_0 += 3){
							// y = 4, x = 136, h = 1, w = 1, c = 3, f = 32
							// T (x, 136) (136 / 1)
							for (x = x248, xp_1 = x248_p_0, xp_0 = 0;x < x248 + 136;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c196, cp_1 = c196_p_0, cp_0 = 0;c < c196 + 3;c += 1, cp_1 += 1, cp_0 += 1){
