...
*/
IND_TYPE c, cp_0, c718_p_0, c719_p_0, cp_1, c718_p_1, cp_2, c718, c719, f, fp_0, f710_p_0, f711_p_0, fp_1, f710_p_1, fp_2, f710, f711, w, wp_0, x, xp_0, y, yp_0;
			...
			for (y = y374, yp_0 = 0;
				...
				for (f = f710, fp_2 = f710_p_1, fp_1 = f710_p_0, fp_0 = 0;
					...
					for (c718 = c719, c718_p_1 = c719_p_0, c718_p_0 = 0;
						c718 < c719 + 16;
						c718 += 16, c718_p_1 += 16, c718_p_0 += 16){
						// y = 4, x = 28, h = 3, w = 3, c = 16, f = 32
						// T (x, 28) (28 / 1)
						for (x = x364, xp_0 = 0;
							x < x364 + 28;
