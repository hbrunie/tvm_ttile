...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (2, c); T (1, f); T (34, y); T (1, x); T (4, f); T (8, x)]
*/
IND_TYPE c, cp_0, c12_p_0, cp_1, c12, f, fp_0, f12_p_0, fp_1, f12, w, wp_0, x, xp_0, x16_p_0, x17_p_0, xp_1, x16_p_1, xp_2, x16, x17, y, yp_0;
