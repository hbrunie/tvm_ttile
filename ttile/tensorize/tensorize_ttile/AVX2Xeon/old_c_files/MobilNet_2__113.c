...
[V f; U (4, f); ULambda y; U (3, h); T (64, c); Hoist_vars [c]; T (1, x);
  ...
  T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c27_p_0, cp_1, c27, f, fp_0, f30_p_0, f31_p_0, fp_1, f30_p_1, fp_2, f30, f31, w, wp_0, x, xp_0, x27_p_0, xp_1, x27, y, yp_0;
...
__m256 mem_vec_312 ,mem_vec_313 ,mem_vec_314 ,mem_vec_315 ,mem_vec_316 ,mem_vec_317 ,mem_vec_318 ,mem_vec_319 ,mem_vec_320 ,mem_vec_321 ,mem_vec_322 ,mem_vec_323 ,mem_vec_324 ,mem_vec_325 ,mem_vec_326 ,mem_vec_327 ,mem_vec_328 ,mem_vec_329 ,mem_vec_330 ,mem_vec_331 ,mem_vec_332 ,mem_vec_333 ,mem_vec_334 ,mem_vec_335 ,mem_vec_336 ,mem_vec_337 ,mem_vec_338 ,mem_vec_339 ,mem_vec_340 ,mem_vec_341 ,mem_vec_342 ,mem_vec_343 ,mem_vec_344 ,mem_vec_345 ,mem_vec_346 ,mem_vec_347 ,mem_vec_348 ,mem_vec_349 ,mem_vec_350 ,mem_vec_351 ,mem_vec_352 ,mem_vec_353 ,mem_vec_354 ,mem_vec_355 ,vec_0 ,vec_1 ,vec_10 ,vec_100 ,vec_101 ,vec_102 ,vec_103 ,vec_104 ,vec_105 ,vec_106 ,vec_107 ,vec_108 ,vec_109 ,vec_11 ,vec_110 ,vec_111 ,vec_112 ,vec_113 ,vec_114 ,vec_115 ,vec_116 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_81 ,vec_82 ,vec_83 ,vec_84 ,vec_85 ,vec_86 ,vec_87 ,vec_88 ,vec_89 ,vec_9 ,vec_90 ,vec_91 ,vec_92 ,vec_93 ,vec_94 ,vec_95 ,vec_96 ,vec_97 ,vec_98 ,vec_99;
...
for (f31 = f32, f31_p_0 = 0;
	...
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 2) (64 / 32)
	for (f30 = f31, f30_p_1 = f31_p_0, f30_p_0 = 0;
		f30 < f31 + 64;
		f30 += 32, f30_p_1 += 32, f30_p_0 += 32){
		...
		for (x27 = x28, x27_p_0 = 0;
			...
			x27 += 1, x27_p_0 += 1){
				for (y = y21, yp_0 = 0;
					...
					// T (f, 1) (32 / 32)
					for (f = f30, fp_2 = f30_p_1, fp_1 = f30_p_0, fp_0 = 0;
						f < f30 + 32;
								...
								for (x = x27, xp_1 = x27_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c27, cp_1 = c27_p_0, cp_0 = 0;
												...
												vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_312);
												mem_vec_312 = vec_24;

												vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_313);
												mem_vec_313 = vec_27;

												vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_314);
												mem_vec_314 = vec_29;

												vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

												vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_315);
												mem_vec_315 = vec_31;
												scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
												vec_34 = _mm256_set1_ps(scal_5);


												vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_316);
												mem_vec_316 = vec_33;



												vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_317);
												mem_vec_317 = vec_35;



												vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_318);
												mem_vec_318 = vec_36;



												vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_319);
												mem_vec_319 = vec_37;
												scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
												vec_39 = _mm256_set1_ps(scal_6);


												vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_320);
												mem_vec_320 = vec_38;



												vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_321);
												mem_vec_321 = vec_40;



												vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_322);
												mem_vec_322 = vec_41;



												vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_323);
												mem_vec_323 = vec_42;
												scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
												vec_44 = _mm256_set1_ps(scal_7);


												vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_324);
												mem_vec_324 = vec_43;



												vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_325);
												mem_vec_325 = vec_45;



												vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_326);
												mem_vec_326 = vec_46;



												vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_327);
												mem_vec_327 = vec_47;
												scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
												vec_49 = _mm256_set1_ps(scal_8);
												vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_312);
												mem_vec_312 = vec_48;

												vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_313);
												mem_vec_313 = vec_51;

												vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_314);
												mem_vec_314 = vec_53;

												vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

												vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_315);
												mem_vec_315 = vec_55;
												scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
												vec_58 = _mm256_set1_ps(scal_9);


												vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_316);
												mem_vec_316 = vec_57;



												vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_317);
												mem_vec_317 = vec_59;



												vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_318);
												mem_vec_318 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_319);
												mem_vec_319 = vec_61;
												scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
												vec_63 = _mm256_set1_ps(scal_10);


												vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_320);
												mem_vec_320 = vec_62;



												vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_321);
												mem_vec_321 = vec_64;



												vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_322);
												mem_vec_322 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_323);
												mem_vec_323 = vec_66;
												scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
												vec_68 = _mm256_set1_ps(scal_11);


												vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_324);
												mem_vec_324 = vec_67;



												vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_325);
												mem_vec_325 = vec_69;



												vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_326);
												mem_vec_326 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_327);
												mem_vec_327 = vec_71;
											}
							...
							for (w = w18, wp_0 = 0;
								...
								for (x = x27, xp_1 = x27_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_350 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_351 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
											mem_vec_352 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_353 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
											mem_vec_354 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_355 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 64, f = 32
											// T (c, 64) (64 / 1)
											for (c = c27, cp_1 = c27_p_0, cp_0 = 0;
												c < c27 + 64;
												...
												vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_348);
												mem_vec_348 = vec_29;



												vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_349);
												mem_vec_349 = vec_31;



												vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_350);
												mem_vec_350 = vec_32;



												vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_351);
												mem_vec_351 = vec_33;
												scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h) + c];
												vec_35 = _mm256_set1_ps(scal_6);


												vec_34 = _mm256_fmadd_ps(vec_35, vec_2, mem_vec_352);
												mem_vec_352 = vec_34;



												vec_36 = _mm256_fmadd_ps(vec_35, vec_4, mem_vec_353);
												mem_vec_353 = vec_36;



												vec_37 = _mm256_fmadd_ps(vec_35, vec_6, mem_vec_354);
												mem_vec_354 = vec_37;



												vec_38 = _mm256_fmadd_ps(vec_35, vec_8, mem_vec_355);
												mem_vec_355 = vec_38;
												scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 1) + c];
												vec_40 = _mm256_set1_ps(scal_7);
												vec_41 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

												vec_39 = _mm256_fmadd_ps(vec_40, vec_41, mem_vec_328);
												mem_vec_328 = vec_39;

												vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_42 = _mm256_fmadd_ps(vec_40, vec_43, mem_vec_329);
												mem_vec_329 = vec_42;

												vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_44 = _mm256_fmadd_ps(vec_40, vec_45, mem_vec_330);
												mem_vec_330 = vec_44;

												vec_47 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

												vec_46 = _mm256_fmadd_ps(vec_40, vec_47, mem_vec_331);
												mem_vec_331 = vec_46;
												scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
												vec_49 = _mm256_set1_ps(scal_8);


												vec_48 = _mm256_fmadd_ps(vec_49, vec_41, mem_vec_332);
												mem_vec_332 = vec_48;



												vec_50 = _mm256_fmadd_ps(vec_49, vec_43, mem_vec_333);
												mem_vec_333 = vec_50;



												vec_51 = _mm256_fmadd_ps(vec_49, vec_45, mem_vec_334);
												mem_vec_334 = vec_51;



												vec_52 = _mm256_fmadd_ps(vec_49, vec_47, mem_vec_335);
												mem_vec_335 = vec_52;
												scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
												vec_54 = _mm256_set1_ps(scal_9);


												vec_53 = _mm256_fmadd_ps(vec_54, vec_41, mem_vec_336);
												mem_vec_336 = vec_53;



												vec_55 = _mm256_fmadd_ps(vec_54, vec_43, mem_vec_337);
												mem_vec_337 = vec_55;



												vec_56 = _mm256_fmadd_ps(vec_54, vec_45, mem_vec_338);
												mem_vec_338 = vec_56;



												vec_57 = _mm256_fmadd_ps(vec_54, vec_47, mem_vec_339);
												mem_vec_339 = vec_57;
												scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
												vec_59 = _mm256_set1_ps(scal_10);


												vec_58 = _mm256_fmadd_ps(vec_59, vec_41, mem_vec_340);
												mem_vec_340 = vec_58;



												vec_60 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_341);
												mem_vec_341 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_342);
												mem_vec_342 = vec_61;



												vec_62 = _mm256_fmadd_ps(vec_59, vec_47, mem_vec_343);
												mem_vec_343 = vec_62;
												scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
												vec_64 = _mm256_set1_ps(scal_11);


												vec_63 = _mm256_fmadd_ps(vec_64, vec_41, mem_vec_344);
												mem_vec_344 = vec_63;



												vec_65 = _mm256_fmadd_ps(vec_64, vec_43, mem_vec_345);
												mem_vec_345 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_64, vec_45, mem_vec_346);
												mem_vec_346 = vec_66;



												vec_67 = _mm256_fmadd_ps(vec_64, vec_47, mem_vec_347);
												mem_vec_347 = vec_67;
												scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 1) + c];
												vec_69 = _mm256_set1_ps(scal_12);


												vec_68 = _mm256_fmadd_ps(vec_69, vec_41, mem_vec_348);
												mem_vec_348 = vec_68;



												vec_70 = _mm256_fmadd_ps(vec_69, vec_43, mem_vec_349);
												mem_vec_349 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_69, vec_45, mem_vec_350);
												mem_vec_350 = vec_71;



												vec_72 = _mm256_fmadd_ps(vec_69, vec_47, mem_vec_351);
												mem_vec_351 = vec_72;
												scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 1) + c];
												vec_74 = _mm256_set1_ps(scal_13);


												vec_73 = _mm256_fmadd_ps(vec_74, vec_41, mem_vec_352);
												mem_vec_352 = vec_73;



												vec_75 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_353);
												mem_vec_353 = vec_75;



												vec_76 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_354);
												mem_vec_354 = vec_76;



												vec_77 = _mm256_fmadd_ps(vec_74, vec_47, mem_vec_355);
												mem_vec_355 = vec_77;
												scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
												vec_79 = _mm256_set1_ps(scal_14);
												vec_80 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_78 = _mm256_fmadd_ps(vec_79, vec_80, mem_vec_328);
												mem_vec_328 = vec_78;

												vec_82 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_81 = _mm256_fmadd_ps(vec_79, vec_82, mem_vec_329);
												mem_vec_329 = vec_81;

												vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_83 = _mm256_fmadd_ps(vec_79, vec_84, mem_vec_330);
												mem_vec_330 = vec_83;

												vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

												vec_85 = _mm256_fmadd_ps(vec_79, vec_86, mem_vec_331);
												mem_vec_331 = vec_85;
												scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
												vec_88 = _mm256_set1_ps(scal_15);


												vec_87 = _mm256_fmadd_ps(vec_88, vec_80, mem_vec_332);
												mem_vec_332 = vec_87;



												vec_89 = _mm256_fmadd_ps(vec_88, vec_82, mem_vec_333);
												mem_vec_333 = vec_89;



												vec_90 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_334);
												mem_vec_334 = vec_90;



												vec_91 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_335);
												mem_vec_335 = vec_91;
												scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
												vec_93 = _mm256_set1_ps(scal_16);


												vec_92 = _mm256_fmadd_ps(vec_93, vec_80, mem_vec_336);
												mem_vec_336 = vec_92;



												vec_94 = _mm256_fmadd_ps(vec_93, vec_82, mem_vec_337);
												mem_vec_337 = vec_94;



												vec_95 = _mm256_fmadd_ps(vec_93, vec_84, mem_vec_338);
												mem_vec_338 = vec_95;



												vec_96 = _mm256_fmadd_ps(vec_93, vec_86, mem_vec_339);
												mem_vec_339 = vec_96;
												scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
												vec_98 = _mm256_set1_ps(scal_17);


												vec_97 = _mm256_fmadd_ps(vec_98, vec_80, mem_vec_340);
												mem_vec_340 = vec_97;



												vec_99 = _mm256_fmadd_ps(vec_98, vec_82, mem_vec_341);
												mem_vec_341 = vec_99;



												vec_100 = _mm256_fmadd_ps(vec_98, vec_84, mem_vec_342);
												mem_vec_342 = vec_100;



												vec_101 = _mm256_fmadd_ps(vec_98, vec_86, mem_vec_343);
												mem_vec_343 = vec_101;
												scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
												vec_103 = _mm256_set1_ps(scal_18);


												vec_102 = _mm256_fmadd_ps(vec_103, vec_80, mem_vec_344);
												mem_vec_344 = vec_102;



												vec_104 = _mm256_fmadd_ps(vec_103, vec_82, mem_vec_345);
												mem_vec_345 = vec_104;



												vec_105 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_346);
												mem_vec_346 = vec_105;



												vec_106 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_347);
												mem_vec_347 = vec_106;
												scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 2) + c];
												vec_108 = _mm256_set1_ps(scal_19);


												vec_107 = _mm256_fmadd_ps(vec_108, vec_80, mem_vec_348);
												mem_vec_348 = vec_107;



												vec_109 = _mm256_fmadd_ps(vec_108, vec_82, mem_vec_349);
												mem_vec_349 = vec_109;



												vec_110 = _mm256_fmadd_ps(vec_108, vec_84, mem_vec_350);
												mem_vec_350 = vec_110;



												vec_111 = _mm256_fmadd_ps(vec_108, vec_86, mem_vec_351);
												mem_vec_351 = vec_111;
												scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 2) + c];
												vec_113 = _mm256_set1_ps(scal_20);


												vec_112 = _mm256_fmadd_ps(vec_113, vec_80, mem_vec_352);
												mem_vec_352 = vec_112;



												vec_114 = _mm256_fmadd_ps(vec_113, vec_82, mem_vec_353);
												mem_vec_353 = vec_114;



												vec_115 = _mm256_fmadd_ps(vec_113, vec_84, mem_vec_354);
												mem_vec_354 = vec_115;



												vec_116 = _mm256_fmadd_ps(vec_113, vec_86, mem_vec_355);
												mem_vec_355 = vec_116;
											}
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_350);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_351);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_352);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_353);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_354);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_355);
								}
							}
						}
					}
