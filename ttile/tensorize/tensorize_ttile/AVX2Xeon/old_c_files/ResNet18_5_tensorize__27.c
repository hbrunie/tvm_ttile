...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (14, x); T (4, f);
  T (1, x); T (7, y); T (2, x); T (1, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x120_p_0, x121_p_0, xp_1, x120_p_1, xp_2, x120, x121, y, yp_0, y90_p_0, yp_1, y90;
IND_TYPE y91 = 0;
IND_TYPE x122 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
fp_0 = 0;
					for (x = x120, xp_2 = x120_p_1, xp_1 = x120_p_0, xp_0 = 0;x < x120 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 64) (64 / 1)
								for (c = c60, cp_0 = 0;c < c60 + 64;c += 1, cp_0 += 1){
