...
__m256 mem_vec_936 ,mem_vec_937 ,mem_vec_938 ,mem_vec_939 ,mem_vec_940 ,mem_vec_941 ,mem_vec_942 ,mem_vec_943 ,mem_vec_944 ,mem_vec_945 ,mem_vec_946 ,mem_vec_947 ,mem_vec_948 ,mem_vec_949 ,mem_vec_950 ,mem_vec_951 ,mem_vec_952 ,mem_vec_953 ,mem_vec_954 ,mem_vec_955 ,mem_vec_956 ,mem_vec_957 ,mem_vec_958 ,mem_vec_959 ,mem_vec_960 ,mem_vec_961 ,mem_vec_962 ,mem_vec_963 ,vec_0 ,vec_1 ,vec_10 ,vec_100 ,vec_101 ,vec_102 ,vec_103 ,vec_104 ,vec_105 ,vec_106 ,vec_107 ,vec_108 ,vec_109 ,vec_11 ,vec_110 ,vec_111 ,vec_112 ,vec_113 ,vec_114 ,vec_115 ,vec_116 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_81 ,vec_82 ,vec_83 ,vec_84 ,vec_85 ,vec_86 ,vec_87 ,vec_88 ,vec_89 ,vec_9 ,vec_90 ,vec_91 ,vec_92 ,vec_93 ,vec_94 ,vec_95 ,vec_96 ,vec_97 ,vec_98 ,vec_99;
					...
					for (x = x72, xp_0 = 0;
						...
						for (h = h54, hp_0 = 0;
							...
							h += 1, hp_0 += 1){
									...
									mem_vec_962 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
									mem_vec_963 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
									...
									for (c = c108, cp_1 = c108_p_0, cp_0 = 0;
										...
										vec_34 = _mm256_fmadd_ps(vec_35, vec_2, mem_vec_960);
										mem_vec_960 = vec_34;



										vec_36 = _mm256_fmadd_ps(vec_35, vec_4, mem_vec_961);
										mem_vec_961 = vec_36;



										vec_37 = _mm256_fmadd_ps(vec_35, vec_6, mem_vec_962);
										mem_vec_962 = vec_37;



										vec_38 = _mm256_fmadd_ps(vec_35, vec_8, mem_vec_963);
										mem_vec_963 = vec_38;
										scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * y + h) + c];
										vec_40 = _mm256_set1_ps(scal_7);
										vec_41 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

										vec_39 = _mm256_fmadd_ps(vec_40, vec_41, mem_vec_936);
										mem_vec_936 = vec_39;

										vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

										vec_42 = _mm256_fmadd_ps(vec_40, vec_43, mem_vec_937);
										mem_vec_937 = vec_42;

										vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_44 = _mm256_fmadd_ps(vec_40, vec_45, mem_vec_938);
										mem_vec_938 = vec_44;

										vec_47 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

										vec_46 = _mm256_fmadd_ps(vec_40, vec_47, mem_vec_939);
										mem_vec_939 = vec_46;
										scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
										vec_49 = _mm256_set1_ps(scal_8);


										vec_48 = _mm256_fmadd_ps(vec_49, vec_41, mem_vec_940);
										mem_vec_940 = vec_48;



										vec_50 = _mm256_fmadd_ps(vec_49, vec_43, mem_vec_941);
										mem_vec_941 = vec_50;



										vec_51 = _mm256_fmadd_ps(vec_49, vec_45, mem_vec_942);
										mem_vec_942 = vec_51;



										vec_52 = _mm256_fmadd_ps(vec_49, vec_47, mem_vec_943);
										mem_vec_943 = vec_52;
										scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
										vec_54 = _mm256_set1_ps(scal_9);


										vec_53 = _mm256_fmadd_ps(vec_54, vec_41, mem_vec_944);
										mem_vec_944 = vec_53;



										vec_55 = _mm256_fmadd_ps(vec_54, vec_43, mem_vec_945);
										mem_vec_945 = vec_55;



										vec_56 = _mm256_fmadd_ps(vec_54, vec_45, mem_vec_946);
										mem_vec_946 = vec_56;



										vec_57 = _mm256_fmadd_ps(vec_54, vec_47, mem_vec_947);
										mem_vec_947 = vec_57;
										scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
										vec_59 = _mm256_set1_ps(scal_10);


										vec_58 = _mm256_fmadd_ps(vec_59, vec_41, mem_vec_948);
										mem_vec_948 = vec_58;



										vec_60 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_949);
										mem_vec_949 = vec_60;



										vec_61 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_950);
										mem_vec_950 = vec_61;



										vec_62 = _mm256_fmadd_ps(vec_59, vec_47, mem_vec_951);
										mem_vec_951 = vec_62;
										scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
										vec_64 = _mm256_set1_ps(scal_11);


										vec_63 = _mm256_fmadd_ps(vec_64, vec_41, mem_vec_952);
										mem_vec_952 = vec_63;



										vec_65 = _mm256_fmadd_ps(vec_64, vec_43, mem_vec_953);
										mem_vec_953 = vec_65;



										vec_66 = _mm256_fmadd_ps(vec_64, vec_45, mem_vec_954);
										mem_vec_954 = vec_66;



										vec_67 = _mm256_fmadd_ps(vec_64, vec_47, mem_vec_955);
										mem_vec_955 = vec_67;
										scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
										vec_69 = _mm256_set1_ps(scal_12);


										vec_68 = _mm256_fmadd_ps(vec_69, vec_41, mem_vec_956);
										mem_vec_956 = vec_68;



										vec_70 = _mm256_fmadd_ps(vec_69, vec_43, mem_vec_957);
										mem_vec_957 = vec_70;



										vec_71 = _mm256_fmadd_ps(vec_69, vec_45, mem_vec_958);
										mem_vec_958 = vec_71;



										vec_72 = _mm256_fmadd_ps(vec_69, vec_47, mem_vec_959);
										mem_vec_959 = vec_72;
										scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h) + c];
										vec_74 = _mm256_set1_ps(scal_13);


										vec_73 = _mm256_fmadd_ps(vec_74, vec_41, mem_vec_960);
										mem_vec_960 = vec_73;



										vec_75 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_961);
										mem_vec_961 = vec_75;



										vec_76 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_962);
										mem_vec_962 = vec_76;



										vec_77 = _mm256_fmadd_ps(vec_74, vec_47, mem_vec_963);
										mem_vec_963 = vec_77;
										scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
										vec_79 = _mm256_set1_ps(scal_14);
										vec_80 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_78 = _mm256_fmadd_ps(vec_79, vec_80, mem_vec_936);
										mem_vec_936 = vec_78;

										vec_82 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

										vec_81 = _mm256_fmadd_ps(vec_79, vec_82, mem_vec_937);
										mem_vec_937 = vec_81;

										vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_83 = _mm256_fmadd_ps(vec_79, vec_84, mem_vec_938);
										mem_vec_938 = vec_83;

										vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

										vec_85 = _mm256_fmadd_ps(vec_79, vec_86, mem_vec_939);
										mem_vec_939 = vec_85;
										scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
										vec_88 = _mm256_set1_ps(scal_15);


										vec_87 = _mm256_fmadd_ps(vec_88, vec_80, mem_vec_940);
										mem_vec_940 = vec_87;



										vec_89 = _mm256_fmadd_ps(vec_88, vec_82, mem_vec_941);
										mem_vec_941 = vec_89;



										vec_90 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_942);
										mem_vec_942 = vec_90;



										vec_91 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_943);
										mem_vec_943 = vec_91;
										scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
										vec_93 = _mm256_set1_ps(scal_16);


										vec_92 = _mm256_fmadd_ps(vec_93, vec_80, mem_vec_944);
										mem_vec_944 = vec_92;



										vec_94 = _mm256_fmadd_ps(vec_93, vec_82, mem_vec_945);
										mem_vec_945 = vec_94;



										vec_95 = _mm256_fmadd_ps(vec_93, vec_84, mem_vec_946);
										mem_vec_946 = vec_95;



										vec_96 = _mm256_fmadd_ps(vec_93, vec_86, mem_vec_947);
										mem_vec_947 = vec_96;
										scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
										vec_98 = _mm256_set1_ps(scal_17);


										vec_97 = _mm256_fmadd_ps(vec_98, vec_80, mem_vec_948);
										mem_vec_948 = vec_97;



										vec_99 = _mm256_fmadd_ps(vec_98, vec_82, mem_vec_949);
										mem_vec_949 = vec_99;



										vec_100 = _mm256_fmadd_ps(vec_98, vec_84, mem_vec_950);
										mem_vec_950 = vec_100;



										vec_101 = _mm256_fmadd_ps(vec_98, vec_86, mem_vec_951);
										mem_vec_951 = vec_101;
										scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
										vec_103 = _mm256_set1_ps(scal_18);


										vec_102 = _mm256_fmadd_ps(vec_103, vec_80, mem_vec_952);
										mem_vec_952 = vec_102;



										vec_104 = _mm256_fmadd_ps(vec_103, vec_82, mem_vec_953);
										mem_vec_953 = vec_104;



										vec_105 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_954);
										mem_vec_954 = vec_105;



										vec_106 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_955);
										mem_vec_955 = vec_106;
										scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
										vec_108 = _mm256_set1_ps(scal_19);


										vec_107 = _mm256_fmadd_ps(vec_108, vec_80, mem_vec_956);
										mem_vec_956 = vec_107;



										vec_109 = _mm256_fmadd_ps(vec_108, vec_82, mem_vec_957);
										mem_vec_957 = vec_109;



										vec_110 = _mm256_fmadd_ps(vec_108, vec_84, mem_vec_958);
										mem_vec_958 = vec_110;



										vec_111 = _mm256_fmadd_ps(vec_108, vec_86, mem_vec_959);
										mem_vec_959 = vec_111;
										scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
										vec_113 = _mm256_set1_ps(scal_20);


										vec_112 = _mm256_fmadd_ps(vec_113, vec_80, mem_vec_960);
										mem_vec_960 = vec_112;



										vec_114 = _mm256_fmadd_ps(vec_113, vec_82, mem_vec_961);
										mem_vec_961 = vec_114;



										vec_115 = _mm256_fmadd_ps(vec_113, vec_84, mem_vec_962);
										mem_vec_962 = vec_115;



										vec_116 = _mm256_fmadd_ps(vec_113, vec_86, mem_vec_963);
										mem_vec_963 = vec_116;
									}
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_962);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_963);
						}
					}
				}
			}
