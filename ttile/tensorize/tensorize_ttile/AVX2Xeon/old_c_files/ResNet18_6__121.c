...
*/
IND_TYPE c, cp_0, c249_p_0, c250_p_0, cp_1, c249_p_1, cp_2, c249, c250, f, fp_0, f250_p_0, f251_p_0, fp_1, f250_p_1, fp_2, f250, f251, w, wp_0, x, xp_0, y, yp_0;
...
for (f251 = f252, f251_p_0 = 0;
	...
	for (c250 = c251, c250_p_0 = 0;
		...
		for (f250 = f251, f250_p_1 = f251_p_0, f250_p_0 = 0;
			f250 < f251 + 128;
			f250 += 32, f250_p_1 += 32, f250_p_0 += 32){
			...
			for (y = y135, yp_0 = 0;
				...
				for (f = f250, fp_2 = f250_p_1, fp_1 = f250_p_0, fp_0 = 0;
					...
					for (c249 = c250, c249_p_1 = c250_p_0, c249_p_0 = 0;
						c249 < c250 + 32;
						c249 += 16, c249_p_1 += 16, c249_p_0 += 16){
						...
						for (x = x128, xp_0 = 0;
							...
							for (w = w98, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c249, cp_2 = c249_p_1, cp_1 = c249_p_0, cp_0 = 0;
											c < c249 + 16;
