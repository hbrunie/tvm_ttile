...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (3, w); T (3, h);
  T (28, x); T (7, y); T (1, f); T (4, c); T (8, f); T (1, y); T (1, f)]
*/
IND_TYPE c, cp_0, c195_p_0, cp_1, c195, f, fp_0, f190_p_0, f191_p_0, fp_1, f190_p_1, fp_2, f190, f191, h, hp_0, w, wp_0, x, xp_0, y, yp_0, y99_p_0, yp_1, y99;
IND_TYPE y100 = 0;
IND_TYPE x98 = 0;
IND_TYPE h77 = 0;
IND_TYPE w71 = 0;
