			...
			for (f = f272, fp_0 = 0;
				...
				f += 16, fp_0 += 16){
					for (y = y144, yp_1 = y144_p_0, yp_0 = 0;
						...
						// T (c, 1) (64 / 64)
						for (c218 = c219, c218_p_2 = c219_p_1, c218_p_1 = c219_p_0, c218_p_0 = 0;
							c218 < c219 + 64;
							c218 += 64, c218_p_2 += 64, c218_p_1 += 64, c218_p_0 += 64){
							// y = ph_y, x = 17, h = 3, w = 3, c = 64, f = 16
							// T (x, 17) (17 / 1)
							for (x = x140, xp_0 = 0;
								x < x140 + 17;
								...
								for (w = w118, wp_0 = 0;
									...
									w += 1, wp_0 += 1){
											...
											// T (c, 64) (64 / 1)
											for (c = c218, cp_3 = c218_p_2, cp_2 = c218_p_1, cp_1 = c218_p_0, cp_0 = 0;
												c < c218 + 64;
					...
					for (y = y144 + 8, yp_1 = y144_p_0, yp_0 = 0;
						y < y144 + 8 + 9;
						y += 9, yp_1 += 9, yp_0 += 9){
						// y = ph_y, x = 17, h = 3, w = 3, c = 64, f = 16
						// T (c, 1) (64 / 64)
