...
/*
[V f; U (4, f); U (4, y); T (4, c); Hoist_vars [c]; T (68, x); T (64, c);
  T (4, f); T (1, x); T (17, y)]
*/
IND_TYPE c, cp_0, c39_p_0, cp_1, c39, f, fp_0, x, xp_0, x39_p_0, xp_1, x39, y, yp_0;
IND_TYPE y26 = 0;
IND_TYPE x40 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c39 = 0;
c39_p_0 = 0;
				for (x = x39, xp_1 = x39_p_0, xp_0 = 0;x < x39 + 68;x += 1, xp_1 += 1, xp_0 += 1){
