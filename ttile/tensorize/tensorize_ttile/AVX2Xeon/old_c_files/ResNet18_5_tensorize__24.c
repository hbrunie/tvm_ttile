...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (2, x); T (4, f);
  T (14, x); T (7, y); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x32_p_0, x33_p_0, xp_1, x32_p_1, xp_2, x32, x33, y, yp_0, y24_p_0, yp_1, y24;
IND_TYPE y25 = 0;
IND_TYPE x34 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
fp_0 = 0;
					for (x = x32, xp_2 = x32_p_1, xp_1 = x32_p_0, xp_0 = 0;x < x32 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 64) (64 / 1)
								for (c = c16, cp_0 = 0;c < c16 + 64;c += 1, cp_0 += 1){
