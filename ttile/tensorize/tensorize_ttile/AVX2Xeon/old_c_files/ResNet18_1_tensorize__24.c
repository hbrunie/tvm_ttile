...
[V f; U (4, f); U (4, y); T (3, c); Hoist_vars [c]; T (4, x); T (1, c);
  T (7, w); T (7, h); T (14, y); T (28, x); T (2, y); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c54_p_0, cp_1, c54, f, fp_0, f54_p_0, fp_1, f54, h, hp_0, w, wp_0, x, xp_0, x54_p_0, xp_1, x54, y, yp_0, y54_p_0, yp_1, y54;
IND_TYPE y55 = 0;
IND_TYPE x55 = 0;
IND_TYPE h36 = 0;
IND_TYPE w36 = 0;
...
yp_1 = 0;
					for (h = h36, hp_0 = 0;h < h36 + 7;h += 1, hp_0 += 1){
						...
						for (w = w36, wp_0 = 0;w < w36 + 7;w += 1, wp_0 += 1){
							...
							// T (c, 1) (3 / 3)
							for (c54 = c55, c54_p_0 = 0;c54 < c55 + 3;c54 += 3, c54_p_0 += 3){
								// y = 4, x = 4, h = 1, w = 1, c = 3, f = 32
								// T (x, 4) (4 / 1)
								for (x = x54, xp_1 = x54_p_0, xp_0 = 0;x < x54 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 3) (3 / 1)
											for (c = c54, cp_1 = c54_p_0, cp_0 = 0;c < c54 + 3;c += 1, cp_1 += 1, cp_0 += 1){
