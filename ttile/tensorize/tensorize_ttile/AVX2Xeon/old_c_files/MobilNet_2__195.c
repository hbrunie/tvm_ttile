...
for (f470 = f471, f470_p_0 = 0;
	...
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 2) (64 / 32)
	for (f469 = f470, f469_p_1 = f470_p_0, f469_p_0 = 0;
		f469 < f470 + 64;
		f469 += 32, f469_p_1 += 32, f469_p_0 += 32){
		...
		for (x364 = x365, x364_p_0 = 0;
			...
			for (y = y248, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f469, fp_2 = f469_p_1, fp_1 = f469_p_0, fp_0 = 0;
					f < f469 + 32;
						...
						for (w = w192, wp_0 = 0;
							...
							for (x = x364, xp_1 = x364_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4860 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_4861 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
										mem_vec_4862 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_4863 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
										...
										mem_vec_4868 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_4869 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
										mem_vec_4870 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
										mem_vec_4871 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_4860);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_4861);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_4862);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_4863);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_4868);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_4869);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_4870);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_4871);
							}
						}
					}
				}
