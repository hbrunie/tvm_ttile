		...
		for (f = f676, fp_1 = f676_p_0, fp_0 = 0;
			...
			for (y = y355, yp_0 = 0;
				...
				for (c671 = c672, c671_p_1 = c672_p_0, c671_p_0 = 0;
					c671 < c672 + 128;
					c671 += 16, c671_p_1 += 16, c671_p_0 += 16){
					...
					for (x = x342, xp_0 = 0;
						...
						for (h = h267, hp_0 = 0;
							...
							h += 1, hp_0 += 1){
									...
									mem_vec_4308 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
									mem_vec_4309 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 40]);
									mem_vec_4310 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									mem_vec_4311 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 56]);
									...
									mem_vec_4316 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
									mem_vec_4317 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 40]);
									mem_vec_4318 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
									mem_vec_4319 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 56]);
									...
									mem_vec_4324 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32]);
									mem_vec_4325 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 40]);
									mem_vec_4326 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48]);
									mem_vec_4327 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 56]);
									...
									mem_vec_4332 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32]);
									mem_vec_4333 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 40]);
									mem_vec_4334 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48]);
									mem_vec_4335 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 56]);
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_4308);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 40], mem_vec_4309);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_4310);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 56], mem_vec_4311);
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_4316);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 40], mem_vec_4317);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_4318);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 56], mem_vec_4319);
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32], mem_vec_4324);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 40], mem_vec_4325);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48], mem_vec_4326);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 56], mem_vec_4327);
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32], mem_vec_4332);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 40], mem_vec_4333);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48], mem_vec_4334);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 56], mem_vec_4335);
						}
					}
				}
			}
