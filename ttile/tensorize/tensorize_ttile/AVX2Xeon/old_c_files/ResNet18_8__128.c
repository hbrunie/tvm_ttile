...
*/
IND_TYPE c, cp_0, c275_p_0, c276_p_0, cp_1, c275_p_1, cp_2, c275, c276, f, fp_0, f274_p_0, f275_p_0, fp_1, f274_p_1, fp_2, f274, f275, h, hp_0, x, xp_0, y, yp_0;
		...
		for (f274 = f275, f274_p_1 = f275_p_0, f274_p_0 = 0;
			...
			for (y = y145, yp_0 = 0;
				...
				for (f = f274, fp_2 = f274_p_1, fp_1 = f274_p_0, fp_0 = 0;
					...
					// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
					// T (c, 4) (32 / 8)
					for (c275 = c276, c275_p_1 = c276_p_0, c275_p_0 = 0;
						c275 < c276 + 32;
						c275 += 8, c275_p_1 += 8, c275_p_0 += 8){
						...
						for (x = x140, xp_0 = 0;
							...
							for (h = h107, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 8) (8 / 1)
										for (c = c275, cp_2 = c275_p_1, cp_1 = c275_p_0, cp_0 = 0;
											c < c275 + 8;
