...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (2, f); T (32, c); T (14, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c202_p_0, cp_1, c202, f, fp_0, f176_p_0, f177_p_0, fp_1, f176_p_1, fp_2, f176, f177, w, wp_0, x, xp_0, x232_p_0, x233_p_0, xp_1, x232_p_1, xp_2, x232, x233, y, yp_0;
IND_TYPE y116 = 0;
IND_TYPE x234 = 0;
IND_TYPE h = 0;
IND_TYPE w116 = 0;
...
fp_2 = 0;
							for (w = w116, wp_0 = 0;w < w116 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x232, xp_2 = x232_p_1, xp_1 = x232_p_0, xp_0 = 0;x < x232 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 4) (4 / 1)
											for (c = c202, cp_1 = c202_p_0, cp_0 = 0;c < c202 + 4;c += 1, cp_1 += 1, cp_0 += 1){
