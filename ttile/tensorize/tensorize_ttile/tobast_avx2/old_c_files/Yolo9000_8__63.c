...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (34, x);
  T (3, h); T (8, f); T (2, x); T (17, y); T (1, f); T (16, c); T (1, x);
  T (1, f)]
*/
		...
		for (c438 = c439, c438_p_0 = 0;
			...
			for (f584 = f585, f584_p_1 = f585_p_0, f584_p_0 = 0;
				...
				for (y = y292, yp_0 = 0;
					y < y292 + 68;
					y += 4, yp_0 += 4){
					// y = 4, x = 68, h = 3, w = 3, c = 8, f = 256
					// T (x, 2) (68 / 34)
					for (x584 = x585, x584_p_1 = x585_p_0, x584_p_0 = 0;
						x584 < x585 + 68;
						x584 += 34, x584_p_1 += 34, x584_p_0 += 34){
						// y = 4, x = 34, h = 3, w = 3, c = 8, f = 256
						// T (f, 8) (256 / 32)
						for (f = f584, fp_2 = f584_p_1, fp_1 = f584_p_0, fp_0 = 0;
							f < f584 + 256;
							f += 32, fp_2 += 32, fp_1 += 32, fp_0 += 32){
							// y = 4, x = 34, h = 3, w = 3, c = 8, f = 32
							// T (h, 3) (3 / 1)
							for (h = h224, hp_0 = 0;
								h < h224 + 3;
								h += 1, hp_0 += 1){
								// y = 4, x = 34, h = 1, w = 3, c = 8, f = 32
								// T (x, 34) (34 / 1)
