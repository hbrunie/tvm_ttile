...
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (1, f); T (2, x); T (7, y); T (1, x); T (4, f); T (64, c);
  T (1, x)]
*/
IND_TYPE c, cp_0, c12_p_0, cp_1, c12, f, fp_0, f12_p_0, fp_1, f12, h, hp_0, w, wp_0, x, xp_0, x20_p_0, x21_p_0, x22_p_0, xp_1, x20_p_1, x21_p_1, xp_2, x20_p_2, xp_3, x20, x21, x22, y, yp_0;
IND_TYPE y8 = 0;
IND_TYPE x23 = 0;
IND_TYPE h8 = 0;
IND_TYPE w8 = 0;
...
fp_1 = 0;
							for (h = h8, hp_0 = 0;h < h8 + 3;h += 1, hp_0 += 1){
								...
								for (w = w8, wp_0 = 0;w < w8 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 14) (14 / 1)
									for (x = x20, xp_3 = x20_p_2, xp_2 = x20_p_1, xp_1 = x20_p_0, xp_0 = 0;x < x20 + 14;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
