...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (1, f); T (2, x); T (7, y); T (1, f); T (8, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c156_p_0, cp_1, c156, f, fp_0, f162_p_0, f163_p_0, fp_1, f162_p_1, fp_2, f162, f163, w, wp_0, x, xp_0, x254_p_0, x255_p_0, xp_1, x254_p_1, xp_2, x254, x255, y, yp_0;
IND_TYPE y104 = 0;
IND_TYPE x256 = 0;
IND_TYPE h = 0;
IND_TYPE w104 = 0;
...
fp_2 = 0;
							for (w = w104, wp_0 = 0;w < w104 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x254, xp_2 = x254_p_1, xp_1 = x254_p_0, xp_0 = 0;x < x254 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
