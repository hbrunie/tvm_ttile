							...
							for (h = h172, hp_0 = 0;h < h172 + 3;h += 1, hp_0 += 1){
								...
								for (w = w178, wp_0 = 0;w < w178 + 3;w += 1, wp_0 += 1){
									...
									for (x = x336, xp_1 = x336_p_0, xp_0 = 0;x < x336 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3280 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_3281 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_3282 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3283 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3280);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_3281);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3282);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3283);
									}
								}
							}
}
