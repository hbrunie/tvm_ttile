...
[V f; U (4, f); U (4, y); U (3, w); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (28, x); T (28, y); T (2, c); T (4, x)]
*/
IND_TYPE c, cp_0, c564_p_0, cp_1, c564, h, hp_0, x, xp_0, x722_p_0, x723_p_0, xp_1, x722_p_1, xp_2, x722, x723, y, yp_0;
IND_TYPE y376 = 0;
IND_TYPE x724 = 0;
IND_TYPE h226 = 0;
IND_TYPE w = 0;
				...
				for (h = h226, hp_0 = 0;h < h226 + 3;h += 1, hp_0 += 1){
					...
					for (x = x722, xp_2 = x722_p_1, xp_1 = x722_p_0, xp_0 = 0;x < x722 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								for (c = c564, cp_1 = c564_p_0, cp_0 = 0;c < c564 + 16;c += 1, cp_1 += 1, cp_0 += 1){
									...
									vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_3800);
									mem_vec_3800 = vec_24;
									vec_28 = _mm256_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 8]);
									vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_3801);
									mem_vec_3801 = vec_27;
									vec_30 = _mm256_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
									vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_3802);
									mem_vec_3802 = vec_29;
									vec_32 = _mm256_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 24]);
									vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_3803);
									mem_vec_3803 = vec_31;
									scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
									vec_34 = _mm256_set1_ps(scal_5);
									vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_3804);
									mem_vec_3804 = vec_33;
									vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_3805);
									mem_vec_3805 = vec_35;
									vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_3806);
									mem_vec_3806 = vec_36;
									vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_3807);
									mem_vec_3807 = vec_37;
									scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
									vec_39 = _mm256_set1_ps(scal_6);
									vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_3808);
									mem_vec_3808 = vec_38;
									vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_3809);
									mem_vec_3809 = vec_40;
									vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_3810);
									mem_vec_3810 = vec_41;
									vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_3811);
									mem_vec_3811 = vec_42;
									scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
									vec_44 = _mm256_set1_ps(scal_7);
									vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_3812);
									mem_vec_3812 = vec_43;
									vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_3813);
									mem_vec_3813 = vec_45;
									vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_3814);
									mem_vec_3814 = vec_46;
									vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_3815);
									mem_vec_3815 = vec_47;
									scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
									vec_49 = _mm256_set1_ps(scal_8);
									vec_50 = _mm256_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
									vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_3800);
									mem_vec_3800 = vec_48;
									vec_52 = _mm256_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 8]);
									vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_3801);
									mem_vec_3801 = vec_51;
									vec_54 = _mm256_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
									vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_3802);
									mem_vec_3802 = vec_53;
									vec_56 = _mm256_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 24]);
									vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_3803);
									mem_vec_3803 = vec_55;
									scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
									vec_58 = _mm256_set1_ps(scal_9);
									vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_3804);
									mem_vec_3804 = vec_57;
									vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_3805);
									mem_vec_3805 = vec_59;
									vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_3806);
									mem_vec_3806 = vec_60;
									vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_3807);
									mem_vec_3807 = vec_61;
									scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
									vec_63 = _mm256_set1_ps(scal_10);
									vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_3808);
									mem_vec_3808 = vec_62;
									vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_3809);
									mem_vec_3809 = vec_64;
									vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_3810);
									mem_vec_3810 = vec_65;
									vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_3811);
									mem_vec_3811 = vec_66;
									scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
									vec_68 = _mm256_set1_ps(scal_11);
									vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_3812);
									mem_vec_3812 = vec_67;
									vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_3813);
									mem_vec_3813 = vec_69;
									vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_3814);
									mem_vec_3814 = vec_70;
									vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_3815);
									mem_vec_3815 = vec_71;
								}
