...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (68, y); T (1, f); T (1, c); T (2, x); T (1, y); T (2, f);
  T (136, x)]
*/
IND_TYPE c, cp_0, c378_p_0, cp_1, c378, f, fp_0, f368_p_0, fp_1, f368, h, hp_0, x, xp_0, x504_p_0, x505_p_0, xp_1, x504_p_1, xp_2, x504, x505, y, yp_0, y378_p_0, yp_1, y378;
