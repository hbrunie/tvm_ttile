...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, f); T (4, x); T (7, y); T (1, x); T (1, f); T (4, c);
  T (1, x)]
*/
IND_TYPE c, cp_0, c18_p_0, cp_1, c18, f, fp_0, f18_p_0, fp_1, f18, h, hp_0, w, wp_0, x, xp_0, x30_p_0, x31_p_0, x32_p_0, xp_1, x30_p_1, x31_p_1, xp_2, x30_p_2, xp_3, x30, x31, x32, y, yp_0;
IND_TYPE y12 = 0;
IND_TYPE x33 = 0;
IND_TYPE h12 = 0;
IND_TYPE w12 = 0;
...
fp_1 = 0;
							for (h = h12, hp_0 = 0;h < h12 + 3;h += 1, hp_0 += 1){
								...
								for (w = w12, wp_0 = 0;w < w12 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 7) (7 / 1)
									for (x = x30, xp_3 = x30_p_2, xp_2 = x30_p_1, xp_1 = x30_p_0, xp_0 = 0;x < x30 + 7;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
