...
__m256 mem_vec_8644 ,mem_vec_8645 ,mem_vec_8646 ,mem_vec_8647 ,mem_vec_8648 ,mem_vec_8649 ,mem_vec_8650 ,mem_vec_8651 ,mem_vec_8652 ,mem_vec_8653 ,mem_vec_8654 ,mem_vec_8655 ,mem_vec_8656 ,mem_vec_8657 ,mem_vec_8658 ,mem_vec_8659 ,mem_vec_8660 ,mem_vec_8661 ,mem_vec_8662 ,mem_vec_8663 ,mem_vec_8664 ,mem_vec_8665 ,mem_vec_8666 ,mem_vec_8667 ,mem_vec_8668 ,mem_vec_8669 ,mem_vec_8670 ,mem_vec_8671 ,mem_vec_8672 ,mem_vec_8673 ,mem_vec_8674 ,mem_vec_8675 ,mem_vec_8676 ,mem_vec_8677 ,mem_vec_8678 ,mem_vec_8679 ,mem_vec_8680 ,mem_vec_8681 ,mem_vec_8682 ,mem_vec_8683 ,mem_vec_8684 ,mem_vec_8685 ,mem_vec_8686 ,mem_vec_8687 ,mem_vec_8688 ,mem_vec_8689 ,mem_vec_8690 ,mem_vec_8691 ,vec_0 ,vec_1 ,vec_10 ,vec_100 ,vec_101 ,vec_102 ,vec_103 ,vec_104 ,vec_105 ,vec_106 ,vec_107 ,vec_108 ,vec_109 ,vec_11 ,vec_110 ,vec_111 ,vec_112 ,vec_113 ,vec_114 ,vec_115 ,vec_116 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_81 ,vec_82 ,vec_83 ,vec_84 ,vec_85 ,vec_86 ,vec_87 ,vec_88 ,vec_89 ,vec_9 ,vec_90 ,vec_91 ,vec_92 ,vec_93 ,vec_94 ,vec_95 ,vec_96 ,vec_97 ,vec_98 ,vec_99;
								...
								for (x = x678, xp_1 = x678_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c678, cp_1 = c678_p_0, cp_0 = 0;
												...
												vec_29 = _mm256_fmadd_ps(vec_30, vec_31, mem_vec_8644);
												mem_vec_8644 = vec_29;

												vec_33 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_32 = _mm256_fmadd_ps(vec_30, vec_33, mem_vec_8645);
												mem_vec_8645 = vec_32;

												vec_35 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_34 = _mm256_fmadd_ps(vec_30, vec_35, mem_vec_8646);
												mem_vec_8646 = vec_34;

												vec_37 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

												vec_36 = _mm256_fmadd_ps(vec_30, vec_37, mem_vec_8647);
												mem_vec_8647 = vec_36;
												scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_39 = _mm256_set1_ps(scal_6);


												vec_38 = _mm256_fmadd_ps(vec_39, vec_31, mem_vec_8648);
												mem_vec_8648 = vec_38;



												vec_40 = _mm256_fmadd_ps(vec_39, vec_33, mem_vec_8649);
												mem_vec_8649 = vec_40;



												vec_41 = _mm256_fmadd_ps(vec_39, vec_35, mem_vec_8650);
												mem_vec_8650 = vec_41;



												vec_42 = _mm256_fmadd_ps(vec_39, vec_37, mem_vec_8651);
												mem_vec_8651 = vec_42;
												scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_44 = _mm256_set1_ps(scal_7);


												vec_43 = _mm256_fmadd_ps(vec_44, vec_31, mem_vec_8652);
												mem_vec_8652 = vec_43;



												vec_45 = _mm256_fmadd_ps(vec_44, vec_33, mem_vec_8653);
												mem_vec_8653 = vec_45;



												vec_46 = _mm256_fmadd_ps(vec_44, vec_35, mem_vec_8654);
												mem_vec_8654 = vec_46;



												vec_47 = _mm256_fmadd_ps(vec_44, vec_37, mem_vec_8655);
												mem_vec_8655 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_49 = _mm256_set1_ps(scal_8);


												vec_48 = _mm256_fmadd_ps(vec_49, vec_31, mem_vec_8656);
												mem_vec_8656 = vec_48;



												vec_50 = _mm256_fmadd_ps(vec_49, vec_33, mem_vec_8657);
												mem_vec_8657 = vec_50;



												vec_51 = _mm256_fmadd_ps(vec_49, vec_35, mem_vec_8658);
												mem_vec_8658 = vec_51;



												vec_52 = _mm256_fmadd_ps(vec_49, vec_37, mem_vec_8659);
												mem_vec_8659 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
												vec_54 = _mm256_set1_ps(scal_9);


												vec_53 = _mm256_fmadd_ps(vec_54, vec_31, mem_vec_8660);
												mem_vec_8660 = vec_53;



												vec_55 = _mm256_fmadd_ps(vec_54, vec_33, mem_vec_8661);
												mem_vec_8661 = vec_55;



												vec_56 = _mm256_fmadd_ps(vec_54, vec_35, mem_vec_8662);
												mem_vec_8662 = vec_56;



												vec_57 = _mm256_fmadd_ps(vec_54, vec_37, mem_vec_8663);
												mem_vec_8663 = vec_57;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_59 = _mm256_set1_ps(scal_10);
												vec_60 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_58 = _mm256_fmadd_ps(vec_59, vec_60, mem_vec_8644);
												mem_vec_8644 = vec_58;

												vec_62 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_61 = _mm256_fmadd_ps(vec_59, vec_62, mem_vec_8645);
												mem_vec_8645 = vec_61;

												vec_64 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_63 = _mm256_fmadd_ps(vec_59, vec_64, mem_vec_8646);
												mem_vec_8646 = vec_63;

												vec_66 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

												vec_65 = _mm256_fmadd_ps(vec_59, vec_66, mem_vec_8647);
												mem_vec_8647 = vec_65;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_68 = _mm256_set1_ps(scal_11);


												vec_67 = _mm256_fmadd_ps(vec_68, vec_60, mem_vec_8648);
												mem_vec_8648 = vec_67;



												vec_69 = _mm256_fmadd_ps(vec_68, vec_62, mem_vec_8649);
												mem_vec_8649 = vec_69;



												vec_70 = _mm256_fmadd_ps(vec_68, vec_64, mem_vec_8650);
												mem_vec_8650 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_68, vec_66, mem_vec_8651);
												mem_vec_8651 = vec_71;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_73 = _mm256_set1_ps(scal_12);


												vec_72 = _mm256_fmadd_ps(vec_73, vec_60, mem_vec_8652);
												mem_vec_8652 = vec_72;



												vec_74 = _mm256_fmadd_ps(vec_73, vec_62, mem_vec_8653);
												mem_vec_8653 = vec_74;



												vec_75 = _mm256_fmadd_ps(vec_73, vec_64, mem_vec_8654);
												mem_vec_8654 = vec_75;



												vec_76 = _mm256_fmadd_ps(vec_73, vec_66, mem_vec_8655);
												mem_vec_8655 = vec_76;
												scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_78 = _mm256_set1_ps(scal_13);


												vec_77 = _mm256_fmadd_ps(vec_78, vec_60, mem_vec_8656);
												mem_vec_8656 = vec_77;



												vec_79 = _mm256_fmadd_ps(vec_78, vec_62, mem_vec_8657);
												mem_vec_8657 = vec_79;



												vec_80 = _mm256_fmadd_ps(vec_78, vec_64, mem_vec_8658);
												mem_vec_8658 = vec_80;



												vec_81 = _mm256_fmadd_ps(vec_78, vec_66, mem_vec_8659);
												mem_vec_8659 = vec_81;
												scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
												vec_83 = _mm256_set1_ps(scal_14);


												vec_82 = _mm256_fmadd_ps(vec_83, vec_60, mem_vec_8660);
												mem_vec_8660 = vec_82;



												vec_84 = _mm256_fmadd_ps(vec_83, vec_62, mem_vec_8661);
												mem_vec_8661 = vec_84;



												vec_85 = _mm256_fmadd_ps(vec_83, vec_64, mem_vec_8662);
												mem_vec_8662 = vec_85;



												vec_86 = _mm256_fmadd_ps(vec_83, vec_66, mem_vec_8663);
												mem_vec_8663 = vec_86;
											}
