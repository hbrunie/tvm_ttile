...
[V f; U (4, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, f); T (1, x); T (4, y); T (1, f); T (4, c); T (28, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c330_p_0, cp_1, c330, f, fp_0, f394_p_0, f395_p_0, fp_1, f394_p_1, fp_2, f394, f395, w, wp_0, x, xp_0, x486_p_0, x487_p_0, xp_1, x486_p_1, xp_2, x486, x487, y, yp_0;
