...
/*
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (34, x); T (3, w);
  T (3, h); T (2, f); T (1, x); T (17, y); T (4, f); T (8, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c66_p_0, cp_1, c66, f, fp_0, f88_p_0, f89_p_0, fp_1, f88_p_1, fp_2, f88, f89, h, hp_0, w, wp_0, x, xp_0, x88_p_0, x89_p_0, xp_1, x88_p_1, xp_2, x88, x89, y, yp_0;
				...
				for (y = y44, yp_0 = 0;
					...
					for (x88 = x89, x88_p_1 = x89_p_0, x88_p_0 = 0;
						...
						for (f = f88, fp_2 = f88_p_1, fp_1 = f88_p_0, fp_0 = 0;
							...
							// y = 4, x = 34, h = 3, w = 3, c = 16, f = 32
							// T (h, 3) (3 / 1)
							for (h = h44, hp_0 = 0;
								h < h44 + 3;
								h += 1, hp_0 += 1){
								// y = 4, x = 34, h = 1, w = 3, c = 16, f = 32
								// T (w, 3) (3 / 1)
								for (w = w44, wp_0 = 0;
									w < w44 + 3;
									w += 1, wp_0 += 1){
