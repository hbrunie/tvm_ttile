...
fp_2 = 0;
					for (h = h148, hp_0 = 0;h < h148 + 3;h += 1, hp_0 += 1){
						...
						for (x = x296, xp_0 = 0;x < x296 + 7;x += 1, xp_0 += 1){
									...
									mem_vec_4170 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
									mem_vec_4171 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_4170);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_4171);
						}
					}
}
