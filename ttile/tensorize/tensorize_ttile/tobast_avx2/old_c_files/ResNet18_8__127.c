...
[V f; U (4, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, f); T (1, x); T (4, y); T (2, f); T (4, c); T (4, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c316_p_0, cp_1, c316, f, fp_0, f328_p_0, f329_p_0, fp_1, f328_p_1, fp_2, f328, f329, w, wp_0, x, xp_0, x384_p_0, x385_p_0, xp_1, x384_p_1, xp_2, x384, x385, y, yp_0;
