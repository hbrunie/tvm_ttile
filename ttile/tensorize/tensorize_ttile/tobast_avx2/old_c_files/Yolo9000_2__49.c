...
/*
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (136, x);
  T (3, w); T (4, y); T (2, f); T (4, c); T (1, x); T (17, y); T (1, f);
  T (2, x)]
*/
IND_TYPE c, cp_0, c180_p_0, cp_1, c180, f, fp_0, f170_p_0, fp_1, f170, w, wp_0, x, xp_0, x240_p_0, x241_p_0, xp_1, x240_p_1, xp_2, x240, x241, y, yp_0, y180_p_0, yp_1, y180;
	...
	for (f170 = f171, f170_p_0 = 0;
		...
		for (y180 = y181, y180_p_0 = 0;
			...
			for (x240 = x241, x240_p_1 = x241_p_0, x240_p_0 = 0;
				x240 < x241 + 136;
				x240 += 136, x240_p_1 += 136, x240_p_0 += 136){
				// y = 16, x = 136, h = 3, w = 3, c = 32, f = 64
				// T (c, 4) (32 / 8)
				for (c180 = c181, c180_p_0 = 0;
					c180 < c181 + 32;
					c180 += 8, c180_p_0 += 8){
					// y = 16, x = 136, h = 3, w = 3, c = 8, f = 64
					// T (f, 2) (64 / 32)
					for (f = f170, fp_1 = f170_p_0, fp_0 = 0;
						f < f170 + 64;
						f += 32, fp_1 += 32, fp_0 += 32){
						// y = 16, x = 136, h = 3, w = 3, c = 8, f = 32
						// T (y, 4) (16 / 4)
