...
/*
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (8, x); T (3, w);
  T (3, h); T (4, y); T (2, f); T (1, c); T (34, x); T (17, y); T (1, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c12_p_0, cp_1, c12, f, fp_0, f12_p_0, fp_1, f12, h, hp_0, w, wp_0, x, xp_0, x16_p_0, x17_p_0, xp_1, x16_p_1, xp_2, x16, x17, y, yp_0, y12_p_0, yp_1, y12;
IND_TYPE y13 = 0;
IND_TYPE x18 = 0;
IND_TYPE h8 = 0;
IND_TYPE w8 = 0;
...
yp_1 = 0;
							for (h = h8, hp_0 = 0;h < h8 + 3;h += 1, hp_0 += 1){
								...
								for (w = w8, wp_0 = 0;w < w8 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 8) (8 / 1)
									for (x = x16, xp_2 = x16_p_1, xp_1 = x16_p_0, xp_0 = 0;x < x16 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
