...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (8, x); T (28, y); T (2, c); T (14, x)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, w, wp_0, x, xp_0, x266_p_0, x267_p_0, xp_1, x266_p_1, xp_2, x266, x267, y, yp_0;
IND_TYPE y148 = 0;
IND_TYPE x268 = 0;
IND_TYPE h = 0;
IND_TYPE w148 = 0;
...
x266_p_1 = 0;
				for (w = w148, wp_0 = 0;w < w148 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x266, xp_2 = x266_p_1, xp_1 = x266_p_0, xp_0 = 0;x < x266 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
