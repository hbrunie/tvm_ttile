...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (28, x); T (7, y); T (1, f); T (4, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c396_p_0, cp_1, c396, f, fp_0, f482_p_0, f483_p_0, fp_1, f482_p_1, fp_2, f482, f483, h, hp_0, x, xp_0, x574_p_0, x575_p_0, xp_1, x574_p_1, xp_2, x574, x575, y, yp_0;
IND_TYPE y264 = 0;
IND_TYPE x576 = 0;
IND_TYPE h194 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h194, hp_0 = 0;h < h194 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x574, xp_2 = x574_p_1, xp_1 = x574_p_0, xp_0 = 0;x < x574 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
