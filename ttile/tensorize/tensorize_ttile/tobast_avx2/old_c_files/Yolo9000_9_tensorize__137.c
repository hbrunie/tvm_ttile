...
[V f; U (4, f); U (4, y); T (256, c); Hoist_vars [c]; T (1, x); T (17, y);
  T (1, f); T (2, f); T (1, c); T (68, x); T (2, f)]
*/
IND_TYPE c, cp_0, c1002_p_0, cp_1, c1002, f, fp_0, f1336_p_0, f1337_p_0, fp_1, f1336_p_1, fp_2, f1336, f1337, x, xp_0, x1002_p_0, xp_1, x1002, y, yp_0;
IND_TYPE y668 = 0;
IND_TYPE x1003 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
						for (x = x1002, xp_1 = x1002_p_0, xp_0 = 0;x < x1002 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 256) (256 / 1)
									for (c = c1002, cp_1 = c1002_p_0, cp_0 = 0;c < c1002 + 256;c += 1, cp_1 += 1, cp_0 += 1){
