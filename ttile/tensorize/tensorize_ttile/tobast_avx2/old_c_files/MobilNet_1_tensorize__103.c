...
x898_p_1 = 0;
				for (h = h314, hp_0 = 0;h < h314 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 14) (14 / 1)
					for (x = x898, xp_2 = x898_p_1, xp_1 = x898_p_0, xp_0 = 0;x < x898 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_4742 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
								mem_vec_4743 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24]);
								...
								mem_vec_4746 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
								mem_vec_4747 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_4742);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24], mem_vec_4743);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_4746);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_4747);
					}
				}
}
