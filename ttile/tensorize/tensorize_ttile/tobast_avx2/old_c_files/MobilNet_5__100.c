...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, f); T (14, x); T (7, y); T (1, f); T (64, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c150_p_0, cp_1, c150, f, fp_0, f200_p_0, f201_p_0, fp_1, f200_p_1, fp_2, f200, f201, w, wp_0, x, xp_0, x200_p_0, x201_p_0, xp_1, x200_p_1, xp_2, x200, x201, y, yp_0;
