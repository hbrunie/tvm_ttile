							...
							for (h = h188, hp_0 = 0;h < h188 + 3;h += 1, hp_0 += 1){
								...
								for (w = w194, wp_0 = 0;w < w194 + 3;w += 1, wp_0 += 1){
									...
									for (x = x360, xp_1 = x360_p_0, xp_0 = 0;x < x360 + 2;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3570 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3571 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3570);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3571);
									}
								}
							}
}
