...
[V f; U (4, f); U (7, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (14, x); T (4, y); T (4, f); T (8, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c294_p_0, cp_1, c294, f, fp_0, f346_p_0, f347_p_0, fp_1, f346_p_1, fp_2, f346, f347, w, wp_0, x, xp_0, x438_p_0, x439_p_0, xp_1, x438_p_1, xp_2, x438, x439, y, yp_0;
