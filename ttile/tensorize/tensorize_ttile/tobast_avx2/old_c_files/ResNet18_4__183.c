...
[V f; U (4, f); ULambda y; U (3, w); T (1, c); Hoist_vars [c]; T (1, x);
  ...
  T (1, x)]
*/
IND_TYPE c, cp_0, c1190_p_0, cp_1, c1190, f, fp_0, h, hp_0, x, xp_0, x1414_p_0, x1415_p_0, xp_1, x1414_p_1, xp_2, x1414, x1415, y, yp_0;
...
__m256 mem_vec_11228 ,mem_vec_11229 ,mem_vec_11230 ,mem_vec_11231 ,mem_vec_11232 ,mem_vec_11233 ,mem_vec_11234 ,mem_vec_11235 ,mem_vec_11236 ,mem_vec_11237 ,mem_vec_11238 ,mem_vec_11239 ,mem_vec_11240 ,mem_vec_11241 ,mem_vec_11242 ,mem_vec_11243 ,mem_vec_11244 ,mem_vec_11245 ,mem_vec_11246 ,mem_vec_11247 ,mem_vec_11248 ,mem_vec_11249 ,mem_vec_11250 ,mem_vec_11251 ,mem_vec_11252 ,mem_vec_11253 ,mem_vec_11254 ,mem_vec_11255 ,mem_vec_11256 ,mem_vec_11257 ,mem_vec_11258 ,mem_vec_11259 ,mem_vec_11260 ,mem_vec_11261 ,mem_vec_11262 ,mem_vec_11263 ,mem_vec_11264 ,mem_vec_11265 ,mem_vec_11266 ,mem_vec_11267 ,mem_vec_11268 ,mem_vec_11269 ,mem_vec_11270 ,mem_vec_11271 ,vec_0 ,vec_1 ,vec_10 ,vec_100 ,vec_101 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_81 ,vec_82 ,vec_83 ,vec_84 ,vec_85 ,vec_86 ,vec_87 ,vec_88 ,vec_89 ,vec_9 ,vec_90 ,vec_91 ,vec_92 ,vec_93 ,vec_94 ,vec_95 ,vec_96 ,vec_97 ,vec_98 ,vec_99;
// y = 28, x = 28, h = 3, w = 3, c = 64, f = 128
// T (x, 1) (28 / 28)
for (x1415 = x1416, x1415_p_0 = 0;
	x1415 < x1416 + 28;
	x1415 += 28, x1415_p_0 += 28){
	// y = 28, x = 28, h = 3, w = 3, c = 64, f = 128
	// T (f, 4) (128 / 32)
	for (f = f818, fp_0 = 0;
		f < f818 + 128;
		f += 32, fp_0 += 32){
			for (y = y744, yp_0 = 0;
				...
				for (x1414 = x1415, x1414_p_1 = x1415_p_0, x1414_p_0 = 0;
					x1414 < x1415 + 28;
					x1414 += 1, x1414_p_1 += 1, x1414_p_0 += 1){
							...
							for (x = x1414, xp_2 = x1414_p_1, xp_1 = x1414_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c1190, cp_1 = c1190_p_0, cp_0 = 0;
											...
											vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_11248);
											mem_vec_11248 = vec_34;

											vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_11249);
											mem_vec_11249 = vec_37;

											vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_11250);
											mem_vec_11250 = vec_39;

											vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_11251);
											mem_vec_11251 = vec_41;
											scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_11252);
											mem_vec_11252 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_11253);
											mem_vec_11253 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_11254);
											mem_vec_11254 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_11255);
											mem_vec_11255 = vec_47;
											scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_11256);
											mem_vec_11256 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_11257);
											mem_vec_11257 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_11258);
											mem_vec_11258 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_11259);
											mem_vec_11259 = vec_52;
											scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_11260);
											mem_vec_11260 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_11261);
											mem_vec_11261 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_11262);
											mem_vec_11262 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_11263);
											mem_vec_11263 = vec_57;
											scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
											vec_59 = _mm256_set1_ps(scal_10);


											vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_11264);
											mem_vec_11264 = vec_58;



											vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_11265);
											mem_vec_11265 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_11266);
											mem_vec_11266 = vec_61;



											vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_11267);
											mem_vec_11267 = vec_62;
											scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
											vec_64 = _mm256_set1_ps(scal_11);


											vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_11268);
											mem_vec_11268 = vec_63;



											vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_11269);
											mem_vec_11269 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_11270);
											mem_vec_11270 = vec_66;



											vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_11271);
											mem_vec_11271 = vec_67;
											scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
											vec_69 = _mm256_set1_ps(scal_12);
											vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_11248);
											mem_vec_11248 = vec_68;

											vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_11249);
											mem_vec_11249 = vec_71;

											vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_11250);
											mem_vec_11250 = vec_73;

											vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_11251);
											mem_vec_11251 = vec_75;
											scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_11252);
											mem_vec_11252 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_11253);
											mem_vec_11253 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_11254);
											mem_vec_11254 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_11255);
											mem_vec_11255 = vec_81;
											scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_11256);
											mem_vec_11256 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_11257);
											mem_vec_11257 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_11258);
											mem_vec_11258 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_11259);
											mem_vec_11259 = vec_86;
											scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
											vec_88 = _mm256_set1_ps(scal_15);


											vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_11260);
											mem_vec_11260 = vec_87;



											vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_11261);
											mem_vec_11261 = vec_89;



											vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_11262);
											mem_vec_11262 = vec_90;



											vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_11263);
											mem_vec_11263 = vec_91;
											scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
											vec_93 = _mm256_set1_ps(scal_16);


											vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_11264);
											mem_vec_11264 = vec_92;



											vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_11265);
											mem_vec_11265 = vec_94;



											vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_11266);
											mem_vec_11266 = vec_95;



											vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_11267);
											mem_vec_11267 = vec_96;
											scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
											vec_98 = _mm256_set1_ps(scal_17);


											vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_11268);
											mem_vec_11268 = vec_97;



											vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_11269);
											mem_vec_11269 = vec_99;



											vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_11270);
											mem_vec_11270 = vec_100;



											vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_11271);
