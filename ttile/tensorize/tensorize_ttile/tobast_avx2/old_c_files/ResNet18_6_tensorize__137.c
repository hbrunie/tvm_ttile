...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (4, f); T (7, x); T (7, y); T (1, f); T (16, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c174_p_0, cp_1, c174, f, fp_0, f186_p_0, f187_p_0, fp_1, f186_p_1, fp_2, f186, f187, w, wp_0, x, xp_0, x278_p_0, x279_p_0, xp_1, x278_p_1, xp_2, x278, x279, y, yp_0;
IND_TYPE y116 = 0;
IND_TYPE x280 = 0;
IND_TYPE h = 0;
IND_TYPE w116 = 0;
...
fp_2 = 0;
							for (w = w116, wp_0 = 0;w < w116 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 4) (4 / 1)
								for (x = x278, xp_2 = x278_p_1, xp_1 = x278_p_0, xp_0 = 0;x < x278 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
