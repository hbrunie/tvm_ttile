...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (17, y); T (2, f); T (32, c); T (2, x); T (4, y); T (1, f);
  T (68, x)]
*/
IND_TYPE c, cp_0, c372_p_0, cp_1, c372, f, fp_0, f362_p_0, fp_1, f362, h, hp_0, x, xp_0, x496_p_0, x497_p_0, xp_1, x496_p_1, xp_2, x496, x497, y, yp_0, y372_p_0, yp_1, y372;
