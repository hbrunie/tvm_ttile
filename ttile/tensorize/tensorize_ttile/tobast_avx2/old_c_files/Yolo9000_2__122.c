		...
		f694 += 32, f694_p_0 += 32){
			for (y822 = y823, y822_p_0 = 0;
				...
				for (x1096 = x1097, x1096_p_1 = x1097_p_0, x1096_p_0 = 0;
					x1096 < x1097 + 136;
					x1096 += 8, x1096_p_1 += 8, x1096_p_0 += 8){
					// y = 8 * ph_y, x = 8, h = 3, w = 3, c = 32, f = 32
					// T (c, 4) (32 / 8)
					for (c822 = c823, c822_p_0 = 0;
						c822 < c823 + 32;
						c822 += 8, c822_p_0 += 8){
						// y = 8 * ph_y, x = 8, h = 3, w = 3, c = 8, f = 32
						// T (f, 1) (32 / 32)
						for (f = f694, fp_1 = f694_p_0, fp_0 = 0;
							...
							// y = 8 * ph_y, x = 8, h = 3, w = 3, c = 8, f = 32
							// T (y, 8) (8 * ph_y / ph_y)
							for (y = y822, yp_1 = y822_p_0, yp_0 = 0;
								y < y822 + 32;
								y += 4, yp_1 += 4, yp_0 += 4){
