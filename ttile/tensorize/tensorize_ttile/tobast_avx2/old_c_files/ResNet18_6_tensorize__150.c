...
[V f; U (4, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, f); T (14, x); T (7, y); T (1, f); T (64, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c378_p_0, cp_1, c378, f, fp_0, f458_p_0, f459_p_0, fp_1, f458_p_1, fp_2, f458, f459, h, hp_0, x, xp_0, x550_p_0, x551_p_0, xp_1, x550_p_1, xp_2, x550, x551, y, yp_0;
IND_TYPE y252 = 0;
IND_TYPE x552 = 0;
IND_TYPE h182 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h182, hp_0 = 0;h < h182 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x550, xp_2 = x550_p_1, xp_1 = x550_p_0, xp_0 = 0;x < x550 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
