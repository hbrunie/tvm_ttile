...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (1, f); T (16, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c150_p_0, cp_1, c150, f, fp_0, f154_p_0, f155_p_0, fp_1, f154_p_1, fp_2, f154, f155, w, wp_0, x, xp_0, x246_p_0, x247_p_0, xp_1, x246_p_1, xp_2, x246, x247, y, yp_0;
IND_TYPE y100 = 0;
IND_TYPE x248 = 0;
IND_TYPE h = 0;
IND_TYPE w100 = 0;
...
fp_2 = 0;
							for (w = w100, wp_0 = 0;w < w100 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 28) (28 / 1)
								for (x = x246, xp_2 = x246_p_1, xp_1 = x246_p_0, xp_0 = 0;x < x246 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
