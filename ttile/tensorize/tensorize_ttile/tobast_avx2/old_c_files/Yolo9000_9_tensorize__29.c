...
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (2, x); T (17, y);
  T (1, f); T (1, f); T (32, c); T (34, x); T (4, f)]
*/
IND_TYPE c, cp_0, c888_p_0, cp_1, c888, f, fp_0, f1184_p_0, f1185_p_0, fp_1, f1184_p_1, fp_2, f1184, f1185, x, xp_0, x888_p_0, xp_1, x888, y, yp_0;
IND_TYPE y592 = 0;
IND_TYPE x889 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
