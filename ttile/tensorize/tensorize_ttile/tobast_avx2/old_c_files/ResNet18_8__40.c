...
[V f; U (4, f); U (4, y); T (1, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (1, c); T (1, x); T (7, y); T (8, f); T (128, c); T (2, x)]
*/
IND_TYPE c, cp_0, c48_p_0, c49_p_0, cp_1, c48_p_1, cp_2, c48, c49, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x48_p_0, x49_p_0, xp_1, x48_p_1, xp_2, x48, x49, y, yp_0;
