...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (14, x); T (28, y); T (4, c); T (8, x)]
*/
IND_TYPE c, cp_0, c612_p_0, cp_1, c612, h, hp_0, x, xp_0, x786_p_0, x787_p_0, xp_1, x786_p_1, xp_2, x786, x787, y, yp_0;
IND_TYPE y408 = 0;
IND_TYPE x788 = 0;
IND_TYPE h258 = 0;
IND_TYPE w = 0;
...
__m256 mem_vec_4056 ,mem_vec_4057 ,mem_vec_4058 ,mem_vec_4059 ,mem_vec_4060 ,mem_vec_4061 ,mem_vec_4062 ,mem_vec_4063 ,mem_vec_4064 ,mem_vec_4065 ,mem_vec_4066 ,mem_vec_4067 ,mem_vec_4068 ,mem_vec_4069 ,mem_vec_4070 ,mem_vec_4071 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_8 ,vec_9;
...
x786_p_1 = 0;
				for (h = h258, hp_0 = 0;h < h258 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x786, xp_2 = x786_p_1, xp_1 = x786_p_0, xp_0 = 0;x < x786 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								for (c = c612, cp_1 = c612_p_0, cp_0 = 0;c < c612 + 8;c += 1, cp_1 += 1, cp_0 += 1){
									...
									vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_4056);
									mem_vec_4056 = vec_24;
									vec_28 = _mm256_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 8]);
									vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_4057);
									mem_vec_4057 = vec_27;
									vec_30 = _mm256_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
									vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_4058);
									mem_vec_4058 = vec_29;
									vec_32 = _mm256_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 24]);
									vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_4059);
									mem_vec_4059 = vec_31;
									scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
									vec_34 = _mm256_set1_ps(scal_5);
									vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_4060);
									mem_vec_4060 = vec_33;
									vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_4061);
									mem_vec_4061 = vec_35;
									vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_4062);
									mem_vec_4062 = vec_36;
									vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_4063);
									mem_vec_4063 = vec_37;
									scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
									vec_39 = _mm256_set1_ps(scal_6);
									vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_4064);
									mem_vec_4064 = vec_38;
									vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_4065);
									mem_vec_4065 = vec_40;
									vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_4066);
									mem_vec_4066 = vec_41;
									vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_4067);
									mem_vec_4067 = vec_42;
									scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
									vec_44 = _mm256_set1_ps(scal_7);
									vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_4068);
									mem_vec_4068 = vec_43;
									vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_4069);
									mem_vec_4069 = vec_45;
									vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_4070);
									mem_vec_4070 = vec_46;
									vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_4071);
									mem_vec_4071 = vec_47;
									scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
									vec_49 = _mm256_set1_ps(scal_8);
									vec_50 = _mm256_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
									vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_4056);
									mem_vec_4056 = vec_48;
									vec_52 = _mm256_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 8]);
									vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_4057);
									mem_vec_4057 = vec_51;
									vec_54 = _mm256_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
									vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_4058);
									mem_vec_4058 = vec_53;
									vec_56 = _mm256_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 24]);
									vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_4059);
									mem_vec_4059 = vec_55;
									scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
									vec_58 = _mm256_set1_ps(scal_9);
									vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_4060);
									mem_vec_4060 = vec_57;
									vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_4061);
									mem_vec_4061 = vec_59;
									vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_4062);
									mem_vec_4062 = vec_60;
									vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_4063);
									mem_vec_4063 = vec_61;
									scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
									vec_63 = _mm256_set1_ps(scal_10);
									vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_4064);
									mem_vec_4064 = vec_62;
									vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_4065);
									mem_vec_4065 = vec_64;
									vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_4066);
									mem_vec_4066 = vec_65;
									vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_4067);
									mem_vec_4067 = vec_66;
									scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
									vec_68 = _mm256_set1_ps(scal_11);
									vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_4068);
									mem_vec_4068 = vec_67;
									vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_4069);
									mem_vec_4069 = vec_69;
									vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_4070);
									mem_vec_4070 = vec_70;
									vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_4071);
									mem_vec_4071 = vec_71;
								}
