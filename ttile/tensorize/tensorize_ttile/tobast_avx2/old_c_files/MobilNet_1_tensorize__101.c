...
x418_p_1 = 0;
				for (w = w224, wp_0 = 0;w < w224 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 8) (8 / 1)
					for (x = x418, xp_2 = x418_p_1, xp_1 = x418_p_0, xp_0 = 0;x < x418 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_2008 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
								mem_vec_2009 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8]);
								mem_vec_2010 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
								mem_vec_2011 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_2008);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8], mem_vec_2009);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_2010);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_2011);
					}
				}
}
