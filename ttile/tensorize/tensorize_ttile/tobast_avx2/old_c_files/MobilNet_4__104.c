...
[V f; U (4, f); U (4, y); U (3, w); T (64, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (14, x); T (7, y); T (2, f); T (2, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c438_p_0, cp_1, c438, f, fp_0, f548_p_0, f549_p_0, fp_1, f548_p_1, fp_2, f548, f549, h, hp_0, x, xp_0, x620_p_0, x621_p_0, xp_1, x620_p_1, xp_2, x620, x621, y, yp_0;
