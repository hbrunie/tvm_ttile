...
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (16, c); T (17, x); T (17, y); T (2, f);
  T (4, x)]
*/
IND_TYPE c, cp_0, c54_p_0, cp_1, c54, f, fp_0, f54_p_0, fp_1, f54, h, hp_0, w, wp_0, x, xp_0, x72_p_0, x73_p_0, xp_1, x72_p_1, xp_2, x72, x73, y, yp_0, y54_p_0, yp_1, y54;
