...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (2, x); T (17, y);
  T (2, f); T (2, f); T (8, c); T (34, x); T (1, f)]
*/
IND_TYPE c, cp_0, c828_p_0, cp_1, c828, f, fp_0, f1104_p_0, f1105_p_0, fp_1, f1104_p_1, fp_2, f1104, f1105, x, xp_0, x828_p_0, xp_1, x828, y, yp_0;
IND_TYPE y552 = 0;
IND_TYPE x829 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
