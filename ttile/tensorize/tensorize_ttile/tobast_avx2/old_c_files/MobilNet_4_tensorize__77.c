...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, f); T (2, x); T (7, y); T (1, f); T (16, c); T (14, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c258_p_0, cp_1, c258, f, fp_0, f308_p_0, f309_p_0, fp_1, f308_p_1, fp_2, f308, f309, w, wp_0, x, xp_0, x380_p_0, x381_p_0, xp_1, x380_p_1, xp_2, x380, x381, y, yp_0;
IND_TYPE y172 = 0;
IND_TYPE x382 = 0;
IND_TYPE h = 0;
IND_TYPE w172 = 0;
