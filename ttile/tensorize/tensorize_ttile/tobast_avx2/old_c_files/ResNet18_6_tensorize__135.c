...
[V f; U (4, f); U (4, y); U (3, w); T (4, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (4, f); T (4, x); T (7, y); T (1, f); T (32, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c354_p_0, cp_1, c354, f, fp_0, f426_p_0, f427_p_0, fp_1, f426_p_1, fp_2, f426, f427, h, hp_0, x, xp_0, x518_p_0, x519_p_0, xp_1, x518_p_1, xp_2, x518, x519, y, yp_0;
IND_TYPE y236 = 0;
IND_TYPE x520 = 0;
IND_TYPE h166 = 0;
IND_TYPE w = 0;
