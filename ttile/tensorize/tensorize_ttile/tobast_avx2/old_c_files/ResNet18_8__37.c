...
/*
[V f; U (4, f); U (7, y); U (3, h); T (128, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (2, f); T (7, x); T (4, y); T (4, f); T (1, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c250_p_0, cp_1, c250, f, fp_0, f240_p_0, f241_p_0, fp_1, f240_p_1, fp_2, f240, f241, w, wp_0, x, xp_0, x296_p_0, x297_p_0, xp_1, x296_p_1, xp_2, x296, x297, y, yp_0;
