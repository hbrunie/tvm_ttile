...
[V f; U (4, f); U (4, y); U (3, w); T (128, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (8, f); T (4, x); T (7, y); T (1, f); T (1, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c394_p_0, cp_1, c394, f, fp_0, f432_p_0, f433_p_0, fp_1, f432_p_1, fp_2, f432, f433, h, hp_0, x, xp_0, x488_p_0, x489_p_0, xp_1, x488_p_1, xp_2, x488, x489, y, yp_0;
IND_TYPE y244 = 0;
IND_TYPE x490 = 0;
IND_TYPE h156 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h156, hp_0 = 0;h < h156 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 7) (7 / 1)
								for (x = x488, xp_2 = x488_p_1, xp_1 = x488_p_0, xp_0 = 0;x < x488 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 128) (128 / 1)
											for (c = c394, cp_1 = c394_p_0, cp_0 = 0;c < c394 + 128;c += 1, cp_1 += 1, cp_0 += 1){
