...
/*
[V f; U (4, f); U (4, y); T (1, c); Hoist_vars [c]; T (8, x); T (3, w);
  T (3, h); T (34, y); T (2, f); T (32, c); T (34, x); T (2, y); T (1, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c6_p_0, cp_1, c6, f, fp_0, f6_p_0, fp_1, f6, h, hp_0, w, wp_0, x, xp_0, x8_p_0, x9_p_0, xp_1, x8_p_1, xp_2, x8, x9, y, yp_0, y6_p_0, yp_1, y6;
	...
	for (f6 = f7, f6_p_0 = 0;
		...
		for (y6 = y7, y6_p_0 = 0;
			...
			for (x8 = x9, x8_p_1 = x9_p_0, x8_p_0 = 0;
				x8 < x9 + 272;
				x8 += 8, x8_p_1 += 8, x8_p_0 += 8){
				// y = 136, x = 8, h = 3, w = 3, c = 32, f = 64
				// T (c, 32) (32 / 1)
				for (c6 = c7, c6_p_0 = 0;
					c6 < c7 + 32;
					c6 += 1, c6_p_0 += 1){
					// y = 136, x = 8, h = 3, w = 3, c = 1, f = 64
					// T (f, 2) (64 / 32)
					for (f = f6, fp_1 = f6_p_0, fp_0 = 0;
						f < f6 + 64;
						f += 32, fp_1 += 32, fp_0 += 32){
						// y = 136, x = 8, h = 3, w = 3, c = 1, f = 32
						// T (y, 34) (136 / 4)
