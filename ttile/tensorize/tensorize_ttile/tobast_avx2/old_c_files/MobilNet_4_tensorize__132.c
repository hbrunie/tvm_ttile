...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, f); T (2, x); T (7, y); T (1, f); T (4, c); T (7, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c240_p_0, cp_1, c240, f, fp_0, f284_p_0, f285_p_0, fp_1, f284_p_1, fp_2, f284, f285, w, wp_0, x, xp_0, x356_p_0, x357_p_0, xp_1, x356_p_1, xp_2, x356, x357, y, yp_0;
IND_TYPE y160 = 0;
IND_TYPE x358 = 0;
IND_TYPE h = 0;
IND_TYPE w160 = 0;
