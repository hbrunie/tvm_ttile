...
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (2, f); T (2, x); T (7, y); T (2, x); T (2, f); T (16, c);
  T (1, x)]
*/
IND_TYPE c, cp_0, c36_p_0, cp_1, c36, f, fp_0, f36_p_0, fp_1, f36, h, hp_0, w, wp_0, x, xp_0, x60_p_0, x61_p_0, x62_p_0, xp_1, x60_p_1, x61_p_1, xp_2, x60_p_2, xp_3, x60, x61, x62, y, yp_0;
IND_TYPE y24 = 0;
IND_TYPE x63 = 0;
IND_TYPE h24 = 0;
IND_TYPE w24 = 0;
...
fp_1 = 0;
							for (h = h24, hp_0 = 0;h < h24 + 3;h += 1, hp_0 += 1){
								...
								for (w = w24, wp_0 = 0;w < w24 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 7) (7 / 1)
									for (x = x60, xp_3 = x60_p_2, xp_2 = x60_p_1, xp_1 = x60_p_0, xp_0 = 0;x < x60 + 7;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
