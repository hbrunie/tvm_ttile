...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (1, x); T (28, y); T (1, c); T (8, x)]
*/
IND_TYPE c, cp_0, c168_p_0, cp_1, c168, w, wp_0, x, xp_0, x194_p_0, x195_p_0, xp_1, x194_p_1, xp_2, x194, x195, y, yp_0;
IND_TYPE y112 = 0;
IND_TYPE x196 = 0;
IND_TYPE h = 0;
IND_TYPE w112 = 0;
...
x194_p_1 = 0;
				for (w = w112, wp_0 = 0;w < w112 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 14) (14 / 1)
					for (x = x194, xp_2 = x194_p_1, xp_1 = x194_p_0, xp_0 = 0;x < x194 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
