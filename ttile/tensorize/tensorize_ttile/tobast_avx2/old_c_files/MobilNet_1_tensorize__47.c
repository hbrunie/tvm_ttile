...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (8, x); T (28, y); T (1, c); T (1, x)]
*/
IND_TYPE c, cp_0, c108_p_0, cp_1, c108, w, wp_0, x, xp_0, x114_p_0, x115_p_0, xp_1, x114_p_1, xp_2, x114, x115, y, yp_0;
IND_TYPE y72 = 0;
IND_TYPE x116 = 0;
IND_TYPE h = 0;
IND_TYPE w72 = 0;
...
x114_p_1 = 0;
				for (w = w72, wp_0 = 0;w < w72 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 14) (14 / 1)
					for (x = x114, xp_2 = x114_p_1, xp_1 = x114_p_0, xp_0 = 0;x < x114 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
