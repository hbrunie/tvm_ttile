...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (4, x);
  T (3, h); T (68, y); T (2, f); T (1, c); T (17, x); T (1, y); T (1, f);
  T (4, x)]
*/
IND_TYPE c, cp_0, c342_p_0, cp_1, c342, f, fp_0, f332_p_0, fp_1, f332, h, hp_0, x, xp_0, x456_p_0, x457_p_0, xp_1, x456_p_1, xp_2, x456, x457, y, yp_0, y342_p_0, yp_1, y342;
IND_TYPE y343 = 0;
IND_TYPE x458 = 0;
IND_TYPE h180 = 0;
IND_TYPE w = 0;
