...
[V f; U (4, f); U (4, y); T (256, c); Hoist_vars [c]; T (1, x); T (17, y);
  T (2, f); T (2, f); T (1, c); T (68, x); T (1, f)]
*/
IND_TYPE c, cp_0, c996_p_0, cp_1, c996, f, fp_0, f1328_p_0, f1329_p_0, fp_1, f1328_p_1, fp_2, f1328, f1329, x, xp_0, x996_p_0, xp_1, x996, y, yp_0;
IND_TYPE y664 = 0;
IND_TYPE x997 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
__m256 mem_vec_5312 ,mem_vec_5313 ,mem_vec_5314 ,mem_vec_5315 ,mem_vec_5316 ,mem_vec_5317 ,mem_vec_5318 ,mem_vec_5319 ,mem_vec_5320 ,mem_vec_5321 ,mem_vec_5322 ,mem_vec_5323 ,mem_vec_5324 ,mem_vec_5325 ,mem_vec_5326 ,mem_vec_5327 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_3 ,vec_4 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
...
yp_0 = 0;
						for (x = x996, xp_1 = x996_p_0, xp_0 = 0;x < x996 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 256) (256 / 1)
									for (c = c996, cp_1 = c996_p_0, cp_0 = 0;c < c996 + 256;c += 1, cp_1 += 1, cp_0 += 1){
