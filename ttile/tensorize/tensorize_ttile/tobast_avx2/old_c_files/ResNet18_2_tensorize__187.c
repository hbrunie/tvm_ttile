...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (14, y); T (1, f); T (2, c); T (1, f); T (32, c); T (56, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c200_p_0, c201_p_0, cp_1, c200_p_1, cp_2, c200, c201, f, fp_0, f176_p_0, f177_p_0, fp_1, f176_p_1, fp_2, f176, f177, w, wp_0, x, xp_0, x192_p_0, xp_1, x192, y, yp_0;
IND_TYPE y112 = 0;
IND_TYPE x193 = 0;
IND_TYPE h = 0;
IND_TYPE w112 = 0;
