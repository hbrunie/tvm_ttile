...
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (34, y); T (1, f); T (2, c); T (68, x); T (2, y); T (2, f);
  T (2, x)]
*/
IND_TYPE c, cp_0, c36_p_0, cp_1, c36, f, fp_0, f36_p_0, fp_1, f36, h, hp_0, w, wp_0, x, xp_0, x48_p_0, x49_p_0, xp_1, x48_p_1, xp_2, x48, x49, y, yp_0, y36_p_0, yp_1, y36;
