...
[V f; U (4, f); ULambda y; U (3, h); T (4, c); Hoist_vars [c]; T (1, x);
  ...
  T (2, f); T (8, c); T (68, x); T (17, y); T (1, f); T (4, x)]
*/
IND_TYPE c, cp_0, c804_p_0, cp_1, c804, f, fp_0, f676_p_0, fp_1, f676, w, wp_0, x, xp_0, x1072_p_0, x1073_p_0, xp_1, x1072_p_1, xp_2, x1072, x1073, y, yp_0, y804_p_0, yp_1, y804;
		...
		for (y804 = y805, y804_p_0 = 0;
			...
			for (x1072 = x1073, x1072_p_1 = x1073_p_0, x1072_p_0 = 0;
				...
				for (c804 = c805, c804_p_0 = 0;
					c804 < c805 + 32;
					c804 += 4, c804_p_0 += 4){
					// y = 16, x = 1, h = 3, w = 3, c = 4, f = 64
					// T (f, 2) (64 / 32)
					for (f = f676, fp_1 = f676_p_0, fp_0 = 0;
						f < f676 + 64;
						f += 32, fp_1 += 32, fp_0 += 32){
							for (y = y804, yp_1 = y804_p_0, yp_0 = 0;
								y < y804 + 4;
								y += 4, yp_1 += 4, yp_0 += 4){
									...
									for (x = x1072, xp_2 = x1072_p_1, xp_1 = x1072_p_0, xp_0 = 0;
										...
										x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c804, cp_1 = c804_p_0, cp_0 = 0;
													...
													vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_7632);
													mem_vec_7632 = vec_24;

													vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

													vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_7633);
													mem_vec_7633 = vec_27;

													vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

													vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_7634);
													mem_vec_7634 = vec_29;

													vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

													vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_7635);
													mem_vec_7635 = vec_31;
													scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
													vec_34 = _mm256_set1_ps(scal_5);


													vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_7636);
													mem_vec_7636 = vec_33;



													vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_7637);
													mem_vec_7637 = vec_35;



													vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_7638);
													mem_vec_7638 = vec_36;



													vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_7639);
													mem_vec_7639 = vec_37;
													scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
													vec_39 = _mm256_set1_ps(scal_6);


													vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_7640);
													mem_vec_7640 = vec_38;



													vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_7641);
													mem_vec_7641 = vec_40;



													vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_7642);
													mem_vec_7642 = vec_41;



													vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_7643);
													mem_vec_7643 = vec_42;
													scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
													vec_44 = _mm256_set1_ps(scal_7);


													vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_7644);
													mem_vec_7644 = vec_43;



													vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_7645);
													mem_vec_7645 = vec_45;



													vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_7646);
													mem_vec_7646 = vec_46;



													vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_7647);
													mem_vec_7647 = vec_47;
													scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
													vec_49 = _mm256_set1_ps(scal_8);
													vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

													vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_7632);
													mem_vec_7632 = vec_48;

													vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

													vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_7633);
													mem_vec_7633 = vec_51;

													vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

													vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_7634);
													mem_vec_7634 = vec_53;

													vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

													vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_7635);
													mem_vec_7635 = vec_55;
													scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
													vec_58 = _mm256_set1_ps(scal_9);


													vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_7636);
													mem_vec_7636 = vec_57;



													vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_7637);
													mem_vec_7637 = vec_59;



													vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_7638);
													mem_vec_7638 = vec_60;



													vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_7639);
													mem_vec_7639 = vec_61;
													scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
													vec_63 = _mm256_set1_ps(scal_10);


													vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_7640);
													mem_vec_7640 = vec_62;



													vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_7641);
													mem_vec_7641 = vec_64;



													vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_7642);
													mem_vec_7642 = vec_65;



													vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_7643);
													mem_vec_7643 = vec_66;
													scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
													vec_68 = _mm256_set1_ps(scal_11);


													vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_7644);
													mem_vec_7644 = vec_67;



													vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_7645);
													mem_vec_7645 = vec_69;



													vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_7646);
													mem_vec_7646 = vec_70;



													vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_7647);
													mem_vec_7647 = vec_71;
												}
							...
							for (y = y804 + 4, yp_1 = y804_p_0, yp_0 = 0;
								y < y804 + 4 + 12;
								y += 6, yp_1 += 6, yp_0 += 6){
								// y = ph_y, x = 1, h = 3, w = 3, c = 4, f = 32
								// T (w, 3) (3 / 1)
								for (w = w486, wp_0 = 0;
									...
									for (x = x1072, xp_2 = x1072_p_1, xp_1 = x1072_p_0, xp_0 = 0;
										...
										x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_7670 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
												mem_vec_7671 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 4, f = 32
												// T (c, 4) (4 / 1)
												for (c = c804, cp_1 = c804_p_0, cp_0 = 0;
													c < c804 + 4;
													...
													vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_7668);
													mem_vec_7668 = vec_29;



													vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_7669);
													mem_vec_7669 = vec_31;



													vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_7670);
													mem_vec_7670 = vec_32;



													vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_7671);
													mem_vec_7671 = vec_33;
													scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
													vec_35 = _mm256_set1_ps(scal_6);
													vec_36 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

													vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_7648);
													mem_vec_7648 = vec_34;

													vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

													vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_7649);
													mem_vec_7649 = vec_37;

													vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

													vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_7650);
													mem_vec_7650 = vec_39;

													vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

													vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_7651);
													mem_vec_7651 = vec_41;
													scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
													vec_44 = _mm256_set1_ps(scal_7);


													vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_7652);
													mem_vec_7652 = vec_43;



													vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_7653);
													mem_vec_7653 = vec_45;



													vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_7654);
													mem_vec_7654 = vec_46;



													vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_7655);
													mem_vec_7655 = vec_47;
													scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
													vec_49 = _mm256_set1_ps(scal_8);


													vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_7656);
													mem_vec_7656 = vec_48;



													vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_7657);
													mem_vec_7657 = vec_50;



													vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_7658);
													mem_vec_7658 = vec_51;



													vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_7659);
													mem_vec_7659 = vec_52;
													scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
													vec_54 = _mm256_set1_ps(scal_9);


													vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_7660);
													mem_vec_7660 = vec_53;



													vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_7661);
													mem_vec_7661 = vec_55;



													vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_7662);
													mem_vec_7662 = vec_56;



													vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_7663);
													mem_vec_7663 = vec_57;
													scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
													vec_59 = _mm256_set1_ps(scal_10);


													vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_7664);
													mem_vec_7664 = vec_58;



													vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_7665);
													mem_vec_7665 = vec_60;



													vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_7666);
													mem_vec_7666 = vec_61;



													vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_7667);
													mem_vec_7667 = vec_62;
													scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
													vec_64 = _mm256_set1_ps(scal_11);


													vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_7668);
													mem_vec_7668 = vec_63;



													vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_7669);
													mem_vec_7669 = vec_65;



													vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_7670);
													mem_vec_7670 = vec_66;



													vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_7671);
													mem_vec_7671 = vec_67;
													scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
													vec_69 = _mm256_set1_ps(scal_12);
													vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

													vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_7648);
													mem_vec_7648 = vec_68;

													vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

													vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_7649);
													mem_vec_7649 = vec_71;

													vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

													vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_7650);
													mem_vec_7650 = vec_73;

													vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

													vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_7651);
													mem_vec_7651 = vec_75;
													scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
													vec_78 = _mm256_set1_ps(scal_13);


													vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_7652);
													mem_vec_7652 = vec_77;



													vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_7653);
													mem_vec_7653 = vec_79;



													vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_7654);
													mem_vec_7654 = vec_80;



													vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_7655);
													mem_vec_7655 = vec_81;
													scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
													vec_83 = _mm256_set1_ps(scal_14);


													vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_7656);
													mem_vec_7656 = vec_82;



													vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_7657);
													mem_vec_7657 = vec_84;



													vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_7658);
													mem_vec_7658 = vec_85;



													vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_7659);
													mem_vec_7659 = vec_86;
													scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
													vec_88 = _mm256_set1_ps(scal_15);


													vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_7660);
													mem_vec_7660 = vec_87;



													vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_7661);
													mem_vec_7661 = vec_89;



													vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_7662);
													mem_vec_7662 = vec_90;



													vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_7663);
													mem_vec_7663 = vec_91;
													scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
													vec_93 = _mm256_set1_ps(scal_16);


													vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_7664);
													mem_vec_7664 = vec_92;



													vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_7665);
													mem_vec_7665 = vec_94;



													vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_7666);
													mem_vec_7666 = vec_95;



													vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_7667);
													mem_vec_7667 = vec_96;
													scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
													vec_98 = _mm256_set1_ps(scal_17);


													vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_7668);
													mem_vec_7668 = vec_97;



													vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_7669);
													mem_vec_7669 = vec_99;



													vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_7670);
													mem_vec_7670 = vec_100;



													vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_7671);
											...
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_7670);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_7671);
									}
								}
							}
					}
