...
[V f; U (4, f); U (4, y); U (3, w); T (16, c); Hoist_vars [c]; T (4, x);
  T (3, h); T (17, y); T (1, f); T (2, c); T (68, x); T (4, y); T (2, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c306_p_0, cp_1, c306, f, fp_0, f296_p_0, fp_1, f296, h, hp_0, x, xp_0, x408_p_0, x409_p_0, xp_1, x408_p_1, xp_2, x408, x409, y, yp_0, y306_p_0, yp_1, y306;
