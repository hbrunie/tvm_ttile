...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, f); T (1, x); T (7, y); T (2, f); T (4, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c414_p_0, cp_1, c414, f, fp_0, f506_p_0, f507_p_0, fp_1, f506_p_1, fp_2, f506, f507, h, hp_0, x, xp_0, x598_p_0, x599_p_0, xp_1, x598_p_1, xp_2, x598, x599, y, yp_0;
IND_TYPE y276 = 0;
IND_TYPE x600 = 0;
IND_TYPE h206 = 0;
IND_TYPE w = 0;
