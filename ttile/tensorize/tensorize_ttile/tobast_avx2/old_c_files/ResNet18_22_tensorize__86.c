...
yp_0 = 0;
								for (w = w486, wp_0 = 0;w < w486 + 3;w += 1, wp_0 += 1){
									...
									for (x = x942, xp_1 = x942_p_0, xp_0 = 0;x < x942 + 28;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_9002 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
												mem_vec_9003 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_9002);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_9003);
									}
								}
}
