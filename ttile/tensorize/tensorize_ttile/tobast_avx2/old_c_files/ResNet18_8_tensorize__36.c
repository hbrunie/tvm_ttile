...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  ...
  T (8, f)]
*/
IND_TYPE c, cp_0, c160_p_0, cp_1, c160, f, fp_0, f120_p_0, f121_p_0, fp_1, f120_p_1, fp_2, f120, f121, w, wp_0, x, xp_0, x176_p_0, x177_p_0, xp_1, x176_p_1, xp_2, x176, x177, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x178 = 0;
IND_TYPE h = 0;
IND_TYPE w88 = 0;
...
fp_2 = 0;
							for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x176, xp_2 = x176_p_1, xp_1 = x176_p_0, xp_0 = 0;x < x176 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 1, f = 32
											// T (c, 1) (1 / 1)
											for (c = c160, cp_1 = c160_p_0, cp_0 = 0;c < c160 + 1;c += 1, cp_1 += 1, cp_0 += 1){
