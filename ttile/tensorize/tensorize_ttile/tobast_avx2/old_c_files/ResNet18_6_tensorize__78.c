...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (28, x); T (7, y); T (1, f); T (8, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c192_p_0, cp_1, c192, f, fp_0, f210_p_0, f211_p_0, fp_1, f210_p_1, fp_2, f210, f211, w, wp_0, x, xp_0, x302_p_0, x303_p_0, xp_1, x302_p_1, xp_2, x302, x303, y, yp_0;
IND_TYPE y128 = 0;
IND_TYPE x304 = 0;
IND_TYPE h = 0;
IND_TYPE w128 = 0;
...
fp_2 = 0;
							for (w = w128, wp_0 = 0;w < w128 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x302, xp_2 = x302_p_1, xp_1 = x302_p_0, xp_0 = 0;x < x302 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
