...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (7, x); T (28, y); T (16, c); T (4, x)]
*/
IND_TYPE c, cp_0, c144_p_0, cp_1, c144, w, wp_0, x, xp_0, x162_p_0, x163_p_0, xp_1, x162_p_1, xp_2, x162, x163, y, yp_0;
IND_TYPE y96 = 0;
IND_TYPE x164 = 0;
IND_TYPE h = 0;
IND_TYPE w96 = 0;
...
x162_p_1 = 0;
				for (w = w96, wp_0 = 0;w < w96 + 3;w += 1, wp_0 += 1){
					// y = 4, x = 4, h = 3, w = 1, c = 2, f = 32
					// T (x, 4) (4 / 1)
					for (x = x162, xp_2 = x162_p_1, xp_1 = x162_p_0, xp_0 = 0;x < x162 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 2) (2 / 1)
								for (c = c144, cp_1 = c144_p_0, cp_0 = 0;c < c144 + 2;c += 1, cp_1 += 1, cp_0 += 1){
