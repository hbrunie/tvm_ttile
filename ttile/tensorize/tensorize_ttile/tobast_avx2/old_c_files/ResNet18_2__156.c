...
[V f; U (4, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (8, y); T (1, f); T (1, c); T (1, f); T (2, c); T (28, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c288_p_0, c289_p_0, cp_1, c288_p_1, cp_2, c288, c289, f, fp_0, f264_p_0, f265_p_0, fp_1, f264_p_1, fp_2, f264, f265, w, wp_0, x, xp_0, x258_p_0, xp_1, x258, y, yp_0;
