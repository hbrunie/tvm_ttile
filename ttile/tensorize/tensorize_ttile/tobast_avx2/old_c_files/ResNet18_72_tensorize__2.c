							...
							for (h = h238, hp_0 = 0;h < h238 + 3;h += 1, hp_0 += 1){
								...
								for (w = w220, wp_0 = 0;w < w220 + 3;w += 1, wp_0 += 1){
									...
									for (x = x426, xp_1 = x426_p_0, xp_0 = 0;x < x426 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4266 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_4267 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4266);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4267);
									}
								}
							}
}
