...
fp_2 = 0;
							for (w = w380, wp_0 = 0;w < w380 + 3;w += 1, wp_0 += 1){
								...
								for (x = x660, xp_1 = x660_p_0, xp_0 = 0;x < x660 + 7;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6882 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											mem_vec_6883 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_6882);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_6883);
								}
							}
}
