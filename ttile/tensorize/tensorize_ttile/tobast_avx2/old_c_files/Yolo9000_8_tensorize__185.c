...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (8, f); T (1, x); T (17, y); T (1, f); T (4, c); T (68, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c420_p_0, cp_1, c420, f, fp_0, f560_p_0, f561_p_0, fp_1, f560_p_1, fp_2, f560, f561, w, wp_0, x, xp_0, x560_p_0, x561_p_0, xp_1, x560_p_1, xp_2, x560, x561, y, yp_0;
IND_TYPE y280 = 0;
IND_TYPE x562 = 0;
IND_TYPE h = 0;
IND_TYPE w280 = 0;
