...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (2, f); T (1, x); T (7, y); T (1, f); T (4, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c348_p_0, cp_1, c348, f, fp_0, f418_p_0, f419_p_0, fp_1, f418_p_1, fp_2, f418, f419, h, hp_0, x, xp_0, x510_p_0, x511_p_0, xp_1, x510_p_1, xp_2, x510, x511, y, yp_0;
IND_TYPE y232 = 0;
IND_TYPE x512 = 0;
IND_TYPE h162 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h162, hp_0 = 0;h < h162 + 3;h += 1, hp_0 += 1){
								// y = 4, x = 28, h = 1, w = 3, c = 32, f = 32
								// T (x, 28) (28 / 1)
								for (x = x510, xp_2 = x510_p_1, xp_1 = x510_p_0, xp_0 = 0;x < x510 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
