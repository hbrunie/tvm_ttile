...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (4, f); T (2, x); T (7, y); T (1, f); T (8, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c216_p_0, cp_1, c216, f, fp_0, f242_p_0, f243_p_0, fp_1, f242_p_1, fp_2, f242, f243, w, wp_0, x, xp_0, x334_p_0, x335_p_0, xp_1, x334_p_1, xp_2, x334, x335, y, yp_0;
			...
			for (f242 = f243, f242_p_1 = f243_p_0, f242_p_0 = 0;
				...
				for (y = y144, yp_0 = 0;
					...
					for (x334 = x335, x334_p_1 = x335_p_0, x334_p_0 = 0;
						x334 < x335 + 14;
						x334 += 7, x334_p_1 += 7, x334_p_0 += 7){
						// y = 4, x = 7, h = 3, w = 3, c = 16, f = 128
						// T (f, 4) (128 / 32)
