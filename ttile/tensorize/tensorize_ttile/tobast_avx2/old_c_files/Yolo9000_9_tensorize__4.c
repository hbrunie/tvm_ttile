...
[V f; U (4, f); U (4, y); T (128, c); Hoist_vars [c]; T (2, x); T (17, y);
  T (1, f); T (2, f); T (2, c); T (34, x); T (2, f)]
*/
IND_TYPE c, cp_0, c810_p_0, cp_1, c810, f, fp_0, f1080_p_0, f1081_p_0, fp_1, f1080_p_1, fp_2, f1080, f1081, x, xp_0, x810_p_0, xp_1, x810, y, yp_0;
IND_TYPE y540 = 0;
IND_TYPE x811 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
						for (x = x810, xp_1 = x810_p_0, xp_0 = 0;x < x810 + 2;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 128) (128 / 1)
									for (c = c810, cp_1 = c810_p_0, cp_0 = 0;c < c810 + 128;c += 1, cp_1 += 1, cp_0 += 1){
