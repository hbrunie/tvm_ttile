...
[V f; U (4, f); ULambda y; U (3, w); T (1, c); Hoist_vars [c]; T (8, x);
  ...
  T (1, f); T (64, c); T (2, f); T (1, c); T (7, x); T (1, f)]
*/
IND_TYPE c, cp_0, c1454_p_0, c1455_p_0, cp_1, c1454_p_1, cp_2, c1454, c1455, f, fp_0, f1380_p_0, f1381_p_0, fp_1, f1380_p_1, fp_2, f1380, f1381, h, hp_0, x, xp_0, x1206_p_0, xp_1, x1206, y, yp_0;
...
for (f1381 = f1382, f1381_p_0 = 0;
	...
	for (x1206 = x1207, x1206_p_0 = 0;
		...
		// T (c, 1) (64 / 64)
		for (c1455 = c1456, c1455_p_0 = 0;
			c1455 < c1456 + 64;
			c1455 += 64, c1455_p_0 += 64){
			// y = 56, x = 8, h = 3, w = 3, c = 64, f = 64
			// T (f, 2) (64 / 32)
			for (f1380 = f1381, f1380_p_1 = f1381_p_0, f1380_p_0 = 0;
				...
				// T (c, 64) (64 / 1)
				for (c1454 = c1455, c1454_p_1 = c1455_p_0, c1454_p_0 = 0;
					c1454 < c1455 + 64;
					c1454 += 1, c1454_p_1 += 1, c1454_p_0 += 1){
								...
								for (h = h544, hp_0 = 0;
									...
									for (x = x1206, xp_1 = x1206_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 1) (1 / 1)
												for (c = c1454, cp_2 = c1454_p_1, cp_1 = c1454_p_0, cp_0 = 0;
													c < c1454 + 1;
