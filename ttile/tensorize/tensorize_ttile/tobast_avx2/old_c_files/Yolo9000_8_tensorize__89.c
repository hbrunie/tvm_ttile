...
fp_2 = 0;
							for (h = h452, hp_0 = 0;h < h452 + 3;h += 1, hp_0 += 1){
								...
								for (x = x1040, xp_2 = x1040_p_1, xp_1 = x1040_p_0, xp_0 = 0;x < x1040 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4932 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
											mem_vec_4933 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 40]);
											mem_vec_4934 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
											mem_vec_4935 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 56]);
											...
											mem_vec_4940 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
											mem_vec_4941 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 40]);
											mem_vec_4942 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
											mem_vec_4943 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 56]);
											...
											mem_vec_4948 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
											mem_vec_4949 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 40]);
											mem_vec_4950 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
											mem_vec_4951 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 56]);
											...
											mem_vec_4956 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
											mem_vec_4957 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 40]);
											mem_vec_4958 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
											mem_vec_4959 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 56]);
											// y = 4, x = 1, h = 1, w = 3, c = 2, f = 64
											// T (c, 2) (2 / 1)
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_4932);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 40], mem_vec_4933);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_4934);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 56], mem_vec_4935);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_4940);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 40], mem_vec_4941);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_4942);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 56], mem_vec_4943);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_4948);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 40], mem_vec_4949);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_4950);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 56], mem_vec_4951);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_4956);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 40], mem_vec_4957);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_4958);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 56], mem_vec_4959);
								}
							}
}
