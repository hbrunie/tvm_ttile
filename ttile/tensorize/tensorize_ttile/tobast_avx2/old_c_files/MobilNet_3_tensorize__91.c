...
c72_p_1 = 0;
						for (w = w44, wp_0 = 0;w < w44 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 7) (7 / 1)
							for (x = x88, xp_2 = x88_p_1, xp_1 = x88_p_0, xp_0 = 0;x < x88 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 4) (4 / 1)
										for (c = c72, cp_2 = c72_p_1, cp_1 = c72_p_0, cp_0 = 0;c < c72 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
