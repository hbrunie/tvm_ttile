...
c96_p_1 = 0;
						for (w = w56, wp_0 = 0;w < w56 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 7) (7 / 1)
							for (x = x112, xp_2 = x112_p_1, xp_1 = x112_p_0, xp_0 = 0;x < x112 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c96, cp_2 = c96_p_1, cp_1 = c96_p_0, cp_0 = 0;c < c96 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
