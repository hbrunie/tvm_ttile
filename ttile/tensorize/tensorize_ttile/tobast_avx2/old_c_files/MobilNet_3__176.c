...
[V f; U (4, f); U (7, y); U (3, w); T (4, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (1, f); T (2, x); T (8, y); T (1, f); T (32, c); T (4, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c388_p_0, cp_1, c388, f, fp_0, f444_p_0, f445_p_0, fp_1, f444_p_1, fp_2, f444, f445, h, hp_0, x, xp_0, x488_p_0, x489_p_0, xp_1, x488_p_1, xp_2, x488, x489, y, yp_0;
