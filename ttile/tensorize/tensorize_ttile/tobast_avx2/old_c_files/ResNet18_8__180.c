...
[V f; U (4, f); U (7, y); U (3, w); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (28, x); T (4, y); T (8, f); T (16, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c568_p_0, cp_1, c568, f, fp_0, f664_p_0, f665_p_0, fp_1, f664_p_1, fp_2, f664, f665, h, hp_0, x, xp_0, x720_p_0, x721_p_0, xp_1, x720_p_1, xp_2, x720, x721, y, yp_0;
