...
fp_2 = 0;
							for (h = h466, hp_0 = 0;h < h466 + 3;h += 1, hp_0 += 1){
								...
								for (x = x966, xp_1 = x966_p_0, xp_0 = 0;x < x966 + 7;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_10730 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											mem_vec_10731 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_10730);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_10731);
								}
							}
}
