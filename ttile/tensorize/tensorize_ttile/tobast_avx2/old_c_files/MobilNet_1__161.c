...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (16, x); T (16, y); T (1, c); T (1, x)]
*/
IND_TYPE c, cp_0, c672_p_0, cp_1, c672, h, hp_0, x, xp_0, x866_p_0, x867_p_0, xp_1, x866_p_1, xp_2, x866, x867, y, yp_0;
		...
		for (y = y448, yp_0 = 0;
			...
			for (x866 = x867, x866_p_1 = x867_p_0, x866_p_0 = 0;
				...
				for (h = h298, hp_0 = 0;
					...
					// T (x, 7) (7 / 1)
					for (x = x866, xp_2 = x866_p_1, xp_1 = x866_p_0, xp_0 = 0;
						x < x866 + 7;
