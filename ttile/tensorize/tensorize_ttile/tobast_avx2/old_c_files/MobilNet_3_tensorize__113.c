...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (4, f); T (14, x); T (14, y); T (1, f); T (4, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c322_p_0, cp_1, c322, f, fp_0, f356_p_0, f357_p_0, fp_1, f356_p_1, fp_2, f356, f357, h, hp_0, x, xp_0, x400_p_0, x401_p_0, xp_1, x400_p_1, xp_2, x400, x401, y, yp_0;
IND_TYPE y200 = 0;
IND_TYPE x402 = 0;
IND_TYPE h126 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h126, hp_0 = 0;h < h126 + 3;h += 1, hp_0 += 1){
								...
								for (x = x400, xp_2 = x400_p_1, xp_1 = x400_p_0, xp_0 = 0;x < x400 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 32) (32 / 1)
											for (c = c322, cp_1 = c322_p_0, cp_0 = 0;c < c322 + 32;c += 1, cp_1 += 1, cp_0 += 1){
