...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (1, y); T (2, f); T (1, c); T (16, x); T (68, y); T (1, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c168_p_0, cp_1, c168, f, fp_0, f158_p_0, fp_1, f158, w, wp_0, x, xp_0, x224_p_0, x225_p_0, xp_1, x224_p_1, xp_2, x224, x225, y, yp_0, y168_p_0, yp_1, y168;
IND_TYPE y169 = 0;
IND_TYPE x226 = 0;
IND_TYPE h = 0;
IND_TYPE w112 = 0;
