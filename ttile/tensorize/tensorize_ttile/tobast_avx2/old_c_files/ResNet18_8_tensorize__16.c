...
/*
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (8, c); T (4, x); T (7, y); T (8, f); T (8, c); T (1, x)]
*/
IND_TYPE c, cp_0, c24_p_0, c25_p_0, cp_1, c24_p_1, cp_2, c24, c25, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x24_p_0, x25_p_0, xp_1, x24_p_1, xp_2, x24, x25, y, yp_0;
IND_TYPE y12 = 0;
IND_TYPE x26 = 0;
IND_TYPE h12 = 0;
IND_TYPE w12 = 0;
...
c24_p_1 = 0;
						for (h = h12, hp_0 = 0;h < h12 + 3;h += 1, hp_0 += 1){
							...
							for (w = w12, wp_0 = 0;w < w12 + 3;w += 1, wp_0 += 1){
								// y = 4, x = 7, h = 1, w = 1, c = 2, f = 32
								// T (x, 7) (7 / 1)
								for (x = x24, xp_2 = x24_p_1, xp_1 = x24_p_0, xp_0 = 0;x < x24 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
