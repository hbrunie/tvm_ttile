...
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, f); T (4, x); T (14, y); T (2, f); T (1, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c202_p_0, cp_1, c202, f, fp_0, f196_p_0, f197_p_0, fp_1, f196_p_1, fp_2, f196, f197, w, wp_0, x, xp_0, x240_p_0, x241_p_0, xp_1, x240_p_1, xp_2, x240, x241, y, yp_0;
IND_TYPE y120 = 0;
IND_TYPE x242 = 0;
IND_TYPE h = 0;
IND_TYPE w120 = 0;
...
fp_2 = 0;
							for (w = w120, wp_0 = 0;w < w120 + 3;w += 1, wp_0 += 1){
								...
								for (x = x240, xp_2 = x240_p_1, xp_1 = x240_p_0, xp_0 = 0;x < x240 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 128, f = 32
											// T (c, 128) (128 / 1)
											for (c = c202, cp_1 = c202_p_0, cp_0 = 0;c < c202 + 128;c += 1, cp_1 += 1, cp_0 += 1){
