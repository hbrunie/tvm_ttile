...
/*
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (112, x); T (3, w);
  T (3, h); T (28, y); T (1, c); T (1, x)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, h, hp_0, w, wp_0, x, x0, xp_0, x0_p_0, xp_1, y, yp_0;
IND_TYPE y0 = 0;
IND_TYPE x1 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
...
yp_0 = 0;
			for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
				// y = 4, x = 112, h = 1, w = 3, c = 32, f = 32
				// T (w, 3) (3 / 1)
				for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
					// y = 4, x = 112, h = 1, w = 1, c = 32, f = 32
					// T (x, 112) (112 / 1)
					for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 112;x += 1, xp_1 += 1, xp_0 += 1){
