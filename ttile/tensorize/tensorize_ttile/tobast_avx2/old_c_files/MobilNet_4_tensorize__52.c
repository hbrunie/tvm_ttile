...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, f); T (14, x); T (7, y); T (1, f); T (128, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c168_p_0, cp_1, c168, f, fp_0, f188_p_0, f189_p_0, fp_1, f188_p_1, fp_2, f188, f189, w, wp_0, x, xp_0, x260_p_0, x261_p_0, xp_1, x260_p_1, xp_2, x260, x261, y, yp_0;
IND_TYPE y112 = 0;
IND_TYPE x262 = 0;
IND_TYPE h = 0;
IND_TYPE w112 = 0;
