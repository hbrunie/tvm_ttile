...
[V f; U (4, f); ULambda y; U (3, w); T (8, c); Hoist_vars [c]; T (8, x);
  ...
  T (1, f); T (8, c); T (1, f); T (1, c); T (7, x); T (2, f)]
*/
IND_TYPE c, cp_0, c1446_p_0, c1447_p_0, cp_1, c1446_p_1, cp_2, c1446, c1447, f, fp_0, f1372_p_0, f1373_p_0, fp_1, f1372_p_1, fp_2, f1372, f1373, h, hp_0, x, xp_0, x1200_p_0, xp_1, x1200, y, yp_0;
...
for (f1373 = f1374, f1373_p_0 = 0;
	...
	for (x1200 = x1201, x1200_p_0 = 0;
		...
		// T (c, 1) (64 / 64)
		for (c1447 = c1448, c1447_p_0 = 0;
			c1447 < c1448 + 64;
			c1447 += 64, c1447_p_0 += 64){
			// y = 56, x = 8, h = 3, w = 3, c = 64, f = 32
			// T (f, 1) (32 / 32)
			for (f1372 = f1373, f1372_p_1 = f1373_p_0, f1372_p_0 = 0;
				...
				// y = 56, x = 8, h = 3, w = 3, c = 64, f = 32
				// T (c, 8) (64 / 8)
				for (c1446 = c1447, c1446_p_1 = c1447_p_0, c1446_p_0 = 0;
					c1446 < c1447 + 64;
					c1446 += 8, c1446_p_1 += 8, c1446_p_0 += 8){
								...
								for (h = h540, hp_0 = 0;
									...
									for (x = x1200, xp_1 = x1200_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 8) (8 / 1)
												for (c = c1446, cp_2 = c1446_p_1, cp_1 = c1446_p_0, cp_0 = 0;
													c < c1446 + 8;
