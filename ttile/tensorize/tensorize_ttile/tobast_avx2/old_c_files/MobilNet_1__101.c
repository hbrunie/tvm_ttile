...
/*
[V f; U (4, f); U (7, y); U (3, h); T (2, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (7, x); T (16, y); T (16, c); T (2, x)]
*/
IND_TYPE c, cp_0, c336_p_0, cp_1, c336, w, wp_0, x, xp_0, x418_p_0, x419_p_0, xp_1, x418_p_1, xp_2, x418, x419, y, yp_0;
	...
	for (c336 = c337, c336_p_0 = 0;
		...
		for (y = y224, yp_0 = 0;
			...
			for (x418 = x419, x418_p_1 = x419_p_0, x418_p_0 = 0;
				x418 < x419 + 56;
				x418 += 8, x418_p_1 += 8, x418_p_0 += 8){
				// y = 7, x = 8, h = 3, w = 3, c = 2, f = 32
				// T (w, 3) (3 / 1)
				for (w = w224, wp_0 = 0;
					w < w224 + 3;
					w += 1, wp_0 += 1){
					// y = 7, x = 8, h = 3, w = 1, c = 2, f = 32
					// T (x, 8) (8 / 1)
