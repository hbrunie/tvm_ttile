							...
							for (h = h218, hp_0 = 0;h < h218 + 3;h += 1, hp_0 += 1){
								...
								for (w = w232, wp_0 = 0;w < w232 + 3;w += 1, wp_0 += 1){
									...
									for (x = x438, xp_1 = x438_p_0, xp_0 = 0;x < x438 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4216 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_4217 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_4218 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_4219 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_4216);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_4217);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4218);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4219);
									}
								}
							}
}
