...
yp_1 = 0;
								for (w = w462, wp_0 = 0;w < w462 + 3;w += 1, wp_0 += 1){
									...
									for (x = x1024, xp_2 = x1024_p_1, xp_1 = x1024_p_0, xp_0 = 0;x < x1024 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_7194 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_7195 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 8, f = 32
												// T (c, 8) (8 / 1)
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_7194);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_7195);
									}
								}
}
