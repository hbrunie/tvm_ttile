...
[V f; U (4, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (2, f); T (4, x); T (7, y); T (1, f); T (64, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c360_p_0, cp_1, c360, f, fp_0, f434_p_0, f435_p_0, fp_1, f434_p_1, fp_2, f434, f435, h, hp_0, x, xp_0, x526_p_0, x527_p_0, xp_1, x526_p_1, xp_2, x526, x527, y, yp_0;
IND_TYPE y240 = 0;
IND_TYPE x528 = 0;
IND_TYPE h170 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h170, hp_0 = 0;h < h170 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 7) (7 / 1)
								for (x = x526, xp_2 = x526_p_1, xp_1 = x526_p_0, xp_0 = 0;x < x526 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
