...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (4, y); T (2, f); T (2, c); T (2, x); T (17, y); T (1, f);
  T (34, x)]
*/
IND_TYPE c, cp_0, c240_p_0, cp_1, c240, f, fp_0, f230_p_0, fp_1, f230, w, wp_0, x, xp_0, x320_p_0, x321_p_0, xp_1, x320_p_1, xp_2, x320, x321, y, yp_0, y240_p_0, yp_1, y240;
IND_TYPE y241 = 0;
IND_TYPE x322 = 0;
IND_TYPE h = 0;
IND_TYPE w160 = 0;
