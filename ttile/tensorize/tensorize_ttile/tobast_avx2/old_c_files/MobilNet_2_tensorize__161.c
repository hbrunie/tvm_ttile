...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (14, y); T (1, f); T (4, c); T (2, f); T (8, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c156_p_0, c157_p_0, cp_1, c156_p_1, cp_2, c156, c157, f, fp_0, f128_p_0, f129_p_0, fp_1, f128_p_1, fp_2, f128, f129, w, wp_0, x, xp_0, x166_p_0, xp_1, x166, y, yp_0;
IND_TYPE y92 = 0;
IND_TYPE x167 = 0;
IND_TYPE h = 0;
IND_TYPE w92 = 0;
...
yp_0 = 0;
							for (w = w92, wp_0 = 0;w < w92 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 4) (4 / 1)
								for (x = x166, xp_1 = x166_p_0, xp_0 = 0;x < x166 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 2) (2 / 1)
											for (c = c156, cp_2 = c156_p_1, cp_1 = c156_p_0, cp_0 = 0;c < c156 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
