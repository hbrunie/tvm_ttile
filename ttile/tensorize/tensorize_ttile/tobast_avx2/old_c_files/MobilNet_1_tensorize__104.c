...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (14, x); T (28, y); T (32, c); T (8, x)]
*/
IND_TYPE c, cp_0, c192_p_0, cp_1, c192, w, wp_0, x, xp_0, x226_p_0, x227_p_0, xp_1, x226_p_1, xp_2, x226, x227, y, yp_0;
IND_TYPE y128 = 0;
IND_TYPE x228 = 0;
IND_TYPE h = 0;
IND_TYPE w128 = 0;
...
x226_p_1 = 0;
				for (w = w128, wp_0 = 0;w < w128 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x226, xp_2 = x226_p_1, xp_1 = x226_p_0, xp_0 = 0;x < x226 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
