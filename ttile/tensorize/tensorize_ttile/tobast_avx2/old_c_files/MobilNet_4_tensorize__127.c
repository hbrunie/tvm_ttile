...
[V f; U (4, f); U (4, y); T (4, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (2, f); T (2, x); T (7, y); T (7, x); T (2, f); T (32, c);
  T (1, x)]
*/
IND_TYPE c, cp_0, c24_p_0, cp_1, c24, f, fp_0, f24_p_0, fp_1, f24, h, hp_0, w, wp_0, x, xp_0, x40_p_0, x41_p_0, x42_p_0, xp_1, x40_p_1, x41_p_1, xp_2, x40_p_2, xp_3, x40, x41, x42, y, yp_0;
IND_TYPE y16 = 0;
IND_TYPE x43 = 0;
IND_TYPE h16 = 0;
IND_TYPE w16 = 0;
...
fp_1 = 0;
							for (h = h16, hp_0 = 0;h < h16 + 3;h += 1, hp_0 += 1){
								...
								for (w = w16, wp_0 = 0;w < w16 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 2) (2 / 1)
									for (x = x40, xp_3 = x40_p_2, xp_2 = x40_p_1, xp_1 = x40_p_0, xp_0 = 0;x < x40 + 2;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
