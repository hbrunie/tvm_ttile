...
[V f; U (8, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (7, y); T (1, c); T (1, f); T (128, c); T (1, x); T (2, f)]
*/
IND_TYPE c, cp_0, c646_p_0, c647_p_0, cp_1, c646_p_1, cp_2, c646, c647, f, fp_0, f816_p_0, fp_1, f816, h, hp_0, x, xp_0, x888_p_0, xp_1, x888, y, yp_0;
						...
						for (h = h338, hp_0 = 0;
							...
							for (x = x888, xp_1 = x888_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4404 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
										mem_vec_4405 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 40]);
										mem_vec_4406 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
										mem_vec_4407 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 56]);
										...
										mem_vec_4412 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
										mem_vec_4413 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 40]);
										mem_vec_4414 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
										mem_vec_4415 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 56]);
										...
										mem_vec_4420 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32]);
										mem_vec_4421 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 40]);
										mem_vec_4422 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48]);
										mem_vec_4423 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 56]);
										...
										mem_vec_4428 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32]);
										mem_vec_4429 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 40]);
										mem_vec_4430 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48]);
										mem_vec_4431 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 56]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_4404);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 40], mem_vec_4405);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_4406);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 56], mem_vec_4407);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_4412);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 40], mem_vec_4413);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_4414);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 56], mem_vec_4415);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32], mem_vec_4420);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 40], mem_vec_4421);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48], mem_vec_4422);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 56], mem_vec_4423);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32], mem_vec_4428);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 40], mem_vec_4429);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48], mem_vec_4430);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 56], mem_vec_4431);
							}
						}
					}
				}
