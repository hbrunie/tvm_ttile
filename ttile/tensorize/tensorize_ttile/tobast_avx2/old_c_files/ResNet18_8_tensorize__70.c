...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (4, f); T (2, x); T (7, y); T (1, f); T (128, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c118_p_0, cp_1, c118, f, fp_0, f64_p_0, f65_p_0, fp_1, f64_p_1, fp_2, f64, f65, w, wp_0, x, xp_0, x120_p_0, x121_p_0, xp_1, x120_p_1, xp_2, x120, x121, y, yp_0;
IND_TYPE y60 = 0;
IND_TYPE x122 = 0;
IND_TYPE h = 0;
IND_TYPE w60 = 0;
...
fp_2 = 0;
							for (w = w60, wp_0 = 0;w < w60 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x120, xp_2 = x120_p_1, xp_1 = x120_p_0, xp_0 = 0;x < x120 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 1) (1 / 1)
											for (c = c118, cp_1 = c118_p_0, cp_0 = 0;c < c118 + 1;c += 1, cp_1 += 1, cp_0 += 1){
