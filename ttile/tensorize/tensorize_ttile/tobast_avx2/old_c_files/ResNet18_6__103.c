...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, f); T (7, x); T (7, y); T (1, f); T (32, c); T (4, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c246_p_0, cp_1, c246, f, fp_0, f282_p_0, f283_p_0, fp_1, f282_p_1, fp_2, f282, f283, w, wp_0, x, xp_0, x374_p_0, x375_p_0, xp_1, x374_p_1, xp_2, x374, x375, y, yp_0;
	...
	for (x375 = x376, x375_p_0 = 0;
		...
		for (c246 = c247, c246_p_0 = 0;
			...
			for (f282 = f283, f282_p_1 = f283_p_0, f282_p_0 = 0;
				f282 < f283 + 64;
				f282 += 64, f282_p_1 += 64, f282_p_0 += 64){
				// y = 28, x = 7, h = 3, w = 3, c = 4, f = 64
				// T (y, 7) (28 / 4)
				for (y = y164, yp_0 = 0;
					y < y164 + 28;
