...
/*
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (68, x); T (17, y);
  T (1, f); T (1, f); T (16, c); T (1, x); T (4, f)]
*/
IND_TYPE c, cp_0, c90_p_0, cp_1, c90, f, fp_0, f120_p_0, f121_p_0, fp_1, f120_p_1, fp_2, f120, f121, x, xp_0, x90_p_0, xp_1, x90, y, yp_0;
IND_TYPE y60 = 0;
IND_TYPE x91 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
