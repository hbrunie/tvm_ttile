...
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (2, x); T (17, y);
  T (4, f); T (1, f); T (16, c); T (34, x); T (1, f)]
*/
IND_TYPE c, cp_0, c852_p_0, cp_1, c852, f, fp_0, f1136_p_0, f1137_p_0, fp_1, f1136_p_1, fp_2, f1136, f1137, x, xp_0, x852_p_0, xp_1, x852, y, yp_0;
IND_TYPE y568 = 0;
IND_TYPE x853 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
