...
fp_2 = 0;
							for (w = w336, wp_0 = 0;w < w336 + 3;w += 1, wp_0 += 1){
								...
								for (x = x600, xp_1 = x600_p_0, xp_0 = 0;x < x600 + 7;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6354 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											mem_vec_6355 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_6354);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_6355);
								}
							}
}
