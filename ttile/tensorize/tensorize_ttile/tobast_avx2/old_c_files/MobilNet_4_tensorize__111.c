...
[V f; U (4, f); U (4, y); U (3, w); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, f); T (7, x); T (7, y); T (2, f); T (32, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c432_p_0, cp_1, c432, f, fp_0, f540_p_0, f541_p_0, fp_1, f540_p_1, fp_2, f540, f541, h, hp_0, x, xp_0, x612_p_0, x613_p_0, xp_1, x612_p_1, xp_2, x612, x613, y, yp_0;
IND_TYPE y288 = 0;
IND_TYPE x614 = 0;
IND_TYPE h198 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h198, hp_0 = 0;h < h198 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x612, xp_2 = x612_p_1, xp_1 = x612_p_0, xp_0 = 0;x < x612 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
