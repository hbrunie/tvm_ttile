...
fp_2 = 0;
							for (w = w260, wp_0 = 0;w < w260 + 3;w += 1, wp_0 += 1){
								...
								for (x = x390, xp_1 = x390_p_0, xp_0 = 0;x < x390 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4574 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											mem_vec_4575 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4574);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4575);
								}
							}
}
