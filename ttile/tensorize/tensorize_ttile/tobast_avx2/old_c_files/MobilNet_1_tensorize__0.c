...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (1, x); T (28, y); T (4, c); T (14, x)]
*/
IND_TYPE c, cp_0, c198_p_0, cp_1, c198, w, wp_0, x, xp_0, x234_p_0, x235_p_0, xp_1, x234_p_1, xp_2, x234, x235, y, yp_0;
IND_TYPE y132 = 0;
IND_TYPE x236 = 0;
IND_TYPE h = 0;
IND_TYPE w132 = 0;
...
x234_p_1 = 0;
				for (w = w132, wp_0 = 0;w < w132 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 8) (8 / 1)
					for (x = x234, xp_2 = x234_p_1, xp_1 = x234_p_0, xp_0 = 0;x < x234 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
