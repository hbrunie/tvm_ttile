...
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (4, f); T (1, x); T (17, y); T (1, f); T (16, c); T (68, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c210_p_0, cp_1, c210, f, fp_0, f280_p_0, f281_p_0, fp_1, f280_p_1, fp_2, f280, f281, h, hp_0, w, wp_0, x, xp_0, x280_p_0, x281_p_0, xp_1, x280_p_1, xp_2, x280, x281, y, yp_0;
IND_TYPE y140 = 0;
IND_TYPE x282 = 0;
IND_TYPE h140 = 0;
IND_TYPE w140 = 0;
