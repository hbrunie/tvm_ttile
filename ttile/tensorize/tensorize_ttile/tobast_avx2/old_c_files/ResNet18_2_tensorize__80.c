...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (14, y); T (2, f); T (8, c); T (1, f); T (2, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c96_p_0, c97_p_0, cp_1, c96_p_1, cp_2, c96, c97, f, fp_0, f72_p_0, f73_p_0, fp_1, f72_p_1, fp_2, f72, f73, w, wp_0, x, xp_0, x114_p_0, xp_1, x114, y, yp_0;
IND_TYPE y60 = 0;
IND_TYPE x115 = 0;
IND_TYPE h = 0;
IND_TYPE w60 = 0;
