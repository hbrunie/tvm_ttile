...
[V f; U (4, f); U (4, y); T (256, c); Hoist_vars [c]; T (68, x); T (17, y);
  T (2, f); T (2, f); T (1, c); T (1, x); T (1, f)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, f, f0, fp_0, f0_p_0, f1_p_0, f1, fp_1, f0_p_1, fp_2, x, x0, xp_0, x0_p_0, xp_1, y, yp_0;
IND_TYPE y0 = 0;
IND_TYPE x1 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
						for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 68;x += 1, xp_1 += 1, xp_0 += 1){
