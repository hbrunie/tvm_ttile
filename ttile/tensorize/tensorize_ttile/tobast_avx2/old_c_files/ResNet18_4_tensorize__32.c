...
*/
IND_TYPE c, cp_0, c336_p_0, cp_1, c336, f, fp_0, h, hp_0, x, xp_0, x448_p_0, x449_p_0, xp_1, x448_p_1, xp_2, x448, x449, y, yp_0;
IND_TYPE y224 = 0;
IND_TYPE x450 = 0;
IND_TYPE h150 = 0;
IND_TYPE w = 0;
...
c336_p_0 = 0;
					for (h = h150, hp_0 = 0;h < h150 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 2) (2 / 1)
						for (x = x448, xp_2 = x448_p_1, xp_1 = x448_p_0, xp_0 = 0;x < x448 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
