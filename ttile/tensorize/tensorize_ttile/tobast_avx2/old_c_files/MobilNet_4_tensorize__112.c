...
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (7, x); T (7, y); T (4, f); T (1, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c192_p_0, cp_1, c192, f, fp_0, f220_p_0, f221_p_0, fp_1, f220_p_1, fp_2, f220, f221, w, wp_0, x, xp_0, x292_p_0, x293_p_0, xp_1, x292_p_1, xp_2, x292, x293, y, yp_0;
IND_TYPE y128 = 0;
IND_TYPE x294 = 0;
IND_TYPE h = 0;
IND_TYPE w128 = 0;
...
fp_2 = 0;
							for (w = w128, wp_0 = 0;w < w128 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x292, xp_2 = x292_p_1, xp_1 = x292_p_0, xp_0 = 0;x < x292 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
