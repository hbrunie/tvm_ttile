...
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (2, f); T (7, x); T (7, y); T (2, f); T (1, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c150_p_0, cp_1, c150, f, fp_0, f164_p_0, f165_p_0, fp_1, f164_p_1, fp_2, f164, f165, w, wp_0, x, xp_0, x236_p_0, x237_p_0, xp_1, x236_p_1, xp_2, x236, x237, y, yp_0;
IND_TYPE y100 = 0;
IND_TYPE x238 = 0;
IND_TYPE h = 0;
IND_TYPE w100 = 0;
