...
[V f; U (4, f); U (7, y); U (3, w); T (1, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (1, f); T (1, y); T (16, c); T (32, f); T (64, c)]
*/
IND_TYPE c, cp_0, c552_p_0, c553_p_0, cp_1, c552_p_1, cp_2, c552, c553, f, fp_0, f414_p_0, fp_1, f414, h, hp_0, x, xp_0, y, yp_0;
