...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (4, x); T (28, y); T (4, c); T (1, x)]
*/
IND_TYPE c, cp_0, c486_p_0, cp_1, c486, h, hp_0, x, xp_0, x618_p_0, x619_p_0, xp_1, x618_p_1, xp_2, x618, x619, y, yp_0;
IND_TYPE y324 = 0;
IND_TYPE x620 = 0;
IND_TYPE h174 = 0;
IND_TYPE w = 0;
...
x618_p_1 = 0;
				for (h = h174, hp_0 = 0;h < h174 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 28) (28 / 1)
					for (x = x618, xp_2 = x618_p_1, xp_1 = x618_p_0, xp_0 = 0;x < x618 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
