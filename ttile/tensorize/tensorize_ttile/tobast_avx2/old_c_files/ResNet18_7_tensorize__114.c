...
fp_2 = 0;
						for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
							...
							for (x = x102, xp_1 = x102_p_0, xp_0 = 0;x < x102 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_978 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
										mem_vec_979 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
										// y = 7, x = 1, h = 3, w = 1, c = 8, f = 32
										// T (c, 8) (8 / 1)
									...
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_978);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_979);
							}
						}
}
