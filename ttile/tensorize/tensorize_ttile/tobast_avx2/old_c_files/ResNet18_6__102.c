...
[V f; U (4, f); U (7, y); U (3, h); T (2, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (4, f); T (2, x); T (4, y); T (1, f); T (64, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c270_p_0, cp_1, c270, f, fp_0, f314_p_0, f315_p_0, fp_1, f314_p_1, fp_2, f314, f315, w, wp_0, x, xp_0, x406_p_0, x407_p_0, xp_1, x406_p_1, xp_2, x406, x407, y, yp_0;
	...
	for (x407 = x408, x407_p_0 = 0;
		...
		for (c270 = c271, c270_p_0 = 0;
			...
			for (f314 = f315, f314_p_1 = f315_p_0, f314_p_0 = 0;
				f314 < f315 + 128;
				f314 += 128, f314_p_1 += 128, f314_p_0 += 128){
				// y = 28, x = 28, h = 3, w = 3, c = 2, f = 128
				// T (y, 4) (28 / 7)
				for (y = y180, yp_0 = 0;
					y < y180 + 28;
