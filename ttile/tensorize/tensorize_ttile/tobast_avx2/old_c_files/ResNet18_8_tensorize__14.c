...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (1, x); T (7, y); T (1, f); T (128, c); T (28, x);
  T (8, f)]
*/
IND_TYPE c, cp_0, c532_p_0, cp_1, c532, f, fp_0, f616_p_0, f617_p_0, fp_1, f616_p_1, fp_2, f616, f617, h, hp_0, x, xp_0, x672_p_0, x673_p_0, xp_1, x672_p_1, xp_2, x672, x673, y, yp_0;
IND_TYPE y336 = 0;
IND_TYPE x674 = 0;
IND_TYPE h248 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h248, hp_0 = 0;h < h248 + 3;h += 1, hp_0 += 1){
								...
								for (x = x672, xp_2 = x672_p_1, xp_1 = x672_p_0, xp_0 = 0;x < x672 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 1, w = 3, c = 1, f = 32
											// T (c, 1) (1 / 1)
											for (c = c532, cp_1 = c532_p_0, cp_0 = 0;c < c532 + 1;c += 1, cp_1 += 1, cp_0 += 1){
