...
c742_p_1 = 0;
							for (w = w378, wp_0 = 0;w < w378 + 3;w += 1, wp_0 += 1){
								...
								for (x = x864, xp_2 = x864_p_1, xp_1 = x864_p_0, xp_0 = 0;x < x864 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6112 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
											mem_vec_6113 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_6112);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8], mem_vec_6113);
								}
							}
}
