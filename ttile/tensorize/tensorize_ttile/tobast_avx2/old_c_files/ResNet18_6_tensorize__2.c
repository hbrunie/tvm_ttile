...
/*
[V f; U (4, f); U (4, y); T (4, c); Hoist_vars [c]; T (14, x); T (3, w);
...
fp_1 = 0;
							for (h = h4, hp_0 = 0;h < h4 + 3;h += 1, hp_0 += 1){
								...
								for (w = w4, wp_0 = 0;w < w4 + 3;w += 1, wp_0 += 1){
									// y = 4, x = 14, h = 1, w = 1, c = 4, f = 32
									// T (x, 14) (14 / 1)
									for (x = x10, xp_3 = x10_p_2, xp_2 = x10_p_1, xp_1 = x10_p_0, xp_0 = 0;x < x10 + 14;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
