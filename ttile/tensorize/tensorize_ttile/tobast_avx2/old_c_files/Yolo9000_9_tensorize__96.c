...
[V f; U (4, f); U (4, y); T (1, c); Hoist_vars [c]; T (34, x); T (17, y);
  T (2, f); T (1, f); T (256, c); T (2, x); T (2, f)]
*/
IND_TYPE c, cp_0, c360_p_0, cp_1, c360, f, fp_0, f480_p_0, f481_p_0, fp_1, f480_p_1, fp_2, f480, f481, x, xp_0, x360_p_0, xp_1, x360, y, yp_0;
IND_TYPE y240 = 0;
IND_TYPE x361 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
						for (x = x360, xp_1 = x360_p_0, xp_0 = 0;x < x360 + 34;x += 1, xp_1 += 1, xp_0 += 1){
