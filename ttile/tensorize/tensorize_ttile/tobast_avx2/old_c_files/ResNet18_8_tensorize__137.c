...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (1, f); T (7, x); T (7, y); T (4, f); T (16, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c124_p_0, cp_1, c124, f, fp_0, f72_p_0, f73_p_0, fp_1, f72_p_1, fp_2, f72, f73, w, wp_0, x, xp_0, x128_p_0, x129_p_0, xp_1, x128_p_1, xp_2, x128, x129, y, yp_0;
IND_TYPE y64 = 0;
IND_TYPE x130 = 0;
IND_TYPE h = 0;
IND_TYPE w64 = 0;
...
fp_2 = 0;
							for (w = w64, wp_0 = 0;w < w64 + 3;w += 1, wp_0 += 1){
								...
								for (x = x128, xp_2 = x128_p_1, xp_1 = x128_p_0, xp_0 = 0;x < x128 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 8) (8 / 1)
											for (c = c124, cp_1 = c124_p_0, cp_0 = 0;c < c124 + 8;c += 1, cp_1 += 1, cp_0 += 1){
