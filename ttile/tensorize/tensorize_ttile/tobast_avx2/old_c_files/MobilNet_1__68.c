...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, x); T (28, y); T (4, c); T (112, x)]
*/
IND_TYPE c, cp_0, c636_p_0, cp_1, c636, h, hp_0, x, xp_0, x818_p_0, x819_p_0, xp_1, x818_p_1, xp_2, x818, x819, y, yp_0;
		...
		for (y = y424, yp_0 = 0;
			...
			for (x818 = x819, x818_p_1 = x819_p_0, x818_p_0 = 0;
				...
				for (h = h274, hp_0 = 0;
					...
					// T (x, 1) (1 / 1)
					for (x = x818, xp_2 = x818_p_1, xp_1 = x818_p_0, xp_0 = 0;
						x < x818 + 1;
