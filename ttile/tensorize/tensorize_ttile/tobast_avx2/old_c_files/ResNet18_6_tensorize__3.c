...
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (2, f); T (1, x); T (7, y); T (1, f); T (1, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c138_p_0, cp_1, c138, f, fp_0, f138_p_0, f139_p_0, fp_1, f138_p_1, fp_2, f138, f139, w, wp_0, x, xp_0, x230_p_0, x231_p_0, xp_1, x230_p_1, xp_2, x230, x231, y, yp_0;
IND_TYPE y92 = 0;
IND_TYPE x232 = 0;
IND_TYPE h = 0;
IND_TYPE w92 = 0;
