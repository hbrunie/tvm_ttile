...
fp_2 = 0;
							for (w = w378, wp_0 = 0;w < w378 + 3;w += 1, wp_0 += 1){
								...
								for (x = x636, xp_1 = x636_p_0, xp_0 = 0;x < x636 + 14;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6934 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
											mem_vec_6935 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_6934);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24], mem_vec_6935);
								}
							}
}
