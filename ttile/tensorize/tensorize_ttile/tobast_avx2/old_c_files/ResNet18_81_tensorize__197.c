...
c832_p_1 = 0;
							for (w = w394, wp_0 = 0;w < w394 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 7) (7 / 1)
								for (x = x998, xp_2 = x998_p_1, xp_1 = x998_p_0, xp_0 = 0;x < x998 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 1) (1 / 1)
											for (c = c832, cp_2 = c832_p_1, cp_1 = c832_p_0, cp_0 = 0;c < c832 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
