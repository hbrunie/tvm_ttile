...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (68, y); T (2, f); T (4, c); T (1, x); T (1, y); T (1, f);
  T (272, x)]
*/
IND_TYPE c, cp_0, c270_p_0, cp_1, c270, f, fp_0, f260_p_0, fp_1, f260, w, wp_0, x, xp_0, x360_p_0, x361_p_0, xp_1, x360_p_1, xp_2, x360, x361, y, yp_0, y270_p_0, yp_1, y270;
IND_TYPE y271 = 0;
IND_TYPE x362 = 0;
IND_TYPE h = 0;
IND_TYPE w180 = 0;
