...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (14, y); T (1, f); T (16, c); T (2, f); T (1, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c112_p_0, c113_p_0, cp_1, c112_p_1, cp_2, c112, c113, f, fp_0, f88_p_0, f89_p_0, fp_1, f88_p_1, fp_2, f88, f89, w, wp_0, x, xp_0, x126_p_0, xp_1, x126, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x127 = 0;
IND_TYPE h = 0;
IND_TYPE w68 = 0;
...
yp_0 = 0;
							for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
								// y = 4, x = 8, h = 3, w = 1, c = 4, f = 32
								// T (x, 8) (8 / 1)
								for (x = x126, xp_1 = x126_p_0, xp_0 = 0;x < x126 + 8;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 4) (4 / 1)
											for (c = c112, cp_2 = c112_p_1, cp_1 = c112_p_0, cp_0 = 0;c < c112 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
