...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, x); T (28, y); T (32, c); T (112, x)]
*/
IND_TYPE c, cp_0, c282_p_0, cp_1, c282, w, wp_0, x, xp_0, x346_p_0, x347_p_0, xp_1, x346_p_1, xp_2, x346, x347, y, yp_0;
IND_TYPE y188 = 0;
IND_TYPE x348 = 0;
IND_TYPE h = 0;
IND_TYPE w188 = 0;
...
x346_p_1 = 0;
				for (w = w188, wp_0 = 0;w < w188 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x346, xp_2 = x346_p_1, xp_1 = x346_p_0, xp_0 = 0;x < x346 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
