...
/*
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (34, x);
  T (3, w); T (68, y); T (1, f); T (1, c); T (2, x); T (1, y); T (2, f);
  T (4, x)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, f, fp_0, f194_p_0, fp_1, f194, w, wp_0, x, xp_0, x272_p_0, x273_p_0, xp_1, x272_p_1, xp_2, x272, x273, y, yp_0, y204_p_0, yp_1, y204;
IND_TYPE y205 = 0;
IND_TYPE x274 = 0;
IND_TYPE h = 0;
IND_TYPE w136 = 0;
