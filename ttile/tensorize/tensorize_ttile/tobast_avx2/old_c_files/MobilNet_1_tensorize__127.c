...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, x); T (28, y); T (1, c); T (14, x)]
*/
IND_TYPE c, cp_0, c216_p_0, cp_1, c216, w, wp_0, x, xp_0, x258_p_0, x259_p_0, xp_1, x258_p_1, xp_2, x258, x259, y, yp_0;
IND_TYPE y144 = 0;
IND_TYPE x260 = 0;
IND_TYPE h = 0;
IND_TYPE w144 = 0;
...
x258_p_1 = 0;
				for (w = w144, wp_0 = 0;w < w144 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 2) (2 / 1)
					for (x = x258, xp_2 = x258_p_1, xp_1 = x258_p_0, xp_0 = 0;x < x258 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
