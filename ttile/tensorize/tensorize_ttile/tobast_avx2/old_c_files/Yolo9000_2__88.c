...
[V f; U (2, f); ULambda y; U (3, h); T (16, c); Hoist_vars [c]; T (68, x);
  ...
  T (4, x)]
*/
IND_TYPE c, cp_0, c522_p_0, cp_1, c522, f, fp_0, w, wp_0, x, xp_0, x696_p_0, x697_p_0, xp_1, x696_p_1, xp_2, x696, x697, y, yp_0, y522_p_0, yp_1, y522;
		...
		f += 16, fp_0 += 16){
			for (y522 = y523, y522_p_0 = 0;
				...
				for (x696 = x697, x696_p_1 = x697_p_0, x696_p_0 = 0;
					x696 < x697 + 68;
					x696 += 68, x696_p_1 += 68, x696_p_0 += 68){
					// y = 8 * ph_y, x = 68, h = 3, w = 3, c = 32, f = 16
					// T (y, 8) (8 * ph_y / ph_y)
			...
			for (y522 = y523 + 64, y522_p_0 = 0;
				y522 < y523 + 64 + 208;
				y522 += 104, y522_p_0 += 104){
				// y = 8 * ph_y, x = 68, h = 3, w = 3, c = 32, f = 16
				// T (x, 1) (68 / 68)
				for (x696 = x697, x696_p_1 = x697_p_0, x696_p_0 = 0;
					x696 < x697 + 68;
							...
							for (w = w298, wp_0 = 0;
								...
								for (x = x696, xp_2 = x696_p_1, xp_1 = x696_p_0, xp_0 = 0;
									...
									x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3678 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
											mem_vec_3679 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 8]);
											mem_vec_3680 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_3681 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 8]);
											mem_vec_3682 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_3683 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 8]);
											mem_vec_3684 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_3685 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 8]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 16, f = 16
											// T (c, 16) (16 / 1)
											for (c = c522, cp_1 = c522_p_0, cp_0 = 0;
												c < c522 + 16;
												...
												vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_3678);
												mem_vec_3678 = vec_29;



												vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_3679);
												mem_vec_3679 = vec_31;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
												vec_33 = _mm256_set1_ps(scal_10);


												vec_32 = _mm256_fmadd_ps(vec_33, vec_2, mem_vec_3680);
												mem_vec_3680 = vec_32;



												vec_34 = _mm256_fmadd_ps(vec_33, vec_4, mem_vec_3681);
												mem_vec_3681 = vec_34;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
												vec_36 = _mm256_set1_ps(scal_11);


												vec_35 = _mm256_fmadd_ps(vec_36, vec_2, mem_vec_3682);
												mem_vec_3682 = vec_35;



												vec_37 = _mm256_fmadd_ps(vec_36, vec_4, mem_vec_3683);
												mem_vec_3683 = vec_37;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
												vec_39 = _mm256_set1_ps(scal_12);


												vec_38 = _mm256_fmadd_ps(vec_39, vec_2, mem_vec_3684);
												mem_vec_3684 = vec_38;



												vec_40 = _mm256_fmadd_ps(vec_39, vec_4, mem_vec_3685);
												mem_vec_3685 = vec_40;
												scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
												vec_42 = _mm256_set1_ps(scal_13);
												vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

												vec_41 = _mm256_fmadd_ps(vec_42, vec_43, mem_vec_3660);
												mem_vec_3660 = vec_41;

												vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_44 = _mm256_fmadd_ps(vec_42, vec_45, mem_vec_3661);
												mem_vec_3661 = vec_44;
												scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_47 = _mm256_set1_ps(scal_14);


												vec_46 = _mm256_fmadd_ps(vec_47, vec_43, mem_vec_3662);
												mem_vec_3662 = vec_46;



												vec_48 = _mm256_fmadd_ps(vec_47, vec_45, mem_vec_3663);
												mem_vec_3663 = vec_48;
												scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_50 = _mm256_set1_ps(scal_15);


												vec_49 = _mm256_fmadd_ps(vec_50, vec_43, mem_vec_3664);
												mem_vec_3664 = vec_49;



												vec_51 = _mm256_fmadd_ps(vec_50, vec_45, mem_vec_3665);
												mem_vec_3665 = vec_51;
												scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_53 = _mm256_set1_ps(scal_16);


												vec_52 = _mm256_fmadd_ps(vec_53, vec_43, mem_vec_3666);
												mem_vec_3666 = vec_52;



												vec_54 = _mm256_fmadd_ps(vec_53, vec_45, mem_vec_3667);
												mem_vec_3667 = vec_54;
												scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
												vec_56 = _mm256_set1_ps(scal_17);


												vec_55 = _mm256_fmadd_ps(vec_56, vec_43, mem_vec_3668);
												mem_vec_3668 = vec_55;



												vec_57 = _mm256_fmadd_ps(vec_56, vec_45, mem_vec_3669);
												mem_vec_3669 = vec_57;
												scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
												vec_59 = _mm256_set1_ps(scal_18);


												vec_58 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_3670);
												mem_vec_3670 = vec_58;



												vec_60 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_3671);
												mem_vec_3671 = vec_60;
												scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
												vec_62 = _mm256_set1_ps(scal_19);


												vec_61 = _mm256_fmadd_ps(vec_62, vec_43, mem_vec_3672);
												mem_vec_3672 = vec_61;



												vec_63 = _mm256_fmadd_ps(vec_62, vec_45, mem_vec_3673);
												mem_vec_3673 = vec_63;
												scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
												vec_65 = _mm256_set1_ps(scal_20);


												vec_64 = _mm256_fmadd_ps(vec_65, vec_43, mem_vec_3674);
												mem_vec_3674 = vec_64;



												vec_66 = _mm256_fmadd_ps(vec_65, vec_45, mem_vec_3675);
												mem_vec_3675 = vec_66;
												scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
												vec_68 = _mm256_set1_ps(scal_21);


												vec_67 = _mm256_fmadd_ps(vec_68, vec_43, mem_vec_3676);
												mem_vec_3676 = vec_67;



												vec_69 = _mm256_fmadd_ps(vec_68, vec_45, mem_vec_3677);
												mem_vec_3677 = vec_69;
												scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
												vec_71 = _mm256_set1_ps(scal_22);


												vec_70 = _mm256_fmadd_ps(vec_71, vec_43, mem_vec_3678);
												mem_vec_3678 = vec_70;



												vec_72 = _mm256_fmadd_ps(vec_71, vec_45, mem_vec_3679);
												mem_vec_3679 = vec_72;
												scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
												vec_74 = _mm256_set1_ps(scal_23);


												vec_73 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_3680);
												mem_vec_3680 = vec_73;



												vec_75 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_3681);
												mem_vec_3681 = vec_75;
												scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
												vec_77 = _mm256_set1_ps(scal_24);


												vec_76 = _mm256_fmadd_ps(vec_77, vec_43, mem_vec_3682);
												mem_vec_3682 = vec_76;



												vec_78 = _mm256_fmadd_ps(vec_77, vec_45, mem_vec_3683);
												mem_vec_3683 = vec_78;
												scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
												vec_80 = _mm256_set1_ps(scal_25);


												vec_79 = _mm256_fmadd_ps(vec_80, vec_43, mem_vec_3684);
												mem_vec_3684 = vec_79;



												vec_81 = _mm256_fmadd_ps(vec_80, vec_45, mem_vec_3685);
												mem_vec_3685 = vec_81;
												scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_83 = _mm256_set1_ps(scal_26);
												vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_82 = _mm256_fmadd_ps(vec_83, vec_84, mem_vec_3660);
												mem_vec_3660 = vec_82;

												vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_85 = _mm256_fmadd_ps(vec_83, vec_86, mem_vec_3661);
												mem_vec_3661 = vec_85;
												scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_88 = _mm256_set1_ps(scal_27);


												vec_87 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_3662);
												mem_vec_3662 = vec_87;



												vec_89 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_3663);
												mem_vec_3663 = vec_89;
												scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_91 = _mm256_set1_ps(scal_28);


												vec_90 = _mm256_fmadd_ps(vec_91, vec_84, mem_vec_3664);
												mem_vec_3664 = vec_90;



												vec_92 = _mm256_fmadd_ps(vec_91, vec_86, mem_vec_3665);
												mem_vec_3665 = vec_92;
												scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_94 = _mm256_set1_ps(scal_29);


												vec_93 = _mm256_fmadd_ps(vec_94, vec_84, mem_vec_3666);
												mem_vec_3666 = vec_93;



												vec_95 = _mm256_fmadd_ps(vec_94, vec_86, mem_vec_3667);
												mem_vec_3667 = vec_95;
												scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
												vec_97 = _mm256_set1_ps(scal_30);


												vec_96 = _mm256_fmadd_ps(vec_97, vec_84, mem_vec_3668);
												mem_vec_3668 = vec_96;



												vec_98 = _mm256_fmadd_ps(vec_97, vec_86, mem_vec_3669);
												mem_vec_3669 = vec_98;
												scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
												vec_100 = _mm256_set1_ps(scal_31);


												vec_99 = _mm256_fmadd_ps(vec_100, vec_84, mem_vec_3670);
												mem_vec_3670 = vec_99;



												vec_101 = _mm256_fmadd_ps(vec_100, vec_86, mem_vec_3671);
												mem_vec_3671 = vec_101;
												scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
												vec_103 = _mm256_set1_ps(scal_32);


												vec_102 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_3672);
												mem_vec_3672 = vec_102;



												vec_104 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_3673);
												mem_vec_3673 = vec_104;
												scal_33 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
												vec_106 = _mm256_set1_ps(scal_33);


												vec_105 = _mm256_fmadd_ps(vec_106, vec_84, mem_vec_3674);
												mem_vec_3674 = vec_105;



												vec_107 = _mm256_fmadd_ps(vec_106, vec_86, mem_vec_3675);
												mem_vec_3675 = vec_107;
												scal_34 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
												vec_109 = _mm256_set1_ps(scal_34);


												vec_108 = _mm256_fmadd_ps(vec_109, vec_84, mem_vec_3676);
												mem_vec_3676 = vec_108;



												vec_110 = _mm256_fmadd_ps(vec_109, vec_86, mem_vec_3677);
												mem_vec_3677 = vec_110;
												scal_35 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
												vec_112 = _mm256_set1_ps(scal_35);


												vec_111 = _mm256_fmadd_ps(vec_112, vec_84, mem_vec_3678);
												mem_vec_3678 = vec_111;



												vec_113 = _mm256_fmadd_ps(vec_112, vec_86, mem_vec_3679);
												mem_vec_3679 = vec_113;
												scal_36 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
												vec_115 = _mm256_set1_ps(scal_36);


												vec_114 = _mm256_fmadd_ps(vec_115, vec_84, mem_vec_3680);
												mem_vec_3680 = vec_114;



												vec_116 = _mm256_fmadd_ps(vec_115, vec_86, mem_vec_3681);
												mem_vec_3681 = vec_116;
												scal_37 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 2) + c];
												vec_118 = _mm256_set1_ps(scal_37);


												vec_117 = _mm256_fmadd_ps(vec_118, vec_84, mem_vec_3682);
												mem_vec_3682 = vec_117;



												vec_119 = _mm256_fmadd_ps(vec_118, vec_86, mem_vec_3683);
												mem_vec_3683 = vec_119;
												scal_38 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 2) + c];
												vec_121 = _mm256_set1_ps(scal_38);


												vec_120 = _mm256_fmadd_ps(vec_121, vec_84, mem_vec_3684);
												mem_vec_3684 = vec_120;



												vec_122 = _mm256_fmadd_ps(vec_121, vec_86, mem_vec_3685);
												mem_vec_3685 = vec_122;
											}
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_3678);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 8], mem_vec_3679);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_3680);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 8], mem_vec_3681);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3682);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 8], mem_vec_3683);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_3684);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 8], mem_vec_3685);
								}
							}
						}
					}
