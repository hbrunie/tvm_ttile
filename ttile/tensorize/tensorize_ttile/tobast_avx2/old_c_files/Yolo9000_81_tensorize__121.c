...
c1046_p_2 = 0;
							for (w = w508, wp_0 = 0;w < w508 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 4) (4 / 1)
								for (x = x1204, xp_1 = x1204_p_0, xp_0 = 0;x < x1204 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 64) (64 / 1)
											for (c = c1046, cp_3 = c1046_p_2, cp_2 = c1046_p_1, cp_1 = c1046_p_0, cp_0 = 0;c < c1046 + 64;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
