...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (14, y); T (2, f); T (1, c); T (1, f); T (16, c); T (8, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c148_p_0, c149_p_0, cp_1, c148_p_1, cp_2, c148, c149, f, fp_0, f120_p_0, f121_p_0, fp_1, f120_p_1, fp_2, f120, f121, w, wp_0, x, xp_0, x160_p_0, xp_1, x160, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x161 = 0;
IND_TYPE h = 0;
IND_TYPE w88 = 0;
...
yp_0 = 0;
							for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 7) (7 / 1)
								for (x = x160, xp_1 = x160_p_0, xp_0 = 0;x < x160 + 7;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 4) (4 / 1)
											for (c = c148, cp_2 = c148_p_1, cp_1 = c148_p_0, cp_0 = 0;c < c148 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
