...
for (c172 = c173, c172_p_0 = 0;
	...
	for (x137 = x138, x137_p_0 = 0;
		...
		for (f = f68, fp_0 = 0;
			...
			// T (c, 8) (64 / 8)
			for (c171 = c172, c171_p_1 = c172_p_0, c171_p_0 = 0;
				c171 < c172 + 64;
				c171 += 8, c171_p_1 += 8, c171_p_0 += 8){
					for (y = y68, yp_0 = 0;
						y < y68 + 24;
						y += 8, yp_0 += 8){
						...
						for (x136 = x137, x136_p_1 = x137_p_0, x136_p_0 = 0;
							...
							// y = ph_y, x = 17, h = 3, w = 3, c = 8, f = 16
							// T (c, 1) (8 / 8)
							for (c170 = c171, c170_p_2 = c171_p_1, c170_p_1 = c171_p_0, c170_p_0 = 0;
								c170 < c171 + 8;
								c170 += 8, c170_p_2 += 8, c170_p_1 += 8, c170_p_0 += 8){
								// y = ph_y, x = 17, h = 3, w = 3, c = 8, f = 16
								// T (w, 3) (3 / 1)
								for (w = w68, wp_0 = 0;
									w < w68 + 3;
									...
									for (x = x136, xp_2 = x136_p_1, xp_1 = x136_p_0, xp_0 = 0;
										...
										x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_1226 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
												mem_vec_1227 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
												mem_vec_1228 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
												mem_vec_1229 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
												mem_vec_1230 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
												mem_vec_1231 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
												mem_vec_1232 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
												mem_vec_1233 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8]);
												mem_vec_1234 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
												mem_vec_1235 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
												mem_vec_1236 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
												mem_vec_1237 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
												mem_vec_1238 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
												mem_vec_1239 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 8]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 8, f = 16
												// T (c, 8) (8 / 1)
												for (c = c170, cp_3 = c170_p_2, cp_2 = c170_p_1, cp_1 = c170_p_0, cp_0 = 0;
													c < c170 + 8;
											...
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_1226);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_1227);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_1228);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_1229);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_1230);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_1231);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_1232);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8], mem_vec_1233);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_1234);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_1235);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_1236);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_1237);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_1238);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 8], mem_vec_1239);
									}
								}
							}
						}
									...
									for (x = x136, xp_2 = x136_p_1, xp_1 = x136_p_0, xp_0 = 0;
										...
										x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c170, cp_3 = c170_p_2, cp_2 = c170_p_1, cp_1 = c170_p_0, cp_0 = 0;
													...
													vec_32 = _mm256_fmadd_ps(vec_33, vec_34, mem_vec_1240);
													mem_vec_1240 = vec_32;

													vec_36 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

													vec_35 = _mm256_fmadd_ps(vec_33, vec_36, mem_vec_1241);
													mem_vec_1241 = vec_35;
													scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
													vec_38 = _mm256_set1_ps(scal_11);


													vec_37 = _mm256_fmadd_ps(vec_38, vec_34, mem_vec_1242);
													mem_vec_1242 = vec_37;



													vec_39 = _mm256_fmadd_ps(vec_38, vec_36, mem_vec_1243);
													mem_vec_1243 = vec_39;
													scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
													vec_41 = _mm256_set1_ps(scal_12);


													vec_40 = _mm256_fmadd_ps(vec_41, vec_34, mem_vec_1244);
													mem_vec_1244 = vec_40;



													vec_42 = _mm256_fmadd_ps(vec_41, vec_36, mem_vec_1245);
													mem_vec_1245 = vec_42;
													scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
													vec_44 = _mm256_set1_ps(scal_13);


													vec_43 = _mm256_fmadd_ps(vec_44, vec_34, mem_vec_1246);
													mem_vec_1246 = vec_43;



													vec_45 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_1247);
													mem_vec_1247 = vec_45;
													scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
													vec_47 = _mm256_set1_ps(scal_14);


													vec_46 = _mm256_fmadd_ps(vec_47, vec_34, mem_vec_1248);
													mem_vec_1248 = vec_46;



													vec_48 = _mm256_fmadd_ps(vec_47, vec_36, mem_vec_1249);
													mem_vec_1249 = vec_48;
													scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
													vec_50 = _mm256_set1_ps(scal_15);


													vec_49 = _mm256_fmadd_ps(vec_50, vec_34, mem_vec_1250);
													mem_vec_1250 = vec_49;



													vec_51 = _mm256_fmadd_ps(vec_50, vec_36, mem_vec_1251);
													mem_vec_1251 = vec_51;
													scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
													vec_53 = _mm256_set1_ps(scal_16);


													vec_52 = _mm256_fmadd_ps(vec_53, vec_34, mem_vec_1252);
													mem_vec_1252 = vec_52;



													vec_54 = _mm256_fmadd_ps(vec_53, vec_36, mem_vec_1253);
													mem_vec_1253 = vec_54;
													scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
													vec_56 = _mm256_set1_ps(scal_17);


													vec_55 = _mm256_fmadd_ps(vec_56, vec_34, mem_vec_1254);
													mem_vec_1254 = vec_55;



													vec_57 = _mm256_fmadd_ps(vec_56, vec_36, mem_vec_1255);
													mem_vec_1255 = vec_57;
													scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
													vec_59 = _mm256_set1_ps(scal_18);


													vec_58 = _mm256_fmadd_ps(vec_59, vec_34, mem_vec_1256);
													mem_vec_1256 = vec_58;



													vec_60 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_1257);
													mem_vec_1257 = vec_60;
													scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
													vec_62 = _mm256_set1_ps(scal_19);


													vec_61 = _mm256_fmadd_ps(vec_62, vec_34, mem_vec_1258);
													mem_vec_1258 = vec_61;



													vec_63 = _mm256_fmadd_ps(vec_62, vec_36, mem_vec_1259);
													mem_vec_1259 = vec_63;
													scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
													vec_65 = _mm256_set1_ps(scal_20);
													vec_66 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

													vec_64 = _mm256_fmadd_ps(vec_65, vec_66, mem_vec_1240);
													mem_vec_1240 = vec_64;

													vec_68 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

													vec_67 = _mm256_fmadd_ps(vec_65, vec_68, mem_vec_1241);
													mem_vec_1241 = vec_67;
													scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
													vec_70 = _mm256_set1_ps(scal_21);


													vec_69 = _mm256_fmadd_ps(vec_70, vec_66, mem_vec_1242);
													mem_vec_1242 = vec_69;



													vec_71 = _mm256_fmadd_ps(vec_70, vec_68, mem_vec_1243);
													mem_vec_1243 = vec_71;
													scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
													vec_73 = _mm256_set1_ps(scal_22);


													vec_72 = _mm256_fmadd_ps(vec_73, vec_66, mem_vec_1244);
													mem_vec_1244 = vec_72;



													vec_74 = _mm256_fmadd_ps(vec_73, vec_68, mem_vec_1245);
													mem_vec_1245 = vec_74;
													scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
													vec_76 = _mm256_set1_ps(scal_23);


													vec_75 = _mm256_fmadd_ps(vec_76, vec_66, mem_vec_1246);
													mem_vec_1246 = vec_75;



													vec_77 = _mm256_fmadd_ps(vec_76, vec_68, mem_vec_1247);
													mem_vec_1247 = vec_77;
													scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
													vec_79 = _mm256_set1_ps(scal_24);


													vec_78 = _mm256_fmadd_ps(vec_79, vec_66, mem_vec_1248);
													mem_vec_1248 = vec_78;



													vec_80 = _mm256_fmadd_ps(vec_79, vec_68, mem_vec_1249);
													mem_vec_1249 = vec_80;
													scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
													vec_82 = _mm256_set1_ps(scal_25);


													vec_81 = _mm256_fmadd_ps(vec_82, vec_66, mem_vec_1250);
													mem_vec_1250 = vec_81;



													vec_83 = _mm256_fmadd_ps(vec_82, vec_68, mem_vec_1251);
													mem_vec_1251 = vec_83;
													scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
													vec_85 = _mm256_set1_ps(scal_26);


													vec_84 = _mm256_fmadd_ps(vec_85, vec_66, mem_vec_1252);
													mem_vec_1252 = vec_84;



													vec_86 = _mm256_fmadd_ps(vec_85, vec_68, mem_vec_1253);
													mem_vec_1253 = vec_86;
													scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
													vec_88 = _mm256_set1_ps(scal_27);


													vec_87 = _mm256_fmadd_ps(vec_88, vec_66, mem_vec_1254);
													mem_vec_1254 = vec_87;



													vec_89 = _mm256_fmadd_ps(vec_88, vec_68, mem_vec_1255);
													mem_vec_1255 = vec_89;
													scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
													vec_91 = _mm256_set1_ps(scal_28);


													vec_90 = _mm256_fmadd_ps(vec_91, vec_66, mem_vec_1256);
													mem_vec_1256 = vec_90;



													vec_92 = _mm256_fmadd_ps(vec_91, vec_68, mem_vec_1257);
													mem_vec_1257 = vec_92;
													scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
													vec_94 = _mm256_set1_ps(scal_29);


													vec_93 = _mm256_fmadd_ps(vec_94, vec_66, mem_vec_1258);
													mem_vec_1258 = vec_93;



													vec_95 = _mm256_fmadd_ps(vec_94, vec_68, mem_vec_1259);
													mem_vec_1259 = vec_95;
												}
