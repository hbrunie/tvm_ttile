...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, f); T (2, x); T (7, y); T (1, f); T (8, c); T (7, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c190_p_0, cp_1, c190, f, fp_0, f160_p_0, f161_p_0, fp_1, f160_p_1, fp_2, f160, f161, w, wp_0, x, xp_0, x216_p_0, x217_p_0, xp_1, x216_p_1, xp_2, x216, x217, y, yp_0;
IND_TYPE y108 = 0;
IND_TYPE x218 = 0;
IND_TYPE h = 0;
IND_TYPE w108 = 0;
...
fp_2 = 0;
							for (w = w108, wp_0 = 0;w < w108 + 3;w += 1, wp_0 += 1){
								...
								for (x = x216, xp_2 = x216_p_1, xp_1 = x216_p_0, xp_0 = 0;x < x216 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 16) (16 / 1)
											for (c = c190, cp_1 = c190_p_0, cp_0 = 0;c < c190 + 16;c += 1, cp_1 += 1, cp_0 += 1){
