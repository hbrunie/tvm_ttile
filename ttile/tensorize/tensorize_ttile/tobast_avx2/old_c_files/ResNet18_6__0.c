...
[V f; U (4, f); U (4, y); U (3, h); T (64, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, f); T (7, x); T (7, y); T (1, f); T (2, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, f, fp_0, f250_p_0, f251_p_0, fp_1, f250_p_1, fp_2, f250, f251, w, wp_0, x, xp_0, x342_p_0, x343_p_0, xp_1, x342_p_1, xp_2, x342, x343, y, yp_0;
	...
	for (x343 = x344, x343_p_0 = 0;
		...
		for (c222 = c223, c222_p_0 = 0;
			...
			for (f250 = f251, f250_p_1 = f251_p_0, f250_p_0 = 0;
				f250 < f251 + 64;
				f250 += 64, f250_p_1 += 64, f250_p_0 += 64){
				// y = 28, x = 14, h = 3, w = 3, c = 64, f = 64
				// T (y, 7) (28 / 4)
				for (y = y148, yp_0 = 0;
					y < y148 + 28;
