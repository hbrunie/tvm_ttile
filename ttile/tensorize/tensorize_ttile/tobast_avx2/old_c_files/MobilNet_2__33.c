...
[V f; U (4, f); ULambda y; U (3, w); T (1, c); Hoist_vars [c]; T (14, x);
  ...
  T (1, f); T (1, c); T (1, f); T (64, c); T (4, x); T (2, f)]
*/
IND_TYPE c, cp_0, c1438_p_0, c1439_p_0, cp_1, c1438_p_1, cp_2, c1438, c1439, f, fp_0, f1364_p_0, f1365_p_0, fp_1, f1364_p_1, fp_2, f1364, f1365, h, hp_0, x, xp_0, x1194_p_0, xp_1, x1194, y, yp_0;
...
for (f1365 = f1366, f1365_p_0 = 0;
	...
	for (x1194 = x1195, x1194_p_0 = 0;
		x1194 < x1195 + 56;
		x1194 += 14, x1194_p_0 += 14){
		// y = 56, x = 14, h = 3, w = 3, c = 64, f = 32
		// T (c, 64) (64 / 1)
		for (c1439 = c1440, c1439_p_0 = 0;
			c1439 < c1440 + 64;
			c1439 += 1, c1439_p_0 += 1){
			...
			for (f1364 = f1365, f1364_p_1 = f1365_p_0, f1364_p_0 = 0;
				...
				// y = 56, x = 14, h = 3, w = 3, c = 1, f = 32
				// T (c, 1) (1 / 1)
				for (c1438 = c1439, c1438_p_1 = c1439_p_0, c1438_p_0 = 0;
					c1438 < c1439 + 1;
					c1438 += 1, c1438_p_1 += 1, c1438_p_0 += 1){
					// y = 56, x = 14, h = 3, w = 3, c = 1, f = 32
					// T (f, 1) (32 / 32)
								...
								for (h = h536, hp_0 = 0;
									...
									for (x = x1194, xp_1 = x1194_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 1) (1 / 1)
												for (c = c1438, cp_2 = c1438_p_1, cp_1 = c1438_p_0, cp_0 = 0;
													c < c1438 + 1;
