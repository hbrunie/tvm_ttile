...
[V f; U (4, f); U (4, y); U (3, h); T (64, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (1, f); T (7, x); T (7, y); T (2, f); T (4, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c132_p_0, cp_1, c132, f, fp_0, f176_p_0, f177_p_0, fp_1, f176_p_1, fp_2, f176, f177, w, wp_0, x, xp_0, x176_p_0, x177_p_0, xp_1, x176_p_1, xp_2, x176, x177, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x178 = 0;
IND_TYPE h = 0;
IND_TYPE w88 = 0;
