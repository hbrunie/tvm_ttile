...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (34, y); T (2, f); T (1, c); T (34, x); T (2, y); T (1, f);
  T (8, x)]
*/
IND_TYPE c, cp_0, c348_p_0, cp_1, c348, f, fp_0, f338_p_0, fp_1, f338, h, hp_0, x, xp_0, x464_p_0, x465_p_0, xp_1, x464_p_1, xp_2, x464, x465, y, yp_0, y348_p_0, yp_1, y348;
IND_TYPE y349 = 0;
IND_TYPE x466 = 0;
IND_TYPE h184 = 0;
IND_TYPE w = 0;
