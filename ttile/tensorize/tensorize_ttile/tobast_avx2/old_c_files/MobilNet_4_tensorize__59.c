...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (14, x); T (7, y); T (1, f); T (64, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c162_p_0, cp_1, c162, f, fp_0, f180_p_0, f181_p_0, fp_1, f180_p_1, fp_2, f180, f181, w, wp_0, x, xp_0, x252_p_0, x253_p_0, xp_1, x252_p_1, xp_2, x252, x253, y, yp_0;
IND_TYPE y108 = 0;
IND_TYPE x254 = 0;
IND_TYPE h = 0;
IND_TYPE w108 = 0;
...
fp_2 = 0;
							for (w = w108, wp_0 = 0;w < w108 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x252, xp_2 = x252_p_1, xp_1 = x252_p_0, xp_0 = 0;x < x252 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
