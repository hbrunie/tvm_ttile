...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (16, x); T (28, y); T (2, c); T (7, x)]
*/
IND_TYPE c, cp_0, c162_p_0, cp_1, c162, w, wp_0, x, xp_0, x186_p_0, x187_p_0, xp_1, x186_p_1, xp_2, x186, x187, y, yp_0;
IND_TYPE y108 = 0;
IND_TYPE x188 = 0;
IND_TYPE h = 0;
IND_TYPE w108 = 0;
...
x186_p_1 = 0;
				for (w = w108, wp_0 = 0;w < w108 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x186, xp_2 = x186_p_1, xp_1 = x186_p_0, xp_0 = 0;x < x186 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
