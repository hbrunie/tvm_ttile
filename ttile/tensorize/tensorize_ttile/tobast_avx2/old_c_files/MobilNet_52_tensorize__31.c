...
fp_2 = 0;
								for (w = w544, wp_0 = 0;w < w544 + 3;w += 1, wp_0 += 1){
									...
									for (x = x1296, xp_2 = x1296_p_1, xp_1 = x1296_p_0, xp_0 = 0;x < x1296 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_8676 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
												mem_vec_8677 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8]);
												mem_vec_8678 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
												mem_vec_8679 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_8676);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8], mem_vec_8677);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_8678);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24], mem_vec_8679);
									}
								}
}
