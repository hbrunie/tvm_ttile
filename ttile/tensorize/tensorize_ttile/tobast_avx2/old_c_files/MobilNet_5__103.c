...
[V f; U (4, f); U (7, y); U (3, h); T (8, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, f); T (1, x); T (4, y); T (2, f); T (32, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c360_p_0, cp_1, c360, f, fp_0, f480_p_0, f481_p_0, fp_1, f480_p_1, fp_2, f480, f481, w, wp_0, x, xp_0, x480_p_0, x481_p_0, xp_1, x480_p_1, xp_2, x480, x481, y, yp_0;
