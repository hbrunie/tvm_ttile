...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (17, x);
  T (3, h); T (34, y); T (2, f); T (4, c); T (4, x); T (2, y); T (1, f);
  T (4, x)]
*/
IND_TYPE c, cp_0, c336_p_0, cp_1, c336, f, fp_0, f326_p_0, fp_1, f326, h, hp_0, x, xp_0, x448_p_0, x449_p_0, xp_1, x448_p_1, xp_2, x448, x449, y, yp_0, y336_p_0, yp_1, y336;
IND_TYPE y337 = 0;
IND_TYPE x450 = 0;
IND_TYPE h176 = 0;
IND_TYPE w = 0;
