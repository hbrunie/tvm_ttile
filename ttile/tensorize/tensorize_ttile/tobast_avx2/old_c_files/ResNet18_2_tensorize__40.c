...
x506_p_1 = 0;
				for (h = h252, hp_0 = 0;h < h252 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 8) (8 / 1)
					for (x = x506, xp_2 = x506_p_1, xp_1 = x506_p_0, xp_0 = 0;x < x506 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_3364 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
								mem_vec_3365 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 40]);
								mem_vec_3366 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
								mem_vec_3367 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 56]);
								...
								mem_vec_3372 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
								mem_vec_3373 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 40]);
								mem_vec_3374 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
								mem_vec_3375 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 56]);
								...
								mem_vec_3380 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
								mem_vec_3381 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 40]);
								mem_vec_3382 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
								mem_vec_3383 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 56]);
								...
								mem_vec_3388 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
								mem_vec_3389 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 40]);
								mem_vec_3390 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
								mem_vec_3391 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 56]);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_3364);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 40], mem_vec_3365);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_3366);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 56], mem_vec_3367);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_3372);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 40], mem_vec_3373);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_3374);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 56], mem_vec_3375);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_3380);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 40], mem_vec_3381);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_3382);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 56], mem_vec_3383);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_3388);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 40], mem_vec_3389);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_3390);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 56], mem_vec_3391);
					}
				}
}
