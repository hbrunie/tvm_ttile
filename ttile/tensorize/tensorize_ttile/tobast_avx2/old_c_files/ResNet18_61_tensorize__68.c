...
fp_2 = 0;
								for (h = h514, hp_0 = 0;h < h514 + 3;h += 1, hp_0 += 1){
									...
									for (x = x1484, xp_2 = x1484_p_1, xp_1 = x1484_p_0, xp_0 = 0;x < x1484 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_10488 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_10489 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_10490 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_10491 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_10488);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_10489);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_10490);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_10491);
									}
								}
}
