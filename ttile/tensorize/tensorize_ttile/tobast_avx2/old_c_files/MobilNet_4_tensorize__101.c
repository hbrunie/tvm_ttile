...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, f); T (1, x); T (7, y); T (1, x); T (1, f); T (4, c);
  T (4, x)]
*/
IND_TYPE c, cp_0, c72_p_0, cp_1, c72, f, fp_0, f72_p_0, fp_1, f72, h, hp_0, w, wp_0, x, xp_0, x120_p_0, x121_p_0, x122_p_0, xp_1, x120_p_1, x121_p_1, xp_2, x120_p_2, xp_3, x120, x121, x122, y, yp_0;
IND_TYPE y48 = 0;
IND_TYPE x123 = 0;
IND_TYPE h48 = 0;
IND_TYPE w48 = 0;
...
fp_1 = 0;
							for (h = h48, hp_0 = 0;h < h48 + 3;h += 1, hp_0 += 1){
								...
								for (w = w48, wp_0 = 0;w < w48 + 3;w += 1, wp_0 += 1){
									// y = 4, x = 7, h = 1, w = 1, c = 32, f = 32
									// T (x, 7) (7 / 1)
									for (x = x120, xp_3 = x120_p_2, xp_2 = x120_p_1, xp_1 = x120_p_0, xp_0 = 0;x < x120 + 7;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
