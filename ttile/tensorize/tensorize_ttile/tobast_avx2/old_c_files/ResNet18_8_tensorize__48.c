...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, f); T (2, x); T (7, y); T (2, f); T (8, c); T (2, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c136_p_0, cp_1, c136, f, fp_0, f88_p_0, f89_p_0, fp_1, f88_p_1, fp_2, f88, f89, w, wp_0, x, xp_0, x144_p_0, x145_p_0, xp_1, x144_p_1, xp_2, x144, x145, y, yp_0;
IND_TYPE y72 = 0;
IND_TYPE x146 = 0;
IND_TYPE h = 0;
IND_TYPE w72 = 0;
...
fp_2 = 0;
							for (w = w72, wp_0 = 0;w < w72 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 7) (7 / 1)
								for (x = x144, xp_2 = x144_p_1, xp_1 = x144_p_0, xp_0 = 0;x < x144 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 16) (16 / 1)
											for (c = c136, cp_1 = c136_p_0, cp_0 = 0;c < c136 + 16;c += 1, cp_1 += 1, cp_0 += 1){
