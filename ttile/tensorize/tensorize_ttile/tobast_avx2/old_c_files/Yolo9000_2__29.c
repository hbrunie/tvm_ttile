...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, y); T (2, f); T (8, c); T (1, x); T (17, y); T (1, f);
  T (136, x)]
*/
IND_TYPE c, cp_0, c264_p_0, cp_1, c264, f, fp_0, f254_p_0, fp_1, f254, w, wp_0, x, xp_0, x352_p_0, x353_p_0, xp_1, x352_p_1, xp_2, x352, x353, y, yp_0, y264_p_0, yp_1, y264;
		...
		for (y264 = y265, y264_p_0 = 0;
			...
			for (x352 = x353, x352_p_1 = x353_p_0, x352_p_0 = 0;
				...
				for (c264 = c265, c264_p_0 = 0;
					c264 < c265 + 32;
					c264 += 4, c264_p_0 += 4){
					// y = 16, x = 2, h = 3, w = 3, c = 4, f = 64
					// T (f, 2) (64 / 32)
					for (f = f254, fp_1 = f254_p_0, fp_0 = 0;
						f < f254 + 64;
						f += 32, fp_1 += 32, fp_0 += 32){
						// y = 16, x = 2, h = 3, w = 3, c = 4, f = 32
						// T (y, 4) (16 / 4)
