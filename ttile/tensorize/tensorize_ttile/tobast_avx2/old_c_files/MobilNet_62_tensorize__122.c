							...
							for (h = h208, hp_0 = 0;h < h208 + 3;h += 1, hp_0 += 1){
								...
								for (w = w200, wp_0 = 0;w < w200 + 3;w += 1, wp_0 += 1){
									...
									for (x = x396, xp_1 = x396_p_0, xp_0 = 0;x < x396 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3826 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3827 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3826);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3827);
									}
								}
							}
}
