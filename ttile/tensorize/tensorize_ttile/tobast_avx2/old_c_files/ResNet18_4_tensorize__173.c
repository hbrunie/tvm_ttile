...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (4, c); T (1, x); T (7, y); T (4, f); T (1, x)]
*/
IND_TYPE c, cp_0, c84_p_0, cp_1, c84, f, fp_0, w, wp_0, x, xp_0, x112_p_0, x113_p_0, xp_1, x112_p_1, xp_2, x112, x113, y, yp_0;
IND_TYPE y56 = 0;
IND_TYPE x114 = 0;
IND_TYPE h = 0;
IND_TYPE w56 = 0;
