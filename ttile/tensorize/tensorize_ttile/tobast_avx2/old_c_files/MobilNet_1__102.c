...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (4, x); T (28, y); T (32, c); T (14, x)]
*/
IND_TYPE c, cp_0, c630_p_0, cp_1, c630, h, hp_0, x, xp_0, x810_p_0, x811_p_0, xp_1, x810_p_1, xp_2, x810, x811, y, yp_0;
...
__m256 mem_vec_4152 ,mem_vec_4153 ,mem_vec_4154 ,mem_vec_4155 ,mem_vec_4156 ,mem_vec_4157 ,mem_vec_4158 ,mem_vec_4159 ,mem_vec_4160 ,mem_vec_4161 ,mem_vec_4162 ,mem_vec_4163 ,mem_vec_4164 ,mem_vec_4165 ,mem_vec_4166 ,mem_vec_4167 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_8 ,vec_9;
// y = 112, x = 112, h = 3, w = 3, c = 32, f = 32
// T (x, 14) (112 / 8)
for (x811 = x812, x811_p_0 = 0;
	x811 < x812 + 112;
	x811 += 8, x811_p_0 += 8){
	...
	for (c630 = c631, c630_p_0 = 0;
		...
		for (y = y420, yp_0 = 0;
			...
			// T (x, 4) (8 / 2)
			for (x810 = x811, x810_p_1 = x811_p_0, x810_p_0 = 0;
				x810 < x811 + 8;
				x810 += 2, x810_p_1 += 2, x810_p_0 += 2){
				...
				for (h = h270, hp_0 = 0;
					...
					// T (x, 2) (2 / 1)
					for (x = x810, xp_2 = x810_p_1, xp_1 = x810_p_0, xp_0 = 0;
						x < x810 + 2;
						x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								for (c = c630, cp_1 = c630_p_0, cp_0 = 0;
									...
									vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_4152);
									mem_vec_4152 = vec_24;

									vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

									vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_4153);
									mem_vec_4153 = vec_27;

									vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

									vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_4154);
									mem_vec_4154 = vec_29;

									vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

									vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_4155);
									mem_vec_4155 = vec_31;
									scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
									vec_34 = _mm256_set1_ps(scal_5);


									vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_4156);
									mem_vec_4156 = vec_33;



									vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_4157);
									mem_vec_4157 = vec_35;



									vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_4158);
									mem_vec_4158 = vec_36;



									vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_4159);
									mem_vec_4159 = vec_37;
									scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
									vec_39 = _mm256_set1_ps(scal_6);


									vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_4160);
									mem_vec_4160 = vec_38;



									vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_4161);
									mem_vec_4161 = vec_40;



									vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_4162);
									mem_vec_4162 = vec_41;



									vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_4163);
									mem_vec_4163 = vec_42;
									scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
									vec_44 = _mm256_set1_ps(scal_7);


									vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_4164);
									mem_vec_4164 = vec_43;



									vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_4165);
									mem_vec_4165 = vec_45;



									vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_4166);
									mem_vec_4166 = vec_46;



									vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_4167);
									mem_vec_4167 = vec_47;
									scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
									vec_49 = _mm256_set1_ps(scal_8);
									vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

									vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_4152);
									mem_vec_4152 = vec_48;

									vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

									vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_4153);
									mem_vec_4153 = vec_51;

									vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

									vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_4154);
									mem_vec_4154 = vec_53;

									vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

									vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_4155);
									mem_vec_4155 = vec_55;
									scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
									vec_58 = _mm256_set1_ps(scal_9);


									vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_4156);
									mem_vec_4156 = vec_57;



									vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_4157);
									mem_vec_4157 = vec_59;



									vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_4158);
									mem_vec_4158 = vec_60;



									vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_4159);
									mem_vec_4159 = vec_61;
									scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
									vec_63 = _mm256_set1_ps(scal_10);


									vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_4160);
									mem_vec_4160 = vec_62;



									vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_4161);
									mem_vec_4161 = vec_64;



									vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_4162);
									mem_vec_4162 = vec_65;



									vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_4163);
									mem_vec_4163 = vec_66;
									scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
									vec_68 = _mm256_set1_ps(scal_11);


									vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_4164);
									mem_vec_4164 = vec_67;



									vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_4165);
									mem_vec_4165 = vec_69;



									vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_4166);
									mem_vec_4166 = vec_70;



									vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_4167);
									mem_vec_4167 = vec_71;
								}
