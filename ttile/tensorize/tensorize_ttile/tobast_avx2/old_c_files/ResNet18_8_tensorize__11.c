...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (4, c); T (4, x); T (7, y); T (8, f); T (1, c); T (7, x)]
*/
IND_TYPE c, cp_0, c88_p_0, c89_p_0, cp_1, c88_p_1, cp_2, c88, c89, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x88_p_0, x89_p_0, xp_1, x88_p_1, xp_2, x88, x89, y, yp_0;
IND_TYPE y44 = 0;
IND_TYPE x90 = 0;
IND_TYPE h44 = 0;
IND_TYPE w44 = 0;
