							...
							for (h = h182, hp_0 = 0;h < h182 + 3;h += 1, hp_0 += 1){
								...
								for (w = w164, wp_0 = 0;w < w164 + 3;w += 1, wp_0 += 1){
									...
									for (x = x342, xp_1 = x342_p_0, xp_0 = 0;x < x342 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3256 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_3257 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_3258 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3259 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3256);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_3257);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3258);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3259);
									}
								}
							}
}
