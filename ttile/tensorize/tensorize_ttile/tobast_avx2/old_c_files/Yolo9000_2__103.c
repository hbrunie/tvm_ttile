...
for (x1369 = x1370, x1369_p_0 = 0;
	...
	for (f898 = f899, f898_p_0 = 0;
		f898 < f899 + 64;
		f898 += 64, f898_p_0 += 64){
			for (y1026 = y1027, y1026_p_0 = 0;
				y1026 < y1027 + 160;
				y1026 += 32, y1026_p_0 += 32){
				...
				for (x1368 = x1369, x1368_p_1 = x1369_p_0, x1368_p_0 = 0;
					...
					for (c1026 = c1027, c1026_p_0 = 0;
						...
						// y = 8 * ph_y, x = 2, h = 3, w = 3, c = 16, f = 64
						// T (f, 2) (64 / 32)
						for (f = f898, fp_1 = f898_p_0, fp_0 = 0;
							...
							// T (y, 8) (8 * ph_y / ph_y)
							for (y = y1026, yp_1 = y1026_p_0, yp_0 = 0;
								y < y1026 + 32;
								y += 4, yp_1 += 4, yp_0 += 4){
			...
			for (y1026 = y1027 + 160, y1026_p_0 = 0;
				y1026 < y1027 + 160 + 112;
				y1026 += 56, y1026_p_0 += 56){
				// y = 8 * ph_y, x = 34, h = 3, w = 3, c = 32, f = 64
				// T (x, 17) (34 / 2)
				for (x1368 = x1369, x1368_p_1 = x1369_p_0, x1368_p_0 = 0;
					x1368 < x1369 + 34;
