...
[V f; U (4, f); U (4, y); U (3, w); T (128, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (2, f); T (1, x); T (7, y); T (1, f); T (1, c); T (28, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c450_p_0, cp_1, c450, f, fp_0, f554_p_0, f555_p_0, fp_1, f554_p_1, fp_2, f554, f555, h, hp_0, x, xp_0, x646_p_0, x647_p_0, xp_1, x646_p_1, xp_2, x646, x647, y, yp_0;
IND_TYPE y300 = 0;
IND_TYPE x648 = 0;
IND_TYPE h230 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h230, hp_0 = 0;h < h230 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x646, xp_2 = x646_p_1, xp_1 = x646_p_0, xp_0 = 0;x < x646 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
