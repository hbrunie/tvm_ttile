...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (4, f); T (1, x); T (7, y); T (2, f); T (128, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c472_p_0, cp_1, c472, f, fp_0, f536_p_0, f537_p_0, fp_1, f536_p_1, fp_2, f536, f537, h, hp_0, x, xp_0, x592_p_0, x593_p_0, xp_1, x592_p_1, xp_2, x592, x593, y, yp_0;
IND_TYPE y296 = 0;
IND_TYPE x594 = 0;
IND_TYPE h208 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h208, hp_0 = 0;h < h208 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 7) (7 / 1)
								for (x = x592, xp_2 = x592_p_1, xp_1 = x592_p_0, xp_0 = 0;x < x592 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 1) (1 / 1)
											for (c = c472, cp_1 = c472_p_0, cp_0 = 0;c < c472 + 1;c += 1, cp_1 += 1, cp_0 += 1){
