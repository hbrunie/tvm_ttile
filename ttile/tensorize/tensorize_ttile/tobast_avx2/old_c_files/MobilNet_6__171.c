...
[V f; U (4, f); U (7, y); U (3, h); T (256, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, f); T (2, x); T (2, y); T (2, f); T (1, c); T (4, f)]
*/
IND_TYPE c, cp_0, c48_p_0, cp_1, c48, f, fp_0, f64_p_0, f65_p_0, fp_1, f64_p_1, fp_2, f64, f65, w, wp_0, x, xp_0, x48_p_0, xp_1, x48, y, yp_0;
