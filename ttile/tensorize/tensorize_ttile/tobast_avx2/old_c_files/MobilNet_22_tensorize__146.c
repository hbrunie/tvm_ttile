...
yp_0 = 0;
								for (h = h540, hp_0 = 0;h < h540 + 3;h += 1, hp_0 += 1){
									...
									// T (x, 8) (8 / 1)
									for (x = x1200, xp_1 = x1200_p_0, xp_0 = 0;x < x1200 + 8;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_13800 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
												mem_vec_13801 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8]);
												mem_vec_13802 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
												mem_vec_13803 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
												// y = ph_y, x = 1, h = 1, w = 3, c = 8, f = 32
												// T (c, 8) (8 / 1)
												for (c = c1446, cp_2 = c1446_p_1, cp_1 = c1446_p_0, cp_0 = 0;c < c1446 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_13800);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8], mem_vec_13801);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_13802);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_13803);
									}
								}
}
