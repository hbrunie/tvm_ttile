...
[V f; U (4, f); U (7, y); U (3, w); T (8, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (8, y); T (1, f); T (2, c); T (1, f); T (4, c); T (8, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c508_p_0, c509_p_0, cp_1, c508_p_1, cp_2, c508, c509, f, fp_0, f480_p_0, f481_p_0, fp_1, f480_p_1, fp_2, f480, f481, h, hp_0, x, xp_0, x430_p_0, xp_1, x430, y, yp_0;
