...
[V f; U (4, f); U (4, y); T (128, c); Hoist_vars [c]; T (2, x); T (17, y);
  T (4, f); T (1, f); T (2, c); T (34, x); T (1, f)]
*/
IND_TYPE c, cp_0, c798_p_0, cp_1, c798, f, fp_0, f1064_p_0, f1065_p_0, fp_1, f1064_p_1, fp_2, f1064, f1065, x, xp_0, x798_p_0, xp_1, x798, y, yp_0;
IND_TYPE y532 = 0;
IND_TYPE x799 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
