...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, f); T (4, x); T (14, y); T (1, f); T (4, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c196_p_0, cp_1, c196, f, fp_0, f188_p_0, f189_p_0, fp_1, f188_p_1, fp_2, f188, f189, w, wp_0, x, xp_0, x232_p_0, x233_p_0, xp_1, x232_p_1, xp_2, x232, x233, y, yp_0;
IND_TYPE y116 = 0;
IND_TYPE x234 = 0;
IND_TYPE h = 0;
IND_TYPE w116 = 0;
...
fp_2 = 0;
							for (w = w116, wp_0 = 0;w < w116 + 3;w += 1, wp_0 += 1){
								...
								for (x = x232, xp_2 = x232_p_1, xp_1 = x232_p_0, xp_0 = 0;x < x232 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 32) (32 / 1)
											for (c = c196, cp_1 = c196_p_0, cp_0 = 0;c < c196 + 32;c += 1, cp_1 += 1, cp_0 += 1){
