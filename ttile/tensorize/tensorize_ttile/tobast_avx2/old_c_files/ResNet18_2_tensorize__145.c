...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (14, y); T (1, f); T (4, c); T (2, f); T (2, c); T (56, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c192_p_0, c193_p_0, cp_1, c192_p_1, cp_2, c192, c193, f, fp_0, f168_p_0, f169_p_0, fp_1, f168_p_1, fp_2, f168, f169, w, wp_0, x, xp_0, x186_p_0, xp_1, x186, y, yp_0;
IND_TYPE y108 = 0;
IND_TYPE x187 = 0;
IND_TYPE h = 0;
IND_TYPE w108 = 0;
...
yp_0 = 0;
							for (w = w108, wp_0 = 0;w < w108 + 3;w += 1, wp_0 += 1){
								...
								for (x = x186, xp_1 = x186_p_0, xp_0 = 0;x < x186 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 8, f = 32
											// T (c, 8) (8 / 1)
											for (c = c192, cp_2 = c192_p_1, cp_1 = c192_p_0, cp_0 = 0;c < c192 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
