...
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (68, x); T (17, y);
  T (1, f); T (4, f); T (32, c); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c102_p_0, cp_1, c102, f, fp_0, f136_p_0, f137_p_0, fp_1, f136_p_1, fp_2, f136, f137, x, xp_0, x102_p_0, xp_1, x102, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x103 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
						for (x = x102, xp_1 = x102_p_0, xp_0 = 0;x < x102 + 68;x += 1, xp_1 += 1, xp_0 += 1){
