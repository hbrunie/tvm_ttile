...
[V f; U (4, f); U (7, y); U (3, w); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (2, f); T (4, x); T (4, y); T (2, f); T (32, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c600_p_0, cp_1, c600, f, fp_0, f764_p_0, f765_p_0, fp_1, f764_p_1, fp_2, f764, f765, h, hp_0, x, xp_0, x836_p_0, x837_p_0, xp_1, x836_p_1, xp_2, x836, x837, y, yp_0;
					...
					for (x836 = x837, x836_p_1 = x837_p_0, x836_p_0 = 0;
						...
						for (f = f764, fp_2 = f764_p_1, fp_1 = f764_p_0, fp_0 = 0;
							...
							for (h = h310, hp_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x836, xp_2 = x836_p_1, xp_1 = x836_p_0, xp_0 = 0;
									x < x836 + 1;
