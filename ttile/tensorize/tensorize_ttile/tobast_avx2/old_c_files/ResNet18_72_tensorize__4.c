							...
							for (h = h190, hp_0 = 0;h < h190 + 3;h += 1, hp_0 += 1){
								...
								for (w = w172, wp_0 = 0;w < w172 + 3;w += 1, wp_0 += 1){
									...
									for (x = x354, xp_1 = x354_p_0, xp_0 = 0;x < x354 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3400 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_3401 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_3402 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3403 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3400);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_3401);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3402);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3403);
									}
								}
							}
}
