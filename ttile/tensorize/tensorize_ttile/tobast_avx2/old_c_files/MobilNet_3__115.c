...
[V f; U (4, f); U (7, y); U (3, h); T (16, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, f); T (2, x); T (8, y); T (1, f); T (8, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c280_p_0, cp_1, c280, f, fp_0, f300_p_0, f301_p_0, fp_1, f300_p_1, fp_2, f300, f301, w, wp_0, x, xp_0, x344_p_0, x345_p_0, xp_1, x344_p_1, xp_2, x344, x345, y, yp_0;
	...
	for (x345 = x346, x345_p_0 = 0;
		...
		for (c280 = c281, c280_p_0 = 0;
			...
			for (f300 = f301, f300_p_1 = f301_p_0, f300_p_0 = 0;
				f300 < f301 + 128;
				f300 += 128, f300_p_1 += 128, f300_p_0 += 128){
				// y = 56, x = 4, h = 3, w = 3, c = 16, f = 128
				// T (y, 8) (56 / 7)
				for (y = y172, yp_0 = 0;
					y < y172 + 56;
					y += 7, yp_0 += 7){
					// y = 7, x = 4, h = 3, w = 3, c = 16, f = 128
					// T (x, 2) (4 / 2)
