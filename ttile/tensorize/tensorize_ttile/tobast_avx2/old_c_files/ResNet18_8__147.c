...
[V f; U (4, f); U (4, y); U (3, h); T (64, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (8, f); T (2, c); T (28, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c220_p_0, cp_1, c220, f, fp_0, f200_p_0, f201_p_0, fp_1, f200_p_1, fp_2, f200, f201, w, wp_0, x, xp_0, x256_p_0, x257_p_0, xp_1, x256_p_1, xp_2, x256, x257, y, yp_0;
