...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, f); T (7, x); T (2, y); T (1, f); T (4, c); T (8, f)]
*/
IND_TYPE c, cp_0, c234_p_0, cp_1, c234, f, fp_0, f312_p_0, f313_p_0, fp_1, f312_p_1, fp_2, f312, f313, h, hp_0, x, xp_0, x234_p_0, xp_1, x234, y, yp_0;
