...
/*
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (28, x); T (3, w);
  T (3, h); T (28, y); T (1, c); T (4, x)]
*/
IND_TYPE c, cp_0, c12_p_0, cp_1, c12, h, hp_0, w, wp_0, x, xp_0, x12_p_0, xp_1, x12, y, yp_0;
IND_TYPE y8 = 0;
IND_TYPE x13 = 0;
IND_TYPE h8 = 0;
IND_TYPE w8 = 0;
