...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (4, x); T (7, y); T (8, f); T (128, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c508_p_0, cp_1, c508, f, fp_0, f584_p_0, f585_p_0, fp_1, f584_p_1, fp_2, f584, f585, h, hp_0, x, xp_0, x640_p_0, x641_p_0, xp_1, x640_p_1, xp_2, x640, x641, y, yp_0;
IND_TYPE y320 = 0;
IND_TYPE x642 = 0;
IND_TYPE h232 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h232, hp_0 = 0;h < h232 + 3;h += 1, hp_0 += 1){
								...
								for (x = x640, xp_2 = x640_p_1, xp_1 = x640_p_0, xp_0 = 0;x < x640 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 1, w = 3, c = 1, f = 32
											// T (c, 1) (1 / 1)
											for (c = c508, cp_1 = c508_p_0, cp_0 = 0;c < c508 + 1;c += 1, cp_1 += 1, cp_0 += 1){
