...
y528 = 0;
y528_p_0 = 0;
			for (x704 = x705, x704_p_1 = x705_p_0, x704_p_0 = 0;x704 < x705 + 68;x704 += 1, x704_p_1 += 1, x704_p_0 += 1){
					for (y = y528, yp_1 = y528_p_0, yp_0 = 0;y < y528 + 8;y += 8, yp_1 += 8, yp_0 += 8){
						// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 16
						// T (c, 32) (32 / 1)
						for (c528 = c529, c528_p_0 = 0;c528 < c529 + 32;c528 += 1, c528_p_0 += 1){
					...
					for (y = y528 + 8, yp_1 = y528_p_0, yp_0 = 0;y < y528 + 8 + 26;y += 13, yp_1 += 13, yp_0 += 13){
						// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 16
						// T (c, 32) (32 / 1)
						for (c528 = c529, c528_p_0 = 0;c528 < c529 + 32;c528 += 1, c528_p_0 += 1){
							// y = ph_y, x = 1, h = 3, w = 3, c = 1, f = 16
							...
							for (w = w302, wp_0 = 0;w < w302 + 3;w += 1, wp_0 += 1){
								...
								for (x = x704, xp_2 = x704_p_1, xp_1 = x704_p_0, xp_0 = 0;x < x704 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3760 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_3761 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
											mem_vec_3762 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_3763 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
											mem_vec_3764 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
											mem_vec_3765 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8]);
											mem_vec_3766 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
											mem_vec_3767 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8]);
											mem_vec_3768 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
											mem_vec_3769 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 1, f = 16
											// T (c, 1) (1 / 1)
											for (c = c528, cp_1 = c528_p_0, cp_0 = 0;c < c528 + 1;c += 1, cp_1 += 1, cp_0 += 1){
												scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3760);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_3761);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3762);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_3763);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_3764);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8], mem_vec_3765);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_3766);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8], mem_vec_3767);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3768);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8], mem_vec_3769);
								}
							}
						}
					}
