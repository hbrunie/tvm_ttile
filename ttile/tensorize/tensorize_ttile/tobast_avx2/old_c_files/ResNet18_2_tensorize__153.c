...
/*
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (14, y); T (2, f); T (2, c); T (1, f); T (4, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c120_p_0, c121_p_0, cp_1, c120_p_1, cp_2, c120, c121, f, fp_0, f96_p_0, f97_p_0, fp_1, f96_p_1, fp_2, f96, f97, w, wp_0, x, xp_0, x132_p_0, xp_1, x132, y, yp_0;
IND_TYPE y72 = 0;
IND_TYPE x133 = 0;
IND_TYPE h = 0;
IND_TYPE w72 = 0;
