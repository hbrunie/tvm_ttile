...
/*
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (136, x);
  T (3, w); T (68, y); T (1, f); T (2, c); T (1, x); T (1, y); T (2, f);
  T (2, x)]
*/
IND_TYPE c, cp_0, c174_p_0, cp_1, c174, f, fp_0, f164_p_0, fp_1, f164, w, wp_0, x, xp_0, x232_p_0, x233_p_0, xp_1, x232_p_1, xp_2, x232, x233, y, yp_0, y174_p_0, yp_1, y174;
IND_TYPE y175 = 0;
IND_TYPE x234 = 0;
IND_TYPE h = 0;
IND_TYPE w116 = 0;
...
yp_1 = 0;
							for (w = w116, wp_0 = 0;w < w116 + 3;w += 1, wp_0 += 1){
								// y = 4, x = 136, h = 3, w = 1, c = 16, f = 32
								// T (x, 136) (136 / 1)
								for (x = x232, xp_2 = x232_p_1, xp_1 = x232_p_0, xp_0 = 0;x < x232 + 136;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
