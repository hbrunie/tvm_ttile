...
yp_0 = 0;
					for (w = w530, wp_0 = 0;w < w530 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 28) (28 / 1)
						for (x = x1212, xp_1 = x1212_p_0, xp_0 = 0;x < x1212 + 28;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_7774 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									mem_vec_7775 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8]);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_7774);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8], mem_vec_7775);
						}
					}
}
