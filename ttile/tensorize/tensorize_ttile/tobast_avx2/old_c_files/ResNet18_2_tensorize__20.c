...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (14, y); T (1, f); T (64, c); T (2, f); T (1, c); T (56, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c184_p_0, c185_p_0, cp_1, c184_p_1, cp_2, c184, c185, f, fp_0, f160_p_0, f161_p_0, fp_1, f160_p_1, fp_2, f160, f161, w, wp_0, x, xp_0, x180_p_0, xp_1, x180, y, yp_0;
IND_TYPE y104 = 0;
IND_TYPE x181 = 0;
IND_TYPE h = 0;
IND_TYPE w104 = 0;
...
yp_0 = 0;
							for (w = w104, wp_0 = 0;w < w104 + 3;w += 1, wp_0 += 1){
								...
								for (x = x180, xp_1 = x180_p_0, xp_0 = 0;x < x180 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 1, f = 32
											// T (c, 1) (1 / 1)
											for (c = c184, cp_2 = c184_p_1, cp_1 = c184_p_0, cp_0 = 0;c < c184 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
