...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, f); T (7, x); T (7, y); T (4, f); T (64, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c180_p_0, cp_1, c180, f, fp_0, f240_p_0, f241_p_0, fp_1, f240_p_1, fp_2, f240, f241, w, wp_0, x, xp_0, x240_p_0, x241_p_0, xp_1, x240_p_1, xp_2, x240, x241, y, yp_0;
