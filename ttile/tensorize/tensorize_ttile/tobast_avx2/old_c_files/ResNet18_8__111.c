...
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (32, c); T (14, x); T (7, y); T (8, f); T (2, c); T (1, x)]
*/
IND_TYPE c, cp_0, c40_p_0, c41_p_0, cp_1, c40_p_1, cp_2, c40, c41, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x40_p_0, x41_p_0, xp_1, x40_p_1, xp_2, x40, x41, y, yp_0;
