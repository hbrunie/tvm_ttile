...
/*
[V f; U (4, f); U (4, y); T (256, c); Hoist_vars [c]; T (68, x); T (17, y);
  T (2, f); T (1, f); T (1, c); T (1, x); T (2, f)]
*/
IND_TYPE c, cp_0, c12_p_0, cp_1, c12, f, fp_0, f16_p_0, f17_p_0, fp_1, f16_p_1, fp_2, f16, f17, x, xp_0, x12_p_0, xp_1, x12, y, yp_0;
IND_TYPE y8 = 0;
IND_TYPE x13 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
						for (x = x12, xp_1 = x12_p_0, xp_0 = 0;x < x12 + 68;x += 1, xp_1 += 1, xp_0 += 1){
