...
c866_p_0 = 0;
						for (w = w392, wp_0 = 0;w < w392 + 3;w += 1, wp_0 += 1){
							...
							for (x = x982, xp_2 = x982_p_1, xp_1 = x982_p_0, xp_0 = 0;x < x982 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6906 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_6907 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
									...
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_6906);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_6907);
							}
						}
}
