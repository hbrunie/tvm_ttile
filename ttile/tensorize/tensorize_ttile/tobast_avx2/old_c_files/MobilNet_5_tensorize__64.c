...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (2, f); T (1, x); T (7, y); T (4, f); T (64, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c198_p_0, cp_1, c198, f, fp_0, f264_p_0, f265_p_0, fp_1, f264_p_1, fp_2, f264, f265, w, wp_0, x, xp_0, x264_p_0, x265_p_0, xp_1, x264_p_1, xp_2, x264, x265, y, yp_0;
IND_TYPE y132 = 0;
IND_TYPE x266 = 0;
IND_TYPE h = 0;
IND_TYPE w132 = 0;
