...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (4, f); T (7, x); T (2, y); T (2, f); T (8, c); T (1, f)]
*/
IND_TYPE c, cp_0, c282_p_0, cp_1, c282, f, fp_0, f376_p_0, f377_p_0, fp_1, f376_p_1, fp_2, f376, f377, h, hp_0, x, xp_0, x282_p_0, xp_1, x282, y, yp_0;
