...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (2, f); T (16, c); T (7, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c184_p_0, cp_1, c184, f, fp_0, f152_p_0, f153_p_0, fp_1, f152_p_1, fp_2, f152, f153, w, wp_0, x, xp_0, x208_p_0, x209_p_0, xp_1, x208_p_1, xp_2, x208, x209, y, yp_0;
IND_TYPE y104 = 0;
IND_TYPE x210 = 0;
IND_TYPE h = 0;
IND_TYPE w104 = 0;
...
fp_2 = 0;
							for (w = w104, wp_0 = 0;w < w104 + 3;w += 1, wp_0 += 1){
								...
								for (x = x208, xp_2 = x208_p_1, xp_1 = x208_p_0, xp_0 = 0;x < x208 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 8) (8 / 1)
											for (c = c184, cp_1 = c184_p_0, cp_0 = 0;c < c184 + 8;c += 1, cp_1 += 1, cp_0 += 1){
