...
[V f; U (4, f); U (4, y); T (256, c); Hoist_vars [c]; T (68, x); T (17, y);
  T (1, f); T (4, f); T (1, c); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c6_p_0, cp_1, c6, f, fp_0, f8_p_0, f9_p_0, fp_1, f8_p_1, fp_2, f8, f9, x, xp_0, x6_p_0, xp_1, x6, y, yp_0;
IND_TYPE y4 = 0;
IND_TYPE x7 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
						for (x = x6, xp_1 = x6_p_0, xp_0 = 0;x < x6 + 68;x += 1, xp_1 += 1, xp_0 += 1){
