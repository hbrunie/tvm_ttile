...
[V f; U (4, f); ULambda y; T (128, c); Hoist_vars [c]; T (17, x); T (2, f);
  ...
  T (8, f); T (8, c); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c120_p_0, cp_1, c120, f, fp_0, f160_p_0, f161_p_0, fp_1, f160_p_1, fp_2, f160, f161, x, xp_0, x160_p_0, x161_p_0, xp_1, x160_p_1, xp_2, x160, x161, y, yp_0;
IND_TYPE y80 = 0;
IND_TYPE x162 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
