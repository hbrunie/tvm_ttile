...
[V f; U (4, f); U (4, y); T (1, c); Hoist_vars [c]; T (1, x); T (17, y);
  T (1, f); T (4, f); T (256, c); T (68, x); T (1, f)]
*/
IND_TYPE c, cp_0, c1176_p_0, cp_1, c1176, f, fp_0, f1568_p_0, f1569_p_0, fp_1, f1568_p_1, fp_2, f1568, f1569, x, xp_0, x1176_p_0, xp_1, x1176, y, yp_0;
IND_TYPE y784 = 0;
IND_TYPE x1177 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
