...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (2, f); T (1, x); T (7, y); T (2, f); T (32, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c228_p_0, cp_1, c228, f, fp_0, f268_p_0, f269_p_0, fp_1, f268_p_1, fp_2, f268, f269, w, wp_0, x, xp_0, x340_p_0, x341_p_0, xp_1, x340_p_1, xp_2, x340, x341, y, yp_0;
IND_TYPE y152 = 0;
IND_TYPE x342 = 0;
IND_TYPE h = 0;
IND_TYPE w152 = 0;
...
fp_2 = 0;
							for (w = w152, wp_0 = 0;w < w152 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 4) (4 / 1)
								for (x = x340, xp_2 = x340_p_1, xp_1 = x340_p_0, xp_0 = 0;x < x340 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
