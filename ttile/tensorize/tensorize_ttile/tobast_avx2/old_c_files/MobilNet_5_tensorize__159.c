...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (7, x); T (7, y); T (8, f); T (64, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, f, fp_0, f272_p_0, f273_p_0, fp_1, f272_p_1, fp_2, f272, f273, w, wp_0, x, xp_0, x272_p_0, x273_p_0, xp_1, x272_p_1, xp_2, x272, x273, y, yp_0;
IND_TYPE y136 = 0;
IND_TYPE x274 = 0;
IND_TYPE h = 0;
IND_TYPE w136 = 0;
...
fp_2 = 0;
							for (w = w136, wp_0 = 0;w < w136 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x272, xp_2 = x272_p_1, xp_1 = x272_p_0, xp_0 = 0;x < x272 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 4, f = 32
											// T (c, 4) (4 / 1)
											for (c = c204, cp_1 = c204_p_0, cp_0 = 0;c < c204 + 4;c += 1, cp_1 += 1, cp_0 += 1){
