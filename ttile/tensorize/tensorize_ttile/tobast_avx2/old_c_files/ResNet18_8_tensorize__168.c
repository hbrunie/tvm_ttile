...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, f); T (14, x); T (7, y); T (4, f); T (128, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c130_p_0, cp_1, c130, f, fp_0, f80_p_0, f81_p_0, fp_1, f80_p_1, fp_2, f80, f81, w, wp_0, x, xp_0, x136_p_0, x137_p_0, xp_1, x136_p_1, xp_2, x136, x137, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x138 = 0;
IND_TYPE h = 0;
IND_TYPE w68 = 0;
...
fp_2 = 0;
							for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
								...
								for (x = x136, xp_2 = x136_p_1, xp_1 = x136_p_0, xp_0 = 0;x < x136 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 1) (1 / 1)
											for (c = c130, cp_1 = c130_p_0, cp_0 = 0;c < c130 + 1;c += 1, cp_1 += 1, cp_0 += 1){
