...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (1, f); T (34, x); T (17, y); T (1, f); T (4, c); T (2, x);
  T (8, f)]
*/
IND_TYPE c, cp_0, c96_p_0, cp_1, c96, f, fp_0, f128_p_0, f129_p_0, fp_1, f128_p_1, fp_2, f128, f129, h, hp_0, w, wp_0, x, xp_0, x128_p_0, x129_p_0, xp_1, x128_p_1, xp_2, x128, x129, y, yp_0;
IND_TYPE y64 = 0;
IND_TYPE x130 = 0;
IND_TYPE h64 = 0;
IND_TYPE w64 = 0;
