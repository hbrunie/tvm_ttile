...
[V f; U (4, f); U (4, y); U (3, w); T (64, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (2, f); T (17, x); T (17, y); T (1, f); T (2, c); T (2, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c528_p_0, cp_1, c528, f, fp_0, f704_p_0, f705_p_0, fp_1, f704_p_1, fp_2, f704, f705, h, hp_0, x, xp_0, x704_p_0, x705_p_0, xp_1, x704_p_1, xp_2, x704, x705, y, yp_0;
IND_TYPE y352 = 0;
IND_TYPE x706 = 0;
IND_TYPE h284 = 0;
IND_TYPE w = 0;
