...
[V f; U (4, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (8, x);
  T (3, h); T (68, y); T (1, f); T (16, c); T (34, x); T (1, y); T (2, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c294_p_0, cp_1, c294, f, fp_0, f284_p_0, fp_1, f284, h, hp_0, x, xp_0, x392_p_0, x393_p_0, xp_1, x392_p_1, xp_2, x392, x393, y, yp_0, y294_p_0, yp_1, y294;
IND_TYPE y295 = 0;
IND_TYPE x394 = 0;
IND_TYPE h148 = 0;
IND_TYPE w = 0;
