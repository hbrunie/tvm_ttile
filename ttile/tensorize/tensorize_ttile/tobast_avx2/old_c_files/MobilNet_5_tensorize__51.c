...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, f); T (1, x); T (7, y); T (4, f); T (256, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c408_p_0, cp_1, c408, f, fp_0, f544_p_0, f545_p_0, fp_1, f544_p_1, fp_2, f544, f545, h, hp_0, x, xp_0, x544_p_0, x545_p_0, xp_1, x544_p_1, xp_2, x544, x545, y, yp_0;
IND_TYPE y272 = 0;
IND_TYPE x546 = 0;
IND_TYPE h182 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h182, hp_0 = 0;h < h182 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x544, xp_2 = x544_p_1, xp_1 = x544_p_0, xp_0 = 0;x < x544 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
