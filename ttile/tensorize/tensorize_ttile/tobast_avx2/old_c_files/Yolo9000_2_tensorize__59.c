...
/*
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (68, x); T (3, w);
  T (3, h); T (2, y); T (1, f); T (2, c); T (2, x); T (34, y); T (2, f);
  T (2, x)]
*/
IND_TYPE c, cp_0, c30_p_0, cp_1, c30, f, fp_0, f30_p_0, fp_1, f30, h, hp_0, w, wp_0, x, xp_0, x40_p_0, x41_p_0, xp_1, x40_p_1, xp_2, x40, x41, y, yp_0, y30_p_0, yp_1, y30;
IND_TYPE y31 = 0;
IND_TYPE x42 = 0;
IND_TYPE h20 = 0;
IND_TYPE w20 = 0;
