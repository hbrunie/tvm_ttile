...
yp_0 = 0;
								for (w = w534, wp_0 = 0;w < w534 + 3;w += 1, wp_0 += 1){
									...
									for (x = x1014, xp_1 = x1014_p_0, xp_0 = 0;x < x1014 + 1;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_10250 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
												mem_vec_10251 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 1, f = 32
												// T (c, 1) (1 / 1)
												for (c = c1156, cp_2 = c1156_p_1, cp_1 = c1156_p_0, cp_0 = 0;c < c1156 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_10250);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_10251);
									}
								}
}
