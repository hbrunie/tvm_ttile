...
[V f; U (4, f); U (7, y); U (3, w); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (4, f); T (14, x); T (2, y); T (1, f); T (128, c); T (2, f)]
*/
IND_TYPE c, cp_0, c318_p_0, cp_1, c318, f, fp_0, f424_p_0, f425_p_0, fp_1, f424_p_1, fp_2, f424, f425, h, hp_0, x, xp_0, x318_p_0, xp_1, x318, y, yp_0;
...
for (f425 = f426, f425_p_0 = 0;
	...
	for (c318 = c319, c318_p_0 = 0;
		...
		for (f424 = f425, f424_p_1 = f425_p_0, f424_p_0 = 0;
			f424 < f425 + 128;
			f424 += 128, f424_p_1 += 128, f424_p_0 += 128){
			// y = 14, x = 14, h = 3, w = 3, c = 1, f = 128
			// T (y, 2) (14 / 7)
			for (y = y212, yp_0 = 0;
				y < y212 + 14;
