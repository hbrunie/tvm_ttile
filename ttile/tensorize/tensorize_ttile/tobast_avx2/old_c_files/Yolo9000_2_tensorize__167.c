...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, y); T (2, f); T (1, c); T (16, x); T (34, y); T (1, f);
  T (17, x)]
*/
IND_TYPE c, cp_0, c228_p_0, cp_1, c228, f, fp_0, f218_p_0, fp_1, f218, w, wp_0, x, xp_0, x304_p_0, x305_p_0, xp_1, x304_p_1, xp_2, x304, x305, y, yp_0, y228_p_0, yp_1, y228;
IND_TYPE y229 = 0;
IND_TYPE x306 = 0;
IND_TYPE h = 0;
IND_TYPE w152 = 0;
