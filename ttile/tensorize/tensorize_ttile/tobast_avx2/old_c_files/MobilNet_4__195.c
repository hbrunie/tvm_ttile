...
[V f; U (4, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (2, f); T (1, x); T (7, y); T (1, f); T (64, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c384_p_0, cp_1, c384, f, fp_0, f476_p_0, f477_p_0, fp_1, f476_p_1, fp_2, f476, f477, h, hp_0, x, xp_0, x548_p_0, x549_p_0, xp_1, x548_p_1, xp_2, x548, x549, y, yp_0;
			...
			for (f476 = f477, f476_p_1 = f477_p_0, f476_p_0 = 0;
				...
				for (y = y256, yp_0 = 0;
					...
					for (x548 = x549, x548_p_1 = x549_p_0, x548_p_0 = 0;
						x548 < x549 + 28;
						x548 += 28, x548_p_1 += 28, x548_p_0 += 28){
						// y = 4, x = 28, h = 3, w = 3, c = 2, f = 64
						// T (f, 2) (64 / 32)
