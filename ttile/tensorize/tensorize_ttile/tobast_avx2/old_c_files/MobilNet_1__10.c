...
/*
[V f; U (4, f); U (7, y); U (3, h); T (8, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (2, x); T (16, y); T (4, c); T (7, x)]
*/
IND_TYPE c, cp_0, c384_p_0, cp_1, c384, w, wp_0, x, xp_0, x482_p_0, x483_p_0, xp_1, x482_p_1, xp_2, x482, x483, y, yp_0;
	...
	for (c384 = c385, c384_p_0 = 0;
		...
		for (y = y256, yp_0 = 0;
			...
			for (x482 = x483, x482_p_1 = x483_p_0, x482_p_0 = 0;
				x482 < x483 + 16;
				x482 += 8, x482_p_1 += 8, x482_p_0 += 8){
				// y = 7, x = 8, h = 3, w = 3, c = 8, f = 32
				// T (w, 3) (3 / 1)
				for (w = w256, wp_0 = 0;
					w < w256 + 3;
					w += 1, wp_0 += 1){
					// y = 7, x = 8, h = 3, w = 1, c = 8, f = 32
					// T (x, 8) (8 / 1)
