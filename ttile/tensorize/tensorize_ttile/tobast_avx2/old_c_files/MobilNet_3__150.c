...
[V f; U (4, f); U (4, y); U (3, w); T (128, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (1, f); T (2, x); T (14, y); T (1, f); T (1, c); T (4, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c346_p_0, cp_1, c346, f, fp_0, f388_p_0, f389_p_0, fp_1, f388_p_1, fp_2, f388, f389, h, hp_0, x, xp_0, x432_p_0, x433_p_0, xp_1, x432_p_1, xp_2, x432, x433, y, yp_0;
