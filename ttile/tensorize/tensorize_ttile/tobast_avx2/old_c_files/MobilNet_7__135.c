...
[V f; U (4, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (16, f); T (14, x); T (2, y); T (1, f); T (16, c); T (1, f)]
*/
IND_TYPE c, cp_0, c114_p_0, cp_1, c114, f, fp_0, f152_p_0, f153_p_0, fp_1, f152_p_1, fp_2, f152, f153, w, wp_0, x, xp_0, x114_p_0, xp_1, x114, y, yp_0;
...
for (f153 = f154, f153_p_0 = 0;
	...
	for (c114 = c115, c114_p_0 = 0;
		...
		for (f152 = f153, f152_p_1 = f153_p_0, f152_p_0 = 0;
			f152 < f153 + 512;
			f152 += 512, f152_p_1 += 512, f152_p_0 += 512){
			// y = 14, x = 14, h = 3, w = 3, c = 32, f = 512
			// T (y, 2) (14 / 7)
			for (y = y76, yp_0 = 0;
				y < y76 + 14;
