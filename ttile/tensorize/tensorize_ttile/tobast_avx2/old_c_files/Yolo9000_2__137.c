...
[V f; U (4, f); ULambda y; U (3, w); T (8, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (17, y); T (1, f); T (4, c); T (4, x);
  Lambda_apply y [((Iter 2), (Arg 5)); ((Iter 1), (Arg 6))]; T (2, f);
  T (34, x)]
*/
IND_TYPE c, cp_0, c1116_p_0, cp_1, c1116, f, fp_0, f988_p_0, fp_1, f988, h, hp_0, x, xp_0, x1488_p_0, x1489_p_0, xp_1, x1488_p_1, xp_2, x1488, x1489, y, yp_0, y1116_p_0, yp_1, y1116;
...
for (x1489 = x1490, x1489_p_0 = 0;
	...
	// T (f, 2) (64 / 32)
	for (f988 = f989, f988_p_0 = 0;
		f988 < f989 + 64;
		f988 += 32, f988_p_0 += 32){
			for (y1116 = y1117, y1116_p_0 = 0;
				y1116 < y1117 + 170;
				y1116 += 85, y1116_p_0 += 85){
				// y = 17 * ph_y, x = 8, h = 3, w = 3, c = 32, f = 32
				// T (x, 4) (8 / 2)
				for (x1488 = x1489, x1488_p_1 = x1489_p_0, x1488_p_0 = 0;
					x1488 < x1489 + 8;
					x1488 += 2, x1488_p_1 += 2, x1488_p_0 += 2){
					// y = 17 * ph_y, x = 2, h = 3, w = 3, c = 32, f = 32
					// T (c, 4) (32 / 8)
					for (c1116 = c1117, c1116_p_0 = 0;
						c1116 < c1117 + 32;
						c1116 += 8, c1116_p_0 += 8){
						// y = 17 * ph_y, x = 2, h = 3, w = 3, c = 8, f = 32
						// T (f, 1) (32 / 32)
						for (f = f988, fp_1 = f988_p_0, fp_0 = 0;
							f < f988 + 32;
							f += 32, fp_1 += 32, fp_0 += 32){
							// y = 17 * ph_y, x = 2, h = 3, w = 3, c = 8, f = 32
							// T (y, 17) (17 * ph_y / ph_y)
							for (y = y1116, yp_1 = y1116_p_0, yp_0 = 0;
								y < y1116 + 85;
								y += 5, yp_1 += 5, yp_0 += 5){
			...
			for (y1116 = y1117 + 170, y1116_p_0 = 0;
				y1116 < y1117 + 170 + 102;
				y1116 += 102, y1116_p_0 += 102){
				// y = 17 * ph_y, x = 8, h = 3, w = 3, c = 32, f = 32
				// T (x, 4) (8 / 2)
				for (x1488 = x1489, x1488_p_1 = x1489_p_0, x1488_p_0 = 0;
					x1488 < x1489 + 8;
									...
									for (x = x1488, xp_2 = x1488_p_1, xp_1 = x1488_p_0, xp_0 = 0;
										...
										x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c1116, cp_1 = c1116_p_0, cp_0 = 0;
													...
													vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_12228);
													mem_vec_12228 = vec_34;

													vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

													vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_12229);
													mem_vec_12229 = vec_37;

													vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_12230);
													mem_vec_12230 = vec_39;

													vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

													vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_12231);
													mem_vec_12231 = vec_41;
													scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
													vec_44 = _mm256_set1_ps(scal_7);


													vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_12232);
													mem_vec_12232 = vec_43;



													vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_12233);
													mem_vec_12233 = vec_45;



													vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_12234);
													mem_vec_12234 = vec_46;



													vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_12235);
													mem_vec_12235 = vec_47;
													scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
													vec_49 = _mm256_set1_ps(scal_8);


													vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_12236);
													mem_vec_12236 = vec_48;



													vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_12237);
													mem_vec_12237 = vec_50;



													vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_12238);
													mem_vec_12238 = vec_51;



													vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_12239);
													mem_vec_12239 = vec_52;
													scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
													vec_54 = _mm256_set1_ps(scal_9);


													vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_12240);
													mem_vec_12240 = vec_53;



													vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_12241);
													mem_vec_12241 = vec_55;



													vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_12242);
													mem_vec_12242 = vec_56;



													vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_12243);
													mem_vec_12243 = vec_57;
													scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
													vec_59 = _mm256_set1_ps(scal_10);


													vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_12244);
													mem_vec_12244 = vec_58;



													vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_12245);
													mem_vec_12245 = vec_60;



													vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_12246);
													mem_vec_12246 = vec_61;



													vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_12247);
													mem_vec_12247 = vec_62;
													scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
													vec_64 = _mm256_set1_ps(scal_11);


													vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_12248);
													mem_vec_12248 = vec_63;



													vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_12249);
													mem_vec_12249 = vec_65;



													vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_12250);
													mem_vec_12250 = vec_66;



													vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_12251);
													mem_vec_12251 = vec_67;
													scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
													vec_69 = _mm256_set1_ps(scal_12);
													vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_12228);
													mem_vec_12228 = vec_68;

													vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

													vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_12229);
													mem_vec_12229 = vec_71;

													vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_12230);
													mem_vec_12230 = vec_73;

													vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

													vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_12231);
													mem_vec_12231 = vec_75;
													scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
													vec_78 = _mm256_set1_ps(scal_13);


													vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_12232);
													mem_vec_12232 = vec_77;



													vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_12233);
													mem_vec_12233 = vec_79;



													vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_12234);
													mem_vec_12234 = vec_80;



													vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_12235);
													mem_vec_12235 = vec_81;
													scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
													vec_83 = _mm256_set1_ps(scal_14);


													vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_12236);
													mem_vec_12236 = vec_82;



													vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_12237);
													mem_vec_12237 = vec_84;



													vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_12238);
													mem_vec_12238 = vec_85;



													vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_12239);
													mem_vec_12239 = vec_86;
													scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
													vec_88 = _mm256_set1_ps(scal_15);


													vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_12240);
													mem_vec_12240 = vec_87;



													vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_12241);
													mem_vec_12241 = vec_89;



													vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_12242);
													mem_vec_12242 = vec_90;



													vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_12243);
													mem_vec_12243 = vec_91;
													scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
													vec_93 = _mm256_set1_ps(scal_16);


													vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_12244);
													mem_vec_12244 = vec_92;



													vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_12245);
													mem_vec_12245 = vec_94;



													vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_12246);
													mem_vec_12246 = vec_95;



													vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_12247);
													mem_vec_12247 = vec_96;
													scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
													vec_98 = _mm256_set1_ps(scal_17);


													vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_12248);
													mem_vec_12248 = vec_97;



													vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_12249);
													mem_vec_12249 = vec_99;



													vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_12250);
													mem_vec_12250 = vec_100;



													vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_12251);
													mem_vec_12251 = vec_101;
												}
