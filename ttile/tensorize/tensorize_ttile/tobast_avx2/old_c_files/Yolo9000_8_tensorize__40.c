...
[V f; U (4, f); U (4, y); T (1, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (4, f); T (1, x); T (17, y); T (2, f); T (128, c); T (17, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c138_p_0, cp_1, c138, f, fp_0, f184_p_0, f185_p_0, fp_1, f184_p_1, fp_2, f184, f185, h, hp_0, w, wp_0, x, xp_0, x184_p_0, x185_p_0, xp_1, x184_p_1, xp_2, x184, x185, y, yp_0;
IND_TYPE y92 = 0;
IND_TYPE x186 = 0;
IND_TYPE h92 = 0;
IND_TYPE w92 = 0;
