...
fp_2 = 0;
							for (h = h222, hp_0 = 0;h < h222 + 3;h += 1, hp_0 += 1){
								...
								for (w = w236, wp_0 = 0;w < w236 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 14) (14 / 1)
									for (x = x444, xp_1 = x444_p_0, xp_0 = 0;x < x444 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4288 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_4289 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_4290 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_4291 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_4288);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_4289);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4290);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4291);
									}
								}
							}
}
