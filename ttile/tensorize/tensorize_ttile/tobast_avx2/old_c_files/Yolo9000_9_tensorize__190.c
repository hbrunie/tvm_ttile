...
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (68, x); T (17, y);
  T (4, f); T (1, f); T (16, c); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c84_p_0, cp_1, c84, f, fp_0, f112_p_0, f113_p_0, fp_1, f112_p_1, fp_2, f112, f113, x, xp_0, x84_p_0, xp_1, x84, y, yp_0;
IND_TYPE y56 = 0;
IND_TYPE x85 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
						for (x = x84, xp_1 = x84_p_0, xp_0 = 0;x < x84 + 68;x += 1, xp_1 += 1, xp_0 += 1){
