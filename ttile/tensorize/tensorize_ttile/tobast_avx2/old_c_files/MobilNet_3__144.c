...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, f); T (14, x); T (14, y); T (1, f); T (128, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c190_p_0, cp_1, c190, f, fp_0, f180_p_0, f181_p_0, fp_1, f180_p_1, fp_2, f180, f181, w, wp_0, x, xp_0, x224_p_0, x225_p_0, xp_1, x224_p_1, xp_2, x224, x225, y, yp_0;
