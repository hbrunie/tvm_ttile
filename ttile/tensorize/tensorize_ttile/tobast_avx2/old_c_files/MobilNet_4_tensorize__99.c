...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (4, f); T (1, x); T (7, y); T (1, f); T (32, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, f, fp_0, f260_p_0, f261_p_0, fp_1, f260_p_1, fp_2, f260, f261, w, wp_0, x, xp_0, x332_p_0, x333_p_0, xp_1, x332_p_1, xp_2, x332, x333, y, yp_0;
IND_TYPE y148 = 0;
IND_TYPE x334 = 0;
IND_TYPE h = 0;
IND_TYPE w148 = 0;
