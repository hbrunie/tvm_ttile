...
for (c908 = c909, c908_p_0 = 0;
	...
	for (x1120 = x1121, x1120_p_0 = 0;
		...
		for (f = f1096, fp_0 = 0;
			...
			// T (c, 16) (64 / 4)
			for (c907 = c908, c907_p_1 = c908_p_0, c907_p_0 = 0;
				c907 < c908 + 64;
				c907 += 4, c907_p_1 += 4, c907_p_0 += 4){
					for (y = y572, yp_0 = 0;
						y < y572 + 24;
						y += 8, yp_0 += 8){
						// y = ph_y, x = 2, h = 3, w = 3, c = 4, f = 16
						// T (c, 1) (4 / 4)
						for (c906 = c907, c906_p_2 = c907_p_1, c906_p_1 = c907_p_0, c906_p_0 = 0;
							c906 < c907 + 4;
							c906 += 4, c906_p_2 += 4, c906_p_1 += 4, c906_p_0 += 4){
							// y = ph_y, x = 2, h = 3, w = 3, c = 4, f = 16
							// T (w, 3) (3 / 1)
							for (w = w452, wp_0 = 0;
								w < w452 + 3;
								...
								for (x = x1120, xp_1 = x1120_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_5906 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
											mem_vec_5907 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
											mem_vec_5908 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
											mem_vec_5909 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
											mem_vec_5910 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
											mem_vec_5911 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
											mem_vec_5912 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
											mem_vec_5913 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8]);
											mem_vec_5914 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_5915 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
											mem_vec_5916 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_5917 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
											mem_vec_5918 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
											mem_vec_5919 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 8]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 4, f = 16
											// T (c, 4) (4 / 1)
											for (c = c906, cp_3 = c906_p_2, cp_2 = c906_p_1, cp_1 = c906_p_0, cp_0 = 0;
												c < c906 + 4;
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_5906);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_5907);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_5908);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_5909);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_5910);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_5911);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_5912);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8], mem_vec_5913);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_5914);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_5915);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_5916);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_5917);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_5918);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 8], mem_vec_5919);
								}
							}
						}
					}
					for (y = y572 + 24, yp_0 = 0;
						y < y572 + 24 + 44;
						y += 11, yp_0 += 11){
						// y = ph_y, x = 2, h = 3, w = 3, c = 4, f = 16
						// T (c, 1) (4 / 4)
							...
							for (w = w452, wp_0 = 0;
								...
								for (x = x1120, xp_1 = x1120_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_5938 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
											mem_vec_5939 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 8]);
											mem_vec_5940 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_5941 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 8]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 4, f = 16
											// T (c, 4) (4 / 1)
											for (c = c906, cp_3 = c906_p_2, cp_2 = c906_p_1, cp_1 = c906_p_0, cp_0 = 0;
												c < c906 + 4;
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_5938);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 8], mem_vec_5939);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_5940);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 8], mem_vec_5941);
								}
							}
						}
					}
