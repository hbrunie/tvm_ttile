...
[V f; U (4, f); U (4, y); T (4, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (1, f); T (7, x); T (7, y); T (2, x); T (4, f); T (32, c);
  T (2, x)]
*/
IND_TYPE c, cp_0, c66_p_0, cp_1, c66, f, fp_0, f66_p_0, fp_1, f66, h, hp_0, w, wp_0, x, xp_0, x110_p_0, x111_p_0, x112_p_0, xp_1, x110_p_1, x111_p_1, xp_2, x110_p_2, xp_3, x110, x111, x112, y, yp_0;
IND_TYPE y44 = 0;
IND_TYPE x113 = 0;
IND_TYPE h44 = 0;
IND_TYPE w44 = 0;
