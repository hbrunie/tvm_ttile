...
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (8, f); T (2, x); T (7, y); T (1, f); T (128, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c48_p_0, cp_1, c48, f, fp_0, f64_p_0, f65_p_0, fp_1, f64_p_1, fp_2, f64, f65, h, hp_0, w, wp_0, x, xp_0, x64_p_0, x65_p_0, xp_1, x64_p_1, xp_2, x64, x65, y, yp_0;
IND_TYPE y32 = 0;
IND_TYPE x66 = 0;
IND_TYPE h32 = 0;
IND_TYPE w32 = 0;
...
fp_2 = 0;
							for (h = h32, hp_0 = 0;h < h32 + 3;h += 1, hp_0 += 1){
								...
								for (w = w32, wp_0 = 0;w < w32 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 7) (7 / 1)
									for (x = x64, xp_2 = x64_p_1, xp_1 = x64_p_0, xp_0 = 0;x < x64 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
