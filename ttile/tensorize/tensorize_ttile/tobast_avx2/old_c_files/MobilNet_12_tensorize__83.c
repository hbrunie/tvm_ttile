...
yp_0 = 0;
					for (w = w650, wp_0 = 0;w < w650 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 112) (112 / 1)
						for (x = x1392, xp_1 = x1392_p_0, xp_0 = 0;x < x1392 + 112;x += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_10444 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									mem_vec_10445 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 8]);
									mem_vec_10446 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_10447 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8]);
									...
									mem_vec_10450 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									mem_vec_10451 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8]);
									...
									mem_vec_10454 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									mem_vec_10455 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8]);
									mem_vec_10456 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									mem_vec_10457 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8]);
									mem_vec_10458 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									mem_vec_10459 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 8]);
									mem_vec_10460 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_10461 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
									mem_vec_10462 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									mem_vec_10463 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
									mem_vec_10464 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									mem_vec_10465 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8]);
									mem_vec_10466 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
									mem_vec_10467 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8]);
									mem_vec_10468 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									mem_vec_10469 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8]);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_10444);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 8], mem_vec_10445);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_10446);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8], mem_vec_10447);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_10450);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8], mem_vec_10451);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_10454);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8], mem_vec_10455);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_10456);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8], mem_vec_10457);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_10458);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 8], mem_vec_10459);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_10460);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_10461);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_10462);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_10463);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_10464);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8], mem_vec_10465);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_10466);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8], mem_vec_10467);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_10468);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8], mem_vec_10469);
						}
					}
}
