...
[V f; U (4, f); U (7, y); U (3, w); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (7, x); T (4, y); T (8, f); T (32, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c610_p_0, cp_1, c610, f, fp_0, f720_p_0, f721_p_0, fp_1, f720_p_1, fp_2, f720, f721, h, hp_0, x, xp_0, x776_p_0, x777_p_0, xp_1, x776_p_1, xp_2, x776, x777, y, yp_0;
