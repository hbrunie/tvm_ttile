...
/*
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (1, f); T (1, x); T (17, y); T (2, f); T (64, c); T (4, x);
  T (4, f)]
*/
...
for (f441 = f442, f441_p_0 = 0;
	...
	for (x441 = x442, x441_p_0 = 0;
		...
		for (c330 = c331, c330_p_0 = 0;
			c330 < c331 + 128;
			c330 += 2, c330_p_0 += 2){
			// y = 68, x = 17, h = 3, w = 3, c = 2, f = 64
			// T (f, 2) (64 / 32)
			for (f440 = f441, f440_p_1 = f441_p_0, f440_p_0 = 0;
				f440 < f441 + 64;
				f440 += 32, f440_p_1 += 32, f440_p_0 += 32){
				// y = 68, x = 17, h = 3, w = 3, c = 2, f = 32
				// T (y, 17) (68 / 4)
				for (y = y220, yp_0 = 0;
					y < y220 + 68;
					y += 4, yp_0 += 4){
					// y = 4, x = 17, h = 3, w = 3, c = 2, f = 32
					// T (x, 1) (17 / 17)
