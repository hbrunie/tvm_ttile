...
[V f; U (4, f); U (7, y); U (3, w); T (256, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (4, f); T (14, x); T (2, y); T (2, f); T (1, c); T (1, f)]
*/
IND_TYPE c, cp_0, c336_p_0, cp_1, c336, f, fp_0, f448_p_0, f449_p_0, fp_1, f448_p_1, fp_2, f448, f449, h, hp_0, x, xp_0, x336_p_0, xp_1, x336, y, yp_0;
