...
c912_p_1 = 0;
							for (w = w434, wp_0 = 0;w < w434 + 3;w += 1, wp_0 += 1){
								...
								for (x = x1078, xp_2 = x1078_p_1, xp_1 = x1078_p_0, xp_0 = 0;x < x1078 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6752 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_6753 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_6752);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_6753);
								}
							}
}
