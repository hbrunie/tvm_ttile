...
[V f; U (4, f); U (7, y); U (3, h); T (256, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, f); T (7, x); T (2, y); T (2, f); T (1, c); T (2, f)]
*/
IND_TYPE c, cp_0, c96_p_0, cp_1, c96, f, fp_0, f128_p_0, f129_p_0, fp_1, f128_p_1, fp_2, f128, f129, w, wp_0, x, xp_0, x96_p_0, xp_1, x96, y, yp_0;
						...
						for (w = w64, wp_0 = 0;
							...
							for (x = x96, xp_1 = x96_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_922 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
										mem_vec_923 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_922);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_923);
							}
						}
					}
				}
