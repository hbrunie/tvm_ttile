...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (1, f); T (7, x); T (7, y); T (1, f); T (32, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c156_p_0, cp_1, c156, f, fp_0, f172_p_0, f173_p_0, fp_1, f172_p_1, fp_2, f172, f173, w, wp_0, x, xp_0, x244_p_0, x245_p_0, xp_1, x244_p_1, xp_2, x244, x245, y, yp_0;
IND_TYPE y104 = 0;
IND_TYPE x246 = 0;
IND_TYPE h = 0;
IND_TYPE w104 = 0;
