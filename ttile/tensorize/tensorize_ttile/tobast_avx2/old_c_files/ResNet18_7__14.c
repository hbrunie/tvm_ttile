...
[V f; U (4, f); U (7, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (14, x); T (2, y); T (2, f); T (128, c); T (4, f)]
*/
IND_TYPE c, cp_0, c132_p_0, cp_1, c132, f, fp_0, f176_p_0, f177_p_0, fp_1, f176_p_1, fp_2, f176, f177, w, wp_0, x, xp_0, x132_p_0, xp_1, x132, y, yp_0;
