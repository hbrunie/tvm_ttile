...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, f); T (7, x); T (7, y); T (2, f); T (32, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c172_p_0, cp_1, c172, f, fp_0, f136_p_0, f137_p_0, fp_1, f136_p_1, fp_2, f136, f137, w, wp_0, x, xp_0, x192_p_0, x193_p_0, xp_1, x192_p_1, xp_2, x192, x193, y, yp_0;
IND_TYPE y96 = 0;
IND_TYPE x194 = 0;
IND_TYPE h = 0;
IND_TYPE w96 = 0;
...
fp_2 = 0;
							for (w = w96, wp_0 = 0;w < w96 + 3;w += 1, wp_0 += 1){
								...
								for (x = x192, xp_2 = x192_p_1, xp_1 = x192_p_0, xp_0 = 0;x < x192 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 4, f = 32
											// T (c, 4) (4 / 1)
											for (c = c172, cp_1 = c172_p_0, cp_0 = 0;c < c172 + 4;c += 1, cp_1 += 1, cp_0 += 1){
