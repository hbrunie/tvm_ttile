...
yp_0 = 0;
					for (w = w586, wp_0 = 0;w < w586 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 8) (8 / 1)
						for (x = x1296, xp_1 = x1296_p_0, xp_0 = 0;x < x1296 + 8;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_8978 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									mem_vec_8979 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
									mem_vec_8980 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									mem_vec_8981 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8]);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_8978);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_8979);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_8980);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8], mem_vec_8981);
						}
					}
}
