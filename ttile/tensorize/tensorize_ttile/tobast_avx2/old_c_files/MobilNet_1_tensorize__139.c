...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, x); T (28, y); T (2, c); T (16, x)]
*/
IND_TYPE c, cp_0, c234_p_0, cp_1, c234, w, wp_0, x, xp_0, x282_p_0, x283_p_0, xp_1, x282_p_1, xp_2, x282, x283, y, yp_0;
IND_TYPE y156 = 0;
IND_TYPE x284 = 0;
IND_TYPE h = 0;
IND_TYPE w156 = 0;
...
x282_p_1 = 0;
				for (w = w156, wp_0 = 0;w < w156 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 7) (7 / 1)
					for (x = x282, xp_2 = x282_p_1, xp_1 = x282_p_0, xp_0 = 0;x < x282 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
