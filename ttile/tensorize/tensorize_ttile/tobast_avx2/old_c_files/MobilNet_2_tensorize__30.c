...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (56, x);
  T (3, w); T (14, y); T (2, f); T (2, c); T (1, f); T (2, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c84_p_0, c85_p_0, cp_1, c84_p_1, cp_2, c84, c85, f, fp_0, f56_p_0, f57_p_0, fp_1, f56_p_1, fp_2, f56, f57, w, wp_0, x, xp_0, x112_p_0, xp_1, x112, y, yp_0;
IND_TYPE y56 = 0;
IND_TYPE x113 = 0;
IND_TYPE h = 0;
IND_TYPE w56 = 0;
...
yp_0 = 0;
							for (w = w56, wp_0 = 0;w < w56 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 56) (56 / 1)
								for (x = x112, xp_1 = x112_p_0, xp_0 = 0;x < x112 + 56;x += 1, xp_1 += 1, xp_0 += 1){
