...
[V f; U (4, f); U (7, y); U (3, h); T (256, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (8, f); T (2, x); T (2, y); T (1, f); T (1, c); T (1, f)]
*/
IND_TYPE c, cp_0, c42_p_0, cp_1, c42, f, fp_0, f56_p_0, f57_p_0, fp_1, f56_p_1, fp_2, f56, f57, w, wp_0, x, xp_0, x42_p_0, xp_1, x42, y, yp_0;
