...
[V f; U (4, f); U (7, y); U (3, h); T (64, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, f); T (1, x); T (8, y); T (1, f); T (2, c); T (28, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c286_p_0, cp_1, c286, f, fp_0, f308_p_0, f309_p_0, fp_1, f308_p_1, fp_2, f308, f309, w, wp_0, x, xp_0, x352_p_0, x353_p_0, xp_1, x352_p_1, xp_2, x352, x353, y, yp_0;
