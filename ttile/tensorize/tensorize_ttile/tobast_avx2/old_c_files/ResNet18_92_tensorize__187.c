							...
							for (h = h230, hp_0 = 0;h < h230 + 3;h += 1, hp_0 += 1){
								...
								for (w = w244, wp_0 = 0;w < w244 + 3;w += 1, wp_0 += 1){
									...
									for (x = x456, xp_1 = x456_p_0, xp_0 = 0;x < x456 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4432 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_4433 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_4434 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_4435 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_4432);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_4433);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4434);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4435);
									}
								}
							}
}
