...
[V f; U (4, f); ULambda y; U (3, h); T (8, c); Hoist_vars [c]; T (8, x);
  ...
  T (1, f); T (1, c); T (1, f); T (8, c); T (7, x); T (2, f)]
*/
IND_TYPE c, cp_0, c782_p_0, c783_p_0, cp_1, c782_p_1, cp_2, c782, c783, f, fp_0, f708_p_0, f709_p_0, fp_1, f708_p_1, fp_2, f708, f709, w, wp_0, x, xp_0, x702_p_0, xp_1, x702, y, yp_0;
									...
									for (x = x702, xp_1 = x702_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c782, cp_2 = c782_p_1, cp_1 = c782_p_0, cp_0 = 0;
													...
													vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_5760);
													mem_vec_5760 = vec_24;

													vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

													vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_5761);
													mem_vec_5761 = vec_27;

													vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

													vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_5762);
													mem_vec_5762 = vec_29;

													vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

													vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_5763);
													mem_vec_5763 = vec_31;
													scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
													vec_34 = _mm256_set1_ps(scal_5);


													vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_5764);
													mem_vec_5764 = vec_33;



													vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_5765);
													mem_vec_5765 = vec_35;



													vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_5766);
													mem_vec_5766 = vec_36;



													vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_5767);
													mem_vec_5767 = vec_37;
													scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
													vec_39 = _mm256_set1_ps(scal_6);


													vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_5768);
													mem_vec_5768 = vec_38;



													vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_5769);
													mem_vec_5769 = vec_40;



													vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_5770);
													mem_vec_5770 = vec_41;



													vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_5771);
													mem_vec_5771 = vec_42;
													scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
													vec_44 = _mm256_set1_ps(scal_7);


													vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_5772);
													mem_vec_5772 = vec_43;



													vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_5773);
													mem_vec_5773 = vec_45;



													vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_5774);
													mem_vec_5774 = vec_46;



													vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_5775);
													mem_vec_5775 = vec_47;
													scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
													vec_49 = _mm256_set1_ps(scal_8);
													vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

													vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_5760);
													mem_vec_5760 = vec_48;

													vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

													vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_5761);
													mem_vec_5761 = vec_51;

													vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

													vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_5762);
													mem_vec_5762 = vec_53;

													vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

													vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_5763);
													mem_vec_5763 = vec_55;
													scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
													vec_58 = _mm256_set1_ps(scal_9);


													vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_5764);
													mem_vec_5764 = vec_57;



													vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_5765);
													mem_vec_5765 = vec_59;



													vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_5766);
													mem_vec_5766 = vec_60;



													vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_5767);
													mem_vec_5767 = vec_61;
													scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
													vec_63 = _mm256_set1_ps(scal_10);


													vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_5768);
													mem_vec_5768 = vec_62;



													vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_5769);
													mem_vec_5769 = vec_64;



													vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_5770);
													mem_vec_5770 = vec_65;



													vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_5771);
													mem_vec_5771 = vec_66;
													scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
													vec_68 = _mm256_set1_ps(scal_11);


													vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_5772);
													mem_vec_5772 = vec_67;



													vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_5773);
													mem_vec_5773 = vec_69;



													vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_5774);
													mem_vec_5774 = vec_70;



													vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_5775);
													mem_vec_5775 = vec_71;
												}
								...
								for (w = w346, wp_0 = 0;
									...
									for (x = x702, xp_1 = x702_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_5796 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
												mem_vec_5797 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
												mem_vec_5798 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
												mem_vec_5799 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
												mem_vec_5800 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
												mem_vec_5801 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
												mem_vec_5802 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
												mem_vec_5803 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 8, f = 32
												// T (c, 8) (8 / 1)
												for (c = c782, cp_2 = c782_p_1, cp_1 = c782_p_0, cp_0 = 0;
													c < c782 + 8;
													...
													vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_5796);
													mem_vec_5796 = vec_29;



													vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_5797);
													mem_vec_5797 = vec_31;



													vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_5798);
													mem_vec_5798 = vec_32;



													vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_5799);
													mem_vec_5799 = vec_33;
													scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h) + c];
													vec_35 = _mm256_set1_ps(scal_6);


													vec_34 = _mm256_fmadd_ps(vec_35, vec_2, mem_vec_5800);
													mem_vec_5800 = vec_34;



													vec_36 = _mm256_fmadd_ps(vec_35, vec_4, mem_vec_5801);
													mem_vec_5801 = vec_36;



													vec_37 = _mm256_fmadd_ps(vec_35, vec_6, mem_vec_5802);
													mem_vec_5802 = vec_37;



													vec_38 = _mm256_fmadd_ps(vec_35, vec_8, mem_vec_5803);
													mem_vec_5803 = vec_38;
													scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 1) + c];
													vec_40 = _mm256_set1_ps(scal_7);
													vec_41 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

													vec_39 = _mm256_fmadd_ps(vec_40, vec_41, mem_vec_5776);
													mem_vec_5776 = vec_39;

													vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

													vec_42 = _mm256_fmadd_ps(vec_40, vec_43, mem_vec_5777);
													mem_vec_5777 = vec_42;

													vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

													vec_44 = _mm256_fmadd_ps(vec_40, vec_45, mem_vec_5778);
													mem_vec_5778 = vec_44;

													vec_47 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

													vec_46 = _mm256_fmadd_ps(vec_40, vec_47, mem_vec_5779);
													mem_vec_5779 = vec_46;
													scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
													vec_49 = _mm256_set1_ps(scal_8);


													vec_48 = _mm256_fmadd_ps(vec_49, vec_41, mem_vec_5780);
													mem_vec_5780 = vec_48;



													vec_50 = _mm256_fmadd_ps(vec_49, vec_43, mem_vec_5781);
													mem_vec_5781 = vec_50;



													vec_51 = _mm256_fmadd_ps(vec_49, vec_45, mem_vec_5782);
													mem_vec_5782 = vec_51;



													vec_52 = _mm256_fmadd_ps(vec_49, vec_47, mem_vec_5783);
													mem_vec_5783 = vec_52;
													scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
													vec_54 = _mm256_set1_ps(scal_9);


													vec_53 = _mm256_fmadd_ps(vec_54, vec_41, mem_vec_5784);
													mem_vec_5784 = vec_53;



													vec_55 = _mm256_fmadd_ps(vec_54, vec_43, mem_vec_5785);
													mem_vec_5785 = vec_55;



													vec_56 = _mm256_fmadd_ps(vec_54, vec_45, mem_vec_5786);
													mem_vec_5786 = vec_56;



													vec_57 = _mm256_fmadd_ps(vec_54, vec_47, mem_vec_5787);
													mem_vec_5787 = vec_57;
													scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
													vec_59 = _mm256_set1_ps(scal_10);


													vec_58 = _mm256_fmadd_ps(vec_59, vec_41, mem_vec_5788);
													mem_vec_5788 = vec_58;



													vec_60 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_5789);
													mem_vec_5789 = vec_60;



													vec_61 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_5790);
													mem_vec_5790 = vec_61;



													vec_62 = _mm256_fmadd_ps(vec_59, vec_47, mem_vec_5791);
													mem_vec_5791 = vec_62;
													scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
													vec_64 = _mm256_set1_ps(scal_11);


													vec_63 = _mm256_fmadd_ps(vec_64, vec_41, mem_vec_5792);
													mem_vec_5792 = vec_63;



													vec_65 = _mm256_fmadd_ps(vec_64, vec_43, mem_vec_5793);
													mem_vec_5793 = vec_65;



													vec_66 = _mm256_fmadd_ps(vec_64, vec_45, mem_vec_5794);
													mem_vec_5794 = vec_66;



													vec_67 = _mm256_fmadd_ps(vec_64, vec_47, mem_vec_5795);
													mem_vec_5795 = vec_67;
													scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 1) + c];
													vec_69 = _mm256_set1_ps(scal_12);


													vec_68 = _mm256_fmadd_ps(vec_69, vec_41, mem_vec_5796);
													mem_vec_5796 = vec_68;



													vec_70 = _mm256_fmadd_ps(vec_69, vec_43, mem_vec_5797);
													mem_vec_5797 = vec_70;



													vec_71 = _mm256_fmadd_ps(vec_69, vec_45, mem_vec_5798);
													mem_vec_5798 = vec_71;



													vec_72 = _mm256_fmadd_ps(vec_69, vec_47, mem_vec_5799);
													mem_vec_5799 = vec_72;
													scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 1) + c];
													vec_74 = _mm256_set1_ps(scal_13);


													vec_73 = _mm256_fmadd_ps(vec_74, vec_41, mem_vec_5800);
													mem_vec_5800 = vec_73;



													vec_75 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_5801);
													mem_vec_5801 = vec_75;



													vec_76 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_5802);
													mem_vec_5802 = vec_76;



													vec_77 = _mm256_fmadd_ps(vec_74, vec_47, mem_vec_5803);
													mem_vec_5803 = vec_77;
													scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
													vec_79 = _mm256_set1_ps(scal_14);
													vec_80 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

													vec_78 = _mm256_fmadd_ps(vec_79, vec_80, mem_vec_5776);
													mem_vec_5776 = vec_78;

													vec_82 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

													vec_81 = _mm256_fmadd_ps(vec_79, vec_82, mem_vec_5777);
													mem_vec_5777 = vec_81;

													vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

													vec_83 = _mm256_fmadd_ps(vec_79, vec_84, mem_vec_5778);
													mem_vec_5778 = vec_83;

													vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

													vec_85 = _mm256_fmadd_ps(vec_79, vec_86, mem_vec_5779);
													mem_vec_5779 = vec_85;
													scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
													vec_88 = _mm256_set1_ps(scal_15);


													vec_87 = _mm256_fmadd_ps(vec_88, vec_80, mem_vec_5780);
													mem_vec_5780 = vec_87;



													vec_89 = _mm256_fmadd_ps(vec_88, vec_82, mem_vec_5781);
													mem_vec_5781 = vec_89;



													vec_90 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_5782);
													mem_vec_5782 = vec_90;



													vec_91 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_5783);
													mem_vec_5783 = vec_91;
													scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
													vec_93 = _mm256_set1_ps(scal_16);


													vec_92 = _mm256_fmadd_ps(vec_93, vec_80, mem_vec_5784);
													mem_vec_5784 = vec_92;



													vec_94 = _mm256_fmadd_ps(vec_93, vec_82, mem_vec_5785);
													mem_vec_5785 = vec_94;



													vec_95 = _mm256_fmadd_ps(vec_93, vec_84, mem_vec_5786);
													mem_vec_5786 = vec_95;



													vec_96 = _mm256_fmadd_ps(vec_93, vec_86, mem_vec_5787);
													mem_vec_5787 = vec_96;
													scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
													vec_98 = _mm256_set1_ps(scal_17);


													vec_97 = _mm256_fmadd_ps(vec_98, vec_80, mem_vec_5788);
													mem_vec_5788 = vec_97;



													vec_99 = _mm256_fmadd_ps(vec_98, vec_82, mem_vec_5789);
													mem_vec_5789 = vec_99;



													vec_100 = _mm256_fmadd_ps(vec_98, vec_84, mem_vec_5790);
													mem_vec_5790 = vec_100;



													vec_101 = _mm256_fmadd_ps(vec_98, vec_86, mem_vec_5791);
													mem_vec_5791 = vec_101;
													scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
													vec_103 = _mm256_set1_ps(scal_18);


													vec_102 = _mm256_fmadd_ps(vec_103, vec_80, mem_vec_5792);
													mem_vec_5792 = vec_102;



													vec_104 = _mm256_fmadd_ps(vec_103, vec_82, mem_vec_5793);
													mem_vec_5793 = vec_104;



													vec_105 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_5794);
													mem_vec_5794 = vec_105;



													vec_106 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_5795);
													mem_vec_5795 = vec_106;
													scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 2) + c];
													vec_108 = _mm256_set1_ps(scal_19);


													vec_107 = _mm256_fmadd_ps(vec_108, vec_80, mem_vec_5796);
													mem_vec_5796 = vec_107;



													vec_109 = _mm256_fmadd_ps(vec_108, vec_82, mem_vec_5797);
													mem_vec_5797 = vec_109;



													vec_110 = _mm256_fmadd_ps(vec_108, vec_84, mem_vec_5798);
													mem_vec_5798 = vec_110;



													vec_111 = _mm256_fmadd_ps(vec_108, vec_86, mem_vec_5799);
													mem_vec_5799 = vec_111;
													scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 2) + c];
													vec_113 = _mm256_set1_ps(scal_20);


													vec_112 = _mm256_fmadd_ps(vec_113, vec_80, mem_vec_5800);
													mem_vec_5800 = vec_112;



													vec_114 = _mm256_fmadd_ps(vec_113, vec_82, mem_vec_5801);
													mem_vec_5801 = vec_114;



													vec_115 = _mm256_fmadd_ps(vec_113, vec_84, mem_vec_5802);
													mem_vec_5802 = vec_115;



													vec_116 = _mm256_fmadd_ps(vec_113, vec_86, mem_vec_5803);
													mem_vec_5803 = vec_116;
												}
											...
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_5796);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_5797);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_5798);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_5799);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_5800);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_5801);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_5802);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_5803);
									}
								}
							}
					}
