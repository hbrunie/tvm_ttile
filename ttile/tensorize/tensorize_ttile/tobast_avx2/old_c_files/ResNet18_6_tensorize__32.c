...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (2, f); T (14, x); T (7, y); T (1, f); T (16, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c372_p_0, cp_1, c372, f, fp_0, f450_p_0, f451_p_0, fp_1, f450_p_1, fp_2, f450, f451, h, hp_0, x, xp_0, x542_p_0, x543_p_0, xp_1, x542_p_1, xp_2, x542, x543, y, yp_0;
IND_TYPE y248 = 0;
IND_TYPE x544 = 0;
IND_TYPE h178 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h178, hp_0 = 0;h < h178 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x542, xp_2 = x542_p_1, xp_1 = x542_p_0, xp_0 = 0;x < x542 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
