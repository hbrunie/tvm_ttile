...
/*
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (1, x); T (28, y); T (32, c); T (14, x)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, w, wp_0, x, xp_0, x242_p_0, x243_p_0, xp_1, x242_p_1, xp_2, x242, x243, y, yp_0;
IND_TYPE y136 = 0;
IND_TYPE x244 = 0;
IND_TYPE h = 0;
IND_TYPE w136 = 0;
...
x242_p_1 = 0;
				for (w = w136, wp_0 = 0;w < w136 + 3;w += 1, wp_0 += 1){
					// y = 4, x = 8, h = 3, w = 1, c = 1, f = 32
					// T (x, 8) (8 / 1)
					for (x = x242, xp_2 = x242_p_1, xp_1 = x242_p_0, xp_0 = 0;x < x242 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
