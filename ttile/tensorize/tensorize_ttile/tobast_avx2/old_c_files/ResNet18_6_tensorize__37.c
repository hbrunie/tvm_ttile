...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (4, f); T (32, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c198_p_0, cp_1, c198, f, fp_0, f218_p_0, f219_p_0, fp_1, f218_p_1, fp_2, f218, f219, w, wp_0, x, xp_0, x310_p_0, x311_p_0, xp_1, x310_p_1, xp_2, x310, x311, y, yp_0;
IND_TYPE y132 = 0;
IND_TYPE x312 = 0;
IND_TYPE h = 0;
IND_TYPE w132 = 0;
...
fp_2 = 0;
							for (w = w132, wp_0 = 0;w < w132 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x310, xp_2 = x310_p_1, xp_1 = x310_p_0, xp_0 = 0;x < x310 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
