...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, f); T (7, x); T (7, y); T (4, f); T (16, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c426_p_0, cp_1, c426, f, fp_0, f532_p_0, f533_p_0, fp_1, f532_p_1, fp_2, f532, f533, h, hp_0, x, xp_0, x604_p_0, x605_p_0, xp_1, x604_p_1, xp_2, x604, x605, y, yp_0;
IND_TYPE y284 = 0;
IND_TYPE x606 = 0;
IND_TYPE h194 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h194, hp_0 = 0;h < h194 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x604, xp_2 = x604_p_1, xp_1 = x604_p_0, xp_0 = 0;x < x604 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
