...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (2, y); T (2, f); T (16, c); T (2, x); T (34, y); T (1, f);
  T (34, x)]
*/
IND_TYPE c, cp_0, c246_p_0, cp_1, c246, f, fp_0, f236_p_0, fp_1, f236, w, wp_0, x, xp_0, x328_p_0, x329_p_0, xp_1, x328_p_1, xp_2, x328, x329, y, yp_0, y246_p_0, yp_1, y246;
IND_TYPE y247 = 0;
IND_TYPE x330 = 0;
IND_TYPE h = 0;
IND_TYPE w164 = 0;
