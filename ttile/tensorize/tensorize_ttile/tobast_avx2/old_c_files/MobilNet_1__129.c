...
/*
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (112, x);
  T (3, w); T (1, x); T (28, y); T (16, c); T (1, x)]
*/
IND_TYPE c, cp_0, c90_p_0, cp_1, c90, w, wp_0, x, xp_0, x90_p_0, x91_p_0, xp_1, x90_p_1, xp_2, x90, x91, y, yp_0;
...
for (x91 = x92, x91_p_0 = 0;
	...
	for (c90 = c91, c90_p_0 = 0;
		...
		for (y = y60, yp_0 = 0;
			y < y60 + 112;
			y += 4, yp_0 += 4){
			// y = 4, x = 112, h = 3, w = 3, c = 2, f = 32
			// T (x, 1) (112 / 112)
			for (x90 = x91, x90_p_1 = x91_p_0, x90_p_0 = 0;
				x90 < x91 + 112;
				x90 += 112, x90_p_1 += 112, x90_p_0 += 112){
				// y = 4, x = 112, h = 3, w = 3, c = 2, f = 32
				// T (w, 3) (3 / 1)
				for (w = w60, wp_0 = 0;
					w < w60 + 3;
					w += 1, wp_0 += 1){
					// y = 4, x = 112, h = 3, w = 1, c = 2, f = 32
					// T (x, 112) (112 / 1)
					for (x = x90, xp_2 = x90_p_1, xp_1 = x90_p_0, xp_0 = 0;
						x < x90 + 112;
