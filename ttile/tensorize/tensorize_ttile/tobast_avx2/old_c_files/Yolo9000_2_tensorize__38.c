...
/*
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (17, x); T (3, w);
  T (3, h); T (4, y); T (1, f); T (4, c); T (1, x); T (17, y); T (2, f);
  T (16, x)]
*/
IND_TYPE c, cp_0, c72_p_0, cp_1, c72, f, fp_0, f72_p_0, fp_1, f72, h, hp_0, w, wp_0, x, xp_0, x96_p_0, x97_p_0, xp_1, x96_p_1, xp_2, x96, x97, y, yp_0, y72_p_0, yp_1, y72;
IND_TYPE y73 = 0;
IND_TYPE x98 = 0;
IND_TYPE h48 = 0;
IND_TYPE w48 = 0;
