...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (1, x); T (14, y); T (4, f); T (128, c); T (28, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c214_p_0, cp_1, c214, f, fp_0, f212_p_0, f213_p_0, fp_1, f212_p_1, fp_2, f212, f213, w, wp_0, x, xp_0, x256_p_0, x257_p_0, xp_1, x256_p_1, xp_2, x256, x257, y, yp_0;
IND_TYPE y128 = 0;
IND_TYPE x258 = 0;
IND_TYPE h = 0;
IND_TYPE w128 = 0;
...
fp_2 = 0;
							for (w = w128, wp_0 = 0;w < w128 + 3;w += 1, wp_0 += 1){
								...
								for (x = x256, xp_2 = x256_p_1, xp_1 = x256_p_0, xp_0 = 0;x < x256 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 1) (1 / 1)
											for (c = c214, cp_1 = c214_p_0, cp_0 = 0;c < c214 + 1;c += 1, cp_1 += 1, cp_0 += 1){
