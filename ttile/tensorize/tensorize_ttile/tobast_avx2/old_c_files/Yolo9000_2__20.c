		...
		f682 += 32, f682_p_0 += 32){
			for (y810 = y811, y810_p_0 = 0;
				...
				for (x1080 = x1081, x1080_p_1 = x1081_p_0, x1080_p_0 = 0;
					x1080 < x1081 + 16;
					x1080 += 16, x1080_p_1 += 16, x1080_p_0 += 16){
					// y = 17 * ph_y, x = 16, h = 3, w = 3, c = 32, f = 32
					// T (c, 32) (32 / 1)
					for (c810 = c811, c810_p_0 = 0;
						c810 < c811 + 32;
						c810 += 1, c810_p_0 += 1){
						// y = 17 * ph_y, x = 16, h = 3, w = 3, c = 1, f = 32
						// T (f, 1) (32 / 32)
						for (f = f682, fp_1 = f682_p_0, fp_0 = 0;
							...
							// y = 17 * ph_y, x = 16, h = 3, w = 3, c = 1, f = 32
							// T (y, 17) (17 * ph_y / ph_y)
							for (y = y810, yp_1 = y810_p_0, yp_0 = 0;
								y < y810 + 68;
								y += 4, yp_1 += 4, yp_0 += 4){
			...
			for (y810 = y811 + 68, y810_p_0 = 0;
				y810 < y811 + 68 + 204;
				y810 += 102, y810_p_0 += 102){
				// y = 17 * ph_y, x = 16, h = 3, w = 3, c = 32, f = 32
				// T (x, 1) (16 / 16)
				for (x1080 = x1081, x1080_p_1 = x1081_p_0, x1080_p_0 = 0;
					x1080 < x1081 + 16;
								...
								for (w = w490, wp_0 = 0;
									...
									for (x = x1080, xp_2 = x1080_p_1, xp_1 = x1080_p_0, xp_0 = 0;
										...
										x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_7744 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
												mem_vec_7745 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8]);
												mem_vec_7746 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
												mem_vec_7747 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24]);
												mem_vec_7748 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
												mem_vec_7749 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
												mem_vec_7750 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
												mem_vec_7751 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 1, f = 32
												// T (c, 1) (1 / 1)
												for (c = c810, cp_1 = c810_p_0, cp_0 = 0;
													c < c810 + 1;
													...
													vec_24 = _mm256_fmadd_ps(vec_25, vec_2, mem_vec_7744);
													mem_vec_7744 = vec_24;



													vec_26 = _mm256_fmadd_ps(vec_25, vec_4, mem_vec_7745);
													mem_vec_7745 = vec_26;



													vec_27 = _mm256_fmadd_ps(vec_25, vec_6, mem_vec_7746);
													mem_vec_7746 = vec_27;



													vec_28 = _mm256_fmadd_ps(vec_25, vec_8, mem_vec_7747);
													mem_vec_7747 = vec_28;
													...
													vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_7750);
													mem_vec_7750 = vec_32;



													vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_7751);
													mem_vec_7751 = vec_33;
													scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
													vec_35 = _mm256_set1_ps(scal_6);
													vec_36 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

													vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_7728);
													mem_vec_7728 = vec_34;

													vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

													vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_7729);
													mem_vec_7729 = vec_37;

													vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

													vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_7730);
													mem_vec_7730 = vec_39;

													vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

													vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_7731);
													mem_vec_7731 = vec_41;
													scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
													vec_44 = _mm256_set1_ps(scal_7);


													vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_7732);
													mem_vec_7732 = vec_43;



													vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_7733);
													mem_vec_7733 = vec_45;



													vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_7734);
													mem_vec_7734 = vec_46;



													vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_7735);
													mem_vec_7735 = vec_47;
													scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
													vec_49 = _mm256_set1_ps(scal_8);


													vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_7736);
													mem_vec_7736 = vec_48;



													vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_7737);
													mem_vec_7737 = vec_50;



													vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_7738);
													mem_vec_7738 = vec_51;



													vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_7739);
													mem_vec_7739 = vec_52;
													scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
													vec_54 = _mm256_set1_ps(scal_9);


													vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_7740);
													mem_vec_7740 = vec_53;



													vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_7741);
													mem_vec_7741 = vec_55;



													vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_7742);
													mem_vec_7742 = vec_56;



													vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_7743);
													mem_vec_7743 = vec_57;
													scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
													vec_59 = _mm256_set1_ps(scal_10);


													vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_7744);
													mem_vec_7744 = vec_58;



													vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_7745);
													mem_vec_7745 = vec_60;



													vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_7746);
													mem_vec_7746 = vec_61;



													vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_7747);
													mem_vec_7747 = vec_62;
													scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
													vec_64 = _mm256_set1_ps(scal_11);


													vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_7748);
													mem_vec_7748 = vec_63;



													vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_7749);
													mem_vec_7749 = vec_65;



													vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_7750);
													mem_vec_7750 = vec_66;



													vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_7751);
													mem_vec_7751 = vec_67;
													scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
													vec_69 = _mm256_set1_ps(scal_12);
													vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

													vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_7728);
													mem_vec_7728 = vec_68;

													vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

													vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_7729);
													mem_vec_7729 = vec_71;

													vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

													vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_7730);
													mem_vec_7730 = vec_73;

													vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

													vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_7731);
													mem_vec_7731 = vec_75;
													scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
													vec_78 = _mm256_set1_ps(scal_13);


													vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_7732);
													mem_vec_7732 = vec_77;



													vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_7733);
													mem_vec_7733 = vec_79;



													vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_7734);
													mem_vec_7734 = vec_80;



													vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_7735);
													mem_vec_7735 = vec_81;
													scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
													vec_83 = _mm256_set1_ps(scal_14);


													vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_7736);
													mem_vec_7736 = vec_82;



													vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_7737);
													mem_vec_7737 = vec_84;



													vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_7738);
													mem_vec_7738 = vec_85;



													vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_7739);
													mem_vec_7739 = vec_86;
													scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
													vec_88 = _mm256_set1_ps(scal_15);


													vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_7740);
													mem_vec_7740 = vec_87;



													vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_7741);
													mem_vec_7741 = vec_89;



													vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_7742);
													mem_vec_7742 = vec_90;



													vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_7743);
													mem_vec_7743 = vec_91;
													scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
													vec_93 = _mm256_set1_ps(scal_16);


													vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_7744);
													mem_vec_7744 = vec_92;



													vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_7745);
													mem_vec_7745 = vec_94;



													vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_7746);
													mem_vec_7746 = vec_95;



													vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_7747);
													mem_vec_7747 = vec_96;
													scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
													vec_98 = _mm256_set1_ps(scal_17);


													vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_7748);
													mem_vec_7748 = vec_97;



													vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_7749);
													mem_vec_7749 = vec_99;



													vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_7750);
													mem_vec_7750 = vec_100;



													vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_7751);
											...
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_7744);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8], mem_vec_7745);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_7746);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24], mem_vec_7747);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_7748);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_7749);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_7750);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_7751);
									}
								}
							}
						}
