...
[V f; U (4, f); U (7, y); U (3, h); T (64, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (14, x); T (8, y); T (1, f); T (2, c); T (4, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c244_p_0, cp_1, c244, f, fp_0, f252_p_0, f253_p_0, fp_1, f252_p_1, fp_2, f252, f253, w, wp_0, x, xp_0, x296_p_0, x297_p_0, xp_1, x296_p_1, xp_2, x296, x297, y, yp_0;
