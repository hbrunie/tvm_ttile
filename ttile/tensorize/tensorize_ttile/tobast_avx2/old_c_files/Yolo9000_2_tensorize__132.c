...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (68, x);
  T (3, h); T (34, y); T (1, f); T (1, c); T (4, x); T (2, y); T (2, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c276_p_0, cp_1, c276, f, fp_0, f266_p_0, fp_1, f266, h, hp_0, x, xp_0, x368_p_0, x369_p_0, xp_1, x368_p_1, xp_2, x368, x369, y, yp_0, y276_p_0, yp_1, y276;
IND_TYPE y277 = 0;
IND_TYPE x370 = 0;
IND_TYPE h136 = 0;
IND_TYPE w = 0;
...
yp_1 = 0;
							for (h = h136, hp_0 = 0;h < h136 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 68) (68 / 1)
								for (x = x368, xp_2 = x368_p_1, xp_1 = x368_p_0, xp_0 = 0;x < x368 + 68;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
