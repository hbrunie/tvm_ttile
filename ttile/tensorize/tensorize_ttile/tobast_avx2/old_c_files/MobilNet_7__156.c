...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (4, f); T (7, x); T (2, y); T (1, f); T (16, c); T (4, f)]
*/
IND_TYPE c, cp_0, c240_p_0, cp_1, c240, f, fp_0, f320_p_0, f321_p_0, fp_1, f320_p_1, fp_2, f320, f321, h, hp_0, x, xp_0, x240_p_0, xp_1, x240, y, yp_0;
