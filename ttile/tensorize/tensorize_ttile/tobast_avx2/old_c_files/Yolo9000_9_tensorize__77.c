...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (4, x); T (17, y);
  T (1, f); T (2, f); T (8, c); T (17, x); T (2, f)]
*/
IND_TYPE c, cp_0, c666_p_0, cp_1, c666, f, fp_0, f888_p_0, f889_p_0, fp_1, f888_p_1, fp_2, f888, f889, x, xp_0, x666_p_0, xp_1, x666, y, yp_0;
IND_TYPE y444 = 0;
IND_TYPE x667 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
						for (x = x666, xp_1 = x666_p_0, xp_0 = 0;x < x666 + 4;x += 1, xp_1 += 1, xp_0 += 1){
