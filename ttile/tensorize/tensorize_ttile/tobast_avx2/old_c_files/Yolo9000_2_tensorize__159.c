...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (17, y); T (1, f); T (16, c); T (4, x); T (4, y); T (2, f);
  T (17, x)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, f, fp_0, f212_p_0, fp_1, f212, w, wp_0, x, xp_0, x296_p_0, x297_p_0, xp_1, x296_p_1, xp_2, x296, x297, y, yp_0, y222_p_0, yp_1, y222;
IND_TYPE y223 = 0;
IND_TYPE x298 = 0;
IND_TYPE h = 0;
IND_TYPE w148 = 0;
