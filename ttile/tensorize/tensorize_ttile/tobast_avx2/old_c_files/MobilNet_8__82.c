...
[V f; U (4, f); U (7, y); U (3, w); T (2, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (2, f); T (1, y); T (1, f); T (256, c); T (8, f)]
*/
IND_TYPE c, cp_0, c846_p_0, cp_1, c846, f, fp_0, f1128_p_0, f1129_p_0, fp_1, f1128_p_1, fp_2, f1128, f1129, h, hp_0, x, xp_0, y, yp_0;
