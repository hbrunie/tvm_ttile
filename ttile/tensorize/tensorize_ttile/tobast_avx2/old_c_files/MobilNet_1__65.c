...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (8, x); T (16, y); T (1, c); T (1, x)]
*/
IND_TYPE c, cp_0, c660_p_0, cp_1, c660, h, hp_0, x, xp_0, x850_p_0, x851_p_0, xp_1, x850_p_1, xp_2, x850, x851, y, yp_0;
...
// T (x, 1) (112 / 112)
for (x851 = x852, x851_p_0 = 0;
	x851 < x852 + 112;
	x851 += 112, x851_p_0 += 112){
	// y = 112, x = 112, h = 3, w = 3, c = 32, f = 32
	// T (c, 1) (32 / 32)
	for (c660 = c661, c660_p_0 = 0;
		...
		for (y = y440, yp_0 = 0;
			...
			// T (x, 8) (112 / 14)
			for (x850 = x851, x850_p_1 = x851_p_0, x850_p_0 = 0;
				x850 < x851 + 112;
				x850 += 14, x850_p_1 += 14, x850_p_0 += 14){
				...
				for (h = h290, hp_0 = 0;
					...
					// T (x, 14) (14 / 1)
					for (x = x850, xp_2 = x850_p_1, xp_1 = x850_p_0, xp_0 = 0;
						x < x850 + 14;
