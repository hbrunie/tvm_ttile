...
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (4, f); T (1, c); T (14, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c196_p_0, cp_1, c196, f, fp_0, f168_p_0, f169_p_0, fp_1, f168_p_1, fp_2, f168, f169, w, wp_0, x, xp_0, x224_p_0, x225_p_0, xp_1, x224_p_1, xp_2, x224, x225, y, yp_0;
IND_TYPE y112 = 0;
IND_TYPE x226 = 0;
IND_TYPE h = 0;
IND_TYPE w112 = 0;
...
fp_2 = 0;
							for (w = w112, wp_0 = 0;w < w112 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x224, xp_2 = x224_p_1, xp_1 = x224_p_0, xp_0 = 0;x < x224 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 128) (128 / 1)
											for (c = c196, cp_1 = c196_p_0, cp_0 = 0;c < c196 + 128;c += 1, cp_1 += 1, cp_0 += 1){
