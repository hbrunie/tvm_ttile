...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (7, x); T (28, y); T (4, c); T (8, x)]
*/
IND_TYPE c, cp_0, c180_p_0, cp_1, c180, w, wp_0, x, xp_0, x210_p_0, x211_p_0, xp_1, x210_p_1, xp_2, x210, x211, y, yp_0;
IND_TYPE y120 = 0;
IND_TYPE x212 = 0;
IND_TYPE h = 0;
IND_TYPE w120 = 0;
...
x210_p_1 = 0;
				for (w = w120, wp_0 = 0;w < w120 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 2) (2 / 1)
					for (x = x210, xp_2 = x210_p_1, xp_1 = x210_p_0, xp_0 = 0;x < x210 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
