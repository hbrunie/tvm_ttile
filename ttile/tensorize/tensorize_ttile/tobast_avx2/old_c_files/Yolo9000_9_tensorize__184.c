...
[V f; U (4, f); U (4, y); T (256, c); Hoist_vars [c]; T (17, x); T (17, y);
  T (1, f); T (2, f); T (1, c); T (4, x); T (2, f)]
*/
IND_TYPE c, cp_0, c396_p_0, cp_1, c396, f, fp_0, f528_p_0, f529_p_0, fp_1, f528_p_1, fp_2, f528, f529, x, xp_0, x396_p_0, xp_1, x396, y, yp_0;
IND_TYPE y264 = 0;
IND_TYPE x397 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
						for (x = x396, xp_1 = x396_p_0, xp_0 = 0;x < x396 + 17;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 256) (256 / 1)
									for (c = c396, cp_1 = c396_p_0, cp_0 = 0;c < c396 + 256;c += 1, cp_1 += 1, cp_0 += 1){
