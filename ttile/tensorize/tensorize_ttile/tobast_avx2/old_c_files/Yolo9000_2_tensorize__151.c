...
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (2, y); T (2, f); T (16, c); T (4, x); T (34, y); T (1, f);
  T (34, x)]
*/
IND_TYPE c, cp_0, c102_p_0, cp_1, c102, f, fp_0, f102_p_0, fp_1, f102, h, hp_0, w, wp_0, x, xp_0, x136_p_0, x137_p_0, xp_1, x136_p_1, xp_2, x136, x137, y, yp_0, y102_p_0, yp_1, y102;
IND_TYPE y103 = 0;
IND_TYPE x138 = 0;
IND_TYPE h68 = 0;
IND_TYPE w68 = 0;
							...
							for (h = h68, hp_0 = 0;h < h68 + 3;h += 1, hp_0 += 1){
								...
								for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
									...
									for (x = x136, xp_2 = x136_p_1, xp_1 = x136_p_0, xp_0 = 0;x < x136 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 2) (2 / 1)
												for (c = c102, cp_1 = c102_p_0, cp_0 = 0;c < c102 + 2;c += 1, cp_1 += 1, cp_0 += 1){
