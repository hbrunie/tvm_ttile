...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (2, f); T (1, x); T (7, y); T (1, x); T (2, f); T (4, c);
  T (7, x)]
*/
IND_TYPE c, cp_0, c96_p_0, cp_1, c96, f, fp_0, f96_p_0, fp_1, f96, h, hp_0, w, wp_0, x, xp_0, x160_p_0, x161_p_0, x162_p_0, xp_1, x160_p_1, x161_p_1, xp_2, x160_p_2, xp_3, x160, x161, x162, y, yp_0;
IND_TYPE y64 = 0;
IND_TYPE x163 = 0;
IND_TYPE h64 = 0;
IND_TYPE w64 = 0;
...
fp_1 = 0;
							for (h = h64, hp_0 = 0;h < h64 + 3;h += 1, hp_0 += 1){
								...
								for (w = w64, wp_0 = 0;w < w64 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 4) (4 / 1)
									for (x = x160, xp_3 = x160_p_2, xp_2 = x160_p_1, xp_1 = x160_p_0, xp_0 = 0;x < x160 + 4;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
