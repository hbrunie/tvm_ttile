...
[V f; U (4, f); U (7, y); U (3, h); T (1, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (2, f); T (1, x); T (8, y); T (1, f); T (128, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c226_p_0, cp_1, c226, f, fp_0, f228_p_0, f229_p_0, fp_1, f228_p_1, fp_2, f228, f229, w, wp_0, x, xp_0, x272_p_0, x273_p_0, xp_1, x272_p_1, xp_2, x272, x273, y, yp_0;
