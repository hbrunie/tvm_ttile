...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (68, x);
  T (3, w); T (68, y); T (2, f); T (2, c); T (4, x); T (1, y); T (1, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c162_p_0, cp_1, c162, f, fp_0, f152_p_0, fp_1, f152, w, wp_0, x, xp_0, x216_p_0, x217_p_0, xp_1, x216_p_1, xp_2, x216, x217, y, yp_0, y162_p_0, yp_1, y162;
...
for (x217 = x218, x217_p_0 = 0;
	...
	for (f152 = f153, f152_p_0 = 0;
		...
		for (y162 = y163, y162_p_0 = 0;
			y162 < y163 + 272;
			y162 += 272, y162_p_0 += 272){
			// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
			// T (x, 4) (272 / 68)
			for (x216 = x217, x216_p_1 = x217_p_0, x216_p_0 = 0;
				x216 < x217 + 272;
				x216 += 68, x216_p_1 += 68, x216_p_0 += 68){
