...
for (c968 = c969, c968_p_0 = 0;
	...
	for (x1156 = x1157, x1156_p_0 = 0;
		...
		for (f = f1120, fp_0 = 0;
			...
			// T (c, 8) (8 / 1)
			for (c967 = c968, c967_p_1 = c968_p_0, c967_p_0 = 0;
				c967 < c968 + 8;
				c967 += 1, c967_p_1 += 1, c967_p_0 += 1){
					for (y = y596, yp_0 = 0;
						y < y596 + 24;
						y += 8, yp_0 += 8){
						// y = ph_y, x = 1, h = 3, w = 3, c = 1, f = 16
						// T (c, 1) (1 / 1)
						for (c966 = c967, c966_p_2 = c967_p_1, c966_p_1 = c967_p_0, c966_p_0 = 0;
							c966 < c967 + 1;
							c966 += 1, c966_p_2 += 1, c966_p_1 += 1, c966_p_0 += 1){
							// y = ph_y, x = 1, h = 3, w = 3, c = 1, f = 16
							// T (w, 3) (3 / 1)
							for (w = w476, wp_0 = 0;
								w < w476 + 3;
								...
								for (x = x1156, xp_1 = x1156_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = ph_y, x = 1, h = 3, w = 1, c = 1, f = 16
											// T (c, 1) (1 / 1)
											for (c = c966, cp_3 = c966_p_2, cp_2 = c966_p_1, cp_1 = c966_p_0, cp_0 = 0;
												c < c966 + 1;
