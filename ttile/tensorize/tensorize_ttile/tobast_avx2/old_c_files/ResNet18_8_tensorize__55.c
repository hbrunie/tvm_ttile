...
/*
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (4, f); T (1, c); T (4, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c166_p_0, cp_1, c166, f, fp_0, f128_p_0, f129_p_0, fp_1, f128_p_1, fp_2, f128, f129, w, wp_0, x, xp_0, x184_p_0, x185_p_0, xp_1, x184_p_1, xp_2, x184, x185, y, yp_0;
IND_TYPE y92 = 0;
IND_TYPE x186 = 0;
IND_TYPE h = 0;
IND_TYPE w92 = 0;
...
fp_2 = 0;
							for (w = w92, wp_0 = 0;w < w92 + 3;w += 1, wp_0 += 1){
								// y = 4, x = 7, h = 3, w = 1, c = 128, f = 32
								// T (x, 7) (7 / 1)
								for (x = x184, xp_2 = x184_p_1, xp_1 = x184_p_0, xp_0 = 0;x < x184 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 128) (128 / 1)
											for (c = c166, cp_1 = c166_p_0, cp_0 = 0;c < c166 + 128;c += 1, cp_1 += 1, cp_0 += 1){
												...
												vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_736);
												mem_vec_736 = vec_24;
												vec_28 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 8]);
												vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_737);
												mem_vec_737 = vec_27;
												vec_30 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
												vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_738);
												mem_vec_738 = vec_29;
												vec_32 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 24]);
												vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_739);
												mem_vec_739 = vec_31;
												scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
												vec_34 = _mm256_set1_ps(scal_5);
												vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_740);
												mem_vec_740 = vec_33;
												vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_741);
												mem_vec_741 = vec_35;
												vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_742);
												mem_vec_742 = vec_36;
												vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_743);
												mem_vec_743 = vec_37;
												scal_6 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
												vec_39 = _mm256_set1_ps(scal_6);
												vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_744);
												mem_vec_744 = vec_38;
												vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_745);
												mem_vec_745 = vec_40;
												vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_746);
												mem_vec_746 = vec_41;
												vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_747);
												mem_vec_747 = vec_42;
												scal_7 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
												vec_44 = _mm256_set1_ps(scal_7);
												vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_748);
												mem_vec_748 = vec_43;
												vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_749);
												mem_vec_749 = vec_45;
												vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_750);
												mem_vec_750 = vec_46;
												vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_751);
												mem_vec_751 = vec_47;
												scal_8 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
												vec_49 = _mm256_set1_ps(scal_8);
												vec_50 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
												vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_736);
												mem_vec_736 = vec_48;
												vec_52 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 8]);
												vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_737);
												mem_vec_737 = vec_51;
												vec_54 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
												vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_738);
												mem_vec_738 = vec_53;
												vec_56 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 24]);
												vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_739);
												mem_vec_739 = vec_55;
												scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
												vec_58 = _mm256_set1_ps(scal_9);
												vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_740);
												mem_vec_740 = vec_57;
												vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_741);
												mem_vec_741 = vec_59;
												vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_742);
												mem_vec_742 = vec_60;
												vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_743);
												mem_vec_743 = vec_61;
												scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
												vec_63 = _mm256_set1_ps(scal_10);
												vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_744);
												mem_vec_744 = vec_62;
												vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_745);
												mem_vec_745 = vec_64;
												vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_746);
												mem_vec_746 = vec_65;
												vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_747);
												mem_vec_747 = vec_66;
												scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
												vec_68 = _mm256_set1_ps(scal_11);
												vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_748);
												mem_vec_748 = vec_67;
												vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_749);
												mem_vec_749 = vec_69;
												vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_750);
												mem_vec_750 = vec_70;
												vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_751);
												mem_vec_751 = vec_71;
											}
