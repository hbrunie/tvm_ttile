...
/*
[V f; U (4, f); U (4, y); T (128, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (1, f); T (1, x); T (7, y); T (1, x); T (4, f); T (1, c);
  T (7, x)]
*/
...
fp_1 = 0;
							for (h = h56, hp_0 = 0;h < h56 + 3;h += 1, hp_0 += 1){
								...
								for (w = w56, wp_0 = 0;w < w56 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 4) (4 / 1)
									for (x = x140, xp_3 = x140_p_2, xp_2 = x140_p_1, xp_1 = x140_p_0, xp_0 = 0;x < x140 + 4;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
