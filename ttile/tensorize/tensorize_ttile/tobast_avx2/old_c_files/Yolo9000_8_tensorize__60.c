...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (1, f); T (2, x); T (17, y); T (2, f); T (4, c); T (34, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c192_p_0, cp_1, c192, f, fp_0, f256_p_0, f257_p_0, fp_1, f256_p_1, fp_2, f256, f257, h, hp_0, w, wp_0, x, xp_0, x256_p_0, x257_p_0, xp_1, x256_p_1, xp_2, x256, x257, y, yp_0;
IND_TYPE y128 = 0;
IND_TYPE x258 = 0;
IND_TYPE h128 = 0;
IND_TYPE w128 = 0;
