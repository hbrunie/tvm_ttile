...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (56, x);
  T (3, w); T (2, x); T (28, y); T (32, c); T (1, x)]
*/
IND_TYPE c, cp_0, c96_p_0, cp_1, c96, w, wp_0, x, xp_0, x98_p_0, x99_p_0, xp_1, x98_p_1, xp_2, x98, x99, y, yp_0;
