...
fp_2 = 0;
							for (h = h262, hp_0 = 0;h < h262 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x704, xp_2 = x704_p_1, xp_1 = x704_p_0, xp_0 = 0;x < x704 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3514 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
											mem_vec_3515 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_3514);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_3515);
								}
							}
}
