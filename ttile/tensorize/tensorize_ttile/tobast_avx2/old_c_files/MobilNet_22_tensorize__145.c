...
yp_0 = 0;
								for (w = w398, wp_0 = 0;w < w398 + 3;w += 1, wp_0 += 1){
									...
									for (x = x780, xp_1 = x780_p_0, xp_0 = 0;x < x780 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_6990 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
												mem_vec_6991 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_6990);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_6991);
									}
								}
}
