							...
							for (h = h192, hp_0 = 0;h < h192 + 3;h += 1, hp_0 += 1){
								...
								for (w = w184, wp_0 = 0;w < w184 + 3;w += 1, wp_0 += 1){
									...
									for (x = x372, xp_1 = x372_p_0, xp_0 = 0;x < x372 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3536 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_3537 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_3538 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3539 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3536);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_3537);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3538);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3539);
									}
								}
							}
}
