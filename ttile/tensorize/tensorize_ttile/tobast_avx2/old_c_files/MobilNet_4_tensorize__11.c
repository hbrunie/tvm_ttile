...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (4, x); T (7, y); T (2, f); T (128, c); T (7, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c246_p_0, cp_1, c246, f, fp_0, f292_p_0, f293_p_0, fp_1, f292_p_1, fp_2, f292, f293, w, wp_0, x, xp_0, x364_p_0, x365_p_0, xp_1, x364_p_1, xp_2, x364, x365, y, yp_0;
IND_TYPE y164 = 0;
IND_TYPE x366 = 0;
IND_TYPE h = 0;
IND_TYPE w164 = 0;
