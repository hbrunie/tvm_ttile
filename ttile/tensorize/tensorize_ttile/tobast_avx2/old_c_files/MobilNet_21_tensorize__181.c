...
yp_0 = 0;
								for (w = w498, wp_0 = 0;w < w498 + 3;w += 1, wp_0 += 1){
									...
									for (x = x930, xp_1 = x930_p_0, xp_0 = 0;x < x930 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_9406 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
												mem_vec_9407 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_9406);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24], mem_vec_9407);
									}
								}
}
