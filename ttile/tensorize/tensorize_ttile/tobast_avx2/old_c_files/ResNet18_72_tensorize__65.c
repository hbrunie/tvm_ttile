...
fp_2 = 0;
							for (w = w384, wp_0 = 0;w < w384 + 3;w += 1, wp_0 += 1){
								...
								for (x = x672, xp_1 = x672_p_0, xp_0 = 0;x < x672 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_7218 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											mem_vec_7219 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 2, f = 32
											// T (c, 2) (2 / 1)
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_7218);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_7219);
								}
							}
}
