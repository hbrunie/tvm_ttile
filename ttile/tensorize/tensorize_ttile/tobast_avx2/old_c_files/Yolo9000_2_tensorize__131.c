...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (4, x);
  T (3, h); T (4, y); T (1, f); T (4, c); T (1, x); T (17, y); T (2, f);
  T (68, x)]
*/
IND_TYPE c, cp_0, c366_p_0, cp_1, c366, f, fp_0, f356_p_0, fp_1, f356, h, hp_0, x, xp_0, x488_p_0, x489_p_0, xp_1, x488_p_1, xp_2, x488, x489, y, yp_0, y366_p_0, yp_1, y366;
IND_TYPE y367 = 0;
IND_TYPE x490 = 0;
IND_TYPE h196 = 0;
IND_TYPE w = 0;
