...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (4, y); T (1, f); T (8, c); T (1, x); T (17, y); T (2, f);
  T (34, x)]
*/
IND_TYPE c, cp_0, c234_p_0, cp_1, c234, f, fp_0, f224_p_0, fp_1, f224, w, wp_0, x, xp_0, x312_p_0, x313_p_0, xp_1, x312_p_1, xp_2, x312, x313, y, yp_0, y234_p_0, yp_1, y234;
IND_TYPE y235 = 0;
IND_TYPE x314 = 0;
IND_TYPE h = 0;
IND_TYPE w156 = 0;
...
yp_1 = 0;
							for (w = w156, wp_0 = 0;w < w156 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 8) (8 / 1)
								for (x = x312, xp_2 = x312_p_1, xp_1 = x312_p_0, xp_0 = 0;x < x312 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
