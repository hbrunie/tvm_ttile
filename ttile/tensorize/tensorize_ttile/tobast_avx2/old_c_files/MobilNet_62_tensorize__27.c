							...
							for (h = h216, hp_0 = 0;h < h216 + 3;h += 1, hp_0 += 1){
								...
								for (w = w208, wp_0 = 0;w < w208 + 3;w += 1, wp_0 += 1){
									...
									for (x = x408, xp_1 = x408_p_0, xp_0 = 0;x < x408 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3968 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_3969 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_3970 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3971 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3968);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_3969);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3970);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3971);
									}
								}
							}
}
