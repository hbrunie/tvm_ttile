...
[V f; U (4, f); U (4, y); U (3, w); T (16, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (14, y); T (1, f); T (1, c); T (2, f); T (4, c); T (8, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c380_p_0, c381_p_0, cp_1, c380_p_1, cp_2, c380, c381, f, fp_0, f352_p_0, f353_p_0, fp_1, f352_p_1, fp_2, f352, f353, h, hp_0, x, xp_0, x334_p_0, xp_1, x334, y, yp_0;
IND_TYPE y204 = 0;
IND_TYPE x335 = 0;
IND_TYPE h134 = 0;
IND_TYPE w = 0;
