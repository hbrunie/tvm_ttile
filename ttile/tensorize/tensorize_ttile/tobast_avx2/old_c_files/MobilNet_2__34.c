...
[V f; U (4, f); U (7, y); U (3, w); T (8, c); Hoist_vars [c]; T (56, x);
  T (3, h); T (8, y); T (1, f); T (1, c); T (2, f); T (8, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c428_p_0, c429_p_0, cp_1, c428_p_1, cp_2, c428, c429, f, fp_0, f400_p_0, f401_p_0, fp_1, f400_p_1, fp_2, f400, f401, h, hp_0, x, xp_0, x370_p_0, xp_1, x370, y, yp_0;
