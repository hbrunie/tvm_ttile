...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (1, x); T (17, y); T (8, f); T (32, c); T (34, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c402_p_0, cp_1, c402, f, fp_0, f536_p_0, f537_p_0, fp_1, f536_p_1, fp_2, f536, f537, w, wp_0, x, xp_0, x536_p_0, x537_p_0, xp_1, x536_p_1, xp_2, x536, x537, y, yp_0;
IND_TYPE y268 = 0;
IND_TYPE x538 = 0;
IND_TYPE h = 0;
IND_TYPE w268 = 0;
