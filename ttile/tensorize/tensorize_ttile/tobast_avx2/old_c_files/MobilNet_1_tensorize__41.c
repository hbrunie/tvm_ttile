...
/*
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (28, y); T (2, c); T (16, x)]
*/
IND_TYPE c, cp_0, c24_p_0, cp_1, c24, h, hp_0, w, wp_0, x, xp_0, x24_p_0, xp_1, x24, y, yp_0;
IND_TYPE y16 = 0;
IND_TYPE x25 = 0;
IND_TYPE h16 = 0;
IND_TYPE w16 = 0;
