...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (2, x); T (17, y); T (4, f); T (8, c); T (34, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c408_p_0, cp_1, c408, f, fp_0, f544_p_0, f545_p_0, fp_1, f544_p_1, fp_2, f544, f545, w, wp_0, x, xp_0, x544_p_0, x545_p_0, xp_1, x544_p_1, xp_2, x544, x545, y, yp_0;
IND_TYPE y272 = 0;
IND_TYPE x546 = 0;
IND_TYPE h = 0;
IND_TYPE w272 = 0;
