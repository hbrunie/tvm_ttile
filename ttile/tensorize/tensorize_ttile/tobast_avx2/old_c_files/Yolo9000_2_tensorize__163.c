...
[V f; U (4, f); U (4, y); U (3, w); T (4, c); Hoist_vars [c]; T (8, x);
  T (3, h); T (34, y); T (2, f); T (8, c); T (34, x); T (2, y); T (1, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c300_p_0, cp_1, c300, f, fp_0, f290_p_0, fp_1, f290, h, hp_0, x, xp_0, x400_p_0, x401_p_0, xp_1, x400_p_1, xp_2, x400, x401, y, yp_0, y300_p_0, yp_1, y300;
IND_TYPE y301 = 0;
IND_TYPE x402 = 0;
IND_TYPE h152 = 0;
IND_TYPE w = 0;
