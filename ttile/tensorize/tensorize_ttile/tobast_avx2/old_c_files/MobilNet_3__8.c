...
[V f; U (4, f); ULambda y; U (3, h); T (2, c); Hoist_vars [c]; T (1, x);
  ...
  T (64, c); T (2, x); T (4, f)]
*/
IND_TYPE c, cp_0, c980_p_0, cp_1, c980, f, fp_0, f960_p_0, f961_p_0, fp_1, f960_p_1, fp_2, f960, f961, w, wp_0, x, xp_0, x1168_p_0, x1169_p_0, xp_1, x1168_p_1, xp_2, x1168, x1169, y, yp_0;
