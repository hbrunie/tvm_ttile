...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (14, x); T (28, y); T (16, c); T (4, x)]
*/
IND_TYPE c, cp_0, c150_p_0, cp_1, c150, w, wp_0, x, xp_0, x170_p_0, x171_p_0, xp_1, x170_p_1, xp_2, x170, x171, y, yp_0;
IND_TYPE y100 = 0;
IND_TYPE x172 = 0;
IND_TYPE h = 0;
IND_TYPE w100 = 0;
...
x170_p_1 = 0;
				for (w = w100, wp_0 = 0;w < w100 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 2) (2 / 1)
					for (x = x170, xp_2 = x170_p_1, xp_1 = x170_p_0, xp_0 = 0;x < x170 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
