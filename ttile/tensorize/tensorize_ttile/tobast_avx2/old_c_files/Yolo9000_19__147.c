...
[V f; U (4, f); ULambda y; T (256, c); Hoist_vars [c]; T (1, x); T (1, f);
  ...
  T (2, f); T (4, c); T (17, x); T (8, f)]
*/
IND_TYPE c, cp_0, c960_p_0, cp_1, c960, f, fp_0, f1280_p_0, f1281_p_0, fp_1, f1280_p_1, fp_2, f1280, f1281, x, xp_0, x1280_p_0, x1281_p_0, xp_1, x1280_p_1, xp_2, x1280, x1281, y, yp_0;
...
for (f1281 = f1282, f1281_p_0 = 0;
	...
	for (x1281 = x1282, x1281_p_0 = 0;
		...
		for (c960 = c961, c960_p_0 = 0;
			c960 < c961 + 1024;
			c960 += 256, c960_p_0 += 256){
			// y = 17, x = 1, h = 1, w = 1, c = 256, f = 64
			// T (f, 2) (64 / 32)
							...
							for (f = f1280, fp_2 = f1280_p_1, fp_1 = f1280_p_0, fp_0 = 0;
								...
								for (x = x1280, xp_2 = x1280_p_1, xp_1 = x1280_p_0, xp_0 = 0;
									...
									x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_11552 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
											mem_vec_11553 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8]);
											mem_vec_11554 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
											mem_vec_11555 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 256, f = 32
											// T (c, 256) (256 / 1)
											for (c = c960, cp_1 = c960_p_0, cp_0 = 0;
												c < c960 + 256;
												...
												vec_24 = _mm256_fmadd_ps(vec_25, vec_2, mem_vec_11552);
												mem_vec_11552 = vec_24;



												vec_26 = _mm256_fmadd_ps(vec_25, vec_4, mem_vec_11553);
												mem_vec_11553 = vec_26;



												vec_27 = _mm256_fmadd_ps(vec_25, vec_6, mem_vec_11554);
												mem_vec_11554 = vec_27;



												vec_28 = _mm256_fmadd_ps(vec_25, vec_8, mem_vec_11555);
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_11552);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8], mem_vec_11553);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_11554);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24], mem_vec_11555);
								}
							}
						}
					}
