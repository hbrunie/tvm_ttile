...
[V f; U (8, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (2, f); T (1, x); T (17, y); T (1, f); T (64, c); T (68, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c780_p_0, cp_1, c780, f, fp_0, f1040_p_0, f1041_p_0, fp_1, f1040_p_1, fp_2, f1040, f1041, h, hp_0, x, xp_0, x1040_p_0, x1041_p_0, xp_1, x1040_p_1, xp_2, x1040, x1041, y, yp_0;
