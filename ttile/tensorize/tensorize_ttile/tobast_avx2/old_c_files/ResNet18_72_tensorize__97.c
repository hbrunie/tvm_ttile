							...
							for (h = h206, hp_0 = 0;h < h206 + 3;h += 1, hp_0 += 1){
								...
								for (w = w188, wp_0 = 0;w < w188 + 3;w += 1, wp_0 += 1){
									...
									for (x = x378, xp_1 = x378_p_0, xp_0 = 0;x < x378 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3690 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3691 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3690);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3691);
									}
								}
							}
}
