...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, f); T (4, x); T (14, y); T (1, f); T (32, c); T (2, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c154_p_0, cp_1, c154, f, fp_0, f132_p_0, f133_p_0, fp_1, f132_p_1, fp_2, f132, f133, w, wp_0, x, xp_0, x176_p_0, x177_p_0, xp_1, x176_p_1, xp_2, x176, x177, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x178 = 0;
IND_TYPE h = 0;
IND_TYPE w88 = 0;
...
fp_2 = 0;
							for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 7) (7 / 1)
								for (x = x176, xp_2 = x176_p_1, xp_1 = x176_p_0, xp_0 = 0;x < x176 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
