...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (4, f); T (8, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c180_p_0, cp_1, c180, f, fp_0, f204_p_0, f205_p_0, fp_1, f204_p_1, fp_2, f204, f205, w, wp_0, x, xp_0, x276_p_0, x277_p_0, xp_1, x276_p_1, xp_2, x276, x277, y, yp_0;
IND_TYPE y120 = 0;
IND_TYPE x278 = 0;
IND_TYPE h = 0;
IND_TYPE w120 = 0;
...
fp_2 = 0;
							for (w = w120, wp_0 = 0;w < w120 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x276, xp_2 = x276_p_1, xp_1 = x276_p_0, xp_0 = 0;x < x276 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
