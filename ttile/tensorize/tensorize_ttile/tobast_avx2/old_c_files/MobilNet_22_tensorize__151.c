...
yp_0 = 0;
								for (w = w414, wp_0 = 0;w < w414 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 8) (8 / 1)
									for (x = x804, xp_1 = x804_p_0, xp_0 = 0;x < x804 + 8;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_7374 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
												mem_vec_7375 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_7374);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_7375);
									}
								}
}
