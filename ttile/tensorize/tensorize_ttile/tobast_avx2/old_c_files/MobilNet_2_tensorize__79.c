...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (56, x);
  T (3, h); T (14, y); T (2, f); T (1, c); T (1, f); T (2, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c316_p_0, c317_p_0, cp_1, c316_p_1, cp_2, c316, c317, f, fp_0, f288_p_0, f289_p_0, fp_1, f288_p_1, fp_2, f288, f289, h, hp_0, x, xp_0, x286_p_0, xp_1, x286, y, yp_0;
IND_TYPE y172 = 0;
IND_TYPE x287 = 0;
IND_TYPE h102 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
							for (h = h102, hp_0 = 0;h < h102 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 56) (56 / 1)
								for (x = x286, xp_1 = x286_p_0, xp_0 = 0;x < x286 + 56;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 32) (32 / 1)
											for (c = c316, cp_2 = c316_p_1, cp_1 = c316_p_0, cp_0 = 0;c < c316 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
