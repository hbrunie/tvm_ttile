...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (17, y); T (2, f); T (32, c); T (16, x); T (4, y); T (1, f);
  T (17, x)]
*/
IND_TYPE c, cp_0, c354_p_0, cp_1, c354, f, fp_0, f344_p_0, fp_1, f344, h, hp_0, x, xp_0, x472_p_0, x473_p_0, xp_1, x472_p_1, xp_2, x472, x473, y, yp_0, y354_p_0, yp_1, y354;
IND_TYPE y355 = 0;
IND_TYPE x474 = 0;
IND_TYPE h188 = 0;
IND_TYPE w = 0;
...
yp_1 = 0;
							for (h = h188, hp_0 = 0;h < h188 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x472, xp_2 = x472_p_1, xp_1 = x472_p_0, xp_0 = 0;x < x472 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
