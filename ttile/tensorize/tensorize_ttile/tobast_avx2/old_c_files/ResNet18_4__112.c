...
[V f; U (8, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (4, x);
  T (3, h); T (7, y); T (1, c); T (2, f); T (32, c); T (7, x); T (1, f)]
*/
IND_TYPE c, cp_0, c664_p_0, c665_p_0, cp_1, c664_p_1, cp_2, c664, c665, f, fp_0, f458_p_0, fp_1, f458, h, hp_0, x, xp_0, x778_p_0, xp_1, x778, y, yp_0;
