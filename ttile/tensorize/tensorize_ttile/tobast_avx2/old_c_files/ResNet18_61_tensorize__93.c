...
c728_p_1 = 0;
							for (w = w370, wp_0 = 0;w < w370 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x964, xp_2 = x964_p_1, xp_1 = x964_p_0, xp_0 = 0;x < x964 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 2) (2 / 1)
											for (c = c728, cp_2 = c728_p_1, cp_1 = c728_p_0, cp_0 = 0;c < c728 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
