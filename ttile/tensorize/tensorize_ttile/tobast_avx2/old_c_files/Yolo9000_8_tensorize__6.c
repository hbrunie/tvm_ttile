...
[V f; U (4, f); U (4, y); T (4, c); Hoist_vars [c]; T (34, x); T (3, w);
  T (3, h); T (1, f); T (1, x); T (17, y); T (8, f); T (32, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c72_p_0, cp_1, c72, f, fp_0, f96_p_0, f97_p_0, fp_1, f96_p_1, fp_2, f96, f97, h, hp_0, w, wp_0, x, xp_0, x96_p_0, x97_p_0, xp_1, x96_p_1, xp_2, x96, x97, y, yp_0;
IND_TYPE y48 = 0;
IND_TYPE x98 = 0;
IND_TYPE h48 = 0;
IND_TYPE w48 = 0;
