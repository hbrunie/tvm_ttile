...
/*
[V f; U (4, f); U (4, y); U (3, h); T (64, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, f); T (4, x); T (7, y); T (4, f); T (2, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c144_p_0, cp_1, c144, f, fp_0, f156_p_0, f157_p_0, fp_1, f156_p_1, fp_2, f156, f157, w, wp_0, x, xp_0, x228_p_0, x229_p_0, xp_1, x228_p_1, xp_2, x228, x229, y, yp_0;
IND_TYPE y96 = 0;
IND_TYPE x230 = 0;
IND_TYPE h = 0;
IND_TYPE w96 = 0;
...
fp_2 = 0;
							for (w = w96, wp_0 = 0;w < w96 + 3;w += 1, wp_0 += 1){
								// y = 4, x = 7, h = 3, w = 1, c = 64, f = 32
								// T (x, 7) (7 / 1)
								for (x = x228, xp_2 = x228_p_1, xp_1 = x228_p_0, xp_0 = 0;x < x228 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
