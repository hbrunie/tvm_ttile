...
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (34, x);
  T (3, w); T (2, f); T (2, x); T (17, y); T (1, f); T (1, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c234_p_0, cp_1, c234, f, fp_0, f312_p_0, f313_p_0, fp_1, f312_p_1, fp_2, f312, f313, w, wp_0, x, xp_0, x312_p_0, x313_p_0, xp_1, x312_p_1, xp_2, x312, x313, y, yp_0;
IND_TYPE y156 = 0;
IND_TYPE x314 = 0;
IND_TYPE h = 0;
IND_TYPE w156 = 0;
