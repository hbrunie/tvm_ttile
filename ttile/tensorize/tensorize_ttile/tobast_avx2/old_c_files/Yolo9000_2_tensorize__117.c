...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (68, x);
  T (3, h); T (4, y); T (2, f); T (4, c); T (1, x); T (17, y); T (1, f);
  T (4, x)]
*/
IND_TYPE c, cp_0, c330_p_0, cp_1, c330, f, fp_0, f320_p_0, fp_1, f320, h, hp_0, x, xp_0, x440_p_0, x441_p_0, xp_1, x440_p_1, xp_2, x440, x441, y, yp_0, y330_p_0, yp_1, y330;
IND_TYPE y331 = 0;
IND_TYPE x442 = 0;
IND_TYPE h172 = 0;
IND_TYPE w = 0;
...
yp_1 = 0;
							for (h = h172, hp_0 = 0;h < h172 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 68) (68 / 1)
								for (x = x440, xp_2 = x440_p_1, xp_1 = x440_p_0, xp_0 = 0;x < x440 + 68;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
