...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (8, f); T (1, x); T (7, y); T (1, f); T (128, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c376_p_0, cp_1, c376, f, fp_0, f408_p_0, f409_p_0, fp_1, f408_p_1, fp_2, f408, f409, h, hp_0, x, xp_0, x464_p_0, x465_p_0, xp_1, x464_p_1, xp_2, x464, x465, y, yp_0;
IND_TYPE y232 = 0;
IND_TYPE x466 = 0;
IND_TYPE h144 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h144, hp_0 = 0;h < h144 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 28) (28 / 1)
								for (x = x464, xp_2 = x464_p_1, xp_1 = x464_p_0, xp_0 = 0;x < x464 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
