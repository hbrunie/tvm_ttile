							...
							for (h = h240, hp_0 = 0;h < h240 + 3;h += 1, hp_0 += 1){
								...
								for (w = w232, wp_0 = 0;w < w232 + 3;w += 1, wp_0 += 1){
									...
									for (x = x444, xp_1 = x444_p_0, xp_0 = 0;x < x444 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4400 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_4401 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_4402 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_4403 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_4400);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_4401);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4402);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4403);
									}
								}
							}
}
