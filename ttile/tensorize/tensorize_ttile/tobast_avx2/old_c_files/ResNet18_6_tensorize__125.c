...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (7, x); T (7, y); T (2, f); T (32, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c228_p_0, cp_1, c228, f, fp_0, f258_p_0, f259_p_0, fp_1, f258_p_1, fp_2, f258, f259, w, wp_0, x, xp_0, x350_p_0, x351_p_0, xp_1, x350_p_1, xp_2, x350, x351, y, yp_0;
IND_TYPE y152 = 0;
IND_TYPE x352 = 0;
IND_TYPE h = 0;
IND_TYPE w152 = 0;
...
fp_2 = 0;
							for (w = w152, wp_0 = 0;w < w152 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x350, xp_2 = x350_p_1, xp_1 = x350_p_0, xp_0 = 0;x < x350 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
