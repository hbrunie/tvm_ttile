...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (2, f); T (128, c); T (7, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c234_p_0, cp_1, c234, f, fp_0, f276_p_0, f277_p_0, fp_1, f276_p_1, fp_2, f276, f277, w, wp_0, x, xp_0, x348_p_0, x349_p_0, xp_1, x348_p_1, xp_2, x348, x349, y, yp_0;
