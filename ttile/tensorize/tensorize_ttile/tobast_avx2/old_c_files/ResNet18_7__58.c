...
[V f; U (4, f); U (7, y); U (3, h); T (64, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (8, f); T (7, x); T (2, y); T (1, f); T (2, c); T (1, f)]
*/
IND_TYPE c, cp_0, c72_p_0, cp_1, c72, f, fp_0, f96_p_0, f97_p_0, fp_1, f96_p_1, fp_2, f96, f97, w, wp_0, x, xp_0, x72_p_0, xp_1, x72, y, yp_0;
