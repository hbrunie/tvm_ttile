...
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (16, c); T (2, x); T (7, y); T (8, f); T (4, c); T (1, x)]
*/
IND_TYPE c, cp_0, c8_p_0, c9_p_0, cp_1, c8_p_1, cp_2, c8, c9, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x8_p_0, x9_p_0, xp_1, x8_p_1, xp_2, x8, x9, y, yp_0;
IND_TYPE y4 = 0;
IND_TYPE x10 = 0;
IND_TYPE h4 = 0;
IND_TYPE w4 = 0;
