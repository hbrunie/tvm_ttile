...
for (f985 = f986, f985_p_0 = 0;
	...
	for (c738 = c739, c738_p_0 = 0;
		...
		for (f984 = f985, f984_p_1 = f985_p_0, f984_p_0 = 0;
			f984 < f985 + 1024;
			f984 += 1024, f984_p_1 += 1024, f984_p_0 += 1024){
				for (y = y492, yp_0 = 0;
					y < y492 + 10;
					y += 5, yp_0 += 5){
					...
					for (x738 = x739, x738_p_0 = 0;
						x738 < x739 + 17;
						x738 += 1, x738_p_0 += 1){
						// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 1024
						// T (f, 32) (1024 / 32)
							...
							for (w = w492, wp_0 = 0;
								...
								for (x = x738, xp_1 = x738_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_9648 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_9649 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
											mem_vec_9650 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_9651 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 32, f = 32
											// T (c, 32) (32 / 1)
											for (c = c738, cp_1 = c738_p_0, cp_0 = 0;
												c < c738 + 32;
												...
												vec_34 = _mm256_fmadd_ps(vec_35, vec_2, mem_vec_9648);
												mem_vec_9648 = vec_34;



												vec_36 = _mm256_fmadd_ps(vec_35, vec_4, mem_vec_9649);
												mem_vec_9649 = vec_36;



												vec_37 = _mm256_fmadd_ps(vec_35, vec_6, mem_vec_9650);
												mem_vec_9650 = vec_37;



												vec_38 = _mm256_fmadd_ps(vec_35, vec_8, mem_vec_9651);
												mem_vec_9651 = vec_38;
												scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
												vec_40 = _mm256_set1_ps(scal_7);
												vec_41 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

												vec_39 = _mm256_fmadd_ps(vec_40, vec_41, mem_vec_9624);
												mem_vec_9624 = vec_39;

												vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_42 = _mm256_fmadd_ps(vec_40, vec_43, mem_vec_9625);
												mem_vec_9625 = vec_42;

												vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_44 = _mm256_fmadd_ps(vec_40, vec_45, mem_vec_9626);
												mem_vec_9626 = vec_44;

												vec_47 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

												vec_46 = _mm256_fmadd_ps(vec_40, vec_47, mem_vec_9627);
												mem_vec_9627 = vec_46;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_49 = _mm256_set1_ps(scal_8);


												vec_48 = _mm256_fmadd_ps(vec_49, vec_41, mem_vec_9628);
												mem_vec_9628 = vec_48;



												vec_50 = _mm256_fmadd_ps(vec_49, vec_43, mem_vec_9629);
												mem_vec_9629 = vec_50;



												vec_51 = _mm256_fmadd_ps(vec_49, vec_45, mem_vec_9630);
												mem_vec_9630 = vec_51;



												vec_52 = _mm256_fmadd_ps(vec_49, vec_47, mem_vec_9631);
												mem_vec_9631 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_54 = _mm256_set1_ps(scal_9);


												vec_53 = _mm256_fmadd_ps(vec_54, vec_41, mem_vec_9632);
												mem_vec_9632 = vec_53;



												vec_55 = _mm256_fmadd_ps(vec_54, vec_43, mem_vec_9633);
												mem_vec_9633 = vec_55;



												vec_56 = _mm256_fmadd_ps(vec_54, vec_45, mem_vec_9634);
												mem_vec_9634 = vec_56;



												vec_57 = _mm256_fmadd_ps(vec_54, vec_47, mem_vec_9635);
												mem_vec_9635 = vec_57;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_59 = _mm256_set1_ps(scal_10);


												vec_58 = _mm256_fmadd_ps(vec_59, vec_41, mem_vec_9636);
												mem_vec_9636 = vec_58;



												vec_60 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_9637);
												mem_vec_9637 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_9638);
												mem_vec_9638 = vec_61;



												vec_62 = _mm256_fmadd_ps(vec_59, vec_47, mem_vec_9639);
												mem_vec_9639 = vec_62;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
												vec_64 = _mm256_set1_ps(scal_11);


												vec_63 = _mm256_fmadd_ps(vec_64, vec_41, mem_vec_9640);
												mem_vec_9640 = vec_63;



												vec_65 = _mm256_fmadd_ps(vec_64, vec_43, mem_vec_9641);
												mem_vec_9641 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_64, vec_45, mem_vec_9642);
												mem_vec_9642 = vec_66;



												vec_67 = _mm256_fmadd_ps(vec_64, vec_47, mem_vec_9643);
												mem_vec_9643 = vec_67;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
												vec_69 = _mm256_set1_ps(scal_12);


												vec_68 = _mm256_fmadd_ps(vec_69, vec_41, mem_vec_9644);
												mem_vec_9644 = vec_68;



												vec_70 = _mm256_fmadd_ps(vec_69, vec_43, mem_vec_9645);
												mem_vec_9645 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_69, vec_45, mem_vec_9646);
												mem_vec_9646 = vec_71;



												vec_72 = _mm256_fmadd_ps(vec_69, vec_47, mem_vec_9647);
												mem_vec_9647 = vec_72;
												scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
												vec_74 = _mm256_set1_ps(scal_13);


												vec_73 = _mm256_fmadd_ps(vec_74, vec_41, mem_vec_9648);
												mem_vec_9648 = vec_73;



												vec_75 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_9649);
												mem_vec_9649 = vec_75;



												vec_76 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_9650);
												mem_vec_9650 = vec_76;



												vec_77 = _mm256_fmadd_ps(vec_74, vec_47, mem_vec_9651);
												mem_vec_9651 = vec_77;
												scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_79 = _mm256_set1_ps(scal_14);
												vec_80 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_78 = _mm256_fmadd_ps(vec_79, vec_80, mem_vec_9624);
												mem_vec_9624 = vec_78;

												vec_82 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_81 = _mm256_fmadd_ps(vec_79, vec_82, mem_vec_9625);
												mem_vec_9625 = vec_81;

												vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_83 = _mm256_fmadd_ps(vec_79, vec_84, mem_vec_9626);
												mem_vec_9626 = vec_83;

												vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

												vec_85 = _mm256_fmadd_ps(vec_79, vec_86, mem_vec_9627);
												mem_vec_9627 = vec_85;
												scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_88 = _mm256_set1_ps(scal_15);


												vec_87 = _mm256_fmadd_ps(vec_88, vec_80, mem_vec_9628);
												mem_vec_9628 = vec_87;



												vec_89 = _mm256_fmadd_ps(vec_88, vec_82, mem_vec_9629);
												mem_vec_9629 = vec_89;



												vec_90 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_9630);
												mem_vec_9630 = vec_90;



												vec_91 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_9631);
												mem_vec_9631 = vec_91;
												scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_93 = _mm256_set1_ps(scal_16);


												vec_92 = _mm256_fmadd_ps(vec_93, vec_80, mem_vec_9632);
												mem_vec_9632 = vec_92;



												vec_94 = _mm256_fmadd_ps(vec_93, vec_82, mem_vec_9633);
												mem_vec_9633 = vec_94;



												vec_95 = _mm256_fmadd_ps(vec_93, vec_84, mem_vec_9634);
												mem_vec_9634 = vec_95;



												vec_96 = _mm256_fmadd_ps(vec_93, vec_86, mem_vec_9635);
												mem_vec_9635 = vec_96;
												scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_98 = _mm256_set1_ps(scal_17);


												vec_97 = _mm256_fmadd_ps(vec_98, vec_80, mem_vec_9636);
												mem_vec_9636 = vec_97;



												vec_99 = _mm256_fmadd_ps(vec_98, vec_82, mem_vec_9637);
												mem_vec_9637 = vec_99;



												vec_100 = _mm256_fmadd_ps(vec_98, vec_84, mem_vec_9638);
												mem_vec_9638 = vec_100;



												vec_101 = _mm256_fmadd_ps(vec_98, vec_86, mem_vec_9639);
												mem_vec_9639 = vec_101;
												scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
												vec_103 = _mm256_set1_ps(scal_18);


												vec_102 = _mm256_fmadd_ps(vec_103, vec_80, mem_vec_9640);
												mem_vec_9640 = vec_102;



												vec_104 = _mm256_fmadd_ps(vec_103, vec_82, mem_vec_9641);
												mem_vec_9641 = vec_104;



												vec_105 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_9642);
												mem_vec_9642 = vec_105;



												vec_106 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_9643);
												mem_vec_9643 = vec_106;
												scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
												vec_108 = _mm256_set1_ps(scal_19);


												vec_107 = _mm256_fmadd_ps(vec_108, vec_80, mem_vec_9644);
												mem_vec_9644 = vec_107;



												vec_109 = _mm256_fmadd_ps(vec_108, vec_82, mem_vec_9645);
												mem_vec_9645 = vec_109;



												vec_110 = _mm256_fmadd_ps(vec_108, vec_84, mem_vec_9646);
												mem_vec_9646 = vec_110;



												vec_111 = _mm256_fmadd_ps(vec_108, vec_86, mem_vec_9647);
												mem_vec_9647 = vec_111;
												scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
												vec_113 = _mm256_set1_ps(scal_20);


												vec_112 = _mm256_fmadd_ps(vec_113, vec_80, mem_vec_9648);
												mem_vec_9648 = vec_112;



												vec_114 = _mm256_fmadd_ps(vec_113, vec_82, mem_vec_9649);
												mem_vec_9649 = vec_114;



												vec_115 = _mm256_fmadd_ps(vec_113, vec_84, mem_vec_9650);
												mem_vec_9650 = vec_115;



												vec_116 = _mm256_fmadd_ps(vec_113, vec_86, mem_vec_9651);
												mem_vec_9651 = vec_116;
											}
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_9648);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_9649);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_9650);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_9651);
								}
							}
						}
					}
