...
fp_2 = 0;
							for (w = w324, wp_0 = 0;w < w324 + 3;w += 1, wp_0 += 1){
								...
								for (x = x576, xp_1 = x576_p_0, xp_0 = 0;x < x576 + 14;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_5874 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											mem_vec_5875 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_5874);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_5875);
								}
							}
}
