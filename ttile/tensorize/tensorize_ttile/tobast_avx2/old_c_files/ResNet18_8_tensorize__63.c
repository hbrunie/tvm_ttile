...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (7, x); T (7, y); T (4, f); T (128, c); T (4, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c178_p_0, cp_1, c178, f, fp_0, f144_p_0, f145_p_0, fp_1, f144_p_1, fp_2, f144, f145, w, wp_0, x, xp_0, x200_p_0, x201_p_0, xp_1, x200_p_1, xp_2, x200, x201, y, yp_0;
IND_TYPE y100 = 0;
IND_TYPE x202 = 0;
IND_TYPE h = 0;
IND_TYPE w100 = 0;
