							...
							for (h = h214, hp_0 = 0;h < h214 + 3;h += 1, hp_0 += 1){
								...
								for (w = w196, wp_0 = 0;w < w196 + 3;w += 1, wp_0 += 1){
									...
									for (x = x390, xp_1 = x390_p_0, xp_0 = 0;x < x390 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3834 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3835 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
												...
												for (c = c390, cp_1 = c390_p_0, cp_0 = 0;c < c390 + 4;c += 1, cp_1 += 1, cp_0 += 1){
													...
													vec_24 = _mm256_fmadd_ps(vec_25, vec_2, mem_vec_3832);
													mem_vec_3832 = vec_24;
													vec_26 = _mm256_fmadd_ps(vec_25, vec_4, mem_vec_3833);
													mem_vec_3833 = vec_26;
													vec_27 = _mm256_fmadd_ps(vec_25, vec_6, mem_vec_3834);
													mem_vec_3834 = vec_27;
													vec_28 = _mm256_fmadd_ps(vec_25, vec_8, mem_vec_3835);
													mem_vec_3835 = vec_28;
												}
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3834);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3835);
									}
								}
							}
}
