...
c996_p_1 = 0;
							for (w = w512, wp_0 = 0;w < w512 + 3;w += 1, wp_0 += 1){
								...
								for (x = x1232, xp_2 = x1232_p_1, xp_1 = x1232_p_0, xp_0 = 0;x < x1232 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_7984 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_7985 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_7984);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_7985);
								}
							}
}
