...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, f); T (14, x); T (14, y); T (1, f); T (4, c); T (2, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c328_p_0, cp_1, c328, f, fp_0, f364_p_0, f365_p_0, fp_1, f364_p_1, fp_2, f364, f365, h, hp_0, x, xp_0, x408_p_0, x409_p_0, xp_1, x408_p_1, xp_2, x408, x409, y, yp_0;
IND_TYPE y204 = 0;
IND_TYPE x410 = 0;
IND_TYPE h130 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h130, hp_0 = 0;h < h130 + 3;h += 1, hp_0 += 1){
								...
								for (x = x408, xp_2 = x408_p_1, xp_1 = x408_p_0, xp_0 = 0;x < x408 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 32) (32 / 1)
											for (c = c328, cp_1 = c328_p_0, cp_0 = 0;c < c328 + 32;c += 1, cp_1 += 1, cp_0 += 1){
