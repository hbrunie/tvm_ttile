...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (7, x); T (28, y); T (4, c); T (16, x)]
*/
IND_TYPE c, cp_0, c240_p_0, cp_1, c240, w, wp_0, x, xp_0, x290_p_0, x291_p_0, xp_1, x290_p_1, xp_2, x290, x291, y, yp_0;
IND_TYPE y160 = 0;
IND_TYPE x292 = 0;
IND_TYPE h = 0;
IND_TYPE w160 = 0;
...
x290_p_1 = 0;
				for (w = w160, wp_0 = 0;w < w160 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x290, xp_2 = x290_p_1, xp_1 = x290_p_0, xp_0 = 0;x < x290 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
