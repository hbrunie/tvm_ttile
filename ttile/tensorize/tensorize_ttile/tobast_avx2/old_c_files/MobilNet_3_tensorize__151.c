...
[V f; U (4, f); U (4, y); U (3, w); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (56, x); T (14, y); T (2, f); T (128, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c298_p_0, cp_1, c298, f, fp_0, f324_p_0, f325_p_0, fp_1, f324_p_1, fp_2, f324, f325, h, hp_0, x, xp_0, x368_p_0, x369_p_0, xp_1, x368_p_1, xp_2, x368, x369, y, yp_0;
IND_TYPE y184 = 0;
IND_TYPE x370 = 0;
IND_TYPE h110 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h110, hp_0 = 0;h < h110 + 3;h += 1, hp_0 += 1){
								...
								for (x = x368, xp_2 = x368_p_1, xp_1 = x368_p_0, xp_0 = 0;x < x368 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 1, w = 3, c = 1, f = 32
											// T (c, 1) (1 / 1)
											for (c = c298, cp_1 = c298_p_0, cp_0 = 0;c < c298 + 1;c += 1, cp_1 += 1, cp_0 += 1){
