...
[V f; U (4, f); U (7, y); U (3, h); T (16, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (16, f); T (1, y); T (1, f); T (32, c); T (1, f)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, f, fp_0, f296_p_0, f297_p_0, fp_1, f296_p_1, fp_2, f296, f297, w, wp_0, x, xp_0, y, yp_0;
...
for (f297 = f298, f297_p_0 = 0;
	...
	for (c222 = c223, c222_p_0 = 0;
		...
		for (f296 = f297, f296_p_1 = f297_p_0, f296_p_0 = 0;
			f296 < f297 + 512;
			f296 += 512, f296_p_1 += 512, f296_p_0 += 512){
			// y = 7, x = 7, h = 3, w = 3, c = 16, f = 512
			// T (y, 1) (7 / 7)
			for (y = y148, yp_0 = 0;
				y < y148 + 7;
