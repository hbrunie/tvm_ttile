...
[V f; U (4, f); U (7, y); U (3, w); T (1, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (64, c); T (1, x); T (4, y); T (4, f); T (1, x)]
*/
IND_TYPE c, cp_0, c372_p_0, cp_1, c372, f, fp_0, h, hp_0, x, xp_0, x496_p_0, x497_p_0, xp_1, x496_p_1, xp_2, x496, x497, y, yp_0;
	...
	for (f = f248, fp_0 = 0;
		...
		for (y = y248, yp_0 = 0;
			...
			for (x496 = x497, x496_p_1 = x497_p_0, x496_p_0 = 0;
				x496 < x497 + 28;
				x496 += 28, x496_p_1 += 28, x496_p_0 += 28){
				// y = 7, x = 28, h = 3, w = 3, c = 64, f = 32
				// T (c, 64) (64 / 1)
