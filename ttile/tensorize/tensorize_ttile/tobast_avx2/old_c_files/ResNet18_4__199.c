...
[V f; U (4, f); ULambda y; U (3, w); T (1, c); Hoist_vars [c]; T (7, x);
  ...
  T (1, x)]
*/
IND_TYPE c, cp_0, c1178_p_0, cp_1, c1178, f, fp_0, h, hp_0, x, xp_0, x1398_p_0, x1399_p_0, xp_1, x1398_p_1, xp_2, x1398, x1399, y, yp_0;
							...
							for (x = x1398, xp_2 = x1398_p_1, xp_1 = x1398_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c1178, cp_1 = c1178_p_0, cp_0 = 0;
											...
											vec_29 = _mm256_fmadd_ps(vec_30, vec_31, mem_vec_11052);
											mem_vec_11052 = vec_29;

											vec_33 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_32 = _mm256_fmadd_ps(vec_30, vec_33, mem_vec_11053);
											mem_vec_11053 = vec_32;

											vec_35 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_34 = _mm256_fmadd_ps(vec_30, vec_35, mem_vec_11054);
											mem_vec_11054 = vec_34;

											vec_37 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_36 = _mm256_fmadd_ps(vec_30, vec_37, mem_vec_11055);
											mem_vec_11055 = vec_36;
											scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
											vec_39 = _mm256_set1_ps(scal_6);


											vec_38 = _mm256_fmadd_ps(vec_39, vec_31, mem_vec_11056);
											mem_vec_11056 = vec_38;



											vec_40 = _mm256_fmadd_ps(vec_39, vec_33, mem_vec_11057);
											mem_vec_11057 = vec_40;



											vec_41 = _mm256_fmadd_ps(vec_39, vec_35, mem_vec_11058);
											mem_vec_11058 = vec_41;



											vec_42 = _mm256_fmadd_ps(vec_39, vec_37, mem_vec_11059);
											mem_vec_11059 = vec_42;
											scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_31, mem_vec_11060);
											mem_vec_11060 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_33, mem_vec_11061);
											mem_vec_11061 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_35, mem_vec_11062);
											mem_vec_11062 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_37, mem_vec_11063);
											mem_vec_11063 = vec_47;
											scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_31, mem_vec_11064);
											mem_vec_11064 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_33, mem_vec_11065);
											mem_vec_11065 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_35, mem_vec_11066);
											mem_vec_11066 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_37, mem_vec_11067);
											mem_vec_11067 = vec_52;
											scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_31, mem_vec_11068);
											mem_vec_11068 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_33, mem_vec_11069);
											mem_vec_11069 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_35, mem_vec_11070);
											mem_vec_11070 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_37, mem_vec_11071);
											mem_vec_11071 = vec_57;
											scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
											vec_59 = _mm256_set1_ps(scal_10);
											vec_60 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_58 = _mm256_fmadd_ps(vec_59, vec_60, mem_vec_11052);
											mem_vec_11052 = vec_58;

											vec_62 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_61 = _mm256_fmadd_ps(vec_59, vec_62, mem_vec_11053);
											mem_vec_11053 = vec_61;

											vec_64 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_63 = _mm256_fmadd_ps(vec_59, vec_64, mem_vec_11054);
											mem_vec_11054 = vec_63;

											vec_66 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_65 = _mm256_fmadd_ps(vec_59, vec_66, mem_vec_11055);
											mem_vec_11055 = vec_65;
											scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
											vec_68 = _mm256_set1_ps(scal_11);


											vec_67 = _mm256_fmadd_ps(vec_68, vec_60, mem_vec_11056);
											mem_vec_11056 = vec_67;



											vec_69 = _mm256_fmadd_ps(vec_68, vec_62, mem_vec_11057);
											mem_vec_11057 = vec_69;



											vec_70 = _mm256_fmadd_ps(vec_68, vec_64, mem_vec_11058);
											mem_vec_11058 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_68, vec_66, mem_vec_11059);
											mem_vec_11059 = vec_71;
											scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
											vec_73 = _mm256_set1_ps(scal_12);


											vec_72 = _mm256_fmadd_ps(vec_73, vec_60, mem_vec_11060);
											mem_vec_11060 = vec_72;



											vec_74 = _mm256_fmadd_ps(vec_73, vec_62, mem_vec_11061);
											mem_vec_11061 = vec_74;



											vec_75 = _mm256_fmadd_ps(vec_73, vec_64, mem_vec_11062);
											mem_vec_11062 = vec_75;



											vec_76 = _mm256_fmadd_ps(vec_73, vec_66, mem_vec_11063);
											mem_vec_11063 = vec_76;
											scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_60, mem_vec_11064);
											mem_vec_11064 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_62, mem_vec_11065);
											mem_vec_11065 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_64, mem_vec_11066);
											mem_vec_11066 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_66, mem_vec_11067);
											mem_vec_11067 = vec_81;
											scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_60, mem_vec_11068);
											mem_vec_11068 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_62, mem_vec_11069);
											mem_vec_11069 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_64, mem_vec_11070);
											mem_vec_11070 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_66, mem_vec_11071);
							...
							for (x = x1398, xp_2 = x1398_p_1, xp_1 = x1398_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c1178, cp_1 = c1178_p_0, cp_0 = 0;
											...
											vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_11072);
											mem_vec_11072 = vec_34;

											vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_11073);
											mem_vec_11073 = vec_37;

											vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_11074);
											mem_vec_11074 = vec_39;

											vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_11075);
											mem_vec_11075 = vec_41;
											scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_11076);
											mem_vec_11076 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_11077);
											mem_vec_11077 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_11078);
											mem_vec_11078 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_11079);
											mem_vec_11079 = vec_47;
											scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_11080);
											mem_vec_11080 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_11081);
											mem_vec_11081 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_11082);
											mem_vec_11082 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_11083);
											mem_vec_11083 = vec_52;
											scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_11084);
											mem_vec_11084 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_11085);
											mem_vec_11085 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_11086);
											mem_vec_11086 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_11087);
											mem_vec_11087 = vec_57;
											scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
											vec_59 = _mm256_set1_ps(scal_10);


											vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_11088);
											mem_vec_11088 = vec_58;



											vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_11089);
											mem_vec_11089 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_11090);
											mem_vec_11090 = vec_61;



											vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_11091);
											mem_vec_11091 = vec_62;
											scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
											vec_64 = _mm256_set1_ps(scal_11);


											vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_11092);
											mem_vec_11092 = vec_63;



											vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_11093);
											mem_vec_11093 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_11094);
											mem_vec_11094 = vec_66;



											vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_11095);
											mem_vec_11095 = vec_67;
											scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
											vec_69 = _mm256_set1_ps(scal_12);
											vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_11072);
											mem_vec_11072 = vec_68;

											vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_11073);
											mem_vec_11073 = vec_71;

											vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_11074);
											mem_vec_11074 = vec_73;

											vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_11075);
											mem_vec_11075 = vec_75;
											scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_11076);
											mem_vec_11076 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_11077);
											mem_vec_11077 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_11078);
											mem_vec_11078 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_11079);
											mem_vec_11079 = vec_81;
											scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_11080);
											mem_vec_11080 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_11081);
											mem_vec_11081 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_11082);
											mem_vec_11082 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_11083);
											mem_vec_11083 = vec_86;
											scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
											vec_88 = _mm256_set1_ps(scal_15);


											vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_11084);
											mem_vec_11084 = vec_87;



											vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_11085);
											mem_vec_11085 = vec_89;



											vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_11086);
											mem_vec_11086 = vec_90;



											vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_11087);
											mem_vec_11087 = vec_91;
											scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
											vec_93 = _mm256_set1_ps(scal_16);


											vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_11088);
											mem_vec_11088 = vec_92;



											vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_11089);
											mem_vec_11089 = vec_94;



											vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_11090);
											mem_vec_11090 = vec_95;



											vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_11091);
											mem_vec_11091 = vec_96;
											scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
											vec_98 = _mm256_set1_ps(scal_17);


											vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_11092);
											mem_vec_11092 = vec_97;



											vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_11093);
											mem_vec_11093 = vec_99;



											vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_11094);
											mem_vec_11094 = vec_100;



											vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_11095);
