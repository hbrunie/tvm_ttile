...
fp_2 = 0;
							for (w = w124, wp_0 = 0;w < w124 + 3;w += 1, wp_0 += 1){
								...
								for (x = x186, xp_1 = x186_p_0, xp_0 = 0;x < x186 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2248 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_2249 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_2248);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_2249);
								}
							}
}
