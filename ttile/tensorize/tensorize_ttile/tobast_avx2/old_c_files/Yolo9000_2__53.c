...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (2, y); T (2, f); T (8, c); T (17, x); T (34, y); T (1, f);
  T (2, x)]
*/
IND_TYPE c, cp_0, c198_p_0, cp_1, c198, f, fp_0, f188_p_0, fp_1, f188, w, wp_0, x, xp_0, x264_p_0, x265_p_0, xp_1, x264_p_1, xp_2, x264, x265, y, yp_0, y198_p_0, yp_1, y198;
