...
[V f; U (4, f); U (4, y); T (4, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (16, c); T (7, x); T (7, y); T (8, f); T (2, c); T (1, x)]
*/
IND_TYPE c, cp_0, c32_p_0, c33_p_0, cp_1, c32_p_1, cp_2, c32, c33, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x32_p_0, x33_p_0, xp_1, x32_p_1, xp_2, x32, x33, y, yp_0;
IND_TYPE y16 = 0;
IND_TYPE x34 = 0;
IND_TYPE h16 = 0;
IND_TYPE w16 = 0;
