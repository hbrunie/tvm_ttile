...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (34, x);
  T (3, w); T (1, f); T (2, x); T (17, y); T (4, f); T (16, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c240_p_0, cp_1, c240, f, fp_0, f320_p_0, f321_p_0, fp_1, f320_p_1, fp_2, f320, f321, w, wp_0, x, xp_0, x320_p_0, x321_p_0, xp_1, x320_p_1, xp_2, x320, x321, y, yp_0;
IND_TYPE y160 = 0;
IND_TYPE x322 = 0;
IND_TYPE h = 0;
IND_TYPE w160 = 0;
