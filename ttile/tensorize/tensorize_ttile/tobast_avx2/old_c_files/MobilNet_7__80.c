						...
						for (f = f1440, fp_2 = f1440_p_1, fp_1 = f1440_p_0, fp_0 = 0;
							...
							for (h = h534, hp_0 = 0;
								...
								for (x = x1080, xp_1 = x1080_p_0, xp_0 = 0;
									x < x1080 + 7;
									x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_12608 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
											mem_vec_12609 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
											mem_vec_12610 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
											mem_vec_12611 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
											mem_vec_12612 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
											mem_vec_12613 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
											mem_vec_12614 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
											mem_vec_12615 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
											...
											mem_vec_12620 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
											mem_vec_12621 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
											mem_vec_12622 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
											mem_vec_12623 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_12608);
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_12609);
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_12610);
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_12611);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_12612);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_12613);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_12614);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_12615);
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_12620);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_12621);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_12622);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_12623);
								}
							}
						}
					}
