...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (1, f); T (128, c); T (2, x);
  T (8, f)]
*/
IND_TYPE c, cp_0, c168_p_0, cp_1, c168, f, fp_0, f224_p_0, f225_p_0, fp_1, f224_p_1, fp_2, f224, f225, w, wp_0, x, xp_0, x224_p_0, x225_p_0, xp_1, x224_p_1, xp_2, x224, x225, y, yp_0;
IND_TYPE y112 = 0;
IND_TYPE x226 = 0;
IND_TYPE h = 0;
IND_TYPE w112 = 0;
