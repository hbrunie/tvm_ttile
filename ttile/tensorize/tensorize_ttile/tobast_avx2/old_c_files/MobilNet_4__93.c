...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (1, f); T (2, x); T (7, y); T (1, f); T (64, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c138_p_0, cp_1, c138, f, fp_0, f148_p_0, f149_p_0, fp_1, f148_p_1, fp_2, f148, f149, w, wp_0, x, xp_0, x220_p_0, x221_p_0, xp_1, x220_p_1, xp_2, x220, x221, y, yp_0;
			...
			for (f148 = f149, f148_p_1 = f149_p_0, f148_p_0 = 0;
				...
				for (y = y92, yp_0 = 0;
					...
					for (x220 = x221, x220_p_1 = x221_p_0, x220_p_0 = 0;
						x220 < x221 + 28;
						x220 += 14, x220_p_1 += 14, x220_p_0 += 14){
