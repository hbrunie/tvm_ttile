...
[V f; U (4, f); U (4, y); U (3, w); T (128, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (4, f); T (1, x); T (7, y); T (1, f); T (1, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c378_p_0, cp_1, c378, f, fp_0, f468_p_0, f469_p_0, fp_1, f468_p_1, fp_2, f468, f469, h, hp_0, x, xp_0, x540_p_0, x541_p_0, xp_1, x540_p_1, xp_2, x540, x541, y, yp_0;
IND_TYPE y252 = 0;
IND_TYPE x542 = 0;
IND_TYPE h162 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h162, hp_0 = 0;h < h162 + 3;h += 1, hp_0 += 1){
								// y = 4, x = 28, h = 1, w = 3, c = 128, f = 32
								// T (x, 28) (28 / 1)
								for (x = x540, xp_2 = x540_p_1, xp_1 = x540_p_0, xp_0 = 0;x < x540 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
