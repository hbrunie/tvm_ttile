...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (28, x); T (14, y); T (4, f); T (128, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c178_p_0, cp_1, c178, f, fp_0, f164_p_0, f165_p_0, fp_1, f164_p_1, fp_2, f164, f165, w, wp_0, x, xp_0, x208_p_0, x209_p_0, xp_1, x208_p_1, xp_2, x208, x209, y, yp_0;
IND_TYPE y104 = 0;
IND_TYPE x210 = 0;
IND_TYPE h = 0;
IND_TYPE w104 = 0;
...
fp_2 = 0;
							for (w = w104, wp_0 = 0;w < w104 + 3;w += 1, wp_0 += 1){
								...
								for (x = x208, xp_2 = x208_p_1, xp_1 = x208_p_0, xp_0 = 0;x < x208 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 1, f = 32
											// T (c, 1) (1 / 1)
											for (c = c178, cp_1 = c178_p_0, cp_0 = 0;c < c178 + 1;c += 1, cp_1 += 1, cp_0 += 1){
