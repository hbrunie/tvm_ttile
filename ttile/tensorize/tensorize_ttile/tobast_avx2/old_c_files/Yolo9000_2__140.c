...
[V f; U (4, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (68, x);
  T (3, h); T (34, y); T (2, f); T (16, c); T (4, x); T (2, y); T (1, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c282_p_0, cp_1, c282, f, fp_0, f272_p_0, fp_1, f272, h, hp_0, x, xp_0, x376_p_0, x377_p_0, xp_1, x376_p_1, xp_2, x376, x377, y, yp_0, y282_p_0, yp_1, y282;
