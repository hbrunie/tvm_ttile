...
/*
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (4, f); T (8, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, f, fp_0, f236_p_0, f237_p_0, fp_1, f236_p_1, fp_2, f236, f237, w, wp_0, x, xp_0, x308_p_0, x309_p_0, xp_1, x308_p_1, xp_2, x308, x309, y, yp_0;
IND_TYPE y136 = 0;
IND_TYPE x310 = 0;
IND_TYPE h = 0;
IND_TYPE w136 = 0;
