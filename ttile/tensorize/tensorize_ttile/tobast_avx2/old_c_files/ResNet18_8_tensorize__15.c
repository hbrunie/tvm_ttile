...
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (4, c); T (2, x); T (7, y); T (8, f); T (4, c); T (1, x)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, c1_p_0, c1, cp_1, c0_p_1, cp_2, f, fp_0, h, hp_0, w, wp_0, x, x0, xp_0, x0_p_0, x1_p_0, x1, xp_1, x0_p_1, xp_2, y, yp_0;
IND_TYPE y0 = 0;
IND_TYPE x2 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
