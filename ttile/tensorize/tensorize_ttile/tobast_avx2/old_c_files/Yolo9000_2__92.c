...
[V f; U (4, f); U (4, y); U (3, w); T (16, c); Hoist_vars [c]; T (16, x);
  T (3, h); T (4, y); T (2, f); T (2, c); T (17, x); T (17, y); T (1, f);
  T (1, x)]
*/
IND_TYPE c, cp_0, c288_p_0, cp_1, c288, f, fp_0, f278_p_0, fp_1, f278, h, hp_0, x, xp_0, x384_p_0, x385_p_0, xp_1, x384_p_1, xp_2, x384, x385, y, yp_0, y288_p_0, yp_1, y288;
