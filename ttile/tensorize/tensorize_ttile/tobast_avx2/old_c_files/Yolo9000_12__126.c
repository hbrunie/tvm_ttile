...
[V f; U (4, f); ULambda y; U (3, h); T (4, c); Hoist_vars [c]; T (2, x);
  ...
  T (64, c); T (17, x); T (2, f)]
*/
IND_TYPE c, cp_0, c1220_p_0, cp_1, c1220, f, fp_0, f656_p_0, f657_p_0, fp_1, f656_p_1, fp_2, f656, f657, w, wp_0, x, xp_0, x1072_p_0, x1073_p_0, xp_1, x1072_p_1, xp_2, x1072, x1073, y, yp_0;
				...
				f656 += 32, f656_p_1 += 32, f656_p_0 += 32){
					for (y = y536, yp_0 = 0;
						...
						for (x1072 = x1073, x1072_p_1 = x1073_p_0, x1072_p_0 = 0;
							x1072 < x1073 + 2;
							x1072 += 2, x1072_p_1 += 2, x1072_p_0 += 2){
							// y = ph_y, x = 2, h = 3, w = 3, c = 4, f = 32
							// T (f, 1) (32 / 32)
