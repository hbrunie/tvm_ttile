...
[V f; U (4, f); U (7, y); U (3, h); T (128, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (8, f); T (28, x); T (4, y); T (1, f); T (1, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c274_p_0, cp_1, c274, f, fp_0, f272_p_0, f273_p_0, fp_1, f272_p_1, fp_2, f272, f273, w, wp_0, x, xp_0, x328_p_0, x329_p_0, xp_1, x328_p_1, xp_2, x328, x329, y, yp_0;
...
for (f273 = f274, f273_p_0 = 0;
	...
	for (x329 = x330, x329_p_0 = 0;
		...
		for (c274 = c275, c274_p_0 = 0;
			c274 < c275 + 128;
			c274 += 128, c274_p_0 += 128){
			// y = 28, x = 28, h = 3, w = 3, c = 128, f = 256
			// T (f, 1) (256 / 256)
			for (f272 = f273, f272_p_1 = f273_p_0, f272_p_0 = 0;
				f272 < f273 + 256;
				f272 += 256, f272_p_1 += 256, f272_p_0 += 256){
				// y = 28, x = 28, h = 3, w = 3, c = 128, f = 256
				// T (y, 4) (28 / 7)
				for (y = y164, yp_0 = 0;
					y < y164 + 28;
