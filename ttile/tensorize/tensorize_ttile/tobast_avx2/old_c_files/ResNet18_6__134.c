...
[V f; U (4, f); U (7, y); U (3, w); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (14, x); T (4, y); T (1, f); T (8, c); T (2, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c528_p_0, cp_1, c528, f, fp_0, f658_p_0, f659_p_0, fp_1, f658_p_1, fp_2, f658, f659, h, hp_0, x, xp_0, x750_p_0, x751_p_0, xp_1, x750_p_1, xp_2, x750, x751, y, yp_0;
	...
	for (x751 = x752, x751_p_0 = 0;
		...
		for (c528 = c529, c528_p_0 = 0;
			...
			for (f658 = f659, f658_p_1 = f659_p_0, f658_p_0 = 0;
				f658 < f659 + 32;
				f658 += 32, f658_p_1 += 32, f658_p_0 += 32){
				// y = 28, x = 14, h = 3, w = 3, c = 16, f = 32
				// T (y, 4) (28 / 7)
				for (y = y352, yp_0 = 0;
					y < y352 + 28;
