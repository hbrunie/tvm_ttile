...
/*
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (14, x); T (3, w);
  T (3, h); T (1, f); T (1, x); T (7, y); T (1, f); T (8, c); T (2, x);
  T (8, f)]
*/
...
fp_2 = 0;
							for (h = h24, hp_0 = 0;h < h24 + 3;h += 1, hp_0 += 1){
								...
								for (w = w24, wp_0 = 0;w < w24 + 3;w += 1, wp_0 += 1){
									// y = 4, x = 14, h = 1, w = 1, c = 32, f = 32
									// T (x, 14) (14 / 1)
									for (x = x48, xp_2 = x48_p_1, xp_1 = x48_p_0, xp_0 = 0;x < x48 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
