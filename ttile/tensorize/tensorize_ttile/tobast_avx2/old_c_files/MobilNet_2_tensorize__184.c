...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (56, x);
  ...
  T (1, f)]
*/
IND_TYPE c, cp_0, c92_p_0, c93_p_0, cp_1, c92_p_1, cp_2, c92, c93, f, fp_0, f64_p_0, f65_p_0, fp_1, f64_p_1, fp_2, f64, f65, w, wp_0, x, xp_0, x118_p_0, xp_1, x118, y, yp_0;
IND_TYPE y60 = 0;
IND_TYPE x119 = 0;
IND_TYPE h = 0;
IND_TYPE w60 = 0;
...
yp_0 = 0;
							for (w = w60, wp_0 = 0;w < w60 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 56) (56 / 1)
								for (x = x118, xp_1 = x118_p_0, xp_0 = 0;x < x118 + 56;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 2) (2 / 1)
											for (c = c92, cp_2 = c92_p_1, cp_1 = c92_p_0, cp_0 = 0;c < c92 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
