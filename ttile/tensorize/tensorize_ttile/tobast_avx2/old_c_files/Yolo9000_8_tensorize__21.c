...
/*
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (1, f); T (4, x); T (17, y); T (8, f); T (1, c); T (1, x);
  T (1, f)]
*/
...
fp_2 = 0;
							for (w = w164, wp_0 = 0;w < w164 + 3;w += 1, wp_0 += 1){
								...
								for (x = x328, xp_2 = x328_p_1, xp_1 = x328_p_0, xp_0 = 0;x < x328 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 128) (128 / 1)
											for (c = c246, cp_1 = c246_p_0, cp_0 = 0;c < c246 + 128;c += 1, cp_1 += 1, cp_0 += 1){
