...
[V f; U (2, f); ULambda y; U (3, h); T (2, c); Hoist_vars [c]; T (17, x);
  ...
  T (32, f); T (1, x); T (8, c)]
*/
IND_TYPE c, cp_0, c80_p_0, c81_p_0, c82_p_0, cp_1, c80_p_1, c81_p_1, cp_2, c80_p_2, cp_3, c80, c81, c82, f, fp_0, w, wp_0, x, xp_0, x64_p_0, x65_p_0, xp_1, x64_p_1, xp_2, x64, x65, y, yp_0;
					...
					for (y = y32, yp_0 = 0;
						...
						for (x64 = x65, x64_p_1 = x65_p_0, x64_p_0 = 0;
							...
							for (c80 = c81, c80_p_2 = c81_p_1, c80_p_1 = c81_p_0, c80_p_0 = 0;
								c80 < c81 + 8;
								c80 += 2, c80_p_2 += 2, c80_p_1 += 2, c80_p_0 += 2){
								...
								for (w = w32, wp_0 = 0;
									...
									for (x = x64, xp_2 = x64_p_1, xp_1 = x64_p_0, xp_0 = 0;
										...
										x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_608 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
												mem_vec_609 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 8]);
												mem_vec_610 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
												mem_vec_611 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 8]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 2, f = 16
												// T (c, 2) (2 / 1)
												for (c = c80, cp_3 = c80_p_2, cp_2 = c80_p_1, cp_1 = c80_p_0, cp_0 = 0;
													c < c80 + 2;
													...
													vec_26 = _mm256_fmadd_ps(vec_27, vec_2, mem_vec_608);
													mem_vec_608 = vec_26;



													vec_28 = _mm256_fmadd_ps(vec_27, vec_4, mem_vec_609);
													mem_vec_609 = vec_28;
													scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h) + c];
													vec_30 = _mm256_set1_ps(scal_9);


													vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_610);
													mem_vec_610 = vec_29;



													vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_611);
													mem_vec_611 = vec_31;
													scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
													vec_33 = _mm256_set1_ps(scal_10);
													vec_34 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

													vec_32 = _mm256_fmadd_ps(vec_33, vec_34, mem_vec_592);
													mem_vec_592 = vec_32;

													vec_36 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

													vec_35 = _mm256_fmadd_ps(vec_33, vec_36, mem_vec_593);
													mem_vec_593 = vec_35;
													scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
													vec_38 = _mm256_set1_ps(scal_11);


													vec_37 = _mm256_fmadd_ps(vec_38, vec_34, mem_vec_594);
													mem_vec_594 = vec_37;



													vec_39 = _mm256_fmadd_ps(vec_38, vec_36, mem_vec_595);
													mem_vec_595 = vec_39;
													scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
													vec_41 = _mm256_set1_ps(scal_12);


													vec_40 = _mm256_fmadd_ps(vec_41, vec_34, mem_vec_596);
													mem_vec_596 = vec_40;



													vec_42 = _mm256_fmadd_ps(vec_41, vec_36, mem_vec_597);
													mem_vec_597 = vec_42;
													scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
													vec_44 = _mm256_set1_ps(scal_13);


													vec_43 = _mm256_fmadd_ps(vec_44, vec_34, mem_vec_598);
													mem_vec_598 = vec_43;



													vec_45 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_599);
													mem_vec_599 = vec_45;
													scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
													vec_47 = _mm256_set1_ps(scal_14);


													vec_46 = _mm256_fmadd_ps(vec_47, vec_34, mem_vec_600);
													mem_vec_600 = vec_46;



													vec_48 = _mm256_fmadd_ps(vec_47, vec_36, mem_vec_601);
													mem_vec_601 = vec_48;
													scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
													vec_50 = _mm256_set1_ps(scal_15);


													vec_49 = _mm256_fmadd_ps(vec_50, vec_34, mem_vec_602);
													mem_vec_602 = vec_49;



													vec_51 = _mm256_fmadd_ps(vec_50, vec_36, mem_vec_603);
													mem_vec_603 = vec_51;
													scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
													vec_53 = _mm256_set1_ps(scal_16);


													vec_52 = _mm256_fmadd_ps(vec_53, vec_34, mem_vec_604);
													mem_vec_604 = vec_52;



													vec_54 = _mm256_fmadd_ps(vec_53, vec_36, mem_vec_605);
													mem_vec_605 = vec_54;
													scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
													vec_56 = _mm256_set1_ps(scal_17);


													vec_55 = _mm256_fmadd_ps(vec_56, vec_34, mem_vec_606);
													mem_vec_606 = vec_55;



													vec_57 = _mm256_fmadd_ps(vec_56, vec_36, mem_vec_607);
													mem_vec_607 = vec_57;
													scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
													vec_59 = _mm256_set1_ps(scal_18);


													vec_58 = _mm256_fmadd_ps(vec_59, vec_34, mem_vec_608);
													mem_vec_608 = vec_58;



													vec_60 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_609);
													mem_vec_609 = vec_60;
													scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
													vec_62 = _mm256_set1_ps(scal_19);


													vec_61 = _mm256_fmadd_ps(vec_62, vec_34, mem_vec_610);
													mem_vec_610 = vec_61;



													vec_63 = _mm256_fmadd_ps(vec_62, vec_36, mem_vec_611);
													mem_vec_611 = vec_63;
													scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
													vec_65 = _mm256_set1_ps(scal_20);
													vec_66 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

													vec_64 = _mm256_fmadd_ps(vec_65, vec_66, mem_vec_592);
													mem_vec_592 = vec_64;

													vec_68 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

													vec_67 = _mm256_fmadd_ps(vec_65, vec_68, mem_vec_593);
													mem_vec_593 = vec_67;
													scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
													vec_70 = _mm256_set1_ps(scal_21);


													vec_69 = _mm256_fmadd_ps(vec_70, vec_66, mem_vec_594);
													mem_vec_594 = vec_69;



													vec_71 = _mm256_fmadd_ps(vec_70, vec_68, mem_vec_595);
													mem_vec_595 = vec_71;
													scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
													vec_73 = _mm256_set1_ps(scal_22);


													vec_72 = _mm256_fmadd_ps(vec_73, vec_66, mem_vec_596);
													mem_vec_596 = vec_72;



													vec_74 = _mm256_fmadd_ps(vec_73, vec_68, mem_vec_597);
													mem_vec_597 = vec_74;
													scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
													vec_76 = _mm256_set1_ps(scal_23);


													vec_75 = _mm256_fmadd_ps(vec_76, vec_66, mem_vec_598);
													mem_vec_598 = vec_75;



													vec_77 = _mm256_fmadd_ps(vec_76, vec_68, mem_vec_599);
													mem_vec_599 = vec_77;
													scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
													vec_79 = _mm256_set1_ps(scal_24);


													vec_78 = _mm256_fmadd_ps(vec_79, vec_66, mem_vec_600);
													mem_vec_600 = vec_78;



													vec_80 = _mm256_fmadd_ps(vec_79, vec_68, mem_vec_601);
													mem_vec_601 = vec_80;
													scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
													vec_82 = _mm256_set1_ps(scal_25);


													vec_81 = _mm256_fmadd_ps(vec_82, vec_66, mem_vec_602);
													mem_vec_602 = vec_81;



													vec_83 = _mm256_fmadd_ps(vec_82, vec_68, mem_vec_603);
													mem_vec_603 = vec_83;
													scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
													vec_85 = _mm256_set1_ps(scal_26);


													vec_84 = _mm256_fmadd_ps(vec_85, vec_66, mem_vec_604);
													mem_vec_604 = vec_84;



													vec_86 = _mm256_fmadd_ps(vec_85, vec_68, mem_vec_605);
													mem_vec_605 = vec_86;
													scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
													vec_88 = _mm256_set1_ps(scal_27);


													vec_87 = _mm256_fmadd_ps(vec_88, vec_66, mem_vec_606);
													mem_vec_606 = vec_87;



													vec_89 = _mm256_fmadd_ps(vec_88, vec_68, mem_vec_607);
													mem_vec_607 = vec_89;
													scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
													vec_91 = _mm256_set1_ps(scal_28);


													vec_90 = _mm256_fmadd_ps(vec_91, vec_66, mem_vec_608);
													mem_vec_608 = vec_90;



													vec_92 = _mm256_fmadd_ps(vec_91, vec_68, mem_vec_609);
													mem_vec_609 = vec_92;
													scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
													vec_94 = _mm256_set1_ps(scal_29);


													vec_93 = _mm256_fmadd_ps(vec_94, vec_66, mem_vec_610);
													mem_vec_610 = vec_93;



													vec_95 = _mm256_fmadd_ps(vec_94, vec_68, mem_vec_611);
													mem_vec_611 = vec_95;
												}
											...
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_608);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 8], mem_vec_609);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_610);
											_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 8], mem_vec_611);
									}
								}
							}
						}
