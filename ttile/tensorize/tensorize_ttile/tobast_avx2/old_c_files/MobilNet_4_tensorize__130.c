...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, f); T (28, x); T (7, y); T (1, f); T (4, c); T (1, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c174_p_0, cp_1, c174, f, fp_0, f196_p_0, f197_p_0, fp_1, f196_p_1, fp_2, f196, f197, w, wp_0, x, xp_0, x268_p_0, x269_p_0, xp_1, x268_p_1, xp_2, x268, x269, y, yp_0;
IND_TYPE y116 = 0;
IND_TYPE x270 = 0;
IND_TYPE h = 0;
IND_TYPE w116 = 0;
...
fp_2 = 0;
							for (w = w116, wp_0 = 0;w < w116 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x268, xp_2 = x268_p_1, xp_1 = x268_p_0, xp_0 = 0;x < x268 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
