...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, f); T (1, x); T (7, y); T (4, f); T (8, c); T (28, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c226_p_0, cp_1, c226, f, fp_0, f208_p_0, f209_p_0, fp_1, f208_p_1, fp_2, f208, f209, w, wp_0, x, xp_0, x264_p_0, x265_p_0, xp_1, x264_p_1, xp_2, x264, x265, y, yp_0;
IND_TYPE y132 = 0;
IND_TYPE x266 = 0;
IND_TYPE h = 0;
IND_TYPE w132 = 0;
...
fp_2 = 0;
							for (w = w132, wp_0 = 0;w < w132 + 3;w += 1, wp_0 += 1){
								...
								for (x = x264, xp_2 = x264_p_1, xp_1 = x264_p_0, xp_0 = 0;x < x264 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 16, f = 32
											// T (c, 16) (16 / 1)
											for (c = c226, cp_1 = c226_p_0, cp_0 = 0;c < c226 + 16;c += 1, cp_1 += 1, cp_0 += 1){
