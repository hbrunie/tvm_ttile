...
y952 = 0;
y952_p_0 = 0;
				for (x1290 = x1291, x1290_p_1 = x1291_p_0, x1290_p_0 = 0;x1290 < x1291 + 68;x1290 += 2, x1290_p_1 += 2, x1290_p_0 += 2){
						for (y = y952, yp_1 = y952_p_0, yp_0 = 0;y < y952 + 110;y += 10, yp_1 += 10, yp_0 += 10){
							// y = ph_y, x = 2, h = 3, w = 3, c = 16, f = 16
							// T (c, 2) (16 / 8)
							for (c1264 = c1265, c1264_p_1 = c1265_p_0, c1264_p_0 = 0;c1264 < c1265 + 16;c1264 += 8, c1264_p_1 += 8, c1264_p_0 += 8){
								// y = ph_y, x = 2, h = 3, w = 3, c = 8, f = 16
								// T (w, 3) (3 / 1)
								for (w = w636, wp_0 = 0;w < w636 + 3;w += 1, wp_0 += 1){
									// y = ph_y, x = 2, h = 3, w = 1, c = 8, f = 16
									// T (x, 2) (2 / 1)
									for (x = x1290, xp_2 = x1290_p_1, xp_1 = x1290_p_0, xp_0 = 0;x < x1290 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												mem_vec_11556 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
												mem_vec_11557 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 8]);
												mem_vec_11558 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
												mem_vec_11559 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8]);
												...
												mem_vec_11562 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
												mem_vec_11563 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8]);
												...
												mem_vec_11566 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
												mem_vec_11567 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8]);
												mem_vec_11568 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
												mem_vec_11569 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8]);
												mem_vec_11570 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
												mem_vec_11571 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 8]);
												mem_vec_11572 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
												mem_vec_11573 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
												mem_vec_11574 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
												mem_vec_11575 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_11556);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 8], mem_vec_11557);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_11558);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8], mem_vec_11559);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_11562);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8], mem_vec_11563);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_11566);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8], mem_vec_11567);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_11568);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8], mem_vec_11569);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_11570);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 8], mem_vec_11571);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_11572);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_11573);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_11574);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_11575);
									}
								}
							}
						}
						for (y = y952 + 110, yp_1 = y952_p_0, yp_0 = 0;y < y952 + 110 + 26;y += 13, yp_1 += 13, yp_0 += 13){
							// y = ph_y, x = 2, h = 3, w = 3, c = 16, f = 16
							// T (c, 2) (16 / 8)
							for (c1264 = c1265, c1264_p_1 = c1265_p_0, c1264_p_0 = 0;c1264 < c1265 + 16;c1264 += 8, c1264_p_1 += 8, c1264_p_0 += 8){
								// y = ph_y, x = 2, h = 3, w = 3, c = 8, f = 16
								...
								for (w = w636, wp_0 = 0;w < w636 + 3;w += 1, wp_0 += 1){
									...
									for (x = x1290, xp_2 = x1290_p_1, xp_1 = x1290_p_0, xp_0 = 0;x < x1290 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_11578 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
												mem_vec_11579 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8]);
												mem_vec_11580 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
												mem_vec_11581 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 8]);
												mem_vec_11582 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
												mem_vec_11583 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8]);
												...
												mem_vec_11586 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
												mem_vec_11587 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8]);
												mem_vec_11588 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
												mem_vec_11589 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8]);
												mem_vec_11590 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
												mem_vec_11591 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 8]);
												mem_vec_11592 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
												mem_vec_11593 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
												mem_vec_11594 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
												mem_vec_11595 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
												mem_vec_11596 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
												mem_vec_11597 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8]);
												mem_vec_11598 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
												mem_vec_11599 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8]);
												mem_vec_11600 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
												mem_vec_11601 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 8, f = 16
												// T (c, 8) (8 / 1)
												for (c = c1264, cp_2 = c1264_p_1, cp_1 = c1264_p_0, cp_0 = 0;c < c1264 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
													scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_11578);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8], mem_vec_11579);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_11580);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 8], mem_vec_11581);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_11582);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8], mem_vec_11583);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_11586);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8], mem_vec_11587);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_11588);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8], mem_vec_11589);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_11590);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 8], mem_vec_11591);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_11592);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_11593);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_11594);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_11595);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_11596);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8], mem_vec_11597);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_11598);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8], mem_vec_11599);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_11600);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8], mem_vec_11601);
									}
								}
							}
						}
