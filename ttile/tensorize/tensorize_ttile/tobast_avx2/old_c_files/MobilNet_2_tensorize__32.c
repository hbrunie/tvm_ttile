...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (14, y); T (2, f); T (4, c); T (1, f); T (16, c); T (56, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c180_p_0, c181_p_0, cp_1, c180_p_1, cp_2, c180, c181, f, fp_0, f152_p_0, f153_p_0, fp_1, f152_p_1, fp_2, f152, f153, w, wp_0, x, xp_0, x184_p_0, xp_1, x184, y, yp_0;
IND_TYPE y104 = 0;
IND_TYPE x185 = 0;
IND_TYPE h = 0;
IND_TYPE w104 = 0;
...
yp_0 = 0;
							for (w = w104, wp_0 = 0;w < w104 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x184, xp_1 = x184_p_0, xp_0 = 0;x < x184 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 3, w = 1, c = 1, f = 32
											// T (c, 1) (1 / 1)
											for (c = c180, cp_2 = c180_p_1, cp_1 = c180_p_0, cp_0 = 0;c < c180 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
