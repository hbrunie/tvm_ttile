							...
							for (h = h250, hp_0 = 0;h < h250 + 3;h += 1, hp_0 += 1){
								...
								for (w = w264, wp_0 = 0;w < w264 + 3;w += 1, wp_0 += 1){
									...
									for (x = x486, xp_1 = x486_p_0, xp_0 = 0;x < x486 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4792 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_4793 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_4794 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_4795 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_4792);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_4793);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4794);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4795);
									}
								}
							}
}
