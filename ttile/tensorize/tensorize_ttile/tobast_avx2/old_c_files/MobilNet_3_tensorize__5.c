...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (1, f); T (7, x); T (14, y); T (2, f); T (8, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c166_p_0, cp_1, c166, f, fp_0, f148_p_0, f149_p_0, fp_1, f148_p_1, fp_2, f148, f149, w, wp_0, x, xp_0, x192_p_0, x193_p_0, xp_1, x192_p_1, xp_2, x192, x193, y, yp_0;
IND_TYPE y96 = 0;
IND_TYPE x194 = 0;
IND_TYPE h = 0;
IND_TYPE w96 = 0;
...
fp_2 = 0;
							for (w = w96, wp_0 = 0;w < w96 + 3;w += 1, wp_0 += 1){
								...
								for (x = x192, xp_2 = x192_p_1, xp_1 = x192_p_0, xp_0 = 0;x < x192 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 16) (16 / 1)
											for (c = c166, cp_1 = c166_p_0, cp_0 = 0;c < c166 + 16;c += 1, cp_1 += 1, cp_0 += 1){
