...
[V f; U (4, f); U (4, y); U (3, h); T (64, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (14, y); T (1, f); T (1, c); T (1, f); T (1, c); T (7, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c104_p_0, c105_p_0, cp_1, c104_p_1, cp_2, c104, c105, f, fp_0, f80_p_0, f81_p_0, fp_1, f80_p_1, fp_2, f80, f81, w, wp_0, x, xp_0, x120_p_0, xp_1, x120, y, yp_0;
IND_TYPE y64 = 0;
IND_TYPE x121 = 0;
IND_TYPE h = 0;
IND_TYPE w64 = 0;
...
yp_0 = 0;
							for (w = w64, wp_0 = 0;w < w64 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 8) (8 / 1)
								for (x = x120, xp_1 = x120_p_0, xp_0 = 0;x < x120 + 8;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 64) (64 / 1)
											for (c = c104, cp_2 = c104_p_1, cp_1 = c104_p_0, cp_0 = 0;c < c104 + 64;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
