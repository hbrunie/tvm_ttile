...
/*
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (14, y); T (1, f); T (64, c); T (2, f); T (1, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c108_p_0, c109_p_0, cp_1, c108_p_1, cp_2, c108, c109, f, fp_0, f80_p_0, f81_p_0, fp_1, f80_p_1, fp_2, f80, f81, w, wp_0, x, xp_0, x130_p_0, xp_1, x130, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x131 = 0;
IND_TYPE h = 0;
IND_TYPE w68 = 0;
...
yp_0 = 0;
							for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
								...
								for (x = x130, xp_1 = x130_p_0, xp_0 = 0;x < x130 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 1) (1 / 1)
											for (c = c108, cp_2 = c108_p_1, cp_1 = c108_p_0, cp_0 = 0;c < c108 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
