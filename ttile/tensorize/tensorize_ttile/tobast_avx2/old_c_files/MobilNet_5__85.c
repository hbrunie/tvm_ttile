...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (2, f); T (64, c); T (7, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c216_p_0, cp_1, c216, f, fp_0, f288_p_0, f289_p_0, fp_1, f288_p_1, fp_2, f288, f289, w, wp_0, x, xp_0, x288_p_0, x289_p_0, xp_1, x288_p_1, xp_2, x288, x289, y, yp_0;
