...
fp_2 = 0;
							for (w = w340, wp_0 = 0;w < w340 + 3;w += 1, wp_0 += 1){
								...
								for (x = x510, xp_1 = x510_p_0, xp_0 = 0;x < x510 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6134 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
											mem_vec_6135 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_6134);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24], mem_vec_6135);
								}
							}
}
