...
/*
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (16, x);
  T (3, w); T (1, x); T (28, y); T (8, c); T (7, x)]
*/
IND_TYPE c, cp_0, c156_p_0, cp_1, c156, w, wp_0, x, xp_0, x178_p_0, x179_p_0, xp_1, x178_p_1, xp_2, x178, x179, y, yp_0;
IND_TYPE y104 = 0;
IND_TYPE x180 = 0;
IND_TYPE h = 0;
IND_TYPE w104 = 0;
...
x178_p_1 = 0;
				for (w = w104, wp_0 = 0;w < w104 + 3;w += 1, wp_0 += 1){
					// y = 4, x = 16, h = 3, w = 1, c = 4, f = 32
					// T (x, 16) (16 / 1)
					for (x = x178, xp_2 = x178_p_1, xp_1 = x178_p_0, xp_0 = 0;x < x178 + 16;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
