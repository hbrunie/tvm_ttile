...
fp_2 = 0;
								for (w = w482, wp_0 = 0;w < w482 + 3;w += 1, wp_0 += 1){
									...
									// T (x, 14) (14 / 1)
									for (x = x1174, xp_2 = x1174_p_1, xp_1 = x1174_p_0, xp_0 = 0;x < x1174 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_7700 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
												mem_vec_7701 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8]);
												mem_vec_7702 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
												mem_vec_7703 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 2, f = 32
												// T (c, 2) (2 / 1)
												for (c = c1006, cp_1 = c1006_p_0, cp_0 = 0;c < c1006 + 2;c += 1, cp_1 += 1, cp_0 += 1){
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_7700);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8], mem_vec_7701);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_7702);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24], mem_vec_7703);
									}
								}
}
