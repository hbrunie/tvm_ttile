			...
			for (y456 = y457, y456_p_0 = 0;
				...
				for (x608 = x609, x608_p_1 = x609_p_0, x608_p_0 = 0;
					...
					for (c456 = c457, c456_p_0 = 0;
						c456 < c457 + 32;
						c456 += 4, c456_p_0 += 4){
						// y = 16 * ph_y, x = 1, h = 3, w = 3, c = 4, f = 64
						// T (f, 2) (64 / 32)
						for (f = f422, fp_1 = f422_p_0, fp_0 = 0;
							f < f422 + 64;
							f += 32, fp_1 += 32, fp_0 += 32){
							// y = 16 * ph_y, x = 1, h = 3, w = 3, c = 4, f = 32
							// T (y, 16) (16 * ph_y / ph_y)
									...
									for (w = w254, wp_0 = 0;
										...
										for (x = x608, xp_2 = x608_p_1, xp_1 = x608_p_0, xp_0 = 0;
											...
											x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
													...
													mem_vec_2856 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
													mem_vec_2857 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8]);
													mem_vec_2858 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
													mem_vec_2859 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24]);
													// y = ph_y, x = 1, h = 1, w = 1, c = 4, f = 32
													// T (c, 4) (4 / 1)
													for (c = c456, cp_1 = c456_p_0, cp_0 = 0;
														c < c456 + 4;
												...
												_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_2856);
												_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8], mem_vec_2857);
												_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_2858);
												_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24], mem_vec_2859);
										}
									}
								}
							}
