								...
								for (x = x810, xp_1 = x810_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c810, cp_1 = c810_p_0, cp_0 = 0;
												...
												vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_9000);
												mem_vec_9000 = vec_24;

												vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_9001);
												mem_vec_9001 = vec_27;

												vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_9002);
												mem_vec_9002 = vec_29;

												vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

												vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_9003);
												mem_vec_9003 = vec_31;
												scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
												vec_34 = _mm256_set1_ps(scal_5);


												vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_9004);
												mem_vec_9004 = vec_33;



												vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_9005);
												mem_vec_9005 = vec_35;



												vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_9006);
												mem_vec_9006 = vec_36;



												vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_9007);
												mem_vec_9007 = vec_37;
												scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
												vec_39 = _mm256_set1_ps(scal_6);


												vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_9008);
												mem_vec_9008 = vec_38;



												vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_9009);
												mem_vec_9009 = vec_40;



												vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_9010);
												mem_vec_9010 = vec_41;



												vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_9011);
												mem_vec_9011 = vec_42;
												scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
												vec_44 = _mm256_set1_ps(scal_7);


												vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_9012);
												mem_vec_9012 = vec_43;



												vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_9013);
												mem_vec_9013 = vec_45;



												vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_9014);
												mem_vec_9014 = vec_46;



												vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_9015);
												mem_vec_9015 = vec_47;
												scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
												vec_49 = _mm256_set1_ps(scal_8);
												vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_9000);
												mem_vec_9000 = vec_48;

												vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_9001);
												mem_vec_9001 = vec_51;

												vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_9002);
												mem_vec_9002 = vec_53;

												vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

												vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_9003);
												mem_vec_9003 = vec_55;
												scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
												vec_58 = _mm256_set1_ps(scal_9);


												vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_9004);
												mem_vec_9004 = vec_57;



												vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_9005);
												mem_vec_9005 = vec_59;



												vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_9006);
												mem_vec_9006 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_9007);
												mem_vec_9007 = vec_61;
												scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
												vec_63 = _mm256_set1_ps(scal_10);


												vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_9008);
												mem_vec_9008 = vec_62;



												vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_9009);
												mem_vec_9009 = vec_64;



												vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_9010);
												mem_vec_9010 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_9011);
												mem_vec_9011 = vec_66;
												scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
												vec_68 = _mm256_set1_ps(scal_11);


												vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_9012);
												mem_vec_9012 = vec_67;



												vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_9013);
												mem_vec_9013 = vec_69;



												vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_9014);
												mem_vec_9014 = vec_70;



												vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_9015);
												mem_vec_9015 = vec_71;
											}
							...
							for (w = w476, wp_0 = 0;
								...
								for (x = x810, xp_1 = x810_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_9036 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_9037 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
											mem_vec_9038 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_9039 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 64, f = 32
											// T (c, 64) (64 / 1)
											for (c = c810, cp_1 = c810_p_0, cp_0 = 0;
												c < c810 + 64;
												...
												vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_9036);
												mem_vec_9036 = vec_29;



												vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_9037);
												mem_vec_9037 = vec_31;



												vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_9038);
												mem_vec_9038 = vec_32;



												vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_9039);
												mem_vec_9039 = vec_33;
												scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 1) + c];
												vec_35 = _mm256_set1_ps(scal_6);
												vec_36 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

												vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_9016);
												mem_vec_9016 = vec_34;

												vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

												vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_9017);
												mem_vec_9017 = vec_37;

												vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_9018);
												mem_vec_9018 = vec_39;

												vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

												vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_9019);
												mem_vec_9019 = vec_41;
												scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
												vec_44 = _mm256_set1_ps(scal_7);


												vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_9020);
												mem_vec_9020 = vec_43;



												vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_9021);
												mem_vec_9021 = vec_45;



												vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_9022);
												mem_vec_9022 = vec_46;



												vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_9023);
												mem_vec_9023 = vec_47;
												scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
												vec_49 = _mm256_set1_ps(scal_8);


												vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_9024);
												mem_vec_9024 = vec_48;



												vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_9025);
												mem_vec_9025 = vec_50;



												vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_9026);
												mem_vec_9026 = vec_51;



												vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_9027);
												mem_vec_9027 = vec_52;
												scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
												vec_54 = _mm256_set1_ps(scal_9);


												vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_9028);
												mem_vec_9028 = vec_53;



												vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_9029);
												mem_vec_9029 = vec_55;



												vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_9030);
												mem_vec_9030 = vec_56;



												vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_9031);
												mem_vec_9031 = vec_57;
												scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
												vec_59 = _mm256_set1_ps(scal_10);


												vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_9032);
												mem_vec_9032 = vec_58;



												vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_9033);
												mem_vec_9033 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_9034);
												mem_vec_9034 = vec_61;



												vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_9035);
												mem_vec_9035 = vec_62;
												scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 1) + c];
												vec_64 = _mm256_set1_ps(scal_11);


												vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_9036);
												mem_vec_9036 = vec_63;



												vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_9037);
												mem_vec_9037 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_9038);
												mem_vec_9038 = vec_66;



												vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_9039);
												mem_vec_9039 = vec_67;
												scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
												vec_69 = _mm256_set1_ps(scal_12);
												vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_9016);
												mem_vec_9016 = vec_68;

												vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

												vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_9017);
												mem_vec_9017 = vec_71;

												vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_9018);
												mem_vec_9018 = vec_73;

												vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

												vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_9019);
												mem_vec_9019 = vec_75;
												scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
												vec_78 = _mm256_set1_ps(scal_13);


												vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_9020);
												mem_vec_9020 = vec_77;



												vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_9021);
												mem_vec_9021 = vec_79;



												vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_9022);
												mem_vec_9022 = vec_80;



												vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_9023);
												mem_vec_9023 = vec_81;
												scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
												vec_83 = _mm256_set1_ps(scal_14);


												vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_9024);
												mem_vec_9024 = vec_82;



												vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_9025);
												mem_vec_9025 = vec_84;



												vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_9026);
												mem_vec_9026 = vec_85;



												vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_9027);
												mem_vec_9027 = vec_86;
												scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
												vec_88 = _mm256_set1_ps(scal_15);


												vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_9028);
												mem_vec_9028 = vec_87;



												vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_9029);
												mem_vec_9029 = vec_89;



												vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_9030);
												mem_vec_9030 = vec_90;



												vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_9031);
												mem_vec_9031 = vec_91;
												scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
												vec_93 = _mm256_set1_ps(scal_16);


												vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_9032);
												mem_vec_9032 = vec_92;



												vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_9033);
												mem_vec_9033 = vec_94;



												vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_9034);
												mem_vec_9034 = vec_95;



												vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_9035);
												mem_vec_9035 = vec_96;
												scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 2) + c];
												vec_98 = _mm256_set1_ps(scal_17);


												vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_9036);
												mem_vec_9036 = vec_97;



												vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_9037);
												mem_vec_9037 = vec_99;



												vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_9038);
												mem_vec_9038 = vec_100;



												vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_9039);
												mem_vec_9039 = vec_101;
											}
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_9036);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_9037);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_9038);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_9039);
								}
							}
						}
					}
