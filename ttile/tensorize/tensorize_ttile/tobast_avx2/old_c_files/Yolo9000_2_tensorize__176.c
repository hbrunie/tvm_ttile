...
/*
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (136, x); T (3, w);
  T (3, h); T (2, y); T (2, f); T (16, c); T (1, x); T (34, y); T (1, f);
  T (2, x)]
*/
IND_TYPE c, cp_0, c24_p_0, cp_1, c24, f, fp_0, f24_p_0, fp_1, f24, h, hp_0, w, wp_0, x, xp_0, x32_p_0, x33_p_0, xp_1, x32_p_1, xp_2, x32, x33, y, yp_0, y24_p_0, yp_1, y24;
IND_TYPE y25 = 0;
IND_TYPE x34 = 0;
IND_TYPE h16 = 0;
IND_TYPE w16 = 0;
...
yp_1 = 0;
							for (h = h16, hp_0 = 0;h < h16 + 3;h += 1, hp_0 += 1){
								// y = 4, x = 136, h = 1, w = 3, c = 2, f = 32
								// T (w, 3) (3 / 1)
								for (w = w16, wp_0 = 0;w < w16 + 3;w += 1, wp_0 += 1){
									// y = 4, x = 136, h = 1, w = 1, c = 2, f = 32
									// T (x, 136) (136 / 1)
									for (x = x32, xp_2 = x32_p_1, xp_1 = x32_p_0, xp_0 = 0;x < x32 + 136;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
