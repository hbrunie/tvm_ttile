...
c598_p_1 = 0;
							for (w = w306, wp_0 = 0;w < w306 + 3;w += 1, wp_0 += 1){
								...
								for (x = x720, xp_2 = x720_p_1, xp_1 = x720_p_0, xp_0 = 0;x < x720 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4466 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_4467 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_4466);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_4467);
								}
							}
}
