...
c510_p_2 = 0;
								for (w = w204, wp_0 = 0;w < w204 + 3;w += 1, wp_0 += 1){
									...
									for (x = x408, xp_2 = x408_p_1, xp_1 = x408_p_0, xp_0 = 0;x < x408 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3932 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
												mem_vec_3933 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
												mem_vec_3934 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
												mem_vec_3935 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
												mem_vec_3936 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
												mem_vec_3937 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8]);
												mem_vec_3938 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
												mem_vec_3939 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8]);
												mem_vec_3940 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
												mem_vec_3941 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8]);
												// y = ph_y, x = 1, h = 3, w = 1, c = 1, f = 16
												// T (c, 1) (1 / 1)
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3932);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_3933);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3934);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_3935);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_3936);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8], mem_vec_3937);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_3938);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8], mem_vec_3939);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3940);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8], mem_vec_3941);
									}
								}
}
