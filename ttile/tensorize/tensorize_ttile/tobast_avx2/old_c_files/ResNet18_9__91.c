...
[V f; U (4, f); U (7, y); U (3, h); T (256, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (7, x); T (2, y); T (2, f); T (1, c); T (4, f)]
*/
IND_TYPE c, cp_0, c102_p_0, cp_1, c102, f, fp_0, f136_p_0, f137_p_0, fp_1, f136_p_1, fp_2, f136, f137, w, wp_0, x, xp_0, x102_p_0, xp_1, x102, y, yp_0;
