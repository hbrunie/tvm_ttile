...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (2, x); T (28, y); T (32, c); T (4, x)]
*/
IND_TYPE c, cp_0, c138_p_0, cp_1, c138, w, wp_0, x, xp_0, x154_p_0, x155_p_0, xp_1, x154_p_1, xp_2, x154, x155, y, yp_0;
	...
	for (c138 = c139, c138_p_0 = 0;
		...
		for (y = y92, yp_0 = 0;
			...
			for (x154 = x155, x154_p_1 = x155_p_0, x154_p_0 = 0;
				x154 < x155 + 28;
				x154 += 14, x154_p_1 += 14, x154_p_0 += 14){
