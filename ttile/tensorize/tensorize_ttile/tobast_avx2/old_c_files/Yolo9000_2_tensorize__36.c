...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (8, x);
  T (3, w); T (17, y); T (1, f); T (2, c); T (17, x); T (4, y); T (2, f);
  T (2, x)]
*/
IND_TYPE c, cp_0, c192_p_0, cp_1, c192, f, fp_0, f182_p_0, fp_1, f182, w, wp_0, x, xp_0, x256_p_0, x257_p_0, xp_1, x256_p_1, xp_2, x256, x257, y, yp_0, y192_p_0, yp_1, y192;
IND_TYPE y193 = 0;
IND_TYPE x258 = 0;
IND_TYPE h = 0;
IND_TYPE w128 = 0;
