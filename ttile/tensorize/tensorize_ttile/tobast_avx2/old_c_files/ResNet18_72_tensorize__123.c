							...
							for (h = h234, hp_0 = 0;h < h234 + 3;h += 1, hp_0 += 1){
								...
								for (w = w216, wp_0 = 0;w < w216 + 3;w += 1, wp_0 += 1){
									...
									for (x = x420, xp_1 = x420_p_0, xp_0 = 0;x < x420 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4192 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_4193 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_4194 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_4195 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_4192);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_4193);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4194);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4195);
									}
								}
							}
}
