...
for (c928 = c929, c928_p_0 = 0;
	...
	for (x1132 = x1133, x1132_p_0 = 0;
		...
		for (f = f1104, fp_0 = 0;
			...
			// T (c, 64) (128 / 2)
			for (c927 = c928, c927_p_1 = c928_p_0, c927_p_0 = 0;
				c927 < c928 + 128;
				c927 += 2, c927_p_1 += 2, c927_p_0 += 2){
					for (y = y580, yp_0 = 0;
						y < y580 + 24;
						y += 8, yp_0 += 8){
						// y = ph_y, x = 1, h = 3, w = 3, c = 2, f = 16
						// T (c, 1) (2 / 2)
						for (c926 = c927, c926_p_2 = c927_p_1, c926_p_1 = c927_p_0, c926_p_0 = 0;
							c926 < c927 + 2;
							c926 += 2, c926_p_2 += 2, c926_p_1 += 2, c926_p_0 += 2){
							// y = ph_y, x = 1, h = 3, w = 3, c = 2, f = 16
							// T (w, 3) (3 / 1)
							for (w = w460, wp_0 = 0;
								w < w460 + 3;
								...
								for (x = x1132, xp_1 = x1132_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = ph_y, x = 1, h = 3, w = 1, c = 2, f = 16
											// T (c, 2) (2 / 1)
											for (c = c926, cp_3 = c926_p_2, cp_2 = c926_p_1, cp_1 = c926_p_0, cp_0 = 0;
												c < c926 + 2;
							...
							for (w = w460, wp_0 = 0;
								...
								for (x = x1132, xp_1 = x1132_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6092 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_6093 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 8]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 2, f = 16
											// T (c, 2) (2 / 1)
											for (c = c926, cp_3 = c926_p_2, cp_2 = c926_p_1, cp_1 = c926_p_0, cp_0 = 0;
												c < c926 + 2;
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_6092);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 8], mem_vec_6093);
								}
							}
						}
					}
