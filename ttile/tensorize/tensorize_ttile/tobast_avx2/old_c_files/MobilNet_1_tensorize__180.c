...
/*
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (16, x);
  T (3, w); T (7, x); T (28, y); T (4, c); T (1, x)]
*/
IND_TYPE c, cp_0, c102_p_0, cp_1, c102, w, wp_0, x, xp_0, x106_p_0, x107_p_0, xp_1, x106_p_1, xp_2, x106, x107, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x108 = 0;
IND_TYPE h = 0;
IND_TYPE w68 = 0;
...
x106_p_1 = 0;
				for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
					// y = 4, x = 16, h = 3, w = 1, c = 8, f = 32
					// T (x, 16) (16 / 1)
					for (x = x106, xp_2 = x106_p_1, xp_1 = x106_p_0, xp_0 = 0;x < x106 + 16;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
