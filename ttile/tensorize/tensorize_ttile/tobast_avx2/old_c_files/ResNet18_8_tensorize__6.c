...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (1, c); T (1, x); T (7, y); T (8, f); T (2, c); T (7, x)]
*/
IND_TYPE c, cp_0, c64_p_0, c65_p_0, cp_1, c64_p_1, cp_2, c64, c65, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x64_p_0, x65_p_0, xp_1, x64_p_1, xp_2, x64, x65, y, yp_0;
IND_TYPE y32 = 0;
IND_TYPE x66 = 0;
IND_TYPE h32 = 0;
IND_TYPE w32 = 0;
