...
/*
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (56, x); T (3, w);
  T (3, h); T (28, y); T (4, c); T (2, x)]
*/
IND_TYPE c, cp_0, c6_p_0, cp_1, c6, h, hp_0, w, wp_0, x, xp_0, x6_p_0, xp_1, x6, y, yp_0;
IND_TYPE y4 = 0;
IND_TYPE x7 = 0;
IND_TYPE h4 = 0;
IND_TYPE w4 = 0;
...
yp_0 = 0;
			for (h = h4, hp_0 = 0;h < h4 + 3;h += 1, hp_0 += 1){
				...
				for (w = w4, wp_0 = 0;w < w4 + 3;w += 1, wp_0 += 1){
					// y = 4, x = 56, h = 1, w = 1, c = 8, f = 32
					// T (x, 56) (56 / 1)
					for (x = x6, xp_1 = x6_p_0, xp_0 = 0;x < x6 + 56;x += 1, xp_1 += 1, xp_0 += 1){
