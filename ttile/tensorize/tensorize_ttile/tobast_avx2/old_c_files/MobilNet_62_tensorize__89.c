							...
							for (h = h184, hp_0 = 0;h < h184 + 3;h += 1, hp_0 += 1){
								...
								for (w = w176, wp_0 = 0;w < w176 + 3;w += 1, wp_0 += 1){
									...
									for (x = x360, xp_1 = x360_p_0, xp_0 = 0;x < x360 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3392 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_3393 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_3394 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_3395 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3392);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_3393);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3394);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3395);
									}
								}
							}
}
