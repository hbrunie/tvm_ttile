...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (56, x); T (28, y); T (2, c); T (2, x)]
*/
IND_TYPE c, cp_0, c132_p_0, cp_1, c132, w, wp_0, x, xp_0, x146_p_0, x147_p_0, xp_1, x146_p_1, xp_2, x146, x147, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x148 = 0;
IND_TYPE h = 0;
IND_TYPE w88 = 0;
...
x146_p_1 = 0;
				for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x146, xp_2 = x146_p_1, xp_1 = x146_p_0, xp_0 = 0;x < x146 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
