...
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (1, f); T (1, x); T (7, y); T (28, x); T (4, f); T (16, c);
  T (1, x)]
*/
IND_TYPE c, cp_0, c48_p_0, cp_1, c48, f, fp_0, f48_p_0, fp_1, f48, h, hp_0, w, wp_0, x, xp_0, x80_p_0, x81_p_0, x82_p_0, xp_1, x80_p_1, x81_p_1, xp_2, x80_p_2, xp_3, x80, x81, x82, y, yp_0;
IND_TYPE y32 = 0;
IND_TYPE x83 = 0;
IND_TYPE h32 = 0;
IND_TYPE w32 = 0;
