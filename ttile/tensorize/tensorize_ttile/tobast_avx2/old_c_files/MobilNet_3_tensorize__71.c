...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (1, f); T (4, x); T (14, y); T (1, f); T (4, c); T (2, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c316_p_0, cp_1, c316, f, fp_0, f348_p_0, f349_p_0, fp_1, f348_p_1, fp_2, f348, f349, h, hp_0, x, xp_0, x392_p_0, x393_p_0, xp_1, x392_p_1, xp_2, x392, x393, y, yp_0;
IND_TYPE y196 = 0;
IND_TYPE x394 = 0;
IND_TYPE h122 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h122, hp_0 = 0;h < h122 + 3;h += 1, hp_0 += 1){
								...
								for (x = x392, xp_2 = x392_p_1, xp_1 = x392_p_0, xp_0 = 0;x < x392 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 32) (32 / 1)
											for (c = c316, cp_1 = c316_p_0, cp_0 = 0;c < c316 + 32;c += 1, cp_1 += 1, cp_0 += 1){
