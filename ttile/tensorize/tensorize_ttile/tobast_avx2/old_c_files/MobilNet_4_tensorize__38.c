...
[V f; U (4, f); U (4, y); U (3, h); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, f); T (7, x); T (7, y); T (2, f); T (4, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c198_p_0, cp_1, c198, f, fp_0, f228_p_0, f229_p_0, fp_1, f228_p_1, fp_2, f228, f229, w, wp_0, x, xp_0, x300_p_0, x301_p_0, xp_1, x300_p_1, xp_2, x300, x301, y, yp_0;
IND_TYPE y132 = 0;
IND_TYPE x302 = 0;
IND_TYPE h = 0;
IND_TYPE w132 = 0;
...
fp_2 = 0;
							for (w = w132, wp_0 = 0;w < w132 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x300, xp_2 = x300_p_1, xp_1 = x300_p_0, xp_0 = 0;x < x300 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
