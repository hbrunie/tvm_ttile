...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (34, y); T (1, f); T (4, c); T (1, x); T (2, y); T (2, f);
  T (136, x)]
*/
IND_TYPE c, cp_0, c258_p_0, cp_1, c258, f, fp_0, f248_p_0, fp_1, f248, w, wp_0, x, xp_0, x344_p_0, x345_p_0, xp_1, x344_p_1, xp_2, x344, x345, y, yp_0, y258_p_0, yp_1, y258;
IND_TYPE y259 = 0;
IND_TYPE x346 = 0;
IND_TYPE h = 0;
IND_TYPE w172 = 0;
