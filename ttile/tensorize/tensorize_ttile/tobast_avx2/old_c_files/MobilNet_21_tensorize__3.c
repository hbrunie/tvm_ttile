...
c634_p_0 = 0;
						for (w = w262, wp_0 = 0;w < w262 + 3;w += 1, wp_0 += 1){
							...
							for (x = x556, xp_2 = x556_p_1, xp_1 = x556_p_0, xp_0 = 0;x < x556 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3920 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
										mem_vec_3921 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
									...
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3920);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_3921);
							}
						}
}
