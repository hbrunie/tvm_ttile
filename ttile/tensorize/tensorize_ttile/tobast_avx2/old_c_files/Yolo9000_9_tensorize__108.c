...
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (4, x); T (17, y);
  T (1, f); T (2, f); T (16, c); T (17, x); T (2, f)]
*/
IND_TYPE c, cp_0, c684_p_0, cp_1, c684, f, fp_0, f912_p_0, f913_p_0, fp_1, f912_p_1, fp_2, f912, f913, x, xp_0, x684_p_0, xp_1, x684, y, yp_0;
IND_TYPE y456 = 0;
IND_TYPE x685 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
