							...
							for (h = h254, hp_0 = 0;h < h254 + 3;h += 1, hp_0 += 1){
								...
								for (w = w236, wp_0 = 0;w < w236 + 3;w += 1, wp_0 += 1){
									...
									for (x = x450, xp_1 = x450_p_0, xp_0 = 0;x < x450 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4552 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_4553 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
												mem_vec_4554 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
												mem_vec_4555 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
											...
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_4552);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_4553);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_4554);
											_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_4555);
									}
								}
							}
}
