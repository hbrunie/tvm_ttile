...
[V f; U (2, f); U (8, y); U (3, h); T (2, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (14, y); T (2, f); T (16, c); T (112, x)]
*/
IND_TYPE c, cp_0, c84_p_0, cp_1, c84, f, fp_0, w, wp_0, x, xp_0, x84_p_0, xp_1, x84, y, yp_0;
IND_TYPE y56 = 0;
IND_TYPE x85 = 0;
IND_TYPE h = 0;
IND_TYPE w56 = 0;
...
yp_0 = 0;
				for (w = w56, wp_0 = 0;w < w56 + 3;w += 1, wp_0 += 1){
					...
					for (x = x84, xp_1 = x84_p_0, xp_0 = 0;x < x84 + 1;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_450 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_451 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8]);
								...
								mem_vec_454 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								mem_vec_455 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8]);
								...
								mem_vec_458 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
								mem_vec_459 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8]);
								mem_vec_460 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
								mem_vec_461 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8]);
								mem_vec_462 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
								mem_vec_463 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 8]);
								// y = 8, x = 1, h = 3, w = 1, c = 2, f = 16
								// T (c, 2) (2 / 1)
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_450);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8], mem_vec_451);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_454);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8], mem_vec_455);
							...
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_458);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 8], mem_vec_459);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_460);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8], mem_vec_461);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_462);
							_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 8], mem_vec_463);
					}
				}
}
