...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (14, y); T (1, f); T (2, c); T (1, f); T (4, c); T (56, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c172_p_0, c173_p_0, cp_1, c172_p_1, cp_2, c172, c173, f, fp_0, f144_p_0, f145_p_0, fp_1, f144_p_1, fp_2, f144, f145, w, wp_0, x, xp_0, x178_p_0, xp_1, x178, y, yp_0;
IND_TYPE y100 = 0;
IND_TYPE x179 = 0;
IND_TYPE h = 0;
IND_TYPE w100 = 0;
