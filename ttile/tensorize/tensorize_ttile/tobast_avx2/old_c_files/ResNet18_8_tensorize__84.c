...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (8, f); T (2, x); T (7, y); T (1, f); T (16, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c520_p_0, cp_1, c520, f, fp_0, f600_p_0, f601_p_0, fp_1, f600_p_1, fp_2, f600, f601, h, hp_0, x, xp_0, x656_p_0, x657_p_0, xp_1, x656_p_1, xp_2, x656, x657, y, yp_0;
IND_TYPE y328 = 0;
IND_TYPE x658 = 0;
IND_TYPE h240 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h240, hp_0 = 0;h < h240 + 3;h += 1, hp_0 += 1){
								...
								for (x = x656, xp_2 = x656_p_1, xp_1 = x656_p_0, xp_0 = 0;x < x656 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = 4, x = 1, h = 1, w = 3, c = 8, f = 32
											// T (c, 8) (8 / 1)
											for (c = c520, cp_1 = c520_p_0, cp_0 = 0;c < c520 + 8;c += 1, cp_1 += 1, cp_0 += 1){
