...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (1, f); T (1, x); T (7, y); T (1, f); T (64, c); T (2, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c210_p_0, cp_1, c210, f, fp_0, f234_p_0, f235_p_0, fp_1, f234_p_1, fp_2, f234, f235, w, wp_0, x, xp_0, x326_p_0, x327_p_0, xp_1, x326_p_1, xp_2, x326, x327, y, yp_0;
IND_TYPE y140 = 0;
IND_TYPE x328 = 0;
IND_TYPE h = 0;
IND_TYPE w140 = 0;
...
fp_2 = 0;
							for (w = w140, wp_0 = 0;w < w140 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x326, xp_2 = x326_p_1, xp_1 = x326_p_0, xp_0 = 0;x < x326 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
