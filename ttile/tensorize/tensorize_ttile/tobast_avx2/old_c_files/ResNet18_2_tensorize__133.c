...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (14, y); T (2, f); T (32, c); T (1, f); T (1, c); T (4, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c88_p_0, c89_p_0, cp_1, c88_p_1, cp_2, c88, c89, f, fp_0, f64_p_0, f65_p_0, fp_1, f64_p_1, fp_2, f64, f65, w, wp_0, x, xp_0, x108_p_0, xp_1, x108, y, yp_0;
IND_TYPE y56 = 0;
IND_TYPE x109 = 0;
IND_TYPE h = 0;
IND_TYPE w56 = 0;
...
yp_0 = 0;
							for (w = w56, wp_0 = 0;w < w56 + 3;w += 1, wp_0 += 1){
								...
								for (x = x108, xp_1 = x108_p_0, xp_0 = 0;x < x108 + 14;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 2) (2 / 1)
											for (c = c88, cp_2 = c88_p_1, cp_1 = c88_p_0, cp_0 = 0;c < c88 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
