...
[V f; U (4, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (14, y); T (2, f); T (4, c); T (1, f); T (8, c); T (2, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c348_p_0, c349_p_0, cp_1, c348_p_1, cp_2, c348, c349, f, fp_0, f320_p_0, f321_p_0, fp_1, f320_p_1, fp_2, f320, f321, h, hp_0, x, xp_0, x310_p_0, xp_1, x310, y, yp_0;
IND_TYPE y188 = 0;
IND_TYPE x311 = 0;
IND_TYPE h118 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
							for (h = h118, hp_0 = 0;h < h118 + 3;h += 1, hp_0 += 1){
								...
								for (x = x310, xp_1 = x310_p_0, xp_0 = 0;x < x310 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 2) (2 / 1)
											for (c = c348, cp_2 = c348_p_1, cp_1 = c348_p_0, cp_0 = 0;c < c348 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
