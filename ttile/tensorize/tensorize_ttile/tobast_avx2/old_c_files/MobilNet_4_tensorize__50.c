...
/*
[V f; U (4, f); U (4, y); U (3, h); T (128, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (4, f); T (1, x); T (7, y); T (1, f); T (1, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c108_p_0, cp_1, c108, f, fp_0, f108_p_0, f109_p_0, fp_1, f108_p_1, fp_2, f108, f109, w, wp_0, x, xp_0, x180_p_0, x181_p_0, xp_1, x180_p_1, xp_2, x180, x181, y, yp_0;
IND_TYPE y72 = 0;
IND_TYPE x182 = 0;
IND_TYPE h = 0;
IND_TYPE w72 = 0;
...
fp_2 = 0;
							for (w = w72, wp_0 = 0;w < w72 + 3;w += 1, wp_0 += 1){
								// y = 4, x = 28, h = 3, w = 1, c = 128, f = 32
								// T (x, 28) (28 / 1)
								for (x = x180, xp_2 = x180_p_1, xp_1 = x180_p_0, xp_0 = 0;x < x180 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
