...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, f); T (4, x); T (7, y); T (4, f); T (8, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c168_p_0, cp_1, c168, f, fp_0, f178_p_0, f179_p_0, fp_1, f178_p_1, fp_2, f178, f179, w, wp_0, x, xp_0, x270_p_0, x271_p_0, xp_1, x270_p_1, xp_2, x270, x271, y, yp_0;
