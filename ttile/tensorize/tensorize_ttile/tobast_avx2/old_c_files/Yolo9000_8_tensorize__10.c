...
[V f; U (4, f); U (4, y); T (1, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (2, f); T (1, x); T (17, y); T (2, f); T (128, c); T (68, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c216_p_0, cp_1, c216, f, fp_0, f288_p_0, f289_p_0, fp_1, f288_p_1, fp_2, f288, f289, h, hp_0, w, wp_0, x, xp_0, x288_p_0, x289_p_0, xp_1, x288_p_1, xp_2, x288, x289, y, yp_0;
IND_TYPE y144 = 0;
IND_TYPE x290 = 0;
IND_TYPE h144 = 0;
IND_TYPE w144 = 0;
