...
[V f; U (4, f); U (4, y); U (3, w); T (64, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, f); T (2, x); T (7, y); T (4, f); T (2, c); T (14, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c486_p_0, cp_1, c486, f, fp_0, f612_p_0, f613_p_0, fp_1, f612_p_1, fp_2, f612, f613, h, hp_0, x, xp_0, x684_p_0, x685_p_0, xp_1, x684_p_1, xp_2, x684, x685, y, yp_0;
IND_TYPE y324 = 0;
IND_TYPE x686 = 0;
IND_TYPE h234 = 0;
IND_TYPE w = 0;
