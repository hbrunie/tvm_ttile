...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (8, x);
  T (3, h); T (1, f); T (7, x); T (14, y); T (4, f); T (16, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c292_p_0, cp_1, c292, f, fp_0, f316_p_0, f317_p_0, fp_1, f316_p_1, fp_2, f316, f317, h, hp_0, x, xp_0, x360_p_0, x361_p_0, xp_1, x360_p_1, xp_2, x360, x361, y, yp_0;
IND_TYPE y180 = 0;
IND_TYPE x362 = 0;
IND_TYPE h106 = 0;
IND_TYPE w = 0;
...
fp_2 = 0;
							for (h = h106, hp_0 = 0;h < h106 + 3;h += 1, hp_0 += 1){
								...
								for (x = x360, xp_2 = x360_p_1, xp_1 = x360_p_0, xp_0 = 0;x < x360 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 8) (8 / 1)
											for (c = c292, cp_1 = c292_p_0, cp_0 = 0;c < c292 + 8;c += 1, cp_1 += 1, cp_0 += 1){
