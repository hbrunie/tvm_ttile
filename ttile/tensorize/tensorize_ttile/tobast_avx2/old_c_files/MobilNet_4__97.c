...
[V f; U (4, f); U (7, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, f); T (14, x); T (4, y); T (2, f); T (16, c); T (2, x);
  T (2, f)]
*/
IND_TYPE c, cp_0, c330_p_0, cp_1, c330, f, fp_0, f404_p_0, f405_p_0, fp_1, f404_p_1, fp_2, f404, f405, w, wp_0, x, xp_0, x476_p_0, x477_p_0, xp_1, x476_p_1, xp_2, x476, x477, y, yp_0;
