...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (34, x); T (17, y);
  T (2, f); T (2, f); T (4, c); T (2, x); T (1, f)]
*/
IND_TYPE c, cp_0, c216_p_0, cp_1, c216, f, fp_0, f288_p_0, f289_p_0, fp_1, f288_p_1, fp_2, f288, f289, x, xp_0, x216_p_0, xp_1, x216, y, yp_0;
IND_TYPE y144 = 0;
IND_TYPE x217 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
