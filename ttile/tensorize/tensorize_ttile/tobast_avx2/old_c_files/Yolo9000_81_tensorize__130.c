...
c1106_p_2 = 0;
							for (w = w532, wp_0 = 0;w < w532 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x1240, xp_1 = x1240_p_0, xp_0 = 0;x < x1240 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// y = ph_y, x = 1, h = 3, w = 1, c = 8, f = 16
											// T (c, 8) (8 / 1)
											for (c = c1106, cp_3 = c1106_p_2, cp_2 = c1106_p_1, cp_1 = c1106_p_0, cp_0 = 0;c < c1106 + 8;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
