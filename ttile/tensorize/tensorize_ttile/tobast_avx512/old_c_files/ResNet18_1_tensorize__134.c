...
[V f; U (2, f); U (14, y); T (3, c); Hoist_vars [c]; T (1, x); T (7, w);
  T (7, h); T (7, x); T (8, y); T (2, f); T (16, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x232_p_0, x233_p_0, xp_1, x232_p_1, xp_2, x232, x233, y, yp_0;
IND_TYPE y116 = 0;
IND_TYPE x234 = 0;
IND_TYPE h116 = 0;
IND_TYPE w116 = 0;
...
x232 = 0;
x232_p_1 = 0;
				for (h = h116, hp_0 = 0;h < h116 + 7;h += 1, hp_0 += 1){
					// y = 14, x = 1, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w116, wp_0 = 0;w < w116 + 7;w += 1, wp_0 += 1){
