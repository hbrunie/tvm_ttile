...
fp_1 = 0;
					for (h = h326, hp_0 = 0;h < h326 + 3;h += 1, hp_0 += 1){
						...
						for (x = x732, xp_0 = 0;x < x732 + 14;x += 1, xp_0 += 1){
									...
									mem_vec_5549 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_5550 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_5551 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5549);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5550);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5551);
						}
					}
}
