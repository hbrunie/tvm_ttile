...
[V f; U (4, f); U (7, y); T (2, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (512, c); T (16, f); T (1, y); T (1, c); T (1, f); T (1, c)]
*/
IND_TYPE c, cp_0, c110_p_0, c111_p_0, c112_p_0, cp_1, c110_p_1, c111_p_1, cp_2, c110_p_2, cp_3, c110, c111, c112, f, fp_0, f66_p_0, fp_1, f66, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y22 = 0;
IND_TYPE x44 = 0;
IND_TYPE h44 = 0;
IND_TYPE w44 = 0;
						...
						for (h = h44, hp_0 = 0;h < h44 + 3;h += 1, hp_0 += 1){
							...
							for (w = w44, wp_0 = 0;w < w44 + 3;w += 1, wp_0 += 1){
								...
								for (x = x44, xp_0 = 0;x < x44 + 7;x += 1, xp_0 += 1){
											...
											// T (c, 2) (2 / 1)
											for (c = c110, cp_3 = c110_p_2, cp_2 = c110_p_1, cp_1 = c110_p_0, cp_0 = 0;c < c110 + 2;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
