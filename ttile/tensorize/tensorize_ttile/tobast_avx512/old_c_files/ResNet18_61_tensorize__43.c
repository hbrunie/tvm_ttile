...
fp_1 = 0;
						for (h = h326, hp_0 = 0;h < h326 + 3;h += 1, hp_0 += 1){
							...
							for (x = x696, xp_1 = x696_p_0, xp_0 = 0;x < x696 + 28;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_5906 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_5907 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_5906);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5907);
