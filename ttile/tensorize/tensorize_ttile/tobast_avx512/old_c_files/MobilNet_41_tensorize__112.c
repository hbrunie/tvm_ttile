...
fp_1 = 0;
						for (h = h356, hp_0 = 0;h < h356 + 3;h += 1, hp_0 += 1){
							...
							for (x = x732, xp_1 = x732_p_0, xp_0 = 0;x < x732 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_5646 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_5647 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
										...
										mem_vec_5652 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_5653 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
										mem_vec_5654 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_5655 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 3, c = 4, f = 32
										// T (c, 4) (4 / 1)
										for (c = c738, cp_1 = c738_p_0, cp_0 = 0;c < c738 + 4;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_17 = _mm512_fmadd_ps(vec_18, vec_19, mem_vec_5646);
											mem_vec_5646 = vec_17;
											vec_21 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
											vec_20 = _mm512_fmadd_ps(vec_18, vec_21, mem_vec_5647);
											mem_vec_5647 = vec_20;
											scal_6 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 1) + h) + c];
											vec_23 = _mm512_set1_ps(scal_6);
											vec_22 = _mm512_fmadd_ps(vec_23, vec_19, mem_vec_5648);
											mem_vec_5648 = vec_22;
											vec_24 = _mm512_fmadd_ps(vec_23, vec_21, mem_vec_5649);
											mem_vec_5649 = vec_24;
											scal_7 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 2) + h) + c];
											vec_26 = _mm512_set1_ps(scal_7);
											vec_25 = _mm512_fmadd_ps(vec_26, vec_19, mem_vec_5650);
											mem_vec_5650 = vec_25;
											vec_27 = _mm512_fmadd_ps(vec_26, vec_21, mem_vec_5651);
											mem_vec_5651 = vec_27;
											scal_8 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 3) + h) + c];
											vec_29 = _mm512_set1_ps(scal_8);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_19, mem_vec_5652);
											mem_vec_5652 = vec_28;
											vec_30 = _mm512_fmadd_ps(vec_29, vec_21, mem_vec_5653);
											mem_vec_5653 = vec_30;
											scal_9 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 4) + h) + c];
											vec_32 = _mm512_set1_ps(scal_9);
											vec_31 = _mm512_fmadd_ps(vec_32, vec_19, mem_vec_5654);
											mem_vec_5654 = vec_31;
											vec_33 = _mm512_fmadd_ps(vec_32, vec_21, mem_vec_5655);
											mem_vec_5655 = vec_33;
											scal_10 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * y + h) + c];
											vec_35 = _mm512_set1_ps(scal_10);
											vec_36 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
											vec_34 = _mm512_fmadd_ps(vec_35, vec_36, mem_vec_5646);
											mem_vec_5646 = vec_34;
											vec_38 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
											vec_37 = _mm512_fmadd_ps(vec_35, vec_38, mem_vec_5647);
											mem_vec_5647 = vec_37;
											scal_11 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 1) + h) + c];
											vec_40 = _mm512_set1_ps(scal_11);
											vec_39 = _mm512_fmadd_ps(vec_40, vec_36, mem_vec_5648);
											mem_vec_5648 = vec_39;
											vec_41 = _mm512_fmadd_ps(vec_40, vec_38, mem_vec_5649);
											mem_vec_5649 = vec_41;
											scal_12 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 2) + h) + c];
											vec_43 = _mm512_set1_ps(scal_12);
											vec_42 = _mm512_fmadd_ps(vec_43, vec_36, mem_vec_5650);
											mem_vec_5650 = vec_42;
											vec_44 = _mm512_fmadd_ps(vec_43, vec_38, mem_vec_5651);
											mem_vec_5651 = vec_44;
											scal_13 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 3) + h) + c];
											vec_46 = _mm512_set1_ps(scal_13);
											vec_45 = _mm512_fmadd_ps(vec_46, vec_36, mem_vec_5652);
											mem_vec_5652 = vec_45;
											vec_47 = _mm512_fmadd_ps(vec_46, vec_38, mem_vec_5653);
											mem_vec_5653 = vec_47;
											scal_14 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 4) + h) + c];
											vec_49 = _mm512_set1_ps(scal_14);
											vec_48 = _mm512_fmadd_ps(vec_49, vec_36, mem_vec_5654);
											mem_vec_5654 = vec_48;
											vec_50 = _mm512_fmadd_ps(vec_49, vec_38, mem_vec_5655);
											mem_vec_5655 = vec_50;
										}
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_5646);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_5647);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5652);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_5653);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_5654);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_5655);
							}
						}
}
