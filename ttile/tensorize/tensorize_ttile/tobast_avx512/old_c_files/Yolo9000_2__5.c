...
[V f; U (2, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (4, x);
  T (3, h); T (4, x); T (68, y); T (2, f); T (16, c); T (17, x); T (1, x)]
*/
IND_TYPE c, cp_0, c354_p_0, cp_1, c354, f, fp_0, h, hp_0, x, xp_0, x598_p_0, x599_p_0, x600_p_0, xp_1, x598_p_1, x599_p_1, xp_2, x598_p_2, xp_3, x598, x599, x600, y, yp_0;
		...
		for (c354 = c355, c354_p_0 = 0;
			...
			for (f = f186, fp_0 = 0;
				...
				for (y = y256, yp_0 = 0;
					...
					// T (x, 4) (16 / 4)
					for (x598 = x599, x598_p_2 = x599_p_1, x598_p_1 = x599_p_0, x598_p_0 = 0;
						x598 < x599 + 16;
						x598 += 4, x598_p_2 += 4, x598_p_1 += 4, x598_p_0 += 4){
						...
						for (h = h160, hp_0 = 0;
							...
							// T (x, 4) (4 / 1)
							for (x = x598, xp_3 = x598_p_2, xp_2 = x598_p_1, xp_1 = x598_p_0, xp_0 = 0;
								x < x598 + 4;
								x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c354, cp_1 = c354_p_0, cp_0 = 0;
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_1488);
											mem_vec_1488 = vec_14;

											vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_1489);
											mem_vec_1489 = vec_17;
											scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_20 = _mm512_set1_ps(scal_5);


											vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_1490);
											mem_vec_1490 = vec_19;



											vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_1491);
											mem_vec_1491 = vec_21;
											scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_23 = _mm512_set1_ps(scal_6);


											vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_1492);
											mem_vec_1492 = vec_22;



											vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_1493);
											mem_vec_1493 = vec_24;
											scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_26 = _mm512_set1_ps(scal_7);


											vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_1494);
											mem_vec_1494 = vec_25;



											vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_1495);
											mem_vec_1495 = vec_27;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_29 = _mm512_set1_ps(scal_8);
											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_1488);
											mem_vec_1488 = vec_28;

											vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_1489);
											mem_vec_1489 = vec_31;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_34 = _mm512_set1_ps(scal_9);


											vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1490);
											mem_vec_1490 = vec_33;



											vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1491);
											mem_vec_1491 = vec_35;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_37 = _mm512_set1_ps(scal_10);


											vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_1492);
											mem_vec_1492 = vec_36;



											vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_1493);
											mem_vec_1493 = vec_38;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_40 = _mm512_set1_ps(scal_11);


											vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_1494);
											mem_vec_1494 = vec_39;



											vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_1495);
											mem_vec_1495 = vec_41;
										}
