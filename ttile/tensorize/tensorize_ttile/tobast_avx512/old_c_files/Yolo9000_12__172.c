							...
							for (h = h12, hp_0 = 0;
								...
								for (w = w18, wp_0 = 0;
									...
									for (x = x30, xp_1 = x30_p_0, xp_0 = 0;
										x < x30 + 34;
										x += 1, xp_1 += 1, xp_0 += 1){
												mem_vec_94 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
												mem_vec_95 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
												mem_vec_96 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
												mem_vec_97 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
												mem_vec_98 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
												mem_vec_99 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
												mem_vec_100 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
												mem_vec_101 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
												...
												mem_vec_106 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
												mem_vec_107 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
												mem_vec_108 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
												mem_vec_109 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
												mem_vec_110 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
												mem_vec_111 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 256, f = 32
												// T (c, 256) (256 / 1)
												for (c = c30, cp_1 = c30_p_0, cp_0 = 0;
													c < c30 + 256;
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_94);
											_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_95);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_96);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_97);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_98);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_99);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_100);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_101);
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_106);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_107);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_108);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_109);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_110);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_111);
									}
								}
							}
						}
