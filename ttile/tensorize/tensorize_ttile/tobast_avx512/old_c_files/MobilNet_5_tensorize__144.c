...
/*
[V f; U (2, f); U (7, y); U (3, w); T (2, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (16, c); T (8, f); T (1, x); T (4, y); T (8, c)]
*/
IND_TYPE c, cp_0, c240_p_0, c241_p_0, cp_1, c240_p_1, cp_2, c240, c241, f, fp_0, h, hp_0, x, xp_0, x198_p_0, xp_1, x198, y, yp_0;
IND_TYPE y132 = 0;
IND_TYPE x199 = 0;
IND_TYPE h98 = 0;
IND_TYPE w = 0;
...
c240_p_1 = 0;
					for (h = h98, hp_0 = 0;h < h98 + 3;h += 1, hp_0 += 1){
						...
						for (x = x198, xp_1 = x198_p_0, xp_0 = 0;x < x198 + 28;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 2) (2 / 1)
									for (c = c240, cp_2 = c240_p_1, cp_1 = c240_p_0, cp_0 = 0;c < c240 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
