...
/*
[V f; U (2, f); U (8, y); T (128, c); Hoist_vars [c]; T (8, x); T (17, x);
  T (17, y); T (2, f); T (1, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x24_p_0, x25_p_0, xp_1, x24_p_1, xp_2, x24, x25, y, yp_0;
IND_TYPE y12 = 0;
IND_TYPE x26 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x24_p_1 = 0;
				for (x = x24, xp_2 = x24_p_1, xp_1 = x24_p_0, xp_0 = 0;x < x24 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
							...
							// T (c, 128) (128 / 1)
							for (c = c12, cp_0 = 0;c < c12 + 128;c += 1, cp_0 += 1){
