...
/*
[V f; U (2, f); U (8, y); U (3, h); T (64, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (7, x); T (7, y); T (2, f); T (1, c); T (4, x)]
*/
IND_TYPE c, cp_0, c106_p_0, cp_1, c106, f, fp_0, w, wp_0, x, xp_0, x132_p_0, x133_p_0, xp_1, x132_p_1, xp_2, x132, x133, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x134 = 0;
IND_TYPE h = 0;
IND_TYPE w68 = 0;
...
x132_p_1 = 0;
					for (w = w68, wp_0 = 0;w < w68 + 3;w += 1, wp_0 += 1){
						...
						for (x = x132, xp_2 = x132_p_1, xp_1 = x132_p_0, xp_0 = 0;x < x132 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_528 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									mem_vec_529 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
									// y = 8, x = 1, h = 3, w = 1, c = 64, f = 32
									// T (c, 64) (64 / 1)
									for (c = c106, cp_1 = c106_p_0, cp_0 = 0;c < c106 + 64;c += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_528);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_529);
						}
					}
}
