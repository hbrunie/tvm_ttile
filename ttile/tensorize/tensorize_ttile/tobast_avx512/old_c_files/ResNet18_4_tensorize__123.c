...
fp_1 = 0;
					for (h = h98, hp_0 = 0;h < h98 + 3;h += 1, hp_0 += 1){
						...
						for (x = x168, xp_1 = x168_p_0, xp_0 = 0;x < x168 + 14;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_774 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
									mem_vec_775 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
									// y = 4, x = 1, h = 1, w = 3, c = 2, f = 64
									// T (c, 2) (2 / 1)
									for (c = c168, cp_1 = c168_p_0, cp_0 = 0;c < c168 + 2;c += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_774);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_775);
						}
					}
}
