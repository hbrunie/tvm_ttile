...
fp_1 = 0;
						for (w = w342, wp_0 = 0;w < w342 + 3;w += 1, wp_0 += 1){
							...
							for (x = x618, xp_1 = x618_p_0, xp_0 = 0;x < x618 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4600 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
										mem_vec_4601 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
										...
										mem_vec_4604 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
										mem_vec_4605 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
										// y = ph_y, x = 1, h = 3, w = 1, c = 16, f = 64
										// T (c, 16) (16 / 1)
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_4600);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_4601);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_4604);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_4605);
							}
						}
}
