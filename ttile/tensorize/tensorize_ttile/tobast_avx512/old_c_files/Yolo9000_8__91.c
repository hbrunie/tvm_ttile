...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  T (4, x); T (17, y); T (1, f); T (8, c); T (2, f); T (17, x); T (8, f)]
*/
IND_TYPE c, cp_0, c138_p_0, cp_1, c138, f, fp_0, f184_p_0, f185_p_0, fp_1, f184_p_1, fp_2, f184, f185, x, xp_0, x156_p_0, xp_1, x156, y, yp_0;
...
for (f185 = f186, f185_p_0 = 0;
	...
	for (x156 = x157, x156_p_0 = 0;
		...
		for (f184 = f185, f184_p_1 = f185_p_0, f184_p_0 = 0;
			f184 < f185 + 32;
			f184 += 16, f184_p_1 += 16, f184_p_0 += 16){
					...
					for (y = y92, yp_0 = 0;
						...
						for (x = x156, xp_1 = x156_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_555 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c138, cp_1 = c138_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_553);
										mem_vec_553 = vec_3;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_555);
						}
					}
				}
			}
