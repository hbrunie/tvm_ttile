							...
							for (h = h60, hp_0 = 0;h < h60 + 3;h += 1, hp_0 += 1){
								...
								for (w = w66, wp_0 = 0;w < w66 + 3;w += 1, wp_0 += 1){
									...
									for (x = x102, xp_1 = x102_p_0, xp_0 = 0;x < x102 + 2;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_1052 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
												mem_vec_1053 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
												mem_vec_1054 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
												mem_vec_1055 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_1052);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_1053);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_1054);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_1055);
									}
								}
							}
}
