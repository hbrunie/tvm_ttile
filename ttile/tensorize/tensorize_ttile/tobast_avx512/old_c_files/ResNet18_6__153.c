				...
				for (f = f84, fp_1 = f84_p_0, fp_0 = 0;
					...
					for (w = w56, wp_0 = 0;
						...
						for (x = x84, xp_1 = x84_p_0, xp_0 = 0;
							x < x84 + 14;
							x += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_502 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_503 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
									...
									mem_vec_507 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_502);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_503);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_507);
