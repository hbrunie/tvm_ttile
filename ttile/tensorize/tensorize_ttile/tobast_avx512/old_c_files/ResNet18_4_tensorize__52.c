...
fp_1 = 0;
					for (h = h66, hp_0 = 0;h < h66 + 3;h += 1, hp_0 += 1){
						...
						for (x = x120, xp_1 = x120_p_0, xp_0 = 0;x < x120 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_638 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_639 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									// y = 4, x = 1, h = 1, w = 3, c = 32, f = 16
									// T (c, 32) (32 / 1)
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_638);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_639);
						}
					}
}
