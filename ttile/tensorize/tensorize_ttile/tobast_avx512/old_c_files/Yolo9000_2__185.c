		...
		for (c414 = c415, c414_p_0 = 0;
			...
			for (f = f226, fp_0 = 0;
				...
				for (y = y296, yp_0 = 0;
					...
					// T (x, 2) (2 / 1)
					for (x698 = x699, x698_p_2 = x699_p_1, x698_p_1 = x699_p_0, x698_p_0 = 0;
						x698 < x699 + 2;
						x698 += 1, x698_p_2 += 1, x698_p_1 += 1, x698_p_0 += 1){
						...
						for (h = h200, hp_0 = 0;
							...
							// T (x, 1) (1 / 1)
							for (x = x698, xp_3 = x698_p_2, xp_2 = x698_p_1, xp_1 = x698_p_0, xp_0 = 0;
								x < x698 + 1;
