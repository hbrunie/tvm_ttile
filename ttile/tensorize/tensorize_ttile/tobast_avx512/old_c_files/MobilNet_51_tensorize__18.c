...
fp_2 = 0;
							for (h = h334, hp_0 = 0;h < h334 + 3;h += 1, hp_0 += 1){
								...
								for (x = x750, xp_1 = x750_p_0, xp_0 = 0;x < x750 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_5419 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											mem_vec_5420 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
											mem_vec_5421 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5419);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5420);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5421);
								}
							}
}
