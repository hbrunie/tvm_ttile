...
c788_p_1 = 0;
						for (w = w382, wp_0 = 0;w < w382 + 3;w += 1, wp_0 += 1){
							...
							for (x = x672, xp_1 = x672_p_0, xp_0 = 0;x < x672 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4546 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_4547 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_4546);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_4547);
							}
						}
}
