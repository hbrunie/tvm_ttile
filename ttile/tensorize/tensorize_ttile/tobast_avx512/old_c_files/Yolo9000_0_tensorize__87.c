...
yp_2 = 0;
					for (w = w12, wp_0 = 0;w < w12 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 8) (8 / 1)
						for (x = x20, xp_1 = x20_p_0, xp_0 = 0;x < x20 + 8;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_71 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_71);
						}
					}
}
