...
c1046_p_1 = 0;
							for (x = x930, xp_1 = x930_p_0, xp_0 = 0;x < x930 + 17;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_8559 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_8560 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_8561 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_8559);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_8560);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_8561);
							}
}
