...
[V f; U (4, f); U (4, y); T (4, c); Hoist_vars [c]; T (1, x); T (3, w);
  T (3, h); T (4, x); T (68, y); T (8, c); T (68, x); T (1, x)]
*/
IND_TYPE c, cp_0, c48_p_0, cp_1, c48, h, hp_0, w, wp_0, x, xp_0, x80_p_0, x81_p_0, x82_p_0, xp_1, x80_p_1, x81_p_1, xp_2, x80_p_2, xp_3, x80, x81, x82, y, yp_0;
IND_TYPE y32 = 0;
IND_TYPE x83 = 0;
IND_TYPE h32 = 0;
IND_TYPE w32 = 0;
...
x80_p_2 = 0;
					for (h = h32, hp_0 = 0;h < h32 + 3;h += 1, hp_0 += 1){
						...
						for (w = w32, wp_0 = 0;w < w32 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 1) (1 / 1)
							for (x = x80, xp_3 = x80_p_2, xp_2 = x80_p_1, xp_1 = x80_p_0, xp_0 = 0;x < x80 + 1;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
