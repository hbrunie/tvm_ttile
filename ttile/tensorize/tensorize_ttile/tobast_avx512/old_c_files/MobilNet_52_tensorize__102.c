...
c836_p_1 = 0;
						for (w = w406, wp_0 = 0;w < w406 + 3;w += 1, wp_0 += 1){
							...
							for (x = x708, xp_1 = x708_p_0, xp_0 = 0;x < x708 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5008 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
										mem_vec_5009 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_5008);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_5009);
							}
						}
}
