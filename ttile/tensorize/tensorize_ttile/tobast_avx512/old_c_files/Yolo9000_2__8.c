...
[V f; U (2, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (68, x);
  T (3, h); T (2, x); T (68, y); T (2, f); T (4, c); T (1, x); T (2, x)]
*/
IND_TYPE c, cp_0, c372_p_0, cp_1, c372, f, fp_0, h, hp_0, x, xp_0, x628_p_0, x629_p_0, x630_p_0, xp_1, x628_p_1, x629_p_1, xp_2, x628_p_2, xp_3, x628, x629, x630, y, yp_0;
...
for (x630 = x631, x630_p_0 = 0;
	x630 < x631 + 272;
	x630 += 136, x630_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 1) (136 / 136)
	for (x629 = x630, x629_p_1 = x630_p_0, x629_p_0 = 0;
		x629 < x630 + 136;
		x629 += 136, x629_p_1 += 136, x629_p_0 += 136){
		// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
		// T (c, 4) (32 / 8)
		for (c372 = c373, c372_p_0 = 0;
			...
			for (f = f198, fp_0 = 0;
				...
				for (y = y268, yp_0 = 0;
					y < y268 + 272;
					y += 4, yp_0 += 4){
					// y = 4, x = 136, h = 3, w = 3, c = 8, f = 32
					// T (x, 2) (136 / 68)
					for (x628 = x629, x628_p_2 = x629_p_1, x628_p_1 = x629_p_0, x628_p_0 = 0;
						x628 < x629 + 136;
						x628 += 68, x628_p_2 += 68, x628_p_1 += 68, x628_p_0 += 68){
						...
						for (h = h172, hp_0 = 0;
							...
							// T (x, 68) (68 / 1)
							for (x = x628, xp_3 = x628_p_2, xp_2 = x628_p_1, xp_1 = x628_p_0, xp_0 = 0;
								x < x628 + 68;
								x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c372, cp_1 = c372_p_0, cp_0 = 0;
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_1536);
											mem_vec_1536 = vec_14;

											vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_1537);
											mem_vec_1537 = vec_17;
											scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_20 = _mm512_set1_ps(scal_5);


											vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_1538);
											mem_vec_1538 = vec_19;



											vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_1539);
											mem_vec_1539 = vec_21;
											scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_23 = _mm512_set1_ps(scal_6);


											vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_1540);
											mem_vec_1540 = vec_22;



											vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_1541);
											mem_vec_1541 = vec_24;
											scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_26 = _mm512_set1_ps(scal_7);


											vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_1542);
											mem_vec_1542 = vec_25;



											vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_1543);
											mem_vec_1543 = vec_27;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_29 = _mm512_set1_ps(scal_8);
											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_1536);
											mem_vec_1536 = vec_28;

											vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_1537);
											mem_vec_1537 = vec_31;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_34 = _mm512_set1_ps(scal_9);


											vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1538);
											mem_vec_1538 = vec_33;



											vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1539);
											mem_vec_1539 = vec_35;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_37 = _mm512_set1_ps(scal_10);


											vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_1540);
											mem_vec_1540 = vec_36;



											vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_1541);
											mem_vec_1541 = vec_38;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_40 = _mm512_set1_ps(scal_11);


											vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_1542);
											mem_vec_1542 = vec_39;



											vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_1543);
											mem_vec_1543 = vec_41;
										}
