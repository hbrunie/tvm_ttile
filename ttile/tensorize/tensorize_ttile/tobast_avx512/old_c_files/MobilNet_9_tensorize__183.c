...
[V f; U (2, f); U (7, y); T (4, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (2, c); T (2, f); T (4, c); T (16, f); T (32, c)]
*/
IND_TYPE c, cp_0, c80_p_0, c81_p_0, c82_p_0, cp_1, c80_p_1, c81_p_1, cp_2, c80_p_2, cp_3, c80, c81, c82, f, fp_0, f48_p_0, fp_1, f48, h, hp_0, w, wp_0, x, xp_0;
IND_TYPE y = 0;
IND_TYPE x32 = 0;
IND_TYPE h32 = 0;
IND_TYPE w32 = 0;
					...
					for (h = h32, hp_0 = 0;h < h32 + 3;h += 1, hp_0 += 1){
						...
						for (w = w32, wp_0 = 0;w < w32 + 3;w += 1, wp_0 += 1){
							...
							for (x = x32, xp_0 = 0;x < x32 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 4) (4 / 1)
										for (c = c80, cp_3 = c80_p_2, cp_2 = c80_p_1, cp_1 = c80_p_0, cp_0 = 0;c < c80 + 4;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
