...
yp_0 = 0;
							for (w = w314, wp_0 = 0;w < w314 + 3;w += 1, wp_0 += 1){
								...
								for (x = x634, xp_1 = x634_p_0, xp_0 = 0;x < x634 + 2;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3457 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											mem_vec_3458 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_3457);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_3458);
