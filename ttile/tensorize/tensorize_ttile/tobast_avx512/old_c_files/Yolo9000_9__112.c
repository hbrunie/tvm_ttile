					...
					for (x712 = x713, x712_p_1 = x713_p_0, x712_p_0 = 0;
						...
						for (x = x712, xp_2 = x712_p_1, xp_1 = x712_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_5964 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_5965 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_5966 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_5967 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 8, f = 32
									// T (c, 8) (8 / 1)
									for (c = c534, cp_1 = c534_p_0, cp_0 = 0;
										c < c534 + 8;
										...
										vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_5964);
										mem_vec_5964 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_5965);
										mem_vec_5965 = vec_40;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
										vec_42 = _mm512_set1_ps(scal_13);


										vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_5966);
										mem_vec_5966 = vec_41;



										vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_5967);
										mem_vec_5967 = vec_43;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_5964);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_5965);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_5966);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_5967);
						}
					}
				}
		}
