							...
							for (h = h48, hp_0 = 0;h < h48 + 3;h += 1, hp_0 += 1){
								...
								for (w = w54, wp_0 = 0;w < w54 + 3;w += 1, wp_0 += 1){
									...
									for (x = x84, xp_1 = x84_p_0, xp_0 = 0;x < x84 + 34;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_788 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
												mem_vec_789 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
												mem_vec_790 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
												mem_vec_791 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
												mem_vec_792 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
												mem_vec_793 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
												mem_vec_794 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
												mem_vec_795 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
												...
												for (c = c84, cp_1 = c84_p_0, cp_0 = 0;c < c84 + 128;c += 1, cp_1 += 1, cp_0 += 1){
													...
													vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_794);
													mem_vec_794 = vec_41;
													vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_795);
													mem_vec_795 = vec_43;
												}
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_788);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_789);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_790);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_791);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_792);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_793);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_794);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_795);
									}
								}
							}
}
