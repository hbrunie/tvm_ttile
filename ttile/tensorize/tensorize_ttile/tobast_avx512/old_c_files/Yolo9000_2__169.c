...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (68, x);
  T (3, w); T (4, x); T (68, y); T (32, c); T (1, x); T (1, x)]
*/
IND_TYPE c, cp_0, c252_p_0, cp_1, c252, w, wp_0, x, xp_0, x420_p_0, x421_p_0, x422_p_0, xp_1, x420_p_1, x421_p_1, xp_2, x420_p_2, xp_3, x420, x421, x422, y, yp_0;
		...
		for (c252 = c253, c252_p_0 = 0;
			...
			for (y = y168, yp_0 = 0;
				...
				for (x420 = x421, x420_p_2 = x421_p_1, x420_p_1 = x421_p_0, x420_p_0 = 0;
					x420 < x421 + 272;
					x420 += 68, x420_p_2 += 68, x420_p_1 += 68, x420_p_0 += 68){
					// y = 4, x = 68, h = 3, w = 3, c = 1, f = 64
					// T (w, 3) (3 / 1)
					for (w = w168, wp_0 = 0;
						w < w168 + 3;
						w += 1, wp_0 += 1){
						// y = 4, x = 68, h = 3, w = 1, c = 1, f = 64
						// T (x, 68) (68 / 1)
						for (x = x420, xp_3 = x420_p_2, xp_2 = x420_p_1, xp_1 = x420_p_0, xp_0 = 0;
							...
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c252, cp_1 = c252_p_0, cp_0 = 0;
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_1008);
										mem_vec_1008 = vec_24;

										vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_1009);
										mem_vec_1009 = vec_27;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_1010);
										mem_vec_1010 = vec_29;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_1011);
										mem_vec_1011 = vec_31;
										scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_34 = _mm512_set1_ps(scal_5);


										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_1012);
										mem_vec_1012 = vec_33;



										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_1013);
										mem_vec_1013 = vec_35;



										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1014);
										mem_vec_1014 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1015);
										mem_vec_1015 = vec_37;
										scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_1016);
										mem_vec_1016 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_1017);
										mem_vec_1017 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_1018);
										mem_vec_1018 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_1019);
										mem_vec_1019 = vec_42;
										scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_7);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_1020);
										mem_vec_1020 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_1021);
										mem_vec_1021 = vec_45;



										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_1022);
										mem_vec_1022 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_1023);
										mem_vec_1023 = vec_47;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_1008);
										mem_vec_1008 = vec_48;

										vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_1009);
										mem_vec_1009 = vec_51;

										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_1010);
										mem_vec_1010 = vec_53;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_1011);
										mem_vec_1011 = vec_55;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_9);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1012);
										mem_vec_1012 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_1013);
										mem_vec_1013 = vec_59;



										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_1014);
										mem_vec_1014 = vec_60;



										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_1015);
										mem_vec_1015 = vec_61;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_63 = _mm512_set1_ps(scal_10);


										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_1016);
										mem_vec_1016 = vec_62;



										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_1017);
										mem_vec_1017 = vec_64;



										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_1018);
										mem_vec_1018 = vec_65;



										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_1019);
										mem_vec_1019 = vec_66;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_1020);
										mem_vec_1020 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_1021);
										mem_vec_1021 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_1022);
										mem_vec_1022 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_1023);
										mem_vec_1023 = vec_71;
									}
