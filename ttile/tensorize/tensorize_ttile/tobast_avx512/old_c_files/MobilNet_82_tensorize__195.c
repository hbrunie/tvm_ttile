...
c1152_p_1 = 0;
					for (h = h472, hp_0 = 0;h < h472 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 7) (7 / 1)
						for (x = x660, xp_0 = 0;x < x660 + 7;x += 1, xp_0 += 1){
									...
									for (c = c1152, cp_2 = c1152_p_1, cp_1 = c1152_p_0, cp_0 = 0;c < c1152 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_19 = _mm512_fmadd_ps(vec_20, vec_21, mem_vec_5928);
										mem_vec_5928 = vec_19;
										vec_23 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_22 = _mm512_fmadd_ps(vec_20, vec_23, mem_vec_5929);
										mem_vec_5929 = vec_22;
										vec_25 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
										vec_24 = _mm512_fmadd_ps(vec_20, vec_25, mem_vec_5930);
										mem_vec_5930 = vec_24;
										vec_27 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
										vec_26 = _mm512_fmadd_ps(vec_20, vec_27, mem_vec_5931);
										mem_vec_5931 = vec_26;
										scal_4 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 1) + h) + c];
										vec_29 = _mm512_set1_ps(scal_4);
										vec_28 = _mm512_fmadd_ps(vec_29, vec_21, mem_vec_5932);
										mem_vec_5932 = vec_28;
										vec_30 = _mm512_fmadd_ps(vec_29, vec_23, mem_vec_5933);
										mem_vec_5933 = vec_30;
										vec_31 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_5934);
										mem_vec_5934 = vec_31;
										vec_32 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_5935);
										mem_vec_5935 = vec_32;
										scal_5 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 2) + h) + c];
										vec_34 = _mm512_set1_ps(scal_5);
										vec_33 = _mm512_fmadd_ps(vec_34, vec_21, mem_vec_5936);
										mem_vec_5936 = vec_33;
										vec_35 = _mm512_fmadd_ps(vec_34, vec_23, mem_vec_5937);
										mem_vec_5937 = vec_35;
										vec_36 = _mm512_fmadd_ps(vec_34, vec_25, mem_vec_5938);
										mem_vec_5938 = vec_36;
										vec_37 = _mm512_fmadd_ps(vec_34, vec_27, mem_vec_5939);
										mem_vec_5939 = vec_37;
										scal_6 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * y + h) + c];
										vec_39 = _mm512_set1_ps(scal_6);
										vec_40 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_38 = _mm512_fmadd_ps(vec_39, vec_40, mem_vec_5928);
										mem_vec_5928 = vec_38;
										vec_42 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_41 = _mm512_fmadd_ps(vec_39, vec_42, mem_vec_5929);
										mem_vec_5929 = vec_41;
										vec_44 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
										vec_43 = _mm512_fmadd_ps(vec_39, vec_44, mem_vec_5930);
										mem_vec_5930 = vec_43;
										vec_46 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
										vec_45 = _mm512_fmadd_ps(vec_39, vec_46, mem_vec_5931);
										mem_vec_5931 = vec_45;
										scal_7 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 1) + h) + c];
										vec_48 = _mm512_set1_ps(scal_7);
										vec_47 = _mm512_fmadd_ps(vec_48, vec_40, mem_vec_5932);
										mem_vec_5932 = vec_47;
										vec_49 = _mm512_fmadd_ps(vec_48, vec_42, mem_vec_5933);
										mem_vec_5933 = vec_49;
										vec_50 = _mm512_fmadd_ps(vec_48, vec_44, mem_vec_5934);
										mem_vec_5934 = vec_50;
										vec_51 = _mm512_fmadd_ps(vec_48, vec_46, mem_vec_5935);
										mem_vec_5935 = vec_51;
										scal_8 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 2) + h) + c];
										vec_53 = _mm512_set1_ps(scal_8);
										vec_52 = _mm512_fmadd_ps(vec_53, vec_40, mem_vec_5936);
										mem_vec_5936 = vec_52;
										vec_54 = _mm512_fmadd_ps(vec_53, vec_42, mem_vec_5937);
										mem_vec_5937 = vec_54;
										vec_55 = _mm512_fmadd_ps(vec_53, vec_44, mem_vec_5938);
										mem_vec_5938 = vec_55;
										vec_56 = _mm512_fmadd_ps(vec_53, vec_46, mem_vec_5939);
										mem_vec_5939 = vec_56;
									}
