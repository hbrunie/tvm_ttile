...
[V f; U (1, f); U (7, y); U (3, w); T (256, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (4, f); T (2, c); T (1, y); T (8, f)]
*/
IND_TYPE c, cp_0, c312_p_0, cp_1, c312, f, fp_0, f252_p_0, fp_1, f252, h, hp_0, x, xp_0, y, yp_0;
IND_TYPE y130 = 0;
IND_TYPE x188 = 0;
IND_TYPE h126 = 0;
IND_TYPE w = 0;
...
fp_1 = 0;
				for (h = h126, hp_0 = 0;h < h126 + 3;h += 1, hp_0 += 1){
					...
					for (x = x188, xp_0 = 0;x < x188 + 7;x += 1, xp_0 += 1){
								...
								mem_vec_1541 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_1542 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								mem_vec_1543 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								mem_vec_1544 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
								mem_vec_1545 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
