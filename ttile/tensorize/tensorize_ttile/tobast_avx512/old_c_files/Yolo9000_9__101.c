...
/*
[V f; U (2, f); ULambda y; T (8, c); Hoist_vars [c]; T (34, x); T (2, x);
			...
			f += 32, fp_0 += 32){
				for (y = y344, yp_0 = 0;
					...
					for (x688 = x689, x688_p_1 = x689_p_0, x688_p_0 = 0;
						x688 < x689 + 68;
						x688 += 34, x688_p_1 += 34, x688_p_0 += 34){
					...
					for (x688 = x689, x688_p_1 = x689_p_0, x688_p_0 = 0;
						...
						for (x = x688, xp_2 = x688_p_1, xp_1 = x688_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_5700 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_5701 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_5702 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_5703 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 8, f = 32
									// T (c, 8) (8 / 1)
									for (c = c516, cp_1 = c516_p_0, cp_0 = 0;
										c < c516 + 8;
										...
										vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_5700);
										mem_vec_5700 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_5701);
										mem_vec_5701 = vec_40;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
										vec_42 = _mm512_set1_ps(scal_13);


										vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_5702);
										mem_vec_5702 = vec_41;



										vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_5703);
										mem_vec_5703 = vec_43;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_5700);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_5701);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_5702);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_5703);
						}
					}
				}
		}
