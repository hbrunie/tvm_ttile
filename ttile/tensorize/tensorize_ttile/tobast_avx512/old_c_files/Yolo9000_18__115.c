								...
								for (x = x612, xp_1 = x612_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c692, cp_1 = c692_p_0, cp_0 = 0;
												...
												vec_17 = _mm512_fmadd_ps(vec_18, vec_19, mem_vec_5386);
												mem_vec_5386 = vec_17;

												vec_21 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_20 = _mm512_fmadd_ps(vec_18, vec_21, mem_vec_5387);
												mem_vec_5387 = vec_20;
												scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_23 = _mm512_set1_ps(scal_6);


												vec_22 = _mm512_fmadd_ps(vec_23, vec_19, mem_vec_5388);
												mem_vec_5388 = vec_22;



												vec_24 = _mm512_fmadd_ps(vec_23, vec_21, mem_vec_5389);
												mem_vec_5389 = vec_24;
												scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_26 = _mm512_set1_ps(scal_7);


												vec_25 = _mm512_fmadd_ps(vec_26, vec_19, mem_vec_5390);
												mem_vec_5390 = vec_25;



												vec_27 = _mm512_fmadd_ps(vec_26, vec_21, mem_vec_5391);
												mem_vec_5391 = vec_27;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_29 = _mm512_set1_ps(scal_8);


												vec_28 = _mm512_fmadd_ps(vec_29, vec_19, mem_vec_5392);
												mem_vec_5392 = vec_28;



												vec_30 = _mm512_fmadd_ps(vec_29, vec_21, mem_vec_5393);
												mem_vec_5393 = vec_30;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_32 = _mm512_set1_ps(scal_9);


												vec_31 = _mm512_fmadd_ps(vec_32, vec_19, mem_vec_5394);
												mem_vec_5394 = vec_31;



												vec_33 = _mm512_fmadd_ps(vec_32, vec_21, mem_vec_5395);
												mem_vec_5395 = vec_33;
												...
												vec_39 = _mm512_fmadd_ps(vec_40, vec_36, mem_vec_5388);
												mem_vec_5388 = vec_39;



												vec_41 = _mm512_fmadd_ps(vec_40, vec_38, mem_vec_5389);
												mem_vec_5389 = vec_41;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_43 = _mm512_set1_ps(scal_12);


												vec_42 = _mm512_fmadd_ps(vec_43, vec_36, mem_vec_5390);
												mem_vec_5390 = vec_42;



												vec_44 = _mm512_fmadd_ps(vec_43, vec_38, mem_vec_5391);
												mem_vec_5391 = vec_44;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_46 = _mm512_set1_ps(scal_13);


												vec_45 = _mm512_fmadd_ps(vec_46, vec_36, mem_vec_5392);
												mem_vec_5392 = vec_45;



												vec_47 = _mm512_fmadd_ps(vec_46, vec_38, mem_vec_5393);
												mem_vec_5393 = vec_47;
