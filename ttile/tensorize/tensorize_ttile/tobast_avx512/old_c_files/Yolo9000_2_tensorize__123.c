...
[V f; U (4, f); U (2, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (34, x); T (136, y); T (32, c); T (4, x); T (2, x)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, w, wp_0, x, xp_0, x370_p_0, x371_p_0, x372_p_0, xp_1, x370_p_1, x371_p_1, xp_2, x370_p_2, xp_3, x370, x371, x372, y, yp_0;
IND_TYPE y148 = 0;
IND_TYPE x373 = 0;
IND_TYPE h = 0;
IND_TYPE w148 = 0;
...
x370_p_2 = 0;
					for (w = w148, wp_0 = 0;w < w148 + 3;w += 1, wp_0 += 1){
						...
						for (x = x370, xp_3 = x370_p_2, xp_2 = x370_p_1, xp_1 = x370_p_0, xp_0 = 0;x < x370 + 1;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_930 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
									mem_vec_931 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
									...
									mem_vec_934 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
									mem_vec_935 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
									// y = 2, x = 1, h = 3, w = 1, c = 1, f = 64
									// T (c, 1) (1 / 1)
									for (c = c222, cp_1 = c222_p_0, cp_0 = 0;c < c222 + 1;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_928);
										mem_vec_928 = vec_14;
										vec_18 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_929);
										mem_vec_929 = vec_17;
										vec_20 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 32]);
										vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_930);
										mem_vec_930 = vec_19;
										vec_22 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
										vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_931);
										mem_vec_931 = vec_21;
										scal_3 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
										vec_24 = _mm512_set1_ps(scal_3);
										vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_932);
										mem_vec_932 = vec_23;
										vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_933);
										mem_vec_933 = vec_25;
										vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_934);
										mem_vec_934 = vec_26;
										vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_935);
										mem_vec_935 = vec_27;
										scal_4 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
										vec_29 = _mm512_set1_ps(scal_4);
										vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_928);
										mem_vec_928 = vec_28;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_929);
										mem_vec_929 = vec_31;
										vec_34 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 32]);
										vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_930);
										mem_vec_930 = vec_33;
										vec_36 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
										vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_931);
										mem_vec_931 = vec_35;
										scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
										vec_38 = _mm512_set1_ps(scal_5);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_932);
										mem_vec_932 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_933);
										mem_vec_933 = vec_39;
										vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_934);
										mem_vec_934 = vec_40;
										vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_935);
										mem_vec_935 = vec_41;
									}
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_930);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_931);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_934);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_935);
						}
					}
}
