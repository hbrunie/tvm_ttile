...
*/
IND_TYPE c, cp_0, c82_p_0, c83_p_0, cp_1, c82_p_1, cp_2, c82, c83, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y34 = 0;
IND_TYPE x48 = 0;
IND_TYPE h48 = 0;
IND_TYPE w48 = 0;
				...
				for (h = h48, hp_0 = 0;h < h48 + 3;h += 1, hp_0 += 1){
					...
					for (w = w48, wp_0 = 0;w < w48 + 3;w += 1, wp_0 += 1){
						...
						for (x = x48, xp_0 = 0;x < x48 + 7;x += 1, xp_0 += 1){
									...
									// T (c, 2) (2 / 1)
									for (c = c82, cp_2 = c82_p_1, cp_1 = c82_p_0, cp_0 = 0;c < c82 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
