...
*/
IND_TYPE c, cp_0, c1020_p_0, cp_1, c1020, f, fp_0, f1020_p_0, fp_1, f1020, h, hp_0, x, xp_0, x1006_p_0, xp_1, x1006, y, yp_0;
						...
						for (h = h514, hp_0 = 0;
							...
							for (x = x1006, xp_1 = x1006_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7996 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
										mem_vec_7997 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
										mem_vec_7998 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32]);
										mem_vec_7999 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48]);
										// y = ph_y, x = 1, h = 1, w = 3, c = 32, f = 64
										// T (c, 32) (32 / 1)
										for (c = c1020, cp_1 = c1020_p_0, cp_0 = 0;
											c < c1020 + 32;
											...
											vec_32 = _mm512_fmadd_ps(vec_30, vec_6, mem_vec_7998);
											mem_vec_7998 = vec_32;



											vec_33 = _mm512_fmadd_ps(vec_30, vec_8, mem_vec_7999);
											mem_vec_7999 = vec_33;
											scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * y + h) + c];
											vec_35 = _mm512_set1_ps(scal_6);
											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

											vec_34 = _mm512_fmadd_ps(vec_35, vec_36, mem_vec_7976);
											mem_vec_7976 = vec_34;

											vec_38 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_37 = _mm512_fmadd_ps(vec_35, vec_38, mem_vec_7977);
											mem_vec_7977 = vec_37;

											vec_40 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

											vec_39 = _mm512_fmadd_ps(vec_35, vec_40, mem_vec_7978);
											mem_vec_7978 = vec_39;

											vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

											vec_41 = _mm512_fmadd_ps(vec_35, vec_42, mem_vec_7979);
											mem_vec_7979 = vec_41;
											scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
											vec_44 = _mm512_set1_ps(scal_7);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_7980);
											mem_vec_7980 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_38, mem_vec_7981);
											mem_vec_7981 = vec_45;



											vec_46 = _mm512_fmadd_ps(vec_44, vec_40, mem_vec_7982);
											mem_vec_7982 = vec_46;



											vec_47 = _mm512_fmadd_ps(vec_44, vec_42, mem_vec_7983);
											mem_vec_7983 = vec_47;
											scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
											vec_49 = _mm512_set1_ps(scal_8);


											vec_48 = _mm512_fmadd_ps(vec_49, vec_36, mem_vec_7984);
											mem_vec_7984 = vec_48;



											vec_50 = _mm512_fmadd_ps(vec_49, vec_38, mem_vec_7985);
											mem_vec_7985 = vec_50;



											vec_51 = _mm512_fmadd_ps(vec_49, vec_40, mem_vec_7986);
											mem_vec_7986 = vec_51;



											vec_52 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_7987);
											mem_vec_7987 = vec_52;
											scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
											vec_54 = _mm512_set1_ps(scal_9);


											vec_53 = _mm512_fmadd_ps(vec_54, vec_36, mem_vec_7988);
											mem_vec_7988 = vec_53;



											vec_55 = _mm512_fmadd_ps(vec_54, vec_38, mem_vec_7989);
											mem_vec_7989 = vec_55;



											vec_56 = _mm512_fmadd_ps(vec_54, vec_40, mem_vec_7990);
											mem_vec_7990 = vec_56;



											vec_57 = _mm512_fmadd_ps(vec_54, vec_42, mem_vec_7991);
											mem_vec_7991 = vec_57;
											scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
											vec_59 = _mm512_set1_ps(scal_10);


											vec_58 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_7992);
											mem_vec_7992 = vec_58;



											vec_60 = _mm512_fmadd_ps(vec_59, vec_38, mem_vec_7993);
											mem_vec_7993 = vec_60;



											vec_61 = _mm512_fmadd_ps(vec_59, vec_40, mem_vec_7994);
											mem_vec_7994 = vec_61;



											vec_62 = _mm512_fmadd_ps(vec_59, vec_42, mem_vec_7995);
											mem_vec_7995 = vec_62;
											scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
											vec_64 = _mm512_set1_ps(scal_11);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_36, mem_vec_7996);
											mem_vec_7996 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_38, mem_vec_7997);
											mem_vec_7997 = vec_65;



											vec_66 = _mm512_fmadd_ps(vec_64, vec_40, mem_vec_7998);
											mem_vec_7998 = vec_66;



											vec_67 = _mm512_fmadd_ps(vec_64, vec_42, mem_vec_7999);
											mem_vec_7999 = vec_67;
											scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
											vec_69 = _mm512_set1_ps(scal_12);
											vec_70 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_68 = _mm512_fmadd_ps(vec_69, vec_70, mem_vec_7976);
											mem_vec_7976 = vec_68;

											vec_72 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_71 = _mm512_fmadd_ps(vec_69, vec_72, mem_vec_7977);
											mem_vec_7977 = vec_71;

											vec_74 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

											vec_73 = _mm512_fmadd_ps(vec_69, vec_74, mem_vec_7978);
											mem_vec_7978 = vec_73;

											vec_76 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

											vec_75 = _mm512_fmadd_ps(vec_69, vec_76, mem_vec_7979);
											mem_vec_7979 = vec_75;
											scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
											vec_78 = _mm512_set1_ps(scal_13);


											vec_77 = _mm512_fmadd_ps(vec_78, vec_70, mem_vec_7980);
											mem_vec_7980 = vec_77;



											vec_79 = _mm512_fmadd_ps(vec_78, vec_72, mem_vec_7981);
											mem_vec_7981 = vec_79;



											vec_80 = _mm512_fmadd_ps(vec_78, vec_74, mem_vec_7982);
											mem_vec_7982 = vec_80;



											vec_81 = _mm512_fmadd_ps(vec_78, vec_76, mem_vec_7983);
											mem_vec_7983 = vec_81;
											scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
											vec_83 = _mm512_set1_ps(scal_14);


											vec_82 = _mm512_fmadd_ps(vec_83, vec_70, mem_vec_7984);
											mem_vec_7984 = vec_82;



											vec_84 = _mm512_fmadd_ps(vec_83, vec_72, mem_vec_7985);
											mem_vec_7985 = vec_84;



											vec_85 = _mm512_fmadd_ps(vec_83, vec_74, mem_vec_7986);
											mem_vec_7986 = vec_85;



											vec_86 = _mm512_fmadd_ps(vec_83, vec_76, mem_vec_7987);
											mem_vec_7987 = vec_86;
											scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
											vec_88 = _mm512_set1_ps(scal_15);


											vec_87 = _mm512_fmadd_ps(vec_88, vec_70, mem_vec_7988);
											mem_vec_7988 = vec_87;



											vec_89 = _mm512_fmadd_ps(vec_88, vec_72, mem_vec_7989);
											mem_vec_7989 = vec_89;



											vec_90 = _mm512_fmadd_ps(vec_88, vec_74, mem_vec_7990);
											mem_vec_7990 = vec_90;



											vec_91 = _mm512_fmadd_ps(vec_88, vec_76, mem_vec_7991);
											mem_vec_7991 = vec_91;
											scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
											vec_93 = _mm512_set1_ps(scal_16);


											vec_92 = _mm512_fmadd_ps(vec_93, vec_70, mem_vec_7992);
											mem_vec_7992 = vec_92;



											vec_94 = _mm512_fmadd_ps(vec_93, vec_72, mem_vec_7993);
											mem_vec_7993 = vec_94;



											vec_95 = _mm512_fmadd_ps(vec_93, vec_74, mem_vec_7994);
											mem_vec_7994 = vec_95;



											vec_96 = _mm512_fmadd_ps(vec_93, vec_76, mem_vec_7995);
											mem_vec_7995 = vec_96;
											scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
											vec_98 = _mm512_set1_ps(scal_17);


											vec_97 = _mm512_fmadd_ps(vec_98, vec_70, mem_vec_7996);
											mem_vec_7996 = vec_97;



											vec_99 = _mm512_fmadd_ps(vec_98, vec_72, mem_vec_7997);
											mem_vec_7997 = vec_99;



											vec_100 = _mm512_fmadd_ps(vec_98, vec_74, mem_vec_7998);
											mem_vec_7998 = vec_100;



											vec_101 = _mm512_fmadd_ps(vec_98, vec_76, mem_vec_7999);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_7996);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_7997);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32], mem_vec_7998);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48], mem_vec_7999);
							}
						}
					}
				}
