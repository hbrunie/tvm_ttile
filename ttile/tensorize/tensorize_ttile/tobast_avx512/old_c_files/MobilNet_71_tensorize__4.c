...
yp_0 = 0;
								for (h = h392, hp_0 = 0;h < h392 + 3;h += 1, hp_0 += 1){
									...
									for (x = x674, xp_1 = x674_p_0, xp_0 = 0;x < x674 + 1;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_4359 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16]);
												...
												mem_vec_4362 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
												mem_vec_4363 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 3, c = 2, f = 32
												// T (c, 2) (2 / 1)
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16], mem_vec_4359);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_4362);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_4363);
									}
								}
}
