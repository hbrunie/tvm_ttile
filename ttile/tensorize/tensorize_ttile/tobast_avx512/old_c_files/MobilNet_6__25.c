...
// T (f, 1) (256 / 256)
for (f1346 = f1347, f1346_p_0 = 0;
	f1346 < f1347 + 256;
	f1346 += 256, f1346_p_0 += 256){
		for (y = y728, yp_0 = 0;
			y < y728 + 9;
			y += 3, yp_0 += 3){
			...
			for (x1090 = x1091, x1090_p_0 = 0;
				...
				for (c1370 = c1371, c1370_p_0 = 0;
					...
					// T (f, 4) (256 / 64)
					for (f = f1346, fp_1 = f1346_p_0, fp_0 = 0;
						f < f1346 + 256;
						...
						for (h = h670, hp_0 = 0;
							...
							for (x = x1090, xp_1 = x1090_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7966 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
										mem_vec_7967 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
										mem_vec_7968 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_7969 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_7970 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
										mem_vec_7971 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
										mem_vec_7972 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_7973 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_7974 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32]);
										mem_vec_7975 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_7966);
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_7967);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_7968);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_7969);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_7970);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_7971);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_7972);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_7973);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32], mem_vec_7974);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48], mem_vec_7975);
							}
						}
					}
				}
