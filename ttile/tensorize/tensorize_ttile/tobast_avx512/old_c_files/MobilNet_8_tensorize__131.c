...
/*
[V f; U (2, f); U (7, y); T (512, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (1, f); T (1, c); T (16, f)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, f, f0, fp_0, f0_p_0, fp_1, h, hp_0, w, wp_0, x, xp_0;
IND_TYPE y = 0;
IND_TYPE x0 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
