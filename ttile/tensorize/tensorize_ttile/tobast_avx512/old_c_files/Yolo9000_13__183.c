				...
				for (y = y8 + 7, yp_0 = 0;
					...
					for (x16 = x17, x16_p_1 = x17_p_0, x16_p_0 = 0;
						...
						for (x = x16, xp_2 = x16_p_1, xp_1 = x16_p_0, xp_0 = 0;
							x < x16 + 17;
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_142 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_143 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
									...
									mem_vec_150 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
									mem_vec_151 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
									mem_vec_152 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									mem_vec_153 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
									mem_vec_154 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_155 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
									mem_vec_156 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_157 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
									mem_vec_158 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_159 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 512, f = 32
									// T (c, 512) (512 / 1)
									for (c = c12, cp_1 = c12_p_0, cp_0 = 0;
										c < c12 + 512;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_142);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_143);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_150);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_151);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_152);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_153);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_154);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_155);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_156);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_157);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_158);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_159);
						}
					}
				}
		}
