...
/*
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (136, x); T (34, y);
  T (8, c); T (1, x)]
*/
IND_TYPE c, cp_0, c74_p_0, cp_1, c74, x, xp_0, x130_p_0, xp_1, x130, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x131 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
			for (x = x130, xp_1 = x130_p_0, xp_0 = 0;x < x130 + 136;x += 1, xp_1 += 1, xp_0 += 1){
