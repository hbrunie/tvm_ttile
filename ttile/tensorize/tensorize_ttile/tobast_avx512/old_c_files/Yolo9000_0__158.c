...
/*
[V f; U (2, f); ULambda y; U (3, w); T (3, c); Hoist_vars [c]; T (17, x);
  T (3, h); Lambda_apply y [((Iter 7), (Arg 12)); ((Iter 4), (Arg 13))];
  T (2, x); T (4, y); T (16, x)]
*/
IND_TYPE c, cp_0, h, hp_0, x, xp_0, x974_p_0, x975_p_0, xp_1, x974_p_1, xp_2, x974, x975, y, yp_0, y832_p_0, yp_1, y832;
...
for (x975 = x976, x975_p_0 = 0;
	...
	// T (y, 4) (544 / 136)
	for (y832 = y833, y832_p_0 = 0;
		y832 < y833 + 544;
		y832 += 136, y832_p_0 += 136){
		// y = 136, x = 34, h = 3, w = 3, c = 3, f = 32
		// T (x, 2) (34 / 17)
		for (x974 = x975, x974_p_1 = x975_p_0, x974_p_0 = 0;
			x974 < x975 + 34;
			x974 += 17, x974_p_1 += 17, x974_p_0 += 17){
				for (y = y832, yp_1 = y832_p_0, yp_0 = 0;
					y < y832 + 84;
					...
					for (h = h398, hp_0 = 0;
						...
						for (x = x974, xp_2 = x974_p_1, xp_1 = x974_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_7716 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_7717 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									mem_vec_7718 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_7719 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									...
									for (c = c516, cp_0 = 0;
										...
										vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_7716);
										mem_vec_7716 = vec_32;



										vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_7717);
										mem_vec_7717 = vec_34;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
										vec_36 = _mm512_set1_ps(scal_11);


										vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_7718);
										mem_vec_7718 = vec_35;



										vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_7719);
										mem_vec_7719 = vec_37;
										...
										vec_41 = _mm512_fmadd_ps(vec_39, vec_42, mem_vec_7697);
										mem_vec_7697 = vec_41;
										...
										vec_45 = _mm512_fmadd_ps(vec_44, vec_42, mem_vec_7699);
										mem_vec_7699 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_47 = _mm512_set1_ps(scal_14);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_40, mem_vec_7700);
										mem_vec_7700 = vec_46;



										vec_48 = _mm512_fmadd_ps(vec_47, vec_42, mem_vec_7701);
										mem_vec_7701 = vec_48;
										scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_40, mem_vec_7702);
										mem_vec_7702 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_42, mem_vec_7703);
										mem_vec_7703 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
										vec_53 = _mm512_set1_ps(scal_16);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_40, mem_vec_7704);
										mem_vec_7704 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_42, mem_vec_7705);
										mem_vec_7705 = vec_54;
										scal_17 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
										vec_56 = _mm512_set1_ps(scal_17);


										vec_55 = _mm512_fmadd_ps(vec_56, vec_40, mem_vec_7706);
										mem_vec_7706 = vec_55;



										vec_57 = _mm512_fmadd_ps(vec_56, vec_42, mem_vec_7707);
										mem_vec_7707 = vec_57;
										scal_18 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
										vec_59 = _mm512_set1_ps(scal_18);


										vec_58 = _mm512_fmadd_ps(vec_59, vec_40, mem_vec_7708);
										mem_vec_7708 = vec_58;



										vec_60 = _mm512_fmadd_ps(vec_59, vec_42, mem_vec_7709);
										mem_vec_7709 = vec_60;
										scal_19 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
										vec_62 = _mm512_set1_ps(scal_19);


										vec_61 = _mm512_fmadd_ps(vec_62, vec_40, mem_vec_7710);
										mem_vec_7710 = vec_61;



										vec_63 = _mm512_fmadd_ps(vec_62, vec_42, mem_vec_7711);
										mem_vec_7711 = vec_63;
										scal_20 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
										vec_65 = _mm512_set1_ps(scal_20);


										vec_64 = _mm512_fmadd_ps(vec_65, vec_40, mem_vec_7712);
										mem_vec_7712 = vec_64;



										vec_66 = _mm512_fmadd_ps(vec_65, vec_42, mem_vec_7713);
										mem_vec_7713 = vec_66;
										scal_21 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
										vec_68 = _mm512_set1_ps(scal_21);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_40, mem_vec_7714);
										mem_vec_7714 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_42, mem_vec_7715);
										mem_vec_7715 = vec_69;
										scal_22 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
										vec_71 = _mm512_set1_ps(scal_22);


										vec_70 = _mm512_fmadd_ps(vec_71, vec_40, mem_vec_7716);
										mem_vec_7716 = vec_70;



										vec_72 = _mm512_fmadd_ps(vec_71, vec_42, mem_vec_7717);
										mem_vec_7717 = vec_72;
										scal_23 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h) + c];
										vec_74 = _mm512_set1_ps(scal_23);


										vec_73 = _mm512_fmadd_ps(vec_74, vec_40, mem_vec_7718);
										mem_vec_7718 = vec_73;



										vec_75 = _mm512_fmadd_ps(vec_74, vec_42, mem_vec_7719);
										mem_vec_7719 = vec_75;
										scal_24 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_77 = _mm512_set1_ps(scal_24);
										vec_78 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_76 = _mm512_fmadd_ps(vec_77, vec_78, mem_vec_7696);
										mem_vec_7696 = vec_76;

										vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_79 = _mm512_fmadd_ps(vec_77, vec_80, mem_vec_7697);
										mem_vec_7697 = vec_79;
										scal_25 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_82 = _mm512_set1_ps(scal_25);


										vec_81 = _mm512_fmadd_ps(vec_82, vec_78, mem_vec_7698);
										mem_vec_7698 = vec_81;



										vec_83 = _mm512_fmadd_ps(vec_82, vec_80, mem_vec_7699);
										mem_vec_7699 = vec_83;
										scal_26 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_85 = _mm512_set1_ps(scal_26);


										vec_84 = _mm512_fmadd_ps(vec_85, vec_78, mem_vec_7700);
										mem_vec_7700 = vec_84;



										vec_86 = _mm512_fmadd_ps(vec_85, vec_80, mem_vec_7701);
										mem_vec_7701 = vec_86;
										scal_27 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_88 = _mm512_set1_ps(scal_27);


										vec_87 = _mm512_fmadd_ps(vec_88, vec_78, mem_vec_7702);
										mem_vec_7702 = vec_87;



										vec_89 = _mm512_fmadd_ps(vec_88, vec_80, mem_vec_7703);
										mem_vec_7703 = vec_89;
										scal_28 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
										vec_91 = _mm512_set1_ps(scal_28);


										vec_90 = _mm512_fmadd_ps(vec_91, vec_78, mem_vec_7704);
										mem_vec_7704 = vec_90;



										vec_92 = _mm512_fmadd_ps(vec_91, vec_80, mem_vec_7705);
										mem_vec_7705 = vec_92;
										scal_29 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
										vec_94 = _mm512_set1_ps(scal_29);


										vec_93 = _mm512_fmadd_ps(vec_94, vec_78, mem_vec_7706);
										mem_vec_7706 = vec_93;



										vec_95 = _mm512_fmadd_ps(vec_94, vec_80, mem_vec_7707);
										mem_vec_7707 = vec_95;
										scal_30 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
										vec_97 = _mm512_set1_ps(scal_30);


										vec_96 = _mm512_fmadd_ps(vec_97, vec_78, mem_vec_7708);
										mem_vec_7708 = vec_96;



										vec_98 = _mm512_fmadd_ps(vec_97, vec_80, mem_vec_7709);
										mem_vec_7709 = vec_98;
										scal_31 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
										vec_100 = _mm512_set1_ps(scal_31);


										vec_99 = _mm512_fmadd_ps(vec_100, vec_78, mem_vec_7710);
										mem_vec_7710 = vec_99;



										vec_101 = _mm512_fmadd_ps(vec_100, vec_80, mem_vec_7711);
										mem_vec_7711 = vec_101;
										scal_32 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
										vec_103 = _mm512_set1_ps(scal_32);


										vec_102 = _mm512_fmadd_ps(vec_103, vec_78, mem_vec_7712);
										mem_vec_7712 = vec_102;



										vec_104 = _mm512_fmadd_ps(vec_103, vec_80, mem_vec_7713);
										mem_vec_7713 = vec_104;
										scal_33 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
										vec_106 = _mm512_set1_ps(scal_33);


										vec_105 = _mm512_fmadd_ps(vec_106, vec_78, mem_vec_7714);
										mem_vec_7714 = vec_105;



										vec_107 = _mm512_fmadd_ps(vec_106, vec_80, mem_vec_7715);
										mem_vec_7715 = vec_107;
										scal_34 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h) + c];
										vec_109 = _mm512_set1_ps(scal_34);


										vec_108 = _mm512_fmadd_ps(vec_109, vec_78, mem_vec_7716);
										mem_vec_7716 = vec_108;



										vec_110 = _mm512_fmadd_ps(vec_109, vec_80, mem_vec_7717);
										mem_vec_7717 = vec_110;
										scal_35 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h) + c];
										vec_112 = _mm512_set1_ps(scal_35);


										vec_111 = _mm512_fmadd_ps(vec_112, vec_78, mem_vec_7718);
										mem_vec_7718 = vec_111;



										vec_113 = _mm512_fmadd_ps(vec_112, vec_80, mem_vec_7719);
										mem_vec_7719 = vec_113;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_7716);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_7717);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_7718);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_7719);
						}
					}
				}
				for (y = y832 + 84, yp_1 = y832_p_0, yp_0 = 0;
					y < y832 + 84 + 52;
