...
/*
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (56, x); T (7, w);
  T (7, h); T (1, x); T (14, y); T (2, f); T (2, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x88_p_0, x89_p_0, xp_1, x88_p_1, xp_2, x88, x89, y, yp_0;
IND_TYPE y44 = 0;
IND_TYPE x90 = 0;
IND_TYPE h44 = 0;
IND_TYPE w44 = 0;
...
x88_p_1 = 0;
				for (h = h44, hp_0 = 0;h < h44 + 7;h += 1, hp_0 += 1){
					// y = 8, x = 56, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w44, wp_0 = 0;w < w44 + 7;w += 1, wp_0 += 1){
						// y = 8, x = 56, h = 1, w = 1, c = 3, f = 32
						// T (x, 56) (56 / 1)
						for (x = x88, xp_2 = x88_p_1, xp_1 = x88_p_0, xp_0 = 0;x < x88 + 56;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
