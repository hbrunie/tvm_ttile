...
[V f; U (2, f); ULambda y; U (3, w); T (1, c); Hoist_vars [c]; T (14, x);
  ...
  T (2, f); T (16, c); T (4, f); T (16, c); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c1174_p_0, c1175_p_0, cp_1, c1174_p_1, cp_2, c1174, c1175, f, fp_0, f1166_p_0, f1167_p_0, fp_1, f1166_p_1, fp_2, f1166, f1167, h, hp_0, x, xp_0, x946_p_0, xp_1, x946, y, yp_0;
...
for (f1167 = f1168, f1167_p_0 = 0;
	...
	for (x946 = x947, x946_p_0 = 0;
		...
		for (c1175 = c1176, c1175_p_0 = 0;
			c1175 < c1176 + 256;
			c1175 += 16, c1175_p_0 += 16){
			// y = 14, x = 14, h = 3, w = 3, c = 16, f = 256
			// T (f, 4) (256 / 64)
			for (f1166 = f1167, f1166_p_1 = f1167_p_0, f1166_p_0 = 0;
				f1166 < f1167 + 256;
				f1166 += 64, f1166_p_1 += 64, f1166_p_0 += 64){
				// y = 14, x = 14, h = 3, w = 3, c = 16, f = 64
				// T (c, 16) (16 / 1)
				for (c1174 = c1175, c1174_p_1 = c1175_p_0, c1174_p_0 = 0;
					c1174 < c1175 + 16;
					c1174 += 1, c1174_p_1 += 1, c1174_p_0 += 1){
					// y = 14, x = 14, h = 3, w = 3, c = 1, f = 64
					// T (f, 2) (64 / 32)
					for (f = f1166, fp_2 = f1166_p_1, fp_1 = f1166_p_0, fp_0 = 0;
						f < f1166 + 64;
									...
									for (x = x946, xp_1 = x946_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c1174, cp_2 = c1174_p_1, cp_1 = c1174_p_0, cp_0 = 0;
													...
													vec_20 = _mm512_fmadd_ps(vec_21, vec_22, mem_vec_6780);
													mem_vec_6780 = vec_20;

													vec_24 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_23 = _mm512_fmadd_ps(vec_21, vec_24, mem_vec_6781);
													mem_vec_6781 = vec_23;
													scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
													vec_26 = _mm512_set1_ps(scal_7);


													vec_25 = _mm512_fmadd_ps(vec_26, vec_22, mem_vec_6782);
													mem_vec_6782 = vec_25;



													vec_27 = _mm512_fmadd_ps(vec_26, vec_24, mem_vec_6783);
													mem_vec_6783 = vec_27;
													scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
													vec_29 = _mm512_set1_ps(scal_8);


													vec_28 = _mm512_fmadd_ps(vec_29, vec_22, mem_vec_6784);
													mem_vec_6784 = vec_28;



													vec_30 = _mm512_fmadd_ps(vec_29, vec_24, mem_vec_6785);
													mem_vec_6785 = vec_30;
													scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
													vec_32 = _mm512_set1_ps(scal_9);


													vec_31 = _mm512_fmadd_ps(vec_32, vec_22, mem_vec_6786);
													mem_vec_6786 = vec_31;



													vec_33 = _mm512_fmadd_ps(vec_32, vec_24, mem_vec_6787);
													mem_vec_6787 = vec_33;
													scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
													vec_35 = _mm512_set1_ps(scal_10);


													vec_34 = _mm512_fmadd_ps(vec_35, vec_22, mem_vec_6788);
													mem_vec_6788 = vec_34;



													vec_36 = _mm512_fmadd_ps(vec_35, vec_24, mem_vec_6789);
													mem_vec_6789 = vec_36;
													scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
													vec_38 = _mm512_set1_ps(scal_11);


													vec_37 = _mm512_fmadd_ps(vec_38, vec_22, mem_vec_6790);
													mem_vec_6790 = vec_37;



													vec_39 = _mm512_fmadd_ps(vec_38, vec_24, mem_vec_6791);
													mem_vec_6791 = vec_39;
													scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
													vec_41 = _mm512_set1_ps(scal_12);
													vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_40 = _mm512_fmadd_ps(vec_41, vec_42, mem_vec_6780);
													mem_vec_6780 = vec_40;

													vec_44 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_43 = _mm512_fmadd_ps(vec_41, vec_44, mem_vec_6781);
													mem_vec_6781 = vec_43;
													scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
													vec_46 = _mm512_set1_ps(scal_13);


													vec_45 = _mm512_fmadd_ps(vec_46, vec_42, mem_vec_6782);
													mem_vec_6782 = vec_45;



													vec_47 = _mm512_fmadd_ps(vec_46, vec_44, mem_vec_6783);
													mem_vec_6783 = vec_47;
													scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
													vec_49 = _mm512_set1_ps(scal_14);


													vec_48 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_6784);
													mem_vec_6784 = vec_48;



													vec_50 = _mm512_fmadd_ps(vec_49, vec_44, mem_vec_6785);
													mem_vec_6785 = vec_50;
													scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
													vec_52 = _mm512_set1_ps(scal_15);


													vec_51 = _mm512_fmadd_ps(vec_52, vec_42, mem_vec_6786);
													mem_vec_6786 = vec_51;



													vec_53 = _mm512_fmadd_ps(vec_52, vec_44, mem_vec_6787);
													mem_vec_6787 = vec_53;
													scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
													vec_55 = _mm512_set1_ps(scal_16);


													vec_54 = _mm512_fmadd_ps(vec_55, vec_42, mem_vec_6788);
													mem_vec_6788 = vec_54;



													vec_56 = _mm512_fmadd_ps(vec_55, vec_44, mem_vec_6789);
													mem_vec_6789 = vec_56;
													scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
													vec_58 = _mm512_set1_ps(scal_17);


													vec_57 = _mm512_fmadd_ps(vec_58, vec_42, mem_vec_6790);
													mem_vec_6790 = vec_57;



													vec_59 = _mm512_fmadd_ps(vec_58, vec_44, mem_vec_6791);
													mem_vec_6791 = vec_59;
												}
									...
									for (x = x946, xp_1 = x946_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c1174, cp_2 = c1174_p_1, cp_1 = c1174_p_0, cp_0 = 0;
													...
													vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_6792);
													mem_vec_6792 = vec_26;

													vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_6793);
													mem_vec_6793 = vec_29;
													scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
													vec_32 = _mm512_set1_ps(scal_9);


													vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_6794);
													mem_vec_6794 = vec_31;



													vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_6795);
													mem_vec_6795 = vec_33;
													scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
													vec_35 = _mm512_set1_ps(scal_10);


													vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_6796);
													mem_vec_6796 = vec_34;



													vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_6797);
													mem_vec_6797 = vec_36;
													scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
													vec_38 = _mm512_set1_ps(scal_11);


													vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_6798);
													mem_vec_6798 = vec_37;



													vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_6799);
													mem_vec_6799 = vec_39;
													scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
													vec_41 = _mm512_set1_ps(scal_12);


													vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_6800);
													mem_vec_6800 = vec_40;



													vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_6801);
													mem_vec_6801 = vec_42;
													scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
													vec_44 = _mm512_set1_ps(scal_13);


													vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_6802);
													mem_vec_6802 = vec_43;



													vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_6803);
													mem_vec_6803 = vec_45;
													scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
													vec_47 = _mm512_set1_ps(scal_14);


													vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_6804);
													mem_vec_6804 = vec_46;



													vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_6805);
													mem_vec_6805 = vec_48;
													scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
													vec_50 = _mm512_set1_ps(scal_15);


													vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_6806);
													mem_vec_6806 = vec_49;



													vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_6807);
													mem_vec_6807 = vec_51;
													scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
													vec_53 = _mm512_set1_ps(scal_16);
													vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_6792);
													mem_vec_6792 = vec_52;

													vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_6793);
													mem_vec_6793 = vec_55;
													scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
													vec_58 = _mm512_set1_ps(scal_17);


													vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_6794);
													mem_vec_6794 = vec_57;



													vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_6795);
													mem_vec_6795 = vec_59;
													scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
													vec_61 = _mm512_set1_ps(scal_18);


													vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_6796);
													mem_vec_6796 = vec_60;



													vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_6797);
													mem_vec_6797 = vec_62;
													scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
													vec_64 = _mm512_set1_ps(scal_19);


													vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_6798);
													mem_vec_6798 = vec_63;



													vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_6799);
													mem_vec_6799 = vec_65;
													scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
													vec_67 = _mm512_set1_ps(scal_20);


													vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_6800);
													mem_vec_6800 = vec_66;



													vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_6801);
													mem_vec_6801 = vec_68;
													scal_21 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
													vec_70 = _mm512_set1_ps(scal_21);


													vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_6802);
													mem_vec_6802 = vec_69;



													vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_6803);
													mem_vec_6803 = vec_71;
													scal_22 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
													vec_73 = _mm512_set1_ps(scal_22);


													vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_6804);
													mem_vec_6804 = vec_72;



													vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_6805);
													mem_vec_6805 = vec_74;
													scal_23 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
													vec_76 = _mm512_set1_ps(scal_23);


													vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_6806);
													mem_vec_6806 = vec_75;



													vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_6807);
													mem_vec_6807 = vec_77;
												}
