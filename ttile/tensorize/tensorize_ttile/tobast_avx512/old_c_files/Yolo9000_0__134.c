...
[V f; U (2, f); U (8, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (8, x); T (34, y); T (1, x); T (2, y); T (68, x)]
*/
IND_TYPE c, cp_0, x, xp_0, x162_p_0, x163_p_0, xp_1, x162_p_1, xp_2, x162, x163, y, yp_0, y132_p_0, yp_1, y132;
...
for (x163 = x164, x163_p_0 = 0;
	...
	for (y132 = y133, y132_p_0 = 0;
		y132 < y133 + 544;
		y132 += 272, y132_p_0 += 272){
		// y = 272, x = 8, h = 3, w = 3, c = 3, f = 32
		// T (x, 1) (8 / 8)
		for (x162 = x163, x162_p_1 = x163_p_0, x162_p_0 = 0;
			x162 < x163 + 8;
			x162 += 8, x162_p_1 += 8, x162_p_0 += 8){
			// y = 272, x = 8, h = 3, w = 3, c = 3, f = 32
			// T (y, 34) (272 / 8)
