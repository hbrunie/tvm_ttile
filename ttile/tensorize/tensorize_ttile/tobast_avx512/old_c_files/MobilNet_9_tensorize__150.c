...
[V f; U (2, f); U (7, y); T (1, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, c); T (16, f); T (32, c); T (2, f); T (8, c)]
*/
IND_TYPE c, cp_0, c60_p_0, c61_p_0, c62_p_0, cp_1, c60_p_1, c61_p_1, cp_2, c60_p_2, cp_3, c60, c61, c62, f, fp_0, f36_p_0, fp_1, f36, h, hp_0, w, wp_0, x, xp_0;
IND_TYPE y = 0;
IND_TYPE x24 = 0;
IND_TYPE h24 = 0;
IND_TYPE w24 = 0;
					...
					for (h = h24, hp_0 = 0;h < h24 + 3;h += 1, hp_0 += 1){
						...
						for (w = w24, wp_0 = 0;w < w24 + 3;w += 1, wp_0 += 1){
							...
							for (x = x24, xp_0 = 0;x < x24 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 1) (1 / 1)
										for (c = c60, cp_3 = c60_p_2, cp_2 = c60_p_1, cp_1 = c60_p_0, cp_0 = 0;c < c60 + 1;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
