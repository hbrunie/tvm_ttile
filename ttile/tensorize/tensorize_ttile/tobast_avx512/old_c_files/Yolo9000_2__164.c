...
[V f; U (1, f); U (8, y); U (3, h); U (3, w); T (4, c); Hoist_vars [c];
  T (1, x); T (4, x); T (34, y); T (4, f); T (8, c); T (2, x); T (34, x)]
*/
IND_TYPE c, cp_0, c714_p_0, cp_1, c714, f, fp_0, x, xp_0, x1198_p_0, x1199_p_0, x1200_p_0, xp_1, x1198_p_1, x1199_p_1, xp_2, x1198_p_2, xp_3, x1198, x1199, x1200, y, yp_0;
...
for (x1200 = x1201, x1200_p_0 = 0;
	...
	// T (x, 2) (8 / 4)
	for (x1199 = x1200, x1199_p_1 = x1200_p_0, x1199_p_0 = 0;
		x1199 < x1200 + 8;
		x1199 += 4, x1199_p_1 += 4, x1199_p_0 += 4){
		...
		for (c714 = c715, c714_p_0 = 0;
			...
			for (f = f398, fp_0 = 0;
				f < f398 + 64;
				f += 16, fp_0 += 16){
				// y = 272, x = 4, h = 3, w = 3, c = 4, f = 16
				// T (y, 34) (272 / 8)
				for (y = y496, yp_0 = 0;
					y < y496 + 272;
					y += 8, yp_0 += 8){
					// y = 8, x = 4, h = 3, w = 3, c = 4, f = 16
					// T (x, 4) (4 / 1)
					for (x1198 = x1199, x1198_p_2 = x1199_p_1, x1198_p_1 = x1199_p_0, x1198_p_0 = 0;
						x1198 < x1199 + 4;
						x1198 += 1, x1198_p_2 += 1, x1198_p_1 += 1, x1198_p_0 += 1){
						// y = 8, x = 1, h = 3, w = 3, c = 4, f = 16
						// T (x, 1) (1 / 1)
						for (x = x1198, xp_3 = x1198_p_2, xp_2 = x1198_p_1, xp_1 = x1198_p_0, xp_0 = 0;
							x < x1198 + 1;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_2608 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_2609 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									...
									mem_vec_2613 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									...
									for (c = c714, cp_1 = c714_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2609);
										mem_vec_2609 = vec_3;
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_2611);
										mem_vec_2611 = vec_7;
										...
										vec_119 = _mm512_fmadd_ps(vec_120, vec_121, mem_vec_2608);
										mem_vec_2608 = vec_119;
										scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
										vec_123 = _mm512_set1_ps(scal_57);


										vec_122 = _mm512_fmadd_ps(vec_123, vec_121, mem_vec_2609);
										mem_vec_2609 = vec_122;
										scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
										vec_125 = _mm512_set1_ps(scal_58);


										vec_124 = _mm512_fmadd_ps(vec_125, vec_121, mem_vec_2610);
										mem_vec_2610 = vec_124;
										scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
										vec_127 = _mm512_set1_ps(scal_59);


										vec_126 = _mm512_fmadd_ps(vec_127, vec_121, mem_vec_2611);
										mem_vec_2611 = vec_126;
										scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
										vec_129 = _mm512_set1_ps(scal_60);


										vec_128 = _mm512_fmadd_ps(vec_129, vec_121, mem_vec_2612);
										mem_vec_2612 = vec_128;
										scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
										vec_131 = _mm512_set1_ps(scal_61);


										vec_130 = _mm512_fmadd_ps(vec_131, vec_121, mem_vec_2613);
										mem_vec_2613 = vec_130;
										scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
										vec_133 = _mm512_set1_ps(scal_62);


										vec_132 = _mm512_fmadd_ps(vec_133, vec_121, mem_vec_2614);
										mem_vec_2614 = vec_132;
										scal_63 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
										vec_135 = _mm512_set1_ps(scal_63);


										vec_134 = _mm512_fmadd_ps(vec_135, vec_121, mem_vec_2615);
										mem_vec_2615 = vec_134;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_2613);
