...
fp_1 = 0;
						for (h = h362, hp_0 = 0;h < h362 + 3;h += 1, hp_0 += 1){
							...
							for (x = x750, xp_1 = x750_p_0, xp_0 = 0;x < x750 + 28;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6298 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
										mem_vec_6299 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_6298);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_6299);
							}
						}
}
