...
/*
[V f; U (2, f); U (7, y); U (3, h); T (512, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (2, f); T (1, c); T (8, f)]
*/
IND_TYPE c, cp_0, c156_p_0, cp_1, c156, f, fp_0, f132_p_0, fp_1, f132, w, wp_0, x, xp_0;
IND_TYPE y = 0;
IND_TYPE x96 = 0;
IND_TYPE h = 0;
IND_TYPE w96 = 0;
...
fp_1 = 0;
			for (w = w96, wp_0 = 0;w < w96 + 3;w += 1, wp_0 += 1){
				...
				for (x = x96, xp_0 = 0;x < x96 + 7;x += 1, xp_0 += 1){
							...
							// T (c, 512) (512 / 1)
							for (c = c156, cp_1 = c156_p_0, cp_0 = 0;c < c156 + 512;c += 1, cp_1 += 1, cp_0 += 1){
