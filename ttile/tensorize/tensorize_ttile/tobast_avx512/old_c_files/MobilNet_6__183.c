...
/*
[V f; U (2, f); U (7, y); U (3, w); T (8, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, y); T (8, f); T (4, c); T (1, f); T (8, c); T (1, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c134_p_0, c135_p_0, cp_1, c134_p_1, cp_2, c134, c135, f, fp_0, f134_p_0, f135_p_0, fp_1, f134_p_1, fp_2, f134, f135, h, hp_0, x, xp_0, x130_p_0, xp_1, x130, y, yp_0;
	...
	for (x130 = x131, x130_p_0 = 0;
		...
		for (c135 = c136, c135_p_0 = 0;
			...
			for (f134 = f135, f134_p_1 = f135_p_0, f134_p_0 = 0;
				f134 < f135 + 256;
				f134 += 256, f134_p_1 += 256, f134_p_0 += 256){
				// y = 14, x = 14, h = 3, w = 3, c = 32, f = 256
				// T (c, 4) (32 / 8)
				for (c134 = c135, c134_p_1 = c135_p_0, c134_p_0 = 0;
					c134 < c135 + 32;
					c134 += 8, c134_p_1 += 8, c134_p_0 += 8){
								...
								for (x = x130, xp_1 = x130_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c134, cp_2 = c134_p_1, cp_1 = c134_p_0, cp_0 = 0;
												...
												vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_718);
												mem_vec_718 = vec_23;

												vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_719);
												mem_vec_719 = vec_26;
												scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
												vec_29 = _mm512_set1_ps(scal_8);


												vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_720);
												mem_vec_720 = vec_28;



												vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_721);
												mem_vec_721 = vec_30;
												scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
												vec_32 = _mm512_set1_ps(scal_9);


												vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_722);
												mem_vec_722 = vec_31;



												vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_723);
												mem_vec_723 = vec_33;
												scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
												vec_35 = _mm512_set1_ps(scal_10);


												vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_724);
												mem_vec_724 = vec_34;



												vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_725);
												mem_vec_725 = vec_36;
												scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
												vec_38 = _mm512_set1_ps(scal_11);


												vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_726);
												mem_vec_726 = vec_37;



												vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_727);
												mem_vec_727 = vec_39;
												scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
												vec_41 = _mm512_set1_ps(scal_12);


												vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_728);
												mem_vec_728 = vec_40;



												vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_729);
												mem_vec_729 = vec_42;
												scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h) + c];
												vec_44 = _mm512_set1_ps(scal_13);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_730);
												mem_vec_730 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_731);
												mem_vec_731 = vec_45;
												scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
												vec_47 = _mm512_set1_ps(scal_14);
												vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_718);
												mem_vec_718 = vec_46;

												vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_719);
												mem_vec_719 = vec_49;
												scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
												vec_52 = _mm512_set1_ps(scal_15);


												vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_720);
												mem_vec_720 = vec_51;



												vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_721);
												mem_vec_721 = vec_53;
												scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
												vec_55 = _mm512_set1_ps(scal_16);


												vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_722);
												mem_vec_722 = vec_54;



												vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_723);
												mem_vec_723 = vec_56;
												scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
												vec_58 = _mm512_set1_ps(scal_17);


												vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_724);
												mem_vec_724 = vec_57;



												vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_725);
												mem_vec_725 = vec_59;
												scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
												vec_61 = _mm512_set1_ps(scal_18);


												vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_726);
												mem_vec_726 = vec_60;



												vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_727);
												mem_vec_727 = vec_62;
												scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
												vec_64 = _mm512_set1_ps(scal_19);


												vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_728);
												mem_vec_728 = vec_63;



												vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_729);
												mem_vec_729 = vec_65;
												scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
												vec_67 = _mm512_set1_ps(scal_20);


												vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_730);
												mem_vec_730 = vec_66;



												vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_731);
												mem_vec_731 = vec_68;
											}
