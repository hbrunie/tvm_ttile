...
/*
[V f; U (2, f); U (4, y); U (3, w); T (64, c); Hoist_vars [c]; T (4, x);
  T (3, h); T (7, x); T (14, y); T (4, f); T (2, c); T (2, x)]
*/
IND_TYPE c, cp_0, c270_p_0, cp_1, c270, f, fp_0, h, hp_0, x, xp_0, x302_p_0, x303_p_0, xp_1, x302_p_1, xp_2, x302, x303, y, yp_0;
IND_TYPE y180 = 0;
IND_TYPE x304 = 0;
IND_TYPE h124 = 0;
IND_TYPE w = 0;
...
__m512 mem_vec_1232 ,mem_vec_1233 ,mem_vec_1234 ,mem_vec_1235 ,mem_vec_1236 ,mem_vec_1237 ,mem_vec_1238 ,mem_vec_1239 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
...
x302_p_1 = 0;
					for (h = h124, hp_0 = 0;h < h124 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 4) (4 / 1)
						for (x = x302, xp_2 = x302_p_1, xp_1 = x302_p_0, xp_0 = 0;x < x302 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c270, cp_1 = c270_p_0, cp_0 = 0;c < c270 + 64;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_1232);
										mem_vec_1232 = vec_14;
										vec_18 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_1233);
										mem_vec_1233 = vec_17;
										scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
										vec_20 = _mm512_set1_ps(scal_5);
										vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_1234);
										mem_vec_1234 = vec_19;
										vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_1235);
										mem_vec_1235 = vec_21;
										scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
										vec_23 = _mm512_set1_ps(scal_6);
										vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_1236);
										mem_vec_1236 = vec_22;
										vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_1237);
										mem_vec_1237 = vec_24;
										scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
										vec_26 = _mm512_set1_ps(scal_7);
										vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_1238);
										mem_vec_1238 = vec_25;
										vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_1239);
										mem_vec_1239 = vec_27;
										scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
										vec_29 = _mm512_set1_ps(scal_8);
										vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_1232);
										mem_vec_1232 = vec_28;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_1233);
										mem_vec_1233 = vec_31;
										scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
										vec_34 = _mm512_set1_ps(scal_9);
										vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1234);
										mem_vec_1234 = vec_33;
										vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1235);
										mem_vec_1235 = vec_35;
										scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
										vec_37 = _mm512_set1_ps(scal_10);
										vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_1236);
										mem_vec_1236 = vec_36;
										vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_1237);
										mem_vec_1237 = vec_38;
										scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
										vec_40 = _mm512_set1_ps(scal_11);
										vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_1238);
										mem_vec_1238 = vec_39;
										vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_1239);
										mem_vec_1239 = vec_41;
									}
