...
x870_p_1 = 0;
						for (h = h322, hp_0 = 0;h < h322 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 7) (7 / 1)
							for (x = x870, xp_2 = x870_p_1, xp_1 = x870_p_0, xp_0 = 0;x < x870 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5962 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
										mem_vec_5963 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 3, c = 16, f = 32
										// T (c, 16) (16 / 1)
										for (c = c768, cp_1 = c768_p_0, cp_0 = 0;c < c768 + 16;c += 1, cp_1 += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_5962);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_5963);
							}
						}
}
