...
x880_p_1 = 0;
					for (w = w406, wp_0 = 0;w < w406 + 3;w += 1, wp_0 += 1){
						...
						for (x = x880, xp_2 = x880_p_1, xp_1 = x880_p_0, xp_0 = 0;x < x880 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_6204 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									mem_vec_6205 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									mem_vec_6206 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
									mem_vec_6207 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_6204);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_6205);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_6206);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_6207);
						}
					}
}
