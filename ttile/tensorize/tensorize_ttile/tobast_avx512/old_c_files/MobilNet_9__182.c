...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (512, c); Hoist_vars [c];
  T (7, x); T (8, f); T (1, c); T (4, f); T (2, f); T (2, c)]
*/
IND_TYPE c, cp_0, c1008_p_0, c1009_p_0, cp_1, c1008_p_1, cp_2, c1008, c1009, f, fp_0, f688_p_0, f689_p_0, fp_1, f688_p_1, fp_2, f688, f689, x, xp_0;
	...
	for (f689 = f690, f689_p_0 = 0;
		...
		for (f688 = f689, f688_p_1 = f689_p_0, f688_p_0 = 0;
			...
			for (c1008 = c1009, c1008_p_1 = c1009_p_0, c1008_p_0 = 0;
				c1008 < c1009 + 512;
				c1008 += 512, c1008_p_1 += 512, c1008_p_0 += 512){
				// y = 7, x = 7, h = 3, w = 3, c = 512, f = 128
				// T (f, 8) (128 / 16)
					...
					for (x = x424, xp_0 = 0;
						...
						x += 1, xp_0 += 1){
								...
								for (c = c1008, cp_2 = c1008_p_1, cp_1 = c1008_p_0, cp_0 = 0;
									...
									vec_105 = _mm512_fmadd_ps(vec_106, vec_107, mem_vec_3668);
									mem_vec_3668 = vec_105;
									scal_50 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
									vec_109 = _mm512_set1_ps(scal_50);


									vec_108 = _mm512_fmadd_ps(vec_109, vec_107, mem_vec_3669);
									mem_vec_3669 = vec_108;
									scal_51 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
									vec_111 = _mm512_set1_ps(scal_51);


									vec_110 = _mm512_fmadd_ps(vec_111, vec_107, mem_vec_3670);
									mem_vec_3670 = vec_110;
									scal_52 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
									vec_113 = _mm512_set1_ps(scal_52);


									vec_112 = _mm512_fmadd_ps(vec_113, vec_107, mem_vec_3671);
									mem_vec_3671 = vec_112;
									scal_53 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
									vec_115 = _mm512_set1_ps(scal_53);


									vec_114 = _mm512_fmadd_ps(vec_115, vec_107, mem_vec_3672);
									mem_vec_3672 = vec_114;
									scal_54 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
									vec_117 = _mm512_set1_ps(scal_54);


									vec_116 = _mm512_fmadd_ps(vec_117, vec_107, mem_vec_3673);
									mem_vec_3673 = vec_116;
									scal_55 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
									vec_119 = _mm512_set1_ps(scal_55);


									vec_118 = _mm512_fmadd_ps(vec_119, vec_107, mem_vec_3674);
									mem_vec_3674 = vec_118;
									...
									vec_120 = _mm512_fmadd_ps(vec_121, vec_122, mem_vec_3668);
									mem_vec_3668 = vec_120;
									scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
									vec_124 = _mm512_set1_ps(scal_57);


									vec_123 = _mm512_fmadd_ps(vec_124, vec_122, mem_vec_3669);
									mem_vec_3669 = vec_123;
									scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
									vec_126 = _mm512_set1_ps(scal_58);


									vec_125 = _mm512_fmadd_ps(vec_126, vec_122, mem_vec_3670);
									mem_vec_3670 = vec_125;
									scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
									vec_128 = _mm512_set1_ps(scal_59);


									vec_127 = _mm512_fmadd_ps(vec_128, vec_122, mem_vec_3671);
									mem_vec_3671 = vec_127;
									scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
									vec_130 = _mm512_set1_ps(scal_60);


									vec_129 = _mm512_fmadd_ps(vec_130, vec_122, mem_vec_3672);
									mem_vec_3672 = vec_129;
									scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
									vec_132 = _mm512_set1_ps(scal_61);


									vec_131 = _mm512_fmadd_ps(vec_132, vec_122, mem_vec_3673);
									mem_vec_3673 = vec_131;
									scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
									vec_134 = _mm512_set1_ps(scal_62);


									vec_133 = _mm512_fmadd_ps(vec_134, vec_122, mem_vec_3674);
									mem_vec_3674 = vec_133;
								}
