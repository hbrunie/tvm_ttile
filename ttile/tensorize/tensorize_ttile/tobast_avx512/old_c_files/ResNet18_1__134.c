					...
					for (w = w116, wp_0 = 0;
						...
						for (x = x232, xp_2 = x232_p_1, xp_1 = x232_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1138 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_1139 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									// y = 14, x = 1, h = 1, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c116, cp_0 = 0;
										c < c116 + 3;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1138);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_1139);
						}
					}
				}
			}
