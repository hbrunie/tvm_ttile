...
fp_1 = 0;
						for (w = w214, wp_0 = 0;w < w214 + 3;w += 1, wp_0 += 1){
							...
							for (x = x426, xp_1 = x426_p_0, xp_0 = 0;x < x426 + 28;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2770 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_2771 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										...
										mem_vec_2777 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2770);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2771);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_2777);
							}
						}
}
