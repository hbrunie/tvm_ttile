...
for (x770 = x771, x770_p_0 = 0;
	x770 < x771 + 272;
	x770 += 272, x770_p_0 += 272){
	// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (x, 8) (272 / 34)
	for (x769 = x770, x769_p_1 = x770_p_0, x769_p_0 = 0;
		x769 < x770 + 272;
		x769 += 34, x769_p_1 += 34, x769_p_0 += 34){
		...
		for (c456 = c457, c456_p_0 = 0;
			...
			for (f = f254, fp_0 = 0;
				...
				for (y = y324, yp_0 = 0;
					...
					// T (x, 2) (34 / 17)
					for (x768 = x769, x768_p_2 = x769_p_1, x768_p_1 = x769_p_0, x768_p_0 = 0;
						x768 < x769 + 34;
						x768 += 17, x768_p_2 += 17, x768_p_1 += 17, x768_p_0 += 17){
						...
						for (h = h228, hp_0 = 0;
							...
							// T (x, 17) (17 / 1)
							for (x = x768, xp_3 = x768_p_2, xp_2 = x768_p_1, xp_1 = x768_p_0, xp_0 = 0;
								x < x768 + 17;
