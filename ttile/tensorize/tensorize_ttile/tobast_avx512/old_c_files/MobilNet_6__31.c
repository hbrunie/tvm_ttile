					...
					for (h = h188, hp_0 = 0;
						...
						for (x = x322, xp_1 = x322_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1692 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
									mem_vec_1693 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									mem_vec_1694 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
									mem_vec_1695 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
									mem_vec_1696 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
									mem_vec_1697 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
									...
									mem_vec_1702 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
									mem_vec_1703 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
									mem_vec_1704 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
									mem_vec_1705 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
									// y = 2, x = 1, h = 1, w = 3, c = 8, f = 128
									// T (c, 8) (8 / 1)
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_1692);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_1693);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_1694);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_1695);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_1696);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_1697);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_1702);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_1703);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_1704);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_1705);
						}
					}
				}
			}
