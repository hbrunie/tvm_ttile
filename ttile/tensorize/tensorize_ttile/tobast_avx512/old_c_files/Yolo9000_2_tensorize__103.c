...
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, x); T (68, y); T (8, c); T (68, x); T (2, x)]
*/
IND_TYPE c, cp_0, c306_p_0, cp_1, c306, w, wp_0, x, xp_0, x510_p_0, x511_p_0, x512_p_0, xp_1, x510_p_1, x511_p_1, xp_2, x510_p_2, xp_3, x510, x511, x512, y, yp_0;
IND_TYPE y204 = 0;
IND_TYPE x513 = 0;
IND_TYPE h = 0;
IND_TYPE w204 = 0;
...
x510_p_2 = 0;
					for (w = w204, wp_0 = 0;w < w204 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 1) (1 / 1)
						for (x = x510, xp_3 = x510_p_2, xp_2 = x510_p_1, xp_1 = x510_p_0, xp_0 = 0;x < x510 + 1;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c306, cp_1 = c306_p_0, cp_0 = 0;c < c306 + 4;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_1296);
										mem_vec_1296 = vec_24;
										vec_28 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_1297);
										mem_vec_1297 = vec_27;
										vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 32]);
										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_1298);
										mem_vec_1298 = vec_29;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_1299);
										mem_vec_1299 = vec_31;
										scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
										vec_34 = _mm512_set1_ps(scal_5);
										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_1300);
										mem_vec_1300 = vec_33;
										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_1301);
										mem_vec_1301 = vec_35;
										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1302);
										mem_vec_1302 = vec_36;
										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1303);
										mem_vec_1303 = vec_37;
										scal_6 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
										vec_39 = _mm512_set1_ps(scal_6);
										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_1304);
										mem_vec_1304 = vec_38;
										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_1305);
										mem_vec_1305 = vec_40;
										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_1306);
										mem_vec_1306 = vec_41;
										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_1307);
										mem_vec_1307 = vec_42;
										scal_7 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_7);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_1308);
										mem_vec_1308 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_1309);
										mem_vec_1309 = vec_45;
										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_1310);
										mem_vec_1310 = vec_46;
										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_1311);
										mem_vec_1311 = vec_47;
										scal_8 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_1296);
										mem_vec_1296 = vec_48;
										vec_52 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_1297);
										mem_vec_1297 = vec_51;
										vec_54 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 32]);
										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_1298);
										mem_vec_1298 = vec_53;
										vec_56 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_1299);
										mem_vec_1299 = vec_55;
										scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_9);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1300);
										mem_vec_1300 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_1301);
										mem_vec_1301 = vec_59;
										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_1302);
										mem_vec_1302 = vec_60;
										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_1303);
										mem_vec_1303 = vec_61;
										scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
										vec_63 = _mm512_set1_ps(scal_10);
										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_1304);
										mem_vec_1304 = vec_62;
										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_1305);
										mem_vec_1305 = vec_64;
										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_1306);
										mem_vec_1306 = vec_65;
										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_1307);
										mem_vec_1307 = vec_66;
										scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
										vec_68 = _mm512_set1_ps(scal_11);
										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_1308);
										mem_vec_1308 = vec_67;
										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_1309);
										mem_vec_1309 = vec_69;
										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_1310);
										mem_vec_1310 = vec_70;
										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_1311);
										mem_vec_1311 = vec_71;
									}
