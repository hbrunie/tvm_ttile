...
[V f; U (2, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, y); T (4, f); T (16, c); T (1, f); T (1, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c114_p_0, c115_p_0, cp_1, c114_p_1, cp_2, c114, c115, f, fp_0, f78_p_0, f79_p_0, fp_1, f78_p_1, fp_2, f78, f79, h, hp_0, x, xp_0, x94_p_0, xp_1, x94, y, yp_0;
IND_TYPE y64 = 0;
IND_TYPE x95 = 0;
IND_TYPE h44 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
							for (h = h44, hp_0 = 0;h < h44 + 3;h += 1, hp_0 += 1){
								...
								for (x = x94, xp_1 = x94_p_0, xp_0 = 0;x < x94 + 14;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 32) (32 / 1)
											for (c = c114, cp_2 = c114_p_1, cp_1 = c114_p_0, cp_0 = 0;c < c114 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
												...
												vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_602);
												mem_vec_602 = vec_23;
												vec_27 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
												vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_603);
												mem_vec_603 = vec_26;
												scal_8 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
												vec_29 = _mm512_set1_ps(scal_8);
												vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_604);
												mem_vec_604 = vec_28;
												vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_605);
												mem_vec_605 = vec_30;
												scal_9 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
												vec_32 = _mm512_set1_ps(scal_9);
												vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_606);
												mem_vec_606 = vec_31;
												vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_607);
												mem_vec_607 = vec_33;
												scal_10 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
												vec_35 = _mm512_set1_ps(scal_10);
												vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_608);
												mem_vec_608 = vec_34;
												vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_609);
												mem_vec_609 = vec_36;
												scal_11 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
												vec_38 = _mm512_set1_ps(scal_11);
												vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_610);
												mem_vec_610 = vec_37;
												vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_611);
												mem_vec_611 = vec_39;
												scal_12 = input[strideA1 * (x + w + 1) + strideA2 * (y + 5 + h) + c];
												vec_41 = _mm512_set1_ps(scal_12);
												vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_612);
												mem_vec_612 = vec_40;
												vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_613);
												mem_vec_613 = vec_42;
												scal_13 = input[strideA1 * (x + w + 1) + strideA2 * (y + 6 + h) + c];
												vec_44 = _mm512_set1_ps(scal_13);
												vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_614);
												mem_vec_614 = vec_43;
												vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_615);
												mem_vec_615 = vec_45;
												scal_14 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
												vec_47 = _mm512_set1_ps(scal_14);
												vec_48 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
												vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_602);
												mem_vec_602 = vec_46;
												vec_50 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
												vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_603);
												mem_vec_603 = vec_49;
												scal_15 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
												vec_52 = _mm512_set1_ps(scal_15);
												vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_604);
												mem_vec_604 = vec_51;
												vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_605);
												mem_vec_605 = vec_53;
												scal_16 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
												vec_55 = _mm512_set1_ps(scal_16);
												vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_606);
												mem_vec_606 = vec_54;
												vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_607);
												mem_vec_607 = vec_56;
												scal_17 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
												vec_58 = _mm512_set1_ps(scal_17);
												vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_608);
												mem_vec_608 = vec_57;
												vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_609);
												mem_vec_609 = vec_59;
												scal_18 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
												vec_61 = _mm512_set1_ps(scal_18);
												vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_610);
												mem_vec_610 = vec_60;
												vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_611);
												mem_vec_611 = vec_62;
												scal_19 = input[strideA1 * (x + w + 2) + strideA2 * (y + 5 + h) + c];
												vec_64 = _mm512_set1_ps(scal_19);
												vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_612);
												mem_vec_612 = vec_63;
												vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_613);
												mem_vec_613 = vec_65;
												scal_20 = input[strideA1 * (x + w + 2) + strideA2 * (y + 6 + h) + c];
												vec_67 = _mm512_set1_ps(scal_20);
												vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_614);
												mem_vec_614 = vec_66;
												vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_615);
												mem_vec_615 = vec_68;
											}
