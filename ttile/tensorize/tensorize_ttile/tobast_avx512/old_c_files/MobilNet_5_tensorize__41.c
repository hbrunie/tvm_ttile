...
fp_2 = 0;
						for (h = h70, hp_0 = 0;h < h70 + 3;h += 1, hp_0 += 1){
							...
							for (x = x156, xp_1 = x156_p_0, xp_0 = 0;x < x156 + 2;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_931 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_932 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_933 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_931);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_932);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_933);
							}
						}
}
