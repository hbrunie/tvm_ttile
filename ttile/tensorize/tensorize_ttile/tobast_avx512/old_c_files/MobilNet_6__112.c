...
[V f; U (2, f); ULambda y; U (3, w); T (64, c); Hoist_vars [c]; T (14, x);
  ...
  T (1, f); T (1, c); T (8, f); T (4, c); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c994_p_0, c995_p_0, cp_1, c994_p_1, cp_2, c994, c995, f, fp_0, f970_p_0, f971_p_0, fp_1, f970_p_1, fp_2, f970, f971, h, hp_0, x, xp_0, x808_p_0, xp_1, x808, y, yp_0;
...
// T (f, 1) (256 / 256)
for (f971 = f972, f971_p_0 = 0;
	f971 < f972 + 256;
	f971 += 256, f971_p_0 += 256){
	// y = 14, x = 14, h = 3, w = 3, c = 256, f = 256
	// T (x, 1) (14 / 14)
	for (x808 = x809, x808_p_0 = 0;
		...
		for (c995 = c996, c995_p_0 = 0;
			...
			// T (f, 8) (256 / 32)
			for (f970 = f971, f970_p_1 = f971_p_0, f970_p_0 = 0;
				f970 < f971 + 256;
				f970 += 32, f970_p_1 += 32, f970_p_0 += 32){
				// y = 14, x = 14, h = 3, w = 3, c = 64, f = 32
				// T (c, 1) (64 / 64)
				for (c994 = c995, c994_p_1 = c995_p_0, c994_p_0 = 0;
					c994 < c995 + 64;
					c994 += 64, c994_p_1 += 64, c994_p_0 += 64){
					// y = 14, x = 14, h = 3, w = 3, c = 64, f = 32
					// T (f, 1) (32 / 32)
					for (f = f970, fp_2 = f970_p_1, fp_1 = f970_p_0, fp_0 = 0;
						f < f970 + 32;
									...
									for (x = x808, xp_1 = x808_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c994, cp_2 = c994_p_1, cp_1 = c994_p_0, cp_0 = 0;
													...
													vec_17 = _mm512_fmadd_ps(vec_18, vec_19, mem_vec_5332);
													mem_vec_5332 = vec_17;

													vec_21 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_20 = _mm512_fmadd_ps(vec_18, vec_21, mem_vec_5333);
													mem_vec_5333 = vec_20;
													scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
													vec_23 = _mm512_set1_ps(scal_6);


													vec_22 = _mm512_fmadd_ps(vec_23, vec_19, mem_vec_5334);
													mem_vec_5334 = vec_22;



													vec_24 = _mm512_fmadd_ps(vec_23, vec_21, mem_vec_5335);
													mem_vec_5335 = vec_24;
													scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
													vec_26 = _mm512_set1_ps(scal_7);


													vec_25 = _mm512_fmadd_ps(vec_26, vec_19, mem_vec_5336);
													mem_vec_5336 = vec_25;



													vec_27 = _mm512_fmadd_ps(vec_26, vec_21, mem_vec_5337);
													mem_vec_5337 = vec_27;
													scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
													vec_29 = _mm512_set1_ps(scal_8);


													vec_28 = _mm512_fmadd_ps(vec_29, vec_19, mem_vec_5338);
													mem_vec_5338 = vec_28;



													vec_30 = _mm512_fmadd_ps(vec_29, vec_21, mem_vec_5339);
													mem_vec_5339 = vec_30;
													scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
													vec_32 = _mm512_set1_ps(scal_9);


													vec_31 = _mm512_fmadd_ps(vec_32, vec_19, mem_vec_5340);
													mem_vec_5340 = vec_31;



													vec_33 = _mm512_fmadd_ps(vec_32, vec_21, mem_vec_5341);
													mem_vec_5341 = vec_33;
													scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
													vec_35 = _mm512_set1_ps(scal_10);
													vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_34 = _mm512_fmadd_ps(vec_35, vec_36, mem_vec_5332);
													mem_vec_5332 = vec_34;

													vec_38 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_37 = _mm512_fmadd_ps(vec_35, vec_38, mem_vec_5333);
													mem_vec_5333 = vec_37;
													scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
													vec_40 = _mm512_set1_ps(scal_11);


													vec_39 = _mm512_fmadd_ps(vec_40, vec_36, mem_vec_5334);
													mem_vec_5334 = vec_39;



													vec_41 = _mm512_fmadd_ps(vec_40, vec_38, mem_vec_5335);
													mem_vec_5335 = vec_41;
													scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
													vec_43 = _mm512_set1_ps(scal_12);


													vec_42 = _mm512_fmadd_ps(vec_43, vec_36, mem_vec_5336);
													mem_vec_5336 = vec_42;



													vec_44 = _mm512_fmadd_ps(vec_43, vec_38, mem_vec_5337);
													mem_vec_5337 = vec_44;
													scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
													vec_46 = _mm512_set1_ps(scal_13);


													vec_45 = _mm512_fmadd_ps(vec_46, vec_36, mem_vec_5338);
													mem_vec_5338 = vec_45;



													vec_47 = _mm512_fmadd_ps(vec_46, vec_38, mem_vec_5339);
													mem_vec_5339 = vec_47;
													scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
													vec_49 = _mm512_set1_ps(scal_14);


													vec_48 = _mm512_fmadd_ps(vec_49, vec_36, mem_vec_5340);
													mem_vec_5340 = vec_48;



													vec_50 = _mm512_fmadd_ps(vec_49, vec_38, mem_vec_5341);
													mem_vec_5341 = vec_50;
												}
								...
								for (h = h482, hp_0 = 0;
									...
									for (x = x808, xp_1 = x808_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_5358 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
												mem_vec_5359 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 3, c = 64, f = 32
												// T (c, 64) (64 / 1)
												for (c = c994, cp_2 = c994_p_1, cp_1 = c994_p_0, cp_0 = 0;
													c < c994 + 64;
													...
													vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_5358);
													mem_vec_5358 = vec_26;



													vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_5359);
													mem_vec_5359 = vec_28;
													scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * y + h) + c];
													vec_30 = _mm512_set1_ps(scal_9);
													vec_31 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

													vec_29 = _mm512_fmadd_ps(vec_30, vec_31, mem_vec_5342);
													mem_vec_5342 = vec_29;

													vec_33 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_5343);
													mem_vec_5343 = vec_32;
													scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
													vec_35 = _mm512_set1_ps(scal_10);


													vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_5344);
													mem_vec_5344 = vec_34;



													vec_36 = _mm512_fmadd_ps(vec_35, vec_33, mem_vec_5345);
													mem_vec_5345 = vec_36;
													scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
													vec_38 = _mm512_set1_ps(scal_11);


													vec_37 = _mm512_fmadd_ps(vec_38, vec_31, mem_vec_5346);
													mem_vec_5346 = vec_37;



													vec_39 = _mm512_fmadd_ps(vec_38, vec_33, mem_vec_5347);
													mem_vec_5347 = vec_39;
													scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
													vec_41 = _mm512_set1_ps(scal_12);


													vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_5348);
													mem_vec_5348 = vec_40;



													vec_42 = _mm512_fmadd_ps(vec_41, vec_33, mem_vec_5349);
													mem_vec_5349 = vec_42;
													scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
													vec_44 = _mm512_set1_ps(scal_13);


													vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_5350);
													mem_vec_5350 = vec_43;



													vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_5351);
													mem_vec_5351 = vec_45;
													scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
													vec_47 = _mm512_set1_ps(scal_14);


													vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_5352);
													mem_vec_5352 = vec_46;



													vec_48 = _mm512_fmadd_ps(vec_47, vec_33, mem_vec_5353);
													mem_vec_5353 = vec_48;
													scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h) + c];
													vec_50 = _mm512_set1_ps(scal_15);


													vec_49 = _mm512_fmadd_ps(vec_50, vec_31, mem_vec_5354);
													mem_vec_5354 = vec_49;



													vec_51 = _mm512_fmadd_ps(vec_50, vec_33, mem_vec_5355);
													mem_vec_5355 = vec_51;
													scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h) + c];
													vec_53 = _mm512_set1_ps(scal_16);


													vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_5356);
													mem_vec_5356 = vec_52;



													vec_54 = _mm512_fmadd_ps(vec_53, vec_33, mem_vec_5357);
													mem_vec_5357 = vec_54;
													scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h) + c];
													vec_56 = _mm512_set1_ps(scal_17);


													vec_55 = _mm512_fmadd_ps(vec_56, vec_31, mem_vec_5358);
													mem_vec_5358 = vec_55;



													vec_57 = _mm512_fmadd_ps(vec_56, vec_33, mem_vec_5359);
													mem_vec_5359 = vec_57;
													scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
													vec_59 = _mm512_set1_ps(scal_18);
													vec_60 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_58 = _mm512_fmadd_ps(vec_59, vec_60, mem_vec_5342);
													mem_vec_5342 = vec_58;

													vec_62 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_5343);
													mem_vec_5343 = vec_61;
													scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
													vec_64 = _mm512_set1_ps(scal_19);


													vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_5344);
													mem_vec_5344 = vec_63;



													vec_65 = _mm512_fmadd_ps(vec_64, vec_62, mem_vec_5345);
													mem_vec_5345 = vec_65;
													scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
													vec_67 = _mm512_set1_ps(scal_20);


													vec_66 = _mm512_fmadd_ps(vec_67, vec_60, mem_vec_5346);
													mem_vec_5346 = vec_66;



													vec_68 = _mm512_fmadd_ps(vec_67, vec_62, mem_vec_5347);
													mem_vec_5347 = vec_68;
													scal_21 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
													vec_70 = _mm512_set1_ps(scal_21);


													vec_69 = _mm512_fmadd_ps(vec_70, vec_60, mem_vec_5348);
													mem_vec_5348 = vec_69;



													vec_71 = _mm512_fmadd_ps(vec_70, vec_62, mem_vec_5349);
													mem_vec_5349 = vec_71;
													scal_22 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
													vec_73 = _mm512_set1_ps(scal_22);


													vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_5350);
													mem_vec_5350 = vec_72;



													vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_5351);
													mem_vec_5351 = vec_74;
													scal_23 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
													vec_76 = _mm512_set1_ps(scal_23);


													vec_75 = _mm512_fmadd_ps(vec_76, vec_60, mem_vec_5352);
													mem_vec_5352 = vec_75;



													vec_77 = _mm512_fmadd_ps(vec_76, vec_62, mem_vec_5353);
													mem_vec_5353 = vec_77;
													scal_24 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
													vec_79 = _mm512_set1_ps(scal_24);


													vec_78 = _mm512_fmadd_ps(vec_79, vec_60, mem_vec_5354);
													mem_vec_5354 = vec_78;



													vec_80 = _mm512_fmadd_ps(vec_79, vec_62, mem_vec_5355);
													mem_vec_5355 = vec_80;
													scal_25 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h) + c];
													vec_82 = _mm512_set1_ps(scal_25);


													vec_81 = _mm512_fmadd_ps(vec_82, vec_60, mem_vec_5356);
													mem_vec_5356 = vec_81;



													vec_83 = _mm512_fmadd_ps(vec_82, vec_62, mem_vec_5357);
													mem_vec_5357 = vec_83;
													scal_26 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h) + c];
													vec_85 = _mm512_set1_ps(scal_26);


													vec_84 = _mm512_fmadd_ps(vec_85, vec_60, mem_vec_5358);
													mem_vec_5358 = vec_84;



													vec_86 = _mm512_fmadd_ps(vec_85, vec_62, mem_vec_5359);
													mem_vec_5359 = vec_86;
												}
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_5358);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_5359);
									}
								}
							}
					}
