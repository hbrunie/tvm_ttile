...
fp_1 = 0;
						for (w = w214, wp_0 = 0;w < w214 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 4) (4 / 1)
							for (x = x396, xp_1 = x396_p_0, xp_0 = 0;x < x396 + 4;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_2720 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_2721 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										...
										mem_vec_2725 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										...
										mem_vec_2729 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_2730 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2721);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_2725);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_2729);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_2730);
							}
						}
}
