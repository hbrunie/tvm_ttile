...
y676 = 0;
y676_p_0 = 0;
		for (x766 = x767, x766_p_1 = x767_p_0, x766_p_0 = 0;x766 < x767 + 32;x766 += 4, x766_p_1 += 4, x766_p_0 += 4){
				for (y = y676, yp_1 = y676_p_0, yp_0 = 0;y < y676 + 4;y += 4, yp_1 += 4, yp_0 += 4){
					// y = ph_y, x = 4, h = 3, w = 3, c = 3, f = 32
					// T (h, 3) (3 / 1)
					for (h = h294, hp_0 = 0;h < h294 + 3;h += 1, hp_0 += 1){
						// y = ph_y, x = 4, h = 1, w = 3, c = 3, f = 32
						// T (x, 4) (4 / 1)
						for (x = x766, xp_2 = x766_p_1, xp_1 = x766_p_0, xp_0 = 0;x < x766 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c412, cp_0 = 0;c < c412 + 3;c += 1, cp_0 += 1){
				...
				for (y = y676 + 4, yp_1 = y676_p_0, yp_0 = 0;y < y676 + 4 + 12;y += 6, yp_1 += 6, yp_0 += 6){
					// y = ph_y, x = 4, h = 3, w = 3, c = 3, f = 32
					// T (h, 3) (3 / 1)
					for (h = h294, hp_0 = 0;h < h294 + 3;h += 1, hp_0 += 1){
						// y = ph_y, x = 4, h = 1, w = 3, c = 3, f = 32
