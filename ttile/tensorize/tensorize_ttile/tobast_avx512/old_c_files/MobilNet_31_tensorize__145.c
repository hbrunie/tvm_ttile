...
yp_0 = 0;
							for (w = w302, wp_0 = 0;w < w302 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x616, xp_1 = x616_p_0, xp_0 = 0;x < x616 + 14;x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_3336 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
											mem_vec_3337 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											...
											mem_vec_3341 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_3337);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3341);
								}
							}
}
