...
[V f; U (1, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (2, f); T (16, c); T (1, y); T (16, f)]
*/
IND_TYPE c, cp_0, c348_p_0, cp_1, c348, f, fp_0, f288_p_0, fp_1, f288, h, hp_0, x, xp_0, y, yp_0;
IND_TYPE y154 = 0;
IND_TYPE x212 = 0;
IND_TYPE h150 = 0;
IND_TYPE w = 0;
...
fp_1 = 0;
				for (h = h150, hp_0 = 0;h < h150 + 3;h += 1, hp_0 += 1){
					...
					for (x = x212, xp_0 = 0;x < x212 + 7;x += 1, xp_0 += 1){
								...
								mem_vec_1625 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_1626 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								mem_vec_1627 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								mem_vec_1628 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
								mem_vec_1629 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
