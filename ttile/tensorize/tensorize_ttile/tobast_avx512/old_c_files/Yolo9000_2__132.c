...
for (x660 = x661, x660_p_0 = 0;
	x660 < x661 + 272;
	x660 += 136, x660_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 2) (136 / 68)
	for (x659 = x660, x659_p_1 = x660_p_0, x659_p_0 = 0;
		x659 < x660 + 136;
		x659 += 68, x659_p_1 += 68, x659_p_0 += 68){
		...
		for (c390 = c391, c390_p_0 = 0;
			...
			for (f = f210, fp_0 = 0;
				...
				for (y = y280, yp_0 = 0;
					...
					// T (x, 34) (68 / 2)
					for (x658 = x659, x658_p_2 = x659_p_1, x658_p_1 = x659_p_0, x658_p_0 = 0;
						x658 < x659 + 68;
						x658 += 2, x658_p_2 += 2, x658_p_1 += 2, x658_p_0 += 2){
						...
						for (h = h184, hp_0 = 0;
							...
							// T (x, 2) (2 / 1)
							for (x = x658, xp_3 = x658_p_2, xp_2 = x658_p_1, xp_1 = x658_p_0, xp_0 = 0;
								x < x658 + 2;
