...
c920_p_1 = 0;
					for (w = w408, wp_0 = 0;w < w408 + 3;w += 1, wp_0 += 1){
						...
						for (x = x544, xp_0 = 0;x < x544 + 7;x += 1, xp_0 += 1){
									...
									mem_vec_4482 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
									mem_vec_4483 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_4482);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_4483);
						}
					}
}
