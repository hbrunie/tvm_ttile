...
[V f; U (2, f); U (8, y); U (3, h); T (2, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, x); T (17, y); T (4, f); T (32, c); T (68, x)]
*/
IND_TYPE c, cp_0, c96_p_0, cp_1, c96, f, fp_0, w, wp_0, x, xp_0, x126_p_0, x127_p_0, xp_1, x126_p_1, xp_2, x126, x127, y, yp_0;
IND_TYPE y64 = 0;
IND_TYPE x128 = 0;
IND_TYPE h = 0;
IND_TYPE w64 = 0;
...
x126_p_1 = 0;
					for (w = w64, wp_0 = 0;w < w64 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 2) (2 / 1)
						for (x = x126, xp_2 = x126_p_1, xp_1 = x126_p_0, xp_0 = 0;x < x126 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c96, cp_1 = c96_p_0, cp_0 = 0;c < c96 + 2;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_496);
										mem_vec_496 = vec_26;
										vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
										vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_497);
										mem_vec_497 = vec_29;
										scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);
										vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_498);
										mem_vec_498 = vec_31;
										vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_499);
										mem_vec_499 = vec_33;
										scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);
										vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_500);
										mem_vec_500 = vec_34;
										vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_501);
										mem_vec_501 = vec_36;
										scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_502);
										mem_vec_502 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_503);
										mem_vec_503 = vec_39;
										scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_504);
										mem_vec_504 = vec_40;
										vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_505);
										mem_vec_505 = vec_42;
										scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_506);
										mem_vec_506 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_507);
										mem_vec_507 = vec_45;
										scal_14 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_508);
										mem_vec_508 = vec_46;
										vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_509);
										mem_vec_509 = vec_48;
										scal_15 = input[strideA1 * (x + w) + strideA2 * (y + 7 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);
										vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_510);
										mem_vec_510 = vec_49;
										vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_511);
										mem_vec_511 = vec_51;
										scal_16 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
										vec_53 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
										vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_496);
										mem_vec_496 = vec_52;
										vec_56 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
										vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_497);
										mem_vec_497 = vec_55;
										scal_17 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_498);
										mem_vec_498 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_499);
										mem_vec_499 = vec_59;
										scal_18 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
										vec_61 = _mm512_set1_ps(scal_18);
										vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_500);
										mem_vec_500 = vec_60;
										vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_501);
										mem_vec_501 = vec_62;
										scal_19 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);
										vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_502);
										mem_vec_502 = vec_63;
										vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_503);
										mem_vec_503 = vec_65;
										scal_20 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);
										vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_504);
										mem_vec_504 = vec_66;
										vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_505);
										mem_vec_505 = vec_68;
										scal_21 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 2) + c];
										vec_70 = _mm512_set1_ps(scal_21);
										vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_506);
										mem_vec_506 = vec_69;
										vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_507);
										mem_vec_507 = vec_71;
										scal_22 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 2) + c];
										vec_73 = _mm512_set1_ps(scal_22);
										vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_508);
										mem_vec_508 = vec_72;
										vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_509);
										mem_vec_509 = vec_74;
										scal_23 = input[strideA1 * (x + w) + strideA2 * (y + 7 + h + 2) + c];
										vec_76 = _mm512_set1_ps(scal_23);
										vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_510);
										mem_vec_510 = vec_75;
										vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_511);
										mem_vec_511 = vec_77;
									}
