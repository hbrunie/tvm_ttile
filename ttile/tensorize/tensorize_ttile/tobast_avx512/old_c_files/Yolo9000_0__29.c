...
/*
[V f; U (2, f); ULambda y; U (3, h); T (3, c); Hoist_vars [c]; T (34, x);
  T (3, w); Lambda_apply y [((Iter 1), (Arg 6)); ((Iter 2), (Arg 13))];
  T (8, x); T (17, y); T (2, x)]
*/
IND_TYPE c, cp_0, w, wp_0, x, xp_0, x574_p_0, x575_p_0, xp_1, x574_p_1, xp_2, x574, x575, y, yp_0, y532_p_0, yp_1, y532;
...
for (x575 = x576, x575_p_0 = 0;
	...
	for (y532 = y533, y532_p_0 = 0;
		...
		for (x574 = x575, x574_p_1 = x575_p_0, x574_p_0 = 0;
			x574 < x575 + 272;
			x574 += 34, x574_p_1 += 34, x574_p_0 += 34){
						...
						for (x = x574, xp_2 = x574_p_1, xp_1 = x574_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c316, cp_0 = 0;
										...
										vec_20 = _mm512_fmadd_ps(vec_21, vec_22, mem_vec_4104);
										mem_vec_4104 = vec_20;

										vec_24 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_23 = _mm512_fmadd_ps(vec_21, vec_24, mem_vec_4105);
										mem_vec_4105 = vec_23;
										scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_26 = _mm512_set1_ps(scal_7);


										vec_25 = _mm512_fmadd_ps(vec_26, vec_22, mem_vec_4106);
										mem_vec_4106 = vec_25;



										vec_27 = _mm512_fmadd_ps(vec_26, vec_24, mem_vec_4107);
										mem_vec_4107 = vec_27;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_8);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_22, mem_vec_4108);
										mem_vec_4108 = vec_28;



										vec_30 = _mm512_fmadd_ps(vec_29, vec_24, mem_vec_4109);
										mem_vec_4109 = vec_30;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_22, mem_vec_4110);
										mem_vec_4110 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_24, mem_vec_4111);
										mem_vec_4111 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_22, mem_vec_4112);
										mem_vec_4112 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_24, mem_vec_4113);
										mem_vec_4113 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_22, mem_vec_4114);
										mem_vec_4114 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_24, mem_vec_4115);
										mem_vec_4115 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_40 = _mm512_fmadd_ps(vec_41, vec_42, mem_vec_4104);
										mem_vec_4104 = vec_40;

										vec_44 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_43 = _mm512_fmadd_ps(vec_41, vec_44, mem_vec_4105);
										mem_vec_4105 = vec_43;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_46 = _mm512_set1_ps(scal_13);


										vec_45 = _mm512_fmadd_ps(vec_46, vec_42, mem_vec_4106);
										mem_vec_4106 = vec_45;



										vec_47 = _mm512_fmadd_ps(vec_46, vec_44, mem_vec_4107);
										mem_vec_4107 = vec_47;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_49 = _mm512_set1_ps(scal_14);


										vec_48 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_4108);
										mem_vec_4108 = vec_48;



										vec_50 = _mm512_fmadd_ps(vec_49, vec_44, mem_vec_4109);
										mem_vec_4109 = vec_50;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_52 = _mm512_set1_ps(scal_15);


										vec_51 = _mm512_fmadd_ps(vec_52, vec_42, mem_vec_4110);
										mem_vec_4110 = vec_51;



										vec_53 = _mm512_fmadd_ps(vec_52, vec_44, mem_vec_4111);
										mem_vec_4111 = vec_53;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_55 = _mm512_set1_ps(scal_16);


										vec_54 = _mm512_fmadd_ps(vec_55, vec_42, mem_vec_4112);
										mem_vec_4112 = vec_54;



										vec_56 = _mm512_fmadd_ps(vec_55, vec_44, mem_vec_4113);
										mem_vec_4113 = vec_56;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_42, mem_vec_4114);
										mem_vec_4114 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_44, mem_vec_4115);
										mem_vec_4115 = vec_59;
									}
				...
				for (y = y532 + 6, yp_1 = y532_p_0, yp_0 = 0;
					y < y532 + 6 + 26;
						...
						for (x = x574, xp_2 = x574_p_1, xp_1 = x574_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c316, cp_0 = 0;
										...
										vec_41 = _mm512_fmadd_ps(vec_42, vec_43, mem_vec_4116);
										mem_vec_4116 = vec_41;

										vec_45 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_44 = _mm512_fmadd_ps(vec_42, vec_45, mem_vec_4117);
										mem_vec_4117 = vec_44;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_14);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_43, mem_vec_4118);
										mem_vec_4118 = vec_46;



										vec_48 = _mm512_fmadd_ps(vec_47, vec_45, mem_vec_4119);
										mem_vec_4119 = vec_48;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_43, mem_vec_4120);
										mem_vec_4120 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_45, mem_vec_4121);
										mem_vec_4121 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_53 = _mm512_set1_ps(scal_16);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_43, mem_vec_4122);
										mem_vec_4122 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_45, mem_vec_4123);
										mem_vec_4123 = vec_54;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_56 = _mm512_set1_ps(scal_17);


										vec_55 = _mm512_fmadd_ps(vec_56, vec_43, mem_vec_4124);
										mem_vec_4124 = vec_55;



										vec_57 = _mm512_fmadd_ps(vec_56, vec_45, mem_vec_4125);
										mem_vec_4125 = vec_57;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_59 = _mm512_set1_ps(scal_18);


										vec_58 = _mm512_fmadd_ps(vec_59, vec_43, mem_vec_4126);
										mem_vec_4126 = vec_58;



										vec_60 = _mm512_fmadd_ps(vec_59, vec_45, mem_vec_4127);
										mem_vec_4127 = vec_60;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_62 = _mm512_set1_ps(scal_19);


										vec_61 = _mm512_fmadd_ps(vec_62, vec_43, mem_vec_4128);
										mem_vec_4128 = vec_61;



										vec_63 = _mm512_fmadd_ps(vec_62, vec_45, mem_vec_4129);
										mem_vec_4129 = vec_63;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_65 = _mm512_set1_ps(scal_20);


										vec_64 = _mm512_fmadd_ps(vec_65, vec_43, mem_vec_4130);
										mem_vec_4130 = vec_64;



										vec_66 = _mm512_fmadd_ps(vec_65, vec_45, mem_vec_4131);
										mem_vec_4131 = vec_66;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
										vec_68 = _mm512_set1_ps(scal_21);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_43, mem_vec_4132);
										mem_vec_4132 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_45, mem_vec_4133);
										mem_vec_4133 = vec_69;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
										vec_71 = _mm512_set1_ps(scal_22);


										vec_70 = _mm512_fmadd_ps(vec_71, vec_43, mem_vec_4134);
										mem_vec_4134 = vec_70;



										vec_72 = _mm512_fmadd_ps(vec_71, vec_45, mem_vec_4135);
										mem_vec_4135 = vec_72;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
										vec_74 = _mm512_set1_ps(scal_23);


										vec_73 = _mm512_fmadd_ps(vec_74, vec_43, mem_vec_4136);
										mem_vec_4136 = vec_73;



										vec_75 = _mm512_fmadd_ps(vec_74, vec_45, mem_vec_4137);
										mem_vec_4137 = vec_75;
										scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
										vec_77 = _mm512_set1_ps(scal_24);


										vec_76 = _mm512_fmadd_ps(vec_77, vec_43, mem_vec_4138);
										mem_vec_4138 = vec_76;



										vec_78 = _mm512_fmadd_ps(vec_77, vec_45, mem_vec_4139);
										mem_vec_4139 = vec_78;
										scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
										vec_80 = _mm512_set1_ps(scal_25);


										vec_79 = _mm512_fmadd_ps(vec_80, vec_43, mem_vec_4140);
										mem_vec_4140 = vec_79;



										vec_81 = _mm512_fmadd_ps(vec_80, vec_45, mem_vec_4141);
										mem_vec_4141 = vec_81;
										scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_83 = _mm512_set1_ps(scal_26);
										vec_84 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_82 = _mm512_fmadd_ps(vec_83, vec_84, mem_vec_4116);
										mem_vec_4116 = vec_82;

										vec_86 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_85 = _mm512_fmadd_ps(vec_83, vec_86, mem_vec_4117);
										mem_vec_4117 = vec_85;
										scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_88 = _mm512_set1_ps(scal_27);


										vec_87 = _mm512_fmadd_ps(vec_88, vec_84, mem_vec_4118);
										mem_vec_4118 = vec_87;



										vec_89 = _mm512_fmadd_ps(vec_88, vec_86, mem_vec_4119);
										mem_vec_4119 = vec_89;
										scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_91 = _mm512_set1_ps(scal_28);


										vec_90 = _mm512_fmadd_ps(vec_91, vec_84, mem_vec_4120);
										mem_vec_4120 = vec_90;



										vec_92 = _mm512_fmadd_ps(vec_91, vec_86, mem_vec_4121);
										mem_vec_4121 = vec_92;
										scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_94 = _mm512_set1_ps(scal_29);


										vec_93 = _mm512_fmadd_ps(vec_94, vec_84, mem_vec_4122);
										mem_vec_4122 = vec_93;



										vec_95 = _mm512_fmadd_ps(vec_94, vec_86, mem_vec_4123);
										mem_vec_4123 = vec_95;
										scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_97 = _mm512_set1_ps(scal_30);


										vec_96 = _mm512_fmadd_ps(vec_97, vec_84, mem_vec_4124);
										mem_vec_4124 = vec_96;



										vec_98 = _mm512_fmadd_ps(vec_97, vec_86, mem_vec_4125);
										mem_vec_4125 = vec_98;
										scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_100 = _mm512_set1_ps(scal_31);


										vec_99 = _mm512_fmadd_ps(vec_100, vec_84, mem_vec_4126);
										mem_vec_4126 = vec_99;



										vec_101 = _mm512_fmadd_ps(vec_100, vec_86, mem_vec_4127);
										mem_vec_4127 = vec_101;
										scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_103 = _mm512_set1_ps(scal_32);


										vec_102 = _mm512_fmadd_ps(vec_103, vec_84, mem_vec_4128);
										mem_vec_4128 = vec_102;



										vec_104 = _mm512_fmadd_ps(vec_103, vec_86, mem_vec_4129);
										mem_vec_4129 = vec_104;
										scal_33 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_106 = _mm512_set1_ps(scal_33);


										vec_105 = _mm512_fmadd_ps(vec_106, vec_84, mem_vec_4130);
										mem_vec_4130 = vec_105;



										vec_107 = _mm512_fmadd_ps(vec_106, vec_86, mem_vec_4131);
										mem_vec_4131 = vec_107;
										scal_34 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
										vec_109 = _mm512_set1_ps(scal_34);


										vec_108 = _mm512_fmadd_ps(vec_109, vec_84, mem_vec_4132);
										mem_vec_4132 = vec_108;



										vec_110 = _mm512_fmadd_ps(vec_109, vec_86, mem_vec_4133);
										mem_vec_4133 = vec_110;
										scal_35 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
										vec_112 = _mm512_set1_ps(scal_35);


										vec_111 = _mm512_fmadd_ps(vec_112, vec_84, mem_vec_4134);
										mem_vec_4134 = vec_111;



										vec_113 = _mm512_fmadd_ps(vec_112, vec_86, mem_vec_4135);
										mem_vec_4135 = vec_113;
										scal_36 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
										vec_115 = _mm512_set1_ps(scal_36);


										vec_114 = _mm512_fmadd_ps(vec_115, vec_84, mem_vec_4136);
										mem_vec_4136 = vec_114;



										vec_116 = _mm512_fmadd_ps(vec_115, vec_86, mem_vec_4137);
										mem_vec_4137 = vec_116;
										scal_37 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 2) + c];
										vec_118 = _mm512_set1_ps(scal_37);


										vec_117 = _mm512_fmadd_ps(vec_118, vec_84, mem_vec_4138);
										mem_vec_4138 = vec_117;



										vec_119 = _mm512_fmadd_ps(vec_118, vec_86, mem_vec_4139);
										mem_vec_4139 = vec_119;
										scal_38 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 2) + c];
										vec_121 = _mm512_set1_ps(scal_38);


										vec_120 = _mm512_fmadd_ps(vec_121, vec_84, mem_vec_4140);
										mem_vec_4140 = vec_120;



										vec_122 = _mm512_fmadd_ps(vec_121, vec_86, mem_vec_4141);
										mem_vec_4141 = vec_122;
									}
