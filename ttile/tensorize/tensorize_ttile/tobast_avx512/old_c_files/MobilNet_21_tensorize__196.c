...
x870_p_1 = 0;
						for (h = h322, hp_0 = 0;h < h322 + 3;h += 1, hp_0 += 1){
							...
							for (x = x870, xp_2 = x870_p_1, xp_1 = x870_p_0, xp_0 = 0;x < x870 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5946 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_5947 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5946);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16], mem_vec_5947);
