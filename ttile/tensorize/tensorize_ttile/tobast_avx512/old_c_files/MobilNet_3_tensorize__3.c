...
yp_0 = 0;
						for (w = w100, wp_0 = 0;w < w100 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 56) (56 / 1)
							for (x = x172, xp_1 = x172_p_0, xp_0 = 0;x < x172 + 56;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_737 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										mem_vec_738 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_739 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_737);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_738);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_739);
							}
						}
}
