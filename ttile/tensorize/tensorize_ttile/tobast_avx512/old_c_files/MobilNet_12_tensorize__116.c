...
x536_p_1 = 0;
						for (w = w234, wp_0 = 0;w < w234 + 3;w += 1, wp_0 += 1){
							...
							for (x = x536, xp_2 = x536_p_1, xp_1 = x536_p_0, xp_0 = 0;x < x536 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3188 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_3189 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3188);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3189);
