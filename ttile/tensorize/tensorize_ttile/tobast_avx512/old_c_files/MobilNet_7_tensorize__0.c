...
/*
[V f; U (2, f); U (7, y); U (3, w); T (2, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, y); T (1, f); T (2, c); T (4, f); T (128, c); T (1, x);
  T (4, f)]
*/
IND_TYPE c, cp_0, c162_p_0, c163_p_0, cp_1, c162_p_1, cp_2, c162, c163, f, fp_0, f126_p_0, f127_p_0, fp_1, f126_p_1, fp_2, f126, f127, h, hp_0, x, xp_0, x130_p_0, xp_1, x130, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x131 = 0;
IND_TYPE h68 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
							for (h = h68, hp_0 = 0;h < h68 + 3;h += 1, hp_0 += 1){
								...
								for (x = x130, xp_1 = x130_p_0, xp_0 = 0;x < x130 + 14;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 2) (2 / 1)
											for (c = c162, cp_2 = c162_p_1, cp_1 = c162_p_0, cp_0 = 0;c < c162 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
