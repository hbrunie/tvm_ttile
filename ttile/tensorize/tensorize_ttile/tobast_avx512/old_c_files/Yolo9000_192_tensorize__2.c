...
c672_p_1 = 0;
						for (x = x504, xp_1 = x504_p_0, xp_0 = 0;x < x504 + 17;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_5382 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
									mem_vec_5383 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 64
									// T (c, 16) (16 / 1)
									for (c = c672, cp_2 = c672_p_1, cp_1 = c672_p_0, cp_0 = 0;c < c672 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_5382);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_5383);
						}
}
