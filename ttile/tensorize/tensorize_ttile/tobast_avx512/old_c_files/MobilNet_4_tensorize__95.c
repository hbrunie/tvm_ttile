...
[V f; U (4, f); U (2, y); U (3, w); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (2, f); T (16, c); T (28, x); T (14, y); T (1, f)]
*/
					...
					for (h = h96, hp_0 = 0;h < h96 + 3;h += 1, hp_0 += 1){
						...
						for (x = x180, xp_1 = x180_p_0, xp_0 = 0;x < x180 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c180, cp_1 = c180_p_0, cp_0 = 0;c < c180 + 8;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_784);
										mem_vec_784 = vec_14;
										vec_18 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_785);
										mem_vec_785 = vec_17;
										vec_20 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
										vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_786);
										mem_vec_786 = vec_19;
										vec_22 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
										vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_787);
										mem_vec_787 = vec_21;
										scal_3 = input[strideA1 * (2 * x + w + 1) + strideA2 * (2 * (y + 1) + h) + c];
										vec_24 = _mm512_set1_ps(scal_3);
										vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_788);
										mem_vec_788 = vec_23;
										vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_789);
										mem_vec_789 = vec_25;
										vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_790);
										mem_vec_790 = vec_26;
										vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_791);
										mem_vec_791 = vec_27;
										scal_4 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * y + h) + c];
										vec_29 = _mm512_set1_ps(scal_4);
										vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_784);
										mem_vec_784 = vec_28;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_785);
										mem_vec_785 = vec_31;
										vec_34 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
										vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_786);
										mem_vec_786 = vec_33;
										vec_36 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
										vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_787);
										mem_vec_787 = vec_35;
										scal_5 = input[strideA1 * (2 * x + w + 2) + strideA2 * (2 * (y + 1) + h) + c];
										vec_38 = _mm512_set1_ps(scal_5);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_788);
										mem_vec_788 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_789);
										mem_vec_789 = vec_39;
										vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_790);
										mem_vec_790 = vec_40;
										vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_791);
										mem_vec_791 = vec_41;
									}
