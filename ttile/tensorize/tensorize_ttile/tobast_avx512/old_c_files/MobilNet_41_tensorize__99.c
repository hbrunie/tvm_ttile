...
fp_1 = 0;
						for (h = h308, hp_0 = 0;h < h308 + 3;h += 1, hp_0 += 1){
							...
							for (x = x660, xp_1 = x660_p_0, xp_0 = 0;x < x660 + 2;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5119 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_5120 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_5121 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5119);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5120);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5121);
							}
						}
}
