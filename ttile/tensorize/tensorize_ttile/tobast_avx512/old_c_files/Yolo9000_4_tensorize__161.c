...
[V f; U (4, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (17, x); T (34, y); T (2, f); T (32, c); T (8, x)]
*/
IND_TYPE c, cp_0, c336_p_0, cp_1, c336, f, fp_0, h, hp_0, x, xp_0, x408_p_0, x409_p_0, xp_1, x408_p_1, xp_2, x408, x409, y, yp_0;
IND_TYPE y224 = 0;
IND_TYPE x410 = 0;
IND_TYPE h200 = 0;
IND_TYPE w = 0;
					...
					for (h = h200, hp_0 = 0;h < h200 + 3;h += 1, hp_0 += 1){
						...
						for (x = x408, xp_2 = x408_p_1, xp_1 = x408_p_0, xp_0 = 0;x < x408 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c336, cp_1 = c336_p_0, cp_0 = 0;c < c336 + 2;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_1240);
										mem_vec_1240 = vec_24;
										vec_28 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_1241);
										mem_vec_1241 = vec_27;
										vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_1242);
										mem_vec_1242 = vec_29;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_1243);
										mem_vec_1243 = vec_31;
										scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
										vec_34 = _mm512_set1_ps(scal_5);
										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_1244);
										mem_vec_1244 = vec_33;
										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_1245);
										mem_vec_1245 = vec_35;
										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1246);
										mem_vec_1246 = vec_36;
										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1247);
										mem_vec_1247 = vec_37;
										scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
										vec_39 = _mm512_set1_ps(scal_6);
										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_1248);
										mem_vec_1248 = vec_38;
										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_1249);
										mem_vec_1249 = vec_40;
										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_1250);
										mem_vec_1250 = vec_41;
										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_1251);
										mem_vec_1251 = vec_42;
										scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
										vec_44 = _mm512_set1_ps(scal_7);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_1252);
										mem_vec_1252 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_1253);
										mem_vec_1253 = vec_45;
										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_1254);
										mem_vec_1254 = vec_46;
										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_1255);
										mem_vec_1255 = vec_47;
										scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_1240);
										mem_vec_1240 = vec_48;
										vec_52 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_1241);
										mem_vec_1241 = vec_51;
										vec_54 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_1242);
										mem_vec_1242 = vec_53;
										vec_56 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_1243);
										mem_vec_1243 = vec_55;
										scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
										vec_58 = _mm512_set1_ps(scal_9);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1244);
										mem_vec_1244 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_1245);
										mem_vec_1245 = vec_59;
										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_1246);
										mem_vec_1246 = vec_60;
										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_1247);
										mem_vec_1247 = vec_61;
										scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
										vec_63 = _mm512_set1_ps(scal_10);
										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_1248);
										mem_vec_1248 = vec_62;
										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_1249);
										mem_vec_1249 = vec_64;
										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_1250);
										mem_vec_1250 = vec_65;
										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_1251);
										mem_vec_1251 = vec_66;
										scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
										vec_68 = _mm512_set1_ps(scal_11);
										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_1252);
										mem_vec_1252 = vec_67;
										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_1253);
										mem_vec_1253 = vec_69;
										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_1254);
										mem_vec_1254 = vec_70;
										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_1255);
										mem_vec_1255 = vec_71;
									}
