...
for (c320 = c321, c320_p_0 = 0;
	c320 < c321 + 1024;
	c320 += 1024, c320_p_0 += 1024){
	// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
	// T (f, 1) (1024 / 1024)
	for (f226 = f227, f226_p_0 = 0;
		f226 < f227 + 1024;
		f226 += 1024, f226_p_0 += 1024){
		// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
		// T (c, 2) (1024 / 512)
		for (c319 = c320, c319_p_1 = c320_p_0, c319_p_0 = 0;
			c319 < c320 + 1024;
			c319 += 512, c319_p_1 += 512, c319_p_0 += 512){
			...
			for (f = f226, fp_1 = f226_p_0, fp_0 = 0;
				...
				// T (c, 4) (512 / 128)
				for (c318 = c319, c318_p_2 = c319_p_1, c318_p_1 = c319_p_0, c318_p_0 = 0;
					c318 < c319 + 512;
					c318 += 128, c318_p_2 += 128, c318_p_1 += 128, c318_p_0 += 128){
					...
					for (w = w136, wp_0 = 0;
						...
						for (x = x136, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									// T (c, 128) (128 / 1)
									for (c = c318, cp_3 = c318_p_2, cp_2 = c318_p_1, cp_1 = c318_p_0, cp_0 = 0;
										c < c318 + 128;
