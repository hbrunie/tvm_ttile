...
for (x473 = x474, x473_p_0 = 0;
	...
	for (c288 = c289, c288_p_0 = 0;
		...
		for (y = y236, yp_0 = 0;
			y < y236 + 112;
			y += 7, yp_0 += 7){
			// y = 7, x = 28, h = 7, w = 7, c = 3, f = 64
			// T (x, 7) (28 / 4)
			for (x472 = x473, x472_p_1 = x473_p_0, x472_p_0 = 0;
				x472 < x473 + 28;
				x472 += 4, x472_p_1 += 4, x472_p_0 += 4){
				// y = 7, x = 4, h = 7, w = 7, c = 3, f = 64
				// T (h, 7) (7 / 1)
				for (h = h236, hp_0 = 0;
					h < h236 + 7;
					h += 1, hp_0 += 1){
					...
					for (w = w236, wp_0 = 0;
						...
						for (x = x472, xp_2 = x472_p_1, xp_1 = x472_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_2450 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32]);
									mem_vec_2451 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48]);
									mem_vec_2452 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									mem_vec_2453 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
									mem_vec_2454 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32]);
									mem_vec_2455 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48]);
									mem_vec_2456 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_2457 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
									mem_vec_2458 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
									mem_vec_2459 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32], mem_vec_2450);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48], mem_vec_2451);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_2452);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_2453);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32], mem_vec_2454);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48], mem_vec_2455);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_2456);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_2457);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_2458);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_2459);
						}
					}
				}
			}
