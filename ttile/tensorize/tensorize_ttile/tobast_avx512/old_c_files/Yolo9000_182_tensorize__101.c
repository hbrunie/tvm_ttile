...
c578_p_1 = 0;
							for (h = h226, hp_0 = 0;h < h226 + 3;h += 1, hp_0 += 1){
								...
								for (x = x510, xp_1 = x510_p_0, xp_0 = 0;x < x510 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_4677 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
											mem_vec_4678 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											mem_vec_4679 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_4677);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_4678);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_4679);
