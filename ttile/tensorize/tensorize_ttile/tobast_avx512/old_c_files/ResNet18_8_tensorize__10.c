...
/*
[V f; U (2, f); U (4, y); U (3, w); T (64, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (1, f); T (2, c); T (2, x); T (7, y); T (8, f)]
*/
IND_TYPE c, cp_0, c234_p_0, cp_1, c234, f, fp_0, f234_p_0, fp_1, f234, h, hp_0, x, xp_0, x234_p_0, xp_1, x234, y, yp_0;
IND_TYPE y156 = 0;
IND_TYPE x235 = 0;
IND_TYPE h108 = 0;
IND_TYPE w = 0;
					...
					for (h = h108, hp_0 = 0;h < h108 + 3;h += 1, hp_0 += 1){
						...
						for (x = x234, xp_1 = x234_p_0, xp_0 = 0;x < x234 + 14;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c234, cp_1 = c234_p_0, cp_0 = 0;c < c234 + 64;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_1290);
										mem_vec_1290 = vec_14;
										vec_18 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_1291);
										mem_vec_1291 = vec_17;
										scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
										vec_20 = _mm512_set1_ps(scal_5);
										vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_1292);
										mem_vec_1292 = vec_19;
										vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_1293);
										mem_vec_1293 = vec_21;
										scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
										vec_23 = _mm512_set1_ps(scal_6);
										vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_1294);
										mem_vec_1294 = vec_22;
										vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_1295);
										mem_vec_1295 = vec_24;
										scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
										vec_26 = _mm512_set1_ps(scal_7);
										vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_1296);
										mem_vec_1296 = vec_25;
										vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_1297);
										mem_vec_1297 = vec_27;
										scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
										vec_29 = _mm512_set1_ps(scal_8);
										vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_1290);
										mem_vec_1290 = vec_28;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_1291);
										mem_vec_1291 = vec_31;
										scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
										vec_34 = _mm512_set1_ps(scal_9);
										vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1292);
										mem_vec_1292 = vec_33;
										vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1293);
										mem_vec_1293 = vec_35;
										scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
										vec_37 = _mm512_set1_ps(scal_10);
										vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_1294);
										mem_vec_1294 = vec_36;
										vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_1295);
										mem_vec_1295 = vec_38;
										scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
										vec_40 = _mm512_set1_ps(scal_11);
										vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_1296);
										mem_vec_1296 = vec_39;
										vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_1297);
										mem_vec_1297 = vec_41;
									}
