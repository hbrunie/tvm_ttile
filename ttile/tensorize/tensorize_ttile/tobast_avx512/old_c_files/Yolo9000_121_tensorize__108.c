...
c226_p_1 = 0;
							for (w = w138, wp_0 = 0;w < w138 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 34) (34 / 1)
								for (x = x226, xp_2 = x226_p_1, xp_1 = x226_p_0, xp_0 = 0;x < x226 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 8) (8 / 1)
											for (c = c226, cp_2 = c226_p_1, cp_1 = c226_p_0, cp_0 = 0;c < c226 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
