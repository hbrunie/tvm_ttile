...
x896_p_1 = 0;
					for (w = w414, wp_0 = 0;w < w414 + 3;w += 1, wp_0 += 1){
						...
						for (x = x896, xp_2 = x896_p_1, xp_1 = x896_p_0, xp_0 = 0;x < x896 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_6440 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									mem_vec_6441 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
									mem_vec_6442 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
									mem_vec_6443 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_6440);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_6441);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_6442);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_6443);
						}
					}
}
