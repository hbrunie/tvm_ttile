...
c490_p_1 = 0;
							for (h = h182, hp_0 = 0;h < h182 + 3;h += 1, hp_0 += 1){
								...
								for (x = x444, xp_1 = x444_p_0, xp_0 = 0;x < x444 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4455 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											mem_vec_4456 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
											mem_vec_4457 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_4455);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_4456);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_4457);
								}
							}
}
