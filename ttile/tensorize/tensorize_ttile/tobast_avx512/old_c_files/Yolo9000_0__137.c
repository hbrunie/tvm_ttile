...
[V f; U (1, f); U (8, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (17, x); T (1, y); T (32, x); T (68, y); T (2, f); T (1, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x146_p_0, x147_p_0, xp_1, x146_p_1, xp_2, x146, x147, y, yp_0, y120_p_0, yp_1, y120;
...
for (x147 = x148, x147_p_0 = 0;
	...
	for (f = f58, fp_0 = 0;
		...
		for (y120 = y121, y120_p_0 = 0;
			y120 < y121 + 544;
			y120 += 8, y120_p_0 += 8){
			// y = 8, x = 544, h = 3, w = 3, c = 3, f = 16
			// T (x, 32) (544 / 17)
			for (x146 = x147, x146_p_1 = x147_p_0, x146_p_0 = 0;
				x146 < x147 + 544;
				x146 += 17, x146_p_1 += 17, x146_p_0 += 17){
				// y = 8, x = 17, h = 3, w = 3, c = 3, f = 16
				// T (y, 1) (8 / 8)
				for (y = y120, yp_1 = y120_p_0, yp_0 = 0;
					...
					// y = 8, x = 17, h = 3, w = 3, c = 3, f = 16
					// T (x, 17) (17 / 1)
					for (x = x146, xp_2 = x146_p_1, xp_1 = x146_p_0, xp_0 = 0;
						x < x146 + 17;
						x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								mem_vec_336 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
								mem_vec_337 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
								mem_vec_338 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
								mem_vec_339 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
								mem_vec_340 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
								mem_vec_341 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
								mem_vec_342 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
								...
								for (c = c76, cp_0 = 0;
									...
									vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_337);
									mem_vec_337 = vec_3;
									...
									vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_339);
									mem_vec_339 = vec_7;
