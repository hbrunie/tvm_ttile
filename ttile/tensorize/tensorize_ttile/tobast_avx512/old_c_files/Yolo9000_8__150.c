...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (17, x); T (17, y); T (1, f); T (4, c); T (4, f); T (4, x); T (4, f)]
*/
IND_TYPE c, cp_0, c132_p_0, cp_1, c132, f, fp_0, f176_p_0, f177_p_0, fp_1, f176_p_1, fp_2, f176, f177, x, xp_0, x150_p_0, xp_1, x150, y, yp_0;
...
for (f177 = f178, f177_p_0 = 0;
	...
	for (x150 = x151, x150_p_0 = 0;
		...
		for (f176 = f177, f176_p_1 = f177_p_0, f176_p_0 = 0;
			f176 < f177 + 64;
			f176 += 16, f176_p_1 += 16, f176_p_0 += 16){
