...
// T (f, 2) (256 / 128)
for (f907 = f908, f907_p_0 = 0;
	f907 < f908 + 256;
	f907 += 128, f907_p_0 += 128){
	...
	for (x760 = x761, x760_p_0 = 0;
		...
		for (c931 = c932, c931_p_0 = 0;
			...
			// T (f, 1) (128 / 128)
			for (f906 = f907, f906_p_1 = f907_p_0, f906_p_0 = 0;
				f906 < f907 + 128;
				f906 += 128, f906_p_1 += 128, f906_p_0 += 128){
				// y = 14, x = 2, h = 3, w = 3, c = 32, f = 128
				// T (c, 4) (32 / 8)
				for (c930 = c931, c930_p_1 = c931_p_0, c930_p_0 = 0;
					c930 < c931 + 32;
					c930 += 8, c930_p_1 += 8, c930_p_0 += 8){
					// y = 14, x = 2, h = 3, w = 3, c = 8, f = 128
					// T (f, 4) (128 / 32)
					for (f = f906, fp_2 = f906_p_1, fp_1 = f906_p_0, fp_0 = 0;
						f < f906 + 128;
