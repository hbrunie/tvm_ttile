...
/*
[V f; U (2, f); U (7, y); T (3, c); Hoist_vars [c]; T (112, x); T (7, w);
  T (7, h); T (1, x); T (16, y); T (2, f); T (1, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, x0, xp_0, x0_p_0, x1_p_0, x1, xp_1, x0_p_1, xp_2, y, yp_0;
IND_TYPE y0 = 0;
IND_TYPE x2 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
...
x0_p_1 = 0;
				for (h = h0, hp_0 = 0;h < h0 + 7;h += 1, hp_0 += 1){
					// y = 7, x = 112, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w0, wp_0 = 0;w < w0 + 7;w += 1, wp_0 += 1){
						// y = 7, x = 112, h = 1, w = 1, c = 3, f = 32
						// T (x, 112) (112 / 1)
