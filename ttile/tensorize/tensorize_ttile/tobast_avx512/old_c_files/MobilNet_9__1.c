...
for (c1340 = c1341, c1340_p_0 = 0;
	...
	for (f918 = f919, f918_p_0 = 0;
		...
		for (c1339 = c1340, c1339_p_1 = c1340_p_0, c1339_p_0 = 0;
			c1339 < c1340 + 256;
			c1339 += 32, c1339_p_1 += 32, c1339_p_0 += 32){
				for (y = y418, yp_0 = 0;
					y < y418 + 4;
					y += 2, yp_0 += 2){
					...
					for (f = f918, fp_1 = f918_p_0, fp_0 = 0;
						...
						for (c1338 = c1339, c1338_p_2 = c1339_p_1, c1338_p_1 = c1339_p_0, c1338_p_0 = 0;
							c1338 < c1339 + 32;
							c1338 += 4, c1338_p_2 += 4, c1338_p_1 += 4, c1338_p_0 += 4){
								...
								for (x = x564, xp_0 = 0;
									...
									x += 1, xp_0 += 1){
											...
											for (c = c1338, cp_3 = c1338_p_2, cp_2 = c1338_p_1, cp_1 = c1338_p_0, cp_0 = 0;
												...
												vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_4916);
												mem_vec_4916 = vec_14;

												vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_4917);
												mem_vec_4917 = vec_17;

												vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

												vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_4918);
												mem_vec_4918 = vec_19;

												vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

												vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_4919);
												mem_vec_4919 = vec_21;
												scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_24 = _mm512_set1_ps(scal_3);


												vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_4920);
												mem_vec_4920 = vec_23;



												vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_4921);
												mem_vec_4921 = vec_25;



												vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_4922);
												mem_vec_4922 = vec_26;



												vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_4923);
												mem_vec_4923 = vec_27;
												scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_29 = _mm512_set1_ps(scal_4);
												vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_4916);
												mem_vec_4916 = vec_28;

												vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_4917);
												mem_vec_4917 = vec_31;

												vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

												vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_4918);
												mem_vec_4918 = vec_33;

												vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

												vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_4919);
												mem_vec_4919 = vec_35;
												scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_38 = _mm512_set1_ps(scal_5);


												vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_4920);
												mem_vec_4920 = vec_37;



												vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_4921);
												mem_vec_4921 = vec_39;



												vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_4922);
												mem_vec_4922 = vec_40;



												vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_4923);
												mem_vec_4923 = vec_41;
											}
