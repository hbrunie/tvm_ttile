...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (4, c); Hoist_vars [c];
  T (7, x); T (2, f); T (4, c); T (16, f); T (2, f); T (64, c)]
*/
IND_TYPE c, cp_0, c1064_p_0, c1065_p_0, cp_1, c1064_p_1, cp_2, c1064, c1065, f, fp_0, f744_p_0, f745_p_0, fp_1, f744_p_1, fp_2, f744, f745, x, xp_0;
	...
	for (f745 = f746, f745_p_0 = 0;
		...
		for (f744 = f745, f744_p_1 = f745_p_0, f744_p_0 = 0;
			...
			for (c1064 = c1065, c1064_p_1 = c1065_p_0, c1064_p_0 = 0;
				c1064 < c1065 + 16;
				c1064 += 4, c1064_p_1 += 4, c1064_p_0 += 4){
