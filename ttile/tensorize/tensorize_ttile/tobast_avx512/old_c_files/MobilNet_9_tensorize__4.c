...
[V f; U (4, f); U (7, y); T (64, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (2, c); T (4, f); T (1, y); T (1, c); T (4, f); T (8, c)]
*/
IND_TYPE c, cp_0, c190_p_0, c191_p_0, c192_p_0, cp_1, c190_p_1, c191_p_1, cp_2, c190_p_2, cp_3, c190, c191, c192, f, fp_0, f114_p_0, fp_1, f114, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y54 = 0;
IND_TYPE x76 = 0;
IND_TYPE h76 = 0;
IND_TYPE w76 = 0;
						...
						for (h = h76, hp_0 = 0;h < h76 + 3;h += 1, hp_0 += 1){
							...
							for (w = w76, wp_0 = 0;w < w76 + 3;w += 1, wp_0 += 1){
								...
								for (x = x76, xp_0 = 0;x < x76 + 7;x += 1, xp_0 += 1){
											...
											// T (c, 64) (64 / 1)
											for (c = c190, cp_3 = c190_p_2, cp_2 = c190_p_1, cp_1 = c190_p_0, cp_0 = 0;c < c190 + 64;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
