...
fp_1 = 0;
						for (h = h330, hp_0 = 0;h < h330 + 3;h += 1, hp_0 += 1){
							...
							for (x = x714, xp_1 = x714_p_0, xp_0 = 0;x < x714 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_5717 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_5718 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_5719 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_5720 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_5721 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_5717);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5718);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5719);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5720);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_5721);
