...
/*
[V f; U (1, f); U (8, y); U (3, h); U (3, w); T (4, c); Hoist_vars [c];
  T (1, x); T (68, x); T (34, y); T (4, f); T (8, c); T (1, x); T (4, x)]
*/
IND_TYPE c, cp_0, c678_p_0, cp_1, c678, f, fp_0, x, xp_0, x1138_p_0, x1139_p_0, x1140_p_0, xp_1, x1138_p_1, x1139_p_1, xp_2, x1138_p_2, xp_3, x1138, x1139, x1140, y, yp_0;
...
for (x1140 = x1141, x1140_p_0 = 0;
	x1140 < x1141 + 272;
	x1140 += 68, x1140_p_0 += 68){
	// y = 272, x = 68, h = 3, w = 3, c = 32, f = 64
	// T (x, 1) (68 / 68)
	for (x1139 = x1140, x1139_p_1 = x1140_p_0, x1139_p_0 = 0;
		x1139 < x1140 + 68;
		x1139 += 68, x1139_p_1 += 68, x1139_p_0 += 68){
		// y = 272, x = 68, h = 3, w = 3, c = 32, f = 64
		// T (c, 8) (32 / 4)
		for (c678 = c679, c678_p_0 = 0;
			...
			for (f = f374, fp_0 = 0;
				f < f374 + 64;
				f += 16, fp_0 += 16){
				// y = 272, x = 68, h = 3, w = 3, c = 4, f = 16
				// T (y, 34) (272 / 8)
				for (y = y472, yp_0 = 0;
					y < y472 + 272;
					y += 8, yp_0 += 8){
					// y = 8, x = 68, h = 3, w = 3, c = 4, f = 16
					// T (x, 68) (68 / 1)
					for (x1138 = x1139, x1138_p_2 = x1139_p_1, x1138_p_1 = x1139_p_0, x1138_p_0 = 0;
						x1138 < x1139 + 68;
						x1138 += 1, x1138_p_2 += 1, x1138_p_1 += 1, x1138_p_0 += 1){
						// y = 8, x = 1, h = 3, w = 3, c = 4, f = 16
						// T (x, 1) (1 / 1)
						for (x = x1138, xp_3 = x1138_p_2, xp_2 = x1138_p_1, xp_1 = x1138_p_0, xp_0 = 0;
							x < x1138 + 1;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_2512 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_2513 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_2514 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_2515 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									mem_vec_2519 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									// y = 8, x = 1, h = 3, w = 3, c = 4, f = 16
									// T (c, 4) (4 / 1)
									for (c = c678, cp_1 = c678_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2513);
										mem_vec_2513 = vec_3;
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_2515);
										mem_vec_2515 = vec_7;
										...
										vec_119 = _mm512_fmadd_ps(vec_120, vec_121, mem_vec_2512);
										mem_vec_2512 = vec_119;
										scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
										vec_123 = _mm512_set1_ps(scal_57);


										vec_122 = _mm512_fmadd_ps(vec_123, vec_121, mem_vec_2513);
										mem_vec_2513 = vec_122;
										scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
										vec_125 = _mm512_set1_ps(scal_58);


										vec_124 = _mm512_fmadd_ps(vec_125, vec_121, mem_vec_2514);
										mem_vec_2514 = vec_124;
										scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
										vec_127 = _mm512_set1_ps(scal_59);


										vec_126 = _mm512_fmadd_ps(vec_127, vec_121, mem_vec_2515);
										mem_vec_2515 = vec_126;
										scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
										vec_129 = _mm512_set1_ps(scal_60);


										vec_128 = _mm512_fmadd_ps(vec_129, vec_121, mem_vec_2516);
										mem_vec_2516 = vec_128;
										scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
										vec_131 = _mm512_set1_ps(scal_61);


										vec_130 = _mm512_fmadd_ps(vec_131, vec_121, mem_vec_2517);
										mem_vec_2517 = vec_130;
										scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
										vec_133 = _mm512_set1_ps(scal_62);


										vec_132 = _mm512_fmadd_ps(vec_133, vec_121, mem_vec_2518);
										mem_vec_2518 = vec_132;
										scal_63 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
										vec_135 = _mm512_set1_ps(scal_63);


										vec_134 = _mm512_fmadd_ps(vec_135, vec_121, mem_vec_2519);
										mem_vec_2519 = vec_134;
										...
										vec_136 = _mm512_fmadd_ps(vec_137, vec_138, mem_vec_2512);
										mem_vec_2512 = vec_136;
										scal_65 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
										vec_140 = _mm512_set1_ps(scal_65);


										vec_139 = _mm512_fmadd_ps(vec_140, vec_138, mem_vec_2513);
										mem_vec_2513 = vec_139;
										scal_66 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
										vec_142 = _mm512_set1_ps(scal_66);


										vec_141 = _mm512_fmadd_ps(vec_142, vec_138, mem_vec_2514);
										mem_vec_2514 = vec_141;
										scal_67 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
										vec_144 = _mm512_set1_ps(scal_67);


										vec_143 = _mm512_fmadd_ps(vec_144, vec_138, mem_vec_2515);
										mem_vec_2515 = vec_143;
										scal_68 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
										vec_146 = _mm512_set1_ps(scal_68);


										vec_145 = _mm512_fmadd_ps(vec_146, vec_138, mem_vec_2516);
										mem_vec_2516 = vec_145;
										scal_69 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
										vec_148 = _mm512_set1_ps(scal_69);


										vec_147 = _mm512_fmadd_ps(vec_148, vec_138, mem_vec_2517);
										mem_vec_2517 = vec_147;
										scal_70 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
										vec_150 = _mm512_set1_ps(scal_70);


										vec_149 = _mm512_fmadd_ps(vec_150, vec_138, mem_vec_2518);
										mem_vec_2518 = vec_149;
										scal_71 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
										vec_152 = _mm512_set1_ps(scal_71);


										vec_151 = _mm512_fmadd_ps(vec_152, vec_138, mem_vec_2519);
										mem_vec_2519 = vec_151;
									}
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_2512);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_2513);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_2514);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_2515);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_2519);
						}
					}
				}
			}
