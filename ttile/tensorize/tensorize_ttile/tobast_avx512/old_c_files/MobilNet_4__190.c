					...
					for (f = f672, fp_1 = f672_p_0, fp_0 = 0;
						...
						for (h = h324, hp_0 = 0;
							...
							for (x = x684, xp_1 = x684_p_0, xp_0 = 0;
								x < x684 + 14;
								x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_5238 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
										mem_vec_5239 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
										mem_vec_5240 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_5241 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_5242 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_5243 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_5238);
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_5239);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_5240);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_5241);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_5242);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_5243);
