					...
					for (w = w92, wp_0 = 0;
						...
						for (x = x184, xp_2 = x184_p_1, xp_1 = x184_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_798 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_799 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_800 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_801 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_802 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_803 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									// y = 14, x = 1, h = 1, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c92, cp_0 = 0;
										c < c92 + 3;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_798);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_799);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_800);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_801);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_802);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_803);
						}
					}
				}
			}
