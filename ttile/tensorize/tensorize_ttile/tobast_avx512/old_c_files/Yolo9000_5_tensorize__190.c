...
/*
[V f; U (2, f); U (8, y); T (128, c); Hoist_vars [c]; T (2, x); T (17, x);
  T (17, y); T (2, f); T (4, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x64_p_0, x65_p_0, xp_1, x64_p_1, xp_2, x64, x65, y, yp_0;
IND_TYPE y32 = 0;
IND_TYPE x66 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x64_p_1 = 0;
				for (x = x64, xp_2 = x64_p_1, xp_1 = x64_p_0, xp_0 = 0;x < x64 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
							...
							// T (c, 128) (128 / 1)
							for (c = c32, cp_0 = 0;c < c32 + 128;c += 1, cp_0 += 1){
