...
for (x670 = x671, x670_p_0 = 0;
	x670 < x671 + 272;
	x670 += 136, x670_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 2) (136 / 68)
	for (x669 = x670, x669_p_1 = x670_p_0, x669_p_0 = 0;
		x669 < x670 + 136;
		x669 += 68, x669_p_1 += 68, x669_p_0 += 68){
		...
		for (c396 = c397, c396_p_0 = 0;
			...
			for (f = f214, fp_0 = 0;
				f < f214 + 64;
				f += 32, fp_0 += 32){
				// y = 272, x = 68, h = 3, w = 3, c = 2, f = 32
				// T (y, 68) (272 / 4)
				for (y = y284, yp_0 = 0;
					y < y284 + 272;
					y += 4, yp_0 += 4){
					// y = 4, x = 68, h = 3, w = 3, c = 2, f = 32
					// T (x, 34) (68 / 2)
					for (x668 = x669, x668_p_2 = x669_p_1, x668_p_1 = x669_p_0, x668_p_0 = 0;
						x668 < x669 + 68;
						x668 += 2, x668_p_2 += 2, x668_p_1 += 2, x668_p_0 += 2){
						...
						for (h = h188, hp_0 = 0;
							...
							// T (x, 2) (2 / 1)
							for (x = x668, xp_3 = x668_p_2, xp_2 = x668_p_1, xp_1 = x668_p_0, xp_0 = 0;
								x < x668 + 2;
