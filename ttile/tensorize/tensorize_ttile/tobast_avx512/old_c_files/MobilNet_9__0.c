...
[V f; U (2, f); U (7, y); U (3, h); T (8, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (32, c); T (32, f); T (4, c); T (1, f); T (1, c)]
*/
IND_TYPE c, cp_0, c338_p_0, c339_p_0, c340_p_0, cp_1, c338_p_1, c339_p_1, cp_2, c338_p_2, cp_3, c338, c339, c340, f, fp_0, f238_p_0, fp_1, f238, w, wp_0, x, xp_0;
...
for (c340 = c341, c340_p_0 = 0;
	c340 < c341 + 1024;
	c340 += 1024, c340_p_0 += 1024){
	// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
	// T (f, 1) (1024 / 1024)
	for (f238 = f239, f238_p_0 = 0;
		f238 < f239 + 1024;
		f238 += 1024, f238_p_0 += 1024){
		// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
		// T (c, 4) (1024 / 256)
		for (c339 = c340, c339_p_1 = c340_p_0, c339_p_0 = 0;
			c339 < c340 + 1024;
			c339 += 256, c339_p_1 += 256, c339_p_0 += 256){
			...
			for (f = f238, fp_1 = f238_p_0, fp_0 = 0;
				...
				// T (c, 32) (256 / 8)
				for (c338 = c339, c338_p_2 = c339_p_1, c338_p_1 = c339_p_0, c338_p_0 = 0;
					c338 < c339 + 256;
					c338 += 8, c338_p_2 += 8, c338_p_1 += 8, c338_p_0 += 8){
					...
					for (w = w144, wp_0 = 0;
						...
						for (x = x144, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									// T (c, 8) (8 / 1)
									for (c = c338, cp_3 = c338_p_2, cp_2 = c338_p_1, cp_1 = c338_p_0, cp_0 = 0;
										c < c338 + 8;
										...
										vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_1134);
										mem_vec_1134 = vec_23;

										vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_1135);
										mem_vec_1135 = vec_26;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_8);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_1136);
										mem_vec_1136 = vec_28;



										vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_1137);
										mem_vec_1137 = vec_30;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_1138);
										mem_vec_1138 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_1139);
										mem_vec_1139 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_1140);
										mem_vec_1140 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_1141);
										mem_vec_1141 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_1142);
										mem_vec_1142 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_1143);
										mem_vec_1143 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_1144);
										mem_vec_1144 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_1145);
										mem_vec_1145 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_1146);
										mem_vec_1146 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_1147);
										mem_vec_1147 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_1134);
										mem_vec_1134 = vec_46;

										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_1135);
										mem_vec_1135 = vec_49;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_52 = _mm512_set1_ps(scal_15);


										vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_1136);
										mem_vec_1136 = vec_51;



										vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_1137);
										mem_vec_1137 = vec_53;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_55 = _mm512_set1_ps(scal_16);


										vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_1138);
										mem_vec_1138 = vec_54;



										vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_1139);
										mem_vec_1139 = vec_56;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_1140);
										mem_vec_1140 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1141);
										mem_vec_1141 = vec_59;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_61 = _mm512_set1_ps(scal_18);


										vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_1142);
										mem_vec_1142 = vec_60;



										vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_1143);
										mem_vec_1143 = vec_62;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_1144);
										mem_vec_1144 = vec_63;



										vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_1145);
										mem_vec_1145 = vec_65;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);


										vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_1146);
										mem_vec_1146 = vec_66;



										vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_1147);
										mem_vec_1147 = vec_68;
									}
