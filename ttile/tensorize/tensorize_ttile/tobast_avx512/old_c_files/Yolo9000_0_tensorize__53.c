...
y724 = 0;
y724_p_0 = 0;
		for (x830 = x831, x830_p_1 = x831_p_0, x830_p_0 = 0;x830 < x831 + 32;x830 += 32, x830_p_1 += 32, x830_p_0 += 32){
				for (y = y724, yp_1 = y724_p_0, yp_0 = 0;y < y724 + 18;y += 6, yp_1 += 6, yp_0 += 6){
					// y = ph_y, x = 32, h = 3, w = 3, c = 3, f = 32
					// T (h, 3) (3 / 1)
					for (h = h326, hp_0 = 0;h < h326 + 3;h += 1, hp_0 += 1){
						// y = ph_y, x = 32, h = 1, w = 3, c = 3, f = 32
						// T (x, 32) (32 / 1)
						for (x = x830, xp_2 = x830_p_1, xp_1 = x830_p_0, xp_0 = 0;x < x830 + 32;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
				...
				for (y = y724 + 18, yp_1 = y724_p_0, yp_0 = 0;y < y724 + 18 + 14;y += 7, yp_1 += 7, yp_0 += 7){
					// y = ph_y, x = 32, h = 3, w = 3, c = 3, f = 32
					// T (h, 3) (3 / 1)
					for (h = h326, hp_0 = 0;h < h326 + 3;h += 1, hp_0 += 1){
						// y = ph_y, x = 32, h = 1, w = 3, c = 3, f = 32
