...
fp_1 = 0;
						for (w = w186, wp_0 = 0;w < w186 + 3;w += 1, wp_0 += 1){
							...
							for (x = x406, xp_1 = x406_p_0, xp_0 = 0;x < x406 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2343 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										...
										mem_vec_2347 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										mem_vec_2348 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
										mem_vec_2349 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2343);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_2347);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_2348);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2349);
							}
						}
}
