...
[V f; U (2, f); U (7, y); U (3, h); T (16, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (14, x); T (8, y); T (2, f); T (4, c); T (2, x)]
*/
IND_TYPE c, cp_0, c92_p_0, cp_1, c92, f, fp_0, w, wp_0, x, xp_0, x104_p_0, x105_p_0, xp_1, x104_p_1, xp_2, x104, x105, y, yp_0;
IND_TYPE y56 = 0;
IND_TYPE x106 = 0;
IND_TYPE h = 0;
IND_TYPE w56 = 0;
...
x104_p_1 = 0;
					for (w = w56, wp_0 = 0;w < w56 + 3;w += 1, wp_0 += 1){
						...
						for (x = x104, xp_2 = x104_p_1, xp_1 = x104_p_0, xp_0 = 0;x < x104 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_398 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									mem_vec_399 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
									...
									mem_vec_402 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_403 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16]);
									...
									mem_vec_406 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
									mem_vec_407 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
									...
									mem_vec_410 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									mem_vec_411 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
									// y = 7, x = 1, h = 3, w = 1, c = 16, f = 32
									// T (c, 16) (16 / 1)
									for (c = c92, cp_1 = c92_p_0, cp_0 = 0;c < c92 + 16;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_398);
										mem_vec_398 = vec_23;
										vec_27 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
										vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_399);
										mem_vec_399 = vec_26;
										scal_8 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 1) + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_8);
										vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_400);
										mem_vec_400 = vec_28;
										vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_401);
										mem_vec_401 = vec_30;
										scal_9 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 2) + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);
										vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_402);
										mem_vec_402 = vec_31;
										vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_403);
										mem_vec_403 = vec_33;
										scal_10 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 3) + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);
										vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_404);
										mem_vec_404 = vec_34;
										vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_405);
										mem_vec_405 = vec_36;
										scal_11 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 4) + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_406);
										mem_vec_406 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_407);
										mem_vec_407 = vec_39;
										scal_12 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 5) + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_408);
										mem_vec_408 = vec_40;
										vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_409);
										mem_vec_409 = vec_42;
										scal_13 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 6) + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_410);
										mem_vec_410 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_411);
										mem_vec_411 = vec_45;
										scal_14 = input[strideA1 * (2 * x + w) + strideA2 * (2 * y + h + 2) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_48 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
										vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_398);
										mem_vec_398 = vec_46;
										vec_50 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
										vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_399);
										mem_vec_399 = vec_49;
										scal_15 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 1) + h + 2) + c];
										vec_52 = _mm512_set1_ps(scal_15);
										vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_400);
										mem_vec_400 = vec_51;
										vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_401);
										mem_vec_401 = vec_53;
										scal_16 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 2) + h + 2) + c];
										vec_55 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_402);
										mem_vec_402 = vec_54;
										vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_403);
										mem_vec_403 = vec_56;
										scal_17 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 3) + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_404);
										mem_vec_404 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_405);
										mem_vec_405 = vec_59;
										scal_18 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 4) + h + 2) + c];
										vec_61 = _mm512_set1_ps(scal_18);
										vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_406);
										mem_vec_406 = vec_60;
										vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_407);
										mem_vec_407 = vec_62;
										scal_19 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 5) + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);
										vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_408);
										mem_vec_408 = vec_63;
										vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_409);
										mem_vec_409 = vec_65;
										scal_20 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 6) + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);
										vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_410);
										mem_vec_410 = vec_66;
										vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_411);
										mem_vec_411 = vec_68;
									}
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_398);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_399);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_402);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16], mem_vec_403);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_406);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_407);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_410);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_411);
						}
					}
}
