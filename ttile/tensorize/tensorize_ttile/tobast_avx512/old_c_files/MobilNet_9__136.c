...
// T (c, 4) (1024 / 256)
for (c1690 = c1691, c1690_p_0 = 0;
	c1690 < c1691 + 1024;
	c1690 += 256, c1690_p_0 += 256){
	...
	for (f1128 = f1129, f1128_p_0 = 0;
		...
		// T (c, 16) (256 / 16)
		for (c1689 = c1690, c1689_p_1 = c1690_p_0, c1689_p_0 = 0;
			c1689 < c1690 + 256;
			c1689 += 16, c1689_p_1 += 16, c1689_p_0 += 16){
				for (y = y558, yp_0 = 0;
					y < y558 + 2;
					y += 2, yp_0 += 2){
					...
					for (f = f1128, fp_1 = f1128_p_0, fp_0 = 0;
						...
						// T (c, 4) (16 / 4)
						for (c1688 = c1689, c1688_p_2 = c1689_p_1, c1688_p_1 = c1689_p_0, c1688_p_0 = 0;
							c1688 < c1689 + 16;
							c1688 += 4, c1688_p_2 += 4, c1688_p_1 += 4, c1688_p_0 += 4){
							...
							for (h = h522, hp_0 = 0;
								...
								for (x = x704, xp_0 = 0;
									...
									x += 1, xp_0 += 1){
											...
											// T (c, 4) (4 / 1)
											for (c = c1688, cp_3 = c1688_p_2, cp_2 = c1688_p_1, cp_1 = c1688_p_0, cp_0 = 0;
												c < c1688 + 4;
												...
												vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_6636);
												mem_vec_6636 = vec_14;

												vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_6637);
												mem_vec_6637 = vec_17;

												vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

												vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_6638);
												mem_vec_6638 = vec_19;

												vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

												vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_6639);
												mem_vec_6639 = vec_21;
												scal_3 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_24 = _mm512_set1_ps(scal_3);


												vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_6640);
												mem_vec_6640 = vec_23;



												vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_6641);
												mem_vec_6641 = vec_25;



												vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_6642);
												mem_vec_6642 = vec_26;



												vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_6643);
												mem_vec_6643 = vec_27;
												scal_4 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_29 = _mm512_set1_ps(scal_4);
												vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_6636);
												mem_vec_6636 = vec_28;

												vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_6637);
												mem_vec_6637 = vec_31;

												vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

												vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_6638);
												mem_vec_6638 = vec_33;

												vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

												vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_6639);
												mem_vec_6639 = vec_35;
												scal_5 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_38 = _mm512_set1_ps(scal_5);


												vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_6640);
												mem_vec_6640 = vec_37;



												vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_6641);
												mem_vec_6641 = vec_39;



												vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_6642);
												mem_vec_6642 = vec_40;



												vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_6643);
												mem_vec_6643 = vec_41;
											}
