...
[V f; U (4, f); U (4, y); U (3, w); T (8, c); Hoist_vars [c]; T (34, x);
  T (3, h); T (1, x); T (68, y); T (4, c); T (1, x); T (8, x)]
*/
IND_TYPE c, cp_0, c576_p_0, cp_1, c576, h, hp_0, x, xp_0, x968_p_0, x969_p_0, x970_p_0, xp_1, x968_p_1, x969_p_1, xp_2, x968_p_2, xp_3, x968, x969, x970, y, yp_0;
IND_TYPE y404 = 0;
IND_TYPE x971 = 0;
IND_TYPE h308 = 0;
IND_TYPE w = 0;
...
x968_p_2 = 0;
					for (h = h308, hp_0 = 0;h < h308 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 34) (34 / 1)
						for (x = x968, xp_3 = x968_p_2, xp_2 = x968_p_1, xp_1 = x968_p_0, xp_0 = 0;x < x968 + 34;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
