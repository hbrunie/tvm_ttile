...
fp_1 = 0;
						for (h = h316, hp_0 = 0;h < h316 + 3;h += 1, hp_0 += 1){
							...
							for (x = x672, xp_1 = x672_p_0, xp_0 = 0;x < x672 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5165 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_5166 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_5167 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5165);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5166);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5167);
