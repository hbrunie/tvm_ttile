...
/*
[V f; U (4, f); U (7, y); T (3, c); Hoist_vars [c]; T (28, x); T (7, w);
  T (7, h); T (4, x); T (16, y); T (1, c); T (1, x)]
*/
IND_TYPE c, cp_0, c234_p_0, cp_1, c234, h, hp_0, w, wp_0, x, xp_0, x400_p_0, x401_p_0, xp_1, x400_p_1, xp_2, x400, x401, y, yp_0;
	...
	for (c234 = c235, c234_p_0 = 0;
		...
		for (y = y200, yp_0 = 0;
			...
			for (x400 = x401, x400_p_1 = x401_p_0, x400_p_0 = 0;
				x400 < x401 + 112;
				x400 += 28, x400_p_1 += 28, x400_p_0 += 28){
				// y = 7, x = 28, h = 7, w = 7, c = 3, f = 64
				// T (h, 7) (7 / 1)
				for (h = h200, hp_0 = 0;
					h < h200 + 7;
					h += 1, hp_0 += 1){
					// y = 7, x = 28, h = 1, w = 7, c = 3, f = 64
					// T (w, 7) (7 / 1)
					for (w = w200, wp_0 = 0;
						w < w200 + 7;
						w += 1, wp_0 += 1){
						// y = 7, x = 28, h = 1, w = 1, c = 3, f = 64
						// T (x, 28) (28 / 1)
