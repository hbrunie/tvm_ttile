...
fp_2 = 0;
							for (w = w198, wp_0 = 0;w < w198 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 2) (2 / 1)
								for (x = x344, xp_1 = x344_p_0, xp_0 = 0;x < x344 + 2;x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_2810 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
											mem_vec_2811 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
											...
											mem_vec_2818 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
											mem_vec_2819 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											...
											// T (c, 4) (4 / 1)
											for (c = c344, cp_1 = c344_p_0, cp_0 = 0;c < c344 + 4;c += 1, cp_1 += 1, cp_0 += 1){
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_2810);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_2811);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_2818);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_2819);
