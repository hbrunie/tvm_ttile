...
x824_p_1 = 0;
					for (w = w378, wp_0 = 0;w < w378 + 3;w += 1, wp_0 += 1){
						...
						for (x = x824, xp_2 = x824_p_1, xp_1 = x824_p_0, xp_0 = 0;x < x824 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_5534 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
									mem_vec_5535 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_5534);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_5535);
						}
					}
}
