					...
					for (x504 = x505, x504_p_1 = x505_p_0, x504_p_0 = 0;
						...
						for (x = x504, xp_2 = x504_p_1, xp_1 = x504_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_4644 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_4645 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
									// T (c, 32) (32 / 1)
									for (c = c378, cp_1 = c378_p_0, cp_0 = 0;
										c < c378 + 32;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_4644);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_4645);
						}
					}
				}
		}
