...
/*
[V f; U (4, f); U (2, y); U (3, h); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, x); T (136, y); T (8, c); T (68, x); T (1, x)]
*/
IND_TYPE c, cp_0, c210_p_0, cp_1, c210, w, wp_0, x, xp_0, x350_p_0, x351_p_0, x352_p_0, xp_1, x350_p_1, x351_p_1, xp_2, x350_p_2, xp_3, x350, x351, x352, y, yp_0;
...
for (x352 = x353, x352_p_0 = 0;
	x352 < x353 + 272;
	x352 += 272, x352_p_0 += 272){
	// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (x, 68) (272 / 4)
	for (x351 = x352, x351_p_1 = x352_p_0, x351_p_0 = 0;
		x351 < x352 + 272;
		x351 += 4, x351_p_1 += 4, x351_p_0 += 4){
						...
						for (x = x350, xp_3 = x350_p_2, xp_2 = x350_p_1, xp_1 = x350_p_0, xp_0 = 0;
							...
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c210, cp_1 = c210_p_0, cp_0 = 0;
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_896);
										mem_vec_896 = vec_14;

										vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_897);
										mem_vec_897 = vec_17;

										vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_898);
										mem_vec_898 = vec_19;

										vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_899);
										mem_vec_899 = vec_21;
										scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_24 = _mm512_set1_ps(scal_3);


										vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_900);
										mem_vec_900 = vec_23;



										vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_901);
										mem_vec_901 = vec_25;



										vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_902);
										mem_vec_902 = vec_26;



										vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_903);
										mem_vec_903 = vec_27;
										scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_29 = _mm512_set1_ps(scal_4);
										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_896);
										mem_vec_896 = vec_28;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_897);
										mem_vec_897 = vec_31;

										vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_898);
										mem_vec_898 = vec_33;

										vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_899);
										mem_vec_899 = vec_35;
										scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_38 = _mm512_set1_ps(scal_5);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_900);
										mem_vec_900 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_901);
										mem_vec_901 = vec_39;



										vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_902);
										mem_vec_902 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_903);
										mem_vec_903 = vec_41;
									}
