...
fp_1 = 0;
					for (h = h58, hp_0 = 0;h < h58 + 3;h += 1, hp_0 += 1){
						...
						for (x = x108, xp_1 = x108_p_0, xp_0 = 0;x < x108 + 7;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_621 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_622 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_623 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_621);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_622);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_623);
						}
					}
}
