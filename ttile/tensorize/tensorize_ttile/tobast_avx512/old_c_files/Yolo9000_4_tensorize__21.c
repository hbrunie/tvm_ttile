...
yp_0 = 0;
						for (h = h112, hp_0 = 0;h < h112 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 136) (136 / 1)
							for (x = x252, xp_1 = x252_p_0, xp_0 = 0;x < x252 + 136;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_813 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										mem_vec_814 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
										mem_vec_815 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_813);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_814);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_815);
							}
						}
}
