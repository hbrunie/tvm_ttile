...
[V f; U (2, f); ULambda y; T (3, c); Hoist_vars [c]; T (2, x); T (3, w);
  ...
  T (2, x); T (4, y); T (136, x)]
*/
IND_TYPE c, cp_0, h, hp_0, w, wp_0, x, xp_0, x274_p_0, x275_p_0, xp_1, x274_p_1, xp_2, x274, x275, y, yp_0, y216_p_0, yp_1, y216;
IND_TYPE y217 = 0;
IND_TYPE x276 = 0;
IND_TYPE h120 = 0;
IND_TYPE w106 = 0;
...
y216 = 0;
y216_p_0 = 0;
		for (x274 = x275, x274_p_1 = x275_p_0, x274_p_0 = 0;x274 < x275 + 4;x274 += 2, x274_p_1 += 2, x274_p_0 += 2){
				for (y = y216, yp_1 = y216_p_0, yp_0 = 0;y < y216 + 81;y += 9, yp_1 += 9, yp_0 += 9){
					...
					for (h = h120, hp_0 = 0;h < h120 + 3;h += 1, hp_0 += 1){
						...
						for (w = w106, wp_0 = 0;w < w106 + 3;w += 1, wp_0 += 1){
							...
							for (x = x274, xp_2 = x274_p_1, xp_1 = x274_p_0, xp_0 = 0;x < x274 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c140, cp_0 = 0;c < c140 + 3;c += 1, cp_0 += 1){
				...
				for (y = y216 + 81, yp_1 = y216_p_0, yp_0 = 0;y < y216 + 81 + 55;y += 11, yp_1 += 11, yp_0 += 11){
					// y = ph_y, x = 2, h = 3, w = 3, c = 3, f = 32
					// T (h, 3) (3 / 1)
					for (h = h120, hp_0 = 0;h < h120 + 3;h += 1, hp_0 += 1){
						// y = ph_y, x = 2, h = 1, w = 3, c = 3, f = 32
