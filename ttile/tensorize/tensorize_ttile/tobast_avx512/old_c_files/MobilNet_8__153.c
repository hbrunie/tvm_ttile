...
[V f; U (4, f); U (7, y); U (3, w); T (256, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (2, c); T (8, f); T (1, y); T (1, c)]
*/
IND_TYPE c, cp_0, c456_p_0, c457_p_0, cp_1, c456_p_1, cp_2, c456, c457, f, fp_0, h, hp_0, x, xp_0, y, yp_0;
					...
					for (x = x284, xp_0 = 0;
						...
						x += 1, xp_0 += 1){
								...
								for (c = c456, cp_2 = c456_p_1, cp_1 = c456_p_0, cp_0 = 0;
									...
									vec_39 = _mm512_fmadd_ps(vec_40, vec_41, mem_vec_2044);
									mem_vec_2044 = vec_39;

									vec_43 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

									vec_42 = _mm512_fmadd_ps(vec_40, vec_43, mem_vec_2045);
									mem_vec_2045 = vec_42;

									vec_45 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

									vec_44 = _mm512_fmadd_ps(vec_40, vec_45, mem_vec_2046);
									mem_vec_2046 = vec_44;

									vec_47 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

									vec_46 = _mm512_fmadd_ps(vec_40, vec_47, mem_vec_2047);
									mem_vec_2047 = vec_46;
									scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
									vec_49 = _mm512_set1_ps(scal_8);


									vec_48 = _mm512_fmadd_ps(vec_49, vec_41, mem_vec_2048);
									mem_vec_2048 = vec_48;



									vec_50 = _mm512_fmadd_ps(vec_49, vec_43, mem_vec_2049);
									mem_vec_2049 = vec_50;



									vec_51 = _mm512_fmadd_ps(vec_49, vec_45, mem_vec_2050);
									mem_vec_2050 = vec_51;



									vec_52 = _mm512_fmadd_ps(vec_49, vec_47, mem_vec_2051);
									mem_vec_2051 = vec_52;
									scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
									vec_54 = _mm512_set1_ps(scal_9);


									vec_53 = _mm512_fmadd_ps(vec_54, vec_41, mem_vec_2052);
									mem_vec_2052 = vec_53;



									vec_55 = _mm512_fmadd_ps(vec_54, vec_43, mem_vec_2053);
									mem_vec_2053 = vec_55;



									vec_56 = _mm512_fmadd_ps(vec_54, vec_45, mem_vec_2054);
									mem_vec_2054 = vec_56;



									vec_57 = _mm512_fmadd_ps(vec_54, vec_47, mem_vec_2055);
									mem_vec_2055 = vec_57;
									scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
									vec_59 = _mm512_set1_ps(scal_10);


									vec_58 = _mm512_fmadd_ps(vec_59, vec_41, mem_vec_2056);
									mem_vec_2056 = vec_58;



									vec_60 = _mm512_fmadd_ps(vec_59, vec_43, mem_vec_2057);
									mem_vec_2057 = vec_60;



									vec_61 = _mm512_fmadd_ps(vec_59, vec_45, mem_vec_2058);
									mem_vec_2058 = vec_61;



									vec_62 = _mm512_fmadd_ps(vec_59, vec_47, mem_vec_2059);
									mem_vec_2059 = vec_62;
									scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
									vec_64 = _mm512_set1_ps(scal_11);


									vec_63 = _mm512_fmadd_ps(vec_64, vec_41, mem_vec_2060);
									mem_vec_2060 = vec_63;



									vec_65 = _mm512_fmadd_ps(vec_64, vec_43, mem_vec_2061);
									mem_vec_2061 = vec_65;



									vec_66 = _mm512_fmadd_ps(vec_64, vec_45, mem_vec_2062);
									mem_vec_2062 = vec_66;



									vec_67 = _mm512_fmadd_ps(vec_64, vec_47, mem_vec_2063);
									mem_vec_2063 = vec_67;
									scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
									vec_69 = _mm512_set1_ps(scal_12);


									vec_68 = _mm512_fmadd_ps(vec_69, vec_41, mem_vec_2064);
									mem_vec_2064 = vec_68;



									vec_70 = _mm512_fmadd_ps(vec_69, vec_43, mem_vec_2065);
									mem_vec_2065 = vec_70;



									vec_71 = _mm512_fmadd_ps(vec_69, vec_45, mem_vec_2066);
									mem_vec_2066 = vec_71;



									vec_72 = _mm512_fmadd_ps(vec_69, vec_47, mem_vec_2067);
									mem_vec_2067 = vec_72;
									scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h) + c];
									vec_74 = _mm512_set1_ps(scal_13);


									vec_73 = _mm512_fmadd_ps(vec_74, vec_41, mem_vec_2068);
									mem_vec_2068 = vec_73;



									vec_75 = _mm512_fmadd_ps(vec_74, vec_43, mem_vec_2069);
									mem_vec_2069 = vec_75;



									vec_76 = _mm512_fmadd_ps(vec_74, vec_45, mem_vec_2070);
									mem_vec_2070 = vec_76;



									vec_77 = _mm512_fmadd_ps(vec_74, vec_47, mem_vec_2071);
									mem_vec_2071 = vec_77;
									scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
									vec_79 = _mm512_set1_ps(scal_14);
									vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

									vec_78 = _mm512_fmadd_ps(vec_79, vec_80, mem_vec_2044);
									mem_vec_2044 = vec_78;

									vec_82 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

									vec_81 = _mm512_fmadd_ps(vec_79, vec_82, mem_vec_2045);
									mem_vec_2045 = vec_81;

									vec_84 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

									vec_83 = _mm512_fmadd_ps(vec_79, vec_84, mem_vec_2046);
									mem_vec_2046 = vec_83;

									vec_86 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

									vec_85 = _mm512_fmadd_ps(vec_79, vec_86, mem_vec_2047);
									mem_vec_2047 = vec_85;
									scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
									vec_88 = _mm512_set1_ps(scal_15);


									vec_87 = _mm512_fmadd_ps(vec_88, vec_80, mem_vec_2048);
									mem_vec_2048 = vec_87;



									vec_89 = _mm512_fmadd_ps(vec_88, vec_82, mem_vec_2049);
									mem_vec_2049 = vec_89;



									vec_90 = _mm512_fmadd_ps(vec_88, vec_84, mem_vec_2050);
									mem_vec_2050 = vec_90;



									vec_91 = _mm512_fmadd_ps(vec_88, vec_86, mem_vec_2051);
									mem_vec_2051 = vec_91;
									scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
									vec_93 = _mm512_set1_ps(scal_16);


									vec_92 = _mm512_fmadd_ps(vec_93, vec_80, mem_vec_2052);
									mem_vec_2052 = vec_92;



									vec_94 = _mm512_fmadd_ps(vec_93, vec_82, mem_vec_2053);
									mem_vec_2053 = vec_94;



									vec_95 = _mm512_fmadd_ps(vec_93, vec_84, mem_vec_2054);
									mem_vec_2054 = vec_95;



									vec_96 = _mm512_fmadd_ps(vec_93, vec_86, mem_vec_2055);
									mem_vec_2055 = vec_96;
									scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
									vec_98 = _mm512_set1_ps(scal_17);


									vec_97 = _mm512_fmadd_ps(vec_98, vec_80, mem_vec_2056);
									mem_vec_2056 = vec_97;



									vec_99 = _mm512_fmadd_ps(vec_98, vec_82, mem_vec_2057);
									mem_vec_2057 = vec_99;



									vec_100 = _mm512_fmadd_ps(vec_98, vec_84, mem_vec_2058);
									mem_vec_2058 = vec_100;



									vec_101 = _mm512_fmadd_ps(vec_98, vec_86, mem_vec_2059);
									mem_vec_2059 = vec_101;
									scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
									vec_103 = _mm512_set1_ps(scal_18);


									vec_102 = _mm512_fmadd_ps(vec_103, vec_80, mem_vec_2060);
									mem_vec_2060 = vec_102;



									vec_104 = _mm512_fmadd_ps(vec_103, vec_82, mem_vec_2061);
									mem_vec_2061 = vec_104;



									vec_105 = _mm512_fmadd_ps(vec_103, vec_84, mem_vec_2062);
									mem_vec_2062 = vec_105;



									vec_106 = _mm512_fmadd_ps(vec_103, vec_86, mem_vec_2063);
									mem_vec_2063 = vec_106;
									scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
									vec_108 = _mm512_set1_ps(scal_19);


									vec_107 = _mm512_fmadd_ps(vec_108, vec_80, mem_vec_2064);
									mem_vec_2064 = vec_107;



									vec_109 = _mm512_fmadd_ps(vec_108, vec_82, mem_vec_2065);
									mem_vec_2065 = vec_109;



									vec_110 = _mm512_fmadd_ps(vec_108, vec_84, mem_vec_2066);
									mem_vec_2066 = vec_110;



									vec_111 = _mm512_fmadd_ps(vec_108, vec_86, mem_vec_2067);
									mem_vec_2067 = vec_111;
									scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
									vec_113 = _mm512_set1_ps(scal_20);


									vec_112 = _mm512_fmadd_ps(vec_113, vec_80, mem_vec_2068);
									mem_vec_2068 = vec_112;



									vec_114 = _mm512_fmadd_ps(vec_113, vec_82, mem_vec_2069);
									mem_vec_2069 = vec_114;



									vec_115 = _mm512_fmadd_ps(vec_113, vec_84, mem_vec_2070);
									mem_vec_2070 = vec_115;



									vec_116 = _mm512_fmadd_ps(vec_113, vec_86, mem_vec_2071);
