...
// T (c, 2) (1024 / 512)
for (c1480 = c1481, c1480_p_0 = 0;
	c1480 < c1481 + 1024;
	c1480 += 512, c1480_p_0 += 512){
	...
	for (f1002 = f1003, f1002_p_0 = 0;
		...
		// T (c, 4) (512 / 128)
		for (c1479 = c1480, c1479_p_1 = c1480_p_0, c1479_p_0 = 0;
			c1479 < c1480 + 512;
			c1479 += 128, c1479_p_1 += 128, c1479_p_0 += 128){
				for (y = y474, yp_0 = 0;
					y < y474 + 3;
					y += 3, yp_0 += 3){
					...
					for (f = f1002, fp_1 = f1002_p_0, fp_0 = 0;
						...
						// y = ph_y, x = 7, h = 3, w = 3, c = 128, f = 64
						// T (c, 8) (128 / 16)
						for (c1478 = c1479, c1478_p_2 = c1479_p_1, c1478_p_1 = c1479_p_0, c1478_p_0 = 0;
							c1478 < c1479 + 128;
							c1478 += 16, c1478_p_2 += 16, c1478_p_1 += 16, c1478_p_0 += 16){
							...
							for (w = w500, wp_0 = 0;
								...
								for (x = x620, xp_0 = 0;
									...
									x += 1, xp_0 += 1){
											...
											// T (c, 16) (16 / 1)
											for (c = c1478, cp_3 = c1478_p_2, cp_2 = c1478_p_1, cp_1 = c1478_p_0, cp_0 = 0;
												c < c1478 + 16;
								...
								for (x = x620, xp_0 = 0;
									...
									x += 1, xp_0 += 1){
											...
											for (c = c1478, cp_3 = c1478_p_2, cp_2 = c1478_p_1, cp_1 = c1478_p_0, cp_0 = 0;
												...
												vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_5648);
												mem_vec_5648 = vec_24;

												vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_5649);
												mem_vec_5649 = vec_27;

												vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

												vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_5650);
												mem_vec_5650 = vec_29;

												vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

												vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_5651);
												mem_vec_5651 = vec_31;
												scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_34 = _mm512_set1_ps(scal_5);


												vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_5652);
												mem_vec_5652 = vec_33;



												vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_5653);
												mem_vec_5653 = vec_35;



												vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_5654);
												mem_vec_5654 = vec_36;



												vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_5655);
												mem_vec_5655 = vec_37;
												scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_39 = _mm512_set1_ps(scal_6);


												vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_5656);
												mem_vec_5656 = vec_38;



												vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_5657);
												mem_vec_5657 = vec_40;



												vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_5658);
												mem_vec_5658 = vec_41;



												vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_5659);
												mem_vec_5659 = vec_42;
												scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_44 = _mm512_set1_ps(scal_7);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_5660);
												mem_vec_5660 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_5661);
												mem_vec_5661 = vec_45;



												vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_5662);
												mem_vec_5662 = vec_46;



												vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_5663);
												mem_vec_5663 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_49 = _mm512_set1_ps(scal_8);
												vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_5648);
												mem_vec_5648 = vec_48;

												vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_5649);
												mem_vec_5649 = vec_51;

												vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

												vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_5650);
												mem_vec_5650 = vec_53;

												vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

												vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_5651);
												mem_vec_5651 = vec_55;
												scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_58 = _mm512_set1_ps(scal_9);


												vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_5652);
												mem_vec_5652 = vec_57;



												vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_5653);
												mem_vec_5653 = vec_59;



												vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_5654);
												mem_vec_5654 = vec_60;



												vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_5655);
												mem_vec_5655 = vec_61;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_63 = _mm512_set1_ps(scal_10);


												vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_5656);
												mem_vec_5656 = vec_62;



												vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_5657);
												mem_vec_5657 = vec_64;



												vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_5658);
												mem_vec_5658 = vec_65;



												vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_5659);
												mem_vec_5659 = vec_66;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_68 = _mm512_set1_ps(scal_11);


												vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_5660);
												mem_vec_5660 = vec_67;



												vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_5661);
												mem_vec_5661 = vec_69;



												vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_5662);
												mem_vec_5662 = vec_70;



												vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_5663);
												mem_vec_5663 = vec_71;
											}
