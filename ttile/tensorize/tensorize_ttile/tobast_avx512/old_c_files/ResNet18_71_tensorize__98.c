...
fp_1 = 0;
					for (h = h330, hp_0 = 0;h < h330 + 3;h += 1, hp_0 += 1){
						...
						for (x = x736, xp_0 = 0;x < x736 + 14;x += 1, xp_0 += 1){
									...
									mem_vec_5569 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_5570 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_5571 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5569);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5570);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5571);
						}
					}
}
