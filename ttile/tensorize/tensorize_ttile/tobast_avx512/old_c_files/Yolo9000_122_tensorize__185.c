...
fp_2 = 0;
							for (w = w210, wp_0 = 0;w < w210 + 3;w += 1, wp_0 += 1){
								...
								for (x = x362, xp_1 = x362_p_0, xp_0 = 0;x < x362 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2999 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
											...
											mem_vec_3005 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 8, f = 32
											// T (c, 8) (8 / 1)
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_2999);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_3005);
								}
							}
}
