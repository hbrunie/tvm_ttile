...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (4, x);
  T (3, h); T (1, x); T (68, y); T (1, c); T (1, x); T (68, x)]
*/
IND_TYPE c, cp_0, c582_p_0, cp_1, c582, h, hp_0, x, xp_0, x978_p_0, x979_p_0, x980_p_0, xp_1, x978_p_1, x979_p_1, xp_2, x978_p_2, xp_3, x978, x979, x980, y, yp_0;
...
for (x980 = x981, x980_p_0 = 0;
	...
	// T (x, 1) (4 / 4)
	for (x979 = x980, x979_p_1 = x980_p_0, x979_p_0 = 0;
		x979 < x980 + 4;
		x979 += 4, x979_p_1 += 4, x979_p_0 += 4){
		// y = 272, x = 4, h = 3, w = 3, c = 32, f = 64
		// T (c, 1) (32 / 32)
		for (c582 = c583, c582_p_0 = 0;
			...
			for (y = y408, yp_0 = 0;
				...
				// T (x, 1) (4 / 4)
				for (x978 = x979, x978_p_2 = x979_p_1, x978_p_1 = x979_p_0, x978_p_0 = 0;
					x978 < x979 + 4;
					x978 += 4, x978_p_2 += 4, x978_p_1 += 4, x978_p_0 += 4){
					// y = 4, x = 4, h = 3, w = 3, c = 32, f = 64
					// T (h, 3) (3 / 1)
					for (h = h312, hp_0 = 0;
						h < h312 + 3;
						...
						// T (x, 4) (4 / 1)
						for (x = x978, xp_3 = x978_p_2, xp_2 = x978_p_1, xp_1 = x978_p_0, xp_0 = 0;
							x < x978 + 4;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c582, cp_1 = c582_p_0, cp_0 = 0;
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_2320);
										mem_vec_2320 = vec_24;

										vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_2321);
										mem_vec_2321 = vec_27;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_2322);
										mem_vec_2322 = vec_29;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_2323);
										mem_vec_2323 = vec_31;
										scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_34 = _mm512_set1_ps(scal_5);


										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_2324);
										mem_vec_2324 = vec_33;



										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_2325);
										mem_vec_2325 = vec_35;



										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_2326);
										mem_vec_2326 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_2327);
										mem_vec_2327 = vec_37;
										scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_2328);
										mem_vec_2328 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_2329);
										mem_vec_2329 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_2330);
										mem_vec_2330 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_2331);
										mem_vec_2331 = vec_42;
										scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_44 = _mm512_set1_ps(scal_7);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_2332);
										mem_vec_2332 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_2333);
										mem_vec_2333 = vec_45;



										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_2334);
										mem_vec_2334 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_2335);
										mem_vec_2335 = vec_47;
										scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_2320);
										mem_vec_2320 = vec_48;

										vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_2321);
										mem_vec_2321 = vec_51;

										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_2322);
										mem_vec_2322 = vec_53;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_2323);
										mem_vec_2323 = vec_55;
										scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_58 = _mm512_set1_ps(scal_9);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_2324);
										mem_vec_2324 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_2325);
										mem_vec_2325 = vec_59;



										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_2326);
										mem_vec_2326 = vec_60;



										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_2327);
										mem_vec_2327 = vec_61;
										scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_63 = _mm512_set1_ps(scal_10);


										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_2328);
										mem_vec_2328 = vec_62;



										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_2329);
										mem_vec_2329 = vec_64;



										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_2330);
										mem_vec_2330 = vec_65;



										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_2331);
										mem_vec_2331 = vec_66;
										scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_2332);
										mem_vec_2332 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_2333);
										mem_vec_2333 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_2334);
										mem_vec_2334 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_2335);
										mem_vec_2335 = vec_71;
									}
