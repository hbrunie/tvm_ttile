...
[V f; U (2, f); U (7, y); U (3, w); T (4, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (8, c); T (8, f); T (28, x); T (4, y); T (8, c)]
*/
IND_TYPE c, cp_0, c272_p_0, c273_p_0, cp_1, c272_p_1, cp_2, c272, c273, f, fp_0, h, hp_0, x, xp_0, x222_p_0, xp_1, x222, y, yp_0;
