...
[V f; U (1, f); U (4, y); U (3, w); T (64, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (34, y); T (4, f); T (1, c); T (1, f); T (136, x); T (2, f)]
*/
IND_TYPE c, cp_0, c198_p_0, cp_1, c198, f, fp_0, f164_p_0, f165_p_0, fp_1, f164_p_1, fp_2, f164, f165, h, hp_0, x, xp_0, x246_p_0, xp_1, x246, y, yp_0;
IND_TYPE y132 = 0;
IND_TYPE x247 = 0;
IND_TYPE h108 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
						for (h = h108, hp_0 = 0;h < h108 + 3;h += 1, hp_0 += 1){
							...
							for (x = x246, xp_1 = x246_p_0, xp_0 = 0;x < x246 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_803 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										// y = 4, x = 1, h = 1, w = 3, c = 64, f = 16
										// T (c, 64) (64 / 1)
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_803);
							}
						}
}
