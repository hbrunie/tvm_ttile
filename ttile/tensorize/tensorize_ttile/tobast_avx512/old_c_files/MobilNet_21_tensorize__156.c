...
x736_p_1 = 0;
						for (w = w328, wp_0 = 0;w < w328 + 3;w += 1, wp_0 += 1){
							...
							for (x = x736, xp_2 = x736_p_1, xp_1 = x736_p_0, xp_0 = 0;x < x736 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4566 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_4567 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_4566);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_4567);
							}
						}
}
