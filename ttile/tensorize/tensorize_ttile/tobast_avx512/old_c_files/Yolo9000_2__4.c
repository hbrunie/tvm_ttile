...
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (34, x); T (68, y); T (4, c); T (4, x); T (1, x)]
*/
IND_TYPE c, cp_0, c42_p_0, cp_1, c42, h, hp_0, w, wp_0, x, xp_0, x70_p_0, x71_p_0, x72_p_0, xp_1, x70_p_1, x71_p_1, xp_2, x70_p_2, xp_3, x70, x71, x72, y, yp_0;
