...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (8, c); Hoist_vars [c];
  T (2, x); T (1, x); T (68, y); T (4, f); T (4, c); T (1, x); T (136, x)]
*/
IND_TYPE c, cp_0, c642_p_0, cp_1, c642, f, fp_0, x, xp_0, x1078_p_0, x1079_p_0, x1080_p_0, xp_1, x1078_p_1, x1079_p_1, xp_2, x1078_p_2, xp_3, x1078, x1079, x1080, y, yp_0;
...
for (x1080 = x1081, x1080_p_0 = 0;
	...
	// T (x, 1) (2 / 2)
	for (x1079 = x1080, x1079_p_1 = x1080_p_0, x1079_p_0 = 0;
		x1079 < x1080 + 2;
		x1079 += 2, x1079_p_1 += 2, x1079_p_0 += 2){
		// y = 272, x = 2, h = 3, w = 3, c = 32, f = 64
		// T (c, 4) (32 / 8)
		for (c642 = c643, c642_p_0 = 0;
			...
			for (f = f350, fp_0 = 0;
				f < f350 + 64;
				f += 16, fp_0 += 16){
				// y = 272, x = 2, h = 3, w = 3, c = 8, f = 16
				// T (y, 68) (272 / 4)
				for (y = y448, yp_0 = 0;
					y < y448 + 272;
					y += 4, yp_0 += 4){
					// y = 4, x = 2, h = 3, w = 3, c = 8, f = 16
					// T (x, 1) (2 / 2)
					for (x1078 = x1079, x1078_p_2 = x1079_p_1, x1078_p_1 = x1079_p_0, x1078_p_0 = 0;
						x1078 < x1079 + 2;
						x1078 += 2, x1078_p_2 += 2, x1078_p_1 += 2, x1078_p_0 += 2){
						// y = 4, x = 2, h = 3, w = 3, c = 8, f = 16
						// T (x, 2) (2 / 1)
						for (x = x1078, xp_3 = x1078_p_2, xp_2 = x1078_p_1, xp_1 = x1078_p_0, xp_0 = 0;
							x < x1078 + 2;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_2427 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c642, cp_1 = c642_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2425);
										mem_vec_2425 = vec_3;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_2427);
						}
					}
				}
			}
