...
[V f; U (2, f); ULambda y; U (3, w); T (16, c); Hoist_vars [c]; T (7, x);
  ...
  T (2, f); T (2, c); T (8, f); T (16, c); T (2, x); T (1, f)]
*/
IND_TYPE c, cp_0, c788_p_0, c789_p_0, cp_1, c788_p_1, cp_2, c788, c789, f, fp_0, f648_p_0, f649_p_0, fp_1, f648_p_1, fp_2, f648, f649, h, hp_0, x, xp_0, x608_p_0, xp_1, x608, y, yp_0;
IND_TYPE y408 = 0;
IND_TYPE x609 = 0;
IND_TYPE h348 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
								for (h = h348, hp_0 = 0;h < h348 + 3;h += 1, hp_0 += 1){
									...
									// T (x, 7) (7 / 1)
									for (x = x608, xp_1 = x608_p_0, xp_0 = 0;x < x608 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 16) (16 / 1)
												for (c = c788, cp_2 = c788_p_1, cp_1 = c788_p_0, cp_0 = 0;c < c788 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
