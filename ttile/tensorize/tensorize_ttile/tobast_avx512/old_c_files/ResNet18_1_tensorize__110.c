...
x400 = 0;
x400_p_1 = 0;
				for (h = h200, hp_0 = 0;h < h200 + 7;h += 1, hp_0 += 1){
					// y = 7, x = 28, h = 1, w = 7, c = 3, f = 64
					// T (w, 7) (7 / 1)
					for (w = w200, wp_0 = 0;w < w200 + 7;w += 1, wp_0 += 1){
						// y = 7, x = 28, h = 1, w = 1, c = 3, f = 64
						// T (x, 28) (28 / 1)
						for (x = x400, xp_2 = x400_p_1, xp_1 = x400_p_0, xp_0 = 0;x < x400 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
