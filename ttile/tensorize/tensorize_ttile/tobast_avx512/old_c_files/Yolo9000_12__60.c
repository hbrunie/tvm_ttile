								...
								for (x = x680, xp_1 = x680_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c680, cp_1 = c680_p_0, cp_0 = 0;
												...
												vec_29 = _mm512_fmadd_ps(vec_30, vec_31, mem_vec_6310);
												mem_vec_6310 = vec_29;

												vec_33 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_6311);
												mem_vec_6311 = vec_32;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_35 = _mm512_set1_ps(scal_10);


												vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_6312);
												mem_vec_6312 = vec_34;



												vec_36 = _mm512_fmadd_ps(vec_35, vec_33, mem_vec_6313);
												mem_vec_6313 = vec_36;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_38 = _mm512_set1_ps(scal_11);


												vec_37 = _mm512_fmadd_ps(vec_38, vec_31, mem_vec_6314);
												mem_vec_6314 = vec_37;



												vec_39 = _mm512_fmadd_ps(vec_38, vec_33, mem_vec_6315);
												mem_vec_6315 = vec_39;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_41 = _mm512_set1_ps(scal_12);


												vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_6316);
												mem_vec_6316 = vec_40;



												vec_42 = _mm512_fmadd_ps(vec_41, vec_33, mem_vec_6317);
												mem_vec_6317 = vec_42;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_44 = _mm512_set1_ps(scal_13);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_6318);
												mem_vec_6318 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_6319);
												mem_vec_6319 = vec_45;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
												vec_47 = _mm512_set1_ps(scal_14);


												vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_6320);
												mem_vec_6320 = vec_46;



												vec_48 = _mm512_fmadd_ps(vec_47, vec_33, mem_vec_6321);
												mem_vec_6321 = vec_48;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
												vec_50 = _mm512_set1_ps(scal_15);


												vec_49 = _mm512_fmadd_ps(vec_50, vec_31, mem_vec_6322);
												mem_vec_6322 = vec_49;



												vec_51 = _mm512_fmadd_ps(vec_50, vec_33, mem_vec_6323);
												mem_vec_6323 = vec_51;
												scal_16 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
												vec_53 = _mm512_set1_ps(scal_16);


												vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_6324);
												mem_vec_6324 = vec_52;



												vec_54 = _mm512_fmadd_ps(vec_53, vec_33, mem_vec_6325);
												mem_vec_6325 = vec_54;
												scal_17 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
												vec_56 = _mm512_set1_ps(scal_17);


												vec_55 = _mm512_fmadd_ps(vec_56, vec_31, mem_vec_6326);
												mem_vec_6326 = vec_55;



												vec_57 = _mm512_fmadd_ps(vec_56, vec_33, mem_vec_6327);
												mem_vec_6327 = vec_57;
												scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_59 = _mm512_set1_ps(scal_18);
												vec_60 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_58 = _mm512_fmadd_ps(vec_59, vec_60, mem_vec_6310);
												mem_vec_6310 = vec_58;

												vec_62 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_6311);
												mem_vec_6311 = vec_61;
												scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_64 = _mm512_set1_ps(scal_19);


												vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_6312);
												mem_vec_6312 = vec_63;



												vec_65 = _mm512_fmadd_ps(vec_64, vec_62, mem_vec_6313);
												mem_vec_6313 = vec_65;
												scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_67 = _mm512_set1_ps(scal_20);


												vec_66 = _mm512_fmadd_ps(vec_67, vec_60, mem_vec_6314);
												mem_vec_6314 = vec_66;



												vec_68 = _mm512_fmadd_ps(vec_67, vec_62, mem_vec_6315);
												mem_vec_6315 = vec_68;
												scal_21 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_70 = _mm512_set1_ps(scal_21);


												vec_69 = _mm512_fmadd_ps(vec_70, vec_60, mem_vec_6316);
												mem_vec_6316 = vec_69;



												vec_71 = _mm512_fmadd_ps(vec_70, vec_62, mem_vec_6317);
												mem_vec_6317 = vec_71;
												scal_22 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_73 = _mm512_set1_ps(scal_22);


												vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_6318);
												mem_vec_6318 = vec_72;



												vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_6319);
												mem_vec_6319 = vec_74;
												scal_23 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_76 = _mm512_set1_ps(scal_23);


												vec_75 = _mm512_fmadd_ps(vec_76, vec_60, mem_vec_6320);
												mem_vec_6320 = vec_75;



												vec_77 = _mm512_fmadd_ps(vec_76, vec_62, mem_vec_6321);
												mem_vec_6321 = vec_77;
												scal_24 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
												vec_79 = _mm512_set1_ps(scal_24);


												vec_78 = _mm512_fmadd_ps(vec_79, vec_60, mem_vec_6322);
												mem_vec_6322 = vec_78;



												vec_80 = _mm512_fmadd_ps(vec_79, vec_62, mem_vec_6323);
												mem_vec_6323 = vec_80;
												scal_25 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
												vec_82 = _mm512_set1_ps(scal_25);


												vec_81 = _mm512_fmadd_ps(vec_82, vec_60, mem_vec_6324);
												mem_vec_6324 = vec_81;



												vec_83 = _mm512_fmadd_ps(vec_82, vec_62, mem_vec_6325);
												mem_vec_6325 = vec_83;
												scal_26 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
												vec_85 = _mm512_set1_ps(scal_26);


												vec_84 = _mm512_fmadd_ps(vec_85, vec_60, mem_vec_6326);
												mem_vec_6326 = vec_84;



												vec_86 = _mm512_fmadd_ps(vec_85, vec_62, mem_vec_6327);
												mem_vec_6327 = vec_86;
											}
