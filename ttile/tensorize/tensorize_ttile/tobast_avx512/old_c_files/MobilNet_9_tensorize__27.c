...
[V f; U (2, f); U (7, y); T (2, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, c); T (16, f); T (16, c); T (2, f); T (8, c)]
*/
IND_TYPE c, cp_0, c50_p_0, c51_p_0, c52_p_0, cp_1, c50_p_1, c51_p_1, cp_2, c50_p_2, cp_3, c50, c51, c52, f, fp_0, f30_p_0, fp_1, f30, h, hp_0, w, wp_0, x, xp_0;
IND_TYPE y = 0;
IND_TYPE x20 = 0;
IND_TYPE h20 = 0;
IND_TYPE w20 = 0;
...
c50_p_2 = 0;
					for (h = h20, hp_0 = 0;h < h20 + 3;h += 1, hp_0 += 1){
						...
						for (w = w20, wp_0 = 0;w < w20 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 7) (7 / 1)
							for (x = x20, xp_0 = 0;x < x20 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 2) (2 / 1)
										for (c = c50, cp_3 = c50_p_2, cp_2 = c50_p_1, cp_1 = c50_p_0, cp_0 = 0;c < c50 + 2;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
