	...
	for (f = f96, fp_0 = 0;
		...
		for (y = y96, yp_0 = 0;
			...
			for (x192 = x193, x192_p_1 = x193_p_0, x192_p_0 = 0;
				x192 < x193 + 28;
				x192 += 14, x192_p_1 += 14, x192_p_0 += 14){
					...
					for (w = w96, wp_0 = 0;
						...
						for (x = x192, xp_2 = x192_p_1, xp_1 = x192_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_849 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
									mem_vec_850 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_851 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
									mem_vec_852 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_853 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									mem_vec_854 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_855 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_856 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_857 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_858 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_859 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_849);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_850);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_851);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_852);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_853);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_854);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_855);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_856);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_857);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_858);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_859);
						}
					}
				}
			}
