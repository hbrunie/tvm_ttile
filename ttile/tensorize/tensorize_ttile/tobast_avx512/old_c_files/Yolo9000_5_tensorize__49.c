...
/*
[V f; U (4, f); U (4, y); T (2, c); Hoist_vars [c]; T (4, x); T (34, y);
  T (64, c); T (34, x)]
*/
IND_TYPE c, cp_0, c182_p_0, cp_1, c182, x, xp_0, x238_p_0, xp_1, x238, y, yp_0;
IND_TYPE y140 = 0;
IND_TYPE x239 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
			for (x = x238, xp_1 = x238_p_0, xp_0 = 0;x < x238 + 4;x += 1, xp_1 += 1, xp_0 += 1){
						...
						// T (c, 2) (2 / 1)
						for (c = c182, cp_1 = c182_p_0, cp_0 = 0;c < c182 + 2;c += 1, cp_1 += 1, cp_0 += 1){
