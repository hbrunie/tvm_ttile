...
x862_p_1 = 0;
						for (h = h318, hp_0 = 0;h < h318 + 3;h += 1, hp_0 += 1){
							...
							for (x = x862, xp_2 = x862_p_1, xp_1 = x862_p_0, xp_0 = 0;x < x862 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5917 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_5918 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_5919 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_5920 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_5921 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5917);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5918);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5919);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_5920);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_5921);
							}
						}
}
