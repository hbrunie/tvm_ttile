...
[V f; U (2, f); ULambda y; U (3, w); T (2, c); Hoist_vars [c]; T (7, x);
  ...
  T (8, f); T (64, c); T (1, f); T (2, c); T (2, x); T (1, f)]
*/
IND_TYPE c, cp_0, c566_p_0, c567_p_0, cp_1, c566_p_1, cp_2, c566, c567, f, fp_0, f558_p_0, f559_p_0, fp_1, f558_p_1, fp_2, f558, f559, h, hp_0, x, xp_0, x490_p_0, xp_1, x490, y, yp_0;
IND_TYPE y328 = 0;
IND_TYPE x491 = 0;
IND_TYPE h254 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
								for (h = h254, hp_0 = 0;h < h254 + 3;h += 1, hp_0 += 1){
									...
									for (x = x490, xp_1 = x490_p_0, xp_0 = 0;x < x490 + 7;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 2) (2 / 1)
												for (c = c566, cp_2 = c566_p_1, cp_1 = c566_p_0, cp_0 = 0;c < c566 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
													...
													vec_20 = _mm512_fmadd_ps(vec_18, vec_21, mem_vec_3173);
													mem_vec_3173 = vec_20;
													scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
													vec_23 = _mm512_set1_ps(scal_6);
													vec_22 = _mm512_fmadd_ps(vec_23, vec_19, mem_vec_3174);
													mem_vec_3174 = vec_22;
													vec_24 = _mm512_fmadd_ps(vec_23, vec_21, mem_vec_3175);
													mem_vec_3175 = vec_24;
													scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
													vec_26 = _mm512_set1_ps(scal_7);
													vec_25 = _mm512_fmadd_ps(vec_26, vec_19, mem_vec_3176);
													mem_vec_3176 = vec_25;
													vec_27 = _mm512_fmadd_ps(vec_26, vec_21, mem_vec_3177);
													mem_vec_3177 = vec_27;
													scal_8 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
													vec_29 = _mm512_set1_ps(scal_8);
													vec_28 = _mm512_fmadd_ps(vec_29, vec_19, mem_vec_3178);
													mem_vec_3178 = vec_28;
													vec_30 = _mm512_fmadd_ps(vec_29, vec_21, mem_vec_3179);
													mem_vec_3179 = vec_30;
													scal_9 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
													vec_32 = _mm512_set1_ps(scal_9);
													vec_31 = _mm512_fmadd_ps(vec_32, vec_19, mem_vec_3180);
													mem_vec_3180 = vec_31;
													vec_33 = _mm512_fmadd_ps(vec_32, vec_21, mem_vec_3181);
													mem_vec_3181 = vec_33;
													...
													vec_37 = _mm512_fmadd_ps(vec_35, vec_38, mem_vec_3173);
													mem_vec_3173 = vec_37;
													scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
													vec_40 = _mm512_set1_ps(scal_11);
													vec_39 = _mm512_fmadd_ps(vec_40, vec_36, mem_vec_3174);
													mem_vec_3174 = vec_39;
													vec_41 = _mm512_fmadd_ps(vec_40, vec_38, mem_vec_3175);
													mem_vec_3175 = vec_41;
													scal_12 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
													vec_43 = _mm512_set1_ps(scal_12);
													vec_42 = _mm512_fmadd_ps(vec_43, vec_36, mem_vec_3176);
													mem_vec_3176 = vec_42;
													vec_44 = _mm512_fmadd_ps(vec_43, vec_38, mem_vec_3177);
													mem_vec_3177 = vec_44;
													scal_13 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
													vec_46 = _mm512_set1_ps(scal_13);
													vec_45 = _mm512_fmadd_ps(vec_46, vec_36, mem_vec_3178);
													mem_vec_3178 = vec_45;
													vec_47 = _mm512_fmadd_ps(vec_46, vec_38, mem_vec_3179);
													mem_vec_3179 = vec_47;
													scal_14 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
													vec_49 = _mm512_set1_ps(scal_14);
													vec_48 = _mm512_fmadd_ps(vec_49, vec_36, mem_vec_3180);
													mem_vec_3180 = vec_48;
													vec_50 = _mm512_fmadd_ps(vec_49, vec_38, mem_vec_3181);
													mem_vec_3181 = vec_50;
												}
