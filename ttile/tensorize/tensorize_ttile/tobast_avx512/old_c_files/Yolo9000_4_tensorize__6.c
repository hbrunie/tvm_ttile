...
/*
[V f; U (1, f); U (8, y); U (3, h); T (64, c); Hoist_vars [c]; T (136, x);
  T (3, w); T (17, y); T (8, f); T (1, c); T (1, x)]
*/
IND_TYPE c, cp_0, c78_p_0, cp_1, c78, f, fp_0, w, wp_0, x, xp_0, x104_p_0, xp_1, x104, y, yp_0;
IND_TYPE y52 = 0;
IND_TYPE x105 = 0;
IND_TYPE h = 0;
IND_TYPE w52 = 0;
...
yp_0 = 0;
				for (w = w52, wp_0 = 0;w < w52 + 3;w += 1, wp_0 += 1){
					// y = 8, x = 136, h = 3, w = 1, c = 64, f = 16
					// T (x, 136) (136 / 1)
					for (x = x104, xp_1 = x104_p_0, xp_0 = 0;x < x104 + 136;x += 1, xp_1 += 1, xp_0 += 1){
