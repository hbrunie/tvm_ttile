...
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, f, fp_0, h, hp_0, w, wp_0, x, x0, xp_0, x0_p_0, x1_p_0, x2_p_0, x1, xp_1, x0_p_1, x1_p_1, x2, xp_2, x0_p_2, xp_3, y, yp_0;
IND_TYPE y0 = 0;
IND_TYPE x3 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
...
x0_p_2 = 0;
						for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
							...
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 34) (34 / 1)
								for (x = x0, xp_3 = x0_p_2, xp_2 = x0_p_1, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 34;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
