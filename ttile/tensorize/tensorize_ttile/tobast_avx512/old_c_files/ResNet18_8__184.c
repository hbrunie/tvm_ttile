...
for (c285 = c286, c285_p_0 = 0;
	...
	for (y = y188, yp_0 = 0;
		...
		for (x282 = x283, x282_p_0 = 0;
			x282 < x283 + 28;
			x282 += 14, x282_p_0 += 14){
			// y = 2, x = 14, h = 3, w = 3, c = 64, f = 256
			// T (f, 2) (256 / 128)
			for (f = f280, fp_0 = 0;
				f < f280 + 256;
				f += 128, fp_0 += 128){
				// y = 2, x = 14, h = 3, w = 3, c = 64, f = 128
				// T (c, 1) (64 / 64)
					...
					for (h = h140, hp_0 = 0;
						...
						for (x = x282, xp_1 = x282_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1506 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
									mem_vec_1507 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
									mem_vec_1508 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
									mem_vec_1509 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
									mem_vec_1510 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1511 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_1512 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
									mem_vec_1513 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
									mem_vec_1514 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
									mem_vec_1515 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
									mem_vec_1516 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
									mem_vec_1517 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_1506);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_1507);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_1508);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_1509);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_1510);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_1511);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_1512);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_1513);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_1514);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_1515);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_1516);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_1517);
						}
					}
				}
			}
