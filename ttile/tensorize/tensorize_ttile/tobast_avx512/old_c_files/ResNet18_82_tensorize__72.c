...
fp_1 = 0;
						for (w = w352, wp_0 = 0;w < w352 + 3;w += 1, wp_0 += 1){
							...
							for (x = x612, xp_1 = x612_p_0, xp_0 = 0;x < x612 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4592 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_4593 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_4592);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_4593);
							}
						}
}
