...
for (x262 = x263, x262_p_0 = 0;
	x262 < x263 + 272;
	x262 += 272, x262_p_0 += 272){
	// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (x, 68) (272 / 4)
	for (x261 = x262, x261_p_1 = x262_p_0, x261_p_0 = 0;
		x261 < x262 + 272;
		x261 += 4, x261_p_1 += 4, x261_p_0 += 4){
		...
		for (c156 = c157, c156_p_0 = 0;
			...
			for (f = f88, fp_0 = 0;
				...
				for (y = y104, yp_0 = 0;
					...
					// T (x, 4) (4 / 1)
					for (x260 = x261, x260_p_2 = x261_p_1, x260_p_1 = x261_p_0, x260_p_0 = 0;
						x260 < x261 + 4;
						x260 += 1, x260_p_2 += 1, x260_p_1 += 1, x260_p_0 += 1){
						...
						for (w = w104, wp_0 = 0;
							...
							// T (x, 1) (1 / 1)
							for (x = x260, xp_3 = x260_p_2, xp_2 = x260_p_1, xp_1 = x260_p_0, xp_0 = 0;
								x < x260 + 1;
