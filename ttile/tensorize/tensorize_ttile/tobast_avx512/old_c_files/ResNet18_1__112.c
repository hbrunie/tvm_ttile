	...
	for (f = f108, fp_0 = 0;
		...
		for (y = y108, yp_0 = 0;
			...
			for (x216 = x217, x216_p_1 = x217_p_0, x216_p_0 = 0;
				x216 < x217 + 14;
				x216 += 14, x216_p_1 += 14, x216_p_0 += 14){
				// y = 14, x = 14, h = 7, w = 7, c = 3, f = 32
				// T (h, 7) (7 / 1)
				for (h = h108, hp_0 = 0;
					h < h108 + 7;
					...
					for (w = w108, wp_0 = 0;
						...
						for (x = x216, xp_2 = x216_p_1, xp_1 = x216_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1022 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_1023 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_1024 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_1025 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_1026 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_1027 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1022);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_1023);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1024);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_1025);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1026);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_1027);
						}
					}
				}
			}
