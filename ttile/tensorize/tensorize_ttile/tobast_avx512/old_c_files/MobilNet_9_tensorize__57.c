...
c974_p_2 = 0;
						for (h = h324, hp_0 = 0;h < h324 + 3;h += 1, hp_0 += 1){
							...
							for (x = x408, xp_0 = 0;x < x408 + 7;x += 1, xp_0 += 1){
										...
										mem_vec_3596 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
										mem_vec_3597 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
										// y = 7, x = 1, h = 1, w = 3, c = 16, f = 64
										// T (c, 16) (16 / 1)
										for (c = c974, cp_3 = c974_p_2, cp_2 = c974_p_1, cp_1 = c974_p_0, cp_0 = 0;c < c974 + 16;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_3596);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_3597);
							}
						}
}
