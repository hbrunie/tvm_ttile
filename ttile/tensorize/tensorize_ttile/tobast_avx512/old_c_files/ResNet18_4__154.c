...
*/
IND_TYPE c, cp_0, c420_p_0, cp_1, c420, f, fp_0, f416_p_0, fp_1, f416, w, wp_0, x, xp_0, x420_p_0, xp_1, x420, y, yp_0;
							...
							for (x = x420, xp_1 = x420_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c420, cp_1 = c420_p_0, cp_0 = 0;
											...
											vec_13 = _mm512_fmadd_ps(vec_14, vec_15, mem_vec_2920);
											mem_vec_2920 = vec_13;
											scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
											vec_17 = _mm512_set1_ps(scal_7);


											vec_16 = _mm512_fmadd_ps(vec_17, vec_15, mem_vec_2921);
											mem_vec_2921 = vec_16;
											scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
											vec_19 = _mm512_set1_ps(scal_8);


											vec_18 = _mm512_fmadd_ps(vec_19, vec_15, mem_vec_2922);
											mem_vec_2922 = vec_18;
											scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
											vec_21 = _mm512_set1_ps(scal_9);


											vec_20 = _mm512_fmadd_ps(vec_21, vec_15, mem_vec_2923);
											mem_vec_2923 = vec_20;
											scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
											vec_23 = _mm512_set1_ps(scal_10);


											vec_22 = _mm512_fmadd_ps(vec_23, vec_15, mem_vec_2924);
											mem_vec_2924 = vec_22;
											scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 1) + c];
											vec_25 = _mm512_set1_ps(scal_11);


											vec_24 = _mm512_fmadd_ps(vec_25, vec_15, mem_vec_2925);
											mem_vec_2925 = vec_24;
											...
											vec_29 = _mm512_fmadd_ps(vec_30, vec_28, mem_vec_2921);
											mem_vec_2921 = vec_29;
											...
											vec_33 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_2923);
											mem_vec_2923 = vec_33;
											scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
											vec_36 = _mm512_set1_ps(scal_16);


											vec_35 = _mm512_fmadd_ps(vec_36, vec_28, mem_vec_2924);
											mem_vec_2924 = vec_35;
											scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 2) + c];
											vec_38 = _mm512_set1_ps(scal_17);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_2925);
											mem_vec_2925 = vec_37;
										}
						...
						for (w = w210, wp_0 = 0;
							...
							for (x = x420, xp_1 = x420_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2933 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
										...
										for (c = c420, cp_1 = c420_p_0, cp_0 = 0;
											...
											vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_2933);
											mem_vec_2933 = vec_15;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_2933);
