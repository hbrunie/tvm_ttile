...
/*
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (14, x); T (7, w);
  T (7, h); T (2, x); T (14, y); T (2, f); T (4, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x112_p_0, x113_p_0, xp_1, x112_p_1, xp_2, x112, x113, y, yp_0;
IND_TYPE y56 = 0;
IND_TYPE x114 = 0;
IND_TYPE h56 = 0;
IND_TYPE w56 = 0;
...
x112_p_1 = 0;
				for (h = h56, hp_0 = 0;h < h56 + 7;h += 1, hp_0 += 1){
					...
					for (w = w56, wp_0 = 0;w < w56 + 7;w += 1, wp_0 += 1){
						...
						// T (x, 14) (14 / 1)
						for (x = x112, xp_2 = x112_p_1, xp_1 = x112_p_0, xp_0 = 0;x < x112 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
