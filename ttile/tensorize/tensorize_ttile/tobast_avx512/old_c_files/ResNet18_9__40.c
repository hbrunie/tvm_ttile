...
[V f; U (2, f); ULambda y; U (3, w); T (2, c); Hoist_vars [c]; T (2, x);
  ...
  T (2, f); T (4, c); T (4, f); T (32, c); T (7, x); T (1, f)]
*/
IND_TYPE c, cp_0, c966_p_0, c967_p_0, cp_1, c966_p_1, cp_2, c966, c967, f, fp_0, f958_p_0, f959_p_0, fp_1, f958_p_1, fp_2, f958, f959, h, hp_0, x, xp_0, x790_p_0, xp_1, x790, y, yp_0;
...
// T (f, 1) (256 / 256)
for (f959 = f960, f959_p_0 = 0;
	f959 < f960 + 256;
	f959 += 256, f959_p_0 += 256){
	// y = 14, x = 14, h = 3, w = 3, c = 256, f = 256
	// T (x, 7) (14 / 2)
	for (x790 = x791, x790_p_0 = 0;
		...
		for (c967 = c968, c967_p_0 = 0;
			...
			// T (f, 4) (256 / 64)
			for (f958 = f959, f958_p_1 = f959_p_0, f958_p_0 = 0;
				f958 < f959 + 256;
				f958 += 64, f958_p_1 += 64, f958_p_0 += 64){
				// y = 14, x = 2, h = 3, w = 3, c = 8, f = 64
				// T (c, 4) (8 / 2)
				for (c966 = c967, c966_p_1 = c967_p_0, c966_p_0 = 0;
					c966 < c967 + 8;
					c966 += 2, c966_p_1 += 2, c966_p_0 += 2){
					// y = 14, x = 2, h = 3, w = 3, c = 2, f = 64
					// T (f, 2) (64 / 32)
					for (f = f958, fp_2 = f958_p_1, fp_1 = f958_p_0, fp_0 = 0;
						f < f958 + 64;
									...
									for (x = x790, xp_1 = x790_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c966, cp_2 = c966_p_1, cp_1 = c966_p_0, cp_0 = 0;
													...
													vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_5324);
													mem_vec_5324 = vec_14;

													vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_5325);
													mem_vec_5325 = vec_17;
													scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
													vec_20 = _mm512_set1_ps(scal_5);


													vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_5326);
													mem_vec_5326 = vec_19;



													vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_5327);
													mem_vec_5327 = vec_21;
													scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
													vec_23 = _mm512_set1_ps(scal_6);


													vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_5328);
													mem_vec_5328 = vec_22;



													vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_5329);
													mem_vec_5329 = vec_24;
													scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
													vec_26 = _mm512_set1_ps(scal_7);


													vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_5330);
													mem_vec_5330 = vec_25;



													vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_5331);
													mem_vec_5331 = vec_27;
													scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
													vec_29 = _mm512_set1_ps(scal_8);
													vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_5324);
													mem_vec_5324 = vec_28;

													vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_5325);
													mem_vec_5325 = vec_31;
													scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
													vec_34 = _mm512_set1_ps(scal_9);


													vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_5326);
													mem_vec_5326 = vec_33;



													vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_5327);
													mem_vec_5327 = vec_35;
													scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
													vec_37 = _mm512_set1_ps(scal_10);


													vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_5328);
													mem_vec_5328 = vec_36;



													vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_5329);
													mem_vec_5329 = vec_38;
													scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
													vec_40 = _mm512_set1_ps(scal_11);


													vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_5330);
													mem_vec_5330 = vec_39;



													vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_5331);
													mem_vec_5331 = vec_41;
												}
									...
									for (x = x790, xp_1 = x790_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c966, cp_2 = c966_p_1, cp_1 = c966_p_0, cp_0 = 0;
													...
													vec_32 = _mm512_fmadd_ps(vec_33, vec_34, mem_vec_5332);
													mem_vec_5332 = vec_32;

													vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_35 = _mm512_fmadd_ps(vec_33, vec_36, mem_vec_5333);
													mem_vec_5333 = vec_35;
													scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
													vec_38 = _mm512_set1_ps(scal_11);


													vec_37 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_5334);
													mem_vec_5334 = vec_37;



													vec_39 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_5335);
													mem_vec_5335 = vec_39;
													scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
													vec_41 = _mm512_set1_ps(scal_12);


													vec_40 = _mm512_fmadd_ps(vec_41, vec_34, mem_vec_5336);
													mem_vec_5336 = vec_40;



													vec_42 = _mm512_fmadd_ps(vec_41, vec_36, mem_vec_5337);
													mem_vec_5337 = vec_42;
													scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
													vec_44 = _mm512_set1_ps(scal_13);


													vec_43 = _mm512_fmadd_ps(vec_44, vec_34, mem_vec_5338);
													mem_vec_5338 = vec_43;



													vec_45 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_5339);
													mem_vec_5339 = vec_45;
													scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
													vec_47 = _mm512_set1_ps(scal_14);


													vec_46 = _mm512_fmadd_ps(vec_47, vec_34, mem_vec_5340);
													mem_vec_5340 = vec_46;



													vec_48 = _mm512_fmadd_ps(vec_47, vec_36, mem_vec_5341);
													mem_vec_5341 = vec_48;
													scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
													vec_50 = _mm512_set1_ps(scal_15);


													vec_49 = _mm512_fmadd_ps(vec_50, vec_34, mem_vec_5342);
													mem_vec_5342 = vec_49;



													vec_51 = _mm512_fmadd_ps(vec_50, vec_36, mem_vec_5343);
													mem_vec_5343 = vec_51;
													scal_16 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
													vec_53 = _mm512_set1_ps(scal_16);


													vec_52 = _mm512_fmadd_ps(vec_53, vec_34, mem_vec_5344);
													mem_vec_5344 = vec_52;



													vec_54 = _mm512_fmadd_ps(vec_53, vec_36, mem_vec_5345);
													mem_vec_5345 = vec_54;
													scal_17 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
													vec_56 = _mm512_set1_ps(scal_17);


													vec_55 = _mm512_fmadd_ps(vec_56, vec_34, mem_vec_5346);
													mem_vec_5346 = vec_55;



													vec_57 = _mm512_fmadd_ps(vec_56, vec_36, mem_vec_5347);
													mem_vec_5347 = vec_57;
													scal_18 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
													vec_59 = _mm512_set1_ps(scal_18);


													vec_58 = _mm512_fmadd_ps(vec_59, vec_34, mem_vec_5348);
													mem_vec_5348 = vec_58;



													vec_60 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_5349);
													mem_vec_5349 = vec_60;
													scal_19 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
													vec_62 = _mm512_set1_ps(scal_19);


													vec_61 = _mm512_fmadd_ps(vec_62, vec_34, mem_vec_5350);
													mem_vec_5350 = vec_61;



													vec_63 = _mm512_fmadd_ps(vec_62, vec_36, mem_vec_5351);
													mem_vec_5351 = vec_63;
													scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
													vec_65 = _mm512_set1_ps(scal_20);
													vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_64 = _mm512_fmadd_ps(vec_65, vec_66, mem_vec_5332);
													mem_vec_5332 = vec_64;

													vec_68 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_67 = _mm512_fmadd_ps(vec_65, vec_68, mem_vec_5333);
													mem_vec_5333 = vec_67;
													scal_21 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
													vec_70 = _mm512_set1_ps(scal_21);


													vec_69 = _mm512_fmadd_ps(vec_70, vec_66, mem_vec_5334);
													mem_vec_5334 = vec_69;



													vec_71 = _mm512_fmadd_ps(vec_70, vec_68, mem_vec_5335);
													mem_vec_5335 = vec_71;
													scal_22 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
													vec_73 = _mm512_set1_ps(scal_22);


													vec_72 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_5336);
													mem_vec_5336 = vec_72;



													vec_74 = _mm512_fmadd_ps(vec_73, vec_68, mem_vec_5337);
													mem_vec_5337 = vec_74;
													scal_23 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
													vec_76 = _mm512_set1_ps(scal_23);


													vec_75 = _mm512_fmadd_ps(vec_76, vec_66, mem_vec_5338);
													mem_vec_5338 = vec_75;



													vec_77 = _mm512_fmadd_ps(vec_76, vec_68, mem_vec_5339);
													mem_vec_5339 = vec_77;
													scal_24 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
													vec_79 = _mm512_set1_ps(scal_24);


													vec_78 = _mm512_fmadd_ps(vec_79, vec_66, mem_vec_5340);
													mem_vec_5340 = vec_78;



													vec_80 = _mm512_fmadd_ps(vec_79, vec_68, mem_vec_5341);
													mem_vec_5341 = vec_80;
													scal_25 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
													vec_82 = _mm512_set1_ps(scal_25);


													vec_81 = _mm512_fmadd_ps(vec_82, vec_66, mem_vec_5342);
													mem_vec_5342 = vec_81;



													vec_83 = _mm512_fmadd_ps(vec_82, vec_68, mem_vec_5343);
													mem_vec_5343 = vec_83;
													scal_26 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
													vec_85 = _mm512_set1_ps(scal_26);


													vec_84 = _mm512_fmadd_ps(vec_85, vec_66, mem_vec_5344);
													mem_vec_5344 = vec_84;



													vec_86 = _mm512_fmadd_ps(vec_85, vec_68, mem_vec_5345);
													mem_vec_5345 = vec_86;
													scal_27 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
													vec_88 = _mm512_set1_ps(scal_27);


													vec_87 = _mm512_fmadd_ps(vec_88, vec_66, mem_vec_5346);
													mem_vec_5346 = vec_87;



													vec_89 = _mm512_fmadd_ps(vec_88, vec_68, mem_vec_5347);
													mem_vec_5347 = vec_89;
													scal_28 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
													vec_91 = _mm512_set1_ps(scal_28);


													vec_90 = _mm512_fmadd_ps(vec_91, vec_66, mem_vec_5348);
													mem_vec_5348 = vec_90;



													vec_92 = _mm512_fmadd_ps(vec_91, vec_68, mem_vec_5349);
													mem_vec_5349 = vec_92;
													scal_29 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
													vec_94 = _mm512_set1_ps(scal_29);


													vec_93 = _mm512_fmadd_ps(vec_94, vec_66, mem_vec_5350);
													mem_vec_5350 = vec_93;



													vec_95 = _mm512_fmadd_ps(vec_94, vec_68, mem_vec_5351);
													mem_vec_5351 = vec_95;
												}
