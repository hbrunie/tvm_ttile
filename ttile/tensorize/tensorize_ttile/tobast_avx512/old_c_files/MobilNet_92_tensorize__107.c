...
c1818_p_2 = 0;
							for (h = h574, hp_0 = 0;h < h574 + 3;h += 1, hp_0 += 1){
								...
								for (x = x756, xp_0 = 0;x < x756 + 7;x += 1, xp_0 += 1){
											...
											mem_vec_7390 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
											mem_vec_7391 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_7390);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_7391);
								}
							}
}
