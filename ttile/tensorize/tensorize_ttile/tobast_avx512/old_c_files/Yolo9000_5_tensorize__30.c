...
/*
[V f; U (4, f); U (4, y); T (128, c); Hoist_vars [c]; T (68, x); T (34, y);
  T (1, c); T (2, x)]
*/
IND_TYPE c, cp_0, c80_p_0, cp_1, c80, x, xp_0, x136_p_0, xp_1, x136, y, yp_0;
IND_TYPE y72 = 0;
IND_TYPE x137 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
			for (x = x136, xp_1 = x136_p_0, xp_0 = 0;x < x136 + 68;x += 1, xp_1 += 1, xp_0 += 1){
						...
						// T (c, 128) (128 / 1)
						for (c = c80, cp_1 = c80_p_0, cp_0 = 0;c < c80 + 128;c += 1, cp_1 += 1, cp_0 += 1){
