						...
						for (x = x524, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c880, cp_2 = c880_p_1, cp_1 = c880_p_0, cp_0 = 0;
										...
										vec_19 = _mm512_fmadd_ps(vec_20, vec_21, mem_vec_4200);
										mem_vec_4200 = vec_19;

										vec_23 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_22 = _mm512_fmadd_ps(vec_20, vec_23, mem_vec_4201);
										mem_vec_4201 = vec_22;

										vec_25 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_24 = _mm512_fmadd_ps(vec_20, vec_25, mem_vec_4202);
										mem_vec_4202 = vec_24;

										vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_26 = _mm512_fmadd_ps(vec_20, vec_27, mem_vec_4203);
										mem_vec_4203 = vec_26;
										scal_4 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_4);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_21, mem_vec_4204);
										mem_vec_4204 = vec_28;



										vec_30 = _mm512_fmadd_ps(vec_29, vec_23, mem_vec_4205);
										mem_vec_4205 = vec_30;



										vec_31 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_4206);
										mem_vec_4206 = vec_31;



										vec_32 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_4207);
										mem_vec_4207 = vec_32;
										scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
										vec_34 = _mm512_set1_ps(scal_5);


										vec_33 = _mm512_fmadd_ps(vec_34, vec_21, mem_vec_4208);
										mem_vec_4208 = vec_33;



										vec_35 = _mm512_fmadd_ps(vec_34, vec_23, mem_vec_4209);
										mem_vec_4209 = vec_35;



										vec_36 = _mm512_fmadd_ps(vec_34, vec_25, mem_vec_4210);
										mem_vec_4210 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_34, vec_27, mem_vec_4211);
										mem_vec_4211 = vec_37;
										scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
										vec_39 = _mm512_set1_ps(scal_6);
										vec_40 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_38 = _mm512_fmadd_ps(vec_39, vec_40, mem_vec_4200);
										mem_vec_4200 = vec_38;

										vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_41 = _mm512_fmadd_ps(vec_39, vec_42, mem_vec_4201);
										mem_vec_4201 = vec_41;

										vec_44 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_43 = _mm512_fmadd_ps(vec_39, vec_44, mem_vec_4202);
										mem_vec_4202 = vec_43;

										vec_46 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_45 = _mm512_fmadd_ps(vec_39, vec_46, mem_vec_4203);
										mem_vec_4203 = vec_45;
										scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
										vec_48 = _mm512_set1_ps(scal_7);


										vec_47 = _mm512_fmadd_ps(vec_48, vec_40, mem_vec_4204);
										mem_vec_4204 = vec_47;



										vec_49 = _mm512_fmadd_ps(vec_48, vec_42, mem_vec_4205);
										mem_vec_4205 = vec_49;



										vec_50 = _mm512_fmadd_ps(vec_48, vec_44, mem_vec_4206);
										mem_vec_4206 = vec_50;



										vec_51 = _mm512_fmadd_ps(vec_48, vec_46, mem_vec_4207);
										mem_vec_4207 = vec_51;
										scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
										vec_53 = _mm512_set1_ps(scal_8);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_40, mem_vec_4208);
										mem_vec_4208 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_42, mem_vec_4209);
										mem_vec_4209 = vec_54;



										vec_55 = _mm512_fmadd_ps(vec_53, vec_44, mem_vec_4210);
										mem_vec_4210 = vec_55;



										vec_56 = _mm512_fmadd_ps(vec_53, vec_46, mem_vec_4211);
										mem_vec_4211 = vec_56;
									}
