...
fp_1 = 0;
						for (h = h428, hp_0 = 0;h < h428 + 3;h += 1, hp_0 += 1){
							...
							for (x = x840, xp_1 = x840_p_0, xp_0 = 0;x < x840 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6984 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
										mem_vec_6985 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
										// y = ph_y, x = 1, h = 1, w = 3, c = 8, f = 64
										// T (c, 8) (8 / 1)
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_6984);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_6985);
							}
						}
}
