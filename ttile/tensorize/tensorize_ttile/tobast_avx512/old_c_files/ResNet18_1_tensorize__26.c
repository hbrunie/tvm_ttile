...
/*
[V f; U (2, f); U (7, y); T (3, c); Hoist_vars [c]; T (28, x); T (7, w);
  T (7, h); T (4, x); T (16, y); T (2, f); T (1, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x8_p_0, x9_p_0, xp_1, x8_p_1, xp_2, x8, x9, y, yp_0;
IND_TYPE y4 = 0;
IND_TYPE x10 = 0;
IND_TYPE h4 = 0;
IND_TYPE w4 = 0;
...
x8 = 0;
x8_p_1 = 0;
				for (h = h4, hp_0 = 0;h < h4 + 7;h += 1, hp_0 += 1){
					// y = 7, x = 28, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w4, wp_0 = 0;w < w4 + 7;w += 1, wp_0 += 1){
						// y = 7, x = 28, h = 1, w = 1, c = 3, f = 32
						// T (x, 28) (28 / 1)
