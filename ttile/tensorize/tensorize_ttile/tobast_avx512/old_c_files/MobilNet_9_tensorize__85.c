...
[V f; U (2, f); U (7, y); T (1, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (1024, c); T (32, f); T (1, c); T (1, f); T (1, c)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, c1_p_0, c2_p_0, c1, cp_1, c0_p_1, c1_p_1, c2, cp_2, c0_p_2, cp_3, f, f0, fp_0, f0_p_0, fp_1, h, hp_0, w, wp_0, x, xp_0;
IND_TYPE y = 0;
IND_TYPE x0 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
					...
					for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
						...
						for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
							...
							for (x = x0, xp_0 = 0;x < x0 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 1) (1 / 1)
										for (c = c0, cp_3 = c0_p_2, cp_2 = c0_p_1, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 1;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
