...
for (c300 = c301, c300_p_0 = 0;
	...
	for (f214 = f215, f214_p_0 = 0;
		f214 < f215 + 1024;
		f214 += 1024, f214_p_0 += 1024){
		// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
		// T (c, 1) (1024 / 1024)
		for (c299 = c300, c299_p_1 = c300_p_0, c299_p_0 = 0;
			c299 < c300 + 1024;
			c299 += 1024, c299_p_1 += 1024, c299_p_0 += 1024){
			// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
			// T (f, 32) (1024 / 32)
			for (f = f214, fp_1 = f214_p_0, fp_0 = 0;
				...
				// T (c, 8) (1024 / 128)
				for (c298 = c299, c298_p_2 = c299_p_1, c298_p_1 = c299_p_0, c298_p_0 = 0;
					c298 < c299 + 1024;
					c298 += 128, c298_p_2 += 128, c298_p_1 += 128, c298_p_0 += 128){
					...
					for (w = w128, wp_0 = 0;
						...
						for (x = x128, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									// T (c, 128) (128 / 1)
									for (c = c298, cp_3 = c298_p_2, cp_2 = c298_p_1, cp_1 = c298_p_0, cp_0 = 0;
										c < c298 + 128;
