...
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (2, x); T (3, w);
  T (3, h); T (2, x); T (68, y); T (2, c); T (4, x); T (17, x)]
*/
IND_TYPE c, cp_0, c66_p_0, cp_1, c66, h, hp_0, w, wp_0, x, xp_0, x110_p_0, x111_p_0, x112_p_0, xp_1, x110_p_1, x111_p_1, xp_2, x110_p_2, xp_3, x110, x111, x112, y, yp_0;
IND_TYPE y44 = 0;
IND_TYPE x113 = 0;
IND_TYPE h44 = 0;
IND_TYPE w44 = 0;
...
x110_p_2 = 0;
					for (h = h44, hp_0 = 0;h < h44 + 3;h += 1, hp_0 += 1){
						...
						for (w = w44, wp_0 = 0;w < w44 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 2) (2 / 1)
							for (x = x110, xp_3 = x110_p_2, xp_2 = x110_p_1, xp_1 = x110_p_0, xp_0 = 0;x < x110 + 2;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
