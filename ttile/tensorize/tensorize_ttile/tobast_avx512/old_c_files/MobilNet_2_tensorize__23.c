...
x210_p_1 = 0;
					for (h = h76, hp_0 = 0;h < h76 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 7) (7 / 1)
						for (x = x210, xp_2 = x210_p_1, xp_1 = x210_p_0, xp_0 = 0;x < x210 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_869 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									// y = 4, x = 1, h = 1, w = 3, c = 16, f = 16
									// T (c, 16) (16 / 1)
									for (c = c196, cp_1 = c196_p_0, cp_0 = 0;c < c196 + 16;c += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_869);
						}
					}
}
