...
yp_2 = 0;
					for (w = w4, wp_0 = 0;w < w4 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 68) (68 / 1)
						for (x = x8, xp_1 = x8_p_0, xp_0 = 0;x < x8 + 68;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_37 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									mem_vec_38 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									mem_vec_39 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									// y = 8, x = 1, h = 3, w = 1, c = 3, f = 16
									// T (c, 3) (3 / 1)
									for (c = c4, cp_0 = 0;c < c4 + 3;c += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_37);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_38);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_39);
						}
					}
}
