...
[V f; U (2, f); ULambda y; U (3, w); T (512, c); Hoist_vars [c]; T (1, x);
  ...
  T (2, f); T (1, c); T (8, f); T (1, c); T (14, x); T (1, f)]
*/
IND_TYPE c, cp_0, c820_p_0, c821_p_0, cp_1, c820_p_1, cp_2, c820, c821, f, fp_0, f680_p_0, f681_p_0, fp_1, f680_p_1, fp_2, f680, f681, h, hp_0, x, xp_0, x632_p_0, xp_1, x632, y, yp_0;
IND_TYPE y424 = 0;
IND_TYPE x633 = 0;
IND_TYPE h364 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
								for (h = h364, hp_0 = 0;h < h364 + 3;h += 1, hp_0 += 1){
									...
									// T (x, 1) (1 / 1)
									for (x = x632, xp_1 = x632_p_0, xp_0 = 0;x < x632 + 1;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// y = ph_y, x = 1, h = 1, w = 3, c = 512, f = 32
												// T (c, 512) (512 / 1)
												for (c = c820, cp_2 = c820_p_1, cp_1 = c820_p_0, cp_0 = 0;c < c820 + 512;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
