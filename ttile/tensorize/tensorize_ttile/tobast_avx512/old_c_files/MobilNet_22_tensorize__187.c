...
c956_p_1 = 0;
					for (h = h442, hp_0 = 0;h < h442 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 56) (56 / 1)
						for (x = x1102, xp_1 = x1102_p_0, xp_0 = 0;x < x1102 + 56;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_8230 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									mem_vec_8231 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
									mem_vec_8232 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_8233 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 3, c = 1, f = 64
									// T (c, 1) (1 / 1)
									for (c = c956, cp_2 = c956_p_1, cp_1 = c956_p_0, cp_0 = 0;c < c956 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_8230);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_8231);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_8232);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_8233);
						}
					}
}
