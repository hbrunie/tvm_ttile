...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (512, c); Hoist_vars [c];
  T (7, x); T (2, f); T (2, c); T (16, f); T (2, f); T (1, c)]
*/
IND_TYPE c, cp_0, c984_p_0, c985_p_0, cp_1, c984_p_1, cp_2, c984, c985, f, fp_0, f664_p_0, f665_p_0, fp_1, f664_p_1, fp_2, f664, f665, x, xp_0;
	...
	for (f665 = f666, f665_p_0 = 0;
		...
		for (f664 = f665, f664_p_1 = f665_p_0, f664_p_0 = 0;
			...
			for (c984 = c985, c984_p_1 = c985_p_0, c984_p_0 = 0;
				c984 < c985 + 1024;
				c984 += 512, c984_p_1 += 512, c984_p_0 += 512){
