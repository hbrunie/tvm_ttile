...
[V f; U (4, f); U (2, y); U (3, w); T (16, c); Hoist_vars [c]; T (17, x);
  T (3, h); T (1, f); T (2, x); T (17, y); T (4, f); T (16, c); T (2, f)]
*/
IND_TYPE c, cp_0, c24_p_0, cp_1, c24, f, fp_0, f32_p_0, f33_p_0, fp_1, f32_p_1, fp_2, f32, f33, h, hp_0, x, xp_0, x24_p_0, xp_1, x24, y, yp_0;
IND_TYPE y16 = 0;
IND_TYPE x25 = 0;
IND_TYPE h8 = 0;
IND_TYPE w = 0;
