...
fp_1 = 0;
						for (h = h424, hp_0 = 0;h < h424 + 3;h += 1, hp_0 += 1){
							...
							for (x = x834, xp_1 = x834_p_0, xp_0 = 0;x < x834 + 4;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6896 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
										mem_vec_6897 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_6896);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_6897);
							}
						}
}
