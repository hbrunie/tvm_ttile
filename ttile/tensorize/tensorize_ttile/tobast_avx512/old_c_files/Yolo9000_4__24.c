...
for (x417 = x418, x417_p_0 = 0;
	...
	for (c342 = c343, c342_p_0 = 0;
		...
		for (y = y228, yp_0 = 0;
			y < y228 + 136;
			y += 2, yp_0 += 2){
			// y = 2, x = 136, h = 3, w = 3, c = 8, f = 128
			// T (x, 4) (136 / 34)
			for (x416 = x417, x416_p_1 = x417_p_0, x416_p_0 = 0;
				x416 < x417 + 136;
				x416 += 34, x416_p_1 += 34, x416_p_0 += 34){
				// y = 2, x = 34, h = 3, w = 3, c = 8, f = 128
				// T (h, 3) (3 / 1)
				for (h = h204, hp_0 = 0;
					h < h204 + 3;
					h += 1, hp_0 += 1){
					...
					for (x = x416, xp_2 = x416_p_1, xp_1 = x416_p_0, xp_0 = 0;
						...
						x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_1276 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
								mem_vec_1277 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
								mem_vec_1278 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
								mem_vec_1279 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
								...
								mem_vec_1284 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
								mem_vec_1285 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
								mem_vec_1286 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
								mem_vec_1287 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_1276);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_1277);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_1278);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_1279);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_1284);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_1285);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_1286);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_1287);
					}
				}
			}
		}
