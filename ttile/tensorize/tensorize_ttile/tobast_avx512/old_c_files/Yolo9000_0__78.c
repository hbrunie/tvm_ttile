...
[V f; U (1, f); U (8, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (17, x); T (4, y); T (2, x); T (17, y); T (2, f); T (16, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x154_p_0, x155_p_0, xp_1, x154_p_1, xp_2, x154, x155, y, yp_0, y126_p_0, yp_1, y126;
...
for (x155 = x156, x155_p_0 = 0;
	...
	for (f = f62, fp_0 = 0;
		...
		for (y126 = y127, y126_p_0 = 0;
			...
			// T (x, 2) (34 / 17)
			for (x154 = x155, x154_p_1 = x155_p_0, x154_p_0 = 0;
				x154 < x155 + 34;
				x154 += 17, x154_p_1 += 17, x154_p_0 += 17){
				// y = 32, x = 17, h = 3, w = 3, c = 3, f = 16
				// T (y, 4) (32 / 8)
				for (y = y126, yp_1 = y126_p_0, yp_0 = 0;
					...
					// T (x, 17) (17 / 1)
					for (x = x154, xp_2 = x154_p_1, xp_1 = x154_p_0, xp_0 = 0;
						x < x154 + 17;
						x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								mem_vec_352 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
								mem_vec_353 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
								mem_vec_354 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
								mem_vec_355 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
								mem_vec_356 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
								mem_vec_357 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
								...
								for (c = c80, cp_0 = 0;
									...
									vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_353);
									mem_vec_353 = vec_3;
									...
									vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_355);
									mem_vec_355 = vec_7;
									...
									vec_136 = _mm512_fmadd_ps(vec_137, vec_138, mem_vec_352);
									mem_vec_352 = vec_136;
									scal_65 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
									vec_140 = _mm512_set1_ps(scal_65);


									vec_139 = _mm512_fmadd_ps(vec_140, vec_138, mem_vec_353);
									mem_vec_353 = vec_139;
									scal_66 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
									vec_142 = _mm512_set1_ps(scal_66);


									vec_141 = _mm512_fmadd_ps(vec_142, vec_138, mem_vec_354);
									mem_vec_354 = vec_141;
									scal_67 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
									vec_144 = _mm512_set1_ps(scal_67);


									vec_143 = _mm512_fmadd_ps(vec_144, vec_138, mem_vec_355);
									mem_vec_355 = vec_143;
									scal_68 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
									vec_146 = _mm512_set1_ps(scal_68);


									vec_145 = _mm512_fmadd_ps(vec_146, vec_138, mem_vec_356);
									mem_vec_356 = vec_145;
									scal_69 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
									vec_148 = _mm512_set1_ps(scal_69);


									vec_147 = _mm512_fmadd_ps(vec_148, vec_138, mem_vec_357);
									mem_vec_357 = vec_147;
									scal_70 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
									vec_150 = _mm512_set1_ps(scal_70);


									vec_149 = _mm512_fmadd_ps(vec_150, vec_138, mem_vec_358);
									mem_vec_358 = vec_149;
									scal_71 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
									vec_152 = _mm512_set1_ps(scal_71);


									vec_151 = _mm512_fmadd_ps(vec_152, vec_138, mem_vec_359);
									mem_vec_359 = vec_151;
								}
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_352);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_353);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_354);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_355);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_356);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_357);
