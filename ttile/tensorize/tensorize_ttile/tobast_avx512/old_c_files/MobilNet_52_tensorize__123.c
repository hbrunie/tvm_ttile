...
c1160_p_1 = 0;
						for (h = h486, hp_0 = 0;h < h486 + 3;h += 1, hp_0 += 1){
							...
							for (x = x978, xp_1 = x978_p_0, xp_0 = 0;x < x978 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7258 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
										mem_vec_7259 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_7258);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_7259);
							}
						}
}
