...
fp_1 = 0;
						for (h = h486, hp_0 = 0;h < h486 + 3;h += 1, hp_0 += 1){
							...
							for (x = x964, xp_1 = x964_p_0, xp_0 = 0;x < x964 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7470 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
										mem_vec_7471 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_7470);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_7471);
							}
						}
}
