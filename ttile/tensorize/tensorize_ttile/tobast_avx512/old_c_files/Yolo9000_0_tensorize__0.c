...
[V f; U (2, f); U (8, y); U (3, w); T (3, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (68, y); T (136, x); T (1, y); T (4, x)]
*/
IND_TYPE c, cp_0, h, hp_0, x, xp_0, x114_p_0, x115_p_0, xp_1, x114_p_1, xp_2, x114, x115, y, yp_0, y96_p_0, yp_1, y96;
IND_TYPE y97 = 0;
IND_TYPE x116 = 0;
IND_TYPE h52 = 0;
IND_TYPE w = 0;
...
yp_1 = 0;
				for (h = h52, hp_0 = 0;h < h52 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 1) (1 / 1)
					for (x = x114, xp_2 = x114_p_1, xp_1 = x114_p_0, xp_0 = 0;x < x114 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
