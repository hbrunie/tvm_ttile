							...
							for (x = x726, xp_1 = x726_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c732, cp_1 = c732_p_0, cp_0 = 0;
											...
											vec_20 = _mm512_fmadd_ps(vec_21, vec_22, mem_vec_5612);
											mem_vec_5612 = vec_20;

											vec_24 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_23 = _mm512_fmadd_ps(vec_21, vec_24, mem_vec_5613);
											mem_vec_5613 = vec_23;
											scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
											vec_26 = _mm512_set1_ps(scal_7);


											vec_25 = _mm512_fmadd_ps(vec_26, vec_22, mem_vec_5614);
											mem_vec_5614 = vec_25;



											vec_27 = _mm512_fmadd_ps(vec_26, vec_24, mem_vec_5615);
											mem_vec_5615 = vec_27;
											scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
											vec_29 = _mm512_set1_ps(scal_8);


											vec_28 = _mm512_fmadd_ps(vec_29, vec_22, mem_vec_5616);
											mem_vec_5616 = vec_28;



											vec_30 = _mm512_fmadd_ps(vec_29, vec_24, mem_vec_5617);
											mem_vec_5617 = vec_30;
											scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_22, mem_vec_5618);
											mem_vec_5618 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_24, mem_vec_5619);
											mem_vec_5619 = vec_33;
											scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_22, mem_vec_5620);
											mem_vec_5620 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_24, mem_vec_5621);
											mem_vec_5621 = vec_36;
											scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_22, mem_vec_5622);
											mem_vec_5622 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_24, mem_vec_5623);
											mem_vec_5623 = vec_39;
											scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);
											vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_40 = _mm512_fmadd_ps(vec_41, vec_42, mem_vec_5612);
											mem_vec_5612 = vec_40;

											vec_44 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_43 = _mm512_fmadd_ps(vec_41, vec_44, mem_vec_5613);
											mem_vec_5613 = vec_43;
											scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
											vec_46 = _mm512_set1_ps(scal_13);


											vec_45 = _mm512_fmadd_ps(vec_46, vec_42, mem_vec_5614);
											mem_vec_5614 = vec_45;



											vec_47 = _mm512_fmadd_ps(vec_46, vec_44, mem_vec_5615);
											mem_vec_5615 = vec_47;
											scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
											vec_49 = _mm512_set1_ps(scal_14);


											vec_48 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_5616);
											mem_vec_5616 = vec_48;



											vec_50 = _mm512_fmadd_ps(vec_49, vec_44, mem_vec_5617);
											mem_vec_5617 = vec_50;
											scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
											vec_52 = _mm512_set1_ps(scal_15);


											vec_51 = _mm512_fmadd_ps(vec_52, vec_42, mem_vec_5618);
											mem_vec_5618 = vec_51;



											vec_53 = _mm512_fmadd_ps(vec_52, vec_44, mem_vec_5619);
											mem_vec_5619 = vec_53;
											scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
											vec_55 = _mm512_set1_ps(scal_16);


											vec_54 = _mm512_fmadd_ps(vec_55, vec_42, mem_vec_5620);
											mem_vec_5620 = vec_54;



											vec_56 = _mm512_fmadd_ps(vec_55, vec_44, mem_vec_5621);
											mem_vec_5621 = vec_56;
											scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_42, mem_vec_5622);
											mem_vec_5622 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_44, mem_vec_5623);
											mem_vec_5623 = vec_59;
										}
