...
/*
[V f; U (2, f); U (8, y); T (128, c); Hoist_vars [c]; T (68, x); T (2, x);
  T (17, y); T (2, f); T (1, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, x0, xp_0, x0_p_0, x1_p_0, x1, xp_1, x0_p_1, xp_2, y, yp_0;
...
for (x1 = x2, x1_p_0 = 0;
	...
	for (f = f0, fp_0 = 0;
		f < f0 + 64;
		f += 32, fp_0 += 32){
		// y = 136, x = 136, h = 1, w = 1, c = 128, f = 32
		// T (y, 17) (136 / 8)
		for (y = y0, yp_0 = 0;
			y < y0 + 136;
			y += 8, yp_0 += 8){
			// y = 8, x = 136, h = 1, w = 1, c = 128, f = 32
			// T (x, 2) (136 / 68)
			for (x0 = x1, x0_p_1 = x1_p_0, x0_p_0 = 0;
				x0 < x1 + 136;
				x0 += 68, x0_p_1 += 68, x0_p_0 += 68){
				// y = 8, x = 68, h = 1, w = 1, c = 128, f = 32
				// T (x, 68) (68 / 1)
