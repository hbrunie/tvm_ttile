...
[V f; U (2, f); ULambda y; T (2, c); Hoist_vars [c]; T (34, x); T (3, w);
  ...
  T (32, c); T (1, x)]
*/
IND_TYPE c, cp_0, c564_p_0, cp_1, c564, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x706_p_0, x707_p_0, xp_1, x706_p_1, xp_2, x706, x707, y, yp_0;
			...
			f += 32, fp_0 += 32){
				for (y = y376, yp_0 = 0;
					...
					for (x706 = x707, x706_p_1 = x707_p_0, x706_p_0 = 0;
						x706 < x707 + 136;
						x706 += 34, x706_p_1 += 34, x706_p_0 += 34){
							...
							for (w = w280, wp_0 = 0;
								...
								for (x = x706, xp_2 = x706_p_1, xp_1 = x706_p_0, xp_0 = 0;
									...
									x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3692 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_3693 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
											mem_vec_3694 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_3695 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
											mem_vec_3696 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_3697 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 2, f = 32
											// T (c, 2) (2 / 1)
											for (c = c564, cp_1 = c564_p_0, cp_0 = 0;
												c < c564 + 2;
												...
												vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_3692);
												mem_vec_3692 = vec_32;



												vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_3693);
												mem_vec_3693 = vec_34;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
												vec_36 = _mm512_set1_ps(scal_11);


												vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_3694);
												mem_vec_3694 = vec_35;



												vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_3695);
												mem_vec_3695 = vec_37;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
												vec_39 = _mm512_set1_ps(scal_12);


												vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_3696);
												mem_vec_3696 = vec_38;



												vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_3697);
												mem_vec_3697 = vec_40;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_3692);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_3693);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3694);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_3695);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_3696);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_3697);
								}
							}
						}
					}
