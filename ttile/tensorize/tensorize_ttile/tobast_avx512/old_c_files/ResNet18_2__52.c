...
[V f; U (2, f); U (14, y); U (3, h); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, w); T (4, x); T (4, y); T (2, f); T (2, c); T (1, x)]
*/
IND_TYPE c, cp_0, c112_p_0, cp_1, c112, f, fp_0, w, wp_0, x, xp_0, x140_p_0, x141_p_0, xp_1, x140_p_1, xp_2, x140, x141, y, yp_0;
		...
		for (f = f68, fp_0 = 0;
			...
			for (y = y72, yp_0 = 0;
				...
				for (x140 = x141, x140_p_1 = x141_p_0, x140_p_0 = 0;
					x140 < x141 + 56;
					x140 += 14, x140_p_1 += 14, x140_p_0 += 14){
					...
					for (w = w72, wp_0 = 0;
						...
						for (x = x140, xp_2 = x140_p_1, xp_1 = x140_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_568 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_569 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_570 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_571 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_572 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_573 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									...
									for (c = c112, cp_1 = c112_p_0, cp_0 = 0;
										...
										vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_568);
										mem_vec_568 = vec_35;



										vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_569);
										mem_vec_569 = vec_37;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
										vec_39 = _mm512_set1_ps(scal_12);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_570);
										mem_vec_570 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_571);
										mem_vec_571 = vec_40;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
										vec_42 = _mm512_set1_ps(scal_13);


										vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_572);
										mem_vec_572 = vec_41;



										vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_573);
										mem_vec_573 = vec_43;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
										vec_45 = _mm512_set1_ps(scal_14);
										vec_46 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

										vec_44 = _mm512_fmadd_ps(vec_45, vec_46, mem_vec_546);
										mem_vec_546 = vec_44;

										vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_47 = _mm512_fmadd_ps(vec_45, vec_48, mem_vec_547);
										mem_vec_547 = vec_47;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_46, mem_vec_548);
										mem_vec_548 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_48, mem_vec_549);
										mem_vec_549 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_53 = _mm512_set1_ps(scal_16);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_46, mem_vec_550);
										mem_vec_550 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_48, mem_vec_551);
										mem_vec_551 = vec_54;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_56 = _mm512_set1_ps(scal_17);


										vec_55 = _mm512_fmadd_ps(vec_56, vec_46, mem_vec_552);
										mem_vec_552 = vec_55;



										vec_57 = _mm512_fmadd_ps(vec_56, vec_48, mem_vec_553);
										mem_vec_553 = vec_57;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_59 = _mm512_set1_ps(scal_18);


										vec_58 = _mm512_fmadd_ps(vec_59, vec_46, mem_vec_554);
										mem_vec_554 = vec_58;



										vec_60 = _mm512_fmadd_ps(vec_59, vec_48, mem_vec_555);
										mem_vec_555 = vec_60;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_62 = _mm512_set1_ps(scal_19);


										vec_61 = _mm512_fmadd_ps(vec_62, vec_46, mem_vec_556);
										mem_vec_556 = vec_61;



										vec_63 = _mm512_fmadd_ps(vec_62, vec_48, mem_vec_557);
										mem_vec_557 = vec_63;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_65 = _mm512_set1_ps(scal_20);


										vec_64 = _mm512_fmadd_ps(vec_65, vec_46, mem_vec_558);
										mem_vec_558 = vec_64;



										vec_66 = _mm512_fmadd_ps(vec_65, vec_48, mem_vec_559);
										mem_vec_559 = vec_66;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_68 = _mm512_set1_ps(scal_21);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_46, mem_vec_560);
										mem_vec_560 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_48, mem_vec_561);
										mem_vec_561 = vec_69;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
										vec_71 = _mm512_set1_ps(scal_22);


										vec_70 = _mm512_fmadd_ps(vec_71, vec_46, mem_vec_562);
										mem_vec_562 = vec_70;



										vec_72 = _mm512_fmadd_ps(vec_71, vec_48, mem_vec_563);
										mem_vec_563 = vec_72;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
										vec_74 = _mm512_set1_ps(scal_23);


										vec_73 = _mm512_fmadd_ps(vec_74, vec_46, mem_vec_564);
										mem_vec_564 = vec_73;



										vec_75 = _mm512_fmadd_ps(vec_74, vec_48, mem_vec_565);
										mem_vec_565 = vec_75;
										scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
										vec_77 = _mm512_set1_ps(scal_24);


										vec_76 = _mm512_fmadd_ps(vec_77, vec_46, mem_vec_566);
										mem_vec_566 = vec_76;



										vec_78 = _mm512_fmadd_ps(vec_77, vec_48, mem_vec_567);
										mem_vec_567 = vec_78;
										scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
										vec_80 = _mm512_set1_ps(scal_25);


										vec_79 = _mm512_fmadd_ps(vec_80, vec_46, mem_vec_568);
										mem_vec_568 = vec_79;



										vec_81 = _mm512_fmadd_ps(vec_80, vec_48, mem_vec_569);
										mem_vec_569 = vec_81;
										scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
										vec_83 = _mm512_set1_ps(scal_26);


										vec_82 = _mm512_fmadd_ps(vec_83, vec_46, mem_vec_570);
										mem_vec_570 = vec_82;



										vec_84 = _mm512_fmadd_ps(vec_83, vec_48, mem_vec_571);
										mem_vec_571 = vec_84;
										scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 1) + c];
										vec_86 = _mm512_set1_ps(scal_27);


										vec_85 = _mm512_fmadd_ps(vec_86, vec_46, mem_vec_572);
										mem_vec_572 = vec_85;



										vec_87 = _mm512_fmadd_ps(vec_86, vec_48, mem_vec_573);
										mem_vec_573 = vec_87;
										scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_89 = _mm512_set1_ps(scal_28);
										vec_90 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_88 = _mm512_fmadd_ps(vec_89, vec_90, mem_vec_546);
										mem_vec_546 = vec_88;

										vec_92 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_91 = _mm512_fmadd_ps(vec_89, vec_92, mem_vec_547);
										mem_vec_547 = vec_91;
										scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_94 = _mm512_set1_ps(scal_29);


										vec_93 = _mm512_fmadd_ps(vec_94, vec_90, mem_vec_548);
										mem_vec_548 = vec_93;



										vec_95 = _mm512_fmadd_ps(vec_94, vec_92, mem_vec_549);
										mem_vec_549 = vec_95;
										scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_97 = _mm512_set1_ps(scal_30);


										vec_96 = _mm512_fmadd_ps(vec_97, vec_90, mem_vec_550);
										mem_vec_550 = vec_96;



										vec_98 = _mm512_fmadd_ps(vec_97, vec_92, mem_vec_551);
										mem_vec_551 = vec_98;
										scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_100 = _mm512_set1_ps(scal_31);


										vec_99 = _mm512_fmadd_ps(vec_100, vec_90, mem_vec_552);
										mem_vec_552 = vec_99;



										vec_101 = _mm512_fmadd_ps(vec_100, vec_92, mem_vec_553);
										mem_vec_553 = vec_101;
										scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_103 = _mm512_set1_ps(scal_32);


										vec_102 = _mm512_fmadd_ps(vec_103, vec_90, mem_vec_554);
										mem_vec_554 = vec_102;



										vec_104 = _mm512_fmadd_ps(vec_103, vec_92, mem_vec_555);
										mem_vec_555 = vec_104;
										scal_33 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_106 = _mm512_set1_ps(scal_33);


										vec_105 = _mm512_fmadd_ps(vec_106, vec_90, mem_vec_556);
										mem_vec_556 = vec_105;



										vec_107 = _mm512_fmadd_ps(vec_106, vec_92, mem_vec_557);
										mem_vec_557 = vec_107;
										scal_34 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_109 = _mm512_set1_ps(scal_34);


										vec_108 = _mm512_fmadd_ps(vec_109, vec_90, mem_vec_558);
										mem_vec_558 = vec_108;



										vec_110 = _mm512_fmadd_ps(vec_109, vec_92, mem_vec_559);
										mem_vec_559 = vec_110;
										scal_35 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_112 = _mm512_set1_ps(scal_35);


										vec_111 = _mm512_fmadd_ps(vec_112, vec_90, mem_vec_560);
										mem_vec_560 = vec_111;



										vec_113 = _mm512_fmadd_ps(vec_112, vec_92, mem_vec_561);
										mem_vec_561 = vec_113;
										scal_36 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
										vec_115 = _mm512_set1_ps(scal_36);


										vec_114 = _mm512_fmadd_ps(vec_115, vec_90, mem_vec_562);
										mem_vec_562 = vec_114;



										vec_116 = _mm512_fmadd_ps(vec_115, vec_92, mem_vec_563);
										mem_vec_563 = vec_116;
										scal_37 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
										vec_118 = _mm512_set1_ps(scal_37);


										vec_117 = _mm512_fmadd_ps(vec_118, vec_90, mem_vec_564);
										mem_vec_564 = vec_117;



										vec_119 = _mm512_fmadd_ps(vec_118, vec_92, mem_vec_565);
										mem_vec_565 = vec_119;
										scal_38 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
										vec_121 = _mm512_set1_ps(scal_38);


										vec_120 = _mm512_fmadd_ps(vec_121, vec_90, mem_vec_566);
										mem_vec_566 = vec_120;



										vec_122 = _mm512_fmadd_ps(vec_121, vec_92, mem_vec_567);
										mem_vec_567 = vec_122;
										scal_39 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 2) + c];
										vec_124 = _mm512_set1_ps(scal_39);


										vec_123 = _mm512_fmadd_ps(vec_124, vec_90, mem_vec_568);
										mem_vec_568 = vec_123;



										vec_125 = _mm512_fmadd_ps(vec_124, vec_92, mem_vec_569);
										mem_vec_569 = vec_125;
										scal_40 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 2) + c];
										vec_127 = _mm512_set1_ps(scal_40);


										vec_126 = _mm512_fmadd_ps(vec_127, vec_90, mem_vec_570);
										mem_vec_570 = vec_126;



										vec_128 = _mm512_fmadd_ps(vec_127, vec_92, mem_vec_571);
										mem_vec_571 = vec_128;
										scal_41 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 2) + c];
										vec_130 = _mm512_set1_ps(scal_41);


										vec_129 = _mm512_fmadd_ps(vec_130, vec_90, mem_vec_572);
										mem_vec_572 = vec_129;



										vec_131 = _mm512_fmadd_ps(vec_130, vec_92, mem_vec_573);
										mem_vec_573 = vec_131;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_568);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_569);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_570);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_571);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_572);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_573);
						}
					}
				}
			}
