...
/*
[V f; U (2, f); U (8, y); T (128, c); Hoist_vars [c]; T (4, x); T (17, x);
  T (17, y); T (2, f); T (2, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x40_p_0, x41_p_0, xp_1, x40_p_1, xp_2, x40, x41, y, yp_0;
