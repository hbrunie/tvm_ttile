...
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (1, x); T (7, w);
  T (7, h); T (112, x); T (14, y); T (2, f); T (1, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x80_p_0, x81_p_0, xp_1, x80_p_1, xp_2, x80, x81, y, yp_0;
IND_TYPE y40 = 0;
IND_TYPE x82 = 0;
IND_TYPE h40 = 0;
IND_TYPE w40 = 0;
				...
				for (h = h40, hp_0 = 0;h < h40 + 7;h += 1, hp_0 += 1){
					...
					for (w = w40, wp_0 = 0;w < w40 + 7;w += 1, wp_0 += 1){
						...
						for (x = x80, xp_2 = x80_p_1, xp_1 = x80_p_0, xp_0 = 0;x < x80 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									// y = 8, x = 1, h = 1, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c40, cp_0 = 0;c < c40 + 3;c += 1, cp_0 += 1){
