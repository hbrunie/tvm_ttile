...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (128, c); Hoist_vars [c];
  T (68, x); T (17, y); T (4, f); T (1, c); T (4, f); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c120_p_0, cp_1, c120, f, fp_0, f160_p_0, f161_p_0, fp_1, f160_p_1, fp_2, f160, f161, x, xp_0, x138_p_0, xp_1, x138, y, yp_0;
						...
						for (x = x138, xp_1 = x138_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c120, cp_1 = c120_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_529);
										mem_vec_529 = vec_3;
