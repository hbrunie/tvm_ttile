...
[V f; U (4, f); U (4, y); U (3, h); T (2, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (17, y); T (1, f); T (64, c); T (2, f); T (34, x); T (2, f)]
*/
IND_TYPE c, cp_0, c60_p_0, cp_1, c60, f, fp_0, f80_p_0, f81_p_0, fp_1, f80_p_1, fp_2, f80, f81, w, wp_0, x, xp_0, x78_p_0, xp_1, x78, y, yp_0;
IND_TYPE y40 = 0;
IND_TYPE x79 = 0;
IND_TYPE h = 0;
IND_TYPE w40 = 0;
...
yp_0 = 0;
						for (w = w40, wp_0 = 0;w < w40 + 3;w += 1, wp_0 += 1){
							...
							for (x = x78, xp_1 = x78_p_0, xp_0 = 0;x < x78 + 2;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_332 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_333 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
										mem_vec_334 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
										mem_vec_335 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_332);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_333);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_334);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_335);
							}
						}
}
