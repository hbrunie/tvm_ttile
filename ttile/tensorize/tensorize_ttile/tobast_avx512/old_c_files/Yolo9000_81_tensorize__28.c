...
c276_p_0 = 0;
						for (w = w158, wp_0 = 0;w < w158 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 2) (2 / 1)
							for (x = x294, xp_2 = x294_p_1, xp_1 = x294_p_0, xp_0 = 0;x < x294 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_2460 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_2461 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2461);
