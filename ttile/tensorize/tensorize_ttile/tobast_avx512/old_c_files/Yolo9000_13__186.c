					...
					for (x56 = x57, x56_p_1 = x57_p_0, x56_p_0 = 0;
						...
						for (x = x56, xp_2 = x56_p_1, xp_1 = x56_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_476 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_477 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
									mem_vec_478 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_479 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 256, f = 32
									// T (c, 256) (256 / 1)
									for (c = c42, cp_1 = c42_p_0, cp_0 = 0;
										c < c42 + 256;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_476);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_477);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_478);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_479);
						}
					}
				}
		}
