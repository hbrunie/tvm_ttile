...
// T (f, 2) (256 / 128)
for (f783 = f784, f783_p_0 = 0;
	f783 < f784 + 256;
	f783 += 128, f783_p_0 += 128){
	...
	for (x658 = x659, x658_p_0 = 0;
		...
		for (c791 = c792, c791_p_0 = 0;
			...
			// T (f, 2) (128 / 64)
			for (f782 = f783, f782_p_1 = f783_p_0, f782_p_0 = 0;
				f782 < f783 + 128;
				f782 += 64, f782_p_1 += 64, f782_p_0 += 64){
				// y = 14, x = 7, h = 3, w = 3, c = 8, f = 64
				// T (c, 4) (8 / 2)
				for (c790 = c791, c790_p_1 = c791_p_0, c790_p_0 = 0;
					c790 < c791 + 8;
					c790 += 2, c790_p_1 += 2, c790_p_0 += 2){
					// y = 14, x = 7, h = 3, w = 3, c = 2, f = 64
					// T (f, 2) (64 / 32)
					for (f = f782, fp_2 = f782_p_1, fp_1 = f782_p_0, fp_0 = 0;
						f < f782 + 64;
