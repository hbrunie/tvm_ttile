...
[V f; U (2, f); ULambda y; U (3, w); T (1, c); Hoist_vars [c]; T (1, x);
  ...
  T (64, c); T (34, x)]
*/
IND_TYPE c, cp_0, c894_p_0, cp_1, c894, f, fp_0, h, hp_0, x, xp_0, x1134_p_0, x1135_p_0, xp_1, x1134_p_1, xp_2, x1134, x1135, y, yp_0;
							...
							for (x = x1134, xp_2 = x1134_p_1, xp_1 = x1134_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c894, cp_1 = c894_p_0, cp_0 = 0;
											...
											vec_32 = _mm512_fmadd_ps(vec_33, vec_34, mem_vec_8492);
											mem_vec_8492 = vec_32;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_35 = _mm512_fmadd_ps(vec_33, vec_36, mem_vec_8493);
											mem_vec_8493 = vec_35;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_8494);
											mem_vec_8494 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_8495);
											mem_vec_8495 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_34, mem_vec_8496);
											mem_vec_8496 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_36, mem_vec_8497);
											mem_vec_8497 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_34, mem_vec_8498);
											mem_vec_8498 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_8499);
											mem_vec_8499 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_34, mem_vec_8500);
											mem_vec_8500 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_36, mem_vec_8501);
											mem_vec_8501 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_34, mem_vec_8502);
											mem_vec_8502 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_36, mem_vec_8503);
											mem_vec_8503 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_53 = _mm512_set1_ps(scal_16);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_34, mem_vec_8504);
											mem_vec_8504 = vec_52;



											vec_54 = _mm512_fmadd_ps(vec_53, vec_36, mem_vec_8505);
											mem_vec_8505 = vec_54;
											scal_17 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_56 = _mm512_set1_ps(scal_17);


											vec_55 = _mm512_fmadd_ps(vec_56, vec_34, mem_vec_8506);
											mem_vec_8506 = vec_55;



											vec_57 = _mm512_fmadd_ps(vec_56, vec_36, mem_vec_8507);
											mem_vec_8507 = vec_57;
											scal_18 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
											vec_59 = _mm512_set1_ps(scal_18);


											vec_58 = _mm512_fmadd_ps(vec_59, vec_34, mem_vec_8508);
											mem_vec_8508 = vec_58;



											vec_60 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_8509);
											mem_vec_8509 = vec_60;
											scal_19 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
											vec_62 = _mm512_set1_ps(scal_19);


											vec_61 = _mm512_fmadd_ps(vec_62, vec_34, mem_vec_8510);
											mem_vec_8510 = vec_61;



											vec_63 = _mm512_fmadd_ps(vec_62, vec_36, mem_vec_8511);
											mem_vec_8511 = vec_63;
											scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_65 = _mm512_set1_ps(scal_20);
											vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_64 = _mm512_fmadd_ps(vec_65, vec_66, mem_vec_8492);
											mem_vec_8492 = vec_64;

											vec_68 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_67 = _mm512_fmadd_ps(vec_65, vec_68, mem_vec_8493);
											mem_vec_8493 = vec_67;
											scal_21 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_70 = _mm512_set1_ps(scal_21);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_66, mem_vec_8494);
											mem_vec_8494 = vec_69;



											vec_71 = _mm512_fmadd_ps(vec_70, vec_68, mem_vec_8495);
											mem_vec_8495 = vec_71;
											scal_22 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_73 = _mm512_set1_ps(scal_22);


											vec_72 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_8496);
											mem_vec_8496 = vec_72;



											vec_74 = _mm512_fmadd_ps(vec_73, vec_68, mem_vec_8497);
											mem_vec_8497 = vec_74;
											scal_23 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_76 = _mm512_set1_ps(scal_23);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_66, mem_vec_8498);
											mem_vec_8498 = vec_75;



											vec_77 = _mm512_fmadd_ps(vec_76, vec_68, mem_vec_8499);
											mem_vec_8499 = vec_77;
											scal_24 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_79 = _mm512_set1_ps(scal_24);


											vec_78 = _mm512_fmadd_ps(vec_79, vec_66, mem_vec_8500);
											mem_vec_8500 = vec_78;



											vec_80 = _mm512_fmadd_ps(vec_79, vec_68, mem_vec_8501);
											mem_vec_8501 = vec_80;
											scal_25 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_82 = _mm512_set1_ps(scal_25);


											vec_81 = _mm512_fmadd_ps(vec_82, vec_66, mem_vec_8502);
											mem_vec_8502 = vec_81;



											vec_83 = _mm512_fmadd_ps(vec_82, vec_68, mem_vec_8503);
											mem_vec_8503 = vec_83;
											scal_26 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_85 = _mm512_set1_ps(scal_26);


											vec_84 = _mm512_fmadd_ps(vec_85, vec_66, mem_vec_8504);
											mem_vec_8504 = vec_84;



											vec_86 = _mm512_fmadd_ps(vec_85, vec_68, mem_vec_8505);
											mem_vec_8505 = vec_86;
											scal_27 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_88 = _mm512_set1_ps(scal_27);


											vec_87 = _mm512_fmadd_ps(vec_88, vec_66, mem_vec_8506);
											mem_vec_8506 = vec_87;



											vec_89 = _mm512_fmadd_ps(vec_88, vec_68, mem_vec_8507);
											mem_vec_8507 = vec_89;
											scal_28 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
											vec_91 = _mm512_set1_ps(scal_28);


											vec_90 = _mm512_fmadd_ps(vec_91, vec_66, mem_vec_8508);
											mem_vec_8508 = vec_90;



											vec_92 = _mm512_fmadd_ps(vec_91, vec_68, mem_vec_8509);
											mem_vec_8509 = vec_92;
											scal_29 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
											vec_94 = _mm512_set1_ps(scal_29);


											vec_93 = _mm512_fmadd_ps(vec_94, vec_66, mem_vec_8510);
											mem_vec_8510 = vec_93;



											vec_95 = _mm512_fmadd_ps(vec_94, vec_68, mem_vec_8511);
											mem_vec_8511 = vec_95;
										}
							...
							for (x = x1134, xp_2 = x1134_p_1, xp_1 = x1134_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c894, cp_1 = c894_p_0, cp_0 = 0;
											...
											vec_41 = _mm512_fmadd_ps(vec_42, vec_43, mem_vec_8512);
											mem_vec_8512 = vec_41;

											vec_45 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_44 = _mm512_fmadd_ps(vec_42, vec_45, mem_vec_8513);
											mem_vec_8513 = vec_44;
											scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_43, mem_vec_8514);
											mem_vec_8514 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_45, mem_vec_8515);
											mem_vec_8515 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_43, mem_vec_8516);
											mem_vec_8516 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_45, mem_vec_8517);
											mem_vec_8517 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_53 = _mm512_set1_ps(scal_16);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_43, mem_vec_8518);
											mem_vec_8518 = vec_52;



											vec_54 = _mm512_fmadd_ps(vec_53, vec_45, mem_vec_8519);
											mem_vec_8519 = vec_54;
											scal_17 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_56 = _mm512_set1_ps(scal_17);


											vec_55 = _mm512_fmadd_ps(vec_56, vec_43, mem_vec_8520);
											mem_vec_8520 = vec_55;



											vec_57 = _mm512_fmadd_ps(vec_56, vec_45, mem_vec_8521);
											mem_vec_8521 = vec_57;
											scal_18 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_59 = _mm512_set1_ps(scal_18);


											vec_58 = _mm512_fmadd_ps(vec_59, vec_43, mem_vec_8522);
											mem_vec_8522 = vec_58;



											vec_60 = _mm512_fmadd_ps(vec_59, vec_45, mem_vec_8523);
											mem_vec_8523 = vec_60;
											scal_19 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_62 = _mm512_set1_ps(scal_19);


											vec_61 = _mm512_fmadd_ps(vec_62, vec_43, mem_vec_8524);
											mem_vec_8524 = vec_61;



											vec_63 = _mm512_fmadd_ps(vec_62, vec_45, mem_vec_8525);
											mem_vec_8525 = vec_63;
											scal_20 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_65 = _mm512_set1_ps(scal_20);


											vec_64 = _mm512_fmadd_ps(vec_65, vec_43, mem_vec_8526);
											mem_vec_8526 = vec_64;



											vec_66 = _mm512_fmadd_ps(vec_65, vec_45, mem_vec_8527);
											mem_vec_8527 = vec_66;
											scal_21 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
											vec_68 = _mm512_set1_ps(scal_21);


											vec_67 = _mm512_fmadd_ps(vec_68, vec_43, mem_vec_8528);
											mem_vec_8528 = vec_67;



											vec_69 = _mm512_fmadd_ps(vec_68, vec_45, mem_vec_8529);
											mem_vec_8529 = vec_69;
											scal_22 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
											vec_71 = _mm512_set1_ps(scal_22);


											vec_70 = _mm512_fmadd_ps(vec_71, vec_43, mem_vec_8530);
											mem_vec_8530 = vec_70;



											vec_72 = _mm512_fmadd_ps(vec_71, vec_45, mem_vec_8531);
											mem_vec_8531 = vec_72;
											scal_23 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
											vec_74 = _mm512_set1_ps(scal_23);


											vec_73 = _mm512_fmadd_ps(vec_74, vec_43, mem_vec_8532);
											mem_vec_8532 = vec_73;



											vec_75 = _mm512_fmadd_ps(vec_74, vec_45, mem_vec_8533);
											mem_vec_8533 = vec_75;
											scal_24 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h) + c];
											vec_77 = _mm512_set1_ps(scal_24);


											vec_76 = _mm512_fmadd_ps(vec_77, vec_43, mem_vec_8534);
											mem_vec_8534 = vec_76;



											vec_78 = _mm512_fmadd_ps(vec_77, vec_45, mem_vec_8535);
											mem_vec_8535 = vec_78;
											scal_25 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h) + c];
											vec_80 = _mm512_set1_ps(scal_25);


											vec_79 = _mm512_fmadd_ps(vec_80, vec_43, mem_vec_8536);
											mem_vec_8536 = vec_79;



											vec_81 = _mm512_fmadd_ps(vec_80, vec_45, mem_vec_8537);
											mem_vec_8537 = vec_81;
											scal_26 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_83 = _mm512_set1_ps(scal_26);
											vec_84 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_82 = _mm512_fmadd_ps(vec_83, vec_84, mem_vec_8512);
											mem_vec_8512 = vec_82;

											vec_86 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_85 = _mm512_fmadd_ps(vec_83, vec_86, mem_vec_8513);
											mem_vec_8513 = vec_85;
											scal_27 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_88 = _mm512_set1_ps(scal_27);


											vec_87 = _mm512_fmadd_ps(vec_88, vec_84, mem_vec_8514);
											mem_vec_8514 = vec_87;



											vec_89 = _mm512_fmadd_ps(vec_88, vec_86, mem_vec_8515);
											mem_vec_8515 = vec_89;
											scal_28 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_91 = _mm512_set1_ps(scal_28);


											vec_90 = _mm512_fmadd_ps(vec_91, vec_84, mem_vec_8516);
											mem_vec_8516 = vec_90;



											vec_92 = _mm512_fmadd_ps(vec_91, vec_86, mem_vec_8517);
											mem_vec_8517 = vec_92;
											scal_29 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_94 = _mm512_set1_ps(scal_29);


											vec_93 = _mm512_fmadd_ps(vec_94, vec_84, mem_vec_8518);
											mem_vec_8518 = vec_93;



											vec_95 = _mm512_fmadd_ps(vec_94, vec_86, mem_vec_8519);
											mem_vec_8519 = vec_95;
											scal_30 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_97 = _mm512_set1_ps(scal_30);


											vec_96 = _mm512_fmadd_ps(vec_97, vec_84, mem_vec_8520);
											mem_vec_8520 = vec_96;



											vec_98 = _mm512_fmadd_ps(vec_97, vec_86, mem_vec_8521);
											mem_vec_8521 = vec_98;
											scal_31 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_100 = _mm512_set1_ps(scal_31);


											vec_99 = _mm512_fmadd_ps(vec_100, vec_84, mem_vec_8522);
											mem_vec_8522 = vec_99;



											vec_101 = _mm512_fmadd_ps(vec_100, vec_86, mem_vec_8523);
											mem_vec_8523 = vec_101;
											scal_32 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_103 = _mm512_set1_ps(scal_32);


											vec_102 = _mm512_fmadd_ps(vec_103, vec_84, mem_vec_8524);
											mem_vec_8524 = vec_102;



											vec_104 = _mm512_fmadd_ps(vec_103, vec_86, mem_vec_8525);
											mem_vec_8525 = vec_104;
											scal_33 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_106 = _mm512_set1_ps(scal_33);


											vec_105 = _mm512_fmadd_ps(vec_106, vec_84, mem_vec_8526);
											mem_vec_8526 = vec_105;



											vec_107 = _mm512_fmadd_ps(vec_106, vec_86, mem_vec_8527);
											mem_vec_8527 = vec_107;
											scal_34 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
											vec_109 = _mm512_set1_ps(scal_34);


											vec_108 = _mm512_fmadd_ps(vec_109, vec_84, mem_vec_8528);
											mem_vec_8528 = vec_108;



											vec_110 = _mm512_fmadd_ps(vec_109, vec_86, mem_vec_8529);
											mem_vec_8529 = vec_110;
											scal_35 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
											vec_112 = _mm512_set1_ps(scal_35);


											vec_111 = _mm512_fmadd_ps(vec_112, vec_84, mem_vec_8530);
											mem_vec_8530 = vec_111;



											vec_113 = _mm512_fmadd_ps(vec_112, vec_86, mem_vec_8531);
											mem_vec_8531 = vec_113;
											scal_36 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h) + c];
											vec_115 = _mm512_set1_ps(scal_36);


											vec_114 = _mm512_fmadd_ps(vec_115, vec_84, mem_vec_8532);
											mem_vec_8532 = vec_114;



											vec_116 = _mm512_fmadd_ps(vec_115, vec_86, mem_vec_8533);
											mem_vec_8533 = vec_116;
											scal_37 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h) + c];
											vec_118 = _mm512_set1_ps(scal_37);


											vec_117 = _mm512_fmadd_ps(vec_118, vec_84, mem_vec_8534);
											mem_vec_8534 = vec_117;



											vec_119 = _mm512_fmadd_ps(vec_118, vec_86, mem_vec_8535);
											mem_vec_8535 = vec_119;
											scal_38 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 12 + h) + c];
											vec_121 = _mm512_set1_ps(scal_38);


											vec_120 = _mm512_fmadd_ps(vec_121, vec_84, mem_vec_8536);
											mem_vec_8536 = vec_120;



											vec_122 = _mm512_fmadd_ps(vec_121, vec_86, mem_vec_8537);
											mem_vec_8537 = vec_122;
										}
