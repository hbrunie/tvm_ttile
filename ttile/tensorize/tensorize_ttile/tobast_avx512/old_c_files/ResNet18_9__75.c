...
// T (f, 1) (256 / 256)
for (f807 = f808, f807_p_0 = 0;
	f807 < f808 + 256;
	f807 += 256, f807_p_0 += 256){
	// y = 14, x = 14, h = 3, w = 3, c = 256, f = 256
	// T (x, 7) (14 / 2)
	for (x676 = x677, x676_p_0 = 0;
		...
		for (c815 = c816, c815_p_0 = 0;
			...
			// T (f, 4) (256 / 64)
			for (f806 = f807, f806_p_1 = f807_p_0, f806_p_0 = 0;
				f806 < f807 + 256;
				f806 += 64, f806_p_1 += 64, f806_p_0 += 64){
				// y = 14, x = 2, h = 3, w = 3, c = 64, f = 64
				// T (c, 16) (64 / 4)
				for (c814 = c815, c814_p_1 = c815_p_0, c814_p_0 = 0;
					c814 < c815 + 64;
					c814 += 4, c814_p_1 += 4, c814_p_0 += 4){
					// y = 14, x = 2, h = 3, w = 3, c = 4, f = 64
					// T (f, 2) (64 / 32)
					for (f = f806, fp_2 = f806_p_1, fp_1 = f806_p_0, fp_0 = 0;
						f < f806 + 64;
									...
									for (x = x676, xp_1 = x676_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c814, cp_2 = c814_p_1, cp_1 = c814_p_0, cp_0 = 0;
													...
													vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_4340);
													mem_vec_4340 = vec_14;

													vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_4341);
													mem_vec_4341 = vec_17;
													scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
													vec_20 = _mm512_set1_ps(scal_5);


													vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_4342);
													mem_vec_4342 = vec_19;



													vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_4343);
													mem_vec_4343 = vec_21;
													scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
													vec_23 = _mm512_set1_ps(scal_6);


													vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_4344);
													mem_vec_4344 = vec_22;



													vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_4345);
													mem_vec_4345 = vec_24;
													scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
													vec_26 = _mm512_set1_ps(scal_7);


													vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_4346);
													mem_vec_4346 = vec_25;



													vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_4347);
													mem_vec_4347 = vec_27;
													scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
													vec_29 = _mm512_set1_ps(scal_8);
													vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_4340);
													mem_vec_4340 = vec_28;

													vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_4341);
													mem_vec_4341 = vec_31;
													scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
													vec_34 = _mm512_set1_ps(scal_9);


													vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_4342);
													mem_vec_4342 = vec_33;



													vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_4343);
													mem_vec_4343 = vec_35;
													scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
													vec_37 = _mm512_set1_ps(scal_10);


													vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_4344);
													mem_vec_4344 = vec_36;



													vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_4345);
													mem_vec_4345 = vec_38;
													scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
													vec_40 = _mm512_set1_ps(scal_11);


													vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_4346);
													mem_vec_4346 = vec_39;



													vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_4347);
													mem_vec_4347 = vec_41;
												}
