...
fp_1 = 0;
						for (w = w202, wp_0 = 0;w < w202 + 3;w += 1, wp_0 += 1){
							...
							for (x = x378, xp_1 = x378_p_0, xp_0 = 0;x < x378 + 28;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2625 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
										mem_vec_2626 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
										mem_vec_2627 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2625);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_2626);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_2627);
