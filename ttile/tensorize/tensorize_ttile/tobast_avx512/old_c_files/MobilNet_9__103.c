...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (8, c); Hoist_vars [c];
  T (7, x); T (16, f); T (2, c); T (1, f); T (4, f); T (64, c)]
*/
IND_TYPE c, cp_0, c1056_p_0, c1057_p_0, cp_1, c1056_p_1, cp_2, c1056, c1057, f, fp_0, f736_p_0, f737_p_0, fp_1, f736_p_1, fp_2, f736, f737, x, xp_0;
				...
				for (f = f736, fp_2 = f736_p_1, fp_1 = f736_p_0, fp_0 = 0;
					...
					for (x = x448, xp_0 = 0;
						...
						x += 1, xp_0 += 1){
								...
								mem_vec_3755 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
								mem_vec_3756 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
								mem_vec_3757 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
								mem_vec_3758 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
								...
								for (c = c1056, cp_2 = c1056_p_1, cp_1 = c1056_p_0, cp_0 = 0;
									...
									vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_3753);
									mem_vec_3753 = vec_3;
									...
									vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_3755);
									mem_vec_3755 = vec_7;
									...
									vec_120 = _mm512_fmadd_ps(vec_121, vec_122, mem_vec_3752);
									mem_vec_3752 = vec_120;
									scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
									vec_124 = _mm512_set1_ps(scal_57);


									vec_123 = _mm512_fmadd_ps(vec_124, vec_122, mem_vec_3753);
									mem_vec_3753 = vec_123;
									scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
									vec_126 = _mm512_set1_ps(scal_58);


									vec_125 = _mm512_fmadd_ps(vec_126, vec_122, mem_vec_3754);
									mem_vec_3754 = vec_125;
									scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
									vec_128 = _mm512_set1_ps(scal_59);


									vec_127 = _mm512_fmadd_ps(vec_128, vec_122, mem_vec_3755);
									mem_vec_3755 = vec_127;
									scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
									vec_130 = _mm512_set1_ps(scal_60);


									vec_129 = _mm512_fmadd_ps(vec_130, vec_122, mem_vec_3756);
									mem_vec_3756 = vec_129;
									scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
									vec_132 = _mm512_set1_ps(scal_61);


									vec_131 = _mm512_fmadd_ps(vec_132, vec_122, mem_vec_3757);
									mem_vec_3757 = vec_131;
									scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
									vec_134 = _mm512_set1_ps(scal_62);


									vec_133 = _mm512_fmadd_ps(vec_134, vec_122, mem_vec_3758);
									mem_vec_3758 = vec_133;
								}
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_3755);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_3756);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_3757);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_3758);
					}
				}
			}
		}
