...
for (c1730 = c1731, c1730_p_0 = 0;
	...
	for (f1152 = f1153, f1152_p_0 = 0;
		...
		for (c1729 = c1730, c1729_p_1 = c1730_p_0, c1729_p_0 = 0;
			c1729 < c1730 + 32;
			c1729 += 32, c1729_p_1 += 32, c1729_p_0 += 32){
				for (y = y574, yp_0 = 0;
					y < y574 + 2;
					y += 2, yp_0 += 2){
					...
					for (f = f1152, fp_1 = f1152_p_0, fp_0 = 0;
						...
						for (c1728 = c1729, c1728_p_2 = c1729_p_1, c1728_p_1 = c1729_p_0, c1728_p_0 = 0;
							c1728 < c1729 + 32;
							c1728 += 32, c1728_p_2 += 32, c1728_p_1 += 32, c1728_p_0 += 32){
							// y = ph_y, x = 7, h = 3, w = 3, c = 32, f = 64
							// T (h, 3) (3 / 1)
							for (h = h538, hp_0 = 0;
								h < h538 + 3;
								...
								for (x = x720, xp_0 = 0;
									...
									x += 1, xp_0 += 1){
											...
											for (c = c1728, cp_3 = c1728_p_2, cp_2 = c1728_p_1, cp_1 = c1728_p_0, cp_0 = 0;
												...
												vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_6869);
												mem_vec_6869 = vec_32;

												vec_35 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

												vec_34 = _mm512_fmadd_ps(vec_30, vec_35, mem_vec_6870);
												mem_vec_6870 = vec_34;

												vec_37 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

												vec_36 = _mm512_fmadd_ps(vec_30, vec_37, mem_vec_6871);
												mem_vec_6871 = vec_36;
												...
												vec_40 = _mm512_fmadd_ps(vec_39, vec_33, mem_vec_6873);
												mem_vec_6873 = vec_40;



												vec_41 = _mm512_fmadd_ps(vec_39, vec_35, mem_vec_6874);
												mem_vec_6874 = vec_41;



												vec_42 = _mm512_fmadd_ps(vec_39, vec_37, mem_vec_6875);
												mem_vec_6875 = vec_42;
												scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_44 = _mm512_set1_ps(scal_7);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_6876);
												mem_vec_6876 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_6877);
												mem_vec_6877 = vec_45;



												vec_46 = _mm512_fmadd_ps(vec_44, vec_35, mem_vec_6878);
												mem_vec_6878 = vec_46;



												vec_47 = _mm512_fmadd_ps(vec_44, vec_37, mem_vec_6879);
												mem_vec_6879 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_49 = _mm512_set1_ps(scal_8);


												vec_48 = _mm512_fmadd_ps(vec_49, vec_31, mem_vec_6880);
												mem_vec_6880 = vec_48;



												vec_50 = _mm512_fmadd_ps(vec_49, vec_33, mem_vec_6881);
												mem_vec_6881 = vec_50;



												vec_51 = _mm512_fmadd_ps(vec_49, vec_35, mem_vec_6882);
												mem_vec_6882 = vec_51;



												vec_52 = _mm512_fmadd_ps(vec_49, vec_37, mem_vec_6883);
												mem_vec_6883 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_54 = _mm512_set1_ps(scal_9);


												vec_53 = _mm512_fmadd_ps(vec_54, vec_31, mem_vec_6884);
												mem_vec_6884 = vec_53;



												vec_55 = _mm512_fmadd_ps(vec_54, vec_33, mem_vec_6885);
												mem_vec_6885 = vec_55;



												vec_56 = _mm512_fmadd_ps(vec_54, vec_35, mem_vec_6886);
												mem_vec_6886 = vec_56;



												vec_57 = _mm512_fmadd_ps(vec_54, vec_37, mem_vec_6887);
												mem_vec_6887 = vec_57;
												...
												vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_6869);
												mem_vec_6869 = vec_61;

												vec_64 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

												vec_63 = _mm512_fmadd_ps(vec_59, vec_64, mem_vec_6870);
												mem_vec_6870 = vec_63;

												vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

												vec_65 = _mm512_fmadd_ps(vec_59, vec_66, mem_vec_6871);
												mem_vec_6871 = vec_65;
												...
												vec_69 = _mm512_fmadd_ps(vec_68, vec_62, mem_vec_6873);
												mem_vec_6873 = vec_69;



												vec_70 = _mm512_fmadd_ps(vec_68, vec_64, mem_vec_6874);
												mem_vec_6874 = vec_70;



												vec_71 = _mm512_fmadd_ps(vec_68, vec_66, mem_vec_6875);
												mem_vec_6875 = vec_71;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_73 = _mm512_set1_ps(scal_12);


												vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_6876);
												mem_vec_6876 = vec_72;



												vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_6877);
												mem_vec_6877 = vec_74;



												vec_75 = _mm512_fmadd_ps(vec_73, vec_64, mem_vec_6878);
												mem_vec_6878 = vec_75;



												vec_76 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_6879);
												mem_vec_6879 = vec_76;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_78 = _mm512_set1_ps(scal_13);


												vec_77 = _mm512_fmadd_ps(vec_78, vec_60, mem_vec_6880);
												mem_vec_6880 = vec_77;



												vec_79 = _mm512_fmadd_ps(vec_78, vec_62, mem_vec_6881);
												mem_vec_6881 = vec_79;



												vec_80 = _mm512_fmadd_ps(vec_78, vec_64, mem_vec_6882);
												mem_vec_6882 = vec_80;



												vec_81 = _mm512_fmadd_ps(vec_78, vec_66, mem_vec_6883);
												mem_vec_6883 = vec_81;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_83 = _mm512_set1_ps(scal_14);


												vec_82 = _mm512_fmadd_ps(vec_83, vec_60, mem_vec_6884);
												mem_vec_6884 = vec_82;



												vec_84 = _mm512_fmadd_ps(vec_83, vec_62, mem_vec_6885);
												mem_vec_6885 = vec_84;



												vec_85 = _mm512_fmadd_ps(vec_83, vec_64, mem_vec_6886);
												mem_vec_6886 = vec_85;



												vec_86 = _mm512_fmadd_ps(vec_83, vec_66, mem_vec_6887);
												mem_vec_6887 = vec_86;
											}
