...
for (c1260 = c1261, c1260_p_0 = 0;
	c1260 < c1261 + 1024;
	c1260 += 32, c1260_p_0 += 32){
	// y = 7, x = 7, h = 3, w = 3, c = 32, f = 1024
	// T (f, 2) (1024 / 512)
	for (f870 = f871, f870_p_0 = 0;
		f870 < f871 + 1024;
		f870 += 512, f870_p_0 += 512){
		// y = 7, x = 7, h = 3, w = 3, c = 32, f = 512
		// T (c, 16) (32 / 2)
		for (c1259 = c1260, c1259_p_1 = c1260_p_0, c1259_p_0 = 0;
			c1259 < c1260 + 32;
			c1259 += 2, c1259_p_1 += 2, c1259_p_0 += 2){
				for (y = y386, yp_0 = 0;
					y < y386 + 3;
					y += 3, yp_0 += 3){
					...
					for (f = f870, fp_1 = f870_p_0, fp_0 = 0;
						...
						// T (c, 2) (2 / 1)
						for (c1258 = c1259, c1258_p_2 = c1259_p_1, c1258_p_1 = c1259_p_0, c1258_p_0 = 0;
							c1258 < c1259 + 2;
							c1258 += 1, c1258_p_2 += 1, c1258_p_1 += 1, c1258_p_0 += 1){
								...
								for (w = w412, wp_0 = 0;
									...
									for (x = x532, xp_0 = 0;
										...
										x += 1, xp_0 += 1){
												...
												// T (c, 1) (1 / 1)
												for (c = c1258, cp_3 = c1258_p_2, cp_2 = c1258_p_1, cp_1 = c1258_p_0, cp_0 = 0;
													c < c1258 + 1;
