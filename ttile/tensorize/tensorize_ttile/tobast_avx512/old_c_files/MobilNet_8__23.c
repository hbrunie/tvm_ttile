		...
		for (y = y566, yp_0 = 0;
			...
			for (f = f872, fp_0 = 0;
				...
				for (c1240 = c1241, c1240_p_1 = c1241_p_0, c1240_p_0 = 0;
					c1240 < c1241 + 64;
					c1240 += 2, c1240_p_1 += 2, c1240_p_0 += 2){
						...
						for (x = x704, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c1240, cp_2 = c1240_p_1, cp_1 = c1240_p_0, cp_0 = 0;
										...
										vec_34 = _mm512_fmadd_ps(vec_30, vec_35, mem_vec_6514);
										mem_vec_6514 = vec_34;

										vec_37 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

										vec_36 = _mm512_fmadd_ps(vec_30, vec_37, mem_vec_6515);
										mem_vec_6515 = vec_36;
										scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_31, mem_vec_6516);
										mem_vec_6516 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_33, mem_vec_6517);
										mem_vec_6517 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_35, mem_vec_6518);
										mem_vec_6518 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_37, mem_vec_6519);
										mem_vec_6519 = vec_42;
										...
										vec_46 = _mm512_fmadd_ps(vec_44, vec_35, mem_vec_6522);
										mem_vec_6522 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_37, mem_vec_6523);
										mem_vec_6523 = vec_47;
										scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
										vec_49 = _mm512_set1_ps(scal_8);


										vec_48 = _mm512_fmadd_ps(vec_49, vec_31, mem_vec_6524);
										mem_vec_6524 = vec_48;



										vec_50 = _mm512_fmadd_ps(vec_49, vec_33, mem_vec_6525);
										mem_vec_6525 = vec_50;



										vec_51 = _mm512_fmadd_ps(vec_49, vec_35, mem_vec_6526);
										mem_vec_6526 = vec_51;



										vec_52 = _mm512_fmadd_ps(vec_49, vec_37, mem_vec_6527);
										mem_vec_6527 = vec_52;
										scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
										vec_54 = _mm512_set1_ps(scal_9);


										vec_53 = _mm512_fmadd_ps(vec_54, vec_31, mem_vec_6528);
										mem_vec_6528 = vec_53;



										vec_55 = _mm512_fmadd_ps(vec_54, vec_33, mem_vec_6529);
										mem_vec_6529 = vec_55;



										vec_56 = _mm512_fmadd_ps(vec_54, vec_35, mem_vec_6530);
										mem_vec_6530 = vec_56;



										vec_57 = _mm512_fmadd_ps(vec_54, vec_37, mem_vec_6531);
										mem_vec_6531 = vec_57;
										...
										vec_63 = _mm512_fmadd_ps(vec_59, vec_64, mem_vec_6514);
										mem_vec_6514 = vec_63;

										vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

										vec_65 = _mm512_fmadd_ps(vec_59, vec_66, mem_vec_6515);
										mem_vec_6515 = vec_65;
										scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_60, mem_vec_6516);
										mem_vec_6516 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_62, mem_vec_6517);
										mem_vec_6517 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_64, mem_vec_6518);
										mem_vec_6518 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_66, mem_vec_6519);
										mem_vec_6519 = vec_71;
										...
										vec_75 = _mm512_fmadd_ps(vec_73, vec_64, mem_vec_6522);
										mem_vec_6522 = vec_75;



										vec_76 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_6523);
										mem_vec_6523 = vec_76;
										scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
										vec_78 = _mm512_set1_ps(scal_13);


										vec_77 = _mm512_fmadd_ps(vec_78, vec_60, mem_vec_6524);
										mem_vec_6524 = vec_77;



										vec_79 = _mm512_fmadd_ps(vec_78, vec_62, mem_vec_6525);
										mem_vec_6525 = vec_79;



										vec_80 = _mm512_fmadd_ps(vec_78, vec_64, mem_vec_6526);
										mem_vec_6526 = vec_80;



										vec_81 = _mm512_fmadd_ps(vec_78, vec_66, mem_vec_6527);
										mem_vec_6527 = vec_81;
										scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
										vec_83 = _mm512_set1_ps(scal_14);


										vec_82 = _mm512_fmadd_ps(vec_83, vec_60, mem_vec_6528);
										mem_vec_6528 = vec_82;



										vec_84 = _mm512_fmadd_ps(vec_83, vec_62, mem_vec_6529);
										mem_vec_6529 = vec_84;



										vec_85 = _mm512_fmadd_ps(vec_83, vec_64, mem_vec_6530);
										mem_vec_6530 = vec_85;



										vec_86 = _mm512_fmadd_ps(vec_83, vec_66, mem_vec_6531);
										mem_vec_6531 = vec_86;
									}
