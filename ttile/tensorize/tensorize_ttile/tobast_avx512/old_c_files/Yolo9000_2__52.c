...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  T (2, x); T (1, x); T (68, y); T (4, f); T (2, c); T (68, x); T (2, x)]
*/
IND_TYPE c, cp_0, c624_p_0, cp_1, c624, f, fp_0, x, xp_0, x1048_p_0, x1049_p_0, x1050_p_0, xp_1, x1048_p_1, x1049_p_1, xp_2, x1048_p_2, xp_3, x1048, x1049, x1050, y, yp_0;
	...
	for (x1049 = x1050, x1049_p_1 = x1050_p_0, x1049_p_0 = 0;
		...
		for (c624 = c625, c624_p_0 = 0;
			...
			for (f = f338, fp_0 = 0;
				f < f338 + 64;
				f += 16, fp_0 += 16){
				// y = 272, x = 2, h = 3, w = 3, c = 16, f = 16
				// T (y, 68) (272 / 4)
				for (y = y436, yp_0 = 0;
					y < y436 + 272;
					y += 4, yp_0 += 4){
					// y = 4, x = 2, h = 3, w = 3, c = 16, f = 16
					// T (x, 1) (2 / 2)
					for (x1048 = x1049, x1048_p_2 = x1049_p_1, x1048_p_1 = x1049_p_0, x1048_p_0 = 0;
						x1048 < x1049 + 2;
						x1048 += 2, x1048_p_2 += 2, x1048_p_1 += 2, x1048_p_0 += 2){
						// y = 4, x = 2, h = 3, w = 3, c = 16, f = 16
						// T (x, 2) (2 / 1)
						for (x = x1048, xp_3 = x1048_p_2, xp_2 = x1048_p_1, xp_1 = x1048_p_0, xp_0 = 0;
							x < x1048 + 2;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_2400 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_2401 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									...
									for (c = c624, cp_1 = c624_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2401);
										mem_vec_2401 = vec_3;
