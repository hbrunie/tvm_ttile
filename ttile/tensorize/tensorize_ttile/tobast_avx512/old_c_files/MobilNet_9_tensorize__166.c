...
fp_2 = 0;
					for (w = w116, wp_0 = 0;w < w116 + 3;w += 1, wp_0 += 1){
						...
						for (x = x116, xp_0 = 0;x < x116 + 7;x += 1, xp_0 += 1){
									...
									mem_vec_985 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									mem_vec_986 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									// y = 7, x = 1, h = 3, w = 1, c = 64, f = 16
									// T (c, 64) (64 / 1)
									for (c = c274, cp_2 = c274_p_1, cp_1 = c274_p_0, cp_0 = 0;c < c274 + 64;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_985);
