...
c578_p_1 = 0;
							for (h = h226, hp_0 = 0;h < h226 + 3;h += 1, hp_0 += 1){
								...
								for (x = x510, xp_1 = x510_p_0, xp_0 = 0;x < x510 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4675 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
											mem_vec_4676 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
											// y = ph_y, x = 1, h = 1, w = 3, c = 8, f = 16
											// T (c, 8) (8 / 1)
											for (c = c578, cp_2 = c578_p_1, cp_1 = c578_p_0, cp_0 = 0;c < c578 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_4675);
