...
x160_p_1 = 0;
				for (h = h58, hp_0 = 0;h < h58 + 3;h += 1, hp_0 += 1){
					...
					for (x = x160, xp_2 = x160_p_1, xp_1 = x160_p_0, xp_0 = 0;x < x160 + 56;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_616 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
								mem_vec_617 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_616);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_617);
					}
				}
}
