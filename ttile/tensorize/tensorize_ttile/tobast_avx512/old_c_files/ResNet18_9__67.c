...
for (f815 = f816, f815_p_0 = 0;
	...
	for (x682 = x683, x682_p_0 = 0;
		...
		for (c823 = c824, c823_p_0 = 0;
			c823 < c824 + 256;
			c823 += 256, c823_p_0 += 256){
			// y = 14, x = 1, h = 3, w = 3, c = 256, f = 32
			// T (f, 1) (32 / 32)
			for (f814 = f815, f814_p_1 = f815_p_0, f814_p_0 = 0;
				f814 < f815 + 32;
				f814 += 32, f814_p_1 += 32, f814_p_0 += 32){
				// y = 14, x = 1, h = 3, w = 3, c = 256, f = 32
				// T (c, 32) (256 / 8)
				for (c822 = c823, c822_p_1 = c823_p_0, c822_p_0 = 0;
					c822 < c823 + 256;
					c822 += 8, c822_p_1 += 8, c822_p_0 += 8){
					// y = 14, x = 1, h = 3, w = 3, c = 8, f = 32
					// T (f, 1) (32 / 32)
					for (f = f814, fp_2 = f814_p_1, fp_1 = f814_p_0, fp_0 = 0;
						f < f814 + 32;
