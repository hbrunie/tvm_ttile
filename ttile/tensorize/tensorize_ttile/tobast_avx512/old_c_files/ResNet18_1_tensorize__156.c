...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (2, x); T (7, w);
  T (7, h); T (28, x); T (16, y); T (3, c); T (2, x)]
*/
IND_TYPE c, cp_0, c276_p_0, cp_1, c276, h, hp_0, w, wp_0, x, xp_0, x456_p_0, x457_p_0, xp_1, x456_p_1, xp_2, x456, x457, y, yp_0;
IND_TYPE y228 = 0;
IND_TYPE x458 = 0;
IND_TYPE h228 = 0;
IND_TYPE w228 = 0;
...
x456 = 0;
x456_p_1 = 0;
				for (h = h228, hp_0 = 0;h < h228 + 7;h += 1, hp_0 += 1){
					// y = 7, x = 2, h = 1, w = 7, c = 1, f = 64
					// T (w, 7) (7 / 1)
					for (w = w228, wp_0 = 0;w < w228 + 7;w += 1, wp_0 += 1){
