...
x1668_p_2 = 0;
							for (w = w520, wp_0 = 0;w < w520 + 3;w += 1, wp_0 += 1){
								...
								for (x = x1668, xp_3 = x1668_p_2, xp_2 = x1668_p_1, xp_1 = x1668_p_0, xp_0 = 0;x < x1668 + 1;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6680 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
											mem_vec_6681 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 4, f = 32
											// T (c, 4) (4 / 1)
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_6680);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_6681);
								}
							}
}
