...
c142_p_1 = 0;
				for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
					...
					for (x = x166, xp_1 = x166_p_0, xp_0 = 0;x < x166 + 7;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_652 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
								mem_vec_653 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
								...
								mem_vec_656 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
								mem_vec_657 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
								// y = 2, x = 1, h = 3, w = 1, c = 32, f = 64
								// T (c, 32) (32 / 1)
								for (c = c142, cp_2 = c142_p_1, cp_1 = c142_p_0, cp_0 = 0;c < c142 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_652);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_653);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_656);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_657);
					}
				}
}
