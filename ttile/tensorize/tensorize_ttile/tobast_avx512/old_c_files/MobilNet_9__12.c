...
for (c806 = c807, c806_p_0 = 0;
	c806 < c807 + 1024;
	c806 += 128, c806_p_0 += 128){
	// y = 7, x = 7, h = 3, w = 3, c = 128, f = 1024
	// T (f, 8) (1024 / 128)
	for (f556 = f557, f556_p_0 = 0;
		f556 < f557 + 1024;
		f556 += 128, f556_p_0 += 128){
		// y = 7, x = 7, h = 3, w = 3, c = 128, f = 128
		// T (c, 1) (128 / 128)
		for (c805 = c806, c805_p_1 = c806_p_0, c805_p_0 = 0;
			c805 < c806 + 128;
			c805 += 128, c805_p_1 += 128, c805_p_0 += 128){
			// y = 7, x = 7, h = 3, w = 3, c = 128, f = 128
			// T (f, 4) (128 / 32)
			for (f = f556, fp_1 = f556_p_0, fp_0 = 0;
				...
				// T (c, 4) (128 / 32)
				for (c804 = c805, c804_p_2 = c805_p_1, c804_p_1 = c805_p_0, c804_p_0 = 0;
					c804 < c805 + 128;
					c804 += 32, c804_p_2 += 32, c804_p_1 += 32, c804_p_0 += 32){
					...
					for (h = h256, hp_0 = 0;
						...
						for (x = x340, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									// T (c, 32) (32 / 1)
									for (c = c804, cp_3 = c804_p_2, cp_2 = c804_p_1, cp_1 = c804_p_0, cp_0 = 0;
										c < c804 + 32;
