...
[V f; U (4, f); ULambda y; U (3, h); T (32, c); Hoist_vars [c]; T (7, x);
  ...
  T (4, f); T (2, c)]
*/
IND_TYPE c, cp_0, c1468_p_0, c1469_p_0, c1470_p_0, cp_1, c1468_p_1, c1469_p_1, cp_2, c1468_p_2, cp_3, c1468, c1469, c1470, f, fp_0, f996_p_0, fp_1, f996, w, wp_0, x, xp_0, y, yp_0;
...
// T (c, 2) (1024 / 512)
for (c1470 = c1471, c1470_p_0 = 0;
	c1470 < c1471 + 1024;
	c1470 += 512, c1470_p_0 += 512){
	...
	for (f996 = f997, f996_p_0 = 0;
		...
		// T (c, 1) (512 / 512)
		for (c1469 = c1470, c1469_p_1 = c1470_p_0, c1469_p_0 = 0;
			c1469 < c1470 + 512;
			c1469 += 512, c1469_p_1 += 512, c1469_p_0 += 512){
				for (y = y470, yp_0 = 0;
					y < y470 + 3;
					y += 3, yp_0 += 3){
					...
					for (f = f996, fp_1 = f996_p_0, fp_0 = 0;
						...
						// T (c, 16) (512 / 32)
						for (c1468 = c1469, c1468_p_2 = c1469_p_1, c1468_p_1 = c1469_p_0, c1468_p_0 = 0;
							c1468 < c1469 + 512;
							c1468 += 32, c1468_p_2 += 32, c1468_p_1 += 32, c1468_p_0 += 32){
							...
							for (w = w496, wp_0 = 0;
								...
								for (x = x616, xp_0 = 0;
									...
									x += 1, xp_0 += 1){
											...
											// T (c, 32) (32 / 1)
											for (c = c1468, cp_3 = c1468_p_2, cp_2 = c1468_p_1, cp_1 = c1468_p_0, cp_0 = 0;
												c < c1468 + 32;
												...
												vec_22 = _mm512_fmadd_ps(vec_20, vec_23, mem_vec_5581);
												mem_vec_5581 = vec_22;

												vec_25 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

												vec_24 = _mm512_fmadd_ps(vec_20, vec_25, mem_vec_5582);
												mem_vec_5582 = vec_24;

												vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

												vec_26 = _mm512_fmadd_ps(vec_20, vec_27, mem_vec_5583);
												mem_vec_5583 = vec_26;
												...
												vec_30 = _mm512_fmadd_ps(vec_29, vec_23, mem_vec_5585);
												mem_vec_5585 = vec_30;



												vec_31 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_5586);
												mem_vec_5586 = vec_31;



												vec_32 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_5587);
												mem_vec_5587 = vec_32;
												scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_34 = _mm512_set1_ps(scal_5);


												vec_33 = _mm512_fmadd_ps(vec_34, vec_21, mem_vec_5588);
												mem_vec_5588 = vec_33;



												vec_35 = _mm512_fmadd_ps(vec_34, vec_23, mem_vec_5589);
												mem_vec_5589 = vec_35;



												vec_36 = _mm512_fmadd_ps(vec_34, vec_25, mem_vec_5590);
												mem_vec_5590 = vec_36;



												vec_37 = _mm512_fmadd_ps(vec_34, vec_27, mem_vec_5591);
												mem_vec_5591 = vec_37;
												...
												vec_41 = _mm512_fmadd_ps(vec_39, vec_42, mem_vec_5581);
												mem_vec_5581 = vec_41;

												vec_44 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

												vec_43 = _mm512_fmadd_ps(vec_39, vec_44, mem_vec_5582);
												mem_vec_5582 = vec_43;

												vec_46 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

												vec_45 = _mm512_fmadd_ps(vec_39, vec_46, mem_vec_5583);
												mem_vec_5583 = vec_45;
												...
												vec_49 = _mm512_fmadd_ps(vec_48, vec_42, mem_vec_5585);
												mem_vec_5585 = vec_49;



												vec_50 = _mm512_fmadd_ps(vec_48, vec_44, mem_vec_5586);
												mem_vec_5586 = vec_50;



												vec_51 = _mm512_fmadd_ps(vec_48, vec_46, mem_vec_5587);
												mem_vec_5587 = vec_51;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_53 = _mm512_set1_ps(scal_8);


												vec_52 = _mm512_fmadd_ps(vec_53, vec_40, mem_vec_5588);
												mem_vec_5588 = vec_52;



												vec_54 = _mm512_fmadd_ps(vec_53, vec_42, mem_vec_5589);
												mem_vec_5589 = vec_54;



												vec_55 = _mm512_fmadd_ps(vec_53, vec_44, mem_vec_5590);
												mem_vec_5590 = vec_55;



												vec_56 = _mm512_fmadd_ps(vec_53, vec_46, mem_vec_5591);
												mem_vec_5591 = vec_56;
											}
							...
							for (w = w496, wp_0 = 0;
								...
								for (x = x616, xp_0 = 0;
									...
									x += 1, xp_0 += 1){
											...
											mem_vec_5594 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
											mem_vec_5595 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
											mem_vec_5596 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
											mem_vec_5597 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
											mem_vec_5598 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
											mem_vec_5599 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
											mem_vec_5600 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
											mem_vec_5601 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
											mem_vec_5602 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32]);
											mem_vec_5603 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48]);
											mem_vec_5604 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
											mem_vec_5605 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
											mem_vec_5606 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32]);
											mem_vec_5607 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 32, f = 64
											// T (c, 32) (32 / 1)
											for (c = c1468, cp_3 = c1468_p_2, cp_2 = c1468_p_1, cp_1 = c1468_p_0, cp_0 = 0;
												c < c1468 + 32;
												...
												vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_5592);
												mem_vec_5592 = vec_24;

												vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

												vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_5593);
												mem_vec_5593 = vec_27;

												vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

												vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_5594);
												mem_vec_5594 = vec_29;

												vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

												vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_5595);
												mem_vec_5595 = vec_31;
												scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_34 = _mm512_set1_ps(scal_5);


												vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_5596);
												mem_vec_5596 = vec_33;



												vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_5597);
												mem_vec_5597 = vec_35;



												vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_5598);
												mem_vec_5598 = vec_36;



												vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_5599);
												mem_vec_5599 = vec_37;
												scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_39 = _mm512_set1_ps(scal_6);


												vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_5600);
												mem_vec_5600 = vec_38;



												vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_5601);
												mem_vec_5601 = vec_40;



												vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_5602);
												mem_vec_5602 = vec_41;



												vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_5603);
												mem_vec_5603 = vec_42;
												scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_44 = _mm512_set1_ps(scal_7);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_5604);
												mem_vec_5604 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_5605);
												mem_vec_5605 = vec_45;



												vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_5606);
												mem_vec_5606 = vec_46;



												vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_5607);
												mem_vec_5607 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
												vec_49 = _mm512_set1_ps(scal_8);
												vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

												vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_5592);
												mem_vec_5592 = vec_48;

												vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

												vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_5593);
												mem_vec_5593 = vec_51;

												vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

												vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_5594);
												mem_vec_5594 = vec_53;

												vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

												vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_5595);
												mem_vec_5595 = vec_55;
												scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
												vec_58 = _mm512_set1_ps(scal_9);


												vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_5596);
												mem_vec_5596 = vec_57;



												vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_5597);
												mem_vec_5597 = vec_59;



												vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_5598);
												mem_vec_5598 = vec_60;



												vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_5599);
												mem_vec_5599 = vec_61;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_63 = _mm512_set1_ps(scal_10);


												vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_5600);
												mem_vec_5600 = vec_62;



												vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_5601);
												mem_vec_5601 = vec_64;



												vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_5602);
												mem_vec_5602 = vec_65;



												vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_5603);
												mem_vec_5603 = vec_66;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_68 = _mm512_set1_ps(scal_11);


												vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_5604);
												mem_vec_5604 = vec_67;



												vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_5605);
												mem_vec_5605 = vec_69;



												vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_5606);
												mem_vec_5606 = vec_70;



												vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_5607);
												mem_vec_5607 = vec_71;
											}
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_5592);
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_5593);
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_5594);
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_5595);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_5596);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_5597);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_5598);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_5599);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_5600);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_5601);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32], mem_vec_5602);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48], mem_vec_5603);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_5604);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_5605);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32], mem_vec_5606);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48], mem_vec_5607);
								}
							}
						}
					}
