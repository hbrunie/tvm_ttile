...
for (x1380 = x1381, x1380_p_0 = 0;
	x1380 < x1381 + 272;
	x1380 += 68, x1380_p_0 += 68){
	// y = 272, x = 68, h = 3, w = 3, c = 32, f = 64
	// T (x, 68) (68 / 1)
	for (x1379 = x1380, x1379_p_1 = x1380_p_0, x1379_p_0 = 0;
		x1379 < x1380 + 68;
		x1379 += 1, x1379_p_1 += 1, x1379_p_0 += 1){
			...
			for (f = f470, fp_0 = 0;
				...
				f += 32, fp_0 += 32){
					for (y = y568, yp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x1378 = x1379, x1378_p_2 = x1379_p_1, x1378_p_1 = x1379_p_0, x1378_p_0 = 0;
							x1378 < x1379 + 1;
							x1378 += 1, x1378_p_2 += 1, x1378_p_1 += 1, x1378_p_0 += 1){
							// y = ph_y, x = 1, h = 3, w = 3, c = 1, f = 32
							// T (h, 3) (3 / 1)
							for (h = h410, hp_0 = 0;
								h < h410 + 3;
								...
								for (w = w404, wp_0 = 0;
									...
									// T (x, 1) (1 / 1)
									for (x = x1378, xp_3 = x1378_p_2, xp_2 = x1378_p_1, xp_1 = x1378_p_0, xp_0 = 0;
										x < x1378 + 1;
								...
								for (w = w404, wp_0 = 0;
									...
									for (x = x1378, xp_3 = x1378_p_2, xp_2 = x1378_p_1, xp_1 = x1378_p_0, xp_0 = 0;
										...
										x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3888 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
												mem_vec_3889 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
												mem_vec_3890 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
												mem_vec_3891 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
												mem_vec_3892 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
												mem_vec_3893 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
												mem_vec_3894 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
												mem_vec_3895 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
												mem_vec_3896 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
												mem_vec_3897 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 1, f = 32
												// T (c, 1) (1 / 1)
												for (c = c822, cp_1 = c822_p_0, cp_0 = 0;
													c < c822 + 1;
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_3888);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_3889);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3890);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_3891);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_3892);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_3893);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3894);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_3895);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_3896);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_3897);
									}
								}
							}
						}
