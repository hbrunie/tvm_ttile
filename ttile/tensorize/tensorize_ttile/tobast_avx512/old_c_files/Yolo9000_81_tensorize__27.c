							...
							for (h = h124, hp_0 = 0;h < h124 + 3;h += 1, hp_0 += 1){
								...
								for (w = w114, wp_0 = 0;w < w114 + 3;w += 1, wp_0 += 1){
									...
									for (x = x228, xp_1 = x228_p_0, xp_0 = 0;x < x228 + 17;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_1368 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
												mem_vec_1369 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_1368);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_1369);
									}
								}
							}
}
