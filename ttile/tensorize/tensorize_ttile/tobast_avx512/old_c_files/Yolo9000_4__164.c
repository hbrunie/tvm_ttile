...
[V f; U (4, f); U (2, y); U (3, w); T (32, c); Hoist_vars [c]; T (34, x);
  T (3, h); T (4, x); T (68, y); T (2, f); T (2, c); T (1, x)]
*/
IND_TYPE c, cp_0, c312_p_0, cp_1, c312, f, fp_0, h, hp_0, x, xp_0, x376_p_0, x377_p_0, xp_1, x376_p_1, xp_2, x376, x377, y, yp_0;
...
__m512 mem_vec_1144 ,mem_vec_1145 ,mem_vec_1146 ,mem_vec_1147 ,mem_vec_1148 ,mem_vec_1149 ,mem_vec_1150 ,mem_vec_1151 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
// y = 136, x = 136, h = 3, w = 3, c = 64, f = 128
// T (x, 1) (136 / 136)
for (x377 = x378, x377_p_0 = 0;
	x377 < x378 + 136;
	x377 += 136, x377_p_0 += 136){
	// y = 136, x = 136, h = 3, w = 3, c = 64, f = 128
	// T (c, 2) (64 / 32)
		...
		for (f = f284, fp_0 = 0;
			...
			for (y = y208, yp_0 = 0;
				...
				for (x376 = x377, x376_p_1 = x377_p_0, x376_p_0 = 0;
					x376 < x377 + 136;
					x376 += 34, x376_p_1 += 34, x376_p_0 += 34){
						...
						for (x = x376, xp_2 = x376_p_1, xp_1 = x376_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c312, cp_1 = c312_p_0, cp_0 = 0;
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_1144);
										mem_vec_1144 = vec_14;

										vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_1145);
										mem_vec_1145 = vec_17;

										vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

										vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_1146);
										mem_vec_1146 = vec_19;

										vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

										vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_1147);
										mem_vec_1147 = vec_21;
										scal_3 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_24 = _mm512_set1_ps(scal_3);


										vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_1148);
										mem_vec_1148 = vec_23;



										vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_1149);
										mem_vec_1149 = vec_25;



										vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_1150);
										mem_vec_1150 = vec_26;



										vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_1151);
										mem_vec_1151 = vec_27;
										scal_4 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_29 = _mm512_set1_ps(scal_4);
										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_1144);
										mem_vec_1144 = vec_28;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_1145);
										mem_vec_1145 = vec_31;

										vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

										vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_1146);
										mem_vec_1146 = vec_33;

										vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

										vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_1147);
										mem_vec_1147 = vec_35;
										scal_5 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_38 = _mm512_set1_ps(scal_5);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_1148);
										mem_vec_1148 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_1149);
										mem_vec_1149 = vec_39;



										vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_1150);
										mem_vec_1150 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_1151);
										mem_vec_1151 = vec_41;
									}
