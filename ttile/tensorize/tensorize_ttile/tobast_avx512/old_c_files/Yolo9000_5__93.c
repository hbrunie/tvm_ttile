...
/*
[V f; U (2, f); U (8, y); T (128, c); Hoist_vars [c]; T (1, x); T (8, x);
  T (17, y); T (2, f); T (17, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x88_p_0, x89_p_0, xp_1, x88_p_1, xp_2, x88, x89, y, yp_0;
