...
*/
IND_TYPE c, cp_0, c66_p_0, c67_p_0, cp_1, c66_p_1, cp_2, c66, c67, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y26 = 0;
IND_TYPE x40 = 0;
IND_TYPE h40 = 0;
IND_TYPE w40 = 0;
				...
				for (h = h40, hp_0 = 0;h < h40 + 3;h += 1, hp_0 += 1){
					...
					for (w = w40, wp_0 = 0;w < w40 + 3;w += 1, wp_0 += 1){
						...
						for (x = x40, xp_0 = 0;x < x40 + 7;x += 1, xp_0 += 1){
									...
									// T (c, 16) (16 / 1)
									for (c = c66, cp_2 = c66_p_1, cp_1 = c66_p_0, cp_0 = 0;c < c66 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
