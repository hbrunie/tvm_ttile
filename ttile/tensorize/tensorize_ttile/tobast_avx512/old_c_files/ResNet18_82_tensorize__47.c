						...
						for (h = h210, hp_0 = 0;h < h210 + 3;h += 1, hp_0 += 1){
							...
							for (w = w228, wp_0 = 0;w < w228 + 3;w += 1, wp_0 += 1){
								...
								for (x = x426, xp_1 = x426_p_0, xp_0 = 0;x < x426 + 14;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2672 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_2673 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
											mem_vec_2674 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_2675 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_2672);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_2673);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_2674);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_2675);
								}
							}
						}
}
