...
*/
IND_TYPE c, cp_0, c708_p_0, c709_p_0, cp_1, c708_p_1, cp_2, c708, c709, f, fp_0, f568_p_0, f569_p_0, fp_1, f568_p_1, fp_2, f568, f569, h, hp_0, x, xp_0, x548_p_0, xp_1, x548, y, yp_0;
IND_TYPE y368 = 0;
IND_TYPE x549 = 0;
IND_TYPE h308 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
								for (h = h308, hp_0 = 0;h < h308 + 3;h += 1, hp_0 += 1){
									...
									// T (x, 14) (14 / 1)
									for (x = x548, xp_1 = x548_p_0, xp_0 = 0;x < x548 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 2) (2 / 1)
												for (c = c708, cp_2 = c708_p_1, cp_1 = c708_p_0, cp_0 = 0;c < c708 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
