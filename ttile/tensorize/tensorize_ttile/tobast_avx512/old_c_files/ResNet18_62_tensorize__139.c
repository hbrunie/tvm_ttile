...
fp_1 = 0;
						for (w = w190, wp_0 = 0;w < w190 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 7) (7 / 1)
							for (x = x360, xp_1 = x360_p_0, xp_0 = 0;x < x360 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_2522 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_2523 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_2524 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_2525 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2523);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2524);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2525);
