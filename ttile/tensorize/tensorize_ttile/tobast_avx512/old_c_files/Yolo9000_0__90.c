...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (4, x); T (34, y); T (4, x); T (4, y); T (2, f); T (34, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x130_p_0, x131_p_0, xp_1, x130_p_1, xp_2, x130, x131, y, yp_0, y108_p_0, yp_1, y108;
...
for (x131 = x132, x131_p_0 = 0;
	...
	for (f = f50, fp_0 = 0;
		...
		for (y108 = y109, y108_p_0 = 0;
			y108 < y109 + 544;
			y108 += 136, y108_p_0 += 136){
			// y = 136, x = 16, h = 3, w = 3, c = 3, f = 16
			// T (x, 4) (16 / 4)
			for (x130 = x131, x130_p_1 = x131_p_0, x130_p_0 = 0;
				x130 < x131 + 16;
				x130 += 4, x130_p_1 += 4, x130_p_0 += 4){
				...
				for (y = y108, yp_1 = y108_p_0, yp_0 = 0;
					...
					// T (x, 4) (4 / 1)
					for (x = x130, xp_2 = x130_p_1, xp_1 = x130_p_0, xp_0 = 0;
						x < x130 + 4;
						x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								mem_vec_320 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
								mem_vec_321 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
								mem_vec_322 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
								mem_vec_323 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
								...
								for (c = c68, cp_0 = 0;
									...
									vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_321);
									mem_vec_321 = vec_3;
