...
[V f; U (2, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (8, x); T (8, y); T (2, f); T (2, c); T (1, x)]
*/
IND_TYPE c, cp_0, c232_p_0, cp_1, c232, f, fp_0, h, hp_0, x, xp_0, x258_p_0, x259_p_0, xp_1, x258_p_1, xp_2, x258, x259, y, yp_0;
IND_TYPE y140 = 0;
IND_TYPE x260 = 0;
IND_TYPE h100 = 0;
IND_TYPE w = 0;
...
x258_p_1 = 0;
					for (h = h100, hp_0 = 0;h < h100 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 7) (7 / 1)
						for (x = x258, xp_2 = x258_p_1, xp_1 = x258_p_0, xp_0 = 0;x < x258 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 32) (32 / 1)
									for (c = c232, cp_1 = c232_p_0, cp_0 = 0;c < c232 + 32;c += 1, cp_1 += 1, cp_0 += 1){
