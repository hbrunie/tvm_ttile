...
[V f; U (2, f); ULambda y; U (3, h); T (3, c); Hoist_vars [c]; T (136, x);
  T (3, w); Lambda_apply y [((Iter 4), (Arg 6)); ((Iter 1), (Arg 8))];
  T (4, x); T (17, y); T (1, x)]
*/
IND_TYPE c, cp_0, w, wp_0, x, xp_0, x550_p_0, x551_p_0, xp_1, x550_p_1, xp_2, x550, x551, y, yp_0, y514_p_0, yp_1, y514;
...
for (x551 = x552, x551_p_0 = 0;
	...
	for (y514 = y515, y514_p_0 = 0;
		...
		for (x550 = x551, x550_p_1 = x551_p_0, x550_p_0 = 0;
			x550 < x551 + 544;
			x550 += 136, x550_p_1 += 136, x550_p_0 += 136){
						...
						for (x = x550, xp_2 = x550_p_1, xp_1 = x550_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c304, cp_0 = 0;
										...
										vec_20 = _mm512_fmadd_ps(vec_21, vec_22, mem_vec_3916);
										mem_vec_3916 = vec_20;

										vec_24 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_23 = _mm512_fmadd_ps(vec_21, vec_24, mem_vec_3917);
										mem_vec_3917 = vec_23;
										scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_26 = _mm512_set1_ps(scal_7);


										vec_25 = _mm512_fmadd_ps(vec_26, vec_22, mem_vec_3918);
										mem_vec_3918 = vec_25;



										vec_27 = _mm512_fmadd_ps(vec_26, vec_24, mem_vec_3919);
										mem_vec_3919 = vec_27;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_8);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_22, mem_vec_3920);
										mem_vec_3920 = vec_28;



										vec_30 = _mm512_fmadd_ps(vec_29, vec_24, mem_vec_3921);
										mem_vec_3921 = vec_30;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_22, mem_vec_3922);
										mem_vec_3922 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_24, mem_vec_3923);
										mem_vec_3923 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_22, mem_vec_3924);
										mem_vec_3924 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_24, mem_vec_3925);
										mem_vec_3925 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_22, mem_vec_3926);
										mem_vec_3926 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_24, mem_vec_3927);
										mem_vec_3927 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_40 = _mm512_fmadd_ps(vec_41, vec_42, mem_vec_3916);
										mem_vec_3916 = vec_40;

										vec_44 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_43 = _mm512_fmadd_ps(vec_41, vec_44, mem_vec_3917);
										mem_vec_3917 = vec_43;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_46 = _mm512_set1_ps(scal_13);


										vec_45 = _mm512_fmadd_ps(vec_46, vec_42, mem_vec_3918);
										mem_vec_3918 = vec_45;



										vec_47 = _mm512_fmadd_ps(vec_46, vec_44, mem_vec_3919);
										mem_vec_3919 = vec_47;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_49 = _mm512_set1_ps(scal_14);


										vec_48 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_3920);
										mem_vec_3920 = vec_48;



										vec_50 = _mm512_fmadd_ps(vec_49, vec_44, mem_vec_3921);
										mem_vec_3921 = vec_50;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_52 = _mm512_set1_ps(scal_15);


										vec_51 = _mm512_fmadd_ps(vec_52, vec_42, mem_vec_3922);
										mem_vec_3922 = vec_51;



										vec_53 = _mm512_fmadd_ps(vec_52, vec_44, mem_vec_3923);
										mem_vec_3923 = vec_53;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_55 = _mm512_set1_ps(scal_16);


										vec_54 = _mm512_fmadd_ps(vec_55, vec_42, mem_vec_3924);
										mem_vec_3924 = vec_54;



										vec_56 = _mm512_fmadd_ps(vec_55, vec_44, mem_vec_3925);
										mem_vec_3925 = vec_56;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_42, mem_vec_3926);
										mem_vec_3926 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_44, mem_vec_3927);
										mem_vec_3927 = vec_59;
									}
				...
				for (y = y514 + 24, yp_1 = y514_p_0, yp_0 = 0;
					y < y514 + 24 + 8;
					y += 8, yp_1 += 8, yp_0 += 8){
					// y = ph_y, x = 136, h = 3, w = 3, c = 3, f = 32
					// T (w, 3) (3 / 1)
						...
						for (x = x550, xp_2 = x550_p_1, xp_1 = x550_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c304, cp_0 = 0;
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_3928);
										mem_vec_3928 = vec_26;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_3929);
										mem_vec_3929 = vec_29;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_3930);
										mem_vec_3930 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_3931);
										mem_vec_3931 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_3932);
										mem_vec_3932 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_3933);
										mem_vec_3933 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_3934);
										mem_vec_3934 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_3935);
										mem_vec_3935 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_3936);
										mem_vec_3936 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_3937);
										mem_vec_3937 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_3938);
										mem_vec_3938 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_3939);
										mem_vec_3939 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_14);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_3940);
										mem_vec_3940 = vec_46;



										vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_3941);
										mem_vec_3941 = vec_48;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_3942);
										mem_vec_3942 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_3943);
										mem_vec_3943 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_53 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_3928);
										mem_vec_3928 = vec_52;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_3929);
										mem_vec_3929 = vec_55;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_3930);
										mem_vec_3930 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_3931);
										mem_vec_3931 = vec_59;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_61 = _mm512_set1_ps(scal_18);


										vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_3932);
										mem_vec_3932 = vec_60;



										vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_3933);
										mem_vec_3933 = vec_62;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_3934);
										mem_vec_3934 = vec_63;



										vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_3935);
										mem_vec_3935 = vec_65;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);


										vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_3936);
										mem_vec_3936 = vec_66;



										vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_3937);
										mem_vec_3937 = vec_68;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_70 = _mm512_set1_ps(scal_21);


										vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_3938);
										mem_vec_3938 = vec_69;



										vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_3939);
										mem_vec_3939 = vec_71;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_73 = _mm512_set1_ps(scal_22);


										vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_3940);
										mem_vec_3940 = vec_72;



										vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_3941);
										mem_vec_3941 = vec_74;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_76 = _mm512_set1_ps(scal_23);


										vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_3942);
										mem_vec_3942 = vec_75;



										vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_3943);
										mem_vec_3943 = vec_77;
									}
