							...
							for (h = h140, hp_0 = 0;h < h140 + 3;h += 1, hp_0 += 1){
								...
								for (w = w130, wp_0 = 0;w < w130 + 3;w += 1, wp_0 += 1){
									...
									for (x = x252, xp_1 = x252_p_0, xp_0 = 0;x < x252 + 2;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_1772 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
												mem_vec_1773 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
												mem_vec_1774 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
												mem_vec_1775 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
												...
												for (c = c234, cp_1 = c234_p_0, cp_0 = 0;c < c234 + 4;c += 1, cp_1 += 1, cp_0 += 1){
													...
													vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_1772);
													mem_vec_1772 = vec_35;
													vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_1773);
													mem_vec_1773 = vec_37;
													scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 12 + h) + c];
													vec_39 = _mm512_set1_ps(scal_12);
													vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_1774);
													mem_vec_1774 = vec_38;
													vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_1775);
													mem_vec_1775 = vec_40;
												}
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_1772);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_1773);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_1774);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_1775);
									}
								}
							}
}
