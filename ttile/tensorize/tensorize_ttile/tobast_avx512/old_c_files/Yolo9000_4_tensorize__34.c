...
[V f; U (4, f); U (4, y); U (3, h); T (64, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (34, x); T (34, y); T (2, f); T (1, c); T (1, x)]
*/
IND_TYPE c, cp_0, c132_p_0, cp_1, c132, f, fp_0, w, wp_0, x, xp_0, x174_p_0, x175_p_0, xp_1, x174_p_1, xp_2, x174, x175, y, yp_0;
IND_TYPE y88 = 0;
IND_TYPE x176 = 0;
IND_TYPE h = 0;
IND_TYPE w88 = 0;
...
x174_p_1 = 0;
					for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 4) (4 / 1)
						for (x = x174, xp_2 = x174_p_1, xp_1 = x174_p_0, xp_0 = 0;x < x174 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_650 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
									mem_vec_651 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
									...
									mem_vec_654 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
									mem_vec_655 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_650);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_651);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_654);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_655);
						}
					}
}
