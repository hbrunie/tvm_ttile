								...
								for (w = w114, wp_0 = 0;
									...
									for (x = x228, xp_1 = x228_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_1368 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
												mem_vec_1369 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
												...
												for (c = c210, cp_1 = c210_p_0, cp_0 = 0;
													...
													vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_1368);
													mem_vec_1368 = vec_26;



													vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_1369);
													mem_vec_1369 = vec_28;
												}
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_1368);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_1369);
									}
								}
							}
						}
						for (y = y140 + 54, yp_0 = 0;
							y < y140 + 54 + 14;
							y += 14, yp_0 += 14){
							// y = ph_y, x = 17, h = 3, w = 3, c = 4, f = 32
							// T (h, 3) (3 / 1)
