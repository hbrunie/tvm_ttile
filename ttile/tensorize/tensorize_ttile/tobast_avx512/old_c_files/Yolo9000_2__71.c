...
for (x810 = x811, x810_p_0 = 0;
	...
	// T (x, 17) (68 / 4)
	for (x809 = x810, x809_p_1 = x810_p_0, x809_p_0 = 0;
		x809 < x810 + 68;
		x809 += 4, x809_p_1 += 4, x809_p_0 += 4){
		...
		for (c480 = c481, c480_p_0 = 0;
			...
			for (f = f270, fp_0 = 0;
				...
				for (y = y340, yp_0 = 0;
					...
					// T (x, 1) (4 / 4)
					for (x808 = x809, x808_p_2 = x809_p_1, x808_p_1 = x809_p_0, x808_p_0 = 0;
						x808 < x809 + 4;
						x808 += 4, x808_p_2 += 4, x808_p_1 += 4, x808_p_0 += 4){
						// y = 8, x = 4, h = 3, w = 3, c = 16, f = 32
						// T (h, 3) (3 / 1)
						for (h = h244, hp_0 = 0;
							h < h244 + 3;
							...
							// T (x, 4) (4 / 1)
							for (x = x808, xp_3 = x808_p_2, xp_2 = x808_p_1, xp_1 = x808_p_0, xp_0 = 0;
								x < x808 + 4;
