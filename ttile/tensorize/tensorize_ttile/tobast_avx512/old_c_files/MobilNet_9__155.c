...
for (c1310 = c1311, c1310_p_0 = 0;
	c1310 < c1311 + 1024;
	c1310 += 512, c1310_p_0 += 512){
	// y = 7, x = 7, h = 3, w = 3, c = 512, f = 1024
	// T (f, 1) (1024 / 1024)
	for (f900 = f901, f900_p_0 = 0;
		f900 < f901 + 1024;
		f900 += 1024, f900_p_0 += 1024){
		// y = 7, x = 7, h = 3, w = 3, c = 512, f = 1024
		// T (c, 8) (512 / 64)
		for (c1309 = c1310, c1309_p_1 = c1310_p_0, c1309_p_0 = 0;
			c1309 < c1310 + 512;
			c1309 += 64, c1309_p_1 += 64, c1309_p_0 += 64){
				for (y = y406, yp_0 = 0;
					y < y406 + 4;
					y += 2, yp_0 += 2){
					...
					for (f = f900, fp_1 = f900_p_0, fp_0 = 0;
						...
						// T (c, 1) (64 / 64)
						for (c1308 = c1309, c1308_p_2 = c1309_p_1, c1308_p_1 = c1309_p_0, c1308_p_0 = 0;
							c1308 < c1309 + 64;
							c1308 += 64, c1308_p_2 += 64, c1308_p_1 += 64, c1308_p_0 += 64){
							// y = ph_y, x = 7, h = 3, w = 3, c = 64, f = 64
							// T (w, 3) (3 / 1)
							for (w = w432, wp_0 = 0;
								w < w432 + 3;
								...
								for (x = x552, xp_0 = 0;
									...
									x += 1, xp_0 += 1){
											...
											// T (c, 64) (64 / 1)
											for (c = c1308, cp_3 = c1308_p_2, cp_2 = c1308_p_1, cp_1 = c1308_p_0, cp_0 = 0;
												c < c1308 + 64;
