					...
					for (h = h152, hp_0 = 0;
						...
						for (x = x308, xp_1 = x308_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1972 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
									mem_vec_1973 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									mem_vec_1974 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
									mem_vec_1975 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
									mem_vec_1976 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
									mem_vec_1977 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
									...
									mem_vec_1982 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
									mem_vec_1983 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
									mem_vec_1984 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
									mem_vec_1985 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_1972);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_1973);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_1974);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_1975);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_1976);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_1977);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_1982);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_1983);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_1984);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_1985);
						}
					}
				}
			}
