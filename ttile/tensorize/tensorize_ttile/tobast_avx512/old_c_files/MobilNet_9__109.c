...
for (c390 = c391, c390_p_0 = 0;
	...
	for (f268 = f269, f268_p_0 = 0;
		f268 < f269 + 1024;
		f268 += 512, f268_p_0 += 512){
		// y = 7, x = 7, h = 3, w = 3, c = 512, f = 512
		// T (c, 512) (512 / 1)
		for (c389 = c390, c389_p_1 = c390_p_0, c389_p_0 = 0;
			c389 < c390 + 512;
			c389 += 1, c389_p_1 += 1, c389_p_0 += 1){
			...
			for (f = f268, fp_1 = f268_p_0, fp_0 = 0;
				...
				// T (c, 1) (1 / 1)
				for (c388 = c389, c388_p_2 = c389_p_1, c388_p_1 = c389_p_0, c388_p_0 = 0;
					c388 < c389 + 1;
					c388 += 1, c388_p_2 += 1, c388_p_1 += 1, c388_p_0 += 1){
					// y = 7, x = 7, h = 3, w = 3, c = 1, f = 32
					// T (w, 3) (3 / 1)
					for (w = w164, wp_0 = 0;
						w < w164 + 3;
						...
						for (x = x164, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									// T (c, 1) (1 / 1)
									for (c = c388, cp_3 = c388_p_2, cp_2 = c388_p_1, cp_1 = c388_p_0, cp_0 = 0;
										c < c388 + 1;
