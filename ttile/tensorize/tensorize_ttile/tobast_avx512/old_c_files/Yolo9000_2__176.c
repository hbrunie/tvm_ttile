...
/*
[V f; U (4, f); U (2, y); U (3, h); T (32, c); Hoist_vars [c]; T (136, x);
  T (3, w); T (1, x); T (136, y); T (1, c); T (2, x); T (1, x)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, w, wp_0, x, xp_0, x340_p_0, x341_p_0, x342_p_0, xp_1, x340_p_1, x341_p_1, xp_2, x340_p_2, xp_3, x340, x341, x342, y, yp_0;
...
__m512 mem_vec_880 ,mem_vec_881 ,mem_vec_882 ,mem_vec_883 ,mem_vec_884 ,mem_vec_885 ,mem_vec_886 ,mem_vec_887 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
// T (x, 1) (272 / 272)
for (x342 = x343, x342_p_0 = 0;
	x342 < x343 + 272;
	x342 += 272, x342_p_0 += 272){
	// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (x, 2) (272 / 136)
	for (x341 = x342, x341_p_1 = x342_p_0, x341_p_0 = 0;
		x341 < x342 + 272;
		x341 += 136, x341_p_1 += 136, x341_p_0 += 136){
		...
		for (c204 = c205, c204_p_0 = 0;
			...
			for (y = y136, yp_0 = 0;
				y < y136 + 272;
				y += 2, yp_0 += 2){
				// y = 2, x = 136, h = 3, w = 3, c = 32, f = 64
				// T (x, 1) (136 / 136)
				for (x340 = x341, x340_p_2 = x341_p_1, x340_p_1 = x341_p_0, x340_p_0 = 0;
					x340 < x341 + 136;
					x340 += 136, x340_p_2 += 136, x340_p_1 += 136, x340_p_0 += 136){
					// y = 2, x = 136, h = 3, w = 3, c = 32, f = 64
					// T (w, 3) (3 / 1)
					for (w = w136, wp_0 = 0;
						w < w136 + 3;
						w += 1, wp_0 += 1){
						// y = 2, x = 136, h = 3, w = 1, c = 32, f = 64
						// T (x, 136) (136 / 1)
						for (x = x340, xp_3 = x340_p_2, xp_2 = x340_p_1, xp_1 = x340_p_0, xp_0 = 0;
							...
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c204, cp_1 = c204_p_0, cp_0 = 0;
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_880);
										mem_vec_880 = vec_14;

										vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_881);
										mem_vec_881 = vec_17;

										vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_882);
										mem_vec_882 = vec_19;

										vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_883);
										mem_vec_883 = vec_21;
										scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_24 = _mm512_set1_ps(scal_3);


										vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_884);
										mem_vec_884 = vec_23;



										vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_885);
										mem_vec_885 = vec_25;



										vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_886);
										mem_vec_886 = vec_26;



										vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_887);
										mem_vec_887 = vec_27;
										scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_29 = _mm512_set1_ps(scal_4);
										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_880);
										mem_vec_880 = vec_28;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_881);
										mem_vec_881 = vec_31;

										vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_882);
										mem_vec_882 = vec_33;

										vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_883);
										mem_vec_883 = vec_35;
										scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_38 = _mm512_set1_ps(scal_5);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_884);
										mem_vec_884 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_885);
										mem_vec_885 = vec_39;



										vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_886);
										mem_vec_886 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_887);
										mem_vec_887 = vec_41;
									}
