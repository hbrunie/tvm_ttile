							...
							for (h = h386, hp_0 = 0;h < h386 + 3;h += 1, hp_0 += 1){
								...
								for (w = w380, wp_0 = 0;w < w380 + 3;w += 1, wp_0 += 1){
									...
									for (x = x1318, xp_3 = x1318_p_2, xp_2 = x1318_p_1, xp_1 = x1318_p_0, xp_0 = 0;x < x1318 + 1;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3170 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
												mem_vec_3171 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
												// T (c, 32) (32 / 1)
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_3170);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_3171);
									}
								}
							}
}
