	...
	for (y240 = y241, y240_p_0 = 0;
		...
		for (x306 = x307, x306_p_1 = x307_p_0, x306_p_0 = 0;
			...
			x306 += 4, x306_p_1 += 4, x306_p_0 += 4){
				...
				for (y = y240 + 18, yp_1 = y240_p_0, yp_0 = 0;
					y < y240 + 18 + 14;
						...
						for (w = w122, wp_0 = 0;
							...
							for (x = x306, xp_2 = x306_p_1, xp_1 = x306_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1750 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
										mem_vec_1751 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
										mem_vec_1752 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_1753 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 3, f = 32
										// T (c, 3) (3 / 1)
										for (c = c156, cp_0 = 0;
											c < c156 + 3;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1750);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_1751);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1752);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_1753);
							}
						}
					}
				}
