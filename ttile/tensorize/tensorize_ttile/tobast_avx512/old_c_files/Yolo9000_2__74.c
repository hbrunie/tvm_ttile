...
/*
[V f; U (2, f); U (8, y); U (3, w); T (2, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, x); T (34, y); T (2, f); T (16, c); T (16, x); T (17, x)]
*/
IND_TYPE c, cp_0, c498_p_0, cp_1, c498, f, fp_0, h, hp_0, x, xp_0, x838_p_0, x839_p_0, x840_p_0, xp_1, x838_p_1, x839_p_1, xp_2, x838_p_2, xp_3, x838, x839, x840, y, yp_0;
...
for (x840 = x841, x840_p_0 = 0;
	...
	// T (x, 16) (16 / 1)
	for (x839 = x840, x839_p_1 = x840_p_0, x839_p_0 = 0;
		x839 < x840 + 16;
		x839 += 1, x839_p_1 += 1, x839_p_0 += 1){
		...
		for (c498 = c499, c498_p_0 = 0;
			...
			for (f = f282, fp_0 = 0;
				...
				for (y = y352, yp_0 = 0;
					...
					// T (x, 1) (1 / 1)
					for (x838 = x839, x838_p_2 = x839_p_1, x838_p_1 = x839_p_0, x838_p_0 = 0;
						x838 < x839 + 1;
						x838 += 1, x838_p_2 += 1, x838_p_1 += 1, x838_p_0 += 1){
						// y = 8, x = 1, h = 3, w = 3, c = 2, f = 32
						// T (h, 3) (3 / 1)
						for (h = h256, hp_0 = 0;
							h < h256 + 3;
							...
							// T (x, 1) (1 / 1)
							for (x = x838, xp_3 = x838_p_2, xp_2 = x838_p_1, xp_1 = x838_p_0, xp_0 = 0;
								x < x838 + 1;
								x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c498, cp_1 = c498_p_0, cp_0 = 0;
											...
											vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_2016);
											mem_vec_2016 = vec_26;

											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_2017);
											mem_vec_2017 = vec_29;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_2018);
											mem_vec_2018 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_2019);
											mem_vec_2019 = vec_33;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_2020);
											mem_vec_2020 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_2021);
											mem_vec_2021 = vec_36;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_2022);
											mem_vec_2022 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_2023);
											mem_vec_2023 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_2024);
											mem_vec_2024 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_2025);
											mem_vec_2025 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_2026);
											mem_vec_2026 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_2027);
											mem_vec_2027 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_2028);
											mem_vec_2028 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_2029);
											mem_vec_2029 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_2030);
											mem_vec_2030 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_2031);
											mem_vec_2031 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_53 = _mm512_set1_ps(scal_16);
											vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_2016);
											mem_vec_2016 = vec_52;

											vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_2017);
											mem_vec_2017 = vec_55;
											scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_2018);
											mem_vec_2018 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_2019);
											mem_vec_2019 = vec_59;
											scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_61 = _mm512_set1_ps(scal_18);


											vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_2020);
											mem_vec_2020 = vec_60;



											vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_2021);
											mem_vec_2021 = vec_62;
											scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_2022);
											mem_vec_2022 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_2023);
											mem_vec_2023 = vec_65;
											scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_2024);
											mem_vec_2024 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_2025);
											mem_vec_2025 = vec_68;
											scal_21 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_70 = _mm512_set1_ps(scal_21);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_2026);
											mem_vec_2026 = vec_69;



											vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_2027);
											mem_vec_2027 = vec_71;
											scal_22 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_73 = _mm512_set1_ps(scal_22);


											vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_2028);
											mem_vec_2028 = vec_72;



											vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_2029);
											mem_vec_2029 = vec_74;
											scal_23 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_76 = _mm512_set1_ps(scal_23);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_2030);
											mem_vec_2030 = vec_75;



											vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_2031);
											mem_vec_2031 = vec_77;
										}
