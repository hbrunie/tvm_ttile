				...
				for (f = f8, fp_0 = 0;
					...
					for (c16 = c17, c16_p_1 = c17_p_0, c16_p_0 = 0;
						...
						for (x = x12, xp_1 = x12_p_0, xp_0 = 0;
							x < x12 + 17;
							x += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_150 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_151 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
									mem_vec_152 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_153 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_154 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_155 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
									mem_vec_156 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_157 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									mem_vec_158 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
									mem_vec_159 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
									mem_vec_160 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									mem_vec_161 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
									mem_vec_162 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_163 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
									mem_vec_164 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_165 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
									mem_vec_166 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_167 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
									mem_vec_168 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_169 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
									// T (c, 128) (128 / 1)
									for (c = c16, cp_2 = c16_p_1, cp_1 = c16_p_0, cp_0 = 0;
										c < c16 + 128;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_150);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_151);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_152);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_153);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_154);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_155);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_156);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_157);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_158);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_159);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_160);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_161);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_162);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_163);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_164);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_165);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_166);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_167);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_168);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_169);
						}
					}
				}
			}
