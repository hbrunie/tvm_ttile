...
[V f; U (2, f); ULambda y; U (3, h); T (2, c); Hoist_vars [c]; T (28, x);
  T (3, w); T (4, x);
  Lambda_apply y [((Iter 3), (Arg 8)); ((Iter 8), (Arg 11))]; T (16, c);
  T (1, x)]
*/
IND_TYPE c, cp_0, c564_p_0, cp_1, c564, w, wp_0, x, xp_0, x752_p_0, x753_p_0, xp_1, x752_p_1, xp_2, x752, x753, y, yp_0;
		...
		c564 += 2, c564_p_0 += 2){
			for (y = y376, yp_0 = 0;
				...
				for (x752 = x753, x752_p_1 = x753_p_0, x752_p_0 = 0;
					x752 < x753 + 112;
					x752 += 28, x752_p_1 += 28, x752_p_0 += 28){
						...
						for (x = x752, xp_2 = x752_p_1, xp_1 = x752_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c564, cp_1 = c564_p_0, cp_0 = 0;
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_4728);
										mem_vec_4728 = vec_26;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_4729);
										mem_vec_4729 = vec_29;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_4730);
										mem_vec_4730 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_4731);
										mem_vec_4731 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_4732);
										mem_vec_4732 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_4733);
										mem_vec_4733 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_4734);
										mem_vec_4734 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_4735);
										mem_vec_4735 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_4736);
										mem_vec_4736 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_4737);
										mem_vec_4737 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_4738);
										mem_vec_4738 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_4739);
										mem_vec_4739 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_14);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_4740);
										mem_vec_4740 = vec_46;



										vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_4741);
										mem_vec_4741 = vec_48;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_4742);
										mem_vec_4742 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_4743);
										mem_vec_4743 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_53 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_4728);
										mem_vec_4728 = vec_52;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_4729);
										mem_vec_4729 = vec_55;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_4730);
										mem_vec_4730 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_4731);
										mem_vec_4731 = vec_59;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_61 = _mm512_set1_ps(scal_18);


										vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_4732);
										mem_vec_4732 = vec_60;



										vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_4733);
										mem_vec_4733 = vec_62;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_4734);
										mem_vec_4734 = vec_63;



										vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_4735);
										mem_vec_4735 = vec_65;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);


										vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_4736);
										mem_vec_4736 = vec_66;



										vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_4737);
										mem_vec_4737 = vec_68;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_70 = _mm512_set1_ps(scal_21);


										vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_4738);
										mem_vec_4738 = vec_69;



										vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_4739);
										mem_vec_4739 = vec_71;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_73 = _mm512_set1_ps(scal_22);


										vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_4740);
										mem_vec_4740 = vec_72;



										vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_4741);
										mem_vec_4741 = vec_74;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_76 = _mm512_set1_ps(scal_23);


										vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_4742);
										mem_vec_4742 = vec_75;



										vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_4743);
										mem_vec_4743 = vec_77;
									}
						...
						for (x = x752, xp_2 = x752_p_1, xp_1 = x752_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c564, cp_1 = c564_p_0, cp_0 = 0;
										...
										vec_35 = _mm512_fmadd_ps(vec_36, vec_37, mem_vec_4744);
										mem_vec_4744 = vec_35;

										vec_39 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_38 = _mm512_fmadd_ps(vec_36, vec_39, mem_vec_4745);
										mem_vec_4745 = vec_38;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_37, mem_vec_4746);
										mem_vec_4746 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_39, mem_vec_4747);
										mem_vec_4747 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_37, mem_vec_4748);
										mem_vec_4748 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_39, mem_vec_4749);
										mem_vec_4749 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_14);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_37, mem_vec_4750);
										mem_vec_4750 = vec_46;



										vec_48 = _mm512_fmadd_ps(vec_47, vec_39, mem_vec_4751);
										mem_vec_4751 = vec_48;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_37, mem_vec_4752);
										mem_vec_4752 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_39, mem_vec_4753);
										mem_vec_4753 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_53 = _mm512_set1_ps(scal_16);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_37, mem_vec_4754);
										mem_vec_4754 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_39, mem_vec_4755);
										mem_vec_4755 = vec_54;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_56 = _mm512_set1_ps(scal_17);


										vec_55 = _mm512_fmadd_ps(vec_56, vec_37, mem_vec_4756);
										mem_vec_4756 = vec_55;



										vec_57 = _mm512_fmadd_ps(vec_56, vec_39, mem_vec_4757);
										mem_vec_4757 = vec_57;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_59 = _mm512_set1_ps(scal_18);


										vec_58 = _mm512_fmadd_ps(vec_59, vec_37, mem_vec_4758);
										mem_vec_4758 = vec_58;



										vec_60 = _mm512_fmadd_ps(vec_59, vec_39, mem_vec_4759);
										mem_vec_4759 = vec_60;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
										vec_62 = _mm512_set1_ps(scal_19);


										vec_61 = _mm512_fmadd_ps(vec_62, vec_37, mem_vec_4760);
										mem_vec_4760 = vec_61;



										vec_63 = _mm512_fmadd_ps(vec_62, vec_39, mem_vec_4761);
										mem_vec_4761 = vec_63;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
										vec_65 = _mm512_set1_ps(scal_20);


										vec_64 = _mm512_fmadd_ps(vec_65, vec_37, mem_vec_4762);
										mem_vec_4762 = vec_64;



										vec_66 = _mm512_fmadd_ps(vec_65, vec_39, mem_vec_4763);
										mem_vec_4763 = vec_66;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
										vec_68 = _mm512_set1_ps(scal_21);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_37, mem_vec_4764);
										mem_vec_4764 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_39, mem_vec_4765);
										mem_vec_4765 = vec_69;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_71 = _mm512_set1_ps(scal_22);
										vec_72 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_70 = _mm512_fmadd_ps(vec_71, vec_72, mem_vec_4744);
										mem_vec_4744 = vec_70;

										vec_74 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_73 = _mm512_fmadd_ps(vec_71, vec_74, mem_vec_4745);
										mem_vec_4745 = vec_73;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_76 = _mm512_set1_ps(scal_23);


										vec_75 = _mm512_fmadd_ps(vec_76, vec_72, mem_vec_4746);
										mem_vec_4746 = vec_75;



										vec_77 = _mm512_fmadd_ps(vec_76, vec_74, mem_vec_4747);
										mem_vec_4747 = vec_77;
										scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_79 = _mm512_set1_ps(scal_24);


										vec_78 = _mm512_fmadd_ps(vec_79, vec_72, mem_vec_4748);
										mem_vec_4748 = vec_78;



										vec_80 = _mm512_fmadd_ps(vec_79, vec_74, mem_vec_4749);
										mem_vec_4749 = vec_80;
										scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_82 = _mm512_set1_ps(scal_25);


										vec_81 = _mm512_fmadd_ps(vec_82, vec_72, mem_vec_4750);
										mem_vec_4750 = vec_81;



										vec_83 = _mm512_fmadd_ps(vec_82, vec_74, mem_vec_4751);
										mem_vec_4751 = vec_83;
										scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_85 = _mm512_set1_ps(scal_26);


										vec_84 = _mm512_fmadd_ps(vec_85, vec_72, mem_vec_4752);
										mem_vec_4752 = vec_84;



										vec_86 = _mm512_fmadd_ps(vec_85, vec_74, mem_vec_4753);
										mem_vec_4753 = vec_86;
										scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_88 = _mm512_set1_ps(scal_27);


										vec_87 = _mm512_fmadd_ps(vec_88, vec_72, mem_vec_4754);
										mem_vec_4754 = vec_87;



										vec_89 = _mm512_fmadd_ps(vec_88, vec_74, mem_vec_4755);
										mem_vec_4755 = vec_89;
										scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_91 = _mm512_set1_ps(scal_28);


										vec_90 = _mm512_fmadd_ps(vec_91, vec_72, mem_vec_4756);
										mem_vec_4756 = vec_90;



										vec_92 = _mm512_fmadd_ps(vec_91, vec_74, mem_vec_4757);
										mem_vec_4757 = vec_92;
										scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_94 = _mm512_set1_ps(scal_29);


										vec_93 = _mm512_fmadd_ps(vec_94, vec_72, mem_vec_4758);
										mem_vec_4758 = vec_93;



										vec_95 = _mm512_fmadd_ps(vec_94, vec_74, mem_vec_4759);
										mem_vec_4759 = vec_95;
										scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
										vec_97 = _mm512_set1_ps(scal_30);


										vec_96 = _mm512_fmadd_ps(vec_97, vec_72, mem_vec_4760);
										mem_vec_4760 = vec_96;



										vec_98 = _mm512_fmadd_ps(vec_97, vec_74, mem_vec_4761);
										mem_vec_4761 = vec_98;
										scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
										vec_100 = _mm512_set1_ps(scal_31);


										vec_99 = _mm512_fmadd_ps(vec_100, vec_72, mem_vec_4762);
										mem_vec_4762 = vec_99;



										vec_101 = _mm512_fmadd_ps(vec_100, vec_74, mem_vec_4763);
										mem_vec_4763 = vec_101;
										scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
										vec_103 = _mm512_set1_ps(scal_32);


										vec_102 = _mm512_fmadd_ps(vec_103, vec_72, mem_vec_4764);
										mem_vec_4764 = vec_102;



										vec_104 = _mm512_fmadd_ps(vec_103, vec_74, mem_vec_4765);
