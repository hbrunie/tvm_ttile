...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (128, c); Hoist_vars [c];
  T (2, x); T (17, y); T (1, f); T (1, c); T (16, f); T (34, x); T (1, f)]
*/
IND_TYPE c, cp_0, c144_p_0, cp_1, c144, f, fp_0, f192_p_0, f193_p_0, fp_1, f192_p_1, fp_2, f192, f193, x, xp_0, x162_p_0, xp_1, x162, y, yp_0;
...
for (f193 = f194, f193_p_0 = 0;
	...
	for (x162 = x163, x162_p_0 = 0;
		...
		for (f192 = f193, f192_p_1 = f193_p_0, f192_p_0 = 0;
			f192 < f193 + 256;
			f192 += 16, f192_p_1 += 16, f192_p_0 += 16){
