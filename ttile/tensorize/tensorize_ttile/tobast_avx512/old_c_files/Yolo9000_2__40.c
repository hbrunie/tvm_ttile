...
for (x940 = x941, x940_p_0 = 0;
	x940 < x941 + 272;
	x940 += 136, x940_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 2) (136 / 68)
	for (x939 = x940, x939_p_1 = x940_p_0, x939_p_0 = 0;
		x939 < x940 + 136;
		x939 += 68, x939_p_1 += 68, x939_p_0 += 68){
		...
		for (c558 = c559, c558_p_0 = 0;
			...
			for (y = y392, yp_0 = 0;
				...
				// T (x, 17) (68 / 4)
				for (x938 = x939, x938_p_2 = x939_p_1, x938_p_1 = x939_p_0, x938_p_0 = 0;
					x938 < x939 + 68;
					x938 += 4, x938_p_2 += 4, x938_p_1 += 4, x938_p_0 += 4){
					...
					for (h = h296, hp_0 = 0;
						...
						// T (x, 4) (4 / 1)
						for (x = x938, xp_3 = x938_p_2, xp_2 = x938_p_1, xp_1 = x938_p_0, xp_0 = 0;
							x < x938 + 4;
