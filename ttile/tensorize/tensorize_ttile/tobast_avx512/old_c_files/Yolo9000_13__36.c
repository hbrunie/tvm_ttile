				...
				for (y = y16 + 7, yp_0 = 0;
					...
					for (x32 = x33, x32_p_1 = x33_p_0, x32_p_0 = 0;
						...
						for (x = x32, xp_2 = x32_p_1, xp_1 = x32_p_0, xp_0 = 0;
							x < x32 + 17;
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_270 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_271 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
									...
									mem_vec_278 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
									mem_vec_279 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
									...
									mem_vec_283 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
									mem_vec_284 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_285 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
									mem_vec_286 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_287 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 4, f = 32
									// T (c, 4) (4 / 1)
									for (c = c24, cp_1 = c24_p_0, cp_0 = 0;
										c < c24 + 4;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_270);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_271);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_278);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_279);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_283);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_284);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_285);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_286);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_287);
						}
					}
				}
		}
