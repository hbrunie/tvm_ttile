...
[V f; U (4, f); U (4, y); U (3, h); T (64, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (1, x); T (34, y); T (2, f); T (1, c); T (68, x)]
*/
IND_TYPE c, cp_0, c144_p_0, cp_1, c144, f, fp_0, w, wp_0, x, xp_0, x190_p_0, x191_p_0, xp_1, x190_p_1, xp_2, x190, x191, y, yp_0;
		...
		for (f = f96, fp_0 = 0;
			...
			for (y = y96, yp_0 = 0;
				...
				for (x190 = x191, x190_p_1 = x191_p_0, x190_p_0 = 0;
					x190 < x191 + 2;
					x190 += 2, x190_p_1 += 2, x190_p_0 += 2){
					// y = 4, x = 2, h = 3, w = 3, c = 64, f = 64
					// T (w, 3) (3 / 1)
					for (w = w96, wp_0 = 0;
						w < w96 + 3;
						w += 1, wp_0 += 1){
						// y = 4, x = 2, h = 3, w = 1, c = 64, f = 64
						// T (x, 2) (2 / 1)
