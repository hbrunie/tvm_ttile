...
for (c355 = c356, c355_p_0 = 0;
	...
	for (y = y200, yp_0 = 0;
		y < y200 + 14;
		y += 2, yp_0 += 2){
		// y = 2, x = 14, h = 3, w = 3, c = 16, f = 256
		// T (x, 2) (14 / 7)
		for (x298 = x299, x298_p_0 = 0;
			x298 < x299 + 14;
			x298 += 7, x298_p_0 += 7){
			// y = 2, x = 7, h = 3, w = 3, c = 16, f = 256
			// T (f, 2) (256 / 128)
			for (f = f350, fp_0 = 0;
				f < f350 + 256;
				f += 128, fp_0 += 128){
				...
				for (c354 = c355, c354_p_1 = c355_p_0, c354_p_0 = 0;
					c354 < c355 + 16;
					c354 += 16, c354_p_1 += 16, c354_p_0 += 16){
					// y = 2, x = 7, h = 3, w = 3, c = 16, f = 128
					// T (h, 3) (3 / 1)
					for (h = h172, hp_0 = 0;
						h < h172 + 3;
						...
						for (x = x298, xp_1 = x298_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1566 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
									mem_vec_1567 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
									mem_vec_1568 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
									mem_vec_1569 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
									...
									mem_vec_1574 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
									mem_vec_1575 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
									mem_vec_1576 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
									mem_vec_1577 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_1566);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_1567);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_1568);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_1569);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_1574);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_1575);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_1576);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_1577);
						}
					}
				}
			}
