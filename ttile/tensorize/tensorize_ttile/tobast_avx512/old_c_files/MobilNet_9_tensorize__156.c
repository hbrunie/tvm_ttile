...
fp_2 = 0;
					for (w = w84, wp_0 = 0;w < w84 + 3;w += 1, wp_0 += 1){
						...
						for (x = x84, xp_0 = 0;x < x84 + 7;x += 1, xp_0 += 1){
									...
									mem_vec_869 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									...
									mem_vec_873 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									mem_vec_874 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									// y = 7, x = 1, h = 3, w = 1, c = 512, f = 16
									// T (c, 512) (512 / 1)
									for (c = c210, cp_2 = c210_p_1, cp_1 = c210_p_0, cp_0 = 0;c < c210 + 512;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_869);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_873);
