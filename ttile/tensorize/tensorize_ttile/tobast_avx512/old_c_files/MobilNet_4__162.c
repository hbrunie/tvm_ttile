				...
				for (h = h116, hp_0 = 0;
					...
					for (x = x210, xp_1 = x210_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_940 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
								mem_vec_941 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
								mem_vec_942 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
								mem_vec_943 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
								...
								mem_vec_948 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
								mem_vec_949 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
								mem_vec_950 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
								mem_vec_951 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_940);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_941);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_942);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_943);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_948);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_949);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_950);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_951);
					}
				}
			}
		}
