...
[V f; U (2, f); ULambda y; U (3, w); T (2, c); Hoist_vars [c]; T (7, x);
  ...
  T (1, f); T (128, c); T (2, f); T (1, c); T (2, x); T (4, f)]
*/
IND_TYPE c, cp_0, c878_p_0, c879_p_0, cp_1, c878_p_1, cp_2, c878, c879, f, fp_0, f870_p_0, f871_p_0, fp_1, f870_p_1, fp_2, f870, f871, h, hp_0, x, xp_0, x724_p_0, xp_1, x724, y, yp_0;
...
for (f871 = f872, f871_p_0 = 0;
	...
	for (x724 = x725, x724_p_0 = 0;
		...
		for (c879 = c880, c879_p_0 = 0;
			c879 < c880 + 256;
			c879 += 256, c879_p_0 += 256){
			// y = 14, x = 7, h = 3, w = 3, c = 256, f = 64
			// T (f, 2) (64 / 32)
			for (f870 = f871, f870_p_1 = f871_p_0, f870_p_0 = 0;
				f870 < f871 + 64;
				f870 += 32, f870_p_1 += 32, f870_p_0 += 32){
				// y = 14, x = 7, h = 3, w = 3, c = 256, f = 32
				// T (c, 128) (256 / 2)
				for (c878 = c879, c878_p_1 = c879_p_0, c878_p_0 = 0;
					c878 < c879 + 256;
					c878 += 2, c878_p_1 += 2, c878_p_0 += 2){
					// y = 14, x = 7, h = 3, w = 3, c = 2, f = 32
					// T (f, 1) (32 / 32)
					for (f = f870, fp_2 = f870_p_1, fp_1 = f870_p_0, fp_0 = 0;
						f < f870 + 32;
									...
									for (x = x724, xp_1 = x724_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c878, cp_2 = c878_p_1, cp_1 = c878_p_0, cp_0 = 0;
													...
													vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_4708);
													mem_vec_4708 = vec_14;

													vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_4709);
													mem_vec_4709 = vec_17;
													scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
													vec_20 = _mm512_set1_ps(scal_5);


													vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_4710);
													mem_vec_4710 = vec_19;



													vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_4711);
													mem_vec_4711 = vec_21;
													scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
													vec_23 = _mm512_set1_ps(scal_6);


													vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_4712);
													mem_vec_4712 = vec_22;



													vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_4713);
													mem_vec_4713 = vec_24;
													scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
													vec_26 = _mm512_set1_ps(scal_7);


													vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_4714);
													mem_vec_4714 = vec_25;



													vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_4715);
													mem_vec_4715 = vec_27;
													scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
													vec_29 = _mm512_set1_ps(scal_8);
													vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_4708);
													mem_vec_4708 = vec_28;

													vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_4709);
													mem_vec_4709 = vec_31;
													scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
													vec_34 = _mm512_set1_ps(scal_9);


													vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_4710);
													mem_vec_4710 = vec_33;



													vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_4711);
													mem_vec_4711 = vec_35;
													scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
													vec_37 = _mm512_set1_ps(scal_10);


													vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_4712);
													mem_vec_4712 = vec_36;



													vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_4713);
													mem_vec_4713 = vec_38;
													scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
													vec_40 = _mm512_set1_ps(scal_11);


													vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_4714);
													mem_vec_4714 = vec_39;



													vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_4715);
													mem_vec_4715 = vec_41;
												}
