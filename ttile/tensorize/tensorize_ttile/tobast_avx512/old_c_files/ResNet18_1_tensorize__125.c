...
[V f; U (2, f); U (14, y); T (3, c); Hoist_vars [c]; T (14, x); T (7, w);
  T (7, h); T (2, x); T (8, y); T (2, f); T (4, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x192_p_0, x193_p_0, xp_1, x192_p_1, xp_2, x192, x193, y, yp_0;
IND_TYPE y96 = 0;
IND_TYPE x194 = 0;
IND_TYPE h96 = 0;
IND_TYPE w96 = 0;
...
x192 = 0;
x192_p_1 = 0;
				for (h = h96, hp_0 = 0;h < h96 + 7;h += 1, hp_0 += 1){
					// y = 14, x = 14, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w96, wp_0 = 0;w < w96 + 7;w += 1, wp_0 += 1){
						// y = 14, x = 14, h = 1, w = 1, c = 3, f = 32
						// T (x, 14) (14 / 1)
						for (x = x192, xp_2 = x192_p_1, xp_1 = x192_p_0, xp_0 = 0;x < x192 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_848 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_849 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
									mem_vec_850 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									mem_vec_851 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
									mem_vec_852 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									mem_vec_853 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									mem_vec_854 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
									mem_vec_855 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
									mem_vec_856 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									mem_vec_857 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
									mem_vec_858 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
									mem_vec_859 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
									...
									for (c = c96, cp_0 = 0;c < c96 + 3;c += 1, cp_0 += 1){
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_848);
										mem_vec_848 = vec_26;
										vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_849);
										mem_vec_849 = vec_28;
										scal_9 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 9) + h) + c];
										vec_30 = _mm512_set1_ps(scal_9);
										vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_850);
										mem_vec_850 = vec_29;
										vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_851);
										mem_vec_851 = vec_31;
										scal_10 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 10) + h) + c];
										vec_33 = _mm512_set1_ps(scal_10);
										vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_852);
										mem_vec_852 = vec_32;
										vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_853);
										mem_vec_853 = vec_34;
										scal_11 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 11) + h) + c];
										vec_36 = _mm512_set1_ps(scal_11);
										vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_854);
										mem_vec_854 = vec_35;
										vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_855);
										mem_vec_855 = vec_37;
										scal_12 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 12) + h) + c];
										vec_39 = _mm512_set1_ps(scal_12);
										vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_856);
										mem_vec_856 = vec_38;
										vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_857);
										mem_vec_857 = vec_40;
										scal_13 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 13) + h) + c];
										vec_42 = _mm512_set1_ps(scal_13);
										vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_858);
										mem_vec_858 = vec_41;
										vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_859);
										mem_vec_859 = vec_43;
									}
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_848);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_849);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_850);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_851);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_852);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_853);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_854);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_855);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_856);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_857);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_858);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_859);
						}
					}
				}
}
