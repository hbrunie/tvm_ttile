...
x1158_p_1 = 0;
						for (h = h492, hp_0 = 0;h < h492 + 3;h += 1, hp_0 += 1){
							...
							for (x = x1158, xp_2 = x1158_p_1, xp_1 = x1158_p_0, xp_0 = 0;x < x1158 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_8824 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_8825 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_8824);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_8825);
							}
						}
}
