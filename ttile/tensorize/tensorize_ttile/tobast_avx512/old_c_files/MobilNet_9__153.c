	...
	for (f262 = f263, f262_p_0 = 0;
		...
		for (c379 = c380, c379_p_1 = c380_p_0, c379_p_0 = 0;
			...
			for (f = f262, fp_1 = f262_p_0, fp_0 = 0;
				...
				// y = 7, x = 7, h = 3, w = 3, c = 4, f = 32
				// T (c, 4) (4 / 1)
				for (c378 = c379, c378_p_2 = c379_p_1, c378_p_1 = c379_p_0, c378_p_0 = 0;
					c378 < c379 + 4;
					c378 += 1, c378_p_2 += 1, c378_p_1 += 1, c378_p_0 += 1){
					...
					for (w = w160, wp_0 = 0;
						...
						for (x = x160, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									// T (c, 1) (1 / 1)
									for (c = c378, cp_3 = c378_p_2, cp_2 = c378_p_1, cp_1 = c378_p_0, cp_0 = 0;
										c < c378 + 1;
