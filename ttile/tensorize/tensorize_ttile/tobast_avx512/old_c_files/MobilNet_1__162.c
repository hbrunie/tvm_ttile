...
[V f; U (2, f); ULambda y; U (3, h); T (8, c); Hoist_vars [c]; T (56, x);
  T (3, w); T (1, x);
  Lambda_apply y [((Iter 1), (Arg 7)); ((Iter 7), (Arg 15))]; T (4, c);
  T (2, x)]
*/
IND_TYPE c, cp_0, c540_p_0, cp_1, c540, w, wp_0, x, xp_0, x720_p_0, x721_p_0, xp_1, x720_p_1, xp_2, x720, x721, y, yp_0;
		...
		c540 += 8, c540_p_0 += 8){
			for (y = y360, yp_0 = 0;
				...
				for (x720 = x721, x720_p_1 = x721_p_0, x720_p_0 = 0;
					x720 < x721 + 56;
					x720 += 56, x720_p_1 += 56, x720_p_0 += 56){
					// y = ph_y, x = 56, h = 3, w = 3, c = 8, f = 32
					// T (w, 3) (3 / 1)
					for (w = w326, wp_0 = 0;
						w < w326 + 3;
						...
						for (x = x720, xp_2 = x720_p_1, xp_1 = x720_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c540, cp_1 = c540_p_0, cp_0 = 0;
										...
										vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_4396);
										mem_vec_4396 = vec_23;

										vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_4397);
										mem_vec_4397 = vec_26;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_8);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_4398);
										mem_vec_4398 = vec_28;



										vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_4399);
										mem_vec_4399 = vec_30;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_4400);
										mem_vec_4400 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_4401);
										mem_vec_4401 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_4402);
										mem_vec_4402 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_4403);
										mem_vec_4403 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_4404);
										mem_vec_4404 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_4405);
										mem_vec_4405 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_4406);
										mem_vec_4406 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_4407);
										mem_vec_4407 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_4408);
										mem_vec_4408 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_4409);
										mem_vec_4409 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_4396);
										mem_vec_4396 = vec_46;

										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_4397);
										mem_vec_4397 = vec_49;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_52 = _mm512_set1_ps(scal_15);


										vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_4398);
										mem_vec_4398 = vec_51;



										vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_4399);
										mem_vec_4399 = vec_53;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_55 = _mm512_set1_ps(scal_16);


										vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_4400);
										mem_vec_4400 = vec_54;



										vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_4401);
										mem_vec_4401 = vec_56;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_4402);
										mem_vec_4402 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_4403);
										mem_vec_4403 = vec_59;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_61 = _mm512_set1_ps(scal_18);


										vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_4404);
										mem_vec_4404 = vec_60;



										vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_4405);
										mem_vec_4405 = vec_62;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_4406);
										mem_vec_4406 = vec_63;



										vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_4407);
										mem_vec_4407 = vec_65;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);


										vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_4408);
										mem_vec_4408 = vec_66;



										vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_4409);
										mem_vec_4409 = vec_68;
									}
					...
					for (w = w326, wp_0 = 0;
						...
						for (x = x720, xp_2 = x720_p_1, xp_1 = x720_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_4436 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_4437 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									mem_vec_4438 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
									mem_vec_4439 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
									// y = ph_y, x = 1, h = 3, w = 1, c = 8, f = 32
									// T (c, 8) (8 / 1)
									for (c = c540, cp_1 = c540_p_0, cp_0 = 0;
										c < c540 + 8;
										...
										vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_4436);
										mem_vec_4436 = vec_41;



										vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_4437);
										mem_vec_4437 = vec_43;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 14 + h) + c];
										vec_45 = _mm512_set1_ps(scal_14);


										vec_44 = _mm512_fmadd_ps(vec_45, vec_2, mem_vec_4438);
										mem_vec_4438 = vec_44;



										vec_46 = _mm512_fmadd_ps(vec_45, vec_4, mem_vec_4439);
										mem_vec_4439 = vec_46;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
										vec_48 = _mm512_set1_ps(scal_15);
										vec_49 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

										vec_47 = _mm512_fmadd_ps(vec_48, vec_49, mem_vec_4410);
										mem_vec_4410 = vec_47;

										vec_51 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_50 = _mm512_fmadd_ps(vec_48, vec_51, mem_vec_4411);
										mem_vec_4411 = vec_50;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_53 = _mm512_set1_ps(scal_16);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_49, mem_vec_4412);
										mem_vec_4412 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_51, mem_vec_4413);
										mem_vec_4413 = vec_54;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_56 = _mm512_set1_ps(scal_17);


										vec_55 = _mm512_fmadd_ps(vec_56, vec_49, mem_vec_4414);
										mem_vec_4414 = vec_55;



										vec_57 = _mm512_fmadd_ps(vec_56, vec_51, mem_vec_4415);
										mem_vec_4415 = vec_57;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_59 = _mm512_set1_ps(scal_18);


										vec_58 = _mm512_fmadd_ps(vec_59, vec_49, mem_vec_4416);
										mem_vec_4416 = vec_58;



										vec_60 = _mm512_fmadd_ps(vec_59, vec_51, mem_vec_4417);
										mem_vec_4417 = vec_60;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_62 = _mm512_set1_ps(scal_19);


										vec_61 = _mm512_fmadd_ps(vec_62, vec_49, mem_vec_4418);
										mem_vec_4418 = vec_61;



										vec_63 = _mm512_fmadd_ps(vec_62, vec_51, mem_vec_4419);
										mem_vec_4419 = vec_63;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_65 = _mm512_set1_ps(scal_20);


										vec_64 = _mm512_fmadd_ps(vec_65, vec_49, mem_vec_4420);
										mem_vec_4420 = vec_64;



										vec_66 = _mm512_fmadd_ps(vec_65, vec_51, mem_vec_4421);
										mem_vec_4421 = vec_66;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_68 = _mm512_set1_ps(scal_21);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_49, mem_vec_4422);
										mem_vec_4422 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_51, mem_vec_4423);
										mem_vec_4423 = vec_69;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_71 = _mm512_set1_ps(scal_22);


										vec_70 = _mm512_fmadd_ps(vec_71, vec_49, mem_vec_4424);
										mem_vec_4424 = vec_70;



										vec_72 = _mm512_fmadd_ps(vec_71, vec_51, mem_vec_4425);
										mem_vec_4425 = vec_72;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
										vec_74 = _mm512_set1_ps(scal_23);


										vec_73 = _mm512_fmadd_ps(vec_74, vec_49, mem_vec_4426);
										mem_vec_4426 = vec_73;



										vec_75 = _mm512_fmadd_ps(vec_74, vec_51, mem_vec_4427);
										mem_vec_4427 = vec_75;
										scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
										vec_77 = _mm512_set1_ps(scal_24);


										vec_76 = _mm512_fmadd_ps(vec_77, vec_49, mem_vec_4428);
										mem_vec_4428 = vec_76;



										vec_78 = _mm512_fmadd_ps(vec_77, vec_51, mem_vec_4429);
										mem_vec_4429 = vec_78;
										scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
										vec_80 = _mm512_set1_ps(scal_25);


										vec_79 = _mm512_fmadd_ps(vec_80, vec_49, mem_vec_4430);
										mem_vec_4430 = vec_79;



										vec_81 = _mm512_fmadd_ps(vec_80, vec_51, mem_vec_4431);
										mem_vec_4431 = vec_81;
										scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
										vec_83 = _mm512_set1_ps(scal_26);


										vec_82 = _mm512_fmadd_ps(vec_83, vec_49, mem_vec_4432);
										mem_vec_4432 = vec_82;



										vec_84 = _mm512_fmadd_ps(vec_83, vec_51, mem_vec_4433);
										mem_vec_4433 = vec_84;
										scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
										vec_86 = _mm512_set1_ps(scal_27);


										vec_85 = _mm512_fmadd_ps(vec_86, vec_49, mem_vec_4434);
										mem_vec_4434 = vec_85;



										vec_87 = _mm512_fmadd_ps(vec_86, vec_51, mem_vec_4435);
										mem_vec_4435 = vec_87;
										scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 1) + c];
										vec_89 = _mm512_set1_ps(scal_28);


										vec_88 = _mm512_fmadd_ps(vec_89, vec_49, mem_vec_4436);
										mem_vec_4436 = vec_88;



										vec_90 = _mm512_fmadd_ps(vec_89, vec_51, mem_vec_4437);
										mem_vec_4437 = vec_90;
										scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 14 + h + 1) + c];
										vec_92 = _mm512_set1_ps(scal_29);


										vec_91 = _mm512_fmadd_ps(vec_92, vec_49, mem_vec_4438);
										mem_vec_4438 = vec_91;



										vec_93 = _mm512_fmadd_ps(vec_92, vec_51, mem_vec_4439);
										mem_vec_4439 = vec_93;
										scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_95 = _mm512_set1_ps(scal_30);
										vec_96 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_94 = _mm512_fmadd_ps(vec_95, vec_96, mem_vec_4410);
										mem_vec_4410 = vec_94;

										vec_98 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_97 = _mm512_fmadd_ps(vec_95, vec_98, mem_vec_4411);
										mem_vec_4411 = vec_97;
										scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_100 = _mm512_set1_ps(scal_31);


										vec_99 = _mm512_fmadd_ps(vec_100, vec_96, mem_vec_4412);
										mem_vec_4412 = vec_99;



										vec_101 = _mm512_fmadd_ps(vec_100, vec_98, mem_vec_4413);
										mem_vec_4413 = vec_101;
										scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_103 = _mm512_set1_ps(scal_32);


										vec_102 = _mm512_fmadd_ps(vec_103, vec_96, mem_vec_4414);
										mem_vec_4414 = vec_102;



										vec_104 = _mm512_fmadd_ps(vec_103, vec_98, mem_vec_4415);
										mem_vec_4415 = vec_104;
										scal_33 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_106 = _mm512_set1_ps(scal_33);


										vec_105 = _mm512_fmadd_ps(vec_106, vec_96, mem_vec_4416);
										mem_vec_4416 = vec_105;



										vec_107 = _mm512_fmadd_ps(vec_106, vec_98, mem_vec_4417);
										mem_vec_4417 = vec_107;
										scal_34 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_109 = _mm512_set1_ps(scal_34);


										vec_108 = _mm512_fmadd_ps(vec_109, vec_96, mem_vec_4418);
										mem_vec_4418 = vec_108;



										vec_110 = _mm512_fmadd_ps(vec_109, vec_98, mem_vec_4419);
										mem_vec_4419 = vec_110;
										scal_35 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_112 = _mm512_set1_ps(scal_35);


										vec_111 = _mm512_fmadd_ps(vec_112, vec_96, mem_vec_4420);
										mem_vec_4420 = vec_111;



										vec_113 = _mm512_fmadd_ps(vec_112, vec_98, mem_vec_4421);
										mem_vec_4421 = vec_113;
										scal_36 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_115 = _mm512_set1_ps(scal_36);


										vec_114 = _mm512_fmadd_ps(vec_115, vec_96, mem_vec_4422);
										mem_vec_4422 = vec_114;



										vec_116 = _mm512_fmadd_ps(vec_115, vec_98, mem_vec_4423);
										mem_vec_4423 = vec_116;
										scal_37 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_118 = _mm512_set1_ps(scal_37);


										vec_117 = _mm512_fmadd_ps(vec_118, vec_96, mem_vec_4424);
										mem_vec_4424 = vec_117;



										vec_119 = _mm512_fmadd_ps(vec_118, vec_98, mem_vec_4425);
										mem_vec_4425 = vec_119;
										scal_38 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
										vec_121 = _mm512_set1_ps(scal_38);


										vec_120 = _mm512_fmadd_ps(vec_121, vec_96, mem_vec_4426);
										mem_vec_4426 = vec_120;



										vec_122 = _mm512_fmadd_ps(vec_121, vec_98, mem_vec_4427);
										mem_vec_4427 = vec_122;
										scal_39 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
										vec_124 = _mm512_set1_ps(scal_39);


										vec_123 = _mm512_fmadd_ps(vec_124, vec_96, mem_vec_4428);
										mem_vec_4428 = vec_123;



										vec_125 = _mm512_fmadd_ps(vec_124, vec_98, mem_vec_4429);
										mem_vec_4429 = vec_125;
										scal_40 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
										vec_127 = _mm512_set1_ps(scal_40);


										vec_126 = _mm512_fmadd_ps(vec_127, vec_96, mem_vec_4430);
										mem_vec_4430 = vec_126;



										vec_128 = _mm512_fmadd_ps(vec_127, vec_98, mem_vec_4431);
										mem_vec_4431 = vec_128;
										scal_41 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 2) + c];
										vec_130 = _mm512_set1_ps(scal_41);


										vec_129 = _mm512_fmadd_ps(vec_130, vec_96, mem_vec_4432);
										mem_vec_4432 = vec_129;



										vec_131 = _mm512_fmadd_ps(vec_130, vec_98, mem_vec_4433);
										mem_vec_4433 = vec_131;
										scal_42 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 2) + c];
										vec_133 = _mm512_set1_ps(scal_42);


										vec_132 = _mm512_fmadd_ps(vec_133, vec_96, mem_vec_4434);
										mem_vec_4434 = vec_132;



										vec_134 = _mm512_fmadd_ps(vec_133, vec_98, mem_vec_4435);
										mem_vec_4435 = vec_134;
										scal_43 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 2) + c];
										vec_136 = _mm512_set1_ps(scal_43);


										vec_135 = _mm512_fmadd_ps(vec_136, vec_96, mem_vec_4436);
										mem_vec_4436 = vec_135;



										vec_137 = _mm512_fmadd_ps(vec_136, vec_98, mem_vec_4437);
										mem_vec_4437 = vec_137;
										scal_44 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 14 + h + 2) + c];
										vec_139 = _mm512_set1_ps(scal_44);


										vec_138 = _mm512_fmadd_ps(vec_139, vec_96, mem_vec_4438);
										mem_vec_4438 = vec_138;



										vec_140 = _mm512_fmadd_ps(vec_139, vec_98, mem_vec_4439);
										mem_vec_4439 = vec_140;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_4436);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_4437);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_4438);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_4439);
						}
					}
				}
			}
