...
yp_0 = 0;
						for (h = h144, hp_0 = 0;h < h144 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 8) (8 / 1)
							for (x = x300, xp_1 = x300_p_0, xp_0 = 0;x < x300 + 8;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_939 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										...
										mem_vec_943 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_939);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_943);
							}
						}
}
