...
fp_1 = 0;
						for (h = h366, hp_0 = 0;h < h366 + 3;h += 1, hp_0 += 1){
							...
							for (x = x756, xp_1 = x756_p_0, xp_0 = 0;x < x756 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6332 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_6333 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_6332);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_6333);
