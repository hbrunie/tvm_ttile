...
for (x347 = x348, x347_p_0 = 0;
	...
	for (y270 = y271, y270_p_0 = 0;
		...
		for (x346 = x347, x346_p_1 = x347_p_0, x346_p_0 = 0;
			x346 < x347 + 544;
			x346 += 17, x346_p_1 += 17, x346_p_0 += 17){
						...
						for (w = w142, wp_0 = 0;
							...
							for (x = x346, xp_2 = x346_p_1, xp_1 = x346_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2216 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
										mem_vec_2217 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
										mem_vec_2218 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_2219 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 3, f = 32
										// T (c, 3) (3 / 1)
										for (c = c176, cp_0 = 0;
											c < c176 + 3;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2216);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_2217);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_2218);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_2219);
							}
						}
					}
				}
