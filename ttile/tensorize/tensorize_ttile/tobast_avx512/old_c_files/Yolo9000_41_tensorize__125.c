...
x894_p_1 = 0;
						for (w = w380, wp_0 = 0;w < w380 + 3;w += 1, wp_0 += 1){
							...
							for (x = x894, xp_2 = x894_p_1, xp_1 = x894_p_0, xp_0 = 0;x < x894 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5660 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_5661 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_5660);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_5661);
							}
						}
}
