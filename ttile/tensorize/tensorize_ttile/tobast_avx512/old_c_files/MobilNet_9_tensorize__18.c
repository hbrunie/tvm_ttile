...
[V f; U (4, f); U (7, y); T (8, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, c); T (16, f); T (1, y); T (8, c); T (1, f); T (4, c)]
*/
IND_TYPE c, cp_0, c180_p_0, c181_p_0, c182_p_0, cp_1, c180_p_1, c181_p_1, cp_2, c180_p_2, cp_3, c180, c181, c182, f, fp_0, f108_p_0, fp_1, f108, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y50 = 0;
IND_TYPE x72 = 0;
IND_TYPE h72 = 0;
IND_TYPE w72 = 0;
						...
						for (h = h72, hp_0 = 0;h < h72 + 3;h += 1, hp_0 += 1){
							...
							for (w = w72, wp_0 = 0;w < w72 + 3;w += 1, wp_0 += 1){
								...
								for (x = x72, xp_0 = 0;x < x72 + 7;x += 1, xp_0 += 1){
											...
											// T (c, 8) (8 / 1)
											for (c = c180, cp_3 = c180_p_2, cp_2 = c180_p_1, cp_1 = c180_p_0, cp_0 = 0;c < c180 + 8;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
