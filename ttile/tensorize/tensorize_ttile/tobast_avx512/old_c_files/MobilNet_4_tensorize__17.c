...
/*
[V f; U (1, f); U (4, y); U (3, w); T (64, c); Hoist_vars [c]; T (1, x);
...
__m512 mem_vec_584 ,mem_vec_585 ,mem_vec_586 ,mem_vec_587 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_3 ,vec_4 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
...
fp_1 = 0;
					for (h = h52, hp_0 = 0;h < h52 + 3;h += 1, hp_0 += 1){
						...
						for (x = x114, xp_1 = x114_p_0, xp_0 = 0;x < x114 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_585 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									...
									for (c = c114, cp_1 = c114_p_0, cp_0 = 0;c < c114 + 64;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_585);
										mem_vec_585 = vec_3;
