...
for (x711 = x712, x711_p_0 = 0;
	...
	// T (y, 4) (544 / 136)
	for (y634 = y635, y634_p_0 = 0;
		y634 < y635 + 544;
		y634 += 136, y634_p_0 += 136){
		// y = 136, x = 17, h = 3, w = 3, c = 3, f = 32
		// T (x, 17) (17 / 1)
		for (x710 = x711, x710_p_1 = x711_p_0, x710_p_0 = 0;
			x710 < x711 + 17;
			x710 += 1, x710_p_1 += 1, x710_p_0 += 1){
				for (y = y634, yp_1 = y634_p_0, yp_0 = 0;
					y < y634 + 84;
				...
				for (y = y634 + 84, yp_1 = y634_p_0, yp_0 = 0;
					y < y634 + 84 + 52;
					...
					for (w = w350, wp_0 = 0;
						...
						for (x = x710, xp_2 = x710_p_1, xp_1 = x710_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_5510 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_5511 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_5512 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_5513 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									// y = ph_y, x = 1, h = 3, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c384, cp_0 = 0;
										c < c384 + 3;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_5510);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_5511);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_5512);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_5513);
						}
					}
				}
		}
