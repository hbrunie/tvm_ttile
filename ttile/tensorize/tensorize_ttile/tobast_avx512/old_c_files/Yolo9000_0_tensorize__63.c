...
/*
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (136, x); T (3, w);
  T (3, h); T (1, y); T (2, x); T (68, y); T (2, x)]
*/
IND_TYPE c, cp_0, h, hp_0, w, wp_0, x, x0, xp_0, x0_p_0, x1_p_0, x1, xp_1, x0_p_1, xp_2, y, y0, yp_0, y0_p_0, yp_1;
IND_TYPE y1 = 0;
IND_TYPE x2 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
...
yp_1 = 0;
				for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
					...
					for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
						// y = 8, x = 136, h = 1, w = 1, c = 3, f = 32
						// T (x, 136) (136 / 1)
						for (x = x0, xp_2 = x0_p_1, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 136;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
