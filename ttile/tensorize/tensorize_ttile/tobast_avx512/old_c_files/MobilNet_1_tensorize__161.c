...
/*
[V f; U (2, f); U (7, y); U (3, h); T (2, c); Hoist_vars [c]; T (4, x);
  T (3, w); T (28, x); T (16, y); T (16, c); T (1, x)]
*/
IND_TYPE c, cp_0, c60_p_0, cp_1, c60, w, wp_0, x, xp_0, x80_p_0, x81_p_0, xp_1, x80_p_1, xp_2, x80, x81, y, yp_0;
IND_TYPE y40 = 0;
IND_TYPE x82 = 0;
IND_TYPE h = 0;
IND_TYPE w40 = 0;
...
x80_p_1 = 0;
				for (w = w40, wp_0 = 0;w < w40 + 3;w += 1, wp_0 += 1){
					...
					for (x = x80, xp_2 = x80_p_1, xp_1 = x80_p_0, xp_0 = 0;x < x80 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 2) (2 / 1)
								for (c = c60, cp_1 = c60_p_0, cp_0 = 0;c < c60 + 2;c += 1, cp_1 += 1, cp_0 += 1){
									...
									vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_254);
									mem_vec_254 = vec_23;
									vec_27 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
									vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_255);
									mem_vec_255 = vec_26;
									scal_8 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
									vec_29 = _mm512_set1_ps(scal_8);
									vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_256);
									mem_vec_256 = vec_28;
									vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_257);
									mem_vec_257 = vec_30;
									scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
									vec_32 = _mm512_set1_ps(scal_9);
									vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_258);
									mem_vec_258 = vec_31;
									vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_259);
									mem_vec_259 = vec_33;
									scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
									vec_35 = _mm512_set1_ps(scal_10);
									vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_260);
									mem_vec_260 = vec_34;
									vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_261);
									mem_vec_261 = vec_36;
									scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 1) + c];
									vec_38 = _mm512_set1_ps(scal_11);
									vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_262);
									mem_vec_262 = vec_37;
									vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_263);
									mem_vec_263 = vec_39;
									scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 1) + c];
									vec_41 = _mm512_set1_ps(scal_12);
									vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_264);
									mem_vec_264 = vec_40;
									vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_265);
									mem_vec_265 = vec_42;
									scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 1) + c];
									vec_44 = _mm512_set1_ps(scal_13);
									vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_266);
									mem_vec_266 = vec_43;
									vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_267);
									mem_vec_267 = vec_45;
									scal_14 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
									vec_47 = _mm512_set1_ps(scal_14);
									vec_48 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
									vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_254);
									mem_vec_254 = vec_46;
									vec_50 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
									vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_255);
									mem_vec_255 = vec_49;
									scal_15 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
									vec_52 = _mm512_set1_ps(scal_15);
									vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_256);
									mem_vec_256 = vec_51;
									vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_257);
									mem_vec_257 = vec_53;
									scal_16 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
									vec_55 = _mm512_set1_ps(scal_16);
									vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_258);
									mem_vec_258 = vec_54;
									vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_259);
									mem_vec_259 = vec_56;
									scal_17 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
									vec_58 = _mm512_set1_ps(scal_17);
									vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_260);
									mem_vec_260 = vec_57;
									vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_261);
									mem_vec_261 = vec_59;
									scal_18 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 2) + c];
									vec_61 = _mm512_set1_ps(scal_18);
									vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_262);
									mem_vec_262 = vec_60;
									vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_263);
									mem_vec_263 = vec_62;
									scal_19 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 2) + c];
									vec_64 = _mm512_set1_ps(scal_19);
									vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_264);
									mem_vec_264 = vec_63;
									vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_265);
									mem_vec_265 = vec_65;
									scal_20 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 2) + c];
									vec_67 = _mm512_set1_ps(scal_20);
									vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_266);
									mem_vec_266 = vec_66;
									vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_267);
									mem_vec_267 = vec_68;
								}
