						...
						for (x = x504, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c840, cp_2 = c840_p_1, cp_1 = c840_p_0, cp_0 = 0;
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_3992);
										mem_vec_3992 = vec_14;

										vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_3993);
										mem_vec_3993 = vec_17;

										vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_3994);
										mem_vec_3994 = vec_19;

										vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_3995);
										mem_vec_3995 = vec_21;
										scal_3 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
										vec_24 = _mm512_set1_ps(scal_3);


										vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_3996);
										mem_vec_3996 = vec_23;



										vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_3997);
										mem_vec_3997 = vec_25;



										vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_3998);
										mem_vec_3998 = vec_26;



										vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_3999);
										mem_vec_3999 = vec_27;
										scal_4 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
										vec_29 = _mm512_set1_ps(scal_4);
										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_3992);
										mem_vec_3992 = vec_28;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_3993);
										mem_vec_3993 = vec_31;

										vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_3994);
										mem_vec_3994 = vec_33;

										vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_3995);
										mem_vec_3995 = vec_35;
										scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
										vec_38 = _mm512_set1_ps(scal_5);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_3996);
										mem_vec_3996 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_3997);
										mem_vec_3997 = vec_39;



										vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_3998);
										mem_vec_3998 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_3999);
										mem_vec_3999 = vec_41;
									}
						...
						for (x = x504, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c840, cp_2 = c840_p_1, cp_1 = c840_p_0, cp_0 = 0;
										...
										vec_19 = _mm512_fmadd_ps(vec_20, vec_21, mem_vec_4000);
										mem_vec_4000 = vec_19;

										vec_23 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_22 = _mm512_fmadd_ps(vec_20, vec_23, mem_vec_4001);
										mem_vec_4001 = vec_22;

										vec_25 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_24 = _mm512_fmadd_ps(vec_20, vec_25, mem_vec_4002);
										mem_vec_4002 = vec_24;

										vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_26 = _mm512_fmadd_ps(vec_20, vec_27, mem_vec_4003);
										mem_vec_4003 = vec_26;
										scal_4 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_4);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_21, mem_vec_4004);
										mem_vec_4004 = vec_28;



										vec_30 = _mm512_fmadd_ps(vec_29, vec_23, mem_vec_4005);
										mem_vec_4005 = vec_30;



										vec_31 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_4006);
										mem_vec_4006 = vec_31;



										vec_32 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_4007);
										mem_vec_4007 = vec_32;
										scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
										vec_34 = _mm512_set1_ps(scal_5);


										vec_33 = _mm512_fmadd_ps(vec_34, vec_21, mem_vec_4008);
										mem_vec_4008 = vec_33;



										vec_35 = _mm512_fmadd_ps(vec_34, vec_23, mem_vec_4009);
										mem_vec_4009 = vec_35;



										vec_36 = _mm512_fmadd_ps(vec_34, vec_25, mem_vec_4010);
										mem_vec_4010 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_34, vec_27, mem_vec_4011);
										mem_vec_4011 = vec_37;
										scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
										vec_39 = _mm512_set1_ps(scal_6);
										vec_40 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_38 = _mm512_fmadd_ps(vec_39, vec_40, mem_vec_4000);
										mem_vec_4000 = vec_38;

										vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_41 = _mm512_fmadd_ps(vec_39, vec_42, mem_vec_4001);
										mem_vec_4001 = vec_41;

										vec_44 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_43 = _mm512_fmadd_ps(vec_39, vec_44, mem_vec_4002);
										mem_vec_4002 = vec_43;

										vec_46 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_45 = _mm512_fmadd_ps(vec_39, vec_46, mem_vec_4003);
										mem_vec_4003 = vec_45;
										scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
										vec_48 = _mm512_set1_ps(scal_7);


										vec_47 = _mm512_fmadd_ps(vec_48, vec_40, mem_vec_4004);
										mem_vec_4004 = vec_47;



										vec_49 = _mm512_fmadd_ps(vec_48, vec_42, mem_vec_4005);
										mem_vec_4005 = vec_49;



										vec_50 = _mm512_fmadd_ps(vec_48, vec_44, mem_vec_4006);
										mem_vec_4006 = vec_50;



										vec_51 = _mm512_fmadd_ps(vec_48, vec_46, mem_vec_4007);
										mem_vec_4007 = vec_51;
										scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
										vec_53 = _mm512_set1_ps(scal_8);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_40, mem_vec_4008);
										mem_vec_4008 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_42, mem_vec_4009);
										mem_vec_4009 = vec_54;



										vec_55 = _mm512_fmadd_ps(vec_53, vec_44, mem_vec_4010);
										mem_vec_4010 = vec_55;



										vec_56 = _mm512_fmadd_ps(vec_53, vec_46, mem_vec_4011);
										mem_vec_4011 = vec_56;
									}
