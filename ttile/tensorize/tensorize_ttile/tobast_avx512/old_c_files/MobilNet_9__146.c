...
[V f; U (1, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (8, f); T (32, c); T (8, f); T (1, f); T (1, c)]
*/
IND_TYPE c, cp_0, c218_p_0, c219_p_0, cp_1, c218_p_1, cp_2, c218, c219, f, fp_0, f134_p_0, f135_p_0, fp_1, f134_p_1, fp_2, f134, f135, w, wp_0, x, xp_0;
...
for (c219 = c220, c219_p_0 = 0;
	c219 < c220 + 1024;
	c219 += 1024, c219_p_0 += 1024){
	// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
	// T (f, 1) (1024 / 1024)
	for (f135 = f136, f135_p_0 = 0;
		f135 < f136 + 1024;
		f135 += 1024, f135_p_0 += 1024){
		// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
		// T (f, 8) (1024 / 128)
