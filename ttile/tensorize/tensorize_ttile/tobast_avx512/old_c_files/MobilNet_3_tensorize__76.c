...
yp_0 = 0;
						for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 1) (1 / 1)
							for (x = x154, xp_1 = x154_p_0, xp_0 = 0;x < x154 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_654 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_655 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										...
										mem_vec_659 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										mem_vec_660 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
										mem_vec_661 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
										// y = 8, x = 1, h = 3, w = 1, c = 4, f = 16
										// T (c, 4) (4 / 1)
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_655);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_659);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_660);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_661);
							}
						}
}
