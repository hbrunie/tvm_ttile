					...
					for (w = w274, wp_0 = 0;
						...
						for (x = x558, xp_2 = x558_p_1, xp_1 = x558_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_3976 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_3977 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
									...
									mem_vec_3982 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									mem_vec_3983 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
									// y = ph_y, x = 1, h = 3, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c308, cp_0 = 0;
										c < c308 + 3;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_3976);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_3977);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_3982);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_3983);
						}
					}
				}
				for (y = y520 + 6, yp_1 = y520_p_0, yp_0 = 0;
					y < y520 + 6 + 10;
