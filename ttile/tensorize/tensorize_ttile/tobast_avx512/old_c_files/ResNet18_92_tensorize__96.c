...
fp_1 = 0;
						for (w = w136, wp_0 = 0;w < w136 + 3;w += 1, wp_0 += 1){
							...
							for (x = x288, xp_1 = x288_p_0, xp_0 = 0;x < x288 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1693 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										...
										mem_vec_1697 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_1693);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_1697);
							}
						}
}
