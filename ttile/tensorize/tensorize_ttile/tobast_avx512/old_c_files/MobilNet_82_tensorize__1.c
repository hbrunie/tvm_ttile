...
c1384_p_1 = 0;
					for (h = h588, hp_0 = 0;h < h588 + 3;h += 1, hp_0 += 1){
						...
						for (x = x776, xp_0 = 0;x < x776 + 7;x += 1, xp_0 += 1){
									...
									mem_vec_7628 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 64]);
									mem_vec_7629 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 80]);
									mem_vec_7630 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 96]);
									mem_vec_7631 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 112]);
									...
									mem_vec_7634 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
									mem_vec_7635 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
									mem_vec_7636 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 64]);
									mem_vec_7637 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 80]);
									mem_vec_7638 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 96]);
									mem_vec_7639 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 112]);
									...
									mem_vec_7642 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
									mem_vec_7643 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
									mem_vec_7644 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 64]);
									mem_vec_7645 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 80]);
									mem_vec_7646 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 96]);
									mem_vec_7647 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 112]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 64], mem_vec_7628);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 80], mem_vec_7629);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 96], mem_vec_7630);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 112], mem_vec_7631);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_7634);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_7635);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 64], mem_vec_7636);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 80], mem_vec_7637);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 96], mem_vec_7638);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 112], mem_vec_7639);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_7642);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_7643);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 64], mem_vec_7644);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 80], mem_vec_7645);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 96], mem_vec_7646);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 112], mem_vec_7647);
						}
					}
}
