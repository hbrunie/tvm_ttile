...
/*
[V f; U (4, f); U (4, y); U (3, h); T (4, c); Hoist_vars [c]; T (34, x);
  T (3, w); T (1, x); T (34, y); T (2, f); T (16, c); T (4, x)]
*/
IND_TYPE c, cp_0, c138_p_0, cp_1, c138, f, fp_0, w, wp_0, x, xp_0, x182_p_0, x183_p_0, xp_1, x182_p_1, xp_2, x182, x183, y, yp_0;
		...
		for (f = f92, fp_0 = 0;
			...
			for (y = y92, yp_0 = 0;
				...
				for (x182 = x183, x182_p_1 = x183_p_0, x182_p_0 = 0;
					x182 < x183 + 34;
					x182 += 34, x182_p_1 += 34, x182_p_0 += 34){
					// y = 4, x = 34, h = 3, w = 3, c = 4, f = 64
					// T (w, 3) (3 / 1)
					for (w = w92, wp_0 = 0;
						w < w92 + 3;
						w += 1, wp_0 += 1){
						// y = 4, x = 34, h = 3, w = 1, c = 4, f = 64
						// T (x, 34) (34 / 1)
						for (x = x182, xp_2 = x182_p_1, xp_1 = x182_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c138, cp_1 = c138_p_0, cp_0 = 0;
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_672);
										mem_vec_672 = vec_24;

										vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_673);
										mem_vec_673 = vec_27;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_674);
										mem_vec_674 = vec_29;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_675);
										mem_vec_675 = vec_31;
										scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_34 = _mm512_set1_ps(scal_5);


										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_676);
										mem_vec_676 = vec_33;



										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_677);
										mem_vec_677 = vec_35;



										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_678);
										mem_vec_678 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_679);
										mem_vec_679 = vec_37;
										scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_680);
										mem_vec_680 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_681);
										mem_vec_681 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_682);
										mem_vec_682 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_683);
										mem_vec_683 = vec_42;
										scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_7);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_684);
										mem_vec_684 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_685);
										mem_vec_685 = vec_45;



										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_686);
										mem_vec_686 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_687);
										mem_vec_687 = vec_47;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_672);
										mem_vec_672 = vec_48;

										vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_673);
										mem_vec_673 = vec_51;

										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_674);
										mem_vec_674 = vec_53;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_675);
										mem_vec_675 = vec_55;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_9);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_676);
										mem_vec_676 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_677);
										mem_vec_677 = vec_59;



										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_678);
										mem_vec_678 = vec_60;



										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_679);
										mem_vec_679 = vec_61;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_63 = _mm512_set1_ps(scal_10);


										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_680);
										mem_vec_680 = vec_62;



										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_681);
										mem_vec_681 = vec_64;



										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_682);
										mem_vec_682 = vec_65;



										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_683);
										mem_vec_683 = vec_66;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_684);
										mem_vec_684 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_685);
										mem_vec_685 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_686);
										mem_vec_686 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_687);
										mem_vec_687 = vec_71;
									}
