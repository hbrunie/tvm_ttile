...
c300_p_0 = 0;
						for (w = w174, wp_0 = 0;w < w174 + 3;w += 1, wp_0 += 1){
							...
							for (x = x326, xp_2 = x326_p_1, xp_1 = x326_p_0, xp_0 = 0;x < x326 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2613 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										...
										mem_vec_2617 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2613);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2617);
