		...
		c264 += 8, c264_p_0 += 8){
			for (y = y176, yp_0 = 0;
				...
				for (x352 = x353, x352_p_1 = x353_p_0, x352_p_0 = 0;
					x352 < x353 + 28;
					x352 += 28, x352_p_1 += 28, x352_p_0 += 28){
					// y = ph_y, x = 28, h = 3, w = 3, c = 8, f = 32
					// T (h, 3) (3 / 1)
					for (h = h132, hp_0 = 0;
						h < h132 + 3;
						...
						for (w = w142, wp_0 = 0;
							...
							for (x = x352, xp_2 = x352_p_1, xp_1 = x352_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1864 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_1865 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										mem_vec_1866 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
										mem_vec_1867 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
										mem_vec_1868 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_1869 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 8, f = 32
										// T (c, 8) (8 / 1)
										for (c = c264, cp_1 = c264_p_0, cp_0 = 0;
											c < c264 + 8;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1864);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_1865);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1866);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_1867);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1868);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_1869);
							}
						}
					}
				}
