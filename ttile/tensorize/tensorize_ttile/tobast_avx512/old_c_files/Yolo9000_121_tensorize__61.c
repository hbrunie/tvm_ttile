...
c548_p_1 = 0;
							for (h = h218, hp_0 = 0;h < h218 + 3;h += 1, hp_0 += 1){
								...
								for (x = x548, xp_2 = x548_p_1, xp_1 = x548_p_0, xp_0 = 0;x < x548 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_5225 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											mem_vec_5226 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
											mem_vec_5227 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_5225);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_5226);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_5227);
