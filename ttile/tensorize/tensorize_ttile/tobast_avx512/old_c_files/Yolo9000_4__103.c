...
[V f; U (4, f); U (2, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (34, x); T (68, y); T (2, f); T (4, c); T (4, x)]
*/
IND_TYPE c, cp_0, c114_p_0, cp_1, c114, f, fp_0, w, wp_0, x, xp_0, x150_p_0, x151_p_0, xp_1, x150_p_1, xp_2, x150, x151, y, yp_0;
	...
	for (c114 = c115, c114_p_0 = 0;
		...
		for (f = f76, fp_0 = 0;
			...
			for (y = y76, yp_0 = 0;
				...
				// T (x, 34) (34 / 1)
				for (x150 = x151, x150_p_1 = x151_p_0, x150_p_0 = 0;
					x150 < x151 + 34;
					x150 += 1, x150_p_1 += 1, x150_p_0 += 1){
					...
					for (w = w76, wp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x = x150, xp_2 = x150_p_1, xp_1 = x150_p_0, xp_0 = 0;
							x < x150 + 1;
