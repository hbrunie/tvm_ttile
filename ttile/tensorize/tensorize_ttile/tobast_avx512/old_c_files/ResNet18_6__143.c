...
for (c227 = c228, c227_p_0 = 0;
	...
	for (y = y148, yp_0 = 0;
		y < y148 + 28;
		y += 2, yp_0 += 2){
		// y = 2, x = 28, h = 3, w = 3, c = 32, f = 128
		// T (x, 28) (28 / 1)
		for (x222 = x223, x222_p_0 = 0;
			x222 < x223 + 28;
			x222 += 1, x222_p_0 += 1){
			// y = 2, x = 1, h = 3, w = 3, c = 32, f = 128
			// T (c, 1) (32 / 32)
				...
				for (h = h126, hp_0 = 0;
					...
					for (x = x222, xp_1 = x222_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_1078 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
								mem_vec_1079 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
								mem_vec_1080 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
								mem_vec_1081 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
								...
								mem_vec_1086 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
								mem_vec_1087 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
								mem_vec_1088 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
								mem_vec_1089 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
								// y = 2, x = 1, h = 1, w = 3, c = 32, f = 128
								// T (c, 32) (32 / 1)
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_1078);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_1079);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_1080);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_1081);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_1086);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_1087);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_1088);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_1089);
					}
				}
			}
		}
