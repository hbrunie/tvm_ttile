...
fp_1 = 0;
						for (x = x1120, xp_1 = x1120_p_0, xp_0 = 0;x < x1120 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_8493 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_8494 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_8495 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_8493);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_8494);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_8495);
						}
}
