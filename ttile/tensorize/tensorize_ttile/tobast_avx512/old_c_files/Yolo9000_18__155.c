							...
							for (w = w144, wp_0 = 0;
								...
								for (x = x216, xp_1 = x216_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_1927 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_1928 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_1929 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 32, f = 16
											// T (c, 32) (32 / 1)
											for (c = c254, cp_2 = c254_p_1, cp_1 = c254_p_0, cp_0 = 0;
												...
												vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1923);
												mem_vec_1923 = vec_3;
												...
												vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_1925);
												mem_vec_1925 = vec_7;
												...
												vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_1928);
												mem_vec_1928 = vec_13;
												scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
												vec_16 = _mm512_set1_ps(scal_7);


												vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_1929);
												mem_vec_1929 = vec_15;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
												vec_18 = _mm512_set1_ps(scal_8);
												vec_19 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

												vec_17 = _mm512_fmadd_ps(vec_18, vec_19, mem_vec_1922);
												mem_vec_1922 = vec_17;
												scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
												vec_21 = _mm512_set1_ps(scal_9);


												vec_20 = _mm512_fmadd_ps(vec_21, vec_19, mem_vec_1923);
												mem_vec_1923 = vec_20;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
												vec_23 = _mm512_set1_ps(scal_10);


												vec_22 = _mm512_fmadd_ps(vec_23, vec_19, mem_vec_1924);
												mem_vec_1924 = vec_22;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
												vec_25 = _mm512_set1_ps(scal_11);


												vec_24 = _mm512_fmadd_ps(vec_25, vec_19, mem_vec_1925);
												mem_vec_1925 = vec_24;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
												vec_27 = _mm512_set1_ps(scal_12);


												vec_26 = _mm512_fmadd_ps(vec_27, vec_19, mem_vec_1926);
												mem_vec_1926 = vec_26;
												scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
												vec_29 = _mm512_set1_ps(scal_13);


												vec_28 = _mm512_fmadd_ps(vec_29, vec_19, mem_vec_1927);
												mem_vec_1927 = vec_28;
												scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
												vec_31 = _mm512_set1_ps(scal_14);


												vec_30 = _mm512_fmadd_ps(vec_31, vec_19, mem_vec_1928);
												mem_vec_1928 = vec_30;
												scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
												vec_33 = _mm512_set1_ps(scal_15);


												vec_32 = _mm512_fmadd_ps(vec_33, vec_19, mem_vec_1929);
												mem_vec_1929 = vec_32;
												...
												vec_37 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_1923);
												mem_vec_1923 = vec_37;
												scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
												vec_40 = _mm512_set1_ps(scal_18);


												vec_39 = _mm512_fmadd_ps(vec_40, vec_36, mem_vec_1924);
												mem_vec_1924 = vec_39;
												scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
												vec_42 = _mm512_set1_ps(scal_19);


												vec_41 = _mm512_fmadd_ps(vec_42, vec_36, mem_vec_1925);
												mem_vec_1925 = vec_41;
												...
												vec_45 = _mm512_fmadd_ps(vec_46, vec_36, mem_vec_1927);
												mem_vec_1927 = vec_45;
												scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
												vec_48 = _mm512_set1_ps(scal_22);


												vec_47 = _mm512_fmadd_ps(vec_48, vec_36, mem_vec_1928);
												mem_vec_1928 = vec_47;
												scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
												vec_50 = _mm512_set1_ps(scal_23);


												vec_49 = _mm512_fmadd_ps(vec_50, vec_36, mem_vec_1929);
												mem_vec_1929 = vec_49;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_1927);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_1928);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_1929);
								}
							}
						}
					}
							...
							for (w = w144, wp_0 = 0;
								...
								for (x = x216, xp_1 = x216_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_1935 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_1936 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_1937 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_1935);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_1936);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_1937);
