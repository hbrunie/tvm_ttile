...
fp_1 = 0;
					for (h = h62, hp_0 = 0;h < h62 + 3;h += 1, hp_0 += 1){
						...
						for (x = x126, xp_1 = x126_p_0, xp_0 = 0;x < x126 + 7;x += 1, xp_1 += 1, xp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_750);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_753);
						}
					}
}
