...
[V f; U (2, f); U (7, y); U (3, w); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (2, y); T (2, f); T (1, c); T (8, f); T (512, c); T (7, x);
  T (1, f)]
*/
IND_TYPE c, cp_0, c218_p_0, c219_p_0, cp_1, c218_p_1, cp_2, c218, c219, f, fp_0, f182_p_0, f183_p_0, fp_1, f182_p_1, fp_2, f182, f183, h, hp_0, x, xp_0, x172_p_0, xp_1, x172, y, yp_0;
								...
								for (x = x172, xp_1 = x172_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c218, cp_2 = c218_p_1, cp_1 = c218_p_0, cp_0 = 0;
												...
												vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_966);
												mem_vec_966 = vec_23;

												vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_967);
												mem_vec_967 = vec_26;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_29 = _mm512_set1_ps(scal_8);


												vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_968);
												mem_vec_968 = vec_28;



												vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_969);
												mem_vec_969 = vec_30;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_32 = _mm512_set1_ps(scal_9);


												vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_970);
												mem_vec_970 = vec_31;



												vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_971);
												mem_vec_971 = vec_33;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_35 = _mm512_set1_ps(scal_10);


												vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_972);
												mem_vec_972 = vec_34;



												vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_973);
												mem_vec_973 = vec_36;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_38 = _mm512_set1_ps(scal_11);


												vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_974);
												mem_vec_974 = vec_37;



												vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_975);
												mem_vec_975 = vec_39;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
												vec_41 = _mm512_set1_ps(scal_12);


												vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_976);
												mem_vec_976 = vec_40;



												vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_977);
												mem_vec_977 = vec_42;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
												vec_44 = _mm512_set1_ps(scal_13);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_978);
												mem_vec_978 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_979);
												mem_vec_979 = vec_45;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_47 = _mm512_set1_ps(scal_14);
												vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_966);
												mem_vec_966 = vec_46;

												vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_967);
												mem_vec_967 = vec_49;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_52 = _mm512_set1_ps(scal_15);


												vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_968);
												mem_vec_968 = vec_51;



												vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_969);
												mem_vec_969 = vec_53;
												scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_55 = _mm512_set1_ps(scal_16);


												vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_970);
												mem_vec_970 = vec_54;



												vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_971);
												mem_vec_971 = vec_56;
												scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_58 = _mm512_set1_ps(scal_17);


												vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_972);
												mem_vec_972 = vec_57;



												vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_973);
												mem_vec_973 = vec_59;
												scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_61 = _mm512_set1_ps(scal_18);


												vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_974);
												mem_vec_974 = vec_60;



												vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_975);
												mem_vec_975 = vec_62;
												scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_64 = _mm512_set1_ps(scal_19);


												vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_976);
												mem_vec_976 = vec_63;



												vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_977);
												mem_vec_977 = vec_65;
												scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
												vec_67 = _mm512_set1_ps(scal_20);


												vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_978);
												mem_vec_978 = vec_66;



												vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_979);
												mem_vec_979 = vec_68;
											}
