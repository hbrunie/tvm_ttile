...
fp_1 = 0;
						for (w = w156, wp_0 = 0;w < w156 + 3;w += 1, wp_0 += 1){
							...
							for (x = x340, xp_1 = x340_p_0, xp_0 = 0;x < x340 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2031 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_2032 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_2033 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2031);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_2032);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_2033);
							}
						}
}
