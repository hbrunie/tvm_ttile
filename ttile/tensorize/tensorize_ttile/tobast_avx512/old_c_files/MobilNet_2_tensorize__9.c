...
c250_p_1 = 0;
				for (h = h112, hp_0 = 0;h < h112 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 8) (8 / 1)
					for (x = x282, xp_1 = x282_p_0, xp_0 = 0;x < x282 + 8;x += 1, xp_1 += 1, xp_0 += 1){
								mem_vec_1030 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
								mem_vec_1031 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
								mem_vec_1032 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
								mem_vec_1033 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
								...
								mem_vec_1036 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
								mem_vec_1037 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
								// y = 2, x = 1, h = 1, w = 3, c = 2, f = 64
								// T (c, 2) (2 / 1)
								for (c = c250, cp_2 = c250_p_1, cp_1 = c250_p_0, cp_0 = 0;c < c250 + 2;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_1030);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_1031);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_1032);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_1033);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_1036);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_1037);
					}
				}
}
