...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (17, y); T (2, f); T (128, c); T (1, f); T (34, x); T (2, f)]
*/
IND_TYPE c, cp_0, c66_p_0, cp_1, c66, f, fp_0, f88_p_0, f89_p_0, fp_1, f88_p_1, fp_2, f88, f89, w, wp_0, x, xp_0, x84_p_0, xp_1, x84, y, yp_0;
