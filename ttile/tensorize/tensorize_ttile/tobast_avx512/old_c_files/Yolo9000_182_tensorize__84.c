...
c522_p_1 = 0;
							for (h = h198, hp_0 = 0;h < h198 + 3;h += 1, hp_0 += 1){
								...
								for (x = x468, xp_1 = x468_p_0, xp_0 = 0;x < x468 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_4530 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
											...
											// y = ph_y, x = 1, h = 1, w = 3, c = 16, f = 16
											// T (c, 16) (16 / 1)
											for (c = c522, cp_2 = c522_p_1, cp_1 = c522_p_0, cp_0 = 0;c < c522 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_4530);
