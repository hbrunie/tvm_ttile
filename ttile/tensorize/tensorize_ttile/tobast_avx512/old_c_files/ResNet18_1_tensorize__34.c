...
/*
[V f; U (2, f); U (7, y); T (3, c); Hoist_vars [c]; T (4, x); T (7, w);
  T (7, h); T (14, x); T (16, y); T (2, f); T (2, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x32_p_0, x33_p_0, xp_1, x32_p_1, xp_2, x32, x33, y, yp_0;
IND_TYPE y16 = 0;
IND_TYPE x34 = 0;
IND_TYPE h16 = 0;
IND_TYPE w16 = 0;
...
x32_p_1 = 0;
				for (h = h16, hp_0 = 0;h < h16 + 7;h += 1, hp_0 += 1){
					// y = 7, x = 4, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w16, wp_0 = 0;w < w16 + 7;w += 1, wp_0 += 1){
						// y = 7, x = 4, h = 1, w = 1, c = 3, f = 32
						// T (x, 4) (4 / 1)
						for (x = x32, xp_2 = x32_p_1, xp_1 = x32_p_0, xp_0 = 0;x < x32 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
