...
for (x970 = x971, x970_p_0 = 0;
	...
	// T (x, 1) (34 / 34)
	for (x969 = x970, x969_p_1 = x970_p_0, x969_p_0 = 0;
		x969 < x970 + 34;
		x969 += 34, x969_p_1 += 34, x969_p_0 += 34){
		// y = 272, x = 34, h = 3, w = 3, c = 32, f = 64
		// T (c, 4) (32 / 8)
		for (c576 = c577, c576_p_0 = 0;
			...
			for (y = y404, yp_0 = 0;
				...
				// T (x, 1) (34 / 34)
				for (x968 = x969, x968_p_2 = x969_p_1, x968_p_1 = x969_p_0, x968_p_0 = 0;
					x968 < x969 + 34;
					x968 += 34, x968_p_2 += 34, x968_p_1 += 34, x968_p_0 += 34){
					// y = 4, x = 34, h = 3, w = 3, c = 8, f = 64
					// T (h, 3) (3 / 1)
					for (h = h308, hp_0 = 0;
						h < h308 + 3;
						...
						// T (x, 34) (34 / 1)
						for (x = x968, xp_3 = x968_p_2, xp_2 = x968_p_1, xp_1 = x968_p_0, xp_0 = 0;
							x < x968 + 34;
