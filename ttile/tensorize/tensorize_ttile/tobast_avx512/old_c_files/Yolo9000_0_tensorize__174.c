...
[V f; U (2, f); ULambda y; T (3, c); Hoist_vars [c]; T (17, x); T (3, w);
  ...
  T (32, x); T (8, y); T (1, x)]
*/
IND_TYPE c, cp_0, h, hp_0, w, wp_0, x, xp_0, x346_p_0, x347_p_0, xp_1, x346_p_1, xp_2, x346, x347, y, yp_0, y270_p_0, yp_1, y270;
IND_TYPE y271 = 0;
IND_TYPE x348 = 0;
IND_TYPE h156 = 0;
IND_TYPE w142 = 0;
...
y270 = 0;
y270_p_0 = 0;
		for (x346 = x347, x346_p_1 = x347_p_0, x346_p_0 = 0;x346 < x347 + 544;x346 += 17, x346_p_1 += 17, x346_p_0 += 17){
				for (y = y270, yp_1 = y270_p_0, yp_0 = 0;y < y270 + 12;y += 12, yp_1 += 12, yp_0 += 12){
					...
					for (h = h156, hp_0 = 0;h < h156 + 3;h += 1, hp_0 += 1){
						...
						for (w = w142, wp_0 = 0;w < w142 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 17) (17 / 1)
							for (x = x346, xp_2 = x346_p_1, xp_1 = x346_p_0, xp_0 = 0;x < x346 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c176, cp_0 = 0;c < c176 + 3;c += 1, cp_0 += 1){
				...
				for (y = y270 + 12, yp_1 = y270_p_0, yp_0 = 0;y < y270 + 12 + 56;y += 14, yp_1 += 14, yp_0 += 14){
					// y = ph_y, x = 17, h = 3, w = 3, c = 3, f = 32
					// T (h, 3) (3 / 1)
					for (h = h156, hp_0 = 0;h < h156 + 3;h += 1, hp_0 += 1){
						// y = ph_y, x = 17, h = 1, w = 3, c = 3, f = 32
						...
						for (w = w142, wp_0 = 0;w < w142 + 3;w += 1, wp_0 += 1){
							...
							for (x = x346, xp_2 = x346_p_1, xp_1 = x346_p_0, xp_0 = 0;x < x346 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2216 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_2217 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
										mem_vec_2218 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_2219 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 3, f = 32
										// T (c, 3) (3 / 1)
										for (c = c176, cp_0 = 0;c < c176 + 3;c += 1, cp_0 += 1){
											scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
											...
											vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_2216);
											mem_vec_2216 = vec_38;
											vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_2217);
											mem_vec_2217 = vec_40;
											scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 13 + h) + c];
											vec_42 = _mm512_set1_ps(scal_13);
											vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_2218);
											mem_vec_2218 = vec_41;
											vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_2219);
											mem_vec_2219 = vec_43;
										}
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_2216);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_2217);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_2218);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_2219);
							}
						}
					}
				}
