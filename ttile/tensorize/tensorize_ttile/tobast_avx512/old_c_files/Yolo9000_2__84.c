...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (8, c); Hoist_vars [c];
  T (1, x); T (136, x); T (68, y); T (4, f); T (4, c); T (1, x); T (2, x)]
*/
IND_TYPE c, cp_0, c606_p_0, cp_1, c606, f, fp_0, x, xp_0, x1018_p_0, x1019_p_0, x1020_p_0, xp_1, x1018_p_1, x1019_p_1, xp_2, x1018_p_2, xp_3, x1018, x1019, x1020, y, yp_0;
...
__m512 mem_vec_2376 ,mem_vec_2377 ,mem_vec_2378 ,mem_vec_2379 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_9;
// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
// T (x, 2) (272 / 136)
for (x1020 = x1021, x1020_p_0 = 0;
	x1020 < x1021 + 272;
	x1020 += 136, x1020_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 1) (136 / 136)
	for (x1019 = x1020, x1019_p_1 = x1020_p_0, x1019_p_0 = 0;
		x1019 < x1020 + 136;
		x1019 += 136, x1019_p_1 += 136, x1019_p_0 += 136){
		// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
		// T (c, 4) (32 / 8)
		for (c606 = c607, c606_p_0 = 0;
			...
			for (f = f326, fp_0 = 0;
				f < f326 + 64;
				f += 16, fp_0 += 16){
				// y = 272, x = 136, h = 3, w = 3, c = 8, f = 16
				// T (y, 68) (272 / 4)
				for (y = y424, yp_0 = 0;
					y < y424 + 272;
					y += 4, yp_0 += 4){
					// y = 4, x = 136, h = 3, w = 3, c = 8, f = 16
					// T (x, 136) (136 / 1)
					for (x1018 = x1019, x1018_p_2 = x1019_p_1, x1018_p_1 = x1019_p_0, x1018_p_0 = 0;
						x1018 < x1019 + 136;
						x1018 += 1, x1018_p_2 += 1, x1018_p_1 += 1, x1018_p_0 += 1){
						// y = 4, x = 1, h = 3, w = 3, c = 8, f = 16
						// T (x, 1) (1 / 1)
						for (x = x1018, xp_3 = x1018_p_2, xp_2 = x1018_p_1, xp_1 = x1018_p_0, xp_0 = 0;
							x < x1018 + 1;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_2376 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_2377 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_2378 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_2379 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									// y = 4, x = 1, h = 3, w = 3, c = 8, f = 16
									// T (c, 8) (8 / 1)
									for (c = c606, cp_1 = c606_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2377);
										mem_vec_2377 = vec_3;
