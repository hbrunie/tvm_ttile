...
c1388_p_2 = 0;
							for (w = w464, wp_0 = 0;w < w464 + 3;w += 1, wp_0 += 1){
								...
								for (x = x584, xp_0 = 0;x < x584 + 7;x += 1, xp_0 += 1){
											...
											mem_vec_5158 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
											mem_vec_5159 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_5158);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_5159);
								}
							}
}
