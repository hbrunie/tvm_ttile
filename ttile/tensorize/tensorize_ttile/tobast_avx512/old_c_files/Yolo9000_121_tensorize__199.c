							...
							for (h = h36, hp_0 = 0;h < h36 + 3;h += 1, hp_0 += 1){
								...
								for (w = w42, wp_0 = 0;w < w42 + 3;w += 1, wp_0 += 1){
									...
									for (x = x66, xp_1 = x66_p_0, xp_0 = 0;x < x66 + 34;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_506 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
												mem_vec_507 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_506);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_507);
									}
								}
							}
}
