...
*/
IND_TYPE c, cp_0, c50_p_0, c51_p_0, cp_1, c50_p_1, cp_2, c50, c51, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y18 = 0;
IND_TYPE x32 = 0;
IND_TYPE h32 = 0;
IND_TYPE w32 = 0;
				...
				for (h = h32, hp_0 = 0;h < h32 + 3;h += 1, hp_0 += 1){
					...
					for (w = w32, wp_0 = 0;w < w32 + 3;w += 1, wp_0 += 1){
						...
						for (x = x32, xp_0 = 0;x < x32 + 7;x += 1, xp_0 += 1){
									...
									// T (c, 4) (4 / 1)
									for (c = c50, cp_2 = c50_p_1, cp_1 = c50_p_0, cp_0 = 0;c < c50 + 4;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
