...
c554_p_1 = 0;
							for (h = h214, hp_0 = 0;h < h214 + 3;h += 1, hp_0 += 1){
								...
								for (x = x492, xp_1 = x492_p_0, xp_0 = 0;x < x492 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_4606 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
											mem_vec_4607 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_4606);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_4607);
