...
/*
[V f; U (2, f); ULambda y; U (3, w); T (64, c); Hoist_vars [c]; T (17, x);
  T (3, h); T (4, f); T (2, x);
  Lambda_apply y [((Iter 1), (Arg 10)); ((Iter 2), (Arg 12))]; T (1, f);
  T (4, c); T (4, f)]
*/
IND_TYPE c, cp_0, c746_p_0, cp_1, c746, f, fp_0, f808_p_0, f809_p_0, fp_1, f808_p_1, fp_2, f808, f809, h, hp_0, x, xp_0, x746_p_0, xp_1, x746, y, yp_0;
							...
							for (h = h346, hp_0 = 0;
								...
								for (x = x746, xp_1 = x746_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_7126 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
											mem_vec_7127 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
											mem_vec_7128 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
											mem_vec_7129 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
											mem_vec_7130 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_7131 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_7132 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_7133 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_7134 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
											mem_vec_7135 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
											mem_vec_7136 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
											mem_vec_7137 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
											mem_vec_7138 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
											mem_vec_7139 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
											...
											for (c = c746, cp_1 = c746_p_0, cp_0 = 0;
												...
												vec_5 = _mm512_fmadd_ps(vec_6, vec_2, mem_vec_7122);
												mem_vec_7122 = vec_5;



												vec_7 = _mm512_fmadd_ps(vec_6, vec_4, mem_vec_7123);
												mem_vec_7123 = vec_7;
												scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
												vec_9 = _mm512_set1_ps(scal_2);


												vec_8 = _mm512_fmadd_ps(vec_9, vec_2, mem_vec_7124);
												mem_vec_7124 = vec_8;



												vec_10 = _mm512_fmadd_ps(vec_9, vec_4, mem_vec_7125);
												mem_vec_7125 = vec_10;
												scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h) + c];
												vec_12 = _mm512_set1_ps(scal_3);


												vec_11 = _mm512_fmadd_ps(vec_12, vec_2, mem_vec_7126);
												mem_vec_7126 = vec_11;



												vec_13 = _mm512_fmadd_ps(vec_12, vec_4, mem_vec_7127);
												mem_vec_7127 = vec_13;
												...
												vec_17 = _mm512_fmadd_ps(vec_18, vec_2, mem_vec_7130);
												mem_vec_7130 = vec_17;



												vec_19 = _mm512_fmadd_ps(vec_18, vec_4, mem_vec_7131);
												mem_vec_7131 = vec_19;
												scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
												vec_21 = _mm512_set1_ps(scal_6);


												vec_20 = _mm512_fmadd_ps(vec_21, vec_2, mem_vec_7132);
												mem_vec_7132 = vec_20;



												vec_22 = _mm512_fmadd_ps(vec_21, vec_4, mem_vec_7133);
												mem_vec_7133 = vec_22;
												scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
												vec_24 = _mm512_set1_ps(scal_7);


												vec_23 = _mm512_fmadd_ps(vec_24, vec_2, mem_vec_7134);
												mem_vec_7134 = vec_23;



												vec_25 = _mm512_fmadd_ps(vec_24, vec_4, mem_vec_7135);
												mem_vec_7135 = vec_25;
												scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h) + c];
												vec_27 = _mm512_set1_ps(scal_8);


												vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_7136);
												mem_vec_7136 = vec_26;



												vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_7137);
												mem_vec_7137 = vec_28;
												...
												vec_32 = _mm512_fmadd_ps(vec_33, vec_34, mem_vec_7120);
												mem_vec_7120 = vec_32;

												vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_35 = _mm512_fmadd_ps(vec_33, vec_36, mem_vec_7121);
												mem_vec_7121 = vec_35;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_38 = _mm512_set1_ps(scal_11);


												vec_37 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_7122);
												mem_vec_7122 = vec_37;



												vec_39 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_7123);
												mem_vec_7123 = vec_39;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_41 = _mm512_set1_ps(scal_12);


												vec_40 = _mm512_fmadd_ps(vec_41, vec_34, mem_vec_7124);
												mem_vec_7124 = vec_40;



												vec_42 = _mm512_fmadd_ps(vec_41, vec_36, mem_vec_7125);
												mem_vec_7125 = vec_42;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_44 = _mm512_set1_ps(scal_13);


												vec_43 = _mm512_fmadd_ps(vec_44, vec_34, mem_vec_7126);
												mem_vec_7126 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_7127);
												mem_vec_7127 = vec_45;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_47 = _mm512_set1_ps(scal_14);


												vec_46 = _mm512_fmadd_ps(vec_47, vec_34, mem_vec_7128);
												mem_vec_7128 = vec_46;



												vec_48 = _mm512_fmadd_ps(vec_47, vec_36, mem_vec_7129);
												mem_vec_7129 = vec_48;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
												vec_50 = _mm512_set1_ps(scal_15);


												vec_49 = _mm512_fmadd_ps(vec_50, vec_34, mem_vec_7130);
												mem_vec_7130 = vec_49;



												vec_51 = _mm512_fmadd_ps(vec_50, vec_36, mem_vec_7131);
												mem_vec_7131 = vec_51;
												scal_16 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
												vec_53 = _mm512_set1_ps(scal_16);


												vec_52 = _mm512_fmadd_ps(vec_53, vec_34, mem_vec_7132);
												mem_vec_7132 = vec_52;



												vec_54 = _mm512_fmadd_ps(vec_53, vec_36, mem_vec_7133);
												mem_vec_7133 = vec_54;
												scal_17 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
												vec_56 = _mm512_set1_ps(scal_17);


												vec_55 = _mm512_fmadd_ps(vec_56, vec_34, mem_vec_7134);
												mem_vec_7134 = vec_55;



												vec_57 = _mm512_fmadd_ps(vec_56, vec_36, mem_vec_7135);
												mem_vec_7135 = vec_57;
												scal_18 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
												vec_59 = _mm512_set1_ps(scal_18);


												vec_58 = _mm512_fmadd_ps(vec_59, vec_34, mem_vec_7136);
												mem_vec_7136 = vec_58;



												vec_60 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_7137);
												mem_vec_7137 = vec_60;
												scal_19 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
												vec_62 = _mm512_set1_ps(scal_19);


												vec_61 = _mm512_fmadd_ps(vec_62, vec_34, mem_vec_7138);
												mem_vec_7138 = vec_61;



												vec_63 = _mm512_fmadd_ps(vec_62, vec_36, mem_vec_7139);
												mem_vec_7139 = vec_63;
												scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_65 = _mm512_set1_ps(scal_20);
												vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_64 = _mm512_fmadd_ps(vec_65, vec_66, mem_vec_7120);
												mem_vec_7120 = vec_64;

												vec_68 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_67 = _mm512_fmadd_ps(vec_65, vec_68, mem_vec_7121);
												mem_vec_7121 = vec_67;
												scal_21 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_70 = _mm512_set1_ps(scal_21);


												vec_69 = _mm512_fmadd_ps(vec_70, vec_66, mem_vec_7122);
												mem_vec_7122 = vec_69;



												vec_71 = _mm512_fmadd_ps(vec_70, vec_68, mem_vec_7123);
												mem_vec_7123 = vec_71;
												scal_22 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_73 = _mm512_set1_ps(scal_22);


												vec_72 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_7124);
												mem_vec_7124 = vec_72;



												vec_74 = _mm512_fmadd_ps(vec_73, vec_68, mem_vec_7125);
												mem_vec_7125 = vec_74;
												scal_23 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_76 = _mm512_set1_ps(scal_23);


												vec_75 = _mm512_fmadd_ps(vec_76, vec_66, mem_vec_7126);
												mem_vec_7126 = vec_75;



												vec_77 = _mm512_fmadd_ps(vec_76, vec_68, mem_vec_7127);
												mem_vec_7127 = vec_77;
												scal_24 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_79 = _mm512_set1_ps(scal_24);


												vec_78 = _mm512_fmadd_ps(vec_79, vec_66, mem_vec_7128);
												mem_vec_7128 = vec_78;



												vec_80 = _mm512_fmadd_ps(vec_79, vec_68, mem_vec_7129);
												mem_vec_7129 = vec_80;
												scal_25 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_82 = _mm512_set1_ps(scal_25);


												vec_81 = _mm512_fmadd_ps(vec_82, vec_66, mem_vec_7130);
												mem_vec_7130 = vec_81;



												vec_83 = _mm512_fmadd_ps(vec_82, vec_68, mem_vec_7131);
												mem_vec_7131 = vec_83;
												scal_26 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
												vec_85 = _mm512_set1_ps(scal_26);


												vec_84 = _mm512_fmadd_ps(vec_85, vec_66, mem_vec_7132);
												mem_vec_7132 = vec_84;



												vec_86 = _mm512_fmadd_ps(vec_85, vec_68, mem_vec_7133);
												mem_vec_7133 = vec_86;
												scal_27 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
												vec_88 = _mm512_set1_ps(scal_27);


												vec_87 = _mm512_fmadd_ps(vec_88, vec_66, mem_vec_7134);
												mem_vec_7134 = vec_87;



												vec_89 = _mm512_fmadd_ps(vec_88, vec_68, mem_vec_7135);
												mem_vec_7135 = vec_89;
												scal_28 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
												vec_91 = _mm512_set1_ps(scal_28);


												vec_90 = _mm512_fmadd_ps(vec_91, vec_66, mem_vec_7136);
												mem_vec_7136 = vec_90;



												vec_92 = _mm512_fmadd_ps(vec_91, vec_68, mem_vec_7137);
												mem_vec_7137 = vec_92;
												scal_29 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
												vec_94 = _mm512_set1_ps(scal_29);


												vec_93 = _mm512_fmadd_ps(vec_94, vec_66, mem_vec_7138);
												mem_vec_7138 = vec_93;



												vec_95 = _mm512_fmadd_ps(vec_94, vec_68, mem_vec_7139);
												mem_vec_7139 = vec_95;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_7126);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_7127);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_7128);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_7129);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_7130);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_7131);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_7132);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_7133);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_7134);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_7135);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_7136);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_7137);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_7138);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_7139);
								}
							}
						}
					}
							...
							for (h = h346, hp_0 = 0;
								...
								for (x = x746, xp_1 = x746_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_7162 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_7163 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 3, c = 64, f = 32
											// T (c, 64) (64 / 1)
											for (c = c746, cp_1 = c746_p_0, cp_0 = 0;
												c < c746 + 64;
												...
												vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_7162);
												mem_vec_7162 = vec_35;



												vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_7163);
												mem_vec_7163 = vec_37;
												...
												vec_43 = _mm512_fmadd_ps(vec_44, vec_40, mem_vec_7142);
												mem_vec_7142 = vec_43;



												vec_45 = _mm512_fmadd_ps(vec_44, vec_42, mem_vec_7143);
												mem_vec_7143 = vec_45;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_47 = _mm512_set1_ps(scal_14);


												vec_46 = _mm512_fmadd_ps(vec_47, vec_40, mem_vec_7144);
												mem_vec_7144 = vec_46;



												vec_48 = _mm512_fmadd_ps(vec_47, vec_42, mem_vec_7145);
												mem_vec_7145 = vec_48;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_50 = _mm512_set1_ps(scal_15);


												vec_49 = _mm512_fmadd_ps(vec_50, vec_40, mem_vec_7146);
												mem_vec_7146 = vec_49;



												vec_51 = _mm512_fmadd_ps(vec_50, vec_42, mem_vec_7147);
												mem_vec_7147 = vec_51;
												...
												vec_55 = _mm512_fmadd_ps(vec_56, vec_40, mem_vec_7150);
												mem_vec_7150 = vec_55;



												vec_57 = _mm512_fmadd_ps(vec_56, vec_42, mem_vec_7151);
												mem_vec_7151 = vec_57;
												scal_18 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
												vec_59 = _mm512_set1_ps(scal_18);


												vec_58 = _mm512_fmadd_ps(vec_59, vec_40, mem_vec_7152);
												mem_vec_7152 = vec_58;



												vec_60 = _mm512_fmadd_ps(vec_59, vec_42, mem_vec_7153);
												mem_vec_7153 = vec_60;
												scal_19 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
												vec_62 = _mm512_set1_ps(scal_19);


												vec_61 = _mm512_fmadd_ps(vec_62, vec_40, mem_vec_7154);
												mem_vec_7154 = vec_61;



												vec_63 = _mm512_fmadd_ps(vec_62, vec_42, mem_vec_7155);
												mem_vec_7155 = vec_63;
												scal_20 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
												vec_65 = _mm512_set1_ps(scal_20);


												vec_64 = _mm512_fmadd_ps(vec_65, vec_40, mem_vec_7156);
												mem_vec_7156 = vec_64;



												vec_66 = _mm512_fmadd_ps(vec_65, vec_42, mem_vec_7157);
												mem_vec_7157 = vec_66;
												scal_21 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
												vec_68 = _mm512_set1_ps(scal_21);


												vec_67 = _mm512_fmadd_ps(vec_68, vec_40, mem_vec_7158);
												mem_vec_7158 = vec_67;



												vec_69 = _mm512_fmadd_ps(vec_68, vec_42, mem_vec_7159);
												mem_vec_7159 = vec_69;
												scal_22 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
												vec_71 = _mm512_set1_ps(scal_22);


												vec_70 = _mm512_fmadd_ps(vec_71, vec_40, mem_vec_7160);
												mem_vec_7160 = vec_70;



												vec_72 = _mm512_fmadd_ps(vec_71, vec_42, mem_vec_7161);
												mem_vec_7161 = vec_72;
												scal_23 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h) + c];
												vec_74 = _mm512_set1_ps(scal_23);


												vec_73 = _mm512_fmadd_ps(vec_74, vec_40, mem_vec_7162);
												mem_vec_7162 = vec_73;



												vec_75 = _mm512_fmadd_ps(vec_74, vec_42, mem_vec_7163);
												mem_vec_7163 = vec_75;
												scal_24 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_77 = _mm512_set1_ps(scal_24);
												vec_78 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_76 = _mm512_fmadd_ps(vec_77, vec_78, mem_vec_7140);
												mem_vec_7140 = vec_76;

												vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_79 = _mm512_fmadd_ps(vec_77, vec_80, mem_vec_7141);
												mem_vec_7141 = vec_79;
												scal_25 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_82 = _mm512_set1_ps(scal_25);


												vec_81 = _mm512_fmadd_ps(vec_82, vec_78, mem_vec_7142);
												mem_vec_7142 = vec_81;



												vec_83 = _mm512_fmadd_ps(vec_82, vec_80, mem_vec_7143);
												mem_vec_7143 = vec_83;
												scal_26 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_85 = _mm512_set1_ps(scal_26);


												vec_84 = _mm512_fmadd_ps(vec_85, vec_78, mem_vec_7144);
												mem_vec_7144 = vec_84;



												vec_86 = _mm512_fmadd_ps(vec_85, vec_80, mem_vec_7145);
												mem_vec_7145 = vec_86;
												scal_27 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_88 = _mm512_set1_ps(scal_27);


												vec_87 = _mm512_fmadd_ps(vec_88, vec_78, mem_vec_7146);
												mem_vec_7146 = vec_87;



												vec_89 = _mm512_fmadd_ps(vec_88, vec_80, mem_vec_7147);
												mem_vec_7147 = vec_89;
												scal_28 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_91 = _mm512_set1_ps(scal_28);


												vec_90 = _mm512_fmadd_ps(vec_91, vec_78, mem_vec_7148);
												mem_vec_7148 = vec_90;



												vec_92 = _mm512_fmadd_ps(vec_91, vec_80, mem_vec_7149);
												mem_vec_7149 = vec_92;
												scal_29 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_94 = _mm512_set1_ps(scal_29);


												vec_93 = _mm512_fmadd_ps(vec_94, vec_78, mem_vec_7150);
												mem_vec_7150 = vec_93;



												vec_95 = _mm512_fmadd_ps(vec_94, vec_80, mem_vec_7151);
												mem_vec_7151 = vec_95;
												scal_30 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
												vec_97 = _mm512_set1_ps(scal_30);


												vec_96 = _mm512_fmadd_ps(vec_97, vec_78, mem_vec_7152);
												mem_vec_7152 = vec_96;



												vec_98 = _mm512_fmadd_ps(vec_97, vec_80, mem_vec_7153);
												mem_vec_7153 = vec_98;
												scal_31 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
												vec_100 = _mm512_set1_ps(scal_31);


												vec_99 = _mm512_fmadd_ps(vec_100, vec_78, mem_vec_7154);
												mem_vec_7154 = vec_99;



												vec_101 = _mm512_fmadd_ps(vec_100, vec_80, mem_vec_7155);
												mem_vec_7155 = vec_101;
												scal_32 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
												vec_103 = _mm512_set1_ps(scal_32);


												vec_102 = _mm512_fmadd_ps(vec_103, vec_78, mem_vec_7156);
												mem_vec_7156 = vec_102;



												vec_104 = _mm512_fmadd_ps(vec_103, vec_80, mem_vec_7157);
												mem_vec_7157 = vec_104;
												scal_33 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
												vec_106 = _mm512_set1_ps(scal_33);


												vec_105 = _mm512_fmadd_ps(vec_106, vec_78, mem_vec_7158);
												mem_vec_7158 = vec_105;



												vec_107 = _mm512_fmadd_ps(vec_106, vec_80, mem_vec_7159);
												mem_vec_7159 = vec_107;
												scal_34 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h) + c];
												vec_109 = _mm512_set1_ps(scal_34);


												vec_108 = _mm512_fmadd_ps(vec_109, vec_78, mem_vec_7160);
												mem_vec_7160 = vec_108;



												vec_110 = _mm512_fmadd_ps(vec_109, vec_80, mem_vec_7161);
												mem_vec_7161 = vec_110;
												scal_35 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h) + c];
												vec_112 = _mm512_set1_ps(scal_35);


												vec_111 = _mm512_fmadd_ps(vec_112, vec_78, mem_vec_7162);
												mem_vec_7162 = vec_111;



												vec_113 = _mm512_fmadd_ps(vec_112, vec_80, mem_vec_7163);
												mem_vec_7163 = vec_113;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_7162);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_7163);
								}
							}
						}
					}
