...
[V f; U (2, f); U (4, y); U (3, w); T (2, c); Hoist_vars [c]; T (4, x);
  T (3, h); T (14, x); T (14, y); T (2, f); T (32, c); T (1, x)]
*/
IND_TYPE c, cp_0, c200_p_0, cp_1, c200, f, fp_0, h, hp_0, x, xp_0, x234_p_0, x235_p_0, xp_1, x234_p_1, xp_2, x234, x235, y, yp_0;
IND_TYPE y124 = 0;
IND_TYPE x236 = 0;
IND_TYPE h90 = 0;
IND_TYPE w = 0;
...
x234_p_1 = 0;
					for (h = h90, hp_0 = 0;h < h90 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 4) (4 / 1)
						for (x = x234, xp_2 = x234_p_1, xp_1 = x234_p_0, xp_0 = 0;x < x234 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 2) (2 / 1)
									for (c = c200, cp_1 = c200_p_0, cp_0 = 0;c < c200 + 2;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_894);
										mem_vec_894 = vec_14;
										vec_18 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_895);
										mem_vec_895 = vec_17;
										scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
										vec_20 = _mm512_set1_ps(scal_5);
										vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_896);
										mem_vec_896 = vec_19;
										vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_897);
										mem_vec_897 = vec_21;
										scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
										vec_23 = _mm512_set1_ps(scal_6);
										vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_898);
										mem_vec_898 = vec_22;
										vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_899);
										mem_vec_899 = vec_24;
										scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
										vec_26 = _mm512_set1_ps(scal_7);
										vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_900);
										mem_vec_900 = vec_25;
										vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_901);
										mem_vec_901 = vec_27;
										scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
										vec_29 = _mm512_set1_ps(scal_8);
										vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_894);
										mem_vec_894 = vec_28;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_895);
										mem_vec_895 = vec_31;
										scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
										vec_34 = _mm512_set1_ps(scal_9);
										vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_896);
										mem_vec_896 = vec_33;
										vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_897);
										mem_vec_897 = vec_35;
										scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
										vec_37 = _mm512_set1_ps(scal_10);
										vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_898);
										mem_vec_898 = vec_36;
										vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_899);
										mem_vec_899 = vec_38;
										scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
										vec_40 = _mm512_set1_ps(scal_11);
										vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_900);
										mem_vec_900 = vec_39;
										vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_901);
										mem_vec_901 = vec_41;
									}
