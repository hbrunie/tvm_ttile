...
x814_p_1 = 0;
						for (w = w340, wp_0 = 0;w < w340 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 17) (17 / 1)
							for (x = x814, xp_2 = x814_p_1, xp_1 = x814_p_0, xp_0 = 0;x < x814 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4828 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_4829 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										mem_vec_4830 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_4831 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_4828);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_4829);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_4830);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_4831);
							}
						}
}
