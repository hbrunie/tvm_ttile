...
[V f; U (2, f); U (7, y); U (3, h); T (1, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (1, c); T (1, f); T (2, c); T (32, f); T (512, c)]
*/
IND_TYPE c, cp_0, c448_p_0, c449_p_0, c450_p_0, cp_1, c448_p_1, c449_p_1, cp_2, c448_p_2, cp_3, c448, c449, c450, f, fp_0, f304_p_0, fp_1, f304, w, wp_0, x, xp_0;
...
for (c450 = c451, c450_p_0 = 0;
	...
	for (f304 = f305, f304_p_0 = 0;
		...
		// T (c, 2) (2 / 1)
		for (c449 = c450, c449_p_1 = c450_p_0, c449_p_0 = 0;
			c449 < c450 + 2;
			c449 += 1, c449_p_1 += 1, c449_p_0 += 1){
			...
			for (f = f304, fp_1 = f304_p_0, fp_0 = 0;
				...
				// y = 7, x = 7, h = 3, w = 3, c = 1, f = 32
				// T (c, 1) (1 / 1)
				for (c448 = c449, c448_p_2 = c449_p_1, c448_p_1 = c449_p_0, c448_p_0 = 0;
					c448 < c449 + 1;
					c448 += 1, c448_p_2 += 1, c448_p_1 += 1, c448_p_0 += 1){
					// y = 7, x = 7, h = 3, w = 3, c = 1, f = 32
					// T (w, 3) (3 / 1)
					for (w = w188, wp_0 = 0;
						w < w188 + 3;
						...
						for (x = x188, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									// T (c, 1) (1 / 1)
									for (c = c448, cp_3 = c448_p_2, cp_2 = c448_p_1, cp_1 = c448_p_0, cp_0 = 0;
										c < c448 + 1;
										...
										vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_1442);
										mem_vec_1442 = vec_23;

										vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_1443);
										mem_vec_1443 = vec_26;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_8);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_1444);
										mem_vec_1444 = vec_28;



										vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_1445);
										mem_vec_1445 = vec_30;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_1446);
										mem_vec_1446 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_1447);
										mem_vec_1447 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_1448);
										mem_vec_1448 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_1449);
										mem_vec_1449 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_1450);
										mem_vec_1450 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_1451);
										mem_vec_1451 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_1452);
										mem_vec_1452 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_1453);
										mem_vec_1453 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_1454);
										mem_vec_1454 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_1455);
										mem_vec_1455 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_1442);
										mem_vec_1442 = vec_46;

										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_1443);
										mem_vec_1443 = vec_49;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_52 = _mm512_set1_ps(scal_15);


										vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_1444);
										mem_vec_1444 = vec_51;



										vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_1445);
										mem_vec_1445 = vec_53;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_55 = _mm512_set1_ps(scal_16);


										vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_1446);
										mem_vec_1446 = vec_54;



										vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_1447);
										mem_vec_1447 = vec_56;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_1448);
										mem_vec_1448 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1449);
										mem_vec_1449 = vec_59;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_61 = _mm512_set1_ps(scal_18);


										vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_1450);
										mem_vec_1450 = vec_60;



										vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_1451);
										mem_vec_1451 = vec_62;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_1452);
										mem_vec_1452 = vec_63;



										vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_1453);
										mem_vec_1453 = vec_65;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);


										vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_1454);
										mem_vec_1454 = vec_66;



										vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_1455);
										mem_vec_1455 = vec_68;
									}
