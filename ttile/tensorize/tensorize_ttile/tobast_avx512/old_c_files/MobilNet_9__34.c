...
[V f; U (4, f); U (7, y); T (1, c); Hoist_vars [c]; T (7, x); T (3, w);
  T (3, h); T (4, c); T (2, f); T (1, y); T (128, c); T (8, f); T (2, c)]
*/
IND_TYPE c, cp_0, c170_p_0, c171_p_0, c172_p_0, cp_1, c170_p_1, c171_p_1, cp_2, c170_p_2, cp_3, c170, c171, c172, f, fp_0, f102_p_0, fp_1, f102, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
			...
			for (y = y46, yp_0 = 0;
				...
				for (f = f102, fp_1 = f102_p_0, fp_0 = 0;
					...
					for (c170 = c171, c170_p_2 = c171_p_1, c170_p_1 = c171_p_0, c170_p_0 = 0;
						c170 < c171 + 4;
						c170 += 1, c170_p_2 += 1, c170_p_1 += 1, c170_p_0 += 1){
