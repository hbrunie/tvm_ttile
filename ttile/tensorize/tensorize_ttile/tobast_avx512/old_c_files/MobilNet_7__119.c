...
[V f; U (2, f); ULambda y; U (3, w); T (4, c); Hoist_vars [c]; T (14, x);
  ...
  T (8, f); T (16, c); T (2, f); T (8, c); T (1, x); T (1, f)]
*/
IND_TYPE c, cp_0, c716_p_0, c717_p_0, cp_1, c716_p_1, cp_2, c716, c717, f, fp_0, f576_p_0, f577_p_0, fp_1, f576_p_1, fp_2, f576, f577, h, hp_0, x, xp_0, x554_p_0, xp_1, x554, y, yp_0;
	...
	for (x554 = x555, x554_p_0 = 0;
		...
		for (c717 = c718, c717_p_0 = 0;
			...
			for (f576 = f577, f576_p_1 = f577_p_0, f576_p_0 = 0;
				f576 < f577 + 512;
				f576 += 256, f576_p_1 += 256, f576_p_0 += 256){
