...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (1, c); Hoist_vars [c];
  T (7, x); T (1, f); T (1, c); T (8, f); T (8, f); T (1024, c)]
*/
IND_TYPE c, cp_0, c1080_p_0, c1081_p_0, cp_1, c1080_p_1, cp_2, c1080, c1081, f, fp_0, f760_p_0, f761_p_0, fp_1, f760_p_1, fp_2, f760, f761, x, xp_0;
...
for (c1081 = c1082, c1081_p_0 = 0;
	...
	for (f761 = f762, f761_p_0 = 0;
		...
		for (f760 = f761, f760_p_1 = f761_p_0, f760_p_0 = 0;
			f760 < f761 + 128;
			f760 += 16, f760_p_1 += 16, f760_p_0 += 16){
					...
					for (x = x460, xp_0 = 0;
						...
						x += 1, xp_0 += 1){
								...
								for (c = c1080, cp_2 = c1080_p_1, cp_1 = c1080_p_0, cp_0 = 0;
									...
									vec_120 = _mm512_fmadd_ps(vec_121, vec_122, mem_vec_3794);
									mem_vec_3794 = vec_120;
									scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
									vec_124 = _mm512_set1_ps(scal_57);


									vec_123 = _mm512_fmadd_ps(vec_124, vec_122, mem_vec_3795);
									mem_vec_3795 = vec_123;
									scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
									vec_126 = _mm512_set1_ps(scal_58);


									vec_125 = _mm512_fmadd_ps(vec_126, vec_122, mem_vec_3796);
									mem_vec_3796 = vec_125;
									scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
									vec_128 = _mm512_set1_ps(scal_59);


									vec_127 = _mm512_fmadd_ps(vec_128, vec_122, mem_vec_3797);
									mem_vec_3797 = vec_127;
									scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
									vec_130 = _mm512_set1_ps(scal_60);


									vec_129 = _mm512_fmadd_ps(vec_130, vec_122, mem_vec_3798);
									mem_vec_3798 = vec_129;
									scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
									vec_132 = _mm512_set1_ps(scal_61);


									vec_131 = _mm512_fmadd_ps(vec_132, vec_122, mem_vec_3799);
									mem_vec_3799 = vec_131;
									scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
									vec_134 = _mm512_set1_ps(scal_62);


									vec_133 = _mm512_fmadd_ps(vec_134, vec_122, mem_vec_3800);
									mem_vec_3800 = vec_133;
								}
