								...
								for (w = w98, wp_0 = 0;
									...
									for (x = x150, xp_1 = x150_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_1806 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
												mem_vec_1807 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 2, f = 64
												// T (c, 2) (2 / 1)
												for (c = c150, cp_1 = c150_p_0, cp_0 = 0;
													c < c150 + 2;
													...
													vec_34 = _mm512_fmadd_ps(vec_35, vec_2, mem_vec_1804);
													mem_vec_1804 = vec_34;



													vec_36 = _mm512_fmadd_ps(vec_35, vec_4, mem_vec_1805);
													mem_vec_1805 = vec_36;



													vec_37 = _mm512_fmadd_ps(vec_35, vec_6, mem_vec_1806);
													mem_vec_1806 = vec_37;



													vec_38 = _mm512_fmadd_ps(vec_35, vec_8, mem_vec_1807);
													mem_vec_1807 = vec_38;
												}
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_1806);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_1807);
									}
								}
							}
						}
