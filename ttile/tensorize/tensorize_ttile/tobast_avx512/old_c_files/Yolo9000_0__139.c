...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (8, x); T (4, y); T (2, x); T (34, y); T (2, f); T (34, x)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x122_p_0, x123_p_0, xp_1, x122_p_1, xp_2, x122, x123, y, yp_0, y102_p_0, yp_1, y102;
...
for (x123 = x124, x123_p_0 = 0;
	...
	for (f = f46, fp_0 = 0;
		...
		for (y102 = y103, y102_p_0 = 0;
			y102 < y103 + 544;
			y102 += 16, y102_p_0 += 16){
			// y = 16, x = 16, h = 3, w = 3, c = 3, f = 16
			// T (x, 2) (16 / 8)
			for (x122 = x123, x122_p_1 = x123_p_0, x122_p_0 = 0;
				x122 < x123 + 16;
				x122 += 8, x122_p_1 += 8, x122_p_0 += 8){
				...
				for (y = y102, yp_1 = y102_p_0, yp_0 = 0;
					...
					// T (x, 8) (8 / 1)
					for (x = x122, xp_2 = x122_p_1, xp_1 = x122_p_0, xp_0 = 0;
						x < x122 + 8;
