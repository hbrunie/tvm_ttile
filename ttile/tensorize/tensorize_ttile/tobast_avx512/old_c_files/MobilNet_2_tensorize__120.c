...
x80_p_1 = 0;
					for (w = w44, wp_0 = 0;w < w44 + 3;w += 1, wp_0 += 1){
						...
						for (x = x80, xp_2 = x80_p_1, xp_1 = x80_p_0, xp_0 = 0;x < x80 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_345 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									// y = 8, x = 1, h = 3, w = 1, c = 16, f = 16
									// T (c, 16) (16 / 1)
									for (c = c74, cp_1 = c74_p_0, cp_0 = 0;c < c74 + 16;c += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_345);
						}
					}
}
