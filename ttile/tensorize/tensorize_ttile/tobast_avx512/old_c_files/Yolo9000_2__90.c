...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  T (4, x); T (2, x); T (68, y); T (4, f); T (2, c); T (17, x); T (2, x)]
*/
IND_TYPE c, cp_0, c618_p_0, cp_1, c618, f, fp_0, x, xp_0, x1038_p_0, x1039_p_0, x1040_p_0, xp_1, x1038_p_1, x1039_p_1, xp_2, x1038_p_2, xp_3, x1038, x1039, x1040, y, yp_0;
...
for (x1040 = x1041, x1040_p_0 = 0;
	x1040 < x1041 + 272;
	x1040 += 136, x1040_p_0 += 136){
	// y = 272, x = 136, h = 3, w = 3, c = 32, f = 64
	// T (x, 17) (136 / 8)
	for (x1039 = x1040, x1039_p_1 = x1040_p_0, x1039_p_0 = 0;
		x1039 < x1040 + 136;
		x1039 += 8, x1039_p_1 += 8, x1039_p_0 += 8){
		...
		for (c618 = c619, c618_p_0 = 0;
			...
			for (f = f334, fp_0 = 0;
				f < f334 + 64;
				f += 16, fp_0 += 16){
				// y = 272, x = 8, h = 3, w = 3, c = 16, f = 16
				// T (y, 68) (272 / 4)
				for (y = y432, yp_0 = 0;
					y < y432 + 272;
					y += 4, yp_0 += 4){
					// y = 4, x = 8, h = 3, w = 3, c = 16, f = 16
					// T (x, 2) (8 / 4)
					for (x1038 = x1039, x1038_p_2 = x1039_p_1, x1038_p_1 = x1039_p_0, x1038_p_0 = 0;
						x1038 < x1039 + 8;
						x1038 += 4, x1038_p_2 += 4, x1038_p_1 += 4, x1038_p_0 += 4){
						// y = 4, x = 4, h = 3, w = 3, c = 16, f = 16
						// T (x, 4) (4 / 1)
						for (x = x1038, xp_3 = x1038_p_2, xp_2 = x1038_p_1, xp_1 = x1038_p_0, xp_0 = 0;
							x < x1038 + 4;
