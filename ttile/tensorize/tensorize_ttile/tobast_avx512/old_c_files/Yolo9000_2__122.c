		...
		for (c426 = c427, c426_p_0 = 0;
			...
			for (f = f234, fp_0 = 0;
				...
				for (y = y304, yp_0 = 0;
					...
					// T (x, 8) (8 / 1)
					for (x718 = x719, x718_p_2 = x719_p_1, x718_p_1 = x719_p_0, x718_p_0 = 0;
						x718 < x719 + 8;
						x718 += 1, x718_p_2 += 1, x718_p_1 += 1, x718_p_0 += 1){
						...
						for (h = h208, hp_0 = 0;
							...
							// T (x, 1) (1 / 1)
							for (x = x718, xp_3 = x718_p_2, xp_2 = x718_p_1, xp_1 = x718_p_0, xp_0 = 0;
								x < x718 + 1;
