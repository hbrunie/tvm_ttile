...
fp_1 = 0;
						for (w = w298, wp_0 = 0;w < w298 + 3;w += 1, wp_0 += 1){
							...
							for (x = x560, xp_1 = x560_p_0, xp_0 = 0;x < x560 + 2;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_3798 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										...
										mem_vec_3803 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_3798);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3803);
							}
						}
}
