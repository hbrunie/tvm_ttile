...
fp_1 = 0;
						for (w = w206, wp_0 = 0;w < w206 + 3;w += 1, wp_0 += 1){
							...
							for (x = x384, xp_1 = x384_p_0, xp_0 = 0;x < x384 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2647 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_2648 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_2649 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2647);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2648);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2649);
