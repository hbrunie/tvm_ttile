...
// T (f, 2) (256 / 128)
for (f863 = f864, f863_p_0 = 0;
	f863 < f864 + 256;
	f863 += 128, f863_p_0 += 128){
	...
	for (x718 = x719, x718_p_0 = 0;
		...
		for (c871 = c872, c871_p_0 = 0;
			c871 < c872 + 256;
			c871 += 256, c871_p_0 += 256){
			// y = 14, x = 7, h = 3, w = 3, c = 256, f = 128
			// T (f, 2) (128 / 64)
			for (f862 = f863, f862_p_1 = f863_p_0, f862_p_0 = 0;
				f862 < f863 + 128;
				f862 += 64, f862_p_1 += 64, f862_p_0 += 64){
				// y = 14, x = 7, h = 3, w = 3, c = 256, f = 64
				// T (c, 1) (256 / 256)
				for (c870 = c871, c870_p_1 = c871_p_0, c870_p_0 = 0;
					c870 < c871 + 256;
					c870 += 256, c870_p_1 += 256, c870_p_0 += 256){
					// y = 14, x = 7, h = 3, w = 3, c = 256, f = 64
					// T (f, 2) (64 / 32)
					for (f = f862, fp_2 = f862_p_1, fp_1 = f862_p_0, fp_0 = 0;
						f < f862 + 64;
									...
									for (x = x718, xp_1 = x718_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c870, cp_2 = c870_p_1, cp_1 = c870_p_0, cp_0 = 0;
													...
													vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_4652);
													mem_vec_4652 = vec_14;

													vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

													vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_4653);
													mem_vec_4653 = vec_17;
													scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
													vec_20 = _mm512_set1_ps(scal_5);


													vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_4654);
													mem_vec_4654 = vec_19;



													vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_4655);
													mem_vec_4655 = vec_21;
													scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
													vec_23 = _mm512_set1_ps(scal_6);


													vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_4656);
													mem_vec_4656 = vec_22;



													vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_4657);
													mem_vec_4657 = vec_24;
													scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
													vec_26 = _mm512_set1_ps(scal_7);


													vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_4658);
													mem_vec_4658 = vec_25;



													vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_4659);
													mem_vec_4659 = vec_27;
													scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
													vec_29 = _mm512_set1_ps(scal_8);
													vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

													vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_4652);
													mem_vec_4652 = vec_28;

													vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

													vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_4653);
													mem_vec_4653 = vec_31;
													scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
													vec_34 = _mm512_set1_ps(scal_9);


													vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_4654);
													mem_vec_4654 = vec_33;



													vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_4655);
													mem_vec_4655 = vec_35;
													scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
													vec_37 = _mm512_set1_ps(scal_10);


													vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_4656);
													mem_vec_4656 = vec_36;



													vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_4657);
													mem_vec_4657 = vec_38;
													scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
													vec_40 = _mm512_set1_ps(scal_11);


													vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_4658);
													mem_vec_4658 = vec_39;



													vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_4659);
													mem_vec_4659 = vec_41;
												}
