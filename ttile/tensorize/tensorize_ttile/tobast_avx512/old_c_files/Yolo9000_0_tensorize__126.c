...
y = 0;
yp_1 = 0;
					for (x = x138, xp_2 = x138_p_1, xp_1 = x138_p_0, xp_0 = 0;x < x138 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								mem_vec_328 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
								mem_vec_329 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_330 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								mem_vec_331 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_329);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_330);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_331);
					}
}
