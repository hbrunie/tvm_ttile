...
for (x790 = x791, x790_p_0 = 0;
	...
	// T (x, 1) (68 / 68)
	for (x789 = x790, x789_p_1 = x790_p_0, x789_p_0 = 0;
		x789 < x790 + 68;
		x789 += 68, x789_p_1 += 68, x789_p_0 += 68){
		// y = 272, x = 68, h = 3, w = 3, c = 32, f = 64
		// T (c, 1) (32 / 32)
		for (c468 = c469, c468_p_0 = 0;
			...
			for (f = f262, fp_0 = 0;
				...
				for (y = y332, yp_0 = 0;
					...
					// T (x, 2) (68 / 34)
					for (x788 = x789, x788_p_2 = x789_p_1, x788_p_1 = x789_p_0, x788_p_0 = 0;
						x788 < x789 + 68;
						x788 += 34, x788_p_2 += 34, x788_p_1 += 34, x788_p_0 += 34){
						...
						for (h = h236, hp_0 = 0;
							...
							// T (x, 34) (34 / 1)
							for (x = x788, xp_3 = x788_p_2, xp_2 = x788_p_1, xp_1 = x788_p_0, xp_0 = 0;
								x < x788 + 34;
