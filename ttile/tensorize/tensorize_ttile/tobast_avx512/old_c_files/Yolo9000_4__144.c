...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  T (68, x); T (34, y); T (8, f); T (1, c); T (2, x)]
*/
IND_TYPE c, cp_0, c372_p_0, cp_1, c372, f, fp_0, x, xp_0, x456_p_0, xp_1, x456, y, yp_0;
