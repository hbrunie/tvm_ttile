...
[V f; U (4, f); U (4, y); U (3, h); T (1, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, x); T (68, y); T (32, c); T (17, x); T (2, x)]
*/
IND_TYPE c, cp_0, c294_p_0, cp_1, c294, w, wp_0, x, xp_0, x490_p_0, x491_p_0, x492_p_0, xp_1, x490_p_1, x491_p_1, xp_2, x490_p_2, xp_3, x490, x491, x492, y, yp_0;
IND_TYPE y196 = 0;
IND_TYPE x493 = 0;
IND_TYPE h = 0;
IND_TYPE w196 = 0;
...
__m512 mem_vec_1232 ,mem_vec_1233 ,mem_vec_1234 ,mem_vec_1235 ,mem_vec_1236 ,mem_vec_1237 ,mem_vec_1238 ,mem_vec_1239 ,mem_vec_1240 ,mem_vec_1241 ,mem_vec_1242 ,mem_vec_1243 ,mem_vec_1244 ,mem_vec_1245 ,mem_vec_1246 ,mem_vec_1247 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_8 ,vec_9;
...
x490_p_2 = 0;
					for (w = w196, wp_0 = 0;w < w196 + 3;w += 1, wp_0 += 1){
						// y = 4, x = 2, h = 3, w = 1, c = 1, f = 64
						// T (x, 2) (2 / 1)
						for (x = x490, xp_3 = x490_p_2, xp_2 = x490_p_1, xp_1 = x490_p_0, xp_0 = 0;x < x490 + 2;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c294, cp_1 = c294_p_0, cp_0 = 0;c < c294 + 1;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_1232);
										mem_vec_1232 = vec_24;
										vec_28 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_1233);
										mem_vec_1233 = vec_27;
										vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 32]);
										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_1234);
										mem_vec_1234 = vec_29;
										vec_32 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_1235);
										mem_vec_1235 = vec_31;
										scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
										vec_34 = _mm512_set1_ps(scal_5);
										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_1236);
										mem_vec_1236 = vec_33;
										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_1237);
										mem_vec_1237 = vec_35;
										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_1238);
										mem_vec_1238 = vec_36;
										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_1239);
										mem_vec_1239 = vec_37;
										scal_6 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
										vec_39 = _mm512_set1_ps(scal_6);
										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_1240);
										mem_vec_1240 = vec_38;
										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_1241);
										mem_vec_1241 = vec_40;
										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_1242);
										mem_vec_1242 = vec_41;
										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_1243);
										mem_vec_1243 = vec_42;
										scal_7 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_7);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_1244);
										mem_vec_1244 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_1245);
										mem_vec_1245 = vec_45;
										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_1246);
										mem_vec_1246 = vec_46;
										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_1247);
										mem_vec_1247 = vec_47;
										scal_8 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_1232);
										mem_vec_1232 = vec_48;
										vec_52 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_1233);
										mem_vec_1233 = vec_51;
										vec_54 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 32]);
										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_1234);
										mem_vec_1234 = vec_53;
										vec_56 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_1235);
										mem_vec_1235 = vec_55;
										scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_9);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1236);
										mem_vec_1236 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_1237);
										mem_vec_1237 = vec_59;
										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_1238);
										mem_vec_1238 = vec_60;
										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_1239);
										mem_vec_1239 = vec_61;
										scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
										vec_63 = _mm512_set1_ps(scal_10);
										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_1240);
										mem_vec_1240 = vec_62;
										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_1241);
										mem_vec_1241 = vec_64;
										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_1242);
										mem_vec_1242 = vec_65;
										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_1243);
										mem_vec_1243 = vec_66;
										scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
										vec_68 = _mm512_set1_ps(scal_11);
										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_1244);
										mem_vec_1244 = vec_67;
										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_1245);
										mem_vec_1245 = vec_69;
										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_1246);
										mem_vec_1246 = vec_70;
										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_1247);
										mem_vec_1247 = vec_71;
									}
