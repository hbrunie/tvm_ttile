...
c470_p_1 = 0;
						for (w = w176, wp_0 = 0;w < w176 + 3;w += 1, wp_0 += 1){
							...
							for (x = x370, xp_1 = x370_p_0, xp_0 = 0;x < x370 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2326 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
										mem_vec_2327 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
										// y = ph_y, x = 1, h = 3, w = 1, c = 32, f = 64
										// T (c, 32) (32 / 1)
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_2326);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_2327);
							}
						}
}
