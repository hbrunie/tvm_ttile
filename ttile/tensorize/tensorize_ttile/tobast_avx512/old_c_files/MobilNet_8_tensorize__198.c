...
*/
IND_TYPE c, cp_0, c42_p_0, c43_p_0, cp_1, c42_p_1, cp_2, c42, c43, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y14 = 0;
IND_TYPE x28 = 0;
IND_TYPE h28 = 0;
IND_TYPE w28 = 0;
				...
				for (h = h28, hp_0 = 0;h < h28 + 3;h += 1, hp_0 += 1){
					...
					for (w = w28, wp_0 = 0;w < w28 + 3;w += 1, wp_0 += 1){
						...
						for (x = x28, xp_0 = 0;x < x28 + 7;x += 1, xp_0 += 1){
									...
									// T (c, 128) (128 / 1)
									for (c = c42, cp_2 = c42_p_1, cp_1 = c42_p_0, cp_0 = 0;c < c42 + 128;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
