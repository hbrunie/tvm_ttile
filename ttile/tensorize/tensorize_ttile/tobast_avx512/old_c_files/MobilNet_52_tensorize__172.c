						...
						for (h = h176, hp_0 = 0;h < h176 + 3;h += 1, hp_0 += 1){
							...
							for (w = w162, wp_0 = 0;w < w162 + 3;w += 1, wp_0 += 1){
								...
								for (x = x342, xp_1 = x342_p_0, xp_0 = 0;x < x342 + 7;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_1826 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_1827 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_1826);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_1827);
								}
							}
						}
}
