...
fp_1 = 0;
						for (w = w206, wp_0 = 0;w < w206 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 4) (4 / 1)
							for (x = x414, xp_1 = x414_p_0, xp_0 = 0;x < x414 + 4;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_2894 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										...
										mem_vec_2897 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_2898 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_2899 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										mem_vec_2900 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
										mem_vec_2901 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
										mem_vec_2902 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
										mem_vec_2903 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_2894);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2897);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_2898);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_2899);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_2900);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2901);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_2902);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_2903);
							}
						}
}
