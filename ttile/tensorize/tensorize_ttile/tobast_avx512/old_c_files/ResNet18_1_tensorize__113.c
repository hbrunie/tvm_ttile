...
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (4, x); T (7, w);
  T (7, h); T (1, x); T (14, y); T (2, f); T (28, x)]
*/
IND_TYPE c, cp_0, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x136_p_0, x137_p_0, xp_1, x136_p_1, xp_2, x136, x137, y, yp_0;
IND_TYPE y68 = 0;
IND_TYPE x138 = 0;
IND_TYPE h68 = 0;
IND_TYPE w68 = 0;
				...
				for (h = h68, hp_0 = 0;h < h68 + 7;h += 1, hp_0 += 1){
					...
					for (w = w68, wp_0 = 0;w < w68 + 7;w += 1, wp_0 += 1){
						...
						for (x = x136, xp_2 = x136_p_1, xp_1 = x136_p_0, xp_0 = 0;x < x136 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c68, cp_0 = 0;c < c68 + 3;c += 1, cp_0 += 1){
