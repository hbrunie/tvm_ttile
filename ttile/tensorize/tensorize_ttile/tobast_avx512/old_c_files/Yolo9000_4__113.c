...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  T (1, x); T (34, y); T (8, f); T (1, c); T (136, x)]
*/
IND_TYPE c, cp_0, c378_p_0, cp_1, c378, f, fp_0, x, xp_0, x462_p_0, xp_1, x462, y, yp_0;
