					...
					for (w = w424, wp_0 = 0;
						...
						for (x = x560, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_4682 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
									mem_vec_4683 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									mem_vec_4684 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_4685 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_4686 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
									mem_vec_4687 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_4682);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_4683);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_4684);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_4685);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_4686);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_4687);
						}
					}
				}
			}
						...
						for (x = x560, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c952, cp_2 = c952_p_1, cp_1 = c952_p_0, cp_0 = 0;
										...
										vec_29 = _mm512_fmadd_ps(vec_30, vec_31, mem_vec_4688);
										mem_vec_4688 = vec_29;

										vec_33 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_4689);
										mem_vec_4689 = vec_32;

										vec_35 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_34 = _mm512_fmadd_ps(vec_30, vec_35, mem_vec_4690);
										mem_vec_4690 = vec_34;

										vec_37 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_36 = _mm512_fmadd_ps(vec_30, vec_37, mem_vec_4691);
										mem_vec_4691 = vec_36;
										scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_31, mem_vec_4692);
										mem_vec_4692 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_33, mem_vec_4693);
										mem_vec_4693 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_35, mem_vec_4694);
										mem_vec_4694 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_37, mem_vec_4695);
										mem_vec_4695 = vec_42;
										scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_7);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_4696);
										mem_vec_4696 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_4697);
										mem_vec_4697 = vec_45;



										vec_46 = _mm512_fmadd_ps(vec_44, vec_35, mem_vec_4698);
										mem_vec_4698 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_37, mem_vec_4699);
										mem_vec_4699 = vec_47;
										scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
										vec_49 = _mm512_set1_ps(scal_8);


										vec_48 = _mm512_fmadd_ps(vec_49, vec_31, mem_vec_4700);
										mem_vec_4700 = vec_48;



										vec_50 = _mm512_fmadd_ps(vec_49, vec_33, mem_vec_4701);
										mem_vec_4701 = vec_50;



										vec_51 = _mm512_fmadd_ps(vec_49, vec_35, mem_vec_4702);
										mem_vec_4702 = vec_51;



										vec_52 = _mm512_fmadd_ps(vec_49, vec_37, mem_vec_4703);
										mem_vec_4703 = vec_52;
										scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
										vec_54 = _mm512_set1_ps(scal_9);


										vec_53 = _mm512_fmadd_ps(vec_54, vec_31, mem_vec_4704);
										mem_vec_4704 = vec_53;



										vec_55 = _mm512_fmadd_ps(vec_54, vec_33, mem_vec_4705);
										mem_vec_4705 = vec_55;



										vec_56 = _mm512_fmadd_ps(vec_54, vec_35, mem_vec_4706);
										mem_vec_4706 = vec_56;



										vec_57 = _mm512_fmadd_ps(vec_54, vec_37, mem_vec_4707);
										mem_vec_4707 = vec_57;
										scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
										vec_59 = _mm512_set1_ps(scal_10);
										vec_60 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_58 = _mm512_fmadd_ps(vec_59, vec_60, mem_vec_4688);
										mem_vec_4688 = vec_58;

										vec_62 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_4689);
										mem_vec_4689 = vec_61;

										vec_64 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_63 = _mm512_fmadd_ps(vec_59, vec_64, mem_vec_4690);
										mem_vec_4690 = vec_63;

										vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_65 = _mm512_fmadd_ps(vec_59, vec_66, mem_vec_4691);
										mem_vec_4691 = vec_65;
										scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_60, mem_vec_4692);
										mem_vec_4692 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_62, mem_vec_4693);
										mem_vec_4693 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_64, mem_vec_4694);
										mem_vec_4694 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_66, mem_vec_4695);
										mem_vec_4695 = vec_71;
										scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
										vec_73 = _mm512_set1_ps(scal_12);


										vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_4696);
										mem_vec_4696 = vec_72;



										vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_4697);
										mem_vec_4697 = vec_74;



										vec_75 = _mm512_fmadd_ps(vec_73, vec_64, mem_vec_4698);
										mem_vec_4698 = vec_75;



										vec_76 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_4699);
										mem_vec_4699 = vec_76;
										scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
										vec_78 = _mm512_set1_ps(scal_13);


										vec_77 = _mm512_fmadd_ps(vec_78, vec_60, mem_vec_4700);
										mem_vec_4700 = vec_77;



										vec_79 = _mm512_fmadd_ps(vec_78, vec_62, mem_vec_4701);
										mem_vec_4701 = vec_79;



										vec_80 = _mm512_fmadd_ps(vec_78, vec_64, mem_vec_4702);
										mem_vec_4702 = vec_80;



										vec_81 = _mm512_fmadd_ps(vec_78, vec_66, mem_vec_4703);
										mem_vec_4703 = vec_81;
										scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
										vec_83 = _mm512_set1_ps(scal_14);


										vec_82 = _mm512_fmadd_ps(vec_83, vec_60, mem_vec_4704);
										mem_vec_4704 = vec_82;



										vec_84 = _mm512_fmadd_ps(vec_83, vec_62, mem_vec_4705);
										mem_vec_4705 = vec_84;



										vec_85 = _mm512_fmadd_ps(vec_83, vec_64, mem_vec_4706);
										mem_vec_4706 = vec_85;



										vec_86 = _mm512_fmadd_ps(vec_83, vec_66, mem_vec_4707);
										mem_vec_4707 = vec_86;
									}
