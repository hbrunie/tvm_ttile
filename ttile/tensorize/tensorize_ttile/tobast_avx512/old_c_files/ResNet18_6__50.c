					...
					for (h = h16, hp_0 = 0;
						...
						for (w = w16, wp_0 = 0;
							...
							for (x = x24, xp_1 = x24_p_0, xp_0 = 0;
								x < x24 + 2;
								x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_148 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
										mem_vec_149 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
										mem_vec_150 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
										mem_vec_151 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
										mem_vec_152 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_153 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_154 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
										mem_vec_155 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
										mem_vec_156 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_157 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_158 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32]);
										mem_vec_159 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48]);
										mem_vec_160 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_161 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
										mem_vec_162 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32]);
										mem_vec_163 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_148);
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_149);
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_150);
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_151);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_152);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_153);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_154);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_155);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_156);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_157);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32], mem_vec_158);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48], mem_vec_159);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_160);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_161);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32], mem_vec_162);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48], mem_vec_163);
							}
						}
					}
				}
