			...
			f += 16, fp_0 += 16){
				for (y = y132, yp_0 = 0;
					...
					for (x210 = x211, x210_p_1 = x211_p_0, x210_p_0 = 0;
						x210 < x211 + 34;
						x210 += 34, x210_p_1 += 34, x210_p_0 += 34){
						// y = ph_y, x = 34, h = 3, w = 3, c = 4, f = 16
						// T (c, 2) (4 / 2)
							...
							for (w = w130, wp_0 = 0;
								...
								for (x = x210, xp_2 = x210_p_1, xp_1 = x210_p_0, xp_0 = 0;
									...
									x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2125 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
											mem_vec_2126 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_2125);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_2126);
