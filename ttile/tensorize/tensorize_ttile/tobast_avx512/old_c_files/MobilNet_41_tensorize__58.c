...
fp_1 = 0;
						for (w = w258, wp_0 = 0;w < w258 + 3;w += 1, wp_0 += 1){
							...
							for (x = x492, xp_1 = x492_p_0, xp_0 = 0;x < x492 + 1;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3153 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										...
										mem_vec_3158 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_3153);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_3158);
