...
[V f; U (1, f); U (8, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (4, x); T (1, x); T (34, y); T (4, f); T (1, c); T (4, x); T (17, x)]
*/
IND_TYPE c, cp_0, c708_p_0, cp_1, c708, f, fp_0, x, xp_0, x1188_p_0, x1189_p_0, x1190_p_0, xp_1, x1188_p_1, x1189_p_1, xp_2, x1188_p_2, xp_3, x1188, x1189, x1190, y, yp_0;
...
for (x1190 = x1191, x1190_p_0 = 0;
	x1190 < x1191 + 272;
	x1190 += 16, x1190_p_0 += 16){
	// y = 272, x = 16, h = 3, w = 3, c = 32, f = 64
	// T (x, 4) (16 / 4)
	for (x1189 = x1190, x1189_p_1 = x1190_p_0, x1189_p_0 = 0;
		x1189 < x1190 + 16;
		x1189 += 4, x1189_p_1 += 4, x1189_p_0 += 4){
		...
		for (c708 = c709, c708_p_0 = 0;
			...
			for (f = f394, fp_0 = 0;
				...
				for (y = y492, yp_0 = 0;
					...
					// T (x, 1) (4 / 4)
					for (x1188 = x1189, x1188_p_2 = x1189_p_1, x1188_p_1 = x1189_p_0, x1188_p_0 = 0;
						x1188 < x1189 + 4;
						x1188 += 4, x1188_p_2 += 4, x1188_p_1 += 4, x1188_p_0 += 4){
						// y = 8, x = 4, h = 3, w = 3, c = 32, f = 16
						// T (x, 4) (4 / 1)
						for (x = x1188, xp_3 = x1188_p_2, xp_2 = x1188_p_1, xp_1 = x1188_p_0, xp_0 = 0;
							x < x1188 + 4;
							x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_2597 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									mem_vec_2598 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_2599 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									...
									for (c = c708, cp_1 = c708_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2593);
										mem_vec_2593 = vec_3;
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_2595);
										mem_vec_2595 = vec_7;
										...
										vec_119 = _mm512_fmadd_ps(vec_120, vec_121, mem_vec_2592);
										mem_vec_2592 = vec_119;
										scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
										vec_123 = _mm512_set1_ps(scal_57);


										vec_122 = _mm512_fmadd_ps(vec_123, vec_121, mem_vec_2593);
										mem_vec_2593 = vec_122;
										scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
										vec_125 = _mm512_set1_ps(scal_58);


										vec_124 = _mm512_fmadd_ps(vec_125, vec_121, mem_vec_2594);
										mem_vec_2594 = vec_124;
										scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
										vec_127 = _mm512_set1_ps(scal_59);


										vec_126 = _mm512_fmadd_ps(vec_127, vec_121, mem_vec_2595);
										mem_vec_2595 = vec_126;
										scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
										vec_129 = _mm512_set1_ps(scal_60);


										vec_128 = _mm512_fmadd_ps(vec_129, vec_121, mem_vec_2596);
										mem_vec_2596 = vec_128;
										scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
										vec_131 = _mm512_set1_ps(scal_61);


										vec_130 = _mm512_fmadd_ps(vec_131, vec_121, mem_vec_2597);
										mem_vec_2597 = vec_130;
										scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
										vec_133 = _mm512_set1_ps(scal_62);


										vec_132 = _mm512_fmadd_ps(vec_133, vec_121, mem_vec_2598);
										mem_vec_2598 = vec_132;
										scal_63 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
										vec_135 = _mm512_set1_ps(scal_63);


										vec_134 = _mm512_fmadd_ps(vec_135, vec_121, mem_vec_2599);
										mem_vec_2599 = vec_134;
										...
										vec_136 = _mm512_fmadd_ps(vec_137, vec_138, mem_vec_2592);
										mem_vec_2592 = vec_136;
										scal_65 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
										vec_140 = _mm512_set1_ps(scal_65);


										vec_139 = _mm512_fmadd_ps(vec_140, vec_138, mem_vec_2593);
										mem_vec_2593 = vec_139;
										scal_66 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
										vec_142 = _mm512_set1_ps(scal_66);


										vec_141 = _mm512_fmadd_ps(vec_142, vec_138, mem_vec_2594);
										mem_vec_2594 = vec_141;
										scal_67 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
										vec_144 = _mm512_set1_ps(scal_67);


										vec_143 = _mm512_fmadd_ps(vec_144, vec_138, mem_vec_2595);
										mem_vec_2595 = vec_143;
										scal_68 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
										vec_146 = _mm512_set1_ps(scal_68);


										vec_145 = _mm512_fmadd_ps(vec_146, vec_138, mem_vec_2596);
										mem_vec_2596 = vec_145;
										scal_69 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
										vec_148 = _mm512_set1_ps(scal_69);


										vec_147 = _mm512_fmadd_ps(vec_148, vec_138, mem_vec_2597);
										mem_vec_2597 = vec_147;
										scal_70 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
										vec_150 = _mm512_set1_ps(scal_70);


										vec_149 = _mm512_fmadd_ps(vec_150, vec_138, mem_vec_2598);
										mem_vec_2598 = vec_149;
										scal_71 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
										vec_152 = _mm512_set1_ps(scal_71);


										vec_151 = _mm512_fmadd_ps(vec_152, vec_138, mem_vec_2599);
										mem_vec_2599 = vec_151;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_2597);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_2598);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_2599);
						}
					}
				}
			}
