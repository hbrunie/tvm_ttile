...
/*
[V f; U (2, f); ULambda y; U (3, w); T (32, c); Hoist_vars [c]; T (56, x);
  T (3, h); T (1, x);
  Lambda_apply y [((Iter 8), (Arg 7)); ((Iter 7), (Arg 8))]; T (1, c);
  T (2, x)]
*/
IND_TYPE c, cp_0, c682_p_0, cp_1, c682, h, hp_0, x, xp_0, x912_p_0, x913_p_0, xp_1, x912_p_1, xp_2, x912, x913, y, yp_0;
		...
		c682 += 32, c682_p_0 += 32){
			for (y = y456, yp_0 = 0;
				...
				for (x912 = x913, x912_p_1 = x913_p_0, x912_p_0 = 0;
					x912 < x913 + 56;
					x912 += 56, x912_p_1 += 56, x912_p_0 += 56){
					// y = ph_y, x = 56, h = 3, w = 3, c = 32, f = 32
					// T (h, 3) (3 / 1)
					for (h = h292, hp_0 = 0;
						h < h292 + 3;
						...
						for (x = x912, xp_2 = x912_p_1, xp_1 = x912_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c682, cp_1 = c682_p_0, cp_0 = 0;
										...
										vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_6526);
										mem_vec_6526 = vec_23;

										vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_6527);
										mem_vec_6527 = vec_26;
										scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_29 = _mm512_set1_ps(scal_8);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_6528);
										mem_vec_6528 = vec_28;



										vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_6529);
										mem_vec_6529 = vec_30;
										scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_6530);
										mem_vec_6530 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_6531);
										mem_vec_6531 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_6532);
										mem_vec_6532 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_6533);
										mem_vec_6533 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_6534);
										mem_vec_6534 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_6535);
										mem_vec_6535 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_6536);
										mem_vec_6536 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_6537);
										mem_vec_6537 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_6538);
										mem_vec_6538 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_6539);
										mem_vec_6539 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_6526);
										mem_vec_6526 = vec_46;

										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_6527);
										mem_vec_6527 = vec_49;
										scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_52 = _mm512_set1_ps(scal_15);


										vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_6528);
										mem_vec_6528 = vec_51;



										vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_6529);
										mem_vec_6529 = vec_53;
										scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_55 = _mm512_set1_ps(scal_16);


										vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_6530);
										mem_vec_6530 = vec_54;



										vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_6531);
										mem_vec_6531 = vec_56;
										scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_6532);
										mem_vec_6532 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_6533);
										mem_vec_6533 = vec_59;
										scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
										vec_61 = _mm512_set1_ps(scal_18);


										vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_6534);
										mem_vec_6534 = vec_60;



										vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_6535);
										mem_vec_6535 = vec_62;
										scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
										vec_64 = _mm512_set1_ps(scal_19);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_6536);
										mem_vec_6536 = vec_63;



										vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_6537);
										mem_vec_6537 = vec_65;
										scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
										vec_67 = _mm512_set1_ps(scal_20);


										vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_6538);
										mem_vec_6538 = vec_66;



										vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_6539);
										mem_vec_6539 = vec_68;
									}
						...
						for (x = x912, xp_2 = x912_p_1, xp_1 = x912_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c682, cp_1 = c682_p_0, cp_0 = 0;
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_6540);
										mem_vec_6540 = vec_26;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_6541);
										mem_vec_6541 = vec_29;
										scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_32 = _mm512_set1_ps(scal_9);


										vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_6542);
										mem_vec_6542 = vec_31;



										vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_6543);
										mem_vec_6543 = vec_33;
										scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_6544);
										mem_vec_6544 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_6545);
										mem_vec_6545 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_6546);
										mem_vec_6546 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_6547);
										mem_vec_6547 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_6548);
										mem_vec_6548 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_6549);
										mem_vec_6549 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_6550);
										mem_vec_6550 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_6551);
										mem_vec_6551 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
										vec_47 = _mm512_set1_ps(scal_14);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_6552);
										mem_vec_6552 = vec_46;



										vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_6553);
										mem_vec_6553 = vec_48;
										scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_6554);
										mem_vec_6554 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_6555);
										mem_vec_6555 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_53 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_6540);
										mem_vec_6540 = vec_52;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_6541);
										mem_vec_6541 = vec_55;
										scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_58 = _mm512_set1_ps(scal_17);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_6542);
										mem_vec_6542 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_6543);
										mem_vec_6543 = vec_59;
										scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_61 = _mm512_set1_ps(scal_18);


										vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_6544);
										mem_vec_6544 = vec_60;



										vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_6545);
										mem_vec_6545 = vec_62;
										scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_64 = _mm512_set1_ps(scal_19);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_6546);
										mem_vec_6546 = vec_63;



										vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_6547);
										mem_vec_6547 = vec_65;
										scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
										vec_67 = _mm512_set1_ps(scal_20);


										vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_6548);
										mem_vec_6548 = vec_66;



										vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_6549);
										mem_vec_6549 = vec_68;
										scal_21 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
										vec_70 = _mm512_set1_ps(scal_21);


										vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_6550);
										mem_vec_6550 = vec_69;



										vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_6551);
										mem_vec_6551 = vec_71;
										scal_22 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
										vec_73 = _mm512_set1_ps(scal_22);


										vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_6552);
										mem_vec_6552 = vec_72;



										vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_6553);
										mem_vec_6553 = vec_74;
										scal_23 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
										vec_76 = _mm512_set1_ps(scal_23);


										vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_6554);
										mem_vec_6554 = vec_75;



										vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_6555);
										mem_vec_6555 = vec_77;
									}
