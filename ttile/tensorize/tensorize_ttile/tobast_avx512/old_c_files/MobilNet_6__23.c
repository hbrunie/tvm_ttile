	...
	for (x910 = x911, x910_p_0 = 0;
		...
		for (c1131 = c1132, c1131_p_0 = 0;
			...
			for (f1106 = f1107, f1106_p_1 = f1107_p_0, f1106_p_0 = 0;
				f1106 < f1107 + 256;
				f1106 += 32, f1106_p_1 += 32, f1106_p_0 += 32){
				// y = 14, x = 2, h = 3, w = 3, c = 2, f = 32
				// T (c, 1) (2 / 2)
				for (c1130 = c1131, c1130_p_1 = c1131_p_0, c1130_p_0 = 0;
					c1130 < c1131 + 2;
					c1130 += 2, c1130_p_1 += 2, c1130_p_0 += 2){
					// y = 14, x = 2, h = 3, w = 3, c = 2, f = 32
					// T (f, 1) (32 / 32)
								...
								for (h = h550, hp_0 = 0;
									...
									for (x = x910, xp_1 = x910_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 2) (2 / 1)
												for (c = c1130, cp_2 = c1130_p_1, cp_1 = c1130_p_0, cp_0 = 0;
													c < c1130 + 2;
									...
									for (x = x910, xp_1 = x910_p_0, xp_0 = 0;
										...
										x += 1, xp_1 += 1, xp_0 += 1){
												...
												for (c = c1130, cp_2 = c1130_p_1, cp_1 = c1130_p_0, cp_0 = 0;
													...
													vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_6295);
													mem_vec_6295 = vec_32;
													...
													vec_36 = _mm512_fmadd_ps(vec_35, vec_33, mem_vec_6297);
													mem_vec_6297 = vec_36;
													scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
													vec_38 = _mm512_set1_ps(scal_11);


													vec_37 = _mm512_fmadd_ps(vec_38, vec_31, mem_vec_6298);
													mem_vec_6298 = vec_37;



													vec_39 = _mm512_fmadd_ps(vec_38, vec_33, mem_vec_6299);
													mem_vec_6299 = vec_39;
													scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
													vec_41 = _mm512_set1_ps(scal_12);


													vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_6300);
													mem_vec_6300 = vec_40;



													vec_42 = _mm512_fmadd_ps(vec_41, vec_33, mem_vec_6301);
													mem_vec_6301 = vec_42;
													scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
													vec_44 = _mm512_set1_ps(scal_13);


													vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_6302);
													mem_vec_6302 = vec_43;



													vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_6303);
													mem_vec_6303 = vec_45;
													scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
													vec_47 = _mm512_set1_ps(scal_14);


													vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_6304);
													mem_vec_6304 = vec_46;



													vec_48 = _mm512_fmadd_ps(vec_47, vec_33, mem_vec_6305);
													mem_vec_6305 = vec_48;
													scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h) + c];
													vec_50 = _mm512_set1_ps(scal_15);


													vec_49 = _mm512_fmadd_ps(vec_50, vec_31, mem_vec_6306);
													mem_vec_6306 = vec_49;



													vec_51 = _mm512_fmadd_ps(vec_50, vec_33, mem_vec_6307);
													mem_vec_6307 = vec_51;
													scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h) + c];
													vec_53 = _mm512_set1_ps(scal_16);


													vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_6308);
													mem_vec_6308 = vec_52;



													vec_54 = _mm512_fmadd_ps(vec_53, vec_33, mem_vec_6309);
													mem_vec_6309 = vec_54;
													scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h) + c];
													vec_56 = _mm512_set1_ps(scal_17);


													vec_55 = _mm512_fmadd_ps(vec_56, vec_31, mem_vec_6310);
													mem_vec_6310 = vec_55;



													vec_57 = _mm512_fmadd_ps(vec_56, vec_33, mem_vec_6311);
													mem_vec_6311 = vec_57;
													...
													vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_6295);
													mem_vec_6295 = vec_61;
													...
													vec_65 = _mm512_fmadd_ps(vec_64, vec_62, mem_vec_6297);
													mem_vec_6297 = vec_65;
													scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
													vec_67 = _mm512_set1_ps(scal_20);


													vec_66 = _mm512_fmadd_ps(vec_67, vec_60, mem_vec_6298);
													mem_vec_6298 = vec_66;



													vec_68 = _mm512_fmadd_ps(vec_67, vec_62, mem_vec_6299);
													mem_vec_6299 = vec_68;
													scal_21 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
													vec_70 = _mm512_set1_ps(scal_21);


													vec_69 = _mm512_fmadd_ps(vec_70, vec_60, mem_vec_6300);
													mem_vec_6300 = vec_69;



													vec_71 = _mm512_fmadd_ps(vec_70, vec_62, mem_vec_6301);
													mem_vec_6301 = vec_71;
													scal_22 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
													vec_73 = _mm512_set1_ps(scal_22);


													vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_6302);
													mem_vec_6302 = vec_72;



													vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_6303);
													mem_vec_6303 = vec_74;
													scal_23 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
													vec_76 = _mm512_set1_ps(scal_23);


													vec_75 = _mm512_fmadd_ps(vec_76, vec_60, mem_vec_6304);
													mem_vec_6304 = vec_75;



													vec_77 = _mm512_fmadd_ps(vec_76, vec_62, mem_vec_6305);
													mem_vec_6305 = vec_77;
													scal_24 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
													vec_79 = _mm512_set1_ps(scal_24);


													vec_78 = _mm512_fmadd_ps(vec_79, vec_60, mem_vec_6306);
													mem_vec_6306 = vec_78;



													vec_80 = _mm512_fmadd_ps(vec_79, vec_62, mem_vec_6307);
													mem_vec_6307 = vec_80;
													scal_25 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h) + c];
													vec_82 = _mm512_set1_ps(scal_25);


													vec_81 = _mm512_fmadd_ps(vec_82, vec_60, mem_vec_6308);
													mem_vec_6308 = vec_81;



													vec_83 = _mm512_fmadd_ps(vec_82, vec_62, mem_vec_6309);
													mem_vec_6309 = vec_83;
													scal_26 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h) + c];
													vec_85 = _mm512_set1_ps(scal_26);


													vec_84 = _mm512_fmadd_ps(vec_85, vec_60, mem_vec_6310);
													mem_vec_6310 = vec_84;



													vec_86 = _mm512_fmadd_ps(vec_85, vec_62, mem_vec_6311);
													mem_vec_6311 = vec_86;
												}
