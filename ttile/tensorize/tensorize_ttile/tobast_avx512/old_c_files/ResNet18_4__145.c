...
[V f; U (2, f); ULambda y; U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, f); T (2, c); T (28, x);
  Lambda_apply y [((Iter 2), (Arg 7)); ((Iter 1), (Arg 14))]; T (2, f)]
*/
IND_TYPE c, cp_0, c588_p_0, cp_1, c588, f, fp_0, f584_p_0, fp_1, f584, w, wp_0, x, xp_0, x588_p_0, xp_1, x588, y, yp_0;
		...
		for (y = y392, yp_0 = 0;
			...
			for (x588 = x589, x588_p_0 = 0;
				...
				for (c588 = c589, c588_p_0 = 0;
					...
					// T (f, 2) (64 / 32)
					for (f = f584, fp_1 = f584_p_0, fp_0 = 0;
						f < f584 + 64;
							...
							for (x = x588, xp_1 = x588_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c588, cp_1 = c588_p_0, cp_0 = 0;
											...
											vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_4196);
											mem_vec_4196 = vec_23;

											vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_4197);
											mem_vec_4197 = vec_26;
											scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
											vec_29 = _mm512_set1_ps(scal_8);


											vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_4198);
											mem_vec_4198 = vec_28;



											vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_4199);
											mem_vec_4199 = vec_30;
											scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_4200);
											mem_vec_4200 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_4201);
											mem_vec_4201 = vec_33;
											scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_4202);
											mem_vec_4202 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_4203);
											mem_vec_4203 = vec_36;
											scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_4204);
											mem_vec_4204 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_4205);
											mem_vec_4205 = vec_39;
											scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_4206);
											mem_vec_4206 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_4207);
											mem_vec_4207 = vec_42;
											scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_4208);
											mem_vec_4208 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_4209);
											mem_vec_4209 = vec_45;
											scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
											vec_47 = _mm512_set1_ps(scal_14);
											vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_4196);
											mem_vec_4196 = vec_46;

											vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_4197);
											mem_vec_4197 = vec_49;
											scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
											vec_52 = _mm512_set1_ps(scal_15);


											vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_4198);
											mem_vec_4198 = vec_51;



											vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_4199);
											mem_vec_4199 = vec_53;
											scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
											vec_55 = _mm512_set1_ps(scal_16);


											vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_4200);
											mem_vec_4200 = vec_54;



											vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_4201);
											mem_vec_4201 = vec_56;
											scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_4202);
											mem_vec_4202 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_4203);
											mem_vec_4203 = vec_59;
											scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
											vec_61 = _mm512_set1_ps(scal_18);


											vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_4204);
											mem_vec_4204 = vec_60;



											vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_4205);
											mem_vec_4205 = vec_62;
											scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 2) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_4206);
											mem_vec_4206 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_4207);
											mem_vec_4207 = vec_65;
											scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 2) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_4208);
											mem_vec_4208 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_4209);
											mem_vec_4209 = vec_68;
										}
							...
							for (x = x588, xp_1 = x588_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c588, cp_1 = c588_p_0, cp_0 = 0;
											...
											vec_44 = _mm512_fmadd_ps(vec_45, vec_46, mem_vec_4210);
											mem_vec_4210 = vec_44;

											vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_47 = _mm512_fmadd_ps(vec_45, vec_48, mem_vec_4211);
											mem_vec_4211 = vec_47;
											scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_46, mem_vec_4212);
											mem_vec_4212 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_48, mem_vec_4213);
											mem_vec_4213 = vec_51;
											scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
											vec_53 = _mm512_set1_ps(scal_16);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_46, mem_vec_4214);
											mem_vec_4214 = vec_52;



											vec_54 = _mm512_fmadd_ps(vec_53, vec_48, mem_vec_4215);
											mem_vec_4215 = vec_54;
											scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
											vec_56 = _mm512_set1_ps(scal_17);


											vec_55 = _mm512_fmadd_ps(vec_56, vec_46, mem_vec_4216);
											mem_vec_4216 = vec_55;



											vec_57 = _mm512_fmadd_ps(vec_56, vec_48, mem_vec_4217);
											mem_vec_4217 = vec_57;
											scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
											vec_59 = _mm512_set1_ps(scal_18);


											vec_58 = _mm512_fmadd_ps(vec_59, vec_46, mem_vec_4218);
											mem_vec_4218 = vec_58;



											vec_60 = _mm512_fmadd_ps(vec_59, vec_48, mem_vec_4219);
											mem_vec_4219 = vec_60;
											scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 1) + c];
											vec_62 = _mm512_set1_ps(scal_19);


											vec_61 = _mm512_fmadd_ps(vec_62, vec_46, mem_vec_4220);
											mem_vec_4220 = vec_61;



											vec_63 = _mm512_fmadd_ps(vec_62, vec_48, mem_vec_4221);
											mem_vec_4221 = vec_63;
											scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 1) + c];
											vec_65 = _mm512_set1_ps(scal_20);


											vec_64 = _mm512_fmadd_ps(vec_65, vec_46, mem_vec_4222);
											mem_vec_4222 = vec_64;



											vec_66 = _mm512_fmadd_ps(vec_65, vec_48, mem_vec_4223);
											mem_vec_4223 = vec_66;
											scal_21 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 7) + h + 1) + c];
											vec_68 = _mm512_set1_ps(scal_21);


											vec_67 = _mm512_fmadd_ps(vec_68, vec_46, mem_vec_4224);
											mem_vec_4224 = vec_67;



											vec_69 = _mm512_fmadd_ps(vec_68, vec_48, mem_vec_4225);
											mem_vec_4225 = vec_69;
											scal_22 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 8) + h + 1) + c];
											vec_71 = _mm512_set1_ps(scal_22);


											vec_70 = _mm512_fmadd_ps(vec_71, vec_46, mem_vec_4226);
											mem_vec_4226 = vec_70;



											vec_72 = _mm512_fmadd_ps(vec_71, vec_48, mem_vec_4227);
											mem_vec_4227 = vec_72;
											scal_23 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 9) + h + 1) + c];
											vec_74 = _mm512_set1_ps(scal_23);


											vec_73 = _mm512_fmadd_ps(vec_74, vec_46, mem_vec_4228);
											mem_vec_4228 = vec_73;



											vec_75 = _mm512_fmadd_ps(vec_74, vec_48, mem_vec_4229);
											mem_vec_4229 = vec_75;
											scal_24 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 10) + h + 1) + c];
											vec_77 = _mm512_set1_ps(scal_24);


											vec_76 = _mm512_fmadd_ps(vec_77, vec_46, mem_vec_4230);
											mem_vec_4230 = vec_76;



											vec_78 = _mm512_fmadd_ps(vec_77, vec_48, mem_vec_4231);
											mem_vec_4231 = vec_78;
											scal_25 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 11) + h + 1) + c];
											vec_80 = _mm512_set1_ps(scal_25);


											vec_79 = _mm512_fmadd_ps(vec_80, vec_46, mem_vec_4232);
											mem_vec_4232 = vec_79;



											vec_81 = _mm512_fmadd_ps(vec_80, vec_48, mem_vec_4233);
											mem_vec_4233 = vec_81;
											scal_26 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 12) + h + 1) + c];
											vec_83 = _mm512_set1_ps(scal_26);


											vec_82 = _mm512_fmadd_ps(vec_83, vec_46, mem_vec_4234);
											mem_vec_4234 = vec_82;



											vec_84 = _mm512_fmadd_ps(vec_83, vec_48, mem_vec_4235);
											mem_vec_4235 = vec_84;
											scal_27 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 13) + h + 1) + c];
											vec_86 = _mm512_set1_ps(scal_27);


											vec_85 = _mm512_fmadd_ps(vec_86, vec_46, mem_vec_4236);
											mem_vec_4236 = vec_85;



											vec_87 = _mm512_fmadd_ps(vec_86, vec_48, mem_vec_4237);
											mem_vec_4237 = vec_87;
											...
											vec_88 = _mm512_fmadd_ps(vec_89, vec_90, mem_vec_4210);
											mem_vec_4210 = vec_88;

											vec_92 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_91 = _mm512_fmadd_ps(vec_89, vec_92, mem_vec_4211);
											mem_vec_4211 = vec_91;
											scal_29 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
											vec_94 = _mm512_set1_ps(scal_29);


											vec_93 = _mm512_fmadd_ps(vec_94, vec_90, mem_vec_4212);
											mem_vec_4212 = vec_93;



											vec_95 = _mm512_fmadd_ps(vec_94, vec_92, mem_vec_4213);
											mem_vec_4213 = vec_95;
											scal_30 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
											vec_97 = _mm512_set1_ps(scal_30);


											vec_96 = _mm512_fmadd_ps(vec_97, vec_90, mem_vec_4214);
											mem_vec_4214 = vec_96;



											vec_98 = _mm512_fmadd_ps(vec_97, vec_92, mem_vec_4215);
											mem_vec_4215 = vec_98;
											scal_31 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
											vec_100 = _mm512_set1_ps(scal_31);


											vec_99 = _mm512_fmadd_ps(vec_100, vec_90, mem_vec_4216);
											mem_vec_4216 = vec_99;



											vec_101 = _mm512_fmadd_ps(vec_100, vec_92, mem_vec_4217);
											mem_vec_4217 = vec_101;
											scal_32 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
											vec_103 = _mm512_set1_ps(scal_32);


											vec_102 = _mm512_fmadd_ps(vec_103, vec_90, mem_vec_4218);
											mem_vec_4218 = vec_102;



											vec_104 = _mm512_fmadd_ps(vec_103, vec_92, mem_vec_4219);
											mem_vec_4219 = vec_104;
											scal_33 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 2) + c];
											vec_106 = _mm512_set1_ps(scal_33);


											vec_105 = _mm512_fmadd_ps(vec_106, vec_90, mem_vec_4220);
											mem_vec_4220 = vec_105;



											vec_107 = _mm512_fmadd_ps(vec_106, vec_92, mem_vec_4221);
											mem_vec_4221 = vec_107;
											scal_34 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 2) + c];
											vec_109 = _mm512_set1_ps(scal_34);


											vec_108 = _mm512_fmadd_ps(vec_109, vec_90, mem_vec_4222);
											mem_vec_4222 = vec_108;



											vec_110 = _mm512_fmadd_ps(vec_109, vec_92, mem_vec_4223);
											mem_vec_4223 = vec_110;
											scal_35 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 7) + h + 2) + c];
											vec_112 = _mm512_set1_ps(scal_35);


											vec_111 = _mm512_fmadd_ps(vec_112, vec_90, mem_vec_4224);
											mem_vec_4224 = vec_111;



											vec_113 = _mm512_fmadd_ps(vec_112, vec_92, mem_vec_4225);
											mem_vec_4225 = vec_113;
											scal_36 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 8) + h + 2) + c];
											vec_115 = _mm512_set1_ps(scal_36);


											vec_114 = _mm512_fmadd_ps(vec_115, vec_90, mem_vec_4226);
											mem_vec_4226 = vec_114;



											vec_116 = _mm512_fmadd_ps(vec_115, vec_92, mem_vec_4227);
											mem_vec_4227 = vec_116;
											scal_37 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 9) + h + 2) + c];
											vec_118 = _mm512_set1_ps(scal_37);


											vec_117 = _mm512_fmadd_ps(vec_118, vec_90, mem_vec_4228);
											mem_vec_4228 = vec_117;



											vec_119 = _mm512_fmadd_ps(vec_118, vec_92, mem_vec_4229);
											mem_vec_4229 = vec_119;
											scal_38 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 10) + h + 2) + c];
											vec_121 = _mm512_set1_ps(scal_38);


											vec_120 = _mm512_fmadd_ps(vec_121, vec_90, mem_vec_4230);
											mem_vec_4230 = vec_120;



											vec_122 = _mm512_fmadd_ps(vec_121, vec_92, mem_vec_4231);
											mem_vec_4231 = vec_122;
											scal_39 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 11) + h + 2) + c];
											vec_124 = _mm512_set1_ps(scal_39);


											vec_123 = _mm512_fmadd_ps(vec_124, vec_90, mem_vec_4232);
											mem_vec_4232 = vec_123;



											vec_125 = _mm512_fmadd_ps(vec_124, vec_92, mem_vec_4233);
											mem_vec_4233 = vec_125;
											scal_40 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 12) + h + 2) + c];
											vec_127 = _mm512_set1_ps(scal_40);


											vec_126 = _mm512_fmadd_ps(vec_127, vec_90, mem_vec_4234);
											mem_vec_4234 = vec_126;



											vec_128 = _mm512_fmadd_ps(vec_127, vec_92, mem_vec_4235);
											mem_vec_4235 = vec_128;
											scal_41 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 13) + h + 2) + c];
											vec_130 = _mm512_set1_ps(scal_41);


											vec_129 = _mm512_fmadd_ps(vec_130, vec_90, mem_vec_4236);
											mem_vec_4236 = vec_129;



											vec_131 = _mm512_fmadd_ps(vec_130, vec_92, mem_vec_4237);
											mem_vec_4237 = vec_131;
										}
