...
[V f; U (4, f); U (4, y); T (16, c); Hoist_vars [c]; T (17, x); T (3, w);
  T (3, h); T (8, x); T (68, y); T (2, c); T (2, x); T (1, x)]
*/
IND_TYPE c, cp_0, c30_p_0, cp_1, c30, h, hp_0, w, wp_0, x, xp_0, x50_p_0, x51_p_0, x52_p_0, xp_1, x50_p_1, x51_p_1, xp_2, x50_p_2, xp_3, x50, x51, x52, y, yp_0;
IND_TYPE y20 = 0;
IND_TYPE x53 = 0;
IND_TYPE h20 = 0;
IND_TYPE w20 = 0;
...
x50_p_2 = 0;
					for (h = h20, hp_0 = 0;h < h20 + 3;h += 1, hp_0 += 1){
						...
						for (w = w20, wp_0 = 0;w < w20 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 17) (17 / 1)
							for (x = x50, xp_3 = x50_p_2, xp_2 = x50_p_1, xp_1 = x50_p_0, xp_0 = 0;x < x50 + 17;x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
