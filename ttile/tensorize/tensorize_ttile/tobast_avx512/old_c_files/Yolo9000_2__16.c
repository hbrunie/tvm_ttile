...
for (x620 = x621, x620_p_0 = 0;
	x620 < x621 + 272;
	x620 += 272, x620_p_0 += 272){
	// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (x, 68) (272 / 4)
	for (x619 = x620, x619_p_1 = x620_p_0, x619_p_0 = 0;
		x619 < x620 + 272;
		x619 += 4, x619_p_1 += 4, x619_p_0 += 4){
		...
		for (c366 = c367, c366_p_0 = 0;
			...
			for (f = f194, fp_0 = 0;
				...
				for (y = y264, yp_0 = 0;
					...
					// T (x, 2) (4 / 2)
					for (x618 = x619, x618_p_2 = x619_p_1, x618_p_1 = x619_p_0, x618_p_0 = 0;
						x618 < x619 + 4;
						x618 += 2, x618_p_2 += 2, x618_p_1 += 2, x618_p_0 += 2){
						...
						for (h = h168, hp_0 = 0;
							...
							// T (x, 2) (2 / 1)
							for (x = x618, xp_3 = x618_p_2, xp_2 = x618_p_1, xp_1 = x618_p_0, xp_0 = 0;
								x < x618 + 2;
