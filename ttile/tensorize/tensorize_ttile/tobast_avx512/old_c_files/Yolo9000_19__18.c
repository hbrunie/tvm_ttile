					...
					for (c880 = c881, c880_p_1 = c881_p_0, c880_p_0 = 0;
						...
						for (x = x660, xp_1 = x660_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_7034 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
									mem_vec_7035 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									...
									mem_vec_7042 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32]);
									mem_vec_7043 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48]);
									...
									for (c = c880, cp_2 = c880_p_1, cp_1 = c880_p_0, cp_0 = 0;
										...
										vec_5 = _mm512_fmadd_ps(vec_1, vec_6, mem_vec_7034);
										mem_vec_7034 = vec_5;

										vec_8 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * h + F * c + f + 48]);

										vec_7 = _mm512_fmadd_ps(vec_1, vec_8, mem_vec_7035);
										mem_vec_7035 = vec_7;
										scal_1 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h) + c];
										vec_10 = _mm512_set1_ps(scal_1);


										vec_9 = _mm512_fmadd_ps(vec_10, vec_2, mem_vec_7036);
										mem_vec_7036 = vec_9;



										vec_11 = _mm512_fmadd_ps(vec_10, vec_4, mem_vec_7037);
										mem_vec_7037 = vec_11;



										vec_12 = _mm512_fmadd_ps(vec_10, vec_6, mem_vec_7038);
										mem_vec_7038 = vec_12;



										vec_13 = _mm512_fmadd_ps(vec_10, vec_8, mem_vec_7039);
										mem_vec_7039 = vec_13;
										...
										vec_17 = _mm512_fmadd_ps(vec_15, vec_6, mem_vec_7042);
										mem_vec_7042 = vec_17;



										vec_18 = _mm512_fmadd_ps(vec_15, vec_8, mem_vec_7043);
										mem_vec_7043 = vec_18;
									}
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_7032);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_7033);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_7034);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_7035);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32], mem_vec_7042);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48], mem_vec_7043);
						}
					}
				}
			}
					...
					for (c880 = c881, c880_p_1 = c881_p_0, c880_p_0 = 0;
						...
						for (x = x660, xp_1 = x660_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_7070 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
									mem_vec_7071 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 4, f = 64
									// T (c, 4) (4 / 1)
									for (c = c880, cp_2 = c880_p_1, cp_1 = c880_p_0, cp_0 = 0;
										c < c880 + 4;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_7070);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_7071);
						}
					}
				}
			}
