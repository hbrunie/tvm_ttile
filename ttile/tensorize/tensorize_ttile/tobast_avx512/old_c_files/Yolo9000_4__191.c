...
[V f; U (4, f); U (2, y); U (3, h); T (1, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, x); T (68, y); T (2, f); T (64, c); T (136, x)]
*/
IND_TYPE c, cp_0, c120_p_0, cp_1, c120, f, fp_0, w, wp_0, x, xp_0, x158_p_0, x159_p_0, xp_1, x158_p_1, xp_2, x158, x159, y, yp_0;
						...
						for (x = x158, xp_2 = x158_p_1, xp_1 = x158_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c120, cp_1 = c120_p_0, cp_0 = 0;
										...
										vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_592);
										mem_vec_592 = vec_14;

										vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_593);
										mem_vec_593 = vec_17;

										vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_594);
										mem_vec_594 = vec_19;

										vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_595);
										mem_vec_595 = vec_21;
										scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_24 = _mm512_set1_ps(scal_3);


										vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_596);
										mem_vec_596 = vec_23;



										vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_597);
										mem_vec_597 = vec_25;



										vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_598);
										mem_vec_598 = vec_26;



										vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_599);
										mem_vec_599 = vec_27;
										scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_29 = _mm512_set1_ps(scal_4);
										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_592);
										mem_vec_592 = vec_28;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_593);
										mem_vec_593 = vec_31;

										vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_594);
										mem_vec_594 = vec_33;

										vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_595);
										mem_vec_595 = vec_35;
										scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_38 = _mm512_set1_ps(scal_5);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_596);
										mem_vec_596 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_597);
										mem_vec_597 = vec_39;



										vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_598);
										mem_vec_598 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_599);
										mem_vec_599 = vec_41;
									}
