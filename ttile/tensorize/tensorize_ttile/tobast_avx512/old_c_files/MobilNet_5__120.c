					...
					for (h = h146, hp_0 = 0;
						...
						for (x = x270, xp_1 = x270_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1382 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
									mem_vec_1383 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
									mem_vec_1384 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
									mem_vec_1385 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
									...
									mem_vec_1390 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
									mem_vec_1391 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
									mem_vec_1392 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
									mem_vec_1393 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_1382);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_1383);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_1384);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_1385);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_1390);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_1391);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_1392);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_1393);
						}
					}
				}
			}
