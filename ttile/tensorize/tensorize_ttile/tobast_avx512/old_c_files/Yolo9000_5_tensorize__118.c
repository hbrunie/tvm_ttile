...
/*
[V f; U (4, f); U (4, y); T (1, c); Hoist_vars [c]; T (68, x); T (34, y);
  T (128, c); T (2, x)]
*/
IND_TYPE c, cp_0, c110_p_0, cp_1, c110, x, xp_0, x166_p_0, xp_1, x166, y, yp_0;
IND_TYPE y92 = 0;
IND_TYPE x167 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y = 0;
yp_0 = 0;
			for (x = x166, xp_1 = x166_p_0, xp_0 = 0;x < x166 + 68;x += 1, xp_1 += 1, xp_0 += 1){
