...
yp_0 = 0;
								for (h = h308, hp_0 = 0;h < h308 + 3;h += 1, hp_0 += 1){
									...
									for (x = x548, xp_1 = x548_p_0, xp_0 = 0;x < x548 + 14;x += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3522 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
												mem_vec_3523 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_3522);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_3523);
									}
								}
}
