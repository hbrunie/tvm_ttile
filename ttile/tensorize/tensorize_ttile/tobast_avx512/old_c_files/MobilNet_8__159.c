		...
		for (y = y398, yp_0 = 0;
			...
			for (f = f704, fp_0 = 0;
				...
				for (c904 = c905, c904_p_1 = c905_p_0, c904_p_0 = 0;
					c904 < c905 + 512;
					c904 += 32, c904_p_1 += 32, c904_p_0 += 32){
					...
					for (w = w400, wp_0 = 0;
						...
						for (x = x536, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_4346 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
									mem_vec_4347 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									mem_vec_4348 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_4349 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_4350 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
									mem_vec_4351 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_4346);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_4347);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_4348);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_4349);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_4350);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_4351);
						}
					}
				}
			}
						...
						for (x = x536, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c904, cp_2 = c904_p_1, cp_1 = c904_p_0, cp_0 = 0;
										...
										vec_29 = _mm512_fmadd_ps(vec_30, vec_31, mem_vec_4352);
										mem_vec_4352 = vec_29;

										vec_33 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_4353);
										mem_vec_4353 = vec_32;

										vec_35 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

										vec_34 = _mm512_fmadd_ps(vec_30, vec_35, mem_vec_4354);
										mem_vec_4354 = vec_34;

										vec_37 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

										vec_36 = _mm512_fmadd_ps(vec_30, vec_37, mem_vec_4355);
										mem_vec_4355 = vec_36;
										scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_31, mem_vec_4356);
										mem_vec_4356 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_33, mem_vec_4357);
										mem_vec_4357 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_35, mem_vec_4358);
										mem_vec_4358 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_37, mem_vec_4359);
										mem_vec_4359 = vec_42;
										scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_7);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_4360);
										mem_vec_4360 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_4361);
										mem_vec_4361 = vec_45;



										vec_46 = _mm512_fmadd_ps(vec_44, vec_35, mem_vec_4362);
										mem_vec_4362 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_37, mem_vec_4363);
										mem_vec_4363 = vec_47;
										scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
										vec_49 = _mm512_set1_ps(scal_8);


										vec_48 = _mm512_fmadd_ps(vec_49, vec_31, mem_vec_4364);
										mem_vec_4364 = vec_48;



										vec_50 = _mm512_fmadd_ps(vec_49, vec_33, mem_vec_4365);
										mem_vec_4365 = vec_50;



										vec_51 = _mm512_fmadd_ps(vec_49, vec_35, mem_vec_4366);
										mem_vec_4366 = vec_51;



										vec_52 = _mm512_fmadd_ps(vec_49, vec_37, mem_vec_4367);
										mem_vec_4367 = vec_52;
										scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
										vec_54 = _mm512_set1_ps(scal_9);


										vec_53 = _mm512_fmadd_ps(vec_54, vec_31, mem_vec_4368);
										mem_vec_4368 = vec_53;



										vec_55 = _mm512_fmadd_ps(vec_54, vec_33, mem_vec_4369);
										mem_vec_4369 = vec_55;



										vec_56 = _mm512_fmadd_ps(vec_54, vec_35, mem_vec_4370);
										mem_vec_4370 = vec_56;



										vec_57 = _mm512_fmadd_ps(vec_54, vec_37, mem_vec_4371);
										mem_vec_4371 = vec_57;
										scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
										vec_59 = _mm512_set1_ps(scal_10);
										vec_60 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_58 = _mm512_fmadd_ps(vec_59, vec_60, mem_vec_4352);
										mem_vec_4352 = vec_58;

										vec_62 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_4353);
										mem_vec_4353 = vec_61;

										vec_64 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

										vec_63 = _mm512_fmadd_ps(vec_59, vec_64, mem_vec_4354);
										mem_vec_4354 = vec_63;

										vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

										vec_65 = _mm512_fmadd_ps(vec_59, vec_66, mem_vec_4355);
										mem_vec_4355 = vec_65;
										scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_60, mem_vec_4356);
										mem_vec_4356 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_62, mem_vec_4357);
										mem_vec_4357 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_64, mem_vec_4358);
										mem_vec_4358 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_66, mem_vec_4359);
										mem_vec_4359 = vec_71;
										scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
										vec_73 = _mm512_set1_ps(scal_12);


										vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_4360);
										mem_vec_4360 = vec_72;



										vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_4361);
										mem_vec_4361 = vec_74;



										vec_75 = _mm512_fmadd_ps(vec_73, vec_64, mem_vec_4362);
										mem_vec_4362 = vec_75;



										vec_76 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_4363);
										mem_vec_4363 = vec_76;
										scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
										vec_78 = _mm512_set1_ps(scal_13);


										vec_77 = _mm512_fmadd_ps(vec_78, vec_60, mem_vec_4364);
										mem_vec_4364 = vec_77;



										vec_79 = _mm512_fmadd_ps(vec_78, vec_62, mem_vec_4365);
										mem_vec_4365 = vec_79;



										vec_80 = _mm512_fmadd_ps(vec_78, vec_64, mem_vec_4366);
										mem_vec_4366 = vec_80;



										vec_81 = _mm512_fmadd_ps(vec_78, vec_66, mem_vec_4367);
										mem_vec_4367 = vec_81;
										scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
										vec_83 = _mm512_set1_ps(scal_14);


										vec_82 = _mm512_fmadd_ps(vec_83, vec_60, mem_vec_4368);
										mem_vec_4368 = vec_82;



										vec_84 = _mm512_fmadd_ps(vec_83, vec_62, mem_vec_4369);
										mem_vec_4369 = vec_84;



										vec_85 = _mm512_fmadd_ps(vec_83, vec_64, mem_vec_4370);
										mem_vec_4370 = vec_85;



										vec_86 = _mm512_fmadd_ps(vec_83, vec_66, mem_vec_4371);
										mem_vec_4371 = vec_86;
									}
