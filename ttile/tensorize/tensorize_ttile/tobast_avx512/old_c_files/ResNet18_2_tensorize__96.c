...
[V f; U (1, f); U (7, y); U (3, h); T (1, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (8, x); T (8, y); T (4, f); T (64, c); T (1, x)]
*/
IND_TYPE c, cp_0, c58_p_0, cp_1, c58, f, fp_0, w, wp_0, x, xp_0, x68_p_0, x69_p_0, xp_1, x68_p_1, xp_2, x68, x69, y, yp_0;
IND_TYPE y36 = 0;
IND_TYPE x70 = 0;
IND_TYPE h = 0;
IND_TYPE w36 = 0;
...
x68_p_1 = 0;
					for (w = w36, wp_0 = 0;w < w36 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 7) (7 / 1)
						for (x = x68, xp_2 = x68_p_1, xp_1 = x68_p_0, xp_0 = 0;x < x68 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_338 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									mem_vec_339 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_340 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_341 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									mem_vec_342 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
									mem_vec_343 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									mem_vec_344 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									// y = 7, x = 1, h = 3, w = 1, c = 1, f = 16
									// T (c, 1) (1 / 1)
									for (c = c58, cp_1 = c58_p_0, cp_0 = 0;c < c58 + 1;c += 1, cp_1 += 1, cp_0 += 1){
