...
[V f; U (2, f); ULambda y; U (3, w); T (1, c); Hoist_vars [c]; T (2, x);
  ...
  T (4, f); T (128, c); T (2, f); T (2, c); T (7, x); T (1, f)]
*/
IND_TYPE c, cp_0, c762_p_0, c763_p_0, cp_1, c762_p_1, cp_2, c762, c763, f, fp_0, f738_p_0, f739_p_0, fp_1, f738_p_1, fp_2, f738, f739, h, hp_0, x, xp_0, x634_p_0, xp_1, x634, y, yp_0;
IND_TYPE y424 = 0;
IND_TYPE x635 = 0;
IND_TYPE h366 = 0;
IND_TYPE w = 0;
...
yp_0 = 0;
								for (h = h366, hp_0 = 0;h < h366 + 3;h += 1, hp_0 += 1){
									...
									// T (x, 2) (2 / 1)
									for (x = x634, xp_1 = x634_p_0, xp_0 = 0;x < x634 + 2;x += 1, xp_1 += 1, xp_0 += 1){
												...
												// T (c, 1) (1 / 1)
												for (c = c762, cp_2 = c762_p_1, cp_1 = c762_p_0, cp_0 = 0;c < c762 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
