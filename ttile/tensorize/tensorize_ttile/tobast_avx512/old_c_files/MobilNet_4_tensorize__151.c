					...
					for (h = h20, hp_0 = 0;h < h20 + 3;h += 1, hp_0 += 1){
						...
						for (w = w20, wp_0 = 0;w < w20 + 3;w += 1, wp_0 += 1){
							...
							for (x = x30, xp_1 = x30_p_0, xp_0 = 0;x < x30 + 2;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_210 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
										mem_vec_211 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
										...
										mem_vec_214 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
										mem_vec_215 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_210);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_211);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_214);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_215);
							}
						}
					}
}
