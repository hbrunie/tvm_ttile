...
x406 = 0;
x406_p_0 = 0;
				for (h = h278, hp_0 = 0;h < h278 + 7;h += 1, hp_0 += 1){
					// y = 8, x = 28, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w278, wp_0 = 0;w < w278 + 7;w += 1, wp_0 += 1){
						// y = 8, x = 28, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c417 = c418, c417_p_0 = 0;c417 < c418 + 3;c417 += 3, c417_p_0 += 3){
							// y = 8, x = 28, h = 1, w = 1, c = 3, f = 32
							// T (x, 28) (28 / 1)
							for (x = x406, xp_1 = x406_p_0, xp_0 = 0;x < x406 + 28;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c417, cp_1 = c417_p_0, cp_0 = 0;c < c417 + 3;c += 1, cp_1 += 1, cp_0 += 1){
