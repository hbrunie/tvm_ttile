							...
							for (w = w42, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c84, cp_2 = c84_p_1, cp_1 = c84_p_0, cp_0 = 0;
											...
											vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_544);
											mem_vec_544 = vec_23;

											vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_545);
											mem_vec_545 = vec_26;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_29 = _mm512_set1_ps(scal_8);


											vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_546);
											mem_vec_546 = vec_28;



											vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_547);
											mem_vec_547 = vec_30;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_548);
											mem_vec_548 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_549);
											mem_vec_549 = vec_33;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_550);
											mem_vec_550 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_551);
											mem_vec_551 = vec_36;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_552);
											mem_vec_552 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_553);
											mem_vec_553 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_554);
											mem_vec_554 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_555);
											mem_vec_555 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_556);
											mem_vec_556 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_557);
											mem_vec_557 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_47 = _mm512_set1_ps(scal_14);
											vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_544);
											mem_vec_544 = vec_46;

											vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_545);
											mem_vec_545 = vec_49;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_52 = _mm512_set1_ps(scal_15);


											vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_546);
											mem_vec_546 = vec_51;



											vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_547);
											mem_vec_547 = vec_53;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_55 = _mm512_set1_ps(scal_16);


											vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_548);
											mem_vec_548 = vec_54;



											vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_549);
											mem_vec_549 = vec_56;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_550);
											mem_vec_550 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_551);
											mem_vec_551 = vec_59;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_61 = _mm512_set1_ps(scal_18);


											vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_552);
											mem_vec_552 = vec_60;



											vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_553);
											mem_vec_553 = vec_62;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_554);
											mem_vec_554 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_555);
											mem_vec_555 = vec_65;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_556);
											mem_vec_556 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_557);
											mem_vec_557 = vec_68;
										}
							...
							for (w = w42, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c84, cp_2 = c84_p_1, cp_1 = c84_p_0, cp_0 = 0;
											...
											vec_32 = _mm512_fmadd_ps(vec_33, vec_34, mem_vec_558);
											mem_vec_558 = vec_32;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_35 = _mm512_fmadd_ps(vec_33, vec_36, mem_vec_559);
											mem_vec_559 = vec_35;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_560);
											mem_vec_560 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_561);
											mem_vec_561 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_34, mem_vec_562);
											mem_vec_562 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_36, mem_vec_563);
											mem_vec_563 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_34, mem_vec_564);
											mem_vec_564 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_565);
											mem_vec_565 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_34, mem_vec_566);
											mem_vec_566 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_36, mem_vec_567);
											mem_vec_567 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_34, mem_vec_568);
											mem_vec_568 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_36, mem_vec_569);
											mem_vec_569 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_53 = _mm512_set1_ps(scal_16);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_34, mem_vec_570);
											mem_vec_570 = vec_52;



											vec_54 = _mm512_fmadd_ps(vec_53, vec_36, mem_vec_571);
											mem_vec_571 = vec_54;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
											vec_56 = _mm512_set1_ps(scal_17);


											vec_55 = _mm512_fmadd_ps(vec_56, vec_34, mem_vec_572);
											mem_vec_572 = vec_55;



											vec_57 = _mm512_fmadd_ps(vec_56, vec_36, mem_vec_573);
											mem_vec_573 = vec_57;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
											vec_59 = _mm512_set1_ps(scal_18);


											vec_58 = _mm512_fmadd_ps(vec_59, vec_34, mem_vec_574);
											mem_vec_574 = vec_58;



											vec_60 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_575);
											mem_vec_575 = vec_60;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
											vec_62 = _mm512_set1_ps(scal_19);


											vec_61 = _mm512_fmadd_ps(vec_62, vec_34, mem_vec_576);
											mem_vec_576 = vec_61;



											vec_63 = _mm512_fmadd_ps(vec_62, vec_36, mem_vec_577);
											mem_vec_577 = vec_63;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_65 = _mm512_set1_ps(scal_20);
											vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_64 = _mm512_fmadd_ps(vec_65, vec_66, mem_vec_558);
											mem_vec_558 = vec_64;

											vec_68 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_67 = _mm512_fmadd_ps(vec_65, vec_68, mem_vec_559);
											mem_vec_559 = vec_67;
											scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_70 = _mm512_set1_ps(scal_21);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_66, mem_vec_560);
											mem_vec_560 = vec_69;



											vec_71 = _mm512_fmadd_ps(vec_70, vec_68, mem_vec_561);
											mem_vec_561 = vec_71;
											scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_73 = _mm512_set1_ps(scal_22);


											vec_72 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_562);
											mem_vec_562 = vec_72;



											vec_74 = _mm512_fmadd_ps(vec_73, vec_68, mem_vec_563);
											mem_vec_563 = vec_74;
											scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_76 = _mm512_set1_ps(scal_23);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_66, mem_vec_564);
											mem_vec_564 = vec_75;



											vec_77 = _mm512_fmadd_ps(vec_76, vec_68, mem_vec_565);
											mem_vec_565 = vec_77;
											scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_79 = _mm512_set1_ps(scal_24);


											vec_78 = _mm512_fmadd_ps(vec_79, vec_66, mem_vec_566);
											mem_vec_566 = vec_78;



											vec_80 = _mm512_fmadd_ps(vec_79, vec_68, mem_vec_567);
											mem_vec_567 = vec_80;
											scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_82 = _mm512_set1_ps(scal_25);


											vec_81 = _mm512_fmadd_ps(vec_82, vec_66, mem_vec_568);
											mem_vec_568 = vec_81;



											vec_83 = _mm512_fmadd_ps(vec_82, vec_68, mem_vec_569);
											mem_vec_569 = vec_83;
											scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_85 = _mm512_set1_ps(scal_26);


											vec_84 = _mm512_fmadd_ps(vec_85, vec_66, mem_vec_570);
											mem_vec_570 = vec_84;



											vec_86 = _mm512_fmadd_ps(vec_85, vec_68, mem_vec_571);
											mem_vec_571 = vec_86;
											scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
											vec_88 = _mm512_set1_ps(scal_27);


											vec_87 = _mm512_fmadd_ps(vec_88, vec_66, mem_vec_572);
											mem_vec_572 = vec_87;



											vec_89 = _mm512_fmadd_ps(vec_88, vec_68, mem_vec_573);
											mem_vec_573 = vec_89;
											scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
											vec_91 = _mm512_set1_ps(scal_28);


											vec_90 = _mm512_fmadd_ps(vec_91, vec_66, mem_vec_574);
											mem_vec_574 = vec_90;



											vec_92 = _mm512_fmadd_ps(vec_91, vec_68, mem_vec_575);
											mem_vec_575 = vec_92;
											scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
											vec_94 = _mm512_set1_ps(scal_29);


											vec_93 = _mm512_fmadd_ps(vec_94, vec_66, mem_vec_576);
											mem_vec_576 = vec_93;



											vec_95 = _mm512_fmadd_ps(vec_94, vec_68, mem_vec_577);
											mem_vec_577 = vec_95;
										}
