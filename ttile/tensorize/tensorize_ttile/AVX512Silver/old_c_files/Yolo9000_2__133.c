...
[V f; U (4, f); U (2, y); U (3, w); T (16, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (2, c); T (1, x); T (1, y); T (17, y); T (136, x); T (8, y)]
*/
IND_TYPE c, cp_0, c210_p_0, cp_1, c210, h, hp_0, x, xp_0, x280_p_0, x281_p_0, xp_1, x280_p_1, xp_2, x280, x281, y, yp_0, y280_p_0, y281_p_0, yp_1, y280_p_1, yp_2, y280, y281;
