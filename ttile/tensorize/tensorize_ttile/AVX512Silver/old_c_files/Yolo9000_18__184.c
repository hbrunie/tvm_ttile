...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  ...
  T (32, c); T (16, f)]
*/
IND_TYPE c, cp_0, c188_p_0, c189_p_0, cp_1, c188_p_1, cp_2, c188, c189, f, fp_0, f141_p_0, fp_1, f141, x, xp_0, y, yp_0;
					...
					for (c188 = c189, c188_p_1 = c189_p_0, c188_p_0 = 0;
						...
						for (x = x94, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_1141 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1142 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_1143 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c188, cp_2 = c188_p_1, cp_1 = c188_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1141);
										mem_vec_1141 = vec_3;
					...
					for (c188 = c189, c188_p_1 = c189_p_0, c188_p_0 = 0;
						...
						for (x = x94, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_1145 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1146 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_1147 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c188, cp_2 = c188_p_1, cp_1 = c188_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1145);
										mem_vec_1145 = vec_3;
										scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
										vec_6 = _mm512_set1_ps(scal_2);
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_1147);
										mem_vec_1147 = vec_7;
