							...
							for (w = w52, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c104, cp_2 = c104_p_1, cp_1 = c104_p_0, cp_0 = 0;
											...
											vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_714);
											mem_vec_714 = vec_26;

											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_715);
											mem_vec_715 = vec_29;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_716);
											mem_vec_716 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_717);
											mem_vec_717 = vec_33;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_718);
											mem_vec_718 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_719);
											mem_vec_719 = vec_36;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_720);
											mem_vec_720 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_721);
											mem_vec_721 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_722);
											mem_vec_722 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_723);
											mem_vec_723 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_724);
											mem_vec_724 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_725);
											mem_vec_725 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_726);
											mem_vec_726 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_727);
											mem_vec_727 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_728);
											mem_vec_728 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_729);
											mem_vec_729 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_53 = _mm512_set1_ps(scal_16);
											vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_714);
											mem_vec_714 = vec_52;

											vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_715);
											mem_vec_715 = vec_55;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_716);
											mem_vec_716 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_717);
											mem_vec_717 = vec_59;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_61 = _mm512_set1_ps(scal_18);


											vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_718);
											mem_vec_718 = vec_60;



											vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_719);
											mem_vec_719 = vec_62;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_720);
											mem_vec_720 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_721);
											mem_vec_721 = vec_65;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_722);
											mem_vec_722 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_723);
											mem_vec_723 = vec_68;
											scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_70 = _mm512_set1_ps(scal_21);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_724);
											mem_vec_724 = vec_69;



											vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_725);
											mem_vec_725 = vec_71;
											scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_73 = _mm512_set1_ps(scal_22);


											vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_726);
											mem_vec_726 = vec_72;



											vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_727);
											mem_vec_727 = vec_74;
											scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
											vec_76 = _mm512_set1_ps(scal_23);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_728);
											mem_vec_728 = vec_75;



											vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_729);
											mem_vec_729 = vec_77;
										}
