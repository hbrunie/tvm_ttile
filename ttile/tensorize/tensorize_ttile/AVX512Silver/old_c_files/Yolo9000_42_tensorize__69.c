...
c210_p_0 = 0;
						for (h = h86, hp_0 = 0;h < h86 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 34) (34 / 1)
							for (x = x278, xp_2 = x278_p_1, xp_1 = x278_p_0, xp_0 = 0;x < x278 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3402 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										mem_vec_3403 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
										mem_vec_3404 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_3405 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_3402);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_3403);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3404);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_3405);
							}
						}
}
