...
xp_0 = 0;
						for (h = h204, hp_0 = 0;h < h204 + 3;h += 1, hp_0 += 1){
									...
									mem_vec_2217 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_2218 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2217);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2218);
