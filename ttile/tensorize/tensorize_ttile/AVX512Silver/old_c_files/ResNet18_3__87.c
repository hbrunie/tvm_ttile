...
for (y691 = y692, y691_p_0 = 0;
	...
	for (x869 = x870, x869_p_0 = 0;
		...
		// y = 56, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 2) (56 / 28)
		for (y690 = y691, y690_p_1 = y691_p_0, y690_p_0 = 0;
			y690 < y691 + 56;
			y690 += 28, y690_p_1 += 28, y690_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (56 / 4)
			for (x868 = x869, x868_p_1 = x869_p_0, x868_p_0 = 0;
				x868 < x869 + 56;
				x868 += 4, x868_p_1 += 4, x868_p_0 += 4){
				...
				for (f = f336, fp_0 = 0;
					...
					// T (y, 4) (28 / 7)
					for (y = y690, yp_2 = y690_p_1, yp_1 = y690_p_0, yp_0 = 0;
						y < y690 + 28;
						y += 7, yp_2 += 7, yp_1 += 7, yp_0 += 7){
						// y = 7, x = 4, h = 1, w = 1, c = 64, f = 32
						// T (x, 4) (4 / 1)
						for (x867 = x868, x867_p_2 = x868_p_1, x867_p_1 = x868_p_0, x867_p_0 = 0;
							x867 < x868 + 4;
							x867 += 1, x867_p_2 += 1, x867_p_1 += 1, x867_p_0 += 1){
							...
							for (c531 = c532, c531_p_0 = 0;
								...
								// y = 7, x = 1, h = 1, w = 1, c = 64, f = 32
								// T (x, 1) (1 / 1)
								for (x = x867, xp_3 = x867_p_2, xp_2 = x867_p_1, xp_1 = x867_p_0, xp_0 = 0;
									x < x867 + 1;
