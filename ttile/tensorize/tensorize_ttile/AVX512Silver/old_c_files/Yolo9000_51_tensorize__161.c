...
yp_1 = 0;
					for (x = x168, xp_1 = x168_p_0, xp_0 = 0;x < x168 + 2;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_2310 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
								mem_vec_2311 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_2310);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_2311);
					}
}
