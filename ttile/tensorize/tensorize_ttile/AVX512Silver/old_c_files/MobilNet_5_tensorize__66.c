...
xp_0 = 0;
					for (w = w136, wp_0 = 0;w < w136 + 3;w += 1, wp_0 += 1){
								...
								mem_vec_1675 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_1676 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								mem_vec_1677 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_1675);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_1676);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_1677);
