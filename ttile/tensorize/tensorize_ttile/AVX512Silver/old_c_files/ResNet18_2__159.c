...
for (x31 = x32, x31_p_0 = 0;
	...
	for (y = y18, yp_0 = 0;
		...
		// T (x, 1) (28 / 28)
		for (x30 = x31, x30_p_1 = x31_p_0, x30_p_0 = 0;
			x30 < x31 + 28;
			x30 += 28, x30_p_1 += 28, x30_p_0 += 28){
			// y = 14, x = 28, h = 3, w = 3, c = 64, f = 64
			// T (f, 2) (64 / 32)
			for (f = f16, fp_0 = 0;
				f < f16 + 64;
				...
				for (c24 = c25, c24_p_0 = 0;
					...
					for (w = w11, wp_0 = 0;
						...
						// T (x, 28) (28 / 1)
						for (x = x30, xp_2 = x30_p_1, xp_1 = x30_p_0, xp_0 = 0;
							x < x30 + 28;
							...
							for (h = h12, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										mem_vec_170 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
										mem_vec_171 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
										mem_vec_172 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
										mem_vec_173 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
										mem_vec_174 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_175 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										mem_vec_176 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
										mem_vec_177 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
										mem_vec_178 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_179 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_170);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_171);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_172);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_173);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_174);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_175);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_176);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_177);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_178);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_179);
							}
						}
					}
				}
