...
[V f; U (2, f); ULambda y; T (256, c); Hoist_vars [c]; T (1, x); T (2, c);
  ...
  T (8, f); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c555_p_0, cp_1, c555, f, fp_0, x, xp_0, x740_p_0, x741_p_0, xp_1, x740_p_1, xp_2, x740, x741, y, yp_0, y529_p_0, yp_1, y529;
...
for (y529 = y530, y529_p_0 = 0;
	...
	for (x741 = x742, x741_p_0 = 0;
		...
		for (f = f370, fp_0 = 0;
			f < f370 + 256;
			f += 32, fp_0 += 32){
				for (y = y529, yp_1 = y529_p_0, yp_0 = 0;
					y < y529 + 24;
					y += 8, yp_1 += 8, yp_0 += 8){
				...
				for (y = y529 + 24, yp_1 = y529_p_0, yp_0 = 0;
					y < y529 + 24 + 10;
