...
y237 = 0;
y237_p_0 = 0;
	for (x317 = x318, x317_p_0 = 0;x317 < x318 + 68;x317 += 34, x317_p_0 += 34){
			for (y = y237, yp_1 = y237_p_0, yp_0 = 0;y < y237 + 9;y += 3, yp_1 += 3, yp_0 += 3){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
				for (x316 = x317, x316_p_1 = x317_p_0, x316_p_0 = 0;x316 < x317 + 34;x316 += 34, x316_p_1 += 34, x316_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f158, fp_0 = 0;f < f158 + 128;f += 64, fp_0 += 64){
						// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 64
						// T (c, 4) (256 / 64)
						for (c237 = c238, c237_p_0 = 0;c237 < c238 + 256;c237 += 64, c237_p_0 += 64){
							// y = ph_y, x = 34, h = 1, w = 1, c = 64, f = 64
							// T (x, 34) (34 / 1)
							for (x = x316, xp_2 = x316_p_1, xp_1 = x316_p_0, xp_0 = 0;x < x316 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y237 + 9, yp_1 = y237_p_0, yp_0 = 0;y < y237 + 9 + 8;y += 4, yp_1 += 4, yp_0 += 4){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
				for (x316 = x317, x316_p_1 = x317_p_0, x316_p_0 = 0;x316 < x317 + 34;x316 += 34, x316_p_1 += 34, x316_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
