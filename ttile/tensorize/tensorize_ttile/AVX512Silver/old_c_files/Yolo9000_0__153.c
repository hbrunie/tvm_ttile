...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (1, x); T (2, f); T (1, x); T (1, y); T (68, y); T (544, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x100_p_0, x101_p_0, xp_1, x100_p_1, xp_2, x100, x101, y, yp_0, y94_p_0, y95_p_0, yp_1, y94_p_1, yp_2, y94, y95;
...
for (y95 = y96, y95_p_0 = 0;
	...
	for (x101 = x102, x101_p_0 = 0;
		...
		// T (y, 68) (272 / 4)
		for (y94 = y95, y94_p_1 = y95_p_0, y94_p_0 = 0;
			y94 < y95 + 272;
			y94 += 4, y94_p_1 += 4, y94_p_0 += 4){
			// y = 4, x = 1, h = 3, w = 3, c = 3, f = 32
			// T (y, 1) (4 / 4)
			for (y = y94, yp_2 = y94_p_1, yp_1 = y94_p_0, yp_0 = 0;
				y < y94 + 4;
					...
					for (f = f44, fp_0 = 0;
						...
						for (x = x100, xp_2 = x100_p_1, xp_1 = x100_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_197 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_198 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_199 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									// y = 4, x = 1, h = 3, w = 3, c = 3, f = 16
									// T (c, 3) (3 / 1)
									for (c = c56, cp_0 = 0;
										c < c56 + 3;
