...
[V f; U (2, f); ULambda y; T (64, c); Hoist_vars [c]; T (2, x); T (8, c);
  ...
  T (8, f); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c147_p_0, cp_1, c147, f, fp_0, x, xp_0, x196_p_0, x197_p_0, xp_1, x196_p_1, xp_2, x196, x197, y, yp_0, y121_p_0, yp_1, y121;
IND_TYPE y122 = 0;
IND_TYPE x198 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x197_p_0 = 0;
		for (f = f98, fp_0 = 0;f < f98 + 256;f += 32, fp_0 += 32){
				for (y = y121, yp_1 = y121_p_0, yp_0 = 0;y < y121 + 10;y += 10, yp_1 += 10, yp_0 += 10){
				...
				for (y = y121 + 10, yp_1 = y121_p_0, yp_0 = 0;y < y121 + 10 + 24;y += 12, yp_1 += 12, yp_0 += 12){
					// y = ph_y, x = 34, h = 1, w = 1, c = 512, f = 32
					// T (x, 17) (34 / 2)
					for (x196 = x197, x196_p_1 = x197_p_0, x196_p_0 = 0;x196 < x197 + 34;x196 += 2, x196_p_1 += 2, x196_p_0 += 2){
						// y = ph_y, x = 2, h = 1, w = 1, c = 512, f = 32
