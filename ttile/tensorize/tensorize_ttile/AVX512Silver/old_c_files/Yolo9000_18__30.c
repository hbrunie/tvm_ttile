...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  ...
  T (8, c); T (1, f)]
*/
IND_TYPE c, cp_0, c336_p_0, c337_p_0, cp_1, c336_p_1, cp_2, c336, c337, f, fp_0, f252_p_0, fp_1, f252, x, xp_0, y, yp_0;
					...
					for (c336 = c337, c336_p_1 = c337_p_0, c336_p_0 = 0;
						...
						for (x = x168, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_1715 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									...
									for (c = c336, cp_2 = c336_p_1, cp_1 = c336_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1714);
										mem_vec_1714 = vec_3;
