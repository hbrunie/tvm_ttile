...
[V f; U (2, f); ULambda y; U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  ...
  T (1, f); T (4, f)]
*/
IND_TYPE c, cp_0, c27_p_0, cp_1, c27, f, fp_0, f36_p_0, f37_p_0, fp_1, f36_p_1, fp_2, f36, f37, x, xp_0, x27_p_0, xp_1, x27, y, yp_0;
							...
							for (x = x27, xp_1 = x27_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c27, cp_1 = c27_p_0, cp_0 = 0;
											...
											vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_414);
											mem_vec_414 = vec_26;

											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_415);
											mem_vec_415 = vec_29;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_416);
											mem_vec_416 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_417);
											mem_vec_417 = vec_33;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_418);
											mem_vec_418 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_419);
											mem_vec_419 = vec_36;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_420);
											mem_vec_420 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_421);
											mem_vec_421 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_422);
											mem_vec_422 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_423);
											mem_vec_423 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_424);
											mem_vec_424 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_425);
											mem_vec_425 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_426);
											mem_vec_426 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_427);
											mem_vec_427 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_428);
											mem_vec_428 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_429);
											mem_vec_429 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_53 = _mm512_set1_ps(scal_16);
											vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_414);
											mem_vec_414 = vec_52;

											vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_415);
											mem_vec_415 = vec_55;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_416);
											mem_vec_416 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_417);
											mem_vec_417 = vec_59;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_61 = _mm512_set1_ps(scal_18);


											vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_418);
											mem_vec_418 = vec_60;



											vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_419);
											mem_vec_419 = vec_62;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_420);
											mem_vec_420 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_421);
											mem_vec_421 = vec_65;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_422);
											mem_vec_422 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_423);
											mem_vec_423 = vec_68;
											scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_70 = _mm512_set1_ps(scal_21);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_424);
											mem_vec_424 = vec_69;



											vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_425);
											mem_vec_425 = vec_71;
											scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_73 = _mm512_set1_ps(scal_22);


											vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_426);
											mem_vec_426 = vec_72;



											vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_427);
											mem_vec_427 = vec_74;
											scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
											vec_76 = _mm512_set1_ps(scal_23);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_428);
											mem_vec_428 = vec_75;



											vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_429);
											mem_vec_429 = vec_77;
											scal_24 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
											vec_79 = _mm512_set1_ps(scal_24);
											vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

											vec_78 = _mm512_fmadd_ps(vec_79, vec_80, mem_vec_414);
											mem_vec_414 = vec_78;

											vec_82 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_81 = _mm512_fmadd_ps(vec_79, vec_82, mem_vec_415);
											mem_vec_415 = vec_81;
											scal_25 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_84 = _mm512_set1_ps(scal_25);


											vec_83 = _mm512_fmadd_ps(vec_84, vec_80, mem_vec_416);
											mem_vec_416 = vec_83;



											vec_85 = _mm512_fmadd_ps(vec_84, vec_82, mem_vec_417);
											mem_vec_417 = vec_85;
											scal_26 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_87 = _mm512_set1_ps(scal_26);


											vec_86 = _mm512_fmadd_ps(vec_87, vec_80, mem_vec_418);
											mem_vec_418 = vec_86;



											vec_88 = _mm512_fmadd_ps(vec_87, vec_82, mem_vec_419);
											mem_vec_419 = vec_88;
											scal_27 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_90 = _mm512_set1_ps(scal_27);


											vec_89 = _mm512_fmadd_ps(vec_90, vec_80, mem_vec_420);
											mem_vec_420 = vec_89;



											vec_91 = _mm512_fmadd_ps(vec_90, vec_82, mem_vec_421);
											mem_vec_421 = vec_91;
											scal_28 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_93 = _mm512_set1_ps(scal_28);


											vec_92 = _mm512_fmadd_ps(vec_93, vec_80, mem_vec_422);
											mem_vec_422 = vec_92;



											vec_94 = _mm512_fmadd_ps(vec_93, vec_82, mem_vec_423);
											mem_vec_423 = vec_94;
											scal_29 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_96 = _mm512_set1_ps(scal_29);


											vec_95 = _mm512_fmadd_ps(vec_96, vec_80, mem_vec_424);
											mem_vec_424 = vec_95;



											vec_97 = _mm512_fmadd_ps(vec_96, vec_82, mem_vec_425);
											mem_vec_425 = vec_97;
											scal_30 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_99 = _mm512_set1_ps(scal_30);


											vec_98 = _mm512_fmadd_ps(vec_99, vec_80, mem_vec_426);
											mem_vec_426 = vec_98;



											vec_100 = _mm512_fmadd_ps(vec_99, vec_82, mem_vec_427);
											mem_vec_427 = vec_100;
											scal_31 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_102 = _mm512_set1_ps(scal_31);


											vec_101 = _mm512_fmadd_ps(vec_102, vec_80, mem_vec_428);
											mem_vec_428 = vec_101;



											vec_103 = _mm512_fmadd_ps(vec_102, vec_82, mem_vec_429);
											mem_vec_429 = vec_103;
											...
											vec_104 = _mm512_fmadd_ps(vec_105, vec_106, mem_vec_414);
											mem_vec_414 = vec_104;

											vec_108 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_107 = _mm512_fmadd_ps(vec_105, vec_108, mem_vec_415);
											mem_vec_415 = vec_107;
											scal_33 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
											vec_110 = _mm512_set1_ps(scal_33);


											vec_109 = _mm512_fmadd_ps(vec_110, vec_106, mem_vec_416);
											mem_vec_416 = vec_109;



											vec_111 = _mm512_fmadd_ps(vec_110, vec_108, mem_vec_417);
											mem_vec_417 = vec_111;
											scal_34 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
											vec_113 = _mm512_set1_ps(scal_34);


											vec_112 = _mm512_fmadd_ps(vec_113, vec_106, mem_vec_418);
											mem_vec_418 = vec_112;



											vec_114 = _mm512_fmadd_ps(vec_113, vec_108, mem_vec_419);
											mem_vec_419 = vec_114;
											scal_35 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
											vec_116 = _mm512_set1_ps(scal_35);


											vec_115 = _mm512_fmadd_ps(vec_116, vec_106, mem_vec_420);
											mem_vec_420 = vec_115;



											vec_117 = _mm512_fmadd_ps(vec_116, vec_108, mem_vec_421);
											mem_vec_421 = vec_117;
											scal_36 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
											vec_119 = _mm512_set1_ps(scal_36);


											vec_118 = _mm512_fmadd_ps(vec_119, vec_106, mem_vec_422);
											mem_vec_422 = vec_118;



											vec_120 = _mm512_fmadd_ps(vec_119, vec_108, mem_vec_423);
											mem_vec_423 = vec_120;
											scal_37 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
											vec_122 = _mm512_set1_ps(scal_37);


											vec_121 = _mm512_fmadd_ps(vec_122, vec_106, mem_vec_424);
											mem_vec_424 = vec_121;



											vec_123 = _mm512_fmadd_ps(vec_122, vec_108, mem_vec_425);
											mem_vec_425 = vec_123;
											scal_38 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
											vec_125 = _mm512_set1_ps(scal_38);


											vec_124 = _mm512_fmadd_ps(vec_125, vec_106, mem_vec_426);
											mem_vec_426 = vec_124;



											vec_126 = _mm512_fmadd_ps(vec_125, vec_108, mem_vec_427);
											mem_vec_427 = vec_126;
											scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
											vec_128 = _mm512_set1_ps(scal_39);


											vec_127 = _mm512_fmadd_ps(vec_128, vec_106, mem_vec_428);
											mem_vec_428 = vec_127;



											vec_129 = _mm512_fmadd_ps(vec_128, vec_108, mem_vec_429);
											mem_vec_429 = vec_129;
											...
											vec_130 = _mm512_fmadd_ps(vec_131, vec_132, mem_vec_414);
											mem_vec_414 = vec_130;

											vec_134 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_133 = _mm512_fmadd_ps(vec_131, vec_134, mem_vec_415);
											mem_vec_415 = vec_133;
											scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
											vec_136 = _mm512_set1_ps(scal_41);


											vec_135 = _mm512_fmadd_ps(vec_136, vec_132, mem_vec_416);
											mem_vec_416 = vec_135;



											vec_137 = _mm512_fmadd_ps(vec_136, vec_134, mem_vec_417);
											mem_vec_417 = vec_137;
											scal_42 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
											vec_139 = _mm512_set1_ps(scal_42);


											vec_138 = _mm512_fmadd_ps(vec_139, vec_132, mem_vec_418);
											mem_vec_418 = vec_138;



											vec_140 = _mm512_fmadd_ps(vec_139, vec_134, mem_vec_419);
											mem_vec_419 = vec_140;
											scal_43 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
											vec_142 = _mm512_set1_ps(scal_43);


											vec_141 = _mm512_fmadd_ps(vec_142, vec_132, mem_vec_420);
											mem_vec_420 = vec_141;



											vec_143 = _mm512_fmadd_ps(vec_142, vec_134, mem_vec_421);
											mem_vec_421 = vec_143;
											scal_44 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
											vec_145 = _mm512_set1_ps(scal_44);


											vec_144 = _mm512_fmadd_ps(vec_145, vec_132, mem_vec_422);
											mem_vec_422 = vec_144;



											vec_146 = _mm512_fmadd_ps(vec_145, vec_134, mem_vec_423);
											mem_vec_423 = vec_146;
											scal_45 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
											vec_148 = _mm512_set1_ps(scal_45);


											vec_147 = _mm512_fmadd_ps(vec_148, vec_132, mem_vec_424);
											mem_vec_424 = vec_147;



											vec_149 = _mm512_fmadd_ps(vec_148, vec_134, mem_vec_425);
											mem_vec_425 = vec_149;
											scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
											vec_151 = _mm512_set1_ps(scal_46);


											vec_150 = _mm512_fmadd_ps(vec_151, vec_132, mem_vec_426);
											mem_vec_426 = vec_150;



											vec_152 = _mm512_fmadd_ps(vec_151, vec_134, mem_vec_427);
											mem_vec_427 = vec_152;
											scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 2) + c];
											vec_154 = _mm512_set1_ps(scal_47);


											vec_153 = _mm512_fmadd_ps(vec_154, vec_132, mem_vec_428);
											mem_vec_428 = vec_153;



											vec_155 = _mm512_fmadd_ps(vec_154, vec_134, mem_vec_429);
											mem_vec_429 = vec_155;
											scal_48 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_157 = _mm512_set1_ps(scal_48);
											vec_158 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_156 = _mm512_fmadd_ps(vec_157, vec_158, mem_vec_414);
											mem_vec_414 = vec_156;

											vec_160 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_159 = _mm512_fmadd_ps(vec_157, vec_160, mem_vec_415);
											mem_vec_415 = vec_159;
											scal_49 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_162 = _mm512_set1_ps(scal_49);


											vec_161 = _mm512_fmadd_ps(vec_162, vec_158, mem_vec_416);
											mem_vec_416 = vec_161;



											vec_163 = _mm512_fmadd_ps(vec_162, vec_160, mem_vec_417);
											mem_vec_417 = vec_163;
											scal_50 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_165 = _mm512_set1_ps(scal_50);


											vec_164 = _mm512_fmadd_ps(vec_165, vec_158, mem_vec_418);
											mem_vec_418 = vec_164;



											vec_166 = _mm512_fmadd_ps(vec_165, vec_160, mem_vec_419);
											mem_vec_419 = vec_166;
											scal_51 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_168 = _mm512_set1_ps(scal_51);


											vec_167 = _mm512_fmadd_ps(vec_168, vec_158, mem_vec_420);
											mem_vec_420 = vec_167;



											vec_169 = _mm512_fmadd_ps(vec_168, vec_160, mem_vec_421);
											mem_vec_421 = vec_169;
											scal_52 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_171 = _mm512_set1_ps(scal_52);


											vec_170 = _mm512_fmadd_ps(vec_171, vec_158, mem_vec_422);
											mem_vec_422 = vec_170;



											vec_172 = _mm512_fmadd_ps(vec_171, vec_160, mem_vec_423);
											mem_vec_423 = vec_172;
											scal_53 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_174 = _mm512_set1_ps(scal_53);


											vec_173 = _mm512_fmadd_ps(vec_174, vec_158, mem_vec_424);
											mem_vec_424 = vec_173;



											vec_175 = _mm512_fmadd_ps(vec_174, vec_160, mem_vec_425);
											mem_vec_425 = vec_175;
											scal_54 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_177 = _mm512_set1_ps(scal_54);


											vec_176 = _mm512_fmadd_ps(vec_177, vec_158, mem_vec_426);
											mem_vec_426 = vec_176;



											vec_178 = _mm512_fmadd_ps(vec_177, vec_160, mem_vec_427);
											mem_vec_427 = vec_178;
											scal_55 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_180 = _mm512_set1_ps(scal_55);


											vec_179 = _mm512_fmadd_ps(vec_180, vec_158, mem_vec_428);
											mem_vec_428 = vec_179;



											vec_181 = _mm512_fmadd_ps(vec_180, vec_160, mem_vec_429);
											mem_vec_429 = vec_181;
											...
											vec_182 = _mm512_fmadd_ps(vec_183, vec_184, mem_vec_414);
											mem_vec_414 = vec_182;

											vec_186 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_185 = _mm512_fmadd_ps(vec_183, vec_186, mem_vec_415);
											mem_vec_415 = vec_185;
											scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
											vec_188 = _mm512_set1_ps(scal_57);


											vec_187 = _mm512_fmadd_ps(vec_188, vec_184, mem_vec_416);
											mem_vec_416 = vec_187;



											vec_189 = _mm512_fmadd_ps(vec_188, vec_186, mem_vec_417);
											mem_vec_417 = vec_189;
											scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
											vec_191 = _mm512_set1_ps(scal_58);


											vec_190 = _mm512_fmadd_ps(vec_191, vec_184, mem_vec_418);
											mem_vec_418 = vec_190;



											vec_192 = _mm512_fmadd_ps(vec_191, vec_186, mem_vec_419);
											mem_vec_419 = vec_192;
											scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
											vec_194 = _mm512_set1_ps(scal_59);


											vec_193 = _mm512_fmadd_ps(vec_194, vec_184, mem_vec_420);
											mem_vec_420 = vec_193;



											vec_195 = _mm512_fmadd_ps(vec_194, vec_186, mem_vec_421);
											mem_vec_421 = vec_195;
											scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
											vec_197 = _mm512_set1_ps(scal_60);


											vec_196 = _mm512_fmadd_ps(vec_197, vec_184, mem_vec_422);
											mem_vec_422 = vec_196;



											vec_198 = _mm512_fmadd_ps(vec_197, vec_186, mem_vec_423);
											mem_vec_423 = vec_198;
											scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
											vec_200 = _mm512_set1_ps(scal_61);


											vec_199 = _mm512_fmadd_ps(vec_200, vec_184, mem_vec_424);
											mem_vec_424 = vec_199;



											vec_201 = _mm512_fmadd_ps(vec_200, vec_186, mem_vec_425);
											mem_vec_425 = vec_201;
											scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
											vec_203 = _mm512_set1_ps(scal_62);


											vec_202 = _mm512_fmadd_ps(vec_203, vec_184, mem_vec_426);
											mem_vec_426 = vec_202;



											vec_204 = _mm512_fmadd_ps(vec_203, vec_186, mem_vec_427);
											mem_vec_427 = vec_204;
											scal_63 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
											vec_206 = _mm512_set1_ps(scal_63);


											vec_205 = _mm512_fmadd_ps(vec_206, vec_184, mem_vec_428);
											mem_vec_428 = vec_205;



											vec_207 = _mm512_fmadd_ps(vec_206, vec_186, mem_vec_429);
											mem_vec_429 = vec_207;
											...
											vec_208 = _mm512_fmadd_ps(vec_209, vec_210, mem_vec_414);
											mem_vec_414 = vec_208;

											vec_212 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_211 = _mm512_fmadd_ps(vec_209, vec_212, mem_vec_415);
											mem_vec_415 = vec_211;
											scal_65 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
											vec_214 = _mm512_set1_ps(scal_65);


											vec_213 = _mm512_fmadd_ps(vec_214, vec_210, mem_vec_416);
											mem_vec_416 = vec_213;



											vec_215 = _mm512_fmadd_ps(vec_214, vec_212, mem_vec_417);
											mem_vec_417 = vec_215;
											scal_66 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
											vec_217 = _mm512_set1_ps(scal_66);


											vec_216 = _mm512_fmadd_ps(vec_217, vec_210, mem_vec_418);
											mem_vec_418 = vec_216;



											vec_218 = _mm512_fmadd_ps(vec_217, vec_212, mem_vec_419);
											mem_vec_419 = vec_218;
											scal_67 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
											vec_220 = _mm512_set1_ps(scal_67);


											vec_219 = _mm512_fmadd_ps(vec_220, vec_210, mem_vec_420);
											mem_vec_420 = vec_219;



											vec_221 = _mm512_fmadd_ps(vec_220, vec_212, mem_vec_421);
											mem_vec_421 = vec_221;
											scal_68 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
											vec_223 = _mm512_set1_ps(scal_68);


											vec_222 = _mm512_fmadd_ps(vec_223, vec_210, mem_vec_422);
											mem_vec_422 = vec_222;



											vec_224 = _mm512_fmadd_ps(vec_223, vec_212, mem_vec_423);
											mem_vec_423 = vec_224;
											scal_69 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
											vec_226 = _mm512_set1_ps(scal_69);


											vec_225 = _mm512_fmadd_ps(vec_226, vec_210, mem_vec_424);
											mem_vec_424 = vec_225;



											vec_227 = _mm512_fmadd_ps(vec_226, vec_212, mem_vec_425);
											mem_vec_425 = vec_227;
											scal_70 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
											vec_229 = _mm512_set1_ps(scal_70);


											vec_228 = _mm512_fmadd_ps(vec_229, vec_210, mem_vec_426);
											mem_vec_426 = vec_228;



											vec_230 = _mm512_fmadd_ps(vec_229, vec_212, mem_vec_427);
											mem_vec_427 = vec_230;
											scal_71 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
											vec_232 = _mm512_set1_ps(scal_71);


											vec_231 = _mm512_fmadd_ps(vec_232, vec_210, mem_vec_428);
											mem_vec_428 = vec_231;



											vec_233 = _mm512_fmadd_ps(vec_232, vec_212, mem_vec_429);
											mem_vec_429 = vec_233;
										}
						...
						for (c27 = c28, c27_p_0 = 0;
							...
							for (x = x27, xp_1 = x27_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_446 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
										mem_vec_447 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
										mem_vec_448 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
										mem_vec_449 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
										mem_vec_450 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
										mem_vec_451 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
										mem_vec_452 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_453 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										mem_vec_454 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
										mem_vec_455 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
										mem_vec_456 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_457 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										mem_vec_458 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
										mem_vec_459 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
										// y = ph_y, x = 1, h = 3, w = 3, c = 64, f = 32
										// T (c, 64) (64 / 1)
										for (c = c27, cp_1 = c27_p_0, cp_0 = 0;
											c < c27 + 64;
											...
											vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_446);
											mem_vec_446 = vec_26;



											vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_447);
											mem_vec_447 = vec_28;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h) + c];
											vec_30 = _mm512_set1_ps(scal_9);


											vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_448);
											mem_vec_448 = vec_29;



											vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_449);
											mem_vec_449 = vec_31;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
											vec_33 = _mm512_set1_ps(scal_10);


											vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_450);
											mem_vec_450 = vec_32;



											vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_451);
											mem_vec_451 = vec_34;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
											vec_36 = _mm512_set1_ps(scal_11);


											vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_452);
											mem_vec_452 = vec_35;



											vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_453);
											mem_vec_453 = vec_37;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
											vec_39 = _mm512_set1_ps(scal_12);


											vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_454);
											mem_vec_454 = vec_38;



											vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_455);
											mem_vec_455 = vec_40;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
											vec_42 = _mm512_set1_ps(scal_13);


											vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_456);
											mem_vec_456 = vec_41;



											vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_457);
											mem_vec_457 = vec_43;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 14 + h) + c];
											vec_45 = _mm512_set1_ps(scal_14);


											vec_44 = _mm512_fmadd_ps(vec_45, vec_2, mem_vec_458);
											mem_vec_458 = vec_44;



											vec_46 = _mm512_fmadd_ps(vec_45, vec_4, mem_vec_459);
											mem_vec_459 = vec_46;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
											vec_48 = _mm512_set1_ps(scal_15);
											vec_49 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

											vec_47 = _mm512_fmadd_ps(vec_48, vec_49, mem_vec_430);
											mem_vec_430 = vec_47;

											vec_51 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_50 = _mm512_fmadd_ps(vec_48, vec_51, mem_vec_431);
											mem_vec_431 = vec_50;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_53 = _mm512_set1_ps(scal_16);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_49, mem_vec_432);
											mem_vec_432 = vec_52;



											vec_54 = _mm512_fmadd_ps(vec_53, vec_51, mem_vec_433);
											mem_vec_433 = vec_54;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_56 = _mm512_set1_ps(scal_17);


											vec_55 = _mm512_fmadd_ps(vec_56, vec_49, mem_vec_434);
											mem_vec_434 = vec_55;



											vec_57 = _mm512_fmadd_ps(vec_56, vec_51, mem_vec_435);
											mem_vec_435 = vec_57;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_59 = _mm512_set1_ps(scal_18);


											vec_58 = _mm512_fmadd_ps(vec_59, vec_49, mem_vec_436);
											mem_vec_436 = vec_58;



											vec_60 = _mm512_fmadd_ps(vec_59, vec_51, mem_vec_437);
											mem_vec_437 = vec_60;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_62 = _mm512_set1_ps(scal_19);


											vec_61 = _mm512_fmadd_ps(vec_62, vec_49, mem_vec_438);
											mem_vec_438 = vec_61;



											vec_63 = _mm512_fmadd_ps(vec_62, vec_51, mem_vec_439);
											mem_vec_439 = vec_63;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_65 = _mm512_set1_ps(scal_20);


											vec_64 = _mm512_fmadd_ps(vec_65, vec_49, mem_vec_440);
											mem_vec_440 = vec_64;



											vec_66 = _mm512_fmadd_ps(vec_65, vec_51, mem_vec_441);
											mem_vec_441 = vec_66;
											scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_68 = _mm512_set1_ps(scal_21);


											vec_67 = _mm512_fmadd_ps(vec_68, vec_49, mem_vec_442);
											mem_vec_442 = vec_67;



											vec_69 = _mm512_fmadd_ps(vec_68, vec_51, mem_vec_443);
											mem_vec_443 = vec_69;
											scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
											vec_71 = _mm512_set1_ps(scal_22);


											vec_70 = _mm512_fmadd_ps(vec_71, vec_49, mem_vec_444);
											mem_vec_444 = vec_70;



											vec_72 = _mm512_fmadd_ps(vec_71, vec_51, mem_vec_445);
											mem_vec_445 = vec_72;
											scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
											vec_74 = _mm512_set1_ps(scal_23);


											vec_73 = _mm512_fmadd_ps(vec_74, vec_49, mem_vec_446);
											mem_vec_446 = vec_73;



											vec_75 = _mm512_fmadd_ps(vec_74, vec_51, mem_vec_447);
											mem_vec_447 = vec_75;
											scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
											vec_77 = _mm512_set1_ps(scal_24);


											vec_76 = _mm512_fmadd_ps(vec_77, vec_49, mem_vec_448);
											mem_vec_448 = vec_76;



											vec_78 = _mm512_fmadd_ps(vec_77, vec_51, mem_vec_449);
											mem_vec_449 = vec_78;
											scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
											vec_80 = _mm512_set1_ps(scal_25);


											vec_79 = _mm512_fmadd_ps(vec_80, vec_49, mem_vec_450);
											mem_vec_450 = vec_79;



											vec_81 = _mm512_fmadd_ps(vec_80, vec_51, mem_vec_451);
											mem_vec_451 = vec_81;
											scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
											vec_83 = _mm512_set1_ps(scal_26);


											vec_82 = _mm512_fmadd_ps(vec_83, vec_49, mem_vec_452);
											mem_vec_452 = vec_82;



											vec_84 = _mm512_fmadd_ps(vec_83, vec_51, mem_vec_453);
											mem_vec_453 = vec_84;
											scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
											vec_86 = _mm512_set1_ps(scal_27);


											vec_85 = _mm512_fmadd_ps(vec_86, vec_49, mem_vec_454);
											mem_vec_454 = vec_85;



											vec_87 = _mm512_fmadd_ps(vec_86, vec_51, mem_vec_455);
											mem_vec_455 = vec_87;
											scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 1) + c];
											vec_89 = _mm512_set1_ps(scal_28);


											vec_88 = _mm512_fmadd_ps(vec_89, vec_49, mem_vec_456);
											mem_vec_456 = vec_88;



											vec_90 = _mm512_fmadd_ps(vec_89, vec_51, mem_vec_457);
											mem_vec_457 = vec_90;
											scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 14 + h + 1) + c];
											vec_92 = _mm512_set1_ps(scal_29);


											vec_91 = _mm512_fmadd_ps(vec_92, vec_49, mem_vec_458);
											mem_vec_458 = vec_91;



											vec_93 = _mm512_fmadd_ps(vec_92, vec_51, mem_vec_459);
											mem_vec_459 = vec_93;
											scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_95 = _mm512_set1_ps(scal_30);
											vec_96 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_94 = _mm512_fmadd_ps(vec_95, vec_96, mem_vec_430);
											mem_vec_430 = vec_94;

											vec_98 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_97 = _mm512_fmadd_ps(vec_95, vec_98, mem_vec_431);
											mem_vec_431 = vec_97;
											scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_100 = _mm512_set1_ps(scal_31);


											vec_99 = _mm512_fmadd_ps(vec_100, vec_96, mem_vec_432);
											mem_vec_432 = vec_99;



											vec_101 = _mm512_fmadd_ps(vec_100, vec_98, mem_vec_433);
											mem_vec_433 = vec_101;
											scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_103 = _mm512_set1_ps(scal_32);


											vec_102 = _mm512_fmadd_ps(vec_103, vec_96, mem_vec_434);
											mem_vec_434 = vec_102;



											vec_104 = _mm512_fmadd_ps(vec_103, vec_98, mem_vec_435);
											mem_vec_435 = vec_104;
											scal_33 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_106 = _mm512_set1_ps(scal_33);


											vec_105 = _mm512_fmadd_ps(vec_106, vec_96, mem_vec_436);
											mem_vec_436 = vec_105;



											vec_107 = _mm512_fmadd_ps(vec_106, vec_98, mem_vec_437);
											mem_vec_437 = vec_107;
											scal_34 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_109 = _mm512_set1_ps(scal_34);


											vec_108 = _mm512_fmadd_ps(vec_109, vec_96, mem_vec_438);
											mem_vec_438 = vec_108;



											vec_110 = _mm512_fmadd_ps(vec_109, vec_98, mem_vec_439);
											mem_vec_439 = vec_110;
											scal_35 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_112 = _mm512_set1_ps(scal_35);


											vec_111 = _mm512_fmadd_ps(vec_112, vec_96, mem_vec_440);
											mem_vec_440 = vec_111;



											vec_113 = _mm512_fmadd_ps(vec_112, vec_98, mem_vec_441);
											mem_vec_441 = vec_113;
											scal_36 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_115 = _mm512_set1_ps(scal_36);


											vec_114 = _mm512_fmadd_ps(vec_115, vec_96, mem_vec_442);
											mem_vec_442 = vec_114;



											vec_116 = _mm512_fmadd_ps(vec_115, vec_98, mem_vec_443);
											mem_vec_443 = vec_116;
											scal_37 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
											vec_118 = _mm512_set1_ps(scal_37);


											vec_117 = _mm512_fmadd_ps(vec_118, vec_96, mem_vec_444);
											mem_vec_444 = vec_117;



											vec_119 = _mm512_fmadd_ps(vec_118, vec_98, mem_vec_445);
											mem_vec_445 = vec_119;
											scal_38 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
											vec_121 = _mm512_set1_ps(scal_38);


											vec_120 = _mm512_fmadd_ps(vec_121, vec_96, mem_vec_446);
											mem_vec_446 = vec_120;



											vec_122 = _mm512_fmadd_ps(vec_121, vec_98, mem_vec_447);
											mem_vec_447 = vec_122;
											scal_39 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
											vec_124 = _mm512_set1_ps(scal_39);


											vec_123 = _mm512_fmadd_ps(vec_124, vec_96, mem_vec_448);
											mem_vec_448 = vec_123;



											vec_125 = _mm512_fmadd_ps(vec_124, vec_98, mem_vec_449);
											mem_vec_449 = vec_125;
											scal_40 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
											vec_127 = _mm512_set1_ps(scal_40);


											vec_126 = _mm512_fmadd_ps(vec_127, vec_96, mem_vec_450);
											mem_vec_450 = vec_126;



											vec_128 = _mm512_fmadd_ps(vec_127, vec_98, mem_vec_451);
											mem_vec_451 = vec_128;
											scal_41 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 2) + c];
											vec_130 = _mm512_set1_ps(scal_41);


											vec_129 = _mm512_fmadd_ps(vec_130, vec_96, mem_vec_452);
											mem_vec_452 = vec_129;



											vec_131 = _mm512_fmadd_ps(vec_130, vec_98, mem_vec_453);
											mem_vec_453 = vec_131;
											scal_42 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 2) + c];
											vec_133 = _mm512_set1_ps(scal_42);


											vec_132 = _mm512_fmadd_ps(vec_133, vec_96, mem_vec_454);
											mem_vec_454 = vec_132;



											vec_134 = _mm512_fmadd_ps(vec_133, vec_98, mem_vec_455);
											mem_vec_455 = vec_134;
											scal_43 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 2) + c];
											vec_136 = _mm512_set1_ps(scal_43);


											vec_135 = _mm512_fmadd_ps(vec_136, vec_96, mem_vec_456);
											mem_vec_456 = vec_135;



											vec_137 = _mm512_fmadd_ps(vec_136, vec_98, mem_vec_457);
											mem_vec_457 = vec_137;
											scal_44 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 14 + h + 2) + c];
											vec_139 = _mm512_set1_ps(scal_44);


											vec_138 = _mm512_fmadd_ps(vec_139, vec_96, mem_vec_458);
											mem_vec_458 = vec_138;



											vec_140 = _mm512_fmadd_ps(vec_139, vec_98, mem_vec_459);
											mem_vec_459 = vec_140;
											scal_45 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
											vec_142 = _mm512_set1_ps(scal_45);
											vec_143 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

											vec_141 = _mm512_fmadd_ps(vec_142, vec_143, mem_vec_430);
											mem_vec_430 = vec_141;

											vec_145 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_144 = _mm512_fmadd_ps(vec_142, vec_145, mem_vec_431);
											mem_vec_431 = vec_144;
											scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_147 = _mm512_set1_ps(scal_46);


											vec_146 = _mm512_fmadd_ps(vec_147, vec_143, mem_vec_432);
											mem_vec_432 = vec_146;



											vec_148 = _mm512_fmadd_ps(vec_147, vec_145, mem_vec_433);
											mem_vec_433 = vec_148;
											scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_150 = _mm512_set1_ps(scal_47);


											vec_149 = _mm512_fmadd_ps(vec_150, vec_143, mem_vec_434);
											mem_vec_434 = vec_149;



											vec_151 = _mm512_fmadd_ps(vec_150, vec_145, mem_vec_435);
											mem_vec_435 = vec_151;
											scal_48 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_153 = _mm512_set1_ps(scal_48);


											vec_152 = _mm512_fmadd_ps(vec_153, vec_143, mem_vec_436);
											mem_vec_436 = vec_152;



											vec_154 = _mm512_fmadd_ps(vec_153, vec_145, mem_vec_437);
											mem_vec_437 = vec_154;
											scal_49 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_156 = _mm512_set1_ps(scal_49);


											vec_155 = _mm512_fmadd_ps(vec_156, vec_143, mem_vec_438);
											mem_vec_438 = vec_155;



											vec_157 = _mm512_fmadd_ps(vec_156, vec_145, mem_vec_439);
											mem_vec_439 = vec_157;
											scal_50 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_159 = _mm512_set1_ps(scal_50);


											vec_158 = _mm512_fmadd_ps(vec_159, vec_143, mem_vec_440);
											mem_vec_440 = vec_158;



											vec_160 = _mm512_fmadd_ps(vec_159, vec_145, mem_vec_441);
											mem_vec_441 = vec_160;
											scal_51 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_162 = _mm512_set1_ps(scal_51);


											vec_161 = _mm512_fmadd_ps(vec_162, vec_143, mem_vec_442);
											mem_vec_442 = vec_161;



											vec_163 = _mm512_fmadd_ps(vec_162, vec_145, mem_vec_443);
											mem_vec_443 = vec_163;
											scal_52 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_165 = _mm512_set1_ps(scal_52);


											vec_164 = _mm512_fmadd_ps(vec_165, vec_143, mem_vec_444);
											mem_vec_444 = vec_164;



											vec_166 = _mm512_fmadd_ps(vec_165, vec_145, mem_vec_445);
											mem_vec_445 = vec_166;
											scal_53 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
											vec_168 = _mm512_set1_ps(scal_53);


											vec_167 = _mm512_fmadd_ps(vec_168, vec_143, mem_vec_446);
											mem_vec_446 = vec_167;



											vec_169 = _mm512_fmadd_ps(vec_168, vec_145, mem_vec_447);
											mem_vec_447 = vec_169;
											scal_54 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
											vec_171 = _mm512_set1_ps(scal_54);


											vec_170 = _mm512_fmadd_ps(vec_171, vec_143, mem_vec_448);
											mem_vec_448 = vec_170;



											vec_172 = _mm512_fmadd_ps(vec_171, vec_145, mem_vec_449);
											mem_vec_449 = vec_172;
											scal_55 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
											vec_174 = _mm512_set1_ps(scal_55);


											vec_173 = _mm512_fmadd_ps(vec_174, vec_143, mem_vec_450);
											mem_vec_450 = vec_173;



											vec_175 = _mm512_fmadd_ps(vec_174, vec_145, mem_vec_451);
											mem_vec_451 = vec_175;
											scal_56 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h) + c];
											vec_177 = _mm512_set1_ps(scal_56);


											vec_176 = _mm512_fmadd_ps(vec_177, vec_143, mem_vec_452);
											mem_vec_452 = vec_176;



											vec_178 = _mm512_fmadd_ps(vec_177, vec_145, mem_vec_453);
											mem_vec_453 = vec_178;
											scal_57 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h) + c];
											vec_180 = _mm512_set1_ps(scal_57);


											vec_179 = _mm512_fmadd_ps(vec_180, vec_143, mem_vec_454);
											mem_vec_454 = vec_179;



											vec_181 = _mm512_fmadd_ps(vec_180, vec_145, mem_vec_455);
											mem_vec_455 = vec_181;
											scal_58 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 13 + h) + c];
											vec_183 = _mm512_set1_ps(scal_58);


											vec_182 = _mm512_fmadd_ps(vec_183, vec_143, mem_vec_456);
											mem_vec_456 = vec_182;



											vec_184 = _mm512_fmadd_ps(vec_183, vec_145, mem_vec_457);
											mem_vec_457 = vec_184;
											scal_59 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 14 + h) + c];
											vec_186 = _mm512_set1_ps(scal_59);


											vec_185 = _mm512_fmadd_ps(vec_186, vec_143, mem_vec_458);
											mem_vec_458 = vec_185;



											vec_187 = _mm512_fmadd_ps(vec_186, vec_145, mem_vec_459);
											mem_vec_459 = vec_187;
											...
											vec_188 = _mm512_fmadd_ps(vec_189, vec_190, mem_vec_430);
											mem_vec_430 = vec_188;

											vec_192 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_191 = _mm512_fmadd_ps(vec_189, vec_192, mem_vec_431);
											mem_vec_431 = vec_191;
											scal_61 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
											vec_194 = _mm512_set1_ps(scal_61);


											vec_193 = _mm512_fmadd_ps(vec_194, vec_190, mem_vec_432);
											mem_vec_432 = vec_193;



											vec_195 = _mm512_fmadd_ps(vec_194, vec_192, mem_vec_433);
											mem_vec_433 = vec_195;
											scal_62 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
											vec_197 = _mm512_set1_ps(scal_62);


											vec_196 = _mm512_fmadd_ps(vec_197, vec_190, mem_vec_434);
											mem_vec_434 = vec_196;



											vec_198 = _mm512_fmadd_ps(vec_197, vec_192, mem_vec_435);
											mem_vec_435 = vec_198;
											scal_63 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
											vec_200 = _mm512_set1_ps(scal_63);


											vec_199 = _mm512_fmadd_ps(vec_200, vec_190, mem_vec_436);
											mem_vec_436 = vec_199;



											vec_201 = _mm512_fmadd_ps(vec_200, vec_192, mem_vec_437);
											mem_vec_437 = vec_201;
											scal_64 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
											vec_203 = _mm512_set1_ps(scal_64);


											vec_202 = _mm512_fmadd_ps(vec_203, vec_190, mem_vec_438);
											mem_vec_438 = vec_202;



											vec_204 = _mm512_fmadd_ps(vec_203, vec_192, mem_vec_439);
											mem_vec_439 = vec_204;
											scal_65 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
											vec_206 = _mm512_set1_ps(scal_65);


											vec_205 = _mm512_fmadd_ps(vec_206, vec_190, mem_vec_440);
											mem_vec_440 = vec_205;



											vec_207 = _mm512_fmadd_ps(vec_206, vec_192, mem_vec_441);
											mem_vec_441 = vec_207;
											scal_66 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
											vec_209 = _mm512_set1_ps(scal_66);


											vec_208 = _mm512_fmadd_ps(vec_209, vec_190, mem_vec_442);
											mem_vec_442 = vec_208;



											vec_210 = _mm512_fmadd_ps(vec_209, vec_192, mem_vec_443);
											mem_vec_443 = vec_210;
											scal_67 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
											vec_212 = _mm512_set1_ps(scal_67);


											vec_211 = _mm512_fmadd_ps(vec_212, vec_190, mem_vec_444);
											mem_vec_444 = vec_211;



											vec_213 = _mm512_fmadd_ps(vec_212, vec_192, mem_vec_445);
											mem_vec_445 = vec_213;
											scal_68 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 1) + c];
											vec_215 = _mm512_set1_ps(scal_68);


											vec_214 = _mm512_fmadd_ps(vec_215, vec_190, mem_vec_446);
											mem_vec_446 = vec_214;



											vec_216 = _mm512_fmadd_ps(vec_215, vec_192, mem_vec_447);
											mem_vec_447 = vec_216;
											scal_69 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 1) + c];
											vec_218 = _mm512_set1_ps(scal_69);


											vec_217 = _mm512_fmadd_ps(vec_218, vec_190, mem_vec_448);
											mem_vec_448 = vec_217;



											vec_219 = _mm512_fmadd_ps(vec_218, vec_192, mem_vec_449);
											mem_vec_449 = vec_219;
											scal_70 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 1) + c];
											vec_221 = _mm512_set1_ps(scal_70);


											vec_220 = _mm512_fmadd_ps(vec_221, vec_190, mem_vec_450);
											mem_vec_450 = vec_220;



											vec_222 = _mm512_fmadd_ps(vec_221, vec_192, mem_vec_451);
											mem_vec_451 = vec_222;
											scal_71 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h + 1) + c];
											vec_224 = _mm512_set1_ps(scal_71);


											vec_223 = _mm512_fmadd_ps(vec_224, vec_190, mem_vec_452);
											mem_vec_452 = vec_223;



											vec_225 = _mm512_fmadd_ps(vec_224, vec_192, mem_vec_453);
											mem_vec_453 = vec_225;
											scal_72 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h + 1) + c];
											vec_227 = _mm512_set1_ps(scal_72);


											vec_226 = _mm512_fmadd_ps(vec_227, vec_190, mem_vec_454);
											mem_vec_454 = vec_226;



											vec_228 = _mm512_fmadd_ps(vec_227, vec_192, mem_vec_455);
											mem_vec_455 = vec_228;
											scal_73 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 13 + h + 1) + c];
											vec_230 = _mm512_set1_ps(scal_73);


											vec_229 = _mm512_fmadd_ps(vec_230, vec_190, mem_vec_456);
											mem_vec_456 = vec_229;



											vec_231 = _mm512_fmadd_ps(vec_230, vec_192, mem_vec_457);
											mem_vec_457 = vec_231;
											scal_74 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 14 + h + 1) + c];
											vec_233 = _mm512_set1_ps(scal_74);


											vec_232 = _mm512_fmadd_ps(vec_233, vec_190, mem_vec_458);
											mem_vec_458 = vec_232;



											vec_234 = _mm512_fmadd_ps(vec_233, vec_192, mem_vec_459);
											mem_vec_459 = vec_234;
											...
											vec_235 = _mm512_fmadd_ps(vec_236, vec_237, mem_vec_430);
											mem_vec_430 = vec_235;

											vec_239 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_238 = _mm512_fmadd_ps(vec_236, vec_239, mem_vec_431);
											mem_vec_431 = vec_238;
											scal_76 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
											vec_241 = _mm512_set1_ps(scal_76);


											vec_240 = _mm512_fmadd_ps(vec_241, vec_237, mem_vec_432);
											mem_vec_432 = vec_240;



											vec_242 = _mm512_fmadd_ps(vec_241, vec_239, mem_vec_433);
											mem_vec_433 = vec_242;
											scal_77 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
											vec_244 = _mm512_set1_ps(scal_77);


											vec_243 = _mm512_fmadd_ps(vec_244, vec_237, mem_vec_434);
											mem_vec_434 = vec_243;



											vec_245 = _mm512_fmadd_ps(vec_244, vec_239, mem_vec_435);
											mem_vec_435 = vec_245;
											scal_78 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
											vec_247 = _mm512_set1_ps(scal_78);


											vec_246 = _mm512_fmadd_ps(vec_247, vec_237, mem_vec_436);
											mem_vec_436 = vec_246;



											vec_248 = _mm512_fmadd_ps(vec_247, vec_239, mem_vec_437);
											mem_vec_437 = vec_248;
											scal_79 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
											vec_250 = _mm512_set1_ps(scal_79);


											vec_249 = _mm512_fmadd_ps(vec_250, vec_237, mem_vec_438);
											mem_vec_438 = vec_249;



											vec_251 = _mm512_fmadd_ps(vec_250, vec_239, mem_vec_439);
											mem_vec_439 = vec_251;
											scal_80 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
											vec_253 = _mm512_set1_ps(scal_80);


											vec_252 = _mm512_fmadd_ps(vec_253, vec_237, mem_vec_440);
											mem_vec_440 = vec_252;



											vec_254 = _mm512_fmadd_ps(vec_253, vec_239, mem_vec_441);
											mem_vec_441 = vec_254;
											scal_81 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
											vec_256 = _mm512_set1_ps(scal_81);


											vec_255 = _mm512_fmadd_ps(vec_256, vec_237, mem_vec_442);
											mem_vec_442 = vec_255;



											vec_257 = _mm512_fmadd_ps(vec_256, vec_239, mem_vec_443);
											mem_vec_443 = vec_257;
											scal_82 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 2) + c];
											vec_259 = _mm512_set1_ps(scal_82);


											vec_258 = _mm512_fmadd_ps(vec_259, vec_237, mem_vec_444);
											mem_vec_444 = vec_258;



											vec_260 = _mm512_fmadd_ps(vec_259, vec_239, mem_vec_445);
											mem_vec_445 = vec_260;
											scal_83 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 2) + c];
											vec_262 = _mm512_set1_ps(scal_83);


											vec_261 = _mm512_fmadd_ps(vec_262, vec_237, mem_vec_446);
											mem_vec_446 = vec_261;



											vec_263 = _mm512_fmadd_ps(vec_262, vec_239, mem_vec_447);
											mem_vec_447 = vec_263;
											scal_84 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 2) + c];
											vec_265 = _mm512_set1_ps(scal_84);


											vec_264 = _mm512_fmadd_ps(vec_265, vec_237, mem_vec_448);
											mem_vec_448 = vec_264;



											vec_266 = _mm512_fmadd_ps(vec_265, vec_239, mem_vec_449);
											mem_vec_449 = vec_266;
											scal_85 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 2) + c];
											vec_268 = _mm512_set1_ps(scal_85);


											vec_267 = _mm512_fmadd_ps(vec_268, vec_237, mem_vec_450);
											mem_vec_450 = vec_267;



											vec_269 = _mm512_fmadd_ps(vec_268, vec_239, mem_vec_451);
											mem_vec_451 = vec_269;
											scal_86 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h + 2) + c];
											vec_271 = _mm512_set1_ps(scal_86);


											vec_270 = _mm512_fmadd_ps(vec_271, vec_237, mem_vec_452);
											mem_vec_452 = vec_270;



											vec_272 = _mm512_fmadd_ps(vec_271, vec_239, mem_vec_453);
											mem_vec_453 = vec_272;
											scal_87 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h + 2) + c];
											vec_274 = _mm512_set1_ps(scal_87);


											vec_273 = _mm512_fmadd_ps(vec_274, vec_237, mem_vec_454);
											mem_vec_454 = vec_273;



											vec_275 = _mm512_fmadd_ps(vec_274, vec_239, mem_vec_455);
											mem_vec_455 = vec_275;
											scal_88 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 13 + h + 2) + c];
											vec_277 = _mm512_set1_ps(scal_88);


											vec_276 = _mm512_fmadd_ps(vec_277, vec_237, mem_vec_456);
											mem_vec_456 = vec_276;



											vec_278 = _mm512_fmadd_ps(vec_277, vec_239, mem_vec_457);
											mem_vec_457 = vec_278;
											scal_89 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 14 + h + 2) + c];
											vec_280 = _mm512_set1_ps(scal_89);


											vec_279 = _mm512_fmadd_ps(vec_280, vec_237, mem_vec_458);
											mem_vec_458 = vec_279;



											vec_281 = _mm512_fmadd_ps(vec_280, vec_239, mem_vec_459);
											mem_vec_459 = vec_281;
											scal_90 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_283 = _mm512_set1_ps(scal_90);
											vec_284 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_282 = _mm512_fmadd_ps(vec_283, vec_284, mem_vec_430);
											mem_vec_430 = vec_282;

											vec_286 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_285 = _mm512_fmadd_ps(vec_283, vec_286, mem_vec_431);
											mem_vec_431 = vec_285;
											scal_91 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_288 = _mm512_set1_ps(scal_91);


											vec_287 = _mm512_fmadd_ps(vec_288, vec_284, mem_vec_432);
											mem_vec_432 = vec_287;



											vec_289 = _mm512_fmadd_ps(vec_288, vec_286, mem_vec_433);
											mem_vec_433 = vec_289;
											scal_92 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_291 = _mm512_set1_ps(scal_92);


											vec_290 = _mm512_fmadd_ps(vec_291, vec_284, mem_vec_434);
											mem_vec_434 = vec_290;



											vec_292 = _mm512_fmadd_ps(vec_291, vec_286, mem_vec_435);
											mem_vec_435 = vec_292;
											scal_93 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_294 = _mm512_set1_ps(scal_93);


											vec_293 = _mm512_fmadd_ps(vec_294, vec_284, mem_vec_436);
											mem_vec_436 = vec_293;



											vec_295 = _mm512_fmadd_ps(vec_294, vec_286, mem_vec_437);
											mem_vec_437 = vec_295;
											scal_94 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_297 = _mm512_set1_ps(scal_94);


											vec_296 = _mm512_fmadd_ps(vec_297, vec_284, mem_vec_438);
											mem_vec_438 = vec_296;



											vec_298 = _mm512_fmadd_ps(vec_297, vec_286, mem_vec_439);
											mem_vec_439 = vec_298;
											scal_95 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_300 = _mm512_set1_ps(scal_95);


											vec_299 = _mm512_fmadd_ps(vec_300, vec_284, mem_vec_440);
											mem_vec_440 = vec_299;



											vec_301 = _mm512_fmadd_ps(vec_300, vec_286, mem_vec_441);
											mem_vec_441 = vec_301;
											scal_96 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_303 = _mm512_set1_ps(scal_96);


											vec_302 = _mm512_fmadd_ps(vec_303, vec_284, mem_vec_442);
											mem_vec_442 = vec_302;



											vec_304 = _mm512_fmadd_ps(vec_303, vec_286, mem_vec_443);
											mem_vec_443 = vec_304;
											scal_97 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_306 = _mm512_set1_ps(scal_97);


											vec_305 = _mm512_fmadd_ps(vec_306, vec_284, mem_vec_444);
											mem_vec_444 = vec_305;



											vec_307 = _mm512_fmadd_ps(vec_306, vec_286, mem_vec_445);
											mem_vec_445 = vec_307;
											scal_98 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
											vec_309 = _mm512_set1_ps(scal_98);


											vec_308 = _mm512_fmadd_ps(vec_309, vec_284, mem_vec_446);
											mem_vec_446 = vec_308;



											vec_310 = _mm512_fmadd_ps(vec_309, vec_286, mem_vec_447);
											mem_vec_447 = vec_310;
											scal_99 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
											vec_312 = _mm512_set1_ps(scal_99);


											vec_311 = _mm512_fmadd_ps(vec_312, vec_284, mem_vec_448);
											mem_vec_448 = vec_311;



											vec_313 = _mm512_fmadd_ps(vec_312, vec_286, mem_vec_449);
											mem_vec_449 = vec_313;
											scal_100 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h) + c];
											vec_315 = _mm512_set1_ps(scal_100);


											vec_314 = _mm512_fmadd_ps(vec_315, vec_284, mem_vec_450);
											mem_vec_450 = vec_314;



											vec_316 = _mm512_fmadd_ps(vec_315, vec_286, mem_vec_451);
											mem_vec_451 = vec_316;
											scal_101 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h) + c];
											vec_318 = _mm512_set1_ps(scal_101);


											vec_317 = _mm512_fmadd_ps(vec_318, vec_284, mem_vec_452);
											mem_vec_452 = vec_317;



											vec_319 = _mm512_fmadd_ps(vec_318, vec_286, mem_vec_453);
											mem_vec_453 = vec_319;
											scal_102 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 12 + h) + c];
											vec_321 = _mm512_set1_ps(scal_102);


											vec_320 = _mm512_fmadd_ps(vec_321, vec_284, mem_vec_454);
											mem_vec_454 = vec_320;



											vec_322 = _mm512_fmadd_ps(vec_321, vec_286, mem_vec_455);
											mem_vec_455 = vec_322;
											scal_103 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 13 + h) + c];
											vec_324 = _mm512_set1_ps(scal_103);


											vec_323 = _mm512_fmadd_ps(vec_324, vec_284, mem_vec_456);
											mem_vec_456 = vec_323;



											vec_325 = _mm512_fmadd_ps(vec_324, vec_286, mem_vec_457);
											mem_vec_457 = vec_325;
											scal_104 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 14 + h) + c];
											vec_327 = _mm512_set1_ps(scal_104);


											vec_326 = _mm512_fmadd_ps(vec_327, vec_284, mem_vec_458);
											mem_vec_458 = vec_326;



											vec_328 = _mm512_fmadd_ps(vec_327, vec_286, mem_vec_459);
											mem_vec_459 = vec_328;
											...
											vec_329 = _mm512_fmadd_ps(vec_330, vec_331, mem_vec_430);
											mem_vec_430 = vec_329;

											vec_333 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_332 = _mm512_fmadd_ps(vec_330, vec_333, mem_vec_431);
											mem_vec_431 = vec_332;
											scal_106 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
											vec_335 = _mm512_set1_ps(scal_106);


											vec_334 = _mm512_fmadd_ps(vec_335, vec_331, mem_vec_432);
											mem_vec_432 = vec_334;



											vec_336 = _mm512_fmadd_ps(vec_335, vec_333, mem_vec_433);
											mem_vec_433 = vec_336;
											scal_107 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
											vec_338 = _mm512_set1_ps(scal_107);


											vec_337 = _mm512_fmadd_ps(vec_338, vec_331, mem_vec_434);
											mem_vec_434 = vec_337;



											vec_339 = _mm512_fmadd_ps(vec_338, vec_333, mem_vec_435);
											mem_vec_435 = vec_339;
											scal_108 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
											vec_341 = _mm512_set1_ps(scal_108);


											vec_340 = _mm512_fmadd_ps(vec_341, vec_331, mem_vec_436);
											mem_vec_436 = vec_340;



											vec_342 = _mm512_fmadd_ps(vec_341, vec_333, mem_vec_437);
											mem_vec_437 = vec_342;
											scal_109 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
											vec_344 = _mm512_set1_ps(scal_109);


											vec_343 = _mm512_fmadd_ps(vec_344, vec_331, mem_vec_438);
											mem_vec_438 = vec_343;



											vec_345 = _mm512_fmadd_ps(vec_344, vec_333, mem_vec_439);
											mem_vec_439 = vec_345;
											scal_110 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
											vec_347 = _mm512_set1_ps(scal_110);


											vec_346 = _mm512_fmadd_ps(vec_347, vec_331, mem_vec_440);
											mem_vec_440 = vec_346;



											vec_348 = _mm512_fmadd_ps(vec_347, vec_333, mem_vec_441);
											mem_vec_441 = vec_348;
											scal_111 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
											vec_350 = _mm512_set1_ps(scal_111);


											vec_349 = _mm512_fmadd_ps(vec_350, vec_331, mem_vec_442);
											mem_vec_442 = vec_349;



											vec_351 = _mm512_fmadd_ps(vec_350, vec_333, mem_vec_443);
											mem_vec_443 = vec_351;
											scal_112 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
											vec_353 = _mm512_set1_ps(scal_112);


											vec_352 = _mm512_fmadd_ps(vec_353, vec_331, mem_vec_444);
											mem_vec_444 = vec_352;



											vec_354 = _mm512_fmadd_ps(vec_353, vec_333, mem_vec_445);
											mem_vec_445 = vec_354;
											scal_113 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 1) + c];
											vec_356 = _mm512_set1_ps(scal_113);


											vec_355 = _mm512_fmadd_ps(vec_356, vec_331, mem_vec_446);
											mem_vec_446 = vec_355;



											vec_357 = _mm512_fmadd_ps(vec_356, vec_333, mem_vec_447);
											mem_vec_447 = vec_357;
											scal_114 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 1) + c];
											vec_359 = _mm512_set1_ps(scal_114);


											vec_358 = _mm512_fmadd_ps(vec_359, vec_331, mem_vec_448);
											mem_vec_448 = vec_358;



											vec_360 = _mm512_fmadd_ps(vec_359, vec_333, mem_vec_449);
											mem_vec_449 = vec_360;
											scal_115 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 1) + c];
											vec_362 = _mm512_set1_ps(scal_115);


											vec_361 = _mm512_fmadd_ps(vec_362, vec_331, mem_vec_450);
											mem_vec_450 = vec_361;



											vec_363 = _mm512_fmadd_ps(vec_362, vec_333, mem_vec_451);
											mem_vec_451 = vec_363;
											scal_116 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h + 1) + c];
											vec_365 = _mm512_set1_ps(scal_116);


											vec_364 = _mm512_fmadd_ps(vec_365, vec_331, mem_vec_452);
											mem_vec_452 = vec_364;



											vec_366 = _mm512_fmadd_ps(vec_365, vec_333, mem_vec_453);
											mem_vec_453 = vec_366;
											scal_117 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 12 + h + 1) + c];
											vec_368 = _mm512_set1_ps(scal_117);


											vec_367 = _mm512_fmadd_ps(vec_368, vec_331, mem_vec_454);
											mem_vec_454 = vec_367;



											vec_369 = _mm512_fmadd_ps(vec_368, vec_333, mem_vec_455);
											mem_vec_455 = vec_369;
											scal_118 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 13 + h + 1) + c];
											vec_371 = _mm512_set1_ps(scal_118);


											vec_370 = _mm512_fmadd_ps(vec_371, vec_331, mem_vec_456);
											mem_vec_456 = vec_370;



											vec_372 = _mm512_fmadd_ps(vec_371, vec_333, mem_vec_457);
											mem_vec_457 = vec_372;
											scal_119 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 14 + h + 1) + c];
											vec_374 = _mm512_set1_ps(scal_119);


											vec_373 = _mm512_fmadd_ps(vec_374, vec_331, mem_vec_458);
											mem_vec_458 = vec_373;



											vec_375 = _mm512_fmadd_ps(vec_374, vec_333, mem_vec_459);
											mem_vec_459 = vec_375;
											...
											vec_376 = _mm512_fmadd_ps(vec_377, vec_378, mem_vec_430);
											mem_vec_430 = vec_376;

											vec_380 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_379 = _mm512_fmadd_ps(vec_377, vec_380, mem_vec_431);
											mem_vec_431 = vec_379;
											scal_121 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
											vec_382 = _mm512_set1_ps(scal_121);


											vec_381 = _mm512_fmadd_ps(vec_382, vec_378, mem_vec_432);
											mem_vec_432 = vec_381;



											vec_383 = _mm512_fmadd_ps(vec_382, vec_380, mem_vec_433);
											mem_vec_433 = vec_383;
											scal_122 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
											vec_385 = _mm512_set1_ps(scal_122);


											vec_384 = _mm512_fmadd_ps(vec_385, vec_378, mem_vec_434);
											mem_vec_434 = vec_384;



											vec_386 = _mm512_fmadd_ps(vec_385, vec_380, mem_vec_435);
											mem_vec_435 = vec_386;
											scal_123 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
											vec_388 = _mm512_set1_ps(scal_123);


											vec_387 = _mm512_fmadd_ps(vec_388, vec_378, mem_vec_436);
											mem_vec_436 = vec_387;



											vec_389 = _mm512_fmadd_ps(vec_388, vec_380, mem_vec_437);
											mem_vec_437 = vec_389;
											scal_124 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
											vec_391 = _mm512_set1_ps(scal_124);


											vec_390 = _mm512_fmadd_ps(vec_391, vec_378, mem_vec_438);
											mem_vec_438 = vec_390;



											vec_392 = _mm512_fmadd_ps(vec_391, vec_380, mem_vec_439);
											mem_vec_439 = vec_392;
											scal_125 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
											vec_394 = _mm512_set1_ps(scal_125);


											vec_393 = _mm512_fmadd_ps(vec_394, vec_378, mem_vec_440);
											mem_vec_440 = vec_393;



											vec_395 = _mm512_fmadd_ps(vec_394, vec_380, mem_vec_441);
											mem_vec_441 = vec_395;
											scal_126 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
											vec_397 = _mm512_set1_ps(scal_126);


											vec_396 = _mm512_fmadd_ps(vec_397, vec_378, mem_vec_442);
											mem_vec_442 = vec_396;



											vec_398 = _mm512_fmadd_ps(vec_397, vec_380, mem_vec_443);
											mem_vec_443 = vec_398;
											scal_127 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
											vec_400 = _mm512_set1_ps(scal_127);


											vec_399 = _mm512_fmadd_ps(vec_400, vec_378, mem_vec_444);
											mem_vec_444 = vec_399;



											vec_401 = _mm512_fmadd_ps(vec_400, vec_380, mem_vec_445);
											mem_vec_445 = vec_401;
											scal_128 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 2) + c];
											vec_403 = _mm512_set1_ps(scal_128);


											vec_402 = _mm512_fmadd_ps(vec_403, vec_378, mem_vec_446);
											mem_vec_446 = vec_402;



											vec_404 = _mm512_fmadd_ps(vec_403, vec_380, mem_vec_447);
											mem_vec_447 = vec_404;
											scal_129 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 2) + c];
											vec_406 = _mm512_set1_ps(scal_129);


											vec_405 = _mm512_fmadd_ps(vec_406, vec_378, mem_vec_448);
											mem_vec_448 = vec_405;



											vec_407 = _mm512_fmadd_ps(vec_406, vec_380, mem_vec_449);
											mem_vec_449 = vec_407;
											scal_130 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 2) + c];
											vec_409 = _mm512_set1_ps(scal_130);


											vec_408 = _mm512_fmadd_ps(vec_409, vec_378, mem_vec_450);
											mem_vec_450 = vec_408;



											vec_410 = _mm512_fmadd_ps(vec_409, vec_380, mem_vec_451);
											mem_vec_451 = vec_410;
											scal_131 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h + 2) + c];
											vec_412 = _mm512_set1_ps(scal_131);


											vec_411 = _mm512_fmadd_ps(vec_412, vec_378, mem_vec_452);
											mem_vec_452 = vec_411;



											vec_413 = _mm512_fmadd_ps(vec_412, vec_380, mem_vec_453);
											mem_vec_453 = vec_413;
											scal_132 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 12 + h + 2) + c];
											vec_415 = _mm512_set1_ps(scal_132);


											vec_414 = _mm512_fmadd_ps(vec_415, vec_378, mem_vec_454);
											mem_vec_454 = vec_414;



											vec_416 = _mm512_fmadd_ps(vec_415, vec_380, mem_vec_455);
											mem_vec_455 = vec_416;
											scal_133 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 13 + h + 2) + c];
											vec_418 = _mm512_set1_ps(scal_133);


											vec_417 = _mm512_fmadd_ps(vec_418, vec_378, mem_vec_456);
											mem_vec_456 = vec_417;



											vec_419 = _mm512_fmadd_ps(vec_418, vec_380, mem_vec_457);
											mem_vec_457 = vec_419;
											scal_134 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 14 + h + 2) + c];
											vec_421 = _mm512_set1_ps(scal_134);


											vec_420 = _mm512_fmadd_ps(vec_421, vec_378, mem_vec_458);
											mem_vec_458 = vec_420;



											vec_422 = _mm512_fmadd_ps(vec_421, vec_380, mem_vec_459);
											mem_vec_459 = vec_422;
										}
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_446);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_447);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_448);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_449);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_450);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_451);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_452);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_453);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_454);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_455);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_456);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_457);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_458);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_459);
							}
						}
					}
				}
