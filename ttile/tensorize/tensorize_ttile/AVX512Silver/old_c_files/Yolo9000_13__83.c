					...
					for (c75 = c76, c75_p_0 = 0;
						...
						for (x = x100, xp_2 = x100_p_1, xp_1 = x100_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1170 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
									mem_vec_1171 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 64
									// T (c, 128) (128 / 1)
									for (c = c75, cp_1 = c75_p_0, cp_0 = 0;
										c < c75 + 128;
										...
										vec_34 = _mm512_fmadd_ps(vec_35, vec_2, mem_vec_1168);
										mem_vec_1168 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_4, mem_vec_1169);
										mem_vec_1169 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_35, vec_6, mem_vec_1170);
										mem_vec_1170 = vec_37;



										vec_38 = _mm512_fmadd_ps(vec_35, vec_8, mem_vec_1171);
										mem_vec_1171 = vec_38;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_1170);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_1171);
						}
					}
				}
			}
