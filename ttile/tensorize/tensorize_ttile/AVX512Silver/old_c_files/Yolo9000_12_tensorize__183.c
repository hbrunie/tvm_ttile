...
[V f; U (2, f); ULambda y; U (3, w); T (32, c); Hoist_vars [c]; T (34, x);
  T (3, h); T (8, c);
  Lambda_apply y [((Iter 4), (Arg 6)); ((Iter 1), (Arg 10))]; T (16, f);
  T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c363_p_0, cp_1, c363, f, fp_0, h, hp_0, x, xp_0, x363_p_0, xp_1, x363, y, yp_0, y270_p_0, yp_1, y270;
IND_TYPE y271 = 0;
IND_TYPE x364 = 0;
IND_TYPE h223 = 0;
IND_TYPE w = 0;
...
x363 = 0;
x363_p_0 = 0;
		for (f = f406, fp_0 = 0;f < f406 + 512;f += 32, fp_0 += 32){
				for (y = y270, yp_1 = y270_p_0, yp_0 = 0;y < y270 + 24;y += 6, yp_1 += 6, yp_0 += 6){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (c, 8) (256 / 32)
					for (c363 = c364, c363_p_0 = 0;c363 < c364 + 256;c363 += 32, c363_p_0 += 32){
						// y = ph_y, x = 34, h = 3, w = 3, c = 32, f = 32
						// T (h, 3) (3 / 1)
						for (h = h223, hp_0 = 0;h < h223 + 3;h += 1, hp_0 += 1){
							// y = ph_y, x = 34, h = 1, w = 3, c = 32, f = 32
							// T (x, 34) (34 / 1)
							for (x = x363, xp_1 = x363_p_0, xp_0 = 0;x < x363 + 34;x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c363, cp_1 = c363_p_0, cp_0 = 0;c < c363 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_20 = _mm512_fmadd_ps(vec_21, vec_22, mem_vec_4216);
											mem_vec_4216 = vec_20;
											vec_24 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
											vec_23 = _mm512_fmadd_ps(vec_21, vec_24, mem_vec_4217);
											mem_vec_4217 = vec_23;
											scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
											vec_26 = _mm512_set1_ps(scal_7);
											vec_25 = _mm512_fmadd_ps(vec_26, vec_22, mem_vec_4218);
											mem_vec_4218 = vec_25;
											vec_27 = _mm512_fmadd_ps(vec_26, vec_24, mem_vec_4219);
											mem_vec_4219 = vec_27;
											scal_8 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
											vec_29 = _mm512_set1_ps(scal_8);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_22, mem_vec_4220);
											mem_vec_4220 = vec_28;
											vec_30 = _mm512_fmadd_ps(vec_29, vec_24, mem_vec_4221);
											mem_vec_4221 = vec_30;
											scal_9 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
											vec_32 = _mm512_set1_ps(scal_9);
											vec_31 = _mm512_fmadd_ps(vec_32, vec_22, mem_vec_4222);
											mem_vec_4222 = vec_31;
											vec_33 = _mm512_fmadd_ps(vec_32, vec_24, mem_vec_4223);
											mem_vec_4223 = vec_33;
											scal_10 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
											vec_35 = _mm512_set1_ps(scal_10);
											vec_34 = _mm512_fmadd_ps(vec_35, vec_22, mem_vec_4224);
											mem_vec_4224 = vec_34;
											vec_36 = _mm512_fmadd_ps(vec_35, vec_24, mem_vec_4225);
											mem_vec_4225 = vec_36;
											scal_11 = input[strideA1 * (x + w + 1) + strideA2 * (y + 5 + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_22, mem_vec_4226);
											mem_vec_4226 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_24, mem_vec_4227);
											mem_vec_4227 = vec_39;
											scal_12 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);
											vec_42 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
											vec_40 = _mm512_fmadd_ps(vec_41, vec_42, mem_vec_4216);
											mem_vec_4216 = vec_40;
											vec_44 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
											vec_43 = _mm512_fmadd_ps(vec_41, vec_44, mem_vec_4217);
											mem_vec_4217 = vec_43;
											scal_13 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
											vec_46 = _mm512_set1_ps(scal_13);
											vec_45 = _mm512_fmadd_ps(vec_46, vec_42, mem_vec_4218);
											mem_vec_4218 = vec_45;
											vec_47 = _mm512_fmadd_ps(vec_46, vec_44, mem_vec_4219);
											mem_vec_4219 = vec_47;
											scal_14 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
											vec_49 = _mm512_set1_ps(scal_14);
											vec_48 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_4220);
											mem_vec_4220 = vec_48;
											vec_50 = _mm512_fmadd_ps(vec_49, vec_44, mem_vec_4221);
											mem_vec_4221 = vec_50;
											scal_15 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
											vec_52 = _mm512_set1_ps(scal_15);
											vec_51 = _mm512_fmadd_ps(vec_52, vec_42, mem_vec_4222);
											mem_vec_4222 = vec_51;
											vec_53 = _mm512_fmadd_ps(vec_52, vec_44, mem_vec_4223);
											mem_vec_4223 = vec_53;
											scal_16 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
											vec_55 = _mm512_set1_ps(scal_16);
											vec_54 = _mm512_fmadd_ps(vec_55, vec_42, mem_vec_4224);
											mem_vec_4224 = vec_54;
											vec_56 = _mm512_fmadd_ps(vec_55, vec_44, mem_vec_4225);
											mem_vec_4225 = vec_56;
											scal_17 = input[strideA1 * (x + w + 2) + strideA2 * (y + 5 + h) + c];
											vec_58 = _mm512_set1_ps(scal_17);
											vec_57 = _mm512_fmadd_ps(vec_58, vec_42, mem_vec_4226);
											mem_vec_4226 = vec_57;
											vec_59 = _mm512_fmadd_ps(vec_58, vec_44, mem_vec_4227);
											mem_vec_4227 = vec_59;
										}
				...
				for (y = y270 + 24, yp_1 = y270_p_0, yp_0 = 0;y < y270 + 24 + 10;y += 10, yp_1 += 10, yp_0 += 10){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (c, 8) (256 / 32)
					for (c363 = c364, c363_p_0 = 0;c363 < c364 + 256;c363 += 32, c363_p_0 += 32){
						// y = ph_y, x = 34, h = 3, w = 3, c = 32, f = 32
						...
						for (h = h223, hp_0 = 0;h < h223 + 3;h += 1, hp_0 += 1){
							...
							for (x = x363, xp_1 = x363_p_0, xp_0 = 0;x < x363 + 34;x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c363, cp_1 = c363_p_0, cp_0 = 0;c < c363 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_32 = _mm512_fmadd_ps(vec_33, vec_34, mem_vec_4228);
											mem_vec_4228 = vec_32;
											vec_36 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
											vec_35 = _mm512_fmadd_ps(vec_33, vec_36, mem_vec_4229);
											mem_vec_4229 = vec_35;
											scal_11 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_4230);
											mem_vec_4230 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_4231);
											mem_vec_4231 = vec_39;
											scal_12 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);
											vec_40 = _mm512_fmadd_ps(vec_41, vec_34, mem_vec_4232);
											mem_vec_4232 = vec_40;
											vec_42 = _mm512_fmadd_ps(vec_41, vec_36, mem_vec_4233);
											mem_vec_4233 = vec_42;
											scal_13 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
											vec_44 = _mm512_set1_ps(scal_13);
											vec_43 = _mm512_fmadd_ps(vec_44, vec_34, mem_vec_4234);
											mem_vec_4234 = vec_43;
											vec_45 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_4235);
											mem_vec_4235 = vec_45;
											scal_14 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
											vec_47 = _mm512_set1_ps(scal_14);
											vec_46 = _mm512_fmadd_ps(vec_47, vec_34, mem_vec_4236);
											mem_vec_4236 = vec_46;
											vec_48 = _mm512_fmadd_ps(vec_47, vec_36, mem_vec_4237);
											mem_vec_4237 = vec_48;
											scal_15 = input[strideA1 * (x + w + 1) + strideA2 * (y + 5 + h) + c];
											vec_50 = _mm512_set1_ps(scal_15);
											vec_49 = _mm512_fmadd_ps(vec_50, vec_34, mem_vec_4238);
											mem_vec_4238 = vec_49;
											vec_51 = _mm512_fmadd_ps(vec_50, vec_36, mem_vec_4239);
											mem_vec_4239 = vec_51;
											scal_16 = input[strideA1 * (x + w + 1) + strideA2 * (y + 6 + h) + c];
											vec_53 = _mm512_set1_ps(scal_16);
											vec_52 = _mm512_fmadd_ps(vec_53, vec_34, mem_vec_4240);
											mem_vec_4240 = vec_52;
											vec_54 = _mm512_fmadd_ps(vec_53, vec_36, mem_vec_4241);
											mem_vec_4241 = vec_54;
											scal_17 = input[strideA1 * (x + w + 1) + strideA2 * (y + 7 + h) + c];
											vec_56 = _mm512_set1_ps(scal_17);
											vec_55 = _mm512_fmadd_ps(vec_56, vec_34, mem_vec_4242);
											mem_vec_4242 = vec_55;
											vec_57 = _mm512_fmadd_ps(vec_56, vec_36, mem_vec_4243);
											mem_vec_4243 = vec_57;
											scal_18 = input[strideA1 * (x + w + 1) + strideA2 * (y + 8 + h) + c];
											vec_59 = _mm512_set1_ps(scal_18);
											vec_58 = _mm512_fmadd_ps(vec_59, vec_34, mem_vec_4244);
											mem_vec_4244 = vec_58;
											vec_60 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_4245);
											mem_vec_4245 = vec_60;
											scal_19 = input[strideA1 * (x + w + 1) + strideA2 * (y + 9 + h) + c];
											vec_62 = _mm512_set1_ps(scal_19);
											vec_61 = _mm512_fmadd_ps(vec_62, vec_34, mem_vec_4246);
											mem_vec_4246 = vec_61;
											vec_63 = _mm512_fmadd_ps(vec_62, vec_36, mem_vec_4247);
											mem_vec_4247 = vec_63;
											scal_20 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
											vec_65 = _mm512_set1_ps(scal_20);
											vec_66 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
											vec_64 = _mm512_fmadd_ps(vec_65, vec_66, mem_vec_4228);
											mem_vec_4228 = vec_64;
											vec_68 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
											vec_67 = _mm512_fmadd_ps(vec_65, vec_68, mem_vec_4229);
											mem_vec_4229 = vec_67;
											scal_21 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
											vec_70 = _mm512_set1_ps(scal_21);
											vec_69 = _mm512_fmadd_ps(vec_70, vec_66, mem_vec_4230);
											mem_vec_4230 = vec_69;
											vec_71 = _mm512_fmadd_ps(vec_70, vec_68, mem_vec_4231);
											mem_vec_4231 = vec_71;
											scal_22 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
											vec_73 = _mm512_set1_ps(scal_22);
											vec_72 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_4232);
											mem_vec_4232 = vec_72;
											vec_74 = _mm512_fmadd_ps(vec_73, vec_68, mem_vec_4233);
											mem_vec_4233 = vec_74;
											scal_23 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
											vec_76 = _mm512_set1_ps(scal_23);
											vec_75 = _mm512_fmadd_ps(vec_76, vec_66, mem_vec_4234);
											mem_vec_4234 = vec_75;
											vec_77 = _mm512_fmadd_ps(vec_76, vec_68, mem_vec_4235);
											mem_vec_4235 = vec_77;
											scal_24 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
											vec_79 = _mm512_set1_ps(scal_24);
											vec_78 = _mm512_fmadd_ps(vec_79, vec_66, mem_vec_4236);
											mem_vec_4236 = vec_78;
											vec_80 = _mm512_fmadd_ps(vec_79, vec_68, mem_vec_4237);
											mem_vec_4237 = vec_80;
											scal_25 = input[strideA1 * (x + w + 2) + strideA2 * (y + 5 + h) + c];
											vec_82 = _mm512_set1_ps(scal_25);
											vec_81 = _mm512_fmadd_ps(vec_82, vec_66, mem_vec_4238);
											mem_vec_4238 = vec_81;
											vec_83 = _mm512_fmadd_ps(vec_82, vec_68, mem_vec_4239);
											mem_vec_4239 = vec_83;
											scal_26 = input[strideA1 * (x + w + 2) + strideA2 * (y + 6 + h) + c];
											vec_85 = _mm512_set1_ps(scal_26);
											vec_84 = _mm512_fmadd_ps(vec_85, vec_66, mem_vec_4240);
											mem_vec_4240 = vec_84;
											vec_86 = _mm512_fmadd_ps(vec_85, vec_68, mem_vec_4241);
											mem_vec_4241 = vec_86;
											scal_27 = input[strideA1 * (x + w + 2) + strideA2 * (y + 7 + h) + c];
											vec_88 = _mm512_set1_ps(scal_27);
											vec_87 = _mm512_fmadd_ps(vec_88, vec_66, mem_vec_4242);
											mem_vec_4242 = vec_87;
											vec_89 = _mm512_fmadd_ps(vec_88, vec_68, mem_vec_4243);
											mem_vec_4243 = vec_89;
											scal_28 = input[strideA1 * (x + w + 2) + strideA2 * (y + 8 + h) + c];
											vec_91 = _mm512_set1_ps(scal_28);
											vec_90 = _mm512_fmadd_ps(vec_91, vec_66, mem_vec_4244);
											mem_vec_4244 = vec_90;
											vec_92 = _mm512_fmadd_ps(vec_91, vec_68, mem_vec_4245);
											mem_vec_4245 = vec_92;
											scal_29 = input[strideA1 * (x + w + 2) + strideA2 * (y + 9 + h) + c];
											vec_94 = _mm512_set1_ps(scal_29);
											vec_93 = _mm512_fmadd_ps(vec_94, vec_66, mem_vec_4246);
											mem_vec_4246 = vec_93;
											vec_95 = _mm512_fmadd_ps(vec_94, vec_68, mem_vec_4247);
											mem_vec_4247 = vec_95;
										}
