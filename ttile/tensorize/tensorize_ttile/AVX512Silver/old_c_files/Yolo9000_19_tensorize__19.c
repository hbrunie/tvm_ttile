...
c545 = 0;
c545_p_0 = 0;
		for (f = f272, fp_0 = 0;f < f272 + 512;f += 64, fp_0 += 64){
				for (y = y408, yp_1 = y408_p_0, yp_0 = 0;y < y408 + 12;y += 4, yp_1 += 4, yp_0 += 4){
					// y = ph_y, x = 17, h = 1, w = 1, c = 128, f = 64
					// T (c, 2) (128 / 64)
					for (c544 = c545, c544_p_1 = c545_p_0, c544_p_0 = 0;c544 < c545 + 128;c544 += 64, c544_p_1 += 64, c544_p_0 += 64){
						// y = ph_y, x = 17, h = 1, w = 1, c = 64, f = 64
						// T (x, 17) (17 / 1)
						for (x = x272, xp_0 = 0;x < x272 + 17;x += 1, xp_0 += 1){
									...
									// T (c, 64) (64 / 1)
									for (c = c544, cp_2 = c544_p_1, cp_1 = c544_p_0, cp_0 = 0;c < c544 + 64;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
				...
				for (y = y408 + 12, yp_1 = y408_p_0, yp_0 = 0;y < y408 + 12 + 5;y += 5, yp_1 += 5, yp_0 += 5){
					// y = ph_y, x = 17, h = 1, w = 1, c = 128, f = 64
					// T (c, 2) (128 / 64)
					for (c544 = c545, c544_p_1 = c545_p_0, c544_p_0 = 0;c544 < c545 + 128;c544 += 64, c544_p_1 += 64, c544_p_0 += 64){
						// y = ph_y, x = 17, h = 1, w = 1, c = 64, f = 64
