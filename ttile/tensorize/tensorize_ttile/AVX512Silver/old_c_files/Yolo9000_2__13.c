...
[V f; U (4, f); U (2, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (1, c); T (17, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c162_p_0, cp_1, c162, h, hp_0, x, xp_0, x216_p_0, x217_p_0, xp_1, x216_p_1, xp_2, x216, x217, y, yp_0, y216_p_0, y217_p_0, yp_1, y216_p_1, yp_2, y216, y217;
...
for (y217 = y218, y217_p_0 = 0;
	...
	for (x217 = x218, x217_p_0 = 0;
		...
		for (y216 = y217, y216_p_1 = y217_p_0, y216_p_0 = 0;
			y216 < y217 + 272;
			y216 += 272, y216_p_1 += 272, y216_p_0 += 272){
			// y = 272, x = 34, h = 3, w = 3, c = 32, f = 64
			// T (y, 136) (272 / 2)
