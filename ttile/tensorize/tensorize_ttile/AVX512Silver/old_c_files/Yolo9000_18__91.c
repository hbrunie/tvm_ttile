...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  ...
  T (8, c); T (2, f)]
*/
IND_TYPE c, cp_0, c576_p_0, c577_p_0, cp_1, c576_p_1, cp_2, c576, c577, f, fp_0, f432_p_0, fp_1, f432, x, xp_0, y, yp_0;
					...
					for (c576 = c577, c576_p_1 = c577_p_0, c576_p_0 = 0;
						...
						for (x = x288, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_2555 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_2556 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_2557 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c576, cp_2 = c576_p_1, cp_1 = c576_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2555);
										mem_vec_2555 = vec_3;
						...
						for (x = x288, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c576, cp_2 = c576_p_1, cp_1 = c576_p_0, cp_0 = 0;
										...
										vec_104 = _mm512_fmadd_ps(vec_105, vec_106, mem_vec_2559);
										mem_vec_2559 = vec_104;
										scal_49 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
										vec_108 = _mm512_set1_ps(scal_49);


										vec_107 = _mm512_fmadd_ps(vec_108, vec_106, mem_vec_2560);
										mem_vec_2560 = vec_107;
										scal_50 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
										vec_110 = _mm512_set1_ps(scal_50);


										vec_109 = _mm512_fmadd_ps(vec_110, vec_106, mem_vec_2561);
										mem_vec_2561 = vec_109;
										scal_51 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
										vec_112 = _mm512_set1_ps(scal_51);


										vec_111 = _mm512_fmadd_ps(vec_112, vec_106, mem_vec_2562);
										mem_vec_2562 = vec_111;
										scal_52 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
										vec_114 = _mm512_set1_ps(scal_52);


										vec_113 = _mm512_fmadd_ps(vec_114, vec_106, mem_vec_2563);
										mem_vec_2563 = vec_113;
										scal_53 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
										vec_116 = _mm512_set1_ps(scal_53);


										vec_115 = _mm512_fmadd_ps(vec_116, vec_106, mem_vec_2564);
										mem_vec_2564 = vec_115;
									}
