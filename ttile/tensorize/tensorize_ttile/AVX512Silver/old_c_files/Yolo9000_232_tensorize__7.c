...
fp_2 = 0;
									for (x = x708, xp_2 = x708_p_1, xp_1 = x708_p_0, xp_0 = 0;x < x708 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
												...
												mem_vec_3021 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
												mem_vec_3022 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
												mem_vec_3023 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
												...
												// T (c, 1024) (1024 / 1)
												for (c = c531, cp_1 = c531_p_0, cp_0 = 0;c < c531 + 1024;c += 1, cp_1 += 1, cp_0 += 1){
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3021);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3022);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_3023);
