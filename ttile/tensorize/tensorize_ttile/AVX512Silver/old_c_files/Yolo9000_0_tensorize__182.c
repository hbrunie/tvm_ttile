...
[V f; U (2, f); U (8, y); U (3, h); T (3, c); Hoist_vars [c]; T (2, x);
  T (1, c); T (3, w); T (17, y); T (1, x); T (272, x); T (4, y)]
*/
IND_TYPE c, cp_0, c372_p_0, cp_1, c372, w, wp_0, x, xp_0, x656_p_0, x657_p_0, xp_1, x656_p_1, xp_2, x656, x657, y, yp_0, y612_p_0, yp_1, y612;
IND_TYPE y613 = 0;
IND_TYPE x658 = 0;
IND_TYPE h = 0;
IND_TYPE w295 = 0;
					...
					for (c372 = c373, c372_p_0 = 0;c372 < c373 + 3;c372 += 3, c372_p_0 += 3){
						...
						for (x = x656, xp_2 = x656_p_1, xp_1 = x656_p_0, xp_0 = 0;x < x656 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c372, cp_1 = c372_p_0, cp_0 = 0;c < c372 + 3;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_2780);
										mem_vec_2780 = vec_26;
										vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
										vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_2781);
										mem_vec_2781 = vec_29;
										scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);
										vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_2782);
										mem_vec_2782 = vec_31;
										vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_2783);
										mem_vec_2783 = vec_33;
										scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);
										vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_2784);
										mem_vec_2784 = vec_34;
										vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_2785);
										mem_vec_2785 = vec_36;
										scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_2786);
										mem_vec_2786 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_2787);
										mem_vec_2787 = vec_39;
										scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_2788);
										mem_vec_2788 = vec_40;
										vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_2789);
										mem_vec_2789 = vec_42;
										scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_2790);
										mem_vec_2790 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_2791);
										mem_vec_2791 = vec_45;
										scal_14 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_2792);
										mem_vec_2792 = vec_46;
										vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_2793);
										mem_vec_2793 = vec_48;
										scal_15 = input[strideA1 * (x + w) + strideA2 * (y + 7 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);
										vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_2794);
										mem_vec_2794 = vec_49;
										vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_2795);
										mem_vec_2795 = vec_51;
										scal_16 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
										vec_53 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
										vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_2780);
										mem_vec_2780 = vec_52;
										vec_56 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
										vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_2781);
										mem_vec_2781 = vec_55;
										scal_17 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_2782);
										mem_vec_2782 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_2783);
										mem_vec_2783 = vec_59;
										scal_18 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
										vec_61 = _mm512_set1_ps(scal_18);
										vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_2784);
										mem_vec_2784 = vec_60;
										vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_2785);
										mem_vec_2785 = vec_62;
										scal_19 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);
										vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_2786);
										mem_vec_2786 = vec_63;
										vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_2787);
										mem_vec_2787 = vec_65;
										scal_20 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);
										vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_2788);
										mem_vec_2788 = vec_66;
										vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_2789);
										mem_vec_2789 = vec_68;
										scal_21 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 2) + c];
										vec_70 = _mm512_set1_ps(scal_21);
										vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_2790);
										mem_vec_2790 = vec_69;
										vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_2791);
										mem_vec_2791 = vec_71;
										scal_22 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 2) + c];
										vec_73 = _mm512_set1_ps(scal_22);
										vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_2792);
										mem_vec_2792 = vec_72;
										vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_2793);
										mem_vec_2793 = vec_74;
										scal_23 = input[strideA1 * (x + w) + strideA2 * (y + 7 + h + 2) + c];
										vec_76 = _mm512_set1_ps(scal_23);
										vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_2794);
										mem_vec_2794 = vec_75;
										vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_2795);
										mem_vec_2795 = vec_77;
									}
