...
xp_0 = 0;
							for (h = h169, hp_0 = 0;h < h169 + 3;h += 1, hp_0 += 1){
										...
										mem_vec_2341 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_2342 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_2343 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2341);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2342);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_2343);
