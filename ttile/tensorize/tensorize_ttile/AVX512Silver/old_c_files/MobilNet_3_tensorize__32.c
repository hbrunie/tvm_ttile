...
[V f; U (2, f); U (8, y); U (3, w); T (16, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (8, c); T (4, f); T (2, x); T (7, y); T (1, x)]
*/
IND_TYPE c, cp_0, c144_p_0, cp_1, c144, f, fp_0, h, hp_0, x, xp_0, x168_p_0, x169_p_0, xp_1, x168_p_1, xp_2, x168, x169, y, yp_0;
IND_TYPE y118 = 0;
IND_TYPE x170 = 0;
IND_TYPE h75 = 0;
IND_TYPE w = 0;
...
__m512 mem_vec_952 ,mem_vec_953 ,mem_vec_954 ,mem_vec_955 ,mem_vec_956 ,mem_vec_957 ,mem_vec_958 ,mem_vec_959 ,mem_vec_960 ,mem_vec_961 ,mem_vec_962 ,mem_vec_963 ,mem_vec_964 ,mem_vec_965 ,mem_vec_966 ,mem_vec_967 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_8 ,vec_9;
					...
					for (h = h75, hp_0 = 0;h < h75 + 3;h += 1, hp_0 += 1){
						...
						for (x = x168, xp_2 = x168_p_1, xp_1 = x168_p_0, xp_0 = 0;x < x168 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c144, cp_1 = c144_p_0, cp_0 = 0;c < c144 + 16;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_952);
										mem_vec_952 = vec_26;
										vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_953);
										mem_vec_953 = vec_29;
										scal_9 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
										vec_32 = _mm512_set1_ps(scal_9);
										vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_954);
										mem_vec_954 = vec_31;
										vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_955);
										mem_vec_955 = vec_33;
										scal_10 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
										vec_35 = _mm512_set1_ps(scal_10);
										vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_956);
										mem_vec_956 = vec_34;
										vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_957);
										mem_vec_957 = vec_36;
										scal_11 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
										vec_38 = _mm512_set1_ps(scal_11);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_958);
										mem_vec_958 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_959);
										mem_vec_959 = vec_39;
										scal_12 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_960);
										mem_vec_960 = vec_40;
										vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_961);
										mem_vec_961 = vec_42;
										scal_13 = input[strideA1 * (x + w + 1) + strideA2 * (y + 5 + h) + c];
										vec_44 = _mm512_set1_ps(scal_13);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_962);
										mem_vec_962 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_963);
										mem_vec_963 = vec_45;
										scal_14 = input[strideA1 * (x + w + 1) + strideA2 * (y + 6 + h) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_964);
										mem_vec_964 = vec_46;
										vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_965);
										mem_vec_965 = vec_48;
										scal_15 = input[strideA1 * (x + w + 1) + strideA2 * (y + 7 + h) + c];
										vec_50 = _mm512_set1_ps(scal_15);
										vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_966);
										mem_vec_966 = vec_49;
										vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_967);
										mem_vec_967 = vec_51;
										scal_16 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
										vec_53 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_952);
										mem_vec_952 = vec_52;
										vec_56 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_953);
										mem_vec_953 = vec_55;
										scal_17 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
										vec_58 = _mm512_set1_ps(scal_17);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_954);
										mem_vec_954 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_955);
										mem_vec_955 = vec_59;
										scal_18 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
										vec_61 = _mm512_set1_ps(scal_18);
										vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_956);
										mem_vec_956 = vec_60;
										vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_957);
										mem_vec_957 = vec_62;
										scal_19 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
										vec_64 = _mm512_set1_ps(scal_19);
										vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_958);
										mem_vec_958 = vec_63;
										vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_959);
										mem_vec_959 = vec_65;
										scal_20 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
										vec_67 = _mm512_set1_ps(scal_20);
										vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_960);
										mem_vec_960 = vec_66;
										vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_961);
										mem_vec_961 = vec_68;
										scal_21 = input[strideA1 * (x + w + 2) + strideA2 * (y + 5 + h) + c];
										vec_70 = _mm512_set1_ps(scal_21);
										vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_962);
										mem_vec_962 = vec_69;
										vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_963);
										mem_vec_963 = vec_71;
										scal_22 = input[strideA1 * (x + w + 2) + strideA2 * (y + 6 + h) + c];
										vec_73 = _mm512_set1_ps(scal_22);
										vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_964);
										mem_vec_964 = vec_72;
										vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_965);
										mem_vec_965 = vec_74;
										scal_23 = input[strideA1 * (x + w + 2) + strideA2 * (y + 7 + h) + c];
										vec_76 = _mm512_set1_ps(scal_23);
										vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_966);
										mem_vec_966 = vec_75;
										vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_967);
										mem_vec_967 = vec_77;
									}
