...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (1, x); T (2, f); T (1, x); T (34, y); T (2, y); T (544, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x84_p_0, x85_p_0, xp_1, x84_p_1, xp_2, x84, x85, y, yp_0, y78_p_0, y79_p_0, yp_1, y78_p_1, yp_2, y78, y79;
...
for (y79 = y80, y79_p_0 = 0;
	...
	for (x85 = x86, x85_p_0 = 0;
		...
		// T (y, 2) (272 / 136)
		for (y78 = y79, y78_p_1 = y79_p_0, y78_p_0 = 0;
			y78 < y79 + 272;
			y78 += 136, y78_p_1 += 136, y78_p_0 += 136){
			// y = 136, x = 1, h = 3, w = 3, c = 3, f = 32
			// T (y, 34) (136 / 4)
			for (y = y78, yp_2 = y78_p_1, yp_1 = y78_p_0, yp_0 = 0;
				y < y78 + 136;
