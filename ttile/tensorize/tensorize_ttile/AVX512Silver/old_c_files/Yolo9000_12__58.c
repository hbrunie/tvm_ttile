...
for (y104 = y105, y104_p_0 = 0;
	...
	for (x149 = x150, x149_p_0 = 0;
		...
		for (f = f178, fp_0 = 0;
			f < f178 + 512;
			f += 32, fp_0 += 32){
				for (y = y104, yp_1 = y104_p_0, yp_0 = 0;
					y < y104 + 6;
					y += 6, yp_1 += 6, yp_0 += 6){
					...
					for (c153 = c154, c153_p_0 = 0;
						...
						for (w = w53, wp_0 = 0;
							...
							for (x = x149, xp_1 = x149_p_0, xp_0 = 0;
								x < x149 + 34;
								x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_1590 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
										mem_vec_1591 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
										...
										mem_vec_1595 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_1596 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_1597 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_1590);
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_1591);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_1595);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_1596);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_1597);
				...
				for (y = y104 + 6, yp_1 = y104_p_0, yp_0 = 0;
					y < y104 + 6 + 28;
					y += 7, yp_1 += 7, yp_0 += 7){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (c, 8) (256 / 32)
