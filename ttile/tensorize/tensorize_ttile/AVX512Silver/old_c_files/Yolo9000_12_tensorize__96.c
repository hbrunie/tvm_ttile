...
[V f; U (2, f); ULambda y; T (32, c); Hoist_vars [c]; T (3, h); T (17, x);
  ...
  T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c225_p_0, cp_1, c225, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x222_p_0, x223_p_0, xp_1, x222_p_1, xp_2, x222, x223, y, yp_0, y163_p_0, yp_1, y163;
IND_TYPE y164 = 0;
IND_TYPE x224 = 0;
IND_TYPE h137 = 0;
IND_TYPE w80 = 0;
...
x223 = 0;
x223_p_0 = 0;
		for (f = f252, fp_0 = 0;f < f252 + 512;f += 32, fp_0 += 32){
				for (y = y163, yp_1 = y163_p_0, yp_0 = 0;y < y163 + 10;y += 10, yp_1 += 10, yp_0 += 10){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (x, 2) (34 / 17)
					for (x222 = x223, x222_p_1 = x223_p_0, x222_p_0 = 0;x222 < x223 + 34;x222 += 17, x222_p_1 += 17, x222_p_0 += 17){
						// y = ph_y, x = 17, h = 3, w = 3, c = 256, f = 32
						// T (c, 8) (256 / 32)
						for (c225 = c226, c225_p_0 = 0;c225 < c226 + 256;c225 += 32, c225_p_0 += 32){
				...
				for (y = y163 + 10, yp_1 = y163_p_0, yp_0 = 0;y < y163 + 10 + 24;y += 12, yp_1 += 12, yp_0 += 12){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (x, 2) (34 / 17)
					for (x222 = x223, x222_p_1 = x223_p_0, x222_p_0 = 0;x222 < x223 + 34;x222 += 17, x222_p_1 += 17, x222_p_0 += 17){
						// y = ph_y, x = 17, h = 3, w = 3, c = 256, f = 32
