...
[V f; U (4, f); ULambda y; T (32, c); Hoist_vars [c]; T (17, x); T (8, c);
  ...
  T (4, c); T (1, y)]
*/
IND_TYPE c, cp_0, c252_p_0, c253_p_0, cp_1, c252_p_1, cp_2, c252, c253, f, fp_0, x, xp_0, y, yp_0, y189_p_0, yp_1, y189;
IND_TYPE y190 = 0;
IND_TYPE x126 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c253 = 0;
c253_p_0 = 0;
		for (f = f126, fp_0 = 0;f < f126 + 512;f += 64, fp_0 += 64){
				for (y = y189, yp_1 = y189_p_0, yp_0 = 0;y < y189 + 3;y += 3, yp_1 += 3, yp_0 += 3){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 64
					// T (c, 8) (256 / 32)
					for (c252 = c253, c252_p_1 = c253_p_0, c252_p_0 = 0;c252 < c253 + 256;c252 += 32, c252_p_1 += 32, c252_p_0 += 32){
						// y = ph_y, x = 17, h = 1, w = 1, c = 32, f = 64
						// T (x, 17) (17 / 1)
						for (x = x126, xp_0 = 0;x < x126 + 17;x += 1, xp_0 += 1){
									...
									// T (c, 32) (32 / 1)
									for (c = c252, cp_2 = c252_p_1, cp_1 = c252_p_0, cp_0 = 0;c < c252 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
				...
				for (y = y189 + 3, yp_1 = y189_p_0, yp_0 = 0;y < y189 + 3 + 14;y += 7, yp_1 += 7, yp_0 += 7){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 64
					// T (c, 8) (256 / 32)
					for (c252 = c253, c252_p_1 = c253_p_0, c252_p_0 = 0;c252 < c253 + 256;c252 += 32, c252_p_1 += 32, c252_p_0 += 32){
						// y = ph_y, x = 17, h = 1, w = 1, c = 32, f = 64
