...
for (y759 = y760, y759_p_0 = 0;
	...
	for (x954 = x955, x954_p_0 = 0;
		...
		for (y758 = y759, y758_p_1 = y759_p_0, y758_p_0 = 0;
			y758 < y759 + 28;
			y758 += 28, y758_p_1 += 28, y758_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 28) (56 / 2)
			for (x953 = x954, x953_p_1 = x954_p_0, x953_p_0 = 0;
				x953 < x954 + 56;
				x953 += 2, x953_p_1 += 2, x953_p_0 += 2){
				...
				for (f = f370, fp_0 = 0;
					...
					for (y = y758, yp_2 = y758_p_1, yp_1 = y758_p_0, yp_0 = 0;
						...
						// T (x, 2) (2 / 1)
						for (x952 = x953, x952_p_2 = x953_p_1, x952_p_1 = x953_p_0, x952_p_0 = 0;
							x952 < x953 + 2;
							x952 += 1, x952_p_2 += 1, x952_p_1 += 1, x952_p_0 += 1){
							...
							for (c582 = c583, c582_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x952, xp_3 = x952_p_2, xp_2 = x952_p_1, xp_1 = x952_p_0, xp_0 = 0;
									x < x952 + 1;
