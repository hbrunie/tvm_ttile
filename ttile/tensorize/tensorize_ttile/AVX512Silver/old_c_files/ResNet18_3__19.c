			...
			for (x346 = x347, x346_p_1 = x347_p_0, x346_p_0 = 0;
				...
				for (f = f138, fp_0 = 0;
					...
					for (y = y276, yp_2 = y276_p_1, yp_1 = y276_p_0, yp_0 = 0;
						...
						// y = 8, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (2 / 2)
						for (x345 = x346, x345_p_2 = x346_p_1, x345_p_1 = x346_p_0, x345_p_0 = 0;
							x345 < x346 + 2;
							x345 += 2, x345_p_2 += 2, x345_p_1 += 2, x345_p_0 += 2){
							// y = 8, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c207 = c208, c207_p_0 = 0;
								...
								// y = 8, x = 2, h = 1, w = 1, c = 64, f = 32
								// T (x, 2) (2 / 1)
								for (x = x345, xp_3 = x345_p_2, xp_2 = x345_p_1, xp_1 = x345_p_0, xp_0 = 0;
									x < x345 + 2;
