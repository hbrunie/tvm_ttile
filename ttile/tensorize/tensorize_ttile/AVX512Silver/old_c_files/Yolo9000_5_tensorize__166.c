...
x27 = 0;
x27_p_0 = 0;
		for (f = f15, fp_0 = 0;f < f15 + 64;f += 32, fp_0 += 32){
				for (y = y27, yp_1 = y27_p_0, yp_0 = 0;y < y27 + 110;y += 10, yp_1 += 10, yp_0 += 10){
					...
					for (x = x27, xp_1 = x27_p_0, xp_0 = 0;x < x27 + 1;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c21, cp_0 = 0;c < c21 + 128;c += 1, cp_0 += 1){
				...
				for (y = y27 + 110, yp_1 = y27_p_0, yp_0 = 0;y < y27 + 110 + 26;y += 13, yp_1 += 13, yp_0 += 13){
					// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
					// T (x, 1) (1 / 1)
					for (x = x27, xp_1 = x27_p_0, xp_0 = 0;x < x27 + 1;x += 1, xp_1 += 1, xp_0 += 1){
