...
[V f; U (4, f); U (2, y); U (3, h); T (16, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, c); T (17, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c39_p_0, cp_1, c39, w, wp_0, x, xp_0, x52_p_0, x53_p_0, xp_1, x52_p_1, xp_2, x52, x53, y, yp_0, y52_p_0, y53_p_0, yp_1, y52_p_1, yp_2, y52, y53;
IND_TYPE y54 = 0;
IND_TYPE x54 = 0;
IND_TYPE h = 0;
IND_TYPE w26 = 0;
