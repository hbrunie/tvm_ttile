...
*/
IND_TYPE c, cp_0, c99_p_0, cp_1, c99, f, fp_0, f99_p_0, fp_1, f99, x, xp_0, x99_p_0, xp_1, x99, y, yp_0;
					...
					for (x = x99, xp_1 = x99_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								for (c = c99, cp_1 = c99_p_0, cp_0 = 0;
									...
									vec_44 = _mm512_fmadd_ps(vec_45, vec_46, mem_vec_924);
									mem_vec_924 = vec_44;

									vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

									vec_47 = _mm512_fmadd_ps(vec_45, vec_48, mem_vec_925);
									mem_vec_925 = vec_47;
									scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
									vec_50 = _mm512_set1_ps(scal_15);


									vec_49 = _mm512_fmadd_ps(vec_50, vec_46, mem_vec_926);
									mem_vec_926 = vec_49;



									vec_51 = _mm512_fmadd_ps(vec_50, vec_48, mem_vec_927);
									mem_vec_927 = vec_51;
									scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
									vec_53 = _mm512_set1_ps(scal_16);


									vec_52 = _mm512_fmadd_ps(vec_53, vec_46, mem_vec_928);
									mem_vec_928 = vec_52;



									vec_54 = _mm512_fmadd_ps(vec_53, vec_48, mem_vec_929);
									mem_vec_929 = vec_54;
									scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
									vec_56 = _mm512_set1_ps(scal_17);


									vec_55 = _mm512_fmadd_ps(vec_56, vec_46, mem_vec_930);
									mem_vec_930 = vec_55;



									vec_57 = _mm512_fmadd_ps(vec_56, vec_48, mem_vec_931);
									mem_vec_931 = vec_57;
									scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 1) + c];
									vec_59 = _mm512_set1_ps(scal_18);


									vec_58 = _mm512_fmadd_ps(vec_59, vec_46, mem_vec_932);
									mem_vec_932 = vec_58;



									vec_60 = _mm512_fmadd_ps(vec_59, vec_48, mem_vec_933);
									mem_vec_933 = vec_60;
									scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 1) + c];
									vec_62 = _mm512_set1_ps(scal_19);


									vec_61 = _mm512_fmadd_ps(vec_62, vec_46, mem_vec_934);
									mem_vec_934 = vec_61;



									vec_63 = _mm512_fmadd_ps(vec_62, vec_48, mem_vec_935);
									mem_vec_935 = vec_63;
									scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 1) + c];
									vec_65 = _mm512_set1_ps(scal_20);


									vec_64 = _mm512_fmadd_ps(vec_65, vec_46, mem_vec_936);
									mem_vec_936 = vec_64;



									vec_66 = _mm512_fmadd_ps(vec_65, vec_48, mem_vec_937);
									mem_vec_937 = vec_66;
									scal_21 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 7) + h + 1) + c];
									vec_68 = _mm512_set1_ps(scal_21);


									vec_67 = _mm512_fmadd_ps(vec_68, vec_46, mem_vec_938);
									mem_vec_938 = vec_67;



									vec_69 = _mm512_fmadd_ps(vec_68, vec_48, mem_vec_939);
									mem_vec_939 = vec_69;
									scal_22 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 8) + h + 1) + c];
									vec_71 = _mm512_set1_ps(scal_22);


									vec_70 = _mm512_fmadd_ps(vec_71, vec_46, mem_vec_940);
									mem_vec_940 = vec_70;



									vec_72 = _mm512_fmadd_ps(vec_71, vec_48, mem_vec_941);
									mem_vec_941 = vec_72;
									scal_23 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 9) + h + 1) + c];
									vec_74 = _mm512_set1_ps(scal_23);


									vec_73 = _mm512_fmadd_ps(vec_74, vec_46, mem_vec_942);
									mem_vec_942 = vec_73;



									vec_75 = _mm512_fmadd_ps(vec_74, vec_48, mem_vec_943);
									mem_vec_943 = vec_75;
									scal_24 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 10) + h + 1) + c];
									vec_77 = _mm512_set1_ps(scal_24);


									vec_76 = _mm512_fmadd_ps(vec_77, vec_46, mem_vec_944);
									mem_vec_944 = vec_76;



									vec_78 = _mm512_fmadd_ps(vec_77, vec_48, mem_vec_945);
									mem_vec_945 = vec_78;
									scal_25 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 11) + h + 1) + c];
									vec_80 = _mm512_set1_ps(scal_25);


									vec_79 = _mm512_fmadd_ps(vec_80, vec_46, mem_vec_946);
									mem_vec_946 = vec_79;



									vec_81 = _mm512_fmadd_ps(vec_80, vec_48, mem_vec_947);
									mem_vec_947 = vec_81;
									scal_26 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 12) + h + 1) + c];
									vec_83 = _mm512_set1_ps(scal_26);


									vec_82 = _mm512_fmadd_ps(vec_83, vec_46, mem_vec_948);
									mem_vec_948 = vec_82;



									vec_84 = _mm512_fmadd_ps(vec_83, vec_48, mem_vec_949);
									mem_vec_949 = vec_84;
									scal_27 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 13) + h + 1) + c];
									vec_86 = _mm512_set1_ps(scal_27);


									vec_85 = _mm512_fmadd_ps(vec_86, vec_46, mem_vec_950);
									mem_vec_950 = vec_85;



									vec_87 = _mm512_fmadd_ps(vec_86, vec_48, mem_vec_951);
									mem_vec_951 = vec_87;
									...
									vec_88 = _mm512_fmadd_ps(vec_89, vec_90, mem_vec_924);
									mem_vec_924 = vec_88;

									vec_92 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

									vec_91 = _mm512_fmadd_ps(vec_89, vec_92, mem_vec_925);
									mem_vec_925 = vec_91;
									scal_29 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
									vec_94 = _mm512_set1_ps(scal_29);


									vec_93 = _mm512_fmadd_ps(vec_94, vec_90, mem_vec_926);
									mem_vec_926 = vec_93;



									vec_95 = _mm512_fmadd_ps(vec_94, vec_92, mem_vec_927);
									mem_vec_927 = vec_95;
									scal_30 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
									vec_97 = _mm512_set1_ps(scal_30);


									vec_96 = _mm512_fmadd_ps(vec_97, vec_90, mem_vec_928);
									mem_vec_928 = vec_96;



									vec_98 = _mm512_fmadd_ps(vec_97, vec_92, mem_vec_929);
									mem_vec_929 = vec_98;
									scal_31 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
									vec_100 = _mm512_set1_ps(scal_31);


									vec_99 = _mm512_fmadd_ps(vec_100, vec_90, mem_vec_930);
									mem_vec_930 = vec_99;



									vec_101 = _mm512_fmadd_ps(vec_100, vec_92, mem_vec_931);
									mem_vec_931 = vec_101;
									scal_32 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h + 2) + c];
									vec_103 = _mm512_set1_ps(scal_32);


									vec_102 = _mm512_fmadd_ps(vec_103, vec_90, mem_vec_932);
									mem_vec_932 = vec_102;



									vec_104 = _mm512_fmadd_ps(vec_103, vec_92, mem_vec_933);
									mem_vec_933 = vec_104;
									scal_33 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 5) + h + 2) + c];
									vec_106 = _mm512_set1_ps(scal_33);


									vec_105 = _mm512_fmadd_ps(vec_106, vec_90, mem_vec_934);
									mem_vec_934 = vec_105;



									vec_107 = _mm512_fmadd_ps(vec_106, vec_92, mem_vec_935);
									mem_vec_935 = vec_107;
									scal_34 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 6) + h + 2) + c];
									vec_109 = _mm512_set1_ps(scal_34);


									vec_108 = _mm512_fmadd_ps(vec_109, vec_90, mem_vec_936);
									mem_vec_936 = vec_108;



									vec_110 = _mm512_fmadd_ps(vec_109, vec_92, mem_vec_937);
									mem_vec_937 = vec_110;
									scal_35 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 7) + h + 2) + c];
									vec_112 = _mm512_set1_ps(scal_35);


									vec_111 = _mm512_fmadd_ps(vec_112, vec_90, mem_vec_938);
									mem_vec_938 = vec_111;



									vec_113 = _mm512_fmadd_ps(vec_112, vec_92, mem_vec_939);
									mem_vec_939 = vec_113;
									scal_36 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 8) + h + 2) + c];
									vec_115 = _mm512_set1_ps(scal_36);


									vec_114 = _mm512_fmadd_ps(vec_115, vec_90, mem_vec_940);
									mem_vec_940 = vec_114;



									vec_116 = _mm512_fmadd_ps(vec_115, vec_92, mem_vec_941);
									mem_vec_941 = vec_116;
									scal_37 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 9) + h + 2) + c];
									vec_118 = _mm512_set1_ps(scal_37);


									vec_117 = _mm512_fmadd_ps(vec_118, vec_90, mem_vec_942);
									mem_vec_942 = vec_117;



									vec_119 = _mm512_fmadd_ps(vec_118, vec_92, mem_vec_943);
									mem_vec_943 = vec_119;
									scal_38 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 10) + h + 2) + c];
									vec_121 = _mm512_set1_ps(scal_38);


									vec_120 = _mm512_fmadd_ps(vec_121, vec_90, mem_vec_944);
									mem_vec_944 = vec_120;



									vec_122 = _mm512_fmadd_ps(vec_121, vec_92, mem_vec_945);
									mem_vec_945 = vec_122;
									scal_39 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 11) + h + 2) + c];
									vec_124 = _mm512_set1_ps(scal_39);


									vec_123 = _mm512_fmadd_ps(vec_124, vec_90, mem_vec_946);
									mem_vec_946 = vec_123;



									vec_125 = _mm512_fmadd_ps(vec_124, vec_92, mem_vec_947);
									mem_vec_947 = vec_125;
									scal_40 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 12) + h + 2) + c];
									vec_127 = _mm512_set1_ps(scal_40);


									vec_126 = _mm512_fmadd_ps(vec_127, vec_90, mem_vec_948);
									mem_vec_948 = vec_126;



									vec_128 = _mm512_fmadd_ps(vec_127, vec_92, mem_vec_949);
									mem_vec_949 = vec_128;
									scal_41 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 13) + h + 2) + c];
									vec_130 = _mm512_set1_ps(scal_41);


									vec_129 = _mm512_fmadd_ps(vec_130, vec_90, mem_vec_950);
									mem_vec_950 = vec_129;



									vec_131 = _mm512_fmadd_ps(vec_130, vec_92, mem_vec_951);
									mem_vec_951 = vec_131;
									...
									vec_132 = _mm512_fmadd_ps(vec_133, vec_134, mem_vec_924);
									mem_vec_924 = vec_132;

									vec_136 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

									vec_135 = _mm512_fmadd_ps(vec_133, vec_136, mem_vec_925);
									mem_vec_925 = vec_135;
									scal_43 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
									vec_138 = _mm512_set1_ps(scal_43);


									vec_137 = _mm512_fmadd_ps(vec_138, vec_134, mem_vec_926);
									mem_vec_926 = vec_137;



									vec_139 = _mm512_fmadd_ps(vec_138, vec_136, mem_vec_927);
									mem_vec_927 = vec_139;
									scal_44 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
									vec_141 = _mm512_set1_ps(scal_44);


									vec_140 = _mm512_fmadd_ps(vec_141, vec_134, mem_vec_928);
									mem_vec_928 = vec_140;



									vec_142 = _mm512_fmadd_ps(vec_141, vec_136, mem_vec_929);
									mem_vec_929 = vec_142;
									scal_45 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
									vec_144 = _mm512_set1_ps(scal_45);


									vec_143 = _mm512_fmadd_ps(vec_144, vec_134, mem_vec_930);
									mem_vec_930 = vec_143;



									vec_145 = _mm512_fmadd_ps(vec_144, vec_136, mem_vec_931);
									mem_vec_931 = vec_145;
									scal_46 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
									vec_147 = _mm512_set1_ps(scal_46);


									vec_146 = _mm512_fmadd_ps(vec_147, vec_134, mem_vec_932);
									mem_vec_932 = vec_146;



									vec_148 = _mm512_fmadd_ps(vec_147, vec_136, mem_vec_933);
									mem_vec_933 = vec_148;
									scal_47 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
									vec_150 = _mm512_set1_ps(scal_47);


									vec_149 = _mm512_fmadd_ps(vec_150, vec_134, mem_vec_934);
									mem_vec_934 = vec_149;



									vec_151 = _mm512_fmadd_ps(vec_150, vec_136, mem_vec_935);
									mem_vec_935 = vec_151;
									scal_48 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h) + c];
									vec_153 = _mm512_set1_ps(scal_48);


									vec_152 = _mm512_fmadd_ps(vec_153, vec_134, mem_vec_936);
									mem_vec_936 = vec_152;



									vec_154 = _mm512_fmadd_ps(vec_153, vec_136, mem_vec_937);
									mem_vec_937 = vec_154;
									scal_49 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h) + c];
									vec_156 = _mm512_set1_ps(scal_49);


									vec_155 = _mm512_fmadd_ps(vec_156, vec_134, mem_vec_938);
									mem_vec_938 = vec_155;



									vec_157 = _mm512_fmadd_ps(vec_156, vec_136, mem_vec_939);
									mem_vec_939 = vec_157;
									scal_50 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h) + c];
									vec_159 = _mm512_set1_ps(scal_50);


									vec_158 = _mm512_fmadd_ps(vec_159, vec_134, mem_vec_940);
									mem_vec_940 = vec_158;



									vec_160 = _mm512_fmadd_ps(vec_159, vec_136, mem_vec_941);
									mem_vec_941 = vec_160;
									scal_51 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 9) + h) + c];
									vec_162 = _mm512_set1_ps(scal_51);


									vec_161 = _mm512_fmadd_ps(vec_162, vec_134, mem_vec_942);
									mem_vec_942 = vec_161;



									vec_163 = _mm512_fmadd_ps(vec_162, vec_136, mem_vec_943);
									mem_vec_943 = vec_163;
									scal_52 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 10) + h) + c];
									vec_165 = _mm512_set1_ps(scal_52);


									vec_164 = _mm512_fmadd_ps(vec_165, vec_134, mem_vec_944);
									mem_vec_944 = vec_164;



									vec_166 = _mm512_fmadd_ps(vec_165, vec_136, mem_vec_945);
									mem_vec_945 = vec_166;
									scal_53 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 11) + h) + c];
									vec_168 = _mm512_set1_ps(scal_53);


									vec_167 = _mm512_fmadd_ps(vec_168, vec_134, mem_vec_946);
									mem_vec_946 = vec_167;



									vec_169 = _mm512_fmadd_ps(vec_168, vec_136, mem_vec_947);
									mem_vec_947 = vec_169;
									scal_54 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 12) + h) + c];
									vec_171 = _mm512_set1_ps(scal_54);


									vec_170 = _mm512_fmadd_ps(vec_171, vec_134, mem_vec_948);
									mem_vec_948 = vec_170;



									vec_172 = _mm512_fmadd_ps(vec_171, vec_136, mem_vec_949);
									mem_vec_949 = vec_172;
									scal_55 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 13) + h) + c];
									vec_174 = _mm512_set1_ps(scal_55);


									vec_173 = _mm512_fmadd_ps(vec_174, vec_134, mem_vec_950);
									mem_vec_950 = vec_173;



									vec_175 = _mm512_fmadd_ps(vec_174, vec_136, mem_vec_951);
									mem_vec_951 = vec_175;
									...
									vec_176 = _mm512_fmadd_ps(vec_177, vec_178, mem_vec_924);
									mem_vec_924 = vec_176;

									vec_180 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

									vec_179 = _mm512_fmadd_ps(vec_177, vec_180, mem_vec_925);
									mem_vec_925 = vec_179;
									scal_57 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h + 1) + c];
									vec_182 = _mm512_set1_ps(scal_57);


									vec_181 = _mm512_fmadd_ps(vec_182, vec_178, mem_vec_926);
									mem_vec_926 = vec_181;



									vec_183 = _mm512_fmadd_ps(vec_182, vec_180, mem_vec_927);
									mem_vec_927 = vec_183;
									scal_58 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h + 1) + c];
									vec_185 = _mm512_set1_ps(scal_58);


									vec_184 = _mm512_fmadd_ps(vec_185, vec_178, mem_vec_928);
									mem_vec_928 = vec_184;



									vec_186 = _mm512_fmadd_ps(vec_185, vec_180, mem_vec_929);
									mem_vec_929 = vec_186;
									scal_59 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h + 1) + c];
									vec_188 = _mm512_set1_ps(scal_59);


									vec_187 = _mm512_fmadd_ps(vec_188, vec_178, mem_vec_930);
									mem_vec_930 = vec_187;



									vec_189 = _mm512_fmadd_ps(vec_188, vec_180, mem_vec_931);
									mem_vec_931 = vec_189;
									scal_60 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h + 1) + c];
									vec_191 = _mm512_set1_ps(scal_60);


									vec_190 = _mm512_fmadd_ps(vec_191, vec_178, mem_vec_932);
									mem_vec_932 = vec_190;



									vec_192 = _mm512_fmadd_ps(vec_191, vec_180, mem_vec_933);
									mem_vec_933 = vec_192;
									scal_61 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h + 1) + c];
									vec_194 = _mm512_set1_ps(scal_61);


									vec_193 = _mm512_fmadd_ps(vec_194, vec_178, mem_vec_934);
									mem_vec_934 = vec_193;



									vec_195 = _mm512_fmadd_ps(vec_194, vec_180, mem_vec_935);
									mem_vec_935 = vec_195;
									scal_62 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h + 1) + c];
									vec_197 = _mm512_set1_ps(scal_62);


									vec_196 = _mm512_fmadd_ps(vec_197, vec_178, mem_vec_936);
									mem_vec_936 = vec_196;



									vec_198 = _mm512_fmadd_ps(vec_197, vec_180, mem_vec_937);
									mem_vec_937 = vec_198;
									scal_63 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h + 1) + c];
									vec_200 = _mm512_set1_ps(scal_63);


									vec_199 = _mm512_fmadd_ps(vec_200, vec_178, mem_vec_938);
									mem_vec_938 = vec_199;



									vec_201 = _mm512_fmadd_ps(vec_200, vec_180, mem_vec_939);
									mem_vec_939 = vec_201;
									scal_64 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h + 1) + c];
									vec_203 = _mm512_set1_ps(scal_64);


									vec_202 = _mm512_fmadd_ps(vec_203, vec_178, mem_vec_940);
									mem_vec_940 = vec_202;



									vec_204 = _mm512_fmadd_ps(vec_203, vec_180, mem_vec_941);
									mem_vec_941 = vec_204;
									scal_65 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 9) + h + 1) + c];
									vec_206 = _mm512_set1_ps(scal_65);


									vec_205 = _mm512_fmadd_ps(vec_206, vec_178, mem_vec_942);
									mem_vec_942 = vec_205;



									vec_207 = _mm512_fmadd_ps(vec_206, vec_180, mem_vec_943);
									mem_vec_943 = vec_207;
									scal_66 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 10) + h + 1) + c];
									vec_209 = _mm512_set1_ps(scal_66);


									vec_208 = _mm512_fmadd_ps(vec_209, vec_178, mem_vec_944);
									mem_vec_944 = vec_208;



									vec_210 = _mm512_fmadd_ps(vec_209, vec_180, mem_vec_945);
									mem_vec_945 = vec_210;
									scal_67 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 11) + h + 1) + c];
									vec_212 = _mm512_set1_ps(scal_67);


									vec_211 = _mm512_fmadd_ps(vec_212, vec_178, mem_vec_946);
									mem_vec_946 = vec_211;



									vec_213 = _mm512_fmadd_ps(vec_212, vec_180, mem_vec_947);
									mem_vec_947 = vec_213;
									scal_68 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 12) + h + 1) + c];
									vec_215 = _mm512_set1_ps(scal_68);


									vec_214 = _mm512_fmadd_ps(vec_215, vec_178, mem_vec_948);
									mem_vec_948 = vec_214;



									vec_216 = _mm512_fmadd_ps(vec_215, vec_180, mem_vec_949);
									mem_vec_949 = vec_216;
									scal_69 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 13) + h + 1) + c];
									vec_218 = _mm512_set1_ps(scal_69);


									vec_217 = _mm512_fmadd_ps(vec_218, vec_178, mem_vec_950);
									mem_vec_950 = vec_217;



									vec_219 = _mm512_fmadd_ps(vec_218, vec_180, mem_vec_951);
									mem_vec_951 = vec_219;
									...
									vec_220 = _mm512_fmadd_ps(vec_221, vec_222, mem_vec_924);
									mem_vec_924 = vec_220;

									vec_224 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

									vec_223 = _mm512_fmadd_ps(vec_221, vec_224, mem_vec_925);
									mem_vec_925 = vec_223;
									scal_71 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h + 2) + c];
									vec_226 = _mm512_set1_ps(scal_71);


									vec_225 = _mm512_fmadd_ps(vec_226, vec_222, mem_vec_926);
									mem_vec_926 = vec_225;



									vec_227 = _mm512_fmadd_ps(vec_226, vec_224, mem_vec_927);
									mem_vec_927 = vec_227;
									scal_72 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h + 2) + c];
									vec_229 = _mm512_set1_ps(scal_72);


									vec_228 = _mm512_fmadd_ps(vec_229, vec_222, mem_vec_928);
									mem_vec_928 = vec_228;



									vec_230 = _mm512_fmadd_ps(vec_229, vec_224, mem_vec_929);
									mem_vec_929 = vec_230;
									scal_73 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h + 2) + c];
									vec_232 = _mm512_set1_ps(scal_73);


									vec_231 = _mm512_fmadd_ps(vec_232, vec_222, mem_vec_930);
									mem_vec_930 = vec_231;



									vec_233 = _mm512_fmadd_ps(vec_232, vec_224, mem_vec_931);
									mem_vec_931 = vec_233;
									scal_74 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h + 2) + c];
									vec_235 = _mm512_set1_ps(scal_74);


									vec_234 = _mm512_fmadd_ps(vec_235, vec_222, mem_vec_932);
									mem_vec_932 = vec_234;



									vec_236 = _mm512_fmadd_ps(vec_235, vec_224, mem_vec_933);
									mem_vec_933 = vec_236;
									scal_75 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h + 2) + c];
									vec_238 = _mm512_set1_ps(scal_75);


									vec_237 = _mm512_fmadd_ps(vec_238, vec_222, mem_vec_934);
									mem_vec_934 = vec_237;



									vec_239 = _mm512_fmadd_ps(vec_238, vec_224, mem_vec_935);
									mem_vec_935 = vec_239;
									scal_76 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h + 2) + c];
									vec_241 = _mm512_set1_ps(scal_76);


									vec_240 = _mm512_fmadd_ps(vec_241, vec_222, mem_vec_936);
									mem_vec_936 = vec_240;



									vec_242 = _mm512_fmadd_ps(vec_241, vec_224, mem_vec_937);
									mem_vec_937 = vec_242;
									scal_77 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h + 2) + c];
									vec_244 = _mm512_set1_ps(scal_77);


									vec_243 = _mm512_fmadd_ps(vec_244, vec_222, mem_vec_938);
									mem_vec_938 = vec_243;



									vec_245 = _mm512_fmadd_ps(vec_244, vec_224, mem_vec_939);
									mem_vec_939 = vec_245;
									scal_78 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h + 2) + c];
									vec_247 = _mm512_set1_ps(scal_78);


									vec_246 = _mm512_fmadd_ps(vec_247, vec_222, mem_vec_940);
									mem_vec_940 = vec_246;



									vec_248 = _mm512_fmadd_ps(vec_247, vec_224, mem_vec_941);
									mem_vec_941 = vec_248;
									scal_79 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 9) + h + 2) + c];
									vec_250 = _mm512_set1_ps(scal_79);


									vec_249 = _mm512_fmadd_ps(vec_250, vec_222, mem_vec_942);
									mem_vec_942 = vec_249;



									vec_251 = _mm512_fmadd_ps(vec_250, vec_224, mem_vec_943);
									mem_vec_943 = vec_251;
									scal_80 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 10) + h + 2) + c];
									vec_253 = _mm512_set1_ps(scal_80);


									vec_252 = _mm512_fmadd_ps(vec_253, vec_222, mem_vec_944);
									mem_vec_944 = vec_252;



									vec_254 = _mm512_fmadd_ps(vec_253, vec_224, mem_vec_945);
									mem_vec_945 = vec_254;
									scal_81 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 11) + h + 2) + c];
									vec_256 = _mm512_set1_ps(scal_81);


									vec_255 = _mm512_fmadd_ps(vec_256, vec_222, mem_vec_946);
									mem_vec_946 = vec_255;



									vec_257 = _mm512_fmadd_ps(vec_256, vec_224, mem_vec_947);
									mem_vec_947 = vec_257;
									scal_82 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 12) + h + 2) + c];
									vec_259 = _mm512_set1_ps(scal_82);


									vec_258 = _mm512_fmadd_ps(vec_259, vec_222, mem_vec_948);
									mem_vec_948 = vec_258;



									vec_260 = _mm512_fmadd_ps(vec_259, vec_224, mem_vec_949);
									mem_vec_949 = vec_260;
									scal_83 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 13) + h + 2) + c];
									vec_262 = _mm512_set1_ps(scal_83);


									vec_261 = _mm512_fmadd_ps(vec_262, vec_222, mem_vec_950);
									mem_vec_950 = vec_261;



									vec_263 = _mm512_fmadd_ps(vec_262, vec_224, mem_vec_951);
									mem_vec_951 = vec_263;
									...
									vec_264 = _mm512_fmadd_ps(vec_265, vec_266, mem_vec_924);
									mem_vec_924 = vec_264;

									vec_268 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

									vec_267 = _mm512_fmadd_ps(vec_265, vec_268, mem_vec_925);
									mem_vec_925 = vec_267;
									scal_85 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
									vec_270 = _mm512_set1_ps(scal_85);


									vec_269 = _mm512_fmadd_ps(vec_270, vec_266, mem_vec_926);
									mem_vec_926 = vec_269;



									vec_271 = _mm512_fmadd_ps(vec_270, vec_268, mem_vec_927);
									mem_vec_927 = vec_271;
									scal_86 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
									vec_273 = _mm512_set1_ps(scal_86);


									vec_272 = _mm512_fmadd_ps(vec_273, vec_266, mem_vec_928);
									mem_vec_928 = vec_272;



									vec_274 = _mm512_fmadd_ps(vec_273, vec_268, mem_vec_929);
									mem_vec_929 = vec_274;
									scal_87 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
									vec_276 = _mm512_set1_ps(scal_87);


									vec_275 = _mm512_fmadd_ps(vec_276, vec_266, mem_vec_930);
									mem_vec_930 = vec_275;



									vec_277 = _mm512_fmadd_ps(vec_276, vec_268, mem_vec_931);
									mem_vec_931 = vec_277;
									scal_88 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
									vec_279 = _mm512_set1_ps(scal_88);


									vec_278 = _mm512_fmadd_ps(vec_279, vec_266, mem_vec_932);
									mem_vec_932 = vec_278;



									vec_280 = _mm512_fmadd_ps(vec_279, vec_268, mem_vec_933);
									mem_vec_933 = vec_280;
									scal_89 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
									vec_282 = _mm512_set1_ps(scal_89);


									vec_281 = _mm512_fmadd_ps(vec_282, vec_266, mem_vec_934);
									mem_vec_934 = vec_281;



									vec_283 = _mm512_fmadd_ps(vec_282, vec_268, mem_vec_935);
									mem_vec_935 = vec_283;
									scal_90 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
									vec_285 = _mm512_set1_ps(scal_90);


									vec_284 = _mm512_fmadd_ps(vec_285, vec_266, mem_vec_936);
									mem_vec_936 = vec_284;



									vec_286 = _mm512_fmadd_ps(vec_285, vec_268, mem_vec_937);
									mem_vec_937 = vec_286;
									scal_91 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h) + c];
									vec_288 = _mm512_set1_ps(scal_91);


									vec_287 = _mm512_fmadd_ps(vec_288, vec_266, mem_vec_938);
									mem_vec_938 = vec_287;



									vec_289 = _mm512_fmadd_ps(vec_288, vec_268, mem_vec_939);
									mem_vec_939 = vec_289;
									scal_92 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h) + c];
									vec_291 = _mm512_set1_ps(scal_92);


									vec_290 = _mm512_fmadd_ps(vec_291, vec_266, mem_vec_940);
									mem_vec_940 = vec_290;



									vec_292 = _mm512_fmadd_ps(vec_291, vec_268, mem_vec_941);
									mem_vec_941 = vec_292;
									scal_93 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 9) + h) + c];
									vec_294 = _mm512_set1_ps(scal_93);


									vec_293 = _mm512_fmadd_ps(vec_294, vec_266, mem_vec_942);
									mem_vec_942 = vec_293;



									vec_295 = _mm512_fmadd_ps(vec_294, vec_268, mem_vec_943);
									mem_vec_943 = vec_295;
									scal_94 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 10) + h) + c];
									vec_297 = _mm512_set1_ps(scal_94);


									vec_296 = _mm512_fmadd_ps(vec_297, vec_266, mem_vec_944);
									mem_vec_944 = vec_296;



									vec_298 = _mm512_fmadd_ps(vec_297, vec_268, mem_vec_945);
									mem_vec_945 = vec_298;
									scal_95 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 11) + h) + c];
									vec_300 = _mm512_set1_ps(scal_95);


									vec_299 = _mm512_fmadd_ps(vec_300, vec_266, mem_vec_946);
									mem_vec_946 = vec_299;



									vec_301 = _mm512_fmadd_ps(vec_300, vec_268, mem_vec_947);
									mem_vec_947 = vec_301;
									scal_96 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 12) + h) + c];
									vec_303 = _mm512_set1_ps(scal_96);


									vec_302 = _mm512_fmadd_ps(vec_303, vec_266, mem_vec_948);
									mem_vec_948 = vec_302;



									vec_304 = _mm512_fmadd_ps(vec_303, vec_268, mem_vec_949);
									mem_vec_949 = vec_304;
									scal_97 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 13) + h) + c];
									vec_306 = _mm512_set1_ps(scal_97);


									vec_305 = _mm512_fmadd_ps(vec_306, vec_266, mem_vec_950);
									mem_vec_950 = vec_305;



									vec_307 = _mm512_fmadd_ps(vec_306, vec_268, mem_vec_951);
									mem_vec_951 = vec_307;
									...
									vec_308 = _mm512_fmadd_ps(vec_309, vec_310, mem_vec_924);
									mem_vec_924 = vec_308;

									vec_312 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

									vec_311 = _mm512_fmadd_ps(vec_309, vec_312, mem_vec_925);
									mem_vec_925 = vec_311;
									scal_99 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h + 1) + c];
									vec_314 = _mm512_set1_ps(scal_99);


									vec_313 = _mm512_fmadd_ps(vec_314, vec_310, mem_vec_926);
									mem_vec_926 = vec_313;



									vec_315 = _mm512_fmadd_ps(vec_314, vec_312, mem_vec_927);
									mem_vec_927 = vec_315;
									scal_100 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h + 1) + c];
									vec_317 = _mm512_set1_ps(scal_100);


									vec_316 = _mm512_fmadd_ps(vec_317, vec_310, mem_vec_928);
									mem_vec_928 = vec_316;



									vec_318 = _mm512_fmadd_ps(vec_317, vec_312, mem_vec_929);
									mem_vec_929 = vec_318;
									scal_101 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h + 1) + c];
									vec_320 = _mm512_set1_ps(scal_101);


									vec_319 = _mm512_fmadd_ps(vec_320, vec_310, mem_vec_930);
									mem_vec_930 = vec_319;



									vec_321 = _mm512_fmadd_ps(vec_320, vec_312, mem_vec_931);
									mem_vec_931 = vec_321;
									scal_102 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h + 1) + c];
									vec_323 = _mm512_set1_ps(scal_102);


									vec_322 = _mm512_fmadd_ps(vec_323, vec_310, mem_vec_932);
									mem_vec_932 = vec_322;



									vec_324 = _mm512_fmadd_ps(vec_323, vec_312, mem_vec_933);
									mem_vec_933 = vec_324;
									scal_103 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h + 1) + c];
									vec_326 = _mm512_set1_ps(scal_103);


									vec_325 = _mm512_fmadd_ps(vec_326, vec_310, mem_vec_934);
									mem_vec_934 = vec_325;



									vec_327 = _mm512_fmadd_ps(vec_326, vec_312, mem_vec_935);
									mem_vec_935 = vec_327;
									scal_104 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h + 1) + c];
									vec_329 = _mm512_set1_ps(scal_104);


									vec_328 = _mm512_fmadd_ps(vec_329, vec_310, mem_vec_936);
									mem_vec_936 = vec_328;



									vec_330 = _mm512_fmadd_ps(vec_329, vec_312, mem_vec_937);
									mem_vec_937 = vec_330;
									scal_105 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h + 1) + c];
									vec_332 = _mm512_set1_ps(scal_105);


									vec_331 = _mm512_fmadd_ps(vec_332, vec_310, mem_vec_938);
									mem_vec_938 = vec_331;



									vec_333 = _mm512_fmadd_ps(vec_332, vec_312, mem_vec_939);
									mem_vec_939 = vec_333;
									scal_106 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h + 1) + c];
									vec_335 = _mm512_set1_ps(scal_106);


									vec_334 = _mm512_fmadd_ps(vec_335, vec_310, mem_vec_940);
									mem_vec_940 = vec_334;



									vec_336 = _mm512_fmadd_ps(vec_335, vec_312, mem_vec_941);
									mem_vec_941 = vec_336;
									scal_107 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 9) + h + 1) + c];
									vec_338 = _mm512_set1_ps(scal_107);


									vec_337 = _mm512_fmadd_ps(vec_338, vec_310, mem_vec_942);
									mem_vec_942 = vec_337;



									vec_339 = _mm512_fmadd_ps(vec_338, vec_312, mem_vec_943);
									mem_vec_943 = vec_339;
									scal_108 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 10) + h + 1) + c];
									vec_341 = _mm512_set1_ps(scal_108);


									vec_340 = _mm512_fmadd_ps(vec_341, vec_310, mem_vec_944);
									mem_vec_944 = vec_340;



									vec_342 = _mm512_fmadd_ps(vec_341, vec_312, mem_vec_945);
									mem_vec_945 = vec_342;
									scal_109 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 11) + h + 1) + c];
									vec_344 = _mm512_set1_ps(scal_109);


									vec_343 = _mm512_fmadd_ps(vec_344, vec_310, mem_vec_946);
									mem_vec_946 = vec_343;



									vec_345 = _mm512_fmadd_ps(vec_344, vec_312, mem_vec_947);
									mem_vec_947 = vec_345;
									scal_110 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 12) + h + 1) + c];
									vec_347 = _mm512_set1_ps(scal_110);


									vec_346 = _mm512_fmadd_ps(vec_347, vec_310, mem_vec_948);
									mem_vec_948 = vec_346;



									vec_348 = _mm512_fmadd_ps(vec_347, vec_312, mem_vec_949);
									mem_vec_949 = vec_348;
									scal_111 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 13) + h + 1) + c];
									vec_350 = _mm512_set1_ps(scal_111);


									vec_349 = _mm512_fmadd_ps(vec_350, vec_310, mem_vec_950);
									mem_vec_950 = vec_349;



									vec_351 = _mm512_fmadd_ps(vec_350, vec_312, mem_vec_951);
									mem_vec_951 = vec_351;
									...
									vec_352 = _mm512_fmadd_ps(vec_353, vec_354, mem_vec_924);
									mem_vec_924 = vec_352;

									vec_356 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

									vec_355 = _mm512_fmadd_ps(vec_353, vec_356, mem_vec_925);
									mem_vec_925 = vec_355;
									scal_113 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h + 2) + c];
									vec_358 = _mm512_set1_ps(scal_113);


									vec_357 = _mm512_fmadd_ps(vec_358, vec_354, mem_vec_926);
									mem_vec_926 = vec_357;



									vec_359 = _mm512_fmadd_ps(vec_358, vec_356, mem_vec_927);
									mem_vec_927 = vec_359;
									scal_114 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h + 2) + c];
									vec_361 = _mm512_set1_ps(scal_114);


									vec_360 = _mm512_fmadd_ps(vec_361, vec_354, mem_vec_928);
									mem_vec_928 = vec_360;



									vec_362 = _mm512_fmadd_ps(vec_361, vec_356, mem_vec_929);
									mem_vec_929 = vec_362;
									scal_115 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h + 2) + c];
									vec_364 = _mm512_set1_ps(scal_115);


									vec_363 = _mm512_fmadd_ps(vec_364, vec_354, mem_vec_930);
									mem_vec_930 = vec_363;



									vec_365 = _mm512_fmadd_ps(vec_364, vec_356, mem_vec_931);
									mem_vec_931 = vec_365;
									scal_116 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h + 2) + c];
									vec_367 = _mm512_set1_ps(scal_116);


									vec_366 = _mm512_fmadd_ps(vec_367, vec_354, mem_vec_932);
									mem_vec_932 = vec_366;



									vec_368 = _mm512_fmadd_ps(vec_367, vec_356, mem_vec_933);
									mem_vec_933 = vec_368;
									scal_117 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h + 2) + c];
									vec_370 = _mm512_set1_ps(scal_117);


									vec_369 = _mm512_fmadd_ps(vec_370, vec_354, mem_vec_934);
									mem_vec_934 = vec_369;



									vec_371 = _mm512_fmadd_ps(vec_370, vec_356, mem_vec_935);
									mem_vec_935 = vec_371;
									scal_118 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h + 2) + c];
									vec_373 = _mm512_set1_ps(scal_118);


									vec_372 = _mm512_fmadd_ps(vec_373, vec_354, mem_vec_936);
									mem_vec_936 = vec_372;



									vec_374 = _mm512_fmadd_ps(vec_373, vec_356, mem_vec_937);
									mem_vec_937 = vec_374;
									scal_119 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h + 2) + c];
									vec_376 = _mm512_set1_ps(scal_119);


									vec_375 = _mm512_fmadd_ps(vec_376, vec_354, mem_vec_938);
									mem_vec_938 = vec_375;



									vec_377 = _mm512_fmadd_ps(vec_376, vec_356, mem_vec_939);
									mem_vec_939 = vec_377;
									scal_120 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h + 2) + c];
									vec_379 = _mm512_set1_ps(scal_120);


									vec_378 = _mm512_fmadd_ps(vec_379, vec_354, mem_vec_940);
									mem_vec_940 = vec_378;



									vec_380 = _mm512_fmadd_ps(vec_379, vec_356, mem_vec_941);
									mem_vec_941 = vec_380;
									scal_121 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 9) + h + 2) + c];
									vec_382 = _mm512_set1_ps(scal_121);


									vec_381 = _mm512_fmadd_ps(vec_382, vec_354, mem_vec_942);
									mem_vec_942 = vec_381;



									vec_383 = _mm512_fmadd_ps(vec_382, vec_356, mem_vec_943);
									mem_vec_943 = vec_383;
									scal_122 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 10) + h + 2) + c];
									vec_385 = _mm512_set1_ps(scal_122);


									vec_384 = _mm512_fmadd_ps(vec_385, vec_354, mem_vec_944);
									mem_vec_944 = vec_384;



									vec_386 = _mm512_fmadd_ps(vec_385, vec_356, mem_vec_945);
									mem_vec_945 = vec_386;
									scal_123 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 11) + h + 2) + c];
									vec_388 = _mm512_set1_ps(scal_123);


									vec_387 = _mm512_fmadd_ps(vec_388, vec_354, mem_vec_946);
									mem_vec_946 = vec_387;



									vec_389 = _mm512_fmadd_ps(vec_388, vec_356, mem_vec_947);
									mem_vec_947 = vec_389;
									scal_124 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 12) + h + 2) + c];
									vec_391 = _mm512_set1_ps(scal_124);


									vec_390 = _mm512_fmadd_ps(vec_391, vec_354, mem_vec_948);
									mem_vec_948 = vec_390;



									vec_392 = _mm512_fmadd_ps(vec_391, vec_356, mem_vec_949);
									mem_vec_949 = vec_392;
									scal_125 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 13) + h + 2) + c];
									vec_394 = _mm512_set1_ps(scal_125);


									vec_393 = _mm512_fmadd_ps(vec_394, vec_354, mem_vec_950);
									mem_vec_950 = vec_393;



									vec_395 = _mm512_fmadd_ps(vec_394, vec_356, mem_vec_951);
									mem_vec_951 = vec_395;
								}
