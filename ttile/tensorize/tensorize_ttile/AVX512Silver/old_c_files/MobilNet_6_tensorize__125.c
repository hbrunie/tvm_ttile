...
*/
IND_TYPE c, cp_0, c153_p_0, cp_1, c153, f, fp_0, f153_p_0, fp_1, f153, h, hp_0, x, xp_0, y, yp_0;
IND_TYPE y102 = 0;
IND_TYPE x102 = 0;
IND_TYPE h73 = 0;
IND_TYPE w = 0;
...
xp_0 = 0;
					for (h = h73, hp_0 = 0;h < h73 + 3;h += 1, hp_0 += 1){
								...
								mem_vec_1121 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_1122 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								mem_vec_1123 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								...
								mem_vec_1126 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_1126);
					}
}
