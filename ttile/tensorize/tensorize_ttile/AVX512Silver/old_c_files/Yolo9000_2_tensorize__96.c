...
[V f; U (4, f); U (2, y); U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, c); T (1, x); T (1, y); T (17, y); T (272, x); T (8, y)]
*/
IND_TYPE c, cp_0, c117_p_0, cp_1, c117, w, wp_0, x, xp_0, x156_p_0, x157_p_0, xp_1, x156_p_1, xp_2, x156, x157, y, yp_0, y156_p_0, y157_p_0, yp_1, y156_p_1, yp_2, y156, y157;
IND_TYPE y158 = 0;
IND_TYPE x158 = 0;
IND_TYPE h = 0;
IND_TYPE w78 = 0;
						...
						for (w = w78, wp_0 = 0;w < w78 + 3;w += 1, wp_0 += 1){
							...
							for (x = x156, xp_2 = x156_p_1, xp_1 = x156_p_0, xp_0 = 0;x < x156 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c117, cp_1 = c117_p_0, cp_0 = 0;c < c117 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_312);
											mem_vec_312 = vec_14;
											vec_18 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_313);
											mem_vec_313 = vec_17;
											vec_20 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 32]);
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_314);
											mem_vec_314 = vec_19;
											vec_22 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_315);
											mem_vec_315 = vec_21;
											scal_3 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
											vec_24 = _mm512_set1_ps(scal_3);
											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_316);
											mem_vec_316 = vec_23;
											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_317);
											mem_vec_317 = vec_25;
											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_318);
											mem_vec_318 = vec_26;
											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_319);
											mem_vec_319 = vec_27;
											scal_4 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
											vec_29 = _mm512_set1_ps(scal_4);
											vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_312);
											mem_vec_312 = vec_28;
											vec_32 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_313);
											mem_vec_313 = vec_31;
											vec_34 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 32]);
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_314);
											mem_vec_314 = vec_33;
											vec_36 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_315);
											mem_vec_315 = vec_35;
											scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
											vec_38 = _mm512_set1_ps(scal_5);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_316);
											mem_vec_316 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_317);
											mem_vec_317 = vec_39;
											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_318);
											mem_vec_318 = vec_40;
											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_319);
											mem_vec_319 = vec_41;
										}
