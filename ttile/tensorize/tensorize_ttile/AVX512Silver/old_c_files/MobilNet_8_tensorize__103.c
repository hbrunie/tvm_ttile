...
[V f; U (1, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (32, f); T (2, c); T (1, y); T (8, c)]
*/
IND_TYPE c, cp_0, c400_p_0, c401_p_0, cp_1, c400_p_1, cp_2, c400, c401, f, fp_0, h, hp_0, x, xp_0, y, yp_0;
IND_TYPE y152 = 0;
IND_TYPE x230 = 0;
IND_TYPE h172 = 0;
IND_TYPE w = 0;
...
fp_0 = 0;
				for (h = h172, hp_0 = 0;h < h172 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 7) (7 / 1)
					for (x = x230, xp_0 = 0;x < x230 + 7;x += 1, xp_0 += 1){
								mem_vec_1813 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
								mem_vec_1814 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_1815 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								mem_vec_1816 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								mem_vec_1817 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_1813);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_1814);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_1815);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_1816);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_1817);
