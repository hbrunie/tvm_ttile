...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  ...
  T (1, f); T (8, f)]
*/
IND_TYPE c, cp_0, c582_p_0, cp_1, c582, f, fp_0, f548_p_0, f549_p_0, fp_1, f548_p_1, fp_2, f548, f549, x, xp_0, x653_p_0, xp_1, x653, y, yp_0;
...
for (f549 = f550, f549_p_0 = 0;
	...
	for (f548 = f549, f548_p_1 = f549_p_0, f548_p_0 = 0;
		f548 < f549 + 16;
		f548 += 16, f548_p_1 += 16, f548_p_0 += 16){
		// y = 56, x = 56, h = 3, w = 3, c = 128, f = 16
		// T (x, 56) (56 / 1)
				...
				for (y = y426, yp_0 = 0;
					...
					for (f = f548, fp_2 = f548_p_1, fp_1 = f548_p_0, fp_0 = 0;
						...
						for (c582 = c583, c582_p_0 = 0;
							...
							// T (x, 1) (1 / 1)
							for (x = x653, xp_1 = x653_p_0, xp_0 = 0;
								x < x653 + 1;
								x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_3710 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
										mem_vec_3711 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_3712 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_3713 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 16
										// T (c, 32) (32 / 1)
							...
							for (x = x653, xp_1 = x653_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c582, cp_1 = c582_p_0, cp_0 = 0;
											...
											vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_3720);
											mem_vec_3720 = vec_13;
											scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
											vec_16 = _mm512_set1_ps(scal_7);


											vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_3721);
											mem_vec_3721 = vec_15;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h) + c];
											vec_18 = _mm512_set1_ps(scal_8);


											vec_17 = _mm512_fmadd_ps(vec_18, vec_2, mem_vec_3722);
											mem_vec_3722 = vec_17;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h) + c];
											vec_20 = _mm512_set1_ps(scal_9);


											vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_3723);
											mem_vec_3723 = vec_19;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
											vec_22 = _mm512_set1_ps(scal_10);


											vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_3724);
											mem_vec_3724 = vec_21;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
											vec_24 = _mm512_set1_ps(scal_11);


											vec_23 = _mm512_fmadd_ps(vec_24, vec_2, mem_vec_3725);
											mem_vec_3725 = vec_23;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
											vec_26 = _mm512_set1_ps(scal_12);


											vec_25 = _mm512_fmadd_ps(vec_26, vec_2, mem_vec_3726);
											mem_vec_3726 = vec_25;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
											vec_28 = _mm512_set1_ps(scal_13);


											vec_27 = _mm512_fmadd_ps(vec_28, vec_2, mem_vec_3727);
											mem_vec_3727 = vec_27;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
											vec_30 = _mm512_set1_ps(scal_14);
											vec_31 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

											vec_29 = _mm512_fmadd_ps(vec_30, vec_31, mem_vec_3714);
											mem_vec_3714 = vec_29;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_33 = _mm512_set1_ps(scal_15);


											vec_32 = _mm512_fmadd_ps(vec_33, vec_31, mem_vec_3715);
											mem_vec_3715 = vec_32;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_35 = _mm512_set1_ps(scal_16);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_3716);
											mem_vec_3716 = vec_34;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_37 = _mm512_set1_ps(scal_17);


											vec_36 = _mm512_fmadd_ps(vec_37, vec_31, mem_vec_3717);
											mem_vec_3717 = vec_36;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_39 = _mm512_set1_ps(scal_18);


											vec_38 = _mm512_fmadd_ps(vec_39, vec_31, mem_vec_3718);
											mem_vec_3718 = vec_38;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_19);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_3719);
											mem_vec_3719 = vec_40;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_43 = _mm512_set1_ps(scal_20);


											vec_42 = _mm512_fmadd_ps(vec_43, vec_31, mem_vec_3720);
											mem_vec_3720 = vec_42;
											scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
											vec_45 = _mm512_set1_ps(scal_21);


											vec_44 = _mm512_fmadd_ps(vec_45, vec_31, mem_vec_3721);
											mem_vec_3721 = vec_44;
											scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
											vec_47 = _mm512_set1_ps(scal_22);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_3722);
											mem_vec_3722 = vec_46;
											scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
											vec_49 = _mm512_set1_ps(scal_23);


											vec_48 = _mm512_fmadd_ps(vec_49, vec_31, mem_vec_3723);
											mem_vec_3723 = vec_48;
											scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
											vec_51 = _mm512_set1_ps(scal_24);


											vec_50 = _mm512_fmadd_ps(vec_51, vec_31, mem_vec_3724);
											mem_vec_3724 = vec_50;
											scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
											vec_53 = _mm512_set1_ps(scal_25);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_3725);
											mem_vec_3725 = vec_52;
											scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
											vec_55 = _mm512_set1_ps(scal_26);


											vec_54 = _mm512_fmadd_ps(vec_55, vec_31, mem_vec_3726);
											mem_vec_3726 = vec_54;
											scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 1) + c];
											vec_57 = _mm512_set1_ps(scal_27);


											vec_56 = _mm512_fmadd_ps(vec_57, vec_31, mem_vec_3727);
											mem_vec_3727 = vec_56;
											scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_59 = _mm512_set1_ps(scal_28);
											vec_60 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_58 = _mm512_fmadd_ps(vec_59, vec_60, mem_vec_3714);
											mem_vec_3714 = vec_58;
											scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_62 = _mm512_set1_ps(scal_29);


											vec_61 = _mm512_fmadd_ps(vec_62, vec_60, mem_vec_3715);
											mem_vec_3715 = vec_61;
											scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_64 = _mm512_set1_ps(scal_30);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_3716);
											mem_vec_3716 = vec_63;
											scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_66 = _mm512_set1_ps(scal_31);


											vec_65 = _mm512_fmadd_ps(vec_66, vec_60, mem_vec_3717);
											mem_vec_3717 = vec_65;
											scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_68 = _mm512_set1_ps(scal_32);


											vec_67 = _mm512_fmadd_ps(vec_68, vec_60, mem_vec_3718);
											mem_vec_3718 = vec_67;
											scal_33 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_70 = _mm512_set1_ps(scal_33);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_60, mem_vec_3719);
											mem_vec_3719 = vec_69;
											scal_34 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_72 = _mm512_set1_ps(scal_34);


											vec_71 = _mm512_fmadd_ps(vec_72, vec_60, mem_vec_3720);
											mem_vec_3720 = vec_71;
											scal_35 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
											vec_74 = _mm512_set1_ps(scal_35);


											vec_73 = _mm512_fmadd_ps(vec_74, vec_60, mem_vec_3721);
											mem_vec_3721 = vec_73;
											scal_36 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
											vec_76 = _mm512_set1_ps(scal_36);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_60, mem_vec_3722);
											mem_vec_3722 = vec_75;
											scal_37 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
											vec_78 = _mm512_set1_ps(scal_37);


											vec_77 = _mm512_fmadd_ps(vec_78, vec_60, mem_vec_3723);
											mem_vec_3723 = vec_77;
											scal_38 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
											vec_80 = _mm512_set1_ps(scal_38);


											vec_79 = _mm512_fmadd_ps(vec_80, vec_60, mem_vec_3724);
											mem_vec_3724 = vec_79;
											scal_39 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 2) + c];
											vec_82 = _mm512_set1_ps(scal_39);


											vec_81 = _mm512_fmadd_ps(vec_82, vec_60, mem_vec_3725);
											mem_vec_3725 = vec_81;
											scal_40 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 2) + c];
											vec_84 = _mm512_set1_ps(scal_40);


											vec_83 = _mm512_fmadd_ps(vec_84, vec_60, mem_vec_3726);
											mem_vec_3726 = vec_83;
											scal_41 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 2) + c];
											vec_86 = _mm512_set1_ps(scal_41);


											vec_85 = _mm512_fmadd_ps(vec_86, vec_60, mem_vec_3727);
											mem_vec_3727 = vec_85;
											scal_42 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
											vec_88 = _mm512_set1_ps(scal_42);
											vec_89 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

											vec_87 = _mm512_fmadd_ps(vec_88, vec_89, mem_vec_3714);
											mem_vec_3714 = vec_87;
											scal_43 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_91 = _mm512_set1_ps(scal_43);


											vec_90 = _mm512_fmadd_ps(vec_91, vec_89, mem_vec_3715);
											mem_vec_3715 = vec_90;
											scal_44 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_93 = _mm512_set1_ps(scal_44);


											vec_92 = _mm512_fmadd_ps(vec_93, vec_89, mem_vec_3716);
											mem_vec_3716 = vec_92;
											scal_45 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_95 = _mm512_set1_ps(scal_45);


											vec_94 = _mm512_fmadd_ps(vec_95, vec_89, mem_vec_3717);
											mem_vec_3717 = vec_94;
											scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_97 = _mm512_set1_ps(scal_46);


											vec_96 = _mm512_fmadd_ps(vec_97, vec_89, mem_vec_3718);
											mem_vec_3718 = vec_96;
											scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_99 = _mm512_set1_ps(scal_47);


											vec_98 = _mm512_fmadd_ps(vec_99, vec_89, mem_vec_3719);
											mem_vec_3719 = vec_98;
											scal_48 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_101 = _mm512_set1_ps(scal_48);


											vec_100 = _mm512_fmadd_ps(vec_101, vec_89, mem_vec_3720);
											mem_vec_3720 = vec_100;
											scal_49 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_103 = _mm512_set1_ps(scal_49);


											vec_102 = _mm512_fmadd_ps(vec_103, vec_89, mem_vec_3721);
											mem_vec_3721 = vec_102;
											scal_50 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
											vec_105 = _mm512_set1_ps(scal_50);


											vec_104 = _mm512_fmadd_ps(vec_105, vec_89, mem_vec_3722);
											mem_vec_3722 = vec_104;
											scal_51 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
											vec_107 = _mm512_set1_ps(scal_51);


											vec_106 = _mm512_fmadd_ps(vec_107, vec_89, mem_vec_3723);
											mem_vec_3723 = vec_106;
											scal_52 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
											vec_109 = _mm512_set1_ps(scal_52);


											vec_108 = _mm512_fmadd_ps(vec_109, vec_89, mem_vec_3724);
											mem_vec_3724 = vec_108;
											scal_53 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h) + c];
											vec_111 = _mm512_set1_ps(scal_53);


											vec_110 = _mm512_fmadd_ps(vec_111, vec_89, mem_vec_3725);
											mem_vec_3725 = vec_110;
											scal_54 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h) + c];
											vec_113 = _mm512_set1_ps(scal_54);


											vec_112 = _mm512_fmadd_ps(vec_113, vec_89, mem_vec_3726);
											mem_vec_3726 = vec_112;
											scal_55 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 13 + h) + c];
											vec_115 = _mm512_set1_ps(scal_55);


											vec_114 = _mm512_fmadd_ps(vec_115, vec_89, mem_vec_3727);
											mem_vec_3727 = vec_114;
											...
											vec_116 = _mm512_fmadd_ps(vec_117, vec_118, mem_vec_3714);
											mem_vec_3714 = vec_116;
											scal_57 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
											vec_120 = _mm512_set1_ps(scal_57);


											vec_119 = _mm512_fmadd_ps(vec_120, vec_118, mem_vec_3715);
											mem_vec_3715 = vec_119;
											scal_58 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
											vec_122 = _mm512_set1_ps(scal_58);


											vec_121 = _mm512_fmadd_ps(vec_122, vec_118, mem_vec_3716);
											mem_vec_3716 = vec_121;
											scal_59 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
											vec_124 = _mm512_set1_ps(scal_59);


											vec_123 = _mm512_fmadd_ps(vec_124, vec_118, mem_vec_3717);
											mem_vec_3717 = vec_123;
											scal_60 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
											vec_126 = _mm512_set1_ps(scal_60);


											vec_125 = _mm512_fmadd_ps(vec_126, vec_118, mem_vec_3718);
											mem_vec_3718 = vec_125;
											scal_61 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
											vec_128 = _mm512_set1_ps(scal_61);


											vec_127 = _mm512_fmadd_ps(vec_128, vec_118, mem_vec_3719);
											mem_vec_3719 = vec_127;
											scal_62 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
											vec_130 = _mm512_set1_ps(scal_62);


											vec_129 = _mm512_fmadd_ps(vec_130, vec_118, mem_vec_3720);
											mem_vec_3720 = vec_129;
											scal_63 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
											vec_132 = _mm512_set1_ps(scal_63);


											vec_131 = _mm512_fmadd_ps(vec_132, vec_118, mem_vec_3721);
											mem_vec_3721 = vec_131;
											scal_64 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 1) + c];
											vec_134 = _mm512_set1_ps(scal_64);


											vec_133 = _mm512_fmadd_ps(vec_134, vec_118, mem_vec_3722);
											mem_vec_3722 = vec_133;
											scal_65 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 1) + c];
											vec_136 = _mm512_set1_ps(scal_65);


											vec_135 = _mm512_fmadd_ps(vec_136, vec_118, mem_vec_3723);
											mem_vec_3723 = vec_135;
											scal_66 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 1) + c];
											vec_138 = _mm512_set1_ps(scal_66);


											vec_137 = _mm512_fmadd_ps(vec_138, vec_118, mem_vec_3724);
											mem_vec_3724 = vec_137;
											scal_67 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h + 1) + c];
											vec_140 = _mm512_set1_ps(scal_67);


											vec_139 = _mm512_fmadd_ps(vec_140, vec_118, mem_vec_3725);
											mem_vec_3725 = vec_139;
											scal_68 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h + 1) + c];
											vec_142 = _mm512_set1_ps(scal_68);


											vec_141 = _mm512_fmadd_ps(vec_142, vec_118, mem_vec_3726);
											mem_vec_3726 = vec_141;
											scal_69 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 13 + h + 1) + c];
											vec_144 = _mm512_set1_ps(scal_69);


											vec_143 = _mm512_fmadd_ps(vec_144, vec_118, mem_vec_3727);
											mem_vec_3727 = vec_143;
											...
											vec_145 = _mm512_fmadd_ps(vec_146, vec_147, mem_vec_3714);
											mem_vec_3714 = vec_145;
											scal_71 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
											vec_149 = _mm512_set1_ps(scal_71);


											vec_148 = _mm512_fmadd_ps(vec_149, vec_147, mem_vec_3715);
											mem_vec_3715 = vec_148;
											scal_72 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
											vec_151 = _mm512_set1_ps(scal_72);


											vec_150 = _mm512_fmadd_ps(vec_151, vec_147, mem_vec_3716);
											mem_vec_3716 = vec_150;
											scal_73 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
											vec_153 = _mm512_set1_ps(scal_73);


											vec_152 = _mm512_fmadd_ps(vec_153, vec_147, mem_vec_3717);
											mem_vec_3717 = vec_152;
											scal_74 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
											vec_155 = _mm512_set1_ps(scal_74);


											vec_154 = _mm512_fmadd_ps(vec_155, vec_147, mem_vec_3718);
											mem_vec_3718 = vec_154;
											scal_75 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
											vec_157 = _mm512_set1_ps(scal_75);


											vec_156 = _mm512_fmadd_ps(vec_157, vec_147, mem_vec_3719);
											mem_vec_3719 = vec_156;
											scal_76 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
											vec_159 = _mm512_set1_ps(scal_76);


											vec_158 = _mm512_fmadd_ps(vec_159, vec_147, mem_vec_3720);
											mem_vec_3720 = vec_158;
											scal_77 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 2) + c];
											vec_161 = _mm512_set1_ps(scal_77);


											vec_160 = _mm512_fmadd_ps(vec_161, vec_147, mem_vec_3721);
											mem_vec_3721 = vec_160;
											scal_78 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 2) + c];
											vec_163 = _mm512_set1_ps(scal_78);


											vec_162 = _mm512_fmadd_ps(vec_163, vec_147, mem_vec_3722);
											mem_vec_3722 = vec_162;
											scal_79 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 2) + c];
											vec_165 = _mm512_set1_ps(scal_79);


											vec_164 = _mm512_fmadd_ps(vec_165, vec_147, mem_vec_3723);
											mem_vec_3723 = vec_164;
											scal_80 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 2) + c];
											vec_167 = _mm512_set1_ps(scal_80);


											vec_166 = _mm512_fmadd_ps(vec_167, vec_147, mem_vec_3724);
											mem_vec_3724 = vec_166;
											scal_81 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h + 2) + c];
											vec_169 = _mm512_set1_ps(scal_81);


											vec_168 = _mm512_fmadd_ps(vec_169, vec_147, mem_vec_3725);
											mem_vec_3725 = vec_168;
											scal_82 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h + 2) + c];
											vec_171 = _mm512_set1_ps(scal_82);


											vec_170 = _mm512_fmadd_ps(vec_171, vec_147, mem_vec_3726);
											mem_vec_3726 = vec_170;
											scal_83 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 13 + h + 2) + c];
											vec_173 = _mm512_set1_ps(scal_83);


											vec_172 = _mm512_fmadd_ps(vec_173, vec_147, mem_vec_3727);
											mem_vec_3727 = vec_172;
											scal_84 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_175 = _mm512_set1_ps(scal_84);
											vec_176 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_174 = _mm512_fmadd_ps(vec_175, vec_176, mem_vec_3714);
											mem_vec_3714 = vec_174;
											scal_85 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_178 = _mm512_set1_ps(scal_85);


											vec_177 = _mm512_fmadd_ps(vec_178, vec_176, mem_vec_3715);
											mem_vec_3715 = vec_177;
											scal_86 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_180 = _mm512_set1_ps(scal_86);


											vec_179 = _mm512_fmadd_ps(vec_180, vec_176, mem_vec_3716);
											mem_vec_3716 = vec_179;
											scal_87 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_182 = _mm512_set1_ps(scal_87);


											vec_181 = _mm512_fmadd_ps(vec_182, vec_176, mem_vec_3717);
											mem_vec_3717 = vec_181;
											scal_88 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_184 = _mm512_set1_ps(scal_88);


											vec_183 = _mm512_fmadd_ps(vec_184, vec_176, mem_vec_3718);
											mem_vec_3718 = vec_183;
											scal_89 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_186 = _mm512_set1_ps(scal_89);


											vec_185 = _mm512_fmadd_ps(vec_186, vec_176, mem_vec_3719);
											mem_vec_3719 = vec_185;
											scal_90 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_188 = _mm512_set1_ps(scal_90);


											vec_187 = _mm512_fmadd_ps(vec_188, vec_176, mem_vec_3720);
											mem_vec_3720 = vec_187;
											scal_91 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_190 = _mm512_set1_ps(scal_91);


											vec_189 = _mm512_fmadd_ps(vec_190, vec_176, mem_vec_3721);
											mem_vec_3721 = vec_189;
											scal_92 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
											vec_192 = _mm512_set1_ps(scal_92);


											vec_191 = _mm512_fmadd_ps(vec_192, vec_176, mem_vec_3722);
											mem_vec_3722 = vec_191;
											scal_93 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
											vec_194 = _mm512_set1_ps(scal_93);


											vec_193 = _mm512_fmadd_ps(vec_194, vec_176, mem_vec_3723);
											mem_vec_3723 = vec_193;
											scal_94 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h) + c];
											vec_196 = _mm512_set1_ps(scal_94);


											vec_195 = _mm512_fmadd_ps(vec_196, vec_176, mem_vec_3724);
											mem_vec_3724 = vec_195;
											scal_95 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h) + c];
											vec_198 = _mm512_set1_ps(scal_95);


											vec_197 = _mm512_fmadd_ps(vec_198, vec_176, mem_vec_3725);
											mem_vec_3725 = vec_197;
											scal_96 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 12 + h) + c];
											vec_200 = _mm512_set1_ps(scal_96);


											vec_199 = _mm512_fmadd_ps(vec_200, vec_176, mem_vec_3726);
											mem_vec_3726 = vec_199;
											scal_97 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 13 + h) + c];
											vec_202 = _mm512_set1_ps(scal_97);


											vec_201 = _mm512_fmadd_ps(vec_202, vec_176, mem_vec_3727);
											mem_vec_3727 = vec_201;
											...
											vec_203 = _mm512_fmadd_ps(vec_204, vec_205, mem_vec_3714);
											mem_vec_3714 = vec_203;
											scal_99 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
											vec_207 = _mm512_set1_ps(scal_99);


											vec_206 = _mm512_fmadd_ps(vec_207, vec_205, mem_vec_3715);
											mem_vec_3715 = vec_206;
											scal_100 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
											vec_209 = _mm512_set1_ps(scal_100);


											vec_208 = _mm512_fmadd_ps(vec_209, vec_205, mem_vec_3716);
											mem_vec_3716 = vec_208;
											scal_101 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
											vec_211 = _mm512_set1_ps(scal_101);


											vec_210 = _mm512_fmadd_ps(vec_211, vec_205, mem_vec_3717);
											mem_vec_3717 = vec_210;
											scal_102 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
											vec_213 = _mm512_set1_ps(scal_102);


											vec_212 = _mm512_fmadd_ps(vec_213, vec_205, mem_vec_3718);
											mem_vec_3718 = vec_212;
											scal_103 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
											vec_215 = _mm512_set1_ps(scal_103);


											vec_214 = _mm512_fmadd_ps(vec_215, vec_205, mem_vec_3719);
											mem_vec_3719 = vec_214;
											scal_104 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
											vec_217 = _mm512_set1_ps(scal_104);


											vec_216 = _mm512_fmadd_ps(vec_217, vec_205, mem_vec_3720);
											mem_vec_3720 = vec_216;
											scal_105 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
											vec_219 = _mm512_set1_ps(scal_105);


											vec_218 = _mm512_fmadd_ps(vec_219, vec_205, mem_vec_3721);
											mem_vec_3721 = vec_218;
											scal_106 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 1) + c];
											vec_221 = _mm512_set1_ps(scal_106);


											vec_220 = _mm512_fmadd_ps(vec_221, vec_205, mem_vec_3722);
											mem_vec_3722 = vec_220;
											scal_107 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 1) + c];
											vec_223 = _mm512_set1_ps(scal_107);


											vec_222 = _mm512_fmadd_ps(vec_223, vec_205, mem_vec_3723);
											mem_vec_3723 = vec_222;
											scal_108 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 1) + c];
											vec_225 = _mm512_set1_ps(scal_108);


											vec_224 = _mm512_fmadd_ps(vec_225, vec_205, mem_vec_3724);
											mem_vec_3724 = vec_224;
											scal_109 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h + 1) + c];
											vec_227 = _mm512_set1_ps(scal_109);


											vec_226 = _mm512_fmadd_ps(vec_227, vec_205, mem_vec_3725);
											mem_vec_3725 = vec_226;
											scal_110 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 12 + h + 1) + c];
											vec_229 = _mm512_set1_ps(scal_110);


											vec_228 = _mm512_fmadd_ps(vec_229, vec_205, mem_vec_3726);
											mem_vec_3726 = vec_228;
											scal_111 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 13 + h + 1) + c];
											vec_231 = _mm512_set1_ps(scal_111);


											vec_230 = _mm512_fmadd_ps(vec_231, vec_205, mem_vec_3727);
											mem_vec_3727 = vec_230;
											...
											vec_232 = _mm512_fmadd_ps(vec_233, vec_234, mem_vec_3714);
											mem_vec_3714 = vec_232;
											scal_113 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
											vec_236 = _mm512_set1_ps(scal_113);


											vec_235 = _mm512_fmadd_ps(vec_236, vec_234, mem_vec_3715);
											mem_vec_3715 = vec_235;
											scal_114 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
											vec_238 = _mm512_set1_ps(scal_114);


											vec_237 = _mm512_fmadd_ps(vec_238, vec_234, mem_vec_3716);
											mem_vec_3716 = vec_237;
											scal_115 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
											vec_240 = _mm512_set1_ps(scal_115);


											vec_239 = _mm512_fmadd_ps(vec_240, vec_234, mem_vec_3717);
											mem_vec_3717 = vec_239;
											scal_116 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
											vec_242 = _mm512_set1_ps(scal_116);


											vec_241 = _mm512_fmadd_ps(vec_242, vec_234, mem_vec_3718);
											mem_vec_3718 = vec_241;
											scal_117 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
											vec_244 = _mm512_set1_ps(scal_117);


											vec_243 = _mm512_fmadd_ps(vec_244, vec_234, mem_vec_3719);
											mem_vec_3719 = vec_243;
											scal_118 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
											vec_246 = _mm512_set1_ps(scal_118);


											vec_245 = _mm512_fmadd_ps(vec_246, vec_234, mem_vec_3720);
											mem_vec_3720 = vec_245;
											scal_119 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
											vec_248 = _mm512_set1_ps(scal_119);


											vec_247 = _mm512_fmadd_ps(vec_248, vec_234, mem_vec_3721);
											mem_vec_3721 = vec_247;
											scal_120 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 2) + c];
											vec_250 = _mm512_set1_ps(scal_120);


											vec_249 = _mm512_fmadd_ps(vec_250, vec_234, mem_vec_3722);
											mem_vec_3722 = vec_249;
											scal_121 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 2) + c];
											vec_252 = _mm512_set1_ps(scal_121);


											vec_251 = _mm512_fmadd_ps(vec_252, vec_234, mem_vec_3723);
											mem_vec_3723 = vec_251;
											scal_122 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 2) + c];
											vec_254 = _mm512_set1_ps(scal_122);


											vec_253 = _mm512_fmadd_ps(vec_254, vec_234, mem_vec_3724);
											mem_vec_3724 = vec_253;
											scal_123 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h + 2) + c];
											vec_256 = _mm512_set1_ps(scal_123);


											vec_255 = _mm512_fmadd_ps(vec_256, vec_234, mem_vec_3725);
											mem_vec_3725 = vec_255;
											scal_124 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 12 + h + 2) + c];
											vec_258 = _mm512_set1_ps(scal_124);


											vec_257 = _mm512_fmadd_ps(vec_258, vec_234, mem_vec_3726);
											mem_vec_3726 = vec_257;
											scal_125 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 13 + h + 2) + c];
											vec_260 = _mm512_set1_ps(scal_125);


											vec_259 = _mm512_fmadd_ps(vec_260, vec_234, mem_vec_3727);
											mem_vec_3727 = vec_259;
										}
