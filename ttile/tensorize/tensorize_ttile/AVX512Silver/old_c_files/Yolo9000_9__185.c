	...
	for (x517 = x518, x517_p_0 = 0;
		...
		for (y = y387, yp_1 = y387_p_0, yp_0 = 0;
			...
			for (x516 = x517, x516_p_1 = x517_p_0, x516_p_0 = 0;
				x516 < x517 + 68;
				x516 += 68, x516_p_1 += 68, x516_p_0 += 68){
				// y = 4, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (f, 2) (128 / 64)
				for (f = f258, fp_0 = 0;
					f < f258 + 128;
					...
					for (c387 = c388, c387_p_0 = 0;
						...
						for (x = x516, xp_2 = x516_p_1, xp_1 = x516_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_4948 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_4949 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									mem_vec_4950 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32]);
									mem_vec_4951 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_4948);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_4949);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32], mem_vec_4950);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48], mem_vec_4951);
						}
					}
				}
			}
