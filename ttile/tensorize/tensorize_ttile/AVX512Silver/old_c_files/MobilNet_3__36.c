...
for (x417 = x418, x417_p_0 = 0;
	...
	for (y = y272, yp_0 = 0;
		...
		for (x416 = x417, x416_p_1 = x417_p_0, x416_p_0 = 0;
			x416 < x417 + 28;
			x416 += 28, x416_p_1 += 28, x416_p_0 += 28){
			// y = 7, x = 28, h = 3, w = 3, c = 128, f = 128
			// T (f, 4) (128 / 32)
			for (f = f308, fp_0 = 0;
				f < f308 + 128;
						...
						for (x = x416, xp_2 = x416_p_1, xp_1 = x416_p_0, xp_0 = 0;
							...
							for (h = h170, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										mem_vec_2271 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_2272 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_2273 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
										mem_vec_2274 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
										mem_vec_2275 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_2271);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_2272);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_2273);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_2274);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_2275);
