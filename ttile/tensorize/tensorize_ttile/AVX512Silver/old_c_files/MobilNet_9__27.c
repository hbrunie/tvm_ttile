...
[V f; U (4, f); U (7, y); U (3, h); T (16, c); Hoist_vars [c]; T (3, w);
  T (7, x); T (8, c); T (1, y); T (1, f); T (8, c); T (16, f)]
*/
IND_TYPE c, cp_0, c780_p_0, c781_p_0, cp_1, c780_p_1, cp_2, c780, c781, f, fp_0, f585_p_0, fp_1, f585, w, wp_0, x, xp_0, y, yp_0;
		...
		for (f = f585, fp_1 = f585_p_0, fp_0 = 0;
			...
			for (y = y284, yp_0 = 0;
				...
				for (c780 = c781, c780_p_1 = c781_p_0, c780_p_0 = 0;
					c780 < c781 + 128;
					c780 += 16, c780_p_1 += 16, c780_p_0 += 16){
