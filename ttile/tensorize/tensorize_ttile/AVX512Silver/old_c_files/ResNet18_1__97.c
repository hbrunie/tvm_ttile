...
for (y195 = y196, y195_p_0 = 0;
	...
	for (f = f119, fp_0 = 0;
		...
		f += 32, fp_0 += 32){
			...
			for (y = y195 + 8, yp_1 = y195_p_0, yp_0 = 0;
				y < y195 + 8 + 104;
							...
							for (c195 = c196, c195_p_0 = 0;
								...
								for (x = x184, xp_1 = x184_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2128 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_2129 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 3, f = 32
											// T (c, 3) (3 / 1)
											for (c = c195, cp_1 = c195_p_0, cp_0 = 0;
												c < c195 + 3;
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2128);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_2129);
								}
							}
						}
					}
