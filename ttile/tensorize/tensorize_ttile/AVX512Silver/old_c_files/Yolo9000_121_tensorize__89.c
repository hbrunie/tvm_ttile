...
c180_p_0 = 0;
							for (h = h112, hp_0 = 0;h < h112 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 34) (34 / 1)
								for (x = x176, xp_1 = x176_p_0, xp_0 = 0;x < x176 + 34;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_1886 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
											mem_vec_1887 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
											...
											mem_vec_1890 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
											mem_vec_1891 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_1886);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_1887);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_1890);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_1891);
								}
							}
}
