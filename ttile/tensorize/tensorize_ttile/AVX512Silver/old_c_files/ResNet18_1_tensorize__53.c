...
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (14, x); T (1, c);
  T (7, w); T (7, h); T (8, x); T (7, y); T (2, f); T (2, y)]
*/
IND_TYPE c, cp_0, c438_p_0, cp_1, c438, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x427_p_0, xp_1, x427, y, yp_0, y438_p_0, yp_1, y438;
IND_TYPE y439 = 0;
IND_TYPE x428 = 0;
IND_TYPE h292 = 0;
IND_TYPE w292 = 0;
...
x427 = 0;
x427_p_0 = 0;
				for (h = h292, hp_0 = 0;h < h292 + 7;h += 1, hp_0 += 1){
					// y = 8, x = 14, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w292, wp_0 = 0;w < w292 + 7;w += 1, wp_0 += 1){
						// y = 8, x = 14, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c438 = c439, c438_p_0 = 0;c438 < c439 + 3;c438 += 3, c438_p_0 += 3){
							// y = 8, x = 14, h = 1, w = 1, c = 3, f = 32
							// T (x, 14) (14 / 1)
							for (x = x427, xp_1 = x427_p_0, xp_0 = 0;x < x427 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c438, cp_1 = c438_p_0, cp_0 = 0;c < c438 + 3;c += 1, cp_1 += 1, cp_0 += 1){
