...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (1, x); T (2, f); T (1, x); T (2, y); T (34, y); T (544, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x96_p_0, x97_p_0, xp_1, x96_p_1, xp_2, x96, x97, y, yp_0, y90_p_0, y91_p_0, yp_1, y90_p_1, yp_2, y90, y91;
...
for (y91 = y92, y91_p_0 = 0;
	...
	for (x97 = x98, x97_p_0 = 0;
		...
		// T (y, 34) (272 / 8)
		for (y90 = y91, y90_p_1 = y91_p_0, y90_p_0 = 0;
			y90 < y91 + 272;
			y90 += 8, y90_p_1 += 8, y90_p_0 += 8){
			// y = 8, x = 1, h = 3, w = 3, c = 3, f = 32
			// T (y, 2) (8 / 4)
			for (y = y90, yp_2 = y90_p_1, yp_1 = y90_p_0, yp_0 = 0;
				y < y90 + 8;
					...
					for (f = f42, fp_0 = 0;
						...
						for (x = x96, xp_2 = x96_p_1, xp_1 = x96_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_193 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_194 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									...
									for (c = c54, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_193);
										mem_vec_193 = vec_3;
