								...
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;
									...
									for (h = h0, hp_0 = 0;
										...
										h += 1, hp_0 += 1){
												...
												mem_vec_38 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
												mem_vec_39 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
												mem_vec_40 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
												mem_vec_41 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
												mem_vec_42 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
												mem_vec_43 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
												mem_vec_44 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
												mem_vec_45 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 32
												// T (c, 16) (16 / 1)
												for (c = c0, cp_1 = c0_p_0, cp_0 = 0;
													c < c0 + 16;
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_38);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_39);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_40);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_41);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_42);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_43);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_44);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_45);
									}
								}
							}
						}
