...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (14, x); T (4, c); T (1, f); T (14, y); T (4, x); T (8, f); T (1, f)]
*/
IND_TYPE c, cp_0, c228_p_0, cp_1, c228, f, fp_0, f182_p_0, f183_p_0, fp_1, f182_p_1, fp_2, f182, f183, x, xp_0, x258_p_0, xp_1, x258, y, yp_0;
...
for (f183 = f184, f183_p_0 = 0;
	...
	for (f182 = f183, f182_p_1 = f183_p_0, f182_p_0 = 0;
		f182 < f183 + 128;
		f182 += 16, f182_p_1 += 16, f182_p_0 += 16){
					...
					for (c228 = c229, c228_p_0 = 0;
						...
						for (x = x258, xp_1 = x258_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1369 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1370 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									...
									for (c = c228, cp_1 = c228_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1369);
										mem_vec_1369 = vec_3;
