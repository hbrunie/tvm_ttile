	...
	for (x30 = x31, x30_p_0 = 0;
		...
		for (f = f17, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				...
				for (y = y30 + 66, yp_1 = y30_p_0, yp_0 = 0;
					y < y30 + 66 + 70;
					...
					for (x = x30, xp_1 = x30_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_375 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
								mem_vec_376 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_377 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
								mem_vec_378 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_379 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
								mem_vec_380 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								mem_vec_381 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c23, cp_0 = 0;
									c < c23 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_375);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_376);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_377);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_378);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_379);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_380);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_381);
					}
				}
		}
	}
