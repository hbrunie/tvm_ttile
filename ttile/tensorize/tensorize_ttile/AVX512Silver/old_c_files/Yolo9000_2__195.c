...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, c); T (1, x); T (17, y); T (1, y); T (272, x); T (4, y)]
*/
IND_TYPE c, cp_0, c396_p_0, cp_1, c396, h, hp_0, x, xp_0, x528_p_0, x529_p_0, xp_1, x528_p_1, xp_2, x528, x529, y, yp_0, y522_p_0, y523_p_0, yp_1, y522_p_1, yp_2, y522, y523;
...
for (y523 = y524, y523_p_0 = 0;
	...
	for (x529 = x530, x529_p_0 = 0;
		...
		// T (y, 1) (68 / 68)
		for (y522 = y523, y522_p_1 = y523_p_0, y522_p_0 = 0;
			y522 < y523 + 68;
			y522 += 68, y522_p_1 += 68, y522_p_0 += 68){
			// y = 68, x = 1, h = 3, w = 3, c = 32, f = 64
			// T (y, 17) (68 / 4)
			for (y = y522, yp_2 = y522_p_1, yp_1 = y522_p_0, yp_0 = 0;
				y < y522 + 68;
