...
[V f; U (1, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  T (1, c); T (3, h); T (28, y); T (1, x); T (2, f); T (56, x)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, f, fp_0, h, hp_0, x, x0, xp_0, x0_p_0, x1_p_0, x1, xp_1, x0_p_1, xp_2, y, yp_0;
IND_TYPE y0 = 0;
IND_TYPE x2 = 0;
IND_TYPE h0 = 0;
IND_TYPE w = 0;
...
__m512 mem_vec_0 ,mem_vec_1 ,mem_vec_2 ,mem_vec_3 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_3 ,vec_4 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
...
yp_0 = 0;
				for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (32 / 32)
					for (c0 = c1, c0_p_0 = 0;c0 < c1 + 32;c0 += 32, c0_p_0 += 32){
						// y = 4, x = 2, h = 1, w = 3, c = 32, f = 16
						// T (x, 2) (2 / 1)
						for (x = x0, xp_2 = x0_p_1, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_9 = _mm512_fmadd_ps(vec_10, vec_11, mem_vec_0);
										mem_vec_0 = vec_9;
										scal_5 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
										vec_13 = _mm512_set1_ps(scal_5);
										vec_12 = _mm512_fmadd_ps(vec_13, vec_11, mem_vec_1);
										mem_vec_1 = vec_12;
										scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
										vec_15 = _mm512_set1_ps(scal_6);
										vec_14 = _mm512_fmadd_ps(vec_15, vec_11, mem_vec_2);
										mem_vec_2 = vec_14;
										scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
										vec_17 = _mm512_set1_ps(scal_7);
										vec_16 = _mm512_fmadd_ps(vec_17, vec_11, mem_vec_3);
										mem_vec_3 = vec_16;
										scal_8 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
										vec_19 = _mm512_set1_ps(scal_8);
										vec_20 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_18 = _mm512_fmadd_ps(vec_19, vec_20, mem_vec_0);
										mem_vec_0 = vec_18;
										scal_9 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
										vec_22 = _mm512_set1_ps(scal_9);
										vec_21 = _mm512_fmadd_ps(vec_22, vec_20, mem_vec_1);
										mem_vec_1 = vec_21;
										scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
										vec_24 = _mm512_set1_ps(scal_10);
										vec_23 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_2);
										mem_vec_2 = vec_23;
										scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
										vec_26 = _mm512_set1_ps(scal_11);
										vec_25 = _mm512_fmadd_ps(vec_26, vec_20, mem_vec_3);
										mem_vec_3 = vec_25;
									}
