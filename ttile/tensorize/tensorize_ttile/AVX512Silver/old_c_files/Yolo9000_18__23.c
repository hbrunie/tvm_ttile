...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  ...
  T (8, c); T (1, f)]
*/
IND_TYPE c, cp_0, c364_p_0, c365_p_0, cp_1, c364_p_1, cp_2, c364, c365, f, fp_0, f273_p_0, fp_1, f273, x, xp_0, y, yp_0;
			...
			f += 16, fp_1 += 16, fp_0 += 16){
				for (y = y182, yp_0 = 0;
					...
					for (c364 = c365, c364_p_1 = c365_p_0, c364_p_0 = 0;
						c364 < c365 + 64;
						c364 += 16, c364_p_1 += 16, c364_p_0 += 16){
						...
						for (x = x182, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_1805 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1806 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_1807 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c364, cp_2 = c364_p_1, cp_1 = c364_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1805);
										mem_vec_1805 = vec_3;
					...
					for (c364 = c365, c364_p_1 = c365_p_0, c364_p_0 = 0;
						...
						for (x = x182, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_1809 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1810 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_1811 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_1812 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
									mem_vec_1813 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									mem_vec_1814 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_1815 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_1816 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_1817 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_1818 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_1819 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_1820 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									// y = ph_y, x = 1, h = 3, w = 3, c = 16, f = 16
									// T (c, 16) (16 / 1)
									for (c = c364, cp_2 = c364_p_1, cp_1 = c364_p_0, cp_0 = 0;
										c < c364 + 16;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1809);
										mem_vec_1809 = vec_3;
										scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
										vec_6 = _mm512_set1_ps(scal_2);
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_1811);
										mem_vec_1811 = vec_7;
										...
										vec_11 = _mm512_fmadd_ps(vec_12, vec_2, mem_vec_1813);
										mem_vec_1813 = vec_11;
										scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
										vec_14 = _mm512_set1_ps(scal_6);


										vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_1814);
										mem_vec_1814 = vec_13;
										scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
										vec_16 = _mm512_set1_ps(scal_7);


										vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_1815);
										mem_vec_1815 = vec_15;
										...
										vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_1817);
										mem_vec_1817 = vec_19;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
										vec_22 = _mm512_set1_ps(scal_10);


										vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_1818);
										mem_vec_1818 = vec_21;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
										vec_24 = _mm512_set1_ps(scal_11);


										vec_23 = _mm512_fmadd_ps(vec_24, vec_2, mem_vec_1819);
										mem_vec_1819 = vec_23;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
										vec_26 = _mm512_set1_ps(scal_12);


										vec_25 = _mm512_fmadd_ps(vec_26, vec_2, mem_vec_1820);
										mem_vec_1820 = vec_25;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
										vec_28 = _mm512_set1_ps(scal_13);
										vec_29 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

										vec_27 = _mm512_fmadd_ps(vec_28, vec_29, mem_vec_1808);
										mem_vec_1808 = vec_27;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_31 = _mm512_set1_ps(scal_14);


										vec_30 = _mm512_fmadd_ps(vec_31, vec_29, mem_vec_1809);
										mem_vec_1809 = vec_30;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_33 = _mm512_set1_ps(scal_15);


										vec_32 = _mm512_fmadd_ps(vec_33, vec_29, mem_vec_1810);
										mem_vec_1810 = vec_32;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_16);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_29, mem_vec_1811);
										mem_vec_1811 = vec_34;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_37 = _mm512_set1_ps(scal_17);


										vec_36 = _mm512_fmadd_ps(vec_37, vec_29, mem_vec_1812);
										mem_vec_1812 = vec_36;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_39 = _mm512_set1_ps(scal_18);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_29, mem_vec_1813);
										mem_vec_1813 = vec_38;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_19);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_29, mem_vec_1814);
										mem_vec_1814 = vec_40;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_43 = _mm512_set1_ps(scal_20);


										vec_42 = _mm512_fmadd_ps(vec_43, vec_29, mem_vec_1815);
										mem_vec_1815 = vec_42;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
										vec_45 = _mm512_set1_ps(scal_21);


										vec_44 = _mm512_fmadd_ps(vec_45, vec_29, mem_vec_1816);
										mem_vec_1816 = vec_44;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_22);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_29, mem_vec_1817);
										mem_vec_1817 = vec_46;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
										vec_49 = _mm512_set1_ps(scal_23);


										vec_48 = _mm512_fmadd_ps(vec_49, vec_29, mem_vec_1818);
										mem_vec_1818 = vec_48;
										scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
										vec_51 = _mm512_set1_ps(scal_24);


										vec_50 = _mm512_fmadd_ps(vec_51, vec_29, mem_vec_1819);
										mem_vec_1819 = vec_50;
										scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
										vec_53 = _mm512_set1_ps(scal_25);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_29, mem_vec_1820);
										mem_vec_1820 = vec_52;
										scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_55 = _mm512_set1_ps(scal_26);
										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_54 = _mm512_fmadd_ps(vec_55, vec_56, mem_vec_1808);
										mem_vec_1808 = vec_54;
										scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_27);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_1809);
										mem_vec_1809 = vec_57;
										scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_60 = _mm512_set1_ps(scal_28);


										vec_59 = _mm512_fmadd_ps(vec_60, vec_56, mem_vec_1810);
										mem_vec_1810 = vec_59;
										scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_62 = _mm512_set1_ps(scal_29);


										vec_61 = _mm512_fmadd_ps(vec_62, vec_56, mem_vec_1811);
										mem_vec_1811 = vec_61;
										scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_30);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_1812);
										mem_vec_1812 = vec_63;
										scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_66 = _mm512_set1_ps(scal_31);


										vec_65 = _mm512_fmadd_ps(vec_66, vec_56, mem_vec_1813);
										mem_vec_1813 = vec_65;
										scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_68 = _mm512_set1_ps(scal_32);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_1814);
										mem_vec_1814 = vec_67;
										scal_33 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_70 = _mm512_set1_ps(scal_33);


										vec_69 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_1815);
										mem_vec_1815 = vec_69;
										scal_34 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
										vec_72 = _mm512_set1_ps(scal_34);


										vec_71 = _mm512_fmadd_ps(vec_72, vec_56, mem_vec_1816);
										mem_vec_1816 = vec_71;
										scal_35 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
										vec_74 = _mm512_set1_ps(scal_35);


										vec_73 = _mm512_fmadd_ps(vec_74, vec_56, mem_vec_1817);
										mem_vec_1817 = vec_73;
										scal_36 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
										vec_76 = _mm512_set1_ps(scal_36);


										vec_75 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_1818);
										mem_vec_1818 = vec_75;
										scal_37 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 2) + c];
										vec_78 = _mm512_set1_ps(scal_37);


										vec_77 = _mm512_fmadd_ps(vec_78, vec_56, mem_vec_1819);
										mem_vec_1819 = vec_77;
										scal_38 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 2) + c];
										vec_80 = _mm512_set1_ps(scal_38);


										vec_79 = _mm512_fmadd_ps(vec_80, vec_56, mem_vec_1820);
										mem_vec_1820 = vec_79;
										scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
										vec_82 = _mm512_set1_ps(scal_39);
										vec_83 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

										vec_81 = _mm512_fmadd_ps(vec_82, vec_83, mem_vec_1808);
										mem_vec_1808 = vec_81;
										scal_40 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_85 = _mm512_set1_ps(scal_40);


										vec_84 = _mm512_fmadd_ps(vec_85, vec_83, mem_vec_1809);
										mem_vec_1809 = vec_84;
										scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_87 = _mm512_set1_ps(scal_41);


										vec_86 = _mm512_fmadd_ps(vec_87, vec_83, mem_vec_1810);
										mem_vec_1810 = vec_86;
										scal_42 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_89 = _mm512_set1_ps(scal_42);


										vec_88 = _mm512_fmadd_ps(vec_89, vec_83, mem_vec_1811);
										mem_vec_1811 = vec_88;
										scal_43 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
										vec_91 = _mm512_set1_ps(scal_43);


										vec_90 = _mm512_fmadd_ps(vec_91, vec_83, mem_vec_1812);
										mem_vec_1812 = vec_90;
										scal_44 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
										vec_93 = _mm512_set1_ps(scal_44);


										vec_92 = _mm512_fmadd_ps(vec_93, vec_83, mem_vec_1813);
										mem_vec_1813 = vec_92;
										scal_45 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
										vec_95 = _mm512_set1_ps(scal_45);


										vec_94 = _mm512_fmadd_ps(vec_95, vec_83, mem_vec_1814);
										mem_vec_1814 = vec_94;
										scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
										vec_97 = _mm512_set1_ps(scal_46);


										vec_96 = _mm512_fmadd_ps(vec_97, vec_83, mem_vec_1815);
										mem_vec_1815 = vec_96;
										scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
										vec_99 = _mm512_set1_ps(scal_47);


										vec_98 = _mm512_fmadd_ps(vec_99, vec_83, mem_vec_1816);
										mem_vec_1816 = vec_98;
										scal_48 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
										vec_101 = _mm512_set1_ps(scal_48);


										vec_100 = _mm512_fmadd_ps(vec_101, vec_83, mem_vec_1817);
										mem_vec_1817 = vec_100;
										scal_49 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
										vec_103 = _mm512_set1_ps(scal_49);


										vec_102 = _mm512_fmadd_ps(vec_103, vec_83, mem_vec_1818);
										mem_vec_1818 = vec_102;
										scal_50 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h) + c];
										vec_105 = _mm512_set1_ps(scal_50);


										vec_104 = _mm512_fmadd_ps(vec_105, vec_83, mem_vec_1819);
										mem_vec_1819 = vec_104;
										scal_51 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h) + c];
										vec_107 = _mm512_set1_ps(scal_51);


										vec_106 = _mm512_fmadd_ps(vec_107, vec_83, mem_vec_1820);
										mem_vec_1820 = vec_106;
										...
										vec_108 = _mm512_fmadd_ps(vec_109, vec_110, mem_vec_1808);
										mem_vec_1808 = vec_108;
										scal_53 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
										vec_112 = _mm512_set1_ps(scal_53);


										vec_111 = _mm512_fmadd_ps(vec_112, vec_110, mem_vec_1809);
										mem_vec_1809 = vec_111;
										scal_54 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
										vec_114 = _mm512_set1_ps(scal_54);


										vec_113 = _mm512_fmadd_ps(vec_114, vec_110, mem_vec_1810);
										mem_vec_1810 = vec_113;
										scal_55 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
										vec_116 = _mm512_set1_ps(scal_55);


										vec_115 = _mm512_fmadd_ps(vec_116, vec_110, mem_vec_1811);
										mem_vec_1811 = vec_115;
										scal_56 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
										vec_118 = _mm512_set1_ps(scal_56);


										vec_117 = _mm512_fmadd_ps(vec_118, vec_110, mem_vec_1812);
										mem_vec_1812 = vec_117;
										scal_57 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
										vec_120 = _mm512_set1_ps(scal_57);


										vec_119 = _mm512_fmadd_ps(vec_120, vec_110, mem_vec_1813);
										mem_vec_1813 = vec_119;
										scal_58 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
										vec_122 = _mm512_set1_ps(scal_58);


										vec_121 = _mm512_fmadd_ps(vec_122, vec_110, mem_vec_1814);
										mem_vec_1814 = vec_121;
										scal_59 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
										vec_124 = _mm512_set1_ps(scal_59);


										vec_123 = _mm512_fmadd_ps(vec_124, vec_110, mem_vec_1815);
										mem_vec_1815 = vec_123;
										scal_60 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 1) + c];
										vec_126 = _mm512_set1_ps(scal_60);


										vec_125 = _mm512_fmadd_ps(vec_126, vec_110, mem_vec_1816);
										mem_vec_1816 = vec_125;
										scal_61 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 1) + c];
										vec_128 = _mm512_set1_ps(scal_61);


										vec_127 = _mm512_fmadd_ps(vec_128, vec_110, mem_vec_1817);
										mem_vec_1817 = vec_127;
										scal_62 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 1) + c];
										vec_130 = _mm512_set1_ps(scal_62);


										vec_129 = _mm512_fmadd_ps(vec_130, vec_110, mem_vec_1818);
										mem_vec_1818 = vec_129;
										scal_63 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h + 1) + c];
										vec_132 = _mm512_set1_ps(scal_63);


										vec_131 = _mm512_fmadd_ps(vec_132, vec_110, mem_vec_1819);
										mem_vec_1819 = vec_131;
										scal_64 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 12 + h + 1) + c];
										vec_134 = _mm512_set1_ps(scal_64);


										vec_133 = _mm512_fmadd_ps(vec_134, vec_110, mem_vec_1820);
										mem_vec_1820 = vec_133;
										...
										vec_189 = _mm512_fmadd_ps(vec_190, vec_191, mem_vec_1808);
										mem_vec_1808 = vec_189;
										scal_92 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
										vec_193 = _mm512_set1_ps(scal_92);


										vec_192 = _mm512_fmadd_ps(vec_193, vec_191, mem_vec_1809);
										mem_vec_1809 = vec_192;
										scal_93 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
										vec_195 = _mm512_set1_ps(scal_93);


										vec_194 = _mm512_fmadd_ps(vec_195, vec_191, mem_vec_1810);
										mem_vec_1810 = vec_194;
										scal_94 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
										vec_197 = _mm512_set1_ps(scal_94);


										vec_196 = _mm512_fmadd_ps(vec_197, vec_191, mem_vec_1811);
										mem_vec_1811 = vec_196;
										scal_95 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
										vec_199 = _mm512_set1_ps(scal_95);


										vec_198 = _mm512_fmadd_ps(vec_199, vec_191, mem_vec_1812);
										mem_vec_1812 = vec_198;
										scal_96 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
										vec_201 = _mm512_set1_ps(scal_96);


										vec_200 = _mm512_fmadd_ps(vec_201, vec_191, mem_vec_1813);
										mem_vec_1813 = vec_200;
										scal_97 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
										vec_203 = _mm512_set1_ps(scal_97);


										vec_202 = _mm512_fmadd_ps(vec_203, vec_191, mem_vec_1814);
										mem_vec_1814 = vec_202;
										scal_98 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
										vec_205 = _mm512_set1_ps(scal_98);


										vec_204 = _mm512_fmadd_ps(vec_205, vec_191, mem_vec_1815);
										mem_vec_1815 = vec_204;
										scal_99 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 1) + c];
										vec_207 = _mm512_set1_ps(scal_99);


										vec_206 = _mm512_fmadd_ps(vec_207, vec_191, mem_vec_1816);
										mem_vec_1816 = vec_206;
										scal_100 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 1) + c];
										vec_209 = _mm512_set1_ps(scal_100);


										vec_208 = _mm512_fmadd_ps(vec_209, vec_191, mem_vec_1817);
										mem_vec_1817 = vec_208;
										scal_101 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 1) + c];
										vec_211 = _mm512_set1_ps(scal_101);


										vec_210 = _mm512_fmadd_ps(vec_211, vec_191, mem_vec_1818);
										mem_vec_1818 = vec_210;
										scal_102 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h + 1) + c];
										vec_213 = _mm512_set1_ps(scal_102);


										vec_212 = _mm512_fmadd_ps(vec_213, vec_191, mem_vec_1819);
										mem_vec_1819 = vec_212;
										scal_103 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 12 + h + 1) + c];
										vec_215 = _mm512_set1_ps(scal_103);


										vec_214 = _mm512_fmadd_ps(vec_215, vec_191, mem_vec_1820);
										mem_vec_1820 = vec_214;
