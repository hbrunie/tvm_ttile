...
[V f; U (2, f); U (7, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (28, x); T (8, c); T (4, y); T (8, f); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c57_p_0, cp_1, c57, f, fp_0, x, xp_0, x61_p_0, xp_1, x61, y, yp_0, y57_p_0, yp_1, y57;
					...
					for (x = x61, xp_1 = x61_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								for (c = c57, cp_1 = c57_p_0, cp_0 = 0;
									...
									vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_406);
									mem_vec_406 = vec_23;

									vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

									vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_407);
									mem_vec_407 = vec_26;
									scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
									vec_29 = _mm512_set1_ps(scal_8);


									vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_408);
									mem_vec_408 = vec_28;



									vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_409);
									mem_vec_409 = vec_30;
									scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
									vec_32 = _mm512_set1_ps(scal_9);


									vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_410);
									mem_vec_410 = vec_31;



									vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_411);
									mem_vec_411 = vec_33;
									scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
									vec_35 = _mm512_set1_ps(scal_10);


									vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_412);
									mem_vec_412 = vec_34;



									vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_413);
									mem_vec_413 = vec_36;
									scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
									vec_38 = _mm512_set1_ps(scal_11);


									vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_414);
									mem_vec_414 = vec_37;



									vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_415);
									mem_vec_415 = vec_39;
									scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
									vec_41 = _mm512_set1_ps(scal_12);


									vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_416);
									mem_vec_416 = vec_40;



									vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_417);
									mem_vec_417 = vec_42;
									scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
									vec_44 = _mm512_set1_ps(scal_13);


									vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_418);
									mem_vec_418 = vec_43;



									vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_419);
									mem_vec_419 = vec_45;
									scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
									vec_47 = _mm512_set1_ps(scal_14);
									vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

									vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_406);
									mem_vec_406 = vec_46;

									vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

									vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_407);
									mem_vec_407 = vec_49;
									scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
									vec_52 = _mm512_set1_ps(scal_15);


									vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_408);
									mem_vec_408 = vec_51;



									vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_409);
									mem_vec_409 = vec_53;
									scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
									vec_55 = _mm512_set1_ps(scal_16);


									vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_410);
									mem_vec_410 = vec_54;



									vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_411);
									mem_vec_411 = vec_56;
									scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
									vec_58 = _mm512_set1_ps(scal_17);


									vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_412);
									mem_vec_412 = vec_57;



									vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_413);
									mem_vec_413 = vec_59;
									scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
									vec_61 = _mm512_set1_ps(scal_18);


									vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_414);
									mem_vec_414 = vec_60;



									vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_415);
									mem_vec_415 = vec_62;
									scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
									vec_64 = _mm512_set1_ps(scal_19);


									vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_416);
									mem_vec_416 = vec_63;



									vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_417);
									mem_vec_417 = vec_65;
									scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
									vec_67 = _mm512_set1_ps(scal_20);


									vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_418);
									mem_vec_418 = vec_66;



									vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_419);
									mem_vec_419 = vec_68;
									scal_21 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
									vec_70 = _mm512_set1_ps(scal_21);
									vec_71 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

									vec_69 = _mm512_fmadd_ps(vec_70, vec_71, mem_vec_406);
									mem_vec_406 = vec_69;

									vec_73 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

									vec_72 = _mm512_fmadd_ps(vec_70, vec_73, mem_vec_407);
									mem_vec_407 = vec_72;
									scal_22 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
									vec_75 = _mm512_set1_ps(scal_22);


									vec_74 = _mm512_fmadd_ps(vec_75, vec_71, mem_vec_408);
									mem_vec_408 = vec_74;



									vec_76 = _mm512_fmadd_ps(vec_75, vec_73, mem_vec_409);
									mem_vec_409 = vec_76;
									scal_23 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
									vec_78 = _mm512_set1_ps(scal_23);


									vec_77 = _mm512_fmadd_ps(vec_78, vec_71, mem_vec_410);
									mem_vec_410 = vec_77;



									vec_79 = _mm512_fmadd_ps(vec_78, vec_73, mem_vec_411);
									mem_vec_411 = vec_79;
									scal_24 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
									vec_81 = _mm512_set1_ps(scal_24);


									vec_80 = _mm512_fmadd_ps(vec_81, vec_71, mem_vec_412);
									mem_vec_412 = vec_80;



									vec_82 = _mm512_fmadd_ps(vec_81, vec_73, mem_vec_413);
									mem_vec_413 = vec_82;
									scal_25 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
									vec_84 = _mm512_set1_ps(scal_25);


									vec_83 = _mm512_fmadd_ps(vec_84, vec_71, mem_vec_414);
									mem_vec_414 = vec_83;



									vec_85 = _mm512_fmadd_ps(vec_84, vec_73, mem_vec_415);
									mem_vec_415 = vec_85;
									scal_26 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
									vec_87 = _mm512_set1_ps(scal_26);


									vec_86 = _mm512_fmadd_ps(vec_87, vec_71, mem_vec_416);
									mem_vec_416 = vec_86;



									vec_88 = _mm512_fmadd_ps(vec_87, vec_73, mem_vec_417);
									mem_vec_417 = vec_88;
									scal_27 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
									vec_90 = _mm512_set1_ps(scal_27);


									vec_89 = _mm512_fmadd_ps(vec_90, vec_71, mem_vec_418);
									mem_vec_418 = vec_89;



									vec_91 = _mm512_fmadd_ps(vec_90, vec_73, mem_vec_419);
									mem_vec_419 = vec_91;
									scal_28 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h + 1) + c];
									vec_93 = _mm512_set1_ps(scal_28);
									vec_94 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f]);

									vec_92 = _mm512_fmadd_ps(vec_93, vec_94, mem_vec_406);
									mem_vec_406 = vec_92;

									vec_96 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

									vec_95 = _mm512_fmadd_ps(vec_93, vec_96, mem_vec_407);
									mem_vec_407 = vec_95;
									scal_29 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
									vec_98 = _mm512_set1_ps(scal_29);


									vec_97 = _mm512_fmadd_ps(vec_98, vec_94, mem_vec_408);
									mem_vec_408 = vec_97;



									vec_99 = _mm512_fmadd_ps(vec_98, vec_96, mem_vec_409);
									mem_vec_409 = vec_99;
									scal_30 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
									vec_101 = _mm512_set1_ps(scal_30);


									vec_100 = _mm512_fmadd_ps(vec_101, vec_94, mem_vec_410);
									mem_vec_410 = vec_100;



									vec_102 = _mm512_fmadd_ps(vec_101, vec_96, mem_vec_411);
									mem_vec_411 = vec_102;
									scal_31 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
									vec_104 = _mm512_set1_ps(scal_31);


									vec_103 = _mm512_fmadd_ps(vec_104, vec_94, mem_vec_412);
									mem_vec_412 = vec_103;



									vec_105 = _mm512_fmadd_ps(vec_104, vec_96, mem_vec_413);
									mem_vec_413 = vec_105;
									scal_32 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
									vec_107 = _mm512_set1_ps(scal_32);


									vec_106 = _mm512_fmadd_ps(vec_107, vec_94, mem_vec_414);
									mem_vec_414 = vec_106;



									vec_108 = _mm512_fmadd_ps(vec_107, vec_96, mem_vec_415);
									mem_vec_415 = vec_108;
									scal_33 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
									vec_110 = _mm512_set1_ps(scal_33);


									vec_109 = _mm512_fmadd_ps(vec_110, vec_94, mem_vec_416);
									mem_vec_416 = vec_109;



									vec_111 = _mm512_fmadd_ps(vec_110, vec_96, mem_vec_417);
									mem_vec_417 = vec_111;
									scal_34 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
									vec_113 = _mm512_set1_ps(scal_34);


									vec_112 = _mm512_fmadd_ps(vec_113, vec_94, mem_vec_418);
									mem_vec_418 = vec_112;



									vec_114 = _mm512_fmadd_ps(vec_113, vec_96, mem_vec_419);
									mem_vec_419 = vec_114;
									...
									vec_115 = _mm512_fmadd_ps(vec_116, vec_117, mem_vec_406);
									mem_vec_406 = vec_115;

									vec_119 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

									vec_118 = _mm512_fmadd_ps(vec_116, vec_119, mem_vec_407);
									mem_vec_407 = vec_118;
									scal_36 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
									vec_121 = _mm512_set1_ps(scal_36);


									vec_120 = _mm512_fmadd_ps(vec_121, vec_117, mem_vec_408);
									mem_vec_408 = vec_120;



									vec_122 = _mm512_fmadd_ps(vec_121, vec_119, mem_vec_409);
									mem_vec_409 = vec_122;
									scal_37 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
									vec_124 = _mm512_set1_ps(scal_37);


									vec_123 = _mm512_fmadd_ps(vec_124, vec_117, mem_vec_410);
									mem_vec_410 = vec_123;



									vec_125 = _mm512_fmadd_ps(vec_124, vec_119, mem_vec_411);
									mem_vec_411 = vec_125;
									scal_38 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
									vec_127 = _mm512_set1_ps(scal_38);


									vec_126 = _mm512_fmadd_ps(vec_127, vec_117, mem_vec_412);
									mem_vec_412 = vec_126;



									vec_128 = _mm512_fmadd_ps(vec_127, vec_119, mem_vec_413);
									mem_vec_413 = vec_128;
									scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
									vec_130 = _mm512_set1_ps(scal_39);


									vec_129 = _mm512_fmadd_ps(vec_130, vec_117, mem_vec_414);
									mem_vec_414 = vec_129;



									vec_131 = _mm512_fmadd_ps(vec_130, vec_119, mem_vec_415);
									mem_vec_415 = vec_131;
									scal_40 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
									vec_133 = _mm512_set1_ps(scal_40);


									vec_132 = _mm512_fmadd_ps(vec_133, vec_117, mem_vec_416);
									mem_vec_416 = vec_132;



									vec_134 = _mm512_fmadd_ps(vec_133, vec_119, mem_vec_417);
									mem_vec_417 = vec_134;
									scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
									vec_136 = _mm512_set1_ps(scal_41);


									vec_135 = _mm512_fmadd_ps(vec_136, vec_117, mem_vec_418);
									mem_vec_418 = vec_135;



									vec_137 = _mm512_fmadd_ps(vec_136, vec_119, mem_vec_419);
									mem_vec_419 = vec_137;
									scal_42 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
									vec_139 = _mm512_set1_ps(scal_42);
									vec_140 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

									vec_138 = _mm512_fmadd_ps(vec_139, vec_140, mem_vec_406);
									mem_vec_406 = vec_138;

									vec_142 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

									vec_141 = _mm512_fmadd_ps(vec_139, vec_142, mem_vec_407);
									mem_vec_407 = vec_141;
									scal_43 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
									vec_144 = _mm512_set1_ps(scal_43);


									vec_143 = _mm512_fmadd_ps(vec_144, vec_140, mem_vec_408);
									mem_vec_408 = vec_143;



									vec_145 = _mm512_fmadd_ps(vec_144, vec_142, mem_vec_409);
									mem_vec_409 = vec_145;
									scal_44 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
									vec_147 = _mm512_set1_ps(scal_44);


									vec_146 = _mm512_fmadd_ps(vec_147, vec_140, mem_vec_410);
									mem_vec_410 = vec_146;



									vec_148 = _mm512_fmadd_ps(vec_147, vec_142, mem_vec_411);
									mem_vec_411 = vec_148;
									scal_45 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
									vec_150 = _mm512_set1_ps(scal_45);


									vec_149 = _mm512_fmadd_ps(vec_150, vec_140, mem_vec_412);
									mem_vec_412 = vec_149;



									vec_151 = _mm512_fmadd_ps(vec_150, vec_142, mem_vec_413);
									mem_vec_413 = vec_151;
									scal_46 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
									vec_153 = _mm512_set1_ps(scal_46);


									vec_152 = _mm512_fmadd_ps(vec_153, vec_140, mem_vec_414);
									mem_vec_414 = vec_152;



									vec_154 = _mm512_fmadd_ps(vec_153, vec_142, mem_vec_415);
									mem_vec_415 = vec_154;
									scal_47 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
									vec_156 = _mm512_set1_ps(scal_47);


									vec_155 = _mm512_fmadd_ps(vec_156, vec_140, mem_vec_416);
									mem_vec_416 = vec_155;



									vec_157 = _mm512_fmadd_ps(vec_156, vec_142, mem_vec_417);
									mem_vec_417 = vec_157;
									scal_48 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
									vec_159 = _mm512_set1_ps(scal_48);


									vec_158 = _mm512_fmadd_ps(vec_159, vec_140, mem_vec_418);
									mem_vec_418 = vec_158;



									vec_160 = _mm512_fmadd_ps(vec_159, vec_142, mem_vec_419);
									mem_vec_419 = vec_160;
									...
									vec_161 = _mm512_fmadd_ps(vec_162, vec_163, mem_vec_406);
									mem_vec_406 = vec_161;

									vec_165 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

									vec_164 = _mm512_fmadd_ps(vec_162, vec_165, mem_vec_407);
									mem_vec_407 = vec_164;
									scal_50 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
									vec_167 = _mm512_set1_ps(scal_50);


									vec_166 = _mm512_fmadd_ps(vec_167, vec_163, mem_vec_408);
									mem_vec_408 = vec_166;



									vec_168 = _mm512_fmadd_ps(vec_167, vec_165, mem_vec_409);
									mem_vec_409 = vec_168;
									scal_51 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
									vec_170 = _mm512_set1_ps(scal_51);


									vec_169 = _mm512_fmadd_ps(vec_170, vec_163, mem_vec_410);
									mem_vec_410 = vec_169;



									vec_171 = _mm512_fmadd_ps(vec_170, vec_165, mem_vec_411);
									mem_vec_411 = vec_171;
									scal_52 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
									vec_173 = _mm512_set1_ps(scal_52);


									vec_172 = _mm512_fmadd_ps(vec_173, vec_163, mem_vec_412);
									mem_vec_412 = vec_172;



									vec_174 = _mm512_fmadd_ps(vec_173, vec_165, mem_vec_413);
									mem_vec_413 = vec_174;
									scal_53 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
									vec_176 = _mm512_set1_ps(scal_53);


									vec_175 = _mm512_fmadd_ps(vec_176, vec_163, mem_vec_414);
									mem_vec_414 = vec_175;



									vec_177 = _mm512_fmadd_ps(vec_176, vec_165, mem_vec_415);
									mem_vec_415 = vec_177;
									scal_54 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
									vec_179 = _mm512_set1_ps(scal_54);


									vec_178 = _mm512_fmadd_ps(vec_179, vec_163, mem_vec_416);
									mem_vec_416 = vec_178;



									vec_180 = _mm512_fmadd_ps(vec_179, vec_165, mem_vec_417);
									mem_vec_417 = vec_180;
									scal_55 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
									vec_182 = _mm512_set1_ps(scal_55);


									vec_181 = _mm512_fmadd_ps(vec_182, vec_163, mem_vec_418);
									mem_vec_418 = vec_181;



									vec_183 = _mm512_fmadd_ps(vec_182, vec_165, mem_vec_419);
									mem_vec_419 = vec_183;
									...
									vec_184 = _mm512_fmadd_ps(vec_185, vec_186, mem_vec_406);
									mem_vec_406 = vec_184;

									vec_188 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

									vec_187 = _mm512_fmadd_ps(vec_185, vec_188, mem_vec_407);
									mem_vec_407 = vec_187;
									scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
									vec_190 = _mm512_set1_ps(scal_57);


									vec_189 = _mm512_fmadd_ps(vec_190, vec_186, mem_vec_408);
									mem_vec_408 = vec_189;



									vec_191 = _mm512_fmadd_ps(vec_190, vec_188, mem_vec_409);
									mem_vec_409 = vec_191;
									scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
									vec_193 = _mm512_set1_ps(scal_58);


									vec_192 = _mm512_fmadd_ps(vec_193, vec_186, mem_vec_410);
									mem_vec_410 = vec_192;



									vec_194 = _mm512_fmadd_ps(vec_193, vec_188, mem_vec_411);
									mem_vec_411 = vec_194;
									scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
									vec_196 = _mm512_set1_ps(scal_59);


									vec_195 = _mm512_fmadd_ps(vec_196, vec_186, mem_vec_412);
									mem_vec_412 = vec_195;



									vec_197 = _mm512_fmadd_ps(vec_196, vec_188, mem_vec_413);
									mem_vec_413 = vec_197;
									scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
									vec_199 = _mm512_set1_ps(scal_60);


									vec_198 = _mm512_fmadd_ps(vec_199, vec_186, mem_vec_414);
									mem_vec_414 = vec_198;



									vec_200 = _mm512_fmadd_ps(vec_199, vec_188, mem_vec_415);
									mem_vec_415 = vec_200;
									scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
									vec_202 = _mm512_set1_ps(scal_61);


									vec_201 = _mm512_fmadd_ps(vec_202, vec_186, mem_vec_416);
									mem_vec_416 = vec_201;



									vec_203 = _mm512_fmadd_ps(vec_202, vec_188, mem_vec_417);
									mem_vec_417 = vec_203;
									scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
									vec_205 = _mm512_set1_ps(scal_62);


									vec_204 = _mm512_fmadd_ps(vec_205, vec_186, mem_vec_418);
									mem_vec_418 = vec_204;



									vec_206 = _mm512_fmadd_ps(vec_205, vec_188, mem_vec_419);
									mem_vec_419 = vec_206;
								}
