...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  ...
  T (8, c); T (2, f)]
*/
IND_TYPE c, cp_0, c544_p_0, c545_p_0, cp_1, c544_p_1, cp_2, c544, c545, f, fp_0, f408_p_0, fp_1, f408, x, xp_0, y, yp_0;
			...
			f += 16, fp_1 += 16, fp_0 += 16){
				for (y = y272, yp_0 = 0;
					...
					for (c544 = c545, c544_p_1 = c545_p_0, c544_p_0 = 0;
						c544 < c545 + 64;
						c544 += 16, c544_p_1 += 16, c544_p_0 += 16){
						...
						for (x = x272, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_2445 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									...
									for (c = c544, cp_2 = c544_p_1, cp_1 = c544_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2445);
										mem_vec_2445 = vec_3;
