...
for (y666 = y667, y666_p_0 = 0;
	y666 < y667 + 544;
	y666 += 544, y666_p_0 += 544){
	// y = 544, x = 544, h = 3, w = 3, c = 3, f = 32
	// T (x, 4) (544 / 136)
	for (x713 = x714, x713_p_0 = 0;
		x713 < x714 + 544;
		x713 += 136, x713_p_0 += 136){
		// y = 544, x = 136, h = 3, w = 3, c = 3, f = 32
		// T (y, 136) (544 / 4)
		for (y665 = y666, y665_p_1 = y666_p_0, y665_p_0 = 0;
			y665 < y666 + 544;
			y665 += 4, y665_p_1 += 4, y665_p_0 += 4){
			// y = 4, x = 136, h = 3, w = 3, c = 3, f = 32
			// T (y, 1) (4 / 4)
			for (y = y665, yp_2 = y665_p_1, yp_1 = y665_p_0, yp_0 = 0;
				y < y665 + 4;
