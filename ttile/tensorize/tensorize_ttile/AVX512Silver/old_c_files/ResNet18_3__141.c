...
*/
IND_TYPE c, cp_0, c546_p_0, cp_1, c546, f, fp_0, x, xp_0, x892_p_0, x893_p_0, x894_p_0, xp_1, x892_p_1, x893_p_1, xp_2, x892_p_2, xp_3, x892, x893, x894, y, yp_0, y710_p_0, y711_p_0, yp_1, y710_p_1, yp_2, y710, y711;
...
for (y711 = y712, y711_p_0 = 0;
	...
	for (x894 = x895, x894_p_0 = 0;
		...
		// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 1) (28 / 28)
		for (y710 = y711, y710_p_1 = y711_p_0, y710_p_0 = 0;
			y710 < y711 + 28;
			y710 += 28, y710_p_1 += 28, y710_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (56 / 4)
			for (x893 = x894, x893_p_1 = x894_p_0, x893_p_0 = 0;
				x893 < x894 + 56;
				x893 += 4, x893_p_1 += 4, x893_p_0 += 4){
				...
				for (f = f346, fp_0 = 0;
					...
					// T (y, 4) (28 / 7)
					for (y = y710, yp_2 = y710_p_1, yp_1 = y710_p_0, yp_0 = 0;
						y < y710 + 28;
						y += 7, yp_2 += 7, yp_1 += 7, yp_0 += 7){
						// y = 7, x = 4, h = 1, w = 1, c = 64, f = 32
						// T (x, 4) (4 / 1)
						for (x892 = x893, x892_p_2 = x893_p_1, x892_p_1 = x893_p_0, x892_p_0 = 0;
							x892 < x893 + 4;
							x892 += 1, x892_p_2 += 1, x892_p_1 += 1, x892_p_0 += 1){
							...
							for (c546 = c547, c546_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x892, xp_3 = x892_p_2, xp_2 = x892_p_1, xp_1 = x892_p_0, xp_0 = 0;
									x < x892 + 1;
