...
/*
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (128, c); Hoist_vars [c];
  T (14, x); T (1, c); T (1, f); T (14, y); T (4, x); T (8, f); T (1, f)]
*/
IND_TYPE c, cp_0, c204_p_0, cp_1, c204, f, fp_0, f150_p_0, f151_p_0, fp_1, f150_p_1, fp_2, f150, f151, x, xp_0, x234_p_0, xp_1, x234, y, yp_0;
...
for (f151 = f152, f151_p_0 = 0;
	...
	for (f150 = f151, f150_p_1 = f151_p_0, f150_p_0 = 0;
		f150 < f151 + 128;
		f150 += 16, f150_p_1 += 16, f150_p_0 += 16){
					...
					for (c204 = c205, c204_p_0 = 0;
						...
						for (x = x234, xp_1 = x234_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1339 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									// y = 4, x = 1, h = 3, w = 3, c = 128, f = 16
									// T (c, 128) (128 / 1)
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_1339);
						}
					}
				}
			}
