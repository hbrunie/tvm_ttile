...
*/
IND_TYPE c, cp_0, c555_p_0, cp_1, c555, f, fp_0, f555_p_0, fp_1, f555, w, wp_0, x, xp_0, y, yp_0;
...
__m512 mem_vec_3533 ,mem_vec_3534 ,mem_vec_3535 ,mem_vec_3536 ,mem_vec_3537 ,mem_vec_3538 ,mem_vec_3539 ,mem_vec_3540 ,mem_vec_3541 ,mem_vec_3542 ,mem_vec_3543 ,mem_vec_3544 ,mem_vec_3545 ,mem_vec_3546 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_81 ,vec_82 ,vec_83 ,vec_84 ,vec_85 ,vec_86 ,vec_9;
				...
				for (x = x510, xp_0 = 0;
					...
					for (w = w282, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								mem_vec_3535 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
								...
								mem_vec_3539 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
								...
								mem_vec_3543 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_3544 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_3545 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								...
								for (c = c555, cp_1 = c555_p_0, cp_0 = 0;
									...
									vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_3534);
									mem_vec_3534 = vec_3;
									...
									vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_3536);
									mem_vec_3536 = vec_7;
									scal_4 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 4) + h) + c];
									vec_10 = _mm512_set1_ps(scal_4);


									vec_9 = _mm512_fmadd_ps(vec_10, vec_2, mem_vec_3537);
									mem_vec_3537 = vec_9;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_3539);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_3543);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3544);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_3545);
