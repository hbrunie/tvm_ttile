...
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (4, x); T (1, c);
  T (7, w); T (7, h); T (28, x); T (7, y); T (2, f); T (2, y)]
*/
IND_TYPE c, cp_0, c474_p_0, cp_1, c474, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x463_p_0, xp_1, x463, y, yp_0, y474_p_0, yp_1, y474;
IND_TYPE y475 = 0;
IND_TYPE x464 = 0;
IND_TYPE h316 = 0;
IND_TYPE w316 = 0;
...
x463 = 0;
x463_p_0 = 0;
				for (h = h316, hp_0 = 0;h < h316 + 7;h += 1, hp_0 += 1){
					// y = 8, x = 4, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w316, wp_0 = 0;w < w316 + 7;w += 1, wp_0 += 1){
						// y = 8, x = 4, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c474 = c475, c474_p_0 = 0;c474 < c475 + 3;c474 += 3, c474_p_0 += 3){
							// y = 8, x = 4, h = 1, w = 1, c = 3, f = 32
							// T (x, 4) (4 / 1)
							for (x = x463, xp_1 = x463_p_0, xp_0 = 0;x < x463 + 4;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c474, cp_1 = c474_p_0, cp_0 = 0;c < c474 + 3;c += 1, cp_1 += 1, cp_0 += 1){
