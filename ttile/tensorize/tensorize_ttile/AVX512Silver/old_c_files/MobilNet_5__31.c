...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (3, h); T (28, x);
  T (3, w); T (8, c); T (1, f); T (7, y); T (1, x); T (1, f); T (4, f)]
*/
IND_TYPE c, cp_0, c93_p_0, cp_1, c93, f, fp_0, f72_p_0, f73_p_0, fp_1, f72_p_1, fp_2, f72, f73, h, hp_0, w, wp_0, x, xp_0, x93_p_0, xp_1, x93, y, yp_0;
