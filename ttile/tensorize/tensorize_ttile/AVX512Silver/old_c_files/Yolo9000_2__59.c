...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  T (1, x); T (2, c); T (1, x); T (17, y); T (4, f); T (272, x); T (2, y);
  T (2, y)]
*/
IND_TYPE c, cp_0, c426_p_0, cp_1, c426, f, fp_0, x, xp_0, x568_p_0, x569_p_0, xp_1, x568_p_1, xp_2, x568, x569, y, yp_0, y562_p_0, y563_p_0, yp_1, y562_p_1, yp_2, y562, y563;
...
__m512 mem_vec_1240 ,mem_vec_1241 ,mem_vec_1242 ,mem_vec_1243 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_9;
// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
// T (y, 2) (272 / 136)
for (y563 = y564, y563_p_0 = 0;
	y563 < y564 + 272;
	y563 += 136, y563_p_0 += 136){
	// y = 136, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (y, 2) (136 / 68)
	for (y562 = y563, y562_p_1 = y563_p_0, y562_p_0 = 0;
		y562 < y563 + 136;
		y562 += 68, y562_p_1 += 68, y562_p_0 += 68){
		...
		for (x569 = x570, x569_p_0 = 0;
			...
			for (f = f158, fp_0 = 0;
				...
				// T (y, 17) (68 / 4)
				for (y = y562, yp_2 = y562_p_1, yp_1 = y562_p_0, yp_0 = 0;
					y < y562 + 68;
