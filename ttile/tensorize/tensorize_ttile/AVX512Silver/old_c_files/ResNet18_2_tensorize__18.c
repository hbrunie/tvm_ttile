...
c66_p_0 = 0;
				for (h = h30, hp_0 = 0;h < h30 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 56) (56 / 1)
					for (x = x80, xp_1 = x80_p_0, xp_0 = 0;x < x80 + 56;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_474 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
								mem_vec_475 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_474);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_475);
					}
				}
}
