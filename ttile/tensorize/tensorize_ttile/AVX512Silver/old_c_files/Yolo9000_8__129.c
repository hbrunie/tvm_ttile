								...
								for (x = x180, xp_1 = x180_p_0, xp_0 = 0;
									...
									for (h = h86, hp_0 = 0;
										...
										h += 1, hp_0 += 1){
												...
												mem_vec_2778 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
												mem_vec_2779 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
												mem_vec_2780 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
												mem_vec_2781 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 32
												// T (c, 16) (16 / 1)
												for (c = c180, cp_1 = c180_p_0, cp_0 = 0;
													c < c180 + 16;
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_2778);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_2779);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_2780);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_2781);
									}
								}
							}
						}
