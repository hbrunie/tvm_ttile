	...
	for (y342 = y343, y342_p_0 = 0;
		...
		for (x347 = x348, x347_p_1 = x348_p_0, x347_p_0 = 0;
			...
			for (f = f88, fp_0 = 0;
				...
				// T (x, 1) (1 / 1)
				for (x346 = x347, x346_p_2 = x347_p_1, x346_p_1 = x347_p_0, x346_p_0 = 0;
					x346 < x347 + 1;
					x346 += 1, x346_p_2 += 1, x346_p_1 += 1, x346_p_0 += 1){
					// y = 68, x = 1, h = 3, w = 3, c = 32, f = 16
					// T (y, 17) (68 / 4)
					for (y = y342, yp_1 = y342_p_0, yp_0 = 0;
						...
						for (h = h130, hp_0 = 0;
							...
							for (c258 = c259, c258_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x346, xp_3 = x346_p_2, xp_2 = x346_p_1, xp_1 = x346_p_0, xp_0 = 0;
									x < x346 + 1;
