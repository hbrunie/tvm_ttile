...
/*
[V f; U (2, f); U (14, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, c); T (1, f); T (28, x); T (2, y); T (4, f)]
*/
IND_TYPE c, cp_0, c87_p_0, cp_1, c87, f, fp_0, f87_p_0, fp_1, f87, w, wp_0, x, xp_0, x87_p_0, xp_1, x87, y, yp_0;
