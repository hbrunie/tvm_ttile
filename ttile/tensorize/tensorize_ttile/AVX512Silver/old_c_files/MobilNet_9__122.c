...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (7, x); T (4, f); T (1, c); T (32, c); T (16, f)]
*/
IND_TYPE c, cp_0, c168_p_0, c169_p_0, cp_1, c168_p_1, cp_2, c168, c169, f, fp_0, f126_p_0, fp_1, f126, x, xp_0;
			...
			for (f = f126, fp_1 = f126_p_0, fp_0 = 0;
				...
				for (x = x84, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_737 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
							mem_vec_738 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
							mem_vec_739 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
							mem_vec_740 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
							mem_vec_741 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
							...
							for (c = c168, cp_2 = c168_p_1, cp_1 = c168_p_0, cp_0 = 0;
								...
								vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_736);
								mem_vec_736 = vec_3;
								...
								vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_738);
								mem_vec_738 = vec_7;
								scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h) + c];
								vec_10 = _mm512_set1_ps(scal_4);


								vec_9 = _mm512_fmadd_ps(vec_10, vec_2, mem_vec_739);
								mem_vec_739 = vec_9;
