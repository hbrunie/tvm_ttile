...
y258 = 0;
y258_p_0 = 0;
	for (x345 = x346, x345_p_0 = 0;x345 < x346 + 68;x345 += 34, x345_p_0 += 34){
			for (y = y258, yp_1 = y258_p_0, yp_0 = 0;y < y258 + 12;y += 3, yp_1 += 3, yp_0 += 3){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
				for (x344 = x345, x344_p_1 = x345_p_0, x344_p_0 = 0;x344 < x345 + 34;x344 += 34, x344_p_1 += 34, x344_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f172, fp_0 = 0;f < f172 + 128;f += 64, fp_0 += 64){
			...
			for (y = y258 + 12, yp_1 = y258_p_0, yp_0 = 0;y < y258 + 12 + 5;y += 5, yp_1 += 5, yp_0 += 5){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
				for (x344 = x345, x344_p_1 = x345_p_0, x344_p_0 = 0;x344 < x345 + 34;x344 += 34, x344_p_1 += 34, x344_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
