...
c293 = 0;
c293_p_0 = 0;
		for (f = f146, fp_0 = 0;f < f146 + 512;f += 64, fp_0 += 64){
				for (y = y219, yp_1 = y219_p_0, yp_0 = 0;y < y219 + 12;y += 4, yp_1 += 4, yp_0 += 4){
					// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 64
					// T (c, 64) (1024 / 16)
					for (c292 = c293, c292_p_1 = c293_p_0, c292_p_0 = 0;c292 < c293 + 1024;c292 += 16, c292_p_1 += 16, c292_p_0 += 16){
						...
						for (x = x146, xp_0 = 0;x < x146 + 17;x += 1, xp_0 += 1){
									...
									// T (c, 16) (16 / 1)
									for (c = c292, cp_2 = c292_p_1, cp_1 = c292_p_0, cp_0 = 0;c < c292 + 16;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
				...
				for (y = y219 + 12, yp_1 = y219_p_0, yp_0 = 0;y < y219 + 12 + 5;y += 5, yp_1 += 5, yp_0 += 5){
					// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 64
					// T (c, 64) (1024 / 16)
					for (c292 = c293, c292_p_1 = c293_p_0, c292_p_0 = 0;c292 < c293 + 1024;c292 += 16, c292_p_1 += 16, c292_p_0 += 16){
						// y = ph_y, x = 17, h = 1, w = 1, c = 16, f = 64
