				...
				for (x = x152, xp_0 = 0;
					...
					for (h = h106, hp_0 = 0;
						...
						h += 1, hp_0 += 1){
								...
								mem_vec_1663 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
								mem_vec_1664 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
								mem_vec_1665 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_1663);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_1664);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_1665);
					}
				}
			}
		}
