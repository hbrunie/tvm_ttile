...
c462_p_0 = 0;
							for (w = w223, wp_0 = 0;w < w223 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 1) (1 / 1)
								for (x = x529, xp_1 = x529_p_0, xp_0 = 0;x < x529 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_2925 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
											mem_vec_2926 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											mem_vec_2927 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
											mem_vec_2928 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
											mem_vec_2929 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_2925);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2926);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2927);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2928);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_2929);
