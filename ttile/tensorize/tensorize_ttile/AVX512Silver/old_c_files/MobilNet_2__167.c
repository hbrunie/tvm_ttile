...
for (y480 = y481, y480_p_0 = 0;
	...
	y480 += 56, y480_p_0 += 56){
						...
						for (h = h282, hp_0 = 0;
							...
							for (x = x654, xp_1 = x654_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4571 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_4572 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_4573 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_4574 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_4575 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_4576 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_4571);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_4572);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_4573);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_4574);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_4575);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_4576);
							}
						}
					}
				}
		...
		for (y = y480 + 20, yp_1 = y480_p_0, yp_0 = 0;
			y < y480 + 20 + 36;
			y += 9, yp_1 += 9, yp_0 += 9){
			// y = ph_y, x = 56, h = 3, w = 3, c = 64, f = 64
			// T (x, 1) (56 / 56)
