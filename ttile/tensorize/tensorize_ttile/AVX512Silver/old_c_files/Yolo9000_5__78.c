	...
	for (x21 = x22, x21_p_0 = 0;
		...
		for (f = f11, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				...
				for (y = y21 + 45, yp_1 = y21_p_0, yp_0 = 0;
					y < y21 + 45 + 91;
					...
					for (x = x21, xp_1 = x21_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_238 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_239 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
								mem_vec_240 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_241 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
								mem_vec_242 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_243 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c17, cp_0 = 0;
									c < c17 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_238);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_239);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_240);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_241);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_242);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_243);
					}
				}
		}
	}
