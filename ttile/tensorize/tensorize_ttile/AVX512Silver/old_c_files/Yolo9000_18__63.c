...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  ...
  T (8, c); T (1, f)]
*/
IND_TYPE c, cp_0, c332_p_0, c333_p_0, cp_1, c332_p_1, cp_2, c332, c333, f, fp_0, f249_p_0, fp_1, f249, x, xp_0, y, yp_0;
			...
			f += 16, fp_1 += 16, fp_0 += 16){
				for (y = y166, yp_0 = 0;
					...
					for (c332 = c333, c332_p_1 = c333_p_0, c332_p_0 = 0;
						c332 < c333 + 64;
						c332 += 64, c332_p_1 += 64, c332_p_0 += 64){
						// y = ph_y, x = 17, h = 3, w = 3, c = 64, f = 16
						// T (x, 17) (17 / 1)
						for (x = x166, xp_0 = 0;
							x < x166 + 17;
							x += 1, xp_0 += 1){
									...
									for (c = c332, cp_2 = c332_p_1, cp_1 = c332_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1705);
										mem_vec_1705 = vec_3;
