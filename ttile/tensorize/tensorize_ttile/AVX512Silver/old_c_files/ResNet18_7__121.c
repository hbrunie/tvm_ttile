					...
					for (h = h14, hp_0 = 0;
						...
						for (w = w11, wp_0 = 0;
							...
							w += 1, wp_0 += 1){
									...
									mem_vec_153 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_154 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									mem_vec_155 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_156 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_157 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_158 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_159 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_160 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_153);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_154);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_155);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_156);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_157);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_158);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_159);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_160);
						}
					}
				}
			}
