...
[V f; U (2, f); ULambda y; T (256, c); Hoist_vars [c]; T (1, x); T (2, c);
  ...
  T (8, f); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c219_p_0, cp_1, c219, f, fp_0, x, xp_0, x292_p_0, x293_p_0, xp_1, x292_p_1, xp_2, x292, x293, y, yp_0, y193_p_0, yp_1, y193;
IND_TYPE y194 = 0;
IND_TYPE x294 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x293_p_0 = 0;
		for (f = f146, fp_0 = 0;f < f146 + 256;f += 32, fp_0 += 32){
				for (y = y193, yp_1 = y193_p_0, yp_0 = 0;y < y193 + 20;y += 10, yp_1 += 10, yp_0 += 10){
				...
				for (y = y193 + 20, yp_1 = y193_p_0, yp_0 = 0;y < y193 + 20 + 14;y += 14, yp_1 += 14, yp_0 += 14){
					// y = ph_y, x = 34, h = 1, w = 1, c = 512, f = 32
					// T (x, 34) (34 / 1)
					for (x292 = x293, x292_p_1 = x293_p_0, x292_p_0 = 0;x292 < x293 + 34;x292 += 1, x292_p_1 += 1, x292_p_0 += 1){
						// y = ph_y, x = 1, h = 1, w = 1, c = 512, f = 32
