...
y393 = 0;
y393_p_0 = 0;
	for (x525 = x526, x525_p_0 = 0;x525 < x526 + 68;x525 += 68, x525_p_0 += 68){
			for (y = y393, yp_1 = y393_p_0, yp_0 = 0;y < y393 + 4;y += 4, yp_1 += 4, yp_0 += 4){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 4) (68 / 17)
				for (x524 = x525, x524_p_1 = x525_p_0, x524_p_0 = 0;x524 < x525 + 68;x524 += 17, x524_p_1 += 17, x524_p_0 += 17){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f262, fp_0 = 0;f < f262 + 128;f += 64, fp_0 += 64){
						// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 64
						// T (c, 2) (256 / 128)
						for (c393 = c394, c393_p_0 = 0;c393 < c394 + 256;c393 += 128, c393_p_0 += 128){
							// y = ph_y, x = 17, h = 1, w = 1, c = 128, f = 64
							// T (x, 17) (17 / 1)
							for (x = x524, xp_2 = x524_p_1, xp_1 = x524_p_0, xp_0 = 0;x < x524 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y393 + 4, yp_1 = y393_p_0, yp_0 = 0;y < y393 + 4 + 30;y += 6, yp_1 += 6, yp_0 += 6){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 4) (68 / 17)
				for (x524 = x525, x524_p_1 = x525_p_0, x524_p_0 = 0;x524 < x525 + 68;x524 += 17, x524_p_1 += 17, x524_p_0 += 17){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 128
