...
*/
IND_TYPE c, cp_0, c20_p_0, c21_p_0, cp_1, c20_p_1, cp_2, c20, c21, f, fp_0, x, xp_0, y, yp_0, y15_p_0, yp_1, y15;
				...
				for (y = y15, yp_1 = y15_p_0, yp_0 = 0;
					...
					for (c20 = c21, c20_p_1 = c21_p_0, c20_p_0 = 0;
						...
						for (x = x10, xp_0 = 0;
							x < x10 + 17;
							x += 1, xp_0 += 1){
									mem_vec_212 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_213 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
									mem_vec_214 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
									mem_vec_215 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									mem_vec_216 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_217 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_218 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
									mem_vec_219 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
									mem_vec_220 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_221 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
									mem_vec_222 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32]);
									mem_vec_223 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48]);
									mem_vec_224 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_225 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									mem_vec_226 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32]);
									mem_vec_227 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48]);
									mem_vec_228 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
									mem_vec_229 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
									mem_vec_230 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32]);
									mem_vec_231 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48]);
									mem_vec_232 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									mem_vec_233 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
									mem_vec_234 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32]);
									mem_vec_235 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48]);
									mem_vec_236 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_237 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
									mem_vec_238 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
									mem_vec_239 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 64, f = 64
									// T (c, 64) (64 / 1)
									for (c = c20, cp_2 = c20_p_1, cp_1 = c20_p_0, cp_0 = 0;
										c < c20 + 64;
										...
										vec_0 = _mm512_fmadd_ps(vec_1, vec_2, mem_vec_212);
										mem_vec_212 = vec_0;

										vec_4 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * h + F * c + f + 16]);

										vec_3 = _mm512_fmadd_ps(vec_1, vec_4, mem_vec_213);
										mem_vec_213 = vec_3;

										vec_6 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * h + F * c + f + 32]);

										vec_5 = _mm512_fmadd_ps(vec_1, vec_6, mem_vec_214);
										mem_vec_214 = vec_5;

										vec_8 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * h + F * c + f + 48]);

										vec_7 = _mm512_fmadd_ps(vec_1, vec_8, mem_vec_215);
										mem_vec_215 = vec_7;
										scal_1 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h) + c];
										vec_10 = _mm512_set1_ps(scal_1);


										vec_9 = _mm512_fmadd_ps(vec_10, vec_2, mem_vec_216);
										mem_vec_216 = vec_9;



										vec_11 = _mm512_fmadd_ps(vec_10, vec_4, mem_vec_217);
										mem_vec_217 = vec_11;



										vec_12 = _mm512_fmadd_ps(vec_10, vec_6, mem_vec_218);
										mem_vec_218 = vec_12;



										vec_13 = _mm512_fmadd_ps(vec_10, vec_8, mem_vec_219);
										mem_vec_219 = vec_13;
										scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
										vec_15 = _mm512_set1_ps(scal_2);


										vec_14 = _mm512_fmadd_ps(vec_15, vec_2, mem_vec_220);
										mem_vec_220 = vec_14;



										vec_16 = _mm512_fmadd_ps(vec_15, vec_4, mem_vec_221);
										mem_vec_221 = vec_16;



										vec_17 = _mm512_fmadd_ps(vec_15, vec_6, mem_vec_222);
										mem_vec_222 = vec_17;



										vec_18 = _mm512_fmadd_ps(vec_15, vec_8, mem_vec_223);
										mem_vec_223 = vec_18;
										scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h) + c];
										vec_20 = _mm512_set1_ps(scal_3);


										vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_224);
										mem_vec_224 = vec_19;



										vec_21 = _mm512_fmadd_ps(vec_20, vec_4, mem_vec_225);
										mem_vec_225 = vec_21;



										vec_22 = _mm512_fmadd_ps(vec_20, vec_6, mem_vec_226);
										mem_vec_226 = vec_22;



										vec_23 = _mm512_fmadd_ps(vec_20, vec_8, mem_vec_227);
										mem_vec_227 = vec_23;
										scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h) + c];
										vec_25 = _mm512_set1_ps(scal_4);


										vec_24 = _mm512_fmadd_ps(vec_25, vec_2, mem_vec_228);
										mem_vec_228 = vec_24;



										vec_26 = _mm512_fmadd_ps(vec_25, vec_4, mem_vec_229);
										mem_vec_229 = vec_26;



										vec_27 = _mm512_fmadd_ps(vec_25, vec_6, mem_vec_230);
										mem_vec_230 = vec_27;



										vec_28 = _mm512_fmadd_ps(vec_25, vec_8, mem_vec_231);
										mem_vec_231 = vec_28;
										scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h) + c];
										vec_30 = _mm512_set1_ps(scal_5);


										vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_232);
										mem_vec_232 = vec_29;



										vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_233);
										mem_vec_233 = vec_31;



										vec_32 = _mm512_fmadd_ps(vec_30, vec_6, mem_vec_234);
										mem_vec_234 = vec_32;



										vec_33 = _mm512_fmadd_ps(vec_30, vec_8, mem_vec_235);
										mem_vec_235 = vec_33;
										scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
										vec_35 = _mm512_set1_ps(scal_6);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_2, mem_vec_236);
										mem_vec_236 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_4, mem_vec_237);
										mem_vec_237 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_35, vec_6, mem_vec_238);
										mem_vec_238 = vec_37;



										vec_38 = _mm512_fmadd_ps(vec_35, vec_8, mem_vec_239);
										mem_vec_239 = vec_38;
									}
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_212);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_213);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_214);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_215);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_216);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_217);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_218);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_219);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_220);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_221);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32], mem_vec_222);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48], mem_vec_223);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_224);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_225);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32], mem_vec_226);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48], mem_vec_227);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_228);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_229);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32], mem_vec_230);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48], mem_vec_231);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_232);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_233);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32], mem_vec_234);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48], mem_vec_235);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_236);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_237);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_238);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_239);
						}
					}
				}
			}
