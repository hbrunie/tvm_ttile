...
[V f; U (4, f); ULambda y; T (64, c); Hoist_vars [c]; T (34, x); T (4, c);
  ...
  T (4, y)]
*/
IND_TYPE c, cp_0, c249_p_0, cp_1, c249, f, fp_0, x, xp_0, x332_p_0, x333_p_0, xp_1, x332_p_1, xp_2, x332, x333, y, yp_0, y249_p_0, yp_1, y249;
IND_TYPE y250 = 0;
IND_TYPE x334 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y249 = 0;
y249_p_0 = 0;
	for (x333 = x334, x333_p_0 = 0;x333 < x334 + 68;x333 += 68, x333_p_0 += 68){
			for (y = y249, yp_1 = y249_p_0, yp_0 = 0;y < y249 + 12;y += 3, yp_1 += 3, yp_0 += 3){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 2) (68 / 34)
				for (x332 = x333, x332_p_1 = x333_p_0, x332_p_0 = 0;x332 < x333 + 68;x332 += 34, x332_p_1 += 34, x332_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f166, fp_0 = 0;f < f166 + 128;f += 64, fp_0 += 64){
						// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 64
						// T (c, 4) (256 / 64)
						for (c249 = c250, c249_p_0 = 0;c249 < c250 + 256;c249 += 64, c249_p_0 += 64){
							// y = ph_y, x = 34, h = 1, w = 1, c = 64, f = 64
							// T (x, 34) (34 / 1)
							for (x = x332, xp_2 = x332_p_1, xp_1 = x332_p_0, xp_0 = 0;x < x332 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 64) (64 / 1)
										for (c = c249, cp_1 = c249_p_0, cp_0 = 0;c < c249 + 64;c += 1, cp_1 += 1, cp_0 += 1){
			...
			for (y = y249 + 12, yp_1 = y249_p_0, yp_0 = 0;y < y249 + 12 + 5;y += 5, yp_1 += 5, yp_0 += 5){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 2) (68 / 34)
				for (x332 = x333, x332_p_1 = x333_p_0, x332_p_0 = 0;x332 < x333 + 68;x332 += 34, x332_p_1 += 34, x332_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
