...
[V f; U (1, f); U (14, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (28, x); T (8, c); T (2, y); T (16, f); T (1, y)]
*/
IND_TYPE c, cp_0, c72_p_0, cp_1, c72, f, fp_0, x, xp_0, y, yp_0, y72_p_0, yp_1, y72;
			...
			for (c72 = c73, c72_p_0 = 0;
				...
				for (x = x74, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_477 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
							mem_vec_478 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
							mem_vec_479 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
							mem_vec_480 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
							mem_vec_481 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
							mem_vec_482 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
							mem_vec_483 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
							mem_vec_484 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
							mem_vec_485 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
							mem_vec_486 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
							mem_vec_487 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
							mem_vec_488 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
							mem_vec_489 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
							...
							for (c = c72, cp_1 = c72_p_0, cp_0 = 0;
								...
								vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_477);
								mem_vec_477 = vec_3;
								...
								vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_479);
								mem_vec_479 = vec_7;
								...
								vec_11 = _mm512_fmadd_ps(vec_12, vec_2, mem_vec_481);
								mem_vec_481 = vec_11;
								scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
								vec_14 = _mm512_set1_ps(scal_6);


								vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_482);
								mem_vec_482 = vec_13;
								scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
								vec_16 = _mm512_set1_ps(scal_7);


								vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_483);
								mem_vec_483 = vec_15;
