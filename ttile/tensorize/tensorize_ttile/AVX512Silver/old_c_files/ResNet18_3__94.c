...
for (y731 = y732, y731_p_0 = 0;
	...
	for (x919 = x920, x919_p_0 = 0;
		...
		for (y730 = y731, y730_p_1 = y731_p_0, y730_p_0 = 0;
			y730 < y731 + 28;
			y730 += 28, y730_p_1 += 28, y730_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 28) (56 / 2)
			for (x918 = x919, x918_p_1 = x919_p_0, x918_p_0 = 0;
				...
				for (f = f356, fp_0 = 0;
					...
					for (y = y730, yp_2 = y730_p_1, yp_1 = y730_p_0, yp_0 = 0;
						...
						// T (x, 1) (2 / 2)
						for (x917 = x918, x917_p_2 = x918_p_1, x917_p_1 = x918_p_0, x917_p_0 = 0;
							x917 < x918 + 2;
							x917 += 2, x917_p_2 += 2, x917_p_1 += 2, x917_p_0 += 2){
							// y = 7, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c561 = c562, c561_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x917, xp_3 = x917_p_2, xp_2 = x917_p_1, xp_1 = x917_p_0, xp_0 = 0;
									x < x917 + 2;
