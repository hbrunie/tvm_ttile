...
*/
IND_TYPE c, cp_0, c423_p_0, cp_1, c423, f, fp_0, f243_p_0, fp_1, f243, w, wp_0, x, xp_0, y, yp_0;
				...
				for (x = x222, xp_0 = 0;
					...
					for (w = w176, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								mem_vec_2379 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_2380 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_2381 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_2382 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_2383 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								for (c = c423, cp_1 = c423_p_0, cp_0 = 0;
									...
									vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_2379);
									mem_vec_2379 = vec_19;
									scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
									vec_22 = _mm512_set1_ps(scal_10);


									vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_2380);
									mem_vec_2380 = vec_21;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_2379);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_2380);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_2381);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2382);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_2383);
					}
				}
			}
		}
