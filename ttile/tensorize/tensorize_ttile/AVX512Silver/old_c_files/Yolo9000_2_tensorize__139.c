...
[V f; U (4, f); U (2, y); U (3, w); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, c); T (2, x); T (1, y); T (17, y); T (136, x); T (8, y)]
*/
IND_TYPE c, cp_0, c225_p_0, cp_1, c225, h, hp_0, x, xp_0, x300_p_0, x301_p_0, xp_1, x300_p_1, xp_2, x300, x301, y, yp_0, y300_p_0, y301_p_0, yp_1, y300_p_1, yp_2, y300, y301;
IND_TYPE y302 = 0;
IND_TYPE x302 = 0;
IND_TYPE h108 = 0;
IND_TYPE w = 0;
...
__m512 mem_vec_600 ,mem_vec_601 ,mem_vec_602 ,mem_vec_603 ,mem_vec_604 ,mem_vec_605 ,mem_vec_606 ,mem_vec_607 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
						...
						for (h = h108, hp_0 = 0;h < h108 + 3;h += 1, hp_0 += 1){
							...
							for (x = x300, xp_2 = x300_p_1, xp_1 = x300_p_0, xp_0 = 0;x < x300 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c225, cp_1 = c225_p_0, cp_0 = 0;c < c225 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_600);
											mem_vec_600 = vec_14;
											vec_18 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_601);
											mem_vec_601 = vec_17;
											vec_20 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_602);
											mem_vec_602 = vec_19;
											vec_22 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_603);
											mem_vec_603 = vec_21;
											scal_3 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
											vec_24 = _mm512_set1_ps(scal_3);
											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_604);
											mem_vec_604 = vec_23;
											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_605);
											mem_vec_605 = vec_25;
											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_606);
											mem_vec_606 = vec_26;
											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_607);
											mem_vec_607 = vec_27;
											scal_4 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
											vec_29 = _mm512_set1_ps(scal_4);
											vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_600);
											mem_vec_600 = vec_28;
											vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_601);
											mem_vec_601 = vec_31;
											vec_34 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_602);
											mem_vec_602 = vec_33;
											vec_36 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_603);
											mem_vec_603 = vec_35;
											scal_5 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_5);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_604);
											mem_vec_604 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_605);
											mem_vec_605 = vec_39;
											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_606);
											mem_vec_606 = vec_40;
											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_607);
											mem_vec_607 = vec_41;
										}
