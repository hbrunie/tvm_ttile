...
[V f; U (2, f); ULambda y; T (3, c); Hoist_vars [c]; T (4, x); T (1, c);
  ...
  T (1, y)]
*/
IND_TYPE c, cp_0, c537_p_0, cp_1, c537, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x526_p_0, xp_1, x526, y, yp_0, y537_p_0, yp_1, y537;
...
for (y537 = y538, y537_p_0 = 0;
	...
	for (f = f347, fp_0 = 0;
		...
		f += 32, fp_0 += 32){
			...
			for (y = y537 + 28, yp_1 = y537_p_0, yp_0 = 0;
				y < y537 + 28 + 84;
