...
[V f; U (4, f); U (2, y); U (3, h); T (8, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (4, c); T (17, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c42_p_0, cp_1, c42, w, wp_0, x, xp_0, x56_p_0, x57_p_0, xp_1, x56_p_1, xp_2, x56, x57, y, yp_0, y56_p_0, y57_p_0, yp_1, y56_p_1, yp_2, y56, y57;
...
for (y57 = y58, y57_p_0 = 0;
	...
	for (x57 = x58, x57_p_0 = 0;
		...
		for (y56 = y57, y56_p_1 = y57_p_0, y56_p_0 = 0;
			y56 < y57 + 272;
			y56 += 272, y56_p_1 += 272, y56_p_0 += 272){
			// y = 272, x = 34, h = 3, w = 3, c = 32, f = 64
			// T (y, 136) (272 / 2)
