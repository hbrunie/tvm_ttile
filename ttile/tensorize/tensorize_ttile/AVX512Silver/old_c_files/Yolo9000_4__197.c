							...
							for (x = x156, xp_2 = x156_p_1, xp_1 = x156_p_0, xp_0 = 0;
								...
								for (h = h42, hp_0 = 0;
									...
									h += 1, hp_0 += 1){
											...
											mem_vec_1872 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_1873 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 32
											// T (c, 16) (16 / 1)
											for (c = c117, cp_1 = c117_p_0, cp_0 = 0;
												c < c117 + 16;
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1872);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_1873);
								}
							}
						}
					}
