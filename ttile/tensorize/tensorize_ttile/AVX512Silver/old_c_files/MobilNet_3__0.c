...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (128, c); Hoist_vars [c];
  T (14, x); T (1, c); T (1, f); T (14, y); T (4, x); T (1, f); T (8, f)]
*/
IND_TYPE c, cp_0, c213_p_0, cp_1, c213, f, fp_0, f162_p_0, f163_p_0, fp_1, f162_p_1, fp_2, f162, f163, x, xp_0, x243_p_0, xp_1, x243, y, yp_0;
...
for (f163 = f164, f163_p_0 = 0;
	...
	for (f162 = f163, f162_p_1 = f163_p_0, f162_p_0 = 0;
		f162 < f163 + 16;
		f162 += 16, f162_p_1 += 16, f162_p_0 += 16){
		// y = 56, x = 56, h = 3, w = 3, c = 128, f = 16
		// T (x, 4) (56 / 14)
					...
					for (c213 = c214, c213_p_0 = 0;
						...
						for (x = x243, xp_1 = x243_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1349 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1350 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_1351 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c213, cp_1 = c213_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1349);
										mem_vec_1349 = vec_3;
