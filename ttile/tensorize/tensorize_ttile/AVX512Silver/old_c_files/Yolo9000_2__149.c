...
[V f; U (4, f); U (2, y); U (3, h); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, c); T (34, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c57_p_0, cp_1, c57, w, wp_0, x, xp_0, x76_p_0, x77_p_0, xp_1, x76_p_1, xp_2, x76, x77, y, yp_0, y76_p_0, y77_p_0, yp_1, y76_p_1, yp_2, y76, y77;
...
for (y77 = y78, y77_p_0 = 0;
	...
	for (x77 = x78, x77_p_0 = 0;
		...
		for (y76 = y77, y76_p_1 = y77_p_0, y76_p_0 = 0;
			y76 < y77 + 272;
			y76 += 272, y76_p_1 += 272, y76_p_0 += 272){
			// y = 272, x = 34, h = 3, w = 3, c = 32, f = 64
			// T (y, 136) (272 / 2)
							...
							for (x = x76, xp_2 = x76_p_1, xp_1 = x76_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c57, cp_1 = c57_p_0, cp_0 = 0;
											...
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_154);
											mem_vec_154 = vec_19;

											vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_155);
											mem_vec_155 = vec_21;
											scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_24 = _mm512_set1_ps(scal_3);


											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_156);
											mem_vec_156 = vec_23;



											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_157);
											mem_vec_157 = vec_25;



											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_158);
											mem_vec_158 = vec_26;



											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_159);
											mem_vec_159 = vec_27;
											...
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_154);
											mem_vec_154 = vec_33;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_155);
											mem_vec_155 = vec_35;
											scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_38 = _mm512_set1_ps(scal_5);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_156);
											mem_vec_156 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_157);
											mem_vec_157 = vec_39;



											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_158);
											mem_vec_158 = vec_40;



											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_159);
											mem_vec_159 = vec_41;
										}
