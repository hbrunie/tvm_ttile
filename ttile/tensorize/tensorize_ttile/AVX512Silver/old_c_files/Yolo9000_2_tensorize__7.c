...
c171_p_0 = 0;
						for (h = h72, hp_0 = 0;h < h72 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 2) (2 / 1)
							for (x = x228, xp_2 = x228_p_1, xp_1 = x228_p_0, xp_0 = 0;x < x228 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_456 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_457 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
										mem_vec_458 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
										mem_vec_459 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
										...
										mem_vec_462 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
										mem_vec_463 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_458);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_459);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_462);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_463);
							}
						}
}
