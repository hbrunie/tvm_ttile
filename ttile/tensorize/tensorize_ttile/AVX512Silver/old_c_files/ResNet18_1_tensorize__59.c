...
x454 = 0;
x454_p_0 = 0;
				for (h = h310, hp_0 = 0;h < h310 + 7;h += 1, hp_0 += 1){
					// y = 8, x = 7, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w310, wp_0 = 0;w < w310 + 7;w += 1, wp_0 += 1){
						// y = 8, x = 7, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c465 = c466, c465_p_0 = 0;c465 < c466 + 3;c465 += 3, c465_p_0 += 3){
							// y = 8, x = 7, h = 1, w = 1, c = 3, f = 32
							// T (x, 7) (7 / 1)
							for (x = x454, xp_1 = x454_p_0, xp_0 = 0;x < x454 + 7;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c465, cp_1 = c465_p_0, cp_0 = 0;c < c465 + 3;c += 1, cp_1 += 1, cp_0 += 1){
