...
x152 = 0;
x152_p_0 = 0;
		for (f = f180, fp_0 = 0;f < f180 + 512;f += 32, fp_0 += 32){
				for (y = y107, yp_1 = y107_p_0, yp_0 = 0;y < y107 + 18;y += 6, yp_1 += 6, yp_0 += 6){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (c, 8) (256 / 32)
					for (c156 = c157, c156_p_0 = 0;c156 < c157 + 256;c156 += 32, c156_p_0 += 32){
						// y = ph_y, x = 34, h = 3, w = 3, c = 32, f = 32
						// T (w, 3) (3 / 1)
						for (w = w55, wp_0 = 0;w < w55 + 3;w += 1, wp_0 += 1){
							// y = ph_y, x = 34, h = 3, w = 1, c = 32, f = 32
							// T (x, 34) (34 / 1)
							for (x = x152, xp_1 = x152_p_0, xp_0 = 0;x < x152 + 34;x += 1, xp_1 += 1, xp_0 += 1){
				...
				for (y = y107 + 18, yp_1 = y107_p_0, yp_0 = 0;y < y107 + 18 + 16;y += 8, yp_1 += 8, yp_0 += 8){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (c, 8) (256 / 32)
					for (c156 = c157, c156_p_0 = 0;c156 < c157 + 256;c156 += 32, c156_p_0 += 32){
						// y = ph_y, x = 34, h = 3, w = 3, c = 32, f = 32
