...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  T (14, x); T (8, c); T (1, f); T (14, y); T (4, x); T (4, f); T (2, f)]
*/
IND_TYPE c, cp_0, c243_p_0, cp_1, c243, f, fp_0, f202_p_0, f203_p_0, fp_1, f202_p_1, fp_2, f202, f203, x, xp_0, x273_p_0, xp_1, x273, y, yp_0;
...
for (f203 = f204, f203_p_0 = 0;
	...
	for (f202 = f203, f202_p_1 = f203_p_0, f202_p_0 = 0;
		f202 < f203 + 64;
		f202 += 16, f202_p_1 += 16, f202_p_0 += 16){
						...
						for (x = x273, xp_1 = x273_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c243, cp_1 = c243_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1389);
										mem_vec_1389 = vec_3;
