...
x436 = 0;
x436_p_0 = 0;
				for (h = h298, hp_0 = 0;h < h298 + 7;h += 1, hp_0 += 1){
					// y = 8, x = 8, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w298, wp_0 = 0;w < w298 + 7;w += 1, wp_0 += 1){
						// y = 8, x = 8, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c447 = c448, c447_p_0 = 0;c447 < c448 + 3;c447 += 3, c447_p_0 += 3){
							// y = 8, x = 8, h = 1, w = 1, c = 3, f = 32
							// T (x, 8) (8 / 1)
							for (x = x436, xp_1 = x436_p_0, xp_0 = 0;x < x436 + 8;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c447, cp_1 = c447_p_0, cp_0 = 0;c < c447 + 3;c += 1, cp_1 += 1, cp_0 += 1){
