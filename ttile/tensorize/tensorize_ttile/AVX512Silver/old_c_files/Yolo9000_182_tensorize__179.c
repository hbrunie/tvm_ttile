...
c640_p_1 = 0;
						for (x = x320, xp_0 = 0;x < x320 + 17;x += 1, xp_0 += 1){
									mem_vec_2807 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									...
									mem_vec_2811 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
									mem_vec_2812 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
									mem_vec_2813 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_2807);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_2811);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_2812);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_2813);
