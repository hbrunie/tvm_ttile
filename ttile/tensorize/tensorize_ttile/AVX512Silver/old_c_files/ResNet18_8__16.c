...
*/
IND_TYPE c, cp_0, c261_p_0, cp_1, c261, f, fp_0, f261_p_0, fp_1, f261, w, wp_0, x, xp_0, y, yp_0;
				...
				for (x = x229, xp_0 = 0;
					...
					for (w = w139, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								mem_vec_1699 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_1700 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_1701 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_1702 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_1703 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								for (c = c261, cp_1 = c261_p_0, cp_0 = 0;
									...
									vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_1700);
									mem_vec_1700 = vec_21;
									scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
									vec_24 = _mm512_set1_ps(scal_11);


									vec_23 = _mm512_fmadd_ps(vec_24, vec_2, mem_vec_1701);
									mem_vec_1701 = vec_23;
									scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
									vec_26 = _mm512_set1_ps(scal_12);


									vec_25 = _mm512_fmadd_ps(vec_26, vec_2, mem_vec_1702);
									mem_vec_1702 = vec_25;
									scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
									vec_28 = _mm512_set1_ps(scal_13);


									vec_27 = _mm512_fmadd_ps(vec_28, vec_2, mem_vec_1703);
									mem_vec_1703 = vec_27;
									...
									vec_32 = _mm512_fmadd_ps(vec_33, vec_31, mem_vec_1691);
									mem_vec_1691 = vec_32;
									...
									vec_36 = _mm512_fmadd_ps(vec_37, vec_31, mem_vec_1693);
									mem_vec_1693 = vec_36;
									scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
									vec_39 = _mm512_set1_ps(scal_18);


									vec_38 = _mm512_fmadd_ps(vec_39, vec_31, mem_vec_1694);
									mem_vec_1694 = vec_38;
									scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
									vec_41 = _mm512_set1_ps(scal_19);


									vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_1695);
									mem_vec_1695 = vec_40;
									scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
									vec_43 = _mm512_set1_ps(scal_20);


									vec_42 = _mm512_fmadd_ps(vec_43, vec_31, mem_vec_1696);
									mem_vec_1696 = vec_42;
									scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
									vec_45 = _mm512_set1_ps(scal_21);


									vec_44 = _mm512_fmadd_ps(vec_45, vec_31, mem_vec_1697);
									mem_vec_1697 = vec_44;
									scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
									vec_47 = _mm512_set1_ps(scal_22);


									vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_1698);
									mem_vec_1698 = vec_46;
									scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
									vec_49 = _mm512_set1_ps(scal_23);


									vec_48 = _mm512_fmadd_ps(vec_49, vec_31, mem_vec_1699);
									mem_vec_1699 = vec_48;
									scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
									vec_51 = _mm512_set1_ps(scal_24);


									vec_50 = _mm512_fmadd_ps(vec_51, vec_31, mem_vec_1700);
									mem_vec_1700 = vec_50;
									scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
									vec_53 = _mm512_set1_ps(scal_25);


									vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_1701);
									mem_vec_1701 = vec_52;
									scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h + 1) + c];
									vec_55 = _mm512_set1_ps(scal_26);


									vec_54 = _mm512_fmadd_ps(vec_55, vec_31, mem_vec_1702);
									mem_vec_1702 = vec_54;
									scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h + 1) + c];
									vec_57 = _mm512_set1_ps(scal_27);


									vec_56 = _mm512_fmadd_ps(vec_57, vec_31, mem_vec_1703);
									mem_vec_1703 = vec_56;
									...
									vec_61 = _mm512_fmadd_ps(vec_62, vec_60, mem_vec_1691);
									mem_vec_1691 = vec_61;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_1699);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_1700);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1701);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1702);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1703);
					}
				}
			}
		}
