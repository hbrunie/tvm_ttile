...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (7, x); T (4, f); T (32, c); T (1, c); T (16, f)]
*/
IND_TYPE c, cp_0, c160_p_0, c161_p_0, cp_1, c160_p_1, cp_2, c160, c161, f, fp_0, f120_p_0, fp_1, f120, x, xp_0;
			...
			for (f = f120, fp_1 = f120_p_0, fp_0 = 0;
				...
				for (x = x80, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_725 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
							mem_vec_726 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
							mem_vec_727 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
							...
							for (c = c160, cp_2 = c160_p_1, cp_1 = c160_p_0, cp_0 = 0;
								...
								vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_722);
								mem_vec_722 = vec_3;
								...
								vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_724);
								mem_vec_724 = vec_7;
						...
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_725);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_726);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_727);
				}
			}
		}
	}
