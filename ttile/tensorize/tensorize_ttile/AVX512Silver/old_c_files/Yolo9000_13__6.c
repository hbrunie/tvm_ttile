...
for (y250 = y251, y250_p_0 = 0;
	...
	for (x369 = x370, x369_p_0 = 0;
		...
		for (f = f184, fp_0 = 0;
			f < f184 + 256;
			f += 32, fp_0 += 32){
				for (y = y250, yp_1 = y250_p_0, yp_0 = 0;
					y < y250 + 22;
						...
						for (c276 = c277, c276_p_0 = 0;
							...
							for (x = x368, xp_2 = x368_p_1, xp_1 = x368_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4156 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
										mem_vec_4157 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
										// T (c, 128) (128 / 1)
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_4156);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_4157);
							}
						}
					}
				}
				for (y = y250 + 22, yp_1 = y250_p_0, yp_0 = 0;
					y < y250 + 22 + 12;
						...
						for (c276 = c277, c276_p_0 = 0;
							...
							for (x = x368, xp_2 = x368_p_1, xp_1 = x368_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4180 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_4181 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
										// T (c, 128) (128 / 1)
										for (c = c276, cp_1 = c276_p_0, cp_0 = 0;
											c < c276 + 128;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_4180);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_4181);
							}
						}
					}
				}
