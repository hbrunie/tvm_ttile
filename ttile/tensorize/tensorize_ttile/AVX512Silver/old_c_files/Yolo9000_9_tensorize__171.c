...
y234 = 0;
y234_p_0 = 0;
	for (x313 = x314, x313_p_0 = 0;x313 < x314 + 68;x313 += 34, x313_p_0 += 34){
			for (y = y234, yp_1 = y234_p_0, yp_0 = 0;y < y234 + 9;y += 3, yp_1 += 3, yp_0 += 3){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
				for (x312 = x313, x312_p_1 = x313_p_0, x312_p_0 = 0;x312 < x313 + 34;x312 += 34, x312_p_1 += 34, x312_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f156, fp_0 = 0;f < f156 + 128;f += 64, fp_0 += 64){
						// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 64
						// T (c, 1) (256 / 256)
						for (c234 = c235, c234_p_0 = 0;c234 < c235 + 256;c234 += 256, c234_p_0 += 256){
							// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 64
							// T (x, 34) (34 / 1)
							for (x = x312, xp_2 = x312_p_1, xp_1 = x312_p_0, xp_0 = 0;x < x312 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y234 + 9, yp_1 = y234_p_0, yp_0 = 0;y < y234 + 9 + 8;y += 4, yp_1 += 4, yp_0 += 4){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
				for (x312 = x313, x312_p_1 = x313_p_0, x312_p_0 = 0;x312 < x313 + 34;x312 += 34, x312_p_1 += 34, x312_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
