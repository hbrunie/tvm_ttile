...
[V f; U (4, f); U (2, y); U (3, w); T (8, c); Hoist_vars [c]; T (17, x);
  T (3, h); T (4, c); T (2, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c150_p_0, cp_1, c150, h, hp_0, x, xp_0, x200_p_0, x201_p_0, xp_1, x200_p_1, xp_2, x200, x201, y, yp_0, y200_p_0, y201_p_0, yp_1, y200_p_1, yp_2, y200, y201;
IND_TYPE y202 = 0;
IND_TYPE x202 = 0;
IND_TYPE h58 = 0;
IND_TYPE w = 0;
						...
						for (h = h58, hp_0 = 0;h < h58 + 3;h += 1, hp_0 += 1){
							...
							for (x = x200, xp_2 = x200_p_1, xp_1 = x200_p_0, xp_0 = 0;x < x200 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c150, cp_1 = c150_p_0, cp_0 = 0;c < c150 + 8;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_402);
											mem_vec_402 = vec_19;
											vec_22 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_403);
											mem_vec_403 = vec_21;
											scal_3 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
											vec_24 = _mm512_set1_ps(scal_3);
											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_404);
											mem_vec_404 = vec_23;
											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_405);
											mem_vec_405 = vec_25;
											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_406);
											mem_vec_406 = vec_26;
											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_407);
											mem_vec_407 = vec_27;
											...
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_402);
											mem_vec_402 = vec_33;
											vec_36 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_403);
											mem_vec_403 = vec_35;
											scal_5 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_5);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_404);
											mem_vec_404 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_405);
											mem_vec_405 = vec_39;
											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_406);
											mem_vec_406 = vec_40;
											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_407);
											mem_vec_407 = vec_41;
										}
