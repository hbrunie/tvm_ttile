...
for (x341 = x342, x341_p_0 = 0;
	...
	for (y = y234, yp_0 = 0;
		...
		for (x340 = x341, x340_p_1 = x341_p_0, x340_p_0 = 0;
			x340 < x341 + 14;
			x340 += 14, x340_p_1 += 14, x340_p_0 += 14){
			// y = 14, x = 14, h = 3, w = 3, c = 128, f = 128
			// T (f, 4) (128 / 32)
			for (f = f270, fp_0 = 0;
				f < f270 + 128;
						...
						for (x = x340, xp_2 = x340_p_1, xp_1 = x340_p_0, xp_0 = 0;
							...
							for (h = h144, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										mem_vec_1785 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
										mem_vec_1786 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_1787 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										mem_vec_1788 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
										mem_vec_1789 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
										mem_vec_1790 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_1791 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_1785);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1786);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_1787);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1788);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_1789);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1790);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_1791);
							}
						}
					}
				}
