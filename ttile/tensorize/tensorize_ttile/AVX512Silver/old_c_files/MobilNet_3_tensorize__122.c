...
c108_p_0 = 0;
				for (h = h55, hp_0 = 0;h < h55 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 56) (56 / 1)
					for (x = x123, xp_1 = x123_p_0, xp_0 = 0;x < x123 + 56;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_764 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 64]);
								mem_vec_765 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 80]);
								mem_vec_766 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 96]);
								mem_vec_767 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 112]);
								...
								mem_vec_772 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 64]);
								mem_vec_773 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 80]);
								mem_vec_774 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 96]);
								mem_vec_775 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 112]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 64], mem_vec_764);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 80], mem_vec_765);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 96], mem_vec_766);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 112], mem_vec_767);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 64], mem_vec_772);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 80], mem_vec_773);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 96], mem_vec_774);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 112], mem_vec_775);
					}
				}
}
