...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  T (7, x); T (32, f); T (16, c); T (1, c); T (2, f)]
*/
IND_TYPE c, cp_0, c708_p_0, c709_p_0, cp_1, c708_p_1, cp_2, c708, c709, f, fp_0, f531_p_0, fp_1, f531, x, xp_0;
...
for (f531 = f532, f531_p_0 = 0;
	...
	for (c709 = c710, c709_p_0 = 0;
		c709 < c710 + 1024;
		c709 += 1024, c709_p_0 += 1024){
		// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 512
		// T (c, 16) (1024 / 64)
		for (c708 = c709, c708_p_1 = c709_p_0, c708_p_0 = 0;
			c708 < c709 + 1024;
			c708 += 64, c708_p_1 += 64, c708_p_0 += 64){
