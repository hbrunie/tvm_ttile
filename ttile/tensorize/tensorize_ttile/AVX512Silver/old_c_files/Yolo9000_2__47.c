...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (8, c); Hoist_vars [c];
  T (1, x); T (4, c); T (1, x); T (17, y); T (4, f); T (272, x); T (1, y);
  T (4, y)]
*/
IND_TYPE c, cp_0, c438_p_0, cp_1, c438, f, fp_0, x, xp_0, x584_p_0, x585_p_0, xp_1, x584_p_1, xp_2, x584, x585, y, yp_0, y578_p_0, y579_p_0, yp_1, y578_p_1, yp_2, y578, y579;
...
for (y579 = y580, y579_p_0 = 0;
	...
	// T (y, 1) (68 / 68)
	for (y578 = y579, y578_p_1 = y579_p_0, y578_p_0 = 0;
		y578 < y579 + 68;
		y578 += 68, y578_p_1 += 68, y578_p_0 += 68){
		// y = 68, x = 272, h = 3, w = 3, c = 32, f = 64
		// T (x, 272) (272 / 1)
		for (x585 = x586, x585_p_0 = 0;
			...
			for (f = f166, fp_0 = 0;
				...
				// T (y, 17) (68 / 4)
				for (y = y578, yp_2 = y578_p_1, yp_1 = y578_p_0, yp_0 = 0;
					y < y578 + 68;
						...
						for (c438 = c439, c438_p_0 = 0;
							...
							for (x = x584, xp_2 = x584_p_1, xp_1 = x584_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1257 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										...
										for (c = c438, cp_1 = c438_p_0, cp_0 = 0;
											...
											vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1257);
											mem_vec_1257 = vec_3;
