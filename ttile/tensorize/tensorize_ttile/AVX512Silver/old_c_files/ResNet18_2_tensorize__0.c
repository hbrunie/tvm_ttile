...
c63_p_0 = 0;
				for (h = h28, hp_0 = 0;h < h28 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 56) (56 / 1)
					for (x = x77, xp_1 = x77_p_0, xp_0 = 0;x < x77 + 56;x += 1, xp_1 += 1, xp_0 += 1){
								mem_vec_444 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
								mem_vec_445 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
								mem_vec_446 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
								mem_vec_447 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
								...
								mem_vec_450 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
								mem_vec_451 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
								...
								mem_vec_454 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
								mem_vec_455 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
								...
								mem_vec_458 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
								mem_vec_459 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_446);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_447);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_450);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_451);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_454);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_455);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_458);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_459);
					}
				}
}
