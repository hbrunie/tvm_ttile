...
[V f; U (1, f); U (7, y); U (3, h); T (64, c); Hoist_vars [c]; T (3, w);
  T (28, x); T (2, c); T (8, f); T (4, y); T (2, f)]
*/
IND_TYPE c, cp_0, c570_p_0, cp_1, c570, f, fp_0, f570_p_0, fp_1, f570, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y380 = 0;
IND_TYPE x459 = 0;
IND_TYPE h = 0;
IND_TYPE w283 = 0;
