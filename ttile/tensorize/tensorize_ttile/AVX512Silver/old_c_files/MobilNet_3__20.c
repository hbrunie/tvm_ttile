...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (14, x); T (4, c); T (1, f); T (14, y); T (4, x); T (2, f); T (4, f)]
*/
IND_TYPE c, cp_0, c234_p_0, cp_1, c234, f, fp_0, f190_p_0, f191_p_0, fp_1, f190_p_1, fp_2, f190, f191, x, xp_0, x264_p_0, xp_1, x264, y, yp_0;
...
for (f191 = f192, f191_p_0 = 0;
	...
	for (f190 = f191, f190_p_1 = f191_p_0, f190_p_0 = 0;
		f190 < f191 + 32;
		f190 += 16, f190_p_1 += 16, f190_p_0 += 16){
					...
					for (c234 = c235, c234_p_0 = 0;
						...
						for (x = x264, xp_1 = x264_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1377 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1378 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_1379 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c234, cp_1 = c234_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1377);
										mem_vec_1377 = vec_3;
