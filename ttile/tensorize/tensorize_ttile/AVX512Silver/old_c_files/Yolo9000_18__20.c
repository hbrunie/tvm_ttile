...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  ...
  T (8, c); T (2, f)]
*/
IND_TYPE c, cp_0, c536_p_0, c537_p_0, cp_1, c536_p_1, cp_2, c536, c537, f, fp_0, f402_p_0, fp_1, f402, x, xp_0, y, yp_0;
						...
						for (x = x268, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c536, cp_2 = c536_p_1, cp_1 = c536_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2427);
										mem_vec_2427 = vec_3;
				...
				for (y = y268 + 12, yp_0 = 0;
					...
					for (c536 = c537, c536_p_1 = c537_p_0, c536_p_0 = 0;
						...
						for (x = x268, xp_0 = 0;
							x < x268 + 17;
							x += 1, xp_0 += 1){
									mem_vec_2430 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_2431 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
