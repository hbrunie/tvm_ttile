...
[V f; U (4, f); ULambda y; T (128, c); Hoist_vars [c]; T (17, x); T (8, c);
  ...
  T (1, c); T (1, y)]
*/
IND_TYPE c, cp_0, c48_p_0, c49_p_0, cp_1, c48_p_1, cp_2, c48, c49, f, fp_0, x, xp_0, y, yp_0, y36_p_0, yp_1, y36;
			...
			f += 64, fp_0 += 64){
				for (y = y36, yp_1 = y36_p_0, yp_0 = 0;
					...
					for (c48 = c49, c48_p_1 = c49_p_0, c48_p_0 = 0;
						c48 < c49 + 1024;
						c48 += 128, c48_p_1 += 128, c48_p_0 += 128){
						...
						for (x = x24, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_498 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32]);
									mem_vec_499 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32], mem_vec_498);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48], mem_vec_499);
						}
					}
				}
				for (y = y36 + 5, yp_1 = y36_p_0, yp_0 = 0;
					y < y36 + 5 + 12;
					y += 6, yp_1 += 6, yp_0 += 6){
					// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 64
					// T (c, 8) (1024 / 128)
					for (c48 = c49, c48_p_1 = c49_p_0, c48_p_0 = 0;
						...
						for (x = x24, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_522 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32]);
									mem_vec_523 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 64
									// T (c, 128) (128 / 1)
									for (c = c48, cp_2 = c48_p_1, cp_1 = c48_p_0, cp_0 = 0;
										c < c48 + 128;
										...
										vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_520);
										mem_vec_520 = vec_29;



										vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_521);
										mem_vec_521 = vec_31;



										vec_32 = _mm512_fmadd_ps(vec_30, vec_6, mem_vec_522);
										mem_vec_522 = vec_32;



										vec_33 = _mm512_fmadd_ps(vec_30, vec_8, mem_vec_523);
										mem_vec_523 = vec_33;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32], mem_vec_522);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48], mem_vec_523);
						}
					}
				}
		}
