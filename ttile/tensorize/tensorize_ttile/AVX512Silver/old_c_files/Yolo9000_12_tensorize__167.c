...
c39_p_1 = 0;
						for (h = h24, hp_0 = 0;h < h24 + 3;h += 1, hp_0 += 1){
							...
							for (x = x36, xp_1 = x36_p_0, xp_0 = 0;x < x36 + 34;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_124 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 64]);
										mem_vec_125 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 80]);
										mem_vec_126 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 96]);
										mem_vec_127 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 112]);
										mem_vec_128 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_129 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16]);
										mem_vec_130 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
										mem_vec_131 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
										mem_vec_132 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 64]);
										mem_vec_133 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 80]);
										mem_vec_134 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 96]);
										mem_vec_135 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 112]);
										// y = 2, x = 1, h = 1, w = 3, c = 128, f = 128
										// T (c, 128) (128 / 1)
										for (c = c39, cp_2 = c39_p_1, cp_1 = c39_p_0, cp_0 = 0;c < c39 + 128;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 64], mem_vec_124);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 80], mem_vec_125);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 96], mem_vec_126);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 112], mem_vec_127);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_128);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16], mem_vec_129);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_130);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_131);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 64], mem_vec_132);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 80], mem_vec_133);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 96], mem_vec_134);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 112], mem_vec_135);
							}
						}
}
