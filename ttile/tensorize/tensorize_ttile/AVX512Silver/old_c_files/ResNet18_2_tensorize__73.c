...
*/
IND_TYPE c, cp_0, c183_p_0, cp_1, c183, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x218_p_0, x219_p_0, xp_1, x218_p_1, xp_2, x218, x219, y, yp_0;
IND_TYPE y148 = 0;
IND_TYPE x220 = 0;
IND_TYPE h90 = 0;
IND_TYPE w86 = 0;
...
c183_p_0 = 0;
					for (w = w86, wp_0 = 0;w < w86 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 28) (28 / 1)
						for (x = x218, xp_2 = x218_p_1, xp_1 = x218_p_0, xp_0 = 0;x < x218 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
