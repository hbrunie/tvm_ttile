...
[V f; U (1, f); U (7, y); U (3, w); T (128, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (4, f); T (1, y); T (4, c); T (2, c); T (16, f)]
*/
...
fp_1 = 0;
					for (h = h290, hp_0 = 0;h < h290 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 7) (7 / 1)
						for (x = x394, xp_0 = 0;x < x394 + 7;x += 1, xp_0 += 1){
									...
									// T (c, 128) (128 / 1)
									for (c = c788, cp_2 = c788_p_1, cp_1 = c788_p_0, cp_0 = 0;c < c788 + 128;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
