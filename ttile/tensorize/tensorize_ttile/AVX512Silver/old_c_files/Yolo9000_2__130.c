...
[V f; U (4, f); U (2, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, c); T (34, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c60_p_0, cp_1, c60, w, wp_0, x, xp_0, x80_p_0, x81_p_0, xp_1, x80_p_1, xp_2, x80, x81, y, yp_0, y80_p_0, y81_p_0, yp_1, y80_p_1, yp_2, y80, y81;
...
for (y81 = y82, y81_p_0 = 0;
	...
	for (x81 = x82, x81_p_0 = 0;
		...
		for (y80 = y81, y80_p_1 = y81_p_0, y80_p_0 = 0;
			y80 < y81 + 272;
			y80 += 272, y80_p_1 += 272, y80_p_0 += 272){
			// y = 272, x = 34, h = 3, w = 3, c = 32, f = 64
			// T (y, 136) (272 / 2)
							...
							for (x = x80, xp_2 = x80_p_1, xp_1 = x80_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c60, cp_1 = c60_p_0, cp_0 = 0;
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_160);
											mem_vec_160 = vec_14;

											vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_161);
											mem_vec_161 = vec_17;

											vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_162);
											mem_vec_162 = vec_19;

											vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_163);
											mem_vec_163 = vec_21;
											scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_24 = _mm512_set1_ps(scal_3);


											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_164);
											mem_vec_164 = vec_23;



											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_165);
											mem_vec_165 = vec_25;



											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_166);
											mem_vec_166 = vec_26;



											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_167);
											mem_vec_167 = vec_27;
											scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_29 = _mm512_set1_ps(scal_4);
											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_160);
											mem_vec_160 = vec_28;

											vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_161);
											mem_vec_161 = vec_31;

											vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_162);
											mem_vec_162 = vec_33;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_163);
											mem_vec_163 = vec_35;
											scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_38 = _mm512_set1_ps(scal_5);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_164);
											mem_vec_164 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_165);
											mem_vec_165 = vec_39;



											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_166);
											mem_vec_166 = vec_40;



											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_167);
											mem_vec_167 = vec_41;
										}
