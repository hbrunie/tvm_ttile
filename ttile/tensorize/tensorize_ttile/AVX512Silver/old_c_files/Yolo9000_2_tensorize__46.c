...
[V f; U (4, f); U (2, y); U (3, h); T (32, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (1, c); T (2, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c18_p_0, cp_1, c18, w, wp_0, x, xp_0, x24_p_0, x25_p_0, xp_1, x24_p_1, xp_2, x24, x25, y, yp_0, y24_p_0, y25_p_0, yp_1, y24_p_1, yp_2, y24, y25;
IND_TYPE y26 = 0;
IND_TYPE x26 = 0;
IND_TYPE h = 0;
IND_TYPE w12 = 0;
...
c18_p_0 = 0;
						for (w = w12, wp_0 = 0;w < w12 + 3;w += 1, wp_0 += 1){
							...
							for (x = x24, xp_2 = x24_p_1, xp_1 = x24_p_0, xp_0 = 0;x < x24 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_50 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
										mem_vec_51 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
										...
										mem_vec_54 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
										mem_vec_55 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_50);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_51);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_54);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_55);
							}
						}
}
