...
for (y410 = y411, y410_p_0 = 0;
	...
	for (x416 = x417, x416_p_0 = 0;
		...
		// T (y, 34) (68 / 2)
		for (y409 = y410, y409_p_1 = y410_p_0, y409_p_0 = 0;
			y409 < y410 + 68;
			y409 += 2, y409_p_1 += 2, y409_p_0 += 2){
			// y = 2, x = 1, h = 3, w = 3, c = 32, f = 64
			// T (y, 1) (2 / 2)
			for (y = y409, yp_2 = y409_p_1, yp_1 = y409_p_0, yp_0 = 0;
				y < y409 + 2;
						...
						for (w = w161, wp_0 = 0;
							...
							for (x = x415, xp_2 = x415_p_1, xp_1 = x415_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_862 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
										mem_vec_863 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_862);
									_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_863);
