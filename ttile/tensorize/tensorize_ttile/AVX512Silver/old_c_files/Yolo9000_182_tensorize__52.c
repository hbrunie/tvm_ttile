...
c552_p_1 = 0;
						for (x = x276, xp_0 = 0;x < x276 + 17;x += 1, xp_0 += 1){
									...
									mem_vec_2477 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									mem_vec_2478 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 16
									// T (c, 32) (32 / 1)
									for (c = c552, cp_2 = c552_p_1, cp_1 = c552_p_0, cp_0 = 0;c < c552 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2477);
