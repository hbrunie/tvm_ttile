...
c273_p_0 = 0;
							for (h = h169, hp_0 = 0;h < h169 + 3;h += 1, hp_0 += 1){
								...
								for (x = x273, xp_1 = x273_p_0, xp_0 = 0;x < x273 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3074 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
											mem_vec_3075 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_3074);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_3075);
								}
							}
}
