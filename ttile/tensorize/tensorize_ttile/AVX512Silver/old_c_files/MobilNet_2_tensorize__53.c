...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (56, x);
  T (3, w); T (4, c); T (1, x); T (2, y); T (7, y)]
*/
IND_TYPE c, cp_0, c54_p_0, cp_1, c54, w, wp_0, x, xp_0, x68_p_0, xp_1, x68, y, yp_0, y40_p_0, yp_1, y40;
IND_TYPE y41 = 0;
IND_TYPE x69 = 0;
IND_TYPE h = 0;
IND_TYPE w27 = 0;
...
c54_p_0 = 0;
				for (w = w27, wp_0 = 0;w < w27 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 56) (56 / 1)
					for (x = x68, xp_1 = x68_p_0, xp_0 = 0;x < x68 + 56;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_408 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								mem_vec_409 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
								mem_vec_410 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
								mem_vec_411 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
								...
								for (c = c54, cp_1 = c54_p_0, cp_0 = 0;c < c54 + 16;c += 1, cp_1 += 1, cp_0 += 1){
									...
									vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_408);
									mem_vec_408 = vec_19;
									vec_21 = _mm512_fmadd_ps(vec_20, vec_4, mem_vec_409);
									mem_vec_409 = vec_21;
									vec_22 = _mm512_fmadd_ps(vec_20, vec_6, mem_vec_410);
									mem_vec_410 = vec_22;
									vec_23 = _mm512_fmadd_ps(vec_20, vec_8, mem_vec_411);
									mem_vec_411 = vec_23;
									scal_4 = input[strideA1 * (2 * x + w) + strideA2 * (2 * y + h + 1) + c];
									vec_25 = _mm512_set1_ps(scal_4);
									vec_26 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f]);
									vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_396);
									mem_vec_396 = vec_24;
									vec_28 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
									vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_397);
									mem_vec_397 = vec_27;
									vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 32]);
									vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_398);
									mem_vec_398 = vec_29;
									vec_32 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
									vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_399);
									mem_vec_399 = vec_31;
									scal_5 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 1) + h + 1) + c];
									vec_34 = _mm512_set1_ps(scal_5);
									vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_400);
									mem_vec_400 = vec_33;
									vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_401);
									mem_vec_401 = vec_35;
									vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_402);
									mem_vec_402 = vec_36;
									vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_403);
									mem_vec_403 = vec_37;
									scal_6 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 2) + h + 1) + c];
									vec_39 = _mm512_set1_ps(scal_6);
									vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_404);
									mem_vec_404 = vec_38;
									vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_405);
									mem_vec_405 = vec_40;
									vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_406);
									mem_vec_406 = vec_41;
									vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_407);
									mem_vec_407 = vec_42;
									scal_7 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 3) + h + 1) + c];
									vec_44 = _mm512_set1_ps(scal_7);
									vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_408);
									mem_vec_408 = vec_43;
									vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_409);
									mem_vec_409 = vec_45;
									vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_410);
									mem_vec_410 = vec_46;
									vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_411);
									mem_vec_411 = vec_47;
									scal_8 = input[strideA1 * (2 * x + w) + strideA2 * (2 * y + h + 2) + c];
									vec_49 = _mm512_set1_ps(scal_8);
									vec_50 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
									vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_396);
									mem_vec_396 = vec_48;
									vec_52 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
									vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_397);
									mem_vec_397 = vec_51;
									vec_54 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 32]);
									vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_398);
									mem_vec_398 = vec_53;
									vec_56 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
									vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_399);
									mem_vec_399 = vec_55;
									scal_9 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 1) + h + 2) + c];
									vec_58 = _mm512_set1_ps(scal_9);
									vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_400);
									mem_vec_400 = vec_57;
									vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_401);
									mem_vec_401 = vec_59;
									vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_402);
									mem_vec_402 = vec_60;
									vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_403);
									mem_vec_403 = vec_61;
									scal_10 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 2) + h + 2) + c];
									vec_63 = _mm512_set1_ps(scal_10);
									vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_404);
									mem_vec_404 = vec_62;
									vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_405);
									mem_vec_405 = vec_64;
									vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_406);
									mem_vec_406 = vec_65;
									vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_407);
									mem_vec_407 = vec_66;
									scal_11 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 3) + h + 2) + c];
									vec_68 = _mm512_set1_ps(scal_11);
									vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_408);
									mem_vec_408 = vec_67;
									vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_409);
									mem_vec_409 = vec_69;
									vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_410);
									mem_vec_410 = vec_70;
									vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_411);
									mem_vec_411 = vec_71;
								}
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_408);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_409);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_410);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_411);
					}
				}
}
