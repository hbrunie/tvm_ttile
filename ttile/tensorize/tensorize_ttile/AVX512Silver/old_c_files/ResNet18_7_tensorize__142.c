...
xp_0 = 0;
					for (h = h58, hp_0 = 0;h < h58 + 3;h += 1, hp_0 += 1){
								...
								mem_vec_949 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
								mem_vec_950 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
								mem_vec_951 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_949);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_950);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_951);
					}
}
