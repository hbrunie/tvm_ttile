				...
				for (w = w27, wp_0 = 0;
					...
					for (x = x68, xp_1 = x68_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_408 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
								mem_vec_409 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
								mem_vec_410 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32]);
								mem_vec_411 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48]);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_408);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_409);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 32], mem_vec_410);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 48], mem_vec_411);
					}
				}
			}
		}
