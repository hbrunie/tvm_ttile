...
x207_p_0 = 0;
		for (f = f116, fp_0 = 0;f < f116 + 64;f += 32, fp_0 += 32){
				for (y = y207, yp_1 = y207_p_0, yp_0 = 0;y < y207 + 40;y += 8, yp_1 += 8, yp_0 += 8){
					// y = ph_y, x = 2, h = 1, w = 1, c = 128, f = 32
					// T (x, 2) (2 / 1)
					for (x = x207, xp_1 = x207_p_0, xp_0 = 0;x < x207 + 2;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 128) (128 / 1)
								for (c = c160, cp_0 = 0;c < c160 + 128;c += 1, cp_0 += 1){
				...
				for (y = y207 + 40, yp_1 = y207_p_0, yp_0 = 0;y < y207 + 40 + 28;y += 14, yp_1 += 14, yp_0 += 14){
					// y = ph_y, x = 2, h = 1, w = 1, c = 128, f = 32
					// T (x, 2) (2 / 1)
					for (x = x207, xp_1 = x207_p_0, xp_0 = 0;x < x207 + 2;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_2846 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
								mem_vec_2847 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c160, cp_0 = 0;c < c160 + 128;c += 1, cp_0 += 1){
									scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_2846);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_2847);
					}
				}
		}
}
