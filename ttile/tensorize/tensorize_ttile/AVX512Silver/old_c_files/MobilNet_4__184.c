...
[V f; U (1, f); U (14, y); U (3, h); U (3, w); T (128, c); Hoist_vars [c];
  T (28, x); T (1, c); T (2, f); T (2, y); T (4, f)]
*/
IND_TYPE c, cp_0, c225_p_0, cp_1, c225, f, fp_0, f225_p_0, fp_1, f225, x, xp_0, y, yp_0;
			...
			for (c225 = c226, c225_p_0 = 0;
				...
				for (x = x191, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_1395 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
							mem_vec_1396 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
							mem_vec_1397 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
							mem_vec_1398 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
							...
							for (c = c225, cp_1 = c225_p_0, cp_0 = 0;
								...
								vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_1394);
								mem_vec_1394 = vec_19;
								scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 10) + h) + c];
								vec_22 = _mm512_set1_ps(scal_10);


								vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_1395);
								mem_vec_1395 = vec_21;
								...
								vec_116 = _mm512_fmadd_ps(vec_117, vec_118, mem_vec_1385);
								mem_vec_1385 = vec_116;
								scal_57 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h + 1) + c];
								vec_120 = _mm512_set1_ps(scal_57);


								vec_119 = _mm512_fmadd_ps(vec_120, vec_118, mem_vec_1386);
								mem_vec_1386 = vec_119;
								scal_58 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h + 1) + c];
								vec_122 = _mm512_set1_ps(scal_58);


								vec_121 = _mm512_fmadd_ps(vec_122, vec_118, mem_vec_1387);
								mem_vec_1387 = vec_121;
								scal_59 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h + 1) + c];
								vec_124 = _mm512_set1_ps(scal_59);


								vec_123 = _mm512_fmadd_ps(vec_124, vec_118, mem_vec_1388);
								mem_vec_1388 = vec_123;
								scal_60 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h + 1) + c];
								vec_126 = _mm512_set1_ps(scal_60);


								vec_125 = _mm512_fmadd_ps(vec_126, vec_118, mem_vec_1389);
								mem_vec_1389 = vec_125;
								scal_61 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h + 1) + c];
								vec_128 = _mm512_set1_ps(scal_61);


								vec_127 = _mm512_fmadd_ps(vec_128, vec_118, mem_vec_1390);
								mem_vec_1390 = vec_127;
								scal_62 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h + 1) + c];
								vec_130 = _mm512_set1_ps(scal_62);


								vec_129 = _mm512_fmadd_ps(vec_130, vec_118, mem_vec_1391);
								mem_vec_1391 = vec_129;
								scal_63 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h + 1) + c];
								vec_132 = _mm512_set1_ps(scal_63);


								vec_131 = _mm512_fmadd_ps(vec_132, vec_118, mem_vec_1392);
								mem_vec_1392 = vec_131;
								scal_64 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h + 1) + c];
								vec_134 = _mm512_set1_ps(scal_64);


								vec_133 = _mm512_fmadd_ps(vec_134, vec_118, mem_vec_1393);
								mem_vec_1393 = vec_133;
								scal_65 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 9) + h + 1) + c];
								vec_136 = _mm512_set1_ps(scal_65);


								vec_135 = _mm512_fmadd_ps(vec_136, vec_118, mem_vec_1394);
								mem_vec_1394 = vec_135;
								scal_66 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 10) + h + 1) + c];
								vec_138 = _mm512_set1_ps(scal_66);


								vec_137 = _mm512_fmadd_ps(vec_138, vec_118, mem_vec_1395);
								mem_vec_1395 = vec_137;
								scal_67 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 11) + h + 1) + c];
								vec_140 = _mm512_set1_ps(scal_67);


								vec_139 = _mm512_fmadd_ps(vec_140, vec_118, mem_vec_1396);
								mem_vec_1396 = vec_139;
								scal_68 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 12) + h + 1) + c];
								vec_142 = _mm512_set1_ps(scal_68);


								vec_141 = _mm512_fmadd_ps(vec_142, vec_118, mem_vec_1397);
								mem_vec_1397 = vec_141;
								scal_69 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 13) + h + 1) + c];
								vec_144 = _mm512_set1_ps(scal_69);


								vec_143 = _mm512_fmadd_ps(vec_144, vec_118, mem_vec_1398);
								mem_vec_1398 = vec_143;
								...
								vec_174 = _mm512_fmadd_ps(vec_175, vec_176, mem_vec_1385);
								mem_vec_1385 = vec_174;
								scal_85 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
								vec_178 = _mm512_set1_ps(scal_85);


								vec_177 = _mm512_fmadd_ps(vec_178, vec_176, mem_vec_1386);
								mem_vec_1386 = vec_177;
								scal_86 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
								vec_180 = _mm512_set1_ps(scal_86);


								vec_179 = _mm512_fmadd_ps(vec_180, vec_176, mem_vec_1387);
								mem_vec_1387 = vec_179;
								scal_87 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
								vec_182 = _mm512_set1_ps(scal_87);


								vec_181 = _mm512_fmadd_ps(vec_182, vec_176, mem_vec_1388);
								mem_vec_1388 = vec_181;
								scal_88 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
								vec_184 = _mm512_set1_ps(scal_88);


								vec_183 = _mm512_fmadd_ps(vec_184, vec_176, mem_vec_1389);
								mem_vec_1389 = vec_183;
								scal_89 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
								vec_186 = _mm512_set1_ps(scal_89);


								vec_185 = _mm512_fmadd_ps(vec_186, vec_176, mem_vec_1390);
								mem_vec_1390 = vec_185;
								scal_90 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
								vec_188 = _mm512_set1_ps(scal_90);


								vec_187 = _mm512_fmadd_ps(vec_188, vec_176, mem_vec_1391);
								mem_vec_1391 = vec_187;
								scal_91 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h) + c];
								vec_190 = _mm512_set1_ps(scal_91);


								vec_189 = _mm512_fmadd_ps(vec_190, vec_176, mem_vec_1392);
								mem_vec_1392 = vec_189;
								scal_92 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h) + c];
								vec_192 = _mm512_set1_ps(scal_92);


								vec_191 = _mm512_fmadd_ps(vec_192, vec_176, mem_vec_1393);
								mem_vec_1393 = vec_191;
								scal_93 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 9) + h) + c];
								vec_194 = _mm512_set1_ps(scal_93);


								vec_193 = _mm512_fmadd_ps(vec_194, vec_176, mem_vec_1394);
								mem_vec_1394 = vec_193;
								scal_94 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 10) + h) + c];
								vec_196 = _mm512_set1_ps(scal_94);


								vec_195 = _mm512_fmadd_ps(vec_196, vec_176, mem_vec_1395);
								mem_vec_1395 = vec_195;
								scal_95 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 11) + h) + c];
								vec_198 = _mm512_set1_ps(scal_95);


								vec_197 = _mm512_fmadd_ps(vec_198, vec_176, mem_vec_1396);
								mem_vec_1396 = vec_197;
								scal_96 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 12) + h) + c];
								vec_200 = _mm512_set1_ps(scal_96);


								vec_199 = _mm512_fmadd_ps(vec_200, vec_176, mem_vec_1397);
								mem_vec_1397 = vec_199;
								scal_97 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 13) + h) + c];
								vec_202 = _mm512_set1_ps(scal_97);


								vec_201 = _mm512_fmadd_ps(vec_202, vec_176, mem_vec_1398);
								mem_vec_1398 = vec_201;
								...
								vec_203 = _mm512_fmadd_ps(vec_204, vec_205, mem_vec_1385);
								mem_vec_1385 = vec_203;
								scal_99 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h + 1) + c];
								vec_207 = _mm512_set1_ps(scal_99);


								vec_206 = _mm512_fmadd_ps(vec_207, vec_205, mem_vec_1386);
								mem_vec_1386 = vec_206;
								scal_100 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h + 1) + c];
								vec_209 = _mm512_set1_ps(scal_100);


								vec_208 = _mm512_fmadd_ps(vec_209, vec_205, mem_vec_1387);
								mem_vec_1387 = vec_208;
								scal_101 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h + 1) + c];
								vec_211 = _mm512_set1_ps(scal_101);


								vec_210 = _mm512_fmadd_ps(vec_211, vec_205, mem_vec_1388);
								mem_vec_1388 = vec_210;
								scal_102 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h + 1) + c];
								vec_213 = _mm512_set1_ps(scal_102);


								vec_212 = _mm512_fmadd_ps(vec_213, vec_205, mem_vec_1389);
								mem_vec_1389 = vec_212;
								scal_103 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h + 1) + c];
								vec_215 = _mm512_set1_ps(scal_103);


								vec_214 = _mm512_fmadd_ps(vec_215, vec_205, mem_vec_1390);
								mem_vec_1390 = vec_214;
								scal_104 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h + 1) + c];
								vec_217 = _mm512_set1_ps(scal_104);


								vec_216 = _mm512_fmadd_ps(vec_217, vec_205, mem_vec_1391);
								mem_vec_1391 = vec_216;
								scal_105 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h + 1) + c];
								vec_219 = _mm512_set1_ps(scal_105);


								vec_218 = _mm512_fmadd_ps(vec_219, vec_205, mem_vec_1392);
								mem_vec_1392 = vec_218;
								scal_106 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h + 1) + c];
								vec_221 = _mm512_set1_ps(scal_106);


								vec_220 = _mm512_fmadd_ps(vec_221, vec_205, mem_vec_1393);
								mem_vec_1393 = vec_220;
								scal_107 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 9) + h + 1) + c];
								vec_223 = _mm512_set1_ps(scal_107);


								vec_222 = _mm512_fmadd_ps(vec_223, vec_205, mem_vec_1394);
								mem_vec_1394 = vec_222;
								scal_108 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 10) + h + 1) + c];
								vec_225 = _mm512_set1_ps(scal_108);


								vec_224 = _mm512_fmadd_ps(vec_225, vec_205, mem_vec_1395);
								mem_vec_1395 = vec_224;
								scal_109 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 11) + h + 1) + c];
								vec_227 = _mm512_set1_ps(scal_109);


								vec_226 = _mm512_fmadd_ps(vec_227, vec_205, mem_vec_1396);
								mem_vec_1396 = vec_226;
								scal_110 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 12) + h + 1) + c];
								vec_229 = _mm512_set1_ps(scal_110);


								vec_228 = _mm512_fmadd_ps(vec_229, vec_205, mem_vec_1397);
								mem_vec_1397 = vec_228;
								scal_111 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 13) + h + 1) + c];
								vec_231 = _mm512_set1_ps(scal_111);


								vec_230 = _mm512_fmadd_ps(vec_231, vec_205, mem_vec_1398);
								mem_vec_1398 = vec_230;
						...
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_1395);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1396);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1397);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1398);
				}
			}
		}
	}
