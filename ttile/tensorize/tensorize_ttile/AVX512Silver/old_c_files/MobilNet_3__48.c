...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  T (14, x); T (2, c); T (1, f); T (14, y); T (4, x); T (4, f); T (2, f)]
*/
IND_TYPE c, cp_0, c219_p_0, cp_1, c219, f, fp_0, f170_p_0, f171_p_0, fp_1, f170_p_1, fp_2, f170, f171, x, xp_0, x249_p_0, xp_1, x249, y, yp_0;
					...
					for (c219 = c220, c219_p_0 = 0;
						...
						for (x = x249, xp_1 = x249_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1359 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c219, cp_1 = c219_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1357);
										mem_vec_1357 = vec_3;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_1359);
						}
					}
				}
			}
