				...
				for (y = y576, yp_1 = y576_p_0, yp_0 = 0;
					...
					for (x = x576, xp_1 = x576_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_7786 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
								mem_vec_7787 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
								...
								mem_vec_7793 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
								mem_vec_7794 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
								mem_vec_7795 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
								mem_vec_7796 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
								mem_vec_7797 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c431, cp_0 = 0;
									c < c431 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_7786);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_7787);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_7793);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_7794);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_7795);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_7796);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_7797);
					}
				}
				for (y = y576 + 7, yp_1 = y576_p_0, yp_0 = 0;
					y < y576 + 7 + 10;
