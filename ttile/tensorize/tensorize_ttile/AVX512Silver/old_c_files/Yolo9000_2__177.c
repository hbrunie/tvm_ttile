...
[V f; U (4, f); U (2, y); U (3, w); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (4, c); T (2, x); T (17, y); T (1, y); T (136, x); T (8, y)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, h, hp_0, x, xp_0, x296_p_0, x297_p_0, xp_1, x296_p_1, xp_2, x296, x297, y, yp_0, y296_p_0, y297_p_0, yp_1, y296_p_1, yp_2, y296, y297;
...
for (y297 = y298, y297_p_0 = 0;
	...
	for (x297 = x298, x297_p_0 = 0;
		...
		for (y296 = y297, y296_p_1 = y297_p_0, y296_p_0 = 0;
			y296 < y297 + 34;
			y296 += 34, y296_p_1 += 34, y296_p_0 += 34){
			// y = 34, x = 2, h = 3, w = 3, c = 32, f = 64
			// T (y, 17) (34 / 2)
