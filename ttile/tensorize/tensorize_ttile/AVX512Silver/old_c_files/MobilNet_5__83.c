...
*/
IND_TYPE c, cp_0, c120_p_0, cp_1, c120, f, fp_0, f108_p_0, f109_p_0, fp_1, f108_p_1, fp_2, f108, f109, h, hp_0, x, xp_0, y, yp_0;
						...
						for (h = h58, hp_0 = 0;
							...
							h += 1, hp_0 += 1){
									...
									for (c = c120, cp_1 = c120_p_0, cp_0 = 0;
										...
										vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_728);
										mem_vec_728 = vec_24;

										vec_28 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_729);
										mem_vec_729 = vec_27;

										vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

										vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_730);
										mem_vec_730 = vec_29;

										vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

										vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_731);
										mem_vec_731 = vec_31;
										scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_34 = _mm512_set1_ps(scal_5);


										vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_732);
										mem_vec_732 = vec_33;



										vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_733);
										mem_vec_733 = vec_35;



										vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_734);
										mem_vec_734 = vec_36;



										vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_735);
										mem_vec_735 = vec_37;
										scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_39 = _mm512_set1_ps(scal_6);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_736);
										mem_vec_736 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_737);
										mem_vec_737 = vec_40;



										vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_738);
										mem_vec_738 = vec_41;



										vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_739);
										mem_vec_739 = vec_42;
										scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_44 = _mm512_set1_ps(scal_7);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_740);
										mem_vec_740 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_741);
										mem_vec_741 = vec_45;



										vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_742);
										mem_vec_742 = vec_46;



										vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_743);
										mem_vec_743 = vec_47;
										scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_49 = _mm512_set1_ps(scal_8);
										vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_728);
										mem_vec_728 = vec_48;

										vec_52 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_729);
										mem_vec_729 = vec_51;

										vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

										vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_730);
										mem_vec_730 = vec_53;

										vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

										vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_731);
										mem_vec_731 = vec_55;
										scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_58 = _mm512_set1_ps(scal_9);


										vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_732);
										mem_vec_732 = vec_57;



										vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_733);
										mem_vec_733 = vec_59;



										vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_734);
										mem_vec_734 = vec_60;



										vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_735);
										mem_vec_735 = vec_61;
										scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_63 = _mm512_set1_ps(scal_10);


										vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_736);
										mem_vec_736 = vec_62;



										vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_737);
										mem_vec_737 = vec_64;



										vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_738);
										mem_vec_738 = vec_65;



										vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_739);
										mem_vec_739 = vec_66;
										scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_68 = _mm512_set1_ps(scal_11);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_740);
										mem_vec_740 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_741);
										mem_vec_741 = vec_69;



										vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_742);
										mem_vec_742 = vec_70;



										vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_743);
										mem_vec_743 = vec_71;
									}
