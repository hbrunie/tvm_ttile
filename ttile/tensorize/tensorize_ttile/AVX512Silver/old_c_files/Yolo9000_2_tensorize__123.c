...
[V f; U (4, f); U (2, y); U (3, w); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, c); T (34, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c180_p_0, cp_1, c180, h, hp_0, x, xp_0, x240_p_0, x241_p_0, xp_1, x240_p_1, xp_2, x240, x241, y, yp_0, y240_p_0, y241_p_0, yp_1, y240_p_1, yp_2, y240, y241;
IND_TYPE y242 = 0;
IND_TYPE x242 = 0;
IND_TYPE h78 = 0;
IND_TYPE w = 0;
...
c180_p_0 = 0;
						for (h = h78, hp_0 = 0;h < h78 + 3;h += 1, hp_0 += 1){
							...
							for (x = x240, xp_2 = x240_p_1, xp_1 = x240_p_0, xp_0 = 0;x < x240 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// y = 2, x = 1, h = 1, w = 3, c = 32, f = 64
										// T (c, 32) (32 / 1)
										for (c = c180, cp_1 = c180_p_0, cp_0 = 0;c < c180 + 32;c += 1, cp_1 += 1, cp_0 += 1){
