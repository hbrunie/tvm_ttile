...
for (y558 = y559, y558_p_0 = 0;
	...
	for (x745 = x746, x745_p_0 = 0;
		...
		x745 += 68, x745_p_0 += 68){
			...
			for (y = y558 + 4, yp_1 = y558_p_0, yp_0 = 0;
				y < y558 + 4 + 30;
				y += 6, yp_1 += 6, yp_0 += 6){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (68 / 68)
						...
						for (c558 = c559, c558_p_0 = 0;
							...
							for (x = x744, xp_2 = x744_p_1, xp_1 = x744_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7444 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
										mem_vec_7445 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
										mem_vec_7446 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32]);
										mem_vec_7447 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 64
										// T (c, 128) (128 / 1)
										for (c = c558, cp_1 = c558_p_0, cp_0 = 0;
											c < c558 + 128;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_7444);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_7445);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32], mem_vec_7446);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48], mem_vec_7447);
							}
						}
					}
				}
