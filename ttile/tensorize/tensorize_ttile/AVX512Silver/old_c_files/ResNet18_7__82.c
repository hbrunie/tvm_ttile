...
*/
IND_TYPE c, cp_0, c270_p_0, cp_1, c270, f, fp_0, f270_p_0, fp_1, f270, x, xp_0, y, yp_0;
			...
			for (c270 = c271, c270_p_0 = 0;
				...
				for (x = x180, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_1855 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
							mem_vec_1856 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
							mem_vec_1857 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
							mem_vec_1858 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
							mem_vec_1859 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
							mem_vec_1860 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
							mem_vec_1861 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
							...
							for (c = c270, cp_1 = c270_p_0, cp_0 = 0;
								...
								vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_1854);
								mem_vec_1854 = vec_13;
								scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 7) + h) + c];
								vec_16 = _mm512_set1_ps(scal_7);


								vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_1855);
								mem_vec_1855 = vec_15;
								...
								vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_1857);
								mem_vec_1857 = vec_19;
								scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 10) + h) + c];
								vec_22 = _mm512_set1_ps(scal_10);


								vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_1858);
								mem_vec_1858 = vec_21;
								...
								vec_145 = _mm512_fmadd_ps(vec_146, vec_147, mem_vec_1848);
								mem_vec_1848 = vec_145;
								scal_71 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h + 2) + c];
								vec_149 = _mm512_set1_ps(scal_71);


								vec_148 = _mm512_fmadd_ps(vec_149, vec_147, mem_vec_1849);
								mem_vec_1849 = vec_148;
								scal_72 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h + 2) + c];
								vec_151 = _mm512_set1_ps(scal_72);


								vec_150 = _mm512_fmadd_ps(vec_151, vec_147, mem_vec_1850);
								mem_vec_1850 = vec_150;
								scal_73 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h + 2) + c];
								vec_153 = _mm512_set1_ps(scal_73);


								vec_152 = _mm512_fmadd_ps(vec_153, vec_147, mem_vec_1851);
								mem_vec_1851 = vec_152;
								scal_74 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h + 2) + c];
								vec_155 = _mm512_set1_ps(scal_74);


								vec_154 = _mm512_fmadd_ps(vec_155, vec_147, mem_vec_1852);
								mem_vec_1852 = vec_154;
								scal_75 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h + 2) + c];
								vec_157 = _mm512_set1_ps(scal_75);


								vec_156 = _mm512_fmadd_ps(vec_157, vec_147, mem_vec_1853);
								mem_vec_1853 = vec_156;
								scal_76 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h + 2) + c];
								vec_159 = _mm512_set1_ps(scal_76);


								vec_158 = _mm512_fmadd_ps(vec_159, vec_147, mem_vec_1854);
								mem_vec_1854 = vec_158;
								scal_77 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h + 2) + c];
								vec_161 = _mm512_set1_ps(scal_77);


								vec_160 = _mm512_fmadd_ps(vec_161, vec_147, mem_vec_1855);
								mem_vec_1855 = vec_160;
								scal_78 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h + 2) + c];
								vec_163 = _mm512_set1_ps(scal_78);


								vec_162 = _mm512_fmadd_ps(vec_163, vec_147, mem_vec_1856);
								mem_vec_1856 = vec_162;
								scal_79 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 9) + h + 2) + c];
								vec_165 = _mm512_set1_ps(scal_79);


								vec_164 = _mm512_fmadd_ps(vec_165, vec_147, mem_vec_1857);
								mem_vec_1857 = vec_164;
								scal_80 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 10) + h + 2) + c];
								vec_167 = _mm512_set1_ps(scal_80);


								vec_166 = _mm512_fmadd_ps(vec_167, vec_147, mem_vec_1858);
								mem_vec_1858 = vec_166;
								scal_81 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 11) + h + 2) + c];
								vec_169 = _mm512_set1_ps(scal_81);


								vec_168 = _mm512_fmadd_ps(vec_169, vec_147, mem_vec_1859);
								mem_vec_1859 = vec_168;
								scal_82 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 12) + h + 2) + c];
								vec_171 = _mm512_set1_ps(scal_82);


								vec_170 = _mm512_fmadd_ps(vec_171, vec_147, mem_vec_1860);
								mem_vec_1860 = vec_170;
								scal_83 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 13) + h + 2) + c];
								vec_173 = _mm512_set1_ps(scal_83);


								vec_172 = _mm512_fmadd_ps(vec_173, vec_147, mem_vec_1861);
								mem_vec_1861 = vec_172;
								...
								vec_232 = _mm512_fmadd_ps(vec_233, vec_234, mem_vec_1848);
								mem_vec_1848 = vec_232;
								scal_113 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h + 2) + c];
								vec_236 = _mm512_set1_ps(scal_113);


								vec_235 = _mm512_fmadd_ps(vec_236, vec_234, mem_vec_1849);
								mem_vec_1849 = vec_235;
								scal_114 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h + 2) + c];
								vec_238 = _mm512_set1_ps(scal_114);


								vec_237 = _mm512_fmadd_ps(vec_238, vec_234, mem_vec_1850);
								mem_vec_1850 = vec_237;
								scal_115 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h + 2) + c];
								vec_240 = _mm512_set1_ps(scal_115);


								vec_239 = _mm512_fmadd_ps(vec_240, vec_234, mem_vec_1851);
								mem_vec_1851 = vec_239;
								scal_116 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h + 2) + c];
								vec_242 = _mm512_set1_ps(scal_116);


								vec_241 = _mm512_fmadd_ps(vec_242, vec_234, mem_vec_1852);
								mem_vec_1852 = vec_241;
								scal_117 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h + 2) + c];
								vec_244 = _mm512_set1_ps(scal_117);


								vec_243 = _mm512_fmadd_ps(vec_244, vec_234, mem_vec_1853);
								mem_vec_1853 = vec_243;
								scal_118 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h + 2) + c];
								vec_246 = _mm512_set1_ps(scal_118);


								vec_245 = _mm512_fmadd_ps(vec_246, vec_234, mem_vec_1854);
								mem_vec_1854 = vec_245;
								scal_119 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h + 2) + c];
								vec_248 = _mm512_set1_ps(scal_119);


								vec_247 = _mm512_fmadd_ps(vec_248, vec_234, mem_vec_1855);
								mem_vec_1855 = vec_247;
								scal_120 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h + 2) + c];
								vec_250 = _mm512_set1_ps(scal_120);


								vec_249 = _mm512_fmadd_ps(vec_250, vec_234, mem_vec_1856);
								mem_vec_1856 = vec_249;
								scal_121 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 9) + h + 2) + c];
								vec_252 = _mm512_set1_ps(scal_121);


								vec_251 = _mm512_fmadd_ps(vec_252, vec_234, mem_vec_1857);
								mem_vec_1857 = vec_251;
								scal_122 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 10) + h + 2) + c];
								vec_254 = _mm512_set1_ps(scal_122);


								vec_253 = _mm512_fmadd_ps(vec_254, vec_234, mem_vec_1858);
								mem_vec_1858 = vec_253;
								scal_123 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 11) + h + 2) + c];
								vec_256 = _mm512_set1_ps(scal_123);


								vec_255 = _mm512_fmadd_ps(vec_256, vec_234, mem_vec_1859);
								mem_vec_1859 = vec_255;
								scal_124 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 12) + h + 2) + c];
								vec_258 = _mm512_set1_ps(scal_124);


								vec_257 = _mm512_fmadd_ps(vec_258, vec_234, mem_vec_1860);
								mem_vec_1860 = vec_257;
								scal_125 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 13) + h + 2) + c];
								vec_260 = _mm512_set1_ps(scal_125);


								vec_259 = _mm512_fmadd_ps(vec_260, vec_234, mem_vec_1861);
								mem_vec_1861 = vec_259;
							}
						...
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_1855);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_1856);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_1857);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_1858);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1859);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1860);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1861);
				}
			}
		}
	}
