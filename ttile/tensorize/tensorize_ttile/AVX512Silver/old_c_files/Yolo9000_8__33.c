							...
							for (x = x456, xp_1 = x456_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c456, cp_1 = c456_p_0, cp_0 = 0;
											...
											vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_6208);
											mem_vec_6208 = vec_23;

											vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_6209);
											mem_vec_6209 = vec_26;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_29 = _mm512_set1_ps(scal_8);


											vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_6210);
											mem_vec_6210 = vec_28;



											vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_6211);
											mem_vec_6211 = vec_30;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_6212);
											mem_vec_6212 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_6213);
											mem_vec_6213 = vec_33;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_6214);
											mem_vec_6214 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_6215);
											mem_vec_6215 = vec_36;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_6216);
											mem_vec_6216 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_6217);
											mem_vec_6217 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_6218);
											mem_vec_6218 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_6219);
											mem_vec_6219 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_6220);
											mem_vec_6220 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_6221);
											mem_vec_6221 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_47 = _mm512_set1_ps(scal_14);
											vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_6208);
											mem_vec_6208 = vec_46;

											vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_6209);
											mem_vec_6209 = vec_49;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_52 = _mm512_set1_ps(scal_15);


											vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_6210);
											mem_vec_6210 = vec_51;



											vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_6211);
											mem_vec_6211 = vec_53;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_55 = _mm512_set1_ps(scal_16);


											vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_6212);
											mem_vec_6212 = vec_54;



											vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_6213);
											mem_vec_6213 = vec_56;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_6214);
											mem_vec_6214 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_6215);
											mem_vec_6215 = vec_59;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_61 = _mm512_set1_ps(scal_18);


											vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_6216);
											mem_vec_6216 = vec_60;



											vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_6217);
											mem_vec_6217 = vec_62;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_6218);
											mem_vec_6218 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_6219);
											mem_vec_6219 = vec_65;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_6220);
											mem_vec_6220 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_6221);
											mem_vec_6221 = vec_68;
											scal_21 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
											vec_70 = _mm512_set1_ps(scal_21);
											vec_71 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

											vec_69 = _mm512_fmadd_ps(vec_70, vec_71, mem_vec_6208);
											mem_vec_6208 = vec_69;

											vec_73 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_72 = _mm512_fmadd_ps(vec_70, vec_73, mem_vec_6209);
											mem_vec_6209 = vec_72;
											scal_22 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_75 = _mm512_set1_ps(scal_22);


											vec_74 = _mm512_fmadd_ps(vec_75, vec_71, mem_vec_6210);
											mem_vec_6210 = vec_74;



											vec_76 = _mm512_fmadd_ps(vec_75, vec_73, mem_vec_6211);
											mem_vec_6211 = vec_76;
											scal_23 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_78 = _mm512_set1_ps(scal_23);


											vec_77 = _mm512_fmadd_ps(vec_78, vec_71, mem_vec_6212);
											mem_vec_6212 = vec_77;



											vec_79 = _mm512_fmadd_ps(vec_78, vec_73, mem_vec_6213);
											mem_vec_6213 = vec_79;
											scal_24 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_81 = _mm512_set1_ps(scal_24);


											vec_80 = _mm512_fmadd_ps(vec_81, vec_71, mem_vec_6214);
											mem_vec_6214 = vec_80;



											vec_82 = _mm512_fmadd_ps(vec_81, vec_73, mem_vec_6215);
											mem_vec_6215 = vec_82;
											scal_25 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_84 = _mm512_set1_ps(scal_25);


											vec_83 = _mm512_fmadd_ps(vec_84, vec_71, mem_vec_6216);
											mem_vec_6216 = vec_83;



											vec_85 = _mm512_fmadd_ps(vec_84, vec_73, mem_vec_6217);
											mem_vec_6217 = vec_85;
											scal_26 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_87 = _mm512_set1_ps(scal_26);


											vec_86 = _mm512_fmadd_ps(vec_87, vec_71, mem_vec_6218);
											mem_vec_6218 = vec_86;



											vec_88 = _mm512_fmadd_ps(vec_87, vec_73, mem_vec_6219);
											mem_vec_6219 = vec_88;
											scal_27 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_90 = _mm512_set1_ps(scal_27);


											vec_89 = _mm512_fmadd_ps(vec_90, vec_71, mem_vec_6220);
											mem_vec_6220 = vec_89;



											vec_91 = _mm512_fmadd_ps(vec_90, vec_73, mem_vec_6221);
											mem_vec_6221 = vec_91;
											scal_28 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h + 1) + c];
											vec_93 = _mm512_set1_ps(scal_28);
											vec_94 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f]);

											vec_92 = _mm512_fmadd_ps(vec_93, vec_94, mem_vec_6208);
											mem_vec_6208 = vec_92;

											vec_96 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_95 = _mm512_fmadd_ps(vec_93, vec_96, mem_vec_6209);
											mem_vec_6209 = vec_95;
											scal_29 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
											vec_98 = _mm512_set1_ps(scal_29);


											vec_97 = _mm512_fmadd_ps(vec_98, vec_94, mem_vec_6210);
											mem_vec_6210 = vec_97;



											vec_99 = _mm512_fmadd_ps(vec_98, vec_96, mem_vec_6211);
											mem_vec_6211 = vec_99;
											scal_30 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
											vec_101 = _mm512_set1_ps(scal_30);


											vec_100 = _mm512_fmadd_ps(vec_101, vec_94, mem_vec_6212);
											mem_vec_6212 = vec_100;



											vec_102 = _mm512_fmadd_ps(vec_101, vec_96, mem_vec_6213);
											mem_vec_6213 = vec_102;
											scal_31 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
											vec_104 = _mm512_set1_ps(scal_31);


											vec_103 = _mm512_fmadd_ps(vec_104, vec_94, mem_vec_6214);
											mem_vec_6214 = vec_103;



											vec_105 = _mm512_fmadd_ps(vec_104, vec_96, mem_vec_6215);
											mem_vec_6215 = vec_105;
											scal_32 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
											vec_107 = _mm512_set1_ps(scal_32);


											vec_106 = _mm512_fmadd_ps(vec_107, vec_94, mem_vec_6216);
											mem_vec_6216 = vec_106;



											vec_108 = _mm512_fmadd_ps(vec_107, vec_96, mem_vec_6217);
											mem_vec_6217 = vec_108;
											scal_33 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
											vec_110 = _mm512_set1_ps(scal_33);


											vec_109 = _mm512_fmadd_ps(vec_110, vec_94, mem_vec_6218);
											mem_vec_6218 = vec_109;



											vec_111 = _mm512_fmadd_ps(vec_110, vec_96, mem_vec_6219);
											mem_vec_6219 = vec_111;
											scal_34 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
											vec_113 = _mm512_set1_ps(scal_34);


											vec_112 = _mm512_fmadd_ps(vec_113, vec_94, mem_vec_6220);
											mem_vec_6220 = vec_112;



											vec_114 = _mm512_fmadd_ps(vec_113, vec_96, mem_vec_6221);
											mem_vec_6221 = vec_114;
											...
											vec_115 = _mm512_fmadd_ps(vec_116, vec_117, mem_vec_6208);
											mem_vec_6208 = vec_115;

											vec_119 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_118 = _mm512_fmadd_ps(vec_116, vec_119, mem_vec_6209);
											mem_vec_6209 = vec_118;
											scal_36 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
											vec_121 = _mm512_set1_ps(scal_36);


											vec_120 = _mm512_fmadd_ps(vec_121, vec_117, mem_vec_6210);
											mem_vec_6210 = vec_120;



											vec_122 = _mm512_fmadd_ps(vec_121, vec_119, mem_vec_6211);
											mem_vec_6211 = vec_122;
											scal_37 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
											vec_124 = _mm512_set1_ps(scal_37);


											vec_123 = _mm512_fmadd_ps(vec_124, vec_117, mem_vec_6212);
											mem_vec_6212 = vec_123;



											vec_125 = _mm512_fmadd_ps(vec_124, vec_119, mem_vec_6213);
											mem_vec_6213 = vec_125;
											scal_38 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
											vec_127 = _mm512_set1_ps(scal_38);


											vec_126 = _mm512_fmadd_ps(vec_127, vec_117, mem_vec_6214);
											mem_vec_6214 = vec_126;



											vec_128 = _mm512_fmadd_ps(vec_127, vec_119, mem_vec_6215);
											mem_vec_6215 = vec_128;
											scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
											vec_130 = _mm512_set1_ps(scal_39);


											vec_129 = _mm512_fmadd_ps(vec_130, vec_117, mem_vec_6216);
											mem_vec_6216 = vec_129;



											vec_131 = _mm512_fmadd_ps(vec_130, vec_119, mem_vec_6217);
											mem_vec_6217 = vec_131;
											scal_40 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
											vec_133 = _mm512_set1_ps(scal_40);


											vec_132 = _mm512_fmadd_ps(vec_133, vec_117, mem_vec_6218);
											mem_vec_6218 = vec_132;



											vec_134 = _mm512_fmadd_ps(vec_133, vec_119, mem_vec_6219);
											mem_vec_6219 = vec_134;
											scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
											vec_136 = _mm512_set1_ps(scal_41);


											vec_135 = _mm512_fmadd_ps(vec_136, vec_117, mem_vec_6220);
											mem_vec_6220 = vec_135;



											vec_137 = _mm512_fmadd_ps(vec_136, vec_119, mem_vec_6221);
											mem_vec_6221 = vec_137;
											scal_42 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_139 = _mm512_set1_ps(scal_42);
											vec_140 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_138 = _mm512_fmadd_ps(vec_139, vec_140, mem_vec_6208);
											mem_vec_6208 = vec_138;

											vec_142 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_141 = _mm512_fmadd_ps(vec_139, vec_142, mem_vec_6209);
											mem_vec_6209 = vec_141;
											scal_43 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_144 = _mm512_set1_ps(scal_43);


											vec_143 = _mm512_fmadd_ps(vec_144, vec_140, mem_vec_6210);
											mem_vec_6210 = vec_143;



											vec_145 = _mm512_fmadd_ps(vec_144, vec_142, mem_vec_6211);
											mem_vec_6211 = vec_145;
											scal_44 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_147 = _mm512_set1_ps(scal_44);


											vec_146 = _mm512_fmadd_ps(vec_147, vec_140, mem_vec_6212);
											mem_vec_6212 = vec_146;



											vec_148 = _mm512_fmadd_ps(vec_147, vec_142, mem_vec_6213);
											mem_vec_6213 = vec_148;
											scal_45 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_150 = _mm512_set1_ps(scal_45);


											vec_149 = _mm512_fmadd_ps(vec_150, vec_140, mem_vec_6214);
											mem_vec_6214 = vec_149;



											vec_151 = _mm512_fmadd_ps(vec_150, vec_142, mem_vec_6215);
											mem_vec_6215 = vec_151;
											scal_46 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_153 = _mm512_set1_ps(scal_46);


											vec_152 = _mm512_fmadd_ps(vec_153, vec_140, mem_vec_6216);
											mem_vec_6216 = vec_152;



											vec_154 = _mm512_fmadd_ps(vec_153, vec_142, mem_vec_6217);
											mem_vec_6217 = vec_154;
											scal_47 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_156 = _mm512_set1_ps(scal_47);


											vec_155 = _mm512_fmadd_ps(vec_156, vec_140, mem_vec_6218);
											mem_vec_6218 = vec_155;



											vec_157 = _mm512_fmadd_ps(vec_156, vec_142, mem_vec_6219);
											mem_vec_6219 = vec_157;
											scal_48 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_159 = _mm512_set1_ps(scal_48);


											vec_158 = _mm512_fmadd_ps(vec_159, vec_140, mem_vec_6220);
											mem_vec_6220 = vec_158;



											vec_160 = _mm512_fmadd_ps(vec_159, vec_142, mem_vec_6221);
											mem_vec_6221 = vec_160;
											...
											vec_161 = _mm512_fmadd_ps(vec_162, vec_163, mem_vec_6208);
											mem_vec_6208 = vec_161;

											vec_165 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_164 = _mm512_fmadd_ps(vec_162, vec_165, mem_vec_6209);
											mem_vec_6209 = vec_164;
											scal_50 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
											vec_167 = _mm512_set1_ps(scal_50);


											vec_166 = _mm512_fmadd_ps(vec_167, vec_163, mem_vec_6210);
											mem_vec_6210 = vec_166;



											vec_168 = _mm512_fmadd_ps(vec_167, vec_165, mem_vec_6211);
											mem_vec_6211 = vec_168;
											scal_51 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
											vec_170 = _mm512_set1_ps(scal_51);


											vec_169 = _mm512_fmadd_ps(vec_170, vec_163, mem_vec_6212);
											mem_vec_6212 = vec_169;



											vec_171 = _mm512_fmadd_ps(vec_170, vec_165, mem_vec_6213);
											mem_vec_6213 = vec_171;
											scal_52 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
											vec_173 = _mm512_set1_ps(scal_52);


											vec_172 = _mm512_fmadd_ps(vec_173, vec_163, mem_vec_6214);
											mem_vec_6214 = vec_172;



											vec_174 = _mm512_fmadd_ps(vec_173, vec_165, mem_vec_6215);
											mem_vec_6215 = vec_174;
											scal_53 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
											vec_176 = _mm512_set1_ps(scal_53);


											vec_175 = _mm512_fmadd_ps(vec_176, vec_163, mem_vec_6216);
											mem_vec_6216 = vec_175;



											vec_177 = _mm512_fmadd_ps(vec_176, vec_165, mem_vec_6217);
											mem_vec_6217 = vec_177;
											scal_54 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
											vec_179 = _mm512_set1_ps(scal_54);


											vec_178 = _mm512_fmadd_ps(vec_179, vec_163, mem_vec_6218);
											mem_vec_6218 = vec_178;



											vec_180 = _mm512_fmadd_ps(vec_179, vec_165, mem_vec_6219);
											mem_vec_6219 = vec_180;
											scal_55 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
											vec_182 = _mm512_set1_ps(scal_55);


											vec_181 = _mm512_fmadd_ps(vec_182, vec_163, mem_vec_6220);
											mem_vec_6220 = vec_181;



											vec_183 = _mm512_fmadd_ps(vec_182, vec_165, mem_vec_6221);
											mem_vec_6221 = vec_183;
											...
											vec_184 = _mm512_fmadd_ps(vec_185, vec_186, mem_vec_6208);
											mem_vec_6208 = vec_184;

											vec_188 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_187 = _mm512_fmadd_ps(vec_185, vec_188, mem_vec_6209);
											mem_vec_6209 = vec_187;
											scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
											vec_190 = _mm512_set1_ps(scal_57);


											vec_189 = _mm512_fmadd_ps(vec_190, vec_186, mem_vec_6210);
											mem_vec_6210 = vec_189;



											vec_191 = _mm512_fmadd_ps(vec_190, vec_188, mem_vec_6211);
											mem_vec_6211 = vec_191;
											scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
											vec_193 = _mm512_set1_ps(scal_58);


											vec_192 = _mm512_fmadd_ps(vec_193, vec_186, mem_vec_6212);
											mem_vec_6212 = vec_192;



											vec_194 = _mm512_fmadd_ps(vec_193, vec_188, mem_vec_6213);
											mem_vec_6213 = vec_194;
											scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
											vec_196 = _mm512_set1_ps(scal_59);


											vec_195 = _mm512_fmadd_ps(vec_196, vec_186, mem_vec_6214);
											mem_vec_6214 = vec_195;



											vec_197 = _mm512_fmadd_ps(vec_196, vec_188, mem_vec_6215);
											mem_vec_6215 = vec_197;
											scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
											vec_199 = _mm512_set1_ps(scal_60);


											vec_198 = _mm512_fmadd_ps(vec_199, vec_186, mem_vec_6216);
											mem_vec_6216 = vec_198;



											vec_200 = _mm512_fmadd_ps(vec_199, vec_188, mem_vec_6217);
											mem_vec_6217 = vec_200;
											scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
											vec_202 = _mm512_set1_ps(scal_61);


											vec_201 = _mm512_fmadd_ps(vec_202, vec_186, mem_vec_6218);
											mem_vec_6218 = vec_201;



											vec_203 = _mm512_fmadd_ps(vec_202, vec_188, mem_vec_6219);
											mem_vec_6219 = vec_203;
											scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
											vec_205 = _mm512_set1_ps(scal_62);


											vec_204 = _mm512_fmadd_ps(vec_205, vec_186, mem_vec_6220);
											mem_vec_6220 = vec_204;



											vec_206 = _mm512_fmadd_ps(vec_205, vec_188, mem_vec_6221);
											mem_vec_6221 = vec_206;
										}
							...
							for (x = x456, xp_1 = x456_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c456, cp_1 = c456_p_0, cp_0 = 0;
											...
											vec_105 = _mm512_fmadd_ps(vec_106, vec_107, mem_vec_6222);
											mem_vec_6222 = vec_105;

											vec_109 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_108 = _mm512_fmadd_ps(vec_106, vec_109, mem_vec_6223);
											mem_vec_6223 = vec_108;
											scal_34 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_111 = _mm512_set1_ps(scal_34);


											vec_110 = _mm512_fmadd_ps(vec_111, vec_107, mem_vec_6224);
											mem_vec_6224 = vec_110;



											vec_112 = _mm512_fmadd_ps(vec_111, vec_109, mem_vec_6225);
											mem_vec_6225 = vec_112;
											scal_35 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_114 = _mm512_set1_ps(scal_35);


											vec_113 = _mm512_fmadd_ps(vec_114, vec_107, mem_vec_6226);
											mem_vec_6226 = vec_113;



											vec_115 = _mm512_fmadd_ps(vec_114, vec_109, mem_vec_6227);
											mem_vec_6227 = vec_115;
											scal_36 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_117 = _mm512_set1_ps(scal_36);


											vec_116 = _mm512_fmadd_ps(vec_117, vec_107, mem_vec_6228);
											mem_vec_6228 = vec_116;



											vec_118 = _mm512_fmadd_ps(vec_117, vec_109, mem_vec_6229);
											mem_vec_6229 = vec_118;
											scal_37 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_120 = _mm512_set1_ps(scal_37);


											vec_119 = _mm512_fmadd_ps(vec_120, vec_107, mem_vec_6230);
											mem_vec_6230 = vec_119;



											vec_121 = _mm512_fmadd_ps(vec_120, vec_109, mem_vec_6231);
											mem_vec_6231 = vec_121;
											scal_38 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_123 = _mm512_set1_ps(scal_38);


											vec_122 = _mm512_fmadd_ps(vec_123, vec_107, mem_vec_6232);
											mem_vec_6232 = vec_122;



											vec_124 = _mm512_fmadd_ps(vec_123, vec_109, mem_vec_6233);
											mem_vec_6233 = vec_124;
											scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_126 = _mm512_set1_ps(scal_39);


											vec_125 = _mm512_fmadd_ps(vec_126, vec_107, mem_vec_6234);
											mem_vec_6234 = vec_125;



											vec_127 = _mm512_fmadd_ps(vec_126, vec_109, mem_vec_6235);
											mem_vec_6235 = vec_127;
											scal_40 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_129 = _mm512_set1_ps(scal_40);


											vec_128 = _mm512_fmadd_ps(vec_129, vec_107, mem_vec_6236);
											mem_vec_6236 = vec_128;



											vec_130 = _mm512_fmadd_ps(vec_129, vec_109, mem_vec_6237);
											mem_vec_6237 = vec_130;
											scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
											vec_132 = _mm512_set1_ps(scal_41);


											vec_131 = _mm512_fmadd_ps(vec_132, vec_107, mem_vec_6238);
											mem_vec_6238 = vec_131;



											vec_133 = _mm512_fmadd_ps(vec_132, vec_109, mem_vec_6239);
											mem_vec_6239 = vec_133;
											scal_42 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
											vec_135 = _mm512_set1_ps(scal_42);


											vec_134 = _mm512_fmadd_ps(vec_135, vec_107, mem_vec_6240);
											mem_vec_6240 = vec_134;



											vec_136 = _mm512_fmadd_ps(vec_135, vec_109, mem_vec_6241);
											mem_vec_6241 = vec_136;
											scal_43 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
											vec_138 = _mm512_set1_ps(scal_43);


											vec_137 = _mm512_fmadd_ps(vec_138, vec_107, mem_vec_6242);
											mem_vec_6242 = vec_137;



											vec_139 = _mm512_fmadd_ps(vec_138, vec_109, mem_vec_6243);
											mem_vec_6243 = vec_139;
											...
											vec_140 = _mm512_fmadd_ps(vec_141, vec_142, mem_vec_6222);
											mem_vec_6222 = vec_140;

											vec_144 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_143 = _mm512_fmadd_ps(vec_141, vec_144, mem_vec_6223);
											mem_vec_6223 = vec_143;
											scal_45 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
											vec_146 = _mm512_set1_ps(scal_45);


											vec_145 = _mm512_fmadd_ps(vec_146, vec_142, mem_vec_6224);
											mem_vec_6224 = vec_145;



											vec_147 = _mm512_fmadd_ps(vec_146, vec_144, mem_vec_6225);
											mem_vec_6225 = vec_147;
											scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
											vec_149 = _mm512_set1_ps(scal_46);


											vec_148 = _mm512_fmadd_ps(vec_149, vec_142, mem_vec_6226);
											mem_vec_6226 = vec_148;



											vec_150 = _mm512_fmadd_ps(vec_149, vec_144, mem_vec_6227);
											mem_vec_6227 = vec_150;
											scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
											vec_152 = _mm512_set1_ps(scal_47);


											vec_151 = _mm512_fmadd_ps(vec_152, vec_142, mem_vec_6228);
											mem_vec_6228 = vec_151;



											vec_153 = _mm512_fmadd_ps(vec_152, vec_144, mem_vec_6229);
											mem_vec_6229 = vec_153;
											scal_48 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
											vec_155 = _mm512_set1_ps(scal_48);


											vec_154 = _mm512_fmadd_ps(vec_155, vec_142, mem_vec_6230);
											mem_vec_6230 = vec_154;



											vec_156 = _mm512_fmadd_ps(vec_155, vec_144, mem_vec_6231);
											mem_vec_6231 = vec_156;
											scal_49 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
											vec_158 = _mm512_set1_ps(scal_49);


											vec_157 = _mm512_fmadd_ps(vec_158, vec_142, mem_vec_6232);
											mem_vec_6232 = vec_157;



											vec_159 = _mm512_fmadd_ps(vec_158, vec_144, mem_vec_6233);
											mem_vec_6233 = vec_159;
											scal_50 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
											vec_161 = _mm512_set1_ps(scal_50);


											vec_160 = _mm512_fmadd_ps(vec_161, vec_142, mem_vec_6234);
											mem_vec_6234 = vec_160;



											vec_162 = _mm512_fmadd_ps(vec_161, vec_144, mem_vec_6235);
											mem_vec_6235 = vec_162;
											scal_51 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
											vec_164 = _mm512_set1_ps(scal_51);


											vec_163 = _mm512_fmadd_ps(vec_164, vec_142, mem_vec_6236);
											mem_vec_6236 = vec_163;



											vec_165 = _mm512_fmadd_ps(vec_164, vec_144, mem_vec_6237);
											mem_vec_6237 = vec_165;
											scal_52 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 1) + c];
											vec_167 = _mm512_set1_ps(scal_52);


											vec_166 = _mm512_fmadd_ps(vec_167, vec_142, mem_vec_6238);
											mem_vec_6238 = vec_166;



											vec_168 = _mm512_fmadd_ps(vec_167, vec_144, mem_vec_6239);
											mem_vec_6239 = vec_168;
											scal_53 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 1) + c];
											vec_170 = _mm512_set1_ps(scal_53);


											vec_169 = _mm512_fmadd_ps(vec_170, vec_142, mem_vec_6240);
											mem_vec_6240 = vec_169;



											vec_171 = _mm512_fmadd_ps(vec_170, vec_144, mem_vec_6241);
											mem_vec_6241 = vec_171;
											scal_54 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 1) + c];
											vec_173 = _mm512_set1_ps(scal_54);


											vec_172 = _mm512_fmadd_ps(vec_173, vec_142, mem_vec_6242);
											mem_vec_6242 = vec_172;



											vec_174 = _mm512_fmadd_ps(vec_173, vec_144, mem_vec_6243);
											mem_vec_6243 = vec_174;
											...
											vec_175 = _mm512_fmadd_ps(vec_176, vec_177, mem_vec_6222);
											mem_vec_6222 = vec_175;

											vec_179 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_178 = _mm512_fmadd_ps(vec_176, vec_179, mem_vec_6223);
											mem_vec_6223 = vec_178;
											scal_56 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
											vec_181 = _mm512_set1_ps(scal_56);


											vec_180 = _mm512_fmadd_ps(vec_181, vec_177, mem_vec_6224);
											mem_vec_6224 = vec_180;



											vec_182 = _mm512_fmadd_ps(vec_181, vec_179, mem_vec_6225);
											mem_vec_6225 = vec_182;
											scal_57 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
											vec_184 = _mm512_set1_ps(scal_57);


											vec_183 = _mm512_fmadd_ps(vec_184, vec_177, mem_vec_6226);
											mem_vec_6226 = vec_183;



											vec_185 = _mm512_fmadd_ps(vec_184, vec_179, mem_vec_6227);
											mem_vec_6227 = vec_185;
											scal_58 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
											vec_187 = _mm512_set1_ps(scal_58);


											vec_186 = _mm512_fmadd_ps(vec_187, vec_177, mem_vec_6228);
											mem_vec_6228 = vec_186;



											vec_188 = _mm512_fmadd_ps(vec_187, vec_179, mem_vec_6229);
											mem_vec_6229 = vec_188;
											scal_59 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
											vec_190 = _mm512_set1_ps(scal_59);


											vec_189 = _mm512_fmadd_ps(vec_190, vec_177, mem_vec_6230);
											mem_vec_6230 = vec_189;



											vec_191 = _mm512_fmadd_ps(vec_190, vec_179, mem_vec_6231);
											mem_vec_6231 = vec_191;
											scal_60 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
											vec_193 = _mm512_set1_ps(scal_60);


											vec_192 = _mm512_fmadd_ps(vec_193, vec_177, mem_vec_6232);
											mem_vec_6232 = vec_192;



											vec_194 = _mm512_fmadd_ps(vec_193, vec_179, mem_vec_6233);
											mem_vec_6233 = vec_194;
											scal_61 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
											vec_196 = _mm512_set1_ps(scal_61);


											vec_195 = _mm512_fmadd_ps(vec_196, vec_177, mem_vec_6234);
											mem_vec_6234 = vec_195;



											vec_197 = _mm512_fmadd_ps(vec_196, vec_179, mem_vec_6235);
											mem_vec_6235 = vec_197;
											scal_62 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 2) + c];
											vec_199 = _mm512_set1_ps(scal_62);


											vec_198 = _mm512_fmadd_ps(vec_199, vec_177, mem_vec_6236);
											mem_vec_6236 = vec_198;



											vec_200 = _mm512_fmadd_ps(vec_199, vec_179, mem_vec_6237);
											mem_vec_6237 = vec_200;
											scal_63 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 2) + c];
											vec_202 = _mm512_set1_ps(scal_63);


											vec_201 = _mm512_fmadd_ps(vec_202, vec_177, mem_vec_6238);
											mem_vec_6238 = vec_201;



											vec_203 = _mm512_fmadd_ps(vec_202, vec_179, mem_vec_6239);
											mem_vec_6239 = vec_203;
											scal_64 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 2) + c];
											vec_205 = _mm512_set1_ps(scal_64);


											vec_204 = _mm512_fmadd_ps(vec_205, vec_177, mem_vec_6240);
											mem_vec_6240 = vec_204;



											vec_206 = _mm512_fmadd_ps(vec_205, vec_179, mem_vec_6241);
											mem_vec_6241 = vec_206;
											scal_65 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 2) + c];
											vec_208 = _mm512_set1_ps(scal_65);


											vec_207 = _mm512_fmadd_ps(vec_208, vec_177, mem_vec_6242);
											mem_vec_6242 = vec_207;



											vec_209 = _mm512_fmadd_ps(vec_208, vec_179, mem_vec_6243);
											mem_vec_6243 = vec_209;
											scal_66 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_211 = _mm512_set1_ps(scal_66);
											vec_212 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_210 = _mm512_fmadd_ps(vec_211, vec_212, mem_vec_6222);
											mem_vec_6222 = vec_210;

											vec_214 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_213 = _mm512_fmadd_ps(vec_211, vec_214, mem_vec_6223);
											mem_vec_6223 = vec_213;
											scal_67 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_216 = _mm512_set1_ps(scal_67);


											vec_215 = _mm512_fmadd_ps(vec_216, vec_212, mem_vec_6224);
											mem_vec_6224 = vec_215;



											vec_217 = _mm512_fmadd_ps(vec_216, vec_214, mem_vec_6225);
											mem_vec_6225 = vec_217;
											scal_68 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_219 = _mm512_set1_ps(scal_68);


											vec_218 = _mm512_fmadd_ps(vec_219, vec_212, mem_vec_6226);
											mem_vec_6226 = vec_218;



											vec_220 = _mm512_fmadd_ps(vec_219, vec_214, mem_vec_6227);
											mem_vec_6227 = vec_220;
											scal_69 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_222 = _mm512_set1_ps(scal_69);


											vec_221 = _mm512_fmadd_ps(vec_222, vec_212, mem_vec_6228);
											mem_vec_6228 = vec_221;



											vec_223 = _mm512_fmadd_ps(vec_222, vec_214, mem_vec_6229);
											mem_vec_6229 = vec_223;
											scal_70 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_225 = _mm512_set1_ps(scal_70);


											vec_224 = _mm512_fmadd_ps(vec_225, vec_212, mem_vec_6230);
											mem_vec_6230 = vec_224;



											vec_226 = _mm512_fmadd_ps(vec_225, vec_214, mem_vec_6231);
											mem_vec_6231 = vec_226;
											scal_71 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_228 = _mm512_set1_ps(scal_71);


											vec_227 = _mm512_fmadd_ps(vec_228, vec_212, mem_vec_6232);
											mem_vec_6232 = vec_227;



											vec_229 = _mm512_fmadd_ps(vec_228, vec_214, mem_vec_6233);
											mem_vec_6233 = vec_229;
											scal_72 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_231 = _mm512_set1_ps(scal_72);


											vec_230 = _mm512_fmadd_ps(vec_231, vec_212, mem_vec_6234);
											mem_vec_6234 = vec_230;



											vec_232 = _mm512_fmadd_ps(vec_231, vec_214, mem_vec_6235);
											mem_vec_6235 = vec_232;
											scal_73 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_234 = _mm512_set1_ps(scal_73);


											vec_233 = _mm512_fmadd_ps(vec_234, vec_212, mem_vec_6236);
											mem_vec_6236 = vec_233;



											vec_235 = _mm512_fmadd_ps(vec_234, vec_214, mem_vec_6237);
											mem_vec_6237 = vec_235;
											scal_74 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
											vec_237 = _mm512_set1_ps(scal_74);


											vec_236 = _mm512_fmadd_ps(vec_237, vec_212, mem_vec_6238);
											mem_vec_6238 = vec_236;



											vec_238 = _mm512_fmadd_ps(vec_237, vec_214, mem_vec_6239);
											mem_vec_6239 = vec_238;
											scal_75 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
											vec_240 = _mm512_set1_ps(scal_75);


											vec_239 = _mm512_fmadd_ps(vec_240, vec_212, mem_vec_6240);
											mem_vec_6240 = vec_239;



											vec_241 = _mm512_fmadd_ps(vec_240, vec_214, mem_vec_6241);
											mem_vec_6241 = vec_241;
											scal_76 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h) + c];
											vec_243 = _mm512_set1_ps(scal_76);


											vec_242 = _mm512_fmadd_ps(vec_243, vec_212, mem_vec_6242);
											mem_vec_6242 = vec_242;



											vec_244 = _mm512_fmadd_ps(vec_243, vec_214, mem_vec_6243);
											mem_vec_6243 = vec_244;
											...
											vec_245 = _mm512_fmadd_ps(vec_246, vec_247, mem_vec_6222);
											mem_vec_6222 = vec_245;

											vec_249 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_248 = _mm512_fmadd_ps(vec_246, vec_249, mem_vec_6223);
											mem_vec_6223 = vec_248;
											scal_78 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
											vec_251 = _mm512_set1_ps(scal_78);


											vec_250 = _mm512_fmadd_ps(vec_251, vec_247, mem_vec_6224);
											mem_vec_6224 = vec_250;



											vec_252 = _mm512_fmadd_ps(vec_251, vec_249, mem_vec_6225);
											mem_vec_6225 = vec_252;
											scal_79 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
											vec_254 = _mm512_set1_ps(scal_79);


											vec_253 = _mm512_fmadd_ps(vec_254, vec_247, mem_vec_6226);
											mem_vec_6226 = vec_253;



											vec_255 = _mm512_fmadd_ps(vec_254, vec_249, mem_vec_6227);
											mem_vec_6227 = vec_255;
											scal_80 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
											vec_257 = _mm512_set1_ps(scal_80);


											vec_256 = _mm512_fmadd_ps(vec_257, vec_247, mem_vec_6228);
											mem_vec_6228 = vec_256;



											vec_258 = _mm512_fmadd_ps(vec_257, vec_249, mem_vec_6229);
											mem_vec_6229 = vec_258;
											scal_81 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
											vec_260 = _mm512_set1_ps(scal_81);


											vec_259 = _mm512_fmadd_ps(vec_260, vec_247, mem_vec_6230);
											mem_vec_6230 = vec_259;



											vec_261 = _mm512_fmadd_ps(vec_260, vec_249, mem_vec_6231);
											mem_vec_6231 = vec_261;
											scal_82 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
											vec_263 = _mm512_set1_ps(scal_82);


											vec_262 = _mm512_fmadd_ps(vec_263, vec_247, mem_vec_6232);
											mem_vec_6232 = vec_262;



											vec_264 = _mm512_fmadd_ps(vec_263, vec_249, mem_vec_6233);
											mem_vec_6233 = vec_264;
											scal_83 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
											vec_266 = _mm512_set1_ps(scal_83);


											vec_265 = _mm512_fmadd_ps(vec_266, vec_247, mem_vec_6234);
											mem_vec_6234 = vec_265;



											vec_267 = _mm512_fmadd_ps(vec_266, vec_249, mem_vec_6235);
											mem_vec_6235 = vec_267;
											scal_84 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
											vec_269 = _mm512_set1_ps(scal_84);


											vec_268 = _mm512_fmadd_ps(vec_269, vec_247, mem_vec_6236);
											mem_vec_6236 = vec_268;



											vec_270 = _mm512_fmadd_ps(vec_269, vec_249, mem_vec_6237);
											mem_vec_6237 = vec_270;
											scal_85 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 1) + c];
											vec_272 = _mm512_set1_ps(scal_85);


											vec_271 = _mm512_fmadd_ps(vec_272, vec_247, mem_vec_6238);
											mem_vec_6238 = vec_271;



											vec_273 = _mm512_fmadd_ps(vec_272, vec_249, mem_vec_6239);
											mem_vec_6239 = vec_273;
											scal_86 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 1) + c];
											vec_275 = _mm512_set1_ps(scal_86);


											vec_274 = _mm512_fmadd_ps(vec_275, vec_247, mem_vec_6240);
											mem_vec_6240 = vec_274;



											vec_276 = _mm512_fmadd_ps(vec_275, vec_249, mem_vec_6241);
											mem_vec_6241 = vec_276;
											scal_87 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 1) + c];
											vec_278 = _mm512_set1_ps(scal_87);


											vec_277 = _mm512_fmadd_ps(vec_278, vec_247, mem_vec_6242);
											mem_vec_6242 = vec_277;



											vec_279 = _mm512_fmadd_ps(vec_278, vec_249, mem_vec_6243);
											mem_vec_6243 = vec_279;
											...
											vec_280 = _mm512_fmadd_ps(vec_281, vec_282, mem_vec_6222);
											mem_vec_6222 = vec_280;

											vec_284 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_283 = _mm512_fmadd_ps(vec_281, vec_284, mem_vec_6223);
											mem_vec_6223 = vec_283;
											scal_89 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
											vec_286 = _mm512_set1_ps(scal_89);


											vec_285 = _mm512_fmadd_ps(vec_286, vec_282, mem_vec_6224);
											mem_vec_6224 = vec_285;



											vec_287 = _mm512_fmadd_ps(vec_286, vec_284, mem_vec_6225);
											mem_vec_6225 = vec_287;
											scal_90 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
											vec_289 = _mm512_set1_ps(scal_90);


											vec_288 = _mm512_fmadd_ps(vec_289, vec_282, mem_vec_6226);
											mem_vec_6226 = vec_288;



											vec_290 = _mm512_fmadd_ps(vec_289, vec_284, mem_vec_6227);
											mem_vec_6227 = vec_290;
											scal_91 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
											vec_292 = _mm512_set1_ps(scal_91);


											vec_291 = _mm512_fmadd_ps(vec_292, vec_282, mem_vec_6228);
											mem_vec_6228 = vec_291;



											vec_293 = _mm512_fmadd_ps(vec_292, vec_284, mem_vec_6229);
											mem_vec_6229 = vec_293;
											scal_92 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
											vec_295 = _mm512_set1_ps(scal_92);


											vec_294 = _mm512_fmadd_ps(vec_295, vec_282, mem_vec_6230);
											mem_vec_6230 = vec_294;



											vec_296 = _mm512_fmadd_ps(vec_295, vec_284, mem_vec_6231);
											mem_vec_6231 = vec_296;
											scal_93 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
											vec_298 = _mm512_set1_ps(scal_93);


											vec_297 = _mm512_fmadd_ps(vec_298, vec_282, mem_vec_6232);
											mem_vec_6232 = vec_297;



											vec_299 = _mm512_fmadd_ps(vec_298, vec_284, mem_vec_6233);
											mem_vec_6233 = vec_299;
											scal_94 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
											vec_301 = _mm512_set1_ps(scal_94);


											vec_300 = _mm512_fmadd_ps(vec_301, vec_282, mem_vec_6234);
											mem_vec_6234 = vec_300;



											vec_302 = _mm512_fmadd_ps(vec_301, vec_284, mem_vec_6235);
											mem_vec_6235 = vec_302;
											scal_95 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
											vec_304 = _mm512_set1_ps(scal_95);


											vec_303 = _mm512_fmadd_ps(vec_304, vec_282, mem_vec_6236);
											mem_vec_6236 = vec_303;



											vec_305 = _mm512_fmadd_ps(vec_304, vec_284, mem_vec_6237);
											mem_vec_6237 = vec_305;
											scal_96 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 2) + c];
											vec_307 = _mm512_set1_ps(scal_96);


											vec_306 = _mm512_fmadd_ps(vec_307, vec_282, mem_vec_6238);
											mem_vec_6238 = vec_306;



											vec_308 = _mm512_fmadd_ps(vec_307, vec_284, mem_vec_6239);
											mem_vec_6239 = vec_308;
											scal_97 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 2) + c];
											vec_310 = _mm512_set1_ps(scal_97);


											vec_309 = _mm512_fmadd_ps(vec_310, vec_282, mem_vec_6240);
											mem_vec_6240 = vec_309;



											vec_311 = _mm512_fmadd_ps(vec_310, vec_284, mem_vec_6241);
											mem_vec_6241 = vec_311;
											scal_98 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 2) + c];
											vec_313 = _mm512_set1_ps(scal_98);


											vec_312 = _mm512_fmadd_ps(vec_313, vec_282, mem_vec_6242);
											mem_vec_6242 = vec_312;



											vec_314 = _mm512_fmadd_ps(vec_313, vec_284, mem_vec_6243);
											mem_vec_6243 = vec_314;
										}
