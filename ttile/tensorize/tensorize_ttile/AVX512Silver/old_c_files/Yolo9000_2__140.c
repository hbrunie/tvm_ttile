...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (1, x); T (1, c); T (1, x); T (17, y); T (4, f); T (272, x); T (1, y);
  T (4, y)]
*/
IND_TYPE c, cp_0, c432_p_0, cp_1, c432, f, fp_0, x, xp_0, x576_p_0, x577_p_0, xp_1, x576_p_1, xp_2, x576, x577, y, yp_0, y570_p_0, y571_p_0, yp_1, y570_p_1, yp_2, y570, y571;
...
__m512 mem_vec_1248 ,mem_vec_1249 ,mem_vec_1250 ,mem_vec_1251 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_78 ,vec_79 ,vec_8 ,vec_80 ,vec_9;
// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
// T (y, 4) (272 / 68)
for (y571 = y572, y571_p_0 = 0;
	y571 < y572 + 272;
	y571 += 68, y571_p_0 += 68){
	// y = 68, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (y, 1) (68 / 68)
	for (y570 = y571, y570_p_1 = y571_p_0, y570_p_0 = 0;
		y570 < y571 + 68;
		y570 += 68, y570_p_1 += 68, y570_p_0 += 68){
		// y = 68, x = 272, h = 3, w = 3, c = 32, f = 64
		// T (x, 272) (272 / 1)
		for (x577 = x578, x577_p_0 = 0;
			...
			for (f = f162, fp_0 = 0;
				...
				// T (y, 17) (68 / 4)
				for (y = y570, yp_2 = y570_p_1, yp_1 = y570_p_0, yp_0 = 0;
					y < y570 + 68;
