...
[V f; U (4, f); U (2, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, c); T (34, x); T (1, y); T (136, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c69_p_0, cp_1, c69, w, wp_0, x, xp_0, x92_p_0, x93_p_0, xp_1, x92_p_1, xp_2, x92, x93, y, yp_0, y92_p_0, y93_p_0, yp_1, y92_p_1, yp_2, y92, y93;
							...
							for (x = x92, xp_2 = x92_p_1, xp_1 = x92_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c69, cp_1 = c69_p_0, cp_0 = 0;
											...
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_186);
											mem_vec_186 = vec_19;

											vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_187);
											mem_vec_187 = vec_21;
											scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_24 = _mm512_set1_ps(scal_3);


											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_188);
											mem_vec_188 = vec_23;



											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_189);
											mem_vec_189 = vec_25;



											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_190);
											mem_vec_190 = vec_26;



											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_191);
											mem_vec_191 = vec_27;
											...
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_186);
											mem_vec_186 = vec_33;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_187);
											mem_vec_187 = vec_35;
											scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_38 = _mm512_set1_ps(scal_5);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_188);
											mem_vec_188 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_189);
											mem_vec_189 = vec_39;



											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_190);
											mem_vec_190 = vec_40;



											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_191);
											mem_vec_191 = vec_41;
										}
