...
[V f; U (2, f); ULambda y; U (3, w); T (32, c); Hoist_vars [c]; T (34, x);
  ...
  T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c162_p_0, cp_1, c162, f, fp_0, h, hp_0, x, xp_0, x158_p_0, xp_1, x158, y, yp_0, y113_p_0, yp_1, y113;
IND_TYPE y114 = 0;
IND_TYPE x159 = 0;
IND_TYPE h100 = 0;
IND_TYPE w = 0;
...
x158 = 0;
x158_p_0 = 0;
		for (f = f184, fp_0 = 0;f < f184 + 512;f += 32, fp_0 += 32){
				for (y = y113, yp_1 = y113_p_0, yp_0 = 0;y < y113 + 6;y += 6, yp_1 += 6, yp_0 += 6){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (c, 8) (256 / 32)
					for (c162 = c163, c162_p_0 = 0;c162 < c163 + 256;c162 += 32, c162_p_0 += 32){
						...
						for (h = h100, hp_0 = 0;h < h100 + 3;h += 1, hp_0 += 1){
							...
							for (x = x158, xp_1 = x158_p_0, xp_0 = 0;x < x158 + 34;x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c162, cp_1 = c162_p_0, cp_0 = 0;c < c162 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_20 = _mm512_fmadd_ps(vec_21, vec_22, mem_vec_1670);
											mem_vec_1670 = vec_20;
											vec_24 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
											vec_23 = _mm512_fmadd_ps(vec_21, vec_24, mem_vec_1671);
											mem_vec_1671 = vec_23;
											scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
											vec_26 = _mm512_set1_ps(scal_7);
											vec_25 = _mm512_fmadd_ps(vec_26, vec_22, mem_vec_1672);
											mem_vec_1672 = vec_25;
											vec_27 = _mm512_fmadd_ps(vec_26, vec_24, mem_vec_1673);
											mem_vec_1673 = vec_27;
											scal_8 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
											vec_29 = _mm512_set1_ps(scal_8);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_22, mem_vec_1674);
											mem_vec_1674 = vec_28;
											vec_30 = _mm512_fmadd_ps(vec_29, vec_24, mem_vec_1675);
											mem_vec_1675 = vec_30;
											scal_9 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
											vec_32 = _mm512_set1_ps(scal_9);
											vec_31 = _mm512_fmadd_ps(vec_32, vec_22, mem_vec_1676);
											mem_vec_1676 = vec_31;
											vec_33 = _mm512_fmadd_ps(vec_32, vec_24, mem_vec_1677);
											mem_vec_1677 = vec_33;
											scal_10 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
											vec_35 = _mm512_set1_ps(scal_10);
											vec_34 = _mm512_fmadd_ps(vec_35, vec_22, mem_vec_1678);
											mem_vec_1678 = vec_34;
											vec_36 = _mm512_fmadd_ps(vec_35, vec_24, mem_vec_1679);
											mem_vec_1679 = vec_36;
											scal_11 = input[strideA1 * (x + w + 1) + strideA2 * (y + 5 + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_22, mem_vec_1680);
											mem_vec_1680 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_24, mem_vec_1681);
											mem_vec_1681 = vec_39;
											scal_12 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);
											vec_42 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
											vec_40 = _mm512_fmadd_ps(vec_41, vec_42, mem_vec_1670);
											mem_vec_1670 = vec_40;
											vec_44 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
											vec_43 = _mm512_fmadd_ps(vec_41, vec_44, mem_vec_1671);
											mem_vec_1671 = vec_43;
											scal_13 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
											vec_46 = _mm512_set1_ps(scal_13);
											vec_45 = _mm512_fmadd_ps(vec_46, vec_42, mem_vec_1672);
											mem_vec_1672 = vec_45;
											vec_47 = _mm512_fmadd_ps(vec_46, vec_44, mem_vec_1673);
											mem_vec_1673 = vec_47;
											scal_14 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
											vec_49 = _mm512_set1_ps(scal_14);
											vec_48 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_1674);
											mem_vec_1674 = vec_48;
											vec_50 = _mm512_fmadd_ps(vec_49, vec_44, mem_vec_1675);
											mem_vec_1675 = vec_50;
											scal_15 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
											vec_52 = _mm512_set1_ps(scal_15);
											vec_51 = _mm512_fmadd_ps(vec_52, vec_42, mem_vec_1676);
											mem_vec_1676 = vec_51;
											vec_53 = _mm512_fmadd_ps(vec_52, vec_44, mem_vec_1677);
											mem_vec_1677 = vec_53;
											scal_16 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
											vec_55 = _mm512_set1_ps(scal_16);
											vec_54 = _mm512_fmadd_ps(vec_55, vec_42, mem_vec_1678);
											mem_vec_1678 = vec_54;
											vec_56 = _mm512_fmadd_ps(vec_55, vec_44, mem_vec_1679);
											mem_vec_1679 = vec_56;
											scal_17 = input[strideA1 * (x + w + 2) + strideA2 * (y + 5 + h) + c];
											vec_58 = _mm512_set1_ps(scal_17);
											vec_57 = _mm512_fmadd_ps(vec_58, vec_42, mem_vec_1680);
											mem_vec_1680 = vec_57;
											vec_59 = _mm512_fmadd_ps(vec_58, vec_44, mem_vec_1681);
											mem_vec_1681 = vec_59;
										}
				...
				for (y = y113 + 6, yp_1 = y113_p_0, yp_0 = 0;y < y113 + 6 + 28;y += 7, yp_1 += 7, yp_0 += 7){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (c, 8) (256 / 32)
					for (c162 = c163, c162_p_0 = 0;c162 < c163 + 256;c162 += 32, c162_p_0 += 32){
						// y = ph_y, x = 34, h = 3, w = 3, c = 32, f = 32
						...
						for (h = h100, hp_0 = 0;h < h100 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 34) (34 / 1)
							for (x = x158, xp_1 = x158_p_0, xp_0 = 0;x < x158 + 34;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_1682 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_1683 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
										...
										mem_vec_1686 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_1687 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16]);
										...
										mem_vec_1690 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_1691 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
										mem_vec_1692 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										mem_vec_1693 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
										mem_vec_1694 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
										mem_vec_1695 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 3, c = 32, f = 32
										// T (c, 32) (32 / 1)
										for (c = c162, cp_1 = c162_p_0, cp_0 = 0;c < c162 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
											...
											vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_1682);
											mem_vec_1682 = vec_23;
											vec_27 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
											vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_1683);
											mem_vec_1683 = vec_26;
											scal_8 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
											vec_29 = _mm512_set1_ps(scal_8);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_1684);
											mem_vec_1684 = vec_28;
											vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_1685);
											mem_vec_1685 = vec_30;
											scal_9 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
											vec_32 = _mm512_set1_ps(scal_9);
											vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_1686);
											mem_vec_1686 = vec_31;
											vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_1687);
											mem_vec_1687 = vec_33;
											scal_10 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
											vec_35 = _mm512_set1_ps(scal_10);
											vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_1688);
											mem_vec_1688 = vec_34;
											vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_1689);
											mem_vec_1689 = vec_36;
											scal_11 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_1690);
											mem_vec_1690 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_1691);
											mem_vec_1691 = vec_39;
											scal_12 = input[strideA1 * (x + w + 1) + strideA2 * (y + 5 + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);
											vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_1692);
											mem_vec_1692 = vec_40;
											vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_1693);
											mem_vec_1693 = vec_42;
											scal_13 = input[strideA1 * (x + w + 1) + strideA2 * (y + 6 + h) + c];
											vec_44 = _mm512_set1_ps(scal_13);
											vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_1694);
											mem_vec_1694 = vec_43;
											vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_1695);
											mem_vec_1695 = vec_45;
											scal_14 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
											vec_47 = _mm512_set1_ps(scal_14);
											vec_48 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
											vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_1682);
											mem_vec_1682 = vec_46;
											vec_50 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
											vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_1683);
											mem_vec_1683 = vec_49;
											scal_15 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
											vec_52 = _mm512_set1_ps(scal_15);
											vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_1684);
											mem_vec_1684 = vec_51;
											vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_1685);
											mem_vec_1685 = vec_53;
											scal_16 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
											vec_55 = _mm512_set1_ps(scal_16);
											vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_1686);
											mem_vec_1686 = vec_54;
											vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_1687);
											mem_vec_1687 = vec_56;
											scal_17 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
											vec_58 = _mm512_set1_ps(scal_17);
											vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_1688);
											mem_vec_1688 = vec_57;
											vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1689);
											mem_vec_1689 = vec_59;
											scal_18 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
											vec_61 = _mm512_set1_ps(scal_18);
											vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_1690);
											mem_vec_1690 = vec_60;
											vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_1691);
											mem_vec_1691 = vec_62;
											scal_19 = input[strideA1 * (x + w + 2) + strideA2 * (y + 5 + h) + c];
											vec_64 = _mm512_set1_ps(scal_19);
											vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_1692);
											mem_vec_1692 = vec_63;
											vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_1693);
											mem_vec_1693 = vec_65;
											scal_20 = input[strideA1 * (x + w + 2) + strideA2 * (y + 6 + h) + c];
											vec_67 = _mm512_set1_ps(scal_20);
											vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_1694);
											mem_vec_1694 = vec_66;
											vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_1695);
											mem_vec_1695 = vec_68;
										}
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_1682);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_1683);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_1686);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16], mem_vec_1687);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_1690);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_1691);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_1692);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_1693);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_1694);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_1695);
							}
						}
					}
				}
