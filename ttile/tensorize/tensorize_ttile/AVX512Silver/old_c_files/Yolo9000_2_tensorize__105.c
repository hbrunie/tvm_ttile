...
[V f; U (4, f); U (2, y); U (3, w); T (16, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (2, c); T (17, x); T (1, y); T (136, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c174_p_0, cp_1, c174, h, hp_0, x, xp_0, x232_p_0, x233_p_0, xp_1, x232_p_1, xp_2, x232, x233, y, yp_0, y232_p_0, y233_p_0, yp_1, y232_p_1, yp_2, y232, y233;
IND_TYPE y234 = 0;
IND_TYPE x234 = 0;
IND_TYPE h74 = 0;
IND_TYPE w = 0;
