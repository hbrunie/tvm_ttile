				...
				for (h = h60, hp_0 = 0;
					...
					for (w = w33, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								mem_vec_271 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
								mem_vec_272 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
								mem_vec_273 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_274 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
								mem_vec_275 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_276 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
								mem_vec_277 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_278 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
								mem_vec_279 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_280 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
								mem_vec_281 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								mem_vec_282 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_271);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_272);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_273);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_274);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_275);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_276);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_277);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_278);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_279);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_280);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_281);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_282);
					}
				}
			}
		}
