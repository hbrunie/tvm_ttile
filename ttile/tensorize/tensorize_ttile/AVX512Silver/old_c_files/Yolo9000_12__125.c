	...
	for (x267 = x268, x267_p_0 = 0;
		...
		for (f = f298, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
						...
						for (h = h165, hp_0 = 0;
							...
							for (x = x267, xp_1 = x267_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2950 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_2951 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_2950);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_2951);
				...
				for (y = y196 + 25, yp_1 = y196_p_0, yp_0 = 0;
					y < y196 + 25 + 9;
					y += 9, yp_1 += 9, yp_0 += 9){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (c, 8) (256 / 32)
