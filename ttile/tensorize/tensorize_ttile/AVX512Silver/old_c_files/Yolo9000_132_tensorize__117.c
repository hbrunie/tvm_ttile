...
*/
IND_TYPE c, cp_0, c321_p_0, cp_1, c321, f, fp_0, x, xp_0, x428_p_0, x429_p_0, xp_1, x428_p_1, xp_2, x428, x429, y, yp_0, y295_p_0, yp_1, y295;
IND_TYPE y296 = 0;
IND_TYPE x430 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c321 = 0;
c321_p_0 = 0;
							for (x = x428, xp_2 = x428_p_1, xp_1 = x428_p_0, xp_0 = 0;x < x428 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 256) (256 / 1)
										for (c = c321, cp_1 = c321_p_0, cp_0 = 0;c < c321 + 256;c += 1, cp_1 += 1, cp_0 += 1){
