	...
	x33 += 136, x33_p_0 += 136){
		for (y = y16, yp_0 = 0;
			...
			for (x32 = x33, x32_p_1 = x33_p_0, x32_p_0 = 0;
				x32 < x33 + 136;
				x32 += 136, x32_p_1 += 136, x32_p_0 += 136){
				// y = ph_y, x = 136, h = 3, w = 3, c = 64, f = 128
				// T (f, 4) (128 / 32)
				for (f = f16, fp_0 = 0;
					f < f16 + 128;
						...
						for (x = x32, xp_2 = x32_p_1, xp_1 = x32_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c24, cp_1 = c24_p_0, cp_0 = 0;
										...
										vec_29 = _mm512_fmadd_ps(vec_30, vec_31, mem_vec_356);
										mem_vec_356 = vec_29;

										vec_33 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_357);
										mem_vec_357 = vec_32;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);


										vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_358);
										mem_vec_358 = vec_34;



										vec_36 = _mm512_fmadd_ps(vec_35, vec_33, mem_vec_359);
										mem_vec_359 = vec_36;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);


										vec_37 = _mm512_fmadd_ps(vec_38, vec_31, mem_vec_360);
										mem_vec_360 = vec_37;



										vec_39 = _mm512_fmadd_ps(vec_38, vec_33, mem_vec_361);
										mem_vec_361 = vec_39;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_362);
										mem_vec_362 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_33, mem_vec_363);
										mem_vec_363 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_364);
										mem_vec_364 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_365);
										mem_vec_365 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_14);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_366);
										mem_vec_366 = vec_46;



										vec_48 = _mm512_fmadd_ps(vec_47, vec_33, mem_vec_367);
										mem_vec_367 = vec_48;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_31, mem_vec_368);
										mem_vec_368 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_33, mem_vec_369);
										mem_vec_369 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_53 = _mm512_set1_ps(scal_16);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_370);
										mem_vec_370 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_33, mem_vec_371);
										mem_vec_371 = vec_54;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
										vec_56 = _mm512_set1_ps(scal_17);


										vec_55 = _mm512_fmadd_ps(vec_56, vec_31, mem_vec_372);
										mem_vec_372 = vec_55;



										vec_57 = _mm512_fmadd_ps(vec_56, vec_33, mem_vec_373);
										mem_vec_373 = vec_57;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_59 = _mm512_set1_ps(scal_18);
										vec_60 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_58 = _mm512_fmadd_ps(vec_59, vec_60, mem_vec_356);
										mem_vec_356 = vec_58;

										vec_62 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_357);
										mem_vec_357 = vec_61;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_64 = _mm512_set1_ps(scal_19);


										vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_358);
										mem_vec_358 = vec_63;



										vec_65 = _mm512_fmadd_ps(vec_64, vec_62, mem_vec_359);
										mem_vec_359 = vec_65;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_67 = _mm512_set1_ps(scal_20);


										vec_66 = _mm512_fmadd_ps(vec_67, vec_60, mem_vec_360);
										mem_vec_360 = vec_66;



										vec_68 = _mm512_fmadd_ps(vec_67, vec_62, mem_vec_361);
										mem_vec_361 = vec_68;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_70 = _mm512_set1_ps(scal_21);


										vec_69 = _mm512_fmadd_ps(vec_70, vec_60, mem_vec_362);
										mem_vec_362 = vec_69;



										vec_71 = _mm512_fmadd_ps(vec_70, vec_62, mem_vec_363);
										mem_vec_363 = vec_71;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_73 = _mm512_set1_ps(scal_22);


										vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_364);
										mem_vec_364 = vec_72;



										vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_365);
										mem_vec_365 = vec_74;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_76 = _mm512_set1_ps(scal_23);


										vec_75 = _mm512_fmadd_ps(vec_76, vec_60, mem_vec_366);
										mem_vec_366 = vec_75;



										vec_77 = _mm512_fmadd_ps(vec_76, vec_62, mem_vec_367);
										mem_vec_367 = vec_77;
										scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_79 = _mm512_set1_ps(scal_24);


										vec_78 = _mm512_fmadd_ps(vec_79, vec_60, mem_vec_368);
										mem_vec_368 = vec_78;



										vec_80 = _mm512_fmadd_ps(vec_79, vec_62, mem_vec_369);
										mem_vec_369 = vec_80;
										scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_82 = _mm512_set1_ps(scal_25);


										vec_81 = _mm512_fmadd_ps(vec_82, vec_60, mem_vec_370);
										mem_vec_370 = vec_81;



										vec_83 = _mm512_fmadd_ps(vec_82, vec_62, mem_vec_371);
										mem_vec_371 = vec_83;
										scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
										vec_85 = _mm512_set1_ps(scal_26);


										vec_84 = _mm512_fmadd_ps(vec_85, vec_60, mem_vec_372);
										mem_vec_372 = vec_84;



										vec_86 = _mm512_fmadd_ps(vec_85, vec_62, mem_vec_373);
										mem_vec_373 = vec_86;
										scal_27 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
										vec_88 = _mm512_set1_ps(scal_27);
										vec_89 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

										vec_87 = _mm512_fmadd_ps(vec_88, vec_89, mem_vec_356);
										mem_vec_356 = vec_87;

										vec_91 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_90 = _mm512_fmadd_ps(vec_88, vec_91, mem_vec_357);
										mem_vec_357 = vec_90;
										scal_28 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_93 = _mm512_set1_ps(scal_28);


										vec_92 = _mm512_fmadd_ps(vec_93, vec_89, mem_vec_358);
										mem_vec_358 = vec_92;



										vec_94 = _mm512_fmadd_ps(vec_93, vec_91, mem_vec_359);
										mem_vec_359 = vec_94;
										scal_29 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_96 = _mm512_set1_ps(scal_29);


										vec_95 = _mm512_fmadd_ps(vec_96, vec_89, mem_vec_360);
										mem_vec_360 = vec_95;



										vec_97 = _mm512_fmadd_ps(vec_96, vec_91, mem_vec_361);
										mem_vec_361 = vec_97;
										scal_30 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_99 = _mm512_set1_ps(scal_30);


										vec_98 = _mm512_fmadd_ps(vec_99, vec_89, mem_vec_362);
										mem_vec_362 = vec_98;



										vec_100 = _mm512_fmadd_ps(vec_99, vec_91, mem_vec_363);
										mem_vec_363 = vec_100;
										scal_31 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
										vec_102 = _mm512_set1_ps(scal_31);


										vec_101 = _mm512_fmadd_ps(vec_102, vec_89, mem_vec_364);
										mem_vec_364 = vec_101;



										vec_103 = _mm512_fmadd_ps(vec_102, vec_91, mem_vec_365);
										mem_vec_365 = vec_103;
										scal_32 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
										vec_105 = _mm512_set1_ps(scal_32);


										vec_104 = _mm512_fmadd_ps(vec_105, vec_89, mem_vec_366);
										mem_vec_366 = vec_104;



										vec_106 = _mm512_fmadd_ps(vec_105, vec_91, mem_vec_367);
										mem_vec_367 = vec_106;
										scal_33 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
										vec_108 = _mm512_set1_ps(scal_33);


										vec_107 = _mm512_fmadd_ps(vec_108, vec_89, mem_vec_368);
										mem_vec_368 = vec_107;



										vec_109 = _mm512_fmadd_ps(vec_108, vec_91, mem_vec_369);
										mem_vec_369 = vec_109;
										scal_34 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
										vec_111 = _mm512_set1_ps(scal_34);


										vec_110 = _mm512_fmadd_ps(vec_111, vec_89, mem_vec_370);
										mem_vec_370 = vec_110;



										vec_112 = _mm512_fmadd_ps(vec_111, vec_91, mem_vec_371);
										mem_vec_371 = vec_112;
										scal_35 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
										vec_114 = _mm512_set1_ps(scal_35);


										vec_113 = _mm512_fmadd_ps(vec_114, vec_89, mem_vec_372);
										mem_vec_372 = vec_113;



										vec_115 = _mm512_fmadd_ps(vec_114, vec_91, mem_vec_373);
										mem_vec_373 = vec_115;
										...
										vec_116 = _mm512_fmadd_ps(vec_117, vec_118, mem_vec_356);
										mem_vec_356 = vec_116;

										vec_120 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

										vec_119 = _mm512_fmadd_ps(vec_117, vec_120, mem_vec_357);
										mem_vec_357 = vec_119;
										scal_37 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
										vec_122 = _mm512_set1_ps(scal_37);


										vec_121 = _mm512_fmadd_ps(vec_122, vec_118, mem_vec_358);
										mem_vec_358 = vec_121;



										vec_123 = _mm512_fmadd_ps(vec_122, vec_120, mem_vec_359);
										mem_vec_359 = vec_123;
										scal_38 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
										vec_125 = _mm512_set1_ps(scal_38);


										vec_124 = _mm512_fmadd_ps(vec_125, vec_118, mem_vec_360);
										mem_vec_360 = vec_124;



										vec_126 = _mm512_fmadd_ps(vec_125, vec_120, mem_vec_361);
										mem_vec_361 = vec_126;
										scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
										vec_128 = _mm512_set1_ps(scal_39);


										vec_127 = _mm512_fmadd_ps(vec_128, vec_118, mem_vec_362);
										mem_vec_362 = vec_127;



										vec_129 = _mm512_fmadd_ps(vec_128, vec_120, mem_vec_363);
										mem_vec_363 = vec_129;
										scal_40 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
										vec_131 = _mm512_set1_ps(scal_40);


										vec_130 = _mm512_fmadd_ps(vec_131, vec_118, mem_vec_364);
										mem_vec_364 = vec_130;



										vec_132 = _mm512_fmadd_ps(vec_131, vec_120, mem_vec_365);
										mem_vec_365 = vec_132;
										scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
										vec_134 = _mm512_set1_ps(scal_41);


										vec_133 = _mm512_fmadd_ps(vec_134, vec_118, mem_vec_366);
										mem_vec_366 = vec_133;



										vec_135 = _mm512_fmadd_ps(vec_134, vec_120, mem_vec_367);
										mem_vec_367 = vec_135;
										scal_42 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
										vec_137 = _mm512_set1_ps(scal_42);


										vec_136 = _mm512_fmadd_ps(vec_137, vec_118, mem_vec_368);
										mem_vec_368 = vec_136;



										vec_138 = _mm512_fmadd_ps(vec_137, vec_120, mem_vec_369);
										mem_vec_369 = vec_138;
										scal_43 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
										vec_140 = _mm512_set1_ps(scal_43);


										vec_139 = _mm512_fmadd_ps(vec_140, vec_118, mem_vec_370);
										mem_vec_370 = vec_139;



										vec_141 = _mm512_fmadd_ps(vec_140, vec_120, mem_vec_371);
										mem_vec_371 = vec_141;
										scal_44 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 1) + c];
										vec_143 = _mm512_set1_ps(scal_44);


										vec_142 = _mm512_fmadd_ps(vec_143, vec_118, mem_vec_372);
										mem_vec_372 = vec_142;



										vec_144 = _mm512_fmadd_ps(vec_143, vec_120, mem_vec_373);
										mem_vec_373 = vec_144;
										...
										vec_145 = _mm512_fmadd_ps(vec_146, vec_147, mem_vec_356);
										mem_vec_356 = vec_145;

										vec_149 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

										vec_148 = _mm512_fmadd_ps(vec_146, vec_149, mem_vec_357);
										mem_vec_357 = vec_148;
										scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
										vec_151 = _mm512_set1_ps(scal_46);


										vec_150 = _mm512_fmadd_ps(vec_151, vec_147, mem_vec_358);
										mem_vec_358 = vec_150;



										vec_152 = _mm512_fmadd_ps(vec_151, vec_149, mem_vec_359);
										mem_vec_359 = vec_152;
										scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
										vec_154 = _mm512_set1_ps(scal_47);


										vec_153 = _mm512_fmadd_ps(vec_154, vec_147, mem_vec_360);
										mem_vec_360 = vec_153;



										vec_155 = _mm512_fmadd_ps(vec_154, vec_149, mem_vec_361);
										mem_vec_361 = vec_155;
										scal_48 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
										vec_157 = _mm512_set1_ps(scal_48);


										vec_156 = _mm512_fmadd_ps(vec_157, vec_147, mem_vec_362);
										mem_vec_362 = vec_156;



										vec_158 = _mm512_fmadd_ps(vec_157, vec_149, mem_vec_363);
										mem_vec_363 = vec_158;
										scal_49 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
										vec_160 = _mm512_set1_ps(scal_49);


										vec_159 = _mm512_fmadd_ps(vec_160, vec_147, mem_vec_364);
										mem_vec_364 = vec_159;



										vec_161 = _mm512_fmadd_ps(vec_160, vec_149, mem_vec_365);
										mem_vec_365 = vec_161;
										scal_50 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
										vec_163 = _mm512_set1_ps(scal_50);


										vec_162 = _mm512_fmadd_ps(vec_163, vec_147, mem_vec_366);
										mem_vec_366 = vec_162;



										vec_164 = _mm512_fmadd_ps(vec_163, vec_149, mem_vec_367);
										mem_vec_367 = vec_164;
										scal_51 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
										vec_166 = _mm512_set1_ps(scal_51);


										vec_165 = _mm512_fmadd_ps(vec_166, vec_147, mem_vec_368);
										mem_vec_368 = vec_165;



										vec_167 = _mm512_fmadd_ps(vec_166, vec_149, mem_vec_369);
										mem_vec_369 = vec_167;
										scal_52 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 2) + c];
										vec_169 = _mm512_set1_ps(scal_52);


										vec_168 = _mm512_fmadd_ps(vec_169, vec_147, mem_vec_370);
										mem_vec_370 = vec_168;



										vec_170 = _mm512_fmadd_ps(vec_169, vec_149, mem_vec_371);
										mem_vec_371 = vec_170;
										scal_53 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 2) + c];
										vec_172 = _mm512_set1_ps(scal_53);


										vec_171 = _mm512_fmadd_ps(vec_172, vec_147, mem_vec_372);
										mem_vec_372 = vec_171;



										vec_173 = _mm512_fmadd_ps(vec_172, vec_149, mem_vec_373);
										mem_vec_373 = vec_173;
										scal_54 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_175 = _mm512_set1_ps(scal_54);
										vec_176 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_174 = _mm512_fmadd_ps(vec_175, vec_176, mem_vec_356);
										mem_vec_356 = vec_174;

										vec_178 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_177 = _mm512_fmadd_ps(vec_175, vec_178, mem_vec_357);
										mem_vec_357 = vec_177;
										scal_55 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_180 = _mm512_set1_ps(scal_55);


										vec_179 = _mm512_fmadd_ps(vec_180, vec_176, mem_vec_358);
										mem_vec_358 = vec_179;



										vec_181 = _mm512_fmadd_ps(vec_180, vec_178, mem_vec_359);
										mem_vec_359 = vec_181;
										scal_56 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_183 = _mm512_set1_ps(scal_56);


										vec_182 = _mm512_fmadd_ps(vec_183, vec_176, mem_vec_360);
										mem_vec_360 = vec_182;



										vec_184 = _mm512_fmadd_ps(vec_183, vec_178, mem_vec_361);
										mem_vec_361 = vec_184;
										scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_186 = _mm512_set1_ps(scal_57);


										vec_185 = _mm512_fmadd_ps(vec_186, vec_176, mem_vec_362);
										mem_vec_362 = vec_185;



										vec_187 = _mm512_fmadd_ps(vec_186, vec_178, mem_vec_363);
										mem_vec_363 = vec_187;
										scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
										vec_189 = _mm512_set1_ps(scal_58);


										vec_188 = _mm512_fmadd_ps(vec_189, vec_176, mem_vec_364);
										mem_vec_364 = vec_188;



										vec_190 = _mm512_fmadd_ps(vec_189, vec_178, mem_vec_365);
										mem_vec_365 = vec_190;
										scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
										vec_192 = _mm512_set1_ps(scal_59);


										vec_191 = _mm512_fmadd_ps(vec_192, vec_176, mem_vec_366);
										mem_vec_366 = vec_191;



										vec_193 = _mm512_fmadd_ps(vec_192, vec_178, mem_vec_367);
										mem_vec_367 = vec_193;
										scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
										vec_195 = _mm512_set1_ps(scal_60);


										vec_194 = _mm512_fmadd_ps(vec_195, vec_176, mem_vec_368);
										mem_vec_368 = vec_194;



										vec_196 = _mm512_fmadd_ps(vec_195, vec_178, mem_vec_369);
										mem_vec_369 = vec_196;
										scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
										vec_198 = _mm512_set1_ps(scal_61);


										vec_197 = _mm512_fmadd_ps(vec_198, vec_176, mem_vec_370);
										mem_vec_370 = vec_197;



										vec_199 = _mm512_fmadd_ps(vec_198, vec_178, mem_vec_371);
										mem_vec_371 = vec_199;
										scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
										vec_201 = _mm512_set1_ps(scal_62);


										vec_200 = _mm512_fmadd_ps(vec_201, vec_176, mem_vec_372);
										mem_vec_372 = vec_200;



										vec_202 = _mm512_fmadd_ps(vec_201, vec_178, mem_vec_373);
										mem_vec_373 = vec_202;
										...
										vec_203 = _mm512_fmadd_ps(vec_204, vec_205, mem_vec_356);
										mem_vec_356 = vec_203;

										vec_207 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

										vec_206 = _mm512_fmadd_ps(vec_204, vec_207, mem_vec_357);
										mem_vec_357 = vec_206;
										scal_64 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
										vec_209 = _mm512_set1_ps(scal_64);


										vec_208 = _mm512_fmadd_ps(vec_209, vec_205, mem_vec_358);
										mem_vec_358 = vec_208;



										vec_210 = _mm512_fmadd_ps(vec_209, vec_207, mem_vec_359);
										mem_vec_359 = vec_210;
										scal_65 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
										vec_212 = _mm512_set1_ps(scal_65);


										vec_211 = _mm512_fmadd_ps(vec_212, vec_205, mem_vec_360);
										mem_vec_360 = vec_211;



										vec_213 = _mm512_fmadd_ps(vec_212, vec_207, mem_vec_361);
										mem_vec_361 = vec_213;
										scal_66 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
										vec_215 = _mm512_set1_ps(scal_66);


										vec_214 = _mm512_fmadd_ps(vec_215, vec_205, mem_vec_362);
										mem_vec_362 = vec_214;



										vec_216 = _mm512_fmadd_ps(vec_215, vec_207, mem_vec_363);
										mem_vec_363 = vec_216;
										scal_67 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
										vec_218 = _mm512_set1_ps(scal_67);


										vec_217 = _mm512_fmadd_ps(vec_218, vec_205, mem_vec_364);
										mem_vec_364 = vec_217;



										vec_219 = _mm512_fmadd_ps(vec_218, vec_207, mem_vec_365);
										mem_vec_365 = vec_219;
										scal_68 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
										vec_221 = _mm512_set1_ps(scal_68);


										vec_220 = _mm512_fmadd_ps(vec_221, vec_205, mem_vec_366);
										mem_vec_366 = vec_220;



										vec_222 = _mm512_fmadd_ps(vec_221, vec_207, mem_vec_367);
										mem_vec_367 = vec_222;
										scal_69 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
										vec_224 = _mm512_set1_ps(scal_69);


										vec_223 = _mm512_fmadd_ps(vec_224, vec_205, mem_vec_368);
										mem_vec_368 = vec_223;



										vec_225 = _mm512_fmadd_ps(vec_224, vec_207, mem_vec_369);
										mem_vec_369 = vec_225;
										scal_70 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
										vec_227 = _mm512_set1_ps(scal_70);


										vec_226 = _mm512_fmadd_ps(vec_227, vec_205, mem_vec_370);
										mem_vec_370 = vec_226;



										vec_228 = _mm512_fmadd_ps(vec_227, vec_207, mem_vec_371);
										mem_vec_371 = vec_228;
										scal_71 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 1) + c];
										vec_230 = _mm512_set1_ps(scal_71);


										vec_229 = _mm512_fmadd_ps(vec_230, vec_205, mem_vec_372);
										mem_vec_372 = vec_229;



										vec_231 = _mm512_fmadd_ps(vec_230, vec_207, mem_vec_373);
										mem_vec_373 = vec_231;
										...
										vec_232 = _mm512_fmadd_ps(vec_233, vec_234, mem_vec_356);
										mem_vec_356 = vec_232;

										vec_236 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

										vec_235 = _mm512_fmadd_ps(vec_233, vec_236, mem_vec_357);
										mem_vec_357 = vec_235;
										scal_73 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
										vec_238 = _mm512_set1_ps(scal_73);


										vec_237 = _mm512_fmadd_ps(vec_238, vec_234, mem_vec_358);
										mem_vec_358 = vec_237;



										vec_239 = _mm512_fmadd_ps(vec_238, vec_236, mem_vec_359);
										mem_vec_359 = vec_239;
										scal_74 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
										vec_241 = _mm512_set1_ps(scal_74);


										vec_240 = _mm512_fmadd_ps(vec_241, vec_234, mem_vec_360);
										mem_vec_360 = vec_240;



										vec_242 = _mm512_fmadd_ps(vec_241, vec_236, mem_vec_361);
										mem_vec_361 = vec_242;
										scal_75 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
										vec_244 = _mm512_set1_ps(scal_75);


										vec_243 = _mm512_fmadd_ps(vec_244, vec_234, mem_vec_362);
										mem_vec_362 = vec_243;



										vec_245 = _mm512_fmadd_ps(vec_244, vec_236, mem_vec_363);
										mem_vec_363 = vec_245;
										scal_76 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
										vec_247 = _mm512_set1_ps(scal_76);


										vec_246 = _mm512_fmadd_ps(vec_247, vec_234, mem_vec_364);
										mem_vec_364 = vec_246;



										vec_248 = _mm512_fmadd_ps(vec_247, vec_236, mem_vec_365);
										mem_vec_365 = vec_248;
										scal_77 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
										vec_250 = _mm512_set1_ps(scal_77);


										vec_249 = _mm512_fmadd_ps(vec_250, vec_234, mem_vec_366);
										mem_vec_366 = vec_249;



										vec_251 = _mm512_fmadd_ps(vec_250, vec_236, mem_vec_367);
										mem_vec_367 = vec_251;
										scal_78 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
										vec_253 = _mm512_set1_ps(scal_78);


										vec_252 = _mm512_fmadd_ps(vec_253, vec_234, mem_vec_368);
										mem_vec_368 = vec_252;



										vec_254 = _mm512_fmadd_ps(vec_253, vec_236, mem_vec_369);
										mem_vec_369 = vec_254;
										scal_79 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
										vec_256 = _mm512_set1_ps(scal_79);


										vec_255 = _mm512_fmadd_ps(vec_256, vec_234, mem_vec_370);
										mem_vec_370 = vec_255;



										vec_257 = _mm512_fmadd_ps(vec_256, vec_236, mem_vec_371);
										mem_vec_371 = vec_257;
										scal_80 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 2) + c];
										vec_259 = _mm512_set1_ps(scal_80);


										vec_258 = _mm512_fmadd_ps(vec_259, vec_234, mem_vec_372);
										mem_vec_372 = vec_258;



										vec_260 = _mm512_fmadd_ps(vec_259, vec_236, mem_vec_373);
										mem_vec_373 = vec_260;
									}
					...
					for (c24 = c25, c24_p_0 = 0;
						...
						for (x = x32, xp_2 = x32_p_1, xp_1 = x32_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_390 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_391 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
									mem_vec_392 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_393 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
									mem_vec_394 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_395 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									// y = ph_y, x = 1, h = 3, w = 3, c = 64, f = 32
									// T (c, 64) (64 / 1)
									for (c = c24, cp_1 = c24_p_0, cp_0 = 0;
										c < c24 + 64;
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_390);
										mem_vec_390 = vec_26;



										vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_391);
										mem_vec_391 = vec_28;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h) + c];
										vec_30 = _mm512_set1_ps(scal_9);


										vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_392);
										mem_vec_392 = vec_29;



										vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_393);
										mem_vec_393 = vec_31;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
										vec_33 = _mm512_set1_ps(scal_10);


										vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_394);
										mem_vec_394 = vec_32;



										vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_395);
										mem_vec_395 = vec_34;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
										vec_36 = _mm512_set1_ps(scal_11);
										vec_37 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

										vec_35 = _mm512_fmadd_ps(vec_36, vec_37, mem_vec_374);
										mem_vec_374 = vec_35;

										vec_39 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

										vec_38 = _mm512_fmadd_ps(vec_36, vec_39, mem_vec_375);
										mem_vec_375 = vec_38;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_41 = _mm512_set1_ps(scal_12);


										vec_40 = _mm512_fmadd_ps(vec_41, vec_37, mem_vec_376);
										mem_vec_376 = vec_40;



										vec_42 = _mm512_fmadd_ps(vec_41, vec_39, mem_vec_377);
										mem_vec_377 = vec_42;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_44 = _mm512_set1_ps(scal_13);


										vec_43 = _mm512_fmadd_ps(vec_44, vec_37, mem_vec_378);
										mem_vec_378 = vec_43;



										vec_45 = _mm512_fmadd_ps(vec_44, vec_39, mem_vec_379);
										mem_vec_379 = vec_45;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_47 = _mm512_set1_ps(scal_14);


										vec_46 = _mm512_fmadd_ps(vec_47, vec_37, mem_vec_380);
										mem_vec_380 = vec_46;



										vec_48 = _mm512_fmadd_ps(vec_47, vec_39, mem_vec_381);
										mem_vec_381 = vec_48;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_50 = _mm512_set1_ps(scal_15);


										vec_49 = _mm512_fmadd_ps(vec_50, vec_37, mem_vec_382);
										mem_vec_382 = vec_49;



										vec_51 = _mm512_fmadd_ps(vec_50, vec_39, mem_vec_383);
										mem_vec_383 = vec_51;
										scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_53 = _mm512_set1_ps(scal_16);


										vec_52 = _mm512_fmadd_ps(vec_53, vec_37, mem_vec_384);
										mem_vec_384 = vec_52;



										vec_54 = _mm512_fmadd_ps(vec_53, vec_39, mem_vec_385);
										mem_vec_385 = vec_54;
										scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_56 = _mm512_set1_ps(scal_17);


										vec_55 = _mm512_fmadd_ps(vec_56, vec_37, mem_vec_386);
										mem_vec_386 = vec_55;



										vec_57 = _mm512_fmadd_ps(vec_56, vec_39, mem_vec_387);
										mem_vec_387 = vec_57;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_59 = _mm512_set1_ps(scal_18);


										vec_58 = _mm512_fmadd_ps(vec_59, vec_37, mem_vec_388);
										mem_vec_388 = vec_58;



										vec_60 = _mm512_fmadd_ps(vec_59, vec_39, mem_vec_389);
										mem_vec_389 = vec_60;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
										vec_62 = _mm512_set1_ps(scal_19);


										vec_61 = _mm512_fmadd_ps(vec_62, vec_37, mem_vec_390);
										mem_vec_390 = vec_61;



										vec_63 = _mm512_fmadd_ps(vec_62, vec_39, mem_vec_391);
										mem_vec_391 = vec_63;
										scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
										vec_65 = _mm512_set1_ps(scal_20);


										vec_64 = _mm512_fmadd_ps(vec_65, vec_37, mem_vec_392);
										mem_vec_392 = vec_64;



										vec_66 = _mm512_fmadd_ps(vec_65, vec_39, mem_vec_393);
										mem_vec_393 = vec_66;
										scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
										vec_68 = _mm512_set1_ps(scal_21);


										vec_67 = _mm512_fmadd_ps(vec_68, vec_37, mem_vec_394);
										mem_vec_394 = vec_67;



										vec_69 = _mm512_fmadd_ps(vec_68, vec_39, mem_vec_395);
										mem_vec_395 = vec_69;
										scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
										vec_71 = _mm512_set1_ps(scal_22);
										vec_72 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

										vec_70 = _mm512_fmadd_ps(vec_71, vec_72, mem_vec_374);
										mem_vec_374 = vec_70;

										vec_74 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

										vec_73 = _mm512_fmadd_ps(vec_71, vec_74, mem_vec_375);
										mem_vec_375 = vec_73;
										scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
										vec_76 = _mm512_set1_ps(scal_23);


										vec_75 = _mm512_fmadd_ps(vec_76, vec_72, mem_vec_376);
										mem_vec_376 = vec_75;



										vec_77 = _mm512_fmadd_ps(vec_76, vec_74, mem_vec_377);
										mem_vec_377 = vec_77;
										scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_79 = _mm512_set1_ps(scal_24);


										vec_78 = _mm512_fmadd_ps(vec_79, vec_72, mem_vec_378);
										mem_vec_378 = vec_78;



										vec_80 = _mm512_fmadd_ps(vec_79, vec_74, mem_vec_379);
										mem_vec_379 = vec_80;
										scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_82 = _mm512_set1_ps(scal_25);


										vec_81 = _mm512_fmadd_ps(vec_82, vec_72, mem_vec_380);
										mem_vec_380 = vec_81;



										vec_83 = _mm512_fmadd_ps(vec_82, vec_74, mem_vec_381);
										mem_vec_381 = vec_83;
										scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
										vec_85 = _mm512_set1_ps(scal_26);


										vec_84 = _mm512_fmadd_ps(vec_85, vec_72, mem_vec_382);
										mem_vec_382 = vec_84;



										vec_86 = _mm512_fmadd_ps(vec_85, vec_74, mem_vec_383);
										mem_vec_383 = vec_86;
										scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
										vec_88 = _mm512_set1_ps(scal_27);


										vec_87 = _mm512_fmadd_ps(vec_88, vec_72, mem_vec_384);
										mem_vec_384 = vec_87;



										vec_89 = _mm512_fmadd_ps(vec_88, vec_74, mem_vec_385);
										mem_vec_385 = vec_89;
										scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
										vec_91 = _mm512_set1_ps(scal_28);


										vec_90 = _mm512_fmadd_ps(vec_91, vec_72, mem_vec_386);
										mem_vec_386 = vec_90;



										vec_92 = _mm512_fmadd_ps(vec_91, vec_74, mem_vec_387);
										mem_vec_387 = vec_92;
										scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
										vec_94 = _mm512_set1_ps(scal_29);


										vec_93 = _mm512_fmadd_ps(vec_94, vec_72, mem_vec_388);
										mem_vec_388 = vec_93;



										vec_95 = _mm512_fmadd_ps(vec_94, vec_74, mem_vec_389);
										mem_vec_389 = vec_95;
										scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
										vec_97 = _mm512_set1_ps(scal_30);


										vec_96 = _mm512_fmadd_ps(vec_97, vec_72, mem_vec_390);
										mem_vec_390 = vec_96;



										vec_98 = _mm512_fmadd_ps(vec_97, vec_74, mem_vec_391);
										mem_vec_391 = vec_98;
										scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
										vec_100 = _mm512_set1_ps(scal_31);


										vec_99 = _mm512_fmadd_ps(vec_100, vec_72, mem_vec_392);
										mem_vec_392 = vec_99;



										vec_101 = _mm512_fmadd_ps(vec_100, vec_74, mem_vec_393);
										mem_vec_393 = vec_101;
										scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
										vec_103 = _mm512_set1_ps(scal_32);


										vec_102 = _mm512_fmadd_ps(vec_103, vec_72, mem_vec_394);
										mem_vec_394 = vec_102;



										vec_104 = _mm512_fmadd_ps(vec_103, vec_74, mem_vec_395);
										mem_vec_395 = vec_104;
										scal_33 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
										vec_106 = _mm512_set1_ps(scal_33);
										vec_107 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

										vec_105 = _mm512_fmadd_ps(vec_106, vec_107, mem_vec_374);
										mem_vec_374 = vec_105;

										vec_109 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_108 = _mm512_fmadd_ps(vec_106, vec_109, mem_vec_375);
										mem_vec_375 = vec_108;
										scal_34 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
										vec_111 = _mm512_set1_ps(scal_34);


										vec_110 = _mm512_fmadd_ps(vec_111, vec_107, mem_vec_376);
										mem_vec_376 = vec_110;



										vec_112 = _mm512_fmadd_ps(vec_111, vec_109, mem_vec_377);
										mem_vec_377 = vec_112;
										scal_35 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
										vec_114 = _mm512_set1_ps(scal_35);


										vec_113 = _mm512_fmadd_ps(vec_114, vec_107, mem_vec_378);
										mem_vec_378 = vec_113;



										vec_115 = _mm512_fmadd_ps(vec_114, vec_109, mem_vec_379);
										mem_vec_379 = vec_115;
										scal_36 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
										vec_117 = _mm512_set1_ps(scal_36);


										vec_116 = _mm512_fmadd_ps(vec_117, vec_107, mem_vec_380);
										mem_vec_380 = vec_116;



										vec_118 = _mm512_fmadd_ps(vec_117, vec_109, mem_vec_381);
										mem_vec_381 = vec_118;
										scal_37 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
										vec_120 = _mm512_set1_ps(scal_37);


										vec_119 = _mm512_fmadd_ps(vec_120, vec_107, mem_vec_382);
										mem_vec_382 = vec_119;



										vec_121 = _mm512_fmadd_ps(vec_120, vec_109, mem_vec_383);
										mem_vec_383 = vec_121;
										scal_38 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
										vec_123 = _mm512_set1_ps(scal_38);


										vec_122 = _mm512_fmadd_ps(vec_123, vec_107, mem_vec_384);
										mem_vec_384 = vec_122;



										vec_124 = _mm512_fmadd_ps(vec_123, vec_109, mem_vec_385);
										mem_vec_385 = vec_124;
										scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
										vec_126 = _mm512_set1_ps(scal_39);


										vec_125 = _mm512_fmadd_ps(vec_126, vec_107, mem_vec_386);
										mem_vec_386 = vec_125;



										vec_127 = _mm512_fmadd_ps(vec_126, vec_109, mem_vec_387);
										mem_vec_387 = vec_127;
										scal_40 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
										vec_129 = _mm512_set1_ps(scal_40);


										vec_128 = _mm512_fmadd_ps(vec_129, vec_107, mem_vec_388);
										mem_vec_388 = vec_128;



										vec_130 = _mm512_fmadd_ps(vec_129, vec_109, mem_vec_389);
										mem_vec_389 = vec_130;
										scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
										vec_132 = _mm512_set1_ps(scal_41);


										vec_131 = _mm512_fmadd_ps(vec_132, vec_107, mem_vec_390);
										mem_vec_390 = vec_131;



										vec_133 = _mm512_fmadd_ps(vec_132, vec_109, mem_vec_391);
										mem_vec_391 = vec_133;
										scal_42 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
										vec_135 = _mm512_set1_ps(scal_42);


										vec_134 = _mm512_fmadd_ps(vec_135, vec_107, mem_vec_392);
										mem_vec_392 = vec_134;



										vec_136 = _mm512_fmadd_ps(vec_135, vec_109, mem_vec_393);
										mem_vec_393 = vec_136;
										scal_43 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
										vec_138 = _mm512_set1_ps(scal_43);


										vec_137 = _mm512_fmadd_ps(vec_138, vec_107, mem_vec_394);
										mem_vec_394 = vec_137;



										vec_139 = _mm512_fmadd_ps(vec_138, vec_109, mem_vec_395);
										mem_vec_395 = vec_139;
										...
										vec_140 = _mm512_fmadd_ps(vec_141, vec_142, mem_vec_374);
										mem_vec_374 = vec_140;

										vec_144 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

										vec_143 = _mm512_fmadd_ps(vec_141, vec_144, mem_vec_375);
										mem_vec_375 = vec_143;
										scal_45 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
										vec_146 = _mm512_set1_ps(scal_45);


										vec_145 = _mm512_fmadd_ps(vec_146, vec_142, mem_vec_376);
										mem_vec_376 = vec_145;



										vec_147 = _mm512_fmadd_ps(vec_146, vec_144, mem_vec_377);
										mem_vec_377 = vec_147;
										scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
										vec_149 = _mm512_set1_ps(scal_46);


										vec_148 = _mm512_fmadd_ps(vec_149, vec_142, mem_vec_378);
										mem_vec_378 = vec_148;



										vec_150 = _mm512_fmadd_ps(vec_149, vec_144, mem_vec_379);
										mem_vec_379 = vec_150;
										scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
										vec_152 = _mm512_set1_ps(scal_47);


										vec_151 = _mm512_fmadd_ps(vec_152, vec_142, mem_vec_380);
										mem_vec_380 = vec_151;



										vec_153 = _mm512_fmadd_ps(vec_152, vec_144, mem_vec_381);
										mem_vec_381 = vec_153;
										scal_48 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
										vec_155 = _mm512_set1_ps(scal_48);


										vec_154 = _mm512_fmadd_ps(vec_155, vec_142, mem_vec_382);
										mem_vec_382 = vec_154;



										vec_156 = _mm512_fmadd_ps(vec_155, vec_144, mem_vec_383);
										mem_vec_383 = vec_156;
										scal_49 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
										vec_158 = _mm512_set1_ps(scal_49);


										vec_157 = _mm512_fmadd_ps(vec_158, vec_142, mem_vec_384);
										mem_vec_384 = vec_157;



										vec_159 = _mm512_fmadd_ps(vec_158, vec_144, mem_vec_385);
										mem_vec_385 = vec_159;
										scal_50 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
										vec_161 = _mm512_set1_ps(scal_50);


										vec_160 = _mm512_fmadd_ps(vec_161, vec_142, mem_vec_386);
										mem_vec_386 = vec_160;



										vec_162 = _mm512_fmadd_ps(vec_161, vec_144, mem_vec_387);
										mem_vec_387 = vec_162;
										scal_51 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
										vec_164 = _mm512_set1_ps(scal_51);


										vec_163 = _mm512_fmadd_ps(vec_164, vec_142, mem_vec_388);
										mem_vec_388 = vec_163;



										vec_165 = _mm512_fmadd_ps(vec_164, vec_144, mem_vec_389);
										mem_vec_389 = vec_165;
										scal_52 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 1) + c];
										vec_167 = _mm512_set1_ps(scal_52);


										vec_166 = _mm512_fmadd_ps(vec_167, vec_142, mem_vec_390);
										mem_vec_390 = vec_166;



										vec_168 = _mm512_fmadd_ps(vec_167, vec_144, mem_vec_391);
										mem_vec_391 = vec_168;
										scal_53 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 1) + c];
										vec_170 = _mm512_set1_ps(scal_53);


										vec_169 = _mm512_fmadd_ps(vec_170, vec_142, mem_vec_392);
										mem_vec_392 = vec_169;



										vec_171 = _mm512_fmadd_ps(vec_170, vec_144, mem_vec_393);
										mem_vec_393 = vec_171;
										scal_54 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 1) + c];
										vec_173 = _mm512_set1_ps(scal_54);


										vec_172 = _mm512_fmadd_ps(vec_173, vec_142, mem_vec_394);
										mem_vec_394 = vec_172;



										vec_174 = _mm512_fmadd_ps(vec_173, vec_144, mem_vec_395);
										mem_vec_395 = vec_174;
										...
										vec_175 = _mm512_fmadd_ps(vec_176, vec_177, mem_vec_374);
										mem_vec_374 = vec_175;

										vec_179 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

										vec_178 = _mm512_fmadd_ps(vec_176, vec_179, mem_vec_375);
										mem_vec_375 = vec_178;
										scal_56 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
										vec_181 = _mm512_set1_ps(scal_56);


										vec_180 = _mm512_fmadd_ps(vec_181, vec_177, mem_vec_376);
										mem_vec_376 = vec_180;



										vec_182 = _mm512_fmadd_ps(vec_181, vec_179, mem_vec_377);
										mem_vec_377 = vec_182;
										scal_57 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
										vec_184 = _mm512_set1_ps(scal_57);


										vec_183 = _mm512_fmadd_ps(vec_184, vec_177, mem_vec_378);
										mem_vec_378 = vec_183;



										vec_185 = _mm512_fmadd_ps(vec_184, vec_179, mem_vec_379);
										mem_vec_379 = vec_185;
										scal_58 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
										vec_187 = _mm512_set1_ps(scal_58);


										vec_186 = _mm512_fmadd_ps(vec_187, vec_177, mem_vec_380);
										mem_vec_380 = vec_186;



										vec_188 = _mm512_fmadd_ps(vec_187, vec_179, mem_vec_381);
										mem_vec_381 = vec_188;
										scal_59 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
										vec_190 = _mm512_set1_ps(scal_59);


										vec_189 = _mm512_fmadd_ps(vec_190, vec_177, mem_vec_382);
										mem_vec_382 = vec_189;



										vec_191 = _mm512_fmadd_ps(vec_190, vec_179, mem_vec_383);
										mem_vec_383 = vec_191;
										scal_60 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
										vec_193 = _mm512_set1_ps(scal_60);


										vec_192 = _mm512_fmadd_ps(vec_193, vec_177, mem_vec_384);
										mem_vec_384 = vec_192;



										vec_194 = _mm512_fmadd_ps(vec_193, vec_179, mem_vec_385);
										mem_vec_385 = vec_194;
										scal_61 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
										vec_196 = _mm512_set1_ps(scal_61);


										vec_195 = _mm512_fmadd_ps(vec_196, vec_177, mem_vec_386);
										mem_vec_386 = vec_195;



										vec_197 = _mm512_fmadd_ps(vec_196, vec_179, mem_vec_387);
										mem_vec_387 = vec_197;
										scal_62 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 2) + c];
										vec_199 = _mm512_set1_ps(scal_62);


										vec_198 = _mm512_fmadd_ps(vec_199, vec_177, mem_vec_388);
										mem_vec_388 = vec_198;



										vec_200 = _mm512_fmadd_ps(vec_199, vec_179, mem_vec_389);
										mem_vec_389 = vec_200;
										scal_63 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 2) + c];
										vec_202 = _mm512_set1_ps(scal_63);


										vec_201 = _mm512_fmadd_ps(vec_202, vec_177, mem_vec_390);
										mem_vec_390 = vec_201;



										vec_203 = _mm512_fmadd_ps(vec_202, vec_179, mem_vec_391);
										mem_vec_391 = vec_203;
										scal_64 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 2) + c];
										vec_205 = _mm512_set1_ps(scal_64);


										vec_204 = _mm512_fmadd_ps(vec_205, vec_177, mem_vec_392);
										mem_vec_392 = vec_204;



										vec_206 = _mm512_fmadd_ps(vec_205, vec_179, mem_vec_393);
										mem_vec_393 = vec_206;
										scal_65 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 2) + c];
										vec_208 = _mm512_set1_ps(scal_65);


										vec_207 = _mm512_fmadd_ps(vec_208, vec_177, mem_vec_394);
										mem_vec_394 = vec_207;



										vec_209 = _mm512_fmadd_ps(vec_208, vec_179, mem_vec_395);
										mem_vec_395 = vec_209;
										scal_66 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
										vec_211 = _mm512_set1_ps(scal_66);
										vec_212 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_210 = _mm512_fmadd_ps(vec_211, vec_212, mem_vec_374);
										mem_vec_374 = vec_210;

										vec_214 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_213 = _mm512_fmadd_ps(vec_211, vec_214, mem_vec_375);
										mem_vec_375 = vec_213;
										scal_67 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
										vec_216 = _mm512_set1_ps(scal_67);


										vec_215 = _mm512_fmadd_ps(vec_216, vec_212, mem_vec_376);
										mem_vec_376 = vec_215;



										vec_217 = _mm512_fmadd_ps(vec_216, vec_214, mem_vec_377);
										mem_vec_377 = vec_217;
										scal_68 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
										vec_219 = _mm512_set1_ps(scal_68);


										vec_218 = _mm512_fmadd_ps(vec_219, vec_212, mem_vec_378);
										mem_vec_378 = vec_218;



										vec_220 = _mm512_fmadd_ps(vec_219, vec_214, mem_vec_379);
										mem_vec_379 = vec_220;
										scal_69 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
										vec_222 = _mm512_set1_ps(scal_69);


										vec_221 = _mm512_fmadd_ps(vec_222, vec_212, mem_vec_380);
										mem_vec_380 = vec_221;



										vec_223 = _mm512_fmadd_ps(vec_222, vec_214, mem_vec_381);
										mem_vec_381 = vec_223;
										scal_70 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
										vec_225 = _mm512_set1_ps(scal_70);


										vec_224 = _mm512_fmadd_ps(vec_225, vec_212, mem_vec_382);
										mem_vec_382 = vec_224;



										vec_226 = _mm512_fmadd_ps(vec_225, vec_214, mem_vec_383);
										mem_vec_383 = vec_226;
										scal_71 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
										vec_228 = _mm512_set1_ps(scal_71);


										vec_227 = _mm512_fmadd_ps(vec_228, vec_212, mem_vec_384);
										mem_vec_384 = vec_227;



										vec_229 = _mm512_fmadd_ps(vec_228, vec_214, mem_vec_385);
										mem_vec_385 = vec_229;
										scal_72 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
										vec_231 = _mm512_set1_ps(scal_72);


										vec_230 = _mm512_fmadd_ps(vec_231, vec_212, mem_vec_386);
										mem_vec_386 = vec_230;



										vec_232 = _mm512_fmadd_ps(vec_231, vec_214, mem_vec_387);
										mem_vec_387 = vec_232;
										scal_73 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
										vec_234 = _mm512_set1_ps(scal_73);


										vec_233 = _mm512_fmadd_ps(vec_234, vec_212, mem_vec_388);
										mem_vec_388 = vec_233;



										vec_235 = _mm512_fmadd_ps(vec_234, vec_214, mem_vec_389);
										mem_vec_389 = vec_235;
										scal_74 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
										vec_237 = _mm512_set1_ps(scal_74);


										vec_236 = _mm512_fmadd_ps(vec_237, vec_212, mem_vec_390);
										mem_vec_390 = vec_236;



										vec_238 = _mm512_fmadd_ps(vec_237, vec_214, mem_vec_391);
										mem_vec_391 = vec_238;
										scal_75 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
										vec_240 = _mm512_set1_ps(scal_75);


										vec_239 = _mm512_fmadd_ps(vec_240, vec_212, mem_vec_392);
										mem_vec_392 = vec_239;



										vec_241 = _mm512_fmadd_ps(vec_240, vec_214, mem_vec_393);
										mem_vec_393 = vec_241;
										scal_76 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h) + c];
										vec_243 = _mm512_set1_ps(scal_76);


										vec_242 = _mm512_fmadd_ps(vec_243, vec_212, mem_vec_394);
										mem_vec_394 = vec_242;



										vec_244 = _mm512_fmadd_ps(vec_243, vec_214, mem_vec_395);
										mem_vec_395 = vec_244;
										...
										vec_245 = _mm512_fmadd_ps(vec_246, vec_247, mem_vec_374);
										mem_vec_374 = vec_245;

										vec_249 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

										vec_248 = _mm512_fmadd_ps(vec_246, vec_249, mem_vec_375);
										mem_vec_375 = vec_248;
										scal_78 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
										vec_251 = _mm512_set1_ps(scal_78);


										vec_250 = _mm512_fmadd_ps(vec_251, vec_247, mem_vec_376);
										mem_vec_376 = vec_250;



										vec_252 = _mm512_fmadd_ps(vec_251, vec_249, mem_vec_377);
										mem_vec_377 = vec_252;
										scal_79 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
										vec_254 = _mm512_set1_ps(scal_79);


										vec_253 = _mm512_fmadd_ps(vec_254, vec_247, mem_vec_378);
										mem_vec_378 = vec_253;



										vec_255 = _mm512_fmadd_ps(vec_254, vec_249, mem_vec_379);
										mem_vec_379 = vec_255;
										scal_80 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
										vec_257 = _mm512_set1_ps(scal_80);


										vec_256 = _mm512_fmadd_ps(vec_257, vec_247, mem_vec_380);
										mem_vec_380 = vec_256;



										vec_258 = _mm512_fmadd_ps(vec_257, vec_249, mem_vec_381);
										mem_vec_381 = vec_258;
										scal_81 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
										vec_260 = _mm512_set1_ps(scal_81);


										vec_259 = _mm512_fmadd_ps(vec_260, vec_247, mem_vec_382);
										mem_vec_382 = vec_259;



										vec_261 = _mm512_fmadd_ps(vec_260, vec_249, mem_vec_383);
										mem_vec_383 = vec_261;
										scal_82 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
										vec_263 = _mm512_set1_ps(scal_82);


										vec_262 = _mm512_fmadd_ps(vec_263, vec_247, mem_vec_384);
										mem_vec_384 = vec_262;



										vec_264 = _mm512_fmadd_ps(vec_263, vec_249, mem_vec_385);
										mem_vec_385 = vec_264;
										scal_83 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
										vec_266 = _mm512_set1_ps(scal_83);


										vec_265 = _mm512_fmadd_ps(vec_266, vec_247, mem_vec_386);
										mem_vec_386 = vec_265;



										vec_267 = _mm512_fmadd_ps(vec_266, vec_249, mem_vec_387);
										mem_vec_387 = vec_267;
										scal_84 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
										vec_269 = _mm512_set1_ps(scal_84);


										vec_268 = _mm512_fmadd_ps(vec_269, vec_247, mem_vec_388);
										mem_vec_388 = vec_268;



										vec_270 = _mm512_fmadd_ps(vec_269, vec_249, mem_vec_389);
										mem_vec_389 = vec_270;
										scal_85 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 1) + c];
										vec_272 = _mm512_set1_ps(scal_85);


										vec_271 = _mm512_fmadd_ps(vec_272, vec_247, mem_vec_390);
										mem_vec_390 = vec_271;



										vec_273 = _mm512_fmadd_ps(vec_272, vec_249, mem_vec_391);
										mem_vec_391 = vec_273;
										scal_86 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 1) + c];
										vec_275 = _mm512_set1_ps(scal_86);


										vec_274 = _mm512_fmadd_ps(vec_275, vec_247, mem_vec_392);
										mem_vec_392 = vec_274;



										vec_276 = _mm512_fmadd_ps(vec_275, vec_249, mem_vec_393);
										mem_vec_393 = vec_276;
										scal_87 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 1) + c];
										vec_278 = _mm512_set1_ps(scal_87);


										vec_277 = _mm512_fmadd_ps(vec_278, vec_247, mem_vec_394);
										mem_vec_394 = vec_277;



										vec_279 = _mm512_fmadd_ps(vec_278, vec_249, mem_vec_395);
										mem_vec_395 = vec_279;
										...
										vec_280 = _mm512_fmadd_ps(vec_281, vec_282, mem_vec_374);
										mem_vec_374 = vec_280;

										vec_284 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

										vec_283 = _mm512_fmadd_ps(vec_281, vec_284, mem_vec_375);
										mem_vec_375 = vec_283;
										scal_89 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
										vec_286 = _mm512_set1_ps(scal_89);


										vec_285 = _mm512_fmadd_ps(vec_286, vec_282, mem_vec_376);
										mem_vec_376 = vec_285;



										vec_287 = _mm512_fmadd_ps(vec_286, vec_284, mem_vec_377);
										mem_vec_377 = vec_287;
										scal_90 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
										vec_289 = _mm512_set1_ps(scal_90);


										vec_288 = _mm512_fmadd_ps(vec_289, vec_282, mem_vec_378);
										mem_vec_378 = vec_288;



										vec_290 = _mm512_fmadd_ps(vec_289, vec_284, mem_vec_379);
										mem_vec_379 = vec_290;
										scal_91 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
										vec_292 = _mm512_set1_ps(scal_91);


										vec_291 = _mm512_fmadd_ps(vec_292, vec_282, mem_vec_380);
										mem_vec_380 = vec_291;



										vec_293 = _mm512_fmadd_ps(vec_292, vec_284, mem_vec_381);
										mem_vec_381 = vec_293;
										scal_92 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
										vec_295 = _mm512_set1_ps(scal_92);


										vec_294 = _mm512_fmadd_ps(vec_295, vec_282, mem_vec_382);
										mem_vec_382 = vec_294;



										vec_296 = _mm512_fmadd_ps(vec_295, vec_284, mem_vec_383);
										mem_vec_383 = vec_296;
										scal_93 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
										vec_298 = _mm512_set1_ps(scal_93);


										vec_297 = _mm512_fmadd_ps(vec_298, vec_282, mem_vec_384);
										mem_vec_384 = vec_297;



										vec_299 = _mm512_fmadd_ps(vec_298, vec_284, mem_vec_385);
										mem_vec_385 = vec_299;
										scal_94 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
										vec_301 = _mm512_set1_ps(scal_94);


										vec_300 = _mm512_fmadd_ps(vec_301, vec_282, mem_vec_386);
										mem_vec_386 = vec_300;



										vec_302 = _mm512_fmadd_ps(vec_301, vec_284, mem_vec_387);
										mem_vec_387 = vec_302;
										scal_95 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
										vec_304 = _mm512_set1_ps(scal_95);


										vec_303 = _mm512_fmadd_ps(vec_304, vec_282, mem_vec_388);
										mem_vec_388 = vec_303;



										vec_305 = _mm512_fmadd_ps(vec_304, vec_284, mem_vec_389);
										mem_vec_389 = vec_305;
										scal_96 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 2) + c];
										vec_307 = _mm512_set1_ps(scal_96);


										vec_306 = _mm512_fmadd_ps(vec_307, vec_282, mem_vec_390);
										mem_vec_390 = vec_306;



										vec_308 = _mm512_fmadd_ps(vec_307, vec_284, mem_vec_391);
										mem_vec_391 = vec_308;
										scal_97 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 2) + c];
										vec_310 = _mm512_set1_ps(scal_97);


										vec_309 = _mm512_fmadd_ps(vec_310, vec_282, mem_vec_392);
										mem_vec_392 = vec_309;



										vec_311 = _mm512_fmadd_ps(vec_310, vec_284, mem_vec_393);
										mem_vec_393 = vec_311;
										scal_98 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 2) + c];
										vec_313 = _mm512_set1_ps(scal_98);


										vec_312 = _mm512_fmadd_ps(vec_313, vec_282, mem_vec_394);
										mem_vec_394 = vec_312;



										vec_314 = _mm512_fmadd_ps(vec_313, vec_284, mem_vec_395);
										mem_vec_395 = vec_314;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_390);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_391);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_392);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_393);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_394);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_395);
						}
					}
				}
			}
