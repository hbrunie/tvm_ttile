...
*/
IND_TYPE c, cp_0, c180_p_0, c181_p_0, cp_1, c180_p_1, cp_2, c180, c181, f, fp_0, f135_p_0, fp_1, f135, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y74 = 0;
IND_TYPE x90 = 0;
IND_TYPE h67 = 0;
IND_TYPE w67 = 0;
...
xp_0 = 0;
						for (h = h67, hp_0 = 0;h < h67 + 3;h += 1, hp_0 += 1){
							...
							for (w = w67, wp_0 = 0;w < w67 + 3;w += 1, wp_0 += 1){
										...
										// T (c, 32) (32 / 1)
										for (c = c180, cp_2 = c180_p_1, cp_1 = c180_p_0, cp_0 = 0;c < c180 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
