...
c632_p_1 = 0;
						for (x = x316, xp_0 = 0;x < x316 + 17;x += 1, xp_0 += 1){
									...
									mem_vec_2780 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									mem_vec_2781 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2780);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_2781);
						}
}
