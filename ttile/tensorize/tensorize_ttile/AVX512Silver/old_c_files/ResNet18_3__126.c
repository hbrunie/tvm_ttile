...
for (y595 = y596, y595_p_0 = 0;
	...
	for (x749 = x750, x749_p_0 = 0;
		...
		for (y594 = y595, y594_p_1 = y595_p_0, y594_p_0 = 0;
			y594 < y595 + 56;
			y594 += 28, y594_p_1 += 28, y594_p_0 += 28){
			...
			for (x748 = x749, x748_p_1 = x749_p_0, x748_p_0 = 0;
				...
				for (f = f288, fp_0 = 0;
					...
					for (y = y594, yp_2 = y594_p_1, yp_1 = y594_p_0, yp_0 = 0;
						...
						// T (x, 1) (7 / 7)
						for (x747 = x748, x747_p_2 = x748_p_1, x747_p_1 = x748_p_0, x747_p_0 = 0;
							x747 < x748 + 7;
							x747 += 7, x747_p_2 += 7, x747_p_1 += 7, x747_p_0 += 7){
							// y = 7, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c459 = c460, c459_p_0 = 0;
								...
								// y = 7, x = 7, h = 1, w = 1, c = 64, f = 32
								// T (x, 7) (7 / 1)
								for (x = x747, xp_3 = x747_p_2, xp_2 = x747_p_1, xp_1 = x747_p_0, xp_0 = 0;
									x < x747 + 7;
