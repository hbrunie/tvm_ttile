...
[V f; U (2, f); U (8, y); U (3, w); T (32, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (4, c); T (4, f); T (2, x); T (7, y); T (1, x)]
*/
IND_TYPE c, cp_0, c141_p_0, cp_1, c141, f, fp_0, h, hp_0, x, xp_0, x164_p_0, x165_p_0, xp_1, x164_p_1, xp_2, x164, x165, y, yp_0;
IND_TYPE y116 = 0;
IND_TYPE x166 = 0;
IND_TYPE h73 = 0;
IND_TYPE w = 0;
					...
					for (h = h73, hp_0 = 0;h < h73 + 3;h += 1, hp_0 += 1){
						...
						for (x = x164, xp_2 = x164_p_1, xp_1 = x164_p_0, xp_0 = 0;x < x164 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c141, cp_1 = c141_p_0, cp_0 = 0;c < c141 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_938);
										mem_vec_938 = vec_31;
										vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_939);
										mem_vec_939 = vec_33;
										scal_10 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
										vec_35 = _mm512_set1_ps(scal_10);
										vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_940);
										mem_vec_940 = vec_34;
										vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_941);
										mem_vec_941 = vec_36;
										scal_11 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
										vec_38 = _mm512_set1_ps(scal_11);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_942);
										mem_vec_942 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_943);
										mem_vec_943 = vec_39;
										scal_12 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_944);
										mem_vec_944 = vec_40;
										vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_945);
										mem_vec_945 = vec_42;
										scal_13 = input[strideA1 * (x + w + 1) + strideA2 * (y + 5 + h) + c];
										vec_44 = _mm512_set1_ps(scal_13);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_946);
										mem_vec_946 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_947);
										mem_vec_947 = vec_45;
										scal_14 = input[strideA1 * (x + w + 1) + strideA2 * (y + 6 + h) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_948);
										mem_vec_948 = vec_46;
										vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_949);
										mem_vec_949 = vec_48;
										scal_15 = input[strideA1 * (x + w + 1) + strideA2 * (y + 7 + h) + c];
										vec_50 = _mm512_set1_ps(scal_15);
										vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_950);
										mem_vec_950 = vec_49;
										vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_951);
										mem_vec_951 = vec_51;
										...
										vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_938);
										mem_vec_938 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_939);
										mem_vec_939 = vec_59;
										scal_18 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
										vec_61 = _mm512_set1_ps(scal_18);
										vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_940);
										mem_vec_940 = vec_60;
										vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_941);
										mem_vec_941 = vec_62;
										scal_19 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
										vec_64 = _mm512_set1_ps(scal_19);
										vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_942);
										mem_vec_942 = vec_63;
										vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_943);
										mem_vec_943 = vec_65;
										scal_20 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
										vec_67 = _mm512_set1_ps(scal_20);
										vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_944);
										mem_vec_944 = vec_66;
										vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_945);
										mem_vec_945 = vec_68;
										scal_21 = input[strideA1 * (x + w + 2) + strideA2 * (y + 5 + h) + c];
										vec_70 = _mm512_set1_ps(scal_21);
										vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_946);
										mem_vec_946 = vec_69;
										vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_947);
										mem_vec_947 = vec_71;
										scal_22 = input[strideA1 * (x + w + 2) + strideA2 * (y + 6 + h) + c];
										vec_73 = _mm512_set1_ps(scal_22);
										vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_948);
										mem_vec_948 = vec_72;
										vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_949);
										mem_vec_949 = vec_74;
										scal_23 = input[strideA1 * (x + w + 2) + strideA2 * (y + 7 + h) + c];
										vec_76 = _mm512_set1_ps(scal_23);
										vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_950);
										mem_vec_950 = vec_75;
										vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_951);
										mem_vec_951 = vec_77;
									}
