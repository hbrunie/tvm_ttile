...
[V f; U (2, f); U (4, y); U (3, w); T (16, c); Hoist_vars [c]; T (3, h);
  T (1, x); T (1, y); T (2, f); T (2, c); T (17, y); T (272, x); T (4, y)]
*/
IND_TYPE c, cp_0, c354_p_0, cp_1, c354, f, fp_0, h, hp_0, x, xp_0, x474_p_0, xp_1, x474, y, yp_0, y466_p_0, y467_p_0, yp_1, y466_p_1, yp_2, y466, y467;
IND_TYPE y468 = 0;
IND_TYPE x475 = 0;
IND_TYPE h176 = 0;
IND_TYPE w = 0;
