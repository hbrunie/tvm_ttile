...
c760 = 0;
c760_p_1 = 0;
						for (x = x380, xp_0 = 0;x < x380 + 17;x += 1, xp_0 += 1){
									mem_vec_3205 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									...
									mem_vec_3211 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_3205);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_3211);
