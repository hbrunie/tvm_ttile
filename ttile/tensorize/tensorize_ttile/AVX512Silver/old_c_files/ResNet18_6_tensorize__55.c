...
xp_0 = 0;
					for (h = h86, hp_0 = 0;h < h86 + 3;h += 1, hp_0 += 1){
								mem_vec_1157 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
								mem_vec_1158 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_1159 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_1157);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_1158);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_1159);
