...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  T (28, x); T (4, c); T (4, y); T (16, f); T (1, y)]
*/
IND_TYPE c, cp_0, c288_p_0, cp_1, c288, f, fp_0, x, xp_0, y, yp_0, y240_p_0, yp_1, y240;
			...
			for (c288 = c289, c288_p_0 = 0;
				...
				for (x = x233, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_1697 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
							...
							mem_vec_1701 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
							...
							for (c = c288, cp_1 = c288_p_0, cp_0 = 0;
								...
								vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1696);
								mem_vec_1696 = vec_3;
								scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
								vec_6 = _mm512_set1_ps(scal_2);


								vec_5 = _mm512_fmadd_ps(vec_6, vec_2, mem_vec_1697);
								mem_vec_1697 = vec_5;
								scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h) + c];
								vec_8 = _mm512_set1_ps(scal_3);


								vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_1698);
								mem_vec_1698 = vec_7;
								...
								vec_105 = _mm512_fmadd_ps(vec_106, vec_107, mem_vec_1695);
								mem_vec_1695 = vec_105;
								scal_50 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
								vec_109 = _mm512_set1_ps(scal_50);


								vec_108 = _mm512_fmadd_ps(vec_109, vec_107, mem_vec_1696);
								mem_vec_1696 = vec_108;
								scal_51 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
								vec_111 = _mm512_set1_ps(scal_51);


								vec_110 = _mm512_fmadd_ps(vec_111, vec_107, mem_vec_1697);
								mem_vec_1697 = vec_110;
								scal_52 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
								vec_113 = _mm512_set1_ps(scal_52);


								vec_112 = _mm512_fmadd_ps(vec_113, vec_107, mem_vec_1698);
								mem_vec_1698 = vec_112;
								scal_53 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
								vec_115 = _mm512_set1_ps(scal_53);


								vec_114 = _mm512_fmadd_ps(vec_115, vec_107, mem_vec_1699);
								mem_vec_1699 = vec_114;
								scal_54 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
								vec_117 = _mm512_set1_ps(scal_54);


								vec_116 = _mm512_fmadd_ps(vec_117, vec_107, mem_vec_1700);
								mem_vec_1700 = vec_116;
								scal_55 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
								vec_119 = _mm512_set1_ps(scal_55);


								vec_118 = _mm512_fmadd_ps(vec_119, vec_107, mem_vec_1701);
								mem_vec_1701 = vec_118;
						...
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_1701);
				}
			}
		}
	}
