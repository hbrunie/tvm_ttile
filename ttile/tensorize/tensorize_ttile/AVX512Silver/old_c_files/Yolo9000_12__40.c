...
[V f; U (4, f); U (2, y); U (3, w); T (256, c); Hoist_vars [c]; T (34, x);
  T (3, h); T (1, c); T (2, f); T (17, y); T (1, x); T (2, f); T (2, f)]
*/
IND_TYPE c, cp_0, c33_p_0, cp_1, c33, f, fp_0, f37_p_0, f38_p_0, fp_1, f37_p_1, fp_2, f37, f38, h, hp_0, x, xp_0, x30_p_0, xp_1, x30, y, yp_0;
...
for (f38 = f39, f38_p_0 = 0;
	...
	// T (f, 2) (256 / 128)
	for (f37 = f38, f37_p_1 = f38_p_0, f37_p_0 = 0;
		f37 < f38 + 256;
		f37 += 128, f37_p_1 += 128, f37_p_0 += 128){
		...
		for (x30 = x31, x30_p_0 = 0;
			...
			for (y = y20, yp_0 = 0;
				...
				// T (f, 2) (128 / 64)
				for (f = f37, fp_2 = f37_p_1, fp_1 = f37_p_0, fp_0 = 0;
					f < f37 + 128;
							...
							for (x = x30, xp_1 = x30_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c33, cp_1 = c33_p_0, cp_0 = 0;
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_104);
											mem_vec_104 = vec_14;

											vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_105);
											mem_vec_105 = vec_17;

											vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_106);
											mem_vec_106 = vec_19;

											vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_107);
											mem_vec_107 = vec_21;
											scal_3 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_24 = _mm512_set1_ps(scal_3);


											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_108);
											mem_vec_108 = vec_23;



											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_109);
											mem_vec_109 = vec_25;



											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_110);
											mem_vec_110 = vec_26;



											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_111);
											mem_vec_111 = vec_27;
											scal_4 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_29 = _mm512_set1_ps(scal_4);
											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_104);
											mem_vec_104 = vec_28;

											vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_105);
											mem_vec_105 = vec_31;

											vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_106);
											mem_vec_106 = vec_33;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_107);
											mem_vec_107 = vec_35;
											scal_5 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_5);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_108);
											mem_vec_108 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_109);
											mem_vec_109 = vec_39;



											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_110);
											mem_vec_110 = vec_40;



											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_111);
											mem_vec_111 = vec_41;
										}
