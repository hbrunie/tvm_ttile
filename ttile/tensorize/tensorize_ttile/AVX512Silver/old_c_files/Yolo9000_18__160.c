...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  ...
  T (8, c); T (8, f)]
*/
IND_TYPE c, cp_0, c748_p_0, c749_p_0, cp_1, c748_p_1, cp_2, c748, c749, f, fp_0, f561_p_0, fp_1, f561, x, xp_0, y, yp_0;
					...
					for (c748 = c749, c748_p_1 = c749_p_0, c748_p_0 = 0;
						...
						for (x = x374, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_3169 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c748, cp_2 = c748_p_1, cp_1 = c748_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_3167);
										mem_vec_3167 = vec_3;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_3169);
						}
					}
				}
						...
						for (x = x374, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									for (c = c748, cp_2 = c748_p_1, cp_1 = c748_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_3171);
										mem_vec_3171 = vec_3;
										scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
										vec_6 = _mm512_set1_ps(scal_2);
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_3173);
										mem_vec_3173 = vec_7;
