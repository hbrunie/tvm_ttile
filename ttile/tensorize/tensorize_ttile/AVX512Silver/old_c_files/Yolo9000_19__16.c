	...
	for (c257 = c258, c257_p_0 = 0;
		...
		for (f = f128, fp_0 = 0;
			...
			f += 64, fp_0 += 64){
				...
				for (y = y192 + 3, yp_1 = y192_p_0, yp_0 = 0;
					y < y192 + 3 + 14;
					y += 7, yp_1 += 7, yp_0 += 7){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 64
					// T (c, 16) (256 / 16)
					for (c256 = c257, c256_p_1 = c257_p_0, c256_p_0 = 0;
						...
						for (x = x128, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_2698 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
									mem_vec_2699 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 64
									// T (c, 16) (16 / 1)
									for (c = c256, cp_2 = c256_p_1, cp_1 = c256_p_0, cp_0 = 0;
										c < c256 + 16;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_2698);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_2699);
						}
					}
				}
		}
