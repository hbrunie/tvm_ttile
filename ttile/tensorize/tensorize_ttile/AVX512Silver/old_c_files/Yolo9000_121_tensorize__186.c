...
c276_p_0 = 0;
							for (h = h171, hp_0 = 0;h < h171 + 3;h += 1, hp_0 += 1){
								...
								for (x = x276, xp_1 = x276_p_0, xp_0 = 0;x < x276 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3098 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
											mem_vec_3099 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_3098);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_3099);
								}
							}
}
