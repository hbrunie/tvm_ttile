				...
				for (x = x136, xp_0 = 0;
					...
					for (w = w117, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								mem_vec_1565 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_1566 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_1567 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								for (c = c204, cp_1 = c204_p_0, cp_0 = 0;
									...
									vec_23 = _mm512_fmadd_ps(vec_24, vec_2, mem_vec_1565);
									mem_vec_1565 = vec_23;
									scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 12) + h) + c];
									vec_26 = _mm512_set1_ps(scal_12);


									vec_25 = _mm512_fmadd_ps(vec_26, vec_2, mem_vec_1566);
									mem_vec_1566 = vec_25;
									scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 13) + h) + c];
									vec_28 = _mm512_set1_ps(scal_13);


									vec_27 = _mm512_fmadd_ps(vec_28, vec_2, mem_vec_1567);
									mem_vec_1567 = vec_27;
									...
									vec_32 = _mm512_fmadd_ps(vec_33, vec_31, mem_vec_1555);
									mem_vec_1555 = vec_32;
									scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
									vec_35 = _mm512_set1_ps(scal_16);


									vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_1556);
									mem_vec_1556 = vec_34;
									scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
									vec_37 = _mm512_set1_ps(scal_17);


									vec_36 = _mm512_fmadd_ps(vec_37, vec_31, mem_vec_1557);
									mem_vec_1557 = vec_36;
									...
									vec_61 = _mm512_fmadd_ps(vec_62, vec_60, mem_vec_1555);
									mem_vec_1555 = vec_61;
									scal_30 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
									vec_64 = _mm512_set1_ps(scal_30);


									vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_1556);
									mem_vec_1556 = vec_63;
									scal_31 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
									vec_66 = _mm512_set1_ps(scal_31);


									vec_65 = _mm512_fmadd_ps(vec_66, vec_60, mem_vec_1557);
									mem_vec_1557 = vec_65;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1565);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1566);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1567);
					}
				}
			}
		}
