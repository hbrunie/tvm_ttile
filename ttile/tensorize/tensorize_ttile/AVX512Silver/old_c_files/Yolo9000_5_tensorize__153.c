...
x180 = 0;
x180_p_0 = 0;
		for (f = f98, fp_0 = 0;f < f98 + 64;f += 32, fp_0 += 32){
				for (y = y180, yp_1 = y180_p_0, yp_0 = 0;y < y180 + 56;y += 7, yp_1 += 7, yp_0 += 7){
					...
					for (x = x180, xp_1 = x180_p_0, xp_0 = 0;x < x180 + 2;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 128) (128 / 1)
								for (c = c142, cp_0 = 0;c < c142 + 128;c += 1, cp_0 += 1){
				...
				for (y = y180 + 56, yp_1 = y180_p_0, yp_0 = 0;y < y180 + 56 + 12;y += 12, yp_1 += 12, yp_0 += 12){
					// y = ph_y, x = 2, h = 1, w = 1, c = 128, f = 32
					// T (x, 2) (2 / 1)
					for (x = x180, xp_1 = x180_p_0, xp_0 = 0;x < x180 + 2;x += 1, xp_1 += 1, xp_0 += 1){
