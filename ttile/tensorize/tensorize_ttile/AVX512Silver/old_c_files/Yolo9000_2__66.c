...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (8, c); Hoist_vars [c];
  T (1, x); T (4, c); T (1, x); T (17, y); T (4, f); T (272, x); T (2, y);
  T (2, y)]
*/
IND_TYPE c, cp_0, c429_p_0, cp_1, c429, f, fp_0, x, xp_0, x572_p_0, x573_p_0, xp_1, x572_p_1, xp_2, x572, x573, y, yp_0, y566_p_0, y567_p_0, yp_1, y566_p_1, yp_2, y566, y567;
...
for (y567 = y568, y567_p_0 = 0;
	...
	for (y566 = y567, y566_p_1 = y567_p_0, y566_p_0 = 0;
		y566 < y567 + 136;
		y566 += 68, y566_p_1 += 68, y566_p_0 += 68){
						...
						for (c429 = c430, c429_p_0 = 0;
							...
							for (x = x572, xp_2 = x572_p_1, xp_1 = x572_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1247 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										// y = 4, x = 1, h = 3, w = 3, c = 8, f = 16
										// T (c, 8) (8 / 1)
										for (c = c429, cp_1 = c429_p_0, cp_0 = 0;
											...
											vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1245);
											mem_vec_1245 = vec_3;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_1247);
							}
						}
					}
				}
