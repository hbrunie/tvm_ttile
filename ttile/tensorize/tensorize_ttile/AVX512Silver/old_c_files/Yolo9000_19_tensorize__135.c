...
[V f; U (4, f); ULambda y; T (32, c); Hoist_vars [c]; T (17, x); T (32, c);
  ...
  T (1, c); T (1, y)]
*/
IND_TYPE c, cp_0, c8_p_0, c9_p_0, cp_1, c8_p_1, cp_2, c8, c9, f, fp_0, x, xp_0, y, yp_0, y6_p_0, yp_1, y6;
IND_TYPE y7 = 0;
IND_TYPE x4 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c9 = 0;
c9_p_0 = 0;
		for (f = f4, fp_0 = 0;f < f4 + 512;f += 64, fp_0 += 64){
				for (y = y6, yp_1 = y6_p_0, yp_0 = 0;y < y6 + 3;y += 3, yp_1 += 3, yp_0 += 3){
					// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 64
					// T (c, 32) (1024 / 32)
					for (c8 = c9, c8_p_1 = c9_p_0, c8_p_0 = 0;c8 < c9 + 1024;c8 += 32, c8_p_1 += 32, c8_p_0 += 32){
						// y = ph_y, x = 17, h = 1, w = 1, c = 32, f = 64
						// T (x, 17) (17 / 1)
						for (x = x4, xp_0 = 0;x < x4 + 17;x += 1, xp_0 += 1){
									mem_vec_80 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									mem_vec_81 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
									mem_vec_82 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
									mem_vec_83 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
									...
									mem_vec_86 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
									mem_vec_87 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
									...
									mem_vec_90 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
									mem_vec_91 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
									...
									for (c = c8, cp_2 = c8_p_1, cp_1 = c8_p_0, cp_0 = 0;c < c8 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_5 = _mm512_fmadd_ps(vec_1, vec_6, mem_vec_82);
										mem_vec_82 = vec_5;
										vec_8 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * h + strideW3 * c + f + 48]);
										vec_7 = _mm512_fmadd_ps(vec_1, vec_8, mem_vec_83);
										mem_vec_83 = vec_7;
										scal_1 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h) + c];
										vec_10 = _mm512_set1_ps(scal_1);
										vec_9 = _mm512_fmadd_ps(vec_10, vec_2, mem_vec_84);
										mem_vec_84 = vec_9;
										vec_11 = _mm512_fmadd_ps(vec_10, vec_4, mem_vec_85);
										mem_vec_85 = vec_11;
										vec_12 = _mm512_fmadd_ps(vec_10, vec_6, mem_vec_86);
										mem_vec_86 = vec_12;
										vec_13 = _mm512_fmadd_ps(vec_10, vec_8, mem_vec_87);
										mem_vec_87 = vec_13;
										...
										mem_vec_89 = vec_16;
										vec_17 = _mm512_fmadd_ps(vec_15, vec_6, mem_vec_90);
										mem_vec_90 = vec_17;
										vec_18 = _mm512_fmadd_ps(vec_15, vec_8, mem_vec_91);
										mem_vec_91 = vec_18;
									}
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_80);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_81);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_82);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_83);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_86);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_87);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_90);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_91);
						}
					}
				}
				for (y = y6 + 3, yp_1 = y6_p_0, yp_0 = 0;y < y6 + 3 + 14;y += 7, yp_1 += 7, yp_0 += 7){
					// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 64
					// T (c, 32) (1024 / 32)
					for (c8 = c9, c8_p_1 = c9_p_0, c8_p_0 = 0;c8 < c9 + 1024;c8 += 32, c8_p_1 += 32, c8_p_0 += 32){
						// y = ph_y, x = 17, h = 1, w = 1, c = 32, f = 64
						...
						for (x = x4, xp_0 = 0;x < x4 + 17;x += 1, xp_0 += 1){
									...
									mem_vec_116 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									mem_vec_117 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
									mem_vec_118 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_119 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 64
									// T (c, 32) (32 / 1)
									for (c = c8, cp_2 = c8_p_1, cp_1 = c8_p_0, cp_0 = 0;c < c8 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
										scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
										...
										vec_34 = _mm512_fmadd_ps(vec_35, vec_2, mem_vec_116);
										mem_vec_116 = vec_34;
										vec_36 = _mm512_fmadd_ps(vec_35, vec_4, mem_vec_117);
										mem_vec_117 = vec_36;
										vec_37 = _mm512_fmadd_ps(vec_35, vec_6, mem_vec_118);
										mem_vec_118 = vec_37;
										vec_38 = _mm512_fmadd_ps(vec_35, vec_8, mem_vec_119);
										mem_vec_119 = vec_38;
									}
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_116);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_117);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_118);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_119);
						}
					}
				}
		}
