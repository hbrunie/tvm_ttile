...
[V f; U (2, f); ULambda y; T (128, c); Hoist_vars [c]; T (4, x);
  ...
  T (34, x); T (4, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x312_p_0, xp_1, x312, y, yp_0, y312_p_0, yp_1, y312;
IND_TYPE y313 = 0;
IND_TYPE x313 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x312 = 0;
x312_p_0 = 0;
		for (f = f180, fp_0 = 0;f < f180 + 64;f += 32, fp_0 += 32){
				for (y = y312, yp_1 = y312_p_0, yp_0 = 0;y < y312 + 7;y += 7, yp_1 += 7, yp_0 += 7){
					...
					for (x = x312, xp_1 = x312_p_0, xp_0 = 0;x < x312 + 4;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 128) (128 / 1)
								for (c = c236, cp_0 = 0;c < c236 + 128;c += 1, cp_0 += 1){
				...
				for (y = y312 + 7, yp_1 = y312_p_0, yp_0 = 0;y < y312 + 7 + 27;y += 9, yp_1 += 9, yp_0 += 9){
					// y = ph_y, x = 4, h = 1, w = 1, c = 128, f = 32
					// T (x, 4) (4 / 1)
					for (x = x312, xp_1 = x312_p_0, xp_0 = 0;x < x312 + 4;x += 1, xp_1 += 1, xp_0 += 1){
