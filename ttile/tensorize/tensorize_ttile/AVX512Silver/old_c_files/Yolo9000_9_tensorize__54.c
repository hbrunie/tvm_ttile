...
y246 = 0;
y246_p_0 = 0;
	for (x329 = x330, x329_p_0 = 0;x329 < x330 + 68;x329 += 68, x329_p_0 += 68){
			for (y = y246, yp_1 = y246_p_0, yp_0 = 0;y < y246 + 12;y += 3, yp_1 += 3, yp_0 += 3){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 2) (68 / 34)
				for (x328 = x329, x328_p_1 = x329_p_0, x328_p_0 = 0;x328 < x329 + 68;x328 += 34, x328_p_1 += 34, x328_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f164, fp_0 = 0;f < f164 + 128;f += 64, fp_0 += 64){
						// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 64
						// T (c, 1) (256 / 256)
						for (c246 = c247, c246_p_0 = 0;c246 < c247 + 256;c246 += 256, c246_p_0 += 256){
							// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 64
							// T (x, 34) (34 / 1)
			...
			for (y = y246 + 12, yp_1 = y246_p_0, yp_0 = 0;y < y246 + 12 + 5;y += 5, yp_1 += 5, yp_0 += 5){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 2) (68 / 34)
				for (x328 = x329, x328_p_1 = x329_p_0, x328_p_0 = 0;x328 < x329 + 68;x328 += 34, x328_p_1 += 34, x328_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
