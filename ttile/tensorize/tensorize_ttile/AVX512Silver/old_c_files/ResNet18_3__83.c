...
for (y603 = y604, y603_p_0 = 0;
	...
	for (x759 = x760, x759_p_0 = 0;
		...
		for (y602 = y603, y602_p_1 = y603_p_0, y602_p_0 = 0;
			y602 < y603 + 56;
			y602 += 28, y602_p_1 += 28, y602_p_0 += 28){
			...
			for (x758 = x759, x758_p_1 = x759_p_0, x758_p_0 = 0;
				...
				for (f = f292, fp_0 = 0;
					...
					for (y = y602, yp_2 = y602_p_1, yp_1 = y602_p_0, yp_0 = 0;
						...
						// T (x, 1) (7 / 7)
						for (x757 = x758, x757_p_2 = x758_p_1, x757_p_1 = x758_p_0, x757_p_0 = 0;
							x757 < x758 + 7;
							x757 += 7, x757_p_2 += 7, x757_p_1 += 7, x757_p_0 += 7){
							// y = 7, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 4) (64 / 16)
							for (c465 = c466, c465_p_0 = 0;
								...
								// T (x, 7) (7 / 1)
								for (x = x757, xp_3 = x757_p_2, xp_2 = x757_p_1, xp_1 = x757_p_0, xp_0 = 0;
									x < x757 + 7;
