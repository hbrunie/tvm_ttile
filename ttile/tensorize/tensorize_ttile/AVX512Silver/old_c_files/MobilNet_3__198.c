...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (128, c); Hoist_vars [c];
  T (14, x); T (1, c); T (1, f); T (14, y); T (4, x); T (4, f); T (2, f)]
*/
IND_TYPE c, cp_0, c207_p_0, cp_1, c207, f, fp_0, f154_p_0, f155_p_0, fp_1, f154_p_1, fp_2, f154, f155, x, xp_0, x237_p_0, xp_1, x237, y, yp_0;
...
for (f155 = f156, f155_p_0 = 0;
	...
	for (f154 = f155, f154_p_1 = f155_p_0, f154_p_0 = 0;
		f154 < f155 + 64;
		f154 += 16, f154_p_1 += 16, f154_p_0 += 16){
					...
					for (c207 = c208, c207_p_0 = 0;
						...
						for (x = x237, xp_1 = x237_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1341 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									...
									for (c = c207, cp_1 = c207_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1341);
										mem_vec_1341 = vec_3;
