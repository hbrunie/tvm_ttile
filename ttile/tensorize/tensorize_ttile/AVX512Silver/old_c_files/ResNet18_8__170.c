...
[V f; U (2, f); U (14, y); U (3, h); U (3, w); T (32, c); Hoist_vars [c];
  T (28, x); T (4, c); T (4, f); T (1, x); T (2, y); T (2, f)]
*/
IND_TYPE c, cp_0, c411_p_0, cp_1, c411, f, fp_0, f411_p_0, fp_1, f411, x, xp_0, x344_p_0, xp_1, x344, y, yp_0;
