...
[V f; U (1, f); U (8, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (1, x); T (2, f); T (1, x); T (1, y); T (34, y); T (544, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x116_p_0, x117_p_0, xp_1, x116_p_1, xp_2, x116, x117, y, yp_0, y110_p_0, y111_p_0, yp_1, y110_p_1, yp_2, y110, y111;
...
for (y111 = y112, y111_p_0 = 0;
	...
	for (x117 = x118, x117_p_0 = 0;
		...
		// T (y, 34) (272 / 8)
		for (y110 = y111, y110_p_1 = y111_p_0, y110_p_0 = 0;
			y110 < y111 + 272;
			y110 += 8, y110_p_1 += 8, y110_p_0 += 8){
			// y = 8, x = 1, h = 3, w = 3, c = 3, f = 32
			// T (y, 1) (8 / 8)
			for (y = y110, yp_2 = y110_p_1, yp_1 = y110_p_0, yp_0 = 0;
				y < y110 + 8;
					...
					for (f = f52, fp_0 = 0;
						...
						for (x = x116, xp_2 = x116_p_1, xp_1 = x116_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_225 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									...
									mem_vec_229 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									...
									for (c = c64, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_225);
										mem_vec_225 = vec_3;
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_227);
										mem_vec_227 = vec_7;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_229);
