...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  T (14, x); T (2, c); T (1, f); T (14, y); T (4, x); T (2, f); T (4, f)]
*/
IND_TYPE c, cp_0, c222_p_0, cp_1, c222, f, fp_0, f174_p_0, f175_p_0, fp_1, f174_p_1, fp_2, f174, f175, x, xp_0, x252_p_0, xp_1, x252, y, yp_0;
...
for (f175 = f176, f175_p_0 = 0;
	...
	for (f174 = f175, f174_p_1 = f175_p_0, f174_p_0 = 0;
		f174 < f175 + 32;
		f174 += 16, f174_p_1 += 16, f174_p_0 += 16){
						...
						for (x = x252, xp_1 = x252_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c222, cp_1 = c222_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1361);
										mem_vec_1361 = vec_3;
