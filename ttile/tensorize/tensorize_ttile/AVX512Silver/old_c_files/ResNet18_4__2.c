				...
				for (x = x196, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							for (c = c219, cp_1 = c219_p_0, cp_0 = 0;
								...
								vec_9 = _mm512_fmadd_ps(vec_10, vec_11, mem_vec_1628);
								mem_vec_1628 = vec_9;
								scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
								vec_13 = _mm512_set1_ps(scal_5);


								vec_12 = _mm512_fmadd_ps(vec_13, vec_11, mem_vec_1629);
								mem_vec_1629 = vec_12;
								scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
								vec_15 = _mm512_set1_ps(scal_6);


								vec_14 = _mm512_fmadd_ps(vec_15, vec_11, mem_vec_1630);
								mem_vec_1630 = vec_14;
								scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
								vec_17 = _mm512_set1_ps(scal_7);


								vec_16 = _mm512_fmadd_ps(vec_17, vec_11, mem_vec_1631);
								mem_vec_1631 = vec_16;
								scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
								vec_19 = _mm512_set1_ps(scal_8);
								vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

								vec_18 = _mm512_fmadd_ps(vec_19, vec_20, mem_vec_1628);
								mem_vec_1628 = vec_18;
								scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
								vec_22 = _mm512_set1_ps(scal_9);


								vec_21 = _mm512_fmadd_ps(vec_22, vec_20, mem_vec_1629);
								mem_vec_1629 = vec_21;
								scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
								vec_24 = _mm512_set1_ps(scal_10);


								vec_23 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_1630);
								mem_vec_1630 = vec_23;
								scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
								vec_26 = _mm512_set1_ps(scal_11);


								vec_25 = _mm512_fmadd_ps(vec_26, vec_20, mem_vec_1631);
								mem_vec_1631 = vec_25;
