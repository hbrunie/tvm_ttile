...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  ...
  T (8, c); T (2, f)]
*/
IND_TYPE c, cp_0, c592_p_0, c593_p_0, cp_1, c592_p_1, cp_2, c592, c593, f, fp_0, f444_p_0, fp_1, f444, x, xp_0, y, yp_0;
					...
					for (c592 = c593, c592_p_1 = c593_p_0, c592_p_0 = 0;
						...
						for (x = x296, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_2601 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_2602 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_2603 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_2604 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
									...
									for (c = c592, cp_2 = c592_p_1, cp_1 = c592_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2601);
										mem_vec_2601 = vec_3;
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_2603);
										mem_vec_2603 = vec_7;
					...
					for (c592 = c593, c592_p_1 = c593_p_0, c592_p_0 = 0;
						...
						for (x = x296, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_2607 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									...
									mem_vec_2611 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									// y = ph_y, x = 1, h = 3, w = 3, c = 16, f = 16
									// T (c, 16) (16 / 1)
									for (c = c592, cp_2 = c592_p_1, cp_1 = c592_p_0, cp_0 = 0;
										c < c592 + 16;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_2606);
										mem_vec_2606 = vec_3;
										scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
										vec_6 = _mm512_set1_ps(scal_2);
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_2608);
										mem_vec_2608 = vec_7;
										scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h) + c];
										vec_10 = _mm512_set1_ps(scal_4);


										vec_9 = _mm512_fmadd_ps(vec_10, vec_2, mem_vec_2609);
										mem_vec_2609 = vec_9;
										...
										vec_120 = _mm512_fmadd_ps(vec_121, vec_122, mem_vec_2605);
										mem_vec_2605 = vec_120;
										scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
										vec_124 = _mm512_set1_ps(scal_57);


										vec_123 = _mm512_fmadd_ps(vec_124, vec_122, mem_vec_2606);
										mem_vec_2606 = vec_123;
										scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
										vec_126 = _mm512_set1_ps(scal_58);


										vec_125 = _mm512_fmadd_ps(vec_126, vec_122, mem_vec_2607);
										mem_vec_2607 = vec_125;
										scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
										vec_128 = _mm512_set1_ps(scal_59);


										vec_127 = _mm512_fmadd_ps(vec_128, vec_122, mem_vec_2608);
										mem_vec_2608 = vec_127;
										scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
										vec_130 = _mm512_set1_ps(scal_60);


										vec_129 = _mm512_fmadd_ps(vec_130, vec_122, mem_vec_2609);
										mem_vec_2609 = vec_129;
										scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
										vec_132 = _mm512_set1_ps(scal_61);


										vec_131 = _mm512_fmadd_ps(vec_132, vec_122, mem_vec_2610);
										mem_vec_2610 = vec_131;
										scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
										vec_134 = _mm512_set1_ps(scal_62);


										vec_133 = _mm512_fmadd_ps(vec_134, vec_122, mem_vec_2611);
										mem_vec_2611 = vec_133;
									}
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_2605);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_2606);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_2607);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_2611);
						}
					}
				}
		}
