...
[V f; U (4, f); U (2, y); U (3, h); T (8, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (4, c); T (2, x); T (1, y); T (136, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c33_p_0, cp_1, c33, w, wp_0, x, xp_0, x44_p_0, x45_p_0, xp_1, x44_p_1, xp_2, x44, x45, y, yp_0, y44_p_0, y45_p_0, yp_1, y44_p_1, yp_2, y44, y45;
IND_TYPE y46 = 0;
IND_TYPE x46 = 0;
IND_TYPE h = 0;
IND_TYPE w22 = 0;
...
c33_p_0 = 0;
						for (w = w22, wp_0 = 0;w < w22 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 17) (17 / 1)
							for (x = x44, xp_2 = x44_p_1, xp_1 = x44_p_0, xp_0 = 0;x < x44 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
