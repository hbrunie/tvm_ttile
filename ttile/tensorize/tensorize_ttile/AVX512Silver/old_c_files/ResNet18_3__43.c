...
for (y341 = y342, y341_p_0 = 0;
	...
	for (x427 = x428, x427_p_0 = 0;
		...
		// T (y, 1) (56 / 56)
		for (y340 = y341, y340_p_1 = y341_p_0, y340_p_0 = 0;
			y340 < y341 + 56;
			y340 += 56, y340_p_1 += 56, y340_p_0 += 56){
			// y = 56, x = 1, h = 1, w = 1, c = 64, f = 64
			// T (x, 1) (1 / 1)
			for (x426 = x427, x426_p_1 = x427_p_0, x426_p_0 = 0;
				...
				for (f = f170, fp_0 = 0;
					...
					// T (y, 7) (56 / 8)
					for (y = y340, yp_2 = y340_p_1, yp_1 = y340_p_0, yp_0 = 0;
						y < y340 + 56;
						y += 8, yp_2 += 8, yp_1 += 8, yp_0 += 8){
						// y = 8, x = 1, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (1 / 1)
						for (x425 = x426, x425_p_2 = x426_p_1, x425_p_1 = x426_p_0, x425_p_0 = 0;
							x425 < x426 + 1;
							x425 += 1, x425_p_2 += 1, x425_p_1 += 1, x425_p_0 += 1){
							// y = 8, x = 1, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c255 = c256, c255_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x425, xp_3 = x425_p_2, xp_2 = x425_p_1, xp_1 = x425_p_0, xp_0 = 0;
									x < x425 + 1;
