...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  ...
  T (8, c); T (1, f)]
*/
IND_TYPE c, cp_0, c340_p_0, c341_p_0, cp_1, c340_p_1, cp_2, c340, c341, f, fp_0, f255_p_0, fp_1, f255, x, xp_0, y, yp_0;
					...
					for (c340 = c341, c340_p_1 = c341_p_0, c340_p_0 = 0;
						...
						for (x = x170, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_1729 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c340, cp_2 = c340_p_1, cp_1 = c340_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1727);
										mem_vec_1727 = vec_3;
										scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
										vec_6 = _mm512_set1_ps(scal_2);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_1729);
