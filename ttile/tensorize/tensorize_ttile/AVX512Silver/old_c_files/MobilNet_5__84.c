...
[V f; U (1, f); U (14, y); U (3, h); U (3, w); T (128, c); Hoist_vars [c];
  T (28, x); T (2, c); T (2, y); T (16, f); T (1, y)]
*/
IND_TYPE c, cp_0, c162_p_0, cp_1, c162, f, fp_0, x, xp_0, y, yp_0, y132_p_0, yp_1, y132;
		...
		for (y = y132, yp_1 = y132_p_0, yp_0 = 0;
			...
			for (c162 = c163, c162_p_0 = 0;
				...
				for (x = x136, xp_0 = 0;
					x < x136 + 28;
					x += 1, xp_0 += 1){
							mem_vec_853 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
							mem_vec_854 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
							mem_vec_855 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
							mem_vec_856 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
							mem_vec_857 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
							mem_vec_858 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
							mem_vec_859 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
							mem_vec_860 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
							mem_vec_861 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
							mem_vec_862 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
							mem_vec_863 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
							mem_vec_864 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
							mem_vec_865 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
							...
							for (c = c162, cp_1 = c162_p_0, cp_0 = 0;
								...
								vec_0 = _mm512_fmadd_ps(vec_1, vec_2, mem_vec_853);
								mem_vec_853 = vec_0;
								scal_1 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h) + c];
								vec_4 = _mm512_set1_ps(scal_1);


								vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_854);
								mem_vec_854 = vec_3;
								scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
								vec_6 = _mm512_set1_ps(scal_2);


								vec_5 = _mm512_fmadd_ps(vec_6, vec_2, mem_vec_855);
								mem_vec_855 = vec_5;
								scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h) + c];
								vec_8 = _mm512_set1_ps(scal_3);


								vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_856);
								mem_vec_856 = vec_7;
								scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h) + c];
								vec_10 = _mm512_set1_ps(scal_4);


								vec_9 = _mm512_fmadd_ps(vec_10, vec_2, mem_vec_857);
								mem_vec_857 = vec_9;
								...
								vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_859);
								mem_vec_859 = vec_13;
								scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
								vec_16 = _mm512_set1_ps(scal_7);


								vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_860);
								mem_vec_860 = vec_15;
