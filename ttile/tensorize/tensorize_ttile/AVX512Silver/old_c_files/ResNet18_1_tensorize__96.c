...
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (16, x); T (1, c);
  T (7, w); T (7, h); T (7, x); T (2, y); T (2, f); T (7, y)]
*/
IND_TYPE c, cp_0, c429_p_0, cp_1, c429, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x418_p_0, xp_1, x418, y, yp_0, y429_p_0, yp_1, y429;
IND_TYPE y430 = 0;
IND_TYPE x419 = 0;
IND_TYPE h286 = 0;
IND_TYPE w286 = 0;
...
x418 = 0;
x418_p_0 = 0;
				for (h = h286, hp_0 = 0;h < h286 + 7;h += 1, hp_0 += 1){
					// y = 8, x = 16, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w286, wp_0 = 0;w < w286 + 7;w += 1, wp_0 += 1){
						// y = 8, x = 16, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c429 = c430, c429_p_0 = 0;c429 < c430 + 3;c429 += 3, c429_p_0 += 3){
							// y = 8, x = 16, h = 1, w = 1, c = 3, f = 32
							// T (x, 16) (16 / 1)
							for (x = x418, xp_1 = x418_p_0, xp_0 = 0;x < x418 + 16;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c429, cp_1 = c429_p_0, cp_0 = 0;c < c429 + 3;c += 1, cp_1 += 1, cp_0 += 1){
