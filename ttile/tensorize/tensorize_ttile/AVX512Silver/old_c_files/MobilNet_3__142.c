				...
				for (h = h59, hp_0 = 0;
					...
					for (x = x129, xp_1 = x129_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_796 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 64]);
								mem_vec_797 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 80]);
								mem_vec_798 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 96]);
								mem_vec_799 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 112]);
								...
								mem_vec_804 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64]);
								mem_vec_805 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80]);
								mem_vec_806 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96]);
								mem_vec_807 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112]);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 64], mem_vec_796);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 80], mem_vec_797);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 96], mem_vec_798);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 112], mem_vec_799);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 64], mem_vec_804);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 80], mem_vec_805);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 96], mem_vec_806);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 112], mem_vec_807);
					}
				}
			}
		}
