...
for (y607 = y608, y607_p_0 = 0;
	...
	for (x764 = x765, x764_p_0 = 0;
		...
		for (y606 = y607, y606_p_1 = y607_p_0, y606_p_0 = 0;
			y606 < y607 + 28;
			y606 += 28, y606_p_1 += 28, y606_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 8) (56 / 7)
			for (x763 = x764, x763_p_1 = x764_p_0, x763_p_0 = 0;
				x763 < x764 + 56;
				x763 += 7, x763_p_1 += 7, x763_p_0 += 7){
				...
				for (f = f294, fp_0 = 0;
					...
					for (y = y606, yp_2 = y606_p_1, yp_1 = y606_p_0, yp_0 = 0;
						...
						// T (x, 1) (7 / 7)
						for (x762 = x763, x762_p_2 = x763_p_1, x762_p_1 = x763_p_0, x762_p_0 = 0;
							x762 < x763 + 7;
							x762 += 7, x762_p_2 += 7, x762_p_1 += 7, x762_p_0 += 7){
							// y = 7, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c468 = c469, c468_p_0 = 0;
								...
								// y = 7, x = 7, h = 1, w = 1, c = 64, f = 32
								// T (x, 7) (7 / 1)
								for (x = x762, xp_3 = x762_p_2, xp_2 = x762_p_1, xp_1 = x762_p_0, xp_0 = 0;
									x < x762 + 7;
