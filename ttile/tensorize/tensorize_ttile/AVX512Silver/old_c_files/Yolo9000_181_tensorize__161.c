...
xp_0 = 0;
							for (h = h173, hp_0 = 0;h < h173 + 3;h += 1, hp_0 += 1){
										...
										mem_vec_2357 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_2358 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_2359 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2357);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2358);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2359);
