							...
							for (w = w225, wp_0 = 0;w < w225 + 3;w += 1, wp_0 += 1){
								...
								for (x = x564, xp_1 = x564_p_0, xp_0 = 0;x < x564 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c565, cp_1 = c565_p_0, cp_0 = 0;c < c565 + 32;c += 1, cp_1 += 1, cp_0 += 1){
												...
												vec_34 = _mm512_fmadd_ps(vec_35, vec_36, mem_vec_7044);
												mem_vec_7044 = vec_34;
												vec_38 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
												vec_37 = _mm512_fmadd_ps(vec_35, vec_38, mem_vec_7045);
												mem_vec_7045 = vec_37;
												vec_40 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 32]);
												vec_39 = _mm512_fmadd_ps(vec_35, vec_40, mem_vec_7046);
												mem_vec_7046 = vec_39;
												vec_42 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
												vec_41 = _mm512_fmadd_ps(vec_35, vec_42, mem_vec_7047);
												mem_vec_7047 = vec_41;
												scal_7 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
												vec_44 = _mm512_set1_ps(scal_7);
												vec_43 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_7048);
												mem_vec_7048 = vec_43;
												vec_45 = _mm512_fmadd_ps(vec_44, vec_38, mem_vec_7049);
												mem_vec_7049 = vec_45;
												vec_46 = _mm512_fmadd_ps(vec_44, vec_40, mem_vec_7050);
												mem_vec_7050 = vec_46;
												vec_47 = _mm512_fmadd_ps(vec_44, vec_42, mem_vec_7051);
												mem_vec_7051 = vec_47;
												scal_8 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
												vec_49 = _mm512_set1_ps(scal_8);
												vec_48 = _mm512_fmadd_ps(vec_49, vec_36, mem_vec_7052);
												mem_vec_7052 = vec_48;
												vec_50 = _mm512_fmadd_ps(vec_49, vec_38, mem_vec_7053);
												mem_vec_7053 = vec_50;
												vec_51 = _mm512_fmadd_ps(vec_49, vec_40, mem_vec_7054);
												mem_vec_7054 = vec_51;
												vec_52 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_7055);
												mem_vec_7055 = vec_52;
												scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
												vec_54 = _mm512_set1_ps(scal_9);
												vec_53 = _mm512_fmadd_ps(vec_54, vec_36, mem_vec_7056);
												mem_vec_7056 = vec_53;
												vec_55 = _mm512_fmadd_ps(vec_54, vec_38, mem_vec_7057);
												mem_vec_7057 = vec_55;
												vec_56 = _mm512_fmadd_ps(vec_54, vec_40, mem_vec_7058);
												mem_vec_7058 = vec_56;
												vec_57 = _mm512_fmadd_ps(vec_54, vec_42, mem_vec_7059);
												mem_vec_7059 = vec_57;
												scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 1) + c];
												vec_59 = _mm512_set1_ps(scal_10);
												vec_58 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_7060);
												mem_vec_7060 = vec_58;
												vec_60 = _mm512_fmadd_ps(vec_59, vec_38, mem_vec_7061);
												mem_vec_7061 = vec_60;
												vec_61 = _mm512_fmadd_ps(vec_59, vec_40, mem_vec_7062);
												mem_vec_7062 = vec_61;
												vec_62 = _mm512_fmadd_ps(vec_59, vec_42, mem_vec_7063);
												mem_vec_7063 = vec_62;
												scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 1) + c];
												vec_64 = _mm512_set1_ps(scal_11);
												vec_63 = _mm512_fmadd_ps(vec_64, vec_36, mem_vec_7064);
												mem_vec_7064 = vec_63;
												vec_65 = _mm512_fmadd_ps(vec_64, vec_38, mem_vec_7065);
												mem_vec_7065 = vec_65;
												vec_66 = _mm512_fmadd_ps(vec_64, vec_40, mem_vec_7066);
												mem_vec_7066 = vec_66;
												vec_67 = _mm512_fmadd_ps(vec_64, vec_42, mem_vec_7067);
												mem_vec_7067 = vec_67;
												scal_12 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
												vec_69 = _mm512_set1_ps(scal_12);
												vec_70 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
												vec_68 = _mm512_fmadd_ps(vec_69, vec_70, mem_vec_7044);
												mem_vec_7044 = vec_68;
												vec_72 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
												vec_71 = _mm512_fmadd_ps(vec_69, vec_72, mem_vec_7045);
												mem_vec_7045 = vec_71;
												vec_74 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 32]);
												vec_73 = _mm512_fmadd_ps(vec_69, vec_74, mem_vec_7046);
												mem_vec_7046 = vec_73;
												vec_76 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
												vec_75 = _mm512_fmadd_ps(vec_69, vec_76, mem_vec_7047);
												mem_vec_7047 = vec_75;
												scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
												vec_78 = _mm512_set1_ps(scal_13);
												vec_77 = _mm512_fmadd_ps(vec_78, vec_70, mem_vec_7048);
												mem_vec_7048 = vec_77;
												vec_79 = _mm512_fmadd_ps(vec_78, vec_72, mem_vec_7049);
												mem_vec_7049 = vec_79;
												vec_80 = _mm512_fmadd_ps(vec_78, vec_74, mem_vec_7050);
												mem_vec_7050 = vec_80;
												vec_81 = _mm512_fmadd_ps(vec_78, vec_76, mem_vec_7051);
												mem_vec_7051 = vec_81;
												scal_14 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
												vec_83 = _mm512_set1_ps(scal_14);
												vec_82 = _mm512_fmadd_ps(vec_83, vec_70, mem_vec_7052);
												mem_vec_7052 = vec_82;
												vec_84 = _mm512_fmadd_ps(vec_83, vec_72, mem_vec_7053);
												mem_vec_7053 = vec_84;
												vec_85 = _mm512_fmadd_ps(vec_83, vec_74, mem_vec_7054);
												mem_vec_7054 = vec_85;
												vec_86 = _mm512_fmadd_ps(vec_83, vec_76, mem_vec_7055);
												mem_vec_7055 = vec_86;
												scal_15 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
												vec_88 = _mm512_set1_ps(scal_15);
												vec_87 = _mm512_fmadd_ps(vec_88, vec_70, mem_vec_7056);
												mem_vec_7056 = vec_87;
												vec_89 = _mm512_fmadd_ps(vec_88, vec_72, mem_vec_7057);
												mem_vec_7057 = vec_89;
												vec_90 = _mm512_fmadd_ps(vec_88, vec_74, mem_vec_7058);
												mem_vec_7058 = vec_90;
												vec_91 = _mm512_fmadd_ps(vec_88, vec_76, mem_vec_7059);
												mem_vec_7059 = vec_91;
												scal_16 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 2) + c];
												vec_93 = _mm512_set1_ps(scal_16);
												vec_92 = _mm512_fmadd_ps(vec_93, vec_70, mem_vec_7060);
												mem_vec_7060 = vec_92;
												vec_94 = _mm512_fmadd_ps(vec_93, vec_72, mem_vec_7061);
												mem_vec_7061 = vec_94;
												vec_95 = _mm512_fmadd_ps(vec_93, vec_74, mem_vec_7062);
												mem_vec_7062 = vec_95;
												vec_96 = _mm512_fmadd_ps(vec_93, vec_76, mem_vec_7063);
												mem_vec_7063 = vec_96;
												scal_17 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 2) + c];
												vec_98 = _mm512_set1_ps(scal_17);
												vec_97 = _mm512_fmadd_ps(vec_98, vec_70, mem_vec_7064);
												mem_vec_7064 = vec_97;
												vec_99 = _mm512_fmadd_ps(vec_98, vec_72, mem_vec_7065);
												mem_vec_7065 = vec_99;
												vec_100 = _mm512_fmadd_ps(vec_98, vec_74, mem_vec_7066);
												mem_vec_7066 = vec_100;
												vec_101 = _mm512_fmadd_ps(vec_98, vec_76, mem_vec_7067);
