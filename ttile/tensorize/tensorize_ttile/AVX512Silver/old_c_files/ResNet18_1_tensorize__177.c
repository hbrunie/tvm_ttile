...
y297 = 0;
y297_p_0 = 0;
	for (f = f187, fp_0 = 0;f < f187 + 64;f += 32, fp_0 += 32){
			for (y = y297, yp_1 = y297_p_0, yp_0 = 0;y < y297 + 20;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 16) (112 / 7)
				for (x286 = x287, x286_p_0 = 0;x286 < x287 + 112;x286 += 7, x286_p_0 += 7){
			...
			for (y = y297 + 20, yp_1 = y297_p_0, yp_0 = 0;y < y297 + 20 + 36;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 16) (112 / 7)
				for (x286 = x287, x286_p_0 = 0;x286 < x287 + 112;x286 += 7, x286_p_0 += 7){
					// y = ph_y, x = 7, h = 7, w = 7, c = 3, f = 32
