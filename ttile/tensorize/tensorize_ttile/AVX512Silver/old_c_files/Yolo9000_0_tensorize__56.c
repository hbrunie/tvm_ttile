...
yp_1 = 0;
				for (w = w291, wp_0 = 0;w < w291 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c366 = c367, c366_p_0 = 0;c366 < c367 + 3;c366 += 3, c366_p_0 += 3){
						// y = 8, x = 2, h = 3, w = 1, c = 3, f = 32
						// T (x, 2) (2 / 1)
						for (x = x648, xp_2 = x648_p_1, xp_1 = x648_p_0, xp_0 = 0;x < x648 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_2762 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									mem_vec_2763 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
									// y = 8, x = 1, h = 3, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c366, cp_1 = c366_p_0, cp_0 = 0;c < c366 + 3;c += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2762);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_2763);
						}
					}
				}
}
