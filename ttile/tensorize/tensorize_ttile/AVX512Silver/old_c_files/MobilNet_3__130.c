...
for (f179 = f180, f179_p_0 = 0;
	...
	for (f178 = f179, f178_p_1 = f179_p_0, f178_p_0 = 0;
		f178 < f179 + 16;
		f178 += 16, f178_p_1 += 16, f178_p_0 += 16){
		// y = 56, x = 56, h = 3, w = 3, c = 128, f = 16
		// T (x, 4) (56 / 14)
					...
					for (c225 = c226, c225_p_0 = 0;
						...
						for (x = x255, xp_1 = x255_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1365 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_1366 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_1367 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_1365);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_1366);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_1367);
						}
					}
				}
			}
