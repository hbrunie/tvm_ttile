...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  T (14, x); T (8, c); T (1, f); T (14, y); T (4, x); T (1, f); T (8, f)]
*/
IND_TYPE c, cp_0, c249_p_0, cp_1, c249, f, fp_0, f210_p_0, f211_p_0, fp_1, f210_p_1, fp_2, f210, f211, x, xp_0, x279_p_0, xp_1, x279, y, yp_0;
					...
					for (c249 = c250, c249_p_0 = 0;
						...
						for (x = x279, xp_1 = x279_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1397 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									...
									for (c = c249, cp_1 = c249_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1397);
										mem_vec_1397 = vec_3;
