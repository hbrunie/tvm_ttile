...
c498_p_0 = 0;
							for (w = w247, wp_0 = 0;w < w247 + 3;w += 1, wp_0 += 1){
								...
								for (x = x565, xp_1 = x565_p_0, xp_0 = 0;x < x565 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_3207 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
											mem_vec_3208 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
											mem_vec_3209 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
											...
											mem_vec_3215 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											...
											mem_vec_3219 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 32, f = 16
											// T (c, 32) (32 / 1)
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_3207);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_3208);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_3209);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3215);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3219);
								}
							}
}
