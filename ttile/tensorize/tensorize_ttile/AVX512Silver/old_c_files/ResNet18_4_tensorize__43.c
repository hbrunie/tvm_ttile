...
/*
[V f; U (2, f); U (7, y); T (64, c); Hoist_vars [c]; T (3, h); T (2, x);
  T (3, w); T (1, c); T (1, f); T (14, x); T (4, y); T (4, f)]
*/
IND_TYPE c, cp_0, c351_p_0, cp_1, c351, f, fp_0, f351_p_0, fp_1, f351, h, hp_0, w, wp_0, x, xp_0, x320_p_0, xp_1, x320, y, yp_0;
IND_TYPE y234 = 0;
IND_TYPE x321 = 0;
IND_TYPE h167 = 0;
IND_TYPE w184 = 0;
...
__m512 mem_vec_2483 ,mem_vec_2484 ,mem_vec_2485 ,mem_vec_2486 ,mem_vec_2487 ,mem_vec_2488 ,mem_vec_2489 ,mem_vec_2490 ,mem_vec_2491 ,mem_vec_2492 ,mem_vec_2493 ,mem_vec_2494 ,mem_vec_2495 ,mem_vec_2496 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_3 ,vec_4 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
...
c351_p_0 = 0;
					for (w = w184, wp_0 = 0;w < w184 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 2) (2 / 1)
						for (x = x320, xp_1 = x320_p_0, xp_0 = 0;x < x320 + 2;x += 1, xp_1 += 1, xp_0 += 1){
