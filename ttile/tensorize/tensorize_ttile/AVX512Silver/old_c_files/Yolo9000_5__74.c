	...
	for (x54 = x55, x54_p_0 = 0;
		...
		for (f = f31, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				...
				for (y = y54 + 35, yp_1 = y54_p_0, yp_0 = 0;
					y < y54 + 35 + 33;
					...
					for (x = x54, xp_1 = x54_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_686 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
								mem_vec_687 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
								...
								mem_vec_695 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
								mem_vec_696 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
								mem_vec_697 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
								mem_vec_698 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
								mem_vec_699 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
								mem_vec_700 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_701 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
								mem_vec_702 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_703 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c41, cp_0 = 0;
									c < c41 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_686);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_687);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_695);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_696);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_697);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_698);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_699);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_700);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_701);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_702);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_703);
					}
				}
		}
	}
