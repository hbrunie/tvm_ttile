...
fp_0 = 0;
						for (h = h269, hp_0 = 0;h < h269 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 1) (1 / 1)
							for (x = x796, xp_2 = x796_p_1, xp_1 = x796_p_0, xp_0 = 0;x < x796 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2959 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										// y = 4, x = 1, h = 1, w = 3, c = 3, f = 16
										// T (c, 3) (3 / 1)
										for (c = c445, cp_0 = 0;c < c445 + 3;c += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2959);
							}
						}
}
