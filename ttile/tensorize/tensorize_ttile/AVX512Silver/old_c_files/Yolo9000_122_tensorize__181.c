							...
							for (w = w148, wp_0 = 0;w < w148 + 3;w += 1, wp_0 += 1){
								...
								for (x = x414, xp_1 = x414_p_0, xp_0 = 0;x < x414 + 17;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (h = h257, hp_0 = 0;h < h257 + 3;h += 1, hp_0 += 1){
												...
												mem_vec_5050 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
												mem_vec_5051 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
												...
												mem_vec_5054 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
												mem_vec_5055 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
												...
												mem_vec_5058 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
												mem_vec_5059 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
												...
												for (c = c414, cp_1 = c414_p_0, cp_0 = 0;c < c414 + 32;c += 1, cp_1 += 1, cp_0 += 1){
													...
													vec_24 = _mm512_fmadd_ps(vec_25, vec_2, mem_vec_5048);
													mem_vec_5048 = vec_24;
													vec_26 = _mm512_fmadd_ps(vec_25, vec_4, mem_vec_5049);
													mem_vec_5049 = vec_26;
													vec_27 = _mm512_fmadd_ps(vec_25, vec_6, mem_vec_5050);
													mem_vec_5050 = vec_27;
													vec_28 = _mm512_fmadd_ps(vec_25, vec_8, mem_vec_5051);
													mem_vec_5051 = vec_28;
													scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h) + c];
													vec_30 = _mm512_set1_ps(scal_5);
													vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_5052);
													mem_vec_5052 = vec_29;
													vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_5053);
													mem_vec_5053 = vec_31;
													vec_32 = _mm512_fmadd_ps(vec_30, vec_6, mem_vec_5054);
													mem_vec_5054 = vec_32;
													vec_33 = _mm512_fmadd_ps(vec_30, vec_8, mem_vec_5055);
													mem_vec_5055 = vec_33;
													scal_6 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h) + c];
													vec_35 = _mm512_set1_ps(scal_6);
													vec_34 = _mm512_fmadd_ps(vec_35, vec_2, mem_vec_5056);
													mem_vec_5056 = vec_34;
													vec_36 = _mm512_fmadd_ps(vec_35, vec_4, mem_vec_5057);
													mem_vec_5057 = vec_36;
													vec_37 = _mm512_fmadd_ps(vec_35, vec_6, mem_vec_5058);
													mem_vec_5058 = vec_37;
													vec_38 = _mm512_fmadd_ps(vec_35, vec_8, mem_vec_5059);
													mem_vec_5059 = vec_38;
												}
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_5050);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_5051);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_5054);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_5055);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_5058);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_5059);
									}
								}
							}
}
