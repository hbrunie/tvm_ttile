	...
	for (x665 = x666, x665_p_0 = 0;
		...
		for (f = f332, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				...
				for (y = y472 + 8, yp_1 = y472_p_0, yp_0 = 0;
					y < y472 + 8 + 9;
					y += 9, yp_1 += 9, yp_0 += 9){
					// y = ph_y, x = 34, h = 1, w = 1, c = 512, f = 32
					// T (x, 34) (34 / 1)
						...
						for (c498 = c499, c498_p_0 = 0;
							...
							for (x = x664, xp_2 = x664_p_1, xp_1 = x664_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_6825 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 512, f = 32
										// T (c, 512) (512 / 1)
										for (c = c498, cp_1 = c498_p_0, cp_0 = 0;
											c < c498 + 512;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_6825);
							}
						}
					}
				}
