...
[V f; U (1, f); U (7, y); U (3, h); U (3, w); T (16, c); Hoist_vars [c];
  T (7, x); T (4, f); T (32, c); T (2, c); T (16, f)]
*/
IND_TYPE c, cp_0, c224_p_0, c225_p_0, cp_1, c224_p_1, cp_2, c224, c225, f, fp_0, f168_p_0, fp_1, f168, x, xp_0;
			...
			for (f = f168, fp_1 = f168_p_0, fp_0 = 0;
				...
				for (x = x112, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_963 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
							mem_vec_964 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
							mem_vec_965 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
							...
							for (c = c224, cp_2 = c224_p_1, cp_1 = c224_p_0, cp_0 = 0;
								...
								vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_960);
								mem_vec_960 = vec_3;
								...
								vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_962);
								mem_vec_962 = vec_7;
								scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h) + c];
								vec_10 = _mm512_set1_ps(scal_4);


								vec_9 = _mm512_fmadd_ps(vec_10, vec_2, mem_vec_963);
								mem_vec_963 = vec_9;
						...
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_963);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_964);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_965);
				}
			}
		}
	}
