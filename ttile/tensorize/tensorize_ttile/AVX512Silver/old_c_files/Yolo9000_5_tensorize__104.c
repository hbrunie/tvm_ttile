...
[V f; U (2, f); ULambda y; T (128, c); Hoist_vars [c]; T (2, x);
  ...
  T (68, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x219_p_0, xp_1, x219, y, yp_0, y219_p_0, yp_1, y219;
IND_TYPE y220 = 0;
IND_TYPE x220 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x219 = 0;
x219_p_0 = 0;
		for (f = f124, fp_0 = 0;f < f124 + 64;f += 32, fp_0 += 32){
				for (y = y219, yp_1 = y219_p_0, yp_0 = 0;y < y219 + 18;y += 9, yp_1 += 9, yp_0 += 9){
					// y = ph_y, x = 2, h = 1, w = 1, c = 128, f = 32
					// T (x, 2) (2 / 1)
					for (x = x219, xp_1 = x219_p_0, xp_0 = 0;x < x219 + 2;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 128) (128 / 1)
								for (c = c168, cp_0 = 0;c < c168 + 128;c += 1, cp_0 += 1){
				...
				for (y = y219 + 18, yp_1 = y219_p_0, yp_0 = 0;y < y219 + 18 + 50;y += 10, yp_1 += 10, yp_0 += 10){
					// y = ph_y, x = 2, h = 1, w = 1, c = 128, f = 32
					// T (x, 2) (2 / 1)
					for (x = x219, xp_1 = x219_p_0, xp_0 = 0;x < x219 + 2;x += 1, xp_1 += 1, xp_0 += 1){
