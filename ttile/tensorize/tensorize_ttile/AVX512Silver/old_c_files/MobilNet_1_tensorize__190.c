...
yp_0 = 0;
				for (h = h6, hp_0 = 0;h < h6 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (32 / 32)
					for (c9 = c10, c9_p_0 = 0;c9 < c10 + 32;c9 += 32, c9_p_0 += 32){
						// y = 4, x = 1, h = 1, w = 3, c = 32, f = 16
						// T (x, 1) (1 / 1)
						for (x = x12, xp_2 = x12_p_1, xp_1 = x12_p_0, xp_0 = 0;x < x12 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_13 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_14 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_15 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									// y = 4, x = 1, h = 1, w = 3, c = 32, f = 16
									// T (c, 32) (32 / 1)
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_13);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_14);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_15);
						}
					}
				}
}
