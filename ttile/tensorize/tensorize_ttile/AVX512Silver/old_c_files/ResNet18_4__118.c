			...
			for (y = y148, yp_0 = 0;
				...
				for (x = x198, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_1635 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
							...
							for (c = c222, cp_1 = c222_p_0, cp_0 = 0;
								...
								vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_1633);
								mem_vec_1633 = vec_3;
						...
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_1635);
				}
			}
		}
	}
