...
*/
IND_TYPE c, cp_0, c648_p_0, c649_p_0, cp_1, c648_p_1, cp_2, c648, c649, f, fp_0, f486_p_0, fp_1, f486, h, hp_0, w, wp_0, x, xp_0;
IND_TYPE y = 0;
IND_TYPE x324 = 0;
IND_TYPE h242 = 0;
IND_TYPE w242 = 0;
...
xp_0 = 0;
					for (h = h242, hp_0 = 0;h < h242 + 3;h += 1, hp_0 += 1){
						...
						for (w = w242, wp_0 = 0;w < w242 + 3;w += 1, wp_0 += 1){
									...
									// T (c, 64) (64 / 1)
									for (c = c648, cp_2 = c648_p_1, cp_1 = c648_p_0, cp_0 = 0;c < c648 + 64;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
