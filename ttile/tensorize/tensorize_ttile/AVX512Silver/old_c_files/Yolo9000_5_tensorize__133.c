...
[V f; U (2, f); ULambda y; T (128, c); Hoist_vars [c]; T (4, x);
  ...
  T (34, x); T (4, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x357_p_0, xp_1, x357, y, yp_0, y357_p_0, yp_1, y357;
IND_TYPE y358 = 0;
IND_TYPE x358 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x357 = 0;
x357_p_0 = 0;
		for (f = f210, fp_0 = 0;f < f210 + 64;f += 32, fp_0 += 32){
				for (y = y357, yp_1 = y357_p_0, yp_0 = 0;y < y357 + 10;y += 10, yp_1 += 10, yp_0 += 10){
					// y = ph_y, x = 4, h = 1, w = 1, c = 128, f = 32
					// T (x, 4) (4 / 1)
					for (x = x357, xp_1 = x357_p_0, xp_0 = 0;x < x357 + 4;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 128) (128 / 1)
								for (c = c266, cp_0 = 0;c < c266 + 128;c += 1, cp_0 += 1){
				...
				for (y = y357 + 10, yp_1 = y357_p_0, yp_0 = 0;y < y357 + 10 + 24;y += 12, yp_1 += 12, yp_0 += 12){
					// y = ph_y, x = 4, h = 1, w = 1, c = 128, f = 32
					// T (x, 4) (4 / 1)
					for (x = x357, xp_1 = x357_p_0, xp_0 = 0;x < x357 + 4;x += 1, xp_1 += 1, xp_0 += 1){
