...
[V f; U (4, f); U (2, y); U (3, h); T (16, c); Hoist_vars [c]; T (34, x);
  T (3, w); T (2, c); T (1, x); T (1, y); T (136, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c12_p_0, cp_1, c12, w, wp_0, x, xp_0, x16_p_0, x17_p_0, xp_1, x16_p_1, xp_2, x16, x17, y, yp_0, y16_p_0, y17_p_0, yp_1, y16_p_1, yp_2, y16, y17;
IND_TYPE y18 = 0;
IND_TYPE x18 = 0;
IND_TYPE h = 0;
IND_TYPE w8 = 0;
