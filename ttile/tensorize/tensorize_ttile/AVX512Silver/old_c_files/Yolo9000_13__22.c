	...
	for (y256 = y257, y256_p_0 = 0;
		...
		for (x377 = x378, x377_p_0 = 0;
			...
			for (f = f188, fp_0 = 0;
				...
				// T (y, 1) (ph_y / ph_y)
				for (y = y256, yp_1 = y256_p_0, yp_0 = 0;
					y < y256 + 11;
						...
						for (c282 = c283, c282_p_0 = 0;
							...
							for (x = x376, xp_2 = x376_p_1, xp_1 = x376_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4270 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
										mem_vec_4271 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
										mem_vec_4272 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_4273 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 512, f = 32
										// T (c, 512) (512 / 1)
										for (c = c282, cp_1 = c282_p_0, cp_0 = 0;
											c < c282 + 512;
											...
											vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_4270);
											mem_vec_4270 = vec_32;



											vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_4271);
											mem_vec_4271 = vec_34;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
											vec_36 = _mm512_set1_ps(scal_11);


											vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_4272);
											mem_vec_4272 = vec_35;



											vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_4273);
											mem_vec_4273 = vec_37;
										}
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_4270);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_4271);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_4272);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_4273);
							}
						}
					}
				}
