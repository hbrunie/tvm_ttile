...
[V f; U (1, f); U (7, y); U (3, h); T (128, c); Hoist_vars [c]; T (3, w);
  T (28, x); T (1, c); T (16, f); T (4, y); T (1, f)]
*/
...
xp_0 = 0;
					for (w = w271, wp_0 = 0;w < w271 + 3;w += 1, wp_0 += 1){
								...
								mem_vec_3199 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								mem_vec_3200 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								mem_vec_3201 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
								mem_vec_3202 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
								mem_vec_3203 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_3199);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_3200);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3201);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3202);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_3203);
					}
}
