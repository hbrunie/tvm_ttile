...
[V f; U (4, f); U (2, y); U (3, h); T (16, c); Hoist_vars [c]; T (2, x);
  T (3, w); T (2, c); T (17, x); T (1, y); T (136, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c48_p_0, cp_1, c48, w, wp_0, x, xp_0, x64_p_0, x65_p_0, xp_1, x64_p_1, xp_2, x64, x65, y, yp_0, y64_p_0, y65_p_0, yp_1, y64_p_1, yp_2, y64, y65;
							...
							for (x = x64, xp_2 = x64_p_1, xp_1 = x64_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c48, cp_1 = c48_p_0, cp_0 = 0;
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_128);
											mem_vec_128 = vec_14;

											vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_129);
											mem_vec_129 = vec_17;

											vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_130);
											mem_vec_130 = vec_19;

											vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_131);
											mem_vec_131 = vec_21;
											scal_3 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_24 = _mm512_set1_ps(scal_3);


											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_132);
											mem_vec_132 = vec_23;



											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_133);
											mem_vec_133 = vec_25;



											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_134);
											mem_vec_134 = vec_26;



											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_135);
											mem_vec_135 = vec_27;
											scal_4 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_29 = _mm512_set1_ps(scal_4);
											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_128);
											mem_vec_128 = vec_28;

											vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_129);
											mem_vec_129 = vec_31;

											vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_130);
											mem_vec_130 = vec_33;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_131);
											mem_vec_131 = vec_35;
											scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_38 = _mm512_set1_ps(scal_5);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_132);
											mem_vec_132 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_133);
											mem_vec_133 = vec_39;



											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_134);
											mem_vec_134 = vec_40;



											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_135);
											mem_vec_135 = vec_41;
										}
