...
xp_0 = 0;
							for (w = w20, wp_0 = 0;w < w20 + 3;w += 1, wp_0 += 1){
										...
										mem_vec_307 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_308 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_309 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										...
										// T (c, 8) (8 / 1)
										for (c = c40, cp_2 = c40_p_1, cp_1 = c40_p_0, cp_0 = 0;c < c40 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_307);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_308);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_309);
