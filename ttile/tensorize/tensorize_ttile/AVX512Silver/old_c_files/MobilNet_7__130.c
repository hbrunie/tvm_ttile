...
/*
[V f; U (4, f); U (2, y); U (3, w); T (16, c); Hoist_vars [c]; T (3, h);
  T (14, x); T (2, c); T (7, y); T (8, f); T (16, c)]
*/
IND_TYPE c, cp_0, c336_p_0, c337_p_0, cp_1, c336_p_1, cp_2, c336, c337, f, fp_0, h, hp_0, x, xp_0, y, yp_0;
					...
					for (h = h130, hp_0 = 0;
						...
						h += 1, hp_0 += 1){
								...
								for (c = c336, cp_2 = c336_p_1, cp_1 = c336_p_0, cp_0 = 0;
									...
									vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_1844);
									mem_vec_1844 = vec_14;

									vec_18 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

									vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_1845);
									mem_vec_1845 = vec_17;

									vec_20 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

									vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_1846);
									mem_vec_1846 = vec_19;

									vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

									vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_1847);
									mem_vec_1847 = vec_21;
									scal_3 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
									vec_24 = _mm512_set1_ps(scal_3);


									vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_1848);
									mem_vec_1848 = vec_23;



									vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_1849);
									mem_vec_1849 = vec_25;



									vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_1850);
									mem_vec_1850 = vec_26;



									vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_1851);
									mem_vec_1851 = vec_27;
									scal_4 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
									vec_29 = _mm512_set1_ps(scal_4);
									vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

									vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_1844);
									mem_vec_1844 = vec_28;

									vec_32 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

									vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_1845);
									mem_vec_1845 = vec_31;

									vec_34 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

									vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_1846);
									mem_vec_1846 = vec_33;

									vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

									vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_1847);
									mem_vec_1847 = vec_35;
									scal_5 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
									vec_38 = _mm512_set1_ps(scal_5);


									vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_1848);
									mem_vec_1848 = vec_37;



									vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_1849);
									mem_vec_1849 = vec_39;



									vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_1850);
									mem_vec_1850 = vec_40;



									vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_1851);
									mem_vec_1851 = vec_41;
								}
