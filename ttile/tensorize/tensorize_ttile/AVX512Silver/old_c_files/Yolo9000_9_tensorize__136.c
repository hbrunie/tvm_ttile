...
y78_p_0 = 0;
	for (x105 = x106, x105_p_0 = 0;x105 < x106 + 68;x105 += 68, x105_p_0 += 68){
			for (y = y78, yp_1 = y78_p_0, yp_0 = 0;y < y78 + 3;y += 3, yp_1 += 3, yp_0 += 3){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 2) (68 / 34)
				for (x104 = x105, x104_p_1 = x105_p_0, x104_p_0 = 0;x104 < x105 + 68;x104 += 34, x104_p_1 += 34, x104_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f52, fp_0 = 0;f < f52 + 128;f += 64, fp_0 += 64){
						...
						for (c78 = c79, c78_p_0 = 0;c78 < c79 + 256;c78 += 256, c78_p_0 += 256){
							...
							for (x = x104, xp_2 = x104_p_1, xp_1 = x104_p_0, xp_0 = 0;x < x104 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1006 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
										mem_vec_1007 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
										...
										mem_vec_1010 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
										mem_vec_1011 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_1006);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_1007);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_1010);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_1011);
							}
						}
					}
				}
			}
			for (y = y78 + 3, yp_1 = y78_p_0, yp_0 = 0;y < y78 + 3 + 14;y += 7, yp_1 += 7, yp_0 += 7){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 2) (68 / 34)
				for (x104 = x105, x104_p_1 = x105_p_0, x104_p_0 = 0;x104 < x105 + 68;x104 += 34, x104_p_1 += 34, x104_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
