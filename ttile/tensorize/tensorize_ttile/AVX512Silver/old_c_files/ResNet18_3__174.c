...
for (y735 = y736, y735_p_0 = 0;
	...
	for (x924 = x925, x924_p_0 = 0;
		...
		for (y734 = y735, y734_p_1 = y735_p_0, y734_p_0 = 0;
			y734 < y735 + 28;
			y734 += 28, y734_p_1 += 28, y734_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 28) (56 / 2)
			for (x923 = x924, x923_p_1 = x924_p_0, x923_p_0 = 0;
				x923 < x924 + 56;
				x923 += 2, x923_p_1 += 2, x923_p_0 += 2){
				...
				for (f = f358, fp_0 = 0;
					...
					for (y = y734, yp_2 = y734_p_1, yp_1 = y734_p_0, yp_0 = 0;
						...
						// T (x, 1) (2 / 2)
						for (x922 = x923, x922_p_2 = x923_p_1, x922_p_1 = x923_p_0, x922_p_0 = 0;
							x922 < x923 + 2;
							x922 += 2, x922_p_2 += 2, x922_p_1 += 2, x922_p_0 += 2){
							// y = 7, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 4) (64 / 16)
							for (c564 = c565, c564_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x922, xp_3 = x922_p_2, xp_2 = x922_p_1, xp_1 = x922_p_0, xp_0 = 0;
									x < x922 + 2;
