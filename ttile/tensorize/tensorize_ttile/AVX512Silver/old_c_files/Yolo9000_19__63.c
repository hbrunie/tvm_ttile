			...
			f += 64, fp_0 += 64){
				for (y = y330, yp_1 = y330_p_0, yp_0 = 0;
					...
					for (c440 = c441, c440_p_1 = c441_p_0, c440_p_0 = 0;
						c440 < c441 + 256;
						c440 += 128, c440_p_1 += 128, c440_p_0 += 128){
						...
						for (x = x220, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_4354 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32]);
									mem_vec_4355 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32], mem_vec_4354);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48], mem_vec_4355);
						}
					}
				}
				for (y = y330 + 5, yp_1 = y330_p_0, yp_0 = 0;
					y < y330 + 5 + 12;
					y += 6, yp_1 += 6, yp_0 += 6){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 64
					// T (c, 2) (256 / 128)
