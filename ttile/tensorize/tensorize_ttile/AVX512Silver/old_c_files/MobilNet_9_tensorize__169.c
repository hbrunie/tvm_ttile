...
*/
IND_TYPE c, cp_0, c652_p_0, c653_p_0, cp_1, c652_p_1, cp_2, c652, c653, f, fp_0, f489_p_0, fp_1, f489, h, hp_0, w, wp_0, x, xp_0;
IND_TYPE y = 0;
IND_TYPE x326 = 0;
IND_TYPE h244 = 0;
IND_TYPE w244 = 0;
...
xp_0 = 0;
					for (h = h244, hp_0 = 0;h < h244 + 3;h += 1, hp_0 += 1){
						...
						for (w = w244, wp_0 = 0;w < w244 + 3;w += 1, wp_0 += 1){
									...
									// T (c, 32) (32 / 1)
									for (c = c652, cp_2 = c652_p_1, cp_1 = c652_p_0, cp_0 = 0;c < c652 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
