...
*/
IND_TYPE c, cp_0, c504_p_0, cp_1, c504, f, fp_0, x, xp_0, x822_p_0, x823_p_0, x824_p_0, xp_1, x822_p_1, x823_p_1, xp_2, x822_p_2, xp_3, x822, x823, x824, y, yp_0, y654_p_0, y655_p_0, yp_1, y654_p_1, yp_2, y654, y655;
...
for (y655 = y656, y655_p_0 = 0;
	...
	for (x824 = x825, x824_p_0 = 0;
		...
		for (y654 = y655, y654_p_1 = y655_p_0, y654_p_0 = 0;
			y654 < y655 + 28;
			y654 += 28, y654_p_1 += 28, y654_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (56 / 4)
			for (x823 = x824, x823_p_1 = x824_p_0, x823_p_0 = 0;
				x823 < x824 + 56;
				x823 += 4, x823_p_1 += 4, x823_p_0 += 4){
				...
				for (f = f318, fp_0 = 0;
					...
					for (y = y654, yp_2 = y654_p_1, yp_1 = y654_p_0, yp_0 = 0;
						...
						// T (x, 1) (4 / 4)
						for (x822 = x823, x822_p_2 = x823_p_1, x822_p_1 = x823_p_0, x822_p_0 = 0;
							x822 < x823 + 4;
							x822 += 4, x822_p_2 += 4, x822_p_1 += 4, x822_p_0 += 4){
							// y = 7, x = 4, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c504 = c505, c504_p_0 = 0;
								...
								// y = 7, x = 4, h = 1, w = 1, c = 64, f = 32
								// T (x, 4) (4 / 1)
								for (x = x822, xp_3 = x822_p_2, xp_2 = x822_p_1, xp_1 = x822_p_0, xp_0 = 0;
									x < x822 + 4;
