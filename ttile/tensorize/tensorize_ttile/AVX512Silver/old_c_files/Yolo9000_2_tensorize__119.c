...
[V f; U (4, f); U (2, y); U (3, w); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (1, c); T (34, x); T (1, y); T (136, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c189_p_0, cp_1, c189, h, hp_0, x, xp_0, x252_p_0, x253_p_0, xp_1, x252_p_1, xp_2, x252, x253, y, yp_0, y252_p_0, y253_p_0, yp_1, y252_p_1, yp_2, y252, y253;
IND_TYPE y254 = 0;
IND_TYPE x254 = 0;
IND_TYPE h84 = 0;
IND_TYPE w = 0;
...
c189_p_0 = 0;
						for (h = h84, hp_0 = 0;h < h84 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 1) (1 / 1)
							for (x = x252, xp_2 = x252_p_1, xp_1 = x252_p_0, xp_0 = 0;x < x252 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c189, cp_1 = c189_p_0, cp_0 = 0;c < c189 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_504);
											mem_vec_504 = vec_14;
											vec_18 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_505);
											mem_vec_505 = vec_17;
											vec_20 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_506);
											mem_vec_506 = vec_19;
											vec_22 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_507);
											mem_vec_507 = vec_21;
											scal_3 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
											vec_24 = _mm512_set1_ps(scal_3);
											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_508);
											mem_vec_508 = vec_23;
											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_509);
											mem_vec_509 = vec_25;
											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_510);
											mem_vec_510 = vec_26;
											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_511);
											mem_vec_511 = vec_27;
											scal_4 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
											vec_29 = _mm512_set1_ps(scal_4);
											vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_504);
											mem_vec_504 = vec_28;
											vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_505);
											mem_vec_505 = vec_31;
											vec_34 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_506);
											mem_vec_506 = vec_33;
											vec_36 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_507);
											mem_vec_507 = vec_35;
											scal_5 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_5);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_508);
											mem_vec_508 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_509);
											mem_vec_509 = vec_39;
											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_510);
											mem_vec_510 = vec_40;
											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_511);
											mem_vec_511 = vec_41;
										}
