...
[V f; U (2, f); ULambda y; T (3, c); Hoist_vars [c]; T (4, x); T (1, c);
  ...
  T (1, y)]
*/
IND_TYPE c, cp_0, c207_p_0, cp_1, c207, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x196_p_0, xp_1, x196, y, yp_0, y207_p_0, yp_1, y207;
IND_TYPE y208 = 0;
IND_TYPE x197 = 0;
IND_TYPE h138 = 0;
IND_TYPE w138 = 0;
...
y207 = 0;
y207_p_0 = 0;
	for (f = f127, fp_0 = 0;f < f127 + 64;f += 32, fp_0 += 32){
			for (y = y207, yp_1 = y207_p_0, yp_0 = 0;y < y207 + 8;y += 8, yp_1 += 8, yp_0 += 8){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 28) (112 / 4)
				for (x196 = x197, x196_p_0 = 0;x196 < x197 + 112;x196 += 4, x196_p_0 += 4){
					...
					for (h = h138, hp_0 = 0;h < h138 + 7;h += 1, hp_0 += 1){
						...
						for (w = w138, wp_0 = 0;w < w138 + 7;w += 1, wp_0 += 1){
							...
							for (c207 = c208, c207_p_0 = 0;c207 < c208 + 3;c207 += 3, c207_p_0 += 3){
								// y = ph_y, x = 4, h = 1, w = 1, c = 3, f = 32
								// T (x, 4) (4 / 1)
								for (x = x196, xp_1 = x196_p_0, xp_0 = 0;x < x196 + 4;x += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y207 + 8, yp_1 = y207_p_0, yp_0 = 0;y < y207 + 8 + 104;y += 13, yp_1 += 13, yp_0 += 13){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 28) (112 / 4)
				for (x196 = x197, x196_p_0 = 0;x196 < x197 + 112;x196 += 4, x196_p_0 += 4){
					// y = ph_y, x = 4, h = 7, w = 7, c = 3, f = 32
