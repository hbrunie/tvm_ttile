								...
								for (x = x210, xp_1 = x210_p_0, xp_0 = 0;
									...
									for (h = h106, hp_0 = 0;
										...
										h += 1, hp_0 += 1){
												...
												mem_vec_3172 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
												mem_vec_3173 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
												mem_vec_3174 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
												mem_vec_3175 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
												...
												for (c = c210, cp_1 = c210_p_0, cp_0 = 0;
													...
													vec_17 = _mm512_fmadd_ps(vec_18, vec_2, mem_vec_3170);
													mem_vec_3170 = vec_17;



													vec_19 = _mm512_fmadd_ps(vec_18, vec_4, mem_vec_3171);
													mem_vec_3171 = vec_19;
													scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
													vec_21 = _mm512_set1_ps(scal_6);


													vec_20 = _mm512_fmadd_ps(vec_21, vec_2, mem_vec_3172);
													mem_vec_3172 = vec_20;



													vec_22 = _mm512_fmadd_ps(vec_21, vec_4, mem_vec_3173);
													mem_vec_3173 = vec_22;
													scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
													vec_24 = _mm512_set1_ps(scal_7);


													vec_23 = _mm512_fmadd_ps(vec_24, vec_2, mem_vec_3174);
													mem_vec_3174 = vec_23;



													vec_25 = _mm512_fmadd_ps(vec_24, vec_4, mem_vec_3175);
													mem_vec_3175 = vec_25;
												}
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_3172);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_3173);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_3174);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_3175);
									}
								}
							}
						}
								...
								for (x = x210, xp_1 = x210_p_0, xp_0 = 0;
									...
									for (h = h106, hp_0 = 0;
										...
										h += 1, hp_0 += 1){
												...
												mem_vec_3202 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
												mem_vec_3203 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
												// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 32
												// T (c, 16) (16 / 1)
												for (c = c210, cp_1 = c210_p_0, cp_0 = 0;
													c < c210 + 16;
											...
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3202);
											_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_3203);
									}
								}
							}
						}
