...
[V f; U (4, f); U (2, y); U (3, w); T (16, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (2, c); T (1, x); T (17, y); T (2, y); T (272, x); T (4, y)]
*/
IND_TYPE c, cp_0, c372_p_0, cp_1, c372, h, hp_0, x, xp_0, x496_p_0, x497_p_0, xp_1, x496_p_1, xp_2, x496, x497, y, yp_0, y490_p_0, y491_p_0, yp_1, y490_p_1, yp_2, y490, y491;
IND_TYPE y492 = 0;
IND_TYPE x498 = 0;
IND_TYPE h188 = 0;
IND_TYPE w = 0;
						...
						for (h = h188, hp_0 = 0;h < h188 + 3;h += 1, hp_0 += 1){
							...
							for (x = x496, xp_2 = x496_p_1, xp_1 = x496_p_0, xp_0 = 0;x < x496 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c372, cp_1 = c372_p_0, cp_0 = 0;c < c372 + 16;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_1064);
											mem_vec_1064 = vec_14;
											vec_18 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_1065);
											mem_vec_1065 = vec_17;
											vec_20 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_1066);
											mem_vec_1066 = vec_19;
											vec_22 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_1067);
											mem_vec_1067 = vec_21;
											scal_3 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
											vec_24 = _mm512_set1_ps(scal_3);
											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_1068);
											mem_vec_1068 = vec_23;
											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_1069);
											mem_vec_1069 = vec_25;
											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_1070);
											mem_vec_1070 = vec_26;
											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_1071);
											mem_vec_1071 = vec_27;
											scal_4 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
											vec_29 = _mm512_set1_ps(scal_4);
											vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_1064);
											mem_vec_1064 = vec_28;
											vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_1065);
											mem_vec_1065 = vec_31;
											vec_34 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_1066);
											mem_vec_1066 = vec_33;
											vec_36 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_1067);
											mem_vec_1067 = vec_35;
											scal_5 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_5);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_1068);
											mem_vec_1068 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_1069);
											mem_vec_1069 = vec_39;
											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_1070);
											mem_vec_1070 = vec_40;
											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_1071);
											mem_vec_1071 = vec_41;
										}
