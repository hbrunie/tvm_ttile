...
[V f; U (1, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (7, x);
  T (3, h); T (32, f); T (8, c); T (1, y); T (2, c)]
*/
IND_TYPE c, cp_0, c436_p_0, c437_p_0, cp_1, c436_p_1, cp_2, c436, c437, f, fp_0, h, hp_0, x, xp_0, y, yp_0;
IND_TYPE y165 = 0;
IND_TYPE x248 = 0;
IND_TYPE h185 = 0;
IND_TYPE w = 0;
...
fp_0 = 0;
				for (h = h185, hp_0 = 0;h < h185 + 3;h += 1, hp_0 += 1){
					...
					for (x = x248, xp_0 = 0;x < x248 + 7;x += 1, xp_0 += 1){
								...
								mem_vec_1919 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								mem_vec_1920 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								mem_vec_1921 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								...
								// T (c, 32) (32 / 1)
								for (c = c436, cp_2 = c436_p_1, cp_1 = c436_p_0, cp_0 = 0;c < c436 + 32;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_1919);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_1920);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_1921);
