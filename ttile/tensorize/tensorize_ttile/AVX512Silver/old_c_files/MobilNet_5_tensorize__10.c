...
xp_0 = 0;
					for (h = h68, hp_0 = 0;h < h68 + 3;h += 1, hp_0 += 1){
								...
								mem_vec_799 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								// y = 4, x = 1, h = 1, w = 3, c = 64, f = 16
								// T (c, 64) (64 / 1)
								for (c = c136, cp_2 = c136_p_1, cp_1 = c136_p_0, cp_0 = 0;c < c136 + 64;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_799);
					}
}
