...
[V f; U (1, f); U (8, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (1, x); T (2, f); T (1, x); T (34, y); T (1, y); T (544, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x104_p_0, x105_p_0, xp_1, x104_p_1, xp_2, x104, x105, y, yp_0, y98_p_0, y99_p_0, yp_1, y98_p_1, yp_2, y98, y99;
...
for (y99 = y100, y99_p_0 = 0;
	...
	for (x105 = x106, x105_p_0 = 0;
		...
		// T (y, 1) (272 / 272)
		for (y98 = y99, y98_p_1 = y99_p_0, y98_p_0 = 0;
			y98 < y99 + 272;
			y98 += 272, y98_p_1 += 272, y98_p_0 += 272){
			// y = 272, x = 1, h = 3, w = 3, c = 3, f = 32
			// T (y, 34) (272 / 8)
			for (y = y98, yp_2 = y98_p_1, yp_1 = y98_p_0, yp_0 = 0;
				y < y98 + 272;
					...
					for (f = f46, fp_0 = 0;
						...
						for (x = x104, xp_2 = x104_p_1, xp_1 = x104_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_203 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_204 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
									mem_vec_205 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
									mem_vec_206 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_207 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									// y = 8, x = 1, h = 3, w = 3, c = 3, f = 16
									// T (c, 3) (3 / 1)
									for (c = c58, cp_0 = 0;
										c < c58 + 3;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_201);
										mem_vec_201 = vec_3;
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_203);
										mem_vec_203 = vec_7;
										...
										vec_13 = _mm512_fmadd_ps(vec_14, vec_2, mem_vec_206);
										mem_vec_206 = vec_13;
										scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h) + c];
										vec_16 = _mm512_set1_ps(scal_7);


										vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_207);
										mem_vec_207 = vec_15;
										scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
										vec_18 = _mm512_set1_ps(scal_8);
										vec_19 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

										vec_17 = _mm512_fmadd_ps(vec_18, vec_19, mem_vec_200);
										mem_vec_200 = vec_17;
										scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
										vec_21 = _mm512_set1_ps(scal_9);


										vec_20 = _mm512_fmadd_ps(vec_21, vec_19, mem_vec_201);
										mem_vec_201 = vec_20;
										scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
										vec_23 = _mm512_set1_ps(scal_10);


										vec_22 = _mm512_fmadd_ps(vec_23, vec_19, mem_vec_202);
										mem_vec_202 = vec_22;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
										vec_25 = _mm512_set1_ps(scal_11);


										vec_24 = _mm512_fmadd_ps(vec_25, vec_19, mem_vec_203);
										mem_vec_203 = vec_24;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
										vec_27 = _mm512_set1_ps(scal_12);


										vec_26 = _mm512_fmadd_ps(vec_27, vec_19, mem_vec_204);
										mem_vec_204 = vec_26;
										scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_13);


										vec_28 = _mm512_fmadd_ps(vec_29, vec_19, mem_vec_205);
										mem_vec_205 = vec_28;
										scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
										vec_31 = _mm512_set1_ps(scal_14);


										vec_30 = _mm512_fmadd_ps(vec_31, vec_19, mem_vec_206);
										mem_vec_206 = vec_30;
										scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
										vec_33 = _mm512_set1_ps(scal_15);


										vec_32 = _mm512_fmadd_ps(vec_33, vec_19, mem_vec_207);
										mem_vec_207 = vec_32;
										...
										vec_37 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_201);
										mem_vec_201 = vec_37;
										scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
										vec_40 = _mm512_set1_ps(scal_18);


										vec_39 = _mm512_fmadd_ps(vec_40, vec_36, mem_vec_202);
										mem_vec_202 = vec_39;
										scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
										vec_42 = _mm512_set1_ps(scal_19);


										vec_41 = _mm512_fmadd_ps(vec_42, vec_36, mem_vec_203);
										mem_vec_203 = vec_41;
										...
										vec_71 = _mm512_fmadd_ps(vec_72, vec_70, mem_vec_201);
										mem_vec_201 = vec_71;
										scal_34 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
										vec_74 = _mm512_set1_ps(scal_34);


										vec_73 = _mm512_fmadd_ps(vec_74, vec_70, mem_vec_202);
										mem_vec_202 = vec_73;
										scal_35 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
										vec_76 = _mm512_set1_ps(scal_35);


										vec_75 = _mm512_fmadd_ps(vec_76, vec_70, mem_vec_203);
										mem_vec_203 = vec_75;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_203);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_204);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_205);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_206);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_207);
						}
					}
				}
			}
