...
for (y576 = y577, y576_p_0 = 0;
	...
	for (x769 = x770, x769_p_0 = 0;
		...
		x769 += 68, x769_p_0 += 68){
			...
			for (y = y576 + 8, yp_1 = y576_p_0, yp_0 = 0;
				y < y576 + 8 + 60;
						...
						for (c576 = c577, c576_p_0 = 0;
							...
							for (x = x768, xp_2 = x768_p_1, xp_1 = x768_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7716 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
										mem_vec_7717 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 256, f = 32
										// T (c, 256) (256 / 1)
										for (c = c576, cp_1 = c576_p_0, cp_0 = 0;
											c < c576 + 256;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_7716);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_7717);
							}
						}
					}
				}
