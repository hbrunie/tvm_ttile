...
xp_0 = 0;
						for (h = h300, hp_0 = 0;h < h300 + 3;h += 1, hp_0 += 1){
									...
									mem_vec_6137 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_6138 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_6137);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_6138);
