				...
				for (y = y24, yp_1 = y24_p_0, yp_0 = 0;
					...
					for (x = x24, xp_1 = x24_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_250 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
								mem_vec_251 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
								mem_vec_252 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
								mem_vec_253 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
								mem_vec_254 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
								mem_vec_255 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
								mem_vec_256 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
								mem_vec_257 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
								mem_vec_258 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
								mem_vec_259 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
								mem_vec_260 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
								mem_vec_261 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
								mem_vec_262 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_263 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c19, cp_0 = 0;
									c < c19 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_250);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_251);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_252);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_253);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_254);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_255);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_256);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_257);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_258);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_259);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_260);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_261);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_262);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_263);
					}
				}
				for (y = y24 + 70, yp_1 = y24_p_0, yp_0 = 0;
					y < y24 + 70 + 66;
