...
[V f; U (4, f); U (2, y); U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (1, c); T (34, x); T (1, y); T (136, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c63_p_0, cp_1, c63, w, wp_0, x, xp_0, x84_p_0, x85_p_0, xp_1, x84_p_1, xp_2, x84, x85, y, yp_0, y84_p_0, y85_p_0, yp_1, y84_p_1, yp_2, y84, y85;
IND_TYPE y86 = 0;
IND_TYPE x86 = 0;
IND_TYPE h = 0;
IND_TYPE w42 = 0;
						...
						for (w = w42, wp_0 = 0;w < w42 + 3;w += 1, wp_0 += 1){
							...
							for (x = x84, xp_2 = x84_p_1, xp_1 = x84_p_0, xp_0 = 0;x < x84 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c63, cp_1 = c63_p_0, cp_0 = 0;c < c63 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_170);
											mem_vec_170 = vec_19;
											vec_22 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_171);
											mem_vec_171 = vec_21;
											scal_3 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
											vec_24 = _mm512_set1_ps(scal_3);
											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_172);
											mem_vec_172 = vec_23;
											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_173);
											mem_vec_173 = vec_25;
											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_174);
											mem_vec_174 = vec_26;
											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_175);
											mem_vec_175 = vec_27;
											...
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_170);
											mem_vec_170 = vec_33;
											vec_36 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_171);
											mem_vec_171 = vec_35;
											scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
											vec_38 = _mm512_set1_ps(scal_5);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_172);
											mem_vec_172 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_173);
											mem_vec_173 = vec_39;
											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_174);
											mem_vec_174 = vec_40;
											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_175);
											mem_vec_175 = vec_41;
										}
