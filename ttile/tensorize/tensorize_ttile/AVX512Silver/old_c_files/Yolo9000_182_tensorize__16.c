...
c752 = 0;
c752_p_1 = 0;
						for (x = x376, xp_0 = 0;x < x376 + 17;x += 1, xp_0 += 1){
									mem_vec_3179 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									...
									mem_vec_3187 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									// y = ph_y, x = 1, h = 3, w = 3, c = 64, f = 16
									// T (c, 64) (64 / 1)
									for (c = c752, cp_2 = c752_p_1, cp_1 = c752_p_0, cp_0 = 0;c < c752 + 64;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_3179);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3187);
						}
}
