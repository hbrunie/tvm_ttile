...
[V f; U (2, f); ULambda y; U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  ...
  T (1, f); T (1, f)]
*/
IND_TYPE c, cp_0, c123_p_0, cp_1, c123, f, fp_0, f164_p_0, f165_p_0, fp_1, f164_p_1, fp_2, f164, f165, x, xp_0, x123_p_0, xp_1, x123, y, yp_0;
							...
							for (x = x123, xp_1 = x123_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c123, cp_1 = c123_p_0, cp_0 = 0;
											...
											vec_78 = _mm512_fmadd_ps(vec_79, vec_80, mem_vec_1948);
											mem_vec_1948 = vec_78;

											vec_82 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_81 = _mm512_fmadd_ps(vec_79, vec_82, mem_vec_1949);
											mem_vec_1949 = vec_81;
											scal_25 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_84 = _mm512_set1_ps(scal_25);


											vec_83 = _mm512_fmadd_ps(vec_84, vec_80, mem_vec_1950);
											mem_vec_1950 = vec_83;



											vec_85 = _mm512_fmadd_ps(vec_84, vec_82, mem_vec_1951);
											mem_vec_1951 = vec_85;
											scal_26 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_87 = _mm512_set1_ps(scal_26);


											vec_86 = _mm512_fmadd_ps(vec_87, vec_80, mem_vec_1952);
											mem_vec_1952 = vec_86;



											vec_88 = _mm512_fmadd_ps(vec_87, vec_82, mem_vec_1953);
											mem_vec_1953 = vec_88;
											scal_27 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_90 = _mm512_set1_ps(scal_27);


											vec_89 = _mm512_fmadd_ps(vec_90, vec_80, mem_vec_1954);
											mem_vec_1954 = vec_89;



											vec_91 = _mm512_fmadd_ps(vec_90, vec_82, mem_vec_1955);
											mem_vec_1955 = vec_91;
											scal_28 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_93 = _mm512_set1_ps(scal_28);


											vec_92 = _mm512_fmadd_ps(vec_93, vec_80, mem_vec_1956);
											mem_vec_1956 = vec_92;



											vec_94 = _mm512_fmadd_ps(vec_93, vec_82, mem_vec_1957);
											mem_vec_1957 = vec_94;
											scal_29 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_96 = _mm512_set1_ps(scal_29);


											vec_95 = _mm512_fmadd_ps(vec_96, vec_80, mem_vec_1958);
											mem_vec_1958 = vec_95;



											vec_97 = _mm512_fmadd_ps(vec_96, vec_82, mem_vec_1959);
											mem_vec_1959 = vec_97;
											scal_30 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_99 = _mm512_set1_ps(scal_30);


											vec_98 = _mm512_fmadd_ps(vec_99, vec_80, mem_vec_1960);
											mem_vec_1960 = vec_98;



											vec_100 = _mm512_fmadd_ps(vec_99, vec_82, mem_vec_1961);
											mem_vec_1961 = vec_100;
											scal_31 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_102 = _mm512_set1_ps(scal_31);


											vec_101 = _mm512_fmadd_ps(vec_102, vec_80, mem_vec_1962);
											mem_vec_1962 = vec_101;



											vec_103 = _mm512_fmadd_ps(vec_102, vec_82, mem_vec_1963);
											mem_vec_1963 = vec_103;
											...
											vec_104 = _mm512_fmadd_ps(vec_105, vec_106, mem_vec_1948);
											mem_vec_1948 = vec_104;

											vec_108 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_107 = _mm512_fmadd_ps(vec_105, vec_108, mem_vec_1949);
											mem_vec_1949 = vec_107;
											scal_33 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
											vec_110 = _mm512_set1_ps(scal_33);


											vec_109 = _mm512_fmadd_ps(vec_110, vec_106, mem_vec_1950);
											mem_vec_1950 = vec_109;



											vec_111 = _mm512_fmadd_ps(vec_110, vec_108, mem_vec_1951);
											mem_vec_1951 = vec_111;
											scal_34 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
											vec_113 = _mm512_set1_ps(scal_34);


											vec_112 = _mm512_fmadd_ps(vec_113, vec_106, mem_vec_1952);
											mem_vec_1952 = vec_112;



											vec_114 = _mm512_fmadd_ps(vec_113, vec_108, mem_vec_1953);
											mem_vec_1953 = vec_114;
											scal_35 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
											vec_116 = _mm512_set1_ps(scal_35);


											vec_115 = _mm512_fmadd_ps(vec_116, vec_106, mem_vec_1954);
											mem_vec_1954 = vec_115;



											vec_117 = _mm512_fmadd_ps(vec_116, vec_108, mem_vec_1955);
											mem_vec_1955 = vec_117;
											scal_36 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
											vec_119 = _mm512_set1_ps(scal_36);


											vec_118 = _mm512_fmadd_ps(vec_119, vec_106, mem_vec_1956);
											mem_vec_1956 = vec_118;



											vec_120 = _mm512_fmadd_ps(vec_119, vec_108, mem_vec_1957);
											mem_vec_1957 = vec_120;
											scal_37 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
											vec_122 = _mm512_set1_ps(scal_37);


											vec_121 = _mm512_fmadd_ps(vec_122, vec_106, mem_vec_1958);
											mem_vec_1958 = vec_121;



											vec_123 = _mm512_fmadd_ps(vec_122, vec_108, mem_vec_1959);
											mem_vec_1959 = vec_123;
											scal_38 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
											vec_125 = _mm512_set1_ps(scal_38);


											vec_124 = _mm512_fmadd_ps(vec_125, vec_106, mem_vec_1960);
											mem_vec_1960 = vec_124;



											vec_126 = _mm512_fmadd_ps(vec_125, vec_108, mem_vec_1961);
											mem_vec_1961 = vec_126;
											scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
											vec_128 = _mm512_set1_ps(scal_39);


											vec_127 = _mm512_fmadd_ps(vec_128, vec_106, mem_vec_1962);
											mem_vec_1962 = vec_127;



											vec_129 = _mm512_fmadd_ps(vec_128, vec_108, mem_vec_1963);
											mem_vec_1963 = vec_129;
											...
											vec_130 = _mm512_fmadd_ps(vec_131, vec_132, mem_vec_1948);
											mem_vec_1948 = vec_130;

											vec_134 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_133 = _mm512_fmadd_ps(vec_131, vec_134, mem_vec_1949);
											mem_vec_1949 = vec_133;
											scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
											vec_136 = _mm512_set1_ps(scal_41);


											vec_135 = _mm512_fmadd_ps(vec_136, vec_132, mem_vec_1950);
											mem_vec_1950 = vec_135;



											vec_137 = _mm512_fmadd_ps(vec_136, vec_134, mem_vec_1951);
											mem_vec_1951 = vec_137;
											scal_42 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
											vec_139 = _mm512_set1_ps(scal_42);


											vec_138 = _mm512_fmadd_ps(vec_139, vec_132, mem_vec_1952);
											mem_vec_1952 = vec_138;



											vec_140 = _mm512_fmadd_ps(vec_139, vec_134, mem_vec_1953);
											mem_vec_1953 = vec_140;
											scal_43 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
											vec_142 = _mm512_set1_ps(scal_43);


											vec_141 = _mm512_fmadd_ps(vec_142, vec_132, mem_vec_1954);
											mem_vec_1954 = vec_141;



											vec_143 = _mm512_fmadd_ps(vec_142, vec_134, mem_vec_1955);
											mem_vec_1955 = vec_143;
											scal_44 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
											vec_145 = _mm512_set1_ps(scal_44);


											vec_144 = _mm512_fmadd_ps(vec_145, vec_132, mem_vec_1956);
											mem_vec_1956 = vec_144;



											vec_146 = _mm512_fmadd_ps(vec_145, vec_134, mem_vec_1957);
											mem_vec_1957 = vec_146;
											scal_45 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
											vec_148 = _mm512_set1_ps(scal_45);


											vec_147 = _mm512_fmadd_ps(vec_148, vec_132, mem_vec_1958);
											mem_vec_1958 = vec_147;



											vec_149 = _mm512_fmadd_ps(vec_148, vec_134, mem_vec_1959);
											mem_vec_1959 = vec_149;
											scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
											vec_151 = _mm512_set1_ps(scal_46);


											vec_150 = _mm512_fmadd_ps(vec_151, vec_132, mem_vec_1960);
											mem_vec_1960 = vec_150;



											vec_152 = _mm512_fmadd_ps(vec_151, vec_134, mem_vec_1961);
											mem_vec_1961 = vec_152;
											scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 2) + c];
											vec_154 = _mm512_set1_ps(scal_47);


											vec_153 = _mm512_fmadd_ps(vec_154, vec_132, mem_vec_1962);
											mem_vec_1962 = vec_153;



											vec_155 = _mm512_fmadd_ps(vec_154, vec_134, mem_vec_1963);
											mem_vec_1963 = vec_155;
											scal_48 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_157 = _mm512_set1_ps(scal_48);
											vec_158 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_156 = _mm512_fmadd_ps(vec_157, vec_158, mem_vec_1948);
											mem_vec_1948 = vec_156;

											vec_160 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_159 = _mm512_fmadd_ps(vec_157, vec_160, mem_vec_1949);
											mem_vec_1949 = vec_159;
											scal_49 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_162 = _mm512_set1_ps(scal_49);


											vec_161 = _mm512_fmadd_ps(vec_162, vec_158, mem_vec_1950);
											mem_vec_1950 = vec_161;



											vec_163 = _mm512_fmadd_ps(vec_162, vec_160, mem_vec_1951);
											mem_vec_1951 = vec_163;
											scal_50 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_165 = _mm512_set1_ps(scal_50);


											vec_164 = _mm512_fmadd_ps(vec_165, vec_158, mem_vec_1952);
											mem_vec_1952 = vec_164;



											vec_166 = _mm512_fmadd_ps(vec_165, vec_160, mem_vec_1953);
											mem_vec_1953 = vec_166;
											scal_51 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_168 = _mm512_set1_ps(scal_51);


											vec_167 = _mm512_fmadd_ps(vec_168, vec_158, mem_vec_1954);
											mem_vec_1954 = vec_167;



											vec_169 = _mm512_fmadd_ps(vec_168, vec_160, mem_vec_1955);
											mem_vec_1955 = vec_169;
											scal_52 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_171 = _mm512_set1_ps(scal_52);


											vec_170 = _mm512_fmadd_ps(vec_171, vec_158, mem_vec_1956);
											mem_vec_1956 = vec_170;



											vec_172 = _mm512_fmadd_ps(vec_171, vec_160, mem_vec_1957);
											mem_vec_1957 = vec_172;
											scal_53 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_174 = _mm512_set1_ps(scal_53);


											vec_173 = _mm512_fmadd_ps(vec_174, vec_158, mem_vec_1958);
											mem_vec_1958 = vec_173;



											vec_175 = _mm512_fmadd_ps(vec_174, vec_160, mem_vec_1959);
											mem_vec_1959 = vec_175;
											scal_54 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_177 = _mm512_set1_ps(scal_54);


											vec_176 = _mm512_fmadd_ps(vec_177, vec_158, mem_vec_1960);
											mem_vec_1960 = vec_176;



											vec_178 = _mm512_fmadd_ps(vec_177, vec_160, mem_vec_1961);
											mem_vec_1961 = vec_178;
											scal_55 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_180 = _mm512_set1_ps(scal_55);


											vec_179 = _mm512_fmadd_ps(vec_180, vec_158, mem_vec_1962);
											mem_vec_1962 = vec_179;



											vec_181 = _mm512_fmadd_ps(vec_180, vec_160, mem_vec_1963);
											mem_vec_1963 = vec_181;
											...
											vec_182 = _mm512_fmadd_ps(vec_183, vec_184, mem_vec_1948);
											mem_vec_1948 = vec_182;

											vec_186 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_185 = _mm512_fmadd_ps(vec_183, vec_186, mem_vec_1949);
											mem_vec_1949 = vec_185;
											scal_57 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
											vec_188 = _mm512_set1_ps(scal_57);


											vec_187 = _mm512_fmadd_ps(vec_188, vec_184, mem_vec_1950);
											mem_vec_1950 = vec_187;



											vec_189 = _mm512_fmadd_ps(vec_188, vec_186, mem_vec_1951);
											mem_vec_1951 = vec_189;
											scal_58 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
											vec_191 = _mm512_set1_ps(scal_58);


											vec_190 = _mm512_fmadd_ps(vec_191, vec_184, mem_vec_1952);
											mem_vec_1952 = vec_190;



											vec_192 = _mm512_fmadd_ps(vec_191, vec_186, mem_vec_1953);
											mem_vec_1953 = vec_192;
											scal_59 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
											vec_194 = _mm512_set1_ps(scal_59);


											vec_193 = _mm512_fmadd_ps(vec_194, vec_184, mem_vec_1954);
											mem_vec_1954 = vec_193;



											vec_195 = _mm512_fmadd_ps(vec_194, vec_186, mem_vec_1955);
											mem_vec_1955 = vec_195;
											scal_60 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
											vec_197 = _mm512_set1_ps(scal_60);


											vec_196 = _mm512_fmadd_ps(vec_197, vec_184, mem_vec_1956);
											mem_vec_1956 = vec_196;



											vec_198 = _mm512_fmadd_ps(vec_197, vec_186, mem_vec_1957);
											mem_vec_1957 = vec_198;
											scal_61 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
											vec_200 = _mm512_set1_ps(scal_61);


											vec_199 = _mm512_fmadd_ps(vec_200, vec_184, mem_vec_1958);
											mem_vec_1958 = vec_199;



											vec_201 = _mm512_fmadd_ps(vec_200, vec_186, mem_vec_1959);
											mem_vec_1959 = vec_201;
											scal_62 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
											vec_203 = _mm512_set1_ps(scal_62);


											vec_202 = _mm512_fmadd_ps(vec_203, vec_184, mem_vec_1960);
											mem_vec_1960 = vec_202;



											vec_204 = _mm512_fmadd_ps(vec_203, vec_186, mem_vec_1961);
											mem_vec_1961 = vec_204;
											scal_63 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
											vec_206 = _mm512_set1_ps(scal_63);


											vec_205 = _mm512_fmadd_ps(vec_206, vec_184, mem_vec_1962);
											mem_vec_1962 = vec_205;



											vec_207 = _mm512_fmadd_ps(vec_206, vec_186, mem_vec_1963);
											mem_vec_1963 = vec_207;
											...
											vec_208 = _mm512_fmadd_ps(vec_209, vec_210, mem_vec_1948);
											mem_vec_1948 = vec_208;

											vec_212 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_211 = _mm512_fmadd_ps(vec_209, vec_212, mem_vec_1949);
											mem_vec_1949 = vec_211;
											scal_65 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
											vec_214 = _mm512_set1_ps(scal_65);


											vec_213 = _mm512_fmadd_ps(vec_214, vec_210, mem_vec_1950);
											mem_vec_1950 = vec_213;



											vec_215 = _mm512_fmadd_ps(vec_214, vec_212, mem_vec_1951);
											mem_vec_1951 = vec_215;
											scal_66 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
											vec_217 = _mm512_set1_ps(scal_66);


											vec_216 = _mm512_fmadd_ps(vec_217, vec_210, mem_vec_1952);
											mem_vec_1952 = vec_216;



											vec_218 = _mm512_fmadd_ps(vec_217, vec_212, mem_vec_1953);
											mem_vec_1953 = vec_218;
											scal_67 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
											vec_220 = _mm512_set1_ps(scal_67);


											vec_219 = _mm512_fmadd_ps(vec_220, vec_210, mem_vec_1954);
											mem_vec_1954 = vec_219;



											vec_221 = _mm512_fmadd_ps(vec_220, vec_212, mem_vec_1955);
											mem_vec_1955 = vec_221;
											scal_68 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
											vec_223 = _mm512_set1_ps(scal_68);


											vec_222 = _mm512_fmadd_ps(vec_223, vec_210, mem_vec_1956);
											mem_vec_1956 = vec_222;



											vec_224 = _mm512_fmadd_ps(vec_223, vec_212, mem_vec_1957);
											mem_vec_1957 = vec_224;
											scal_69 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
											vec_226 = _mm512_set1_ps(scal_69);


											vec_225 = _mm512_fmadd_ps(vec_226, vec_210, mem_vec_1958);
											mem_vec_1958 = vec_225;



											vec_227 = _mm512_fmadd_ps(vec_226, vec_212, mem_vec_1959);
											mem_vec_1959 = vec_227;
											scal_70 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
											vec_229 = _mm512_set1_ps(scal_70);


											vec_228 = _mm512_fmadd_ps(vec_229, vec_210, mem_vec_1960);
											mem_vec_1960 = vec_228;



											vec_230 = _mm512_fmadd_ps(vec_229, vec_212, mem_vec_1961);
											mem_vec_1961 = vec_230;
											scal_71 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
											vec_232 = _mm512_set1_ps(scal_71);


											vec_231 = _mm512_fmadd_ps(vec_232, vec_210, mem_vec_1962);
											mem_vec_1962 = vec_231;



											vec_233 = _mm512_fmadd_ps(vec_232, vec_212, mem_vec_1963);
											mem_vec_1963 = vec_233;
										}
						...
						for (c123 = c124, c123_p_0 = 0;
							...
							for (x = x123, xp_1 = x123_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1984 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
										mem_vec_1985 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
										mem_vec_1986 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_1987 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										// y = ph_y, x = 1, h = 3, w = 3, c = 64, f = 32
										// T (c, 64) (64 / 1)
										for (c = c123, cp_1 = c123_p_0, cp_0 = 0;
											c < c123 + 64;
											...
											vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_1984);
											mem_vec_1984 = vec_32;



											vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_1985);
											mem_vec_1985 = vec_34;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
											vec_36 = _mm512_set1_ps(scal_11);


											vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_1986);
											mem_vec_1986 = vec_35;



											vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_1987);
											mem_vec_1987 = vec_37;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
											vec_39 = _mm512_set1_ps(scal_12);
											vec_40 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

											vec_38 = _mm512_fmadd_ps(vec_39, vec_40, mem_vec_1964);
											mem_vec_1964 = vec_38;

											vec_42 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_41 = _mm512_fmadd_ps(vec_39, vec_42, mem_vec_1965);
											mem_vec_1965 = vec_41;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_40, mem_vec_1966);
											mem_vec_1966 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_42, mem_vec_1967);
											mem_vec_1967 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_40, mem_vec_1968);
											mem_vec_1968 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_42, mem_vec_1969);
											mem_vec_1969 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_40, mem_vec_1970);
											mem_vec_1970 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_42, mem_vec_1971);
											mem_vec_1971 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_53 = _mm512_set1_ps(scal_16);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_40, mem_vec_1972);
											mem_vec_1972 = vec_52;



											vec_54 = _mm512_fmadd_ps(vec_53, vec_42, mem_vec_1973);
											mem_vec_1973 = vec_54;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_56 = _mm512_set1_ps(scal_17);


											vec_55 = _mm512_fmadd_ps(vec_56, vec_40, mem_vec_1974);
											mem_vec_1974 = vec_55;



											vec_57 = _mm512_fmadd_ps(vec_56, vec_42, mem_vec_1975);
											mem_vec_1975 = vec_57;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_59 = _mm512_set1_ps(scal_18);


											vec_58 = _mm512_fmadd_ps(vec_59, vec_40, mem_vec_1976);
											mem_vec_1976 = vec_58;



											vec_60 = _mm512_fmadd_ps(vec_59, vec_42, mem_vec_1977);
											mem_vec_1977 = vec_60;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
											vec_62 = _mm512_set1_ps(scal_19);


											vec_61 = _mm512_fmadd_ps(vec_62, vec_40, mem_vec_1978);
											mem_vec_1978 = vec_61;



											vec_63 = _mm512_fmadd_ps(vec_62, vec_42, mem_vec_1979);
											mem_vec_1979 = vec_63;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
											vec_65 = _mm512_set1_ps(scal_20);


											vec_64 = _mm512_fmadd_ps(vec_65, vec_40, mem_vec_1980);
											mem_vec_1980 = vec_64;



											vec_66 = _mm512_fmadd_ps(vec_65, vec_42, mem_vec_1981);
											mem_vec_1981 = vec_66;
											scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 1) + c];
											vec_68 = _mm512_set1_ps(scal_21);


											vec_67 = _mm512_fmadd_ps(vec_68, vec_40, mem_vec_1982);
											mem_vec_1982 = vec_67;



											vec_69 = _mm512_fmadd_ps(vec_68, vec_42, mem_vec_1983);
											mem_vec_1983 = vec_69;
											scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 1) + c];
											vec_71 = _mm512_set1_ps(scal_22);


											vec_70 = _mm512_fmadd_ps(vec_71, vec_40, mem_vec_1984);
											mem_vec_1984 = vec_70;



											vec_72 = _mm512_fmadd_ps(vec_71, vec_42, mem_vec_1985);
											mem_vec_1985 = vec_72;
											scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 1) + c];
											vec_74 = _mm512_set1_ps(scal_23);


											vec_73 = _mm512_fmadd_ps(vec_74, vec_40, mem_vec_1986);
											mem_vec_1986 = vec_73;



											vec_75 = _mm512_fmadd_ps(vec_74, vec_42, mem_vec_1987);
											mem_vec_1987 = vec_75;
											scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_77 = _mm512_set1_ps(scal_24);
											vec_78 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_76 = _mm512_fmadd_ps(vec_77, vec_78, mem_vec_1964);
											mem_vec_1964 = vec_76;

											vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_79 = _mm512_fmadd_ps(vec_77, vec_80, mem_vec_1965);
											mem_vec_1965 = vec_79;
											scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_82 = _mm512_set1_ps(scal_25);


											vec_81 = _mm512_fmadd_ps(vec_82, vec_78, mem_vec_1966);
											mem_vec_1966 = vec_81;



											vec_83 = _mm512_fmadd_ps(vec_82, vec_80, mem_vec_1967);
											mem_vec_1967 = vec_83;
											scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_85 = _mm512_set1_ps(scal_26);


											vec_84 = _mm512_fmadd_ps(vec_85, vec_78, mem_vec_1968);
											mem_vec_1968 = vec_84;



											vec_86 = _mm512_fmadd_ps(vec_85, vec_80, mem_vec_1969);
											mem_vec_1969 = vec_86;
											scal_27 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_88 = _mm512_set1_ps(scal_27);


											vec_87 = _mm512_fmadd_ps(vec_88, vec_78, mem_vec_1970);
											mem_vec_1970 = vec_87;



											vec_89 = _mm512_fmadd_ps(vec_88, vec_80, mem_vec_1971);
											mem_vec_1971 = vec_89;
											scal_28 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_91 = _mm512_set1_ps(scal_28);


											vec_90 = _mm512_fmadd_ps(vec_91, vec_78, mem_vec_1972);
											mem_vec_1972 = vec_90;



											vec_92 = _mm512_fmadd_ps(vec_91, vec_80, mem_vec_1973);
											mem_vec_1973 = vec_92;
											scal_29 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_94 = _mm512_set1_ps(scal_29);


											vec_93 = _mm512_fmadd_ps(vec_94, vec_78, mem_vec_1974);
											mem_vec_1974 = vec_93;



											vec_95 = _mm512_fmadd_ps(vec_94, vec_80, mem_vec_1975);
											mem_vec_1975 = vec_95;
											scal_30 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_97 = _mm512_set1_ps(scal_30);


											vec_96 = _mm512_fmadd_ps(vec_97, vec_78, mem_vec_1976);
											mem_vec_1976 = vec_96;



											vec_98 = _mm512_fmadd_ps(vec_97, vec_80, mem_vec_1977);
											mem_vec_1977 = vec_98;
											scal_31 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
											vec_100 = _mm512_set1_ps(scal_31);


											vec_99 = _mm512_fmadd_ps(vec_100, vec_78, mem_vec_1978);
											mem_vec_1978 = vec_99;



											vec_101 = _mm512_fmadd_ps(vec_100, vec_80, mem_vec_1979);
											mem_vec_1979 = vec_101;
											scal_32 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
											vec_103 = _mm512_set1_ps(scal_32);


											vec_102 = _mm512_fmadd_ps(vec_103, vec_78, mem_vec_1980);
											mem_vec_1980 = vec_102;



											vec_104 = _mm512_fmadd_ps(vec_103, vec_80, mem_vec_1981);
											mem_vec_1981 = vec_104;
											scal_33 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h + 2) + c];
											vec_106 = _mm512_set1_ps(scal_33);


											vec_105 = _mm512_fmadd_ps(vec_106, vec_78, mem_vec_1982);
											mem_vec_1982 = vec_105;



											vec_107 = _mm512_fmadd_ps(vec_106, vec_80, mem_vec_1983);
											mem_vec_1983 = vec_107;
											scal_34 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h + 2) + c];
											vec_109 = _mm512_set1_ps(scal_34);


											vec_108 = _mm512_fmadd_ps(vec_109, vec_78, mem_vec_1984);
											mem_vec_1984 = vec_108;



											vec_110 = _mm512_fmadd_ps(vec_109, vec_80, mem_vec_1985);
											mem_vec_1985 = vec_110;
											scal_35 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h + 2) + c];
											vec_112 = _mm512_set1_ps(scal_35);


											vec_111 = _mm512_fmadd_ps(vec_112, vec_78, mem_vec_1986);
											mem_vec_1986 = vec_111;



											vec_113 = _mm512_fmadd_ps(vec_112, vec_80, mem_vec_1987);
											mem_vec_1987 = vec_113;
											scal_36 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
											vec_115 = _mm512_set1_ps(scal_36);
											vec_116 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

											vec_114 = _mm512_fmadd_ps(vec_115, vec_116, mem_vec_1964);
											mem_vec_1964 = vec_114;

											vec_118 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_117 = _mm512_fmadd_ps(vec_115, vec_118, mem_vec_1965);
											mem_vec_1965 = vec_117;
											scal_37 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_120 = _mm512_set1_ps(scal_37);


											vec_119 = _mm512_fmadd_ps(vec_120, vec_116, mem_vec_1966);
											mem_vec_1966 = vec_119;



											vec_121 = _mm512_fmadd_ps(vec_120, vec_118, mem_vec_1967);
											mem_vec_1967 = vec_121;
											scal_38 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_123 = _mm512_set1_ps(scal_38);


											vec_122 = _mm512_fmadd_ps(vec_123, vec_116, mem_vec_1968);
											mem_vec_1968 = vec_122;



											vec_124 = _mm512_fmadd_ps(vec_123, vec_118, mem_vec_1969);
											mem_vec_1969 = vec_124;
											scal_39 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_126 = _mm512_set1_ps(scal_39);


											vec_125 = _mm512_fmadd_ps(vec_126, vec_116, mem_vec_1970);
											mem_vec_1970 = vec_125;



											vec_127 = _mm512_fmadd_ps(vec_126, vec_118, mem_vec_1971);
											mem_vec_1971 = vec_127;
											scal_40 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_129 = _mm512_set1_ps(scal_40);


											vec_128 = _mm512_fmadd_ps(vec_129, vec_116, mem_vec_1972);
											mem_vec_1972 = vec_128;



											vec_130 = _mm512_fmadd_ps(vec_129, vec_118, mem_vec_1973);
											mem_vec_1973 = vec_130;
											scal_41 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_132 = _mm512_set1_ps(scal_41);


											vec_131 = _mm512_fmadd_ps(vec_132, vec_116, mem_vec_1974);
											mem_vec_1974 = vec_131;



											vec_133 = _mm512_fmadd_ps(vec_132, vec_118, mem_vec_1975);
											mem_vec_1975 = vec_133;
											scal_42 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_135 = _mm512_set1_ps(scal_42);


											vec_134 = _mm512_fmadd_ps(vec_135, vec_116, mem_vec_1976);
											mem_vec_1976 = vec_134;



											vec_136 = _mm512_fmadd_ps(vec_135, vec_118, mem_vec_1977);
											mem_vec_1977 = vec_136;
											scal_43 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_138 = _mm512_set1_ps(scal_43);


											vec_137 = _mm512_fmadd_ps(vec_138, vec_116, mem_vec_1978);
											mem_vec_1978 = vec_137;



											vec_139 = _mm512_fmadd_ps(vec_138, vec_118, mem_vec_1979);
											mem_vec_1979 = vec_139;
											scal_44 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
											vec_141 = _mm512_set1_ps(scal_44);


											vec_140 = _mm512_fmadd_ps(vec_141, vec_116, mem_vec_1980);
											mem_vec_1980 = vec_140;



											vec_142 = _mm512_fmadd_ps(vec_141, vec_118, mem_vec_1981);
											mem_vec_1981 = vec_142;
											scal_45 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
											vec_144 = _mm512_set1_ps(scal_45);


											vec_143 = _mm512_fmadd_ps(vec_144, vec_116, mem_vec_1982);
											mem_vec_1982 = vec_143;



											vec_145 = _mm512_fmadd_ps(vec_144, vec_118, mem_vec_1983);
											mem_vec_1983 = vec_145;
											scal_46 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h) + c];
											vec_147 = _mm512_set1_ps(scal_46);


											vec_146 = _mm512_fmadd_ps(vec_147, vec_116, mem_vec_1984);
											mem_vec_1984 = vec_146;



											vec_148 = _mm512_fmadd_ps(vec_147, vec_118, mem_vec_1985);
											mem_vec_1985 = vec_148;
											scal_47 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h) + c];
											vec_150 = _mm512_set1_ps(scal_47);


											vec_149 = _mm512_fmadd_ps(vec_150, vec_116, mem_vec_1986);
											mem_vec_1986 = vec_149;



											vec_151 = _mm512_fmadd_ps(vec_150, vec_118, mem_vec_1987);
											mem_vec_1987 = vec_151;
											...
											vec_152 = _mm512_fmadd_ps(vec_153, vec_154, mem_vec_1964);
											mem_vec_1964 = vec_152;

											vec_156 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_155 = _mm512_fmadd_ps(vec_153, vec_156, mem_vec_1965);
											mem_vec_1965 = vec_155;
											scal_49 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 1) + c];
											vec_158 = _mm512_set1_ps(scal_49);


											vec_157 = _mm512_fmadd_ps(vec_158, vec_154, mem_vec_1966);
											mem_vec_1966 = vec_157;



											vec_159 = _mm512_fmadd_ps(vec_158, vec_156, mem_vec_1967);
											mem_vec_1967 = vec_159;
											scal_50 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 1) + c];
											vec_161 = _mm512_set1_ps(scal_50);


											vec_160 = _mm512_fmadd_ps(vec_161, vec_154, mem_vec_1968);
											mem_vec_1968 = vec_160;



											vec_162 = _mm512_fmadd_ps(vec_161, vec_156, mem_vec_1969);
											mem_vec_1969 = vec_162;
											scal_51 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 1) + c];
											vec_164 = _mm512_set1_ps(scal_51);


											vec_163 = _mm512_fmadd_ps(vec_164, vec_154, mem_vec_1970);
											mem_vec_1970 = vec_163;



											vec_165 = _mm512_fmadd_ps(vec_164, vec_156, mem_vec_1971);
											mem_vec_1971 = vec_165;
											scal_52 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 1) + c];
											vec_167 = _mm512_set1_ps(scal_52);


											vec_166 = _mm512_fmadd_ps(vec_167, vec_154, mem_vec_1972);
											mem_vec_1972 = vec_166;



											vec_168 = _mm512_fmadd_ps(vec_167, vec_156, mem_vec_1973);
											mem_vec_1973 = vec_168;
											scal_53 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 1) + c];
											vec_170 = _mm512_set1_ps(scal_53);


											vec_169 = _mm512_fmadd_ps(vec_170, vec_154, mem_vec_1974);
											mem_vec_1974 = vec_169;



											vec_171 = _mm512_fmadd_ps(vec_170, vec_156, mem_vec_1975);
											mem_vec_1975 = vec_171;
											scal_54 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 1) + c];
											vec_173 = _mm512_set1_ps(scal_54);


											vec_172 = _mm512_fmadd_ps(vec_173, vec_154, mem_vec_1976);
											mem_vec_1976 = vec_172;



											vec_174 = _mm512_fmadd_ps(vec_173, vec_156, mem_vec_1977);
											mem_vec_1977 = vec_174;
											scal_55 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 1) + c];
											vec_176 = _mm512_set1_ps(scal_55);


											vec_175 = _mm512_fmadd_ps(vec_176, vec_154, mem_vec_1978);
											mem_vec_1978 = vec_175;



											vec_177 = _mm512_fmadd_ps(vec_176, vec_156, mem_vec_1979);
											mem_vec_1979 = vec_177;
											scal_56 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 1) + c];
											vec_179 = _mm512_set1_ps(scal_56);


											vec_178 = _mm512_fmadd_ps(vec_179, vec_154, mem_vec_1980);
											mem_vec_1980 = vec_178;



											vec_180 = _mm512_fmadd_ps(vec_179, vec_156, mem_vec_1981);
											mem_vec_1981 = vec_180;
											scal_57 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 1) + c];
											vec_182 = _mm512_set1_ps(scal_57);


											vec_181 = _mm512_fmadd_ps(vec_182, vec_154, mem_vec_1982);
											mem_vec_1982 = vec_181;



											vec_183 = _mm512_fmadd_ps(vec_182, vec_156, mem_vec_1983);
											mem_vec_1983 = vec_183;
											scal_58 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 1) + c];
											vec_185 = _mm512_set1_ps(scal_58);


											vec_184 = _mm512_fmadd_ps(vec_185, vec_154, mem_vec_1984);
											mem_vec_1984 = vec_184;



											vec_186 = _mm512_fmadd_ps(vec_185, vec_156, mem_vec_1985);
											mem_vec_1985 = vec_186;
											scal_59 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h + 1) + c];
											vec_188 = _mm512_set1_ps(scal_59);


											vec_187 = _mm512_fmadd_ps(vec_188, vec_154, mem_vec_1986);
											mem_vec_1986 = vec_187;



											vec_189 = _mm512_fmadd_ps(vec_188, vec_156, mem_vec_1987);
											mem_vec_1987 = vec_189;
											...
											vec_190 = _mm512_fmadd_ps(vec_191, vec_192, mem_vec_1964);
											mem_vec_1964 = vec_190;

											vec_194 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_193 = _mm512_fmadd_ps(vec_191, vec_194, mem_vec_1965);
											mem_vec_1965 = vec_193;
											scal_61 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h + 2) + c];
											vec_196 = _mm512_set1_ps(scal_61);


											vec_195 = _mm512_fmadd_ps(vec_196, vec_192, mem_vec_1966);
											mem_vec_1966 = vec_195;



											vec_197 = _mm512_fmadd_ps(vec_196, vec_194, mem_vec_1967);
											mem_vec_1967 = vec_197;
											scal_62 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h + 2) + c];
											vec_199 = _mm512_set1_ps(scal_62);


											vec_198 = _mm512_fmadd_ps(vec_199, vec_192, mem_vec_1968);
											mem_vec_1968 = vec_198;



											vec_200 = _mm512_fmadd_ps(vec_199, vec_194, mem_vec_1969);
											mem_vec_1969 = vec_200;
											scal_63 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h + 2) + c];
											vec_202 = _mm512_set1_ps(scal_63);


											vec_201 = _mm512_fmadd_ps(vec_202, vec_192, mem_vec_1970);
											mem_vec_1970 = vec_201;



											vec_203 = _mm512_fmadd_ps(vec_202, vec_194, mem_vec_1971);
											mem_vec_1971 = vec_203;
											scal_64 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h + 2) + c];
											vec_205 = _mm512_set1_ps(scal_64);


											vec_204 = _mm512_fmadd_ps(vec_205, vec_192, mem_vec_1972);
											mem_vec_1972 = vec_204;



											vec_206 = _mm512_fmadd_ps(vec_205, vec_194, mem_vec_1973);
											mem_vec_1973 = vec_206;
											scal_65 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h + 2) + c];
											vec_208 = _mm512_set1_ps(scal_65);


											vec_207 = _mm512_fmadd_ps(vec_208, vec_192, mem_vec_1974);
											mem_vec_1974 = vec_207;



											vec_209 = _mm512_fmadd_ps(vec_208, vec_194, mem_vec_1975);
											mem_vec_1975 = vec_209;
											scal_66 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h + 2) + c];
											vec_211 = _mm512_set1_ps(scal_66);


											vec_210 = _mm512_fmadd_ps(vec_211, vec_192, mem_vec_1976);
											mem_vec_1976 = vec_210;



											vec_212 = _mm512_fmadd_ps(vec_211, vec_194, mem_vec_1977);
											mem_vec_1977 = vec_212;
											scal_67 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h + 2) + c];
											vec_214 = _mm512_set1_ps(scal_67);


											vec_213 = _mm512_fmadd_ps(vec_214, vec_192, mem_vec_1978);
											mem_vec_1978 = vec_213;



											vec_215 = _mm512_fmadd_ps(vec_214, vec_194, mem_vec_1979);
											mem_vec_1979 = vec_215;
											scal_68 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h + 2) + c];
											vec_217 = _mm512_set1_ps(scal_68);


											vec_216 = _mm512_fmadd_ps(vec_217, vec_192, mem_vec_1980);
											mem_vec_1980 = vec_216;



											vec_218 = _mm512_fmadd_ps(vec_217, vec_194, mem_vec_1981);
											mem_vec_1981 = vec_218;
											scal_69 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h + 2) + c];
											vec_220 = _mm512_set1_ps(scal_69);


											vec_219 = _mm512_fmadd_ps(vec_220, vec_192, mem_vec_1982);
											mem_vec_1982 = vec_219;



											vec_221 = _mm512_fmadd_ps(vec_220, vec_194, mem_vec_1983);
											mem_vec_1983 = vec_221;
											scal_70 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 10 + h + 2) + c];
											vec_223 = _mm512_set1_ps(scal_70);


											vec_222 = _mm512_fmadd_ps(vec_223, vec_192, mem_vec_1984);
											mem_vec_1984 = vec_222;



											vec_224 = _mm512_fmadd_ps(vec_223, vec_194, mem_vec_1985);
											mem_vec_1985 = vec_224;
											scal_71 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 11 + h + 2) + c];
											vec_226 = _mm512_set1_ps(scal_71);


											vec_225 = _mm512_fmadd_ps(vec_226, vec_192, mem_vec_1986);
											mem_vec_1986 = vec_225;



											vec_227 = _mm512_fmadd_ps(vec_226, vec_194, mem_vec_1987);
											mem_vec_1987 = vec_227;
											scal_72 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_229 = _mm512_set1_ps(scal_72);
											vec_230 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_228 = _mm512_fmadd_ps(vec_229, vec_230, mem_vec_1964);
											mem_vec_1964 = vec_228;

											vec_232 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_231 = _mm512_fmadd_ps(vec_229, vec_232, mem_vec_1965);
											mem_vec_1965 = vec_231;
											scal_73 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_234 = _mm512_set1_ps(scal_73);


											vec_233 = _mm512_fmadd_ps(vec_234, vec_230, mem_vec_1966);
											mem_vec_1966 = vec_233;



											vec_235 = _mm512_fmadd_ps(vec_234, vec_232, mem_vec_1967);
											mem_vec_1967 = vec_235;
											scal_74 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_237 = _mm512_set1_ps(scal_74);


											vec_236 = _mm512_fmadd_ps(vec_237, vec_230, mem_vec_1968);
											mem_vec_1968 = vec_236;



											vec_238 = _mm512_fmadd_ps(vec_237, vec_232, mem_vec_1969);
											mem_vec_1969 = vec_238;
											scal_75 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_240 = _mm512_set1_ps(scal_75);


											vec_239 = _mm512_fmadd_ps(vec_240, vec_230, mem_vec_1970);
											mem_vec_1970 = vec_239;



											vec_241 = _mm512_fmadd_ps(vec_240, vec_232, mem_vec_1971);
											mem_vec_1971 = vec_241;
											scal_76 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_243 = _mm512_set1_ps(scal_76);


											vec_242 = _mm512_fmadd_ps(vec_243, vec_230, mem_vec_1972);
											mem_vec_1972 = vec_242;



											vec_244 = _mm512_fmadd_ps(vec_243, vec_232, mem_vec_1973);
											mem_vec_1973 = vec_244;
											scal_77 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_246 = _mm512_set1_ps(scal_77);


											vec_245 = _mm512_fmadd_ps(vec_246, vec_230, mem_vec_1974);
											mem_vec_1974 = vec_245;



											vec_247 = _mm512_fmadd_ps(vec_246, vec_232, mem_vec_1975);
											mem_vec_1975 = vec_247;
											scal_78 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_249 = _mm512_set1_ps(scal_78);


											vec_248 = _mm512_fmadd_ps(vec_249, vec_230, mem_vec_1976);
											mem_vec_1976 = vec_248;



											vec_250 = _mm512_fmadd_ps(vec_249, vec_232, mem_vec_1977);
											mem_vec_1977 = vec_250;
											scal_79 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_252 = _mm512_set1_ps(scal_79);


											vec_251 = _mm512_fmadd_ps(vec_252, vec_230, mem_vec_1978);
											mem_vec_1978 = vec_251;



											vec_253 = _mm512_fmadd_ps(vec_252, vec_232, mem_vec_1979);
											mem_vec_1979 = vec_253;
											scal_80 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
											vec_255 = _mm512_set1_ps(scal_80);


											vec_254 = _mm512_fmadd_ps(vec_255, vec_230, mem_vec_1980);
											mem_vec_1980 = vec_254;



											vec_256 = _mm512_fmadd_ps(vec_255, vec_232, mem_vec_1981);
											mem_vec_1981 = vec_256;
											scal_81 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
											vec_258 = _mm512_set1_ps(scal_81);


											vec_257 = _mm512_fmadd_ps(vec_258, vec_230, mem_vec_1982);
											mem_vec_1982 = vec_257;



											vec_259 = _mm512_fmadd_ps(vec_258, vec_232, mem_vec_1983);
											mem_vec_1983 = vec_259;
											scal_82 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h) + c];
											vec_261 = _mm512_set1_ps(scal_82);


											vec_260 = _mm512_fmadd_ps(vec_261, vec_230, mem_vec_1984);
											mem_vec_1984 = vec_260;



											vec_262 = _mm512_fmadd_ps(vec_261, vec_232, mem_vec_1985);
											mem_vec_1985 = vec_262;
											scal_83 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h) + c];
											vec_264 = _mm512_set1_ps(scal_83);


											vec_263 = _mm512_fmadd_ps(vec_264, vec_230, mem_vec_1986);
											mem_vec_1986 = vec_263;



											vec_265 = _mm512_fmadd_ps(vec_264, vec_232, mem_vec_1987);
											mem_vec_1987 = vec_265;
											...
											vec_266 = _mm512_fmadd_ps(vec_267, vec_268, mem_vec_1964);
											mem_vec_1964 = vec_266;

											vec_270 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 1) + F * c + f + 16]);

											vec_269 = _mm512_fmadd_ps(vec_267, vec_270, mem_vec_1965);
											mem_vec_1965 = vec_269;
											scal_85 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 1) + c];
											vec_272 = _mm512_set1_ps(scal_85);


											vec_271 = _mm512_fmadd_ps(vec_272, vec_268, mem_vec_1966);
											mem_vec_1966 = vec_271;



											vec_273 = _mm512_fmadd_ps(vec_272, vec_270, mem_vec_1967);
											mem_vec_1967 = vec_273;
											scal_86 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 1) + c];
											vec_275 = _mm512_set1_ps(scal_86);


											vec_274 = _mm512_fmadd_ps(vec_275, vec_268, mem_vec_1968);
											mem_vec_1968 = vec_274;



											vec_276 = _mm512_fmadd_ps(vec_275, vec_270, mem_vec_1969);
											mem_vec_1969 = vec_276;
											scal_87 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 1) + c];
											vec_278 = _mm512_set1_ps(scal_87);


											vec_277 = _mm512_fmadd_ps(vec_278, vec_268, mem_vec_1970);
											mem_vec_1970 = vec_277;



											vec_279 = _mm512_fmadd_ps(vec_278, vec_270, mem_vec_1971);
											mem_vec_1971 = vec_279;
											scal_88 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 1) + c];
											vec_281 = _mm512_set1_ps(scal_88);


											vec_280 = _mm512_fmadd_ps(vec_281, vec_268, mem_vec_1972);
											mem_vec_1972 = vec_280;



											vec_282 = _mm512_fmadd_ps(vec_281, vec_270, mem_vec_1973);
											mem_vec_1973 = vec_282;
											scal_89 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 1) + c];
											vec_284 = _mm512_set1_ps(scal_89);


											vec_283 = _mm512_fmadd_ps(vec_284, vec_268, mem_vec_1974);
											mem_vec_1974 = vec_283;



											vec_285 = _mm512_fmadd_ps(vec_284, vec_270, mem_vec_1975);
											mem_vec_1975 = vec_285;
											scal_90 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 1) + c];
											vec_287 = _mm512_set1_ps(scal_90);


											vec_286 = _mm512_fmadd_ps(vec_287, vec_268, mem_vec_1976);
											mem_vec_1976 = vec_286;



											vec_288 = _mm512_fmadd_ps(vec_287, vec_270, mem_vec_1977);
											mem_vec_1977 = vec_288;
											scal_91 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 1) + c];
											vec_290 = _mm512_set1_ps(scal_91);


											vec_289 = _mm512_fmadd_ps(vec_290, vec_268, mem_vec_1978);
											mem_vec_1978 = vec_289;



											vec_291 = _mm512_fmadd_ps(vec_290, vec_270, mem_vec_1979);
											mem_vec_1979 = vec_291;
											scal_92 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 1) + c];
											vec_293 = _mm512_set1_ps(scal_92);


											vec_292 = _mm512_fmadd_ps(vec_293, vec_268, mem_vec_1980);
											mem_vec_1980 = vec_292;



											vec_294 = _mm512_fmadd_ps(vec_293, vec_270, mem_vec_1981);
											mem_vec_1981 = vec_294;
											scal_93 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 1) + c];
											vec_296 = _mm512_set1_ps(scal_93);


											vec_295 = _mm512_fmadd_ps(vec_296, vec_268, mem_vec_1982);
											mem_vec_1982 = vec_295;



											vec_297 = _mm512_fmadd_ps(vec_296, vec_270, mem_vec_1983);
											mem_vec_1983 = vec_297;
											scal_94 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 1) + c];
											vec_299 = _mm512_set1_ps(scal_94);


											vec_298 = _mm512_fmadd_ps(vec_299, vec_268, mem_vec_1984);
											mem_vec_1984 = vec_298;



											vec_300 = _mm512_fmadd_ps(vec_299, vec_270, mem_vec_1985);
											mem_vec_1985 = vec_300;
											scal_95 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h + 1) + c];
											vec_302 = _mm512_set1_ps(scal_95);


											vec_301 = _mm512_fmadd_ps(vec_302, vec_268, mem_vec_1986);
											mem_vec_1986 = vec_301;



											vec_303 = _mm512_fmadd_ps(vec_302, vec_270, mem_vec_1987);
											mem_vec_1987 = vec_303;
											...
											vec_304 = _mm512_fmadd_ps(vec_305, vec_306, mem_vec_1964);
											mem_vec_1964 = vec_304;

											vec_308 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * (h + 2) + F * c + f + 16]);

											vec_307 = _mm512_fmadd_ps(vec_305, vec_308, mem_vec_1965);
											mem_vec_1965 = vec_307;
											scal_97 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h + 2) + c];
											vec_310 = _mm512_set1_ps(scal_97);


											vec_309 = _mm512_fmadd_ps(vec_310, vec_306, mem_vec_1966);
											mem_vec_1966 = vec_309;



											vec_311 = _mm512_fmadd_ps(vec_310, vec_308, mem_vec_1967);
											mem_vec_1967 = vec_311;
											scal_98 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h + 2) + c];
											vec_313 = _mm512_set1_ps(scal_98);


											vec_312 = _mm512_fmadd_ps(vec_313, vec_306, mem_vec_1968);
											mem_vec_1968 = vec_312;



											vec_314 = _mm512_fmadd_ps(vec_313, vec_308, mem_vec_1969);
											mem_vec_1969 = vec_314;
											scal_99 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h + 2) + c];
											vec_316 = _mm512_set1_ps(scal_99);


											vec_315 = _mm512_fmadd_ps(vec_316, vec_306, mem_vec_1970);
											mem_vec_1970 = vec_315;



											vec_317 = _mm512_fmadd_ps(vec_316, vec_308, mem_vec_1971);
											mem_vec_1971 = vec_317;
											scal_100 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h + 2) + c];
											vec_319 = _mm512_set1_ps(scal_100);


											vec_318 = _mm512_fmadd_ps(vec_319, vec_306, mem_vec_1972);
											mem_vec_1972 = vec_318;



											vec_320 = _mm512_fmadd_ps(vec_319, vec_308, mem_vec_1973);
											mem_vec_1973 = vec_320;
											scal_101 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h + 2) + c];
											vec_322 = _mm512_set1_ps(scal_101);


											vec_321 = _mm512_fmadd_ps(vec_322, vec_306, mem_vec_1974);
											mem_vec_1974 = vec_321;



											vec_323 = _mm512_fmadd_ps(vec_322, vec_308, mem_vec_1975);
											mem_vec_1975 = vec_323;
											scal_102 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h + 2) + c];
											vec_325 = _mm512_set1_ps(scal_102);


											vec_324 = _mm512_fmadd_ps(vec_325, vec_306, mem_vec_1976);
											mem_vec_1976 = vec_324;



											vec_326 = _mm512_fmadd_ps(vec_325, vec_308, mem_vec_1977);
											mem_vec_1977 = vec_326;
											scal_103 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h + 2) + c];
											vec_328 = _mm512_set1_ps(scal_103);


											vec_327 = _mm512_fmadd_ps(vec_328, vec_306, mem_vec_1978);
											mem_vec_1978 = vec_327;



											vec_329 = _mm512_fmadd_ps(vec_328, vec_308, mem_vec_1979);
											mem_vec_1979 = vec_329;
											scal_104 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h + 2) + c];
											vec_331 = _mm512_set1_ps(scal_104);


											vec_330 = _mm512_fmadd_ps(vec_331, vec_306, mem_vec_1980);
											mem_vec_1980 = vec_330;



											vec_332 = _mm512_fmadd_ps(vec_331, vec_308, mem_vec_1981);
											mem_vec_1981 = vec_332;
											scal_105 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h + 2) + c];
											vec_334 = _mm512_set1_ps(scal_105);


											vec_333 = _mm512_fmadd_ps(vec_334, vec_306, mem_vec_1982);
											mem_vec_1982 = vec_333;



											vec_335 = _mm512_fmadd_ps(vec_334, vec_308, mem_vec_1983);
											mem_vec_1983 = vec_335;
											scal_106 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 10 + h + 2) + c];
											vec_337 = _mm512_set1_ps(scal_106);


											vec_336 = _mm512_fmadd_ps(vec_337, vec_306, mem_vec_1984);
											mem_vec_1984 = vec_336;



											vec_338 = _mm512_fmadd_ps(vec_337, vec_308, mem_vec_1985);
											mem_vec_1985 = vec_338;
											scal_107 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 11 + h + 2) + c];
											vec_340 = _mm512_set1_ps(scal_107);


											vec_339 = _mm512_fmadd_ps(vec_340, vec_306, mem_vec_1986);
											mem_vec_1986 = vec_339;



											vec_341 = _mm512_fmadd_ps(vec_340, vec_308, mem_vec_1987);
											mem_vec_1987 = vec_341;
										}
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_1984);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_1985);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1986);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_1987);
							}
						}
					}
				}
