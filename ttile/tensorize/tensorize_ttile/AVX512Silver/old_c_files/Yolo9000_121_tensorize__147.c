...
c360_p_0 = 0;
							for (h = h221, hp_0 = 0;h < h221 + 3;h += 1, hp_0 += 1){
								...
								for (x = x360, xp_1 = x360_p_0, xp_0 = 0;x < x360 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4190 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
											mem_vec_4191 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_4190);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_4191);
								}
							}
}
