					...
					for (w = w65, wp_0 = 0;
						...
						for (x = x148, xp_2 = x148_p_1, xp_1 = x148_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_886 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_887 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_886);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_887);
						}
					}
				}
			}
