...
for (y671 = y672, y671_p_0 = 0;
	...
	for (x844 = x845, x844_p_0 = 0;
		...
		for (y670 = y671, y670_p_1 = y671_p_0, y670_p_0 = 0;
			y670 < y671 + 56;
			y670 += 28, y670_p_1 += 28, y670_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (56 / 4)
			for (x843 = x844, x843_p_1 = x844_p_0, x843_p_0 = 0;
				x843 < x844 + 56;
				x843 += 4, x843_p_1 += 4, x843_p_0 += 4){
				...
				for (f = f326, fp_0 = 0;
					...
					for (y = y670, yp_2 = y670_p_1, yp_1 = y670_p_0, yp_0 = 0;
						...
						// T (x, 2) (4 / 2)
						for (x842 = x843, x842_p_2 = x843_p_1, x842_p_1 = x843_p_0, x842_p_0 = 0;
							x842 < x843 + 4;
							x842 += 2, x842_p_2 += 2, x842_p_1 += 2, x842_p_0 += 2){
							...
							for (c516 = c517, c516_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x842, xp_3 = x842_p_2, xp_2 = x842_p_1, xp_1 = x842_p_0, xp_0 = 0;
									x < x842 + 2;
