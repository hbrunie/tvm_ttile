...
[V f; U (2, f); U (7, y); T (32, c); Hoist_vars [c]; T (3, h); T (28, x);
  T (3, w); T (8, c); T (1, x); T (2, y); T (8, f); T (1, x); T (2, y)]
*/
IND_TYPE c, cp_0, c33_p_0, cp_1, c33, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x38_p_0, x39_p_0, xp_1, x38_p_1, xp_2, x38, x39, y, yp_0, y33_p_0, yp_1, y33;
