...
[V f; U (1, f); U (14, y); U (3, h); U (3, w); T (128, c); Hoist_vars [c];
  T (14, x); T (1, c); T (2, f); T (1, y); T (8, f)]
*/
			...
			for (c240 = c241, c240_p_0 = 0;
				...
				for (x = x160, xp_0 = 0;
					...
					x += 1, xp_0 += 1){
							...
							mem_vec_1717 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
							mem_vec_1718 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
							mem_vec_1719 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
							mem_vec_1720 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
							mem_vec_1721 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
							...
							for (c = c240, cp_1 = c240_p_0, cp_0 = 0;
								...
								vec_116 = _mm512_fmadd_ps(vec_117, vec_118, mem_vec_1708);
								mem_vec_1708 = vec_116;
								scal_57 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h + 1) + c];
								vec_120 = _mm512_set1_ps(scal_57);


								vec_119 = _mm512_fmadd_ps(vec_120, vec_118, mem_vec_1709);
								mem_vec_1709 = vec_119;
								scal_58 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h + 1) + c];
								vec_122 = _mm512_set1_ps(scal_58);


								vec_121 = _mm512_fmadd_ps(vec_122, vec_118, mem_vec_1710);
								mem_vec_1710 = vec_121;
								scal_59 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h + 1) + c];
								vec_124 = _mm512_set1_ps(scal_59);


								vec_123 = _mm512_fmadd_ps(vec_124, vec_118, mem_vec_1711);
								mem_vec_1711 = vec_123;
								scal_60 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h + 1) + c];
								vec_126 = _mm512_set1_ps(scal_60);


								vec_125 = _mm512_fmadd_ps(vec_126, vec_118, mem_vec_1712);
								mem_vec_1712 = vec_125;
								scal_61 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h + 1) + c];
								vec_128 = _mm512_set1_ps(scal_61);


								vec_127 = _mm512_fmadd_ps(vec_128, vec_118, mem_vec_1713);
								mem_vec_1713 = vec_127;
								scal_62 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h + 1) + c];
								vec_130 = _mm512_set1_ps(scal_62);


								vec_129 = _mm512_fmadd_ps(vec_130, vec_118, mem_vec_1714);
								mem_vec_1714 = vec_129;
								scal_63 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h + 1) + c];
								vec_132 = _mm512_set1_ps(scal_63);


								vec_131 = _mm512_fmadd_ps(vec_132, vec_118, mem_vec_1715);
								mem_vec_1715 = vec_131;
								scal_64 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h + 1) + c];
								vec_134 = _mm512_set1_ps(scal_64);


								vec_133 = _mm512_fmadd_ps(vec_134, vec_118, mem_vec_1716);
								mem_vec_1716 = vec_133;
								scal_65 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 9) + h + 1) + c];
								vec_136 = _mm512_set1_ps(scal_65);


								vec_135 = _mm512_fmadd_ps(vec_136, vec_118, mem_vec_1717);
								mem_vec_1717 = vec_135;
								scal_66 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 10) + h + 1) + c];
								vec_138 = _mm512_set1_ps(scal_66);


								vec_137 = _mm512_fmadd_ps(vec_138, vec_118, mem_vec_1718);
								mem_vec_1718 = vec_137;
								scal_67 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 11) + h + 1) + c];
								vec_140 = _mm512_set1_ps(scal_67);


								vec_139 = _mm512_fmadd_ps(vec_140, vec_118, mem_vec_1719);
								mem_vec_1719 = vec_139;
								scal_68 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 12) + h + 1) + c];
								vec_142 = _mm512_set1_ps(scal_68);


								vec_141 = _mm512_fmadd_ps(vec_142, vec_118, mem_vec_1720);
								mem_vec_1720 = vec_141;
								scal_69 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 13) + h + 1) + c];
								vec_144 = _mm512_set1_ps(scal_69);


								vec_143 = _mm512_fmadd_ps(vec_144, vec_118, mem_vec_1721);
								mem_vec_1721 = vec_143;
								...
								vec_145 = _mm512_fmadd_ps(vec_146, vec_147, mem_vec_1708);
								mem_vec_1708 = vec_145;
								scal_71 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h + 2) + c];
								vec_149 = _mm512_set1_ps(scal_71);


								vec_148 = _mm512_fmadd_ps(vec_149, vec_147, mem_vec_1709);
								mem_vec_1709 = vec_148;
								scal_72 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h + 2) + c];
								vec_151 = _mm512_set1_ps(scal_72);


								vec_150 = _mm512_fmadd_ps(vec_151, vec_147, mem_vec_1710);
								mem_vec_1710 = vec_150;
								scal_73 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h + 2) + c];
								vec_153 = _mm512_set1_ps(scal_73);


								vec_152 = _mm512_fmadd_ps(vec_153, vec_147, mem_vec_1711);
								mem_vec_1711 = vec_152;
								scal_74 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h + 2) + c];
								vec_155 = _mm512_set1_ps(scal_74);


								vec_154 = _mm512_fmadd_ps(vec_155, vec_147, mem_vec_1712);
								mem_vec_1712 = vec_154;
								scal_75 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h + 2) + c];
								vec_157 = _mm512_set1_ps(scal_75);


								vec_156 = _mm512_fmadd_ps(vec_157, vec_147, mem_vec_1713);
								mem_vec_1713 = vec_156;
								scal_76 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h + 2) + c];
								vec_159 = _mm512_set1_ps(scal_76);


								vec_158 = _mm512_fmadd_ps(vec_159, vec_147, mem_vec_1714);
								mem_vec_1714 = vec_158;
								scal_77 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 7) + h + 2) + c];
								vec_161 = _mm512_set1_ps(scal_77);


								vec_160 = _mm512_fmadd_ps(vec_161, vec_147, mem_vec_1715);
								mem_vec_1715 = vec_160;
								scal_78 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 8) + h + 2) + c];
								vec_163 = _mm512_set1_ps(scal_78);


								vec_162 = _mm512_fmadd_ps(vec_163, vec_147, mem_vec_1716);
								mem_vec_1716 = vec_162;
								scal_79 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 9) + h + 2) + c];
								vec_165 = _mm512_set1_ps(scal_79);


								vec_164 = _mm512_fmadd_ps(vec_165, vec_147, mem_vec_1717);
								mem_vec_1717 = vec_164;
								scal_80 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 10) + h + 2) + c];
								vec_167 = _mm512_set1_ps(scal_80);


								vec_166 = _mm512_fmadd_ps(vec_167, vec_147, mem_vec_1718);
								mem_vec_1718 = vec_166;
								scal_81 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 11) + h + 2) + c];
								vec_169 = _mm512_set1_ps(scal_81);


								vec_168 = _mm512_fmadd_ps(vec_169, vec_147, mem_vec_1719);
								mem_vec_1719 = vec_168;
								scal_82 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 12) + h + 2) + c];
								vec_171 = _mm512_set1_ps(scal_82);


								vec_170 = _mm512_fmadd_ps(vec_171, vec_147, mem_vec_1720);
								mem_vec_1720 = vec_170;
								scal_83 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 13) + h + 2) + c];
								vec_173 = _mm512_set1_ps(scal_83);


								vec_172 = _mm512_fmadd_ps(vec_173, vec_147, mem_vec_1721);
								mem_vec_1721 = vec_172;
								...
								vec_174 = _mm512_fmadd_ps(vec_175, vec_176, mem_vec_1708);
								mem_vec_1708 = vec_174;
								scal_85 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
								vec_178 = _mm512_set1_ps(scal_85);


								vec_177 = _mm512_fmadd_ps(vec_178, vec_176, mem_vec_1709);
								mem_vec_1709 = vec_177;
								scal_86 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
								vec_180 = _mm512_set1_ps(scal_86);


								vec_179 = _mm512_fmadd_ps(vec_180, vec_176, mem_vec_1710);
								mem_vec_1710 = vec_179;
								scal_87 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
								vec_182 = _mm512_set1_ps(scal_87);


								vec_181 = _mm512_fmadd_ps(vec_182, vec_176, mem_vec_1711);
								mem_vec_1711 = vec_181;
								scal_88 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
								vec_184 = _mm512_set1_ps(scal_88);


								vec_183 = _mm512_fmadd_ps(vec_184, vec_176, mem_vec_1712);
								mem_vec_1712 = vec_183;
								scal_89 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
								vec_186 = _mm512_set1_ps(scal_89);


								vec_185 = _mm512_fmadd_ps(vec_186, vec_176, mem_vec_1713);
								mem_vec_1713 = vec_185;
								scal_90 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
								vec_188 = _mm512_set1_ps(scal_90);


								vec_187 = _mm512_fmadd_ps(vec_188, vec_176, mem_vec_1714);
								mem_vec_1714 = vec_187;
								scal_91 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h) + c];
								vec_190 = _mm512_set1_ps(scal_91);


								vec_189 = _mm512_fmadd_ps(vec_190, vec_176, mem_vec_1715);
								mem_vec_1715 = vec_189;
								scal_92 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h) + c];
								vec_192 = _mm512_set1_ps(scal_92);


								vec_191 = _mm512_fmadd_ps(vec_192, vec_176, mem_vec_1716);
								mem_vec_1716 = vec_191;
								scal_93 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 9) + h) + c];
								vec_194 = _mm512_set1_ps(scal_93);


								vec_193 = _mm512_fmadd_ps(vec_194, vec_176, mem_vec_1717);
								mem_vec_1717 = vec_193;
								scal_94 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 10) + h) + c];
								vec_196 = _mm512_set1_ps(scal_94);


								vec_195 = _mm512_fmadd_ps(vec_196, vec_176, mem_vec_1718);
								mem_vec_1718 = vec_195;
								scal_95 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 11) + h) + c];
								vec_198 = _mm512_set1_ps(scal_95);


								vec_197 = _mm512_fmadd_ps(vec_198, vec_176, mem_vec_1719);
								mem_vec_1719 = vec_197;
								scal_96 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 12) + h) + c];
								vec_200 = _mm512_set1_ps(scal_96);


								vec_199 = _mm512_fmadd_ps(vec_200, vec_176, mem_vec_1720);
								mem_vec_1720 = vec_199;
								scal_97 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 13) + h) + c];
								vec_202 = _mm512_set1_ps(scal_97);


								vec_201 = _mm512_fmadd_ps(vec_202, vec_176, mem_vec_1721);
								mem_vec_1721 = vec_201;
								...
								vec_232 = _mm512_fmadd_ps(vec_233, vec_234, mem_vec_1708);
								mem_vec_1708 = vec_232;
								scal_113 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h + 2) + c];
								vec_236 = _mm512_set1_ps(scal_113);


								vec_235 = _mm512_fmadd_ps(vec_236, vec_234, mem_vec_1709);
								mem_vec_1709 = vec_235;
								scal_114 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h + 2) + c];
								vec_238 = _mm512_set1_ps(scal_114);


								vec_237 = _mm512_fmadd_ps(vec_238, vec_234, mem_vec_1710);
								mem_vec_1710 = vec_237;
								scal_115 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h + 2) + c];
								vec_240 = _mm512_set1_ps(scal_115);


								vec_239 = _mm512_fmadd_ps(vec_240, vec_234, mem_vec_1711);
								mem_vec_1711 = vec_239;
								scal_116 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h + 2) + c];
								vec_242 = _mm512_set1_ps(scal_116);


								vec_241 = _mm512_fmadd_ps(vec_242, vec_234, mem_vec_1712);
								mem_vec_1712 = vec_241;
								scal_117 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h + 2) + c];
								vec_244 = _mm512_set1_ps(scal_117);


								vec_243 = _mm512_fmadd_ps(vec_244, vec_234, mem_vec_1713);
								mem_vec_1713 = vec_243;
								scal_118 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h + 2) + c];
								vec_246 = _mm512_set1_ps(scal_118);


								vec_245 = _mm512_fmadd_ps(vec_246, vec_234, mem_vec_1714);
								mem_vec_1714 = vec_245;
								scal_119 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 7) + h + 2) + c];
								vec_248 = _mm512_set1_ps(scal_119);


								vec_247 = _mm512_fmadd_ps(vec_248, vec_234, mem_vec_1715);
								mem_vec_1715 = vec_247;
								scal_120 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 8) + h + 2) + c];
								vec_250 = _mm512_set1_ps(scal_120);


								vec_249 = _mm512_fmadd_ps(vec_250, vec_234, mem_vec_1716);
								mem_vec_1716 = vec_249;
								scal_121 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 9) + h + 2) + c];
								vec_252 = _mm512_set1_ps(scal_121);


								vec_251 = _mm512_fmadd_ps(vec_252, vec_234, mem_vec_1717);
								mem_vec_1717 = vec_251;
								scal_122 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 10) + h + 2) + c];
								vec_254 = _mm512_set1_ps(scal_122);


								vec_253 = _mm512_fmadd_ps(vec_254, vec_234, mem_vec_1718);
								mem_vec_1718 = vec_253;
								scal_123 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 11) + h + 2) + c];
								vec_256 = _mm512_set1_ps(scal_123);


								vec_255 = _mm512_fmadd_ps(vec_256, vec_234, mem_vec_1719);
								mem_vec_1719 = vec_255;
								scal_124 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 12) + h + 2) + c];
								vec_258 = _mm512_set1_ps(scal_124);


								vec_257 = _mm512_fmadd_ps(vec_258, vec_234, mem_vec_1720);
								mem_vec_1720 = vec_257;
								scal_125 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 13) + h + 2) + c];
								vec_260 = _mm512_set1_ps(scal_125);


								vec_259 = _mm512_fmadd_ps(vec_260, vec_234, mem_vec_1721);
								mem_vec_1721 = vec_259;
							}
						...
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_1717);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_1718);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1719);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_1720);
						_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_1721);
				}
			}
		}
	}
