						...
						for (w = w227, wp_0 = 0;w < w227 + 3;w += 1, wp_0 += 1){
							...
							for (x = x618, xp_2 = x618_p_1, xp_1 = x618_p_0, xp_0 = 0;x < x618 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								for (h = h222, hp_0 = 0;h < h222 + 3;h += 1, hp_0 += 1){
											...
											mem_vec_6772 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
											mem_vec_6773 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_6772);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_6773);
								}
							}
						}
}
