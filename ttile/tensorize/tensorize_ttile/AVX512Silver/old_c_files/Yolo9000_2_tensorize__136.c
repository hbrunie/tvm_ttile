...
[V f; U (4, f); U (2, y); U (3, w); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (4, c); T (1, x); T (34, y); T (1, y); T (272, x); T (4, y)]
*/
IND_TYPE c, cp_0, c366_p_0, cp_1, c366, h, hp_0, x, xp_0, x488_p_0, x489_p_0, xp_1, x488_p_1, xp_2, x488, x489, y, yp_0, y482_p_0, y483_p_0, yp_1, y482_p_1, yp_2, y482, y483;
IND_TYPE y484 = 0;
IND_TYPE x490 = 0;
IND_TYPE h184 = 0;
IND_TYPE w = 0;
