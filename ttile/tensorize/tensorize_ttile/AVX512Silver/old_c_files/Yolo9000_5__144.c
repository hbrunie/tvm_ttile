	...
	for (x249 = x250, x249_p_0 = 0;
		...
		for (f = f144, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				...
				for (y = y249 + 12, yp_1 = y249_p_0, yp_0 = 0;
					y < y249 + 12 + 56;
					...
					for (x = x249, xp_1 = x249_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_3494 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								mem_vec_3495 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c188, cp_0 = 0;
									c < c188 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3494);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_3495);
					}
				}
		}
	}
