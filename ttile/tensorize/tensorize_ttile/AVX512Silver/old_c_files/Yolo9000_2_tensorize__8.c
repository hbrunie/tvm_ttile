...
[V f; U (4, f); U (2, y); U (3, h); T (8, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (4, c); T (2, x); T (1, y); T (17, y); T (136, x); T (8, y)]
*/
IND_TYPE c, cp_0, c105_p_0, cp_1, c105, w, wp_0, x, xp_0, x140_p_0, x141_p_0, xp_1, x140_p_1, xp_2, x140, x141, y, yp_0, y140_p_0, y141_p_0, yp_1, y140_p_1, yp_2, y140, y141;
IND_TYPE y142 = 0;
IND_TYPE x142 = 0;
IND_TYPE h = 0;
IND_TYPE w70 = 0;
...
__m512 mem_vec_280 ,mem_vec_281 ,mem_vec_282 ,mem_vec_283 ,mem_vec_284 ,mem_vec_285 ,mem_vec_286 ,mem_vec_287 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
						...
						for (w = w70, wp_0 = 0;w < w70 + 3;w += 1, wp_0 += 1){
							...
							for (x = x140, xp_2 = x140_p_1, xp_1 = x140_p_0, xp_0 = 0;x < x140 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c105, cp_1 = c105_p_0, cp_0 = 0;c < c105 + 8;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_280);
											mem_vec_280 = vec_14;
											vec_18 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
											vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_281);
											mem_vec_281 = vec_17;
											vec_20 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 32]);
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_282);
											mem_vec_282 = vec_19;
											vec_22 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_283);
											mem_vec_283 = vec_21;
											scal_3 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
											vec_24 = _mm512_set1_ps(scal_3);
											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_284);
											mem_vec_284 = vec_23;
											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_285);
											mem_vec_285 = vec_25;
											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_286);
											mem_vec_286 = vec_26;
											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_287);
											mem_vec_287 = vec_27;
											scal_4 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
											vec_29 = _mm512_set1_ps(scal_4);
											vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_280);
											mem_vec_280 = vec_28;
											vec_32 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
											vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_281);
											mem_vec_281 = vec_31;
											vec_34 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 32]);
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_282);
											mem_vec_282 = vec_33;
											vec_36 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_283);
											mem_vec_283 = vec_35;
											scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
											vec_38 = _mm512_set1_ps(scal_5);
											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_284);
											mem_vec_284 = vec_37;
											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_285);
											mem_vec_285 = vec_39;
											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_286);
											mem_vec_286 = vec_40;
											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_287);
											mem_vec_287 = vec_41;
										}
