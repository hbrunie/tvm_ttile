...
[V f; U (4, f); U (2, y); U (3, w); T (8, c); Hoist_vars [c]; T (2, x);
  T (3, h); T (4, c); T (17, x); T (136, y); T (1, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c168_p_0, cp_1, c168, h, hp_0, x, xp_0, x224_p_0, x225_p_0, xp_1, x224_p_1, xp_2, x224, x225, y, yp_0, y224_p_0, y225_p_0, yp_1, y224_p_1, yp_2, y224, y225;
IND_TYPE y226 = 0;
IND_TYPE x226 = 0;
IND_TYPE h70 = 0;
IND_TYPE w = 0;
