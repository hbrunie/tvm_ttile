...
*/
IND_TYPE c, cp_0, c576_p_0, cp_1, c576, f, fp_0, f576_p_0, fp_1, f576, w, wp_0, x, xp_0, x465_p_0, xp_1, x465, y, yp_0;
IND_TYPE y384 = 0;
IND_TYPE x466 = 0;
IND_TYPE h = 0;
IND_TYPE w295 = 0;
...
c576_p_0 = 0;
					for (w = w295, wp_0 = 0;w < w295 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 14) (14 / 1)
						for (x = x465, xp_1 = x465_p_0, xp_0 = 0;x < x465 + 14;x += 1, xp_1 += 1, xp_0 += 1){
