	...
	x475 += 28, x475_p_0 += 28){
		for (y = y360, yp_0 = 0;
			...
			for (x474 = x475, x474_p_1 = x475_p_0, x474_p_0 = 0;
				x474 < x475 + 28;
				x474 += 28, x474_p_1 += 28, x474_p_0 += 28){
				// y = ph_y, x = 28, h = 3, w = 3, c = 64, f = 64
				// T (f, 2) (64 / 32)
				for (f = f257, fp_0 = 0;
					f < f257 + 64;
							...
							for (x = x474, xp_2 = x474_p_1, xp_1 = x474_p_0, xp_0 = 0;
								...
								for (h = h205, hp_0 = 0;
									...
									h += 1, hp_0 += 1){
											...
											mem_vec_3175 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
											mem_vec_3176 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_3175);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_3176);
								}
							}
						}
					}
