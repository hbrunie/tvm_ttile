...
for (y413 = y414, y413_p_0 = 0;
	...
	for (x517 = x518, x517_p_0 = 0;
		...
		// T (y, 2) (56 / 28)
		for (y412 = y413, y412_p_1 = y413_p_0, y412_p_0 = 0;
			y412 < y413 + 56;
			y412 += 28, y412_p_1 += 28, y412_p_0 += 28){
			...
			for (x516 = x517, x516_p_1 = x517_p_0, x516_p_0 = 0;
				...
				for (f = f206, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y412, yp_2 = y412_p_1, yp_1 = y412_p_0, yp_0 = 0;
						y < y412 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (2 / 2)
						for (x515 = x516, x515_p_2 = x516_p_1, x515_p_1 = x516_p_0, x515_p_0 = 0;
							x515 < x516 + 2;
							x515 += 2, x515_p_2 += 2, x515_p_1 += 2, x515_p_0 += 2){
							// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c309 = c310, c309_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x515, xp_3 = x515_p_2, xp_2 = x515_p_1, xp_1 = x515_p_0, xp_0 = 0;
									x < x515 + 2;
