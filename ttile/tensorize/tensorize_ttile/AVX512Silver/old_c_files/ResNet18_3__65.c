...
for (y727 = y728, y727_p_0 = 0;
	...
	for (x914 = x915, x914_p_0 = 0;
		...
		for (y726 = y727, y726_p_1 = y727_p_0, y726_p_0 = 0;
			y726 < y727 + 28;
			y726 += 28, y726_p_1 += 28, y726_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 28) (56 / 2)
			for (x913 = x914, x913_p_1 = x914_p_0, x913_p_0 = 0;
				x913 < x914 + 56;
				x913 += 2, x913_p_1 += 2, x913_p_0 += 2){
				...
				for (f = f354, fp_0 = 0;
					...
					for (y = y726, yp_2 = y726_p_1, yp_1 = y726_p_0, yp_0 = 0;
						...
						// T (x, 1) (2 / 2)
						for (x912 = x913, x912_p_2 = x913_p_1, x912_p_1 = x913_p_0, x912_p_0 = 0;
							x912 < x913 + 2;
							x912 += 2, x912_p_2 += 2, x912_p_1 += 2, x912_p_0 += 2){
							// y = 7, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c558 = c559, c558_p_0 = 0;
								...
								// y = 7, x = 2, h = 1, w = 1, c = 64, f = 32
								// T (x, 2) (2 / 1)
								for (x = x912, xp_3 = x912_p_2, xp_2 = x912_p_1, xp_1 = x912_p_0, xp_0 = 0;
									x < x912 + 2;
