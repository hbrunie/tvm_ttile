					...
					for (c276 = c277, c276_p_1 = c277_p_0, c276_p_0 = 0;
						...
						for (x = x138, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_2898 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
									mem_vec_2899 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 64
									// T (c, 16) (16 / 1)
									for (c = c276, cp_2 = c276_p_1, cp_1 = c276_p_0, cp_0 = 0;
										c < c276 + 16;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_2898);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_2899);
						}
					}
				}
			}
