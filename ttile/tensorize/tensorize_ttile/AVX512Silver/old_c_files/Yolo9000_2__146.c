...
[V f; U (4, f); U (2, y); U (3, w); T (16, c); Hoist_vars [c]; T (17, x);
  T (3, h); T (2, c); T (2, x); T (1, y); T (136, y); T (8, x); T (1, y)]
*/
IND_TYPE c, cp_0, c156_p_0, cp_1, c156, h, hp_0, x, xp_0, x208_p_0, x209_p_0, xp_1, x208_p_1, xp_2, x208, x209, y, yp_0, y208_p_0, y209_p_0, yp_1, y208_p_1, yp_2, y208, y209;
...
// T (y, 1) (272 / 272)
for (y209 = y210, y209_p_0 = 0;
	y209 < y210 + 272;
	y209 += 272, y209_p_0 += 272){
	// y = 272, x = 272, h = 3, w = 3, c = 32, f = 64
	// T (x, 8) (272 / 34)
	for (x209 = x210, x209_p_0 = 0;
		...
		// T (y, 136) (272 / 2)
		for (y208 = y209, y208_p_1 = y209_p_0, y208_p_0 = 0;
			y208 < y209 + 272;
			y208 += 2, y208_p_1 += 2, y208_p_0 += 2){
			// y = 2, x = 34, h = 3, w = 3, c = 32, f = 64
			// T (y, 1) (2 / 2)
			for (y = y208, yp_2 = y208_p_1, yp_1 = y208_p_0, yp_0 = 0;
				y < y208 + 2;
				...
				for (x208 = x209, x208_p_1 = x209_p_0, x208_p_0 = 0;
					x208 < x209 + 34;
					x208 += 17, x208_p_1 += 17, x208_p_0 += 17){
							...
							for (x = x208, xp_2 = x208_p_1, xp_1 = x208_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c156, cp_1 = c156_p_0, cp_0 = 0;
											...
											vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_418);
											mem_vec_418 = vec_19;

											vec_22 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

											vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_419);
											mem_vec_419 = vec_21;
											scal_3 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_24 = _mm512_set1_ps(scal_3);


											vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_420);
											mem_vec_420 = vec_23;



											vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_421);
											mem_vec_421 = vec_25;



											vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_422);
											mem_vec_422 = vec_26;



											vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_423);
											mem_vec_423 = vec_27;
											...
											vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_418);
											mem_vec_418 = vec_33;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

											vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_419);
											mem_vec_419 = vec_35;
											scal_5 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_5);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_420);
											mem_vec_420 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_421);
											mem_vec_421 = vec_39;



											vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_422);
											mem_vec_422 = vec_40;



											vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_423);
											mem_vec_423 = vec_41;
										}
