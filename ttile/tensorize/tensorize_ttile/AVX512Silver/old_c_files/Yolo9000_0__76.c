...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (1, x); T (2, f); T (1, x); T (68, y); T (1, y); T (544, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x80_p_0, x81_p_0, xp_1, x80_p_1, xp_2, x80, x81, y, yp_0, y74_p_0, y75_p_0, yp_1, y74_p_1, yp_2, y74, y75;
...
for (y75 = y76, y75_p_0 = 0;
	...
	for (x81 = x82, x81_p_0 = 0;
		...
		// T (y, 1) (272 / 272)
		for (y74 = y75, y74_p_1 = y75_p_0, y74_p_0 = 0;
			y74 < y75 + 272;
			y74 += 272, y74_p_1 += 272, y74_p_0 += 272){
			// y = 272, x = 1, h = 3, w = 3, c = 3, f = 32
			// T (y, 68) (272 / 4)
			for (y = y74, yp_2 = y74_p_1, yp_1 = y74_p_0, yp_0 = 0;
				y < y74 + 272;
					...
					for (f = f34, fp_0 = 0;
						...
						for (x = x80, xp_2 = x80_p_1, xp_1 = x80_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_177 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_178 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_179 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									// y = 4, x = 1, h = 3, w = 3, c = 3, f = 16
									// T (c, 3) (3 / 1)
									for (c = c46, cp_0 = 0;
										c < c46 + 3;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_177);
										mem_vec_177 = vec_3;
