...
y = 0;
yp_2 = 0;
					for (x = x322, xp_0 = 0;x < x322 + 56;x += 1, xp_0 += 1){
								mem_vec_2206 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
								mem_vec_2207 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_2206);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_2207);
