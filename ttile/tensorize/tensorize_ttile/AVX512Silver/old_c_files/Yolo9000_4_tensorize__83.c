...
[V f; U (2, f); U (8, y); U (3, w); T (16, c); Hoist_vars [c]; T (34, x);
  T (3, h); T (4, c); T (4, f); T (4, x); T (17, y); T (1, x)]
*/
IND_TYPE c, cp_0, c447_p_0, cp_1, c447, f, fp_0, h, hp_0, x, xp_0, x574_p_0, x575_p_0, xp_1, x574_p_1, xp_2, x574, x575, y, yp_0;
IND_TYPE y320 = 0;
IND_TYPE x576 = 0;
IND_TYPE h206 = 0;
IND_TYPE w = 0;
...
__m512 mem_vec_6526 ,mem_vec_6527 ,mem_vec_6528 ,mem_vec_6529 ,mem_vec_6530 ,mem_vec_6531 ,mem_vec_6532 ,mem_vec_6533 ,mem_vec_6534 ,mem_vec_6535 ,mem_vec_6536 ,mem_vec_6537 ,mem_vec_6538 ,mem_vec_6539 ,mem_vec_6540 ,mem_vec_6541 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_51 ,vec_52 ,vec_53 ,vec_54 ,vec_55 ,vec_56 ,vec_57 ,vec_58 ,vec_59 ,vec_6 ,vec_60 ,vec_61 ,vec_62 ,vec_63 ,vec_64 ,vec_65 ,vec_66 ,vec_67 ,vec_68 ,vec_69 ,vec_7 ,vec_70 ,vec_71 ,vec_72 ,vec_73 ,vec_74 ,vec_75 ,vec_76 ,vec_77 ,vec_8 ,vec_9;
...
c447_p_0 = 0;
					for (h = h206, hp_0 = 0;h < h206 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 34) (34 / 1)
						for (x = x574, xp_2 = x574_p_1, xp_1 = x574_p_0, xp_0 = 0;x < x574 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									for (c = c447, cp_1 = c447_p_0, cp_0 = 0;c < c447 + 16;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_6526);
										mem_vec_6526 = vec_26;
										vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
										vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_6527);
										mem_vec_6527 = vec_29;
										scal_9 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
										vec_32 = _mm512_set1_ps(scal_9);
										vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_6528);
										mem_vec_6528 = vec_31;
										vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_6529);
										mem_vec_6529 = vec_33;
										scal_10 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
										vec_35 = _mm512_set1_ps(scal_10);
										vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_6530);
										mem_vec_6530 = vec_34;
										vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_6531);
										mem_vec_6531 = vec_36;
										scal_11 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
										vec_38 = _mm512_set1_ps(scal_11);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_6532);
										mem_vec_6532 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_6533);
										mem_vec_6533 = vec_39;
										scal_12 = input[strideA1 * (x + w + 1) + strideA2 * (y + 4 + h) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_6534);
										mem_vec_6534 = vec_40;
										vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_6535);
										mem_vec_6535 = vec_42;
										scal_13 = input[strideA1 * (x + w + 1) + strideA2 * (y + 5 + h) + c];
										vec_44 = _mm512_set1_ps(scal_13);
										vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_6536);
										mem_vec_6536 = vec_43;
										vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_6537);
										mem_vec_6537 = vec_45;
										scal_14 = input[strideA1 * (x + w + 1) + strideA2 * (y + 6 + h) + c];
										vec_47 = _mm512_set1_ps(scal_14);
										vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_6538);
										mem_vec_6538 = vec_46;
										vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_6539);
										mem_vec_6539 = vec_48;
										scal_15 = input[strideA1 * (x + w + 1) + strideA2 * (y + 7 + h) + c];
										vec_50 = _mm512_set1_ps(scal_15);
										vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_6540);
										mem_vec_6540 = vec_49;
										vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_6541);
										mem_vec_6541 = vec_51;
										scal_16 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
										vec_53 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
										vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_6526);
										mem_vec_6526 = vec_52;
										vec_56 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
										vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_6527);
										mem_vec_6527 = vec_55;
										scal_17 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
										vec_58 = _mm512_set1_ps(scal_17);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_6528);
										mem_vec_6528 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_6529);
										mem_vec_6529 = vec_59;
										scal_18 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
										vec_61 = _mm512_set1_ps(scal_18);
										vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_6530);
										mem_vec_6530 = vec_60;
										vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_6531);
										mem_vec_6531 = vec_62;
										scal_19 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
										vec_64 = _mm512_set1_ps(scal_19);
										vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_6532);
										mem_vec_6532 = vec_63;
										vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_6533);
										mem_vec_6533 = vec_65;
										scal_20 = input[strideA1 * (x + w + 2) + strideA2 * (y + 4 + h) + c];
										vec_67 = _mm512_set1_ps(scal_20);
										vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_6534);
										mem_vec_6534 = vec_66;
										vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_6535);
										mem_vec_6535 = vec_68;
										scal_21 = input[strideA1 * (x + w + 2) + strideA2 * (y + 5 + h) + c];
										vec_70 = _mm512_set1_ps(scal_21);
										vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_6536);
										mem_vec_6536 = vec_69;
										vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_6537);
										mem_vec_6537 = vec_71;
										scal_22 = input[strideA1 * (x + w + 2) + strideA2 * (y + 6 + h) + c];
										vec_73 = _mm512_set1_ps(scal_22);
										vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_6538);
										mem_vec_6538 = vec_72;
										vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_6539);
										mem_vec_6539 = vec_74;
										scal_23 = input[strideA1 * (x + w + 2) + strideA2 * (y + 7 + h) + c];
										vec_76 = _mm512_set1_ps(scal_23);
										vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_6540);
										mem_vec_6540 = vec_75;
										vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_6541);
										mem_vec_6541 = vec_77;
									}
