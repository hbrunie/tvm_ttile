...
// T (y, 2) (56 / 28)
for (y190 = y191, y190_p_0 = 0;y190 < y191 + 56;y190 += 28, y190_p_0 += 28){
		for (y = y190, yp_1 = y190_p_0, yp_0 = 0;y < y190 + 4;y += 4, yp_1 += 4, yp_0 += 4){
			// y = ph_y, x = 56, h = 3, w = 3, c = 64, f = 64
			// T (x, 1) (56 / 56)
			for (x284 = x285, x284_p_0 = 0;x284 < x285 + 56;x284 += 56, x284_p_0 += 56){
				// y = ph_y, x = 56, h = 3, w = 3, c = 64, f = 64
				// T (f, 2) (64 / 32)
				for (f = f135, fp_0 = 0;f < f135 + 64;f += 32, fp_0 += 32){
					// y = ph_y, x = 56, h = 3, w = 3, c = 64, f = 32
					// T (c, 4) (64 / 16)
					for (c237 = c238, c237_p_0 = 0;c237 < c238 + 64;c237 += 16, c237_p_0 += 16){
						// y = ph_y, x = 56, h = 3, w = 3, c = 16, f = 32
						// T (h, 3) (3 / 1)
						for (h = h116, hp_0 = 0;h < h116 + 3;h += 1, hp_0 += 1){
							// y = ph_y, x = 56, h = 1, w = 3, c = 16, f = 32
							// T (x, 56) (56 / 1)
							for (x = x284, xp_1 = x284_p_0, xp_0 = 0;x < x284 + 56;x += 1, xp_1 += 1, xp_0 += 1){
		...
		for (y = y190 + 4, yp_1 = y190_p_0, yp_0 = 0;y < y190 + 4 + 24;y += 8, yp_1 += 8, yp_0 += 8){
			// y = ph_y, x = 56, h = 3, w = 3, c = 64, f = 64
			// T (x, 1) (56 / 56)
			for (x284 = x285, x284_p_0 = 0;x284 < x285 + 56;x284 += 56, x284_p_0 += 56){
				// y = ph_y, x = 56, h = 3, w = 3, c = 64, f = 64
