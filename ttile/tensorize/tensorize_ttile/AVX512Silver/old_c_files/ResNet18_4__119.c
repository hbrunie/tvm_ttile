			...
			for (y = y126, yp_0 = 0;
				...
				for (x = x176, xp_0 = 0;
					...
					for (h = h85, hp_0 = 0;
						h < h85 + 3;
						h += 1, hp_0 += 1){
								mem_vec_1573 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
								mem_vec_1574 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
								mem_vec_1575 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_1573);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_1574);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_1575);
