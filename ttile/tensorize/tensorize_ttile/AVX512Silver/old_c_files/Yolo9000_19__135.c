					...
					for (c8 = c9, c8_p_1 = c9_p_0, c8_p_0 = 0;
						...
						for (x = x4, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_82 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 32]);
									mem_vec_83 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 48]);
									mem_vec_84 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_85 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_86 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32]);
									mem_vec_87 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48]);
									mem_vec_88 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_89 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
									mem_vec_90 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32]);
									mem_vec_91 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 32], mem_vec_82);
								_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 48], mem_vec_83);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_84);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_85);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 32], mem_vec_86);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 48], mem_vec_87);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_88);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_89);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 32], mem_vec_90);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 48], mem_vec_91);
						}
					}
				}
				for (y = y6 + 3, yp_1 = y6_p_0, yp_0 = 0;
					y < y6 + 3 + 14;
					y += 7, yp_1 += 7, yp_0 += 7){
					// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 64
					// T (c, 32) (1024 / 32)
					for (c8 = c9, c8_p_1 = c9_p_0, c8_p_0 = 0;
						...
						for (x = x4, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_116 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_117 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
									mem_vec_118 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
									mem_vec_119 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 64
									// T (c, 32) (32 / 1)
									for (c = c8, cp_2 = c8_p_1, cp_1 = c8_p_0, cp_0 = 0;
										c < c8 + 32;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_116);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_117);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_118);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_119);
						}
					}
				}
		}
