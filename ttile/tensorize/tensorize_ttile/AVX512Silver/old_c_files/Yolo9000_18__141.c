...
[V f; U (1, f); ULambda y; U (3, h); U (3, w); T (64, c); Hoist_vars [c];
  ...
  T (8, c); T (8, f)]
*/
IND_TYPE c, cp_0, c740_p_0, c741_p_0, cp_1, c740_p_1, cp_2, c740, c741, f, fp_0, f555_p_0, fp_1, f555, x, xp_0, y, yp_0;
			...
			f += 16, fp_1 += 16, fp_0 += 16){
				for (y = y370, yp_0 = 0;
					...
					for (c740 = c741, c740_p_1 = c741_p_0, c740_p_0 = 0;
						c740 < c741 + 64;
						c740 += 64, c740_p_1 += 64, c740_p_0 += 64){
						// y = ph_y, x = 17, h = 3, w = 3, c = 64, f = 16
						// T (x, 17) (17 / 1)
						for (x = x370, xp_0 = 0;
							x < x370 + 17;
					...
					for (c740 = c741, c740_p_1 = c741_p_0, c740_p_0 = 0;
						...
						for (x = x370, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_3153 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_3154 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_3155 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									...
									for (c = c740, cp_2 = c740_p_1, cp_1 = c740_p_0, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_3153);
										mem_vec_3153 = vec_3;
										scal_2 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h) + c];
										vec_6 = _mm512_set1_ps(scal_2);
										...
										vec_7 = _mm512_fmadd_ps(vec_8, vec_2, mem_vec_3155);
										mem_vec_3155 = vec_7;
