...
// T (y, 4) (544 / 136)
for (y706 = y707, y706_p_0 = 0;
	y706 < y707 + 544;
	y706 += 136, y706_p_0 += 136){
	...
	for (x753 = x754, x753_p_0 = 0;
		...
		// T (y, 2) (136 / 68)
		for (y705 = y706, y705_p_1 = y706_p_0, y705_p_0 = 0;
			y705 < y706 + 136;
			y705 += 68, y705_p_1 += 68, y705_p_0 += 68){
			// y = 68, x = 4, h = 3, w = 3, c = 3, f = 32
			// T (y, 17) (68 / 4)
			for (y = y705, yp_2 = y705_p_1, yp_1 = y705_p_0, yp_0 = 0;
				y < y705 + 68;
