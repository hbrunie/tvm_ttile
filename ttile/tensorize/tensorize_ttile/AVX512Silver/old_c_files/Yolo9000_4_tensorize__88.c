...
// T (y, 17) (136 / 8)
for (y423 = y424, y423_p_0 = 0;y423 < y424 + 136;y423 += 8, y423_p_0 += 8){
		for (y = y423, yp_1 = y423_p_0, yp_0 = 0;y < y423 + 2;y += 2, yp_1 += 2, yp_0 += 2){
			// y = ph_y, x = 136, h = 3, w = 3, c = 64, f = 128
			// T (x, 2) (136 / 68)
			for (x752 = x753, x752_p_0 = 0;x752 < x753 + 136;x752 += 68, x752_p_0 += 68){
				// y = ph_y, x = 68, h = 3, w = 3, c = 64, f = 128
				// T (f, 2) (128 / 64)
				for (f = f394, fp_0 = 0;f < f394 + 128;f += 64, fp_0 += 64){
					// y = ph_y, x = 68, h = 3, w = 3, c = 64, f = 64
					// T (c, 4) (64 / 16)
					for (c591 = c592, c591_p_0 = 0;c591 < c592 + 64;c591 += 16, c591_p_0 += 16){
						// y = ph_y, x = 68, h = 3, w = 3, c = 16, f = 64
						// T (w, 3) (3 / 1)
						for (w = w278, wp_0 = 0;w < w278 + 3;w += 1, wp_0 += 1){
							// y = ph_y, x = 68, h = 3, w = 1, c = 16, f = 64
							// T (x, 68) (68 / 1)
							for (x = x752, xp_1 = x752_p_0, xp_0 = 0;x < x752 + 68;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_7847 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_7848 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
										mem_vec_7849 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
										mem_vec_7850 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
										mem_vec_7851 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_7852 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16]);
										mem_vec_7853 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
										mem_vec_7854 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_7847);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_7848);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_7849);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_7850);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_7851);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16], mem_vec_7852);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_7853);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_7854);
							}
						}
					}
				}
		...
		for (y = y423 + 2, yp_1 = y423_p_0, yp_0 = 0;y < y423 + 2 + 6;y += 3, yp_1 += 3, yp_0 += 3){
			// y = ph_y, x = 136, h = 3, w = 3, c = 64, f = 128
			// T (x, 2) (136 / 68)
			for (x752 = x753, x752_p_0 = 0;x752 < x753 + 136;x752 += 68, x752_p_0 += 68){
				// y = ph_y, x = 68, h = 3, w = 3, c = 64, f = 128
				...
				for (f = f394, fp_0 = 0;f < f394 + 128;f += 64, fp_0 += 64){
					...
					for (c591 = c592, c591_p_0 = 0;c591 < c592 + 64;c591 += 16, c591_p_0 += 16){
						...
						for (w = w278, wp_0 = 0;w < w278 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 68) (68 / 1)
							for (x = x752, xp_1 = x752_p_0, xp_0 = 0;x < x752 + 68;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_7855 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_7856 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
										mem_vec_7857 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
										mem_vec_7858 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
										mem_vec_7859 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_7860 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16]);
										mem_vec_7861 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32]);
										mem_vec_7862 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48]);
										mem_vec_7863 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_7864 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16]);
										mem_vec_7865 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32]);
										mem_vec_7866 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48]);
										// y = ph_y, x = 1, h = 3, w = 1, c = 16, f = 64
										// T (c, 16) (16 / 1)
										for (c = c591, cp_1 = c591_p_0, cp_0 = 0;c < c591 + 16;c += 1, cp_1 += 1, cp_0 += 1){
											scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_7855);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_7856);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_7857);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_7858);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_7859);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16], mem_vec_7860);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 32], mem_vec_7861);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 48], mem_vec_7862);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_7863);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16], mem_vec_7864);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 32], mem_vec_7865);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 48], mem_vec_7866);
							}
						}
					}
				}
