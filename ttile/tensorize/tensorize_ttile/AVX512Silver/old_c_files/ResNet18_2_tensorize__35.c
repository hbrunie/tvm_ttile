...
[V f; U (4, f); U (4, y); U (3, h); T (16, c); Hoist_vars [c]; T (56, x);
  T (3, w); T (4, c); T (1, x); T (14, y); T (1, y)]
*/
IND_TYPE c, cp_0, c48_p_0, cp_1, c48, w, wp_0, x, xp_0, x62_p_0, xp_1, x62, y, yp_0, y34_p_0, yp_1, y34;
IND_TYPE y35 = 0;
IND_TYPE x63 = 0;
IND_TYPE h = 0;
IND_TYPE w23 = 0;
...
c48_p_0 = 0;
				for (w = w23, wp_0 = 0;w < w23 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 56) (56 / 1)
					for (x = x62, xp_1 = x62_p_0, xp_0 = 0;x < x62 + 56;x += 1, xp_1 += 1, xp_0 += 1){
								...
								for (c = c48, cp_1 = c48_p_0, cp_0 = 0;c < c48 + 16;c += 1, cp_1 += 1, cp_0 += 1){
									...
									vec_24 = _mm512_fmadd_ps(vec_25, vec_26, mem_vec_364);
									mem_vec_364 = vec_24;
									vec_28 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
									vec_27 = _mm512_fmadd_ps(vec_25, vec_28, mem_vec_365);
									mem_vec_365 = vec_27;
									vec_30 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 32]);
									vec_29 = _mm512_fmadd_ps(vec_25, vec_30, mem_vec_366);
									mem_vec_366 = vec_29;
									vec_32 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 48]);
									vec_31 = _mm512_fmadd_ps(vec_25, vec_32, mem_vec_367);
									mem_vec_367 = vec_31;
									scal_5 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
									vec_34 = _mm512_set1_ps(scal_5);
									vec_33 = _mm512_fmadd_ps(vec_34, vec_26, mem_vec_368);
									mem_vec_368 = vec_33;
									vec_35 = _mm512_fmadd_ps(vec_34, vec_28, mem_vec_369);
									mem_vec_369 = vec_35;
									vec_36 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_370);
									mem_vec_370 = vec_36;
									vec_37 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_371);
									mem_vec_371 = vec_37;
									scal_6 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
									vec_39 = _mm512_set1_ps(scal_6);
									vec_38 = _mm512_fmadd_ps(vec_39, vec_26, mem_vec_372);
									mem_vec_372 = vec_38;
									vec_40 = _mm512_fmadd_ps(vec_39, vec_28, mem_vec_373);
									mem_vec_373 = vec_40;
									vec_41 = _mm512_fmadd_ps(vec_39, vec_30, mem_vec_374);
									mem_vec_374 = vec_41;
									vec_42 = _mm512_fmadd_ps(vec_39, vec_32, mem_vec_375);
									mem_vec_375 = vec_42;
									scal_7 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
									vec_44 = _mm512_set1_ps(scal_7);
									vec_43 = _mm512_fmadd_ps(vec_44, vec_26, mem_vec_376);
									mem_vec_376 = vec_43;
									vec_45 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_377);
									mem_vec_377 = vec_45;
									vec_46 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_378);
									mem_vec_378 = vec_46;
									vec_47 = _mm512_fmadd_ps(vec_44, vec_32, mem_vec_379);
									mem_vec_379 = vec_47;
									scal_8 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
									vec_49 = _mm512_set1_ps(scal_8);
									vec_50 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
									vec_48 = _mm512_fmadd_ps(vec_49, vec_50, mem_vec_364);
									mem_vec_364 = vec_48;
									vec_52 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
									vec_51 = _mm512_fmadd_ps(vec_49, vec_52, mem_vec_365);
									mem_vec_365 = vec_51;
									vec_54 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 32]);
									vec_53 = _mm512_fmadd_ps(vec_49, vec_54, mem_vec_366);
									mem_vec_366 = vec_53;
									vec_56 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 48]);
									vec_55 = _mm512_fmadd_ps(vec_49, vec_56, mem_vec_367);
									mem_vec_367 = vec_55;
									scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
									vec_58 = _mm512_set1_ps(scal_9);
									vec_57 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_368);
									mem_vec_368 = vec_57;
									vec_59 = _mm512_fmadd_ps(vec_58, vec_52, mem_vec_369);
									mem_vec_369 = vec_59;
									vec_60 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_370);
									mem_vec_370 = vec_60;
									vec_61 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_371);
									mem_vec_371 = vec_61;
									scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
									vec_63 = _mm512_set1_ps(scal_10);
									vec_62 = _mm512_fmadd_ps(vec_63, vec_50, mem_vec_372);
									mem_vec_372 = vec_62;
									vec_64 = _mm512_fmadd_ps(vec_63, vec_52, mem_vec_373);
									mem_vec_373 = vec_64;
									vec_65 = _mm512_fmadd_ps(vec_63, vec_54, mem_vec_374);
									mem_vec_374 = vec_65;
									vec_66 = _mm512_fmadd_ps(vec_63, vec_56, mem_vec_375);
									mem_vec_375 = vec_66;
									scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
									vec_68 = _mm512_set1_ps(scal_11);
									vec_67 = _mm512_fmadd_ps(vec_68, vec_50, mem_vec_376);
									mem_vec_376 = vec_67;
									vec_69 = _mm512_fmadd_ps(vec_68, vec_52, mem_vec_377);
									mem_vec_377 = vec_69;
									vec_70 = _mm512_fmadd_ps(vec_68, vec_54, mem_vec_378);
									mem_vec_378 = vec_70;
									vec_71 = _mm512_fmadd_ps(vec_68, vec_56, mem_vec_379);
									mem_vec_379 = vec_71;
								}
