...
xp_0 = 0;
							for (w = w230, wp_0 = 0;w < w230 + 3;w += 1, wp_0 += 1){
										mem_vec_2977 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										...
										mem_vec_2982 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										mem_vec_2983 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
										mem_vec_2984 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
										mem_vec_2985 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_2977);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_2982);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_2983);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2984);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_2985);
							}
}
