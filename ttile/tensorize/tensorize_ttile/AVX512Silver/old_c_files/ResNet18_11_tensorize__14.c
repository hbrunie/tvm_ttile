...
/*
[V f; U (2, f); U (7, y); T (256, c); Hoist_vars [c]; T (1, x); T (16, f);
  T (1, c); T (7, x)]
*/
IND_TYPE c, cp_0, c75_p_0, cp_1, c75, f, fp_0, x, xp_0, x55_p_0, xp_1, x55;
IND_TYPE y = 0;
IND_TYPE x56 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
f = 0;
fp_0 = 0;
			for (x = x55, xp_1 = x55_p_0, xp_0 = 0;x < x55 + 1;x += 1, xp_1 += 1, xp_0 += 1){
