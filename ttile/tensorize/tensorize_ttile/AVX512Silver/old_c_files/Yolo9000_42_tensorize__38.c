...
c270_p_0 = 0;
						for (w = w129, wp_0 = 0;w < w129 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 34) (34 / 1)
							for (x = x358, xp_2 = x358_p_1, xp_1 = x358_p_0, xp_0 = 0;x < x358 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_4316 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_4317 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_4316);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_4317);
							}
						}
}
