...
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (16, x); T (1, c);
  T (7, w); T (7, h); T (7, x); T (7, y); T (2, f); T (2, y)]
*/
IND_TYPE c, cp_0, c426_p_0, cp_1, c426, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x415_p_0, xp_1, x415, y, yp_0, y426_p_0, yp_1, y426;
IND_TYPE y427 = 0;
IND_TYPE x416 = 0;
IND_TYPE h284 = 0;
IND_TYPE w284 = 0;
...
__m512 mem_vec_5340 ,mem_vec_5341 ,mem_vec_5342 ,mem_vec_5343 ,mem_vec_5344 ,mem_vec_5345 ,mem_vec_5346 ,mem_vec_5347 ,mem_vec_5348 ,mem_vec_5349 ,mem_vec_5350 ,mem_vec_5351 ,mem_vec_5352 ,mem_vec_5353 ,mem_vec_5354 ,mem_vec_5355 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_3 ,vec_4 ,vec_5 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
...
x415 = 0;
x415_p_0 = 0;
				for (h = h284, hp_0 = 0;h < h284 + 7;h += 1, hp_0 += 1){
					// y = 8, x = 16, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w284, wp_0 = 0;w < w284 + 7;w += 1, wp_0 += 1){
						// y = 8, x = 16, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c426 = c427, c426_p_0 = 0;c426 < c427 + 3;c426 += 3, c426_p_0 += 3){
							// y = 8, x = 16, h = 1, w = 1, c = 3, f = 32
							// T (x, 16) (16 / 1)
							for (x = x415, xp_1 = x415_p_0, xp_0 = 0;x < x415 + 16;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c426, cp_1 = c426_p_0, cp_0 = 0;c < c426 + 3;c += 1, cp_1 += 1, cp_0 += 1){
