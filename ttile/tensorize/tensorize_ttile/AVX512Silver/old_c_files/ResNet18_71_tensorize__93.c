...
xp_0 = 0;
						for (w = w309, wp_0 = 0;w < w309 + 3;w += 1, wp_0 += 1){
									...
									for (c = c594, cp_1 = c594_p_0, cp_0 = 0;c < c594 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_20 = _mm512_fmadd_ps(vec_21, vec_22, mem_vec_3058);
										mem_vec_3058 = vec_20;
										vec_24 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
										vec_23 = _mm512_fmadd_ps(vec_21, vec_24, mem_vec_3059);
										mem_vec_3059 = vec_23;
										scal_7 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 1) + h + 1) + c];
										vec_26 = _mm512_set1_ps(scal_7);
										vec_25 = _mm512_fmadd_ps(vec_26, vec_22, mem_vec_3060);
										mem_vec_3060 = vec_25;
										vec_27 = _mm512_fmadd_ps(vec_26, vec_24, mem_vec_3061);
										mem_vec_3061 = vec_27;
										scal_8 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 2) + h + 1) + c];
										vec_29 = _mm512_set1_ps(scal_8);
										vec_28 = _mm512_fmadd_ps(vec_29, vec_22, mem_vec_3062);
										mem_vec_3062 = vec_28;
										vec_30 = _mm512_fmadd_ps(vec_29, vec_24, mem_vec_3063);
										mem_vec_3063 = vec_30;
										scal_9 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 3) + h + 1) + c];
										vec_32 = _mm512_set1_ps(scal_9);
										vec_31 = _mm512_fmadd_ps(vec_32, vec_22, mem_vec_3064);
										mem_vec_3064 = vec_31;
										vec_33 = _mm512_fmadd_ps(vec_32, vec_24, mem_vec_3065);
										mem_vec_3065 = vec_33;
										scal_10 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 4) + h + 1) + c];
										vec_35 = _mm512_set1_ps(scal_10);
										vec_34 = _mm512_fmadd_ps(vec_35, vec_22, mem_vec_3066);
										mem_vec_3066 = vec_34;
										vec_36 = _mm512_fmadd_ps(vec_35, vec_24, mem_vec_3067);
										mem_vec_3067 = vec_36;
										scal_11 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 5) + h + 1) + c];
										vec_38 = _mm512_set1_ps(scal_11);
										vec_37 = _mm512_fmadd_ps(vec_38, vec_22, mem_vec_3068);
										mem_vec_3068 = vec_37;
										vec_39 = _mm512_fmadd_ps(vec_38, vec_24, mem_vec_3069);
										mem_vec_3069 = vec_39;
										scal_12 = input[strideA1 * (2 * x + w) + strideA2 * (2 * y + h + 2) + c];
										vec_41 = _mm512_set1_ps(scal_12);
										vec_42 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
										vec_40 = _mm512_fmadd_ps(vec_41, vec_42, mem_vec_3058);
										mem_vec_3058 = vec_40;
										vec_44 = _mm512_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
										vec_43 = _mm512_fmadd_ps(vec_41, vec_44, mem_vec_3059);
										mem_vec_3059 = vec_43;
										scal_13 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 1) + h + 2) + c];
										vec_46 = _mm512_set1_ps(scal_13);
										vec_45 = _mm512_fmadd_ps(vec_46, vec_42, mem_vec_3060);
										mem_vec_3060 = vec_45;
										vec_47 = _mm512_fmadd_ps(vec_46, vec_44, mem_vec_3061);
										mem_vec_3061 = vec_47;
										scal_14 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 2) + h + 2) + c];
										vec_49 = _mm512_set1_ps(scal_14);
										vec_48 = _mm512_fmadd_ps(vec_49, vec_42, mem_vec_3062);
										mem_vec_3062 = vec_48;
										vec_50 = _mm512_fmadd_ps(vec_49, vec_44, mem_vec_3063);
										mem_vec_3063 = vec_50;
										scal_15 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 3) + h + 2) + c];
										vec_52 = _mm512_set1_ps(scal_15);
										vec_51 = _mm512_fmadd_ps(vec_52, vec_42, mem_vec_3064);
										mem_vec_3064 = vec_51;
										vec_53 = _mm512_fmadd_ps(vec_52, vec_44, mem_vec_3065);
										mem_vec_3065 = vec_53;
										scal_16 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 4) + h + 2) + c];
										vec_55 = _mm512_set1_ps(scal_16);
										vec_54 = _mm512_fmadd_ps(vec_55, vec_42, mem_vec_3066);
										mem_vec_3066 = vec_54;
										vec_56 = _mm512_fmadd_ps(vec_55, vec_44, mem_vec_3067);
										mem_vec_3067 = vec_56;
										scal_17 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 5) + h + 2) + c];
										vec_58 = _mm512_set1_ps(scal_17);
										vec_57 = _mm512_fmadd_ps(vec_58, vec_42, mem_vec_3068);
										mem_vec_3068 = vec_57;
										vec_59 = _mm512_fmadd_ps(vec_58, vec_44, mem_vec_3069);
										mem_vec_3069 = vec_59;
									}
