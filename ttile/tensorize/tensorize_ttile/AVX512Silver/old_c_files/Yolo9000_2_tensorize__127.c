...
c471_p_0 = 0;
						for (w = w233, wp_0 = 0;w < w233 + 3;w += 1, wp_0 += 1){
							...
							for (x = x628, xp_2 = x628_p_1, xp_1 = x628_p_0, xp_0 = 0;x < x628 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1342 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 32]);
										mem_vec_1343 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 32], mem_vec_1342);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 48], mem_vec_1343);
