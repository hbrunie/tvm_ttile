			...
			f += 64, fp_0 += 64){
				for (y = y360, yp_1 = y360_p_0, yp_0 = 0;
					...
					for (c480 = c481, c480_p_1 = c481_p_0, c480_p_0 = 0;
						c480 < c481 + 512;
						c480 += 256, c480_p_1 += 256, c480_p_0 += 256){
						...
						for (x = x240, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_4798 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32]);
									mem_vec_4799 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32], mem_vec_4798);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48], mem_vec_4799);
						}
					}
				}
					...
					for (c480 = c481, c480_p_1 = c481_p_0, c480_p_0 = 0;
						...
						for (x = x240, xp_0 = 0;
							...
							x += 1, xp_0 += 1){
									...
									mem_vec_4826 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
									mem_vec_4827 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 256, f = 64
									// T (c, 256) (256 / 1)
									for (c = c480, cp_2 = c480_p_1, cp_1 = c480_p_0, cp_0 = 0;
										c < c480 + 256;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_4826);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_4827);
						}
					}
				}
		}
