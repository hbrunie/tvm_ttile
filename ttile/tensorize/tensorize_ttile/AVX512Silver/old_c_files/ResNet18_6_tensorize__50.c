...
*/
IND_TYPE c, cp_0, c582_p_0, cp_1, c582, f, fp_0, f582_p_0, fp_1, f582, w, wp_0, x, xp_0, x471_p_0, xp_1, x471, y, yp_0;
IND_TYPE y388 = 0;
IND_TYPE x472 = 0;
IND_TYPE h = 0;
IND_TYPE w299 = 0;
...
c582_p_0 = 0;
					for (w = w299, wp_0 = 0;w < w299 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 14) (14 / 1)
						for (x = x471, xp_1 = x471_p_0, xp_0 = 0;x < x471 + 14;x += 1, xp_1 += 1, xp_0 += 1){
