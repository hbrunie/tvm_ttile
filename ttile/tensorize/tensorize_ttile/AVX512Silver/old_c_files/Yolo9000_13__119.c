	...
	for (y349 = y350, y349_p_0 = 0;
		...
		for (x501 = x502, x501_p_0 = 0;
			...
			for (f = f250, fp_0 = 0;
				...
				// T (y, 2) (2 * ph_y / ph_y)
				for (y = y349, yp_1 = y349_p_0, yp_0 = 0;
					y < y349 + 14;
					y += 7, yp_1 += 7, yp_0 += 7){
						...
						for (c375 = c376, c375_p_0 = 0;
							...
							for (x = x500, xp_2 = x500_p_1, xp_1 = x500_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5296 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_5297 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
										mem_vec_5298 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
										mem_vec_5299 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_5296);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_5297);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_5298);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_5299);
