...
y84 = 0;
y84_p_0 = 0;
	for (x113 = x114, x113_p_0 = 0;x113 < x114 + 68;x113 += 34, x113_p_0 += 34){
			for (y = y84, yp_1 = y84_p_0, yp_0 = 0;y < y84 + 3;y += 3, yp_1 += 3, yp_0 += 3){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
				for (x112 = x113, x112_p_1 = x113_p_0, x112_p_0 = 0;x112 < x113 + 34;x112 += 34, x112_p_1 += 34, x112_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f56, fp_0 = 0;f < f56 + 128;f += 64, fp_0 += 64){
						// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 64
						// T (c, 1) (256 / 256)
						for (c84 = c85, c84_p_0 = 0;c84 < c85 + 256;c84 += 256, c84_p_0 += 256){
							// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 64
							// T (x, 34) (34 / 1)
							for (x = x112, xp_2 = x112_p_1, xp_1 = x112_p_0, xp_0 = 0;x < x112 + 34;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y84 + 3, yp_1 = y84_p_0, yp_0 = 0;y < y84 + 3 + 14;y += 7, yp_1 += 7, yp_0 += 7){
				// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (34 / 34)
				for (x112 = x113, x112_p_1 = x113_p_0, x112_p_0 = 0;x112 < x113 + 34;x112 += 34, x112_p_1 += 34, x112_p_0 += 34){
					// y = ph_y, x = 34, h = 1, w = 1, c = 256, f = 128
