...
y309 = 0;
y309_p_0 = 0;
	for (f = f195, fp_0 = 0;f < f195 + 64;f += 32, fp_0 += 32){
			for (y = y309, yp_1 = y309_p_0, yp_0 = 0;y < y309 + 20;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 56) (112 / 2)
				for (x298 = x299, x298_p_0 = 0;x298 < x299 + 112;x298 += 2, x298_p_0 += 2){
					...
					for (h = h206, hp_0 = 0;h < h206 + 7;h += 1, hp_0 += 1){
						...
						for (w = w206, wp_0 = 0;w < w206 + 7;w += 1, wp_0 += 1){
							...
							for (c309 = c310, c309_p_0 = 0;c309 < c310 + 3;c309 += 3, c309_p_0 += 3){
								// y = ph_y, x = 2, h = 1, w = 1, c = 3, f = 32
								// T (x, 2) (2 / 1)
								for (x = x298, xp_1 = x298_p_0, xp_0 = 0;x < x298 + 2;x += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y309 + 20, yp_1 = y309_p_0, yp_0 = 0;y < y309 + 20 + 36;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 56) (112 / 2)
				for (x298 = x299, x298_p_0 = 0;x298 < x299 + 112;x298 += 2, x298_p_0 += 2){
					// y = ph_y, x = 2, h = 7, w = 7, c = 3, f = 32
