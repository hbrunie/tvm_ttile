...
y = 0;
yp_1 = 0;
					for (x = x159, xp_1 = x159_p_0, xp_0 = 0;x < x159 + 2;x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_2158 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
								mem_vec_2159 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_2158);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_2159);
					}
}
