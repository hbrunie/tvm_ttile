...
xp_0 = 0;
							for (h = h56, hp_0 = 0;h < h56 + 3;h += 1, hp_0 += 1){
										...
										for (c = c152, cp_2 = c152_p_1, cp_1 = c152_p_0, cp_0 = 0;c < c152 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_19 = _mm512_fmadd_ps(vec_20, vec_16, mem_vec_882);
											mem_vec_882 = vec_19;
											vec_21 = _mm512_fmadd_ps(vec_20, vec_18, mem_vec_883);
											mem_vec_883 = vec_21;
											scal_6 = input[strideA1 * (x + w + 1) + strideA2 * (y + 2 + h) + c];
											vec_23 = _mm512_set1_ps(scal_6);
											vec_22 = _mm512_fmadd_ps(vec_23, vec_16, mem_vec_884);
											mem_vec_884 = vec_22;
											vec_24 = _mm512_fmadd_ps(vec_23, vec_18, mem_vec_885);
											mem_vec_885 = vec_24;
											scal_7 = input[strideA1 * (x + w + 1) + strideA2 * (y + 3 + h) + c];
											vec_26 = _mm512_set1_ps(scal_7);
											vec_25 = _mm512_fmadd_ps(vec_26, vec_16, mem_vec_886);
											mem_vec_886 = vec_25;
											vec_27 = _mm512_fmadd_ps(vec_26, vec_18, mem_vec_887);
											mem_vec_887 = vec_27;
											...
											vec_33 = _mm512_fmadd_ps(vec_34, vec_30, mem_vec_882);
											mem_vec_882 = vec_33;
											vec_35 = _mm512_fmadd_ps(vec_34, vec_32, mem_vec_883);
											mem_vec_883 = vec_35;
											scal_10 = input[strideA1 * (x + w + 2) + strideA2 * (y + 2 + h) + c];
											vec_37 = _mm512_set1_ps(scal_10);
											vec_36 = _mm512_fmadd_ps(vec_37, vec_30, mem_vec_884);
											mem_vec_884 = vec_36;
											vec_38 = _mm512_fmadd_ps(vec_37, vec_32, mem_vec_885);
											mem_vec_885 = vec_38;
											scal_11 = input[strideA1 * (x + w + 2) + strideA2 * (y + 3 + h) + c];
											vec_40 = _mm512_set1_ps(scal_11);
											vec_39 = _mm512_fmadd_ps(vec_40, vec_30, mem_vec_886);
											mem_vec_886 = vec_39;
											vec_41 = _mm512_fmadd_ps(vec_40, vec_32, mem_vec_887);
											mem_vec_887 = vec_41;
										}
