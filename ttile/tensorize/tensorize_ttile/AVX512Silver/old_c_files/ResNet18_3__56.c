...
for (y775 = y776, y775_p_0 = 0;
	...
	for (x974 = x975, x974_p_0 = 0;
		...
		for (y774 = y775, y774_p_1 = y775_p_0, y774_p_0 = 0;
			y774 < y775 + 28;
			y774 += 28, y774_p_1 += 28, y774_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 56) (56 / 1)
			for (x973 = x974, x973_p_1 = x974_p_0, x973_p_0 = 0;
				x973 < x974 + 56;
				x973 += 1, x973_p_1 += 1, x973_p_0 += 1){
				...
				for (f = f378, fp_0 = 0;
					...
					for (y = y774, yp_2 = y774_p_1, yp_1 = y774_p_0, yp_0 = 0;
						...
						// T (x, 1) (1 / 1)
						for (x972 = x973, x972_p_2 = x973_p_1, x972_p_1 = x973_p_0, x972_p_0 = 0;
							x972 < x973 + 1;
							x972 += 1, x972_p_2 += 1, x972_p_1 += 1, x972_p_0 += 1){
							// y = 7, x = 1, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c594 = c595, c594_p_0 = 0;
								...
								// y = 7, x = 1, h = 1, w = 1, c = 64, f = 32
								// T (x, 1) (1 / 1)
								for (x = x972, xp_3 = x972_p_2, xp_2 = x972_p_1, xp_1 = x972_p_0, xp_0 = 0;
									x < x972 + 1;
