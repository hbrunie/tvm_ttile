...
xp_0 = 0;
						for (h = h242, hp_0 = 0;h < h242 + 3;h += 1, hp_0 += 1){
									mem_vec_2799 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									...
									mem_vec_2803 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_2799);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_2803);
						}
}
