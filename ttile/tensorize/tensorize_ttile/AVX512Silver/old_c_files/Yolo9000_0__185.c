...
[V f; U (1, f); U (4, y); U (3, h); U (3, w); T (3, c); Hoist_vars [c];
  T (1, x); T (2, f); T (1, x); T (17, y); T (4, y); T (544, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x88_p_0, x89_p_0, xp_1, x88_p_1, xp_2, x88, x89, y, yp_0, y82_p_0, y83_p_0, yp_1, y82_p_1, yp_2, y82, y83;
...
for (y83 = y84, y83_p_0 = 0;
	...
	for (x89 = x90, x89_p_0 = 0;
		...
		// T (y, 4) (272 / 68)
		for (y82 = y83, y82_p_1 = y83_p_0, y82_p_0 = 0;
			y82 < y83 + 272;
			y82 += 68, y82_p_1 += 68, y82_p_0 += 68){
			// y = 68, x = 1, h = 3, w = 3, c = 3, f = 32
			// T (y, 17) (68 / 4)
			for (y = y82, yp_2 = y82_p_1, yp_1 = y82_p_0, yp_0 = 0;
				y < y82 + 68;
					...
					for (f = f38, fp_0 = 0;
						...
						for (x = x88, xp_2 = x88_p_1, xp_1 = x88_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_185 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									...
									for (c = c50, cp_0 = 0;
										...
										vec_3 = _mm512_fmadd_ps(vec_4, vec_2, mem_vec_185);
										mem_vec_185 = vec_3;
