...
[V f; U (4, f); U (7, y); U (3, w); T (64, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (1, c); T (2, x); T (8, y); T (1, y)]
*/
IND_TYPE c, cp_0, c114_p_0, cp_1, c114, h, hp_0, x, xp_0, x134_p_0, xp_1, x134, y, yp_0, y94_p_0, yp_1, y94;
				...
				for (h = h55, hp_0 = 0;
					...
					for (x = x134, xp_1 = x134_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_798 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
								mem_vec_799 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
								...
								for (c = c114, cp_1 = c114_p_0, cp_0 = 0;
									...
									vec_34 = _mm512_fmadd_ps(vec_35, vec_2, mem_vec_796);
									mem_vec_796 = vec_34;



									vec_36 = _mm512_fmadd_ps(vec_35, vec_4, mem_vec_797);
									mem_vec_797 = vec_36;



									vec_37 = _mm512_fmadd_ps(vec_35, vec_6, mem_vec_798);
									mem_vec_798 = vec_37;



									vec_38 = _mm512_fmadd_ps(vec_35, vec_8, mem_vec_799);
									mem_vec_799 = vec_38;
									scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
									vec_40 = _mm512_set1_ps(scal_7);
									vec_41 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

									vec_39 = _mm512_fmadd_ps(vec_40, vec_41, mem_vec_772);
									mem_vec_772 = vec_39;

									vec_43 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

									vec_42 = _mm512_fmadd_ps(vec_40, vec_43, mem_vec_773);
									mem_vec_773 = vec_42;

									vec_45 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

									vec_44 = _mm512_fmadd_ps(vec_40, vec_45, mem_vec_774);
									mem_vec_774 = vec_44;

									vec_47 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

									vec_46 = _mm512_fmadd_ps(vec_40, vec_47, mem_vec_775);
									mem_vec_775 = vec_46;
									scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
									vec_49 = _mm512_set1_ps(scal_8);


									vec_48 = _mm512_fmadd_ps(vec_49, vec_41, mem_vec_776);
									mem_vec_776 = vec_48;



									vec_50 = _mm512_fmadd_ps(vec_49, vec_43, mem_vec_777);
									mem_vec_777 = vec_50;



									vec_51 = _mm512_fmadd_ps(vec_49, vec_45, mem_vec_778);
									mem_vec_778 = vec_51;



									vec_52 = _mm512_fmadd_ps(vec_49, vec_47, mem_vec_779);
									mem_vec_779 = vec_52;
									scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
									vec_54 = _mm512_set1_ps(scal_9);


									vec_53 = _mm512_fmadd_ps(vec_54, vec_41, mem_vec_780);
									mem_vec_780 = vec_53;



									vec_55 = _mm512_fmadd_ps(vec_54, vec_43, mem_vec_781);
									mem_vec_781 = vec_55;



									vec_56 = _mm512_fmadd_ps(vec_54, vec_45, mem_vec_782);
									mem_vec_782 = vec_56;



									vec_57 = _mm512_fmadd_ps(vec_54, vec_47, mem_vec_783);
									mem_vec_783 = vec_57;
									scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
									vec_59 = _mm512_set1_ps(scal_10);


									vec_58 = _mm512_fmadd_ps(vec_59, vec_41, mem_vec_784);
									mem_vec_784 = vec_58;



									vec_60 = _mm512_fmadd_ps(vec_59, vec_43, mem_vec_785);
									mem_vec_785 = vec_60;



									vec_61 = _mm512_fmadd_ps(vec_59, vec_45, mem_vec_786);
									mem_vec_786 = vec_61;



									vec_62 = _mm512_fmadd_ps(vec_59, vec_47, mem_vec_787);
									mem_vec_787 = vec_62;
									scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
									vec_64 = _mm512_set1_ps(scal_11);


									vec_63 = _mm512_fmadd_ps(vec_64, vec_41, mem_vec_788);
									mem_vec_788 = vec_63;



									vec_65 = _mm512_fmadd_ps(vec_64, vec_43, mem_vec_789);
									mem_vec_789 = vec_65;



									vec_66 = _mm512_fmadd_ps(vec_64, vec_45, mem_vec_790);
									mem_vec_790 = vec_66;



									vec_67 = _mm512_fmadd_ps(vec_64, vec_47, mem_vec_791);
									mem_vec_791 = vec_67;
									scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
									vec_69 = _mm512_set1_ps(scal_12);


									vec_68 = _mm512_fmadd_ps(vec_69, vec_41, mem_vec_792);
									mem_vec_792 = vec_68;



									vec_70 = _mm512_fmadd_ps(vec_69, vec_43, mem_vec_793);
									mem_vec_793 = vec_70;



									vec_71 = _mm512_fmadd_ps(vec_69, vec_45, mem_vec_794);
									mem_vec_794 = vec_71;



									vec_72 = _mm512_fmadd_ps(vec_69, vec_47, mem_vec_795);
									mem_vec_795 = vec_72;
									scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
									vec_74 = _mm512_set1_ps(scal_13);


									vec_73 = _mm512_fmadd_ps(vec_74, vec_41, mem_vec_796);
									mem_vec_796 = vec_73;



									vec_75 = _mm512_fmadd_ps(vec_74, vec_43, mem_vec_797);
									mem_vec_797 = vec_75;



									vec_76 = _mm512_fmadd_ps(vec_74, vec_45, mem_vec_798);
									mem_vec_798 = vec_76;



									vec_77 = _mm512_fmadd_ps(vec_74, vec_47, mem_vec_799);
									mem_vec_799 = vec_77;
									scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
									vec_79 = _mm512_set1_ps(scal_14);
									vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

									vec_78 = _mm512_fmadd_ps(vec_79, vec_80, mem_vec_772);
									mem_vec_772 = vec_78;

									vec_82 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

									vec_81 = _mm512_fmadd_ps(vec_79, vec_82, mem_vec_773);
									mem_vec_773 = vec_81;

									vec_84 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

									vec_83 = _mm512_fmadd_ps(vec_79, vec_84, mem_vec_774);
									mem_vec_774 = vec_83;

									vec_86 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

									vec_85 = _mm512_fmadd_ps(vec_79, vec_86, mem_vec_775);
									mem_vec_775 = vec_85;
									scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
									vec_88 = _mm512_set1_ps(scal_15);


									vec_87 = _mm512_fmadd_ps(vec_88, vec_80, mem_vec_776);
									mem_vec_776 = vec_87;



									vec_89 = _mm512_fmadd_ps(vec_88, vec_82, mem_vec_777);
									mem_vec_777 = vec_89;



									vec_90 = _mm512_fmadd_ps(vec_88, vec_84, mem_vec_778);
									mem_vec_778 = vec_90;



									vec_91 = _mm512_fmadd_ps(vec_88, vec_86, mem_vec_779);
									mem_vec_779 = vec_91;
									scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
									vec_93 = _mm512_set1_ps(scal_16);


									vec_92 = _mm512_fmadd_ps(vec_93, vec_80, mem_vec_780);
									mem_vec_780 = vec_92;



									vec_94 = _mm512_fmadd_ps(vec_93, vec_82, mem_vec_781);
									mem_vec_781 = vec_94;



									vec_95 = _mm512_fmadd_ps(vec_93, vec_84, mem_vec_782);
									mem_vec_782 = vec_95;



									vec_96 = _mm512_fmadd_ps(vec_93, vec_86, mem_vec_783);
									mem_vec_783 = vec_96;
									scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
									vec_98 = _mm512_set1_ps(scal_17);


									vec_97 = _mm512_fmadd_ps(vec_98, vec_80, mem_vec_784);
									mem_vec_784 = vec_97;



									vec_99 = _mm512_fmadd_ps(vec_98, vec_82, mem_vec_785);
									mem_vec_785 = vec_99;



									vec_100 = _mm512_fmadd_ps(vec_98, vec_84, mem_vec_786);
									mem_vec_786 = vec_100;



									vec_101 = _mm512_fmadd_ps(vec_98, vec_86, mem_vec_787);
									mem_vec_787 = vec_101;
									scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
									vec_103 = _mm512_set1_ps(scal_18);


									vec_102 = _mm512_fmadd_ps(vec_103, vec_80, mem_vec_788);
									mem_vec_788 = vec_102;



									vec_104 = _mm512_fmadd_ps(vec_103, vec_82, mem_vec_789);
									mem_vec_789 = vec_104;



									vec_105 = _mm512_fmadd_ps(vec_103, vec_84, mem_vec_790);
									mem_vec_790 = vec_105;



									vec_106 = _mm512_fmadd_ps(vec_103, vec_86, mem_vec_791);
									mem_vec_791 = vec_106;
									scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
									vec_108 = _mm512_set1_ps(scal_19);


									vec_107 = _mm512_fmadd_ps(vec_108, vec_80, mem_vec_792);
									mem_vec_792 = vec_107;



									vec_109 = _mm512_fmadd_ps(vec_108, vec_82, mem_vec_793);
									mem_vec_793 = vec_109;



									vec_110 = _mm512_fmadd_ps(vec_108, vec_84, mem_vec_794);
									mem_vec_794 = vec_110;



									vec_111 = _mm512_fmadd_ps(vec_108, vec_86, mem_vec_795);
									mem_vec_795 = vec_111;
									scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
									vec_113 = _mm512_set1_ps(scal_20);


									vec_112 = _mm512_fmadd_ps(vec_113, vec_80, mem_vec_796);
									mem_vec_796 = vec_112;



									vec_114 = _mm512_fmadd_ps(vec_113, vec_82, mem_vec_797);
									mem_vec_797 = vec_114;



									vec_115 = _mm512_fmadd_ps(vec_113, vec_84, mem_vec_798);
									mem_vec_798 = vec_115;



									vec_116 = _mm512_fmadd_ps(vec_113, vec_86, mem_vec_799);
									mem_vec_799 = vec_116;
								}
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_798);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_799);
					}
				}
			}
		}
