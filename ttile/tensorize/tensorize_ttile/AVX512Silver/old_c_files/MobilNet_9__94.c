...
[V f; U (1, f); U (7, y); U (3, h); T (128, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (4, f); T (8, c); T (1, c); T (16, f)]
*/
IND_TYPE c, cp_0, c752_p_0, c753_p_0, cp_1, c752_p_1, cp_2, c752, c753, f, fp_0, f564_p_0, fp_1, f564, w, wp_0, x, xp_0;
