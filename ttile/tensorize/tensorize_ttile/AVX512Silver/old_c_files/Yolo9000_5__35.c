				...
				for (y = y372, yp_1 = y372_p_0, yp_0 = 0;
					...
					for (x = x372, xp_1 = x372_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_5156 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
								mem_vec_5157 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
								mem_vec_5158 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_5159 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c276, cp_0 = 0;
									c < c276 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_5156);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_5157);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_5158);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_5159);
					}
				}
				for (y = y372 + 20, yp_1 = y372_p_0, yp_0 = 0;
					y < y372 + 20 + 14;
					...
					for (x = x372, xp_1 = x372_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_5186 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								mem_vec_5187 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c276, cp_0 = 0;
									c < c276 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_5186);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_5187);
					}
				}
		}
	}
