...
fp_1 = 0;
				for (w = w121, wp_0 = 0;w < w121 + 3;w += 1, wp_0 += 1){
					...
					// T (x, 7) (7 / 1)
					for (x = x158, xp_0 = 0;x < x158 + 7;x += 1, xp_0 += 1){
								mem_vec_1288 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
								mem_vec_1289 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
								...
								mem_vec_1293 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_1289);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_1293);
