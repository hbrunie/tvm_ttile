...
[V f; U (2, f); ULambda y; T (64, c); Hoist_vars [c]; T (2, x); T (8, c);
  ...
  T (8, f); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c537_p_0, cp_1, c537, f, fp_0, x, xp_0, x716_p_0, x717_p_0, xp_1, x716_p_1, xp_2, x716, x717, y, yp_0, y511_p_0, yp_1, y511;
...
for (y511 = y512, y511_p_0 = 0;
	...
	for (x717 = x718, x717_p_0 = 0;
		...
		for (f = f358, fp_0 = 0;
			f < f358 + 256;
			f += 32, fp_0 += 32){
				for (y = y511, yp_1 = y511_p_0, yp_0 = 0;
					y < y511 + 24;
					y += 8, yp_1 += 8, yp_0 += 8){
				...
				for (y = y511 + 24, yp_1 = y511_p_0, yp_0 = 0;
					y < y511 + 24 + 10;
