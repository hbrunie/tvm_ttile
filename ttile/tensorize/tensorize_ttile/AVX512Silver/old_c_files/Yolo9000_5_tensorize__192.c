...
[V f; U (2, f); ULambda y; T (128, c); Hoist_vars [c]; T (1, x);
  ...
  T (136, x); T (4, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x318_p_0, xp_1, x318, y, yp_0, y318_p_0, yp_1, y318;
IND_TYPE y319 = 0;
IND_TYPE x319 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x318 = 0;
x318_p_0 = 0;
		for (f = f184, fp_0 = 0;f < f184 + 64;f += 32, fp_0 += 32){
				for (y = y318, yp_1 = y318_p_0, yp_0 = 0;y < y318 + 7;y += 7, yp_1 += 7, yp_0 += 7){
					...
					for (x = x318, xp_1 = x318_p_0, xp_0 = 0;x < x318 + 1;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c240, cp_0 = 0;c < c240 + 128;c += 1, cp_0 += 1){
				...
				for (y = y318 + 7, yp_1 = y318_p_0, yp_0 = 0;y < y318 + 7 + 27;y += 9, yp_1 += 9, yp_0 += 9){
					// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
					// T (x, 1) (1 / 1)
					for (x = x318, xp_1 = x318_p_0, xp_0 = 0;x < x318 + 1;x += 1, xp_1 += 1, xp_0 += 1){
