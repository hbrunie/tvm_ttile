...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (3, h);
  T (7, x); T (16, c); T (1, y); T (8, f); T (2, c); T (2, f)]
*/
IND_TYPE c, cp_0, c580_p_0, c581_p_0, cp_1, c580_p_1, cp_2, c580, c581, f, fp_0, f435_p_0, fp_1, f435, h, hp_0, x, xp_0, y, yp_0;
		...
		for (f = f435, fp_1 = f435_p_0, fp_0 = 0;
			...
			for (y = y214, yp_0 = 0;
				...
				for (c580 = c581, c580_p_1 = c581_p_0, c580_p_0 = 0;
					c580 < c581 + 512;
					c580 += 32, c580_p_1 += 32, c580_p_0 += 32){
