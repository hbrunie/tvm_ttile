...
[V f; U (1, f); U (8, y); U (3, h); T (3, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, f); T (1, x); T (17, y); T (1, y); T (544, x); T (4, y)]
*/
IND_TYPE c, cp_0, f, fp_0, w, wp_0, x, xp_0, x624_p_0, x625_p_0, xp_1, x624_p_1, xp_2, x624, x625, y, yp_0, y586_p_0, y587_p_0, yp_1, y586_p_1, yp_2, y586, y587;
IND_TYPE y588 = 0;
IND_TYPE x626 = 0;
IND_TYPE h = 0;
IND_TYPE w279 = 0;
...
__m512 mem_vec_2668 ,mem_vec_2669 ,mem_vec_2670 ,mem_vec_2671 ,mem_vec_2672 ,mem_vec_2673 ,mem_vec_2674 ,mem_vec_2675 ,vec_0 ,vec_1 ,vec_10 ,vec_11 ,vec_12 ,vec_13 ,vec_14 ,vec_15 ,vec_16 ,vec_17 ,vec_18 ,vec_19 ,vec_2 ,vec_20 ,vec_21 ,vec_22 ,vec_23 ,vec_24 ,vec_25 ,vec_26 ,vec_27 ,vec_28 ,vec_29 ,vec_3 ,vec_30 ,vec_31 ,vec_32 ,vec_33 ,vec_34 ,vec_35 ,vec_36 ,vec_37 ,vec_38 ,vec_39 ,vec_4 ,vec_40 ,vec_41 ,vec_42 ,vec_43 ,vec_44 ,vec_45 ,vec_46 ,vec_47 ,vec_48 ,vec_49 ,vec_5 ,vec_50 ,vec_6 ,vec_7 ,vec_8 ,vec_9;
...
fp_0 = 0;
						for (w = w279, wp_0 = 0;w < w279 + 3;w += 1, wp_0 += 1){
							...
							for (x = x624, xp_2 = x624_p_1, xp_1 = x624_p_0, xp_0 = 0;x < x624 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// y = 8, x = 1, h = 3, w = 1, c = 3, f = 16
										// T (c, 3) (3 / 1)
										for (c = c350, cp_0 = 0;c < c350 + 3;c += 1, cp_0 += 1){
											...
											vec_20 = _mm512_fmadd_ps(vec_21, vec_19, mem_vec_2669);
											mem_vec_2669 = vec_20;
											...
											vec_24 = _mm512_fmadd_ps(vec_25, vec_19, mem_vec_2671);
											mem_vec_2671 = vec_24;
											scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 1) + c];
											vec_27 = _mm512_set1_ps(scal_12);
											vec_26 = _mm512_fmadd_ps(vec_27, vec_19, mem_vec_2672);
											mem_vec_2672 = vec_26;
											scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 1) + c];
											vec_29 = _mm512_set1_ps(scal_13);
											vec_28 = _mm512_fmadd_ps(vec_29, vec_19, mem_vec_2673);
											mem_vec_2673 = vec_28;
											scal_14 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 1) + c];
											vec_31 = _mm512_set1_ps(scal_14);
											vec_30 = _mm512_fmadd_ps(vec_31, vec_19, mem_vec_2674);
											mem_vec_2674 = vec_30;
											scal_15 = input[strideA1 * (x + w) + strideA2 * (y + 7 + h + 1) + c];
											vec_33 = _mm512_set1_ps(scal_15);
											vec_32 = _mm512_fmadd_ps(vec_33, vec_19, mem_vec_2675);
											mem_vec_2675 = vec_32;
											...
											vec_37 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_2669);
											mem_vec_2669 = vec_37;
											...
											vec_41 = _mm512_fmadd_ps(vec_42, vec_36, mem_vec_2671);
											mem_vec_2671 = vec_41;
											scal_20 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 2) + c];
											vec_44 = _mm512_set1_ps(scal_20);
											vec_43 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_2672);
											mem_vec_2672 = vec_43;
											scal_21 = input[strideA1 * (x + w) + strideA2 * (y + 5 + h + 2) + c];
											vec_46 = _mm512_set1_ps(scal_21);
											vec_45 = _mm512_fmadd_ps(vec_46, vec_36, mem_vec_2673);
											mem_vec_2673 = vec_45;
											scal_22 = input[strideA1 * (x + w) + strideA2 * (y + 6 + h + 2) + c];
											vec_48 = _mm512_set1_ps(scal_22);
											vec_47 = _mm512_fmadd_ps(vec_48, vec_36, mem_vec_2674);
											mem_vec_2674 = vec_47;
											scal_23 = input[strideA1 * (x + w) + strideA2 * (y + 7 + h + 2) + c];
											vec_50 = _mm512_set1_ps(scal_23);
											vec_49 = _mm512_fmadd_ps(vec_50, vec_36, mem_vec_2675);
											mem_vec_2675 = vec_49;
										}
