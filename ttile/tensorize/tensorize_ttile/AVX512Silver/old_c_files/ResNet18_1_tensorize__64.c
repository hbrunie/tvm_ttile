...
y327 = 0;
y327_p_0 = 0;
	for (f = f207, fp_0 = 0;f < f207 + 64;f += 32, fp_0 += 32){
			for (y = y327, yp_1 = y327_p_0, yp_0 = 0;y < y327 + 30;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 7) (112 / 16)
				for (x316 = x317, x316_p_0 = 0;x316 < x317 + 112;x316 += 16, x316_p_0 += 16){
					...
					for (h = h218, hp_0 = 0;h < h218 + 7;h += 1, hp_0 += 1){
						...
						for (w = w218, wp_0 = 0;w < w218 + 7;w += 1, wp_0 += 1){
							...
							for (c327 = c328, c327_p_0 = 0;c327 < c328 + 3;c327 += 3, c327_p_0 += 3){
								// y = ph_y, x = 16, h = 1, w = 1, c = 3, f = 32
								// T (x, 16) (16 / 1)
								for (x = x316, xp_1 = x316_p_0, xp_0 = 0;x < x316 + 16;x += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y327 + 30, yp_1 = y327_p_0, yp_0 = 0;y < y327 + 30 + 26;y += 13, yp_1 += 13, yp_0 += 13){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 7) (112 / 16)
				for (x316 = x317, x316_p_0 = 0;x316 < x317 + 112;x316 += 16, x316_p_0 += 16){
					// y = ph_y, x = 16, h = 7, w = 7, c = 3, f = 32
						...
						for (w = w218, wp_0 = 0;w < w218 + 7;w += 1, wp_0 += 1){
							...
							for (c327 = c328, c327_p_0 = 0;c327 < c328 + 3;c327 += 3, c327_p_0 += 3){
								...
								for (x = x316, xp_1 = x316_p_0, xp_0 = 0;x < x316 + 16;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3988 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
											mem_vec_3989 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 3, f = 32
											// T (c, 3) (3 / 1)
											for (c = c327, cp_1 = c327_p_0, cp_0 = 0;c < c327 + 3;c += 1, cp_1 += 1, cp_0 += 1){
												scal_0 = input[strideA1 * (2 * x + w) + strideA2 * (2 * y + h) + c];
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3988);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_3989);
								}
							}
						}
					}
