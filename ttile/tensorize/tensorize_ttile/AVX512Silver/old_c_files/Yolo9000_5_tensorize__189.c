...
x381 = 0;
x381_p_0 = 0;
		for (f = f226, fp_0 = 0;f < f226 + 64;f += 32, fp_0 += 32){
				for (y = y381, yp_1 = y381_p_0, yp_0 = 0;y < y381 + 22;y += 11, yp_1 += 11, yp_0 += 11){
					// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
					// T (x, 1) (1 / 1)
					for (x = x381, xp_1 = x381_p_0, xp_0 = 0;x < x381 + 1;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c282, cp_0 = 0;c < c282 + 128;c += 1, cp_0 += 1){
				...
				for (y = y381 + 22, yp_1 = y381_p_0, yp_0 = 0;y < y381 + 22 + 12;y += 12, yp_1 += 12, yp_0 += 12){
					// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
					// T (x, 1) (1 / 1)
					for (x = x381, xp_1 = x381_p_0, xp_0 = 0;x < x381 + 1;x += 1, xp_1 += 1, xp_0 += 1){
