...
y54 = 0;
y54_p_0 = 0;
	for (x73 = x74, x73_p_0 = 0;x73 < x74 + 68;x73 += 68, x73_p_0 += 68){
			for (y = y54, yp_1 = y54_p_0, yp_0 = 0;y < y54 + 9;y += 3, yp_1 += 3, yp_0 += 3){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (68 / 68)
				for (x72 = x73, x72_p_1 = x73_p_0, x72_p_0 = 0;x72 < x73 + 68;x72 += 68, x72_p_1 += 68, x72_p_0 += 68){
					// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f36, fp_0 = 0;f < f36 + 128;f += 64, fp_0 += 64){
						...
						for (c54 = c55, c54_p_0 = 0;c54 < c55 + 256;c54 += 256, c54_p_0 += 256){
							// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 64
							// T (x, 68) (68 / 1)
							for (x = x72, xp_2 = x72_p_1, xp_1 = x72_p_0, xp_0 = 0;x < x72 + 68;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y54 + 9, yp_1 = y54_p_0, yp_0 = 0;y < y54 + 9 + 8;y += 4, yp_1 += 4, yp_0 += 4){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (68 / 68)
				for (x72 = x73, x72_p_1 = x73_p_0, x72_p_0 = 0;x72 < x73 + 68;x72 += 68, x72_p_1 += 68, x72_p_0 += 68){
					// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
