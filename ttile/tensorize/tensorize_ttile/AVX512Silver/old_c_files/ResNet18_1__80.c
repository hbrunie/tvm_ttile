...
for (y357 = y358, y357_p_0 = 0;
	...
	for (f = f227, fp_0 = 0;
		...
		f += 32, fp_0 += 32){
			...
			for (y = y357 + 30, yp_1 = y357_p_0, yp_0 = 0;
				y < y357 + 30 + 26;
							...
							for (c357 = c358, c357_p_0 = 0;
								...
								for (x = x346, xp_1 = x346_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4446 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_4447 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
											mem_vec_4448 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_4449 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 3, f = 32
											// T (c, 3) (3 / 1)
											for (c = c357, cp_1 = c357_p_0, cp_0 = 0;
												c < c357 + 3;
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_4446);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_4447);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_4448);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_4449);
								}
							}
						}
					}
