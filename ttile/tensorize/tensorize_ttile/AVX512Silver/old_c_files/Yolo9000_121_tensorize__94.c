...
[V f; U (4, f); ULambda y; U (3, w); T (64, c); Hoist_vars [c]; T (34, x);
  ...
  T (4, f); T (1, f)]
*/
IND_TYPE c, cp_0, c456_p_0, cp_1, c456, f, fp_0, f516_p_0, f517_p_0, fp_1, f516_p_1, fp_2, f516, f517, h, hp_0, x, xp_0, x451_p_0, xp_1, x451, y, yp_0;
IND_TYPE y339 = 0;
IND_TYPE x452 = 0;
IND_TYPE h275 = 0;
IND_TYPE w = 0;
...
c456_p_0 = 0;
							for (h = h275, hp_0 = 0;h < h275 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 34) (34 / 1)
								for (x = x451, xp_1 = x451_p_0, xp_0 = 0;x < x451 + 34;x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c456, cp_1 = c456_p_0, cp_0 = 0;c < c456 + 64;c += 1, cp_1 += 1, cp_0 += 1){
												...
												vec_14 = _mm512_fmadd_ps(vec_15, vec_16, mem_vec_5556);
												mem_vec_5556 = vec_14;
												vec_18 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 16]);
												vec_17 = _mm512_fmadd_ps(vec_15, vec_18, mem_vec_5557);
												mem_vec_5557 = vec_17;
												vec_20 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 32]);
												vec_19 = _mm512_fmadd_ps(vec_15, vec_20, mem_vec_5558);
												mem_vec_5558 = vec_19;
												vec_22 = _mm512_loadu_ps(&params[strideW1 * (w + 1) + strideW2 * h + strideW3 * c + f + 48]);
												vec_21 = _mm512_fmadd_ps(vec_15, vec_22, mem_vec_5559);
												mem_vec_5559 = vec_21;
												scal_3 = input[strideA1 * (x + w + 1) + strideA2 * (y + 1 + h) + c];
												vec_24 = _mm512_set1_ps(scal_3);
												vec_23 = _mm512_fmadd_ps(vec_24, vec_16, mem_vec_5560);
												mem_vec_5560 = vec_23;
												vec_25 = _mm512_fmadd_ps(vec_24, vec_18, mem_vec_5561);
												mem_vec_5561 = vec_25;
												vec_26 = _mm512_fmadd_ps(vec_24, vec_20, mem_vec_5562);
												mem_vec_5562 = vec_26;
												vec_27 = _mm512_fmadd_ps(vec_24, vec_22, mem_vec_5563);
												mem_vec_5563 = vec_27;
												scal_4 = input[strideA1 * (x + w + 2) + strideA2 * (y + h) + c];
												vec_29 = _mm512_set1_ps(scal_4);
												vec_30 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f]);
												vec_28 = _mm512_fmadd_ps(vec_29, vec_30, mem_vec_5556);
												mem_vec_5556 = vec_28;
												vec_32 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 16]);
												vec_31 = _mm512_fmadd_ps(vec_29, vec_32, mem_vec_5557);
												mem_vec_5557 = vec_31;
												vec_34 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 32]);
												vec_33 = _mm512_fmadd_ps(vec_29, vec_34, mem_vec_5558);
												mem_vec_5558 = vec_33;
												vec_36 = _mm512_loadu_ps(&params[strideW1 * (w + 2) + strideW2 * h + strideW3 * c + f + 48]);
												vec_35 = _mm512_fmadd_ps(vec_29, vec_36, mem_vec_5559);
												mem_vec_5559 = vec_35;
												scal_5 = input[strideA1 * (x + w + 2) + strideA2 * (y + 1 + h) + c];
												vec_38 = _mm512_set1_ps(scal_5);
												vec_37 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_5560);
												mem_vec_5560 = vec_37;
												vec_39 = _mm512_fmadd_ps(vec_38, vec_32, mem_vec_5561);
												mem_vec_5561 = vec_39;
												vec_40 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_5562);
												mem_vec_5562 = vec_40;
												vec_41 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_5563);
												mem_vec_5563 = vec_41;
											}
