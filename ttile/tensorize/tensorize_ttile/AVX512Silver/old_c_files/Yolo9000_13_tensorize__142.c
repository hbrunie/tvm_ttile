...
[V f; U (2, f); ULambda y; T (256, c); Hoist_vars [c]; T (1, x); T (2, c);
  ...
  T (8, f); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c333_p_0, cp_1, c333, f, fp_0, x, xp_0, x444_p_0, x445_p_0, xp_1, x444_p_1, xp_2, x444, x445, y, yp_0, y307_p_0, yp_1, y307;
IND_TYPE y308 = 0;
IND_TYPE x446 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
x445 = 0;
x445_p_0 = 0;
		for (f = f222, fp_0 = 0;f < f222 + 256;f += 32, fp_0 += 32){
				for (y = y307, yp_1 = y307_p_0, yp_0 = 0;y < y307 + 7;y += 7, yp_1 += 7, yp_0 += 7){
					// y = ph_y, x = 34, h = 1, w = 1, c = 512, f = 32
					// T (x, 34) (34 / 1)
					for (x444 = x445, x444_p_1 = x445_p_0, x444_p_0 = 0;x444 < x445 + 34;x444 += 1, x444_p_1 += 1, x444_p_0 += 1){
						// y = ph_y, x = 1, h = 1, w = 1, c = 512, f = 32
						// T (c, 2) (512 / 256)
						for (c333 = c334, c333_p_0 = 0;c333 < c334 + 512;c333 += 256, c333_p_0 += 256){
							// y = ph_y, x = 1, h = 1, w = 1, c = 256, f = 32
							// T (x, 1) (1 / 1)
							for (x = x444, xp_2 = x444_p_1, xp_1 = x444_p_0, xp_0 = 0;x < x444 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
				...
				for (y = y307 + 7, yp_1 = y307_p_0, yp_0 = 0;y < y307 + 7 + 27;y += 9, yp_1 += 9, yp_0 += 9){
					// y = ph_y, x = 34, h = 1, w = 1, c = 512, f = 32
					// T (x, 34) (34 / 1)
					for (x444 = x445, x444_p_1 = x445_p_0, x444_p_0 = 0;x444 < x445 + 34;x444 += 1, x444_p_1 += 1, x444_p_0 += 1){
						// y = ph_y, x = 1, h = 1, w = 1, c = 512, f = 32
