...
[V f; U (2, f); ULambda y; U (3, h); T (16, c); Hoist_vars [c]; T (3, w);
  ...
  T (32, c); T (16, f)]
*/
IND_TYPE c, cp_0, c96_p_0, c97_p_0, cp_1, c96_p_1, cp_2, c96, c97, f, fp_0, f72_p_0, fp_1, f72, w, wp_0, x, xp_0, y, yp_0;
							...
							for (w = w48, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c96, cp_2 = c96_p_1, cp_1 = c96_p_0, cp_0 = 0;
											...
											vec_26 = _mm512_fmadd_ps(vec_27, vec_28, mem_vec_646);
											mem_vec_646 = vec_26;

											vec_30 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_29 = _mm512_fmadd_ps(vec_27, vec_30, mem_vec_647);
											mem_vec_647 = vec_29;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_28, mem_vec_648);
											mem_vec_648 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_30, mem_vec_649);
											mem_vec_649 = vec_33;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_28, mem_vec_650);
											mem_vec_650 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_30, mem_vec_651);
											mem_vec_651 = vec_36;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_28, mem_vec_652);
											mem_vec_652 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_30, mem_vec_653);
											mem_vec_653 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_28, mem_vec_654);
											mem_vec_654 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_30, mem_vec_655);
											mem_vec_655 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_28, mem_vec_656);
											mem_vec_656 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_30, mem_vec_657);
											mem_vec_657 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_28, mem_vec_658);
											mem_vec_658 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_30, mem_vec_659);
											mem_vec_659 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_28, mem_vec_660);
											mem_vec_660 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_30, mem_vec_661);
											mem_vec_661 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_53 = _mm512_set1_ps(scal_16);
											vec_54 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_52 = _mm512_fmadd_ps(vec_53, vec_54, mem_vec_646);
											mem_vec_646 = vec_52;

											vec_56 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_55 = _mm512_fmadd_ps(vec_53, vec_56, mem_vec_647);
											mem_vec_647 = vec_55;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_54, mem_vec_648);
											mem_vec_648 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_56, mem_vec_649);
											mem_vec_649 = vec_59;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_61 = _mm512_set1_ps(scal_18);


											vec_60 = _mm512_fmadd_ps(vec_61, vec_54, mem_vec_650);
											mem_vec_650 = vec_60;



											vec_62 = _mm512_fmadd_ps(vec_61, vec_56, mem_vec_651);
											mem_vec_651 = vec_62;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_54, mem_vec_652);
											mem_vec_652 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_56, mem_vec_653);
											mem_vec_653 = vec_65;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_54, mem_vec_654);
											mem_vec_654 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_56, mem_vec_655);
											mem_vec_655 = vec_68;
											scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_70 = _mm512_set1_ps(scal_21);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_54, mem_vec_656);
											mem_vec_656 = vec_69;



											vec_71 = _mm512_fmadd_ps(vec_70, vec_56, mem_vec_657);
											mem_vec_657 = vec_71;
											scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_73 = _mm512_set1_ps(scal_22);


											vec_72 = _mm512_fmadd_ps(vec_73, vec_54, mem_vec_658);
											mem_vec_658 = vec_72;



											vec_74 = _mm512_fmadd_ps(vec_73, vec_56, mem_vec_659);
											mem_vec_659 = vec_74;
											scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
											vec_76 = _mm512_set1_ps(scal_23);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_54, mem_vec_660);
											mem_vec_660 = vec_75;



											vec_77 = _mm512_fmadd_ps(vec_76, vec_56, mem_vec_661);
											mem_vec_661 = vec_77;
										}
							...
							for (w = w48, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c96, cp_2 = c96_p_1, cp_1 = c96_p_0, cp_0 = 0;
											...
											vec_29 = _mm512_fmadd_ps(vec_30, vec_31, mem_vec_662);
											mem_vec_662 = vec_29;

											vec_33 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_32 = _mm512_fmadd_ps(vec_30, vec_33, mem_vec_663);
											mem_vec_663 = vec_32;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_31, mem_vec_664);
											mem_vec_664 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_33, mem_vec_665);
											mem_vec_665 = vec_36;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_31, mem_vec_666);
											mem_vec_666 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_33, mem_vec_667);
											mem_vec_667 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_31, mem_vec_668);
											mem_vec_668 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_33, mem_vec_669);
											mem_vec_669 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_31, mem_vec_670);
											mem_vec_670 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_33, mem_vec_671);
											mem_vec_671 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_31, mem_vec_672);
											mem_vec_672 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_33, mem_vec_673);
											mem_vec_673 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_31, mem_vec_674);
											mem_vec_674 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_33, mem_vec_675);
											mem_vec_675 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 1) + c];
											vec_53 = _mm512_set1_ps(scal_16);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_31, mem_vec_676);
											mem_vec_676 = vec_52;



											vec_54 = _mm512_fmadd_ps(vec_53, vec_33, mem_vec_677);
											mem_vec_677 = vec_54;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 1) + c];
											vec_56 = _mm512_set1_ps(scal_17);


											vec_55 = _mm512_fmadd_ps(vec_56, vec_31, mem_vec_678);
											mem_vec_678 = vec_55;



											vec_57 = _mm512_fmadd_ps(vec_56, vec_33, mem_vec_679);
											mem_vec_679 = vec_57;
											scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_59 = _mm512_set1_ps(scal_18);
											vec_60 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_58 = _mm512_fmadd_ps(vec_59, vec_60, mem_vec_662);
											mem_vec_662 = vec_58;

											vec_62 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_61 = _mm512_fmadd_ps(vec_59, vec_62, mem_vec_663);
											mem_vec_663 = vec_61;
											scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_60, mem_vec_664);
											mem_vec_664 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_62, mem_vec_665);
											mem_vec_665 = vec_65;
											scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_60, mem_vec_666);
											mem_vec_666 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_62, mem_vec_667);
											mem_vec_667 = vec_68;
											scal_21 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_70 = _mm512_set1_ps(scal_21);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_60, mem_vec_668);
											mem_vec_668 = vec_69;



											vec_71 = _mm512_fmadd_ps(vec_70, vec_62, mem_vec_669);
											mem_vec_669 = vec_71;
											scal_22 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_73 = _mm512_set1_ps(scal_22);


											vec_72 = _mm512_fmadd_ps(vec_73, vec_60, mem_vec_670);
											mem_vec_670 = vec_72;



											vec_74 = _mm512_fmadd_ps(vec_73, vec_62, mem_vec_671);
											mem_vec_671 = vec_74;
											scal_23 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_76 = _mm512_set1_ps(scal_23);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_60, mem_vec_672);
											mem_vec_672 = vec_75;



											vec_77 = _mm512_fmadd_ps(vec_76, vec_62, mem_vec_673);
											mem_vec_673 = vec_77;
											scal_24 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
											vec_79 = _mm512_set1_ps(scal_24);


											vec_78 = _mm512_fmadd_ps(vec_79, vec_60, mem_vec_674);
											mem_vec_674 = vec_78;



											vec_80 = _mm512_fmadd_ps(vec_79, vec_62, mem_vec_675);
											mem_vec_675 = vec_80;
											scal_25 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 7 + h + 2) + c];
											vec_82 = _mm512_set1_ps(scal_25);


											vec_81 = _mm512_fmadd_ps(vec_82, vec_60, mem_vec_676);
											mem_vec_676 = vec_81;



											vec_83 = _mm512_fmadd_ps(vec_82, vec_62, mem_vec_677);
											mem_vec_677 = vec_83;
											scal_26 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 8 + h + 2) + c];
											vec_85 = _mm512_set1_ps(scal_26);


											vec_84 = _mm512_fmadd_ps(vec_85, vec_60, mem_vec_678);
											mem_vec_678 = vec_84;



											vec_86 = _mm512_fmadd_ps(vec_85, vec_62, mem_vec_679);
											mem_vec_679 = vec_86;
										}
