...
[V f; U (2, f); ULambda y; U (3, w); T (16, c); Hoist_vars [c]; T (3, h);
  ...
  T (32, c); T (16, f)]
*/
IND_TYPE c, cp_0, c180_p_0, c181_p_0, cp_1, c180_p_1, cp_2, c180, c181, f, fp_0, f135_p_0, fp_1, f135, h, hp_0, x, xp_0, y, yp_0;
							...
							for (h = h70, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										for (c = c180, cp_2 = c180_p_1, cp_1 = c180_p_0, cp_0 = 0;
											...
											vec_23 = _mm512_fmadd_ps(vec_24, vec_25, mem_vec_1072);
											mem_vec_1072 = vec_23;

											vec_27 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_26 = _mm512_fmadd_ps(vec_24, vec_27, mem_vec_1073);
											mem_vec_1073 = vec_26;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_29 = _mm512_set1_ps(scal_8);


											vec_28 = _mm512_fmadd_ps(vec_29, vec_25, mem_vec_1074);
											mem_vec_1074 = vec_28;



											vec_30 = _mm512_fmadd_ps(vec_29, vec_27, mem_vec_1075);
											mem_vec_1075 = vec_30;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_32 = _mm512_set1_ps(scal_9);


											vec_31 = _mm512_fmadd_ps(vec_32, vec_25, mem_vec_1076);
											mem_vec_1076 = vec_31;



											vec_33 = _mm512_fmadd_ps(vec_32, vec_27, mem_vec_1077);
											mem_vec_1077 = vec_33;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_35 = _mm512_set1_ps(scal_10);


											vec_34 = _mm512_fmadd_ps(vec_35, vec_25, mem_vec_1078);
											mem_vec_1078 = vec_34;



											vec_36 = _mm512_fmadd_ps(vec_35, vec_27, mem_vec_1079);
											mem_vec_1079 = vec_36;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_25, mem_vec_1080);
											mem_vec_1080 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_27, mem_vec_1081);
											mem_vec_1081 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_25, mem_vec_1082);
											mem_vec_1082 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_27, mem_vec_1083);
											mem_vec_1083 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_25, mem_vec_1084);
											mem_vec_1084 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_27, mem_vec_1085);
											mem_vec_1085 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_47 = _mm512_set1_ps(scal_14);
											vec_48 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_46 = _mm512_fmadd_ps(vec_47, vec_48, mem_vec_1072);
											mem_vec_1072 = vec_46;

											vec_50 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_49 = _mm512_fmadd_ps(vec_47, vec_50, mem_vec_1073);
											mem_vec_1073 = vec_49;
											scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_52 = _mm512_set1_ps(scal_15);


											vec_51 = _mm512_fmadd_ps(vec_52, vec_48, mem_vec_1074);
											mem_vec_1074 = vec_51;



											vec_53 = _mm512_fmadd_ps(vec_52, vec_50, mem_vec_1075);
											mem_vec_1075 = vec_53;
											scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_55 = _mm512_set1_ps(scal_16);


											vec_54 = _mm512_fmadd_ps(vec_55, vec_48, mem_vec_1076);
											mem_vec_1076 = vec_54;



											vec_56 = _mm512_fmadd_ps(vec_55, vec_50, mem_vec_1077);
											mem_vec_1077 = vec_56;
											scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_58 = _mm512_set1_ps(scal_17);


											vec_57 = _mm512_fmadd_ps(vec_58, vec_48, mem_vec_1078);
											mem_vec_1078 = vec_57;



											vec_59 = _mm512_fmadd_ps(vec_58, vec_50, mem_vec_1079);
											mem_vec_1079 = vec_59;
											scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_61 = _mm512_set1_ps(scal_18);


											vec_60 = _mm512_fmadd_ps(vec_61, vec_48, mem_vec_1080);
											mem_vec_1080 = vec_60;



											vec_62 = _mm512_fmadd_ps(vec_61, vec_50, mem_vec_1081);
											mem_vec_1081 = vec_62;
											scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_64 = _mm512_set1_ps(scal_19);


											vec_63 = _mm512_fmadd_ps(vec_64, vec_48, mem_vec_1082);
											mem_vec_1082 = vec_63;



											vec_65 = _mm512_fmadd_ps(vec_64, vec_50, mem_vec_1083);
											mem_vec_1083 = vec_65;
											scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_67 = _mm512_set1_ps(scal_20);


											vec_66 = _mm512_fmadd_ps(vec_67, vec_48, mem_vec_1084);
											mem_vec_1084 = vec_66;



											vec_68 = _mm512_fmadd_ps(vec_67, vec_50, mem_vec_1085);
											mem_vec_1085 = vec_68;
										}
							...
							for (h = h70, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										for (c = c180, cp_2 = c180_p_1, cp_1 = c180_p_0, cp_0 = 0;
											...
											vec_32 = _mm512_fmadd_ps(vec_33, vec_34, mem_vec_1086);
											mem_vec_1086 = vec_32;

											vec_36 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_35 = _mm512_fmadd_ps(vec_33, vec_36, mem_vec_1087);
											mem_vec_1087 = vec_35;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_38 = _mm512_set1_ps(scal_11);


											vec_37 = _mm512_fmadd_ps(vec_38, vec_34, mem_vec_1088);
											mem_vec_1088 = vec_37;



											vec_39 = _mm512_fmadd_ps(vec_38, vec_36, mem_vec_1089);
											mem_vec_1089 = vec_39;
											scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_41 = _mm512_set1_ps(scal_12);


											vec_40 = _mm512_fmadd_ps(vec_41, vec_34, mem_vec_1090);
											mem_vec_1090 = vec_40;



											vec_42 = _mm512_fmadd_ps(vec_41, vec_36, mem_vec_1091);
											mem_vec_1091 = vec_42;
											scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_44 = _mm512_set1_ps(scal_13);


											vec_43 = _mm512_fmadd_ps(vec_44, vec_34, mem_vec_1092);
											mem_vec_1092 = vec_43;



											vec_45 = _mm512_fmadd_ps(vec_44, vec_36, mem_vec_1093);
											mem_vec_1093 = vec_45;
											scal_14 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_47 = _mm512_set1_ps(scal_14);


											vec_46 = _mm512_fmadd_ps(vec_47, vec_34, mem_vec_1094);
											mem_vec_1094 = vec_46;



											vec_48 = _mm512_fmadd_ps(vec_47, vec_36, mem_vec_1095);
											mem_vec_1095 = vec_48;
											scal_15 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_50 = _mm512_set1_ps(scal_15);


											vec_49 = _mm512_fmadd_ps(vec_50, vec_34, mem_vec_1096);
											mem_vec_1096 = vec_49;



											vec_51 = _mm512_fmadd_ps(vec_50, vec_36, mem_vec_1097);
											mem_vec_1097 = vec_51;
											scal_16 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_53 = _mm512_set1_ps(scal_16);


											vec_52 = _mm512_fmadd_ps(vec_53, vec_34, mem_vec_1098);
											mem_vec_1098 = vec_52;



											vec_54 = _mm512_fmadd_ps(vec_53, vec_36, mem_vec_1099);
											mem_vec_1099 = vec_54;
											scal_17 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 7 + h) + c];
											vec_56 = _mm512_set1_ps(scal_17);


											vec_55 = _mm512_fmadd_ps(vec_56, vec_34, mem_vec_1100);
											mem_vec_1100 = vec_55;



											vec_57 = _mm512_fmadd_ps(vec_56, vec_36, mem_vec_1101);
											mem_vec_1101 = vec_57;
											scal_18 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 8 + h) + c];
											vec_59 = _mm512_set1_ps(scal_18);


											vec_58 = _mm512_fmadd_ps(vec_59, vec_34, mem_vec_1102);
											mem_vec_1102 = vec_58;



											vec_60 = _mm512_fmadd_ps(vec_59, vec_36, mem_vec_1103);
											mem_vec_1103 = vec_60;
											scal_19 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 9 + h) + c];
											vec_62 = _mm512_set1_ps(scal_19);


											vec_61 = _mm512_fmadd_ps(vec_62, vec_34, mem_vec_1104);
											mem_vec_1104 = vec_61;



											vec_63 = _mm512_fmadd_ps(vec_62, vec_36, mem_vec_1105);
											mem_vec_1105 = vec_63;
											scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_65 = _mm512_set1_ps(scal_20);
											vec_66 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_64 = _mm512_fmadd_ps(vec_65, vec_66, mem_vec_1086);
											mem_vec_1086 = vec_64;

											vec_68 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_67 = _mm512_fmadd_ps(vec_65, vec_68, mem_vec_1087);
											mem_vec_1087 = vec_67;
											scal_21 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_70 = _mm512_set1_ps(scal_21);


											vec_69 = _mm512_fmadd_ps(vec_70, vec_66, mem_vec_1088);
											mem_vec_1088 = vec_69;



											vec_71 = _mm512_fmadd_ps(vec_70, vec_68, mem_vec_1089);
											mem_vec_1089 = vec_71;
											scal_22 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_73 = _mm512_set1_ps(scal_22);


											vec_72 = _mm512_fmadd_ps(vec_73, vec_66, mem_vec_1090);
											mem_vec_1090 = vec_72;



											vec_74 = _mm512_fmadd_ps(vec_73, vec_68, mem_vec_1091);
											mem_vec_1091 = vec_74;
											scal_23 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_76 = _mm512_set1_ps(scal_23);


											vec_75 = _mm512_fmadd_ps(vec_76, vec_66, mem_vec_1092);
											mem_vec_1092 = vec_75;



											vec_77 = _mm512_fmadd_ps(vec_76, vec_68, mem_vec_1093);
											mem_vec_1093 = vec_77;
											scal_24 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_79 = _mm512_set1_ps(scal_24);


											vec_78 = _mm512_fmadd_ps(vec_79, vec_66, mem_vec_1094);
											mem_vec_1094 = vec_78;



											vec_80 = _mm512_fmadd_ps(vec_79, vec_68, mem_vec_1095);
											mem_vec_1095 = vec_80;
											scal_25 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_82 = _mm512_set1_ps(scal_25);


											vec_81 = _mm512_fmadd_ps(vec_82, vec_66, mem_vec_1096);
											mem_vec_1096 = vec_81;



											vec_83 = _mm512_fmadd_ps(vec_82, vec_68, mem_vec_1097);
											mem_vec_1097 = vec_83;
											scal_26 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_85 = _mm512_set1_ps(scal_26);


											vec_84 = _mm512_fmadd_ps(vec_85, vec_66, mem_vec_1098);
											mem_vec_1098 = vec_84;



											vec_86 = _mm512_fmadd_ps(vec_85, vec_68, mem_vec_1099);
											mem_vec_1099 = vec_86;
											scal_27 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 7 + h) + c];
											vec_88 = _mm512_set1_ps(scal_27);


											vec_87 = _mm512_fmadd_ps(vec_88, vec_66, mem_vec_1100);
											mem_vec_1100 = vec_87;



											vec_89 = _mm512_fmadd_ps(vec_88, vec_68, mem_vec_1101);
											mem_vec_1101 = vec_89;
											scal_28 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 8 + h) + c];
											vec_91 = _mm512_set1_ps(scal_28);


											vec_90 = _mm512_fmadd_ps(vec_91, vec_66, mem_vec_1102);
											mem_vec_1102 = vec_90;



											vec_92 = _mm512_fmadd_ps(vec_91, vec_68, mem_vec_1103);
											mem_vec_1103 = vec_92;
											scal_29 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 9 + h) + c];
											vec_94 = _mm512_set1_ps(scal_29);


											vec_93 = _mm512_fmadd_ps(vec_94, vec_66, mem_vec_1104);
											mem_vec_1104 = vec_93;



											vec_95 = _mm512_fmadd_ps(vec_94, vec_68, mem_vec_1105);
											mem_vec_1105 = vec_95;
										}
