...
for (y186 = y187, y186_p_0 = 0;
	...
	for (x249 = x250, x249_p_0 = 0;
		...
		x249 += 4, x249_p_0 += 4){
			...
			for (y = y186 + 26, yp_1 = y186_p_0, yp_0 = 0;
				y < y186 + 26 + 42;
						...
						for (c186 = c187, c186_p_0 = 0;
							...
							for (x = x248, xp_2 = x248_p_1, xp_1 = x248_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3196 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_3197 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 64, f = 32
										// T (c, 64) (64 / 1)
										for (c = c186, cp_1 = c186_p_0, cp_0 = 0;
											c < c186 + 64;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3196);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_3197);
							}
						}
					}
				}
