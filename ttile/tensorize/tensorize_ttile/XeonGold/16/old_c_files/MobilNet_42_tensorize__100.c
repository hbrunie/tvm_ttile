...
xp_0 = 0;
						for (w = w170, wp_0 = 0;w < w170 + 3;w += 1, wp_0 += 1){
									mem_vec_2734 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									...
									mem_vec_2741 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									mem_vec_2742 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_2743 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_2734);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_2741);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_2742);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_2743);
						}
}
