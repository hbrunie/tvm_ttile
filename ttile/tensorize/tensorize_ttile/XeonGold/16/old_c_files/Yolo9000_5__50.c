	...
	for (x51 = x52, x51_p_0 = 0;
		...
		for (f = f34, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				...
				for (y = y51 + 40, yp_1 = y51_p_0, yp_0 = 0;
					y < y51 + 40 + 28;
					...
					for (x = x51, xp_1 = x51_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_726 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_727 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
								mem_vec_728 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_729 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
								mem_vec_730 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								mem_vec_731 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c34, cp_0 = 0;
									c < c34 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_726);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_727);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_728);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_729);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_730);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_731);
					}
				}
		}
	}
