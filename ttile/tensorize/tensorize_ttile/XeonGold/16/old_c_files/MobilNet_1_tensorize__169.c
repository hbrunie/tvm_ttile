...
y138 = 0;
y138_p_0 = 0;
	for (c138 = c139, c138_p_0 = 0;c138 < c139 + 32;c138 += 32, c138_p_0 += 32){
			for (y = y138, yp_1 = y138_p_0, yp_0 = 0;y < y138 + 45;y += 9, yp_1 += 9, yp_0 += 9){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x92, xp_0 = 0;x < x92 + 112;x += 1, xp_0 += 1){
			...
			for (y = y138 + 45, yp_1 = y138_p_0, yp_0 = 0;y < y138 + 45 + 11;y += 11, yp_1 += 11, yp_0 += 11){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x92, xp_0 = 0;x < x92 + 112;x += 1, xp_0 += 1){
					// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 32
