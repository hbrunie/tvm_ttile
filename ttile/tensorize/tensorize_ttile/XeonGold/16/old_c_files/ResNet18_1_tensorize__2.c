...
y237 = 0;
y237_p_0 = 0;
	for (f = f153, fp_0 = 0;f < f153 + 64;f += 32, fp_0 += 32){
			for (y = y237, yp_1 = y237_p_0, yp_0 = 0;y < y237 + 30;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 28) (112 / 4)
				for (x232 = x233, x232_p_0 = 0;x232 < x233 + 112;x232 += 4, x232_p_0 += 4){
						...
						for (w = w158, wp_0 = 0;w < w158 + 7;w += 1, wp_0 += 1){
							...
							for (c237 = c238, c237_p_0 = 0;c237 < c238 + 3;c237 += 3, c237_p_0 += 3){
								...
								for (x = x232, xp_1 = x232_p_0, xp_0 = 0;x < x232 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2890 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_2891 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_2890);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_2891);
								}
							}
						}
					}
			...
			for (y = y237 + 30, yp_1 = y237_p_0, yp_0 = 0;y < y237 + 30 + 26;y += 13, yp_1 += 13, yp_0 += 13){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 28) (112 / 4)
				for (x232 = x233, x232_p_0 = 0;x232 < x233 + 112;x232 += 4, x232_p_0 += 4){
					// y = ph_y, x = 4, h = 7, w = 7, c = 3, f = 32
						...
						for (w = w158, wp_0 = 0;w < w158 + 7;w += 1, wp_0 += 1){
							...
							for (c237 = c238, c237_p_0 = 0;c237 < c238 + 3;c237 += 3, c237_p_0 += 3){
								...
								for (x = x232, xp_1 = x232_p_0, xp_0 = 0;x < x232 + 4;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2908 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_2909 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
											mem_vec_2910 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_2911 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
											mem_vec_2912 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
											mem_vec_2913 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
											mem_vec_2914 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
											mem_vec_2915 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
											mem_vec_2916 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
											mem_vec_2917 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 3, f = 32
											// T (c, 3) (3 / 1)
											for (c = c237, cp_1 = c237_p_0, cp_0 = 0;c < c237 + 3;c += 1, cp_1 += 1, cp_0 += 1){
												scal_0 = input[strideA1 * (2 * x + w) + strideA2 * (2 * y + h) + c];
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_2908);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_2909);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_2910);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_2911);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_2912);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_2913);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_2914);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_2915);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_2916);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_2917);
								}
							}
						}
					}
