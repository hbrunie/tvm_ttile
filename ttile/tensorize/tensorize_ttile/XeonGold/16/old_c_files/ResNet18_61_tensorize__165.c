...
c231_p_0 = 0;
						for (h = h130, hp_0 = 0;h < h130 + 3;h += 1, hp_0 += 1){
							...
							for (x = x215, xp_1 = x215_p_0, xp_0 = 0;x < x215 + 28;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2078 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
										mem_vec_2079 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_2078);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_2079);
							}
						}
}
