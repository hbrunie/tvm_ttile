...
c66_p_0 = 0;
						for (h = h44, hp_0 = 0;h < h44 + 3;h += 1, hp_0 += 1){
							...
							for (x = x70, xp_1 = x70_p_0, xp_0 = 0;x < x70 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_570 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
										mem_vec_571 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_570);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_571);
							}
						}
}
