						...
						for (w = w266, wp_0 = 0;w < w266 + 3;w += 1, wp_0 += 1){
							...
							for (x = x434, xp_1 = x434_p_0, xp_0 = 0;x < x434 + 7;x += 1, xp_1 += 1, xp_0 += 1){
								...
								for (h = h265, hp_0 = 0;h < h265 + 3;h += 1, hp_0 += 1){
											...
											mem_vec_4626 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
											mem_vec_4627 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_4626);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_4627);
								}
							}
						}
}
