...
for (y480 = y481, y480_p_0 = 0;
	...
	for (x603 = x604, x603_p_0 = 0;
		...
		// y = 56, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 2) (56 / 28)
		for (y479 = y480, y479_p_1 = y480_p_0, y479_p_0 = 0;
			y479 < y480 + 56;
			y479 += 28, y479_p_1 += 28, y479_p_0 += 28){
			...
			for (x602 = x603, x602_p_1 = x603_p_0, x602_p_0 = 0;
				...
				for (f = f235, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y479, yp_2 = y479_p_1, yp_1 = y479_p_0, yp_0 = 0;
						y < y479 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 4, h = 1, w = 1, c = 64, f = 32
						// T (x, 4) (4 / 1)
						for (x601 = x602, x601_p_2 = x602_p_1, x601_p_1 = x602_p_0, x601_p_0 = 0;
							x601 < x602 + 4;
							x601 += 1, x601_p_2 += 1, x601_p_1 += 1, x601_p_0 += 1){
							...
							for (c366 = c367, c366_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x601, xp_3 = x601_p_2, xp_2 = x601_p_1, xp_1 = x601_p_0, xp_0 = 0;
									x < x601 + 1;
