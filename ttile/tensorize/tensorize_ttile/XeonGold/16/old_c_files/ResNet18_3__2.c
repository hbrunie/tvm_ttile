...
for (y620 = y621, y620_p_0 = 0;
	...
	for (x778 = x779, x778_p_0 = 0;
		...
		// T (y, 2) (28 / 14)
		for (y619 = y620, y619_p_1 = y620_p_0, y619_p_0 = 0;
			y619 < y620 + 28;
			y619 += 14, y619_p_1 += 14, y619_p_0 += 14){
			// y = 14, x = 7, h = 1, w = 1, c = 64, f = 64
			// T (x, 1) (7 / 7)
			for (x777 = x778, x777_p_1 = x778_p_0, x777_p_0 = 0;
				x777 < x778 + 7;
				x777 += 7, x777_p_1 += 7, x777_p_0 += 7){
				// y = 14, x = 7, h = 1, w = 1, c = 64, f = 64
				// T (f, 2) (64 / 32)
				for (f = f305, fp_0 = 0;
					f < f305 + 64;
					...
					// T (y, 1) (14 / 14)
					for (y = y619, yp_2 = y619_p_1, yp_1 = y619_p_0, yp_0 = 0;
						y < y619 + 14;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (7 / 7)
						for (x776 = x777, x776_p_2 = x777_p_1, x776_p_1 = x777_p_0, x776_p_0 = 0;
							x776 < x777 + 7;
							x776 += 7, x776_p_2 += 7, x776_p_1 += 7, x776_p_0 += 7){
							// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c471 = c472, c471_p_0 = 0;
								...
								// T (x, 7) (7 / 1)
								for (x = x776, xp_3 = x776_p_2, xp_2 = x776_p_1, xp_1 = x776_p_0, xp_0 = 0;
									x < x776 + 7;
