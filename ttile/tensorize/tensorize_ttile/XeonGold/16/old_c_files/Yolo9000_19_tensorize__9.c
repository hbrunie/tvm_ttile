...
[V f; U (2, f); ULambda y; T (128, c); Hoist_vars [c]; T (17, x); T (8, c);
  ...
  T (1, y)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, f, fp_0, x, xp_0, y, y0, yp_0, y0_p_0, yp_1;
IND_TYPE y1 = 0;
IND_TYPE x0 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
y0 = 0;
y0_p_0 = 0;
	for (f = f0, fp_0 = 0;f < f0 + 512;f += 32, fp_0 += 32){
			for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 8;y += 8, yp_1 += 8, yp_0 += 8){
				// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 32
				// T (c, 8) (1024 / 128)
				for (c0 = c1, c0_p_0 = 0;c0 < c1 + 1024;c0 += 128, c0_p_0 += 128){
			...
			for (y = y0 + 8, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 8 + 9;y += 9, yp_1 += 9, yp_0 += 9){
				// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 32
				// T (c, 8) (1024 / 128)
				for (c0 = c1, c0_p_0 = 0;c0 < c1 + 1024;c0 += 128, c0_p_0 += 128){
					// y = ph_y, x = 17, h = 1, w = 1, c = 128, f = 32
