...
for (y344 = y345, y344_p_0 = 0;
	...
	for (x433 = x434, x433_p_0 = 0;
		...
		// T (y, 1) (56 / 56)
		for (y343 = y344, y343_p_1 = y344_p_0, y343_p_0 = 0;
			y343 < y344 + 56;
			y343 += 56, y343_p_1 += 56, y343_p_0 += 56){
			// y = 56, x = 28, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (28 / 2)
			for (x432 = x433, x432_p_1 = x433_p_0, x432_p_0 = 0;
				...
				for (f = f167, fp_0 = 0;
					...
					// T (y, 7) (56 / 8)
					for (y = y343, yp_2 = y343_p_1, yp_1 = y343_p_0, yp_0 = 0;
						y < y343 + 56;
						y += 8, yp_2 += 8, yp_1 += 8, yp_0 += 8){
						// y = 8, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (2 / 2)
						for (x431 = x432, x431_p_2 = x432_p_1, x431_p_1 = x432_p_0, x431_p_0 = 0;
							x431 < x432 + 2;
							x431 += 2, x431_p_2 += 2, x431_p_1 += 2, x431_p_0 += 2){
							// y = 8, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c264 = c265, c264_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x431, xp_3 = x431_p_2, xp_2 = x431_p_1, xp_1 = x431_p_0, xp_0 = 0;
									x < x431 + 2;
