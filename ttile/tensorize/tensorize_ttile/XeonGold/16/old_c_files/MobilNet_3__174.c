			...
			for (f = f70, fp_0 = 0;
				...
				for (c75 = c76, c75_p_0 = 0;
					...
					for (w = w48, wp_0 = 0;
						...
						// T (x, 14) (14 / 1)
						for (x = x86, xp_2 = x86_p_1, xp_1 = x86_p_0, xp_0 = 0;
							x < x86 + 14;
							...
							for (h = h39, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										mem_vec_526 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_527 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_526);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_527);
							}
						}
					}
				}
