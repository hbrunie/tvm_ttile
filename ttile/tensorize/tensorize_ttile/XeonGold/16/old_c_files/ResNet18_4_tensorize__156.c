...
*/
IND_TYPE c, cp_0, c78_p_0, cp_1, c78, f, fp_0, f78_p_0, fp_1, f78, h, hp_0, w, wp_0, x, xp_0, x77_p_0, xp_1, x77, y, yp_0;
IND_TYPE y52 = 0;
IND_TYPE x78 = 0;
IND_TYPE h49 = 0;
IND_TYPE w48 = 0;
...
c78_p_0 = 0;
					for (w = w48, wp_0 = 0;w < w48 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 14) (14 / 1)
						for (x = x77, xp_1 = x77_p_0, xp_0 = 0;x < x77 + 14;x += 1, xp_1 += 1, xp_0 += 1){
							...
							for (h = h49, hp_0 = 0;h < h49 + 3;h += 1, hp_0 += 1){
										...
										mem_vec_730 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
										mem_vec_731 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
										mem_vec_732 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_733 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										mem_vec_734 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_735 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
										mem_vec_736 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										mem_vec_737 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
										mem_vec_738 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_739 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
										mem_vec_740 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_741 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
										...
										for (c = c78, cp_1 = c78_p_0, cp_0 = 0;c < c78 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_736);
											mem_vec_736 = vec_35;
											vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_737);
											mem_vec_737 = vec_37;
											scal_12 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 12) + h) + c];
											vec_39 = _mm512_set1_ps(scal_12);
											vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_738);
											mem_vec_738 = vec_38;
											vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_739);
											mem_vec_739 = vec_40;
											scal_13 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 13) + h) + c];
											vec_42 = _mm512_set1_ps(scal_13);
											vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_740);
											mem_vec_740 = vec_41;
											vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_741);
											mem_vec_741 = vec_43;
										}
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_730);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_731);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_732);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_733);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_734);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_735);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_736);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_737);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_738);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_739);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_740);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_741);
							}
						}
					}
}
