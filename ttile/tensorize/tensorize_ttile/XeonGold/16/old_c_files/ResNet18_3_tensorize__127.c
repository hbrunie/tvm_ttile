...
*/
IND_TYPE c, cp_0, c243_p_0, cp_1, c243, x, xp_0, x402_p_0, x403_p_0, xp_1, x402_p_1, xp_2, x402, x403, y, yp_0, y321_p_0, yp_1, y321;
IND_TYPE y322 = 0;
IND_TYPE x404 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c243 = 0;
c243_p_0 = 0;
					for (x = x402, xp_2 = x402_p_1, xp_1 = x402_p_0, xp_0 = 0;x < x402 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
