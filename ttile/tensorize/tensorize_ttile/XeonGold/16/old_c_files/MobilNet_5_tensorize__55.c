...
*/
IND_TYPE c, cp_0, c18_p_0, cp_1, c18, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x18_p_0, x19_p_0, xp_1, x18_p_1, xp_2, x18, x19, y, yp_0, y12_p_0, yp_1, y12;
IND_TYPE y13 = 0;
IND_TYPE x20 = 0;
IND_TYPE h12 = 0;
IND_TYPE w6 = 0;
...
c18_p_0 = 0;
						for (w = w6, wp_0 = 0;w < w6 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 14) (14 / 1)
							for (x = x18, xp_2 = x18_p_1, xp_1 = x18_p_0, xp_0 = 0;x < x18 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
