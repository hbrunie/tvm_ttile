...
x430_p_0 = 0;
					for (w = w324, wp_0 = 0;w < w324 + 3;w += 1, wp_0 += 1){
						...
						// T (c, 1) (32 / 32)
						for (c486 = c487, c486_p_0 = 0;c486 < c487 + 32;c486 += 32, c486_p_0 += 32){
							// y = ph_y, x = 14, h = 3, w = 1, c = 32, f = 16
							// T (x, 14) (14 / 1)
							for (x = x430, xp_1 = x430_p_0, xp_0 = 0;x < x430 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_3882 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										mem_vec_3883 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
										mem_vec_3884 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_3885 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_3886 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_3887 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										mem_vec_3888 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
										mem_vec_3889 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
										mem_vec_3890 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
										...
										mem_vec_3894 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_3883);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_3884);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_3885);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3886);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3887);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_3888);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_3889);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3890);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3894);
							}
						}
					}
}
