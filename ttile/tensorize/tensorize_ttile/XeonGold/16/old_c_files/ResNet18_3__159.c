...
for (y580 = y581, y580_p_0 = 0;
	...
	for (x728 = x729, x728_p_0 = 0;
		...
		// T (y, 1) (56 / 56)
		for (y579 = y580, y579_p_1 = y580_p_0, y579_p_0 = 0;
			y579 < y580 + 56;
			y579 += 56, y579_p_1 += 56, y579_p_0 += 56){
			// y = 56, x = 28, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (28 / 2)
			for (x727 = x728, x727_p_1 = x728_p_0, x727_p_0 = 0;
				x727 < x728 + 28;
				x727 += 2, x727_p_1 += 2, x727_p_0 += 2){
				...
				for (f = f285, fp_0 = 0;
					...
					// T (y, 4) (56 / 14)
					for (y = y579, yp_2 = y579_p_1, yp_1 = y579_p_0, yp_0 = 0;
						y < y579 + 56;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 2) (2 / 1)
						for (x726 = x727, x726_p_2 = x727_p_1, x726_p_1 = x727_p_0, x726_p_0 = 0;
							x726 < x727 + 2;
							x726 += 1, x726_p_2 += 1, x726_p_1 += 1, x726_p_0 += 1){
							...
							for (c441 = c442, c441_p_0 = 0;
								...
								// y = 14, x = 1, h = 1, w = 1, c = 64, f = 32
								// T (x, 1) (1 / 1)
								for (x = x726, xp_3 = x726_p_2, xp_2 = x726_p_1, xp_1 = x726_p_0, xp_0 = 0;
									x < x726 + 1;
