...
y159 = 0;
y159_p_0 = 0;
	for (f = f101, fp_0 = 0;f < f101 + 64;f += 32, fp_0 += 32){
			for (y = y159, yp_1 = y159_p_0, yp_0 = 0;y < y159 + 20;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 4) (112 / 28)
				for (x154 = x155, x154_p_0 = 0;x154 < x155 + 112;x154 += 28, x154_p_0 += 28){
					// y = ph_y, x = 28, h = 7, w = 7, c = 3, f = 32
					// T (h, 7) (7 / 1)
					for (h = h106, hp_0 = 0;h < h106 + 7;h += 1, hp_0 += 1){
						// y = ph_y, x = 28, h = 1, w = 7, c = 3, f = 32
						// T (w, 7) (7 / 1)
						for (w = w106, wp_0 = 0;w < w106 + 7;w += 1, wp_0 += 1){
							// y = ph_y, x = 28, h = 1, w = 1, c = 3, f = 32
							// T (c, 1) (3 / 3)
							for (c159 = c160, c159_p_0 = 0;c159 < c160 + 3;c159 += 3, c159_p_0 += 3){
								// y = ph_y, x = 28, h = 1, w = 1, c = 3, f = 32
								// T (x, 28) (28 / 1)
								for (x = x154, xp_1 = x154_p_0, xp_0 = 0;x < x154 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 3) (3 / 1)
											for (c = c159, cp_1 = c159_p_0, cp_0 = 0;c < c159 + 3;c += 1, cp_1 += 1, cp_0 += 1){
			...
			for (y = y159 + 20, yp_1 = y159_p_0, yp_0 = 0;y < y159 + 20 + 36;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 4) (112 / 28)
				for (x154 = x155, x154_p_0 = 0;x154 < x155 + 112;x154 += 28, x154_p_0 += 28){
					// y = ph_y, x = 28, h = 7, w = 7, c = 3, f = 32
						...
						for (w = w106, wp_0 = 0;w < w106 + 7;w += 1, wp_0 += 1){
							...
							for (c159 = c160, c159_p_0 = 0;c159 < c160 + 3;c159 += 3, c159_p_0 += 3){
								...
								for (x = x154, xp_1 = x154_p_0, xp_0 = 0;x < x154 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_1744 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_1745 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
											mem_vec_1746 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_1747 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
											mem_vec_1748 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
											mem_vec_1749 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
											mem_vec_1750 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
											mem_vec_1751 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 3, f = 32
											// T (c, 3) (3 / 1)
											for (c = c159, cp_1 = c159_p_0, cp_0 = 0;c < c159 + 3;c += 1, cp_1 += 1, cp_0 += 1){
												scal_0 = input[strideA1 * (2 * x + w) + strideA2 * (2 * y + h) + c];
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_1744);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_1745);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_1746);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_1747);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_1748);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_1749);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_1750);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_1751);
								}
							}
						}
					}
