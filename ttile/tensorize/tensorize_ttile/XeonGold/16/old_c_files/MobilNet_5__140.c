...
[V f; U (4, f); U (7, y); U (3, w); T (256, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (1, c); T (1, f); T (4, y); T (1, x); T (1, f); T (4, f)]
*/
IND_TYPE c, cp_0, c15_p_0, cp_1, c15, f, fp_0, f20_p_0, f21_p_0, fp_1, f20_p_1, fp_2, f20, f21, h, hp_0, x, xp_0, x15_p_0, xp_1, x15, y, yp_0;
