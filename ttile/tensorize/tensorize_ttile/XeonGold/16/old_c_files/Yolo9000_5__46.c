			...
			f += 32, fp_0 += 32){
				for (y = y33, yp_1 = y33_p_0, yp_0 = 0;
					...
					for (x = x33, xp_1 = x33_p_0, xp_0 = 0;
						x < x33 + 1;
						x += 1, xp_1 += 1, xp_0 += 1){
								mem_vec_450 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
								mem_vec_451 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
								mem_vec_452 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
								mem_vec_453 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
								mem_vec_454 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
								mem_vec_455 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
								...
								mem_vec_462 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
								mem_vec_463 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
								mem_vec_464 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
								mem_vec_465 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c22, cp_0 = 0;
									c < c22 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_450);
							_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_451);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_452);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_453);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_454);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_455);
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_462);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_463);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_464);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_465);
					}
				}
				for (y = y33 + 24, yp_1 = y33_p_0, yp_0 = 0;
					y < y33 + 24 + 44;
