...
[V f; U (2, f); U (14, y); T (32, c); Hoist_vars [c]; T (3, h); T (14, x);
  T (3, w); T (8, c); T (1, x); T (2, y); T (8, f); T (2, x); T (1, y)]
*/
IND_TYPE c, cp_0, c24_p_0, cp_1, c24, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x26_p_0, x27_p_0, xp_1, x26_p_1, xp_2, x26, x27, y, yp_0, y18_p_0, yp_1, y18;
IND_TYPE y19 = 0;
IND_TYPE x28 = 0;
IND_TYPE h16 = 0;
IND_TYPE w10 = 0;
...
c24_p_0 = 0;
						for (w = w10, wp_0 = 0;w < w10 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 14) (14 / 1)
							for (x = x26, xp_2 = x26_p_1, xp_1 = x26_p_0, xp_0 = 0;x < x26 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
