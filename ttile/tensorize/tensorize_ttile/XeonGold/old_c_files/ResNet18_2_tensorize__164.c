...
[V f; U (2, f); U (8, y); T (32, c); Hoist_vars [c]; T (3, h); T (14, x);
  T (3, w); T (2, c); T (2, f); T (2, x); T (7, y); T (2, x)]
*/
IND_TYPE c, cp_0, c183_p_0, cp_1, c183, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x236_p_0, x237_p_0, xp_1, x236_p_1, xp_2, x236, x237, y, yp_0;
IND_TYPE y126 = 0;
IND_TYPE x238 = 0;
IND_TYPE h106 = 0;
IND_TYPE w110 = 0;
...
c183_p_0 = 0;
					for (w = w110, wp_0 = 0;w < w110 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 14) (14 / 1)
						for (x = x236, xp_2 = x236_p_1, xp_1 = x236_p_0, xp_0 = 0;x < x236 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
