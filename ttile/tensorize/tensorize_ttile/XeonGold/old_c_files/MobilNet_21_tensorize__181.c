...
c507_p_0 = 0;
					for (h = h287, hp_0 = 0;h < h287 + 3;h += 1, hp_0 += 1){
						...
						for (x = x634, xp_2 = x634_p_1, xp_1 = x634_p_0, xp_0 = 0;x < x634 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_5482 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
									mem_vec_5483 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_5482);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_5483);
						}
					}
}
