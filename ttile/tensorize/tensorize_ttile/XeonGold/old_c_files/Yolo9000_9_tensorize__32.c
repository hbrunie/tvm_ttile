...
y60 = 0;
y60_p_0 = 0;
	for (x81 = x82, x81_p_0 = 0;x81 < x82 + 68;x81 += 17, x81_p_0 += 17){
			for (y = y60, yp_1 = y60_p_0, yp_0 = 0;y < y60 + 6;y += 6, yp_1 += 6, yp_0 += 6){
				// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (17 / 17)
				for (x80 = x81, x80_p_1 = x81_p_0, x80_p_0 = 0;x80 < x81 + 17;x80 += 17, x80_p_1 += 17, x80_p_0 += 17){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 128
					// T (f, 2) (128 / 64)
					for (f = f40, fp_0 = 0;f < f40 + 128;f += 64, fp_0 += 64){
						// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 64
						// T (c, 4) (256 / 64)
						for (c60 = c61, c60_p_0 = 0;c60 < c61 + 256;c60 += 64, c60_p_0 += 64){
							...
							for (x = x80, xp_2 = x80_p_1, xp_1 = x80_p_0, xp_0 = 0;x < x80 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1058 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
										mem_vec_1059 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
										...
										mem_vec_1062 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32]);
										mem_vec_1063 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_1058);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_1059);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 32], mem_vec_1062);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 48], mem_vec_1063);
							}
						}
					}
				}
			}
			for (y = y60 + 6, yp_1 = y60_p_0, yp_0 = 0;y < y60 + 6 + 28;y += 7, yp_1 += 7, yp_0 += 7){
				// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (17 / 17)
				for (x80 = x81, x80_p_1 = x81_p_0, x80_p_0 = 0;x80 < x81 + 17;x80 += 17, x80_p_1 += 17, x80_p_0 += 17){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 128
