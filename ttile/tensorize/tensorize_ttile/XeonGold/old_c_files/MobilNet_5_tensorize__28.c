...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (8, c); T (4, f); T (7, y); T (1, x); T (1, f); T (1, f)]
*/
IND_TYPE c, cp_0, c108_p_0, cp_1, c108, f, fp_0, f132_p_0, f133_p_0, fp_1, f132_p_1, fp_2, f132, f133, h, hp_0, x, xp_0, x110_p_0, xp_1, x110, y, yp_0;
IND_TYPE y78 = 0;
IND_TYPE x111 = 0;
IND_TYPE h70 = 0;
IND_TYPE w = 0;
...
c108_p_0 = 0;
						for (h = h70, hp_0 = 0;h < h70 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 28) (28 / 1)
							for (x = x110, xp_1 = x110_p_0, xp_0 = 0;x < x110 + 28;x += 1, xp_1 += 1, xp_0 += 1){
