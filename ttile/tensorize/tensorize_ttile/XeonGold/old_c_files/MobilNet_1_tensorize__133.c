...
y108 = 0;
y108_p_0 = 0;
	for (c108 = c109, c108_p_0 = 0;c108 < c109 + 32;c108 += 32, c108_p_0 += 32){
			for (y = y108, yp_1 = y108_p_0, yp_0 = 0;y < y108 + 90;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x72, xp_0 = 0;x < x72 + 112;x += 1, xp_0 += 1){
					...
					for (h = h68, hp_0 = 0;h < h68 + 3;h += 1, hp_0 += 1){
						...
						for (w = w72, wp_0 = 0;w < w72 + 3;w += 1, wp_0 += 1){
									...
									mem_vec_1504 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_1505 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
									mem_vec_1506 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									mem_vec_1507 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_1504);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_1505);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_1506);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_1507);
						}
					}
				}
			}
			for (y = y108 + 90, yp_1 = y108_p_0, yp_0 = 0;y < y108 + 90 + 22;y += 11, yp_1 += 11, yp_0 += 11){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x72, xp_0 = 0;x < x72 + 112;x += 1, xp_0 += 1){
					// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 32
