...
y102 = 0;
y102_p_0 = 0;
	for (c102 = c103, c102_p_0 = 0;c102 < c103 + 32;c102 += 32, c102_p_0 += 32){
			for (y = y102, yp_1 = y102_p_0, yp_0 = 0;y < y102 + 56;y += 8, yp_1 += 8, yp_0 += 8){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x68, xp_0 = 0;x < x68 + 112;x += 1, xp_0 += 1){
			...
			for (y = y102 + 56, yp_1 = y102_p_0, yp_0 = 0;y < y102 + 56 + 56;y += 14, yp_1 += 14, yp_0 += 14){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x68, xp_0 = 0;x < x68 + 112;x += 1, xp_0 += 1){
					// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 32
