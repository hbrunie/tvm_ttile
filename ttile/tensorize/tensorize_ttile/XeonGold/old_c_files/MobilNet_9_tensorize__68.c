...
*/
IND_TYPE c, cp_0, c650_p_0, c651_p_0, c652_p_0, cp_1, c650_p_1, c651_p_1, cp_2, c650_p_2, cp_3, c650, c651, c652, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y260 = 0;
IND_TYPE x260 = 0;
IND_TYPE h = 0;
IND_TYPE w224 = 0;
...
xp_0 = 0;
						for (w = w224, wp_0 = 0;w < w224 + 3;w += 1, wp_0 += 1){
									...
									// T (c, 16) (16 / 1)
									for (c = c650, cp_3 = c650_p_2, cp_2 = c650_p_1, cp_1 = c650_p_0, cp_0 = 0;c < c650 + 16;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
