...
[V f; U (2, f); U (8, y); T (3, c); Hoist_vars [c]; T (1, x); T (1, c);
  T (3, w); T (3, h); T (34, y); T (544, x); T (1, x); T (2, y)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, h, hp_0, w, wp_0, x, x0, xp_0, x0_p_0, x1_p_0, x1, xp_1, x0_p_1, xp_2, y, y0, yp_0, y0_p_0, yp_1;
IND_TYPE y1 = 0;
IND_TYPE x2 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
...
yp_1 = 0;
				for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
					...
					for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
						...
						// T (c, 1) (3 / 3)
						for (c0 = c1, c0_p_0 = 0;c0 < c1 + 3;c0 += 3, c0_p_0 += 3){
							// y = 8, x = 1, h = 1, w = 1, c = 3, f = 32
							// T (x, 1) (1 / 1)
