						...
						for (w = w134, wp_0 = 0;w < w134 + 3;w += 1, wp_0 += 1){
							...
							for (x = x217, xp_1 = x217_p_0, xp_0 = 0;x < x217 + 4;x += 1, xp_1 += 1, xp_0 += 1){
								...
								for (h = h135, hp_0 = 0;h < h135 + 3;h += 1, hp_0 += 1){
											...
											mem_vec_2178 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
											mem_vec_2179 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
											mem_vec_2180 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
											mem_vec_2181 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_2178);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_2179);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_2180);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_2181);
								}
							}
						}
}
