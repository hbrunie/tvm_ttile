...
x337_p_0 = 0;
		for (f = f168, fp_0 = 0;f < f168 + 256;f += 32, fp_0 += 32){
				for (y = y244, yp_1 = y244_p_0, yp_0 = 0;y < y244 + 8;y += 8, yp_1 += 8, yp_0 += 8){
					// y = ph_y, x = 34, h = 1, w = 1, c = 512, f = 32
					// T (x, 17) (34 / 2)
					for (x336 = x337, x336_p_1 = x337_p_0, x336_p_0 = 0;x336 < x337 + 34;x336 += 2, x336_p_1 += 2, x336_p_0 += 2){
						// y = ph_y, x = 2, h = 1, w = 1, c = 512, f = 32
						// T (c, 1) (512 / 512)
						for (c252 = c253, c252_p_0 = 0;c252 < c253 + 512;c252 += 512, c252_p_0 += 512){
							// y = ph_y, x = 2, h = 1, w = 1, c = 512, f = 32
							// T (x, 2) (2 / 1)
							for (x = x336, xp_2 = x336_p_1, xp_1 = x336_p_0, xp_0 = 0;x < x336 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 512) (512 / 1)
										for (c = c252, cp_1 = c252_p_0, cp_0 = 0;c < c252 + 512;c += 1, cp_1 += 1, cp_0 += 1){
				...
				for (y = y244 + 8, yp_1 = y244_p_0, yp_0 = 0;y < y244 + 8 + 9;y += 9, yp_1 += 9, yp_0 += 9){
					// y = ph_y, x = 34, h = 1, w = 1, c = 512, f = 32
					// T (x, 17) (34 / 2)
					for (x336 = x337, x336_p_1 = x337_p_0, x336_p_0 = 0;x336 < x337 + 34;x336 += 2, x336_p_1 += 2, x336_p_0 += 2){
						// y = ph_y, x = 2, h = 1, w = 1, c = 512, f = 32
