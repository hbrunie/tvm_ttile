...
c171_p_0 = 0;
							for (w = w105, wp_0 = 0;w < w105 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 17) (17 / 1)
								for (x = x171, xp_1 = x171_p_0, xp_0 = 0;x < x171 + 17;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (h = h114, hp_0 = 0;h < h114 + 3;h += 1, hp_0 += 1){
												...
												mem_vec_2394 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
												mem_vec_2395 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
												mem_vec_2396 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
												mem_vec_2397 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_2394);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_2395);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_2396);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_2397);
									}
								}
							}
}
