						...
						for (w = w345, wp_0 = 0;w < w345 + 3;w += 1, wp_0 += 1){
							...
							for (x = x722, xp_2 = x722_p_1, xp_1 = x722_p_0, xp_0 = 0;x < x722 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								for (h = h325, hp_0 = 0;h < h325 + 3;h += 1, hp_0 += 1){
											...
											mem_vec_6502 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
											mem_vec_6503 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_6502);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_6503);
								}
							}
						}
}
