...
*/
IND_TYPE c, cp_0, c69_p_0, cp_1, c69, h, hp_0, w, wp_0, x, xp_0, y, yp_0, y69_p_0, yp_1, y69;
IND_TYPE y70 = 0;
IND_TYPE x46 = 0;
IND_TYPE h46 = 0;
IND_TYPE w46 = 0;
...
xp_0 = 0;
					for (h = h46, hp_0 = 0;h < h46 + 3;h += 1, hp_0 += 1){
						...
						for (w = w46, wp_0 = 0;w < w46 + 3;w += 1, wp_0 += 1){
									...
									mem_vec_948 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									mem_vec_949 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									mem_vec_950 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
									mem_vec_951 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
									mem_vec_952 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									mem_vec_953 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
									mem_vec_954 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
									mem_vec_955 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
									...
									for (c = c69, cp_1 = c69_p_0, cp_0 = 0;c < c69 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_948);
										mem_vec_948 = vec_32;
										vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_949);
										mem_vec_949 = vec_34;
										scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 11 + h) + c];
										vec_36 = _mm512_set1_ps(scal_11);
										vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_950);
										mem_vec_950 = vec_35;
										vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_951);
										mem_vec_951 = vec_37;
										scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 12 + h) + c];
										vec_39 = _mm512_set1_ps(scal_12);
										vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_952);
										mem_vec_952 = vec_38;
										vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_953);
										mem_vec_953 = vec_40;
										scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 13 + h) + c];
										vec_42 = _mm512_set1_ps(scal_13);
										vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_954);
										mem_vec_954 = vec_41;
										vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_955);
										mem_vec_955 = vec_43;
									}
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_948);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_949);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_950);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_951);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_952);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_953);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_954);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_955);
						}
					}
}
