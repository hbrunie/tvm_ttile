...
*/
IND_TYPE c, cp_0, c153_p_0, cp_1, c153, f, fp_0, f153_p_0, fp_1, f153, h, hp_0, x, xp_0, x137_p_0, xp_1, x137, y, yp_0;
IND_TYPE y102 = 0;
IND_TYPE x138 = 0;
IND_TYPE h81 = 0;
IND_TYPE w = 0;
...
c153_p_0 = 0;
					for (h = h81, hp_0 = 0;h < h81 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 28) (28 / 1)
						for (x = x137, xp_1 = x137_p_0, xp_0 = 0;x < x137 + 28;x += 1, xp_1 += 1, xp_0 += 1){
