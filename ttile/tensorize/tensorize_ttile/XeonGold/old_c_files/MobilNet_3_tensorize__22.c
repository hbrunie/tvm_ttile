...
[V f; U (2, f); U (8, y); T (16, c); Hoist_vars [c]; T (3, h); T (14, x);
  T (3, w); T (8, c); T (4, f); T (4, x); T (7, y); T (1, x)]
*/
IND_TYPE c, cp_0, c315_p_0, cp_1, c315, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x352_p_0, x353_p_0, xp_1, x352_p_1, xp_2, x352, x353, y, yp_0;
IND_TYPE y210 = 0;
IND_TYPE x354 = 0;
IND_TYPE h157 = 0;
IND_TYPE w190 = 0;
...
c315_p_0 = 0;
					for (w = w190, wp_0 = 0;w < w190 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 14) (14 / 1)
						for (x = x352, xp_2 = x352_p_1, xp_1 = x352_p_0, xp_0 = 0;x < x352 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
