...
*/
IND_TYPE c, cp_0, c80_p_0, c81_p_0, c82_p_0, cp_1, c80_p_1, c81_p_1, cp_2, c80_p_2, cp_3, c80, c81, c82, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
...
for (c82 = c83, c82_p_0 = 0;
	c82 < c83 + 1024;
	c82 += 1024, c82_p_0 += 1024){
	// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
	// T (c, 2) (1024 / 512)
	for (c81 = c82, c81_p_1 = c82_p_0, c81_p_0 = 0;
		c81 < c82 + 1024;
		c81 += 512, c81_p_1 += 512, c81_p_0 += 512){
		...
		for (f = f32, fp_0 = 0;
			...
			for (y = y32, yp_0 = 0;
				...
				for (c80 = c81, c80_p_2 = c81_p_1, c80_p_1 = c81_p_0, c80_p_0 = 0;
					c80 < c81 + 512;
					c80 += 16, c80_p_2 += 16, c80_p_1 += 16, c80_p_0 += 16){
