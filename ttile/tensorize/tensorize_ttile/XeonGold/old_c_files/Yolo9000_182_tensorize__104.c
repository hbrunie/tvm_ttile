...
[V f; U (2, f); ULambda y; T (8, c); Hoist_vars [c]; T (3, w); T (3, h);
  ...
  T (2, c); T (1, c)]
*/
IND_TYPE c, cp_0, c90_p_0, c91_p_0, c92_p_0, cp_1, c90_p_1, c91_p_1, cp_2, c90_p_2, cp_3, c90, c91, c92, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y36 = 0;
IND_TYPE x36 = 0;
IND_TYPE h30 = 0;
IND_TYPE w30 = 0;
...
xp_0 = 0;
							for (h = h30, hp_0 = 0;h < h30 + 3;h += 1, hp_0 += 1){
								...
								for (w = w30, wp_0 = 0;w < w30 + 3;w += 1, wp_0 += 1){
											...
											mem_vec_788 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
											mem_vec_789 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 8, f = 32
											// T (c, 8) (8 / 1)
											for (c = c90, cp_3 = c90_p_2, cp_2 = c90_p_1, cp_1 = c90_p_0, cp_0 = 0;c < c90 + 8;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
												...
												vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_788);
												mem_vec_788 = vec_26;
												vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_789);
												mem_vec_789 = vec_28;
											}
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_788);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_789);
								}
							}
}
