...
[V f; U (2, f); U (14, y); T (3, c); Hoist_vars [c]; T (14, x); T (1, c);
  T (7, w); T (7, h); T (8, x); T (8, y); T (2, f); T (1, y)]
*/
IND_TYPE c, cp_0, c39_p_0, cp_1, c39, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x34_p_0, xp_1, x34, y, yp_0, y39_p_0, yp_1, y39;
IND_TYPE y40 = 0;
IND_TYPE x35 = 0;
IND_TYPE h26 = 0;
IND_TYPE w26 = 0;
				...
				for (h = h26, hp_0 = 0;h < h26 + 7;h += 1, hp_0 += 1){
					...
					for (w = w26, wp_0 = 0;w < w26 + 7;w += 1, wp_0 += 1){
						...
						for (c39 = c40, c39_p_0 = 0;c39 < c40 + 3;c39 += 3, c39_p_0 += 3){
							// y = 14, x = 14, h = 1, w = 1, c = 3, f = 32
							// T (x, 14) (14 / 1)
							for (x = x34, xp_1 = x34_p_0, xp_0 = 0;x < x34 + 14;x += 1, xp_1 += 1, xp_0 += 1){
