							...
							for (w = w227, wp_0 = 0;w < w227 + 3;w += 1, wp_0 += 1){
								...
								for (x = x375, xp_1 = x375_p_0, xp_0 = 0;x < x375 + 17;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (h = h247, hp_0 = 0;h < h247 + 3;h += 1, hp_0 += 1){
												...
												mem_vec_4786 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
												mem_vec_4787 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_4786);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_4787);
									}
								}
							}
}
