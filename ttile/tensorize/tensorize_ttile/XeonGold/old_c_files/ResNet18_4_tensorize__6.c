...
/*
[V f; U (2, f); U (14, y); T (64, c); Hoist_vars [c]; T (3, h); T (2, x);
  T (3, w); T (1, c); T (1, f); T (14, x); T (2, y); T (4, f)]
*/
IND_TYPE c, cp_0, c27_p_0, cp_1, c27, f, fp_0, f27_p_0, fp_1, f27, h, hp_0, w, wp_0, x, xp_0, x27_p_0, xp_1, x27, y, yp_0;
IND_TYPE y18 = 0;
IND_TYPE x28 = 0;
IND_TYPE h18 = 0;
IND_TYPE w18 = 0;
...
c27_p_0 = 0;
					for (w = w18, wp_0 = 0;w < w18 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 2) (2 / 1)
						for (x = x27, xp_1 = x27_p_0, xp_0 = 0;x < x27 + 2;x += 1, xp_1 += 1, xp_0 += 1){
