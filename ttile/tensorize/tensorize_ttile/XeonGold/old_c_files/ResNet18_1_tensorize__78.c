...
y231 = 0;
y231_p_0 = 0;
	for (f = f149, fp_0 = 0;f < f149 + 64;f += 32, fp_0 += 32){
			for (y = y231, yp_1 = y231_p_0, yp_0 = 0;y < y231 + 30;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 16) (112 / 7)
				for (x226 = x227, x226_p_0 = 0;x226 < x227 + 112;x226 += 7, x226_p_0 += 7){
					...
					for (h = h154, hp_0 = 0;h < h154 + 7;h += 1, hp_0 += 1){
						...
						for (w = w154, wp_0 = 0;w < w154 + 7;w += 1, wp_0 += 1){
							...
							for (c231 = c232, c231_p_0 = 0;c231 < c232 + 3;c231 += 3, c231_p_0 += 3){
								// y = ph_y, x = 7, h = 1, w = 1, c = 3, f = 32
								// T (x, 7) (7 / 1)
								for (x = x226, xp_1 = x226_p_0, xp_0 = 0;x < x226 + 7;x += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y231 + 30, yp_1 = y231_p_0, yp_0 = 0;y < y231 + 30 + 26;y += 13, yp_1 += 13, yp_0 += 13){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 16) (112 / 7)
				for (x226 = x227, x226_p_0 = 0;x226 < x227 + 112;x226 += 7, x226_p_0 += 7){
					// y = ph_y, x = 7, h = 7, w = 7, c = 3, f = 32
