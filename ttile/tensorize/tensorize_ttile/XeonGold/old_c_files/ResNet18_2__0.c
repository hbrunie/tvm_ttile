	...
	x125 += 28, x125_p_0 += 28){
		for (y = y70, yp_0 = 0;
			...
			for (x124 = x125, x124_p_1 = x125_p_0, x124_p_0 = 0;
				x124 < x125 + 28;
				x124 += 28, x124_p_1 += 28, x124_p_0 += 28){
				// y = ph_y, x = 28, h = 3, w = 3, c = 64, f = 64
				// T (f, 2) (64 / 32)
				for (f = f57, fp_0 = 0;
					f < f57 + 64;
							...
							for (x = x124, xp_2 = x124_p_1, xp_1 = x124_p_0, xp_0 = 0;
								...
								for (h = h60, hp_0 = 0;
									...
									h += 1, hp_0 += 1){
											...
											mem_vec_944 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
											mem_vec_945 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
											mem_vec_946 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
											mem_vec_947 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
											mem_vec_948 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
											mem_vec_949 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
											mem_vec_950 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_951 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_944);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_945);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_946);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_947);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_948);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_949);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_950);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_951);
								}
							}
						}
					}
