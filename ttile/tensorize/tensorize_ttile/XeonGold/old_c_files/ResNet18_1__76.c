...
for (y267 = y268, y267_p_0 = 0;
	...
	for (f = f173, fp_0 = 0;
		...
		f += 32, fp_0 += 32){
							...
							for (c267 = c268, c267_p_0 = 0;
								...
								for (x = x262, xp_1 = x262_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3358 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
											mem_vec_3359 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_3358);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_3359);
								}
							}
						}
					}
			...
			for (y = y267 + 70, yp_1 = y267_p_0, yp_0 = 0;
				y < y267 + 70 + 42;
