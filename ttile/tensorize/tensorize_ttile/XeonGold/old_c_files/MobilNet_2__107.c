...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, c); T (1, x); T (8, y); T (4, x)]
*/
IND_TYPE c, cp_0, c378_p_0, cp_1, c378, h, hp_0, x, xp_0, x478_p_0, x479_p_0, xp_1, x478_p_1, xp_2, x478, x479, y, yp_0;
...
for (x479 = x480, x479_p_0 = 0;
	...
	for (y = y265, yp_0 = 0;
		...
		for (x478 = x479, x478_p_1 = x479_p_0, x478_p_0 = 0;
			x478 < x479 + 14;
			x478 += 14, x478_p_1 += 14, x478_p_0 += 14){
			// y = 7, x = 14, h = 3, w = 3, c = 64, f = 64
			// T (c, 2) (64 / 32)
				...
				for (h = h221, hp_0 = 0;
					...
					for (x = x478, xp_2 = x478_p_1, xp_1 = x478_p_0, xp_0 = 0;
						...
						x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_3846 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32]);
								mem_vec_3847 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48]);
								mem_vec_3848 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
								mem_vec_3849 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
								mem_vec_3850 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32]);
								mem_vec_3851 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48]);
								mem_vec_3852 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
								mem_vec_3853 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
								mem_vec_3854 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32]);
								mem_vec_3855 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48]);
								...
								for (c = c378, cp_1 = c378_p_0, cp_0 = 0;
									...
									vec_34 = _mm512_fmadd_ps(vec_35, vec_2, mem_vec_3852);
									mem_vec_3852 = vec_34;



									vec_36 = _mm512_fmadd_ps(vec_35, vec_4, mem_vec_3853);
									mem_vec_3853 = vec_36;



									vec_37 = _mm512_fmadd_ps(vec_35, vec_6, mem_vec_3854);
									mem_vec_3854 = vec_37;



									vec_38 = _mm512_fmadd_ps(vec_35, vec_8, mem_vec_3855);
									mem_vec_3855 = vec_38;
									scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * y + h) + c];
									vec_40 = _mm512_set1_ps(scal_7);
									vec_41 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

									vec_39 = _mm512_fmadd_ps(vec_40, vec_41, mem_vec_3828);
									mem_vec_3828 = vec_39;

									vec_43 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

									vec_42 = _mm512_fmadd_ps(vec_40, vec_43, mem_vec_3829);
									mem_vec_3829 = vec_42;

									vec_45 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 32]);

									vec_44 = _mm512_fmadd_ps(vec_40, vec_45, mem_vec_3830);
									mem_vec_3830 = vec_44;

									vec_47 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 48]);

									vec_46 = _mm512_fmadd_ps(vec_40, vec_47, mem_vec_3831);
									mem_vec_3831 = vec_46;
									scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 1) + h) + c];
									vec_49 = _mm512_set1_ps(scal_8);


									vec_48 = _mm512_fmadd_ps(vec_49, vec_41, mem_vec_3832);
									mem_vec_3832 = vec_48;



									vec_50 = _mm512_fmadd_ps(vec_49, vec_43, mem_vec_3833);
									mem_vec_3833 = vec_50;



									vec_51 = _mm512_fmadd_ps(vec_49, vec_45, mem_vec_3834);
									mem_vec_3834 = vec_51;



									vec_52 = _mm512_fmadd_ps(vec_49, vec_47, mem_vec_3835);
									mem_vec_3835 = vec_52;
									scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 2) + h) + c];
									vec_54 = _mm512_set1_ps(scal_9);


									vec_53 = _mm512_fmadd_ps(vec_54, vec_41, mem_vec_3836);
									mem_vec_3836 = vec_53;



									vec_55 = _mm512_fmadd_ps(vec_54, vec_43, mem_vec_3837);
									mem_vec_3837 = vec_55;



									vec_56 = _mm512_fmadd_ps(vec_54, vec_45, mem_vec_3838);
									mem_vec_3838 = vec_56;



									vec_57 = _mm512_fmadd_ps(vec_54, vec_47, mem_vec_3839);
									mem_vec_3839 = vec_57;
									scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 3) + h) + c];
									vec_59 = _mm512_set1_ps(scal_10);


									vec_58 = _mm512_fmadd_ps(vec_59, vec_41, mem_vec_3840);
									mem_vec_3840 = vec_58;



									vec_60 = _mm512_fmadd_ps(vec_59, vec_43, mem_vec_3841);
									mem_vec_3841 = vec_60;



									vec_61 = _mm512_fmadd_ps(vec_59, vec_45, mem_vec_3842);
									mem_vec_3842 = vec_61;



									vec_62 = _mm512_fmadd_ps(vec_59, vec_47, mem_vec_3843);
									mem_vec_3843 = vec_62;
									scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 4) + h) + c];
									vec_64 = _mm512_set1_ps(scal_11);


									vec_63 = _mm512_fmadd_ps(vec_64, vec_41, mem_vec_3844);
									mem_vec_3844 = vec_63;



									vec_65 = _mm512_fmadd_ps(vec_64, vec_43, mem_vec_3845);
									mem_vec_3845 = vec_65;



									vec_66 = _mm512_fmadd_ps(vec_64, vec_45, mem_vec_3846);
									mem_vec_3846 = vec_66;



									vec_67 = _mm512_fmadd_ps(vec_64, vec_47, mem_vec_3847);
									mem_vec_3847 = vec_67;
									scal_12 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 5) + h) + c];
									vec_69 = _mm512_set1_ps(scal_12);


									vec_68 = _mm512_fmadd_ps(vec_69, vec_41, mem_vec_3848);
									mem_vec_3848 = vec_68;



									vec_70 = _mm512_fmadd_ps(vec_69, vec_43, mem_vec_3849);
									mem_vec_3849 = vec_70;



									vec_71 = _mm512_fmadd_ps(vec_69, vec_45, mem_vec_3850);
									mem_vec_3850 = vec_71;



									vec_72 = _mm512_fmadd_ps(vec_69, vec_47, mem_vec_3851);
									mem_vec_3851 = vec_72;
									scal_13 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 1) + C * (2 * (y + 6) + h) + c];
									vec_74 = _mm512_set1_ps(scal_13);


									vec_73 = _mm512_fmadd_ps(vec_74, vec_41, mem_vec_3852);
									mem_vec_3852 = vec_73;



									vec_75 = _mm512_fmadd_ps(vec_74, vec_43, mem_vec_3853);
									mem_vec_3853 = vec_75;



									vec_76 = _mm512_fmadd_ps(vec_74, vec_45, mem_vec_3854);
									mem_vec_3854 = vec_76;



									vec_77 = _mm512_fmadd_ps(vec_74, vec_47, mem_vec_3855);
									mem_vec_3855 = vec_77;
									scal_14 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * y + h) + c];
									vec_79 = _mm512_set1_ps(scal_14);
									vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

									vec_78 = _mm512_fmadd_ps(vec_79, vec_80, mem_vec_3828);
									mem_vec_3828 = vec_78;

									vec_82 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

									vec_81 = _mm512_fmadd_ps(vec_79, vec_82, mem_vec_3829);
									mem_vec_3829 = vec_81;

									vec_84 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 32]);

									vec_83 = _mm512_fmadd_ps(vec_79, vec_84, mem_vec_3830);
									mem_vec_3830 = vec_83;

									vec_86 = _mm512_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 48]);

									vec_85 = _mm512_fmadd_ps(vec_79, vec_86, mem_vec_3831);
									mem_vec_3831 = vec_85;
									scal_15 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 1) + h) + c];
									vec_88 = _mm512_set1_ps(scal_15);


									vec_87 = _mm512_fmadd_ps(vec_88, vec_80, mem_vec_3832);
									mem_vec_3832 = vec_87;



									vec_89 = _mm512_fmadd_ps(vec_88, vec_82, mem_vec_3833);
									mem_vec_3833 = vec_89;



									vec_90 = _mm512_fmadd_ps(vec_88, vec_84, mem_vec_3834);
									mem_vec_3834 = vec_90;



									vec_91 = _mm512_fmadd_ps(vec_88, vec_86, mem_vec_3835);
									mem_vec_3835 = vec_91;
									scal_16 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 2) + h) + c];
									vec_93 = _mm512_set1_ps(scal_16);


									vec_92 = _mm512_fmadd_ps(vec_93, vec_80, mem_vec_3836);
									mem_vec_3836 = vec_92;



									vec_94 = _mm512_fmadd_ps(vec_93, vec_82, mem_vec_3837);
									mem_vec_3837 = vec_94;



									vec_95 = _mm512_fmadd_ps(vec_93, vec_84, mem_vec_3838);
									mem_vec_3838 = vec_95;



									vec_96 = _mm512_fmadd_ps(vec_93, vec_86, mem_vec_3839);
									mem_vec_3839 = vec_96;
									scal_17 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 3) + h) + c];
									vec_98 = _mm512_set1_ps(scal_17);


									vec_97 = _mm512_fmadd_ps(vec_98, vec_80, mem_vec_3840);
									mem_vec_3840 = vec_97;



									vec_99 = _mm512_fmadd_ps(vec_98, vec_82, mem_vec_3841);
									mem_vec_3841 = vec_99;



									vec_100 = _mm512_fmadd_ps(vec_98, vec_84, mem_vec_3842);
									mem_vec_3842 = vec_100;



									vec_101 = _mm512_fmadd_ps(vec_98, vec_86, mem_vec_3843);
									mem_vec_3843 = vec_101;
									scal_18 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 4) + h) + c];
									vec_103 = _mm512_set1_ps(scal_18);


									vec_102 = _mm512_fmadd_ps(vec_103, vec_80, mem_vec_3844);
									mem_vec_3844 = vec_102;



									vec_104 = _mm512_fmadd_ps(vec_103, vec_82, mem_vec_3845);
									mem_vec_3845 = vec_104;



									vec_105 = _mm512_fmadd_ps(vec_103, vec_84, mem_vec_3846);
									mem_vec_3846 = vec_105;



									vec_106 = _mm512_fmadd_ps(vec_103, vec_86, mem_vec_3847);
									mem_vec_3847 = vec_106;
									scal_19 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 5) + h) + c];
									vec_108 = _mm512_set1_ps(scal_19);


									vec_107 = _mm512_fmadd_ps(vec_108, vec_80, mem_vec_3848);
									mem_vec_3848 = vec_107;



									vec_109 = _mm512_fmadd_ps(vec_108, vec_82, mem_vec_3849);
									mem_vec_3849 = vec_109;



									vec_110 = _mm512_fmadd_ps(vec_108, vec_84, mem_vec_3850);
									mem_vec_3850 = vec_110;



									vec_111 = _mm512_fmadd_ps(vec_108, vec_86, mem_vec_3851);
									mem_vec_3851 = vec_111;
									scal_20 = input[(C * (2 * Y + H - 1)) * (2 * x + w + 2) + C * (2 * (y + 6) + h) + c];
									vec_113 = _mm512_set1_ps(scal_20);


									vec_112 = _mm512_fmadd_ps(vec_113, vec_80, mem_vec_3852);
									mem_vec_3852 = vec_112;



									vec_114 = _mm512_fmadd_ps(vec_113, vec_82, mem_vec_3853);
									mem_vec_3853 = vec_114;



									vec_115 = _mm512_fmadd_ps(vec_113, vec_84, mem_vec_3854);
									mem_vec_3854 = vec_115;



									vec_116 = _mm512_fmadd_ps(vec_113, vec_86, mem_vec_3855);
									mem_vec_3855 = vec_116;
								}
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 32], mem_vec_3846);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 48], mem_vec_3847);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_3848);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_3849);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 32], mem_vec_3850);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 48], mem_vec_3851);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_3852);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_3853);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 32], mem_vec_3854);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 48], mem_vec_3855);
					}
				}
			}
		}
