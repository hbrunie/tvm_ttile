...
y18_p_0 = 0;
	for (x25 = x26, x25_p_0 = 0;x25 < x26 + 68;x25 += 68, x25_p_0 += 68){
			for (y = y18, yp_1 = y18_p_0, yp_0 = 0;y < y18 + 6;y += 6, yp_1 += 6, yp_0 += 6){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 4) (68 / 17)
				for (x24 = x25, x24_p_1 = x25_p_0, x24_p_0 = 0;x24 < x25 + 68;x24 += 17, x24_p_1 += 17, x24_p_0 += 17){
			...
			for (y = y18 + 6, yp_1 = y18_p_0, yp_0 = 0;y < y18 + 6 + 28;y += 7, yp_1 += 7, yp_0 += 7){
				// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
				// T (x, 4) (68 / 17)
				for (x24 = x25, x24_p_1 = x25_p_0, x24_p_0 = 0;x24 < x25 + 68;x24 += 17, x24_p_1 += 17, x24_p_0 += 17){
					// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 128
