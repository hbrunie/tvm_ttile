...
[V f; U (2, f); ULambda y; T (32, c); Hoist_vars [c]; T (3, w); T (3, h);
  ...
  T (1, c); T (4, y)]
*/
IND_TYPE c, cp_0, c30_p_0, cp_1, c30, h, hp_0, w, wp_0, x, xp_0, y, yp_0, y30_p_0, yp_1, y30;
IND_TYPE y31 = 0;
IND_TYPE x20 = 0;
IND_TYPE h20 = 0;
IND_TYPE w20 = 0;
...
y30 = 0;
y30_p_0 = 0;
	for (c30 = c31, c30_p_0 = 0;c30 < c31 + 32;c30 += 32, c30_p_0 += 32){
			for (y = y30, yp_1 = y30_p_0, yp_0 = 0;y < y30 + 13;y += 13, yp_1 += 13, yp_0 += 13){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x20, xp_0 = 0;x < x20 + 112;x += 1, xp_0 += 1){
			...
			for (y = y30 + 13, yp_1 = y30_p_0, yp_0 = 0;y < y30 + 13 + 15;y += 15, yp_1 += 15, yp_0 += 15){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x20, xp_0 = 0;x < x20 + 112;x += 1, xp_0 += 1){
					// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 32
					...
					for (h = h20, hp_0 = 0;h < h20 + 3;h += 1, hp_0 += 1){
						...
						for (w = w20, wp_0 = 0;w < w20 + 3;w += 1, wp_0 += 1){
									...
									mem_vec_322 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_323 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
									mem_vec_324 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									mem_vec_325 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
									mem_vec_326 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									mem_vec_327 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
									mem_vec_328 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
									mem_vec_329 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
									mem_vec_330 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									mem_vec_331 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
									mem_vec_332 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
									mem_vec_333 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
									mem_vec_334 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
									mem_vec_335 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
									// T (c, 32) (32 / 1)
									for (c = c30, cp_1 = c30_p_0, cp_0 = 0;c < c30 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
										...
										vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_332);
										mem_vec_332 = vec_41;
										vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_333);
										mem_vec_333 = vec_43;
										scal_14 = input[strideA1 * (x + w) + strideA2 * (y + 14 + h) + c];
										vec_45 = _mm512_set1_ps(scal_14);
										vec_44 = _mm512_fmadd_ps(vec_45, vec_2, mem_vec_334);
										mem_vec_334 = vec_44;
										vec_46 = _mm512_fmadd_ps(vec_45, vec_4, mem_vec_335);
										mem_vec_335 = vec_46;
									}
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_322);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_323);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_324);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_325);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_326);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_327);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_328);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_329);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_330);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_331);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_332);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_333);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_334);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_335);
						}
					}
				}
			}
