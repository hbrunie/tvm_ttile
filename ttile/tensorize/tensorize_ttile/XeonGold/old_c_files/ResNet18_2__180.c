						...
						for (x = x374, xp_2 = x374_p_1, xp_1 = x374_p_0, xp_0 = 0;
							...
							for (h = h175, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										mem_vec_3125 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
										mem_vec_3126 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
										mem_vec_3127 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_3125);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3126);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_3127);
							}
						}
					}
				}
