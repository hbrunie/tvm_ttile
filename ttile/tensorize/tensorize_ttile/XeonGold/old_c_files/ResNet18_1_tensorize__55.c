...
y195 = 0;
y195_p_0 = 0;
	for (f = f125, fp_0 = 0;f < f125 + 64;f += 32, fp_0 += 32){
			for (y = y195, yp_1 = y195_p_0, yp_0 = 0;y < y195 + 20;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 56) (112 / 2)
				for (x190 = x191, x190_p_0 = 0;x190 < x191 + 112;x190 += 2, x190_p_0 += 2){
			...
			for (y = y195 + 20, yp_1 = y195_p_0, yp_0 = 0;y < y195 + 20 + 36;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 56) (112 / 2)
				for (x190 = x191, x190_p_0 = 0;x190 < x191 + 112;x190 += 2, x190_p_0 += 2){
					// y = ph_y, x = 2, h = 7, w = 7, c = 3, f = 32
