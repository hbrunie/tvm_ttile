				...
				for (x = x95, xp_0 = 0;
					...
					for (w = w58, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								mem_vec_889 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
								mem_vec_890 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
								mem_vec_891 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_892 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_893 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_894 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_895 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								for (c = c96, cp_1 = c96_p_0, cp_0 = 0;
									...
									vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_889);
									mem_vec_889 = vec_15;
									...
									vec_19 = _mm512_fmadd_ps(vec_20, vec_2, mem_vec_891);
									mem_vec_891 = vec_19;
									scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 10) + h) + c];
									vec_22 = _mm512_set1_ps(scal_10);


									vec_21 = _mm512_fmadd_ps(vec_22, vec_2, mem_vec_892);
									mem_vec_892 = vec_21;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_889);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_890);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_891);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_892);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_893);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_894);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_895);
					}
				}
			}
		}
