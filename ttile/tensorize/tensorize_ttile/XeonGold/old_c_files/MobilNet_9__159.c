...
*/
IND_TYPE c, cp_0, c705_p_0, c706_p_0, c707_p_0, cp_1, c705_p_1, c706_p_1, cp_2, c705_p_2, cp_3, c705, c706, c707, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
...
for (c707 = c708, c707_p_0 = 0;
	...
	for (c706 = c707, c706_p_1 = c707_p_0, c706_p_0 = 0;
		c706 < c707 + 128;
		c706 += 128, c706_p_1 += 128, c706_p_0 += 128){
		// y = 7, x = 7, h = 3, w = 3, c = 128, f = 1024
		// T (f, 16) (1024 / 64)
		for (f = f282, fp_0 = 0;
			f < f282 + 1024;
