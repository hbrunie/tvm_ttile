...
y369 = 0;
y369_p_0 = 0;
	for (x493 = x494, x493_p_0 = 0;x493 < x494 + 68;x493 += 4, x493_p_0 += 4){
			for (y = y369, yp_1 = y369_p_0, yp_0 = 0;y < y369 + 20;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (4 / 4)
				for (x492 = x493, x492_p_1 = x493_p_0, x492_p_0 = 0;x492 < x493 + 4;x492 += 4, x492_p_1 += 4, x492_p_0 += 4){
					// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
					// T (f, 4) (128 / 32)
					for (f = f246, fp_0 = 0;f < f246 + 128;f += 32, fp_0 += 32){
						// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 32
						// T (c, 2) (256 / 128)
						for (c369 = c370, c369_p_0 = 0;c369 < c370 + 256;c369 += 128, c369_p_0 += 128){
							// y = ph_y, x = 4, h = 1, w = 1, c = 128, f = 32
							// T (x, 4) (4 / 1)
							for (x = x492, xp_2 = x492_p_1, xp_1 = x492_p_0, xp_0 = 0;x < x492 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_5851 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_5851);
							}
						}
					}
				}
