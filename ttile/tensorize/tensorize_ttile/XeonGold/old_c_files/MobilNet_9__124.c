...
*/
IND_TYPE c, cp_0, c90_p_0, c91_p_0, c92_p_0, cp_1, c90_p_1, c91_p_1, cp_2, c90_p_2, cp_3, c90, c91, c92, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
...
for (c92 = c93, c92_p_0 = 0;
	...
	for (c91 = c92, c91_p_1 = c92_p_0, c91_p_0 = 0;
		c91 < c92 + 512;
		c91 += 512, c91_p_1 += 512, c91_p_0 += 512){
		// y = 7, x = 7, h = 3, w = 3, c = 512, f = 1024
		// T (f, 16) (1024 / 64)
		for (f = f36, fp_0 = 0;
			f < f36 + 1024;
			...
			for (y = y36, yp_0 = 0;
				...
				for (c90 = c91, c90_p_2 = c91_p_1, c90_p_1 = c91_p_0, c90_p_0 = 0;
					c90 < c91 + 512;
					c90 += 32, c90_p_2 += 32, c90_p_1 += 32, c90_p_0 += 32){
