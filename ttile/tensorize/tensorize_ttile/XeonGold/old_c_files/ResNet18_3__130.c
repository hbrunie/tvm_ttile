...
for (y388 = y389, y388_p_0 = 0;
	...
	for (x488 = x489, x488_p_0 = 0;
		...
		// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 1) (28 / 28)
		for (y387 = y388, y387_p_1 = y388_p_0, y387_p_0 = 0;
			y387 < y388 + 28;
			y387 += 28, y387_p_1 += 28, y387_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 8) (56 / 7)
			for (x487 = x488, x487_p_1 = x488_p_0, x487_p_0 = 0;
				x487 < x488 + 56;
				x487 += 7, x487_p_1 += 7, x487_p_0 += 7){
				...
				for (f = f189, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y387, yp_2 = y387_p_1, yp_1 = y387_p_0, yp_0 = 0;
						y < y387 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (7 / 7)
						for (x486 = x487, x486_p_2 = x487_p_1, x486_p_1 = x487_p_0, x486_p_0 = 0;
							x486 < x487 + 7;
							x486 += 7, x486_p_2 += 7, x486_p_1 += 7, x486_p_0 += 7){
							// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c297 = c298, c297_p_0 = 0;
								...
								// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
								// T (x, 7) (7 / 1)
								for (x = x486, xp_3 = x486_p_2, xp_2 = x486_p_1, xp_1 = x486_p_0, xp_0 = 0;
									x < x486 + 7;
