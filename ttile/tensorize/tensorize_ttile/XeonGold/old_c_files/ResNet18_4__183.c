				...
				for (x = x69, xp_0 = 0;
					...
					for (w = w42, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								mem_vec_651 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
								mem_vec_652 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
								mem_vec_653 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
								mem_vec_654 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
								mem_vec_655 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
								mem_vec_656 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
								mem_vec_657 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								for (c = c69, cp_1 = c69_p_0, cp_0 = 0;
									...
									vec_15 = _mm512_fmadd_ps(vec_16, vec_2, mem_vec_651);
									mem_vec_651 = vec_15;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_651);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_652);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_653);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_654);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_655);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_656);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_657);
					}
				}
			}
		}
