	...
	x117 += 28, x117_p_0 += 28){
		for (y = y66, yp_0 = 0;
			...
			for (x116 = x117, x116_p_1 = x117_p_0, x116_p_0 = 0;
				x116 < x117 + 28;
				x116 += 28, x116_p_1 += 28, x116_p_0 += 28){
				// y = ph_y, x = 28, h = 3, w = 3, c = 64, f = 64
				// T (f, 2) (64 / 32)
				for (f = f53, fp_0 = 0;
					f < f53 + 64;
							...
							for (x = x116, xp_2 = x116_p_1, xp_1 = x116_p_0, xp_0 = 0;
								...
								for (h = h56, hp_0 = 0;
									...
									h += 1, hp_0 += 1){
											...
											mem_vec_875 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
											mem_vec_876 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
											mem_vec_877 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
											mem_vec_878 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_879 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
											mem_vec_880 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_881 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
											mem_vec_882 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_883 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 32
											// T (c, 16) (16 / 1)
											for (c = c93, cp_1 = c93_p_0, cp_0 = 0;
												c < c93 + 16;
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_875);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_876);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_877);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_878);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_879);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_880);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_881);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_882);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_883);
								}
							}
						}
					}
