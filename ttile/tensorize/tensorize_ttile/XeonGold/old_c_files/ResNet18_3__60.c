...
for (y756 = y757, y756_p_0 = 0;
	...
	for (x948 = x949, x948_p_0 = 0;
		...
		// T (y, 1) (28 / 28)
		for (y755 = y756, y755_p_1 = y756_p_0, y755_p_0 = 0;
			y755 < y756 + 28;
			y755 += 28, y755_p_1 += 28, y755_p_0 += 28){
			// y = 28, x = 4, h = 1, w = 1, c = 64, f = 64
			// T (x, 2) (4 / 2)
			for (x947 = x948, x947_p_1 = x948_p_0, x947_p_0 = 0;
				x947 < x948 + 4;
				x947 += 2, x947_p_1 += 2, x947_p_0 += 2){
				...
				for (f = f373, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y755, yp_2 = y755_p_1, yp_1 = y755_p_0, yp_0 = 0;
						y < y755 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (2 / 2)
						for (x946 = x947, x946_p_2 = x947_p_1, x946_p_1 = x947_p_0, x946_p_0 = 0;
							x946 < x947 + 2;
							x946 += 2, x946_p_2 += 2, x946_p_1 += 2, x946_p_0 += 2){
							// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 4) (64 / 16)
							for (c573 = c574, c573_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x946, xp_3 = x946_p_2, xp_2 = x946_p_1, xp_1 = x946_p_0, xp_0 = 0;
									x < x946 + 2;
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4870 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_4871 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_4870);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_4871);
								}
							}
						}
					}
