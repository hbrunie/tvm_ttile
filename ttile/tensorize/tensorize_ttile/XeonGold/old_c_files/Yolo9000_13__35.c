	...
	for (x145 = x146, x145_p_0 = 0;
		...
		for (f = f72, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				...
				for (y = y100 + 10, yp_1 = y100_p_0, yp_0 = 0;
					y < y100 + 10 + 24;
						...
						for (c108 = c109, c108_p_0 = 0;
							...
							for (x = x144, xp_2 = x144_p_1, xp_1 = x144_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1654 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_1655 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 512, f = 32
										// T (c, 512) (512 / 1)
										for (c = c108, cp_1 = c108_p_0, cp_0 = 0;
											c < c108 + 512;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_1654);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_1655);
							}
						}
					}
				}
