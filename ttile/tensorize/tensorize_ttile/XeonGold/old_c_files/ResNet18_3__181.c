...
for (y440 = y441, y440_p_0 = 0;
	...
	for (x553 = x554, x553_p_0 = 0;
		...
		// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 1) (28 / 28)
		for (y439 = y440, y439_p_1 = y440_p_0, y439_p_0 = 0;
			y439 < y440 + 28;
			y439 += 28, y439_p_1 += 28, y439_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (56 / 4)
			for (x552 = x553, x552_p_1 = x553_p_0, x552_p_0 = 0;
				...
				for (f = f215, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y439, yp_2 = y439_p_1, yp_1 = y439_p_0, yp_0 = 0;
						y < y439 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 4, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (4 / 4)
						for (x551 = x552, x551_p_2 = x552_p_1, x551_p_1 = x552_p_0, x551_p_0 = 0;
							x551 < x552 + 4;
							x551 += 4, x551_p_2 += 4, x551_p_1 += 4, x551_p_0 += 4){
							// y = 14, x = 4, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c336 = c337, c336_p_0 = 0;
								...
								// T (x, 4) (4 / 1)
								for (x = x551, xp_3 = x551_p_2, xp_2 = x551_p_1, xp_1 = x551_p_0, xp_0 = 0;
									x < x551 + 4;
