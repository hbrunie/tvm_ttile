...
[V f; U (2, f); ULambda y; T (32, c); Hoist_vars [c]; T (3, h); T (17, x);
  ...
  T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c90_p_0, cp_1, c90, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x93_p_0, x94_p_0, xp_1, x93_p_1, xp_2, x93, x94, y, yp_0, y63_p_0, yp_1, y63;
IND_TYPE y64 = 0;
IND_TYPE x95 = 0;
IND_TYPE h60 = 0;
IND_TYPE w33 = 0;
...
x94 = 0;
x94_p_0 = 0;
		for (f = f114, fp_0 = 0;f < f114 + 512;f += 32, fp_0 += 32){
				for (y = y63, yp_1 = y63_p_0, yp_0 = 0;y < y63 + 20;y += 10, yp_1 += 10, yp_0 += 10){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (x, 2) (34 / 17)
					for (x93 = x94, x93_p_1 = x94_p_0, x93_p_0 = 0;x93 < x94 + 34;x93 += 17, x93_p_1 += 17, x93_p_0 += 17){
						// y = ph_y, x = 17, h = 3, w = 3, c = 256, f = 32
						// T (c, 8) (256 / 32)
						for (c90 = c91, c90_p_0 = 0;c90 < c91 + 256;c90 += 32, c90_p_0 += 32){
							// y = ph_y, x = 17, h = 3, w = 3, c = 32, f = 32
							// T (w, 3) (3 / 1)
							for (w = w33, wp_0 = 0;w < w33 + 3;w += 1, wp_0 += 1){
								// y = ph_y, x = 17, h = 3, w = 1, c = 32, f = 32
								// T (x, 17) (17 / 1)
								for (x = x93, xp_2 = x93_p_1, xp_1 = x93_p_0, xp_0 = 0;x < x93 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
				...
				for (y = y63 + 20, yp_1 = y63_p_0, yp_0 = 0;y < y63 + 20 + 14;y += 14, yp_1 += 14, yp_0 += 14){
					// y = ph_y, x = 34, h = 3, w = 3, c = 256, f = 32
					// T (x, 2) (34 / 17)
					for (x93 = x94, x93_p_1 = x94_p_0, x93_p_0 = 0;x93 < x94 + 34;x93 += 17, x93_p_1 += 17, x93_p_0 += 17){
						// y = ph_y, x = 17, h = 3, w = 3, c = 256, f = 32
