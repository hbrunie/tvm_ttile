...
xp_0 = 0;
						for (w = w184, wp_0 = 0;w < w184 + 3;w += 1, wp_0 += 1){
									...
									mem_vec_2951 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									...
									mem_vec_2955 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2951);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_2955);
