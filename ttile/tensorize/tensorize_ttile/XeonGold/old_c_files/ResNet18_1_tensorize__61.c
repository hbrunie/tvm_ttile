...
[V f; U (2, f); U (14, y); T (3, c); Hoist_vars [c]; T (7, x); T (1, c);
  T (7, w); T (7, h); T (16, x); T (4, y); T (2, f); T (2, y)]
*/
IND_TYPE c, cp_0, c66_p_0, cp_1, c66, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x61_p_0, xp_1, x61, y, yp_0, y66_p_0, yp_1, y66;
IND_TYPE y67 = 0;
IND_TYPE x62 = 0;
IND_TYPE h44 = 0;
IND_TYPE w44 = 0;
				...
				for (h = h44, hp_0 = 0;h < h44 + 7;h += 1, hp_0 += 1){
					...
					for (w = w44, wp_0 = 0;w < w44 + 7;w += 1, wp_0 += 1){
						...
						for (c66 = c67, c66_p_0 = 0;c66 < c67 + 3;c66 += 3, c66_p_0 += 3){
							// y = 14, x = 7, h = 1, w = 1, c = 3, f = 32
							// T (x, 7) (7 / 1)
							for (x = x61, xp_1 = x61_p_0, xp_0 = 0;x < x61 + 7;x += 1, xp_1 += 1, xp_0 += 1){
