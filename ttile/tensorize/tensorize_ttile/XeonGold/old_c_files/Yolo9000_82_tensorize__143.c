							...
							for (w = w12, wp_0 = 0;w < w12 + 3;w += 1, wp_0 += 1){
								...
								for (x = x18, xp_1 = x18_p_0, xp_0 = 0;x < x18 + 34;x += 1, xp_1 += 1, xp_0 += 1){
									...
									for (h = h12, hp_0 = 0;h < h12 + 3;h += 1, hp_0 += 1){
												...
												mem_vec_270 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
												mem_vec_271 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
												mem_vec_272 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
												mem_vec_273 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
												mem_vec_274 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
												mem_vec_275 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
												mem_vec_276 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
												mem_vec_277 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
												...
												for (c = c18, cp_1 = c18_p_0, cp_0 = 0;c < c18 + 16;c += 1, cp_1 += 1, cp_0 += 1){
													...
													vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_272);
													mem_vec_272 = vec_26;
													vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_273);
													mem_vec_273 = vec_28;
													scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 9 + h) + c];
													vec_30 = _mm512_set1_ps(scal_9);
													vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_274);
													mem_vec_274 = vec_29;
													vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_275);
													mem_vec_275 = vec_31;
													scal_10 = input[strideA1 * (x + w) + strideA2 * (y + 10 + h) + c];
													vec_33 = _mm512_set1_ps(scal_10);
													vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_276);
													mem_vec_276 = vec_32;
													vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_277);
													mem_vec_277 = vec_34;
												}
											...
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_270);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_271);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_272);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_273);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_274);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_275);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_276);
											_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_277);
									}
								}
							}
}
