						...
						for (w = w144, wp_0 = 0;w < w144 + 3;w += 1, wp_0 += 1){
							...
							for (x = x232, xp_1 = x232_p_0, xp_0 = 0;x < x232 + 1;x += 1, xp_1 += 1, xp_0 += 1){
								...
								for (h = h145, hp_0 = 0;h < h145 + 3;h += 1, hp_0 += 1){
											...
											mem_vec_2458 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
											mem_vec_2459 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
											mem_vec_2460 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f]);
											mem_vec_2461 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_2458);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_2459);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f], mem_vec_2460);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 14) + f + 16], mem_vec_2461);
								}
							}
						}
}
