				...
				for (f = f96, fp_0 = 0;
					...
					for (y = y192, yp_2 = y192_p_1, yp_1 = y192_p_0, yp_0 = 0;
						...
						for (x240 = x241, x240_p_2 = x241_p_1, x240_p_1 = x241_p_0, x240_p_0 = 0;
							x240 < x241 + 2;
							x240 += 2, x240_p_2 += 2, x240_p_1 += 2, x240_p_0 += 2){
							// y = 14, x = 2, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c144 = c145, c144_p_0 = 0;
								...
								for (x = x240, xp_3 = x240_p_2, xp_2 = x240_p_1, xp_1 = x240_p_0, xp_0 = 0;
									...
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_974 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_975 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_974);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_975);
								}
							}
						}
					}
