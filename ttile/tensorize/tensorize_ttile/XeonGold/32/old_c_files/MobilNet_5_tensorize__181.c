...
[V f; U (2, f); U (14, y); T (32, c); Hoist_vars [c]; T (3, h); T (14, x);
  T (3, w); T (8, c); T (1, x); T (1, y); T (8, f); T (2, x); T (2, y)]
*/
IND_TYPE c, cp_0, c27_p_0, cp_1, c27, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x30_p_0, x31_p_0, xp_1, x30_p_1, xp_2, x30, x31, y, yp_0, y21_p_0, yp_1, y21;
IND_TYPE y22 = 0;
IND_TYPE x32 = 0;
IND_TYPE h18 = 0;
IND_TYPE w12 = 0;
...
c27_p_0 = 0;
						for (w = w12, wp_0 = 0;w < w12 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 14) (14 / 1)
							for (x = x30, xp_2 = x30_p_1, xp_1 = x30_p_0, xp_0 = 0;x < x30 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
