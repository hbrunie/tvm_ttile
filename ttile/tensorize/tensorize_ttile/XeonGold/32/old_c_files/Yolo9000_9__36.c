...
for (y102 = y103, y102_p_0 = 0;
	...
	for (x137 = x138, x137_p_0 = 0;
		...
		x137 += 4, x137_p_0 += 4){
			...
			for (y = y102 + 8, yp_1 = y102_p_0, yp_0 = 0;
				y < y102 + 8 + 60;
						...
						for (c102 = c103, c102_p_0 = 0;
							...
							for (x = x136, xp_2 = x136_p_1, xp_1 = x136_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1764 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
										mem_vec_1765 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 256, f = 32
										// T (c, 256) (256 / 1)
										for (c = c102, cp_1 = c102_p_0, cp_0 = 0;
											c < c102 + 256;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_1764);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_1765);
							}
						}
					}
				}
