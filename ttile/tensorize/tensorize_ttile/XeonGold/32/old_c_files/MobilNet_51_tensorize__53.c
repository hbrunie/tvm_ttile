...
c387_p_0 = 0;
							for (h = h246, hp_0 = 0;h < h246 + 3;h += 1, hp_0 += 1){
								...
								for (x = x399, xp_1 = x399_p_0, xp_0 = 0;x < x399 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3442 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32]);
											mem_vec_3443 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 32], mem_vec_3442);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 48], mem_vec_3443);
								}
							}
}
