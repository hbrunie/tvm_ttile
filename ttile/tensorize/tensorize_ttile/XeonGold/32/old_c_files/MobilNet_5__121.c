...
[V f; U (4, f); U (7, y); U (3, w); T (256, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (1, c); T (2, f); T (4, y); T (1, x); T (1, f); T (2, f)]
*/
IND_TYPE c, cp_0, c9_p_0, cp_1, c9, f, fp_0, f12_p_0, f13_p_0, fp_1, f12_p_1, fp_2, f12, f13, h, hp_0, x, xp_0, x9_p_0, xp_1, x9, y, yp_0;
...
for (f13 = f14, f13_p_0 = 0;
	...
	for (f12 = f13, f12_p_1 = f13_p_0, f12_p_0 = 0;
		f12 < f13 + 128;
		f12 += 128, f12_p_1 += 128, f12_p_0 += 128){
		// y = 28, x = 28, h = 3, w = 3, c = 256, f = 128
		// T (x, 1) (28 / 28)
		for (x9 = x10, x9_p_0 = 0;
			x9 < x10 + 28;
