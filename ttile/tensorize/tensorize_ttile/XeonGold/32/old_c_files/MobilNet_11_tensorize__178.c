...
xp_0 = 0;
					for (h = h46, hp_0 = 0;h < h46 + 3;h += 1, hp_0 += 1){
						...
						for (w = w46, wp_0 = 0;w < w46 + 3;w += 1, wp_0 += 1){
									...
									mem_vec_924 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_925 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
									mem_vec_926 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									mem_vec_927 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
									...
									for (c = c69, cp_1 = c69_p_0, cp_0 = 0;c < c69 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										...
										vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_926);
										mem_vec_926 = vec_29;
										vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_927);
										mem_vec_927 = vec_31;
									}
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_924);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_925);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_926);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_927);
						}
					}
}
