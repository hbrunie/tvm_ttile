...
[V f; U (2, f); U (14, y); T (3, c); Hoist_vars [c]; T (16, x); T (1, c);
  T (7, w); T (7, h); T (7, x); T (1, y); T (2, f); T (8, y)]
*/
IND_TYPE c, cp_0, c36_p_0, cp_1, c36, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x31_p_0, xp_1, x31, y, yp_0, y36_p_0, yp_1, y36;
IND_TYPE y37 = 0;
IND_TYPE x32 = 0;
IND_TYPE h24 = 0;
IND_TYPE w24 = 0;
...
x31 = 0;
x31_p_0 = 0;
				for (h = h24, hp_0 = 0;h < h24 + 7;h += 1, hp_0 += 1){
					// y = 14, x = 16, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w24, wp_0 = 0;w < w24 + 7;w += 1, wp_0 += 1){
						// y = 14, x = 16, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c36 = c37, c36_p_0 = 0;c36 < c37 + 3;c36 += 3, c36_p_0 += 3){
							// y = 14, x = 16, h = 1, w = 1, c = 3, f = 32
							// T (x, 16) (16 / 1)
							for (x = x31, xp_1 = x31_p_0, xp_0 = 0;x < x31 + 16;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_362 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_363 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
										// y = 14, x = 1, h = 1, w = 1, c = 3, f = 32
										// T (c, 3) (3 / 1)
										for (c = c36, cp_1 = c36_p_0, cp_0 = 0;c < c36 + 3;c += 1, cp_1 += 1, cp_0 += 1){
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_362);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_363);
							}
						}
					}
				}
