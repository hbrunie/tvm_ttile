...
[V f; U (2, f); U (14, y); T (3, c); Hoist_vars [c]; T (4, x); T (1, c);
  T (7, w); T (7, h); T (28, x); T (1, y); T (2, f); T (8, y)]
*/
IND_TYPE c, cp_0, c84_p_0, cp_1, c84, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x79_p_0, xp_1, x79, y, yp_0, y84_p_0, yp_1, y84;
IND_TYPE y85 = 0;
IND_TYPE x80 = 0;
IND_TYPE h56 = 0;
IND_TYPE w56 = 0;
...
x79 = 0;
x79_p_0 = 0;
				for (h = h56, hp_0 = 0;h < h56 + 7;h += 1, hp_0 += 1){
					// y = 14, x = 4, h = 1, w = 7, c = 3, f = 32
					// T (w, 7) (7 / 1)
					for (w = w56, wp_0 = 0;w < w56 + 7;w += 1, wp_0 += 1){
						// y = 14, x = 4, h = 1, w = 1, c = 3, f = 32
						// T (c, 1) (3 / 3)
						for (c84 = c85, c84_p_0 = 0;c84 < c85 + 3;c84 += 3, c84_p_0 += 3){
							// y = 14, x = 4, h = 1, w = 1, c = 3, f = 32
							// T (x, 4) (4 / 1)
							for (x = x79, xp_1 = x79_p_0, xp_0 = 0;x < x79 + 4;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c84, cp_1 = c84_p_0, cp_0 = 0;c < c84 + 3;c += 1, cp_1 += 1, cp_0 += 1){
