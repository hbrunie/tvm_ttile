...
y495 = 0;
y495_p_0 = 0;
	for (f = f274, fp_0 = 0;f < f274 + 32;f += 16, fp_0 += 16){
			for (y = y495, yp_1 = y495_p_0, yp_0 = 0;y < y495 + 60;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 16
				// T (x, 14) (112 / 8)
				for (x439 = x440, x439_p_0 = 0;x439 < x440 + 112;x439 += 8, x439_p_0 += 8){
					// y = ph_y, x = 8, h = 3, w = 3, c = 32, f = 16
					// T (w, 3) (3 / 1)
					for (w = w330, wp_0 = 0;w < w330 + 3;w += 1, wp_0 += 1){
						// y = ph_y, x = 8, h = 3, w = 1, c = 32, f = 16
						// T (c, 2) (32 / 16)
						for (c495 = c496, c495_p_0 = 0;c495 < c496 + 32;c495 += 16, c495_p_0 += 16){
							...
							for (x = x439, xp_1 = x439_p_0, xp_0 = 0;x < x439 + 8;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3947 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
										mem_vec_3948 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_3949 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_3950 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
										...
										mem_vec_3953 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
										mem_vec_3954 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_3955 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_3956 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_3947);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_3948);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3949);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_3950);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3953);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3954);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_3955);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_3956);
							}
						}
					}
				}
			}
			for (y = y495 + 60, yp_1 = y495_p_0, yp_0 = 0;y < y495 + 60 + 52;y += 13, yp_1 += 13, yp_0 += 13){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 16
				// T (x, 14) (112 / 8)
				for (x439 = x440, x439_p_0 = 0;x439 < x440 + 112;x439 += 8, x439_p_0 += 8){
					// y = ph_y, x = 8, h = 3, w = 3, c = 32, f = 16
					...
					for (w = w330, wp_0 = 0;w < w330 + 3;w += 1, wp_0 += 1){
						...
						for (c495 = c496, c495_p_0 = 0;c495 < c496 + 32;c495 += 16, c495_p_0 += 16){
							...
							// T (x, 8) (8 / 1)
							for (x = x439, xp_1 = x439_p_0, xp_0 = 0;x < x439 + 8;x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_3957 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										...
										mem_vec_3960 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
										mem_vec_3961 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										...
										mem_vec_3965 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
										mem_vec_3966 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
										mem_vec_3967 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_3968 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										mem_vec_3969 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										// y = ph_y, x = 1, h = 3, w = 1, c = 16, f = 16
										// T (c, 16) (16 / 1)
										for (c = c495, cp_1 = c495_p_0, cp_0 = 0;c < c495 + 16;c += 1, cp_1 += 1, cp_0 += 1){
											scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_3957);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_3960);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3961);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3965);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3966);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_3967);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_3968);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3969);
							}
						}
					}
				}
