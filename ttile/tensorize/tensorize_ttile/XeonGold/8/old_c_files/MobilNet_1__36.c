					...
					for (h = h44, hp_0 = 0;
						...
						for (w = w44, wp_0 = 0;
							...
							w += 1, wp_0 += 1){
									...
									mem_vec_900 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_901 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									mem_vec_902 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_903 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_904 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_905 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_906 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_907 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
									// T (c, 32) (32 / 1)
									for (c = c66, cp_1 = c66_p_0, cp_0 = 0;
										c < c66 + 32;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_900);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_901);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_902);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_903);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_904);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_905);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_906);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_907);
						}
					}
				}
			}
