...
for (y464 = y465, y464_p_0 = 0;
	...
	for (x583 = x584, x583_p_0 = 0;
		...
		// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 1) (28 / 28)
		for (y463 = y464, y463_p_1 = y464_p_0, y463_p_0 = 0;
			y463 < y464 + 28;
			y463 += 28, y463_p_1 += 28, y463_p_0 += 28){
			// y = 28, x = 56, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (56 / 4)
			for (x582 = x583, x582_p_1 = x583_p_0, x582_p_0 = 0;
				x582 < x583 + 56;
				x582 += 4, x582_p_1 += 4, x582_p_0 += 4){
				...
				for (f = f227, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y463, yp_2 = y463_p_1, yp_1 = y463_p_0, yp_0 = 0;
						y < y463 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 4, h = 1, w = 1, c = 64, f = 32
						// T (x, 2) (4 / 2)
						for (x581 = x582, x581_p_2 = x582_p_1, x581_p_1 = x582_p_0, x581_p_0 = 0;
							x581 < x582 + 4;
							x581 += 2, x581_p_2 += 2, x581_p_1 += 2, x581_p_0 += 2){
							...
							for (c354 = c355, c354_p_0 = 0;
								...
								// T (x, 2) (2 / 1)
								for (x = x581, xp_3 = x581_p_2, xp_2 = x581_p_1, xp_1 = x581_p_0, xp_0 = 0;
									x < x581 + 2;
