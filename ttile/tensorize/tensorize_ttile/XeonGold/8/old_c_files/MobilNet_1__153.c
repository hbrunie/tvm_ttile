...
for (y30 = y31, y30_p_0 = 0;
	...
	for (c30 = c31, c30_p_0 = 0;
		...
		c30 += 32, c30_p_0 += 32){
			...
			for (y = y30 + 13, yp_1 = y30_p_0, yp_0 = 0;
				y < y30 + 13 + 15;
					...
					for (h = h20, hp_0 = 0;
						...
						for (w = w20, wp_0 = 0;
							...
							w += 1, wp_0 += 1){
									...
									mem_vec_332 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_333 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									mem_vec_334 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
									mem_vec_335 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
									// T (c, 32) (32 / 1)
									for (c = c30, cp_1 = c30_p_0, cp_0 = 0;
										c < c30 + 32;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_332);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_333);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_334);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_335);
						}
					}
				}
			}
