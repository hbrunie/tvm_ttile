...
c219_p_0 = 0;
				for (h = h130, hp_0 = 0;h < h130 + 3;h += 1, hp_0 += 1){
					...
					// T (x, 28) (28 / 1)
					for (x = x284, xp_2 = x284_p_1, xp_1 = x284_p_0, xp_0 = 0;x < x284 + 28;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_2288 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
								mem_vec_2289 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
								mem_vec_2290 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
								mem_vec_2291 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2288);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_2289);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_2290);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_2291);
					}
				}
}
