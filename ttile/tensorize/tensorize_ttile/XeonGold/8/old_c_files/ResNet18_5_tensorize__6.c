...
*/
IND_TYPE c, cp_0, c46_p_0, cp_1, c46, f, fp_0, f46_p_0, fp_1, f46, x, xp_0, x51_p_0, xp_1, x51, y, yp_0;
IND_TYPE y34 = 0;
IND_TYPE x52 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c46 = 0;
c46_p_0 = 0;
					for (x = x51, xp_1 = x51_p_0, xp_0 = 0;x < x51 + 4;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 64) (64 / 1)
								for (c = c46, cp_1 = c46_p_0, cp_0 = 0;c < c46 + 64;c += 1, cp_1 += 1, cp_0 += 1){
