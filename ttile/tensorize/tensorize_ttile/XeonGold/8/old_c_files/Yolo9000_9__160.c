		...
		x665 += 68, x665_p_0 += 68){
			for (y = y498, yp_1 = y498_p_0, yp_0 = 0;
				...
				for (x664 = x665, x664_p_1 = x665_p_0, x664_p_0 = 0;
					x664 < x665 + 68;
					x664 += 68, x664_p_1 += 68, x664_p_0 += 68){
					// y = ph_y, x = 68, h = 1, w = 1, c = 256, f = 128
					// T (f, 4) (128 / 32)
					for (f = f332, fp_0 = 0;
						f < f332 + 128;
						...
						for (c498 = c499, c498_p_0 = 0;
							...
							for (x = x664, xp_2 = x664_p_1, xp_1 = x664_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_7866 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
										mem_vec_7867 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
										mem_vec_7868 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
										mem_vec_7869 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
										mem_vec_7870 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
										mem_vec_7871 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
										mem_vec_7872 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
										mem_vec_7873 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_7866);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_7867);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_7868);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_7869);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_7870);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_7871);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_7872);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_7873);
							}
						}
					}
				}
			}
			for (y = y498 + 22, yp_1 = y498_p_0, yp_0 = 0;
				y < y498 + 22 + 12;
