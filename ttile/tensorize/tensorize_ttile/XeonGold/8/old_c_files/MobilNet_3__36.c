	...
	x303 += 56, x303_p_0 += 56){
		for (y = y184, yp_0 = 0;
			...
			for (x302 = x303, x302_p_1 = x303_p_0, x302_p_0 = 0;
				x302 < x303 + 56;
				x302 += 14, x302_p_1 += 14, x302_p_0 += 14){
							...
							for (x = x302, xp_2 = x302_p_1, xp_1 = x302_p_0, xp_0 = 0;
								...
								for (h = h137, hp_0 = 0;
									...
									h += 1, hp_0 += 1){
											...
											mem_vec_2416 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_2417 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
											mem_vec_2418 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_2419 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
											// T (c, 32) (32 / 1)
											for (c = c276, cp_1 = c276_p_0, cp_0 = 0;
												c < c276 + 32;
												...
												vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_2416);
												mem_vec_2416 = vec_32;



												vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_2417);
												mem_vec_2417 = vec_34;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
												vec_36 = _mm512_set1_ps(scal_11);


												vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_2418);
												mem_vec_2418 = vec_35;



												vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_2419);
												mem_vec_2419 = vec_37;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_2416);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_2417);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_2418);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_2419);
								}
							}
						}
					}
