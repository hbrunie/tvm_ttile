										...
										for (w = w0, wp_0 = 0;
											...
											for (x = x0, xp_1 = x0_p_0, xp_0 = 0;
												...
												x += 1, xp_1 += 1, xp_0 += 1){
														...
														mem_vec_36 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
														mem_vec_37 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 8]);
														mem_vec_38 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
														mem_vec_39 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 8]);
														mem_vec_40 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
														mem_vec_41 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 8]);
														mem_vec_42 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
														mem_vec_43 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 8]);
														// y = u_y, x = 1, h = 1, w = 1, c = 1, f = 16
														// T (c, 1) (1 / 1)
														for (c = c0, cp_2 = c0_p_1, cp_1 = c0_p_0, cp_0 = 0;
															c < c0 + 1;
													...
													_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_36);
													_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 8], mem_vec_37);
													_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_38);
													_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 8], mem_vec_39);
													_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_40);
													_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 8], mem_vec_41);
													_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_42);
													_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 8], mem_vec_43);
											}
										}
									}
								}
