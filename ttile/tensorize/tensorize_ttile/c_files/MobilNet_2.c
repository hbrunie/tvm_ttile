...
// T (x, 1) (56 / 56)
for (x53074 = x53075, x53074_p_0 = 0;
	x53074 < x53075 + 56;
	x53074 += 56, x53074_p_0 += 56){
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 4) (64 / 16)
	for (f = f43837, fp_0 = 0;
		f < f43837 + 64;
		...
		for (y = y36126, yp_0 = 0;
			y < y36126 + 56;
			y += 7, yp_0 += 7){
			// y = 7, x = 56, h = 3, w = 3, c = 64, f = 16
			// T (x, 4) (56 / 14)
			for (x53073 = x53074, x53073_p_1 = x53074_p_0, x53073_p_0 = 0;
				x53073 < x53074 + 56;
				x53073 += 14, x53073_p_1 += 14, x53073_p_0 += 14){
				// y = 7, x = 14, h = 3, w = 3, c = 64, f = 16
				// T (c, 2) (64 / 32)
				for (c46190 = c46191, c46190_p_0 = 0;
					c46190 < c46191 + 64;
					c46190 += 32, c46190_p_0 += 32){
					...
					for (w = w18819, wp_0 = 0;
						...
						// T (x, 14) (14 / 1)
						for (x = x53073, xp_2 = x53073_p_1, xp_1 = x53073_p_0, xp_0 = 0;
							x < x53073 + 14;
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 32) (32 / 1)
									for (c = c46190, cp_1 = c46190_p_0, cp_0 = 0;
										c < c46190 + 32;
										c += 1, cp_1 += 1, cp_0 += 1){
