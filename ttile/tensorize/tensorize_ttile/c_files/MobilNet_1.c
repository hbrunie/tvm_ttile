					...
					for (h = h0, hp_0 = 0;
						...
						for (x = x0, xp_2 = x0_p_1, xp_1 = x0_p_0, xp_0 = 0;
							...
							x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_60 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_61 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 8]);
									mem_vec_62 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
									mem_vec_63 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 24]);
									mem_vec_64 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_65 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 8]);
									mem_vec_66 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
									mem_vec_67 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 24]);
									// y = u_y, x = 1, h = 1, w = 3, c = 8, f = 32
									// T (c, 8) (8 / 1)
									for (c = c0, cp_1 = c0_p_0, cp_0 = 0;
										c < c0 + 8;
										...
										vec_51 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

										vec_49 = _mm256_fmadd_ps(vec_50, vec_51, mem_vec_32);
										mem_vec_32 = vec_49;

										vec_53 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

										vec_52 = _mm256_fmadd_ps(vec_50, vec_53, mem_vec_33);
										mem_vec_33 = vec_52;

										vec_55 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

										vec_54 = _mm256_fmadd_ps(vec_50, vec_55, mem_vec_34);
										mem_vec_34 = vec_54;

										vec_57 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);
										...
										vec_100 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

										vec_98 = _mm256_fmadd_ps(vec_99, vec_100, mem_vec_32);
										mem_vec_32 = vec_98;

										vec_102 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

										vec_101 = _mm256_fmadd_ps(vec_99, vec_102, mem_vec_33);
										mem_vec_33 = vec_101;

										vec_104 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

										vec_103 = _mm256_fmadd_ps(vec_99, vec_104, mem_vec_34);
										mem_vec_34 = vec_103;

										vec_106 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_60);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 8], mem_vec_61);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_62);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 24], mem_vec_63);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_64);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 8], mem_vec_65);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_66);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 24], mem_vec_67);
						}
					}
				}
			}
