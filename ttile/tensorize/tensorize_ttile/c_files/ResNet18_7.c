...
[V f; U (4, f); U (7, y); U (3, h); T (8, c); Hoist_vars [c]; T (7, x);
  T (3, w); T (8, c); T (2, f); T (1, y); T (16, c); T (8, f)]
*/
IND_TYPE c, cp_0, c888_p_0, c889_p_0, cp_1, c888_p_1, cp_2, c888, c889, f, fp_0, f666_p_0, fp_1, f666, w, wp_0, x, xp_0, y, yp_0;
