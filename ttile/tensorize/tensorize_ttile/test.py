...
def assign_output(a, b):
    c = output_tensor((a.shape[0], 17, 17, a.shape[3]), 'float32')
...
Out1 = te.compute(
    (batch_size, out_w, 10, out_channels),
...
Out2 = te.compute(
    (batch_size, out_w, out_h - 10, out_channels),
    lambda batch, xx, yy, out_channels: te.sum(
        A[batch, xx + axe_kernel_w2, yy + 10 + axe_kernel_h2, axe_in_channels2]* W[axe_kernel_w2, axe_kernel_h2, axe_in_channels2, out_channels],
...
factor_out_channels1 = 32
factor_yy1 = 10
factor_xx1 = 1
factor_in_channels1 = 4

factor_out_channels2 = 32
factor_yy2 = 7
factor_xx2 = 1
factor_in_channels2 = 4
...
extern "C" {
    ...
    file_ = open("tensorize_files/Yolo9000_191.c", "r")
    cc_code_midle = file_.read()
    file_.close()

    file_ = open("tensorize_files/Yolo9000_192.c", "r")
    cc_code_midle += file_.read()
    file_.close()
