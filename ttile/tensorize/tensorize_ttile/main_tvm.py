...
if __name__ == '__main__':
    ...
    for k in range(19):
        results += [float(os.popen("python3.8 run_tvm.py " + name_conv + " " + archi).read())]
    ...
    os.system("python3.8 main_tvm_1kernel.py " + name_conv + " " + archi + " " + str(runs))
