...
x0_p_1 = 0;
					for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
						...
						for (x = x0, xp_2 = x0_p_1, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_30 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
									mem_vec_31 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 24]);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_30);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 24], mem_vec_31);
						}
					}
}
