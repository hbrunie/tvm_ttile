...
/*
[V f; U (2, f); ULambda y; T (64, c); Hoist_vars [c]; T (8, x); T (7, x);
...
x1 = 0;
x1_p_0 = 0;
		for (f = f0, fp_0 = 0;f < f0 + 64;f += 32, fp_0 += 32){
				for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 44;y += 11, yp_1 += 11, yp_0 += 11){
					// y = u_y, x = 56, h = 1, w = 1, c = 64, f = 32
					// T (x, 7) (56 / 8)
					for (x0 = x1, x0_p_1 = x1_p_0, x0_p_0 = 0;x0 < x1 + 56;x0 += 8, x0_p_1 += 8, x0_p_0 += 8){
						...
						for (x = x0, xp_2 = x0_p_1, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 8;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 64) (64 / 1)
									for (c = c0, cp_0 = 0;c < c0 + 64;c += 1, cp_0 += 1){
				...
				for (y = y0 + 44, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 44 + 12;y += 12, yp_1 += 12, yp_0 += 12){
					// y = u_y, x = 56, h = 1, w = 1, c = 64, f = 32
					// T (x, 7) (56 / 8)
					for (x0 = x1, x0_p_1 = x1_p_0, x0_p_0 = 0;x0 < x1 + 56;x0 += 8, x0_p_1 += 8, x0_p_0 += 8){
						// y = u_y, x = 8, h = 1, w = 1, c = 64, f = 32
