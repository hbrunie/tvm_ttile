...
*/
IND_TYPE c, cp_0, c216_p_0, c217_p_0, cp_1, c216_p_1, cp_2, c216, c217, f, fp_0, f162_p_0, fp_1, f162, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y108 = 0;
IND_TYPE x108 = 0;
IND_TYPE h108 = 0;
IND_TYPE w108 = 0;
					...
					for (h = h108, hp_0 = 0;h < h108 + 3;h += 1, hp_0 += 1){
						...
						for (w = w108, wp_0 = 0;w < w108 + 3;w += 1, wp_0 += 1){
							...
							for (x = x108, xp_0 = 0;x < x108 + 7;x += 1, xp_0 += 1){
										...
										// T (c, 64) (64 / 1)
										for (c = c216, cp_2 = c216_p_1, cp_1 = c216_p_0, cp_0 = 0;c < c216 + 64;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
