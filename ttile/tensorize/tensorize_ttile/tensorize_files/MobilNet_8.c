...
fp_2 = 0;
					for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
						...
						for (x = x0, xp_0 = 0;x < x0 + 7;x += 1, xp_0 += 1){
									...
									mem_vec_22 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16]);
									mem_vec_23 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24]);
									mem_vec_24 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
									mem_vec_25 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8]);
									mem_vec_26 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
									mem_vec_27 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
									...
									for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 4;c += 1, cp_1 += 1, cp_0 += 1){
										...
										mem_vec_27 = vec_38;
										scal_7 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 1) + strideA2 * (2 * y + h) + c];
										...
										mem_vec_3 = vec_46;
										scal_8 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 1) + strideA2 * (2 * (y + 1) + h) + c];
										...
										mem_vec_7 = vec_52;
										scal_9 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 1) + strideA2 * (2 * (y + 2) + h) + c];
										...
										mem_vec_11 = vec_57;
										scal_10 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 1) + strideA2 * (2 * (y + 3) + h) + c];
										...
										mem_vec_15 = vec_62;
										scal_11 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 1) + strideA2 * (2 * (y + 4) + h) + c];
										...
										mem_vec_19 = vec_67;
										scal_12 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 1) + strideA2 * (2 * (y + 5) + h) + c];
										...
										mem_vec_23 = vec_72;
										scal_13 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 1) + strideA2 * (2 * (y + 6) + h) + c];
										...
										mem_vec_27 = vec_77;
										scal_14 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 2) + strideA2 * (2 * y + h) + c];
										...
										mem_vec_3 = vec_85;
										scal_15 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 2) + strideA2 * (2 * (y + 1) + h) + c];
										...
										mem_vec_7 = vec_91;
										scal_16 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 2) + strideA2 * (2 * (y + 2) + h) + c];
										...
										mem_vec_11 = vec_96;
										scal_17 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 2) + strideA2 * (2 * (y + 3) + h) + c];
										...
										mem_vec_15 = vec_101;
										scal_18 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 2) + strideA2 * (2 * (y + 4) + h) + c];
										...
										mem_vec_19 = vec_106;
										scal_19 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 2) + strideA2 * (2 * (y + 5) + h) + c];
										...
										mem_vec_23 = vec_111;
										scal_20 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w + 2) + strideA2 * (2 * (y + 6) + h) + c];
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 16], mem_vec_22);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f + 24], mem_vec_23);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_24);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 8], mem_vec_25);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_26);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_27);
						}
					}
}
