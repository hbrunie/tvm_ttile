...
[V f; U (2, f); ULambda y; T (1, c); Hoist_vars [c]; T (4, x); T (3, w);
  T (3, h); T (1, y); T (1, f); T (1, c); T (1, f); T (64, c); T (28, x);
  Lambda_apply y [((Iter 7), (Arg 8)); ((Iter 4), (Arg 14))]; T (4, f)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, c1_p_0, c1, cp_1, c0_p_1, cp_2, f, f0, fp_0, f0_p_0, f1_p_0, f1, fp_1, f0_p_1, fp_2, h, hp_0, w, wp_0, x, x0, xp_0, x0_p_0, xp_1, y, y0, yp_0, y0_p_0, yp_1;
IND_TYPE y1 = 0;
IND_TYPE x1 = 0;
IND_TYPE h0 = 0;
IND_TYPE w0 = 0;
...
yp_1 = 0;
									for (h = h0, hp_0 = 0;h < h0 + 3;h += 1, hp_0 += 1){
										// y = u_y, x = 4, h = 1, w = 3, c = 1, f = 16
										// T (w, 3) (3 / 1)
										for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
											// y = u_y, x = 4, h = 1, w = 1, c = 1, f = 16
											// T (x, 4) (4 / 1)
											for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 4;x += 1, xp_1 += 1, xp_0 += 1){
														...
														mem_vec_32 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
														mem_vec_33 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8]);
														mem_vec_34 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
														mem_vec_35 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8]);
														mem_vec_36 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
														mem_vec_37 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8]);
														mem_vec_38 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
														mem_vec_39 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8]);
														mem_vec_40 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
														mem_vec_41 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8]);
														mem_vec_42 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
														mem_vec_43 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 8]);
														// y = u_y, x = 1, h = 1, w = 1, c = 1, f = 16
														// T (c, 1) (1 / 1)
														for (c = c0, cp_2 = c0_p_1, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 1;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
															...
															vec_32 = _mm256_fmadd_ps(vec_33, vec_2, mem_vec_36);
															mem_vec_36 = vec_32;
															vec_34 = _mm256_fmadd_ps(vec_33, vec_4, mem_vec_37);
															mem_vec_37 = vec_34;
															scal_11 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 11) + h) + c];
															vec_36 = _mm256_set1_ps(scal_11);
															vec_35 = _mm256_fmadd_ps(vec_36, vec_2, mem_vec_38);
															mem_vec_38 = vec_35;
															vec_37 = _mm256_fmadd_ps(vec_36, vec_4, mem_vec_39);
															mem_vec_39 = vec_37;
															scal_12 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 12) + h) + c];
															vec_39 = _mm256_set1_ps(scal_12);
															vec_38 = _mm256_fmadd_ps(vec_39, vec_2, mem_vec_40);
															mem_vec_40 = vec_38;
															vec_40 = _mm256_fmadd_ps(vec_39, vec_4, mem_vec_41);
															mem_vec_41 = vec_40;
															scal_13 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 13) + h) + c];
															vec_42 = _mm256_set1_ps(scal_13);
															vec_41 = _mm256_fmadd_ps(vec_42, vec_2, mem_vec_42);
															mem_vec_42 = vec_41;
															vec_43 = _mm256_fmadd_ps(vec_42, vec_4, mem_vec_43);
															mem_vec_43 = vec_43;
														}
													...
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_32);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 8], mem_vec_33);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_34);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 8], mem_vec_35);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_36);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 8], mem_vec_37);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_38);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 8], mem_vec_39);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_40);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8], mem_vec_41);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_42);
													_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 8], mem_vec_43);
											}
										}
									}
}
