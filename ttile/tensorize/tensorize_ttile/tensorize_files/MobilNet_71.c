							...
							for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
								...
								for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 1;x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 256;c += 1, cp_1 += 1, cp_0 += 1){
												...
												vec_21 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f]);
												vec_19 = _mm256_fmadd_ps(vec_20, vec_21, mem_vec_0);
												mem_vec_0 = vec_19;
												vec_23 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 8]);
												vec_22 = _mm256_fmadd_ps(vec_20, vec_23, mem_vec_1);
												mem_vec_1 = vec_22;
												vec_25 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
												vec_24 = _mm256_fmadd_ps(vec_20, vec_25, mem_vec_2);
												mem_vec_2 = vec_24;
												vec_27 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 24]);
												...
												vec_40 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
												vec_38 = _mm256_fmadd_ps(vec_39, vec_40, mem_vec_0);
												mem_vec_0 = vec_38;
												vec_42 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 8]);
												vec_41 = _mm256_fmadd_ps(vec_39, vec_42, mem_vec_1);
												mem_vec_1 = vec_41;
												vec_44 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
												vec_43 = _mm256_fmadd_ps(vec_39, vec_44, mem_vec_2);
												mem_vec_2 = vec_43;
												vec_46 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 24]);
