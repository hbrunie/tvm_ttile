						...
						for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){
							...
							for (x = x0, xp_2 = x0_p_1, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 1;c += 1, cp_1 += 1, cp_0 += 1){
											...
											mem_vec_9 = vec_16;
											scal_5 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * y + h + 1) + c];
											vec_18 = _mm256_set1_ps(scal_5);
											vec_19 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f]);
											vec_17 = _mm256_fmadd_ps(vec_18, vec_19, mem_vec_0);
											mem_vec_0 = vec_17;
											vec_21 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 8]);
											vec_20 = _mm256_fmadd_ps(vec_18, vec_21, mem_vec_1);
											mem_vec_1 = vec_20;
											scal_6 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 1) + h + 1) + c];
											vec_23 = _mm256_set1_ps(scal_6);
											vec_22 = _mm256_fmadd_ps(vec_23, vec_19, mem_vec_2);
											mem_vec_2 = vec_22;
											vec_24 = _mm256_fmadd_ps(vec_23, vec_21, mem_vec_3);
											mem_vec_3 = vec_24;
											scal_7 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 2) + h + 1) + c];
											vec_26 = _mm256_set1_ps(scal_7);
											vec_25 = _mm256_fmadd_ps(vec_26, vec_19, mem_vec_4);
											mem_vec_4 = vec_25;
											vec_27 = _mm256_fmadd_ps(vec_26, vec_21, mem_vec_5);
											mem_vec_5 = vec_27;
											scal_8 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 3) + h + 1) + c];
											vec_29 = _mm256_set1_ps(scal_8);
											vec_28 = _mm256_fmadd_ps(vec_29, vec_19, mem_vec_6);
											mem_vec_6 = vec_28;
											vec_30 = _mm256_fmadd_ps(vec_29, vec_21, mem_vec_7);
											mem_vec_7 = vec_30;
											scal_9 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 4) + h + 1) + c];
											vec_32 = _mm256_set1_ps(scal_9);
											vec_31 = _mm256_fmadd_ps(vec_32, vec_19, mem_vec_8);
											mem_vec_8 = vec_31;
											vec_33 = _mm256_fmadd_ps(vec_32, vec_21, mem_vec_9);
											mem_vec_9 = vec_33;
											scal_10 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * y + h + 2) + c];
											vec_35 = _mm256_set1_ps(scal_10);
											vec_36 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
											vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_0);
											mem_vec_0 = vec_34;
											vec_38 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 8]);
											vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_1);
											mem_vec_1 = vec_37;
											scal_11 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 1) + h + 2) + c];
											...
											mem_vec_3 = vec_41;
											scal_12 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 2) + h + 2) + c];
											...
											mem_vec_5 = vec_44;
											scal_13 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 3) + h + 2) + c];
											...
											mem_vec_7 = vec_47;
											scal_14 = input[(strideA2 * (2 * Y + H - 1)) * (2 * x + w) + strideA2 * (2 * (y + 4) + h + 2) + c];
