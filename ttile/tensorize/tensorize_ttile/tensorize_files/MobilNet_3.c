...
f = 0;
fp_0 = 0;
				for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 14;y += 14, yp_1 += 14, yp_0 += 14){					// y = 14, x = 1, h = 3, w = 3, c = 128, f = 16
					// T (h, 1) (3 / 3)
					for (h = h0, hp_0 = 0;h < h0 + 3;h += 3, hp_0 += 3){						// y = 14, x = 1, h = 3, w = 3, c = 128, f = 16
						// T (w, 3) (3 / 1)
						for (w = w0, wp_0 = 0;w < w0 + 3;w += 1, wp_0 += 1){							// y = 14, x = 1, h = 3, w = 1, c = 128, f = 16
							// T (x, 1) (1 / 1)
							for (x = x0, xp_1 = x0_p_0, xp_0 = 0;x < x0 + 1;x += 1, xp_1 += 1, xp_0 += 1){										mem_vec_0 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
										...
										mem_vec_24 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_25 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8]);
										mem_vec_26 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_27 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 8]);
										// y = 14, x = 1, h = 3, w = 1, c = 128, f = 16
										// T (c, 128) (128 / 1)
										for (c = c0, cp_1 = c0_p_0, cp_0 = 0;c < c0 + 128;c += 1, cp_1 += 1, cp_0 += 1){											scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
									...
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_24);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8], mem_vec_25);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_26);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 8], mem_vec_27);
							}
						}
					}
				}
