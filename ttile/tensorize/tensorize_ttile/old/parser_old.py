...
def parser(name):
    ...
    if number_of_file == 1:
        ...
        level1 = write_c_file("tensorize_files/" + name + "1_.c", structure1[1][1], f1, structure1, "1")
        out_h1 = factor("height", structure1, level1, True)
        level2 = write_c_file("tensorize_files/" + name + "2_.c", structure2[1][1], f2, structure2, "2", out_h1)
