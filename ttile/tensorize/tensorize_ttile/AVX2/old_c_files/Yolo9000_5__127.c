...
// T (y, 1) (136 / 136)
for (y793 = y794, y793_p_0 = 0;
	y793 < y794 + 136;
	y793 += 136, y793_p_0 += 136){
	// y = 136, x = 136, h = 1, w = 1, c = 128, f = 64
	// T (x, 17) (136 / 8)
	for (x992 = x993, x992_p_0 = 0;
		...
		// T (y, 17) (136 / 8)
		for (y792 = y793, y792_p_1 = y793_p_0, y792_p_0 = 0;
			y792 < y793 + 136;
			y792 += 8, y792_p_1 += 8, y792_p_0 += 8){
			// y = 8, x = 8, h = 1, w = 1, c = 128, f = 64
			// T (x, 1) (8 / 8)
			for (x991 = x992, x991_p_1 = x992_p_0, x991_p_0 = 0;
				x991 < x992 + 8;
				x991 += 8, x991_p_1 += 8, x991_p_0 += 8){
				// y = 8, x = 8, h = 1, w = 1, c = 128, f = 64
				// T (f, 2) (64 / 32)
				for (f = f396, fp_0 = 0;
					f < f396 + 64;
					...
					// T (y, 2) (8 / 4)
					for (y = y792, yp_2 = y792_p_1, yp_1 = y792_p_0, yp_0 = 0;
						y < y792 + 8;
						...
						for (x990 = x991, x990_p_2 = x991_p_1, x990_p_1 = x991_p_0, x990_p_0 = 0;
							x990 < x991 + 8;
							x990 += 8, x990_p_2 += 8, x990_p_1 += 8, x990_p_0 += 8){
							// y = 4, x = 8, h = 1, w = 1, c = 128, f = 32
							// T (c, 4) (128 / 32)
