...
yp_2 = 0;
				for (h = h121, hp_0 = 0;h < h121 + 3;h += 1, hp_0 += 1){
					...
					for (w = w147, wp_0 = 0;w < w147 + 3;w += 1, wp_0 += 1){
						...
						// T (c, 1) (3 / 3)
						for (c220 = c221, c220_p_0 = 0;c220 < c221 + 3;c220 += 3, c220_p_0 += 3){
							// y = 4, x = 8, h = 1, w = 1, c = 3, f = 32
							// T (x, 8) (8 / 1)
							for (x = x272, xp_1 = x272_p_0, xp_0 = 0;x < x272 + 8;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c220, cp_1 = c220_p_0, cp_0 = 0;c < c220 + 3;c += 1, cp_1 += 1, cp_0 += 1){
