...
*/
IND_TYPE c, cp_0, c474_p_0, c475_p_0, cp_1, c474_p_1, cp_2, c474, c475, f, fp_0, f478_p_0, f479_p_0, fp_1, f478_p_1, fp_2, f478, f479, w, wp_0, x, xp_0, y, yp_0;
...
for (f479 = f480, f479_p_0 = 0;
	...
	for (c475 = c476, c475_p_0 = 0;
		c475 < c476 + 128;
		c475 += 128, c475_p_0 += 128){
		// y = 28, x = 28, h = 3, w = 3, c = 128, f = 64
		// T (f, 2) (64 / 32)
		for (f478 = f479, f478_p_1 = f479_p_0, f478_p_0 = 0;
			f478 < f479 + 64;
			f478 += 32, f478_p_1 += 32, f478_p_0 += 32){
			...
			for (y = y252, yp_0 = 0;
				...
				for (f = f478, fp_2 = f478_p_1, fp_1 = f478_p_0, fp_0 = 0;
					...
					for (c474 = c475, c474_p_1 = c475_p_0, c474_p_0 = 0;
						c474 < c475 + 128;
						c474 += 64, c474_p_1 += 64, c474_p_0 += 64){
