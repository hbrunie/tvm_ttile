...
[V f; U (4, f); U (4, y); U (3, h); T (3, c); Hoist_vars [c]; T (1, x);
  T (1, c); T (3, w); T (17, y); T (544, x); T (2, y); T (4, y)]
*/
IND_TYPE c, cp_0, c325_p_0, cp_1, c325, w, wp_0, x, xp_0, x389_p_0, xp_1, x389, y, yp_0, y444_p_0, y445_p_0, yp_1, y444_p_1, yp_2, y444, y445;
IND_TYPE y446 = 0;
IND_TYPE x390 = 0;
IND_TYPE h = 0;
IND_TYPE w221 = 0;
...
yp_2 = 0;
				for (w = w221, wp_0 = 0;w < w221 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c325 = c326, c325_p_0 = 0;c325 < c326 + 3;c325 += 3, c325_p_0 += 3){
						// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
						// T (x, 1) (1 / 1)
						for (x = x389, xp_1 = x389_p_0, xp_0 = 0;x < x389 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c325, cp_1 = c325_p_0, cp_0 = 0;c < c325 + 3;c += 1, cp_1 += 1, cp_0 += 1){
