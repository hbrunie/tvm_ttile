...
c728_p_1 = 0;
							for (h = h263, hp_0 = 0;h < h263 + 3;h += 1, hp_0 += 1){
								...
								// T (x, 8) (8 / 1)
								for (x = x546, xp_1 = x546_p_0, xp_0 = 0;x < x546 + 8;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_8366 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
											mem_vec_8367 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24]);
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_8366);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 24], mem_vec_8367);
								}
							}
}
