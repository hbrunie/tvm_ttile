...
*/
IND_TYPE c, cp_0, c449_p_0, c450_p_0, cp_1, c449_p_1, cp_2, c449, c450, f, fp_0, f450_p_0, f451_p_0, fp_1, f450_p_1, fp_2, f450, f451, w, wp_0, x, xp_0, y, yp_0;
			...
			for (y = y235, yp_0 = 0;
				...
				for (f = f450, fp_2 = f450_p_1, fp_1 = f450_p_0, fp_0 = 0;
					...
					for (c449 = c450, c449_p_1 = c450_p_0, c449_p_0 = 0;
						c449 < c450 + 64;
						c449 += 64, c449_p_1 += 64, c449_p_0 += 64){
						// y = 7, x = 28, h = 3, w = 3, c = 64, f = 32
						// T (x, 28) (28 / 1)
						for (x = x228, xp_0 = 0;
							x < x228 + 28;
							...
							for (w = w177, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										// T (c, 64) (64 / 1)
										for (c = c449, cp_2 = c449_p_1, cp_1 = c449_p_0, cp_0 = 0;
											c < c449 + 64;
