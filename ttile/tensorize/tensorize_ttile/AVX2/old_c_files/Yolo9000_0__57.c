...
[V f; U (4, f); U (4, y); U (3, w); T (3, c); Hoist_vars [c]; T (8, x);
  T (1, c); T (3, h); T (17, y); T (68, x); T (1, y); T (8, y)]
*/
IND_TYPE c, cp_0, c343_p_0, cp_1, c343, h, hp_0, x, xp_0, x407_p_0, xp_1, x407, y, yp_0, y468_p_0, y469_p_0, yp_1, y468_p_1, yp_2, y468, y469;
...
for (y469 = y470, y469_p_0 = 0;
	...
	for (y468 = y469, y468_p_1 = y469_p_0, y468_p_0 = 0;
		y468 < y469 + 68;
		y468 += 68, y468_p_1 += 68, y468_p_0 += 68){
		// y = 68, x = 544, h = 3, w = 3, c = 3, f = 32
		// T (x, 68) (544 / 8)
