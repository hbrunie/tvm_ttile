...
*/
IND_TYPE c, cp_0, c48_p_0, c49_p_0, cp_1, c48_p_1, cp_2, c48, c49, f, fp_0, f45_p_0, f46_p_0, fp_1, f45_p_1, fp_2, f45, f46, h, hp_0, x, xp_0, y, yp_0;
...
for (f46 = f47, f46_p_0 = 0;
	...
	for (c49 = c50, c49_p_0 = 0;
		...
		// T (f, 2) (128 / 64)
		for (f45 = f46, f45_p_1 = f46_p_0, f45_p_0 = 0;
			f45 < f46 + 128;
			f45 += 64, f45_p_1 += 64, f45_p_0 += 64){
			...
			for (y = y24, yp_0 = 0;
				...
				// T (f, 2) (64 / 32)
				for (f = f45, fp_2 = f45_p_1, fp_1 = f45_p_0, fp_0 = 0;
					f < f45 + 64;
