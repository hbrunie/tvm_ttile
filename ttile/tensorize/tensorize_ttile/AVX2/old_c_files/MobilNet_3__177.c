...
for (f281 = f282, f281_p_0 = 0;
	...
	for (c381 = c382, c381_p_0 = 0;
		...
		// T (f, 2) (64 / 32)
		for (f = f281, fp_1 = f281_p_0, fp_0 = 0;
			f < f281 + 64;
				...
				x285 += 1, x285_p_0 += 1){
					for (y = y190, yp_0 = 0;
						...
						for (c380 = c381, c380_p_1 = c381_p_0, c380_p_0 = 0;
							c380 < c381 + 64;
							c380 += 64, c380_p_1 += 64, c380_p_0 += 64){
							// y = ph_y, x = 1, h = 3, w = 3, c = 64, f = 32
							// T (h, 3) (3 / 1)
							for (h = h138, hp_0 = 0;
								h < h138 + 3;
							...
							for (h = h138, hp_0 = 0;
								...
								for (x = x285, xp_1 = x285_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4352 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_4353 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
											mem_vec_4354 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_4355 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
											mem_vec_4356 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_4357 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
											mem_vec_4358 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_4359 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
											// y = ph_y, x = 1, h = 1, w = 3, c = 64, f = 32
											// T (c, 64) (64 / 1)
											for (c = c380, cp_2 = c380_p_1, cp_1 = c380_p_0, cp_0 = 0;
												c < c380 + 64;
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_4352);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_4353);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_4354);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_4355);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_4356);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_4357);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_4358);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_4359);
								}
							}
						}
					}
