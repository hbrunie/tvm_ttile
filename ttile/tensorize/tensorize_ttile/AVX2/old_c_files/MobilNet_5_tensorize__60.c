...
[V f; U (4, f); U (4, y); U (3, h); T (8, c); Hoist_vars [c]; T (3, w);
  T (28, x); T (4, c); T (2, f); T (7, y); T (1, f); T (8, c); T (4, f)]
*/
IND_TYPE c, cp_0, c54_p_0, c55_p_0, cp_1, c54_p_1, cp_2, c54, c55, f, fp_0, f54_p_0, f55_p_0, fp_1, f54_p_1, fp_2, f54, f55, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y30 = 0;
IND_TYPE x28 = 0;
IND_TYPE h = 0;
IND_TYPE w24 = 0;
...
xp_0 = 0;
							for (w = w24, wp_0 = 0;w < w24 + 3;w += 1, wp_0 += 1){
										...
										// T (c, 8) (8 / 1)
										for (c = c54, cp_2 = c54_p_1, cp_1 = c54_p_0, cp_0 = 0;c < c54 + 8;c += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
