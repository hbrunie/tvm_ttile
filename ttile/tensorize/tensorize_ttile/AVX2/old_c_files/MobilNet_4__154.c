...
*/
IND_TYPE c, c0, cp_0, c0_p_0, c1_p_0, c1, cp_1, c0_p_1, cp_2, f, f0, fp_0, f0_p_0, f1_p_0, f1, fp_1, f0_p_1, fp_2, w, wp_0, x, xp_0, y, yp_0;
							...
							for (w = w0, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c0, cp_2 = c0_p_1, cp_1 = c0_p_0, cp_0 = 0;
											...
											vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_0);
											mem_vec_0 = vec_24;

											vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

											vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_1);
											mem_vec_1 = vec_27;

											vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_2);
											mem_vec_2 = vec_29;

											vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

											vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_3);
											mem_vec_3 = vec_31;
											scal_5 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 1) + c];
											vec_34 = _mm256_set1_ps(scal_5);


											vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_4);
											mem_vec_4 = vec_33;



											vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_5);
											mem_vec_5 = vec_35;



											vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_6);
											mem_vec_6 = vec_36;



											vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_7);
											mem_vec_7 = vec_37;
											scal_6 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 1) + c];
											vec_39 = _mm256_set1_ps(scal_6);


											vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_8);
											mem_vec_8 = vec_38;



											vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_9);
											mem_vec_9 = vec_40;



											vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_10);
											mem_vec_10 = vec_41;



											vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_11);
											mem_vec_11 = vec_42;
											scal_7 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 1) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_12);
											mem_vec_12 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_13);
											mem_vec_13 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_14);
											mem_vec_14 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_15);
											mem_vec_15 = vec_47;
											scal_8 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * y + h + 2) + c];
											vec_49 = _mm256_set1_ps(scal_8);
											vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_0);
											mem_vec_0 = vec_48;

											vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

											vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_1);
											mem_vec_1 = vec_51;

											vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_2);
											mem_vec_2 = vec_53;

											vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

											vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_3);
											mem_vec_3 = vec_55;
											scal_9 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 1) + h + 2) + c];
											vec_58 = _mm256_set1_ps(scal_9);


											vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_4);
											mem_vec_4 = vec_57;



											vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_5);
											mem_vec_5 = vec_59;



											vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_6);
											mem_vec_6 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_7);
											mem_vec_7 = vec_61;
											scal_10 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 2) + h + 2) + c];
											vec_63 = _mm256_set1_ps(scal_10);


											vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_8);
											mem_vec_8 = vec_62;



											vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_9);
											mem_vec_9 = vec_64;



											vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_10);
											mem_vec_10 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_11);
											mem_vec_11 = vec_66;
											scal_11 = input[(C * (2 * Y + H - 1)) * (2 * x + w) + C * (2 * (y + 3) + h + 2) + c];
											vec_68 = _mm256_set1_ps(scal_11);


											vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_12);
											mem_vec_12 = vec_67;



											vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_13);
											mem_vec_13 = vec_69;



											vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_14);
											mem_vec_14 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_15);
											mem_vec_15 = vec_71;
										}
