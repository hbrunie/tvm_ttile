...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (2, x); T (4, f);
  T (1, x); T (1, y); T (14, x); T (7, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x100_p_0, x101_p_0, xp_1, x100_p_1, xp_2, x100, x101, y, yp_0, y75_p_0, yp_1, y75;
IND_TYPE y76 = 0;
IND_TYPE x102 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
fp_0 = 0;
					for (x = x100, xp_2 = x100_p_1, xp_1 = x100_p_0, xp_0 = 0;x < x100 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 64) (64 / 1)
								for (c = c50, cp_0 = 0;c < c50 + 64;c += 1, cp_0 += 1){
