...
*/
IND_TYPE c, cp_0, c156_p_0, c157_p_0, cp_1, c156_p_1, cp_2, c156, c157, f, fp_0, f117_p_0, fp_1, f117, w, wp_0, x, xp_0, y, yp_0;
					...
					for (x = x78, xp_0 = 0;
						...
						for (w = w60, wp_0 = 0;
							...
							w += 1, wp_0 += 1){
									...
									mem_vec_1116 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
									mem_vec_1117 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
									mem_vec_1118 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
									mem_vec_1119 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_1116);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_1117);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_1118);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_1119);
						}
					}
				}
			}
