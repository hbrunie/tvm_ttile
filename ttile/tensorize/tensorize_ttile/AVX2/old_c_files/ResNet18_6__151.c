...
[V f; U (4, f); U (4, y); U (3, w); T (16, c); Hoist_vars [c]; T (3, h);
  T (28, x); T (2, c); T (2, f); T (7, y); T (1, f); T (4, c); T (2, f)]
*/
IND_TYPE c, cp_0, c36_p_0, c37_p_0, cp_1, c36_p_1, cp_2, c36, c37, f, fp_0, f36_p_0, f37_p_0, fp_1, f36_p_1, fp_2, f36, f37, h, hp_0, x, xp_0, y, yp_0;
							...
							for (h = h12, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										for (c = c36, cp_2 = c36_p_1, cp_1 = c36_p_0, cp_0 = 0;
											...
											vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_144);
											mem_vec_144 = vec_24;

											vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_145);
											mem_vec_145 = vec_27;

											vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_146);
											mem_vec_146 = vec_29;

											vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_147);
											mem_vec_147 = vec_31;
											scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_34 = _mm256_set1_ps(scal_5);


											vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_148);
											mem_vec_148 = vec_33;



											vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_149);
											mem_vec_149 = vec_35;



											vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_150);
											mem_vec_150 = vec_36;



											vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_151);
											mem_vec_151 = vec_37;
											scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_39 = _mm256_set1_ps(scal_6);


											vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_152);
											mem_vec_152 = vec_38;



											vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_153);
											mem_vec_153 = vec_40;



											vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_154);
											mem_vec_154 = vec_41;



											vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_155);
											mem_vec_155 = vec_42;
											scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_156);
											mem_vec_156 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_157);
											mem_vec_157 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_158);
											mem_vec_158 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_159);
											mem_vec_159 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);
											vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_144);
											mem_vec_144 = vec_48;

											vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_145);
											mem_vec_145 = vec_51;

											vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_146);
											mem_vec_146 = vec_53;

											vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_147);
											mem_vec_147 = vec_55;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_58 = _mm256_set1_ps(scal_9);


											vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_148);
											mem_vec_148 = vec_57;



											vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_149);
											mem_vec_149 = vec_59;



											vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_150);
											mem_vec_150 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_151);
											mem_vec_151 = vec_61;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_63 = _mm256_set1_ps(scal_10);


											vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_152);
											mem_vec_152 = vec_62;



											vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_153);
											mem_vec_153 = vec_64;



											vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_154);
											mem_vec_154 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_155);
											mem_vec_155 = vec_66;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_68 = _mm256_set1_ps(scal_11);


											vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_156);
											mem_vec_156 = vec_67;



											vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_157);
											mem_vec_157 = vec_69;



											vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_158);
											mem_vec_158 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_159);
											mem_vec_159 = vec_71;
										}
