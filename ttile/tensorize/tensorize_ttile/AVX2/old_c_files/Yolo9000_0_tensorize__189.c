...
yp_2 = 0;
				for (w = w138, wp_0 = 0;w < w138 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c202 = c203, c202_p_0 = 0;c202 < c203 + 3;c202 += 3, c202_p_0 += 3){
						// y = 4, x = 136, h = 3, w = 1, c = 3, f = 32
						// T (x, 136) (136 / 1)
						for (x = x254, xp_1 = x254_p_0, xp_0 = 0;x < x254 + 136;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c202, cp_1 = c202_p_0, cp_0 = 0;c < c202 + 3;c += 1, cp_1 += 1, cp_0 += 1){
