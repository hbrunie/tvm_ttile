...
yp_2 = 0;
				for (h = h180, hp_0 = 0;h < h180 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c337 = c338, c337_p_0 = 0;c337 < c338 + 3;c337 += 3, c337_p_0 += 3){
						// y = 4, x = 8, h = 1, w = 3, c = 3, f = 32
						// T (x, 8) (8 / 1)
						for (x = x401, xp_1 = x401_p_0, xp_0 = 0;x < x401 + 8;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c337, cp_1 = c337_p_0, cp_0 = 0;c < c337 + 3;c += 1, cp_1 += 1, cp_0 += 1){
