...
yp_2 = 0;
				for (w = w207, wp_0 = 0;w < w207 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c304 = c305, c304_p_0 = 0;c304 < c305 + 3;c304 += 3, c304_p_0 += 3){
						// y = 4, x = 4, h = 3, w = 1, c = 3, f = 32
						// T (x, 4) (4 / 1)
						for (x = x368, xp_1 = x368_p_0, xp_0 = 0;x < x368 + 4;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c304, cp_1 = c304_p_0, cp_0 = 0;c < c304 + 3;c += 1, cp_1 += 1, cp_0 += 1){
