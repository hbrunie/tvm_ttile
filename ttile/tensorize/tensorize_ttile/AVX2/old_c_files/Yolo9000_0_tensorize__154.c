...
yp_2 = 0;
				for (h = h106, hp_0 = 0;h < h106 + 3;h += 1, hp_0 += 1){
					...
					for (w = w132, wp_0 = 0;w < w132 + 3;w += 1, wp_0 += 1){
						...
						// T (c, 1) (3 / 3)
						for (c193 = c194, c193_p_0 = 0;c193 < c194 + 3;c193 += 3, c193_p_0 += 3){
							// y = 4, x = 136, h = 1, w = 1, c = 3, f = 32
							// T (x, 136) (136 / 1)
							for (x = x245, xp_1 = x245_p_0, xp_0 = 0;x < x245 + 136;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c193, cp_1 = c193_p_0, cp_0 = 0;c < c193 + 3;c += 1, cp_1 += 1, cp_0 += 1){
