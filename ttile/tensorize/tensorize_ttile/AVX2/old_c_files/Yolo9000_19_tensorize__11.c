...
c24 = 0;
c24_p_0 = 0;
			for (f = f16, fp_0 = 0;f < f16 + 512;f += 32, fp_0 += 32){
					for (y = y24, yp_1 = y24_p_0, yp_0 = 0;y < y24 + 12;y += 4, yp_1 += 4, yp_0 += 4){
					...
					for (y = y24 + 12, yp_1 = y24_p_0, yp_0 = 0;y < y24 + 12 + 5;y += 5, yp_1 += 5, yp_0 += 5){
						// y = ph_y, x = 17, h = 1, w = 1, c = 32, f = 32
						// T (x, 17) (17 / 1)
						for (x = x24, xp_1 = x24_p_0, xp_0 = 0;x < x24 + 17;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_320 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
									mem_vec_321 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
									mem_vec_322 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
									mem_vec_323 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
									// T (c, 32) (32 / 1)
									for (c = c24, cp_1 = c24_p_0, cp_0 = 0;c < c24 + 32;c += 1, cp_1 += 1, cp_0 += 1){
										scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_320);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_321);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_322);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_323);
						}
					}
			}
}
