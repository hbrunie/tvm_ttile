...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, c); T (1, f); T (14, y); T (4, x); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c399_p_0, cp_1, c399, f, fp_0, f517_p_0, f518_p_0, fp_1, f517_p_1, fp_2, f517, f518, h, hp_0, x, xp_0, x400_p_0, xp_1, x400, y, yp_0;
...
for (f518 = f519, f518_p_0 = 0;
	...
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 2) (64 / 32)
	for (f517 = f518, f517_p_1 = f518_p_0, f517_p_0 = 0;
		f517 < f518 + 64;
		f517 += 32, f517_p_1 += 32, f517_p_0 += 32){
		...
		for (x400 = x401, x400_p_0 = 0;
			...
			for (y = y272, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f517, fp_2 = f517_p_1, fp_1 = f517_p_0, fp_0 = 0;
					f < f517 + 32;
