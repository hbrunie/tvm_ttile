			...
			f522 += 32, f522_p_1 += 32, f522_p_0 += 32){
				for (y = y269, yp_0 = 0;
					...
					for (f = f522, fp_2 = f522_p_1, fp_1 = f522_p_0, fp_0 = 0;
						...
						// y = ph_y, x = 28, h = 3, w = 3, c = 16, f = 32
						// T (c, 1) (16 / 16)
						for (c523 = c524, c523_p_1 = c524_p_0, c523_p_0 = 0;
							c523 < c524 + 16;
							c523 += 16, c523_p_1 += 16, c523_p_0 += 16){
							// y = ph_y, x = 28, h = 3, w = 3, c = 16, f = 32
							// T (x, 28) (28 / 1)
							for (x = x264, xp_0 = 0;
								x < x264 + 28;
								...
								for (h = h192, hp_0 = 0;
									...
									h += 1, hp_0 += 1){
											...
											// T (c, 16) (16 / 1)
											for (c = c523, cp_2 = c523_p_1, cp_1 = c523_p_0, cp_0 = 0;
												c < c523 + 16;
							...
							for (x = x264, xp_0 = 0;
								...
								for (h = h192, hp_0 = 0;
									...
									h += 1, hp_0 += 1){
											...
											mem_vec_3476 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_3477 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
											mem_vec_3478 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_3479 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
											// y = ph_y, x = 1, h = 1, w = 3, c = 16, f = 32
											// T (c, 16) (16 / 1)
											for (c = c523, cp_2 = c523_p_1, cp_1 = c523_p_0, cp_0 = 0;
												c < c523 + 16;
												...
												vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_3478);
												mem_vec_3478 = vec_32;



												vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_3479);
												mem_vec_3479 = vec_33;
												scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
												vec_35 = _mm256_set1_ps(scal_6);
												vec_36 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

												vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_3456);
												mem_vec_3456 = vec_34;

												vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

												vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_3457);
												mem_vec_3457 = vec_37;

												vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_3458);
												mem_vec_3458 = vec_39;

												vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

												vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_3459);
												mem_vec_3459 = vec_41;
												scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_44 = _mm256_set1_ps(scal_7);


												vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_3460);
												mem_vec_3460 = vec_43;



												vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_3461);
												mem_vec_3461 = vec_45;



												vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_3462);
												mem_vec_3462 = vec_46;



												vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_3463);
												mem_vec_3463 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_49 = _mm256_set1_ps(scal_8);


												vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_3464);
												mem_vec_3464 = vec_48;



												vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_3465);
												mem_vec_3465 = vec_50;



												vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_3466);
												mem_vec_3466 = vec_51;



												vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_3467);
												mem_vec_3467 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_54 = _mm256_set1_ps(scal_9);


												vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_3468);
												mem_vec_3468 = vec_53;



												vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_3469);
												mem_vec_3469 = vec_55;



												vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_3470);
												mem_vec_3470 = vec_56;



												vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_3471);
												mem_vec_3471 = vec_57;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_59 = _mm256_set1_ps(scal_10);


												vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_3472);
												mem_vec_3472 = vec_58;



												vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_3473);
												mem_vec_3473 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_3474);
												mem_vec_3474 = vec_61;



												vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_3475);
												mem_vec_3475 = vec_62;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
												vec_64 = _mm256_set1_ps(scal_11);


												vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_3476);
												mem_vec_3476 = vec_63;



												vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_3477);
												mem_vec_3477 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_3478);
												mem_vec_3478 = vec_66;



												vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_3479);
												mem_vec_3479 = vec_67;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_69 = _mm256_set1_ps(scal_12);
												vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_3456);
												mem_vec_3456 = vec_68;

												vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

												vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_3457);
												mem_vec_3457 = vec_71;

												vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_3458);
												mem_vec_3458 = vec_73;

												vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

												vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_3459);
												mem_vec_3459 = vec_75;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_78 = _mm256_set1_ps(scal_13);


												vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_3460);
												mem_vec_3460 = vec_77;



												vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_3461);
												mem_vec_3461 = vec_79;



												vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_3462);
												mem_vec_3462 = vec_80;



												vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_3463);
												mem_vec_3463 = vec_81;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_83 = _mm256_set1_ps(scal_14);


												vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_3464);
												mem_vec_3464 = vec_82;



												vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_3465);
												mem_vec_3465 = vec_84;



												vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_3466);
												mem_vec_3466 = vec_85;



												vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_3467);
												mem_vec_3467 = vec_86;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_88 = _mm256_set1_ps(scal_15);


												vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_3468);
												mem_vec_3468 = vec_87;



												vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_3469);
												mem_vec_3469 = vec_89;



												vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_3470);
												mem_vec_3470 = vec_90;



												vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_3471);
												mem_vec_3471 = vec_91;
												scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_93 = _mm256_set1_ps(scal_16);


												vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_3472);
												mem_vec_3472 = vec_92;



												vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_3473);
												mem_vec_3473 = vec_94;



												vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_3474);
												mem_vec_3474 = vec_95;



												vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_3475);
												mem_vec_3475 = vec_96;
												scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_98 = _mm256_set1_ps(scal_17);


												vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_3476);
												mem_vec_3476 = vec_97;



												vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_3477);
												mem_vec_3477 = vec_99;



												vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_3478);
												mem_vec_3478 = vec_100;



												vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_3479);
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_3476);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_3477);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_3478);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_3479);
								}
							}
						}
					}
