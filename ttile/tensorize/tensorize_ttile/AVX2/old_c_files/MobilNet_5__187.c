...
*/
IND_TYPE c, cp_0, c70_p_0, c71_p_0, cp_1, c70_p_1, cp_2, c70, c71, f, fp_0, f70_p_0, f71_p_0, fp_1, f70_p_1, fp_2, f70, f71, h, hp_0, x, xp_0, y, yp_0;
		...
		for (f70 = f71, f70_p_1 = f71_p_0, f70_p_0 = 0;
			...
			for (y = y38, yp_0 = 0;
				...
				for (f = f70, fp_2 = f70_p_1, fp_1 = f70_p_0, fp_0 = 0;
					...
					// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
					// T (c, 1) (32 / 32)
					for (c70 = c71, c70_p_1 = c71_p_0, c70_p_0 = 0;
						c70 < c71 + 32;
						c70 += 32, c70_p_1 += 32, c70_p_0 += 32){
						// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
						// T (x, 28) (28 / 1)
						for (x = x36, xp_0 = 0;
							x < x36 + 28;
							...
							for (h = h24, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 32) (32 / 1)
										for (c = c70, cp_2 = c70_p_1, cp_1 = c70_p_0, cp_0 = 0;
											c < c70 + 32;
