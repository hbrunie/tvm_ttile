...
[V f; U (4, f); U (7, y); U (3, w); T (64, c); Hoist_vars [c]; T (3, h);
  T (28, x); T (2, c); T (1, f); T (4, y); T (1, f); T (1, c); T (4, f)]
*/
IND_TYPE c, cp_0, c545_p_0, c546_p_0, cp_1, c545_p_1, cp_2, c545, c546, f, fp_0, f546_p_0, f547_p_0, fp_1, f546_p_1, fp_2, f546, f547, h, hp_0, x, xp_0, y, yp_0;
			...
			for (y = y283, yp_0 = 0;
				...
				for (f = f546, fp_2 = f546_p_1, fp_1 = f546_p_0, fp_0 = 0;
					...
					for (c545 = c546, c545_p_1 = c546_p_0, c545_p_0 = 0;
						c545 < c546 + 128;
						c545 += 64, c545_p_1 += 64, c545_p_0 += 64){
