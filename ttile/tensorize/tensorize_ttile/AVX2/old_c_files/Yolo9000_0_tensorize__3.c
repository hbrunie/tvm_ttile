...
[V f; U (4, f); U (4, y); U (3, h); T (3, c); Hoist_vars [c]; T (4, x);
  T (1, c); T (3, w); T (17, y); T (136, x); T (8, y); T (1, y)]
*/
IND_TYPE c, cp_0, c295_p_0, cp_1, c295, w, wp_0, x, xp_0, x359_p_0, xp_1, x359, y, yp_0, y404_p_0, y405_p_0, yp_1, y404_p_1, yp_2, y404, y405;
IND_TYPE y406 = 0;
IND_TYPE x360 = 0;
IND_TYPE h = 0;
IND_TYPE w201 = 0;
...
yp_2 = 0;
				for (w = w201, wp_0 = 0;w < w201 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c295 = c296, c295_p_0 = 0;c295 < c296 + 3;c295 += 3, c295_p_0 += 3){
						// y = 4, x = 4, h = 3, w = 1, c = 3, f = 32
						// T (x, 4) (4 / 1)
						for (x = x359, xp_1 = x359_p_0, xp_0 = 0;x < x359 + 4;x += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_2304 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									mem_vec_2305 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 8]);
									mem_vec_2306 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
									mem_vec_2307 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 24]);
									...
									mem_vec_2310 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16]);
									mem_vec_2311 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 24]);
									mem_vec_2312 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_2313 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 8]);
									mem_vec_2314 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16]);
									mem_vec_2315 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 24]);
									mem_vec_2316 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
									mem_vec_2317 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8]);
									mem_vec_2318 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16]);
									mem_vec_2319 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 24]);
									// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c295, cp_1 = c295_p_0, cp_0 = 0;c < c295 + 3;c += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_2306);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 24], mem_vec_2307);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16], mem_vec_2310);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 24], mem_vec_2311);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_2312);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 8], mem_vec_2313);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16], mem_vec_2314);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 24], mem_vec_2315);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_2316);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 8], mem_vec_2317);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 16], mem_vec_2318);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 24], mem_vec_2319);
						}
					}
				}
}
