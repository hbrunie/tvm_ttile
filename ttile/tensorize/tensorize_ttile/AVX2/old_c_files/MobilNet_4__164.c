...
*/
IND_TYPE c, cp_0, c425_p_0, c426_p_0, cp_1, c425_p_1, cp_2, c425, c426, f, fp_0, f426_p_0, f427_p_0, fp_1, f426_p_1, fp_2, f426, f427, w, wp_0, x, xp_0, y, yp_0;
			...
			for (y = y223, yp_0 = 0;
				...
				for (f = f426, fp_2 = f426_p_1, fp_1 = f426_p_0, fp_0 = 0;
					...
					for (c425 = c426, c425_p_1 = c426_p_0, c425_p_0 = 0;
						c425 < c426 + 128;
						c425 += 64, c425_p_1 += 64, c425_p_0 += 64){
						...
						for (x = x216, xp_0 = 0;
							...
							for (w = w165, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										// T (c, 64) (64 / 1)
										for (c = c425, cp_2 = c425_p_1, cp_1 = c425_p_0, cp_0 = 0;
											c < c425 + 64;
