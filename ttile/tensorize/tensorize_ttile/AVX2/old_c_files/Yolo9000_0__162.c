...
[V f; U (4, f); U (4, y); U (3, w); T (3, c); Hoist_vars [c]; T (4, x);
  T (1, c); T (3, h); T (17, y); T (136, x); T (1, y); T (8, y)]
*/
IND_TYPE c, cp_0, c355_p_0, cp_1, c355, h, hp_0, x, xp_0, x419_p_0, xp_1, x419, y, yp_0, y484_p_0, y485_p_0, yp_1, y484_p_1, yp_2, y484, y485;
...
for (y485 = y486, y485_p_0 = 0;
	...
	for (y484 = y485, y484_p_1 = y485_p_0, y484_p_0 = 0;
		y484 < y485 + 68;
		y484 += 68, y484_p_1 += 68, y484_p_0 += 68){
		// y = 68, x = 544, h = 3, w = 3, c = 3, f = 32
		// T (x, 136) (544 / 4)
