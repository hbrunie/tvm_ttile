...
[V f; U (4, f); U (4, y); U (3, h); T (3, c); Hoist_vars [c]; T (1, x);
  T (1, c); T (3, w); T (68, y); T (544, x); T (1, y); T (2, y)]
*/
IND_TYPE c, cp_0, c11_p_0, cp_1, c11, w, wp_0, x, xp_0, x13_p_0, xp_1, x13, y, yp_0, y15_p_0, y16_p_0, yp_1, y15_p_1, yp_2, y15, y16;
...
for (y16 = y17, y16_p_0 = 0;
	...
	// T (y, 1) (272 / 272)
	for (y15 = y16, y15_p_1 = y16_p_0, y15_p_0 = 0;
		y15 < y16 + 272;
		y15 += 272, y15_p_1 += 272, y15_p_0 += 272){
		// y = 272, x = 544, h = 3, w = 3, c = 3, f = 32
		// T (x, 544) (544 / 1)
		for (x13 = x14, x13_p_0 = 0;
			...
			// T (y, 68) (272 / 4)
			for (y = y15, yp_2 = y15_p_1, yp_1 = y15_p_0, yp_0 = 0;
				y < y15 + 272;
