...
[V f; U (4, f); ULambda y; U (3, w); T (32, c); Hoist_vars [c]; T (3, h);
  ...
  T (2, c); T (2, f)]
*/
IND_TYPE c, cp_0, c54_p_0, c55_p_0, cp_1, c54_p_1, cp_2, c54, c55, f, fp_0, f58_p_0, fp_1, f58, h, hp_0, x, xp_0, y, yp_0;
		...
		for (f = f58, fp_1 = f58_p_0, fp_0 = 0;
			...
			f += 32, fp_1 += 32, fp_0 += 32){
				for (y = y42, yp_0 = 0;
					...
					// T (c, 4) (128 / 32)
					for (c54 = c55, c54_p_1 = c55_p_0, c54_p_0 = 0;
						c54 < c55 + 128;
						c54 += 32, c54_p_1 += 32, c54_p_0 += 32){
						...
						for (x = x32, xp_0 = 0;
							...
							for (h = h28, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 32) (32 / 1)
										for (c = c54, cp_2 = c54_p_1, cp_1 = c54_p_0, cp_0 = 0;
											c < c54 + 32;
											...
											vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_672);
											mem_vec_672 = vec_34;

											vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_673);
											mem_vec_673 = vec_37;

											vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_674);
											mem_vec_674 = vec_39;

											vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_675);
											mem_vec_675 = vec_41;
											scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_676);
											mem_vec_676 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_677);
											mem_vec_677 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_678);
											mem_vec_678 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_679);
											mem_vec_679 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_680);
											mem_vec_680 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_681);
											mem_vec_681 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_682);
											mem_vec_682 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_683);
											mem_vec_683 = vec_52;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_684);
											mem_vec_684 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_685);
											mem_vec_685 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_686);
											mem_vec_686 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_687);
											mem_vec_687 = vec_57;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_59 = _mm256_set1_ps(scal_10);


											vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_688);
											mem_vec_688 = vec_58;



											vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_689);
											mem_vec_689 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_690);
											mem_vec_690 = vec_61;



											vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_691);
											mem_vec_691 = vec_62;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_64 = _mm256_set1_ps(scal_11);


											vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_692);
											mem_vec_692 = vec_63;



											vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_693);
											mem_vec_693 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_694);
											mem_vec_694 = vec_66;



											vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_695);
											mem_vec_695 = vec_67;
											scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_69 = _mm256_set1_ps(scal_12);
											vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_672);
											mem_vec_672 = vec_68;

											vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_673);
											mem_vec_673 = vec_71;

											vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_674);
											mem_vec_674 = vec_73;

											vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_675);
											mem_vec_675 = vec_75;
											scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_676);
											mem_vec_676 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_677);
											mem_vec_677 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_678);
											mem_vec_678 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_679);
											mem_vec_679 = vec_81;
											scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_680);
											mem_vec_680 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_681);
											mem_vec_681 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_682);
											mem_vec_682 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_683);
											mem_vec_683 = vec_86;
											scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_88 = _mm256_set1_ps(scal_15);


											vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_684);
											mem_vec_684 = vec_87;



											vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_685);
											mem_vec_685 = vec_89;



											vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_686);
											mem_vec_686 = vec_90;



											vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_687);
											mem_vec_687 = vec_91;
											scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_93 = _mm256_set1_ps(scal_16);


											vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_688);
											mem_vec_688 = vec_92;



											vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_689);
											mem_vec_689 = vec_94;



											vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_690);
											mem_vec_690 = vec_95;



											vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_691);
											mem_vec_691 = vec_96;
											scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_98 = _mm256_set1_ps(scal_17);


											vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_692);
											mem_vec_692 = vec_97;



											vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_693);
											mem_vec_693 = vec_99;



											vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_694);
											mem_vec_694 = vec_100;



											vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_695);
											mem_vec_695 = vec_101;
										}
						...
						for (x = x32, xp_0 = 0;
							...
							for (h = h28, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										mem_vec_716 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
										mem_vec_717 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
										mem_vec_718 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
										mem_vec_719 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
										mem_vec_720 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
										mem_vec_721 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
										mem_vec_722 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
										mem_vec_723 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
										// y = ph_y, x = 1, h = 1, w = 3, c = 32, f = 32
										// T (c, 32) (32 / 1)
										for (c = c54, cp_2 = c54_p_1, cp_1 = c54_p_0, cp_0 = 0;
											c < c54 + 32;
											...
											vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_716);
											mem_vec_716 = vec_29;



											vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_717);
											mem_vec_717 = vec_31;



											vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_718);
											mem_vec_718 = vec_32;



											vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_719);
											mem_vec_719 = vec_33;
											scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h) + c];
											vec_35 = _mm256_set1_ps(scal_6);


											vec_34 = _mm256_fmadd_ps(vec_35, vec_2, mem_vec_720);
											mem_vec_720 = vec_34;



											vec_36 = _mm256_fmadd_ps(vec_35, vec_4, mem_vec_721);
											mem_vec_721 = vec_36;



											vec_37 = _mm256_fmadd_ps(vec_35, vec_6, mem_vec_722);
											mem_vec_722 = vec_37;



											vec_38 = _mm256_fmadd_ps(vec_35, vec_8, mem_vec_723);
											mem_vec_723 = vec_38;
											scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + h) + c];
											vec_40 = _mm256_set1_ps(scal_7);
											vec_41 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f]);

											vec_39 = _mm256_fmadd_ps(vec_40, vec_41, mem_vec_696);
											mem_vec_696 = vec_39;

											vec_43 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_42 = _mm256_fmadd_ps(vec_40, vec_43, mem_vec_697);
											mem_vec_697 = vec_42;

											vec_45 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_44 = _mm256_fmadd_ps(vec_40, vec_45, mem_vec_698);
											mem_vec_698 = vec_44;

											vec_47 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_46 = _mm256_fmadd_ps(vec_40, vec_47, mem_vec_699);
											mem_vec_699 = vec_46;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_41, mem_vec_700);
											mem_vec_700 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_43, mem_vec_701);
											mem_vec_701 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_45, mem_vec_702);
											mem_vec_702 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_47, mem_vec_703);
											mem_vec_703 = vec_52;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_41, mem_vec_704);
											mem_vec_704 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_43, mem_vec_705);
											mem_vec_705 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_45, mem_vec_706);
											mem_vec_706 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_47, mem_vec_707);
											mem_vec_707 = vec_57;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_59 = _mm256_set1_ps(scal_10);


											vec_58 = _mm256_fmadd_ps(vec_59, vec_41, mem_vec_708);
											mem_vec_708 = vec_58;



											vec_60 = _mm256_fmadd_ps(vec_59, vec_43, mem_vec_709);
											mem_vec_709 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_59, vec_45, mem_vec_710);
											mem_vec_710 = vec_61;



											vec_62 = _mm256_fmadd_ps(vec_59, vec_47, mem_vec_711);
											mem_vec_711 = vec_62;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_64 = _mm256_set1_ps(scal_11);


											vec_63 = _mm256_fmadd_ps(vec_64, vec_41, mem_vec_712);
											mem_vec_712 = vec_63;



											vec_65 = _mm256_fmadd_ps(vec_64, vec_43, mem_vec_713);
											mem_vec_713 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_64, vec_45, mem_vec_714);
											mem_vec_714 = vec_66;



											vec_67 = _mm256_fmadd_ps(vec_64, vec_47, mem_vec_715);
											mem_vec_715 = vec_67;
											scal_12 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_69 = _mm256_set1_ps(scal_12);


											vec_68 = _mm256_fmadd_ps(vec_69, vec_41, mem_vec_716);
											mem_vec_716 = vec_68;



											vec_70 = _mm256_fmadd_ps(vec_69, vec_43, mem_vec_717);
											mem_vec_717 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_69, vec_45, mem_vec_718);
											mem_vec_718 = vec_71;



											vec_72 = _mm256_fmadd_ps(vec_69, vec_47, mem_vec_719);
											mem_vec_719 = vec_72;
											scal_13 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 6 + h) + c];
											vec_74 = _mm256_set1_ps(scal_13);


											vec_73 = _mm256_fmadd_ps(vec_74, vec_41, mem_vec_720);
											mem_vec_720 = vec_73;



											vec_75 = _mm256_fmadd_ps(vec_74, vec_43, mem_vec_721);
											mem_vec_721 = vec_75;



											vec_76 = _mm256_fmadd_ps(vec_74, vec_45, mem_vec_722);
											mem_vec_722 = vec_76;



											vec_77 = _mm256_fmadd_ps(vec_74, vec_47, mem_vec_723);
											mem_vec_723 = vec_77;
											scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_79 = _mm256_set1_ps(scal_14);
											vec_80 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_78 = _mm256_fmadd_ps(vec_79, vec_80, mem_vec_696);
											mem_vec_696 = vec_78;

											vec_82 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_81 = _mm256_fmadd_ps(vec_79, vec_82, mem_vec_697);
											mem_vec_697 = vec_81;

											vec_84 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_83 = _mm256_fmadd_ps(vec_79, vec_84, mem_vec_698);
											mem_vec_698 = vec_83;

											vec_86 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_85 = _mm256_fmadd_ps(vec_79, vec_86, mem_vec_699);
											mem_vec_699 = vec_85;
											scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_88 = _mm256_set1_ps(scal_15);


											vec_87 = _mm256_fmadd_ps(vec_88, vec_80, mem_vec_700);
											mem_vec_700 = vec_87;



											vec_89 = _mm256_fmadd_ps(vec_88, vec_82, mem_vec_701);
											mem_vec_701 = vec_89;



											vec_90 = _mm256_fmadd_ps(vec_88, vec_84, mem_vec_702);
											mem_vec_702 = vec_90;



											vec_91 = _mm256_fmadd_ps(vec_88, vec_86, mem_vec_703);
											mem_vec_703 = vec_91;
											scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_93 = _mm256_set1_ps(scal_16);


											vec_92 = _mm256_fmadd_ps(vec_93, vec_80, mem_vec_704);
											mem_vec_704 = vec_92;



											vec_94 = _mm256_fmadd_ps(vec_93, vec_82, mem_vec_705);
											mem_vec_705 = vec_94;



											vec_95 = _mm256_fmadd_ps(vec_93, vec_84, mem_vec_706);
											mem_vec_706 = vec_95;



											vec_96 = _mm256_fmadd_ps(vec_93, vec_86, mem_vec_707);
											mem_vec_707 = vec_96;
											scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_98 = _mm256_set1_ps(scal_17);


											vec_97 = _mm256_fmadd_ps(vec_98, vec_80, mem_vec_708);
											mem_vec_708 = vec_97;



											vec_99 = _mm256_fmadd_ps(vec_98, vec_82, mem_vec_709);
											mem_vec_709 = vec_99;



											vec_100 = _mm256_fmadd_ps(vec_98, vec_84, mem_vec_710);
											mem_vec_710 = vec_100;



											vec_101 = _mm256_fmadd_ps(vec_98, vec_86, mem_vec_711);
											mem_vec_711 = vec_101;
											scal_18 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_103 = _mm256_set1_ps(scal_18);


											vec_102 = _mm256_fmadd_ps(vec_103, vec_80, mem_vec_712);
											mem_vec_712 = vec_102;



											vec_104 = _mm256_fmadd_ps(vec_103, vec_82, mem_vec_713);
											mem_vec_713 = vec_104;



											vec_105 = _mm256_fmadd_ps(vec_103, vec_84, mem_vec_714);
											mem_vec_714 = vec_105;



											vec_106 = _mm256_fmadd_ps(vec_103, vec_86, mem_vec_715);
											mem_vec_715 = vec_106;
											scal_19 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_108 = _mm256_set1_ps(scal_19);


											vec_107 = _mm256_fmadd_ps(vec_108, vec_80, mem_vec_716);
											mem_vec_716 = vec_107;



											vec_109 = _mm256_fmadd_ps(vec_108, vec_82, mem_vec_717);
											mem_vec_717 = vec_109;



											vec_110 = _mm256_fmadd_ps(vec_108, vec_84, mem_vec_718);
											mem_vec_718 = vec_110;



											vec_111 = _mm256_fmadd_ps(vec_108, vec_86, mem_vec_719);
											mem_vec_719 = vec_111;
											scal_20 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 6 + h) + c];
											vec_113 = _mm256_set1_ps(scal_20);


											vec_112 = _mm256_fmadd_ps(vec_113, vec_80, mem_vec_720);
											mem_vec_720 = vec_112;



											vec_114 = _mm256_fmadd_ps(vec_113, vec_82, mem_vec_721);
											mem_vec_721 = vec_114;



											vec_115 = _mm256_fmadd_ps(vec_113, vec_84, mem_vec_722);
											mem_vec_722 = vec_115;



											vec_116 = _mm256_fmadd_ps(vec_113, vec_86, mem_vec_723);
											mem_vec_723 = vec_116;
										}
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_716);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_717);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_718);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_719);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_720);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_721);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_722);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_723);
							}
						}
					}
				}
