...
[V f; U (4, f); ULambda y; U (3, w); T (64, c); Hoist_vars [c]; T (2, x);
  ...
  T (4, f); T (2, c); T (1, f)]
*/
IND_TYPE c, cp_0, c216_p_0, c217_p_0, cp_1, c216_p_1, cp_2, c216, c217, f, fp_0, f158_p_0, fp_1, f158, h, hp_0, x, xp_0, x162_p_0, xp_1, x162, y, yp_0;
				...
				x162 += 2, x162_p_0 += 2){
					for (y = y108, yp_0 = 0;
						...
						for (c216 = c217, c216_p_1 = c217_p_0, c216_p_0 = 0;
							c216 < c217 + 64;
							c216 += 64, c216_p_1 += 64, c216_p_0 += 64){
							// y = ph_y, x = 2, h = 3, w = 3, c = 64, f = 32
							// T (h, 3) (3 / 1)
							for (h = h72, hp_0 = 0;
								h < h72 + 3;
