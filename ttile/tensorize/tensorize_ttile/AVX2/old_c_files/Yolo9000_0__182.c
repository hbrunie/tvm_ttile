				...
				for (h = h60, hp_0 = 0;
					...
					for (c112 = c113, c112_p_0 = 0;
						...
						for (x = x128, xp_1 = x128_p_0, xp_0 = 0;
							x < x128 + 2;
							x += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_658 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_659 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
									mem_vec_660 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
									mem_vec_661 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
									mem_vec_662 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_663 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
									mem_vec_664 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_665 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
									mem_vec_666 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_667 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
									mem_vec_668 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
									mem_vec_669 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
									mem_vec_670 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_671 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
									mem_vec_672 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									mem_vec_673 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_658);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_659);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_660);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_661);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_662);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_663);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_664);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_665);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_666);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_667);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_668);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_669);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_670);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_671);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_672);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_673);
						}
					}
				}
			}
