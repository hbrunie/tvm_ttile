...
yp_2 = 0;
				for (h = h113, hp_0 = 0;h < h113 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c208 = c209, c208_p_0 = 0;c208 < c209 + 3;c208 += 3, c208_p_0 += 3){
						// y = 4, x = 136, h = 1, w = 3, c = 3, f = 32
						// T (x, 136) (136 / 1)
						for (x = x260, xp_1 = x260_p_0, xp_0 = 0;x < x260 + 136;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c208, cp_1 = c208_p_0, cp_0 = 0;c < c208 + 3;c += 1, cp_1 += 1, cp_0 += 1){
