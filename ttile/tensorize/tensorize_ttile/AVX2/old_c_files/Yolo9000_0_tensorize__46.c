...
yp_2 = 0;
				for (h = h196, hp_0 = 0;h < h196 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c361 = c362, c361_p_0 = 0;c361 < c362 + 3;c361 += 3, c361_p_0 += 3){
						// y = 4, x = 2, h = 1, w = 3, c = 3, f = 32
						// T (x, 2) (2 / 1)
						for (x = x425, xp_1 = x425_p_0, xp_0 = 0;x < x425 + 2;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c361, cp_1 = c361_p_0, cp_0 = 0;c < c361 + 3;c += 1, cp_1 += 1, cp_0 += 1){
