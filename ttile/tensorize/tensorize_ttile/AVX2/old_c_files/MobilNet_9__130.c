...
[V f; U (4, f); U (7, y); U (3, h); T (8, c); Hoist_vars [c]; T (3, w);
  T (7, x); T (1, y); T (2, f); T (64, c); T (16, f); T (2, c)]
*/
IND_TYPE c, cp_0, c344_p_0, c345_p_0, cp_1, c344_p_1, cp_2, c344, c345, f, fp_0, f258_p_0, fp_1, f258, w, wp_0, x, xp_0, y, yp_0;
