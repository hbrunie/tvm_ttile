...
/*
[V f; U (4, f); ULambda y; T (256, c); Hoist_vars [c]; T (17, x);
  Lambda_apply y [((Iter 3), (Arg 4)); ((Iter 1), (Arg 5))]; T (16, f);
  T (4, c); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c12_p_0, cp_1, c12, f, fp_0, x, xp_0, x12_p_0, xp_1, x12, y, yp_0, y12_p_0, yp_1, y12;
IND_TYPE y13 = 0;
IND_TYPE x13 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c12_p_0 = 0;
			for (f = f8, fp_0 = 0;f < f8 + 512;f += 32, fp_0 += 32){
					for (y = y12, yp_1 = y12_p_0, yp_0 = 0;y < y12 + 12;y += 4, yp_1 += 4, yp_0 += 4){
					...
					for (y = y12 + 12, yp_1 = y12_p_0, yp_0 = 0;y < y12 + 12 + 5;y += 5, yp_1 += 5, yp_0 += 5){
						// y = ph_y, x = 17, h = 1, w = 1, c = 256, f = 32
						// T (x, 17) (17 / 1)
						for (x = x12, xp_1 = x12_p_0, xp_0 = 0;x < x12 + 17;x += 1, xp_1 += 1, xp_0 += 1){
