			...
			for (x402 = x403, x402_p_0 = 0;
				...
				for (y = y268, yp_0 = 0;
					...
					for (c580 = c581, c580_p_1 = c581_p_0, c580_p_0 = 0;
						c580 < c581 + 64;
						c580 += 64, c580_p_1 += 64, c580_p_0 += 64){
						// y = 4, x = 17, h = 3, w = 3, c = 64, f = 32
						// T (w, 3) (3 / 1)
						for (w = w232, wp_0 = 0;
							w < w232 + 3;
							...
							for (x = x402, xp_1 = x402_p_0, xp_0 = 0;
								x < x402 + 17;
								x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_3628 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
										mem_vec_3629 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
										mem_vec_3630 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
										mem_vec_3631 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
										...
										mem_vec_3636 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_3637 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
										mem_vec_3638 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_3639 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_3628);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_3629);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_3630);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_3631);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_3636);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_3637);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_3638);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_3639);
