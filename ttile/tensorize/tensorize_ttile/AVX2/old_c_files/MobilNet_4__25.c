...
*/
IND_TYPE c, cp_0, c609_p_0, c610_p_0, cp_1, c609_p_1, cp_2, c609, c610, f, fp_0, f610_p_0, f611_p_0, fp_1, f610_p_1, fp_2, f610, f611, h, hp_0, x, xp_0, y, yp_0;
		...
		for (f610 = f611, f610_p_1 = f611_p_0, f610_p_0 = 0;
			...
			for (y = y315, yp_0 = 0;
				...
				for (f = f610, fp_2 = f610_p_1, fp_1 = f610_p_0, fp_0 = 0;
					...
					// T (c, 4) (64 / 16)
					for (c609 = c610, c609_p_1 = c610_p_0, c609_p_0 = 0;
						c609 < c610 + 64;
						c609 += 16, c609_p_1 += 16, c609_p_0 += 16){
						...
						for (x = x308, xp_0 = 0;
							...
							for (h = h233, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c609, cp_2 = c609_p_1, cp_1 = c609_p_0, cp_0 = 0;
											c < c609 + 16;
