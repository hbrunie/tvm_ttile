...
[V f; U (4, f); ULambda y; U (3, w); T (32, c); Hoist_vars [c]; T (2, x);
  ...
  T (1, f); T (2, c); T (4, f)]
*/
IND_TYPE c, cp_0, c516_p_0, c517_p_0, cp_1, c516_p_1, cp_2, c516, c517, f, fp_0, f383_p_0, fp_1, f383, h, hp_0, x, xp_0, x387_p_0, xp_1, x387, y, yp_0;
...
for (f383 = f384, f383_p_0 = 0;
	...
	for (c517 = c518, c517_p_0 = 0;
		...
		// T (f, 1) (32 / 32)
		for (f = f383, fp_1 = f383_p_0, fp_0 = 0;
			f < f383 + 32;
