...
[V f; U (4, f); U (4, y); U (3, w); T (16, c); Hoist_vars [c]; T (3, h);
  T (28, x); T (2, c); T (2, f); T (7, y); T (2, f); T (4, c); T (2, f)]
*/
IND_TYPE c, cp_0, c52_p_0, c53_p_0, cp_1, c52_p_1, cp_2, c52, c53, f, fp_0, f49_p_0, f50_p_0, fp_1, f49_p_1, fp_2, f49, f50, h, hp_0, x, xp_0, y, yp_0;
...
for (f50 = f51, f50_p_0 = 0;
	...
	for (c53 = c54, c53_p_0 = 0;
		...
		// T (f, 2) (128 / 64)
		for (f49 = f50, f49_p_1 = f50_p_0, f49_p_0 = 0;
			f49 < f50 + 128;
			f49 += 64, f49_p_1 += 64, f49_p_0 += 64){
			...
			for (y = y26, yp_0 = 0;
				...
				// T (f, 2) (64 / 32)
				for (f = f49, fp_2 = f49_p_1, fp_1 = f49_p_0, fp_0 = 0;
					f < f49 + 64;
							...
							for (h = h20, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										for (c = c52, cp_2 = c52_p_1, cp_1 = c52_p_0, cp_0 = 0;
											...
											vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_256);
											mem_vec_256 = vec_24;

											vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_257);
											mem_vec_257 = vec_27;

											vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_258);
											mem_vec_258 = vec_29;

											vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_259);
											mem_vec_259 = vec_31;
											scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_34 = _mm256_set1_ps(scal_5);


											vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_260);
											mem_vec_260 = vec_33;



											vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_261);
											mem_vec_261 = vec_35;



											vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_262);
											mem_vec_262 = vec_36;



											vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_263);
											mem_vec_263 = vec_37;
											scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_39 = _mm256_set1_ps(scal_6);


											vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_264);
											mem_vec_264 = vec_38;



											vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_265);
											mem_vec_265 = vec_40;



											vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_266);
											mem_vec_266 = vec_41;



											vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_267);
											mem_vec_267 = vec_42;
											scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_268);
											mem_vec_268 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_269);
											mem_vec_269 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_270);
											mem_vec_270 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_271);
											mem_vec_271 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);
											vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_256);
											mem_vec_256 = vec_48;

											vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_257);
											mem_vec_257 = vec_51;

											vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_258);
											mem_vec_258 = vec_53;

											vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_259);
											mem_vec_259 = vec_55;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_58 = _mm256_set1_ps(scal_9);


											vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_260);
											mem_vec_260 = vec_57;



											vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_261);
											mem_vec_261 = vec_59;



											vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_262);
											mem_vec_262 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_263);
											mem_vec_263 = vec_61;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_63 = _mm256_set1_ps(scal_10);


											vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_264);
											mem_vec_264 = vec_62;



											vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_265);
											mem_vec_265 = vec_64;



											vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_266);
											mem_vec_266 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_267);
											mem_vec_267 = vec_66;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_68 = _mm256_set1_ps(scal_11);


											vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_268);
											mem_vec_268 = vec_67;



											vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_269);
											mem_vec_269 = vec_69;



											vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_270);
											mem_vec_270 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_271);
											mem_vec_271 = vec_71;
										}
