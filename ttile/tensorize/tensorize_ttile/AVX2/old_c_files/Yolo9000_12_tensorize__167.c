...
[V f; U (4, f); ULambda y; T (16, c); Hoist_vars [c]; T (3, w); T (3, h);
  ...
  T (1, f); T (16, c); T (16, f); T (2, y); T (1, f)]
*/
...
c0 = 0;
c0_p_0 = 0;
				for (f = f0, fp_2 = f0_p_1, fp_1 = f0_p_0, fp_0 = 0;f < f0 + 32;f += 32, fp_2 += 32, fp_1 += 32, fp_0 += 32){
						for (y = y0, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 12;y += 4, yp_1 += 4, yp_0 += 4){
							// y = ph_y, x = 34, h = 3, w = 3, c = 16, f = 32
							// T (x, 34) (34 / 1)
							for (x = x0, xp_0 = 0;x < x0 + 34;x += 1, xp_0 += 1){
						...
						for (y = y0 + 12, yp_1 = y0_p_0, yp_0 = 0;y < y0 + 12 + 5;y += 5, yp_1 += 5, yp_0 += 5){
							// y = ph_y, x = 34, h = 3, w = 3, c = 16, f = 32
							// T (x, 34) (34 / 1)
							for (x = x0, xp_0 = 0;x < x0 + 34;x += 1, xp_0 += 1){
								// y = ph_y, x = 1, h = 3, w = 3, c = 16, f = 32
