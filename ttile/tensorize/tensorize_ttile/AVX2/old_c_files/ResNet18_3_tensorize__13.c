...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (1, x); T (2, f);
  T (14, x); T (14, y); T (4, x); T (1, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x60_p_0, x61_p_0, xp_1, x60_p_1, xp_2, x60, x61, y, yp_0, y45_p_0, yp_1, y45;
IND_TYPE y46 = 0;
IND_TYPE x62 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
fp_0 = 0;
					for (x = x60, xp_2 = x60_p_1, xp_1 = x60_p_0, xp_0 = 0;x < x60 + 1;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 64) (64 / 1)
								for (c = c30, cp_0 = 0;c < c30 + 64;c += 1, cp_0 += 1){
