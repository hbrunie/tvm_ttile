...
*/
IND_TYPE c, cp_0, c495_p_0, c496_p_0, cp_1, c495_p_1, cp_2, c495, c496, f, fp_0, f494_p_0, f495_p_0, fp_1, f494_p_1, fp_2, f494, f495, h, hp_0, x, xp_0, y, yp_0;
		...
		for (f494 = f495, f494_p_1 = f495_p_0, f494_p_0 = 0;
			...
			for (y = y255, yp_0 = 0;
				...
				for (f = f494, fp_2 = f494_p_1, fp_1 = f494_p_0, fp_0 = 0;
					...
					// y = 7, x = 28, h = 3, w = 3, c = 32, f = 32
					// T (c, 2) (32 / 16)
					for (c495 = c496, c495_p_1 = c496_p_0, c495_p_0 = 0;
						c495 < c496 + 32;
						c495 += 16, c495_p_1 += 16, c495_p_0 += 16){
						...
						for (x = x250, xp_0 = 0;
							...
							for (h = h182, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c495, cp_2 = c495_p_1, cp_1 = c495_p_0, cp_0 = 0;
											c < c495 + 16;
