...
for (y299 = y300, y299_p_0 = 0;
	y299 < y300 + 544;
	y299 += 544, y299_p_0 += 544){
	// y = 544, x = 544, h = 3, w = 3, c = 3, f = 32
	// T (y, 1) (544 / 544)
	for (y298 = y299, y298_p_1 = y299_p_0, y298_p_0 = 0;
		y298 < y299 + 544;
		y298 += 544, y298_p_1 += 544, y298_p_0 += 544){
		// y = 544, x = 544, h = 3, w = 3, c = 3, f = 32
		// T (x, 8) (544 / 68)
		for (x269 = x270, x269_p_0 = 0;
			...
			// T (y, 136) (544 / 4)
			for (y = y298, yp_2 = y298_p_1, yp_1 = y298_p_0, yp_0 = 0;
				y < y298 + 544;
						...
						for (c217 = c218, c217_p_0 = 0;
							...
							for (x = x269, xp_1 = x269_p_0, xp_0 = 0;
								...
								x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c217, cp_1 = c217_p_0, cp_0 = 0;
											c < c217 + 3;
											c += 1, cp_1 += 1, cp_0 += 1){
