...
for (f377 = f378, f377_p_0 = 0;
	...
	for (c509 = c510, c509_p_0 = 0;
		...
		// T (f, 2) (64 / 32)
		for (f = f377, fp_1 = f377_p_0, fp_0 = 0;
			f < f377 + 64;
						...
						for (c508 = c509, c508_p_1 = c509_p_0, c508_p_0 = 0;
							...
							for (h = h182, hp_0 = 0;
								...
								for (x = x381, xp_1 = x381_p_0, xp_0 = 0;
									x < x381 + 14;
									x += 1, xp_1 += 1, xp_0 += 1){
											mem_vec_5860 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
											mem_vec_5861 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
											mem_vec_5862 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
											mem_vec_5863 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
											mem_vec_5864 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
											mem_vec_5865 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
											mem_vec_5866 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
											mem_vec_5867 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
											mem_vec_5868 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
											mem_vec_5869 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
											mem_vec_5870 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
											mem_vec_5871 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_5860);
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_5861);
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_5862);
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_5863);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_5864);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_5865);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_5866);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_5867);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_5868);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_5869);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_5870);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_5871);
