...
*/
IND_TYPE c, cp_0, c573_p_0, c574_p_0, cp_1, c573_p_1, cp_2, c573, c574, f, fp_0, f574_p_0, f575_p_0, fp_1, f574_p_1, fp_2, f574, f575, h, hp_0, x, xp_0, y, yp_0;
...
for (f575 = f576, f575_p_0 = 0;
	...
	for (c574 = c575, c574_p_0 = 0;
		...
		for (f574 = f575, f574_p_1 = f575_p_0, f574_p_0 = 0;
			f574 < f575 + 128;
			f574 += 128, f574_p_1 += 128, f574_p_0 += 128){
			// y = 28, x = 28, h = 3, w = 3, c = 64, f = 128
			// T (y, 4) (28 / 7)
			for (y = y297, yp_0 = 0;
				y < y297 + 28;
				...
				for (f = f574, fp_2 = f574_p_1, fp_1 = f574_p_0, fp_0 = 0;
					...
					// T (c, 2) (64 / 32)
					for (c573 = c574, c573_p_1 = c574_p_0, c573_p_0 = 0;
						c573 < c574 + 64;
						c573 += 32, c573_p_1 += 32, c573_p_0 += 32){
						...
						for (x = x290, xp_0 = 0;
							...
							for (h = h215, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 32) (32 / 1)
										for (c = c573, cp_2 = c573_p_1, cp_1 = c573_p_0, cp_0 = 0;
											c < c573 + 32;
