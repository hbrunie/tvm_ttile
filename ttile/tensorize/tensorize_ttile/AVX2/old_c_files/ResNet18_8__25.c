...
*/
IND_TYPE c, cp_0, c763_p_0, c764_p_0, cp_1, c763_p_1, cp_2, c763, c764, f, fp_0, f764_p_0, f765_p_0, fp_1, f764_p_1, fp_2, f764, f765, h, hp_0, x, xp_0, y, yp_0;
		...
		for (f764 = f765, f764_p_1 = f765_p_0, f764_p_0 = 0;
			...
			for (y = y401, yp_0 = 0;
				...
				for (f = f764, fp_2 = f764_p_1, fp_1 = f764_p_0, fp_0 = 0;
					...
					// T (c, 4) (64 / 16)
					for (c763 = c764, c763_p_1 = c764_p_0, c763_p_0 = 0;
						c763 < c764 + 64;
						c763 += 16, c763_p_1 += 16, c763_p_0 += 16){
						...
						for (x = x388, xp_0 = 0;
							...
							for (h = h301, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c763, cp_2 = c763_p_1, cp_1 = c763_p_0, cp_0 = 0;
											c < c763 + 16;
