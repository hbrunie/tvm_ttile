...
/*
[V f; U (4, f); U (4, y); T (8, c); Hoist_vars [c]; T (34, x); T (32, c);
  T (4, f); T (2, x); T (17, y)]
*/
IND_TYPE c, cp_0, c63_p_0, cp_1, c63, f, fp_0, x, xp_0, x63_p_0, xp_1, x63, y, yp_0;
IND_TYPE y42 = 0;
IND_TYPE x64 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c63 = 0;
c63_p_0 = 0;
				for (x = x63, xp_1 = x63_p_0, xp_0 = 0;x < x63 + 34;x += 1, xp_1 += 1, xp_0 += 1){
							...
							// T (c, 8) (8 / 1)
							for (c = c63, cp_1 = c63_p_0, cp_0 = 0;c < c63 + 8;c += 1, cp_1 += 1, cp_0 += 1){
