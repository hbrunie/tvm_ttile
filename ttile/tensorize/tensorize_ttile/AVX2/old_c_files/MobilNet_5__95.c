...
*/
IND_TYPE c, cp_0, c774_p_0, c775_p_0, cp_1, c774_p_1, cp_2, c774, c775, f, fp_0, f765_p_0, f766_p_0, fp_1, f765_p_1, fp_2, f765, f766, w, wp_0, x, xp_0, y, yp_0;
...
for (f766 = f767, f766_p_0 = 0;
	...
	for (c775 = c776, c775_p_0 = 0;
		c775 < c776 + 256;
		c775 += 256, c775_p_0 += 256){
		// y = 28, x = 28, h = 3, w = 3, c = 256, f = 64
		// T (f, 2) (64 / 32)
		for (f765 = f766, f765_p_1 = f766_p_0, f765_p_0 = 0;
			f765 < f766 + 64;
			f765 += 32, f765_p_1 += 32, f765_p_0 += 32){
			...
			for (y = y402, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f765, fp_2 = f765_p_1, fp_1 = f765_p_0, fp_0 = 0;
					f < f765 + 32;
					...
					for (c774 = c775, c774_p_1 = c775_p_0, c774_p_0 = 0;
						c774 < c775 + 256;
						c774 += 32, c774_p_1 += 32, c774_p_0 += 32){
