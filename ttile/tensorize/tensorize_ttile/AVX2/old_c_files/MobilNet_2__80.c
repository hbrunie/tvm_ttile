...
for (f752 = f753, f752_p_0 = 0;
	...
	// T (f, 1) (32 / 32)
	for (f751 = f752, f751_p_1 = f752_p_0, f751_p_0 = 0;
		f751 < f752 + 32;
		f751 += 32, f751_p_1 += 32, f751_p_0 += 32){
		// y = 56, x = 56, h = 3, w = 3, c = 64, f = 32
		// T (x, 7) (56 / 8)
		for (x586 = x587, x586_p_0 = 0;
			...
			for (y = y407, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f751, fp_2 = f751_p_1, fp_1 = f751_p_0, fp_0 = 0;
					f < f751 + 32;
					...
					for (c588 = c589, c588_p_0 = 0;
						...
						for (w = w316, wp_0 = 0;
							...
							for (x = x586, xp_1 = x586_p_0, xp_0 = 0;
								x < x586 + 8;
								x += 1, xp_1 += 1, xp_0 += 1){
										mem_vec_7346 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
										mem_vec_7347 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
										mem_vec_7348 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
										mem_vec_7349 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
										mem_vec_7350 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_7351 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
										mem_vec_7352 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_7353 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
										mem_vec_7354 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_7355 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
										mem_vec_7356 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_7357 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
										mem_vec_7358 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
										mem_vec_7359 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
										mem_vec_7360 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
										mem_vec_7361 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_7346);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_7347);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_7348);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_7349);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_7350);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_7351);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_7352);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_7353);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_7354);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_7355);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_7356);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_7357);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_7358);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_7359);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_7360);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_7361);
							}
						}
					}
				}
