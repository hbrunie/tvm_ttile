...
[V f; U (4, f); U (4, y); U (3, h); T (3, c); Hoist_vars [c]; T (34, x);
  T (1, c); T (3, w); T (34, y); T (16, x); T (2, y); T (2, y)]
*/
IND_TYPE c, cp_0, c510_p_0, cp_1, c510, w, wp_0, x, xp_0, x654_p_0, xp_1, x654, y, yp_0, y704_p_0, y705_p_0, yp_1, y704_p_1, yp_2, y704, y705;
IND_TYPE y706 = 0;
IND_TYPE x655 = 0;
IND_TYPE h = 0;
IND_TYPE w352 = 0;
...
yp_2 = 0;
				for (w = w352, wp_0 = 0;w < w352 + 3;w += 1, wp_0 += 1){
					...
					for (c510 = c511, c510_p_0 = 0;c510 < c511 + 3;c510 += 3, c510_p_0 += 3){
						// y = 4, x = 34, h = 3, w = 1, c = 3, f = 32
						// T (x, 34) (34 / 1)
						for (x = x654, xp_1 = x654_p_0, xp_0 = 0;x < x654 + 34;x += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_4540 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f]);
									mem_vec_4541 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 8]);
									mem_vec_4542 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 16]);
									mem_vec_4543 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * y + f + 24]);
									mem_vec_4544 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f]);
									mem_vec_4545 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8]);
									mem_vec_4546 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16]);
									mem_vec_4547 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 24]);
									mem_vec_4548 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f]);
									mem_vec_4549 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 8]);
									mem_vec_4550 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16]);
									mem_vec_4551 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 24]);
								...
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f], mem_vec_4540);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 8], mem_vec_4541);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 16], mem_vec_4542);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * y + f + 24], mem_vec_4543);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f], mem_vec_4544);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 8], mem_vec_4545);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 16], mem_vec_4546);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 1) + f + 24], mem_vec_4547);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f], mem_vec_4548);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 8], mem_vec_4549);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 16], mem_vec_4550);
								_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 2) + f + 24], mem_vec_4551);
