...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, h); T (2, c); T (1, f); T (8, y); T (56, x); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c246_p_0, cp_1, c246, f, fp_0, f319_p_0, f320_p_0, fp_1, f319_p_1, fp_2, f319, f320, h, hp_0, x, xp_0, x247_p_0, xp_1, x247, y, yp_0;
...
for (f320 = f321, f320_p_0 = 0;
	...
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 2) (64 / 32)
	for (f319 = f320, f319_p_1 = f320_p_0, f319_p_0 = 0;
		f319 < f320 + 64;
		f319 += 32, f319_p_1 += 32, f319_p_0 += 32){
		...
		for (x247 = x248, x247_p_0 = 0;
			...
			for (y = y167, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f319, fp_2 = f319_p_1, fp_1 = f319_p_0, fp_0 = 0;
					f < f319 + 32;
