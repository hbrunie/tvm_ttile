...
yp_2 = 0;
				for (h = h104, hp_0 = 0;h < h104 + 3;h += 1, hp_0 += 1){
					...
					for (w = w130, wp_0 = 0;w < w130 + 3;w += 1, wp_0 += 1){
						...
						// T (c, 1) (3 / 3)
						for (c190 = c191, c190_p_0 = 0;c190 < c191 + 3;c190 += 3, c190_p_0 += 3){
							// y = 4, x = 136, h = 1, w = 1, c = 3, f = 32
							// T (x, 136) (136 / 1)
							for (x = x242, xp_1 = x242_p_0, xp_0 = 0;x < x242 + 136;x += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c190, cp_1 = c190_p_0, cp_0 = 0;c < c190 + 3;c += 1, cp_1 += 1, cp_0 += 1){
