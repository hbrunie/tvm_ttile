...
*/
IND_TYPE c, cp_0, c365_p_0, c366_p_0, cp_1, c365_p_1, cp_2, c365, c366, f, fp_0, f366_p_0, f367_p_0, fp_1, f366_p_1, fp_2, f366, f367, h, hp_0, x, xp_0, y, yp_0;
...
for (f367 = f368, f367_p_0 = 0;
	...
	for (c366 = c367, c366_p_0 = 0;
		...
		for (f366 = f367, f366_p_1 = f367_p_0, f366_p_0 = 0;
			f366 < f367 + 32;
			f366 += 32, f366_p_1 += 32, f366_p_0 += 32){
			// y = 28, x = 28, h = 3, w = 3, c = 32, f = 32
			// T (y, 4) (28 / 7)
			for (y = y193, yp_0 = 0;
				y < y193 + 28;
				...
				for (f = f366, fp_2 = f366_p_1, fp_1 = f366_p_0, fp_0 = 0;
					...
					// y = 7, x = 28, h = 3, w = 3, c = 32, f = 32
					// T (c, 2) (32 / 16)
					for (c365 = c366, c365_p_1 = c366_p_0, c365_p_0 = 0;
						c365 < c366 + 32;
						c365 += 16, c365_p_1 += 16, c365_p_0 += 16){
						...
						for (x = x186, xp_0 = 0;
							...
							for (h = h144, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c365, cp_2 = c365_p_1, cp_1 = c365_p_0, cp_0 = 0;
											c < c365 + 16;
