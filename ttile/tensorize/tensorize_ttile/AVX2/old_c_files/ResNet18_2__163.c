...
[V f; U (4, f); U (7, y); U (3, h); T (32, c); Hoist_vars [c]; T (1, x);
  T (3, w); T (2, c); T (1, f); T (8, y); T (56, x); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c210_p_0, cp_1, c210, f, fp_0, f271_p_0, f272_p_0, fp_1, f271_p_1, fp_2, f271, f272, w, wp_0, x, xp_0, x211_p_0, xp_1, x211, y, yp_0;
...
for (f272 = f273, f272_p_0 = 0;
	...
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 2) (64 / 32)
	for (f271 = f272, f271_p_1 = f272_p_0, f271_p_0 = 0;
		f271 < f272 + 64;
		f271 += 32, f271_p_1 += 32, f271_p_0 += 32){
		...
		for (x211 = x212, x211_p_0 = 0;
			...
			for (y = y143, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f271, fp_2 = f271_p_1, fp_1 = f271_p_0, fp_0 = 0;
					f < f271 + 32;
