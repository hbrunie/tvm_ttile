...
for (y577 = y578, y577_p_0 = 0;
	...
	for (x722 = x723, x722_p_0 = 0;
		x722 < x723 + 136;
		x722 += 136, x722_p_0 += 136){
		// y = 8, x = 136, h = 1, w = 1, c = 128, f = 64
		// T (y, 1) (8 / 8)
		for (y576 = y577, y576_p_1 = y577_p_0, y576_p_0 = 0;
			y576 < y577 + 8;
			y576 += 8, y576_p_1 += 8, y576_p_0 += 8){
			// y = 8, x = 136, h = 1, w = 1, c = 128, f = 64
			// T (x, 17) (136 / 8)
			for (x721 = x722, x721_p_1 = x722_p_0, x721_p_0 = 0;
				x721 < x722 + 136;
				x721 += 8, x721_p_1 += 8, x721_p_0 += 8){
				...
				for (f = f288, fp_0 = 0;
					...
					// T (y, 2) (8 / 4)
					for (y = y576, yp_2 = y576_p_1, yp_1 = y576_p_0, yp_0 = 0;
						y < y576 + 8;
						y += 4, yp_2 += 4, yp_1 += 4, yp_0 += 4){
						// y = 4, x = 8, h = 1, w = 1, c = 128, f = 32
						// T (x, 8) (8 / 1)
						for (x720 = x721, x720_p_2 = x721_p_1, x720_p_1 = x721_p_0, x720_p_0 = 0;
							x720 < x721 + 8;
							x720 += 1, x720_p_2 += 1, x720_p_1 += 1, x720_p_0 += 1){
							...
							for (c432 = c433, c432_p_0 = 0;
								...
								// y = 4, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (x, 1) (1 / 1)
								for (x = x720, xp_3 = x720_p_2, xp_2 = x720_p_1, xp_1 = x720_p_0, xp_0 = 0;
									x < x720 + 1;
