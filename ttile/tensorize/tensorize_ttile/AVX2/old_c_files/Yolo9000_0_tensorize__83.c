...
yp_2 = 0;
				for (h = h206, hp_0 = 0;h < h206 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c376 = c377, c376_p_0 = 0;c376 < c377 + 3;c376 += 3, c376_p_0 += 3){
						// y = 4, x = 1, h = 1, w = 3, c = 3, f = 32
						// T (x, 1) (1 / 1)
						for (x = x440, xp_1 = x440_p_0, xp_0 = 0;x < x440 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// y = 4, x = 1, h = 1, w = 3, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c376, cp_1 = c376_p_0, cp_0 = 0;c < c376 + 3;c += 1, cp_1 += 1, cp_0 += 1){
