...
xp_1 = 0;
								for (w = w60, wp_0 = 0;w < w60 + 3;w += 1, wp_0 += 1){
											...
											mem_vec_1442 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
											mem_vec_1443 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8]);
											// y = ph_y, x = 1, h = 3, w = 1, c = 8, f = 16
											// T (c, 8) (8 / 1)
											for (c = c168, cp_3 = c168_p_2, cp_2 = c168_p_1, cp_1 = c168_p_0, cp_0 = 0;c < c168 + 8;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
										...
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_1442);
										_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 8], mem_vec_1443);
								}
}
