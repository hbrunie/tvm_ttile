...
*/
IND_TYPE c, cp_0, c245_p_0, c246_p_0, cp_1, c245_p_1, cp_2, c245, c246, f, fp_0, f246_p_0, f247_p_0, fp_1, f246_p_1, fp_2, f246, f247, w, wp_0, x, xp_0, y, yp_0;
		...
		for (f246 = f247, f246_p_1 = f247_p_0, f246_p_0 = 0;
			...
			for (y = y133, yp_0 = 0;
				...
				for (f = f246, fp_2 = f246_p_1, fp_1 = f246_p_0, fp_0 = 0;
					...
					// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
					// T (c, 1) (32 / 32)
					for (c245 = c246, c245_p_1 = c246_p_0, c245_p_0 = 0;
						c245 < c246 + 32;
						c245 += 32, c245_p_1 += 32, c245_p_0 += 32){
						// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
						// T (x, 28) (28 / 1)
						for (x = x126, xp_0 = 0;
							x < x126 + 28;
							...
							for (w = w96, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										// T (c, 32) (32 / 1)
										for (c = c245, cp_2 = c245_p_1, cp_1 = c245_p_0, cp_0 = 0;
											c < c245 + 32;
