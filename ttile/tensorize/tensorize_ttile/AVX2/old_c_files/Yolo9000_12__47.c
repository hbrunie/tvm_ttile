...
[V f; U (4, f); ULambda y; U (3, w); T (16, c); Hoist_vars [c]; T (3, h);
  ...
  T (2, c); T (1, f)]
*/
IND_TYPE c, cp_0, c78_p_0, c79_p_0, cp_1, c78_p_1, cp_2, c78, c79, f, fp_0, f76_p_0, fp_1, f76, h, hp_0, x, xp_0, y, yp_0;
							...
							for (h = h37, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										for (c = c78, cp_2 = c78_p_1, cp_1 = c78_p_0, cp_0 = 0;
											...
											vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_936);
											mem_vec_936 = vec_24;

											vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_937);
											mem_vec_937 = vec_27;

											vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_938);
											mem_vec_938 = vec_29;

											vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_939);
											mem_vec_939 = vec_31;
											scal_5 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_34 = _mm256_set1_ps(scal_5);


											vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_940);
											mem_vec_940 = vec_33;



											vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_941);
											mem_vec_941 = vec_35;



											vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_942);
											mem_vec_942 = vec_36;



											vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_943);
											mem_vec_943 = vec_37;
											scal_6 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_39 = _mm256_set1_ps(scal_6);


											vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_944);
											mem_vec_944 = vec_38;



											vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_945);
											mem_vec_945 = vec_40;



											vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_946);
											mem_vec_946 = vec_41;



											vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_947);
											mem_vec_947 = vec_42;
											scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_948);
											mem_vec_948 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_949);
											mem_vec_949 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_950);
											mem_vec_950 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_951);
											mem_vec_951 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);
											vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_936);
											mem_vec_936 = vec_48;

											vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_937);
											mem_vec_937 = vec_51;

											vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_938);
											mem_vec_938 = vec_53;

											vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_939);
											mem_vec_939 = vec_55;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_58 = _mm256_set1_ps(scal_9);


											vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_940);
											mem_vec_940 = vec_57;



											vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_941);
											mem_vec_941 = vec_59;



											vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_942);
											mem_vec_942 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_943);
											mem_vec_943 = vec_61;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_63 = _mm256_set1_ps(scal_10);


											vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_944);
											mem_vec_944 = vec_62;



											vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_945);
											mem_vec_945 = vec_64;



											vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_946);
											mem_vec_946 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_947);
											mem_vec_947 = vec_66;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_68 = _mm256_set1_ps(scal_11);


											vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_948);
											mem_vec_948 = vec_67;



											vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_949);
											mem_vec_949 = vec_69;



											vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_950);
											mem_vec_950 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_951);
											mem_vec_951 = vec_71;
										}
							...
							for (h = h37, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										for (c = c78, cp_2 = c78_p_1, cp_1 = c78_p_0, cp_0 = 0;
											...
											vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_952);
											mem_vec_952 = vec_34;

											vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

											vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_953);
											mem_vec_953 = vec_37;

											vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

											vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_954);
											mem_vec_954 = vec_39;

											vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

											vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_955);
											mem_vec_955 = vec_41;
											scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_956);
											mem_vec_956 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_957);
											mem_vec_957 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_958);
											mem_vec_958 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_959);
											mem_vec_959 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_960);
											mem_vec_960 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_961);
											mem_vec_961 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_962);
											mem_vec_962 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_963);
											mem_vec_963 = vec_52;
											scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_964);
											mem_vec_964 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_965);
											mem_vec_965 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_966);
											mem_vec_966 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_967);
											mem_vec_967 = vec_57;
											scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
											vec_59 = _mm256_set1_ps(scal_10);


											vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_968);
											mem_vec_968 = vec_58;



											vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_969);
											mem_vec_969 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_970);
											mem_vec_970 = vec_61;



											vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_971);
											mem_vec_971 = vec_62;
											scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
											vec_64 = _mm256_set1_ps(scal_11);


											vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_972);
											mem_vec_972 = vec_63;



											vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_973);
											mem_vec_973 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_974);
											mem_vec_974 = vec_66;



											vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_975);
											mem_vec_975 = vec_67;
											scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
											vec_69 = _mm256_set1_ps(scal_12);
											vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

											vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_952);
											mem_vec_952 = vec_68;

											vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

											vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_953);
											mem_vec_953 = vec_71;

											vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

											vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_954);
											mem_vec_954 = vec_73;

											vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

											vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_955);
											mem_vec_955 = vec_75;
											scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_956);
											mem_vec_956 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_957);
											mem_vec_957 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_958);
											mem_vec_958 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_959);
											mem_vec_959 = vec_81;
											scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_960);
											mem_vec_960 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_961);
											mem_vec_961 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_962);
											mem_vec_962 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_963);
											mem_vec_963 = vec_86;
											scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
											vec_88 = _mm256_set1_ps(scal_15);


											vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_964);
											mem_vec_964 = vec_87;



											vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_965);
											mem_vec_965 = vec_89;



											vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_966);
											mem_vec_966 = vec_90;



											vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_967);
											mem_vec_967 = vec_91;
											scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
											vec_93 = _mm256_set1_ps(scal_16);


											vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_968);
											mem_vec_968 = vec_92;



											vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_969);
											mem_vec_969 = vec_94;



											vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_970);
											mem_vec_970 = vec_95;



											vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_971);
											mem_vec_971 = vec_96;
											scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
											vec_98 = _mm256_set1_ps(scal_17);


											vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_972);
											mem_vec_972 = vec_97;



											vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_973);
											mem_vec_973 = vec_99;



											vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_974);
											mem_vec_974 = vec_100;



											vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_975);
											mem_vec_975 = vec_101;
										}
