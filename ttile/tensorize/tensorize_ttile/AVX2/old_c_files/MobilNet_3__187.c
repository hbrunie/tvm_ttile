...
[V f; U (4, f); U (7, y); U (3, w); T (16, c); Hoist_vars [c]; T (56, x);
  T (3, h); T (8, c); T (8, y); T (1, x); T (2, f); T (1, c); T (2, f)]
*/
IND_TYPE c, cp_0, c564_p_0, c565_p_0, cp_1, c564_p_1, cp_2, c564, c565, f, fp_0, f419_p_0, fp_1, f419, h, hp_0, x, xp_0, x423_p_0, xp_1, x423, y, yp_0;
...
for (f419 = f420, f419_p_0 = 0;
	...
	for (c565 = c566, c565_p_0 = 0;
		...
		// y = 56, x = 56, h = 3, w = 3, c = 128, f = 64
		// T (f, 2) (64 / 32)
		for (f = f419, fp_1 = f419_p_0, fp_0 = 0;
			f < f419 + 64;
			...
			for (x423 = x424, x423_p_0 = 0;
				...
				for (y = y282, yp_0 = 0;
					...
					for (c564 = c565, c564_p_1 = c565_p_0, c564_p_0 = 0;
						c564 < c565 + 128;
						c564 += 16, c564_p_1 += 16, c564_p_0 += 16){
