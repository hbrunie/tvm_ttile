...
*/
IND_TYPE c, cp_0, c516_p_0, cp_1, c516, f, fp_0, x, xp_0, x860_p_0, x861_p_0, x862_p_0, xp_1, x860_p_1, x861_p_1, xp_2, x860_p_2, xp_3, x860, x861, x862, y, yp_0, y688_p_0, y689_p_0, yp_1, y688_p_1, yp_2, y688, y689;
...
// T (y, 1) (136 / 136)
for (y689 = y690, y689_p_0 = 0;
	y689 < y690 + 136;
	y689 += 136, y689_p_0 += 136){
	// y = 136, x = 136, h = 1, w = 1, c = 128, f = 64
	// T (x, 1) (136 / 136)
	for (x862 = x863, x862_p_0 = 0;
		x862 < x863 + 136;
		x862 += 136, x862_p_0 += 136){
		// y = 136, x = 136, h = 1, w = 1, c = 128, f = 64
		// T (y, 17) (136 / 8)
		for (y688 = y689, y688_p_1 = y689_p_0, y688_p_0 = 0;
			y688 < y689 + 136;
			y688 += 8, y688_p_1 += 8, y688_p_0 += 8){
			// y = 8, x = 136, h = 1, w = 1, c = 128, f = 64
			// T (x, 68) (136 / 2)
			for (x861 = x862, x861_p_1 = x862_p_0, x861_p_0 = 0;
				x861 < x862 + 136;
				x861 += 2, x861_p_1 += 2, x861_p_0 += 2){
				...
				for (f = f344, fp_0 = 0;
					...
					// T (y, 2) (8 / 4)
					for (y = y688, yp_2 = y688_p_1, yp_1 = y688_p_0, yp_0 = 0;
						y < y688 + 8;
						...
						for (x860 = x861, x860_p_2 = x861_p_1, x860_p_1 = x861_p_0, x860_p_0 = 0;
							x860 < x861 + 2;
							x860 += 2, x860_p_2 += 2, x860_p_1 += 2, x860_p_0 += 2){
							// y = 4, x = 2, h = 1, w = 1, c = 128, f = 32
							// T (c, 1) (128 / 128)
