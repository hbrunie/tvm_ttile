...
yp_2 = 0;
				for (w = w140, wp_0 = 0;w < w140 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c205 = c206, c205_p_0 = 0;c205 < c206 + 3;c205 += 3, c205_p_0 += 3){
						// y = 4, x = 136, h = 3, w = 1, c = 3, f = 32
						// T (x, 136) (136 / 1)
						for (x = x257, xp_1 = x257_p_0, xp_0 = 0;x < x257 + 136;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c205, cp_1 = c205_p_0, cp_0 = 0;c < c205 + 3;c += 1, cp_1 += 1, cp_0 += 1){
