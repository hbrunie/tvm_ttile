...
yp_2 = 0;
				for (h = h182, hp_0 = 0;h < h182 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c340 = c341, c340_p_0 = 0;c340 < c341 + 3;c340 += 3, c340_p_0 += 3){
						// y = 4, x = 8, h = 1, w = 3, c = 3, f = 32
						// T (x, 8) (8 / 1)
						for (x = x404, xp_1 = x404_p_0, xp_0 = 0;x < x404 + 8;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c340, cp_1 = c340_p_0, cp_0 = 0;c < c340 + 3;c += 1, cp_1 += 1, cp_0 += 1){
