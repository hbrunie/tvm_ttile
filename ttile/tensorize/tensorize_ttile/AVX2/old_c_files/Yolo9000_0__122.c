...
for (y89 = y90, y89_p_0 = 0;
	...
	for (y88 = y89, y88_p_1 = y89_p_0, y88_p_0 = 0;
		y88 < y89 + 544;
		y88 += 544, y88_p_1 += 544, y88_p_0 += 544){
		// y = 544, x = 544, h = 3, w = 3, c = 3, f = 32
		// T (x, 4) (544 / 136)
				...
				for (w = w46, wp_0 = 0;
					...
					for (c64 = c65, c64_p_0 = 0;
						...
						for (x = x80, xp_1 = x80_p_0, xp_0 = 0;
							x < x80 + 136;
							x += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_402 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_403 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
									mem_vec_404 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
									mem_vec_405 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
									mem_vec_406 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_407 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
									mem_vec_408 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_409 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
									mem_vec_410 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_411 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
									mem_vec_412 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
									mem_vec_413 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
									mem_vec_414 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_415 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
									mem_vec_416 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									mem_vec_417 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_402);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_403);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_404);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_405);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_406);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_407);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_408);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_409);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_410);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_411);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_412);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_413);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_414);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_415);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_416);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_417);
						}
					}
				}
			}
