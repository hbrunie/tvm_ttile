...
[V f; U (4, f); U (7, y); U (3, w); T (32, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (2, c); T (1, f); T (8, y); T (4, x); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c417_p_0, cp_1, c417, f, fp_0, f541_p_0, f542_p_0, fp_1, f541_p_1, fp_2, f541, f542, h, hp_0, x, xp_0, x418_p_0, xp_1, x418, y, yp_0;
...
for (f542 = f543, f542_p_0 = 0;
	...
	// y = 56, x = 56, h = 3, w = 3, c = 64, f = 64
	// T (f, 2) (64 / 32)
	for (f541 = f542, f541_p_1 = f542_p_0, f541_p_0 = 0;
		f541 < f542 + 64;
		f541 += 32, f541_p_1 += 32, f541_p_0 += 32){
		...
		for (x418 = x419, x418_p_0 = 0;
			...
			for (y = y284, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f541, fp_2 = f541_p_1, fp_1 = f541_p_0, fp_0 = 0;
					f < f541 + 32;
