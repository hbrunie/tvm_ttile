...
[V f; U (4, f); U (4, y); T (3, c); Hoist_vars [c]; T (2, x); T (1, c);
  T (7, w); T (7, h); T (7, y); T (56, x); T (4, y); T (1, f); T (2, f)]
*/
IND_TYPE c, cp_0, c75_p_0, cp_1, c75, f, fp_0, f75_p_0, fp_1, f75, h, hp_0, w, wp_0, x, xp_0, x75_p_0, xp_1, x75, y, yp_0, y75_p_0, yp_1, y75;
IND_TYPE y76 = 0;
IND_TYPE x76 = 0;
IND_TYPE h50 = 0;
IND_TYPE w50 = 0;
					...
					for (h = h50, hp_0 = 0;h < h50 + 7;h += 1, hp_0 += 1){
						...
						for (w = w50, wp_0 = 0;w < w50 + 7;w += 1, wp_0 += 1){
							...
							for (c75 = c76, c75_p_0 = 0;c75 < c76 + 3;c75 += 3, c75_p_0 += 3){
								// y = 4, x = 2, h = 1, w = 1, c = 3, f = 32
								// T (x, 2) (2 / 1)
								for (x = x75, xp_1 = x75_p_0, xp_0 = 0;x < x75 + 2;x += 1, xp_1 += 1, xp_0 += 1){
