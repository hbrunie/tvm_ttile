...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (2, x); T (2, f);
  T (7, x); T (7, y); T (4, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x88_p_0, x89_p_0, xp_1, x88_p_1, xp_2, x88, x89, y, yp_0, y66_p_0, yp_1, y66;
IND_TYPE y67 = 0;
IND_TYPE x90 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
fp_0 = 0;
					for (x = x88, xp_2 = x88_p_1, xp_1 = x88_p_0, xp_0 = 0;x < x88 + 2;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 64) (64 / 1)
								for (c = c44, cp_0 = 0;c < c44 + 64;c += 1, cp_0 += 1){
