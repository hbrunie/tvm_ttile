...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (17, x);
  T (3, h); T (2, c); T (1, f); T (34, y); T (1, x); T (4, f); T (8, x)]
*/
IND_TYPE c, cp_0, c21_p_0, cp_1, c21, f, fp_0, f21_p_0, fp_1, f21, h, hp_0, x, xp_0, x28_p_0, x29_p_0, xp_1, x28_p_1, xp_2, x28, x29, y, yp_0;
IND_TYPE y14 = 0;
IND_TYPE x30 = 0;
IND_TYPE h11 = 0;
IND_TYPE w = 0;
