...
[V f; U (4, f); ULambda y; U (3, w); T (32, c); Hoist_vars [c]; T (14, x);
  ...
  T (1, f); T (2, f)]
*/
IND_TYPE c, cp_0, c354_p_0, cp_1, c354, f, fp_0, f457_p_0, f458_p_0, fp_1, f457_p_1, fp_2, f457, f458, h, hp_0, x, xp_0, x355_p_0, xp_1, x355, y, yp_0;
...
for (f458 = f459, f458_p_0 = 0;
	...
	// T (f, 1) (32 / 32)
	for (f457 = f458, f457_p_1 = f458_p_0, f457_p_0 = 0;
		f457 < f458 + 32;
		f457 += 32, f457_p_1 += 32, f457_p_0 += 32){
		// y = 56, x = 56, h = 3, w = 3, c = 64, f = 32
		// T (x, 4) (56 / 14)
		for (x355 = x356, x355_p_0 = 0;
			...
			x355 += 14, x355_p_0 += 14){
				for (y = y242, yp_0 = 0;
					...
					// T (f, 1) (32 / 32)
					for (f = f457, fp_2 = f457_p_1, fp_1 = f457_p_0, fp_0 = 0;
						f < f457 + 32;
								...
								for (x = x355, xp_1 = x355_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											for (c = c354, cp_1 = c354_p_0, cp_0 = 0;
												...
												vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_4772);
												mem_vec_4772 = vec_34;

												vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 8]);

												vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_4773);
												mem_vec_4773 = vec_37;

												vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 16]);

												vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_4774);
												mem_vec_4774 = vec_39;

												vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 1) + (F * C) * h + F * c + f + 24]);

												vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_4775);
												mem_vec_4775 = vec_41;
												scal_7 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 1 + h) + c];
												vec_44 = _mm256_set1_ps(scal_7);


												vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_4776);
												mem_vec_4776 = vec_43;



												vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_4777);
												mem_vec_4777 = vec_45;



												vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_4778);
												mem_vec_4778 = vec_46;



												vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_4779);
												mem_vec_4779 = vec_47;
												scal_8 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 2 + h) + c];
												vec_49 = _mm256_set1_ps(scal_8);


												vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_4780);
												mem_vec_4780 = vec_48;



												vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_4781);
												mem_vec_4781 = vec_50;



												vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_4782);
												mem_vec_4782 = vec_51;



												vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_4783);
												mem_vec_4783 = vec_52;
												scal_9 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 3 + h) + c];
												vec_54 = _mm256_set1_ps(scal_9);


												vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_4784);
												mem_vec_4784 = vec_53;



												vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_4785);
												mem_vec_4785 = vec_55;



												vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_4786);
												mem_vec_4786 = vec_56;



												vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_4787);
												mem_vec_4787 = vec_57;
												scal_10 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 4 + h) + c];
												vec_59 = _mm256_set1_ps(scal_10);


												vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_4788);
												mem_vec_4788 = vec_58;



												vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_4789);
												mem_vec_4789 = vec_60;



												vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_4790);
												mem_vec_4790 = vec_61;



												vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_4791);
												mem_vec_4791 = vec_62;
												scal_11 = input[(C * (Y + H - 1)) * (x + w + 1) + C * (y + 5 + h) + c];
												vec_64 = _mm256_set1_ps(scal_11);


												vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_4792);
												mem_vec_4792 = vec_63;



												vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_4793);
												mem_vec_4793 = vec_65;



												vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_4794);
												mem_vec_4794 = vec_66;



												vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_4795);
												mem_vec_4795 = vec_67;
												scal_12 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + h) + c];
												vec_69 = _mm256_set1_ps(scal_12);
												vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f]);

												vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_4772);
												mem_vec_4772 = vec_68;

												vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 8]);

												vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_4773);
												mem_vec_4773 = vec_71;

												vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 16]);

												vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_4774);
												mem_vec_4774 = vec_73;

												vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * (w + 2) + (F * C) * h + F * c + f + 24]);

												vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_4775);
												mem_vec_4775 = vec_75;
												scal_13 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 1 + h) + c];
												vec_78 = _mm256_set1_ps(scal_13);


												vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_4776);
												mem_vec_4776 = vec_77;



												vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_4777);
												mem_vec_4777 = vec_79;



												vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_4778);
												mem_vec_4778 = vec_80;



												vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_4779);
												mem_vec_4779 = vec_81;
												scal_14 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 2 + h) + c];
												vec_83 = _mm256_set1_ps(scal_14);


												vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_4780);
												mem_vec_4780 = vec_82;



												vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_4781);
												mem_vec_4781 = vec_84;



												vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_4782);
												mem_vec_4782 = vec_85;



												vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_4783);
												mem_vec_4783 = vec_86;
												scal_15 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 3 + h) + c];
												vec_88 = _mm256_set1_ps(scal_15);


												vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_4784);
												mem_vec_4784 = vec_87;



												vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_4785);
												mem_vec_4785 = vec_89;



												vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_4786);
												mem_vec_4786 = vec_90;



												vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_4787);
												mem_vec_4787 = vec_91;
												scal_16 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 4 + h) + c];
												vec_93 = _mm256_set1_ps(scal_16);


												vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_4788);
												mem_vec_4788 = vec_92;



												vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_4789);
												mem_vec_4789 = vec_94;



												vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_4790);
												mem_vec_4790 = vec_95;



												vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_4791);
												mem_vec_4791 = vec_96;
												scal_17 = input[(C * (Y + H - 1)) * (x + w + 2) + C * (y + 5 + h) + c];
												vec_98 = _mm256_set1_ps(scal_17);


												vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_4792);
												mem_vec_4792 = vec_97;



												vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_4793);
												mem_vec_4793 = vec_99;



												vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_4794);
												mem_vec_4794 = vec_100;



												vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_4795);
							...
							for (h = h167, hp_0 = 0;
								...
								for (x = x355, xp_1 = x355_p_0, xp_0 = 0;
									...
									x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4798 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
											mem_vec_4799 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
											...
											mem_vec_4806 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
											mem_vec_4807 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
											...
											mem_vec_4814 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
											mem_vec_4815 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24]);
											mem_vec_4816 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_4817 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
											mem_vec_4818 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_4819 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
											mem_vec_4820 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_4821 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
											mem_vec_4822 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_4823 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
											// y = ph_y, x = 1, h = 1, w = 3, c = 32, f = 32
											// T (c, 32) (32 / 1)
											for (c = c354, cp_1 = c354_p_0, cp_0 = 0;
												c < c354 + 32;
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_4798);
										_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_4799);
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_4806);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_4807);
										...
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_4814);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24], mem_vec_4815);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_4816);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_4817);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_4818);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_4819);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_4820);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_4821);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_4822);
										_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_4823);
								}
							}
						}
					}
