...
/*
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (4, x); T (4, c);
  T (4, f); T (17, x); T (17, y)]
*/
IND_TYPE c, cp_0, c84_p_0, cp_1, c84, f, fp_0, x, xp_0, x84_p_0, xp_1, x84, y, yp_0;
IND_TYPE y56 = 0;
IND_TYPE x85 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c84 = 0;
c84_p_0 = 0;
				for (x = x84, xp_1 = x84_p_0, xp_0 = 0;x < x84 + 4;x += 1, xp_1 += 1, xp_0 += 1){
