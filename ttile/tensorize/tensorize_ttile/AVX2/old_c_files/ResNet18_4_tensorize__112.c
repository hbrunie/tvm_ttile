...
*/
IND_TYPE c, cp_0, c225_p_0, cp_1, c225, f, fp_0, f300_p_0, f301_p_0, fp_1, f300_p_1, fp_2, f300, f301, h, hp_0, w, wp_0, x, xp_0, y, yp_0, y183_p_0, yp_1, y183;
IND_TYPE y184 = 0;
IND_TYPE x150 = 0;
IND_TYPE h132 = 0;
IND_TYPE w126 = 0;
...
xp_0 = 0;
							for (h = h132, hp_0 = 0;h < h132 + 3;h += 1, hp_0 += 1){
								...
								for (w = w126, wp_0 = 0;w < w126 + 3;w += 1, wp_0 += 1){
											...
											// T (c, 8) (8 / 1)
											for (c = c225, cp_1 = c225_p_0, cp_0 = 0;c < c225 + 8;c += 1, cp_1 += 1, cp_0 += 1){
