...
[V f; U (4, f); U (4, y); T (3, c); Hoist_vars [c]; T (56, x); T (1, c);
  T (7, w); T (7, h); T (28, y); T (2, x); T (1, y); T (1, f); T (2, f)]
*/
IND_TYPE c, cp_0, c15_p_0, cp_1, c15, f, fp_0, f15_p_0, fp_1, f15, h, hp_0, w, wp_0, x, xp_0, x15_p_0, xp_1, x15, y, yp_0, y15_p_0, yp_1, y15;
IND_TYPE y16 = 0;
IND_TYPE x16 = 0;
IND_TYPE h10 = 0;
IND_TYPE w10 = 0;
...
y = 0;
yp_1 = 0;
					for (h = h10, hp_0 = 0;h < h10 + 7;h += 1, hp_0 += 1){
						// y = 4, x = 56, h = 1, w = 7, c = 3, f = 32
						// T (w, 7) (7 / 1)
						for (w = w10, wp_0 = 0;w < w10 + 7;w += 1, wp_0 += 1){
							// y = 4, x = 56, h = 1, w = 1, c = 3, f = 32
							// T (c, 1) (3 / 3)
							for (c15 = c16, c15_p_0 = 0;c15 < c16 + 3;c15 += 3, c15_p_0 += 3){
								// y = 4, x = 56, h = 1, w = 1, c = 3, f = 32
								// T (x, 56) (56 / 1)
								for (x = x15, xp_1 = x15_p_0, xp_0 = 0;x < x15 + 56;x += 1, xp_1 += 1, xp_0 += 1){
											...
											// T (c, 3) (3 / 1)
											for (c = c15, cp_1 = c15_p_0, cp_0 = 0;c < c15 + 3;c += 1, cp_1 += 1, cp_0 += 1){
