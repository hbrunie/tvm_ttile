...
for (f69 = f70, f69_p_0 = 0;
	...
	for (f68 = f69, f68_p_1 = f69_p_0, f68_p_0 = 0;
		f68 < f69 + 512;
		f68 += 256, f68_p_1 += 256, f68_p_0 += 256){
							...
							for (w = w32, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c51, cp_1 = c51_p_0, cp_0 = 0;
											...
											vec_29 = _mm256_fmadd_ps(vec_30, vec_31, mem_vec_660);
											mem_vec_660 = vec_29;

											vec_33 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

											vec_32 = _mm256_fmadd_ps(vec_30, vec_33, mem_vec_661);
											mem_vec_661 = vec_32;

											vec_35 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_34 = _mm256_fmadd_ps(vec_30, vec_35, mem_vec_662);
											mem_vec_662 = vec_34;

											vec_37 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

											vec_36 = _mm256_fmadd_ps(vec_30, vec_37, mem_vec_663);
											mem_vec_663 = vec_36;
											scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_39 = _mm256_set1_ps(scal_6);


											vec_38 = _mm256_fmadd_ps(vec_39, vec_31, mem_vec_664);
											mem_vec_664 = vec_38;



											vec_40 = _mm256_fmadd_ps(vec_39, vec_33, mem_vec_665);
											mem_vec_665 = vec_40;



											vec_41 = _mm256_fmadd_ps(vec_39, vec_35, mem_vec_666);
											mem_vec_666 = vec_41;



											vec_42 = _mm256_fmadd_ps(vec_39, vec_37, mem_vec_667);
											mem_vec_667 = vec_42;
											scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_31, mem_vec_668);
											mem_vec_668 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_33, mem_vec_669);
											mem_vec_669 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_35, mem_vec_670);
											mem_vec_670 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_37, mem_vec_671);
											mem_vec_671 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_31, mem_vec_672);
											mem_vec_672 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_33, mem_vec_673);
											mem_vec_673 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_35, mem_vec_674);
											mem_vec_674 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_37, mem_vec_675);
											mem_vec_675 = vec_52;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_31, mem_vec_676);
											mem_vec_676 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_33, mem_vec_677);
											mem_vec_677 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_35, mem_vec_678);
											mem_vec_678 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_37, mem_vec_679);
											mem_vec_679 = vec_57;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_59 = _mm256_set1_ps(scal_10);
											vec_60 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_58 = _mm256_fmadd_ps(vec_59, vec_60, mem_vec_660);
											mem_vec_660 = vec_58;

											vec_62 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

											vec_61 = _mm256_fmadd_ps(vec_59, vec_62, mem_vec_661);
											mem_vec_661 = vec_61;

											vec_64 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_63 = _mm256_fmadd_ps(vec_59, vec_64, mem_vec_662);
											mem_vec_662 = vec_63;

											vec_66 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

											vec_65 = _mm256_fmadd_ps(vec_59, vec_66, mem_vec_663);
											mem_vec_663 = vec_65;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_68 = _mm256_set1_ps(scal_11);


											vec_67 = _mm256_fmadd_ps(vec_68, vec_60, mem_vec_664);
											mem_vec_664 = vec_67;



											vec_69 = _mm256_fmadd_ps(vec_68, vec_62, mem_vec_665);
											mem_vec_665 = vec_69;



											vec_70 = _mm256_fmadd_ps(vec_68, vec_64, mem_vec_666);
											mem_vec_666 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_68, vec_66, mem_vec_667);
											mem_vec_667 = vec_71;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_73 = _mm256_set1_ps(scal_12);


											vec_72 = _mm256_fmadd_ps(vec_73, vec_60, mem_vec_668);
											mem_vec_668 = vec_72;



											vec_74 = _mm256_fmadd_ps(vec_73, vec_62, mem_vec_669);
											mem_vec_669 = vec_74;



											vec_75 = _mm256_fmadd_ps(vec_73, vec_64, mem_vec_670);
											mem_vec_670 = vec_75;



											vec_76 = _mm256_fmadd_ps(vec_73, vec_66, mem_vec_671);
											mem_vec_671 = vec_76;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_60, mem_vec_672);
											mem_vec_672 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_62, mem_vec_673);
											mem_vec_673 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_64, mem_vec_674);
											mem_vec_674 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_66, mem_vec_675);
											mem_vec_675 = vec_81;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_60, mem_vec_676);
											mem_vec_676 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_62, mem_vec_677);
											mem_vec_677 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_64, mem_vec_678);
											mem_vec_678 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_66, mem_vec_679);
											mem_vec_679 = vec_86;
										}
						...
						for (x = x34, xp_0 = 0;
							...
							for (w = w32, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										mem_vec_696 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
										mem_vec_697 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8]);
										mem_vec_698 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
										mem_vec_699 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24]);
										mem_vec_700 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
										mem_vec_701 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
										mem_vec_702 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
										mem_vec_703 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
										// y = ph_y, x = 1, h = 3, w = 1, c = 64, f = 32
										// T (c, 64) (64 / 1)
										for (c = c51, cp_1 = c51_p_0, cp_0 = 0;
											c < c51 + 64;
											...
											vec_24 = _mm256_fmadd_ps(vec_25, vec_2, mem_vec_696);
											mem_vec_696 = vec_24;



											vec_26 = _mm256_fmadd_ps(vec_25, vec_4, mem_vec_697);
											mem_vec_697 = vec_26;



											vec_27 = _mm256_fmadd_ps(vec_25, vec_6, mem_vec_698);
											mem_vec_698 = vec_27;



											vec_28 = _mm256_fmadd_ps(vec_25, vec_8, mem_vec_699);
											mem_vec_699 = vec_28;
											scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h) + c];
											vec_30 = _mm256_set1_ps(scal_5);


											vec_29 = _mm256_fmadd_ps(vec_30, vec_2, mem_vec_700);
											mem_vec_700 = vec_29;



											vec_31 = _mm256_fmadd_ps(vec_30, vec_4, mem_vec_701);
											mem_vec_701 = vec_31;



											vec_32 = _mm256_fmadd_ps(vec_30, vec_6, mem_vec_702);
											mem_vec_702 = vec_32;



											vec_33 = _mm256_fmadd_ps(vec_30, vec_8, mem_vec_703);
											mem_vec_703 = vec_33;
											scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 1) + c];
											vec_35 = _mm256_set1_ps(scal_6);
											vec_36 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f]);

											vec_34 = _mm256_fmadd_ps(vec_35, vec_36, mem_vec_680);
											mem_vec_680 = vec_34;

											vec_38 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

											vec_37 = _mm256_fmadd_ps(vec_35, vec_38, mem_vec_681);
											mem_vec_681 = vec_37;

											vec_40 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_39 = _mm256_fmadd_ps(vec_35, vec_40, mem_vec_682);
											mem_vec_682 = vec_39;

											vec_42 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

											vec_41 = _mm256_fmadd_ps(vec_35, vec_42, mem_vec_683);
											mem_vec_683 = vec_41;
											scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_36, mem_vec_684);
											mem_vec_684 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_38, mem_vec_685);
											mem_vec_685 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_40, mem_vec_686);
											mem_vec_686 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_42, mem_vec_687);
											mem_vec_687 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_36, mem_vec_688);
											mem_vec_688 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_38, mem_vec_689);
											mem_vec_689 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_40, mem_vec_690);
											mem_vec_690 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_42, mem_vec_691);
											mem_vec_691 = vec_52;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_36, mem_vec_692);
											mem_vec_692 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_38, mem_vec_693);
											mem_vec_693 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_40, mem_vec_694);
											mem_vec_694 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_42, mem_vec_695);
											mem_vec_695 = vec_57;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_59 = _mm256_set1_ps(scal_10);


											vec_58 = _mm256_fmadd_ps(vec_59, vec_36, mem_vec_696);
											mem_vec_696 = vec_58;



											vec_60 = _mm256_fmadd_ps(vec_59, vec_38, mem_vec_697);
											mem_vec_697 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_59, vec_40, mem_vec_698);
											mem_vec_698 = vec_61;



											vec_62 = _mm256_fmadd_ps(vec_59, vec_42, mem_vec_699);
											mem_vec_699 = vec_62;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
											vec_64 = _mm256_set1_ps(scal_11);


											vec_63 = _mm256_fmadd_ps(vec_64, vec_36, mem_vec_700);
											mem_vec_700 = vec_63;



											vec_65 = _mm256_fmadd_ps(vec_64, vec_38, mem_vec_701);
											mem_vec_701 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_64, vec_40, mem_vec_702);
											mem_vec_702 = vec_66;



											vec_67 = _mm256_fmadd_ps(vec_64, vec_42, mem_vec_703);
											mem_vec_703 = vec_67;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_69 = _mm256_set1_ps(scal_12);
											vec_70 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_68 = _mm256_fmadd_ps(vec_69, vec_70, mem_vec_680);
											mem_vec_680 = vec_68;

											vec_72 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

											vec_71 = _mm256_fmadd_ps(vec_69, vec_72, mem_vec_681);
											mem_vec_681 = vec_71;

											vec_74 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_73 = _mm256_fmadd_ps(vec_69, vec_74, mem_vec_682);
											mem_vec_682 = vec_73;

											vec_76 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

											vec_75 = _mm256_fmadd_ps(vec_69, vec_76, mem_vec_683);
											mem_vec_683 = vec_75;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_70, mem_vec_684);
											mem_vec_684 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_72, mem_vec_685);
											mem_vec_685 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_74, mem_vec_686);
											mem_vec_686 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_76, mem_vec_687);
											mem_vec_687 = vec_81;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_70, mem_vec_688);
											mem_vec_688 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_72, mem_vec_689);
											mem_vec_689 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_74, mem_vec_690);
											mem_vec_690 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_76, mem_vec_691);
											mem_vec_691 = vec_86;
											scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_88 = _mm256_set1_ps(scal_15);


											vec_87 = _mm256_fmadd_ps(vec_88, vec_70, mem_vec_692);
											mem_vec_692 = vec_87;



											vec_89 = _mm256_fmadd_ps(vec_88, vec_72, mem_vec_693);
											mem_vec_693 = vec_89;



											vec_90 = _mm256_fmadd_ps(vec_88, vec_74, mem_vec_694);
											mem_vec_694 = vec_90;



											vec_91 = _mm256_fmadd_ps(vec_88, vec_76, mem_vec_695);
											mem_vec_695 = vec_91;
											scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_93 = _mm256_set1_ps(scal_16);


											vec_92 = _mm256_fmadd_ps(vec_93, vec_70, mem_vec_696);
											mem_vec_696 = vec_92;



											vec_94 = _mm256_fmadd_ps(vec_93, vec_72, mem_vec_697);
											mem_vec_697 = vec_94;



											vec_95 = _mm256_fmadd_ps(vec_93, vec_74, mem_vec_698);
											mem_vec_698 = vec_95;



											vec_96 = _mm256_fmadd_ps(vec_93, vec_76, mem_vec_699);
											mem_vec_699 = vec_96;
											scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
											vec_98 = _mm256_set1_ps(scal_17);


											vec_97 = _mm256_fmadd_ps(vec_98, vec_70, mem_vec_700);
											mem_vec_700 = vec_97;



											vec_99 = _mm256_fmadd_ps(vec_98, vec_72, mem_vec_701);
											mem_vec_701 = vec_99;



											vec_100 = _mm256_fmadd_ps(vec_98, vec_74, mem_vec_702);
											mem_vec_702 = vec_100;



											vec_101 = _mm256_fmadd_ps(vec_98, vec_76, mem_vec_703);
											mem_vec_703 = vec_101;
										}
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_696);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 8], mem_vec_697);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_698);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24], mem_vec_699);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_700);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_701);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_702);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_703);
							}
						}
					}
			}
