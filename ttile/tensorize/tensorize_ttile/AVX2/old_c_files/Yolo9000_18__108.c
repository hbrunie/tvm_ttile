							...
							for (w = w4, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c6, cp_1 = c6_p_0, cp_0 = 0;
											...
											vec_24 = _mm256_fmadd_ps(vec_25, vec_26, mem_vec_72);
											mem_vec_72 = vec_24;

											vec_28 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

											vec_27 = _mm256_fmadd_ps(vec_25, vec_28, mem_vec_73);
											mem_vec_73 = vec_27;

											vec_30 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_29 = _mm256_fmadd_ps(vec_25, vec_30, mem_vec_74);
											mem_vec_74 = vec_29;

											vec_32 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

											vec_31 = _mm256_fmadd_ps(vec_25, vec_32, mem_vec_75);
											mem_vec_75 = vec_31;
											scal_5 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_34 = _mm256_set1_ps(scal_5);


											vec_33 = _mm256_fmadd_ps(vec_34, vec_26, mem_vec_76);
											mem_vec_76 = vec_33;



											vec_35 = _mm256_fmadd_ps(vec_34, vec_28, mem_vec_77);
											mem_vec_77 = vec_35;



											vec_36 = _mm256_fmadd_ps(vec_34, vec_30, mem_vec_78);
											mem_vec_78 = vec_36;



											vec_37 = _mm256_fmadd_ps(vec_34, vec_32, mem_vec_79);
											mem_vec_79 = vec_37;
											scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_39 = _mm256_set1_ps(scal_6);


											vec_38 = _mm256_fmadd_ps(vec_39, vec_26, mem_vec_80);
											mem_vec_80 = vec_38;



											vec_40 = _mm256_fmadd_ps(vec_39, vec_28, mem_vec_81);
											mem_vec_81 = vec_40;



											vec_41 = _mm256_fmadd_ps(vec_39, vec_30, mem_vec_82);
											mem_vec_82 = vec_41;



											vec_42 = _mm256_fmadd_ps(vec_39, vec_32, mem_vec_83);
											mem_vec_83 = vec_42;
											scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_26, mem_vec_84);
											mem_vec_84 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_28, mem_vec_85);
											mem_vec_85 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_30, mem_vec_86);
											mem_vec_86 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_32, mem_vec_87);
											mem_vec_87 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_49 = _mm256_set1_ps(scal_8);
											vec_50 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_48 = _mm256_fmadd_ps(vec_49, vec_50, mem_vec_72);
											mem_vec_72 = vec_48;

											vec_52 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

											vec_51 = _mm256_fmadd_ps(vec_49, vec_52, mem_vec_73);
											mem_vec_73 = vec_51;

											vec_54 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_53 = _mm256_fmadd_ps(vec_49, vec_54, mem_vec_74);
											mem_vec_74 = vec_53;

											vec_56 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

											vec_55 = _mm256_fmadd_ps(vec_49, vec_56, mem_vec_75);
											mem_vec_75 = vec_55;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_58 = _mm256_set1_ps(scal_9);


											vec_57 = _mm256_fmadd_ps(vec_58, vec_50, mem_vec_76);
											mem_vec_76 = vec_57;



											vec_59 = _mm256_fmadd_ps(vec_58, vec_52, mem_vec_77);
											mem_vec_77 = vec_59;



											vec_60 = _mm256_fmadd_ps(vec_58, vec_54, mem_vec_78);
											mem_vec_78 = vec_60;



											vec_61 = _mm256_fmadd_ps(vec_58, vec_56, mem_vec_79);
											mem_vec_79 = vec_61;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_63 = _mm256_set1_ps(scal_10);


											vec_62 = _mm256_fmadd_ps(vec_63, vec_50, mem_vec_80);
											mem_vec_80 = vec_62;



											vec_64 = _mm256_fmadd_ps(vec_63, vec_52, mem_vec_81);
											mem_vec_81 = vec_64;



											vec_65 = _mm256_fmadd_ps(vec_63, vec_54, mem_vec_82);
											mem_vec_82 = vec_65;



											vec_66 = _mm256_fmadd_ps(vec_63, vec_56, mem_vec_83);
											mem_vec_83 = vec_66;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_68 = _mm256_set1_ps(scal_11);


											vec_67 = _mm256_fmadd_ps(vec_68, vec_50, mem_vec_84);
											mem_vec_84 = vec_67;



											vec_69 = _mm256_fmadd_ps(vec_68, vec_52, mem_vec_85);
											mem_vec_85 = vec_69;



											vec_70 = _mm256_fmadd_ps(vec_68, vec_54, mem_vec_86);
											mem_vec_86 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_68, vec_56, mem_vec_87);
											mem_vec_87 = vec_71;
										}
							...
							for (w = w4, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										for (c = c6, cp_1 = c6_p_0, cp_0 = 0;
											...
											vec_29 = _mm256_fmadd_ps(vec_30, vec_31, mem_vec_88);
											mem_vec_88 = vec_29;

											vec_33 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 8]);

											vec_32 = _mm256_fmadd_ps(vec_30, vec_33, mem_vec_89);
											mem_vec_89 = vec_32;

											vec_35 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

											vec_34 = _mm256_fmadd_ps(vec_30, vec_35, mem_vec_90);
											mem_vec_90 = vec_34;

											vec_37 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 24]);

											vec_36 = _mm256_fmadd_ps(vec_30, vec_37, mem_vec_91);
											mem_vec_91 = vec_36;
											scal_6 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
											vec_39 = _mm256_set1_ps(scal_6);


											vec_38 = _mm256_fmadd_ps(vec_39, vec_31, mem_vec_92);
											mem_vec_92 = vec_38;



											vec_40 = _mm256_fmadd_ps(vec_39, vec_33, mem_vec_93);
											mem_vec_93 = vec_40;



											vec_41 = _mm256_fmadd_ps(vec_39, vec_35, mem_vec_94);
											mem_vec_94 = vec_41;



											vec_42 = _mm256_fmadd_ps(vec_39, vec_37, mem_vec_95);
											mem_vec_95 = vec_42;
											scal_7 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
											vec_44 = _mm256_set1_ps(scal_7);


											vec_43 = _mm256_fmadd_ps(vec_44, vec_31, mem_vec_96);
											mem_vec_96 = vec_43;



											vec_45 = _mm256_fmadd_ps(vec_44, vec_33, mem_vec_97);
											mem_vec_97 = vec_45;



											vec_46 = _mm256_fmadd_ps(vec_44, vec_35, mem_vec_98);
											mem_vec_98 = vec_46;



											vec_47 = _mm256_fmadd_ps(vec_44, vec_37, mem_vec_99);
											mem_vec_99 = vec_47;
											scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
											vec_49 = _mm256_set1_ps(scal_8);


											vec_48 = _mm256_fmadd_ps(vec_49, vec_31, mem_vec_100);
											mem_vec_100 = vec_48;



											vec_50 = _mm256_fmadd_ps(vec_49, vec_33, mem_vec_101);
											mem_vec_101 = vec_50;



											vec_51 = _mm256_fmadd_ps(vec_49, vec_35, mem_vec_102);
											mem_vec_102 = vec_51;



											vec_52 = _mm256_fmadd_ps(vec_49, vec_37, mem_vec_103);
											mem_vec_103 = vec_52;
											scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
											vec_54 = _mm256_set1_ps(scal_9);


											vec_53 = _mm256_fmadd_ps(vec_54, vec_31, mem_vec_104);
											mem_vec_104 = vec_53;



											vec_55 = _mm256_fmadd_ps(vec_54, vec_33, mem_vec_105);
											mem_vec_105 = vec_55;



											vec_56 = _mm256_fmadd_ps(vec_54, vec_35, mem_vec_106);
											mem_vec_106 = vec_56;



											vec_57 = _mm256_fmadd_ps(vec_54, vec_37, mem_vec_107);
											mem_vec_107 = vec_57;
											scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
											vec_59 = _mm256_set1_ps(scal_10);
											vec_60 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

											vec_58 = _mm256_fmadd_ps(vec_59, vec_60, mem_vec_88);
											mem_vec_88 = vec_58;

											vec_62 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 8]);

											vec_61 = _mm256_fmadd_ps(vec_59, vec_62, mem_vec_89);
											mem_vec_89 = vec_61;

											vec_64 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

											vec_63 = _mm256_fmadd_ps(vec_59, vec_64, mem_vec_90);
											mem_vec_90 = vec_63;

											vec_66 = _mm256_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 24]);

											vec_65 = _mm256_fmadd_ps(vec_59, vec_66, mem_vec_91);
											mem_vec_91 = vec_65;
											scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
											vec_68 = _mm256_set1_ps(scal_11);


											vec_67 = _mm256_fmadd_ps(vec_68, vec_60, mem_vec_92);
											mem_vec_92 = vec_67;



											vec_69 = _mm256_fmadd_ps(vec_68, vec_62, mem_vec_93);
											mem_vec_93 = vec_69;



											vec_70 = _mm256_fmadd_ps(vec_68, vec_64, mem_vec_94);
											mem_vec_94 = vec_70;



											vec_71 = _mm256_fmadd_ps(vec_68, vec_66, mem_vec_95);
											mem_vec_95 = vec_71;
											scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
											vec_73 = _mm256_set1_ps(scal_12);


											vec_72 = _mm256_fmadd_ps(vec_73, vec_60, mem_vec_96);
											mem_vec_96 = vec_72;



											vec_74 = _mm256_fmadd_ps(vec_73, vec_62, mem_vec_97);
											mem_vec_97 = vec_74;



											vec_75 = _mm256_fmadd_ps(vec_73, vec_64, mem_vec_98);
											mem_vec_98 = vec_75;



											vec_76 = _mm256_fmadd_ps(vec_73, vec_66, mem_vec_99);
											mem_vec_99 = vec_76;
											scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
											vec_78 = _mm256_set1_ps(scal_13);


											vec_77 = _mm256_fmadd_ps(vec_78, vec_60, mem_vec_100);
											mem_vec_100 = vec_77;



											vec_79 = _mm256_fmadd_ps(vec_78, vec_62, mem_vec_101);
											mem_vec_101 = vec_79;



											vec_80 = _mm256_fmadd_ps(vec_78, vec_64, mem_vec_102);
											mem_vec_102 = vec_80;



											vec_81 = _mm256_fmadd_ps(vec_78, vec_66, mem_vec_103);
											mem_vec_103 = vec_81;
											scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
											vec_83 = _mm256_set1_ps(scal_14);


											vec_82 = _mm256_fmadd_ps(vec_83, vec_60, mem_vec_104);
											mem_vec_104 = vec_82;



											vec_84 = _mm256_fmadd_ps(vec_83, vec_62, mem_vec_105);
											mem_vec_105 = vec_84;



											vec_85 = _mm256_fmadd_ps(vec_83, vec_64, mem_vec_106);
											mem_vec_106 = vec_85;



											vec_86 = _mm256_fmadd_ps(vec_83, vec_66, mem_vec_107);
											mem_vec_107 = vec_86;
										}
