...
yp_2 = 0;
				for (w = w8, wp_0 = 0;w < w8 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c11 = c12, c11_p_0 = 0;c11 < c12 + 3;c11 += 3, c11_p_0 += 3){
						// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
						// T (x, 1) (1 / 1)
						for (x = x13, xp_1 = x13_p_0, xp_0 = 0;x < x13 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c11, cp_1 = c11_p_0, cp_0 = 0;c < c11 + 3;c += 1, cp_1 += 1, cp_0 += 1){
