...
for (c137 = c138, c137_p_0 = 0;
	...
	for (f = f68, fp_0 = 0;
		...
		for (c136 = c137, c136_p_1 = c137_p_0, c136_p_0 = 0;
			c136 < c137 + 64;
			c136 += 16, c136_p_1 += 16, c136_p_0 += 16){
				for (y = y68, yp_0 = 0;
					y < y68 + 8;
					y += 4, yp_0 += 4){
