...
[V f; U (4, f); U (4, y); T (3, c); Hoist_vars [c]; T (1, x); T (1, c);
  T (7, w); T (7, h); T (28, y); T (112, x); T (1, y); T (1, f); T (2, f)]
*/
IND_TYPE c, cp_0, c9_p_0, cp_1, c9, f, fp_0, f9_p_0, fp_1, f9, h, hp_0, w, wp_0, x, xp_0, x9_p_0, xp_1, x9, y, yp_0, y9_p_0, yp_1, y9;
IND_TYPE y10 = 0;
IND_TYPE x10 = 0;
IND_TYPE h6 = 0;
IND_TYPE w6 = 0;
...
yp_1 = 0;
					for (h = h6, hp_0 = 0;h < h6 + 7;h += 1, hp_0 += 1){
						...
						for (w = w6, wp_0 = 0;w < w6 + 7;w += 1, wp_0 += 1){
							...
							// T (c, 1) (3 / 3)
							for (c9 = c10, c9_p_0 = 0;c9 < c10 + 3;c9 += 3, c9_p_0 += 3){
								// y = 4, x = 1, h = 1, w = 1, c = 3, f = 32
								// T (x, 1) (1 / 1)
