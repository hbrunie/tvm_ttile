...
*/
IND_TYPE c, cp_0, c770_p_0, c771_p_0, cp_1, c770_p_1, cp_2, c770, c771, f, fp_0, f761_p_0, f762_p_0, fp_1, f761_p_1, fp_2, f761, f762, w, wp_0, x, xp_0, y, yp_0;
...
for (f762 = f763, f762_p_0 = 0;
	...
	for (c771 = c772, c771_p_0 = 0;
		c771 < c772 + 256;
		c771 += 256, c771_p_0 += 256){
		// y = 28, x = 28, h = 3, w = 3, c = 256, f = 128
		// T (f, 4) (128 / 32)
		for (f761 = f762, f761_p_1 = f762_p_0, f761_p_0 = 0;
			f761 < f762 + 128;
			f761 += 32, f761_p_1 += 32, f761_p_0 += 32){
			...
			for (y = y400, yp_0 = 0;
				...
				// T (f, 1) (32 / 32)
				for (f = f761, fp_2 = f761_p_1, fp_1 = f761_p_0, fp_0 = 0;
					f < f761 + 32;
					...
					for (c770 = c771, c770_p_1 = c771_p_0, c770_p_0 = 0;
						c770 < c771 + 256;
						c770 += 32, c770_p_1 += 32, c770_p_0 += 32){
						...
						for (x = x390, xp_0 = 0;
							...
							for (w = w302, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										mem_vec_5214 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
										mem_vec_5215 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
										mem_vec_5216 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
										mem_vec_5217 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
										mem_vec_5218 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
										mem_vec_5219 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
										mem_vec_5220 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
										mem_vec_5221 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
										mem_vec_5222 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
										mem_vec_5223 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
										...
										mem_vec_5230 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
										mem_vec_5231 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24]);
										mem_vec_5232 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
										mem_vec_5233 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8]);
										mem_vec_5234 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
										mem_vec_5235 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24]);
										mem_vec_5236 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
										mem_vec_5237 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
										mem_vec_5238 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
										mem_vec_5239 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_5214);
									_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_5215);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_5216);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_5217);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_5218);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_5219);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_5220);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_5221);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_5222);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_5223);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_5230);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 24], mem_vec_5231);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_5232);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 8], mem_vec_5233);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_5234);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 24], mem_vec_5235);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_5236);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_5237);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_5238);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_5239);
							}
						}
					}
				}
