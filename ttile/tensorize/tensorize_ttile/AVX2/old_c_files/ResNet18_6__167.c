...
*/
IND_TYPE c, cp_0, c349_p_0, c350_p_0, cp_1, c349_p_1, cp_2, c349, c350, f, fp_0, f350_p_0, f351_p_0, fp_1, f350_p_1, fp_2, f350, f351, h, hp_0, x, xp_0, y, yp_0;
...
for (f351 = f352, f351_p_0 = 0;
	...
	for (c350 = c351, c350_p_0 = 0;
		...
		for (f350 = f351, f350_p_1 = f351_p_0, f350_p_0 = 0;
			f350 < f351 + 64;
			f350 += 32, f350_p_1 += 32, f350_p_0 += 32){
						...
						for (x = x178, xp_0 = 0;
							...
							for (h = h136, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 32) (32 / 1)
										for (c = c349, cp_2 = c349_p_1, cp_1 = c349_p_0, cp_0 = 0;
											c < c349 + 32;
