...
*/
IND_TYPE c, cp_0, c557_p_0, c558_p_0, cp_1, c557_p_1, cp_2, c557, c558, f, fp_0, f558_p_0, f559_p_0, fp_1, f558_p_1, fp_2, f558, f559, h, hp_0, x, xp_0, y, yp_0;
			...
			for (y = y289, yp_0 = 0;
				...
				for (f = f558, fp_2 = f558_p_1, fp_1 = f558_p_0, fp_0 = 0;
					...
					for (c557 = c558, c557_p_1 = c558_p_0, c557_p_0 = 0;
						c557 < c558 + 64;
						c557 += 64, c557_p_1 += 64, c557_p_0 += 64){
						// y = 7, x = 28, h = 3, w = 3, c = 64, f = 32
						// T (x, 28) (28 / 1)
						for (x = x282, xp_0 = 0;
							x < x282 + 28;
							...
							for (h = h207, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										mem_vec_3552 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
										mem_vec_3553 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8]);
										mem_vec_3554 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
										mem_vec_3555 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24]);
									...
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_3552);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 8], mem_vec_3553);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_3554);
									_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 24], mem_vec_3555);
							}
						}
					}
				}
