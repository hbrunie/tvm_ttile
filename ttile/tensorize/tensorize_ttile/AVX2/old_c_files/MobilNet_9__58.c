...
[V f; U (4, f); U (7, y); U (3, h); T (64, c); Hoist_vars [c]; T (3, w);
  T (7, x); T (1, y); T (16, f); T (16, c); T (2, f); T (1, c)]
*/
IND_TYPE c, cp_0, c488_p_0, c489_p_0, cp_1, c488_p_1, cp_2, c488, c489, f, fp_0, f366_p_0, fp_1, f366, w, wp_0, x, xp_0, y, yp_0;
