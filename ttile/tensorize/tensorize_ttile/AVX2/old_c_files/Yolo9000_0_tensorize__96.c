...
yp_2 = 0;
				for (h = h115, hp_0 = 0;h < h115 + 3;h += 1, hp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c211 = c212, c211_p_0 = 0;c211 < c212 + 3;c211 += 3, c211_p_0 += 3){
						// y = 4, x = 136, h = 1, w = 3, c = 3, f = 32
						// T (x, 136) (136 / 1)
						for (x = x263, xp_1 = x263_p_0, xp_0 = 0;x < x263 + 136;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// T (c, 3) (3 / 1)
									for (c = c211, cp_1 = c211_p_0, cp_0 = 0;c < c211 + 3;c += 1, cp_1 += 1, cp_0 += 1){
