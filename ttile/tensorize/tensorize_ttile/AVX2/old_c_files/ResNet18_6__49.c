...
*/
IND_TYPE c, cp_0, c265_p_0, c266_p_0, cp_1, c265_p_1, cp_2, c265, c266, f, fp_0, f266_p_0, f267_p_0, fp_1, f266_p_1, fp_2, f266, f267, w, wp_0, x, xp_0, y, yp_0;
		...
		for (f266 = f267, f266_p_1 = f267_p_0, f266_p_0 = 0;
			...
			for (y = y143, yp_0 = 0;
				...
				for (f = f266, fp_2 = f266_p_1, fp_1 = f266_p_0, fp_0 = 0;
					...
					// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
					// T (c, 4) (32 / 8)
					for (c265 = c266, c265_p_1 = c266_p_0, c265_p_0 = 0;
						c265 < c266 + 32;
						c265 += 8, c265_p_1 += 8, c265_p_0 += 8){
						...
						for (x = x136, xp_0 = 0;
							...
							for (w = w106, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										// T (c, 8) (8 / 1)
										for (c = c265, cp_2 = c265_p_1, cp_1 = c265_p_0, cp_0 = 0;
											c < c265 + 8;
