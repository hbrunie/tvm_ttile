...
[V f; U (4, f); U (4, y); T (32, c); Hoist_vars [c]; T (3, w); T (3, h);
  T (28, x); T (7, y); T (4, f); T (8, c); T (1, f); T (1, y); T (2, f)]
*/
IND_TYPE c, cp_0, c31_p_0, cp_1, c31, f, fp_0, f30_p_0, f31_p_0, fp_1, f30_p_1, fp_2, f30, f31, h, hp_0, w, wp_0, x, xp_0, y, yp_0, y17_p_0, yp_1, y17;
