...
for (y641 = y642, y641_p_0 = 0;
	...
	for (x802 = x803, x802_p_0 = 0;
		x802 < x803 + 136;
		x802 += 136, x802_p_0 += 136){
		// y = 8, x = 136, h = 1, w = 1, c = 128, f = 64
		// T (y, 1) (8 / 8)
		for (y640 = y641, y640_p_1 = y641_p_0, y640_p_0 = 0;
			y640 < y641 + 8;
			y640 += 8, y640_p_1 += 8, y640_p_0 += 8){
			// y = 8, x = 136, h = 1, w = 1, c = 128, f = 64
			// T (x, 34) (136 / 4)
			for (x801 = x802, x801_p_1 = x802_p_0, x801_p_0 = 0;
				x801 < x802 + 136;
				x801 += 4, x801_p_1 += 4, x801_p_0 += 4){
				...
				for (f = f320, fp_0 = 0;
					...
					// T (y, 2) (8 / 4)
					for (y = y640, yp_2 = y640_p_1, yp_1 = y640_p_0, yp_0 = 0;
						y < y640 + 8;
						...
						for (x800 = x801, x800_p_2 = x801_p_1, x800_p_1 = x801_p_0, x800_p_0 = 0;
							x800 < x801 + 4;
							x800 += 2, x800_p_2 += 2, x800_p_1 += 2, x800_p_0 += 2){
