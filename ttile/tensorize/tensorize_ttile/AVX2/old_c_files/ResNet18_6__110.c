...
*/
IND_TYPE c, cp_0, c373_p_0, c374_p_0, cp_1, c373_p_1, cp_2, c373, c374, f, fp_0, f374_p_0, f375_p_0, fp_1, f374_p_1, fp_2, f374, f375, h, hp_0, x, xp_0, y, yp_0;
...
for (f375 = f376, f375_p_0 = 0;
	...
	for (c374 = c375, c374_p_0 = 0;
		...
		for (f374 = f375, f374_p_1 = f375_p_0, f374_p_0 = 0;
			f374 < f375 + 64;
			f374 += 32, f374_p_1 += 32, f374_p_0 += 32){
			...
			for (y = y197, yp_0 = 0;
				...
				for (f = f374, fp_2 = f374_p_1, fp_1 = f374_p_0, fp_0 = 0;
					...
					// y = 7, x = 28, h = 3, w = 3, c = 32, f = 32
					// T (c, 4) (32 / 8)
					for (c373 = c374, c373_p_1 = c374_p_0, c373_p_0 = 0;
						c373 < c374 + 32;
						c373 += 8, c373_p_1 += 8, c373_p_0 += 8){
						...
						for (x = x190, xp_0 = 0;
							...
							for (h = h148, hp_0 = 0;
								...
								h += 1, hp_0 += 1){
										...
										// T (c, 8) (8 / 1)
										for (c = c373, cp_2 = c373_p_1, cp_1 = c373_p_0, cp_0 = 0;
											c < c373 + 8;
