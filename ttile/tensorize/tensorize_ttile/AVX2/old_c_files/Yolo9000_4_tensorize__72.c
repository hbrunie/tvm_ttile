...
[V f; U (2, f); U (8, y); U (3, h); T (64, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (1, c); T (17, y); T (8, f); T (2, x); T (1, y); T (4, x)]
*/
IND_TYPE c, cp_0, c534_p_0, cp_1, c534, f, fp_0, w, wp_0, x, xp_0, x712_p_0, x713_p_0, xp_1, x712_p_1, xp_2, x712, x713, y, yp_0, y491_p_0, yp_1, y491;
IND_TYPE y492 = 0;
IND_TYPE x714 = 0;
IND_TYPE h = 0;
IND_TYPE w341 = 0;
...
c534_p_0 = 0;
						for (w = w341, wp_0 = 0;w < w341 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 17) (17 / 1)
							for (x = x712, xp_2 = x712_p_1, xp_1 = x712_p_0, xp_0 = 0;x < x712 + 17;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
