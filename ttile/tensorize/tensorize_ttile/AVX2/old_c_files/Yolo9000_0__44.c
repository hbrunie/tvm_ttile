				...
				for (h = h64, hp_0 = 0;
					...
					for (c118 = c119, c118_p_0 = 0;
						...
						for (x = x134, xp_1 = x134_p_0, xp_0 = 0;
							x < x134 + 1;
							x += 1, xp_1 += 1, xp_0 += 1){
									mem_vec_690 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f]);
									mem_vec_691 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 8]);
									mem_vec_692 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
									mem_vec_693 = _mm256_loadu_ps(&output[(F * Y) * x + F * y + f + 24]);
									mem_vec_694 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
									mem_vec_695 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8]);
									mem_vec_696 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
									mem_vec_697 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24]);
									mem_vec_698 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
									mem_vec_699 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8]);
									mem_vec_700 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
									mem_vec_701 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24]);
									mem_vec_702 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f]);
									mem_vec_703 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8]);
									mem_vec_704 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16]);
									mem_vec_705 = _mm256_loadu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24]);
									// y = 4, x = 1, h = 1, w = 3, c = 3, f = 32
									// T (c, 3) (3 / 1)
								...
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_690);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 8], mem_vec_691);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_692);
								_mm256_storeu_ps(&output[(F * Y) * x + F * y + f + 24], mem_vec_693);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_694);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 8], mem_vec_695);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_696);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 24], mem_vec_697);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_698);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 8], mem_vec_699);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_700);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 24], mem_vec_701);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f], mem_vec_702);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 8], mem_vec_703);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 16], mem_vec_704);
								_mm256_storeu_ps(&output[(F * Y) * x + F * (y + 3) + f + 24], mem_vec_705);
						}
					}
				}
			}
