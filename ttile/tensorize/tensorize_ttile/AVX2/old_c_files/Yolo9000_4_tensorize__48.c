...
[V f; U (4, f); U (4, y); U (3, h); T (64, c); Hoist_vars [c]; T (17, x);
  T (3, w); T (1, c); T (1, f); T (34, y); T (1, x); T (4, f); T (8, x)]
*/
IND_TYPE c, cp_0, c9_p_0, cp_1, c9, f, fp_0, f9_p_0, fp_1, f9, w, wp_0, x, xp_0, x12_p_0, x13_p_0, xp_1, x12_p_1, xp_2, x12, x13, y, yp_0;
IND_TYPE y6 = 0;
IND_TYPE x14 = 0;
IND_TYPE h = 0;
IND_TYPE w6 = 0;
