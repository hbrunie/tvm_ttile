...
*/
IND_TYPE c, cp_0, c477_p_0, c478_p_0, cp_1, c477_p_1, cp_2, c477, c478, f, fp_0, f478_p_0, f479_p_0, fp_1, f478_p_1, fp_2, f478, f479, w, wp_0, x, xp_0, y, yp_0;
...
for (f479 = f480, f479_p_0 = 0;
	...
	for (c478 = c479, c478_p_0 = 0;
		...
		for (f478 = f479, f478_p_1 = f479_p_0, f478_p_0 = 0;
			f478 < f479 + 128;
			f478 += 128, f478_p_1 += 128, f478_p_0 += 128){
			// y = 28, x = 28, h = 3, w = 3, c = 64, f = 128
			// T (y, 4) (28 / 7)
			for (y = y249, yp_0 = 0;
				y < y249 + 28;
				...
				for (f = f478, fp_2 = f478_p_1, fp_1 = f478_p_0, fp_0 = 0;
					...
					// T (c, 4) (64 / 16)
					for (c477 = c478, c477_p_1 = c478_p_0, c477_p_0 = 0;
						c477 < c478 + 64;
						c477 += 16, c477_p_1 += 16, c477_p_0 += 16){
						...
						for (x = x242, xp_0 = 0;
							...
							for (w = w191, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c477, cp_2 = c477_p_1, cp_1 = c477_p_0, cp_0 = 0;
											c < c477 + 16;
