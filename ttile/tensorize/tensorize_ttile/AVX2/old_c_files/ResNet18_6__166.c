...
*/
IND_TYPE c, cp_0, c445_p_0, c446_p_0, cp_1, c445_p_1, cp_2, c445, c446, f, fp_0, f446_p_0, f447_p_0, fp_1, f446_p_1, fp_2, f446, f447, w, wp_0, x, xp_0, y, yp_0;
			...
			for (y = y233, yp_0 = 0;
				...
				for (f = f446, fp_2 = f446_p_1, fp_1 = f446_p_0, fp_0 = 0;
					...
					for (c445 = c446, c445_p_1 = c446_p_0, c445_p_0 = 0;
						c445 < c446 + 64;
						c445 += 64, c445_p_1 += 64, c445_p_0 += 64){
						// y = 7, x = 28, h = 3, w = 3, c = 64, f = 32
						// T (x, 28) (28 / 1)
						for (x = x226, xp_0 = 0;
							x < x226 + 28;
							...
							for (w = w175, wp_0 = 0;
								...
								w += 1, wp_0 += 1){
										...
										// T (c, 64) (64 / 1)
										for (c = c445, cp_2 = c445_p_1, cp_1 = c445_p_0, cp_0 = 0;
											c < c445 + 64;
