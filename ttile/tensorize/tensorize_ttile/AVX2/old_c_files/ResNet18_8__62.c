...
*/
IND_TYPE c, cp_0, c259_p_0, c260_p_0, cp_1, c259_p_1, cp_2, c259, c260, f, fp_0, f258_p_0, f259_p_0, fp_1, f258_p_1, fp_2, f258, f259, h, hp_0, x, xp_0, y, yp_0;
			...
			for (y = y137, yp_0 = 0;
				...
				for (f = f258, fp_2 = f258_p_1, fp_1 = f258_p_0, fp_0 = 0;
					...
					for (c259 = c260, c259_p_1 = c260_p_0, c259_p_0 = 0;
						c259 < c260 + 32;
						c259 += 32, c259_p_1 += 32, c259_p_0 += 32){
						// y = 4, x = 28, h = 3, w = 3, c = 32, f = 32
						// T (x, 28) (28 / 1)
						for (x = x132, xp_0 = 0;
							x < x132 + 28;
