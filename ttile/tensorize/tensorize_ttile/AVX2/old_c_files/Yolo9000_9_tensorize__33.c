...
/*
[V f; U (4, f); U (4, y); T (1, c); Hoist_vars [c]; T (68, x); T (256, c);
  T (4, f); T (1, x); T (17, y)]
*/
IND_TYPE c, cp_0, c45_p_0, cp_1, c45, f, fp_0, x, xp_0, x45_p_0, xp_1, x45, y, yp_0;
IND_TYPE y30 = 0;
IND_TYPE x46 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c45 = 0;
c45_p_0 = 0;
				for (x = x45, xp_1 = x45_p_0, xp_0 = 0;x < x45 + 68;x += 1, xp_1 += 1, xp_0 += 1){
