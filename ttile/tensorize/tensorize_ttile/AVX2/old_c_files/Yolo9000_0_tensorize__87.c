...
[V f; U (4, f); U (4, y); U (3, h); T (3, c); Hoist_vars [c]; T (1, x);
  T (1, c); T (3, w); T (68, y); T (544, x); T (2, y); T (1, y)]
*/
IND_TYPE c, cp_0, c8_p_0, cp_1, c8, w, wp_0, x, xp_0, x10_p_0, xp_1, x10, y, yp_0, y11_p_0, y12_p_0, yp_1, y11_p_1, yp_2, y11, y12;
IND_TYPE y13 = 0;
IND_TYPE x11 = 0;
IND_TYPE h = 0;
IND_TYPE w6 = 0;
...
yp_2 = 0;
				for (w = w6, wp_0 = 0;w < w6 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 1) (3 / 3)
					for (c8 = c9, c8_p_0 = 0;c8 < c9 + 3;c8 += 3, c8_p_0 += 3){
						// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
						// T (x, 1) (1 / 1)
						for (x = x10, xp_1 = x10_p_0, xp_0 = 0;x < x10 + 1;x += 1, xp_1 += 1, xp_0 += 1){
									...
									// y = 4, x = 1, h = 3, w = 1, c = 3, f = 32
									// T (c, 3) (3 / 1)
									for (c = c8, cp_1 = c8_p_0, cp_0 = 0;c < c8 + 3;c += 1, cp_1 += 1, cp_0 += 1){
