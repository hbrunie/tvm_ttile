...
[V f; U (4, f); U (4, y); U (3, w); T (3, c); Hoist_vars [c]; T (1, x);
  T (1, c); T (3, h); T (68, y); T (544, x); T (2, y); T (1, y)]
*/
IND_TYPE c, cp_0, c14_p_0, cp_1, c14, h, hp_0, x, xp_0, x16_p_0, xp_1, x16, y, yp_0, y19_p_0, y20_p_0, yp_1, y19_p_1, yp_2, y19, y20;
IND_TYPE y21 = 0;
IND_TYPE x17 = 0;
IND_TYPE h7 = 0;
IND_TYPE w = 0;
...
yp_2 = 0;
				for (h = h7, hp_0 = 0;h < h7 + 3;h += 1, hp_0 += 1){
					...
					for (c14 = c15, c14_p_0 = 0;c14 < c15 + 3;c14 += 3, c14_p_0 += 3){
						// y = 4, x = 1, h = 1, w = 3, c = 3, f = 32
						// T (x, 1) (1 / 1)
						for (x = x16, xp_1 = x16_p_0, xp_0 = 0;x < x16 + 1;x += 1, xp_1 += 1, xp_0 += 1){
