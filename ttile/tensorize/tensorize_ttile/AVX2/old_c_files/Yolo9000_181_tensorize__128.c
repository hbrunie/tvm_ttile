...
*/
IND_TYPE c, cp_0, c322_p_0, cp_1, c322, f, fp_0, f336_p_0, f337_p_0, fp_1, f336_p_1, fp_2, f336, f337, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y208 = 0;
IND_TYPE x188 = 0;
IND_TYPE h = 0;
IND_TYPE w166 = 0;
...
xp_0 = 0;
							for (w = w166, wp_0 = 0;w < w166 + 3;w += 1, wp_0 += 1){
										...
										mem_vec_3644 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
										mem_vec_3645 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8]);
										mem_vec_3646 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16]);
										mem_vec_3647 = _mm256_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24]);
										...
										for (c = c322, cp_1 = c322_p_0, cp_0 = 0;c < c322 + 32;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_24 = _mm256_fmadd_ps(vec_25, vec_2, mem_vec_3644);
											mem_vec_3644 = vec_24;
											vec_26 = _mm256_fmadd_ps(vec_25, vec_4, mem_vec_3645);
											mem_vec_3645 = vec_26;
											vec_27 = _mm256_fmadd_ps(vec_25, vec_6, mem_vec_3646);
											mem_vec_3646 = vec_27;
											vec_28 = _mm256_fmadd_ps(vec_25, vec_8, mem_vec_3647);
											mem_vec_3647 = vec_28;
											scal_5 = input[strideA1 * (x + w) + strideA2 * (y + h + 1) + c];
											vec_30 = _mm256_set1_ps(scal_5);
											vec_31 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f]);
											vec_29 = _mm256_fmadd_ps(vec_30, vec_31, mem_vec_3628);
											mem_vec_3628 = vec_29;
											vec_33 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 8]);
											vec_32 = _mm256_fmadd_ps(vec_30, vec_33, mem_vec_3629);
											mem_vec_3629 = vec_32;
											vec_35 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 16]);
											vec_34 = _mm256_fmadd_ps(vec_30, vec_35, mem_vec_3630);
											mem_vec_3630 = vec_34;
											vec_37 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 1) + strideW3 * c + f + 24]);
											vec_36 = _mm256_fmadd_ps(vec_30, vec_37, mem_vec_3631);
											mem_vec_3631 = vec_36;
											scal_6 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 1) + c];
											vec_39 = _mm256_set1_ps(scal_6);
											vec_38 = _mm256_fmadd_ps(vec_39, vec_31, mem_vec_3632);
											mem_vec_3632 = vec_38;
											vec_40 = _mm256_fmadd_ps(vec_39, vec_33, mem_vec_3633);
											mem_vec_3633 = vec_40;
											vec_41 = _mm256_fmadd_ps(vec_39, vec_35, mem_vec_3634);
											mem_vec_3634 = vec_41;
											vec_42 = _mm256_fmadd_ps(vec_39, vec_37, mem_vec_3635);
											mem_vec_3635 = vec_42;
											scal_7 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 1) + c];
											vec_44 = _mm256_set1_ps(scal_7);
											vec_43 = _mm256_fmadd_ps(vec_44, vec_31, mem_vec_3636);
											mem_vec_3636 = vec_43;
											vec_45 = _mm256_fmadd_ps(vec_44, vec_33, mem_vec_3637);
											mem_vec_3637 = vec_45;
											vec_46 = _mm256_fmadd_ps(vec_44, vec_35, mem_vec_3638);
											mem_vec_3638 = vec_46;
											vec_47 = _mm256_fmadd_ps(vec_44, vec_37, mem_vec_3639);
											mem_vec_3639 = vec_47;
											scal_8 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 1) + c];
											vec_49 = _mm256_set1_ps(scal_8);
											vec_48 = _mm256_fmadd_ps(vec_49, vec_31, mem_vec_3640);
											mem_vec_3640 = vec_48;
											vec_50 = _mm256_fmadd_ps(vec_49, vec_33, mem_vec_3641);
											mem_vec_3641 = vec_50;
											vec_51 = _mm256_fmadd_ps(vec_49, vec_35, mem_vec_3642);
											mem_vec_3642 = vec_51;
											vec_52 = _mm256_fmadd_ps(vec_49, vec_37, mem_vec_3643);
											mem_vec_3643 = vec_52;
											scal_9 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 1) + c];
											vec_54 = _mm256_set1_ps(scal_9);
											vec_53 = _mm256_fmadd_ps(vec_54, vec_31, mem_vec_3644);
											mem_vec_3644 = vec_53;
											vec_55 = _mm256_fmadd_ps(vec_54, vec_33, mem_vec_3645);
											mem_vec_3645 = vec_55;
											vec_56 = _mm256_fmadd_ps(vec_54, vec_35, mem_vec_3646);
											mem_vec_3646 = vec_56;
											vec_57 = _mm256_fmadd_ps(vec_54, vec_37, mem_vec_3647);
											mem_vec_3647 = vec_57;
											scal_10 = input[strideA1 * (x + w) + strideA2 * (y + h + 2) + c];
											vec_59 = _mm256_set1_ps(scal_10);
											vec_60 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f]);
											vec_58 = _mm256_fmadd_ps(vec_59, vec_60, mem_vec_3628);
											mem_vec_3628 = vec_58;
											vec_62 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 8]);
											vec_61 = _mm256_fmadd_ps(vec_59, vec_62, mem_vec_3629);
											mem_vec_3629 = vec_61;
											vec_64 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 16]);
											vec_63 = _mm256_fmadd_ps(vec_59, vec_64, mem_vec_3630);
											mem_vec_3630 = vec_63;
											vec_66 = _mm256_loadu_ps(&params[strideW1 * w + strideW2 * (h + 2) + strideW3 * c + f + 24]);
											vec_65 = _mm256_fmadd_ps(vec_59, vec_66, mem_vec_3631);
											mem_vec_3631 = vec_65;
											scal_11 = input[strideA1 * (x + w) + strideA2 * (y + 1 + h + 2) + c];
											vec_68 = _mm256_set1_ps(scal_11);
											vec_67 = _mm256_fmadd_ps(vec_68, vec_60, mem_vec_3632);
											mem_vec_3632 = vec_67;
											vec_69 = _mm256_fmadd_ps(vec_68, vec_62, mem_vec_3633);
											mem_vec_3633 = vec_69;
											vec_70 = _mm256_fmadd_ps(vec_68, vec_64, mem_vec_3634);
											mem_vec_3634 = vec_70;
											vec_71 = _mm256_fmadd_ps(vec_68, vec_66, mem_vec_3635);
											mem_vec_3635 = vec_71;
											scal_12 = input[strideA1 * (x + w) + strideA2 * (y + 2 + h + 2) + c];
											vec_73 = _mm256_set1_ps(scal_12);
											vec_72 = _mm256_fmadd_ps(vec_73, vec_60, mem_vec_3636);
											mem_vec_3636 = vec_72;
											vec_74 = _mm256_fmadd_ps(vec_73, vec_62, mem_vec_3637);
											mem_vec_3637 = vec_74;
											vec_75 = _mm256_fmadd_ps(vec_73, vec_64, mem_vec_3638);
											mem_vec_3638 = vec_75;
											vec_76 = _mm256_fmadd_ps(vec_73, vec_66, mem_vec_3639);
											mem_vec_3639 = vec_76;
											scal_13 = input[strideA1 * (x + w) + strideA2 * (y + 3 + h + 2) + c];
											vec_78 = _mm256_set1_ps(scal_13);
											vec_77 = _mm256_fmadd_ps(vec_78, vec_60, mem_vec_3640);
											mem_vec_3640 = vec_77;
											vec_79 = _mm256_fmadd_ps(vec_78, vec_62, mem_vec_3641);
											mem_vec_3641 = vec_79;
											vec_80 = _mm256_fmadd_ps(vec_78, vec_64, mem_vec_3642);
											mem_vec_3642 = vec_80;
											vec_81 = _mm256_fmadd_ps(vec_78, vec_66, mem_vec_3643);
											mem_vec_3643 = vec_81;
											scal_14 = input[strideA1 * (x + w) + strideA2 * (y + 4 + h + 2) + c];
											vec_83 = _mm256_set1_ps(scal_14);
											vec_82 = _mm256_fmadd_ps(vec_83, vec_60, mem_vec_3644);
											mem_vec_3644 = vec_82;
											vec_84 = _mm256_fmadd_ps(vec_83, vec_62, mem_vec_3645);
											mem_vec_3645 = vec_84;
											vec_85 = _mm256_fmadd_ps(vec_83, vec_64, mem_vec_3646);
											mem_vec_3646 = vec_85;
											vec_86 = _mm256_fmadd_ps(vec_83, vec_66, mem_vec_3647);
											mem_vec_3647 = vec_86;
										}
									...
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_3644);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 8], mem_vec_3645);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 16], mem_vec_3646);
									_mm256_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f + 24], mem_vec_3647);
							}
}
