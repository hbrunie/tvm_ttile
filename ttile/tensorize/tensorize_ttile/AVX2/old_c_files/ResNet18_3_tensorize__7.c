...
[V f; U (4, f); U (4, y); T (64, c); Hoist_vars [c]; T (14, x); T (2, f);
  T (1, x); T (14, y); T (4, x); T (1, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x48_p_0, x49_p_0, xp_1, x48_p_1, xp_2, x48, x49, y, yp_0, y36_p_0, yp_1, y36;
IND_TYPE y37 = 0;
IND_TYPE x50 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
fp_0 = 0;
					for (x = x48, xp_2 = x48_p_1, xp_1 = x48_p_0, xp_0 = 0;x < x48 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 64) (64 / 1)
								for (c = c24, cp_0 = 0;c < c24 + 64;c += 1, cp_0 += 1){
