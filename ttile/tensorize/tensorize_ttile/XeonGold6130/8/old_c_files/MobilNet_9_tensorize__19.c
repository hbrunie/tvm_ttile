...
xp_0 = 0;
						for (w = w238, wp_0 = 0;w < w238 + 3;w += 1, wp_0 += 1){
									...
									mem_vec_3862 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
									mem_vec_3863 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									// y = 7, x = 1, h = 3, w = 1, c = 8, f = 64
									// T (c, 8) (8 / 1)
									for (c = c685, cp_3 = c685_p_2, cp_2 = c685_p_1, cp_1 = c685_p_0, cp_0 = 0;c < c685 + 8;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_3862);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_3863);
						}
}
