...
[V f; U (4, f); U (7, y); U (3, w); T (256, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (1, c); T (4, f); T (4, y); T (1, x); T (1, f); T (1, f)]
*/
IND_TYPE c, c0, cp_0, c0_p_0, cp_1, f, f0, fp_0, f0_p_0, f1_p_0, f1, fp_1, f0_p_1, fp_2, h, hp_0, x, x0, xp_0, x0_p_0, xp_1, y, yp_0;
