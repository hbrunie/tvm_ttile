...
*/
IND_TYPE c, cp_0, c519_p_0, cp_1, c519, f, fp_0, f519_p_0, fp_1, f519, h, hp_0, w, wp_0, x, xp_0, x501_p_0, xp_1, x501, y, yp_0;
IND_TYPE y346 = 0;
IND_TYPE x502 = 0;
IND_TYPE h308 = 0;
IND_TYPE w326 = 0;
...
c519_p_0 = 0;
					for (w = w326, wp_0 = 0;w < w326 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 4) (4 / 1)
						for (x = x501, xp_1 = x501_p_0, xp_0 = 0;x < x501 + 4;x += 1, xp_1 += 1, xp_0 += 1){
