...
c522_p_0 = 0;
							for (w = w318, wp_0 = 0;w < w318 + 3;w += 1, wp_0 += 1){
								...
								for (x = x522, xp_1 = x522_p_0, xp_0 = 0;x < x522 + 17;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_6472 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_6473 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_6472);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f + 16], mem_vec_6473);
								}
							}
}
