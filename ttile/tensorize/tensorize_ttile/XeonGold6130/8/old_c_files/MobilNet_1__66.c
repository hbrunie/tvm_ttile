...
*/
IND_TYPE c, cp_0, c39_p_0, cp_1, c39, h, hp_0, w, wp_0, x, xp_0, y, yp_0, y39_p_0, yp_1, y39;
					...
					for (h = h26, hp_0 = 0;
						...
						for (w = w26, wp_0 = 0;
							...
							w += 1, wp_0 += 1){
									...
									mem_vec_448 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
									mem_vec_449 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_448);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_449);
						}
					}
				}
			}
					...
					for (h = h26, hp_0 = 0;
						...
						for (w = w26, wp_0 = 0;
							...
							w += 1, wp_0 += 1){
									...
									mem_vec_466 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
									mem_vec_467 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
									mem_vec_468 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_469 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
									mem_vec_470 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_471 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									mem_vec_472 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_473 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_474 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_475 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
									// T (c, 32) (32 / 1)
									for (c = c39, cp_1 = c39_p_0, cp_0 = 0;
										c < c39 + 32;
										...
										vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_466);
										mem_vec_466 = vec_26;



										vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_467);
										mem_vec_467 = vec_28;
										...
										vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_470);
										mem_vec_470 = vec_32;



										vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_471);
										mem_vec_471 = vec_34;
										scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
										vec_36 = _mm512_set1_ps(scal_11);


										vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_472);
										mem_vec_472 = vec_35;



										vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_473);
										mem_vec_473 = vec_37;
										scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
										vec_39 = _mm512_set1_ps(scal_12);


										vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_474);
										mem_vec_474 = vec_38;



										vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_475);
										mem_vec_475 = vec_40;
									}
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_466);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_467);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_468);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_469);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_470);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_471);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_472);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_473);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_474);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_475);
						}
					}
				}
			}
