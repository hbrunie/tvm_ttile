				...
				for (y = y72, yp_1 = y72_p_0, yp_0 = 0;
					...
					for (x = x72, xp_1 = x72_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_1004 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
								mem_vec_1005 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
								mem_vec_1006 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
								mem_vec_1007 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c48, cp_0 = 0;
									c < c48 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_1004);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_1005);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_1006);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_1007);
					}
				}
				for (y = y72 + 54, yp_1 = y72_p_0, yp_0 = 0;
					y < y72 + 54 + 14;
