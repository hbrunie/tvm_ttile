...
*/
IND_TYPE c, cp_0, c420_p_0, c421_p_0, c422_p_0, cp_1, c420_p_1, c421_p_1, cp_2, c420_p_2, cp_3, c420, c421, c422, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y168 = 0;
IND_TYPE x168 = 0;
IND_TYPE h141 = 0;
IND_TYPE w142 = 0;
...
xp_0 = 0;
						for (h = h141, hp_0 = 0;h < h141 + 3;h += 1, hp_0 += 1){
							...
							for (w = w142, wp_0 = 0;w < w142 + 3;w += 1, wp_0 += 1){
										...
										// T (c, 16) (16 / 1)
										for (c = c420, cp_3 = c420_p_2, cp_2 = c420_p_1, cp_1 = c420_p_0, cp_0 = 0;c < c420 + 16;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
