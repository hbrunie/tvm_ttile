...
c372_p_0 = 0;
							for (w = w228, wp_0 = 0;w < w228 + 3;w += 1, wp_0 += 1){
								...
								for (x = x422, xp_1 = x422_p_0, xp_0 = 0;x < x422 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_3305 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
											mem_vec_3306 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
											mem_vec_3307 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3305);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_3306);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_3307);
								}
							}
}
