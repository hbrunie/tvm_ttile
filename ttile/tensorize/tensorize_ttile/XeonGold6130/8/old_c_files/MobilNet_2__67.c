...
[V f; U (4, f); U (7, y); U (3, w); T (16, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (4, c); T (4, x); T (8, y); T (1, x)]
*/
IND_TYPE c, cp_0, c363_p_0, cp_1, c363, h, hp_0, x, xp_0, x458_p_0, x459_p_0, xp_1, x458_p_1, xp_2, x458, x459, y, yp_0;
...
for (x459 = x460, x459_p_0 = 0;
	...
	for (y = y255, yp_0 = 0;
		...
		for (x458 = x459, x458_p_1 = x459_p_0, x458_p_0 = 0;
			x458 < x459 + 56;
			x458 += 14, x458_p_1 += 14, x458_p_0 += 14){
