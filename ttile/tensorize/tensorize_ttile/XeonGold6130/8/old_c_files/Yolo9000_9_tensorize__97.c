...
y150 = 0;
y150_p_0 = 0;
	for (x201 = x202, x201_p_0 = 0;x201 < x202 + 68;x201 += 4, x201_p_0 += 4){
			for (y = y150, yp_1 = y150_p_0, yp_0 = 0;y < y150 + 12;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (4 / 4)
				for (x200 = x201, x200_p_1 = x201_p_0, x200_p_0 = 0;x200 < x201 + 4;x200 += 4, x200_p_1 += 4, x200_p_0 += 4){
					// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
					// T (f, 4) (128 / 32)
					for (f = f100, fp_0 = 0;f < f100 + 128;f += 32, fp_0 += 32){
						// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 32
						// T (c, 4) (256 / 64)
						for (c150 = c151, c150_p_0 = 0;c150 < c151 + 256;c150 += 64, c150_p_0 += 64){
			...
			for (y = y150 + 12, yp_1 = y150_p_0, yp_0 = 0;y < y150 + 12 + 56;y += 14, yp_1 += 14, yp_0 += 14){
				// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
				// T (x, 1) (4 / 4)
				for (x200 = x201, x200_p_1 = x201_p_0, x200_p_0 = 0;x200 < x201 + 4;x200 += 4, x200_p_1 += 4, x200_p_0 += 4){
					// y = ph_y, x = 4, h = 1, w = 1, c = 256, f = 128
					...
					for (f = f100, fp_0 = 0;f < f100 + 128;f += 32, fp_0 += 32){
						...
						for (c150 = c151, c150_p_0 = 0;c150 < c151 + 256;c150 += 64, c150_p_0 += 64){
							...
							for (x = x200, xp_2 = x200_p_1, xp_1 = x200_p_0, xp_0 = 0;x < x200 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_2550 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										mem_vec_2551 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
										mem_vec_2552 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_2553 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
										mem_vec_2554 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_2555 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 64, f = 32
										// T (c, 64) (64 / 1)
										for (c = c150, cp_1 = c150_p_0, cp_0 = 0;c < c150 + 64;c += 1, cp_1 += 1, cp_0 += 1){
											scal_0 = input[strideA1 * (x + w) + strideA2 * (y + h) + c];
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_2550);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_2551);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_2552);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_2553);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_2554);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_2555);
							}
						}
					}
				}
