...
*/
IND_TYPE c, cp_0, c453_p_0, cp_1, c453, f, fp_0, x, xp_0, x746_p_0, x747_p_0, x748_p_0, xp_1, x746_p_1, x747_p_1, xp_2, x746_p_2, xp_3, x746, x747, x748, y, yp_0, y595_p_0, y596_p_0, yp_1, y595_p_1, yp_2, y595, y596;
...
for (y596 = y597, y596_p_0 = 0;
	...
	for (x748 = x749, x748_p_0 = 0;
		...
		// T (y, 1) (56 / 56)
		for (y595 = y596, y595_p_1 = y596_p_0, y595_p_0 = 0;
			y595 < y596 + 56;
			y595 += 56, y595_p_1 += 56, y595_p_0 += 56){
			// y = 56, x = 28, h = 1, w = 1, c = 64, f = 64
			// T (x, 28) (28 / 1)
			for (x747 = x748, x747_p_1 = x748_p_0, x747_p_0 = 0;
				x747 < x748 + 28;
				x747 += 1, x747_p_1 += 1, x747_p_0 += 1){
				...
				for (f = f293, fp_0 = 0;
					...
					// T (y, 4) (56 / 14)
					for (y = y595, yp_2 = y595_p_1, yp_1 = y595_p_0, yp_0 = 0;
						y < y595 + 56;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 1, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (1 / 1)
						for (x746 = x747, x746_p_2 = x747_p_1, x746_p_1 = x747_p_0, x746_p_0 = 0;
							x746 < x747 + 1;
							x746 += 1, x746_p_2 += 1, x746_p_1 += 1, x746_p_0 += 1){
							// y = 14, x = 1, h = 1, w = 1, c = 64, f = 32
							// T (c, 2) (64 / 32)
							for (c453 = c454, c453_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x746, xp_3 = x746_p_2, xp_2 = x746_p_1, xp_1 = x746_p_0, xp_0 = 0;
									x < x746 + 1;
