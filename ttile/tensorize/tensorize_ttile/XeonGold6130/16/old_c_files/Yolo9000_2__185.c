						...
						for (x = x3, xp_1 = x3_p_0, xp_0 = 0;
							...
							for (h = h2, hp_0 = 0;
								...
								for (w = w2, wp_0 = 0;
									w < w2 + 3;
									w += 1, wp_0 += 1){
											mem_vec_46 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
											mem_vec_47 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
											...
											mem_vec_54 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
											mem_vec_55 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
											mem_vec_56 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_57 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_58 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_59 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_60 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
											mem_vec_61 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
											mem_vec_62 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
											mem_vec_63 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_46);
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_47);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_54);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_55);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_56);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_57);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_58);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_59);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_60);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_61);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_62);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_63);
								}
							}
						}
					}
							...
							for (h = h2, hp_0 = 0;
								...
								for (w = w2, wp_0 = 0;
									...
									w += 1, wp_0 += 1){
											...
											mem_vec_80 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
											mem_vec_81 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
											mem_vec_82 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
											mem_vec_83 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
											mem_vec_84 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
											mem_vec_85 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
											mem_vec_86 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
											mem_vec_87 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
											mem_vec_88 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_89 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
											mem_vec_90 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_91 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 16, f = 32
											// T (c, 16) (16 / 1)
											for (c = c3, cp_1 = c3_p_0, cp_0 = 0;
												c < c3 + 16;
												...
												vec_26 = _mm512_fmadd_ps(vec_27, vec_2, mem_vec_80);
												mem_vec_80 = vec_26;



												vec_28 = _mm512_fmadd_ps(vec_27, vec_4, mem_vec_81);
												mem_vec_81 = vec_28;
												scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 9 + h) + c];
												vec_30 = _mm512_set1_ps(scal_9);


												vec_29 = _mm512_fmadd_ps(vec_30, vec_2, mem_vec_82);
												mem_vec_82 = vec_29;



												vec_31 = _mm512_fmadd_ps(vec_30, vec_4, mem_vec_83);
												mem_vec_83 = vec_31;
												scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 10 + h) + c];
												vec_33 = _mm512_set1_ps(scal_10);


												vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_84);
												mem_vec_84 = vec_32;



												vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_85);
												mem_vec_85 = vec_34;
												scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 11 + h) + c];
												vec_36 = _mm512_set1_ps(scal_11);


												vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_86);
												mem_vec_86 = vec_35;



												vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_87);
												mem_vec_87 = vec_37;
												scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 12 + h) + c];
												vec_39 = _mm512_set1_ps(scal_12);


												vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_88);
												mem_vec_88 = vec_38;



												vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_89);
												mem_vec_89 = vec_40;
												scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 13 + h) + c];
												vec_42 = _mm512_set1_ps(scal_13);


												vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_90);
												mem_vec_90 = vec_41;



												vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_91);
												mem_vec_91 = vec_43;
											}
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_80);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_81);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_82);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_83);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_84);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_85);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_86);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_87);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_88);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_89);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_90);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_91);
								}
							}
						}
					}
