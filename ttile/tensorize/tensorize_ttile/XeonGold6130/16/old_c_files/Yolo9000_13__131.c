...
for (y208 = y209, y208_p_0 = 0;
	...
	for (x289 = x290, x289_p_0 = 0;
		...
		for (f = f144, fp_0 = 0;
			f < f144 + 256;
			f += 32, fp_0 += 32){
				for (y = y208, yp_1 = y208_p_0, yp_0 = 0;
					y < y208 + 22;
				...
				for (y = y208 + 22, yp_1 = y208_p_0, yp_0 = 0;
					y < y208 + 22 + 12;
						...
						for (c216 = c217, c216_p_0 = 0;
							...
							for (x = x288, xp_2 = x288_p_1, xp_1 = x288_p_0, xp_0 = 0;
								...
								x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_3332 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
										mem_vec_3333 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
										// y = ph_y, x = 1, h = 1, w = 1, c = 512, f = 32
										// T (c, 512) (512 / 1)
										for (c = c216, cp_1 = c216_p_0, cp_0 = 0;
											c < c216 + 512;
									...
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3332);
									_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_3333);
							}
						}
					}
				}
