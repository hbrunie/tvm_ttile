...
c168_p_0 = 0;
						for (w = w70, wp_0 = 0;w < w70 + 3;w += 1, wp_0 += 1){
							...
							for (x = x168, xp_1 = x168_p_0, xp_0 = 0;x < x168 + 14;x += 1, xp_1 += 1, xp_0 += 1){
										...
										mem_vec_1322 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
										mem_vec_1323 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_1322);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_1323);
							}
						}
}
