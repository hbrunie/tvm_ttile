...
[V f; U (2, f); U (14, y); T (3, c); Hoist_vars [c]; T (2, x); T (1, c);
  T (7, w); T (7, h); T (56, x); T (1, y); T (2, f); T (8, y)]
*/
IND_TYPE c, cp_0, c96_p_0, cp_1, c96, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x91_p_0, xp_1, x91, y, yp_0, y96_p_0, yp_1, y96;
IND_TYPE y97 = 0;
IND_TYPE x92 = 0;
IND_TYPE h64 = 0;
IND_TYPE w64 = 0;
				...
				for (h = h64, hp_0 = 0;h < h64 + 7;h += 1, hp_0 += 1){
					...
					for (w = w64, wp_0 = 0;w < w64 + 7;w += 1, wp_0 += 1){
						...
						for (c96 = c97, c96_p_0 = 0;c96 < c97 + 3;c96 += 3, c96_p_0 += 3){
							// y = 14, x = 2, h = 1, w = 1, c = 3, f = 32
							// T (x, 2) (2 / 1)
							for (x = x91, xp_1 = x91_p_0, xp_0 = 0;x < x91 + 2;x += 1, xp_1 += 1, xp_0 += 1){
