...
[V f; U (2, f); ULambda y; T (512, c); Hoist_vars [c]; T (17, x); T (1, c);
  ...
  T (8, f); T (2, x); T (1, y)]
*/
IND_TYPE c, cp_0, c414_p_0, cp_1, c414, f, fp_0, x, xp_0, x552_p_0, x553_p_0, xp_1, x552_p_1, xp_2, x552, x553, y, yp_0, y406_p_0, yp_1, y406;
			...
			f += 32, fp_0 += 32){
				for (y = y406, yp_1 = y406_p_0, yp_0 = 0;
					...
					for (x552 = x553, x552_p_1 = x553_p_0, x552_p_0 = 0;
						x552 < x553 + 17;
						x552 += 17, x552_p_1 += 17, x552_p_0 += 17){
						// y = ph_y, x = 17, h = 1, w = 1, c = 512, f = 32
						// T (c, 1) (512 / 512)
				...
				for (y = y406 + 10, yp_1 = y406_p_0, yp_0 = 0;
					y < y406 + 10 + 24;
