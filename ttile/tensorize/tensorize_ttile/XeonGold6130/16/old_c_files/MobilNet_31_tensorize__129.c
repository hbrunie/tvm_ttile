...
c216_p_0 = 0;
					for (h = h99, hp_0 = 0;h < h99 + 3;h += 1, hp_0 += 1){
						...
						// T (x, 56) (56 / 1)
						for (x = x236, xp_1 = x236_p_0, xp_0 = 0;x < x236 + 56;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_1618 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32]);
									mem_vec_1619 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48]);
									// y = ph_y, x = 1, h = 1, w = 3, c = 128, f = 64
									// T (c, 128) (128 / 1)
									for (c = c216, cp_1 = c216_p_0, cp_0 = 0;c < c216 + 128;c += 1, cp_1 += 1, cp_0 += 1){
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 32], mem_vec_1618);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f + 48], mem_vec_1619);
						}
					}
}
