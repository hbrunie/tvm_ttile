...
c339_p_0 = 0;
				for (w = w206, wp_0 = 0;w < w206 + 3;w += 1, wp_0 += 1){
					...
					for (x = x426, xp_2 = x426_p_1, xp_1 = x426_p_0, xp_0 = 0;x < x426 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_3488 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
								mem_vec_3489 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16]);
								mem_vec_3490 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
								mem_vec_3491 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
							...
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_3488);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 16], mem_vec_3489);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_3490);
							_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_3491);
					}
				}
}
