...
y183 = 0;
y183_p_0 = 0;
	for (f = f117, fp_0 = 0;f < f117 + 64;f += 32, fp_0 += 32){
			for (y = y183, yp_1 = y183_p_0, yp_0 = 0;y < y183 + 20;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 16) (112 / 7)
				for (x178 = x179, x178_p_0 = 0;x178 < x179 + 112;x178 += 7, x178_p_0 += 7){
					...
					for (h = h122, hp_0 = 0;h < h122 + 7;h += 1, hp_0 += 1){
						...
						for (w = w122, wp_0 = 0;w < w122 + 7;w += 1, wp_0 += 1){
							...
							for (c183 = c184, c183_p_0 = 0;c183 < c184 + 3;c183 += 3, c183_p_0 += 3){
								// y = ph_y, x = 7, h = 1, w = 1, c = 3, f = 32
								// T (x, 7) (7 / 1)
								for (x = x178, xp_1 = x178_p_0, xp_0 = 0;x < x178 + 7;x += 1, xp_1 += 1, xp_0 += 1){
			...
			for (y = y183 + 20, yp_1 = y183_p_0, yp_0 = 0;y < y183 + 20 + 36;y += 12, yp_1 += 12, yp_0 += 12){
				// y = ph_y, x = 112, h = 7, w = 7, c = 3, f = 32
				// T (x, 16) (112 / 7)
				for (x178 = x179, x178_p_0 = 0;x178 < x179 + 112;x178 += 7, x178_p_0 += 7){
					// y = ph_y, x = 7, h = 7, w = 7, c = 3, f = 32
