...
*/
IND_TYPE c, cp_0, c85_p_0, c86_p_0, c87_p_0, cp_1, c85_p_1, c86_p_1, cp_2, c85_p_2, cp_3, c85, c86, c87, f, fp_0, w, wp_0, x, xp_0, y, yp_0;
...
for (c87 = c88, c87_p_0 = 0;
	c87 < c88 + 1024;
	c87 += 1024, c87_p_0 += 1024){
	// y = 7, x = 7, h = 3, w = 3, c = 1024, f = 1024
	// T (c, 2) (1024 / 512)
	for (c86 = c87, c86_p_1 = c87_p_0, c86_p_0 = 0;
		c86 < c87 + 1024;
		c86 += 512, c86_p_1 += 512, c86_p_0 += 512){
		...
		for (f = f34, fp_0 = 0;
			...
			for (y = y34, yp_0 = 0;
				...
				for (c85 = c86, c85_p_2 = c86_p_1, c85_p_1 = c86_p_0, c85_p_0 = 0;
					c85 < c86 + 512;
					c85 += 8, c85_p_2 += 8, c85_p_1 += 8, c85_p_0 += 8){
