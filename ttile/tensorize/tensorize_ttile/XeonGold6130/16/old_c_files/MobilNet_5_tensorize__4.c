...
x427 = 0;
x427_p_0 = 0;
		for (f = f504, fp_0 = 0;f < f504 + 256;f += 32, fp_0 += 32){
				for (y = y300, yp_1 = y300_p_0, yp_0 = 0;y < y300 + 8;y += 8, yp_1 += 8, yp_0 += 8){
					// y = ph_y, x = 28, h = 3, w = 3, c = 256, f = 32
					// T (x, 2) (28 / 14)
					for (x426 = x427, x426_p_1 = x427_p_0, x426_p_0 = 0;x426 < x427 + 28;x426 += 14, x426_p_1 += 14, x426_p_0 += 14){
						...
						for (c414 = c415, c414_p_0 = 0;c414 < c415 + 256;c414 += 32, c414_p_0 += 32){
							...
							for (w = w174, wp_0 = 0;w < w174 + 3;w += 1, wp_0 += 1){
								...
								// T (x, 14) (14 / 1)
								for (x = x426, xp_2 = x426_p_1, xp_1 = x426_p_0, xp_0 = 0;x < x426 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
				...
				for (y = y300 + 8, yp_1 = y300_p_0, yp_0 = 0;y < y300 + 8 + 20;y += 10, yp_1 += 10, yp_0 += 10){
					// y = ph_y, x = 28, h = 3, w = 3, c = 256, f = 32
					// T (x, 2) (28 / 14)
					for (x426 = x427, x426_p_1 = x427_p_0, x426_p_0 = 0;x426 < x427 + 28;x426 += 14, x426_p_1 += 14, x426_p_0 += 14){
						// y = ph_y, x = 14, h = 3, w = 3, c = 256, f = 32
