...
[V f; U (4, f); U (4, y); U (3, w); T (32, c); Hoist_vars [c]; T (28, x);
  T (3, h); T (8, c); T (2, f); T (7, y); T (1, x); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c111_p_0, cp_1, c111, f, fp_0, f136_p_0, f137_p_0, fp_1, f136_p_1, fp_2, f136, f137, h, hp_0, x, xp_0, x113_p_0, xp_1, x113, y, yp_0;
IND_TYPE y80 = 0;
IND_TYPE x114 = 0;
IND_TYPE h72 = 0;
IND_TYPE w = 0;
...
c111_p_0 = 0;
						for (h = h72, hp_0 = 0;h < h72 + 3;h += 1, hp_0 += 1){
							...
							// T (x, 28) (28 / 1)
							for (x = x113, xp_1 = x113_p_0, xp_0 = 0;x < x113 + 28;x += 1, xp_1 += 1, xp_0 += 1){
