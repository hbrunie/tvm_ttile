...
*/
IND_TYPE c, cp_0, c70_p_0, c71_p_0, c72_p_0, cp_1, c70_p_1, c71_p_1, cp_2, c70_p_2, cp_3, c70, c71, c72, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
IND_TYPE y28 = 0;
IND_TYPE x28 = 0;
IND_TYPE h25 = 0;
IND_TYPE w25 = 0;
...
xp_0 = 0;
						for (h = h25, hp_0 = 0;h < h25 + 3;h += 1, hp_0 += 1){
							...
							for (w = w25, wp_0 = 0;w < w25 + 3;w += 1, wp_0 += 1){
										...
										// T (c, 8) (8 / 1)
										for (c = c70, cp_3 = c70_p_2, cp_2 = c70_p_1, cp_1 = c70_p_0, cp_0 = 0;c < c70 + 8;c += 1, cp_3 += 1, cp_2 += 1, cp_1 += 1, cp_0 += 1){
