...
c423_p_0 = 0;
					for (w = w244, wp_0 = 0;w < w244 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 4) (4 / 1)
						for (x = x395, xp_1 = x395_p_0, xp_0 = 0;x < x395 + 4;x += 1, xp_1 += 1, xp_0 += 1){
							...
							for (h = h239, hp_0 = 0;h < h239 + 3;h += 1, hp_0 += 1){
										...
										mem_vec_4146 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_4147 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_4146);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_4147);
							}
						}
					}
}
