...
*/
IND_TYPE c, cp_0, c10_p_0, cp_1, c10, f, fp_0, f10_p_0, fp_1, f10, x, xp_0, x15_p_0, xp_1, x15, y, yp_0;
IND_TYPE y10 = 0;
IND_TYPE x16 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
c10 = 0;
c10_p_0 = 0;
					for (x = x15, xp_1 = x15_p_0, xp_0 = 0;x < x15 + 28;x += 1, xp_1 += 1, xp_0 += 1){
								...
								// T (c, 64) (64 / 1)
								for (c = c10, cp_1 = c10_p_0, cp_0 = 0;c < c10 + 64;c += 1, cp_1 += 1, cp_0 += 1){
