...
y6 = 0;
y6_p_0 = 0;
	for (f = f4, fp_0 = 0;f < f4 + 512;f += 32, fp_0 += 32){
			for (y = y6, yp_1 = y6_p_0, yp_0 = 0;y < y6 + 8;y += 8, yp_1 += 8, yp_0 += 8){
				// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 32
				// T (c, 32) (1024 / 32)
				for (c6 = c7, c6_p_0 = 0;c6 < c7 + 1024;c6 += 32, c6_p_0 += 32){
			...
			for (y = y6 + 8, yp_1 = y6_p_0, yp_0 = 0;y < y6 + 8 + 9;y += 9, yp_1 += 9, yp_0 += 9){
				// y = ph_y, x = 17, h = 1, w = 1, c = 1024, f = 32
				// T (c, 32) (1024 / 32)
				for (c6 = c7, c6_p_0 = 0;c6 < c7 + 1024;c6 += 32, c6_p_0 += 32){
					// y = ph_y, x = 17, h = 1, w = 1, c = 32, f = 32
