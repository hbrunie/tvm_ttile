...
x298_p_0 = 0;
				for (w = w236, wp_0 = 0;w < w236 + 3;w += 1, wp_0 += 1){
					...
					// T (c, 4) (32 / 8)
					for (c354 = c355, c354_p_0 = 0;c354 < c355 + 32;c354 += 8, c354_p_0 += 8){
						// y = 14, x = 4, h = 3, w = 1, c = 8, f = 16
						// T (x, 4) (4 / 1)
						for (x = x298, xp_1 = x298_p_0, xp_0 = 0;x < x298 + 4;x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_3151 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									mem_vec_3152 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_3153 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f]);
									mem_vec_3154 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
									mem_vec_3155 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
									mem_vec_3156 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
									mem_vec_3157 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_3151);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_3152);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 9) + f], mem_vec_3153);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_3154);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_3155);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3156);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_3157);
						}
					}
				}
}
