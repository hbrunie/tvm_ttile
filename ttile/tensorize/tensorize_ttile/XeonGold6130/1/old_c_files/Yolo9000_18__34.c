...
[V f; U (2, f); ULambda y; T (4, c); Hoist_vars [c]; T (3, w); T (3, h);
  ...
  T (1, c); T (1, c)]
*/
IND_TYPE c, cp_0, c15_p_0, c16_p_0, c17_p_0, cp_1, c15_p_1, c16_p_1, cp_2, c15_p_2, cp_3, c15, c16, c17, f, fp_0, h, hp_0, w, wp_0, x, xp_0, y, yp_0;
...
for (c17 = c18, c17_p_0 = 0;
	...
	for (c16 = c17, c16_p_1 = c17_p_0, c16_p_0 = 0;
		c16 < c17 + 512;
		c16 += 512, c16_p_1 += 512, c16_p_0 += 512){
		// y = 17, x = 17, h = 3, w = 3, c = 512, f = 1024
		// T (f, 32) (1024 / 32)
		for (f = f6, fp_0 = 0;
			f < f6 + 1024;
			f += 32, fp_0 += 32){
				for (y = y6, yp_0 = 0;
					...
					for (c15 = c16, c15_p_2 = c16_p_1, c15_p_1 = c16_p_0, c15_p_0 = 0;
						c15 < c16 + 512;
						c15 += 4, c15_p_2 += 4, c15_p_1 += 4, c15_p_0 += 4){
						...
						for (x = x6, xp_0 = 0;
							...
							for (h = h6, hp_0 = 0;
								...
								for (w = w6, wp_0 = 0;
									w < w6 + 3;
									w += 1, wp_0 += 1){
											mem_vec_102 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
											mem_vec_103 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
											...
											mem_vec_110 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f]);
											mem_vec_111 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16]);
											mem_vec_112 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_113 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_114 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_115 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_116 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
											mem_vec_117 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_102);
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_103);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f], mem_vec_110);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 4) + f + 16], mem_vec_111);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_112);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_113);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_114);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_115);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_116);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_117);
								}
							}
						}
					}
						...
						for (x = x6, xp_0 = 0;
							...
							for (h = h6, hp_0 = 0;
								...
								for (w = w6, wp_0 = 0;
									w < w6 + 3;
									w += 1, wp_0 += 1){
											mem_vec_118 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f]);
											mem_vec_119 = _mm512_loadu_ps(&output[(F * Y) * x + F * y + f + 16]);
											mem_vec_120 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f]);
											mem_vec_121 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16]);
											mem_vec_122 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f]);
											mem_vec_123 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16]);
											...
											mem_vec_128 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f]);
											mem_vec_129 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16]);
											mem_vec_130 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f]);
											mem_vec_131 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16]);
											mem_vec_132 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f]);
											mem_vec_133 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16]);
											mem_vec_134 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f]);
											mem_vec_135 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16]);
											// y = ph_y, x = 1, h = 1, w = 1, c = 4, f = 32
											// T (c, 4) (4 / 1)
											for (c = c15, cp_3 = c15_p_2, cp_2 = c15_p_1, cp_1 = c15_p_0, cp_0 = 0;
												c < c15 + 4;
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f], mem_vec_118);
										_mm512_storeu_ps(&output[(F * Y) * x + F * y + f + 16], mem_vec_119);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f], mem_vec_120);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 1) + f + 16], mem_vec_121);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f], mem_vec_122);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 2) + f + 16], mem_vec_123);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f], mem_vec_128);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 5) + f + 16], mem_vec_129);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f], mem_vec_130);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 6) + f + 16], mem_vec_131);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f], mem_vec_132);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 7) + f + 16], mem_vec_133);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f], mem_vec_134);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 8) + f + 16], mem_vec_135);
								}
							}
						}
					}
