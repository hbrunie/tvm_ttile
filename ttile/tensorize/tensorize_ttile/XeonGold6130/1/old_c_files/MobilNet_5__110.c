...
[V f; U (4, f); U (7, y); U (3, w); T (256, c); Hoist_vars [c]; T (14, x);
  T (3, h); T (1, c); T (2, f); T (4, y); T (2, x); T (2, f); T (1, f)]
*/
IND_TYPE c, cp_0, c69_p_0, cp_1, c69, f, fp_0, f84_p_0, f85_p_0, fp_1, f84_p_1, fp_2, f84, f85, h, hp_0, x, xp_0, x73_p_0, xp_1, x73, y, yp_0;
...
for (f85 = f86, f85_p_0 = 0;
	...
	for (f84 = f85, f84_p_1 = f85_p_0, f84_p_0 = 0;
		f84 < f85 + 256;
		f84 += 128, f84_p_1 += 128, f84_p_0 += 128){
