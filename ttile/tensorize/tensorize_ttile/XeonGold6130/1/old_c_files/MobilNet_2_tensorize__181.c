...
[V f; U (2, f); U (14, y); T (64, c); Hoist_vars [c]; T (3, h); T (7, x);
  T (3, w); T (1, c); T (2, f); T (2, x); T (4, y); T (4, x)]
*/
IND_TYPE c, cp_0, c303_p_0, cp_1, c303, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x378_p_0, x379_p_0, xp_1, x378_p_1, xp_2, x378, x379, y, yp_0;
IND_TYPE y215 = 0;
IND_TYPE x380 = 0;
IND_TYPE h177 = 0;
IND_TYPE w182 = 0;
...
c303_p_0 = 0;
					for (w = w182, wp_0 = 0;w < w182 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 7) (7 / 1)
						for (x = x378, xp_2 = x378_p_1, xp_1 = x378_p_0, xp_0 = 0;x < x378 + 7;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
							...
							for (h = h177, hp_0 = 0;h < h177 + 3;h += 1, hp_0 += 1){
										...
										mem_vec_3148 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f]);
										mem_vec_3149 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16]);
										mem_vec_3150 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f]);
										mem_vec_3151 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16]);
										mem_vec_3152 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f]);
										mem_vec_3153 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16]);
										mem_vec_3154 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f]);
										mem_vec_3155 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16]);
										...
										for (c = c303, cp_1 = c303_p_0, cp_0 = 0;c < c303 + 64;c += 1, cp_1 += 1, cp_0 += 1){
											...
											vec_32 = _mm512_fmadd_ps(vec_33, vec_2, mem_vec_3148);
											mem_vec_3148 = vec_32;
											vec_34 = _mm512_fmadd_ps(vec_33, vec_4, mem_vec_3149);
											mem_vec_3149 = vec_34;
											scal_11 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 11) + h) + c];
											vec_36 = _mm512_set1_ps(scal_11);
											vec_35 = _mm512_fmadd_ps(vec_36, vec_2, mem_vec_3150);
											mem_vec_3150 = vec_35;
											vec_37 = _mm512_fmadd_ps(vec_36, vec_4, mem_vec_3151);
											mem_vec_3151 = vec_37;
											scal_12 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 12) + h) + c];
											vec_39 = _mm512_set1_ps(scal_12);
											vec_38 = _mm512_fmadd_ps(vec_39, vec_2, mem_vec_3152);
											mem_vec_3152 = vec_38;
											vec_40 = _mm512_fmadd_ps(vec_39, vec_4, mem_vec_3153);
											mem_vec_3153 = vec_40;
											scal_13 = input[strideA1 * (2 * x + w) + strideA2 * (2 * (y + 13) + h) + c];
											vec_42 = _mm512_set1_ps(scal_13);
											vec_41 = _mm512_fmadd_ps(vec_42, vec_2, mem_vec_3154);
											mem_vec_3154 = vec_41;
											vec_43 = _mm512_fmadd_ps(vec_42, vec_4, mem_vec_3155);
											mem_vec_3155 = vec_43;
										}
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f], mem_vec_3148);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 10) + f + 16], mem_vec_3149);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f], mem_vec_3150);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 11) + f + 16], mem_vec_3151);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f], mem_vec_3152);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 12) + f + 16], mem_vec_3153);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f], mem_vec_3154);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 13) + f + 16], mem_vec_3155);
							}
						}
					}
}
