				...
				for (y = y57 + 8, yp_1 = y57_p_0, yp_0 = 0;
					...
					for (x = x57, xp_1 = x57_p_0, xp_0 = 0;
						...
						x += 1, xp_1 += 1, xp_0 += 1){
								...
								mem_vec_820 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f]);
								mem_vec_821 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16]);
								// y = ph_y, x = 1, h = 1, w = 1, c = 128, f = 32
								// T (c, 128) (128 / 1)
								for (c = c38, cp_0 = 0;
									c < c38 + 128;
							...
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f], mem_vec_820);
							_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 14) + f + 16], mem_vec_821);
					}
				}
		}
	}
