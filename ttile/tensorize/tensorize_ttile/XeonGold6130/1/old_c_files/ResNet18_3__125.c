...
for (y376 = y377, y376_p_0 = 0;
	...
	for (x473 = x474, x473_p_0 = 0;
		...
		// y = 56, x = 56, h = 1, w = 1, c = 64, f = 64
		// T (y, 2) (56 / 28)
		for (y375 = y376, y375_p_1 = y376_p_0, y375_p_0 = 0;
			y375 < y376 + 56;
			y375 += 28, y375_p_1 += 28, y375_p_0 += 28){
			...
			for (x472 = x473, x472_p_1 = x473_p_0, x472_p_0 = 0;
				...
				for (f = f183, fp_0 = 0;
					...
					// T (y, 2) (28 / 14)
					for (y = y375, yp_2 = y375_p_1, yp_1 = y375_p_0, yp_0 = 0;
						y < y375 + 28;
						y += 14, yp_2 += 14, yp_1 += 14, yp_0 += 14){
						// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
						// T (x, 1) (7 / 7)
						for (x471 = x472, x471_p_2 = x472_p_1, x471_p_1 = x472_p_0, x471_p_0 = 0;
							x471 < x472 + 7;
							x471 += 7, x471_p_2 += 7, x471_p_1 += 7, x471_p_0 += 7){
							// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
							// T (c, 1) (64 / 64)
							for (c288 = c289, c288_p_0 = 0;
								...
								// y = 14, x = 7, h = 1, w = 1, c = 64, f = 32
								// T (x, 7) (7 / 1)
								for (x = x471, xp_3 = x471_p_2, xp_2 = x471_p_1, xp_1 = x471_p_0, xp_0 = 0;
									x < x471 + 7;
									x += 1, xp_3 += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_2208 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
											mem_vec_2209 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
											mem_vec_2210 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
											mem_vec_2211 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
										...
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_2208);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_2209);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_2210);
										_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_2211);
								}
							}
						}
					}
