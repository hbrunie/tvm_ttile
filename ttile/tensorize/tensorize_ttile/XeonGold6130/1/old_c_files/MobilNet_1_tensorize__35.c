...
y132 = 0;
y132_p_0 = 0;
	for (c132 = c133, c132_p_0 = 0;c132 < c133 + 32;c132 += 32, c132_p_0 += 32){
			for (y = y132, yp_1 = y132_p_0, yp_0 = 0;y < y132 + 18;y += 9, yp_1 += 9, yp_0 += 9){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x88, xp_0 = 0;x < x88 + 112;x += 1, xp_0 += 1){
					...
					for (h = h82, hp_0 = 0;h < h82 + 3;h += 1, hp_0 += 1){
						...
						for (w = w88, wp_0 = 0;w < w88 + 3;w += 1, wp_0 += 1){
									...
									mem_vec_1822 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
									mem_vec_1823 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16]);
									mem_vec_1824 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f]);
									mem_vec_1825 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16]);
								...
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_1822);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f + 16], mem_vec_1823);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f], mem_vec_1824);
								_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 8) + f + 16], mem_vec_1825);
						}
					}
				}
			}
			for (y = y132 + 18, yp_1 = y132_p_0, yp_0 = 0;y < y132 + 18 + 10;y += 10, yp_1 += 10, yp_0 += 10){
				// y = ph_y, x = 112, h = 3, w = 3, c = 32, f = 32
				// T (x, 112) (112 / 1)
				for (x = x88, xp_0 = 0;x < x88 + 112;x += 1, xp_0 += 1){
					// y = ph_y, x = 1, h = 3, w = 3, c = 32, f = 32
