...
yp_1 = 0;
				for (h = h144, hp_0 = 0;h < h144 + 3;h += 1, hp_0 += 1){
					...
					for (w = w180, wp_0 = 0;w < w180 + 3;w += 1, wp_0 += 1){
						...
						// T (c, 1) (3 / 3)
						for (c234 = c235, c234_p_0 = 0;c234 < c235 + 3;c234 += 3, c234_p_0 += 3){
							// y = 8, x = 4, h = 1, w = 1, c = 3, f = 32
							// T (x, 4) (4 / 1)
							for (x = x360, xp_2 = x360_p_1, xp_1 = x360_p_0, xp_0 = 0;x < x360 + 4;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
										...
										// T (c, 3) (3 / 1)
										for (c = c234, cp_1 = c234_p_0, cp_0 = 0;c < c234 + 3;c += 1, cp_1 += 1, cp_0 += 1){
