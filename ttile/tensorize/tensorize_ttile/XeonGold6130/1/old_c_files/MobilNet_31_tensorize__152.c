...
c567_p_0 = 0;
							for (w = w355, wp_0 = 0;w < w355 + 3;w += 1, wp_0 += 1){
								...
								for (x = x623, xp_1 = x623_p_0, xp_0 = 0;x < x623 + 28;x += 1, xp_1 += 1, xp_0 += 1){
											...
											mem_vec_4637 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f]);
											mem_vec_4638 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f]);
											mem_vec_4639 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f]);
											mem_vec_4640 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f]);
											mem_vec_4641 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f]);
										...
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 3) + f], mem_vec_4637);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 4) + f], mem_vec_4638);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 5) + f], mem_vec_4639);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f], mem_vec_4640);
										_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 7) + f], mem_vec_4641);
