...
c162_p_0 = 0;
					for (w = w96, wp_0 = 0;w < w96 + 3;w += 1, wp_0 += 1){
						...
						// T (x, 14) (14 / 1)
						for (x = x152, xp_1 = x152_p_0, xp_0 = 0;x < x152 + 14;x += 1, xp_1 += 1, xp_0 += 1){
							...
							for (h = h96, hp_0 = 0;h < h96 + 3;h += 1, hp_0 += 1){
										...
										mem_vec_1326 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32]);
										mem_vec_1327 = _mm512_loadu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48]);
									...
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 32], mem_vec_1326);
									_mm512_storeu_ps(&output[strideO1 * x + strideO2 * (y + 6) + f + 48], mem_vec_1327);
							}
						}
					}
}
