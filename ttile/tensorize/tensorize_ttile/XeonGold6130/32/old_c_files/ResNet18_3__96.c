...
*/
IND_TYPE c, cp_0, c273_p_0, cp_1, c273, f, fp_0, x, xp_0, x446_p_0, x447_p_0, x448_p_0, xp_1, x446_p_1, x447_p_1, xp_2, x446_p_2, xp_3, x446, x447, x448, y, yp_0, y355_p_0, y356_p_0, yp_1, y355_p_1, yp_2, y355, y356;
...
for (y356 = y357, y356_p_0 = 0;
	...
	for (x448 = x449, x448_p_0 = 0;
		...
		// T (y, 1) (56 / 56)
		for (y355 = y356, y355_p_1 = y356_p_0, y355_p_0 = 0;
			y355 < y356 + 56;
			y355 += 56, y355_p_1 += 56, y355_p_0 += 56){
			// y = 56, x = 28, h = 1, w = 1, c = 64, f = 64
			// T (x, 14) (28 / 2)
			for (x447 = x448, x447_p_1 = x448_p_0, x447_p_0 = 0;
				x447 < x448 + 28;
				x447 += 2, x447_p_1 += 2, x447_p_0 += 2){
				...
				for (f = f173, fp_0 = 0;
					...
					// T (y, 7) (56 / 8)
					for (y = y355, yp_2 = y355_p_1, yp_1 = y355_p_0, yp_0 = 0;
						y < y355 + 56;
						y += 8, yp_2 += 8, yp_1 += 8, yp_0 += 8){
						// y = 8, x = 2, h = 1, w = 1, c = 64, f = 32
						// T (x, 2) (2 / 1)
						for (x446 = x447, x446_p_2 = x447_p_1, x446_p_1 = x447_p_0, x446_p_0 = 0;
							x446 < x447 + 2;
							x446 += 1, x446_p_2 += 1, x446_p_1 += 1, x446_p_0 += 1){
							...
							for (c273 = c274, c273_p_0 = 0;
								...
								// T (x, 1) (1 / 1)
								for (x = x446, xp_3 = x446_p_2, xp_2 = x446_p_1, xp_1 = x446_p_0, xp_0 = 0;
									x < x446 + 1;
