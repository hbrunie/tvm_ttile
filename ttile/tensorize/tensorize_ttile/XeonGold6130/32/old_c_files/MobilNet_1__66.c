					...
					for (c360 = c361, c360_p_0 = 0;
						...
						for (x = x304, xp_1 = x304_p_0, xp_0 = 0;
							...
							x += 1, xp_1 += 1, xp_0 += 1){
									...
									mem_vec_3181 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_3182 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_3183 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_3184 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_3185 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_3181);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_3182);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_3183);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_3184);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_3185);
						}
					}
				}
			}
