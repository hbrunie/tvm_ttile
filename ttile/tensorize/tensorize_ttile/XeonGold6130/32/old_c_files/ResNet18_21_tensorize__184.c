...
*/
IND_TYPE c, cp_0, c420_p_0, cp_1, c420, f, fp_0, h, hp_0, w, wp_0, x, xp_0, x518_p_0, x519_p_0, xp_1, x518_p_1, xp_2, x518, x519, y, yp_0;
IND_TYPE y301 = 0;
IND_TYPE x520 = 0;
IND_TYPE h241 = 0;
IND_TYPE w250 = 0;
...
c420_p_0 = 0;
						for (w = w250, wp_0 = 0;w < w250 + 3;w += 1, wp_0 += 1){
							...
							// T (x, 14) (14 / 1)
							for (x = x518, xp_2 = x518_p_1, xp_1 = x518_p_0, xp_0 = 0;x < x518 + 14;x += 1, xp_2 += 1, xp_1 += 1, xp_0 += 1){
