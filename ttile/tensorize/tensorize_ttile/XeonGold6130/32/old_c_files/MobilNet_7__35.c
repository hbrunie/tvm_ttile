					...
					for (w = w56, wp_0 = 0;
						...
						w += 1, wp_0 += 1){
								...
								for (c = c120, cp_2 = c120_p_1, cp_1 = c120_p_0, cp_0 = 0;
									...
									vec_39 = _mm512_fmadd_ps(vec_40, vec_41, mem_vec_840);
									mem_vec_840 = vec_39;

									vec_43 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 16]);

									vec_42 = _mm512_fmadd_ps(vec_40, vec_43, mem_vec_841);
									mem_vec_841 = vec_42;

									vec_45 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 32]);

									vec_44 = _mm512_fmadd_ps(vec_40, vec_45, mem_vec_842);
									mem_vec_842 = vec_44;

									vec_47 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 1) + F * c + f + 48]);

									vec_46 = _mm512_fmadd_ps(vec_40, vec_47, mem_vec_843);
									mem_vec_843 = vec_46;
									scal_8 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 1) + c];
									vec_49 = _mm512_set1_ps(scal_8);


									vec_48 = _mm512_fmadd_ps(vec_49, vec_41, mem_vec_844);
									mem_vec_844 = vec_48;



									vec_50 = _mm512_fmadd_ps(vec_49, vec_43, mem_vec_845);
									mem_vec_845 = vec_50;



									vec_51 = _mm512_fmadd_ps(vec_49, vec_45, mem_vec_846);
									mem_vec_846 = vec_51;



									vec_52 = _mm512_fmadd_ps(vec_49, vec_47, mem_vec_847);
									mem_vec_847 = vec_52;
									scal_9 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 1) + c];
									vec_54 = _mm512_set1_ps(scal_9);


									vec_53 = _mm512_fmadd_ps(vec_54, vec_41, mem_vec_848);
									mem_vec_848 = vec_53;



									vec_55 = _mm512_fmadd_ps(vec_54, vec_43, mem_vec_849);
									mem_vec_849 = vec_55;



									vec_56 = _mm512_fmadd_ps(vec_54, vec_45, mem_vec_850);
									mem_vec_850 = vec_56;



									vec_57 = _mm512_fmadd_ps(vec_54, vec_47, mem_vec_851);
									mem_vec_851 = vec_57;
									scal_10 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 1) + c];
									vec_59 = _mm512_set1_ps(scal_10);


									vec_58 = _mm512_fmadd_ps(vec_59, vec_41, mem_vec_852);
									mem_vec_852 = vec_58;



									vec_60 = _mm512_fmadd_ps(vec_59, vec_43, mem_vec_853);
									mem_vec_853 = vec_60;



									vec_61 = _mm512_fmadd_ps(vec_59, vec_45, mem_vec_854);
									mem_vec_854 = vec_61;



									vec_62 = _mm512_fmadd_ps(vec_59, vec_47, mem_vec_855);
									mem_vec_855 = vec_62;
									scal_11 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 1) + c];
									vec_64 = _mm512_set1_ps(scal_11);


									vec_63 = _mm512_fmadd_ps(vec_64, vec_41, mem_vec_856);
									mem_vec_856 = vec_63;



									vec_65 = _mm512_fmadd_ps(vec_64, vec_43, mem_vec_857);
									mem_vec_857 = vec_65;



									vec_66 = _mm512_fmadd_ps(vec_64, vec_45, mem_vec_858);
									mem_vec_858 = vec_66;



									vec_67 = _mm512_fmadd_ps(vec_64, vec_47, mem_vec_859);
									mem_vec_859 = vec_67;
									scal_12 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 1) + c];
									vec_69 = _mm512_set1_ps(scal_12);


									vec_68 = _mm512_fmadd_ps(vec_69, vec_41, mem_vec_860);
									mem_vec_860 = vec_68;



									vec_70 = _mm512_fmadd_ps(vec_69, vec_43, mem_vec_861);
									mem_vec_861 = vec_70;



									vec_71 = _mm512_fmadd_ps(vec_69, vec_45, mem_vec_862);
									mem_vec_862 = vec_71;



									vec_72 = _mm512_fmadd_ps(vec_69, vec_47, mem_vec_863);
									mem_vec_863 = vec_72;
									scal_13 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 1) + c];
									vec_74 = _mm512_set1_ps(scal_13);


									vec_73 = _mm512_fmadd_ps(vec_74, vec_41, mem_vec_864);
									mem_vec_864 = vec_73;



									vec_75 = _mm512_fmadd_ps(vec_74, vec_43, mem_vec_865);
									mem_vec_865 = vec_75;



									vec_76 = _mm512_fmadd_ps(vec_74, vec_45, mem_vec_866);
									mem_vec_866 = vec_76;



									vec_77 = _mm512_fmadd_ps(vec_74, vec_47, mem_vec_867);
									mem_vec_867 = vec_77;
									scal_14 = input[(C * (Y + H - 1)) * (x + w) + C * (y + h + 2) + c];
									vec_79 = _mm512_set1_ps(scal_14);
									vec_80 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f]);

									vec_78 = _mm512_fmadd_ps(vec_79, vec_80, mem_vec_840);
									mem_vec_840 = vec_78;

									vec_82 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 16]);

									vec_81 = _mm512_fmadd_ps(vec_79, vec_82, mem_vec_841);
									mem_vec_841 = vec_81;

									vec_84 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 32]);

									vec_83 = _mm512_fmadd_ps(vec_79, vec_84, mem_vec_842);
									mem_vec_842 = vec_83;

									vec_86 = _mm512_loadu_ps(&params[((F * C) * H) * w + (F * C) * (h + 2) + F * c + f + 48]);

									vec_85 = _mm512_fmadd_ps(vec_79, vec_86, mem_vec_843);
									mem_vec_843 = vec_85;
									scal_15 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 1 + h + 2) + c];
									vec_88 = _mm512_set1_ps(scal_15);


									vec_87 = _mm512_fmadd_ps(vec_88, vec_80, mem_vec_844);
									mem_vec_844 = vec_87;



									vec_89 = _mm512_fmadd_ps(vec_88, vec_82, mem_vec_845);
									mem_vec_845 = vec_89;



									vec_90 = _mm512_fmadd_ps(vec_88, vec_84, mem_vec_846);
									mem_vec_846 = vec_90;



									vec_91 = _mm512_fmadd_ps(vec_88, vec_86, mem_vec_847);
									mem_vec_847 = vec_91;
									scal_16 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 2 + h + 2) + c];
									vec_93 = _mm512_set1_ps(scal_16);


									vec_92 = _mm512_fmadd_ps(vec_93, vec_80, mem_vec_848);
									mem_vec_848 = vec_92;



									vec_94 = _mm512_fmadd_ps(vec_93, vec_82, mem_vec_849);
									mem_vec_849 = vec_94;



									vec_95 = _mm512_fmadd_ps(vec_93, vec_84, mem_vec_850);
									mem_vec_850 = vec_95;



									vec_96 = _mm512_fmadd_ps(vec_93, vec_86, mem_vec_851);
									mem_vec_851 = vec_96;
									scal_17 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 3 + h + 2) + c];
									vec_98 = _mm512_set1_ps(scal_17);


									vec_97 = _mm512_fmadd_ps(vec_98, vec_80, mem_vec_852);
									mem_vec_852 = vec_97;



									vec_99 = _mm512_fmadd_ps(vec_98, vec_82, mem_vec_853);
									mem_vec_853 = vec_99;



									vec_100 = _mm512_fmadd_ps(vec_98, vec_84, mem_vec_854);
									mem_vec_854 = vec_100;



									vec_101 = _mm512_fmadd_ps(vec_98, vec_86, mem_vec_855);
									mem_vec_855 = vec_101;
									scal_18 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 4 + h + 2) + c];
									vec_103 = _mm512_set1_ps(scal_18);


									vec_102 = _mm512_fmadd_ps(vec_103, vec_80, mem_vec_856);
									mem_vec_856 = vec_102;



									vec_104 = _mm512_fmadd_ps(vec_103, vec_82, mem_vec_857);
									mem_vec_857 = vec_104;



									vec_105 = _mm512_fmadd_ps(vec_103, vec_84, mem_vec_858);
									mem_vec_858 = vec_105;



									vec_106 = _mm512_fmadd_ps(vec_103, vec_86, mem_vec_859);
									mem_vec_859 = vec_106;
									scal_19 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 5 + h + 2) + c];
									vec_108 = _mm512_set1_ps(scal_19);


									vec_107 = _mm512_fmadd_ps(vec_108, vec_80, mem_vec_860);
									mem_vec_860 = vec_107;



									vec_109 = _mm512_fmadd_ps(vec_108, vec_82, mem_vec_861);
									mem_vec_861 = vec_109;



									vec_110 = _mm512_fmadd_ps(vec_108, vec_84, mem_vec_862);
									mem_vec_862 = vec_110;



									vec_111 = _mm512_fmadd_ps(vec_108, vec_86, mem_vec_863);
									mem_vec_863 = vec_111;
									scal_20 = input[(C * (Y + H - 1)) * (x + w) + C * (y + 6 + h + 2) + c];
									vec_113 = _mm512_set1_ps(scal_20);


									vec_112 = _mm512_fmadd_ps(vec_113, vec_80, mem_vec_864);
									mem_vec_864 = vec_112;



									vec_114 = _mm512_fmadd_ps(vec_113, vec_82, mem_vec_865);
									mem_vec_865 = vec_114;



									vec_115 = _mm512_fmadd_ps(vec_113, vec_84, mem_vec_866);
									mem_vec_866 = vec_115;



									vec_116 = _mm512_fmadd_ps(vec_113, vec_86, mem_vec_867);
									mem_vec_867 = vec_116;
								}
