...
/*
[V f; U (2, f); U (14, y); T (64, c); Hoist_vars [c]; T (4, x); T (4, f);
  T (7, x); T (2, y)]
*/
IND_TYPE c, cp_0, f, fp_0, x, xp_0, x3_p_0, xp_1, x3, y, yp_0;
IND_TYPE y2 = 0;
IND_TYPE x4 = 0;
IND_TYPE h = 0;
IND_TYPE w = 0;
...
f = 0;
fp_0 = 0;
			for (x = x3, xp_1 = x3_p_0, xp_0 = 0;x < x3 + 4;x += 1, xp_1 += 1, xp_0 += 1){
						...
						// T (c, 64) (64 / 1)
						for (c = c2, cp_0 = 0;c < c2 + 64;c += 1, cp_0 += 1){
