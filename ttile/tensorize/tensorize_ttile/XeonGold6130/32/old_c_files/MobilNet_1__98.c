...
for (y48 = y49, y48_p_0 = 0;
	...
	for (c48 = c49, c48_p_0 = 0;
		...
		c48 += 32, c48_p_0 += 32){
			...
			for (y = y48 + 84, yp_1 = y48_p_0, yp_0 = 0;
				y < y48 + 84 + 28;
					...
					for (h = h32, hp_0 = 0;
						...
						for (w = w32, wp_0 = 0;
							...
							w += 1, wp_0 += 1){
									...
									mem_vec_618 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f]);
									mem_vec_619 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16]);
									mem_vec_620 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f]);
									mem_vec_621 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16]);
									mem_vec_622 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f]);
									mem_vec_623 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16]);
									mem_vec_624 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f]);
									mem_vec_625 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16]);
									mem_vec_626 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f]);
									mem_vec_627 = _mm512_loadu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16]);
									// y = ph_y, x = 1, h = 1, w = 1, c = 32, f = 32
									// T (c, 32) (32 / 1)
									for (c = c48, cp_1 = c48_p_0, cp_0 = 0;
										c < c48 + 32;
								...
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f], mem_vec_618);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 9) + f + 16], mem_vec_619);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f], mem_vec_620);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 10) + f + 16], mem_vec_621);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f], mem_vec_622);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 11) + f + 16], mem_vec_623);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f], mem_vec_624);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 12) + f + 16], mem_vec_625);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f], mem_vec_626);
								_mm512_storeu_ps(&output[(F * Y) * x + F * (y + 13) + f + 16], mem_vec_627);
						}
					}
				}
			}
