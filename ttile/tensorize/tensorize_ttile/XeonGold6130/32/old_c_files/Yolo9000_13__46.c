...
[V f; U (2, f); ULambda y; T (64, c); Hoist_vars [c]; T (1, x); T (8, c);
  ...
  T (8, f); T (1, x); T (1, y)]
*/
IND_TYPE c, cp_0, c117_p_0, cp_1, c117, f, fp_0, x, xp_0, x156_p_0, x157_p_0, xp_1, x156_p_1, xp_2, x156, x157, y, yp_0, y109_p_0, yp_1, y109;
	...
	for (x157 = x158, x157_p_0 = 0;
		...
		for (f = f78, fp_0 = 0;
			...
			f += 32, fp_0 += 32){
				...
				for (y = y109 + 10, yp_1 = y109_p_0, yp_0 = 0;
					y < y109 + 10 + 24;
