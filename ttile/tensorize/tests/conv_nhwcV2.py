...
s[Out].reorder(axe_batch, axe_yyo, axe_xxo, axe_in_channelso, axe_out_channelso, axe_yyi, axe_xxi, axe_kernel_h, axe_kernel_w, axe_in_channelsi, axe_out_channelsi)
