...
def conv_impl():
    cc_code = """
      extern "C" int Mttile_conv2d(float* K, float * Input, float * Output, int W, int H, int C, int F, int X, int Y, int strideO1, int strideO2, int strideA1, int strideA2, int strideW1, int strideW2, int strideW3) {
	/*
	Simple Convolution
	...
	*/
    ...
    return 0;
      ...
      extern "C" void ttile_conv2d_reset(float * Output, int F, int X, int Y, int strideO1, int strideO2) {
	/*
	Simple Convolution
