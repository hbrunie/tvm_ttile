...
def conv2d_ttile_ResNet18_1(batch_size, height, width, in_channels, out_channels, kernel_h, kernel_w, stride_h, stride_w):
    ...
    axe_xx_1, axe_xx_0 = s[Out].split(axe_xx, 15)
                
    axe_yy_1, axe_yy_0 = s[Out].split(axe_yy, 112)
                
    axe_yy_2, axe_yy_1 = s[Out].split(axe_yy_1, 36)
                
    axe_yy_3, axe_yy_2 = s[Out].split(axe_yy_2, 41)
