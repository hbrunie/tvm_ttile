...
def conv2d_ttile_ResNet18_12(batch_size, height, width, in_channels, out_channels, kernel_h, kernel_w, stride_h, stride_w):
    ...
    cfg.define_knob("tile_out_channels_2", [k for k in range(1, out_channels + 1) if out_channels%k == 0])
    ...
    axe_out_channels_3, axe_out_channels_2 = s[Out].split(axe_out_channels_2, cfg["tile_out_channels_2"].val)
