...
s[Out].reorder(axe_batch, axe_yyo, axe_xxo, axe_out_channelso, axe_in_channelso, axe_yyi, axe_xxi, axe_kernel_h, axe_kernel_w, axe_in_channelsi, axe_out_channelsi)

xxyyoc = s[Out].fuse(axe_xxo, axe_yyo, axe_out_channelso)
s[Out].parallel(xxyyoc)
...
extern "C" {
    ...
    file_ = open("gen_conv_mbnet3_avx512_tensorize.c", "r")
