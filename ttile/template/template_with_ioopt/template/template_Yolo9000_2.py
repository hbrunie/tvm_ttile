...
def conv2d_ttile_Yolo9000_2(batch_size, height, width, in_channels, out_channels, kernel_h, kernel_w, stride_h, stride_w):
    ...
    axe_xx_1, axe_xx_0 = s[Out].split(axe_xx, 12)
                
    axe_yy_1, axe_yy_0 = s[Out].split(axe_yy, 68)
                
    axe_yy_2, axe_yy_1 = s[Out].split(axe_yy_1, 58)
                
    axe_yy_3, axe_yy_2 = s[Out].split(axe_yy_2, 16)
