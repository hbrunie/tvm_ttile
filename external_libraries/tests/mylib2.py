...
A = tvm.te.placeholder((batch_size, in_channels, height + kernel_h - 1, width + kernel_w - 1), name="A")
W = tvm.te.placeholder((out_channels, in_channels, kernel_h, kernel_w), name="W")
